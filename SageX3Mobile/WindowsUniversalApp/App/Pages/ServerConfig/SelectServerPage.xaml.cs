...
namespace Sage.X3.Mobile.App.Pages.ServerConfig
{
    ...
    public sealed partial class SelectServerPage : Page
    {
        ...
        {
            this.gridViewServers.ItemsSource = Servers.GetKnownServers().List;
        }
        ...
        private void buttonNewServer_Click(object sender, RoutedEventArgs e)
        {
            ...
            rootFrame.Navigate(typeof(ConfigServerPage));
        }
        ...
        private void buttonEditServer_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Frame rootFrame = Window.Current.Content as Frame;
                rootFrame.Navigate(typeof(ConfigServerPage), server.Id);
            }
        }
