...
exports.metadata = {
	fileId: "be4cbccef5e5", // this id MUST never change and MUST be unique over all update scripts
	description: "Ambassdor P4 update script" // !important, some description, optional and can change
};