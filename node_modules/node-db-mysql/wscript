...
def build(bld):
  ...
  obj.source = "lib/node-db/binding.cc lib/node-db/connection.cc lib/node-db/cursor.cc lib/node-db/events.cc lib/node-db/exception.cc lib/node-db/query.cc lib/node-db/result.cc src/connection.cc src/mysql.cc src/query.cc src/result.cc src/mysql_bindings.cc"
  obj.includes = "lib/"
