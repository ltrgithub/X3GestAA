	...
	send_ND_DISPLAYREPORT: function(_){
		...
		for (var i in propsOut) {
			...
			var prop = {
				...
				status: locale.format(module, "STATUS_" + parseInt(arr[5], 10)),
				phase: locale.format(module, "PHASE_" + parseInt(arr[6], 10)),
				destination: locale.format(module, "DESTINATION_" + parseInt(arr[7], 10)),
				report: arr[8],
				application: {
					folder: app[0],
					host: app[1],
