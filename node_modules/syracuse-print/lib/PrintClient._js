...
/// 
exports.getClient = function(_, hostname, port, id) {
	...
	if ((client = clients[cltId])) {
		...
		client = new PrintClient(_, hostname, port, cltId);
...
var PrintClient = exports.PrintClient = helpers.defineClass(function(_, hostname, port, id) {
