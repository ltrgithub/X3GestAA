...
exports.initialize = function(site){
    ...
    site.addGrid = function(page, $prototype){
        ...
        syra_article.beforeDrawBox(page.$grid);
        syra_article.endDrawBox(page.$grid);
        ...
        syra_article.beforeDrawBox(page.$grid.$record);
        syra_article.endDrawBox(page.$grid.$record);
    };   
