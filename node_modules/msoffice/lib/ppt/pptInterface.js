...
var PptInterfaceImpl = require("msoffice/lib/ppt/pptInterfaceImpl").PptInterfaceImpl;
var PptInterfaceDummy = require("msoffice/lib/ppt/pptInterfaceDummy").PptInterfaceDummy;
...
exports.PptInterface = helpers.defineClass(PptInterface, null, {
	...
	fetchData: function(page, maxLines, data, onLoaded) {
		...
		page.fetch(options, function(fetchData, response, requestUrl) {
			...
			if (!fetchData.$itemsPerPage) fetchData.$itemsPerPage = fetchData.$resources && fetchData.$resources.length;
			//
