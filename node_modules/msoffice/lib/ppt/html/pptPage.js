...
exports.PptPage = helpers.defineClass(PptPage, DesktopPage, {
	...
	drawPage: function() {
        ...
        syra_article.beforeDrawBox(this.$grid);
        syra_article.endDrawBox(this.$grid);
        
        this.$grid.$record = {
            $prototype:this.$proto.$item,
            articleParent: this.$grid,
            applyChange: function(newData){
                syra_article.applyChange(this, newData);
            },
            dispose: function(){
        ...
        syra_article.beforeDrawBox(this.$grid.$record);
        syra_article.endDrawBox(this.$grid.$record);		
	},
