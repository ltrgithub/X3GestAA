...
exports.main = function(){
    ...
    if (site.isExcelOfficeConfig) {
        ...
        site.controller_onChangeMainPage = function(urlSeg){
            if (urlSeg.representationRoot == "excelconfig") {
        ...
        site.drawPage = function(){
            var self = this;
            syra_item.pageCategories.excelDatasource = ExcelDatasourcePage;
            syra_item.pageCategories.worksheet = ExcelPage;
            syra_item.pageCategories.excelreport = ExcelReportPage;
            Site.prototype.drawPage.apply(this);
            syra_dom.hide(this.productName, true);
        };
    ...
    site._renderHeader = function(){
        ...
        this.header.setAttribute("id", "s-header");
        syra_dom.setZIndex(this.header);
        
        this.headerBar = syra_dom.div("s-header-bar");
        //this.topPanel.addOpener(this.headerBar);
