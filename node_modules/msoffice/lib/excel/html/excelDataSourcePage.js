...
function _loadPage(articleParent, $excelView, dataset){
    ...
    page.unloadRelated = function(save){
        ...
        setTimeout(function(){
            ...
            syra_site.dom.hide(openerPage.domItem, false);
            syra_site.resize();
        }, 10);
    };
    ...
    syra_site.dom.hide(articleParent.page.domItem, true);
...
function _onButtonClick(){
    ...
    switch (this.$bind) {
        ...
        case "browseMenu":
        case "browseEntity":
            _loadPage(article, this.$bind.syraValue);
            break;
    }
}
    ...
    if (syra_site.excelDocument.documentUrl) 
        syra_site.excelDocument.publishDocument("", null, null, function(data, response){
            ...
            syra_diagnose.showDiagnoses({
                $diagnoses: [{
                    severity: "info",
                    message: syra_office_local.office_document_saved
                }]
            });
        });
    else {
