...
exports.ExcelDocument = helpers.defineClass(ExcelDocument, null, {
    ...
    getDatasourcesResource: function(uuid, facet){
        ...
        if (uuid) {
            ...
            if (!excelLoaded) {
                ...
                ds.$resources.push(_stubsDs["f1af2c6d-ccd9-4488-a2f1-c54166147374"]);
                ds.$resources.push(_stubsDs["f1af2c6d-ccd9-4488-a2f1-c54166147375"]);
            }
            //
            return ds;
        }
    ...
    addDatasource: function(record, onLoaded){
        if (record.serviceUrl) {
            ...
            var ds = this.getDatasource(record.$uuid) || this.workingCopyToDatasource(record);
