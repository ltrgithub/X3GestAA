...
function ExcelDocument(){
    ...
    //self.enableSageIntelligence = ((syra_controller._currentUrl || "").indexOf("sageIntelligence=1") >= 0);
    //
...
exports.ExcelDocument = helpers.defineClass(ExcelDocument, null, {
    ...
    loadPage: function(datasource, name, cellAddress, onLoaded){
        ...
        var role = external.getSyracuseRole && external.getSyracuseRole();
        ...
        if (role) {
            syra_controller.sendRequest(null, {
                ...
                /*
                 * Removing this (empty) function causes downstream issues - see issue 100281. Re-instating for the moment.
                 */
            });
        }
    ...
    publishDocument: function(documentUrl, documentTitle, saveUrl, onSuccess){
        ...
        var content = excelLoaded ? base64.raw_decode(external.GetDocumentContent()) : "";
    ...
    getCurrentDatasourceId: function(){
        return excelLoaded ? syra_site.$currentDatasource || "" : "f1af2c6d-ccd9-4488-a2f1-c54166147374";
    },
