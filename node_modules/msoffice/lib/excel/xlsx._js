		...
		transform: function(_, contents, entry) {
			switch(entry.name) {
				...
				case "xl/worksheets/_rels/sheet2.xml.rels":
					return new Buffer(contents.toString('utf8').
						replace("___addInDownloadAddress___", connectUrl + "/msoffice/lib/general/addIn/SyracuseAddinsSetup.msi")
						);
...
function _get_test_data(_)
{
	var obj = { 
		proto: '[{"_name":"login","_orgName":"login","_title":"Login","_type":"application/x-string"},{"_name":"title","_orgName":"title","_title":"Title","_type":"application/x-choice"},{"_name":"firstName","_orgName":"firstName","_title":"First name","_type":"application/x-string"},{"_name":"lastName","_orgName":"lastName","_title":"Last name","_type":"application/x-string"},{"_name":"fullName","_orgName":"fullName","_title":"Full name","_type":"application/x-string"},{"_name":"active","_orgName":"active","_title":"Active","_type":"application/x-boolean"},{"_name":"authentication","_orgName":"authentication","_title":"Authentication","_type":"application/x-choice"},{"_name":"authenticationName","_orgName":"authenticationName","_title":"Authentication name","_type":"application/x-string"},{"_name":"email","_orgName":"email","_title":"Email","_type":"application/x-string"},{"_name":"photo","_orgName":"photo","_title":"Photo","_type":"image"},{"_name":"ldap","_orgName":"ldap","_title":"LDAP instance","_type":"application/x-reference"},{"_name":"oauth2","_orgName":"oauth2","_title":"OAuth2 instance","_type":"application/x-reference"}]',
		data: '[[["admin",""],"mr",null,["Super administrator",""]," Super administrator",true,"",null,null,"","",""],[["guest",""],"mr",null,["Guest",""]," Guest",true,"",null,null,"","",""],[["import",""],"mr","Import",["Special user",""],"Import Special user",true,"",null,null,"","",""],[["mawal",""],"mr","Mathias Test",["Walz",""],"Mathias Test Walz",true,"",null,"test@test.de","","",""],[["messner",""],"mr","Jürgen",["Messner",""],"Jürgen Messner",true,"",null,null,"","",""]]',
		styles: ''
	};
	var xml = "<SyracuseOfficeCustomData>" + JSON.stringify(obj).replace(/&/g, "&amp;") + "</SyracuseOfficeCustomData>";
	return xml;
}
