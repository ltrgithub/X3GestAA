        ...
        for (var ii = 0, jj = self.embedded.length; ii < jj; ii++) {
            ...
            syra_controller.loadRepresentation({
                ...
                success: function (response) {
                    ...
                    $article = PageBuilder.ensureDefaultArticle({$facet: response.openerUrlSegments.$facet}, $article, response.$representation.$prototype);
                    ...
                    var options = {};
                    options.$location = {
                        $url: response.openerUrlSegments.$url
                    };
                    options.page = self;
