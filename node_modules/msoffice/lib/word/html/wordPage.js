...
exports.WordPage = helpers.defineClass(WordPage, DesktopPage, {
    ...
    drawPage: function(){
        ...
        this.$grid.$record = {
            $prototype:$properties.$resources.$item,
			...
			return items.map(function(item) {
				...
				*/
                ...
                if (record && propProto.$links && propProto.$links.$details) 
                    ...
                    syra_site.$syracuseMainPageUrl +
                    "?url=" +
                    encodeURIComponent(syra_expression.parse(self.$grid.$record,propProto.$links.$details.$url, record))];
                else 
                    return result;
                    */
			});
