...
exports.WordInterface = helpers.defineClass(WordInterface, null, {
    ...
    loadPage: function(resourceUrl, name, onLoaded, documentType) {
        ...
        if (documentType === "word-report-tpl" || documentType === "word-report-tpl-refresh" || documentType === "word-report" || documentType === "word-report-refresh")
       	{
        	document.controller.loadRepresentation(null, resourceUrl, function(response) {
        		...
        		self.fetchData(page, -1, null, function() {
        			...
        			} else if (documentType === "word-report-refresh") {
        				page.refreshWordDocument(self.wordInterfaceImpl);        			
        			}
        			onLoaded && onLoaded();
        		});
        	});
