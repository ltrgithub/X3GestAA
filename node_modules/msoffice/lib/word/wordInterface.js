...
exports.WordInterface = helpers.defineClass(WordInterface, null, {
    ...
    onLogin: function() {
        ...
        else if (documentType === "word-v6-upload")
        {
        	alert("word-v6-upload");
        }
        else
        {
	        if (resourceUrl != "")
...
//    	http://localhost:8124/sdata/x3/erp/SUPERV/IMAGE('C_AOBJBUR~BLOB~SQH~TEST')
    	
//    	http://localhost:8124/sdata/x3/erp/SUPERV/AOBJBUR('TEST')?representation=AOBJBUR.$details
//    	http://localhost:8124/sdata/x3/erp/SUPERV/AOBJBUR('SQH~TEST')?representation=AOBJBUR.$details
//    	main.html?url=http%3A%2F%2Flocalhost%3A8124%2Fsdata%2Fsyracuse%2Fcollaboration%2Fsyracuse%2Fusers('b75a3954-2c48-4c62-8ab4-ab1c92e27e23')%2F%24workingCopies%3Frepresentation%3Duser.%24edit%26role%3D3fcb1318-d234-458e-bf07-b9f293044510    	
    	var wcUuid = helpers.uuid.generate();
    	
    	var xhr = new XMLHttpRequest();
    	var data = {};
    	
    	var wcCreateURL = "http://localhost:8124/sdata/x3/erp/SUPERV/AOBJBURS('SQH~TEST')/$workingCopies?representation=AOBJBUR.$edit&trackingId=" + wcUuid;
    	var wcCreateURL = "http://localhost:8124/sdata/x3/erp/SUPERV/AUTILIS('ADMIN')/$workingCopies?representation=AUTILIS.$edit&trackingId=" + wcUuid;
    	var filename = "1.jpg";
    	
    	xhr.open('POST', wcCreateURL, false);
    	xhr.onreadystatechange = function(e) {
    		if (this.readyState == 4 && (this.status == 200 || this.status == 201)) {
    			var wc = JSON.parse(this.response);
    			wcUuid = wc.$uuid;

    			var imagePUTUrl = "http://localhost:8124/sdata/x3/erp/SUPERV/IMAGE('C_AOBJBUR~BLOB~" + wcUuid + "~SQH~TEST')";
    			var imagePUTUrl = "http://localhost:8124/sdata/x3/erp/SUPERV/IMAGE('C_AUTILIS~AUSPIC~" + wcUuid + "~AUSPIC~ADMIN')";
    			var xhr2 = new XMLHttpRequest();
    			xhr2.open('PUT', imagePUTUrl, false);
    			xhr2.setRequestHeader("content-type", "image/jpeg");
    			xhr2.setRequestHeader("accept", "application/json;vnd.sage=syracuse");
    			xhr2.setRequestHeader("x-file-name", filename);
