...
exports.handleDocument = function(_, document, documentUrl) {
	var customDataXml;
	var doc;
	...
	if (isZipFile == false) {
		var customDataObj = _docx_build_custom_data(_, null, null, "v6_doc_download", "1");
		...
		docxHelper.serve_docx_buffer(_, newDoc, document, 
			...
			function(_) {
				if (!customDataXml) {
					var customDataObj = _docx_build_custom_data(_, null, null, "v6_doc", "1");
