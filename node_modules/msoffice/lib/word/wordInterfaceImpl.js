...
exports.WordInterfaceImpl = helpers.defineClass(WordInterfaceImpl, null, {
	...
	createWordTemplate: function(layoutBoxes, data) {
		external.createWordTemplate(JSON.stringify({ "layout": layoutBoxes , "data": data}));	// add data to the template to be able to generate a preview
	},
