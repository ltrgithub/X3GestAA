...
exports.WordInterfaceImpl = helpers.defineClass(WordInterfaceImpl, null, {
	...
	populateWordTemplate: function(proto, data) {
		external.populateWordTemplate(JSON.stringify({
			"data": data,
			"proto": proto
		}));
	},
	...
	getBase64DocumentContent: function() {
		return external.GetDocumentContent();
	},
	...
	getSyracuseRole: function() {
		return external.getSyracuseRole();
	},
	getSyracuseLocale: function() {
		return external.getSyracuseLocale();
	},
	getSyracuseEndpoint: function() {
		return external.getSyracuseEndpoint();
	},
