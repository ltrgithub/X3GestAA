...
exports.WordInterfaceImpl = helpers.defineClass(WordInterfaceImpl, null, {
	...
	// used for documents from convergence
	v6Download: function(data, url) {
		external.v6Download(JSON.stringify(data));
	},
