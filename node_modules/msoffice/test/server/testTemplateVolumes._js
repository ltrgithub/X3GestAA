...
var doStop = false; 
var volumesToBePresent = [require("syracuse-collaboration/lib/entities/msoReportMode").template_storage_volume,
                          require("syracuse-collaboration/lib/entities/msoMailMergeDocSel").template_storage_volume];
