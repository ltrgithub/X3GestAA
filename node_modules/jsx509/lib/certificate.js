...
exports.stripEncryption = function(key, passphrase, test) {
	...
	if (r) {
		...
		return key;
	} else throw locale.format(module, "noPEM");
};
...
exports.Certificate = helpers.defineClass(function(buffer) {
	...
	verify: function(certificate) {
		...
		if (algorithm.type === asn1.types.OID) {
			...
			if (!verify.verify(certificate, this.parsed.children[2].getData())) throw "Signature could not be verified";
			return true;
		} else throw "Algorithm is not an OID";
	}
});
