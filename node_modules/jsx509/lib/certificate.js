...
exports.Certificate = helpers.defineClass(function(buffer) {
	...
	subject: {
		get: function() {
			...
			var node = this.parsed.children[0].children[type === asn1.types.INTEGER ? 4 : 5];
			return {
	...
	issuer: {
		get: function() {
			var type = this.parsed.children[0].children[0].type;
			var node = this.parsed.children[0].children[type === asn1.types.INTEGER ? 2 : 3];
			return {
				countryName: oidStrings(node, OIDS.at.countryName)[0],
				stateOrProvinceName: oidStrings(node, OIDS.at.stateOrProvinceName)[0],
				localityName: oidStrings(node, OIDS.at.localityName)[0],
	...
	notAfter: {
		get: function() {
			...
			var type = this.parsed.children[0].children[0].type;
			var node = this.parsed.children[0].children[type === asn1.types.INTEGER ? 3 : 4];
