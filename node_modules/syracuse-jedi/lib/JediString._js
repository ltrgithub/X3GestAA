...
var Jedi      = require('syracuse-jedi/lib/jedi.js');

var JediString = function (_buffer,_options){
  /*dbg*/tracer && tracer.log("var JediString");
...
JediString.prototype.readStream = function(_) {
  ...
  this.eof = true;
  /*dbg*/tracer && tracer.log("JediString.readStream=",buffer);
  return buffer;
}

JediString.prototype.read = function(_,_structure,transform){
  /*dbg*/tracer && tracer.log("JediString.read");
  var item;
...
JediString.prototype.parse = function(_,_structure){
  var jedi = new Jedi(this.options);
  /*dbg*/tracer && tracer.log("JediString.parse");
...
JediString.prototype.write = function(_,_value,_structure){
  ...
  var jedi = new Jedi(this.options)
  /*dbg*/jedi.log(3,"write buffer:",lStructure.buffer);
