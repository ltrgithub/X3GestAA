    ...
    "$properties": {
       "operations":{
        ...
        "$item":{
          ...
          "$after":"^\r\n",
          "$properties": {
            "date":       {"$type":"date"  ,"$before":"D","$format":"MM/DD/YY","$after":"\r\n"},
            "montant":    {"$type":"number","$before":"U","$format":"#########0,00","$after":"\r\n"},
            "montantT":   {"$type":"number","$before":"T","$format":"#########0,00","$after":"\r\n"},
            "type":       {"$type":"string","$before":"N","$after":"\r\n"},
            "libelle":    {"$type":"string","$before":"P","$after":"\r\n","$length":40},
            "memo":       {"$type":"string","$before":"M","$after":"\r\n","$length":40},
            "categorie":  {"$type":"string","$before":"L","$after":"\r\n"}
          }
        }
      }
    }
