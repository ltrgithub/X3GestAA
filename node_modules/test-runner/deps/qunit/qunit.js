	...
	test: function(testName, expected, callback, async) {
	    ...
	    synchronize(function() {
			...
			function recover(e) {
				...
				QUnit.ok( false, "Died on test #" + (config.assertions.length + 1) + ": " + e.stack );
			...
			try {
				callback.call(testEnvironment, function(err) {
					if (err) recover(err);
				});
			} catch(e) {
				recover(e);
...
addEvent(window, "load", function() {
	...
	var banner = id("qunit-header-title");
	if ( banner ) {
...
function addEvent(elem, type, fn) {
	if ( elem.addEventListener ) {
		console.log("addEventListener: " + type + " " + elem.id + " class=" + elem.className)
		elem.addEventListener( type, fn, false );
	} else if ( elem.attachEvent ) {
		console.log("on: " + type + " " + elem.id + "class=" + elem.className)
