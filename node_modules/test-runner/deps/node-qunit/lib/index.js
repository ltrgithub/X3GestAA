...
function logTest( obj ) {
	...
	if ( obj.errorStack ) {
		sys.print( format(  "[Error]" + descr + obj.message + "\n", "red" ) );
		if ( options.errorStack ) {
			sys.print(format( obj.errorStack, "red" ) + "\n" );
		}
	} else if ( !options.errorsOnly ) {
		sys.print( format( "[OK]", "green" ) + descr + obj.message + "\n" );
	}
