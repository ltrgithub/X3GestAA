...
function _runFile(_, file, verbose, results) {
	...
	try {		
		...
		var message = (summary.pass ? "PASS" : "FAIL") + " Module " + summary.module + " Exp: " + summary.expect + " Got: " + summary.got + " Err: " + summary.error;
		console.log(colors[summary.pass ? "green" : "red"](message));
    } finally {
		fs.closeSync(logfd);
	}
}
