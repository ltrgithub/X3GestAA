...
exports.BookmarksBar = helpers.defineClass(BookmarksBar, null, {
	...
	load: function(slot) {
		...
		bar.appendChild(this.morePicker = this.appendPicker("s-bookmarks-bar-more", null, document.site.localize.bookmarksMore));
		...
		// "more" picker
		this.morePicker = document.createElement("a");
		this.morePicker.className = "s-bookmarks-more-picker";
		this.morePicker.setAttribute("data-s-picker", "s-bookmarks-more-picker");
		this.morePicker.textContent = document.site.localize.bookmarksMore;
