...
exports.BookmarksBar = helpers.defineClass(BookmarksBar, null, {
	...
	getUrlParameter: function(href, transf) {
	...
	_httpQuery: function(href) {
		...
		if (selectedEndpoint && selectedEndpoint.application === endPointParts.application && selectedEndpoint.contract === endPointParts.contract) {
			httpQuery.$url = document.site.urlMaker.replaceEndpoint(httpQuery.$url, selectedEndpoint);
			httpQuery = document.controller.parseUrl(httpQuery.$url);
			httpQuery.$url = "?url=" + this.getUrlParameter(httpQuery.$url, encodeURIComponent);
		} else {
