...
exports.BookmarksBar = helpers.defineClass(BookmarksBar, null, {
	...
	load: function(slot) {
		...
		this.moreLinkOpenerSlot = document.createElement("div");
		this.moreLinkOpenerSlot.id = this.moreLinkOpenerSlot.className = "s-bookmarks-more-slot";
		bar.appendChild(this.moreLinkOpenerSlot);
