...
exports.BookmarkItemRecord = helpers.defineClass(BookmarkItemRecord, SingleRecord, {
	...
	_createMenusBox: function() {
		if (!this.menusSlot) {
			...
			this.page.loadNewItem(this.menusSlot, this.list.defineNewIconMenu("$cancelEdit", "s-nav-item-link", true), this);
		}
	},
	onMenuClick: function(menuItem) {
		switch (menuItem.$bind) {
			...
			case "$cancelEdit":
				...
				break;
			case "$edit":
				this.readField = this.singleField;
				//   document.site.removeDomChild(this.readField.variantItem.domItem);
	...
	drawBox: function() {
		...
		if (this.dataset.$singleField.menuItem) {
			this.applyChange({
				$actions: {
					$edit: {
						$title: "edit"
