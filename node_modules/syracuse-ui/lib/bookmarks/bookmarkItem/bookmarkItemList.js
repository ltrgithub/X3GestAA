...
var BarResizerDDAgent = require("syracuse-ui/lib/page/bar/barResizerDDAgent").BarResizerDDAgent;
...
exports.BarSplitter = helpers.defineClass(BarSplitter, null, {
	...
	ensureState: function() {
		if (!this.isHidden && !this._designing) {
			...
			/*if ((document.site && document.site.$item && document.site.$item.$device && document.site.$item.$device == "tablet" && this.options.resizeDirection.right)
             || document.site && document.site.$item && document.site.$item.$device && document.site.$item.$device == "desktop"){
