...
exports.show = function(message, target, options, severity) {
	if (message !== undefined) {
		...
		if (options && options.silent && message.$diagnoses) {
		...
		if (page && !page.disposed && !page.useAlertModal && page != syra_site && page != syra_site.userProfile) {
			if (!page.alertPanel) {
			...
			if (options) {
				...
				message.noViewer = options.noViewer;
			}
