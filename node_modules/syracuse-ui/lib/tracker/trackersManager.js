...
function _onStackClick() {
	...
	if (this.$opened && !diagnose.stackSlot) {
		diagnose.stackSlot = syra_dom.addDiv("s-tracker-stack", this.link.parentNode);
		syra_dom.addPreformatText("s-pre", diagnose.$diagnose.$stackTrace, diagnose.stackSlot);
	}
...
helpers.defineClass(TrackersPage, DesktopPage, {
	load: function() {
		...
		this.datetApi = syra_culture.date;
		this.dateLocalFormat = syra_culture.format.getDate();
		this.timeApi = syra_culture.time;
		this.timeLocalFormat = syra_culture.format.getTime();
