"use strict";
var _printerSetup = require('syracuse-ui/lib/site/aside/printerSetup');
...
exports.load = function(page) {
	var $prototype = _printerSetup.getSetupPage();
	$prototype.$x3Facet = "message";
	$prototype.$baseHelpUrl = "http://localhost:8124/help/fr-FR/x3/erp/superv/{$category}/{$keyword}";
	syra_site.deltaManager.applyObjectDelta(page, page.$prototype, $prototype, true);
	page.$prototype.$facet = "$edit";
