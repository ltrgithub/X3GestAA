...
var _pages = {
	DashboardConverter: {
		...
		$path: "syracuse-ui/lib/tests/dashboardConverter",
	...
	diagnoseCenter: {
		$title: "Diagnoses and Jobs Test",
		$path: "syracuse-ui/lib/tests/diagnoseCenterTest",
		$class: "DiagnoseCenterTest"
	},
	json: {
		$title: "Json Test",
	...
	process: {
		$title: "Process Test",
		$path: "syracuse-ui/lib/tests/process/processTest",
		$class: "ProcessTest"
	},
	fields: {
		$title: "Fields Test",
	...
	formula: {
		$title: "Formula Tests",
		$path: "syracuse-ui/lib/tests/formulaTest",
		$class: "FormulaTest"
	},
	selectPrinter: {
		$title: "Select Printer Tests",
		$path: "syracuse-ui/lib/tests/selectPrinterTest",
		$class: "SelectPrinterTest"
	},
	HighChartBarTest: {
		$title: "HighChart Bar",
		$path: "syracuse-ui/lib/tests/charts/bars",
		$class: "HighChartBarTest"
	},
	HighChartSpiderTest: {
		$title: "HighChart Spider",
		$path: "syracuse-ui/lib/tests/charts/spider",
		$class: "HighChartSpiderTest"
	},
	GanttTest: {
		$title: "Gantt",
		$path: "syracuse-ui/lib/tests/charts/gantt",
		$class: "GanttTest"
	}
};
	...
	$menus = [{
		$layout: {
			$items: [{
				...
				$bind: "testlink-DashboardConverter"
			}]
		}
	}, {
		$title: "Array",
		...
		$layout: {
			$items: [{
				$bind: "testlink-HighChartBarTest"
			}, {
				$bind: "testlink-HighChartSpiderTest"
			}, {
				$bind: "testlink-GanttTest"
			}]
		}
	}, {
		$title: "Pages",
