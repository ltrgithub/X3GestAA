...
exports.TestPage = helpers.defineClass(TestPage, DesktopPage, {
	dispose: function() {
		this.diposeTest && this.diposeTest();
	...
	load: function(initData) {
		...
		self.addMenus(_map, self.menuBar.body);
	...
	form_postAction: function(menuItem, target, value) {
		this.testCase && this.testCase.form_postAction && this.testCase.form_postAction(menuItem, target, value);
		return true;
	},
