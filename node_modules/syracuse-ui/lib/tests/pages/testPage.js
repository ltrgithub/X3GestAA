...
function _showDiagnosesSummary(page, show) {
	...
	syra_site.dom.hide(page.unitDiagnosesSlot, show === false);
}
	...
	if (names && names.length) {
		...
		names.forEach(function($name) {
			...
			scenario.forEach(function(unit) {
				...
				unit.button = syra_menus.button.add({
					parent: page,
					slot: block,
					text: unit.$title || "",
					css: menuCss,
...
exports.TestPage = helpers.defineClass(TestPage, DesktopPage, {
	...
	loadBox: function(initData) {
		...
		syra_site.dom.toggleClass(self.menuBar.body, "s-uitest-menubar-body", true);
