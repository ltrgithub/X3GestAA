...
exports.TestPage = helpers.defineClass(TestPage, DesktopPage, {
	...
	loadBox: function(initData) {
		...
		self.menuBar.body.appendChild(syra_menus.addTextButton("ui lock", "s-uitest-mn", "onNavTestMenuClick")).syraValue = "uilock";
		self.menuBar.body.appendChild(syra_menus.addTextButton("ui lock long", "s-uitest-mn", "onNavTestMenuClick")).syraValue = "uilocklong";
