...
function _addUnitTests(page, scenarios) {
	...
	page.rightCol.appendChild(syra_menus.addTextButton("Refresh list", "s-uitest-mn", "refreshData"));
	...
	Object.keys(scenarios).forEach(function($name) {
		...
		scenario.forEach(function(unit) {
			unit._link = block.appendChild(syra_menus.addTextButton(unit.$title || "", "s-uitest-unit-mn", "onUnitClick"));
