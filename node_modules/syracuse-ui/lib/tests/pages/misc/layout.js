...
exports.onFormUpdate = function(field, value) {
				...
				switch ($bind) {
					...
					default:
						Object.keys(page.idMap).forEach(function(id) {
							...
							if (box.$item.$test) {
								box.applyDesignMeta(metaData, true);
							}
						});
						break;
				}
