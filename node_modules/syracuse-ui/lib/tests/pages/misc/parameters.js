...
exports.load = function(page, finish) {
	...
	page.onMenuClick = function(options) {
		if (options.menu.$bind.indexOf("Parameter") > 0) {
			syra_url.formatMenuUrl(page, options.menu, null, function($url, isCanceled) {
				var result = {};
				result[options.menu.$bind + "FieldResult"] = JSON.stringify({
	...
	page.updateWorkingCopy = function(sendBag) {
