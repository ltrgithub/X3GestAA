...
exports.load = function(page, finish) {
	...
	page.diposeTest = function() {
		if (syra_nav.megaMenus.isTestPage) {
			syra_nav.megaMenus && syra_nav.megaMenus.dispose();
			syra_nav.toggleMegaMenus(true);
		}
	};
	syra_site.switchGPDC();
	syra_nav.megaMenus && syra_nav.megaMenus.dispose();
	syra_nav.toggleMegaMenus(true, _navigation.$representation);
	syra_nav.megaMenus.isTestPage = true;
	finish(page);
};