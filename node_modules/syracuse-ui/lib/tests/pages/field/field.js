...
exports.icon = {
	load: function(page, finish) {
		...
		var cols = [];
		for (var ii = 0; ii < 6; ii++) {
			cols.push(page.addCol(page.leftCol, 2));
		}
...
exports.editor = {
	load: function(page, finish) {
		...
		syra_item.ensureMediaTypes(page.$prototype, function() {
			...
			var box = page.addBox("textrtf");
			var slot = page.leftCol.appendChild(box.slot);
			page.addItem(page.addCol(box.body, 6), {
				$bind: "textrtf",
				$rows: 5,
				$isEditMode: true
			});
			...
			page.addFieldBlock(page.leftCol, "textplainxml", ["textplainxml"], function($edit) {
				$edit.$rows = 5;
			});
