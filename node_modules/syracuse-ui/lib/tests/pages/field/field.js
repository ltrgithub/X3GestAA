...
exports.editor = {
	load: function(page, finish) {
		...
		syra_item.ensureMediaTypes(page.$prototype, function() {
			...
			page.addFieldBlock(page.leftCol, "textxml", ["textxml"], function($edit) {
				$edit.$rows = 5;
			});
			page.refreshData = function() {
				page.applyChange({
...
exports.xmlJSON = {
	load: function(page, finish) {
		var self = this;
		self.goodXml = '<?xml version="1.0" encoding="UTF-8"?><RESULT DIM="10000" SIZE="10"><LIN NUM="1"><FLD NAME="USR" TYPE="Char">00001</FLD><FLD NAME="C2" TYPE="Char">QUERE yvonnic</FLD><FLD NAME="LOGIN" TYPE="Char">0001</FLD><FLD NAME="ADDEML" TYPE="Char">pascale.saintblancard@sage.com</FLD><FLD NAME="TELEP" TYPE="Char"/></LIN><LIN NUM="2"><FLD NAME="USR" TYPE="Char">00002</FLD><FLD NAME="C2" TYPE="Char">TESTEXTOURNE TEST</FLD><FLD NAME="LOGIN" TYPE="Char">TESTEXTOURNE</FLD><FLD NAME="ADDEML" TYPE="Char"/><FLD NAME="TELEP" TYPE="Char"/></LIN><LIN NUM="3"><FLD NAME="USR" TYPE="Char">00003</FLD><FLD NAME="C2" TYPE="Char"/><FLD NAME="LOGIN" TYPE="Char">001A1300000301</FLD><FLD NAME="ADDEML" TYPE="Char"/><FLD NAME="TELEP" TYPE="Char"/></LIN><LIN NUM="4"><FLD NAME="USR" TYPE="Char">00004</FLD><FLD NAME="C2" TYPE="Char">MARTY CECILE</FLD><FLD NAME="LOGIN" TYPE="Char">0012</FLD><FLD NAME="ADDEML" TYPE="Char"/><FLD NAME="TELEP" TYPE="Char"/></LIN><LIN NUM="5"><FLD NAME="USR" TYPE="Char">00005</FLD><FLD NAME="C2" TYPE="Char">INTERM Mimi</FLD><FLD NAME="LOGIN" TYPE="Char">0001300000310</FLD><FLD NAME="ADDEML" TYPE="Char"/><FLD NAME="TELEP" TYPE="Char"/></LIN><LIN NUM="6"><FLD NAME="USR" TYPE="Char">00006</FLD><FLD NAME="C2" TYPE="Char">TESTUSER PRENOM</FLD><FLD NAME="LOGIN" TYPE="Char">TESTUSER</FLD><FLD NAME="ADDEML" TYPE="Char"/><FLD NAME="TELEP" TYPE="Char"/></LIN><LIN NUM="7"><FLD NAME="USR" TYPE="Char">00017</FLD><FLD NAME="C2" TYPE="Char">FARAMA Corinne</FLD><FLD NAME="LOGIN" TYPE="Char">HR02D1200000002</FLD><FLD NAME="ADDEML" TYPE="Char"/><FLD NAME="TELEP" TYPE="Char"/></LIN><LIN NUM="8"><FLD NAME="USR" TYPE="Char">00018</FLD><FLD NAME="C2" TYPE="Char">DIAZ Sherley</FLD><FLD NAME="LOGIN" TYPE="Char">HR2BA1200000003</FLD><FLD NAME="ADDEML" TYPE="Char"/><FLD NAME="TELEP" TYPE="Char"/></LIN><LIN NUM="9"><FLD NAME="USR" TYPE="Char">00019</FLD><FLD NAME="C2" TYPE="Char">81652 81652</FLD><FLD NAME="LOGIN" TYPE="Char">0001200000024</FLD><FLD NAME="ADDEML" TYPE="Char"/><FLD NAME="TELEP" TYPE="Char"/></LIN><LIN NUM="10"><FLD NAME="USR" TYPE="Char">00020</FLD><FLD NAME="C2" TYPE="Char">CHATOUILLE Sam</FLD><FLD NAME="LOGIN" TYPE="Char">0001200000222</FLD><FLD NAME="ADDEML" TYPE="Char">pascale.saintblancard@sage.com</FLD><FLD NAME="TELEP" TYPE="Char"/></LIN></RESULT>';
		self.goodJson = '[{"USR":"00001","C2":"QUERE yvonnic","LOGIN":"0001","ADDEML":"pascale.saintblancard@sage.com","TELEP":""},{"USR":"00002","C2":"TESTEXTOURNE TEST","LOGIN":"TESTEXTOURNE","ADDEML":"","TELEP":""},{"USR":"00003","C2":"","LOGIN":"001A1300000301","ADDEML":"","TELEP":""},{"USR":"00004","C2":"MARTY CECILE","LOGIN":"0012","ADDEML":"","TELEP":""},{"USR":"00005","C2":"INTERM Mimi","LOGIN":"0001300000310","ADDEML":"","TELEP":""},{"USR":"00006","C2":"TESTUSER PRENOM","LOGIN":"TESTUSER","ADDEML":"","TELEP":""},{"USR":"00017","C2":"FARAMA Corinne","LOGIN":"HR02D1200000002","ADDEML":"","TELEP":""},{"USR":"00018","C2":"DIAZ Sherley","LOGIN":"HR2BA1200000003","ADDEML":"","TELEP":""},{"USR":"00019","C2":"81652 81652","LOGIN":"0001200000024","ADDEML":"","TELEP":""},{"USR":"00020","C2":"CHATOUILLE Sam","LOGIN":"0001200000222","ADDEML":"pascale.saintblancard@sage.com","TELEP":""}]'

		page.$prototype.$properties.xmlField = {
			$title: "xml",
			$type: "text/xml"
		};
		page.$prototype.$properties.xmlBadField = {
			$title: "xml bad",
			$type: "text/xml"
		};
		page.$prototype.$properties.xmlJsonField = {
			$title: "XML will receive JSON in 2 s",
			$type: "text/xml"
		};
		page.$prototype.$properties.jsonField = {
			$title: "JSON",
			$type: "application/json"
		};
		page.$prototype.$properties.jsonBadField = {
			$title: "JSON bad",
			$type: "application/json"
		};
		page.$prototype.$properties.jsonXMLField = {
			$title: "JSON will receive XML in 2 s",
			$type: "application/json"
		};
		page.refreshData = function() {
			var $properties = {};
			...
			page.applyChange({
				$properties: $properties,
				xmlField: self.goodXml,
				xmlBadField: '<?xml version="1.0" encoding="UTF-8"?><RESULT DIM="10000" SIZhar">00001</FLD><FLD NAME="C2" TYPE="Char">QUERE yvonnic</FLD><FLD NAME="LOGIN" TYPE="Char">0001</FLD><FLD NAME="ADDEML" TYPE="Char">pascale.saintblancard@sage.com</FLD><FLD NAME="TELEP" TYPE="Char"/></LIN><LIN NUM="2"><FLD NAME="USR" TYPE="Char">00002</FLD><FLD NAME="C2" TYPE="Char">TESTEXTOURNE TEST</FLD><FLD NAME="LOGIN" TYPE="Char">TESTEXTOURNE</FLD><FLD NAME="ADDEML" TYPE="Char"/><FLD NAME="TELEP" TYPE="Char"/></LIN><LIN NUM="3"><FLD NAME="USR" TYPE="Char">00003</FLD><FLD NAME="C2" TYPE="Char"/><FLD NAME="LOGIN" TYPE="Char">001A1300000301</FLD><FLD NAME="ADDEML" TYPE="Char"/><FLD NAME="TELEP" TYPE="Char"/></LIN><LIN NUM="4"><FLD NAME="USR" TYPE="Char">00004</FLD><FLD NAME="C2" TYPE="Char">MARTY CECILE</FLD><FLD NAME="LOGIN" TYPE="Char">0012</FLD><FLD NAME="ADDEML" TYPE="Char"/><FLD NAME="TELEP" TYPE="Char"/></LIN><LIN NUM="5"><FLD NAME="USR" TYPE="Char">00005</FLD><FLD NAME="C2" TYPE="Char">INTERM Mimi</FLD><FLD NAME="LOGIN" TYPE="Char">0001300000310</FLD><FLD NAME="ADDEML" TYPE="Char"/><FLD NAME="TELEP" TYPE="Char"/></LIN><LIN NUM="6"><FLD NAME="USR" TYPE="Char">00006</FLD><FLD NAME="C2" TYPE="Char">TESTUSER PRENOM</FLD><FLD NAME="LOGIN" TYPE="Char">TESTUSER</FLD><FLD NAME="ADDEML" TYPE="Char"/><FLD NAME="TELEP" TYPE="Char"/></LIN><LIN NUM="7"><FLD NAME="USR" TYPE="Char">00017</FLD><FLD NAME="C2" TYPE="Char">FARAMA Corinne</FLD><FLD NAME="LOGIN" TYPE="Char">HR02D1200000002</FLD><FLD NAME="ADDEML" TYPE="Char"/><FLD NAME="TELEP" TYPE="Char"/></LIN><LIN NUM="8"><FLD NAME="USR" TYPE="Char">00018</FLD><FLD NAME="C2" TYPE="Char">DIAZ Sherley</FLD><FLD NAME="LOGIN" TYPE="Char">HR2BA1200000003</FLD><FLD NAME="ADDEML" TYPE="Char"/><FLD NAME="TELEP" TYPE="Char"/></LIN><LIN NUM="9"><FLD NAME="USR" TYPE="Char">00019</FLD><FLD NAME="C2" TYPE="Char">81652 81652</FLD><FLD NAME="LOGIN" TYPE="Char">0001200000024</FLD><FLD NAME="ADDEML" TYPE="Char"/><FLD NAME="TELEP" TYPE="Char"/></LIN><LIN NUM="10"><FLD NAME="USR" TYPE="Char">00020</FLD><FLD NAME="C2" TYPE="Char">CHATOUILLE Sam</FLD><FLD NAME="LOGIN" TYPE="Char">0001200000222</FLD><FLD NAME="ADDEML" TYPE="Char">pascale.saintblancard@sage.com</FLD><FLD NAME="TELEP" TYPE="Char"/></LIN></RESULT>',
				xmlJsonField: self.goodXml,
				jsonField: self.goodJson,
				jsonBadField: '[{"US0222","ADDEML":"pascale.saintblancard@sage.com","TELEP":""}]',
				jsonXMLField: self.goodJson
			});
		};
		syra_item.ensureMediaTypes(page.$prototype, function() {
			var left = page.addCol(page.leftCol, "50%");
			var right = page.addCol(page.leftCol, "50%");

			var xmlBox = page.addBox("xml", "h2");
			left.appendChild(xmlBox.slot);
			page.addItem(xmlBox.body, {
				$bind: "xmlField"
			});
			page.addItem(xmlBox.body, {
				$bind: "xmlBadField"
			...
			var jsonBox = page.addBox("xml", "h2");
			right.appendChild(jsonBox.slot);
			page.addItem(jsonBox.body, {
				$bind: "jsonField"
			});
			page.addItem(jsonBox.body, {
				$bind: "jsonBadField"
			...
			self.nextAction(function() {
				page.applyChange({
					$properties: {
						xmlJsonField: {
							$title: "JSON with no type update (null in 2s)"
						},
						jsonXMLField: {
							$title: "XML with no type update (null in 2s)"
						}
					},
					xmlJsonField: self.goodJson,
					jsonXMLField: self.goodXml
				});
				self.nextAction(function() {
					page.applyChange({
						$properties: {
							xmlJsonField: {
								$title: "Null value (JSON with type update in 2s)"
							},
							jsonXMLField: {
								$title: "Null value (XML with type update  in 2s)"
							}
						},
						xmlJsonField: null,
						jsonXMLField: null
					...
					self.nextAction(function() {
						page.applyChange({
							$properties: {
								xmlJsonField: {
									$type: "application/json",
									$title: "JSON with type update"
								},
								jsonXMLField: {
									$type: "text/xml",
									$title: "XML with type update"
								}
							},
							xmlJsonField: self.goodJson,
							jsonXMLField: self.goodXml
