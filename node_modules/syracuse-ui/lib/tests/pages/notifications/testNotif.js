...
exports.load = function(page) {
	...
	var socket = socketHandler.register("/unit_test", {
		...
		delDynEvent: function(data) {
			// remove button
			syra_menus.button.hide(dina1, true);
			syra_menus.button.hide(dina2, true);
			if (socketDynamic) {
	...
	page.onTestButtonClick1 = function() {
		...
		socketDynamic = socketHandler.register(dynamicUnit, {
			...
			connectTest: function(data) {
				...
				dina1 = dina1 || syra_menus.button.add({
					parent: page,
					slot: page.layoutContent.domItem,
					text: "dynamicEvent1",
					css: "s-uitest-mn",
					btnclick: page.dynamic1,
					isHidden: true
				});
				dina2 = dina2 || syra_menus.button.add({
					parent: page,
					slot: page.layoutContent.domItem,
					text: "dynamicEvent2",
					css: "s-uitest-mn",
					btnclick: page.dynamic2,
					isHidden: true
				});
				syra_menus.button.hide(dina1, false);
				syra_menus.button.hide(dina2, false);
			}
		});
	};
	syra_menus.button.add({
		...
		text: "testEvent1",
		slot: page.layoutContent.domItem,
		btnclick: page.onTestButtonClick2
	});
	syra_menus.button.add({
		parent: page,
		css: "s-uitest-mn",
		slot: page.layoutContent.domItem,
		text: "testEvent2",
		btnclick: page.onTestButtonClick3
	});
	syra_menus.button.add({
		parent: page,
		slot: page.layoutContent.domItem,
		...
		btnclick: page.onTestButtonClick1
	});
	syra_menus.button.add({
		parent: page,
		slot: page.layoutContent.domItem,
		...
		btnclick: page.onTestButtonClick4
	});
