...
input[type =
"number"]::-webkit-inner-spin-button, input[type = "number"]::-webkit-outer-spin-button {
    height: auto;
}
...
@font-face {font-family:
    'Sage Armonye Icons';
    src:
    url('../fonts/sagearmonyeicons.eot');
    src:
    url('../fonts/sagearmonyeicons.eot?#iefix') format('embedded-opentype'), url('../fonts/sagearmonyeicons.woff') format('woff'), url('../fonts/sagearmonyeicons.ttf') format('truetype'), url('../fonts/sagearmonyeicons.svg#sagearmonyeicons') format('svg');
}[data-icon]:before {
...
.glyphicon-window:before {
    content: "e";
}

.glyphicon-quick-help:before {
    content: "f";
}

.glyphicon-quick-close:before {
    content: "\2297";
}

.glyphicon-quick-add:before {
    content: "\2295";
}
...
.glyphicon-prev-all:before {
    content: "\ab";
}

.glyphicon-quick-info:before {
    content: "\a1";
}

.glyphicon-quick-subtract:before {
    content: "\2205";
}
...
.glyphicon-garbage:before {
    content: "K";
}

.glyphicon-graph-bar:before {
    content: "L";
}
...
.glyphicon-doc-search:before {
    content: "X";
}

.glyphicon-doc-pdf:before {
    content: "Y";
}

.glyphicon-diagram:before {
    content: "Z";
}

.glyphicon-confirm:before {
    content: "0";
}
...
input[type="checkbox"] {
  ...
  margin-top: 1px \9;
  line-height: normal;
  /* hide the input, but still clickable */
  opacity: 0;
  width: 22px;
}
input[type="file"] {
...
.checkbox-inline label:after {
  ...
  width: 22px;
  height: 22px;
  background: transparent url('/assets/img/sprite_form.png') no-repeat -3px -31px;
...
.radio input[type='checkbox'] + label:hover:after,
.checkbox input[type='checkbox'] + label:hover:after,
.radio-inline input[type='checkbox'] + label:hover:after,
.checkbox-inline input[type='checkbox'] + label:hover:after {
  background-position: -38px -31px;
}
.radio input[type='checkbox']:focus + label:after,
.checkbox input[type='checkbox']:focus + label:after,
.radio-inline input[type='checkbox']:focus + label:after,
...
.radio-inline input[type='checkbox']:checked + label:hover:after,
.checkbox-inline input[type='checkbox']:checked + label:hover:after {
  background-position: -38px -3px;
}
.radio input[type='checkbox'][disabled] + label:after,
.checkbox input[type='checkbox'][disabled] + label:after,
.radio-inline input[type='checkbox'][disabled] + label:after,
...
.radio-inline input[type='checkbox'][disabled]:checked + label:after,
.checkbox-inline input[type='checkbox'][disabled]:checked + label:after {
  background-position: -73px -3px;
}
.radio input[type='checkbox']:checked:focus + label:after,
.checkbox input[type='checkbox']:checked:focus + label:after,
.radio-inline input[type='checkbox']:checked:focus + label:after,
.checkbox-inline input[type='checkbox']:checked:focus + label:after {
  background-position: -38px -3px;
}
...
.radio-inline input[type='radio'] + label:hover:after,
.checkbox-inline input[type='radio'] + label:hover:after {
  background-position: -38px -87px;
}
.radio input[type='radio']:focus + label:after,
.checkbox input[type='radio']:focus + label:after,
.radio-inline input[type='radio']:focus + label:after,
.checkbox-inline input[type='radio']:focus + label:after {
  background-position: -38px -87px;
}
...
.radio-inline input[type='radio']:checked + label:hover:after,
.checkbox-inline input[type='radio']:checked + label:hover:after {
  background-position: -38px -59px;
}
.radio input[type='radio'][disabled] + label:after,
.checkbox input[type='radio'][disabled] + label:after,
.radio-inline input[type='radio'][disabled] + label:after,
.checkbox-inline input[type='radio'][disabled] + label:after {
...
.radio-inline input[type='radio'][disabled]:checked + label:after,
.checkbox-inline input[type='radio'][disabled]:checked + label:after {
  background-position: -73px -59px;
}
.radio input[type='radio']:focus:checked + label:after,
.checkbox input[type='radio']:focus:checked + label:after,
.radio-inline input[type='radio']:focus:checked + label:after,
.checkbox-inline input[type='radio']:focus:checked + label:after {
  background-position: -38px -59px;
}
...
fieldset[disabled] input[type='checkbox']:checked + label:after {
  background-position: -73px -3px;
}
.disabled input[type='radio'] + label:after,
fieldset[disabled] input[type='radio'] + label:after {
  background-position: -73px -87px;
}
.disabled input[type='radio']:checked + label:after,
fieldset[disabled] input[type='radio']:checked + label:after {
  background-position: -73px -59px;
}
...
.nav-tabs > li > a:hover {
  border-color: #f5f6f7 #f5f6f7 #dddddd;
}
...
.form-section-sub .section-heading .checkbox,
.form-section-sub .section-heading .radio {
  margin-top: 0;
}
.dependency {
  margin-top: 20px;
...
.k-grid .checkbox {
  ...
  height: 22px;
  margin: 0;
  background: transparent url('/assets/img/sprite_form.png') no-repeat -3px -30px;
  background-size: 110px 110px;
}
.k-grid .checkbox.selected {
...
.grid-toolbar .radio-inline,
.grid-toolbar .checkbox-inline {
  margin: 0;
  display: inline;
}
.grid-toolbar input + .radio-inline,
.grid-toolbar input + .checkbox-inline {
  margin: 0 0 0 20px;
}
.grid-toolbar .btn {
  font-size: 12px;
...
.k-grid-pager ÃŸ .k-state-disabled:hover {
  opacity: 0.25;
  cursor: default;
}
.k-pager-nav {
