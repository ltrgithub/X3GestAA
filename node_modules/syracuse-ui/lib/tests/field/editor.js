...
exports.load = function(page) {
	...
	page.addFieldBlock(root, "textplain", ["textplain"]);
	page.addFieldBlock(root, "textrtf", ["textrtf"], function($edit) {
		$edit.$rows = 5;
	});
	page.addFieldBlock(root, "texthtml", ["texthtml"], function($edit) {
		$edit.$rows = 5;
	});
