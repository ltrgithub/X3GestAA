...
exports.FieldsTest = helpers.defineClass(FieldsTest, TestPage, {
    ...
    loadBox: function(initData){
        ...
        this.$prototype.$field$isDiagnosesPanelHidden = true;
        this._defineArticle();
        initData = initData || {};
            ...
            default:
                if (field.$item.$bind.indexOf("$field") == 0) {
                    if (field.$item.$bind.indexOf("$field$capability") >= 0) {
                        ...
                        self.applyFieldMetaData("$capabilities", $capabilities, self.$prototype.$properties[field.$item.$bind])
                    }
                    else {
                        switch (field.$item.$bind) {
                            case "":
