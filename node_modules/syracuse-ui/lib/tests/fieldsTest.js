    ...
    onNotifyRecordChange: function(value, binding){
        ...
        switch (binding) {
            case "$field$LinksType":
                ...
                var isLinksTypeMetaDataOnly = self.boundFields.$field$LinksTypeMetaDataOnly[0].getDataValue();
                    ...
                    if (bind.indexOf("$field") != 0) {
                        ...
                        if ($recordItem) {
                            if (isLinksTypeMetaDataOnly) {
                                ...
                                dataRecordSet[bind] = [];
                                self.dataset[bind].forEach(function(dataRecord){
                                    dataRecord.$links = metaData.$links;
                                    dataRecord.$actions = metaData.$actions;
                                    if ($recordItem.$properties) {
