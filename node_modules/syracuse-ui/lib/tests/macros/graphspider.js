...
exports.$prototype = {
		...
		"A": {
			...
			"$links": {
				"$pptslide": {
					...
					"$url": "/sdata/x3stb/erp/stubs/HighCharts?representation=HighCharts.$query&pptMode=newSlide&$bind=A",
	...
	"$representationUrl": "/sdata/x3stb/erp/stubs/HighCharts?representation=HighCharts.$query"
};
