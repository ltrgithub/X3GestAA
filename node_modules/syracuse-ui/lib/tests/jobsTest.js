        ...
        if (menu.$bind == 'printJob' || menu.$bind == 'operationJob') {
            ...
            var newData = {
                ...
                $jobDetails: [{
                    ...
                    elapsedSeconds: 10,
                    remainingSeconds: 50,
                    diagnoseError: "diagnose error \n testt teesttatadada da",
                    diagnoseWarning: "diagnose warning test",
                    $properties: {
                        diagnoseError: isPropertyHidden,
                        diagnoseWarning: isPropertyHidden,
                ...
                $properties: {
                    $jobType: {
                        $value: {
                            $enum: jobsViewer._getJobsTypesEnum()
                        }
                    }
                }
            };
