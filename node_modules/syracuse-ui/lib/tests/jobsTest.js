...
exports.JobsTest = helpers.defineClass(JobsTest, TestPage, {
    ...
    onMenuClick: function(menu){
        ...
        switch (menu.$bind) {
            case "simpleJob":
                $url = "http://localhost:8126/sdata/sprint1/settings/sprint1/employees?representation=employee.$query&trackngId=1";
                break;
            case "printJob":
                //$url = "http://localhost:8126/print/ecvmdev2003x64:1890/$getState('uuid')";
				$url = "http://localhost:8126/print/ecvmdev2003x64:1890/$getState('5f86de15-c4d6-4b25-9b09-a2b406528c64')";
                break;
        }
