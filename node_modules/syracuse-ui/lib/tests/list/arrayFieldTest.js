...
exports.ArrayFieldTest = helpers.defineClass(ArrayFieldTest, FieldsTest, {
    ...
    notifyActionChange: function(target, value){
        ...
        if (value.$applyStyleToArray || value.$applyStyleToRecord || value.$applyStyleToField) {
            ...
            this._notifyConvergenceStyle(convergenceStyle.$styles[this.dataset.$field$convergenceStyle].$css, level);
        }
    ...
    notifyDataChange: function(field, value){
        ...
        switch (field.$item.$bind) {
            ...
            case "$fieldRecordCount":
                ...
                notify = false;
                break;
            case "$field$convergenceStyle":
                this.applyChange({
                    $field$convergenceStyleDesc: convergenceStyle.$styles[value].$css
                });
    ...
    loadBox: function(){
        var self = this;
        FieldsTest.prototype.loadBox.call(self, self._makeArrayPrototype(), {
            $fieldRecordCount: 8,
            $field$fixedBodyHeight: 0,
            $field$fitContainer: false,
            $field$convergenceStyle: Object.keys(convergenceStyle.$styles)[0]
        });
        ...
        self.idMap.editSection.openBox(true);
    },
    ...
    _makeArrayPrototype: function(){
        return {
            "$properties": {
                ...
                "$field$convergenceStyle": {
                    $title: "$convergenceStyle",
                    $type: "application/x-choice",
                    $value: {
                        $type: "application/x-integer",
            ...
            $items: [{
                ...
                $layout: {
                    $items: [{
                        ...
                        $bind: "$field$convergenceStyle",
                        $choiceLayout: 4,
                        $format: "$combo",
                        $isEditMode: true
                    }, {
                        $bind: "$field$convergenceStyleDesc",
                        $isTitleHidden: true
                    }]
                }
            }]
    ...
    _notifyConvergenceStyle: function($convergenceStyle, level){
        var self = this;
        var dataRecordSet = {
            $properties: {}
        };
