...
exports.ArrayFieldTest = helpers.defineClass(ArrayFieldTest, FieldsTest, {
    ...
    onNotifyRecordChange: function(value, binding){
        if (binding == "$fieldRecordCount") {
            ...
            if (binding == "xarray") {
                ...
                page.$etag = page.$etag || 1;
                if (page.sendBag && page.sendBag.$etag == page.$etag) {
                }
                else {
					page.sendBag = {};
                    page.sendBag.$etag = page.$etag;
                }
				page.sendBag[binding] = value;
                this.boundFields.$fieldServerData[0].setDataValue(JSON.stringify(page.sendBag));
                return null;
            }
    ...
    loadBox: function(){
        var self = this;
        debugger;
        self.getPage().$isNewCollectionEdit = true;
        var $prototype = {
            "$properties": {
                "$field$type": {
                    $isHidden: true
