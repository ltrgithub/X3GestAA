...
exports.GraphTest = helpers.defineClass(GraphTest, ArrayFieldTest, {
    refreshList: function(records){
        if (records === undefined) {
            ...
            this.boundFields.$field$dataset[0].setDataValue(JSON.stringify(records = this.getResources().getCube()));
        }
        this.applyChange({
            $properties: {
                "xarray": {
