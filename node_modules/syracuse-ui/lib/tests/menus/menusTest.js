...
exports.MenusTest = helpers.defineClass(MenusTest, TestPage, {
	...
	_initiliazeTestPage: function() {
		...
		this.defineMenu("s-mn-main", "s-mn-main");
		this.defineMenu("s-mn-tools", "s-mn-tools");
		this.defineMenu("s-mn-extra", "s-mn-extra");
		this.defineMenu("s-mn-business", "s-mn-business");
		this.defineMenu("s-mn-prefer", "s-mn-prefer");
