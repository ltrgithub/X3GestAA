...
exports.TestCase = helpers.defineClass(TestCase, TestPage, {
	loadBox: function() {
		...
		this.layoutContent.layoutSlot.appendChild(syra_menus.addTextButton("Copy Old Dashboard and click", "s-uitest-mn", "onConvertClick"));

		var col = this.addCol(this.layoutContent.layoutSlot, "50%");
