...
var singleTestCases = require("./single/singleTestCases");
var utility = require("syracuse-ui/lib/tests/array/utility");



function _addCapabilitySetting(testPage) {
	syra_site.deltaManager.applyObjectDelta(testPage, testPage.$prototype, {
		$properties: {
...
exports.TestCase = helpers.defineClass(TestCase, Fields, {
	...
	notifyDataChange: function(field, value) {
		...
		if (notify) {
			Fields.prototype.notifyDataChange.call(self, field, value);
		}
	},
	_fillDiagnoses: function(value, $bind) {
		var metaData = Fields.prototype._fillDiagnoses.call(this, value, $bind);
		if ($bind.indexOf("array") == 0) {
	...
	loadBox: function() {
		...
		_addCapabilitySetting(this);
		Fields.prototype.loadBox.call(this);

		this.addMetaSectionField("$field$LinksTypeMetaDataOnly");
		this.addMetaSectionField("$field$LinksType");

		var box = this.addBox("$capabilities", "h2");
		...
		var box = this.addBox("$diagnoses", "h2");
		this.loadNewItem(box.body, {
		...
		var box = this.addBox("Max Min Items", "h2");
