...
exports.JobsTest = helpers.defineClass(JobsTest, TestPage, {
	...
	onMenuClick: function(menu) {
		...
		if (menu.$bind == 'printJob' || menu.$bind == 'operationJob') {
			...
			//====== for tests scenario
			syra_site.jobsPage.updateJobsTypesList("print", true);
			syra_site.jobsPage.updateJobsTypesList("print", true);
			syra_site.jobsPage.updateJobsTypesList("operation", true);
			syra_site.jobsPage._updateJobsViewCount('add');
			syra_site.jobsPage._updateJobsViewCount('add');
			syra_site.jobsPage._updateJobsViewCount('add');
			syra_site.jobsPage.jobs = {};
			...
			syra_site.jobsPage.toggle();
			syra_site.jobsPage.isPageLoaded = true;
			syra_site.jobsPage.applyChange(newData);
			return false;
		}
