...
exports.FieldsTest = helpers.defineClass(FieldsTest, TestPage, {
	...
	loadBox: function(initData) {
		...
		syra_site.spyer.setSpyedPage(this);
	},
	...
	notifyDiagnoses: function(value, useMetaDataOnly) {
		...
		// to test cases in which property with diagnoses is not available in the representation
		/*
         dataRecordSet.$properties.$test = {
         $diagnoses: [{
         severity: "error",
         message: "this error is associated to a property not available in the representation"
         }]
         };*/
