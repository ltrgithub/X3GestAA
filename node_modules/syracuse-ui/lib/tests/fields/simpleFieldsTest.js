...
exports.SimpleFieldsTest = helpers.defineClass(SimpleFieldsTest, FieldsTest, {
	...
	_makeBlockhg: function($isEditMode) {
	...
	_makeBlock: function($isEditMode) {
		return [this._makeEditReadBlock("xstring", [{
			...
			$bind: "xinteger"
		}]), this._makeEditReadBlock("Localizable", [{
			$bind: "xstring$localizable"
		}, {
			$bind: "xstring$localizablePicker",
			$useLocalizePicker: true
		}]), this._makeEditReadBlock("Progress", [{
			$bind: "xProgress"
		}]), this._makeEditReadBlock("Decimal", [{
			$bind: "xdecimal"
		}]), this._makeEditReadBlock("Quantity", [{
			$bind: "xquantity1"
		}, {
			$bind: "xquantity2"
		}]), this._makeEditReadBlock("xboolean", [{
