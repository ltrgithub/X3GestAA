...
exports.load = function(page) {
	page.$prototype.$title = "Tests HighCharts";
	...
	var col1 = page.addCol(page.layoutContent.domItem, "50%");
	var col2 = page.addCol(page.layoutContent.domItem, "50%");
	page.loadNewItem(col1, {
		$bind: "A",
		$renderer: "highCharts"
	});
	page.loadNewItem(col1, {
