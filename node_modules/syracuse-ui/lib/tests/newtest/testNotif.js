...
exports.load = function(page) {
	...
	var socket = socketHandler.register("unit_test", "/unit_test", {
		...
		removeDynamicEvent: function(data) {
			// remove button
			syra_site.dom.display(dina1, false);
			syra_site.dom.display(dina2, false);
			socketHandler.unregister("unit_test2");
		},
	...
	dina1 = syra_menus.addTextButton("dynamicEvent1", "s-uitest-mn", "dynamic1");
	dina2 = syra_menus.addTextButton("dynamicEvent2", "s-uitest-mn", "dynamic2");
	syra_site.dom.display(dina1, false);
	syra_site.dom.display(dina2, false);

	page.layoutContent.domItem.appendChild(dina1);
	page.layoutContent.domItem.appendChild(dina2);
	...
	page.onTestButtonClick1 = function() {
		...
		socketDynamic = socketHandler.register("unit_test2", "/unit_test2", {
			...
			connectTest: function(data) {
				...
				syra_site.dom.display(dina1, true);
				syra_site.dom.display(dina2, true);
			}
		});
	};
};