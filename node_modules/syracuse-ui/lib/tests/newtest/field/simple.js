...
exports.load = function(page) {
	...
	$props.xstring$localizable = {
		...
		$links: {
			$localize: {
				$title: "Translations",
				$url: "/syracuse-ui/lib/tests/datasamples/localizablePropertyTest.json"
			}
		}
	};
	...
	page.addFieldBlock(root, "xstring", ["unknow", "notdefined", "xstring", "$phone", "$email"]);
	page.addFieldBlock(root, "xboolean", ["xdate", "xtime", "xdatetime"]);
	page.addFieldBlock(root, "Numeric", ["xinteger"]);
	page.addFieldBlock(root, "Localizable", ["xstring$localizable", "xstring$localizablePicker"], function($edit) {
		if ($edit.$bind == "xstring$localizablePicker") {
			$edit.$useLocalizePicker = true;
		}
	});
	page.addFieldBlock(root, "Progress", ["xProgress"]);
	page.addFieldBlock(root, "Decimal", ["xdecimal"]);
	page.addFieldBlock(root, "Quantity", ["xquantity1", "xquantity2"]);
	page.addFieldBlock(root, "xboolean", ["xboolean"]);
	page.addFieldBlock(root, "xboolean", ["xchoice", "xchoice", "xchoice"]);
	...
	page.addFieldBlock(root, "xreference", ["xreference"]);
	page.addFieldBlock(root, "image", ["image"]);
