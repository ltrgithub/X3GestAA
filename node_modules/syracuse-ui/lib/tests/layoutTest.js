...
exports.LayoutTest = helpers.defineClass(LayoutTest, TestPage, {
	loadBox: function(initData) {
		...
		div.innerHTML = '<div class="s-page-head-breadcrumb"><div class="s-page-breadcrumb-link-slot-first">Dictionnaire des écrans</div><div class="s-page-breadcrumb-link-slot-next">Dictionnaire des actions</div><div class="s-page-breadcrumb-link-slot-last">Codes activité<a class="s-page-breadcrumb-link" href="#" title=""></a></div></div>';
		this.domItem.insertBefore(div, this.domItem.firstChild);
		var div = document.createElement("div");
		div.innerHTML = '<div class="s-page-head-breadcrumb-new"><div class="s-page-breadcrumb-link-item">Dictionnaire des écrans<div class="s-page-breadcrumb-link-between"/></div><div class="s-page-breadcrumb-link-item">Dictionnaire des actions<div class="s-page-breadcrumb-link-between"/></div><div class="s-page-breadcrumb-link-item">Codes activité<a class="s-page-breadcrumb-link-new" href="#" title=""></a></div></div>';
		this.domItem.insertBefore(div, this.domItem.firstChild);
