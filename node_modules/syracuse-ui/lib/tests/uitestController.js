...
var _pages = {
    ...
    single: {
        ...
        $path: "syracuse-ui/lib/tests/array/singleArrayTest",
        $class: "SingleArrayTest"
    },
    array: {
        $title: "Array Test",
        $path: "syracuse-ui/lib/tests/array/multiArrayTest",
        $class: "MultiArrayTest"
    },
    graph: {
        $title: "Array Graph Test",
        $path: "syracuse-ui/lib/tests/array/graphTest",
        $class: "GraphTest"
    },
    param: {
...
exports.openPage = function(httpQuery){
    ...
    var test = JSON.stringify($links, null, 2);
