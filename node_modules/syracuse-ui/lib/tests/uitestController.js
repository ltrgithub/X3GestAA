...
var _$menus = [{
	...
	$title: "Charts",
	$menus: [{
		$url: "?representation=s-uitest.$test&screen=charts_bar",
		$title: "HighChart Bar"
	}, {
		$url: "?representation=s-uitest.$test&screen=charts_spider",
		$title: "HighChart Spider"
	}, {
		$url: "?representation=s-uitest.$test&screen=charts_gantt",
		$title: "Gantt"
	}]
...
exports.addMenusToTestPage = function(page, $menus, rootSlot) {
	$menus = $menus || _$menus;
	rootSlot = rootSlot || page.menuBar.barBody;
	for (var ii = 0, jj = $menus.length; ii < jj; ii++) {
		...
		$menu.$menus && exports.addMenusToTestPage(page, $menu.$menus, rootSlot);
	}
};
