...
var _pages = {
	 layout: {
        ...
        $links: {
            ...
            "single": {
                "$title": "Single List",
                "$url": "?representation=s-uitest-single.$test"
            },
            "graph": {
                "$title": "Graph",
                "$url": "?representation=s-uitest-graph.$test"
            },
            "uilist": {
    ...
    menus: {
        ...
        $links: {
			"layout": {
                "$title": "Layout",
                "$url": "?representation=s-uitest-layout.$test"
            },
            "messagebox": {
                "$title": "Message box",
