	...
	if (scope) {
		if (!scope.menusPopup) {
			var $item = {
				...
				$skin: "s-mn-popup",
				$itemSkin: "s-popup-default-btn-default",
				$category: "menus",
				$layout: {
					$items: []
				}
			...
			syra_site.activeMenusPopup = scope.menusPopup = syra_over.openPopup(scope, {
				content: scope.menusPopupBox,
				...
				close: function() {
					if (scope.menusPopup == syra_site.activeMenusPopup) {
						delete syra_site.activeMenusPopup;
					}
					if (picker.pickerId) {
