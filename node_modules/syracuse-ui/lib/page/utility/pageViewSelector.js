					...
					query.sendRequest({}, function(data, response, requestUrl) {
						if (data.$prototype) {
							setTimeout(function() {
								...
								$itemPage.openerUrlSegments.$url = document.site.urlMaker.applyParameters($itemPage.openerUrlSegments.$url, $itemPage.openerUrlSegments.params);
							...
							if (segments) {
								...
								segments.$url = document.site.urlMaker.applyParameters(segments.$url, segments.params);
								document.site.history.update(self.targetPage, decodeURIComponent(segments.$url));
							}
