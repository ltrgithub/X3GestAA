	...
	appendPickerBar: function() {
		...
		self._widgetResizer = document.site.setWidgetResizable({
			...
			onResize: function(resizer, moving) {
				if (!moving) {
					document.site.toggleClass(self._resizeBar, "s-resizing", document.site.widgetResizing);
					document.site.toggleClass(self._openerPicker, "s-resizing", document.site.widgetResizing);
				}
			}
		});
	...
	onWindowResize: function() {
		if (this._bar && this.barSlot) {
			...
			if (scrollviewRect.height) {
				...
				this._resizeBar.style.height = scrollviewRect.height + "px";
				this._openerPicker.style.display = "";
				this._openerPicker.style.top = ((scrollviewRect.height - this._openerPicker.clientHeight) / 2) + "px";
