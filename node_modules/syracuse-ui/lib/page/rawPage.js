...
exports.RawPage = helpers.defineClass(RawPage, Article, {
	...
	openHelp: function(field, $url) {
		...
		if ($url) {
			...
			if (!_helpTab.winRef || _helpTab.winRef.hasOwnProperty == undefined || _helpTab.winRef.closed) {
				_helpTab.winRef = window.open($url, winId, "width=350,height=400,resizable,scrollbars,status");
			} else if (_helpTab.lastUrl != $url) {
			...
			} else if (_helpTab.winRef && _helpTab.winRef.focus) {
				_helpTab.winRef.focus();
			}
