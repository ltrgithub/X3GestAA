...
exports.RawPage = helpers.defineClass(RawPage, Article, {
	...
	setActivateList: function(list) {
		...
		if (this.activateList && this.activateList != list) {
			syra_site.dom.toggleClass(this.activateList.fieldValue, "s-key-activate", false);
		}
		this.activateList = list;
		//!list.isPageActivationHidden && syra_site.dom.toggleClass(this.activateList.fieldValue, "s-key-activate", true);
	},
	...
	dispose: function() {
		...
		this.lastFetchOptions = this.$prototypeRepository = this.externalAdapter = null;
	},
