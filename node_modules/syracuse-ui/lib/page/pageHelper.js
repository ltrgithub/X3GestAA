...
exports.addTestEmbeddedLinks = function(page) {
		...
		switch (page.openerUrlSegments.$facet) {
			...
			case "$details":
				...
				$links.inlineEmployees = {
					...
					$url: "/sdata/sprint1/settings/sprint1/employees?representation=employee.$query$where=(firstName like '%{firstName}%')"
				};
				break;
			case "$query":
...
exports.addFooter = function(page) {
	if (!page.dialogWrapper && !page.inlinePageHost && !page.isVignettePage && !page.isLandingMaster) {
		page.footer = document.createElement("footer");
		page.footer.className = "s-site-page-footer";
...
function _onScrollView(page) {
	//syra_site.dialogManager.resizePositionedDialogs(page);
...
exports.addScrollViewListener = function(listener) {
	if (listener.page) {
		(listener.page._scrollViewListeners = listener.page._scrollViewListeners || []).push(listener);
	}
};
exports.removeScrollViewListener = function(listener) {
	var page = listener.page;
	if (page) {
