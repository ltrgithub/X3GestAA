...
exports.showBreadCrumb = function(page) {
	...
	// TODO depending of the number of element and the available size for breadcrumb. have to display it in breadCrumbSlot or securityViewSlot
	var breadCrumbSlot = document.createElement("div");
	if (page.$breadCrumb && page.$breadCrumb.length > 0) {

		var item, breadLink;
		if (page.$breadCrumb.length) {
			page.$breadCrumb.splice(0, 0, {
				title: "All"
			});
		}
		if (syra_site.isDocumentRTL) {
			page.$breadCrumb.reverse();
		}
