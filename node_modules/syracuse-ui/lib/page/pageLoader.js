...
exports.load = function($itemPage, onMainPagechange) {
	...
	if (item.ensureRepresentation) {
		$representation = item.ensureRepresentation($representation);
	}
	...
	if (item.$prototype && item.$prototype.$localization && item.$prototype.$hackBlockRank) {
		_localizationConverter.applyHackBlockRank(item.$prototype, $article);
	}
