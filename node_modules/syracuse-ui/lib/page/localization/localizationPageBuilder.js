...
exports.LocalizationPageBuilder = helpers.defineClass(LocalizationPageBuilder, null, {
	...
	_createPage: function(data, openerMenu) {
		...
		self.isPageDetailsFacet = openerMenu.page && openerMenu.page.$facet == "$details";
		...
		if (Object.keys(self.enumLocaleUnset).length > 0 && !self.isPageDetailsFacet) {
			self.newData.$translations.push({
				$uuid: helpers.uuid.generate(),
					...
					$prototype: {
						$properties: {
							$translations: {
								...
								$capabilities: self.isPageDetailsFacet ? "" : "delete",
								$item: {
									$properties: {
										$localeChoice: {
										...
										$localeValue: {
											...
											$isReadOnly: self.isPageDetailsFacet ? true : false
										}
									}
								}
							}
						},
						$links: !self.isPageDetailsFacet ? data.$links : {}
					},
					$article: {
						$category: "page",
