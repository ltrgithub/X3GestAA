...
exports.ModuleRecord = helpers.defineClass(ModuleRecord, RecordArticle, {
    ...
    onItemEnterLeave: function(event){
        if (event && event.currentTarget == this.subModulesBody) {
            this.page.toggleExpandAllOnenter(event);
        }
        else {
    ...
    highlightSelection: function(selected){
        ...
        if (this.page.isAdminMode) {
            if (selected) {
                if (!this.subModulesItem) {
                    ...
                    this.page.adminTableBody.appendChild(this.subModulesAdminBodySep).className = "s-nav-admin-body-sep";
                    this.subModulesBody = document.createElement("div");
                    this.subModulesBody.className = "s-nav-admin-submodules-body";
                    this.subModulesBody.setAttribute("data-s-inout", this.id);
        ...
        if (selected) {
            this.page.ensurePageVisibility("change module");
        }
    },
    dispose: function(){
        ...
        this.icon = this.cardItem = this.domItem = this.dataSlot = this.body = this.menusSlot = this.dataRow = null;
