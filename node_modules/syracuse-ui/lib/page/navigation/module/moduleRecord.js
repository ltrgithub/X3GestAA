...
exports.ModuleRecord = helpers.defineClass(ModuleRecord, RecordArticle, {
	...
	applyChange: function(metaData) {
		...
		if (this.page.isAdminMode) {
			...
			if (titleMeta && titleMeta.$isDisabled && this.boundFields.title && this.boundFields.title.length) {
				document.site.toggleClass(this.boundFields.title[0]._dataValue, "s-disabled", false);
			}
		}
	},
	drawBox: function() {
	...
	dispose: function() {
		...
		site.removeDomChild(this.subModulesHead);
		site.removeDomChild(this.subModulesAdminBodySep);
		site.removeDomChild(this.subModulesBody);
		site.removeDomChild(this.subModulesSlot);
