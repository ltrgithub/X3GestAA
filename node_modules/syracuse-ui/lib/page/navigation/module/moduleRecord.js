	...
	highlightSelection: function(selected) {
		...
		if (this.page.isAdminMode) {
			if (selected) {
				...
				this.page.refreshExpandAllLinks(this.page.selectedSubModuleRecord = this.selectedSubModuleRecord, true);
			} else {
				if (this.page.selectedModule == this) {
					this.page.selectedModule = null;
				}
			}
		...
		if (selected && this.page.isPageLoaded) {
