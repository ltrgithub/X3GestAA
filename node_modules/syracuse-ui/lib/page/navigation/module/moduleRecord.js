...
exports.ModuleRecord = helpers.defineClass(ModuleRecord, RecordArticle, {
    ...
    highlightSelection: function(selected){
        ...
        if (this.page.isAdminMode) {
            if (selected) {
                if (!this.subModulesItem) {
                    ...
                    this.page.admin.slot.appendChild(this.subModulesHead);
                    this.page.admin.slot.appendChild(this.subModulesBody);
                }
            }
            this.subModulesHead.style.display = this.subModulesBody.style.display = selected ? "" : "none";
        }
        else {
            if (selected) {
                if (!this.subModulesItem) {
		...
		if(selected){
			this.page.ensurePageVisibility("chnage module");
		}
    },
    dispose: function(){
