	...
	load: function(page) {
		if (document.site.isTableDevice()) {
			this.options = {
				...
				$viewMode: "dock",
				$skins: {
					bar: "s-nav-modulebar-tablet",
					openerPicker: "s-nav-modulebar-tablet-opener",
					resizePicker: "s-nav-modulebar-tablet-resizer"
				}
			};
		} else {
			this.options = {
		...
		this.barSlot.className = this.options.$skins.bar + "-slot";
		this.barBody = document.createElement("div");
		this.barBody.className = this.options.$skins.bar + "-body";
