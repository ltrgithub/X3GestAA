...
exports.add = function(scrollBody) {
	var cols = new Columns();
	cols.megaScrollPanel = syra_dom.div("simplebar", cols.scrollBody = scrollBody);
	cols.megaScrollPanel.id = "contentPanelScrollBar";

	cols.columnList = {
		cols: []
	};
	cols.columnList.cols.push({
		slot: syra_dom.ul("s-mega-scroll-column", cols.megaScrollPanel)
	});
	return cols;
};