...
MegaMenuColumns.prototype.firstColumnSlot = function() {
	return this.columnList.cols[0].slot;
};
MegaMenuColumns.prototype.adjustColumnContent = function(maxColumnCount) {
...
MegaMenuColumns.prototype.addColumn = function(columnList, columnNumber) {
...
MegaMenuColumns.prototype.dispose = function() {};
exports.add = function(megaScrollPanel, scrollBody) {
	var cols = new MegaMenuColumns();
