...
exports.SubModuleList = helpers.defineClass(SubModuleList, MultiList, {
	loadBox: function(initData) {
		...
		this.emptyMessage = this.localize.nvpNoSubModule;
		this.$confirmDelete = this.localize.nvpConfirmDeleteSubModule;
	...
	onRecordReorderAgentCalculateDragOffset: function(recordReorderDDAgent) {
		recordReorderDDAgent.$drag = document.site.dom.getBoundingClientRect(recordReorderDDAgent.targetRecord.header);
	},
	drawBox: function() {
	...
	emptyBody: function(addEmptySlot, onFetch) {
		...
		if (this.page.isAdminMode) {
			document.site.dom.empty(this.articleParent.subModulesAdminTitleList);
			if (addEmptySlot) {
	...
	dispose: function() {
		document.site.dom.empty(this._core);
		this.rows = null;
