...
exports.SubModuleRecord = helpers.defineClass(SubModuleRecord, RecordArticle, {
	...
	drawBox: function() {
		...
		this.navigationItemsSlot = document.createElement("div");
		this.navigationItemsSlot.className = "s-nav-submodules-slot";
		this.body.appendChild(this.navigationItemsSlot);
		this.navigationItems = this.page.loadNewItem(this.navigationItemsSlot, {
			$isTitleHidden: true,
			$bind: "items"
		}, this);
