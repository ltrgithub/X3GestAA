...
exports.SubModuleRecord = helpers.defineClass(SubModuleRecord, RecordArticle, {
	...
	onItemEnterLeave: function(event) {
		if (this.itemsField && this.itemsField._menusSlot) {
			document.site.toggleClass(this.itemsField._menusSlot, "s-enter", event.type == "mouseenter");
		}
		if (this._menusSlot) {
	...
	drawBox: function() {
		...
		this.body.appendChild(this._menusSlot);
		...
		this.itemsField._menusSlot.className = "s-nav-items-menus-slot";
		this._menusSlot.appendChild(this.itemsField._menusSlot);
