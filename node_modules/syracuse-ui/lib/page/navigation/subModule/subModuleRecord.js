...
exports.SubModuleRecord = helpers.defineClass(SubModuleRecord, RecordArticle, {
	...
	onSelectMouseEvent: function(onEnter) {
		syra_site.dom.toggleClass(this.header, "s-record-over", onEnter);
	},
	highlightSelection: function(selected) {
		syra_site.dom.toggleClass(this.header, "s-list-record-selected", selected);
	...
	drawBox: function() {
		...
		if (!this.page.isAdminMode) {
			this.page.defineExpandAllItems(this.menusBar, this.list.$skinMenus, this, "page/s-nav-sub-");
		}
