...
exports.SubModuleRecord = helpers.defineClass(SubModuleRecord, RecordArticle, {
	...
	highlightSelection: function(selected) {
		...
		if (selected && this.page.isAdminMode) {
			...
			if (this.page.selectedModule) {
				this.page.refreshExpandAllLinks(this.page.selectedSubModuleRecord = this.page.selectedModule.selectedSubModuleRecord = this);
			}
		}
	},
	drawBox: function() {
		...
		if (!this.page.isAdminMode) {
			this.page.defineExpandAllItems(this.header, "s-nav-list-menus-link", this, "page/s-nav-sub-");
		}
		if (this.page.isAdminMode) {
