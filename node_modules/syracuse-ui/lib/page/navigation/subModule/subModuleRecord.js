...
exports.SubModuleRecord = helpers.defineClass(SubModuleRecord, RecordArticle, {
    ...
    drawBox: function(){
        ...
        this.expandMenus.className = this.$skin + "-expand-menus";
        if (this.page.isAdminMode) {
            var $linkItem = this.list.defineNewIconMenu("$expand-all", this.list.$skinMenus + "-link", true, this);
            this.expandLink = this.page.loadNewItem(this.expandMenus, $linkItem, this);
            $linkItem = this.list.defineNewIconMenu("$collapse-all", this.list.$skinMenus + "-link", true, this);
            this.expandMenus.style.display = "none";
            this.collapseLink = this.page.loadNewItem(this.expandMenus, $linkItem, this);
            this.page.adminMenusHeader.appendChild(this.expandMenus);
        }
        else {
            this.expandLink = this.page.loadNewItem(this.expandMenus, {
                $category: "link",
                $skin: this.list.$skinMenus + "-link",
                $bind: "$expand-all"
            }, this);
            this.collapseLink = this.page.loadNewItem(this.expandMenus, {
                $category: "link",
                $skin: this.list.$skinMenus + "-link",
                $bind: "$collapse-all"
            }, this);
