...
function _expandSubModule(subModule, expanded) {
	...
	//syra_site.dom.display(subModule.btnExpandAll, subModule.btnExpandAll.hasChildBlock && expanded);
	//syra_site.dom.display(subModule.btnCollapseAll, subModule.btnCollapseAll.hasChildBlock && expanded);
}
...
exports.SubModuleBuilder = helpers.defineClass(SubModuleBuilder, null, {
	...
	record_onAfterApplyChange: function(record, metaData) {
		...
		syra_menus.button.setText(record.titleBtn, title);
	},
	...
	record_draw: function(record) {
		...
		if (record.page.isAdminMode) {
			record.titleBtn = syra_menus.button.addIndicator({
				parent: record,
				slot: record.header,
				text: "",
			...
			record.domTitle = record.titleBtn.link;
			...
			record.titleBtn = syra_menus.button.add({
				parent: record,
				slot: record.header,
				text: "",
