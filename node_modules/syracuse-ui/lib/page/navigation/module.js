...
Module.prototype.onActivated = function() {
	if (!this.body) {
		...
		if (dataRecords) {
			for (var ii = 0, jj = dataRecords.length; ii < jj; ii++) {
				this.children.push(_subModule.add(this, dataRecords[ii]));
			}
		}
	...
	this.menuScroller && this.menuScroller.revalidate(this.body.clientHeight);
};
...
exports.add = function(page, parentNode, dataset) {
	...
	module.navParent = module.articleParent = module.boxParent = page;

	var slot = module.slot = syra_dom.li(page.$skin + "-module");
