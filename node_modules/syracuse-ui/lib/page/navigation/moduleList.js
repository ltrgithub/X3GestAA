...
var RowRecordSelector = require('syracuse-ui/lib/field/array/selector/rowRecordSelector').RowRecordSelector;
var ModuleRecord = require('./moduleRecord').ModuleRecord;

function ModuleList() {}

exports.ModuleList = helpers.defineClass(ModuleList, Article, {
	...
	loadSelector: function() {
		(this.selector = new RowRecordSelector()).load(this);
	},
	...
	_appendRecord: function(options) {
		...
		var record = (this.recordsMap[options.dataRecord.$uuid] = new ModuleRecord());
	...
	dispose: function() {
		...
		document.site.emptyDom(this._core);
		this._core = this.menusBox = this.domTitle = this._mandatoryFlag = this._description = this._helpFlag = null;
		this.cardItemSlotSeparator = this.cardItemSlot = this.graphSeparator = this.graphSlot = this.tableRow = null;
