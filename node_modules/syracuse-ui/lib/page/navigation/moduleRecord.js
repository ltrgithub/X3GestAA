...
exports.ModuleRecord = helpers.defineClass(ModuleRecord, RecordArticle, {
	...
	drawBox: function() {
		...
		this.cardItem = this.page.loadNewItem(card, {
			$bind: "title",
			$category: "field",
			$isEditMode: true,
			$inplace: true
