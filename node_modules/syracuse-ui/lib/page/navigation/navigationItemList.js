...
exports.NavigationItemList = helpers.defineClass(NavigationItemList, Article, {
	...
	_appendRecord: function(options) {
		...
		var record = (this.recordsMap[options.dataRecord.$uuid] = new MenuItemRecord());
