...
function DetailPanel(navParent) {
	...
	this._scrollview = syra_dom.div("simplebar", this._slot);
	this._scrollview.id = "contentPanelScrollBar";
	this.cols = [];
	this.cols.push({
		slot: syra_dom.ul("s-mega-scroll-column", this._scrollview)
	});
}
...
DetailPanel.prototype.activate = function() {
	this._scrollview.style.height = this.navParent.page.popup.clientHeight + "px";
