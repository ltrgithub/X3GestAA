...
exports.add = function(navParent) {
	var menu = syra_item.initialize(navParent.page, new MenuItem());
	menu.$skin = navParent.$skin_menu || menu.page.$skin + "-link";
	menu.navParent = this;
	menu.submodule = navParent.submodule || navParent;
	return menu;
};