...
exports.NavigationItemBuilder = helpers.defineClass(NavigationItemBuilder, null, {
	initialize: function(list) {
		...
		if (list.isBookMarkList) {
			this.emptyMessage = syra_local.bookmarks_edit_empty;
	...
	record_draw: function(record) {
		...
		if (this.list.isBookMarkList) {
			record.applyChange({
				$actions: {
					$edit: {
						$title: syra_local.bookmarks_edit_item
					},
					"remove_separator": {
						$title: syra_local.bookmarks_delete_separator,
						$isHidden: !record.dataset.$singleField.menuItem.$hasSeparator
					},
					"add_separator": {
						$title: syra_local.bookmarks_add_separator,
						$isHidden: record.dataset.$singleField.menuItem.$hasSeparator
					}
				}
			});
