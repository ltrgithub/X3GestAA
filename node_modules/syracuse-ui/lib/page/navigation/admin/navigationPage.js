...
var ModuleBuilder = require('syracuse-ui/lib/page/navigation/admin/moduleBuilder').ModuleBuilder;
var NavigationItemBuilder = require('syracuse-ui/lib/page/navigation/admin/navigationItemBuilder').NavigationItemBuilder;
var _variantsType = {
	menuItem: require('syracuse-ui/lib/page/navigation/admin/menuField').MenuField,
	menuBlock: require('syracuse-ui/lib/page/navigation/admin/menuBlockField').MenuBlockField
};
var _subModuleBuilder = require('syracuse-ui/lib/page/navigation/admin/subModuleBuilder');
...
exports.NavigationPage = helpers.defineClass(NavigationPage, DesktopPage, {
	load: function(initData) {
		...
		syra_layout.ensureArticleVisibility(this);
	},
