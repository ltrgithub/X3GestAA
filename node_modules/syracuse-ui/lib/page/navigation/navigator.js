...
exports.showMegaMenus = function($representation) {
	...
	if (syra_site.megaMenus) {
		if (syra_site.userProfile && syra_site.userProfile.getSelectedEndpoint().$uuid === syra_site.megaMenus.selectedEndpointUiid) {
			return;
		}
		syra_site.megaMenus.dispose();
	}

	page = syra_site.megaMenus = new Navigator();
	syra_site.megaMenus.selectedEndpointUiid = syra_site.userProfile && syra_site.userProfile.getSelectedEndpoint().$uuid;
