	...
	togglePopup: function(content) {
		...
		if (content) {
			...
			if (!self.popupDlg) {
				...
				self.setMegaMenuSize(self.popup.parentNode.clientHeight * 0.65, self.maxColumns === 5 ? 1200 : 960);
			}
		} else {
			self.popupDlg && self.popupDlg.close();
		}
	},
	setMegaMenuSize: function(height, width) {
		...
		this.popupImage.style.left = (this.body.clientWidth - this.popupImage.clientWidth) / 2 + "px";
	},
	addMore: function() {
		var self = this;
