...
function _endLoad(page) {
	syra_site.breadcrumbs.$prototype = syra_site.megaMenus.$prototype;
	syra_site.breadcrumbs.dataset = syra_site.megaMenus.dataset;
...
exports.page = {
	load: function(page, options) {
		...
		page.breadcrumb_togglePopup = function(content, modules) {
			var self = this;
			if (content) {
				...
				if (!self.breadcrumb_popupDlg) {
					self.breadcrumb_popupDlg = syra_over.openPopup(self.page, {
						...
						autoCloseBoundary: self.eventSourceDomItem,
	...
	resizeItem: function(page) {
		if (page.isModulesLoaded) {
			if (page.breadcrumb_popup) {
				var height = syra_site.size.popupMaxHeight + "px";
				page.breadcrumb_popup.style.height = height;
				page.breadcrumb_popup.style.maxHeight = height;
			}
...
exports.modules = {
	...
	_showModules: function(page) {
		...
		page.breadcrumb_togglePopup(modules.scrollview, true);
	},
...
exports.module = {
	...
	_showSubModules: function(module) {
		...
		page.breadcrumb_togglePopup(module.scrollview);
...
exports.subModule = {
	...
	_showSubModule: function(submodule) {
		submodule.page.breadcrumb_togglePopup(submodule.scrollview);
