		...
		page.overPanel = syra_over.openModal(syra_site, {
			...
			resize: function(dlg) {
				...
				if (syra_site.$device == "tablet") {
					this.page.modulesBarSlot.style.height = (this.page.size.maxBarHeight - 60) + "px";
					this.page.modulesContentSlot.style.height = (this.page.size.maxBarHeight - 60) + "px";
					...
					this.page.domItem.parentElement.style.padding = "0px";
					maxContentWidth = width - this.page.modulesBarSlot.clientWidth - 30;
					this.page.modulesContent.style.width = (maxContentWidth - 30) + "px";
