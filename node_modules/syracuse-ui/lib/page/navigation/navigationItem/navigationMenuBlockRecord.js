...
exports.NavigationMenuBlockRecord = helpers.defineClass(NavigationMenuBlockRecord, ChildFieldRecord, {
	...
	ensureCollapState: function() {
		this.expandPicker.title = this.page.localize.box_expand;
		document.site.toggleClass(this.expandPicker, "s-close", this.$collapsed);
		this.itemsField.domItem.style.display = this.$collapsed ? "none" : "";
	},
