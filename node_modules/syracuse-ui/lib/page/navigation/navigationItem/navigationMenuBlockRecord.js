...
exports.NavigationMenuBlockRecord = helpers.defineClass(NavigationMenuBlockRecord, ChildFieldRecord, {
	drawBox: function() {
		...
		this.titleField = this.page.loadNewItem(this.blockCardHeader, {
			...
			$title: this.page.localize.nvpEnterMenuBlock,
		...
		this.blockCardHeader.syrainout = this;
		this.blockCardHeader.setAttribute("data-s-inout", this.id);
		if (prevTitleField) {
	...
	ensureExpandedState: function() {
		...
		document.site.dom.toggleClass(this.expandPicker, "s-close", !this.$expanded);
