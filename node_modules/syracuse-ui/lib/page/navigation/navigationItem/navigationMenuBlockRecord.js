...
exports.NavigationMenuBlockRecord = helpers.defineClass(NavigationMenuBlockRecord, ChildFieldRecord, {
	drawBox: function() {
		...
		this.itemsField.builder.body.className += " s-nav-block-items-field";
		this.itemsField._menusSlot.className = "s-nav-items-menus-slot";
		this.titleField._dataValue.appendChild(this.itemsField._menusSlot);
		card.setAttribute("data-s-inout", this.id);
	},
