	...
	onItemInOut: function(on) {
		if (this.page.isAdminMode) {
			if (this.itemsField && this.itemsField.menusSlot) {
				this.page.toggleCssOnEnter(this.itemsField.menusSlot, on);
			}
			this.titleField.pickersHelper.highlight(this.titleField, on);
			this.page.toggleCssOnEnter(this.articleParent.articleParent.menusSlot, on);
			this.page.toggleCssOnEnter(this.articleParent.articleParent.reorderPicker, on);
		}
	},
