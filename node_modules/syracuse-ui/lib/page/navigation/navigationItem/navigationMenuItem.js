...
exports.NavigationMenuItem = helpers.defineClass(NavigationMenuItem, ReferenceField, {
	...
	addBookmarkButton: function(item) {
		if (this.codeMenu.href) {
			this.bookmarkBtn = syra_menus.addIconButton(syra_local.bookmarksAdd, "s-nav-menu-bookmark", "onBookmarClick", null, "bookmark_off");
			this.bookmarkBtn.syraIsNavigationItem = true;
			this.bookmarkBtn.syraItem = syra_site.id;
			this.bookmarkBtn.syraFieldId = this.id;
			this._dataValue.parentNode.insertBefore(this.bookmarkBtn, this._dataValue.nextSibling);
