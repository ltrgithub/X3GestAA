...
exports.NavigationMenuItem = helpers.defineClass(NavigationMenuItem, ReferenceField, {
    ...
    setBookmarkStatus: function(isBookmark){
        document.site.toggleClass(this.bookmarkPicker, "s-bookmark-on", this.isBookmark = isBookmark);
    },
    addBookmarkPicker: function(item){
        ...
        if (this.codeMenu.href) {
            if (document.site.bookmarksProvider.isBookmarkLink(this.codeMenu.href)) {
                this.setBookmarkStatus(true);
            }
        }
        else {
            //document.site.toggleClass(item.layoutSlot, "s-bookmark-off", true);
        }
    }
});
