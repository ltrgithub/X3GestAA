...
exports.NavigationMenuItem = helpers.defineClass(NavigationMenuItem, ReferenceField, {
	loadBox: function() {
		...
		this.articleParent.domItem.className += " s-nav-menu-item";
	},
	...
	_createMenusBox: function() {
		//ReferenceField.prototype._createMenusBox.call(this);
	...
	onItemEnterLeave: function(event, record) {
		if (record) {
			if (this.menusBox) {
				this.menusBox.domItem.style.visibility = (event.type == "mouseenter") ? "visible" : "hidden";
			}
