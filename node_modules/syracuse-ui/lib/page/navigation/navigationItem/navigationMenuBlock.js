...
helpers.defineClass(NavigationMenuBlockRecord, ChildFieldRecord, {
	drawBox: function() {
		...
		if (this.navigationItemRecord.reorderBtn) {
			this.expandBtn.link.parentNode.insertBefore(this.navigationItemRecord.reorderBtn, this.expandBtn.link);
		}
		if (prevTitleField) {
		...
		if (this.page.isAdminMode) {
			...
			if (this.titleField.picker_$localize) {
				this.titleField.domItem.insertBefore(this.titleField.picker_$localize.link, this.titleField.domItem.firstChild);
			}
			...
			if (deleteMenu) {
				...
				this.titleField.domItem.insertBefore(deleteMenu.domItem, this.titleField.domItem.firstChild);
			}
		} else {
