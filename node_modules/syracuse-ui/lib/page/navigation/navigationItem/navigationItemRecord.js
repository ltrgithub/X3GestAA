...
exports.NavigationItemRecord = helpers.defineClass(NavigationItemRecord, SingleRecord, {
    ...
    setLevel: function(){
        ...
        document.site.toggleClass(this.domItem, this.level = this.page.getTreeLevel(this), true);
        if (this.singleField.variantItem) {
            this.singleField.variantItem.setLevel(this.level);
        }
    },
