...
exports.NavigationItemRecord = helpers.defineClass(NavigationItemRecord, SingleRecord, {
	reorderItem: function(targetRecord, isAfter) {
		...
		this._singleField.variantItem.onReorderItem(this);
	},
	...
	onMenuClick: function(menuItem) {
		if (menuItem.$bind == "$delete") {
			menuItem.$confirm = this.localize["dskpNavigationPageConfirmDelete" + (this._singleField.$variantItemKey == "menuItem" ? "Menu" : "Block")];
		}
		return true;
	},
	onItemEnterLeave: function(event) {
		if (this._singleField.variantItem) {
			this._singleField.variantItem.onItemEnterLeave(event, this);
		}
		SingleRecord.prototype.onItemEnterLeave.call(this, event);
	},
	drawBox: function() {
