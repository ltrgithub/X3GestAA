...
exports.NavigationItemRecord = helpers.defineClass(NavigationItemRecord, SingleRecord, {
	...
	onFocusInOut: function(onEnter) {
		this.singleField && this._highlightBookmark(onEnter);
	},
	onItemInOut: function(onEnter) {
		for (var ii = 0, jj = this._buttons.length; ii < jj; ii++) {
			syra_site.dom.toggleClass(this._buttons[ii], "s-invisible", !onEnter);
		}
	...
	addReorder: function() {
		if (this.page.isAdminMode && this.list.$capability.reorder) {
