    ...
    _createMenusBox: function(){
        if (!this.isMenuLoaded) {
            ...
            if (this.page.isAdminMode) {
                var $itemBlock = this.defineNewIconMenu("$create", this.$skinMenus + "-link", !this.articleParent.isSubModuleRecord);
                $itemBlock.$icon.$value = "new-menus-block";
                var $itemMenu = this.defineNewIconMenu("$select", this.$skinMenus + "-link", !this.articleParent.isSubModuleRecord);
