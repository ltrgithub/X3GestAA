...
exports.NavigationPage = helpers.defineClass(NavigationPage, DesktopPage, {
	...
	refreshExpandAllLinks: function(subModule) {
		...
		if (article) {
			syra_menus.button.display(article.btnExpandAll, article.btnExpandAll.hasChildBlock = hasChildBlock);
			syra_menus.button.disable(article.btnExpandAll, !hasExpandAll);
			syra_menus.button.display(article.btnCollapseAll, article.btnCollapseAll.hasChildBlock = hasChildBlock);
