...
exports.NavigationPage = helpers.defineClass(NavigationPage, DesktopPage, {
    ...
    loadBox: function(initData, $initDiagnoses){
        ...
        if (this.isAdminMode) {
            ...
            this.adminMenusSlot = header.appendChild(document.createElement("div"));
            this.adminMenusSlot.className = "s-nav-admin-head-menus";
            this.adminMenusSlot.setAttribute("data-s-inout", this.id);
            var menusHeader = this.adminMenusSlot.appendChild(document.createElement("div"));
    ...
    onItemEnterLeave: function(event){
        if (this.adminModulesSlot && (this.adminModulesSlot == event.currentTarget)) {
            ...
            if (this.adminMenusSlot && (this.adminMenusSlot == event.currentTarget)) {
                this.toggleExpandAllOnenter(event);
            }
        }
    },
    toggleExpandAllOnenter: function(event){
        if (this.expandMenus) {
            this.toggleCssOnEnter(this.expandMenus, event);
        }
    },
    ...
    dispose: function(){
        ...
        this.adminMenusSlot = this.selectedSubModuleRecord = this.adminSlot = this.adminTable = this.adminTableBody = this.adminModulesSlot = this.modules = this.bar = null;
