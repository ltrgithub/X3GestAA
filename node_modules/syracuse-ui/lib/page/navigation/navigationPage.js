...
exports.NavigationPage = helpers.defineClass(NavigationPage, DesktopPage, {
	...
	resizeArticle: function(resize, articleParent) {
		DesktopPage.prototype.resizeArticle.call(this, resize, articleParent);
		if (!this.scrollPosInit && sessionStorage && this.scrollview) {
	...
	bindScrollView: function(bind) {
		var self = this;
		if (bind) {
			self.scrollview.addEventListener("scroll", self.scrollHandler = function(event) {
