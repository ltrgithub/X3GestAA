...
function _expandSubModule(subModule, expanded) {
	...
	syra_menus.setFontIconButton(subModule.domTitle.firstChild, expanded ? "node_expanded" : "node_collapsed");
	...
	createField: function($field, $item, boxParent, $class) {
		switch ($item.$bind) {
			case "modules":
				...
				list.topbar = document.createElement("div");
				list.topbar.className = "s-ldp-mn-bar";
