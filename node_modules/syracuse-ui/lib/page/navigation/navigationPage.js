...
exports.NavigationPage = helpers.defineClass(NavigationPage, DesktopPage, {
    ...
    loadBox: function(initData, $initDiagnoses){
        ...
        if (this.isAdminMode) {
            ...
            this.adminMenusHeader = menusSlot.appendChild(document.createElement("div"));
            this.adminMenusHeader.className = "s-nav-admin-head-menus-inner";
            title = this.adminMenusHeader.appendChild(document.createElement("div"));
            title.textContent = this.localize.navigPageMenus;
            title.className = "s-nav-admin-head-menus-title";
            this.defineExpandAllItems();
            this.adminMenusHeader.appendChild(this.expandMenus);
    ...
    dispose: function(){
        ...
        this.selectedSubModuleRecord = this.adminSlot = this.adminTable = this.adminTableBody = this.adminMenusHeader = this.adminModulesSlot = this.modules = this.bar = null;
