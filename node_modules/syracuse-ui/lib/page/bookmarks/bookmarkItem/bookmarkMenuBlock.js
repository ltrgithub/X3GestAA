...
var NavigationMenuBlock = require("syracuse-ui/lib/page/navigation/navigationItem/navigationMenuBlock").NavigationMenuBlock;

function BookmarkMenuBlock() {}

exports.BookmarkMenuBlock = helpers.defineClass(BookmarkMenuBlock, NavigationMenuBlock, {
	loadBox: function() {
		this.ChildRecordClass = BookmarkMenuBlockRecord;
		NavigationMenuBlock.prototype.loadBox.call(this);
	}
});

function BookmarkMenuBlockRecord() {}

helpers.defineClass(BookmarkMenuBlockRecord, ChildFieldRecord, {
	drawBox: function() {
		...
		if (itemRecord.reorderBtn) {
			this.expandBtn.link.parentNode.insertBefore(itemRecord.reorderBtn, this.expandBtn.link);
		}
		...
		if (!this.expandBtn) {
			...
			this.expandBtn = syra_menus.button.add({
				...
				btnclick: function(event, btn) {
					this.parent.expandMenuBlock(!this.parent.$expanded);
				}
			});
	...
	ensureExpandedState: function() {
		syra_menus.button.setText(this.expandBtn, this.$expanded ? syra_local.box_collapse : syra_local.box_expand);
		syra_site.dom.toggleClass(this.expandBtn.link, "s-close", !this.$expanded);
