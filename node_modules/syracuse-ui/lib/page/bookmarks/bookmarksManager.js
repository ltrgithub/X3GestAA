		...
		for (var ii = 0, jj = items.length; ii < jj; ii++) {
			...
			if (item.menuItem) {
				if (item.menuItem.$url) {
					...
					btn.link.title = item.menuItem.description;
...
function _toggleButton(btn, isOn) {
	syra_menus.updateButtonIcon(btn.link, isOn ? syra_local.bookmarksRemove : syra_local.bookmarksAdd, isOn ? "bookmark_on" : "bookmark_off");
}
...
exports.load = function() {
	...
	_moreBtn.link.title = syra_local.bookmarksMoreTooltip;
	syra_menus.button.visibility(_moreBtn, false);
