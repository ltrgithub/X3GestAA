...
exports.load = function() {
	...
	_links = [];
	_addBtn = syra_menus.addIconButton(syra_local.bookmarksAdd, "s-bookmarks-bar-btn", "onAddClick", null, "bookmark_off");
	_addBtn.syraSiteObserver = "bookmarksManager";

	_manageBtn = syra_menus.addIconButton(syra_local.bookmarksManage, "s-bookmarks-bar-btn", "onManagerClick", null, "expand");
