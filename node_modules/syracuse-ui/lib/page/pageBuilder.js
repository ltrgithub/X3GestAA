...
function _endLoad(page, $itemPage, $representation, onLoaded) {
	...
	syra_item.initializeNewItem(syra_site, page, $article, $itemPage.boxParent);
...
exports.load = function($itemPage, onLoaded) {
	...
	page.id = syra_site._childPageOffset++;
	var openerUrlSegments = page.openerUrlSegments = $itemPage.openerUrlSegments;
	...
	page.$facet = $itemPage.$facet || openerUrlSegments.$facet;
