...
function _endLoad(context) {
	try {
		...
		$itemPage.$pageCategoryClass = $itemPage.boxParent = $itemPage.layoutSlot = $itemPage.overPanel = null;
...
exports.load = function(context) {
	try {
		...
		var page = new($itemPage.$pageCategoryClass || syra_item.pageCategories[$pageCategory] || DesktopPage)();
