...
function _endLoad(page, $itemPage, $representation, onLoaded) {
	...
	if ($representation.$diagnoses && $representation != $itemPage.initData) {
		syra_alert.show($representation.$diagnoses, page);
	} else {
		page.alertPanel && page.alertPanel.refresh();
	}
	$itemPage.$pageCategoryClass = $itemPage.boxParent = $itemPage.layoutSlot = $representation = $itemPage.overPanel = null;
...
exports.load = function($itemPage, onLoaded) {
	...
	page.page = page;
	syra_log.page.load.start(page, $itemPage);
