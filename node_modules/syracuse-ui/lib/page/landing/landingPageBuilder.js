...
function _onDisposeRecord(record) {
	if (record.page && record.page.selectedPageRecord == record) {
		record.showRecordSelection(false);
	}
...
exports.Builder = helpers.defineClass(Builder, null, {
	...
	record_onAfterResize: function(record, doResize, boxParent) {
		record.childPage && record.childPage.resizeArticle(doResize);
	},
	...
	dispose: function() {
		this.list && syra_site.dom.empty(this.list._core);
	}
});