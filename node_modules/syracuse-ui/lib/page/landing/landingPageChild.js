...
exports.LandingPageChild = helpers.defineClass(LandingPageChild, DesktopPage, {
	...
	dispose: function() {
		this.landingPageMaster = this.masterRecord = this.designPicker = this.addVignettePicker = this.refreshPicker = this.addTabPicker = null;
	...
	appendHeader: function() {
		...
		this.addVignettePicker = document.createElement("a");
		this.addVignettePicker.style.display = "none";
		this.addVignettePicker.className = "s-ldp-add-vignette";
		this.addVignettePicker.syraOnClick = "onAddVignetteClick";
		this.addVignettePicker.title = syra_local.ldpAddVignette;
		this.headerCoreRight.appendChild(this.addVignettePicker);

		this.headerCoreRight.syrainout = this.headerCoreRight.syraItem = this.id;

		this.refreshPicker = document.createElement("a");
		this.refreshPicker.className = "s-ldp-refresh";
		this.refreshPicker.syraOnClick = "onRefreshPageClick";
		this.refreshPicker.title = syra_local.ldpRefresh;
		this.headerCoreRight.appendChild(this.refreshPicker);

		if (this.isDesignModeEnabled) {
			this.designPicker = document.createElement("a");
			this.designPicker.className = "s-ldp-designer-picker";
			this.designPicker.syraOnClick = "openDesigner";
			this.designPicker.title = syra_local.ldpOpenDesigner;
			this.designPicker.style.display = this.refreshPicker.style.display = "none";
			this.headerCoreRight.appendChild(this.designPicker);
		}
	},
	onItemInOut: function(onEnter) {
		this.toggleCssOnEnter(this.headerCoreRight, onEnter);
	},
	...
	loadBox: function(initData) {
		...
		if (this.isDesignModeEnabled) {
			this.addTabPicker = document.createElement("a");
			this.addTabPicker.className = "s-ldp-add-tab";
			this.addTabPicker.syraItem = this.id;
			this.addTabPicker.syraOnClick = "onAddTabClick";
			this.addTabPicker.textContent = "+";
			this.addTabPicker.title = syra_local.ldpAddTab;
			this.layoutContent.tabStop = this.layoutContent._tabs.appendChild(this.addTabPicker);
			this.designPicker.style.display = this.refreshPicker.style.display = "";
		}
		...
		if (this.isDesignModeEnabled && this.getAddVignetteDefinition()) {
			this.addVignettePicker.style.display = "";
		}
	}
});