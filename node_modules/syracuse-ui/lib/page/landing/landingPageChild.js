...
exports.LandingPageChild = helpers.defineClass(LandingPageChild, DesktopPage, {
	...
	dispose: function() {
		this.landingPageMaster = this.masterRecord = this.designBtn = this.addVignetteBtn = this.refreshPicker = this.addTabBtn = null;
	...
	appendHeader: function() {
		...
		this.addVignetteBtn = syra_menus.addIconButton(syra_local.ldpAddVignette, "s-ldp-add-vignette", "onAddVignetteClick", "ESC SHIFT N", "$create");
		this.addVignetteBtn.style.display = "none";
		slot.appendChild(this.addVignetteBtn);
		this.refreshPicker = syra_menus.addIconButton(syra_local.ldpRefresh, "s-ldp-refresh", "onRefreshPageClick", "ESC F5", "refresh");
		slot.appendChild(this.refreshPicker);
		if (this.isDesignModeEnabled) {
			this.designBtn = syra_menus.addIconButton(syra_local.ldpOpenDesigner, "s-ldp-designer-btn", "openDesigner");
