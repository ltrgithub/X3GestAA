...
exports.LandingPageChild = helpers.defineClass(LandingPageChild, DesktopPage, {
	...
	appendHeader: function() {
		...
		this.addVignetteBtn = syra_menus.addIconButton(syra_local.ldpAddVignette, "s-ldp-add-vignette", "onAddVignetteClick", "ESC SHIFT +");
	...
	loadBox: function(initData) {
		...
		if (this.isDesignModeEnabled) {
			this.addTabBtn = syra_menus.addTextButton("+", "s-ldp-add-tab", "onAddTabClick", "ESC +");
