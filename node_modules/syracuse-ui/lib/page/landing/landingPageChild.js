...
exports.LandingPageChild = helpers.defineClass(LandingPageChild, DesktopPage, {
	...
	appendHeader: function() {
		...
		this.headerCoreRight.appendChild(this.addVignetteBtn);
		...
		if (this.isDesignModeEnabled) {
			...
			this.headerCoreRight.appendChild(this.designBtn);
		}
	},
	onItemInOut: function(onEnter) {
		this.headerCoreRight && syra_site.dom.toggleClass(this.headerCoreRight, "s-enter", onEnter);
	},
