...
exports.LandingPageDesigner = helpers.defineClass(LandingPageDesigner, Designer, {
	...
	dispose: function() {
		...
		this.editTitleField = this.itemTool = this.sectionModel = this._ddTabEnter = null;
