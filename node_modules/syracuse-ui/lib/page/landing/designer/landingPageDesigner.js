...
exports.LandingPageDesigner = helpers.defineClass(LandingPageDesigner, Designer, {
	...
	drawBox: function() {
		...
		link.syraOnClick = "onExcludeTabClick";
		link.textContent = link.title = this.localize.ldpDelete;
		var div = document.createElement("div");
	...
	onExcludeTabClick: function(picker) {
