...
exports.LandingPage = helpers.defineClass(LandingPage, DesktopPage, {
	onExecuteMenuResponse: function($bind, record, responseData) {
		if ($bind == "$delete") {
			...
			var delta = {};
			var index = syra_site.dom.getIndex(record.domItem);
	...
	saveLayoutContent: function() {
		...
		sendBag.content = syra_site.layoutUpdater.cleanBeforeSave(helpers.object.clone(this.$item, true));
	...
	switchDesigner: function(open) {
		if (open) {
			syra_fields.advancedState.toggleAllFields(this, true);
