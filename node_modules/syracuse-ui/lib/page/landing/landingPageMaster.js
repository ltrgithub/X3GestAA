...
exports.LandingPageMaster = helpers.defineClass(LandingPageMaster, DesktopPage, {
	...
	getChildPageContent: function(childPage) {
	...
	saveLandingDesign: function(childPage) {
		...
		var sendBag = {
			...
			content: self.getChildPageContent(childPage)
		};
	...
	deleteVignettes: function(record, $uuids) {
		...
		sendBag.content = this.getChildPageContent(record.childPage);
			...
			if (self.$prototype.$representationUrl) {
				...
				document.controller.sendRequest(self, {
					...
					if (!articleSender.disposed) {
						...
						if (onAdd) {
							self.saveLandingDesign(articleSender.childPage);
						}
