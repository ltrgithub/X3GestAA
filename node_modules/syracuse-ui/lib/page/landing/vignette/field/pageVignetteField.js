				...
				success: function($itemPage) {
					if (self.body) {
						...
						if (self.$url && self.$field.$location.$url != self.$url) {
							var newSeg = document.site.urlMaker.parse(self.$url);
							var sourceSeg = document.site.urlMaker.parse(self.$field.$location.$url);
