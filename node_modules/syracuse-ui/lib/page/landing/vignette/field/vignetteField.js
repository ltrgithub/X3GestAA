...
exports.VignetteField = helpers.defineClass(VignetteField, SectionBlock, {
	...
	doPicker: function(pickerId) {
		switch (pickerId) {
			case "delete":
				this.page.masterContext.page.deleteVignette(this);
				break;
			case "refresh":
				this.refresh(true);
				break;
	...
	drawBox: function() {
		...
		if (this.page.isLandingPage && !this.page.$prototype.$isRolePage) {
	...
	onDesignVignette: function(open) {
		...
		site.disableItem(this.pickers.items.design, open);
		site.disableItem(this.pickers.items.menus, open);
		site.disableItem(this.pickers.items.refresh, open);
	},
