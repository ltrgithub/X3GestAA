...
exports.HTMLVignetteField = helpers.defineClass(HTMLVignetteField, VignetteField, {
	...
	designArticle: function(open) {
		document.site.dom.toggleClass(this.pickers.items.design, "s-close", open);
		document.site.designArticle(open, this, HTMLVignetteDesigner);
	},
	_showUrl: function() {
		if (this.$contentUrl) {
			if (!this._iframe) {
		...
		document.site.dom.toggleClass(this.domTitle, "s-title-link", this.$contentUrl != null);
	},
