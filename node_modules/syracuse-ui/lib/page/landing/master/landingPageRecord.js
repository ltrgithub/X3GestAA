    ...
    highlightSelection: function(selected){
        ...
        if (selected) {
            if (!this.subModulesItem) {
                ...
                this.subModulesSlot.className = "s-ldp-submodules-slot-admin";
                var $vignettes = {};
                if (this.dataset.vignettes) {
                    for (var ii = 0, jj = this.dataset.vignettes.length; ii < jj; ii++) {
                        var source = helpers.object.clone(this.dataset.vignettes[ii]);
                ...
                var $itemPage = {
                    layoutSlot: this.subModulesSlot,
                    $category: "dashboard",
                ...
                document.site.loadNewPage($itemPage);
