...
exports.LandingPageList = helpers.defineClass(LandingPageList, MultiList, {
	loadBox: function(initData) {
		...
		this.$item.$skinMenus = "s-ldp-list-menus";
	...
	drawBox: function() {
		...
		this.topbar.className += " s-ldp-modules-bar";
	...
	_createMenusBox: function() {
		if (!this.isMenuLoaded) {
			...
			if (this.page.isAdminMode) {
				this.page.loadNewItem(this.menusSlot, this.defineNewIconMenu("$create", this.$skinMenus + "-link"), this);
				this.page.loadNewItem(this.menusSlot, this.defineNewIconMenu("$select", this.$skinMenus + "-link"), this);
			}
		}
	},
