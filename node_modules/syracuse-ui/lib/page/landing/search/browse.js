...
function _selectItem(col, btn) {
	col.selectedBtn && syra_site.dom.toggleClass(col.selectedBtn, "s-list-record-selected");
...
exports.buildLevels = function(page, slot, data) {
	...
	for (var ii = 0, jj = _modules.stack.length; ii < jj; ii++) {
		...
		icon.setAttribute("style", "background-image: url('/syracuse-ui/themes/desktop/sage/images/modules/s_module_" + (module.code || "no_code").toLowerCase() + ".png')");
