...
exports.LandingVignetteSelect = helpers.defineClass(LandingVignetteSelect, DesktopPage, {
	...
	onMenuClick: function(menu) {
		...
		if (_gadgetTypes.indexOf(menu.$bind) >= 0) {
			...
			_callServer(self, menu.$method, menu.$url, function(data) {
				syra_menus.button.display(self.backBtn, true);
				_gotoStep(self, 2);
	...
	drawBox: function() {
		...
		this.backBtn = syra_menus.button.add({
			...
			isHidden: true,
			btnclick: function() {
				syra_menus.button.display(this, false);
				_gotoStep(this.parent, 1);
				this.parent.resizeArticle();
			}
		});
		this.titleLabel.parentNode.insertBefore(this.backBtn.link, this.titleLabel);
		_gotoStep(this, 1);
	},
