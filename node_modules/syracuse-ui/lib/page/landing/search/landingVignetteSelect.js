	...
	getPrototype: function() {
		...
		if (this.$prototype && this.$prototype.$properties) {
			this.$prototype.$properties.$searchVignetteField = {
				...
				$title: document.site.localize.landingVignetteSearch
			};
			...
			this.$prototype.$properties.selectedVignettes = {
				...
				$title: document.site.localize.landingVignetteSelectedVignettes,
				$item: {
					$type: "application/x-string"
				}
			};
					...
					$properties: {
						$searchResult: {
							...
							$item: {
								...
								$properties: {
									title: {
										$title: document.site.localize.landingVignetteSearchResultTitle,
										$type: "application/x-string",
										$format: "$html",
										$links: {
											$details: {}
									...
									menuCategory: {
										$title: document.site.localize.landingVignetteSearchResultCategories,
										$type: "application/x-array",
										$item: {
											$type: "application/x-string",
											"$format": "$html"
									...
									menuModule: {
										$title: document.site.localize.landingVignetteSearchResultModule,
										$type: "application/x-array",
										$item: {
											$type: "application/x-string",
											"$format": "$html"
			...
			case "sv-category-picker":
				...
				if (!this.selectedCatId || this.selectedCatId != catId) {
					...
					for (var ii = 0, jj = vignettes.length; ii < jj; ii++) {
						...
						vignetteItem.textContent = vignettes[ii].title || document.site.localize.landingVignetteNoTitle;
		...
		for (var ii = 0, jj = data.$resources.length; ii < jj; ii++) {
			...
			if (!this.vignetteData.modules[moduleKey]) {
				this.vignetteData.modules[moduleKey] = resource.module || {
					title: document.site.localize.landingVignetteNoModule
				};
			...
			if (!hasCategories) {
				if (!this.vignetteData.modules[moduleKey].categories[noCategoryKey]) {
					this.vignetteData.modules[moduleKey].categories[noCategoryKey] = {
						$uuid: noCategoryKey,
						$vignettes: [],
						description: document.site.localize.landingVignetteNoCategory
					};
				}
					...
					$items: [{
						...
						$layout: {
							$items: [{
								...
								$category: "section",
								$title: document.site.localize.landingVignetteSelectEndpoint,
								...
								$category: "section",
								$title: document.site.localize.landingVignetteBrowseCategory,
							...
							$items: [{
								...
								$layout: {
									$items: [{
										...
										$title: document.site.localize.landingVignetteUseSearch,
										$layout: {
											$items: [{
										...
										$noDataText: document.site.localize.landingVignetteNoVignetteSelected,
										$isHidden: true
									}]
								}
							}, {
								$category: "section",
								$title: document.site.localize.landingVignetteFounds,
