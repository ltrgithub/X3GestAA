...
exports.NavigationPage = helpers.defineClass(NavigationPage, DesktopPage, {
	designItem: function() {
		document.site.toggleClass(this.designerOpenerLink, "s-close", this.designing = !this.designing);
		if (this.menusBlocks) {
	...
	_ensureMenus: function() {
		this.page.loadNewItem(this.headerCoreRight, {
			...
			$bind: this.$prototype.$editMode == "admin" ? "$details" : "$edit",
			$icon: {
				$mode: "icon",
	...
	appendHeader: function() {
		...
		this.designerOpenerLink.title = this.localize.navigationPageOpenDesigner;
