...
exports.MenuBar = helpers.defineClass(MenuBar, null, {
    load: function(page){
        ...
        this.page.appendArticleMenus($$body);
        
        this._bindEvents(true);
        this._ensureState();
    },
    onMenuDataFilled: function(){
        if (!this.isSlotVisible && !this.page.authoringPage) {
            this._slot.style.display = "";
            this.isSlotVisible = true;
            if (this.page.$$container[0].style.display != "none") {
    ...
    onWindowResize: function(){
        if (this._bar && this._slot) {
            ...
            if (this.page.$dialogMode) {
                container = this.page.scrollview;
                this.dockMode.style.display = "none";
            }
            else {
                container = document.site.body;
            }
