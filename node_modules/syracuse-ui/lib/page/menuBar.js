...
exports.MenuBar = helpers.defineClass(MenuBar, null, {
    ...
    appendPickerBar: function(){
        ...
        self._resizer = document.site.setResizable({
            ...
            onResize: function(resizer){
                document.site.toggleClass(self.resizeBar, "s-resizing", resizer.resizing);
                document.site.toggleClass(self.openerPicker, "s-resizing", resizer.resizing);
            }
        });
    },
    hideBar: function(){
    ...
    onMenuDataFilled: function(menuItem){
        if (!this.isSlotVisible && !this.page.authoringPage && !this.isHidden) {
            if (menuItem.$skin && menuItem.$skin.indexOf("s-page-menus") >= 0) {
    ...
    ensureState: function(){
        if (this.preferences.menuBar.isCollapsed) {
            ...
            this.resizeBar.className = "s-page-menu-bar-resizer s-close";
            this.openerPicker.className = "s-page-menu-bar-opener  s-close";
            ...
            this.resizeBar.className = "s-page-menu-bar-resizer";
            this.openerPicker.className = "s-page-menu-bar-opener";
            if (this.preferences.menuBar.isDocked) {
    ...
    dispose: function(){
        ...
        this.menuGroups = this.$$slot = this._slot = this._bar = null;
