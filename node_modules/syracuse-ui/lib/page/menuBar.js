...
exports.MenuBar = helpers.defineClass(MenuBar, null, {
	load: function(page) {
		...
		page.attachToPageResizeListener(true, this);
		...
		this.body.className = this.page.$skin + "-menubar-body";
		this._bar.appendChild(this.body);
		this.page.appendArticleMenus(this.body);
		this.ensureState();
	},
	appendPickerBar: function() {
		...
		self._widgetResizer.isEnabled = !self.preferences.menuBar.isCollapsed;
	},
	...
	collapse: function() {
		this._widgetResizer.isEnabled = !(this.preferences.menuBar.isCollapsed = !this.preferences.menuBar.isCollapsed);
		this.ensureState();
		document.site.resize();
	},
		...
		if (!this.isHidden && !this._designing) {
			if (this.preferences.menuBar.isCollapsed) {
				...
				if (this.preferences.menuBar.isDocked) {
					this._slot.style.width = this._bar.style.width = "";
					this._slot.style.position = "";
					//this._slot.style.display = "";
				} else {
					this._slot.style.width = "10px";
	...
	_resizeWidthPage: function() {
		if (this.page.dialogWrapper && !this._designing) {
