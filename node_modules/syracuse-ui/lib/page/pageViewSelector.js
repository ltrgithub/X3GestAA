...
exports.PageViewSelector = helpers.defineClass(PageViewSelector, null, {
    load: function(page){
        this.page = page;
        this._choice = document.createElement("div");
        this._choice.className = this.page.$skin + "-head-footer-variants";
        this.fill(this.page.$views);
        this.page._headerFoooter.appendChild(this._choice);
    },
    ...
    fill: function($views){
        document.site.emptyDom(this._choice);
        this._views = {};
        if ($views && $views.length > 1) {
            ...
            this.page.loadNewItem(this._choice, {
    ...
    dispose: function(){
        this.page = this._choice = this._views = null;
    }
});
