...
exports.BarResizerDDAgent = helpers.defineClass(BarResizerDDAgent, null, {
	...
	onDragMouseUp: function(target, event) {
		this.barSplitter.$width = Math.max(this.barSplitter.minWidth, this.barSplitter.barSlot.clientWidth);
		this.barSplitter.barSlot.style.minWidth = this.resizerRect.width + "px";
		this.barSplitter.barSlot.style.width = this.barSplitter.$width + "px";
		...
		this.barSplitter.savePreferences("$width");
	},
	dispose: function() {
