...
exports.BarSplitter = helpers.defineClass(BarSplitter, null, {
	load: function(page) {
		...
		if (this.$width != undefined && parseInt(this.$width) <= 50) {
			delete this.$width;
		}
	...
	savePreferences: function(key) {
		if (this.preferenceKey) {
			...
			if (this.userPreferenceKey) {
				var pref = (this.page.$userPreferences[this.userPreferenceKey] = this.page.$userPreferences[this.userPreferenceKey] || {})[key];
