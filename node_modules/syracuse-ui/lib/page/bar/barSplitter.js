...
exports.BarSplitter = helpers.defineClass(BarSplitter, null, {
	load: function(page) {
		...
		this.barSlot.className += " s-bar-slot s-bar-slot-" + this.options.resizeDirection;
	...
	onChildPageMaximize: function(maximized) {
		if (maximized) {
			this.onBeforeMaximized = this.$isCollapsed;
			this.$isCollapsed = true;
			this.ensureState();
			this.page.resizeArticle(true);
		} else {
			if (this.onBeforeMaximized !== undefined) {
				this.$isCollapsed = this.onBeforeMaximized;
				this.ensureState();
				this.page.resizeArticle(true);
			}
		}
