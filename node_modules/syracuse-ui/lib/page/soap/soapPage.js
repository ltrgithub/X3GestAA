...
helpers.defineClass(SoapPage, DesktopPage, {
	...
	onMenuClick: function(menuItem) {
		if (menuItem.$bind == "$invoke") {
			var self = this;
			if (syra_workingCopy.validateAllInputs(self)) {
				...
				syra_url.formatMenuUrl(self, menuItem, null, function($url) {
					...
					syra_controller.callServer(self, {
						...
						var page = syra_pageBuilder.load($itemPage);
						page.masterPage = self;
						page.scrollContainer = self.layoutSlot;
...
exports.open = function(segments) {
	syra_controller.parseUrl(segments.$url).sendNewRequest({
