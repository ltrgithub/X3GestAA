...
exports.DashboardPage = helpers.defineClass(DashboardPage, DesktopPage, {
	...
	appendHeader: function() {
		...
		this.designerOpenerLink.display = this.refreshLink.style.display = "none";
	...
	onBoxClickItem: function(box, link) {
		if (box && box.$item.$isAddLandingTab) {
	...
	loadBox: function(initData, $initDiagnoses) {
		...
		if (this.isLandingPage) {
			this.designerOpenerLink.display = this.refreshLink.style.display = "";
			this.layoutContent.loadChildItem(null, {
				$category: "section",
