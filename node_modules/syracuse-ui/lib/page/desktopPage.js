...
exports.DesktopPage = helpers.defineClass(DesktopPage, RawPage, {
	...
	onDesignViewClick: function(event, target) {
		designerViewChoice.onDesignViewClick(this, event, target);
	},
	...
	appendHeader: function() {
		...
		designerViewChoice.registerDesignViews(this);
	},
	...
	loadSelectedDesignView: function($selectedView) {
		...
		query.sendRequest({
			...
			designerViewChoice.registerDesignViews(self, $selectedView || true);
			if (!self.$views) {
	...
	dispose: function() {
		...
		designerViewChoice.dispose(this);
		if (this.breadCrumbSlot) {
			this._breadCrumb = this.breadCrumbSlot = null;
		}
		this.securityViewSlot = this.security = this.openerUrlSegments = this.noProtoFields = null;
		this.garbage = this.$persistPrototype = null;
		this._advancedFieldsSlot = this._advancedFieldsBtn = this.diagnoseSlot = null;
