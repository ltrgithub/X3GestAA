...
exports.DesktopPage = helpers.defineClass(DesktopPage, RawPage, {
	...
	onWindowResize: function() {
		if (this._isPageLoaded) {
			...
			if (this.dialogWrapper) {
				...
				this.domItem.style.width = this.dialogWrapper.$$dialogSlot.width() + "px";
			} else {
	...
	showDiagnoses: function(message, options) {
		if (!this.diagnosesPanel) {
			if (this.$pageCategory == "navigation" || this.$pageCategory == "dashboard" || this.$pageCategory == "page" || this.$pageCategory == "fusion" || this.$pageCategory == "soap" || this.$pageCategory == "vignette") {
