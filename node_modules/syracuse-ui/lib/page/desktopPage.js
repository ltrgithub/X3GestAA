...
//http://www.siteduzero.com/informatique/tutoriels/ajax-et-l-echange-de-donnees-en-javascript/exemple-demonstratif
...
exports.DesktopPage = helpers.defineClass(DesktopPage, RawPage, {
    ...
    onShowAdvancedFields: function(){
        this._advancedFieldsFieldsLink.textContent = this._advancedFieldsFieldsLink.title = this.$isAdvancedFieldsVisible ? this.localize.box_advanced_hide : this.localize.box_advanced;
        document.site.toggleClass(this._advancedFieldsFieldsLink, "s-hide-advanced", this.$isAdvancedFieldsVisible);
    },
    toggleAdvancedFieldsMode: function(enable, onAuthoring){
        ...
        if (!this._advancedFieldsSlot) {
            this._advancedFieldsFieldsSlot = document.createElement("div");
            this._advancedFieldsFieldsSlot.className = this.$skin + "-head-advanced-fields";
            this._advancedFieldsFieldsSlot.setAttribute("data-s-box", this.id);
            this._headerViewSelector.parentNode.insertBefore(this._advancedFieldsFieldsSlot, this._headerViewSelector);
            this._advancedFieldsFieldsLink = document.createElement("a");
            this._advancedFieldsFieldsLink.setAttribute("data-s-box-picker", "advanced");
            this._advancedFieldsFieldsLink.className = this.$skin + "-head-advanced-fields-link";
            this._advancedFieldsFieldsSlot.appendChild(this._advancedFieldsFieldsLink);
        }
        this._advancedFieldsFieldsSlot.style.display = this.$isAdvancedModeEnabled ? "" : "none";
        ...
        if ($description) {
            ...
            if (title != $description) {
                if (!this.domDescription) {
                    ...
                    this._header.insertBefore(this._headerDescription, this._headerCore.nextSibling);
                }
                ...
                if (title && title == this.domDescription.textContent) {
                    this._headerDescription.style.display = "none";
                }
            }
        }
    },
    ...
    showDiagnoses: function(message, options){
        if (!this.diagnosesPanel) {
            ...
            if (this.$pageCategory == "dashboard" || this.$pageCategory == "page" || this.$pageCategory == "fusion" || this.$pageCategory == "soap") {
    ...
    dispose: function(){
        ...
        this._$sourceArticle = this.authorWorkingCopy = this.garbageFields = this.pageViewSelector = null;
        this._advancedFieldsSlot = this._$$diagnoseSlot = this._$$header = this._headerFoooter = this._headerViewSelector = null;
