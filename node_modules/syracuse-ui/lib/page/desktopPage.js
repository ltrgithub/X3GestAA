...
exports.DesktopPage = helpers.defineClass(DesktopPage, RawPage, {
    ...
    loadBox: function(initData){
        ...
        if (this.$facet == "$query") {
            if (this.$prototype && this.$prototype.$url && this.$prototype.$url.indexOf("employees") >= 0) {
                this.$prototype.$filters = this.$prototype.$filters ||
                {
                    filter1: {
    ...
    fitPageToContainer: function(resize){
        if (resize || this.$isResizeEnabled !== false) {
            var height = this.dialogWrapper ? this.dialogWrapper.$$layoutSlot.height() : document.site.$$body.height();
    ...
    applyActionLinkChange: function(resources){
        RawPage.prototype.applyActionLinkChange.call(this, resources);
        if (resources && resources.$filters) {
            if (this._filtersMenus) {
                this._filtersMenus._ensurePrivateMenus(resources, "$filters");
            }
        }
    },
    appendArticleMenus: function(slot){
        ...
        if (this.$facet == "$query") {
            this._filtersMenus = this.loadNewItem(slot || this._slot, {
                $category: "menus",
