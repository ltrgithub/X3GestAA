...
exports.DesktopPage = helpers.defineClass(DesktopPage, RawPage, {
	...
	resizeSplitter: function(barSplitter) {
		if (!barSplitter.options.isAutoModeDisabled) {
			...
			if (barSplitter.autoViewMode == undefined) {
				if (barSplitter.$viewMode == autoViewMode) {
	...
	dispose: function() {
		...
		this._advancedFieldsSlot = this._advancedFieldsBtn = this.diagnoseSlot = this.dataSlot = this.headerViewSelector = null;
