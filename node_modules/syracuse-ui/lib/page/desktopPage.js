...
exports.DesktopPage = _helpers.defineClass(DesktopPage, RawPage, {
	...
	loadBox: function(initData) {
		...
		if (this.mainPageDesignerAccess === "disabled") {
			syra_site.siteFunctions.showPageDesignerOpener(false);
			...
			if (syra_site.dom.isVisible(this.domItem)) {
				...
				if (this.dialogWrapper) {
					...
					if (!this.isFreeHeight && !this.inlinePageHost) {
						height = this.getPageSlot().getBoundingClientRect().height;
						if (height == 0) {
							return;
						}
	...
	dispose: function() {
		if (this.mainPageDesignerAccess === "disabled" && this.openerDialogDesignerAccess !== undefined) {
			syra_site.siteFunctions.refreshPageDesignerOpener(this.openerDialogDesignerAccess);
		}
