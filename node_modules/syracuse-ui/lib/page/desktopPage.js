...
exports.DesktopPage = helpers.defineClass(DesktopPage, RawPage, {
	...
	_loadAddNewItem: function(article, $newAddItem) {
		...
		if ($newAddItem.$fieldBind) {
			...
			//    $authoringLevel = $newAddItem.$authoringLevel;
	...
	onAddNewItem: function(article, targetItem, newItem, $insertAt) {
		...
		newChild = this._addNewItem(article, targetItem, newItem.$authoringLevel, newItem.$bind, newChild, $insertAt);
		if (newItem.$authoringLevel == "field") {
		...
		if (dropItem && dropItem.isLayout) {
			...
			if ($targetAuthoringLevel == "field") {
				if ($newAuthoringLevel == "field") {
					...
					//dragged section                       
					targetLayout.loadChildItems(dropItem.layoutContent.getItems("field"), targetItemIndex);
	...
	dispose: function() {
		...
		this.positionedList = this.diagnosesPanel = this._headerCore = this._headerCoreLeft = this.domDescription = null;
