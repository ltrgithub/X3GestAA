...
exports.DesktopPage = _helpers.defineClass(DesktopPage, RawPage, {
	loadBox: function(initData) {
		...
		this.defaultItemsPerPage = this.defaultItemsPerPage || 10;
		if (this.$facet == "$cube") {
	...
	appendHeader: function() {
		...
		// breadcrumb
		if (!this.page.isSecurityViewHidden && !this.isBreadCrumbHidden) {
			var top = document.createElement("div");
			top.className = "s-page-head-top";
			if (!this.isBreadCrumbHidden) {
