...
exports.DesktopPage = _helpers.defineClass(DesktopPage, null, {
	...
	drawPage: function() {
		...
		if (syra_site.footer && !this.isFooterDisabled && !this.overPanel && !this.inlinePageHost && !this.isVignettePage) {
			this.scrollview.appendChild(this.footer = syra_site.footer);
		}
