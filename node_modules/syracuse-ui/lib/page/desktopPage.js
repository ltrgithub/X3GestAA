...
exports.DesktopPage = helpers.defineClass(DesktopPage, RawPage, {
	...
	onScrollView: function() {
		...
		if (this._scrollViewListeners) {
			var ids = Object.keys(this._scrollViewListeners);
			for (var ii = 0, jj = ids.length; ii < jj; ii++) {
				if (this._scrollViewListeners[ids[ii]]) {
					var list = this.idMap[ids[ii]];
					if (list) {
						this._scrollViewListeners[ids[ii]](list.scroller);
					}
				}
			}
		}
