...
exports.DesktopPage = helpers.defineClass(DesktopPage, RawPage, {
    ...
    drawUserProfile: function(userProfile){
        if (document.site.$item.$isUserProfileQuickViewEnabled !== false) {
            this.headerUserProfile.style.display = "";
    ...
    appendHeader: function(){
        ...
        this.headerUserProfile.style.display = "none";
    ...
    onMenuClick: function(menuItem){
        var self = this;
        if (menuItem.$isViewVariant) {
            var query = document.controller.parseUrl(menuItem.$sourceUrl);
    ...
    dispose: function(){
        ...
        this._$$diagnoseSlot = this._$$dataSlot = this.$$scrollview = this.scrollview = this.$menus = this.menuBar = this.diagnosesPanel = this._headerCore = this._headerBottom = null;
