...
exports.menu = {
	fire: function(context, $link, dataset) {
		...
		$link.$url = exports.data.parseExpression(context, $link.$url, dataset);
...
exports.item = {
	...
	addArticle: function(context, article, initData) {
		article.articleParent = context.field.articleParent;
		article.page = context.field.page;
		syra_article.beforeDraw(article);
