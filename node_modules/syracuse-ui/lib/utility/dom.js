...
function create(tag, css, parent) {
	var item = document.createElement(tag);
	item.className = css;
	parent && parent.appendChild(item);
	return item;
}
exports.input = function(css, parent, type) {
...
exports.textarea = function(css, parent, rows) {
...
exports.span = function(css, parent) {
	return create("span", css, parent);
};
exports.div = function(css, parent) {
	return create("div", css, parent);
};
exports.label = function(css, parent) {
	return create("label", css, parent);
};
exports.addFontIcon = function(css, fontKey, parent) {
	var icon = exports.div(css + " s-fonticon-btn", parent);
	icon.innerHTML = fontKey;
	return icon;
};

exports.text = function(css, text, parent) {
	var div = document.createElement("div");
	div.className = css;
...
exports.pre = function(css, text, parent) {
...
exports.header = function(css, parent) {
	return create("header", css, parent);
};
exports.article = function(css, parent) {
	return create("article", css, parent);
};
exports.li = function(css, parent) {
	return create("li", css, parent);
};
exports.ul = function(css, parent) {
	return create("ul", css, parent);
};

exports.img = function(css, url, parent) {
...
exports.anchor = function(css, parent) {
	return create("a", css, parent);
};

exports.getParentByTag = function(node, tag, root) {
	while (node) {
		if (node.tagName == tag) {
			return node;
		}
...
exports.td = function(css, parent) {
	return create("td", css, parent);
};