...
exports.DocumentFieldAddin = helpers.defineClass(DocumentFieldAddin, null, {
	...
	onShow: function() {
		if (this.designer.awItem.$authoringType == "documentField") {
			this.designer.applyChange({
				$documentField$isAutoSize: this.designer.awItem.$item.$isAutoSize,
				$documentField$imageWidth: this.designer.awItem.$item.$imageWidth,
				$documentField$imageHeight: this.designer.awItem.$item.$imageHeight,
				$documentField$isEmbedded: this.designer.awItem.$item.$isEmbedded,
				$properties: {
					$documentField$isAutoSize: {
						isHidden: !this.designer.awItem.isImage
					},
