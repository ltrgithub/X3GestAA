...
exports.DragDrop = helpers.defineClass(DragDrop, null, {
    start: function($$boundary){
        ...
        $(document).bind("mouseup.syradragdrop", function(event){
            if (self.targetItem) {
                ...
                authorPage.layoutAuthoring.newMoveItem(self.targetItem.layoutParent, self.targetItem, self.sourceItem, self.$drag.$insert == "insertAfter");
                authorPage.selectItem(self.sourceItem, true);
    ...
    _calculateDropCuePosition: function(event, targetItem){
        ...
        if (targetItem && targetItem.layoutParent) {
            ...
            var $$target = (targetItem._tabTitle) ? $(targetItem._tabTitle) : targetItem.$$item;
