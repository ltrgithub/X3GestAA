        ...
        "$layout": {
            "$items": [{
                ...
                "$layout": {
                    ...
                    "$fitToContent": true,
                    "$items": [{
                        "$bind": "s-layout-type-1"
                    }, {
                        "$bind": "s-layout-type-2"
                    }, {
                        "$bind": "s-layout-type-3"
                    }, {
                        "$bind": "s-layout-type-4"
                    }, {
                        "$bind": "s-layout-type-5"
                    }, {
                        "$bind": "s-layout-type-more"
                    }]
                }
            }]
        }
    ...
    return {
        ...
        "$layout": {
            "$items": [{
                ...
                "$category": "field",
                "$isExcluded": !($level == "article" || $level == "section"),
        ...
        $items: [{
            ...
            "$layout": {
                "$items": [{
                    ...
                    "$layout": {
                        "$layoutType": "stack",
                        "$items": [getRow(), getLayout("article"), {
                            "$category": "section",
                            "$skin": "s-aw-h2",
                            "$css": "s-aw-palette-article",
                            "$bind": "$field",
            ...
            "$layout": {
                "$items": [{
                    ...
                    "$layout": {
                        "$layoutType": "stack",
                        "$items": [getRow(), getLayout("section"), {
                            "$category": "section",
                            "$skin": "s-aw-h2",
                            "$css": "s-aw-palette-section",
                            "$isBoxCollapsable": true,
