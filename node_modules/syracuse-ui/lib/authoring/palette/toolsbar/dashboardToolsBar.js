...
exports.DashboardToolsBar = helpers.defineClass(DashboardToolsBar, ToolsBar, {
    ...
    loadAvailableVignettes: function(){
        this._loadAvailableVignettes(this.awContext.targetPage.$freeVignetteBinds);
    ...
    onEndExcludeItem: function(){
        ...
        if (layoutTabs.tabOpened && layoutTabs.tabOpened.$isHidden) {
            if (!this._insertFreeLinksBox.$isHidden) {
                this._insertFreeLinksBox.tabTitle.click();
            }
            else {
                if (!this._insertFreeVignettesBox.$isHidden) {
                    this._insertFreeVignettesBox.tabTitle.click();
                }
            }
        }
    ...
    onExcludeField: function($bind, isExcluded, isVignette){
        ...
        if (isExcluded) {
            ...
            if (!isVignette) {
                ...
                menuBox = this._insertFreeVignettesBox;
                if (this.awContext.targetPage.$freeVignetteBinds.indexOf($bind) >= 0) {
                    this.awContext.targetPage.$freeVignetteBinds.splice(this.awContext.targetPage.$freeVignetteBinds.indexOf($bind), 1);
