...
exports.ToolsBar = helpers.defineClass(ToolsBar, RawPage, {
    ...
    dispose: function(){
        ...
        this._insertMenusBox = this._$insertActions = this._$insertItems = null;
    ...
    _loadInsertLinks: function(){
        ...
        for (var ii = 0, jj = fields.length; ii < jj; ii++) {
            var $action = this._$insertActions["$insertAction" + fields[ii].$item.$bind];
            if ($action) {
    ...
    reloadInsertMenus: function(){
        ...
        this._reloadInsertMenuBox(this._insertMenusBox, this._loadInsertLinks());
    },
