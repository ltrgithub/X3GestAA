...
exports.ToolsBar = helpers.defineClass(ToolsBar, RawPage, {
    ...
    dispose: function(){
        ...
        if (this.awContext) {
            ...
            this.awContext.articleToolBox = this.awContext.columnsToolBox = null;
        }
        this.awContext = this._boxes = this.layoutSlot = null;
    },
    ...
    onMenuClick: function(menuItem){
        switch (menuItem.$item.$bind) {
            case "$addSection":
            case "$addBlock":
                var newChild = this.awContext.authorPage.addNewItem(this.awContext.awArticle, this.awContext.awItem, menuItem.$item.$bind.replace("$add", "").toLowerCase());
                this.awContext.authorPage.endTargetPageUpdate(newChild, true);
                return false;
            case "$addMenus":
                var newChild = this.awContext.authorPage.addNewItem(this.awContext.awArticle, this.awContext.awItem, "block", null, undefined, undefined, "menus");
                this.awContext.authorPage.endTargetPageUpdate(newChild, true);
                return false;
            case "$defaultLayout":
