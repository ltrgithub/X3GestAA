	...
	onNodeClick: function(event) {
		...
		if (node && !node.item.$awAddNewItem) {
			if (node.item == this.trees.designer.designedArticle) {
				syra_page.scrollToItem(this.trees.designer.designedArticle.page, node.item);
			}
		...
		if (!this._isSelecteDisabled && item && !item.disposed) {
			...
			if (node) {
				if (select) {
					...
					syra_page.scrollToItem(this.trees.designer, this.selectedNode.node, this.tabItem.body, true);
				} else {
