...
exports.InsertTree = helpers.defineClass(InsertTree, ItemTree, {
	...
	fill: function() {
		...
		this._addInsertNewPageFrameNode();
		this._addInsertNewPageFrameNode2();
		this._addInsertNewPageFrameNode3();
		this.itemNodeStart = 4;
	...
	_addInsertNewPageFrameNode: function() {
		var itemNode = this._createNodeItem("node-" + this.nodes.length, "field");
		this.tabItem.body.appendChild(itemNode.node);
		itemNode.titleLabel.textContent = itemNode.node.title = "sage vignette";
		this.nodes.push(itemNode);
		itemNode.item = {
			$title: "sage vignette",
			$awAddNewItem: true,
	...
	_addInsertNewPageFrameNode2: function() {
		var itemNode = this._createNodeItem("node-" + this.nodes.length, "field");
		this.tabItem.body.appendChild(itemNode.node);
		itemNode.titleLabel.textContent = itemNode.node.title = "employes vignette";
		this.nodes.push(itemNode);
		itemNode.item = {
			$title: "employes vignette",
			$awAddNewItem: true,
			$isPageFrame: true,
			$designLevel: itemNode.$designLevel,
			$field: {
				$type: "application/x-vignette",
				$title: "testlpemployemenu",
				$location: {
					$method: "GET",
					$target: "self",
					$title: "testlpemployemenu",
	...
	_addInsertNewPageFrameNode3: function() {
		var itemNode = this._createNodeItem("node-" + this.nodes.length, "field");
		this.tabItem.body.appendChild(itemNode.node);
