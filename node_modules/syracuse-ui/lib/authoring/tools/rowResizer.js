...
function _drawSteps(resizer) {
	...
	resizer.markersSlot = document.createElement("div");
	resizer.markersSlot.className = "s-aw-markers";
...
exports.RowResizer = helpers.defineClass(RowResizer, null, {
	...
	onDragMouseUp: function(target, event) {
		...
		var step = null;
		var right = syra_site.dom.getBoundingClientRect(this._left)[this.sideProperty];
