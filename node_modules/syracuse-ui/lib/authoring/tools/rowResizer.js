...
exports.RowResizer = helpers.defineClass(RowResizer, null, {
	start: function(dropItem, designer, $$boundary) {
		...
		this.startX = this.$$rowSeparator.offset().left;
		...
		this.leftWidth = $(this.leftItem.layoutSlot).width();
		this.rightItem = this.layout.items[this.index];
		this.rightWidth = $(this.rightItem.layoutSlot).width();
		this.offset = $(this.layout.$$item).offset();

		this.margin = document.site.$$body.offset();
