"use strict";
var _addins = [require("syracuse-ui/lib/authoring/fieldAddins/choiceFieldAddin"), require("syracuse-ui/lib/authoring/fieldAddins/documentFieldAddin"), require("syracuse-ui/lib/authoring/fieldAddins/htmlFielddAddin")];
...
function _addVignette(designer) {
	...
	syra_over.openModal(designer, {
		article: designer,
		$url: syra_config.$landingUrl,
		$isOkHidden: true,
...
function _fillRowSection(designer, box) {
	if (!box.insertRow) {
		...
		var cell = syra_dom.div("s-aw-insert-row-btns", syra_local.aw_addrow, row);
...
SettingBar.prototype.resizeBar = function() {
	if (this.slot.parentNode) {
		if (this.selectedPanel) {
			this.selectedPanel.body.style.height = (Math.max(0, this.slot.clientHeight - this.selectedPanel.body.offsetTop)) + "px";
		}
