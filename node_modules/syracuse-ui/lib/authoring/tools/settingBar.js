...
function _addPanel($title, $skin) {
	...
	panel.itemTitle = syra_dom.div("s-aw-panel-head-title" + $skin, panel.head);
...
function _addBox(container, $title, $skin) {
	...
	box.body = syra_dom.div("s-aw-box-body", slot);
...
SettingBar.prototype.resizeBar = function(height) {
	if (this.slot.parentNode) {
		this.slot.style.height = height + "px";
		if (this.selectedPanel) {
			this.selectedPanel.body.style.height = (Math.max(0, height - this.selectedPanel.body.offsetTop)) + "px";
		}
		this.designer.asideParent.domItem.style.paddingRight = this.slot.clientWidth + "px";
	}
};
SettingBar.prototype.getScrollHeight = function() {
...
exports.load = function(designer, slot) {
	return new SettingBar(designer, slot);
};