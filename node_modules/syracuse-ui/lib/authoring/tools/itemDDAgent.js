...
exports.ItemDDAgent = helpers.defineClass(ItemDDAgent, null, {
	start: function(dropItem, itemTool, boundaryItem) {
		...
		this.scrollViewRect = syra_site.dom.getBoundingClientRect(boundaryItem);
	...
	_ensureDragImage: function() {
		if (!this._info) {
			...
			if (this.dropItem.$field) {
				this._info.appendChild(syra_menus.addFontIconFlag("s-aw-tree-field-type", syra_fields.getTypeFieldIcon(this.dropItem.$field.$type)));
			}
