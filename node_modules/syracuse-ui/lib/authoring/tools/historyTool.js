...
exports.HistoryTool = helpers.defineClass(HistoryTool, null, {
	...
	onAfterStepChange: function($item) {
		try {
			...
			this.designer.awArticle.reloadLayout($article);
			this.refreshStepLinks();
			var itemToSelect = null;
			if ($bind) {
				var bounds = this.designer.awArticle.boundFields[$bind];
				if (bounds) {
			...
			this.designer.applyChangeToMobile($article);
			this.designer.onEndHistoryChangeStep(itemToSelect || this.designer.awArticle);
		} finally {
