...
exports.DesignerLabel = helpers.defineClass(DesignerLabel, null, {
	load: function(designer, $stepSkin) {
		this.designer = designer;
		this.designer.$prototype.$properties.$labelAlignment = {
			$type: "application/x-choice",
			$title: this.designer.designerLocalize.aw_labelPosition,
			$value: {
				$type: "application/x-string",
				$enum: [{
					$value: "t",
					$title: this.designer.designerLocalize.aw_labelPositionTop
				}, {
					$value: "ll",
					$title: this.designer.designerLocalize.aw_labelPositionLeftLeft
				}, {
					$value: "lr",
					$title: this.designer.designerLocalize.aw_labelPositionLeftRight
				}]
			}
		};
		this.designer.$prototype.$properties.$isTitleHidden = {
			$type: "application/x-boolean",
			$title: this.designer.designerLocalize.aw_isTitleHidden
		};
		this.designer.$prototype.$properties.$fieldsIsTitleHidden = {
			$type: "application/x-boolean",
			$title: this.designer.designerLocalize.aw_isLabelHidden
		};
	},
