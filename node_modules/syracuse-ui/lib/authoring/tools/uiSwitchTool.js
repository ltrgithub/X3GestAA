...
exports.UISwitchTool = helpers.defineClass(UISwitchTool, null, {
	...
	toggleUIDesign: function(item, enable, disposingDesigner) {
		...
		if (item.syraSeparator && item.layoutSlot) {
			syra_site.dom.toggleClass(item.layoutSlot, "s-aw-sep-" + item.layoutParent.$layout.$layoutType, enable);
		}
	...
	onDeleteLayoutClick: function(event, btn) {
		syra_site.layoutUpdater.onDeleteLayoutClick(this.designer, event, btn);
	},
