...
exports.UISwitchTool = helpers.defineClass(UISwitchTool, null, {
	...
	toggleItemAuthoring: function(item, enable) {
		...
		if (item == this.designer.awArticle) {
			if (item.menuBar) {
				item.menuBar.toggleItemAuthoring(enable || this.designer.viewsTool.isOnPreviewMode, this.designer.viewsTool.isOnPreviewMode);
			}
			if (item.fusionBar) {
				item.fusionBar.toggleItemAuthoring(enable || this.designer.viewsTool.isOnPreviewMode, this.designer.viewsTool.isOnPreviewMode);
			}
