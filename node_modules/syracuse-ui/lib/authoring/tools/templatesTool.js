...
exports.TemplatesTool = helpers.defineClass(TemplatesTool, null, {
			...
			if (!children[ii].disposed) {
				...
				switch (row) {
					case 0:
						...
						break;
					case 1:
						layout = section.layoutContent.loadChildItem(null, {
							$layoutType: "stack",
							$items: []
						}, colIndex);
						break;
					default:
						layout = section.layoutContent[colIndex];
						break;
				}
	...
	_applyMixtModel: function(section, children) {
		children = children || section.layoutContent.extractItems();
		var prevLayout = section.layoutContent._item;
		section.layoutContent.clearContent();
		section.$item.$layout = {
