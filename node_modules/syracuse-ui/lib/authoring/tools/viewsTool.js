...
exports.ViewsTool = helpers.defineClass(ViewsTool, null, {
	...
	toggleViewType: function($viewType) {
		...
		if (this.isOnPreviewMode && this.$viewType != "viewTypePreview") {
			...
			this.designer.uiSwitchTool.toggleUIDesign(this.designer.awArticle, true);
		}
		...
		this.designer.uiSwitchTool.toggleUIDesign(this.designer.awArticle, !this.isOnPreviewMode);
		this.designer.awArticle.page.layoutValidator.validate(this.designer.awArticle.layoutContent, true);
