...
exports.ViewsTool = helpers.defineClass(ViewsTool, null, {
	...
	toggleViewType: function($viewType) {
		...
		this.designer.designedArticle.page.layoutValidator.validate(this.designer.designedArticle.layoutContent, true);
		this.designer.designedArticle.page.onWindowResize();
	},
