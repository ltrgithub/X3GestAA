...
exports.ViewsTool = helpers.defineClass(ViewsTool, null, {
	load: function(designer, $skin) {
		...
		document.site.dom.toggleClass(this._links[this.$viewType = "viewTypeLayout"], "s-selected", true);
	...
	toggleViewType: function($viewType) {
		if (this.$viewType) {
			document.site.dom.toggleClass(this._links[this.$viewType], "s-selected", false);
		}
		...
		document.site.dom.toggleClass(this._links[this.$viewType], "s-selected", true);
