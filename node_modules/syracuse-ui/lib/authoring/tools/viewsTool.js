...
exports.ViewsTool = helpers.defineClass(ViewsTool, null, {
	...
	toggleViewType: function($viewType) {
		...
		if (this.isOnPreviewMode && this.$viewType != "viewTypePreview") {
			...
			this.designer.uiSwitchTool.toggleUIDesign(this.designer.awArticle.page, true);
		}
		...
		this.designer.uiSwitchTool.toggleUIDesign(this.designer.awArticle.page, !this.isOnPreviewMode);
