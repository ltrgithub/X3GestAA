	...
	toggleViewType: function($viewType) {
		...
		switch (this.$viewType) {
			case "viewTypeJSON":
				...
				this.designer.treebarSlot.style.display = this.designer.propertiesSlot.style.display = "none";
			...
			case "viewTypePreview":
				...
				break;
			default:
				this.designer.treebarSlot.style.display = this.designer.propertiesSlot.style.display = "";
				break;
		}
