...
exports.DesignDDAgent = helpers.defineClass(DesignDDAgent, null, {
	start: function(dropItem, designer, $$boundary) {
		...
		$$boundary = $($$boundary);
		this.boundary = $$boundary.offset();
		this.boundary.$$boundary = $$boundary;
		this.boundary.height = $$boundary.height();
		this.boundary.width = $$boundary.width();
		this.boundary.scrollWidth = $$boundary[0].scrollWidth;
		this.boundary.scrollHeight = $$boundary[0].scrollHeight;
