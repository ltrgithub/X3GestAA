...
exports.AuthorPage = helpers.defineClass(AuthorPage, RawPage, {
    ...
    toggleItemAuthoring: function(item, enable){
        ...
        if (item.fusionBar) {
            item.fusionBar.toggleItemAuthoring(enable || this.isOnPreviewMode);
            if (this.isOnPreviewMode) {
                item.fusionBar._slot.style.display = "";
            }
        }
        if (item.menuBar) {
            item.menuBar.toggleItemAuthoring(enable || this.isOnPreviewMode);
            if (this.isOnPreviewMode && !item.menuBar.isHidden && item.menuBar.isSlotVisible) {
                item.menuBar._slot.style.display = "";
            }
        }
