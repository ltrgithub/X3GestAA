...
exports.AuthorPage = helpers.defineClass(AuthorPage, RawPage, {
	...
	beginAuthoring: function(awPageSlot, authoredItem) {
		...
		if (this.targetPage.$prototype.$article) {
			this.targetPage.$prototype.$article = helpers.object.clone(this.targetPage.$prototype.$article, true);
		}
