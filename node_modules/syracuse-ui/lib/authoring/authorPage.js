...
exports.AuthorPage = helpers.defineClass(AuthorPage, RawPage, {
    ...
    toggleViewType: function($viewType){
        ...
        if ($viewType == "menus") {
            ...
            this.targetPage.menuBar.resizeBar.style.display = "none";
        }
        else {
            this.targetPage.dataSlot.style.display = "";
            this.targetPage.menuBar._slot.style.display = "none";
            this.targetPage.menuBar._slot.style.width = "";
            this.targetPage.menuBar.resizeBar.style.display = "";
        }
    ...
    bindEvents: function(){
        ...
        document.site.$$layoutSlot.delegate(".s-aw-item", "click.author", function(event){
            ...
            if (!document.site.resizing && !self.rowResizer.onResizing) {
                var item = self.findTargetItemEvent(this);
                if (item) {
                    if (item != self.targetPage) {
                        if (document.site.requestedDDAuthoringItem) {
