...
exports.AuthorPage = helpers.defineClass(AuthorPage, RawPage, {
    ...
    notifySteps: function(pageContext, resetUpdates){
        ...
        if (!resetUpdates && this.isUpdated) {
            ...
            this.updatedSteps.push(helpers.object.clone(pageContext.awArticle.$item, true));
    ...
    onChangeSep: function(menuItem){
        ...
        switch (menuItem.$item.$bind) {
            ...
            case "$undoAllLayout":
                ...
                break;
            case "$defaultLayout":
                $item = helpers.object.clone(document.site.ensureDefaultArticle(pageContext.$prototype.$article, pageContext.$prototype), true);
    ...
    notifyActionChange: function(target, value, notifyServer){
        ...
        if ($article.$generatorVersion) {
            document.site._cvgPageConverterMakePersistent(awContext.targetPage.$prototype, $article);
        }
