...
exports.PageStorage = _helpers.defineClass(PageStorage, DesktopPage, {
	loadStorage: function(designer) {
		...
		this.crudSlot = syra_dom.div("s-aw-page-wc", designer.layoutSlot);
	...
	saveDesign: function($article) {
		if (this.hasWorkingCopy) {
			syra_form.getSendBag(this).content = {
				$article: syra_layout.cleanBeforeSave(_helpers.object.clone($article || this.designer.designedArticle.page.$item, true))
			};
		}
	},
	dispose: function() {
