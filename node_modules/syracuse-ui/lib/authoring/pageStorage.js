...
function _loadSelectedDesignView(page, $selectedView) {
	...
	query.sendNewRequest({
		...
		onSuccess: function(data, response, requestUrl) {
			...
			if (!page.$views) {
				page.$item = _helpers.object.clone(page.ensureDefaultArticle(page.$prototype.$article, page.$prototype), true);
...
exports.PageStorage = _helpers.defineClass(PageStorage, RawPage, {
	...
	cancelUpdate: function() {
		var $item = _helpers.object.clone(this.designer.$sourceItem, true);
