		...
		$(document).bind("mouseup.syradragdrop", function(event) {
			if (self.targetItem) {
				...
				if (self.dropItem) {
					...
					if (enable) {
						/*if (self.dropItem.layoutParent && self.dropItem.layoutParent.isRow) {
                         self.dropItem.layoutParent.addSpaceBox(self.dropItem.layoutParent.items.indexOf(self.dropItem));
                         }*/
