            ...
            if (self.targetItem) {
                ...
                if (targetItem && dropItem) {
                    ...
                    if (targetItem.layoutParent && targetItem.layoutParent.$layout.$layoutType == "row") {
                        enable = !(targetItem.layoutParent.items.length > 5 && ($insertAt == "left" || $insertAt == "right"));
                    }
                    if (enable) {
                        ...
                        authorPage.endTargetPageUpdate(newChild);
                    }
                }
            }
            self.stop();
            ...
            if (this.dropItem != targetItem) {
                ...
                if (this.dropItem.isLayout) {
                    if (this.dropItem.boxParent == targetItem.boxParent) {
                        ...
                        if (layoutParent) {
                            if (layoutParent == this.dropItem || layoutParent.layoutParent) {
                                return false;
                            }
                            
                        }
                        /*while (layoutParent) {
                         if (layoutParent == this.dropItem) {
                         return false;
                         }
