...
exports.ListDesigner = helpers.defineClass(ListDesigner, Designer, {
    designCardItem: function(cardItem){
        document.site.designItem(true, cardItem, CardDesigner);
        (this.cardDesiggner = cardItem.designer).onWindowResize();
    },
    ...
    onChangeMode: function(newMode){
        ...
        designer.awArticle.applyDesignMetaData(metaData, true);
        designer.endTargetPageUpdate();
    ...
    drawBox: function(){
        ...
        this.workinCopySlot.className = "s-aw-list-wc";
    ...
    getDesignedCardItem: function(){
        ...
        if (this.awArticle.$item.$format == "grid") {
            if (this.awArticle.$item.$cardItem) {
                if (this.awArticle.cardDecorator.isRowCardMode) {
                    this.awArticle.cardDecorator.toggleRowCard(record, true);
                    cardItem = record;
                }
                else {
        ...
        for (var ii = 0, jj = modeTypes.length; ii < jj; ii++) {
            ...
            switch (modeType) {
                ...
                case "cards":
                    ...
                    this.templatesTool.addColsCountLinks(this.sectionCards, this.awItem, this.awArticle.$cardsByRowCount || 1, 6);
    ...
    dispose: function(){
        ...
        this.cardDesiggner =  this.switchPagerLinks = this.graphAddin = this.modes = null;
