...
exports.ListDesigner = helpers.defineClass(ListDesigner, Designer, {
	...
	drawBox: function() {
		...
		this.sectionGridCardBody = this.modes.detailgrid.body.appendChild(document.createElement("div"));
		this.sectionCards = {
		...
		this.sectionGridCardBody.appendChild(this.designGridCardLink);
