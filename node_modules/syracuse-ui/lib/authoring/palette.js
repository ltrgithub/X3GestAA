...
exports.Palette = helpers.defineClass(Palette, RawPage, {
	...
	onExcludeField: function($bind, isExcluded) {
		if (isExcluded) {
			this.targetPage.garbageFields[$bind] = 1;
		} else {
			...
			delete this.targetPage.garbageFields[$bind];
		}
		this.targetPage.$item.$garbageFields = Object.keys(this.targetPage.garbageFields);
	},
