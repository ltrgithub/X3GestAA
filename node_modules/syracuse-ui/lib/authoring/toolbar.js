...
exports.Toolbar = helpers.defineClass(Toolbar, null, {
	load: function(awPalette) {
		...
		(this.contentTree = new ContentTree()).load(this, this.appendTab(localize.aw_viewTypeContent));
		(this.insertTree = new InsertTree()).load(this, this.appendTab(localize.aw_insert));
	...
	onExcludeField: function($bind, isExcluded) {
		this.contentTre.onExcludeField($bind, isExcluded);
		this.insertTree.onExcludeField($bind, isExcluded);
	},
	...
	dispose: function() {
		...
		this.contentTree = this.insertTree = this.awPalette = this.toolbarBody = null;
	}
});