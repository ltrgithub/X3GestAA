...
function _ensureDesigneBar(designer, isDesigning) {
	...
	if (isDesigning) {
		...
		syra_site.dom.hide(designer.propertiesSlot, !designer.isDesignBarVisible);
	} else {
...
exports.Designer = helpers.defineClass(function() {}, Designer, {
	...
	drawBox: function() {
		...
		syra_site.dom.hide(this.layoutSlot, false);
		...
		var bar = this.treesBar = new BarSplitter();
		bar.options = {
		...
		this.designedArticle.garbage.loadFreeField();
		(this.contentTree = new ContentTree()).load(this);
		(this.insertTree = new InsertTree()).load(this);
		this.contentTree.tabItem.select(true);


		syra_site.dom.hide(this.propertiesSlot, false);
		syra_site.dom.hide(this.treebarSlot, false);
		...
		if (this.designedArticle.$item.$transaction && this.leftTop) {
			...
			syra_site.dom.hide(this.transactionLabel, true);
	...
	displayViewTitle: function($view) {
		...
		syra_site.dom.hide(this.viewTitleSlot, !! $view);
	},
	...
	onTopScreenDesigner: function(isTop) {
		syra_site.dom.hide(this.propertiesSlot, !isTop);
		syra_site.dom.hide(this.layoutSlot, !isTop);
		syra_site.dom.hide(this.treebarSlot, !isTop);
	},
