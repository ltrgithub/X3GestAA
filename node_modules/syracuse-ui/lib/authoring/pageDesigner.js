...
function _appendTreesTab(designer, title) {
...
function _addTreeBar(designer) {
	...
	(designer.contentTree = new ContentTree()).load(designer, _appendTreesTab(designer, syra_local.aw_viewTypeContent));
	(designer.insertTree = new InsertTree()).load(designer, _appendTreesTab(designer, syra_local.aw_insert));
