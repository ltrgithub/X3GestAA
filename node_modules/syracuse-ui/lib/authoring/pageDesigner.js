...
function _ensureDesigneBar(designer, isDesigning) {
	...
	designer.isDesignBarVisible = isDesigning && designer.$viewType != "viewTypePreview";
	syra_site.dom.hide(designer.propertiesBar.slot, !designer.isDesignBarVisible);

	designer.asideParent.domItem.style.paddingLeft = designer.isDesignBarVisible ? (designer.treebarSlot.clientWidth + "px") : "";
	designer.asideParent.domItem.style.paddingRight = designer.isDesignBarVisible ? (designer.propertiesBar.slot.clientWidth + "px") : "";
...
exports.Designer = helpers.defineClass(function() {}, Designer, {
	...
	onTopScreenDesigner: function(isTop) {
		syra_site.dom.hide(this.propertiesBar.slot, !isTop);
