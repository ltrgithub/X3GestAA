...
exports.Designer = helpers.defineClass(function() {}, Designer, {
	...
	applyChange: function(newData) {
		if (newData) {
			...
			for (var ii = 0, jj = _addins.length; ii < jj; ii++) {
				this.settingBar.addins[ii].onDesignerApplyChange(this, newData);
			}
	...
	notifyDataChange: function(field, value) {
		...
		switch (field.$item.$bind) {
			...
			default:
				var metaData = {};
				if (!_localizationTool.updateForm(this, metaData, field, value)) {
					switch (field.$item.$bind) {
				...
				if (this.designedItem.$designLevel == "field") {
					for (var ii = 0, jj = this.settingBar.addins.length; ii < jj; ii++) {
						this.settingBar.addins[ii].updateForm(this, metaData);
					}
				}
				this.history.updateSteps();
