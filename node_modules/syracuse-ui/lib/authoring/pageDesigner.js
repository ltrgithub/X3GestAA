...
var _itemTool = require("syracuse-ui/lib/authoring/tools/itemTool");

var _settingBar = require("syracuse-ui/lib/authoring/tools/settingBar");
...
exports.Designer = helpers.defineClass(function() {}, Designer, {
	...
	drawPage: function() {
		...
		this.itemTool = _itemTool.add(this);
		...
		this.settingBar = _settingBar.load(this, this.asideParent.domItem);
	...
	resizeItem: function(resize) {
		if (this.settingBar) {
			...
			if (this.isDesignBarVisible) {
				...
				this.settingBar.resizeBar(page.getPageSize().barHeight);
			} else {
