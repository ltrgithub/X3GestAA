...
exports.PageDesigner = helpers.defineClass(PageDesigner, Designer, {
	...
	onAddRowClick: function(event, picker) {
	...
	onExcludeItemClick: function(event, picker) {
	...
	addExcludeMeLink: function(panelId) {
		if (panelId != "article") {
			...
			if (!this.selectedPanel.datastore.excludeMeLink) {
				...
				link.textContent = link.title = syra_local.aw_excludeMe;
