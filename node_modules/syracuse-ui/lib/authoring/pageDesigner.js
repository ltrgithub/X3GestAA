...
exports.Designer = helpers.defineClass(function() {}, Designer, {
	...
	drawPage: function() {
		...
		bar.resizeBar = function() {
			if (this.designer.contentTree) {
				var bodyHeight = Math.max(this.slot.clientHeight - this.header.clientHeight, 20) + "px";
		...
		syra_site.layoutSlot.style.paddingTop = this.layoutSlot.getBoundingClientRect().height + "px";
	...
	_ensureDesigneBar: function(isDesigning) {
		...
		if (this.settingBar) {
			...
			this.asideParent.domItem.style.paddingRight = this.isDesignBarVisible ? (this.settingBar.slot.clientWidth + "px") : "";
		}
