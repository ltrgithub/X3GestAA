...
exports.ArrayAuthoring = helpers.defineClass(ArrayAuthoring, RawPage, {
	...
	loadBox: function() {
		...
		this.$prototype = {
			"$properties": {
				...
				$position: {
					$type: "application/x-choice",
					$title: localize.lw_cardPosition,
					$value: {
						$type: "application/x-string",

						$enum: [{
							$value: "no",
							$title: localize.lw_cardPositionNo
						}, {
							$value: "inline",
							$title: localize.lw_cardPositionInline
						}, {
							$value: "top",
							$title: localize.lw_cardPositionTop
						}, {
							$value: "left",
							$title: localize.lw_cardPositionLeft
						}, {
							$value: "right",
							$title: localize.lw_cardPositionRight
						}, {
							$value: "bottom",
							$title: localize.lw_cardPositionBottom
						}]
					}
				},
				$cardsByRowCount: {
	...
	ensureDesignContext: function(designer) {
		if (!this.designer) {
			this.designer = document.site.authorPage.createContext(this.designedField);
		}
	},
