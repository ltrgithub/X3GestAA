...
exports.ArrayAuthoring = helpers.defineClass(ArrayAuthoring, RawPage, {
    ...
    onNotifyDataChange: function(field, value){
        ...
        this.designedField.awContext.toolsBar.ensureArrayBoxVisibility();
        this.notifyUpdate();
        this.designedField.awContext.authorPage.endTargetPageUpdate();
    },
    ...
    ensureDesignContext: function(awContext){
        if (!this.designedField.awContext) {
            this.designedField.awContext = awContext.authorPage.createContext(this.designedField, {
                isArrayField: true
            });
        }
    },
