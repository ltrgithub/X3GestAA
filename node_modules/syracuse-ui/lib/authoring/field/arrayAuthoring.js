...
exports.ArrayAuthoring = helpers.defineClass(ArrayAuthoring, RawPage, {
	...
	onNotifyDataChange: function(field, value) {
		...
		if (this.awPalette) {
			this.awPalette.ensureArrayBoxVisibility();
			this.awPalette.authorPage.endTargetPageUpdate();
		}
	},
	...
	ensureDesignContext: function(awPalette) {
		if (!this.awPalette) {
			this.awPalette = awPalette.authorPage.createContext(this.designedField, {
				isArrayField: true
			});
		}
	},
	refreshToolsBar: function() {
		if (this.awPalette) {
			this.awPalette.toggleColumnsToolBox(true);
		}
	},
	dispose: function() {
