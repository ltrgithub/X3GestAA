...
exports.PageVignetteAuthoring = helpers.defineClass(PageVignetteAuthoring, RawPage, {
	...
	showAddin: function(slot) {
		if (this.contentAddin) {
			if (this.contentField && this.contentAddin && this.contentAddin.awPalette) {
				this.contentAddin.awPalette.authorPage.getContext(this.contentField);
			} else {
	...
	ensureDesignContext: function(awPalette) {
		if (this.contentAddin && this.contentAddin.ensureDesignContext) {
			this.contentAddin.ensureDesignContext(awPalette);
		}
	},
