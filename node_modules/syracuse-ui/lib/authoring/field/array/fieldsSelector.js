...
exports.FieldsSelector = helpers.defineClass(FieldsSelector, null, {
    load: function(list, layoutSlot){
        var self = this;
        self.list = list;
        self.$$item = $("<table class='s-aw-list-fields'/>").appendTo($(layoutSlot));
    ...
    _addItem: function(itemList, $bind, $field){
        ...
        var $$li = $(li).appendTo(itemList.$$ul).text(this.list.getLocalizedTitle($field.$title));
    ...
    _fillList: function(itemList){
        ...
        self.list.$item.$layout.$items.forEach(function($item){
            ...
            if ($field && !$field.$isHidden) {
                if (itemList.$isHiddenItem == ($item.$isExcluded || false)) {
