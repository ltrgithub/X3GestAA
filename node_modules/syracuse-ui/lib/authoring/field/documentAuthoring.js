		...
		this.$prototype = {
			"$properties": {
				$isEmbedded: {
					...
					$title: this.designedField.localize.fdocAuthorIsEmbedded
				},
				$imageWidth: {
					$type: "application/x-string",
					$title: this.designedField.localize.fdocAuthorWidth
				},
				$imageHeight: {
					$type: "application/x-string",
					$title: this.designedField.localize.fdocAuthorHeight
				},
				$isAutoSize: {
					$type: "application/x-boolean",
					$title: this.designedField.localize.fdocAuthorIsAutoHeight
				}
			}
		};
		this.$item = {
