		...
		this.$prototype = {
			"$properties": {
				$imageWidth: {
					...
					$title: this.designedField.getLocalize().fdoc_imageFieldWidth
				},
				$imageHeight: {
					$type: "application/x-string",
					$title: this.designedField.getLocalize().fdoc_imageFieldHeight
				},
				$isAutoSize: {
					$type: "application/x-boolean",
					$title: this.designedField.getLocalize().fdoc_imageFieldWidthIsAutoSize
				}
			}
		};
		this.$item = {
