...
function DocumentAuthoring() {}

exports.DocumentAuthoring = helpers.defineClass(DocumentAuthoring, RawPage, {
		...
		this.$prototype = {
			"$properties": {
				$isEmbedded: {
					...
					$title: this.designedField.getLocalize().fdocAuthorIsEmbedded
				},
				$imageWidth: {
					$type: "application/x-string",
					$title: this.designedField.getLocalize().fdocAuthorWidth
				},
				$imageHeight: {
					$type: "application/x-string",
					$title: this.designedField.getLocalize().fdocAuthorHeight
				},
				$isAutoSize: {
					$type: "application/x-boolean",
					$title: this.designedField.getLocalize().fdocAuthorIsAutoHeight
				}
			}
		};
		this.$item = {
			...
			$layout: {
				$items: [{
					...
					$isEditMode: true,
					$skin: "s-aw-field",
					isHidden: !this.designedField.isImage
				}, {
					$bind: "$isEmbedded",
					$isEditMode: true,
					$skin: "s-aw-field",
