...
exports.LandingPageDesigner = helpers.defineClass(LandingPageDesigner, Designer, {
	...
	drawBox: function() {
		...
		this.templatesTool.addModelLinks(this.sectionModel, this.awItem.layoutContent.tabOpened);
	...
	onClickPicker: function(picker) {
		...
		var templateResult = this.templatesTool.onTemplateChoiceClick(picker, this.awItem.layoutContent.tabOpened);
		if (templateResult) {
