...
exports.Designer = helpers.defineClass(function() {}, Designer, {
	...
	drawBox: function() {
		...
		slot.className = "s-aw-prop-field-horz";
		...
		this.body.appendChild(this.modelSlot = document.createElement("div"));
		this.modelSlot.className = "s-aw-prop-field-horz";
		...
		syra_menus.button.add({
			...
			btnclick: function() {
				syra_site.landingPage.deleteOpenedTab(this.parent.designedArticle);
			}
		});
	...
	endArticleUpdate: function(selectedItem, isStructureUpdated, saveUpdate) {
		syra_site.ensureArticleVisibility(this.designedArticle, true);
		this.toggleUIDesign(this.designedArticle, true);
		if (saveUpdate !== false) {
			this.saveDesign();
		}
	...
	saveDesign: function() {
		syra_site.landingPage.saveLayoutContent();
	},
	...
	toggleDesigner: function(show) {
		...
		syra_menus.button.disable(this.designedArticle.designBtn, this.isVisible);
		syra_site.dom.hide(this.layoutSlot, !this.isVisible);
		this.onTabClik();
