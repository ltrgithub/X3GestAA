...
exports.registerDesignViews = function(page, select) {
	...
	if (page.$selectedDesignView) { // && page.$views.length > 1) {
		...
		//page.designerViewBtn.iconflag && page.designerViewBtn.link.appendChild(page.designerViewBtn.iconflag);
	} else {
				...
				page.designViewsPopup = syra_over.openPopup(page, {
					...
					onresize: function() {
						if (page.designViewList) {
							page.designViewList.resize(syra_site.size.popupMaxHeight);
						}
					},
					close: function() {
						if (page.designViewList) {
