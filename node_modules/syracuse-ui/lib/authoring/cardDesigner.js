...
function _togleOverLaySlots(designer, show) {
...
exports.Designer = helpers.defineClass(function() {}, PageDesigner, {
	drawBox: function() {
	...
	closeDesigner: function() {
		...
		syra_site.designStore.designCardItem(this.designedArticle.list.designer, this.designedArticle, false);
	},
	dispose: function() {
		_togleOverLaySlots(this, false);
