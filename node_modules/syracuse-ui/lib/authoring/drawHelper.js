...
exports.excludeItem = function(awContext, removedItem){
    awContext.targetPage.onAuthoringExcludeItem(removedItem);
    var layoutParent = removedItem.layoutParent;
    var excludedFields;
    if (removedItem.$item && removedItem.$item.$vignette) {
        awContext.toolsBar.onExcludeField(removedItem.$item.$vignette, false);
    }
...
exports.onAddNewVignette = function(awContext, targetItem, $newItem, $insertAt){
    ...
    newChild.page.newLoadVignetteMenu(newChild, $newItem.$vignette);
    return newChild;
};
...
exports.onAddNewField = function(awContext, targetItem, $newItem, $insertAt){
    if (awContext.targetPage) {
        awContext.targetPage.onAuthoringAddNewField($newItem.$fieldBind);
    }
    var newChild;
    if ($insertAt) {
