        ...
        switch (menuItem.$item.$bind) {
            ...
            default:
                if (menuItem.$item.$fieldBind) {
                    if (menuItem.$item.$fieldCategory == "link") {
                        delete this.authorPage.targetPage.garbageLinks[menuItem.$item.$fieldBind];
                    }
                    var newChild = this.authorPage.addNewItem(awItem, "field", menuItem.$item.$fieldBind, undefined, undefined, menuItem.$item.$fieldCategory);
