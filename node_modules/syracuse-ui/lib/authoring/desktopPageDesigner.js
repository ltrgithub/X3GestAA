...
exports.DesktopPageDesigner = helpers.defineClass(DesktopPageDesigner, Designer, {
	...
	bindEvents: function() {
		var self = this;
		document.site.$$layoutSlot.delegate(".s-aw-item", "click.designer" + this.id, function(event) {
			self.onClickItem(self.findItem(this), this);
			return false;
		}).delegate(".s-aw-item", "mouseenter.author mouseleave.designer" + this.id, function(event) {
			if (document.site.ddManager.ddAgent) {
	...
	dispose: function() {
		document.site.$$layoutSlot.undelegate(".designer" + this.id);
