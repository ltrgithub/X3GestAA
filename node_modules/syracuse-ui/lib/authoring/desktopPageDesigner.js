...
var TreesBar = require("syracuse-ui/lib/authoring/desktopPageDesigner/tree/treesBar").TreesBar;
var Trees = require("syracuse-ui/lib/authoring/desktopPageDesigner/tree/trees").Trees;
...
exports.DesktopPageDesigner = helpers.defineClass(DesktopPageDesigner, Designer, {
	...
	drawBox: function() {
		...
		this.treesBar.load(this.awArticle.page, this.propertiesBodySlot, this.treebarSlot, this.trees.treebarBody);
		...
		this.eventNamespace = ".designer" + this.id;
		this.bindEvents();
	...
	onClickPicker: function(picker) {
		...
		if (this.treesBar.onClickPicker(picker)) {
			return false;
		}
	...
	onWindowResize: function() {
		if (this.propertiesBodySlot && this.awArticle.scrollview) {
			this.treesBar.onWindowResize(this.trees);
		}
	},
	dispose: function() {
