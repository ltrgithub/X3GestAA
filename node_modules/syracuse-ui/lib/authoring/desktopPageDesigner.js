...
exports.DesktopPageDesigner = helpers.defineClass(DesktopPageDesigner, Designer, {
	...
	dispose: function() {
		...
		var ids = ["viewsTool", "uiSwitchTool", "localizationTool", "labelTool", "fieldAddinsTool", "rowResizer"];
		...
		this.barSplitter = this._ddTabEnter = null;
		this.panels = this.treebar = this.selectedPanel = null;
		this.transactionLabel = this.helpLink = null;
