...
var InsertTree = require("syracuse-ui/lib/authoring/desktopPageDesigner/tree/insertTree").InsertTree;
var ContentTree = require("syracuse-ui/lib/authoring/desktopPageDesigner/tree/contentTree").ContentTree;
...
exports.Treebar = helpers.defineClass(Treebar, null, {
	load: function(designer) {
		...
		this.designer.awArticle.page.warnAdministrationUpdates(false);
		(this.contentTree = new ContentTree()).load(this, this.appendTab(this.designer.localize.aw_viewTypeContent));
		(this.insertTree = new InsertTree()).load(this, this.appendTab(this.designer.localize.aw_insert));
	...
	_createArrayBoxes: function() {
		this.newGraphTab = this.appendTab(this.designer.localize.aw_graph);
		this.newArticleTab = this.appendTab(this.designer.localize.aw_listCard);
		if (this.awArticle.chart && this.awArticle.chart.$authoringType == "cube$highCharts") {
			...
			if ($fieldCube && $fieldCube.$measures) {
				...
				for (var ii = 0, jj = binds.length; ii < jj; ii++) {
					...
					$field.$title = $measure.$title ? this.designer.awArticle.page.getLocalizeText($measure.$title) : "";
