...
exports.Designer = helpers.defineClass(Designer, RawPage, {
    ...
    dispose: function(){
        ...
        document.site.authorPage = this.workinCopySlot = this.historyTool = this.templatesTool = null;
        this.awItem = this.awLayout = this.awArticle = this.helpLink = this.diagnosePage = this.persistence = null;
