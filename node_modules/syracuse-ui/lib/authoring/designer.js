...
exports.Designer = helpers.defineClass(Designer, RawPage, {
	...
	onBeforeMainPageChange: function(continueChanging) {
		var self = this;
		if (self.historyTool.isUpdated && self.designerWorkingCopy) {
	...
	loadDefaultTools: function(historyCss, workingCopyCss) {
		this.historySlot = document.createElement("div");
		this.historySlot.className = historyCss || "s-aw-top-left-links";
		this.historySlot.appendChild(this.addHelpLink());
		(this.historyTool = new HistoryTool()).load(this, "s-aw-top-left-link");

		this.workinCopySlot = document.createElement("div");
		this.workinCopySlot.className = workingCopyCss || "s-aw-page-right";
		if (this.awArticle.page.$authorUrl) {
	...
	onClickItem: function(item, target, article) {
		...
		if (!article.isDesigned && article.page != this) {
	...
	onMenuClick: function(menuItem) {
		return this.designerWorkingCopy && this.designerWorkingCopy.onMenuClick(menuItem);
	},
	dispose: function() {
		if (this.designerWorkingCopy) {
		...
		this.helpLink = this.page = this.diagnosePage = this.designerWorkingCopy = null;
