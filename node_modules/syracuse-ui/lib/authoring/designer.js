...
exports.Designer = helpers.defineClass(Designer, DesktopPage, {
	loadNewItem: function(slot, $item, boxParent, initData) {
		var item = DesktopPage.prototype.loadNewItem.call(this, slot, $item, boxParent, initData);
		if (item.input) {
	...
	showTargetPageDiagnoses: function(message, options) {
		syra_diagnose.showDiagnoses(message, this.designedArticle, options);
	...
	_toggleDesignDialog: function(page, begin) {
		...
		if (dlg) {
			syra_menus.button.hide(dlg.btn_close, begin);
	...
	findItem: function(domItem, findLayout) {
		...
		return item.isTreeNode ? item.item : item;
	},
	dispose: function() {
		var page;
