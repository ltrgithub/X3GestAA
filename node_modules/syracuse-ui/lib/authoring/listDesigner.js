...
function _loadGraphDesigner(designer) {
	...
	if (hasDecorator || hasCube) {
		...
		syra_dom.addText("s-aw-graph-title", syra_local.lw_graph_position, slot);
...
exports.Designer = helpers.defineClass(function() {}, Designer, {
	...
	appendMeasure: function(bind, delta, body) {
		...
		this.graph.colorFields["$cube" + bind] = this.addItem(syra_dom.addDiv("s-aw-graph-meassure-item", slot), {
			$category: "field",
			$inplace: true,
