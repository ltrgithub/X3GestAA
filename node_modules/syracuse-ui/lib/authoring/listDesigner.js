...
var CardDesigner = helpers.defineClass(function() {}, PageDesigner, {
	drawPage: function() {
		PageDesigner.prototype.drawPage.call(this);
		syra_dom.remove(this.viewsSlot);
		this.viewsSlot = null;
		...
		if (show) {
			...
			if (this.overlays) {
				for (var ii = 0, kk = ids.length; ii < kk; ii++) {
					syra_dom.remove(this.overlays[ids[ii]]);
				}
				this.overlays = null;
			}
		}
	...
	resizeItem: function(resize) {
		PageDesigner.prototype.resizeItem.call(this, resize);
