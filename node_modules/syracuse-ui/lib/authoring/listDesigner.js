...
exports.ListDesigner = helpers.defineClass(ListDesigner, Designer, {
	...
	drawBox: function() {
		...
		this.settingsSlot.className = "s-listdesigner-left";
		this.layoutSlot.appendChild(this.settingsSlot);
		this.awItem = this.awArticle;

		this.loadDefaultTools(undefined, "s-listdesigner-right");
	...
	appendFormat: function() {
		...
		this.settingsSlot.appendChild(this.formats.slot);
	},
	...
	dispose: function() {
		...
		this.fieldMeasures = this.sectionCards = this.sectionGrid = null;
