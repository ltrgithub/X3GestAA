...
exports.DesignerPersistence = helpers.defineClass(DesignerPersistence, RawPage, {
	load: function(designer) {
		...
		if (this.designer.awArticle == this.designer.awArticle.page && this.designer.awArticle.page.$authorUrl) {
			...
			link.title = this.designer.localize.aw_close;
			link.className = this.designer.awArticle.isList ? "s-aw-designer-list-close" : "s-aw-designer-close";
			this.designer.workinCopySlot.appendChild(link);
		}
	},
	...
	notifyActionChange: function(menuItem, target, value, notifyServer) {
		...
		if (this.designer.awArticle.page.$prototype.$generatorVersion) {
			this.designer.awArticle.page.$sourcePrototype = helpers.object.clone(this.designer.awArticle.page.$prototype, true);
			document.site._cvgPageConverterMakePersistent(this.designer.awArticle.page.$sourcePrototype, $article);
