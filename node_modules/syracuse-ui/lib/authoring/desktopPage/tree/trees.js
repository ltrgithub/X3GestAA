...
var InsertTree = require("syracuse-ui/lib/authoring/desktopPage/tree/insertTree").InsertTree;
var ContentTree = require("syracuse-ui/lib/authoring/desktopPage/tree/contentTree").ContentTree;
...
exports.Trees = helpers.defineClass(Trees, null, {
	load: function(designer) {
		...
		this.designer.awArticle.garbage.loadFreeField();
	...
	onWindowResize: function(height) {
		...
		var bodyHeight = Math.max(height - document.site.getBoundingClientRect(this.treebarTabs).height, 20) + "px";
