...
exports.InsertTree = helpers.defineClass(InsertTree, ItemTree, {
	...
	_addInsertNewSectionBlockNode: function($designLevel) {
		...
		itemNode.titleText.textContent = itemNode.node.title = this.trees.designer.localize.aw_addSectionBlock;
		this.nodes.push(itemNode);
		itemNode.item = {
			$title: this.trees.designer.localize.aw_addSectionBlock,
			$awAddNewItem: true,
