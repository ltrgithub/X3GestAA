				...
				switch (event.type) {
					case "mouseenter":
						if (!node.item.$awAddNewItem) {
							this.treebar.designer.tools.uiSwitch.toggleOverItem(node.item, true);
							this.treebar._designedPage.scrollToItem(node.item);
						}
						break;
					case "mouseleave":
						if (!node.item.$awAddNewItem) {
							this.treebar.designer.tools.uiSwitch.toggleOverItem(node.item, false);
						}
						break;
					case "click":
						if (!node.item.$awAddNewItem) {
