...
function _clearDynamicMenu() {
	_dynamicMenu && _dynamicMenu.articleParent && _dynamicMenu.articleParent.removeItem(dynamicMenu, true, true);
	_dynamicMenu = null;
}
...
exports.navigation = function() {
	return exports.menuId(syra_site, "$navigation");
};
...
exports.refreshPageData = function(page) {
	if (page.isFusionPage) {
		...
		if (page.isLandingMaster) {
			landingPage = page.selectedPageRecord && page.selectedPageRecord && page.selectedPageRecord.childPage;
		} else {
...
exports.goToSearch = function(page) {
	if (page.isFusionPage) {
		exports.menuId(page, "1186");
	} else {
		if (syra_site.searcher) {
			syra_site.searcher.setFocusToSearchField();
			return true;
		}
	}
};
