...
exports.button = {
	...
	setText: function(btn, text, icon, title) {
	...
	applyShortCut: function(group, shortcuts, event) {
		...
		if (shortcuts.up || shortcuts.down) {
			...
			for (var ii = 0, jj = items.length; ii < jj; ii++) {
				...
				if (menuItem.domItem) {
					syra_dom.toggleClass(menuItem.domItem, "s-selected", ii == group._$selectedListIndex);
				}
			}
