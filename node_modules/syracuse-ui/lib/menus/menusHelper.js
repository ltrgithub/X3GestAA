...
exports.cssFontIconMn = " s-fonticon-mn ";

if (document.dir === 'rtl') {
	exports.cssFontIconBtn += " s-rtl-img ";
	exports.cssFontIconMn += " s-rtl-img ";
}
...
function _setTitleIconValue(menu, $title, $iconValue) {
	...
	if (menu.$item.$icon && !menu.iconValue) {
		menu.cssTitle = null;
		var cssBtn = exports.cssFontIconMn + "s-btn-" + ((name[0] == "$") ? name.substr(1) : name);
...
exports.addIconButton = function(text, css, onClick, shortCutTip, fontIcon) {
	...
	if (fontIcon) {
		...
		if (icon) {
			css += exports.cssFontIconBtn + "s-btn-" + ((fontIcon[0] == "$") ? fontIcon.substr(1) : fontIcon);
			btn.innerHTML = icon;
		}
	}
	btn.className = css;
