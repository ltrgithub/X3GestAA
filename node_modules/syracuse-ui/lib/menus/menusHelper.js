...
exports.button = {
	...
	add: function(btn) {
		...
		var link = btn.link = document.createElement("a");
		...
		if (btn.iconOnly) {
			...
			if (btn.fontIcon) {
				link.syraHasIcon = true;
				link.insertBefore(exports.addFontIconFlag(btn.css + "-flag s-mn-icontext", btn.fontIcon), link.firstChild);
			}
		}
