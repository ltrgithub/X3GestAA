...
exports.button = {
	...
	setText: function(btn, text, fontIcon) {
		var icon;
		if (btn.link.syraHasIcon) {
			btn.link.removeChild(icon = btn.link.firstChild);
		}
		if (btn.syraTipTitle) {
		...
		fontIcon && _setFontIconButton(icon || btn.link, fontIcon);
	},
