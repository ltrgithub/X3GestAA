...
exports.MenuGroup = helpers.defineClass(MenuGroup, SectionBlock, {
	...
	setRootGroupCss: function() {
		document.site.dom.toggleClass(this.body, "s-menu-group-root", true);
		document.site.dom.toggleClass(this.header, "s-menu-group-root", true);
		document.site.dom.toggleClass(this.domItem, "s-menu-group-root", true);
	},
