...
exports.MenuGroup = helpers.defineClass(MenuGroup, SectionBlock, {
	...
	onOpenButtonClick: function() {
		if (this.$item) {
			if (this.page.userPreferences && this.page.menuBar && !this.page.isVignettePage) {
				if (this.page.isInMenuBar(this) && !this.$item.$isPopupContent) {
					this.page.userPreferences.getForKey("$menuBarGroup", {})[this.id] = this.$opened;
