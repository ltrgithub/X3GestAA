...
exports.MenuGroup = helpers.defineClass(MenuGroup, SectionBlock, {
	...
	setRootGroupCss: function() {
		document.site.toggleClass(this._body, "s-menu-group-root", true);
		document.site.toggleClass(this._header, "s-menu-group-root", true);
		document.site.toggleClass(this._item, "s-menu-group-root", true);
	},
	...
	doOpenPicker: function($$ofPosition) {
		if (this.$item.$masterFriendMenuId) {
			...
			if (master) {
				master.doOpenPicker($(this._header));
			}
		} else {
	...
	ensureLayoutMode: function() {
		...
		if (this._item && this.boxParent.isMenuGroup) {
