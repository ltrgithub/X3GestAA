...
exports.MenuItem = helpers.defineClass(MenuItem, null, {
	highlight: function(show) {
		document.site.dom.toggleClass(this.mn, "s-highlight", show);
	},
	...
	setStyle: function($style) {
		if ($style === null) {
			if (this.$style) {
				...
				document.site.dom.toggleClass(this.mn, this.$style, false);
			}
			this.$style = null;
		} else {
			this.$style = "s-cst-sty-" + $style;
			document.site.dom.toggleClass(this._label, this.$style, true);
			document.site.dom.toggleClass(this.mn, this.$style, true);
		}
	},
	loadBox: function(record) {
		...
		if (this.boxParent.isMenuGroup) {
			if (this.boxParent.$item.$style) {
				...
				document.site.dom.toggleClass(this.mn, $style, true);
			}
		}
	...
	disable: function($value) {
		document.site.dom.disableItem(this.mn, this.$isDisabled = $value || false);
	},
	...
	setMenu: function($menu, record) {
		...
		if (this.$sourceType && (this.$sourceType.indexOf('json') == -1) && (this.$sourceType != "html")) {
			...
			if (this.mn && this.$url && this.isHrefEnabled()) {
