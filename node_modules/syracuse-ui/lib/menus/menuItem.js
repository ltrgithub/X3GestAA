...
function _onMenuItemClick(menuItem){
    ...
    if (menuItem.boxParent) {
        ...
        // todo: review
        // menuItem.boxParent.$$body.css('display', 'none');
        if (doClick) {
...
exports.MenuItem = helpers.defineClass(MenuItem, null, {
    ...
    setTitle: function($value){
        this.$title = $value;
        if (this.$title != null && !this.$title.indexOf) {
        ...
        if (this._label) {
            if (this.$title.indexOf("{") < 0) {
                ...
                this.boxParent._renderExpression(this.$title, $(this._label));
            }
        }
        this.mn.title = this.$title;
    },
    ...
    dispose: function(){
        ...
        this.$url = this.$$container = this.mn = this.$$item = this._label = this.$title = null;
    }
});
