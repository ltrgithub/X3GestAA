...
exports.MenuItem = helpers.defineClass(MenuItem, null, {
    ...
    setMenu: function($menu, record){
        ...
        if (this.$type && this.$type.indexOf('json') == -1) {
            if (this.$url && (this.$url.indexOf("format=") < 0)) { // TODO: improve this hack
                this.$url += "&format=" +
                this.article.formatMenuUrl({
                    $url: this.$type,
                    $parameters: this.$parameters
                }, record);
            }
            this.mn.setAttribute("target", this.$target = "blank");
            this.mn.setAttribute("href", this.$url = this.article.formatMenuUrl(this, record));
            ...
            if (this.mn) {
                if (this.$url) {
                    this.mn.setAttribute("href", "?url=" + encodeURIComponent(this.$url = this.article.formatMenuUrl(this, record)));
    ...
    dispose: function(){
        ...
        this.article = this.page = this.onMenuClick = this.$item = this.liParent = null;
