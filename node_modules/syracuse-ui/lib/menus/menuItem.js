	...
	setMenu: function($menu, record) {
		...
		if (this.$sourceType && (this.$sourceType.indexOf('json') == -1) && (this.$sourceType != "html")) {
			if (this.isHrefEnabled()) {
				...
				this.mn.setAttribute("href", this.href = this.$url = document.site.urlMaker.formatMenuUrl(this.articleParent, this, record));
			}
			...
			if (this.mn && this.$url) {
				if (this.isHrefEnabled()) {
					this.$url = document.site.urlMaker.formatMenuUrl(this.articleParent, this, record);
					this.mn.setAttribute("href", this.href = document.site.urlMaker.setUrlParameter(this.$url));
