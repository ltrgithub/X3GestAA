...
exports.MenuItem = helpers.defineClass(MenuItem, null, {
	...
	onItemInOut: function(onEnter) {
		if (onEnter) {
			...
			if (this.titleText && this._label) {
				this.domItem.title = "";
				if (this.$item.$noText || (this._label.clientWidth != this._label.scrollWidth) || (this.domItem.syraTitle != this.titleText)) {
					syra_site.siteFunctions.showTip(this, true, this.domItem.syraTitle);
				}
			}
		} else {
			if (this.domItem && this.domItem.syraTitle) {
				this.domItem.title = this.domItem.syraTitle;
			}
	...
	setTitle: function($value) {
		...
		this.domItem.title = this.domItem.syraTitle = this.$description || title;
	},
	setDescription: function($value) {
		...
		if (this._description) {
			...
			this.domItem.title = this.domItem.syraTitle = $value;
		}
	},
