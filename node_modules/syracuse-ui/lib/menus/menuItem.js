...
exports.MenuItem = helpers.defineClass(MenuItem, null, {
    loadBox: function(record){
        ...
        if (this.boxParent.isMenuGroup) {
            ...
            if (this.$item.$style) {
                var $style = " s-menu-" + this.$item.$style;
                this.liParent.className += $style;
                this.mn.className += $style;
            }
    ...
    setTitle: function($value){
        ...
        if (this._label) {
            if ($value.indexOf("{") < 0) {
                ...
                this.boxParent._renderExpression($value, $(this._label));
            }
        }
        else {
            this.mn.title = $value;
    ...
    _setIconMenu: function(){
        ...
        if (!this.iconValue) {
            ...
            if (this.$icon.$mode != "icon") {
                ...
                this._label.className = this.mn.className + "-label";
                this.$$item[0].appendChild(this._label);
                if (this._description) {
                    this.$$item[0].appendChild(this._description);
                }
            }
        }
        this._setIconValue();
    ...
    dispose: function(){
        ...
        this.$$container = this.mn = this.$$item = this._label = this.$title = null;
