...
exports.MenuItem = helpers.defineClass(MenuItem, null, {
    ...
    loadBox: function(record){
        ...
        if (this.$item.$isGroupHeader) {
            this.layoutSlot.style.display = "none";
            this.$skin = this.boxParent.$item.$headSkinLink;
            this.boxParent.titleMenu = this.mn;
            this.boxParent.domTitle.parentNode.insertBefore(this.mn, this.boxParent.domTitle);
            this.boxParent.domTitle.style.display = "none";
        }
        else {
