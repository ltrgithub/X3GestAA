...
helpers.defineClass(Selector, null, {
    ...
    bindEvent: function(){
        ...
        if (self.list.$item.$selectMode == "row") {
            self.list.$$item.delegate("[data-s-record]", "click", function(event){
    ...
    _onSelectRecords: function(event){
        ...
        self.list.getPage().externalAdapter.onSelectRecordEvent({
            doEvent: function(){
...
var _selectors = {
    multi: helpers.defineClass(MultiSelector, Selector, {
        ...
        appendToTitle: function(slot){
            slot.className += " " + this.list.$skin + "-flag-th";
        ...
        appendToRecord: function(slot){
            slot.className += " " + this.list.$skin + "-flag-cell";
            var input = document.createElement("input");
            input.setAttribute("type", "checkbox");
    ...
    button: helpers.defineClass(ButtonSelector, Selector, {
        load: function(list){
            this.text = localize.select || "Select";
            this.width = (0.2 * this.text.length) + "em";
        ...
        appendToRecord: function(slot){
            slot.className += " " + this.list.$skin + "-selector-button";
            var btn = document.createElement("a");
            btn.className = "s-list-selector";
