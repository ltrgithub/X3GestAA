...
exports.RawList = helpers.defineClass(RawList, Article, {
    ...
    removeRecords: function(){
        var self = this;
        self.dataRows.forEach(function(recordArticle){
            ...
            if (this.builder.setDataBind) {
                ...
                if ($resources !== undefined) {
                    ...
                    if (record.$isDelta) {
                        ...
                        $resources.forEach(function(record, $recordIndex){
                            ...
                            if (record.$isDeleted) {
                                ...
                                if (recordArticle) {
                                    ...
                                    self.dataRows.splice(self.builder.appendRecord(record, $recordIndex, true), 1);
                                }
                            }
                        });
                    }
                        ...
                        if ($resources) {
                            $resources.forEach(function(record, $recordIndex){
                                self.dataRows.push(self.builder.appendRecord(record, $recordIndex));
                            });
                        }
                    }
