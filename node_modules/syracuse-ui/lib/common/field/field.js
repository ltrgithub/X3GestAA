...
exports.Field = helpers.defineClass(Field, null, {
    ...
    _addValueBtns: function($$btn){
        if (!this.$$valueBtn) {
            ...
            this.$$valueBtn = $(div).appendTo(this.$$dataValue);
        }
        this.$$valueBtn.append($$btn);
        this.$$dataValue[0].style.paddingRight = this.$$valueBtn.width() + "px";
    },
        ...
        if (this.$$title && this.titleText.length > 0) {
            if (this.$menus) {
                if (!this.$$menusFlag) {
                    ...
                    this._addValueBtns(this.$$menusFlag = $(div));
                }
            }
            else {
                if (this.$$menusFlag) {
                    this.$$menusFlag.remove();
    ...
    getValue: function(event){
        return this.getInputValue ? this.getInputValue(event) : this.$$input.val();
    },
    isEmpty: function(){
