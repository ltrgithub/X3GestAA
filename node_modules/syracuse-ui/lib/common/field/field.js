...
var MenusController = require('./menusController').MenusController;
var _localize = {
    defaultTitle: "Field"
};
...
exports.Field = helpers.defineClass(Field, null, {
    ...
    loadBox: function($$item){
        ...
        if (this.$$input) {
            ...
            if (this.$item.$isCellMode) {
                input.className += " s-cell-input-mode";
            }
    ...
    _ensureButtonsVisible: function(){
        if (this._buttons) {
            if (this.$isEditMode) {
                ...
                this._buttons.style.display = this.currentValue ? "" : "none";
            }
        }
    },
