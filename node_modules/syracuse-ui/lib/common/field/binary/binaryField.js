...
exports.BinaryField = helpers.defineClass(BinaryField, Field, {
    ...
    _disableButtons: function(isDisabled){
        this.$$btns.children("a").toggleClass("s-disabled", isDisabled).attr("disabled", isDisabled);
    },
    bindEvents: function(){
    },
    render: function(){
    ...
    _appendActions: function($skin){
        ...
        dom.className = $skin + "-upload";
        $(dom).appendTo(self.$$btns).text(_localize.selectFile);
        
        dom = document.createElement("a");
        dom.className = $skin + "-remove";
        dom.style.display = "none";
        $(self.remove = dom).appendTo(self.$$btns).text(_localize.removeFile)
    ...
    _renderDetailMode: function($skin){
        ...
        dom.className = $skin + "-link";
        this.$$anchor = $(dom).prependTo(this.$$dataValue);
    },
