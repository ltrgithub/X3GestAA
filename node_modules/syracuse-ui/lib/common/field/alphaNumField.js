...
exports.PasswordField = helpers.defineClass(PasswordField, Field, {
    ...
    setDataValue: function(value, record){
        ...
        if (this.$isEditMode) {
            ...
            this.$$value.text((value || "").length > 0 ? "***" : "");
        }
    }
});
    ...
    setDataValue: function(value, record){
        ...
        if (this.$isEditMode) {
            ...
            if (formattedNum && this.$field.$links && this.$field.$links.$details && !this.$item.$isMenusDisabled) {
                this.appendDetailLink(this.$$value, formattedNum, this.$field.$links.$details);
            }
            else {
                this.$$value.text(formattedNum);
            }
        }
    },
...
exports.TextField = helpers.defineClass(TextField, Field, {
    setDataValue: function(value, record){
        this.currentValue = value;
        if (this.$isEditMode) {
            this.$$input.val(this.currentValue);
...
exports.PhoneField = helpers.defineClass(PhoneField, Field, {
    ...
    setDataValue: function(value, record){
        ...
        if (this.$isEditMode) {
            ...
            this.$$value.empty();
            this.$$value.append($("<a class='s-phone-link'/>").attr("href", "callto:" + value).text(value));
        }
    }
});
...
exports.EmailField = helpers.defineClass(EmailField, Field, {
    ...
    setDataValue: function(value, record){
        ...
        if (this.$isEditMode) {
            ...
            this.$$value.empty();
            this.$$value.append($("<a rel='nofollow' class='s-email-link'/>").attr("href", "mailto:" + value).text(value));
        }
    }
});
