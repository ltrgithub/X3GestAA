...
exports.PhoneField = helpers.defineClass(PhoneField, Field, {
    ...
    setDataValue: function(value, record){
        ...
        if (this.$isEditMode) {
            ...
            this.$$textValue.empty().append($("<a class='s-phone-link'/>").attr("href", "callto:" + value).text(value));
        }
    }
});
...
exports.EmailField = helpers.defineClass(EmailField, Field, {
    ...
    setDataValue: function(value, record){
        ...
        if (this.$isEditMode) {
            ...
            this.$$textValue.empty().append($("<a rel='nofollow' class='s-email-link'/>").attr("href", "mailto:" + value).text(value));
        }
    }
});
