...
var ListAuthoring = require("syracuse-ui/lib/desktop/field/collection/authoring/listAuthoring").ListAuthoring;
...
exports.AuthoringListTest = helpers.defineClass(AuthoringListTest, FieldsTest, {
    loadBox: function(){
        ...
        FieldsTest.prototype.loadBox.call(this, $prototype, {
            "application/x-collection": this.getResources().getRecords(8),
            "$field$capabilityInsert": true,
            "$field$capabilityDelete": true,
            "$field$capabilityAppend": true,
            "$field$capabilityReorder": true
        });
        this.designedField = this.boundFields["application/x-collection"][0];
        
        (this.authoring = new ListAuthoring()).loadBox(this);
        this.authoring.designedTestFields = this.boundFields["application/x-collection"];
