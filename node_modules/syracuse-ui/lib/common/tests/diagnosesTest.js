...
exports.DiagnosesTest = helpers.defineClass(DiagnosesTest, Article, {
    ...
    _showDiagnosesInSection: function($type){
        ...
        var diagnoseViewer = document.site.appendDiagnoseViewer(section.$$body, document.site, true);
        var domItem = diagnoseViewer.$$item[0];
		diagnoseViewer.isTestMode = true;
        domItem.style.top = "0px";
        domItem.style.left = "0px";
        domItem.style.position = "relative";
        domItem.style.display = "inline-block";
        diagnoseViewer.showDiagnoses(this.buildDiagnose($type), document.site.mainPage);
        if ($type == "multitest") {
