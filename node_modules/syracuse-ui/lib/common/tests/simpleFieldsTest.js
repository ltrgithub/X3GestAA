...
exports.SimpleFieldsTest = helpers.defineClass(SimpleFieldsTest, Article, {
    loadBox: function(){
        var self = this;
        self.$layoutOptions = document.site.$item.$layoutOptions.page["portlet"];
        self.$prototype = {
            "$": {
                $field$isDiagnoses: {
        ...
        switch (binding) {
            ...
            case "$field$help":
                Object.keys(self.boundFields).forEach(function(bind){
                    var metaData = {
                        $help: value ? "description dqdfsdhfdlsk fdqsmf,qsdmfmqsdj fmsdfmqsdf fmsdmdlsjgq" : null
                    };
