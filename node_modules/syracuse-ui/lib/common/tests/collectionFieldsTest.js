...
function CollectionFieldsTest(){
}

exports.CollectionFieldsTest = helpers.defineClass(CollectionFieldsTest, FieldsTest, {
    loadBox: function(){
        var $prototype = {
            "$": {
                "application/x-collection": {
                    "$title": "application/x-collection",
                    "$capabilitiesNew": "sort,filter,insert,append,delete,reorder",
