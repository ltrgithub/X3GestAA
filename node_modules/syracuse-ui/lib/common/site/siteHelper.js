...
exports.loadSite = function(siteOptions){
    ...
    document.site.resizeListeners = {};
    document.site.externalAdapter = new ExternalAdapter();
    
    document.site._zIndex = 100;
    document.site.setZIndex = function($$item){
    ...
    document.site.onBeforClick = function(){
    ...
    document.site.addResizeListener = function(listener){
        this.resizeListeners[listener.id] = listener;
    };
    document.site.removeResizeListener = function(listener){
