...
helpers.defineClass(ItemFactory, null, {
    ...
    loadPage: function($itemPage){
        ...
        if ($itemPage.$representation.$url && $itemPage.$representation.$url.indexOf("x3.erp.SUPERV.AUTILISM") >= 0) {
            var $list = item.$item.$layout.$items[0].$layout.$items[0];
            ...
            if ($itemPage.$representation.$url && $itemPage.$representation.$url.indexOf("x3.erp.SUPERV.COMPANYM") >= 0) {
                var $list = item.$item.$layout.$items[0].$layout.$items[0];
                $list.$format = "cardList";
                $list.$cardsByRowCount = 3;
                $list.$cardView = {
        ...
        /*if ($itemPage.onPageLoaded) {
         $itemPage.onPageLoaded(item);
         delete $itemPage.onPageLoaded;
         }*/
        return item;
    },
