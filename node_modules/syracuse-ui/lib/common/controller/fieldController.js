...
exports.FieldController = helpers.defineClass(FieldController, null, {
    changeType: function($newType, oldField){
        //oldField.$$item.detach();
        var $field = oldField.getArticle().$prototype.$[oldField.$item.$bind];
        ...
        var newField = document.itemFactory.load(oldField.$$container, oldField.$item, this);
        oldField.$$item.empty().remove();
        document.controller.disposeObject(oldField);
    },
