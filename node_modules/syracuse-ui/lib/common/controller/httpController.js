        ...
        xhr.onreadystatechange = function(){
            if (xhr.readyState == 4) {
                ...
                if ((xhr.status >= 200 && xhr.status < 300) || xhr.status == 304 || xhr.status == 1223) {
                	...
                	var response = _parseResponse(xhr, (typeof xhr.response !== "object") ? JSON.parse(xhr.response) : xhr.response);
    ...
    sendRequest: function(options, onSuccess, onError){
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR){
                ...
                if ((document.site.getSessionId() !== initialSid) && document.site.userProfile) {
