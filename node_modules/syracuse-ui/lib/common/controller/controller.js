...
exports.Controller = helpers.defineClass(Controller, null, {
    ...
    _executeAction: function(menu, record, article){
        ...
        if (menu.$parameters) {
            if (menu.$parameters && menu.$parameters.$ && menu.$parameters.$.$select) {
				var proto = menu.$parameters.$.$select;
                proto && menu.boxParent.openDialog({
                    article: menuArticle,
                    $url: proto.$url,
                    onValidate: function(page){
                        if ($bindAction.$parameters && $bindAction.$parameters.$select && $bindAction.$parameters.$select.length) {
