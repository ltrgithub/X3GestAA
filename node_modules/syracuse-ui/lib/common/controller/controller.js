...
exports.Controller = helpers.defineClass(Controller, null, {
    ...
    _executeAction: function(menu, record, article){
        ...
        if (menu.$properties) {
            if (menu.$properties && menu.$properties.$ && menu.$properties.$.$select) {
				var proto = menu.$properties.$.$select;
                proto && menu.boxParent.openDialog({
                    article: menuArticle,
                    $url: proto.$url,
                ...
                menu.$properties.$title = menu.getTitle ? menu.getTitle() : null;
                menuArticle.parseProperties(menu.$properties, record, function(values, isCanceled){
                    if (!isCanceled) {
