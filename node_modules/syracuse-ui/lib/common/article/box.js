...
exports.Box = helpers.defineClass(Box, null, {
    applyDesignMetaData: function(metadata, onAuthoring){
        ...
        if (onAuthoring !== false) {
            ...
            if (metadata.$layout !== undefined) {
                self.convertLayout(metadata.$layout);
            }
        }
    },
    ...
    convertLayout: function($newLayout){
        var oldLayout = this.layoutContent;
        oldLayout.toggleAuthoring(false);
        //$newLayout.$items = oldLayout.$layout.$items;
        this.layoutContent = document.itemFactory.createLayout(this, $newLayout);
        this.$item.$layout = $newLayout;
        this.layoutContent.convertLayout(oldLayout);
