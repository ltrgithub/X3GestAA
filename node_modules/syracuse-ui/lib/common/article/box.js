...
exports.Box = helpers.defineClass(Box, null, {
    ...
    getTitle: function(){
        var title = (this.$$title ? this.$$title.text() : null) || this.$item.$title || "";
        if (title.trim() == "") {
    ...
    renderDescription: function($description){
        if (this.$isTabLayout) {
            ...
            if (!this.$$description) {
                ...
                this.$$description = $(this.$$header[0].appendChild(div));
            }
    ...
    appendHeader: function($$container, hideHeader){
        ...
        self.renderTitle(self.$item.$title || (self.$field ? self.$field.$title : null) || self.getDefaultTitle());
