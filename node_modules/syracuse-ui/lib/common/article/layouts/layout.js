            ...
            if (this.items.length != 0) {
                ...
                if (!this.empty) {
                    ...
                    this.empty = {
                        ...
                        $$dropText: $("<div class='s-author-empty-drop-text'/>").text(localize.l_emptyDropArea).appendTo($$drop)
                    };
                    this.empty.$$item.append(this.empty.$$drop = $$drop).append(this.empty.$$delete = $("<a class='s-author-layout-delete'/>").text(localize.l_deleteLayout));
                }
            }
        }
        else {
