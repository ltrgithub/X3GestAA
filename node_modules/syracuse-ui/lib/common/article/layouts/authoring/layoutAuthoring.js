...
exports.LayoutAuthoring = helpers.defineClass(LayoutAuthoring, null, {
    begin: function(layout, $$container, selector){
        ...
        self.$$container.delegate(".s-author-layout-table-on,.s-author-layout-columns", "mouseup.author mousemove.author mouseleave.author mouseenter.author", function(event){
            if (document.site.DDAuthoring) {
                document.site.DDAuthoring.onEmptyLayoutArea(event);
