    ...
    isDropValidate: function(target){
        ...
        if (this.source != target) {
            switch (this.source.$authoringLevel) {
                case "section":
                    isValidate = target.$authoringLevel == "section" || target.$authoringLevel == "article";
                    break;
                case "block":
                    isValidate = (target.$authoringLevel == "block") || (target.$authoringLevel == "section") || (target.$authoringLevel == "article");
                    break
                case "field":
                    isValidate = target.$authoringLevel == "field" || (target.$authoringLevel == "block") || (target.$authoringLevel == "section");
                    break;
            }
        }
        return isValidate;
