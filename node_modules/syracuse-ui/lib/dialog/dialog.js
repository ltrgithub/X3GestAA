...
function _setMinMax(dlg) {
	if (syra_site.isResizing || !dlg.isMinMaxInit) {
		var siteSize = syra_site.getSize();
		dlg.isMinMaxInit = true;
		dlg.dialogSlot.style.maxWidth = siteSize.dlg.maxWidth + "px";
		dlg.dialogSlot.style.maxHeight = siteSize.dlg.maxHeight + "px";
	}
}
