...
function _resizeLookupPage(dlg, page, isDlgResizing) {
	...
	lookupField.scrollTable.bodySlot.style.width = "0px";
	lookupField.scrollTable.bodySlot.style.height = "0px";
	var style = dlg.dialogSlot.style;
	style.maxWidth = siteSize.dlgMaxW + "px";
	style.maxHeight = siteSize.dlgMaxH + "px";

	var slotRect = dlg.dialogSlot.getBoundingClientRect();
	var fieldRect = lookupField._dataValue.getBoundingClientRect();
	var bodyRect = lookupField.scrollTable.bodySlot.getBoundingClientRect();
	...
	lookupField._dataValue.style.maxWidth = (siteSize.dlgMaxW - diffW) + "px";
	...
	lookupField.scrollTable.bodySlot.style.maxHeight = (siteSize.dlgMaxH - diffH) + "px";
	lookupField.scrollTable.bodySlot.style.maxWidth = (lookupField.tableMaxWidth = (siteSize.dlgMaxW - diffW)) + "px";

	lookupField.scrollTable.bodySlot.style.width = "";
	lookupField.scrollTable.bodySlot.style.height = "";
