	...
	resizeDialog: function(resize, onScroll, isDlgResizing) {
		...
		if (this._content) {
			...
			if (!this.disposed && syra_site.body) {
				...
				rect.top = Math.max(size.top, 50);
				rect.height = size.height - rect.top;
				rect.bottom = rect.top + rect.height;
				this._maxHeight = rect.height - rect.top;
					...
					if (this.options.position) {
						...
						if (this._content && this._content.page && this._content.page.scrollview) {
							...
							if (page.scrollview) {
								...
								var maxDlgHeight = Math.max(100, this._maxHeight - 32);
								var maxDlgWidth = Math.max(100, this._maxWidth - 32);
