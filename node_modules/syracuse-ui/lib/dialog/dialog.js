						...
						if (this.options.position) {
							...
							if (page && page.scrollview) {
								if (page.$facet == "$lookup" || page.$facet == "$select") {
									...
									page.scrollview.style.maxWidth = (siteSize.dlg.maxWidth - pageSize.dlgMargin.width) + "px";
									page.scrollview.style.maxHeight = (siteSize.dlg.maxHeight - pageSize.dlgMargin.height) + "px";
									var barH;
