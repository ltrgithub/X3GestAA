...
function _resizeOverlay(dlg) {
	...
	if (dlg._content.isFusionPage) {
		var size = syra_site.getSize().body;
...
function _resizePage(dlg, page, isDlgResizing) {
	...
	style.maxWidth = siteSize.dlg.maxWidth + "px";
	style.maxHeight = siteSize.dlg.maxHeight + "px";
	...
	resizeDialog: function(resize, onScroll, isDlgResizing) {
		if (!this.isDeactivated && this._content) {
			...
			if (!this.disposed && syra_site.body) {
				...
				var siteSize = syra_site.getSize();
				rect.width = siteSize.width - (rect.left * 2);
				rect.right = rect.left + rect.width;
				rect.top = 50;
				this._maxHeight = rect.height = siteSize.height - (rect.top * 2);
