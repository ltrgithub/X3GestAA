...
function _resizeLookupPage(dlg, page, isDlgResizing) {
	...
	lookupField.resizeScrollView(lookupField.tableMaxWidth);
...
exports.Dialog = helpers.defineClass(Dialog, null, {
	...
	onOkClick: function() {
		if ((this.options.onValidate && this.options.onValidate(this._content, this) !== false) || this.options.onServerSaved) {
			if (this.options.onServerSaved) {
				...
				//temp hack for SAM-103328
				var $save = this._content.menuItems && this._content.menuItems.$save;
				if ($save && $save.length) {
					$save[0].$isAction = true;
				}
