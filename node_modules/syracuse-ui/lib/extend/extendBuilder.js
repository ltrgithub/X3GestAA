"use strict";
var ExtendField = require('syracuse-ui/lib/extend/extendField').ExtendField;
...
exports.ensureMediaTypes = function($prototype, finish, error) {
	...
	syra_ajax.get({
		...
		success: function(data) {
			_requireMissing(0, data, finish, error || _error);
		},
		error: function(response, ajax, $diagnoses) {
			(error || _error)($diagnoses);
		}
	});
};
