...
function _validateDisplay() {
	...
	var isHidden = !btnOn && ((_buttons.length >= syra_config.bookmarksMax) || page.isBookmarkDisable || (page.$facet == "$edit" && !page.isFusionPage));
...
exports.onLinkClick = function(menuItem) {
	if (!syra_router.executeFusionFunc(menuItem, syra_fusion && syra_fusion.activatedBook)) {
		var target;
