        ...
        if ((binding === "$actions")) {
            ...
            switch (repr) {
                case "documentExcel":
                    ...
                    document.site.excelDocument.publishDocument(article.parseExpression(article.$prototype.$url + "?representation={$representation}.$details"), article.dataset.description, article.parseExpression(article.$prototype.$.content.$url), function(data, resp){
