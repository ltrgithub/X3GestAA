...
exports.WordReportPage = helpers.defineClass(WordReportPage, RawPage, {
    ...
    refreshWordDocument: function(wordInterface) {
    	var self = this;
    	wordInterface.refreshWordDocument(self.createSimpleData());
    },
    		...
    		for (var property in proto)
    		{
    			...
    			if (prop.$type === "application/x-array") {
    			...
    			else
   				{
    				...
    				if (p.$type === "application/x-decimal" && value)
    				{
    					// on syracuse entities, decimal values are currently sent as quoted strings 
    					// which will result in errors when they are converted to typed values in .NET
    					// Therefore convert them to "real" numbers here and review protocol change later
    					value = value * 1;
    				}
