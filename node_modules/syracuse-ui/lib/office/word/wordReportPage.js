...
exports.WordReportPage = helpers.defineClass(WordReportPage, page.Page, {
    ...
    populateWordTemplate: function(wordInterface) {
    	var self = this;
    	wordInterface.populateWordTemplate(self.pageData);
    },
    ...
    createLayout: function(article, prototype, parent, boxes, level) {
    	...
    	items && items.map(function(item) {
    		self.createLayout(item, data, box, childBoxes, level);
    	});
    	if (box) {
