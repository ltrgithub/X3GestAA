...
var dispatcher = require('msoffice/lib/word/dispatcher');
...
exports.load = function($item, $prototype){
    ...
    widgetsLibrary.pageCategories.worksheet = require("./wordPage").WordPage;
    ...
    site.agents = {
    		createMailMergeDS: {
            saveDS: function(article, menu, record) {
            	// record is the saved instance
            }
        }
    }

    var wordInterfaceCtor = require('msoffice/lib/word/wordInterface').WordInterface;
    site.wordInterface = new wordInterfaceCtor();
