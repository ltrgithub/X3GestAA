...
exports.PptPage = helpers.defineClass(PptPage, RawPage, {
	...
	drawBox: function() {
		...
		this.$chartExtensions = this.createChartExtensions(this.$proto, this.$item);
			...
			return items.map(function(item) {
				...
				switch (item._type) {
					...
					case "application/x-reference":
						record = prop;
						result.value = (record && propProto.$value && document.site.expressionMaker.parse(self.$grid.$record, propProto.$value, record)) || "";
						break;
					default:
						result.value = "";
				}
