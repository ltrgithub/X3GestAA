...
exports.OfficeSite = helpers.defineClass(OfficeSite, Site, {
    ...
    renderUpdatePanel: function(){
        ...
        $("<a href='/msoffice/lib/general/addIn/SyracuseAddinsSetup.msi'>A newer version of the addin is available. Click here to download it</a>").appendTo(self.$$updatePanel);
    },
    ...
    _renderHeader: function(){
        ...
        this._appendTopPanelOpener(this._header, OfficeSiteTopPanel);
    ...
    _renderSearch: function(layoutSlot){
    }
});
