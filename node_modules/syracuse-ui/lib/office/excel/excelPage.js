...
exports.ExcelPage = helpers.defineClass(ExcelPage, page.Page, {
    drawBox: function(){
        this.$excelTablePrototype = this._makeExcelTablePrototype(this.$prototype.$.$resources.$item.$, this.$item);
        this.$grid = new ExcelGrid(this, this.$prototype.$.$resources);
        this.$grid.$record = new ExcelRecord(this.$grid, this.$prototype.$.$resources.$item);
    },
            ...
            return items.map(function(item){
                ...
                switch (item._type) {
                    ...
                    case "application/x-reference":
                        record = prop;
                        result = (record && propProto.$value &&
                        self.$grid.$record.parseExpression(propProto.$value, record)) ||
                        "";
                        break;
                    default:
                        result = "";
    ...
    createExcelTableShell: function(linesCount){
        return excelLoaded && external.ResizeTable(this.$prototype.$datasourceName, JSON.stringify(this.$excelTablePrototype), linesCount);
    },
    ...
    dispose: function(){
        ...
        page.Page.prototype.dispose.call(this);
    }
});
