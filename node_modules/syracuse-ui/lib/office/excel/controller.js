        ...
        if (($bind === "$actions")) {
            ...
            switch (repr) {
				...
				case "documentExcelSI":
                    ...
                    document.site.excelDocument.publishDocument(article.parseExpression(article.$prototype.$url + "?representation={$representation}.$details"), article.dataset.description, article.parseExpression(article.$prototype.$properties.content.$url), function(data, resp){
