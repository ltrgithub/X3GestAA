...
function ExcelDocument() {
	var self = this;
	window.syra_excel_local = _locale.resources(module)();
...
exports.ExcelDocument = _helpers.defineClass(ExcelDocument, null, {
	...
	getDatasourcesResource: function(uuid, applyMeta) {
		function getDsResource(datasource) {
			...
			dsItem.$etag = 1;
			dsItem.description = _locale.format(module, "representation", dsItem.title, dsItem.representation, dsItem.entity, dsItem.endpoint);
