...
exports.dispatcher = {
	...
	PUT: function(excelQuery, id, data, onSuccess, onError) {
		var $saveDocument = data && data.$actions && data.$actions.$saveDocument;
		if ($saveDocument && $saveDocument.$isRequested) {
			syra_site.excelDocument.publishDocument("", null, null, function() {
			...
			$saveDocument.$isRequested = false;
		}
		onSuccess(null);
	}
};