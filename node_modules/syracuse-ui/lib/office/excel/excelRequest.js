...
var _operationMap = {
	GET: function(context, data, onSuccess, onError) {
		_entities[context.entityName].executeOperation && _entities[context.entityName].executeOperation(context.operationName, context.resourceId, "GET", data, onSuccess, onError);
	},
	POST: function(context, data, onSuccess, onError) {
		_entities[context.entityName].executeOperation && _entities[context.entityName].executeOperation(context.operationName, context.resourceId, "POST", data, onSuccess, onError);
	}
};
