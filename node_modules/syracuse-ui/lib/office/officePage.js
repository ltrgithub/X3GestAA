...
exports.OfficePage = helpers.defineClass(OfficePage, DesktopPage, {
	notifyActionChange: function(target, value, notifyServer) {
		...
		// save the document to the working copy
		if (publisher && value && value.$save && value.$save.$isRequested) publisher.publishDocument(documentUrl, this.dataset.description, saveUrl, function(data, resp) {
		...
		else DesktopPage.prototype.notifyActionChange.call(this, target, value, notifyServer);
	},
