				...
				if (item.page == page) {
					...
					if (item.isRecordArticle) {
						...
						if (item.isFilterArticle) {
							...
							item.domItem.setAttribute("data-s-selected", item.$isSelected);
							...
							item.rowCard && item.rowCard.contentSlot && item.rowCard.contentSlot.outCardSlot && item.rowCard.contentSlot.outCardSlot.setAttribute("data-s-record", item.$uuid);
