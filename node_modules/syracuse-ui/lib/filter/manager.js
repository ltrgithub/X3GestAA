"use strict";
exports.criteria = require('syracuse-ui/lib/filter/criteria');
...
exports.addField = function(articleParent, slot, $item) {
	...
	field.getFilterCriteria = function() {
		if (field.filter_selectedOperator != "none") {
			...
			return exports.criteria.format({
				field: field,
...
exports.setField = function(where, field) {
	...
	var exp = syra_filter.criteria.parse(where, keys);
	if (exp && keys == keys) {
		syra_filter.operators.setFieldOperator(field, exp.$value, exp.$operator);
		if (field.isReferenceField) {
			var obj = {};
