...
function ApplicationConnection() {
	...
	this.showList = function(parentNode) {
		if (this.page) {
			if (!this.list) {
				var self = this;
				self.slot = syra_dom.div("", parentNode);
				var actions = syra_dom.div("s-user-profile-application-actions", self.slot);
				...
				self.saveBtn = syra_button.add({
					...
					click: function() {
						...
						sendBag.applicationConnection = {
							proto: self.$prototype.$properties,
							data: self.page.sendBag
						};
