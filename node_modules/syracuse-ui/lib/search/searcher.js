...
function SuggestBox(field, $source, slot) {
	...
	this.fill = function(data) {
		...
		syra_menus.button.display(this.field.suggestMore, count > 0);
		syra_menus.button.setTitle(this.field.suggestMore, count > 5 ? syra_local.searchAdvanceResults : syra_local.searchAdvanceDetails);
	};
...
helpers.defineClass(SearchField, Field, {
	...
	showPicker: function(onOut) {
		...
		syra_menus.button.display(this.clearBtn, show);
	},
	onKeyUp: function() {
		this.showPicker();
	},
