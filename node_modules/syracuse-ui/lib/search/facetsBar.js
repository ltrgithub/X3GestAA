...
var _filters, _facetItems, _map, _$facetSkin, _$criteria, _page;
...
function _addMember(facet, index) {
	...
	syra_fields.renderCheckBock(member, id, _$facetSkin + "-member-check");
...
exports.fill = function(facets) {
	if (facets) {
		syra_site.dom.empty(_page.bar.barBody);
		_filters = {};
		_facetItems = [];
		_map = {};
		...
		_page.bar.barBody.appendChild(header);
		...
		_page.bar.barBody.appendChild(body);
	}
};
...
function _addBar(options) {
	...
	bar.barBody = document.createElement("div");
...
exports.dispose = function() {
	...
	_filters = _facetItems = _map = _$criteria = _page = null;
};