...
var pSubTypesC = {}, pTypesC = {"S_STRG": 1, "S_NUM": 2, "S_DATE": 3, "S_MNL": 4};
    pSubTypesC[pTypesC.S_NUM] = {"X_INT": 0, "X_DCB": 1, "X_FLOAT": 2};
...
/* Misc constants */
var fmtK = {"MAX_CTRLSPEC": 26, "MAX_STDTYPE": 60, "MAX_CHARSUP": 32, "MAX_ENT": 24, "MAX_DECI": 24};
...
exports.LegacyCSFormatterEnv = helpers.defineClass(LegacyCSFormatterEnv, null, {
	initialize: function() {
		...
		this.preferences = {"nDatePivot": 63, "cSepDate": "/", "cSepGroupNum": " ", "cSepDecimal": ".", "cSepTime": ":", "dateOrder": dateOrderK.MDY};
	...
	getFmtDataType: function (format) {
		...
		if (format && format.length > 0 && (cutFmt = this._cutFmt (format))){
			if (cutFmt.left.indexOf(pTypes.F_STRG) >= 0) {
				...
				return {"t": pTypesC.S_DATE};
			}
			else if (cutFmt.left.indexOf(pTypes.F_MNL) >= 0) {
				return {"t": pTypesC.S_MNL};
			}
		}
		return def;	
	},
