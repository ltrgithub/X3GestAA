...
var httpController = require("syracuse-ui/lib/desktop/controller/httpController");
...
exports.Session = helpers.defineClass(Session, null, {
    ...
    waitSharedRes: function(wait, repeat, callback) {
        ...
        if (!stop && repeat > 0) {
            ...
            callback(!stop ? [util.makeDiagnosis(localize.getMessage(this.cdIsoLang, "8"), 3, "client.Controller.waitSharedRes()", "08")] : null);
        }       
    },
