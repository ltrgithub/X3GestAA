...
exports.Session = helpers.defineClass(Session, null, {
    ...
    _setRegionalOptions: function(settings){
        var fmtLocales = {}, regOpts;
        // Set regional settings
        this.regionalOptions = {"date": {}, "time": {}, "numeric": {}, "format": {}};
        regOpts = this.regionalOptions;
        _.defaults(regOpts.date, {"dateSep": settings.dateSep, "dateOrder": settings.dateOrder, "datePivot": settings.datePivot, "dateFormat": settings.DefaultDateFormat}, {"dateSep": "/", "dateOrder": "MDY", "datePivot": 1940, "dateFormat": "MM[/]DD[/]YY"});
        ...
        this.wrapperFormatter = new FormatWrapper();
        this.formatter = this.wrapperFormatter.initialize(settings.fmtExt, fmtLocales, "cvg");
    },
    ...
    getSessInfo: function() {
        var sessInfo = {"login": {}, "client": {}, "version": {}, "node": {}, "runtime": {}, "bridge": {}};
        // User
    ...
    dispose: function(){
        ...
        if(this.wrapperFormatter) {
            delete this.formatter;
            delete this.wrapperFormatter;
        }
    },
