...
exports.Session = helpers.defineClass(Session, null, {
	...
	waitSharedRes: function(wait, repeat, callback) {
		...
		if (!stop && repeat > 0) {
			...
			detail = syra_site.fusionGateway.getMessage(this.cdIsoLang, this._sharedRes.$resOnErr ? "7" : "22");
			delete this._sharedRes.$resOnErr;
			code = syra_site.fusionGateway.getMessage(this.cdIsoLang, "8") + (member ? ("\n" + syra_site.fusionGateway.getMessage(this.cdIsoLang, "15") + "'" + member + "'") : "");
