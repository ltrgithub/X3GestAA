...
exports.EventManager = helpers.defineClass(EventManager, null, {
	...
	// Add global listener
    addGlobalListeners: function(handler) {
        this._globalListeners.push(handler);
    },
	...
	trigger: function(event, object) {
		...
		_.each(this._globalListeners, function(handler) {
			//handler.call(this, event);
			handler.apply(this, evtIsString ? Array.prototype.slice.call(args, 1) : args);
		}, this);
		return intercepted ? ret : undefined;
    },
	
    dispose: function() {
		for(var i = 0, ii = this._globalListeners.length; i < ii; i++) {
			delete this._globalListeners[i];
		}
		_.each(this._evtsListeners, function(evtListners, evtName) {
			this.unbind(evtName);
		}, this);
