            ...
            function(data, response, notifyComplete) {
                ...
                try {
                    if(ret && post && post.callback) {
                        ...
                        if(!ctrlFailed && (sapUtil.cmpIst(params.target, ist) || ((sapUtil.isBlockInst(params.target.xid) || sapUtil.isLineGridInst(params.target)) && sapUtil.cmpIstGrid(params.target, ist)))){
