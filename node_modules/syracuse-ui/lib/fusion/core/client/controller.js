...
exports.Controller = helpers.defineClass(Controller, EventManager, {
    ...
    _localFormatSvcRqst: function(rqstSvc, input, post, options){
        var output = this.formatAdx.wrapper.formatSvc(input.svc, input, options);
        if(post) {
            post.callback.apply(this, post.args ? [output.succeded, output].concat(post.args) : [output.succeded, output]);
        }
    },
