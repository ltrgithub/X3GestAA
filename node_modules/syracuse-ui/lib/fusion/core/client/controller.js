...
exports.Controller = helpers.defineClass(Controller, EventManager, {
	...
	completeInit: function(rqstLocation, urlSeg, session, localOpts) {
		...
		// UI locker hoster registration
		if (this._uiLocking) {
			this._uiLocking.setHoster(this);
		}
	},
	...
	loadRepresentation: function(representation, article, success, error, customProto, stamp, onErr) {
		...
		if (stamp && this.protoQueryOpts) {
			this.protoQueryOpts.params = this.protoQueryOpts.params || {};
			this.protoQueryOpts.params.timestamp = stamp;
		}
	...
	dispose: function() {
		this.forceUnlockUI();
		if (this._uiLocking) {
			this._uiLocking.setHoster(null);
		}
...
var _uiLockDefault = helpers.defineClass(function(dummy, opts) {
	...
	lock: function(lockerId, longProcess) {
		...
		if (longProcess != this._longProcessing && (!this._lockerId || lockerId === this._lockerId)) {
			syra_locker.lock(1, (this._longProcessing = longProcess), true);
