...
var _rqstSvc = {
    "sapPost": {"name": "Native protocol", "act": null, "proxy": "sapHttpSvc", "method": "PUT", "subUrl": "requestSvc", "contentType": "application/json", "tracking": true, "lockUI": false},
...
var _cnxSvc = {
    "sapCnx": {"name": "Session connection", "act": null, "proxy": "sapHttpCnx", "method": "POST", "subUrl": "", "contentType": "application/json", "tracking": true, "lockUI": false}
};
...
exports.Controller = helpers.defineClass(Controller, EventManager, {
    ...
    completeInit: function(rqstLocation, httpQuery, session, localOpts){
        ...
        this.protoQueryOpts = {"headers": {"accept-language": this._session ? this._session.cdIsoLang : localize.defLang}, "noDisplayErr": true};
        // Formatter policies
