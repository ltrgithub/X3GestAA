...
exports.Controller = helpers.defineClass(Controller, EventManager, {
	...
	_oneLineHelpRqst: function(rqstSvc, params, post, options, currentTarget) {
		var helpKind, pageMeta = syraUtil.getFusionPageMeta(currentTarget),
			currField = this._sapController.getCurrInst(true);
		helpKind = _.find(sapUtil.helpHandler, function(value, key) {
	...
	triggerAdx: function(event, object) {
		try {
			...
			if (succeeded) {
				...
				intercepted = !intercepted && EventManager.prototype.trigger.apply(privateEvtManager || this, arguments);
				// Process result
