...
exports.Controller = helpers.defineClass(Controller, EventManager, {
    ...
    postSapRqst: function(action, params, post, options){
        ...
        this._closePending = action == requestActions.getSrvAction("SRV_FIN_APPLI") || action == requestActions.getSrvAction("SRV_TIMEOUTSESS");
	...
	getImageUrl: function(){
		return this.imageHttpSvc.$location.$url;
	},
    getSession: function(){
