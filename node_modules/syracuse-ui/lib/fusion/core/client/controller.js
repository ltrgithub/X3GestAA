...
exports.Controller = helpers.defineClass(Controller, EventManager, {
    ...
    _sendRequest: function(svc, data, queryString, onSuccess, onError, delegatePending, options){
        ...
        // Check options...
        if(options && options.preProcElapse) {
            ...
            function(data, response, notifyComplete) {
                ...
                try {
                    if(ret && post && post.callback) {
                        ...
                        if(!ctrlFailed && (sapUtil.cmpIst(params.target, ist) || (sapUtil.isBlockInst(params.target.xid) && sapUtil.cmpIstLine(params.target, ist)))){
                    ...
                    var ourAjaxErr = util.makeOurAjaxErrEx("CLOSESESS", [util.makeDiagnosis("stack trace...", 4, ex.message, 18)], 18, localize.getMessage(self._site.cdIsoLang, "13"), "Script error catched in 'controller.postSapRqst/Onsuccess()");
    ...
    triggerAdx: function(event, object){
        try {
            ...
            this._sapController._sapException(null, [util.makeDiagnosis(mess, 3, ex.message, "29", util.cltFusionNice, "Script error catched in 'controller.triggerAdx()'")]);
            return false;
        }
    },
