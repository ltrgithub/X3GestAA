...
var _rqstSvc = {
    ...
    "format": {"name": "Format service", "act": [requestActions.svcFormat, "_formatRqst"], "proxy": "fmtHttpSvc", "method": "PUT", "subUrl": "formatSvc", "contentType": "application/json"},
...
exports.Controller = helpers.defineClass(Controller, EventManager, {
    _initRqstSvcs: function(rqstHttpLoc){
        _.each(_rqstSvc, function(value, key){
            ...
            if(value.act) {
                this._svcActMapping[value.act[0].toString()] = {"dispatch": value.act[1]};
            }
        }, this);      
    },
        ...
        this._sendRequest(_rqstSvc.sapPost, data, "act=" + action, 
            ...
            function(error, notifyComplete) {
                ...
                if(!(ourAjaxErr = util.isOurAjaxErr(error))) {
                    ...
                    ourAjaxErr = util.makeOurAjaxErr("KILL", util.getDiagnosesFromAjax(error, self._session), 23, localize.getMessage(self._site.cdIsoLang, "14"));
                }
    ...
    _ourSapRqstError: function(ourAjaxErr, notifyComplete) {
        ...
        switch (ourAjaxErr.errCode) {
            case "CLOSESESS" : 
                ...
                messCallback = this.onSapCompleted;
                break;
            case "DISCONNECT" : 
    ...
    _formatRqst: function(params, post){
        var self = this;
        ...
        this._sendRequest(_rqstSvc.format, params, "svc=" + params.svc,
            function(data, response, notifyComplete) {
    ...
    _printRqst: function(params, post){
         this._sendRequest(_rqstSvc.format, params, null, 
            function(data, response, notifyComplete) {
                if(notifyComplete) {
                    notifyComplete();
                }
                ...
                if(intercepted !== undefined)
                {
                    if(object.result && object.result.diagnoses)
                    {
                        ...
                        if (object.result.$act > requestActions.srvActionStart) {
                            ...
                            this[this._svcActMapping[actId].dispatch](object.result.params, object.result.post, object.opts);
                        }
                    }
                }
            }       
