        ...
        this._hosterController.sendRequest(null, rqstPlg || this[svc.proxy],
            function (dataResp, response) {
                ...
                if(response.status == 202 && self[svc.proxy]._tracking) {
                    // Polling!
                    plgManifest = {"$location" : response.headers.location, "method": "GET", "type": dataResp && dataResp.type || "default"};
                    setTimeout(function() {
                        self._sendRequest(svc, null, null, onSuccess, onError, delegatePending, options, plgManifest);
