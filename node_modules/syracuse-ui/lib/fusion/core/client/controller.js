...
exports.Controller = helpers.defineClass(Controller, EventManager, {
    ...
    postSapRqst: function(action, params, post){
        ...
        this._sendRequest(_rqstSvc.sapPost, data, "act=" + action, 
            function(data, response) {
                var ret = self._sapController.processReply(data), chain = null;
                if(ret && post && post.callback && sapUtil.cmpIst(params.target, sapUtil.getTargetIstFromReply(data))){
            ...
            function(error) {
               self._sapController._sapException(null, util.getDiagnosesFromAjax(error, self._session), null, error);
            }
        );
    },
