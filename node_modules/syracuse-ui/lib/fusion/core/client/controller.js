			...
			for (i = 0, len = evtBuffering.buffLength(); i < len; i++) {
				...
				if (force && (msgBox = syra_alert.getModal()) && !msgBox.disposed) {
					...
					if (evt.type == "keypress") {
						if (evt.nativeEvt.charCode == KeyboardHandlers.keyCodeNameMap.space && syraUtil.getFieldType(curField, true) == syraUtil.dataTypes.booleanType) {
							// Deal with "space" key on check field
							checkValues = sapUtil.check;
