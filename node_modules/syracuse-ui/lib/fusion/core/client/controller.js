                ...
                if(intercepted !== undefined)
                {
                    if(object.result && object.result.diagnoses)
                    {
                        ...
                        if (object.result.$act > requestActions.srvActionStart) {
                            succeeded = !this[_rqstSvc.sapPost.proxy]._tech.pending ? this.postSapRqst(object.result.$act, object.result.params, object.result.post, {"preProcElapse": evtTimelapse}) : false;
                        }
