	...
	_initSvcs: function(svcsDesc, svcHttpLoc) {
		_.each(svcsDesc, function(value, key) {
			this[value.proxy] = {
				...
				$acceptType: value.type || svcHttpLoc.$type || svcHttpLoc.$acceptType || "application/json",
				$contentType: value.contentType || svcHttpLoc.$contentType || "application/json",
				_tech: {
					pending: false,
					count: {
						"s": 0,
...
var _uiLockDefault = helpers.defineClass(function(dummy, opts) {
	...
	lock: function(lockerId, longProcess) {
		...
		if (!this._locked) {
			...
			this._locked = true;
			this._longProcessing = false;
			syra_uiLocker.lock(0, false, true);
		...
		if (longProcess != this._longProcessing && (!this._lockerId || lockerId === this._lockerId)) {
			syra_uiLocker.lock(1, (this._longProcessing = longProcess), true);
