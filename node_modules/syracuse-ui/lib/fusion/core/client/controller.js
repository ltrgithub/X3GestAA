            ...
            function(data, response, notifyComplete) {
                ...
                try {
                    if(ret && post && post.callback) {
                        ...
                        if(!self._sapController.isControlFailedInReply(null, ist) && (sapUtil.cmpIst(params.target, ist) || (sapUtil.isBlockInst(params.target.xid) && sapUtil.cmpIstLine(params.target, ist)))){
