...
var _rqstSvc = {
    ...
    "gridSortData": {"name": "Sort data grid service", "act": [requestActions.svcGridSortData, "_basicSvcRqst"], "proxy": "fmtHttpSvc", "method": "PUT", "subUrl": "gridSortDataSvc", "contentType": "application/json"}
};
...
exports.Controller = helpers.defineClass(Controller, EventManager, {
    ...
    _basicSvcRqst: function(params, post){
        var self = this;
        ...
        this._sendRequest(_rqstSvc.format, params, params.svc?"svc=" + params.svc:"",
            function(data, response, notifyComplete) {
