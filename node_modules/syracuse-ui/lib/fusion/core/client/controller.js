...
var _rqstSvc = {
    ...
    "print": {"name": "Print services", "act": [requestActions.svcPrint, "_printRqst"], "proxy": "printHttpSvc", "method": "PUT", "subUrl": "print", "contentType": "application/json"},
 	//proxy : fmtHttpSvc provides all format service identified by svc parameter
	...
	//proxy : miscHttpSvc provides various kinds of fusion services identified by svc parameter
...
exports.Controller = helpers.defineClass(Controller, EventManager, {
	...
	// Basic Rest service - params.svc contains service ID
                ...
                if(intercepted !== undefined)
                {
                    if(object.result && object.result.diagnoses)
                    {
                        ...
                        if (object.result.$act > requestActions.srvActionStart) {
							...
							var m=this._svcActMapping[actId];
							// FDB - requests called only by using action Code - m.rqstSvc in order to be able to use on methode for multiple services (basic...)
                        	 this[m.dispatch](m.rqstSvc, object.result.params, object.result.post, object.opts);							
                        }
                    }
                }
            }       
