...
exports.Controller = helpers.defineClass(Controller, EventManager, {
    ...
    loadRepresentation: function(representation, article, success, error, customProto, stamp, completeOnErr){
        ...
        this._hosterController.loadRepresentation(article, this.httpQuery, function($itemPage){
            ...
            try {
                ...
                diag = util.makeDiagnosis(self._session.getlabel("error", "68", "Unexpected error loading window : ") + " '" + representation.name + "'.\n" + self._session.getlabel("error", "26", "The expected function could not be opened. Please, contact your system administrator if the issue persists."), 3, ex.stack, "67", util.cltFusionNice, ex.message);
                self._sapController._sapException(null, diag, {"typ": "RqstSrv" , "act": requestActions.getSrvAction("SRV_ABANDON"), "param": {"ist": null, "v": ""}}, null, null, completeOnErr);
            }
