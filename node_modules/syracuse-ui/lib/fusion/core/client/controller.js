...
var _enableKeyboardBuffering = true /*check with future syra_site.userProfile.dataset*/ ;
...
function Controller() {
	...
	this._evtBuffering = _enableKeyboardBuffering && syra_quality.enableEvtBuffering !== false ? new _keyboardBuffering(null, null, this) : null;
...
exports.Controller = helpers.defineClass(Controller, EventManager, {
	...
	dispatchEvtBuffered: function(svcId, force, evtBuffering) {
		var ret, i, len, evt, curIst = this._sapController ? this._sapController.getCurrInst(true) : null;
...
var _uiLockDefault = helpers.defineClass(function(dummy, opts, hoster, evtBuffering) {
	...
	lock: function(lockerId, longProcess) {
		...
		if (longProcess != this._longProcessing && (!this._lockerId || lockerId === this._lockerId)) {
			syra_locker.lock(1, (this._longProcessing = longProcess), true, this._evtBuff);
...
var _keyboardBuffering = helpers.defineClass(function(bufferSize, timer, controller) {
	...
	dispatch: function(svcId, force, callback) {
		var ret = undefined,
			ctrlDispatcher;
		if (this.buffLength()) {
			ret = null;
			if (callback) {
				ret = callback(svcId, force, this);
