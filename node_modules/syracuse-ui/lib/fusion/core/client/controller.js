...
var _cnxSvc = {
    "sapCnx": {"name": "Session connection", "act": null, "proxy": "sapHttpCnx", "method": "POST", "subUrl": "", "contentType": "application/json", "tracking": true}
};
...
exports.Controller = helpers.defineClass(Controller, EventManager, {
        ...
        this._hosterController.sendRequest(null, rqstPlg || this[svc.proxy],
            ...
            function (error) {
                ...
                if(!delegatePending) {
                   ...
                   onError(error, function () {self[svc.proxy]._tech.pending = false;});
                }
                if(self._log) {
    ...
    completeInit: function(rqstLocation, httpQuery, session, localOpts){
        ...
        // Sap controller post-initialization
        this._sapController.onConnecting();
    },
    ...
    loadRepresentation: function(representation, article, success, error, customProto, stamp, onErr){
        ...
        this.httpQuery.$urlParts.params.representation = representation.name + ".$fusion" + (representation.$variant ? ("," + representation.$variant) : "");
