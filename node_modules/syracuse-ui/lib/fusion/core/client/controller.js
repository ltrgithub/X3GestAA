...
exports.Controller = helpers.defineClass(Controller, EventManager, {
    ...
    _sendRequest: function(svc, data, queryString, onSuccess, onError, delegatePending, options, pollingManifest){
        ...
        this._hosterController.sendRequest(null, rqstPlg || this[svc.proxy],
            function (dataResp, response) {
                ...
                if(response.status == 202 && self[svc.proxy]._tracking) {
                    // Polling!
                    plgRules = {"$location" : response.headers.location, "method": "GET", "type": dataResp && dataResp.type || "default"};
                    setTimeout(function() {
                        self._sendRequest(svc, null, null, onSuccess, onError, delegatePending, options, plgRules);
                    }, dataResp && dataResp.pollingMillis || 1000);
                    return;
                }
                ...
                if(intercepted !== undefined)
                {
                    if(object.result && object.result.diagnoses)
                    {
                        ...
                        if (object.result.$act > requestActions.srvActionStart) {
                            if(this[_rqstSvc.sapPost.proxy]._tech.pending) {
