...
exports.FusionSite = helpers.defineClass(FusionInPlaceSite, null, {
    ...
    connect: function(httpQuery, onError){
        var self = this, _elapse = utilBis.getTimer(true);
        try {
            ...
            this.controller.postCnxpRqst( {"settings": {}},
                function($location, reply){
                    var _srvDuration = _elapse.inter();
                    ...
                    (self._getLogger()).timer(null, "Connection duration : total [" + _elapse.elapsedMs() + "], with ajax [" + _srvDuration + "] and local [" + (_elapse.elapsedMs() - _srvDuration) + "]");
                },
                function(err){
                    var ourAjaxErr;
    ...
    _bootStrap: function(httpQuery, rqstLocation, sessSettings, statements, srvOpts, localOpts, onError){
        ...
        try {
            ...
            this.controller.postInit(srvOpts, localOpts);
