...
exports.FusionSite = helpers.defineClass(FusionInPlaceSite, null, {
    ...
    _initDisconnectRules: function(){
        ...
        this._disconnectCtrlMap = {
            "connecting": {
                ...
                "checkArgs": [sapUtil.cnxStatus.establishing, null, true],
                "forceClose": this._emergencyCltClose
            },
            "closed": {
                "rnk": 2,
                "mess": "36",
            ...
            "jobPending": {
                ...
                "mess": "38",
                "messForce": "45",
                "check": this._isJobPending,
                "release": this._releaseJobPending,
                "forceClose": this._emergencyCltClose
            }
        };
    ...
    free: function(reason){
        ...
        if (hosterCtrl && hosterCtrl.fusionGateway && hosterInst) {
            hosterCtrl.fusionGateway.closeBook(hosterInst, true);
        }
        else {
            this.dispose();
        }
