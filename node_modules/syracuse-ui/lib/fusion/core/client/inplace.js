...
exports.FusionSite = helpers.defineClass(FusionInPlaceSite, null, {
	...
	_fixtureMode: function(requester, onError) {
		...
		// Fixture mode
		if (requester.openerUrlSegments.params && requester.openerUrlSegments.params.d == "on" && requester.openerUrlSegments.params.r) {
			(this._hoster.controller.parseUrl("/sdata/x3stb/erp/stubs/" + requester.openerUrlSegments.params.r)).sendRequest(null, function(reply) {
				requester.openerUrlSegments.params = requester.openerUrlSegments.params || {};
