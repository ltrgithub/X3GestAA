...
exports.FusionSite = helpers.defineClass(FusionInPlaceSite, null, {
    ...
    _initDisconnectRules: function() {
        ...
        this._disconnectCtrlMap = {
            ...
            "jobPending": {"rnk": 4, "mess": "38", "messForce": "45", "check": function () {return false;}, "release": function () {return true;}, "forceClose": this.emergencyCltClose}
        };
        ...
        if(diagnosis) {
            ...
            post = {
                ...
                "callback": function (reply) {
                    var diagnosis = mkDiag(_kSvrtSuccess, "39", "closeDone"), ok = true;
                    if(!self.controller._sapController.isEndSessReply(reply)) {
                        diagnosis = mkDiag(_kSvrtError, "40", "closeRefused");
                        ok = false;
                    }
                    if(ok) {
                        setTimeout(function(){callBackEx(diagnosis);}, 50);
                    }
                    else{
                        if(force) {
