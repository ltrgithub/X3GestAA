...
exports.FusionSite = helpers.defineClass(FusionInPlaceSite, null, {
    ...
    _initDisconnectRules: function() {
        ...
        this._disconnectCtrlMap = {
            "connecting": {"rnk": 1, "mess": "49", "messForce": "50", "check": this.checkCnxStatus, "checkArgs": [sapUtil.cnxStatus.established, true], "forceClose": this.emergencyCltClose},
    ...
    connect: function(httpQuery, onError){
        ...
        try {
            ...
            this.controller.postCnxpRqst({"settings": {}},
                function($location, reply, acknowledge, standBy){
                    self._bootStrap(httpQuery, $location, sap.getSessSetsFromReply(reply), reply, sap.getsrvOptsFromReply(reply), {"cdIsoLang": self.cdIsoLang, "standBy": standBy}, onError, acknowledge);
                },
    ...
    _bootStrap: function(httpQuery, rqstLocation, sessSettings, statements, srvOpts, localOpts, onError, acknowledge){
        try {
            // Normally, the connexion is now established...
            var srvCfg, self = this, err, standBy = localOpts && localOpts.standBy;
            ...
            this.controller.completeInit(rqstLocation, httpQuery, this._session, localOpts);
            this._session.waitSharedRes(100, 30, function(diagnoses) {
                ...
                if(!standBy && (err = self.controller.onStart(statements, isSharedResErr ? diagnoses : null))) {
                    setTimeout(function(){onError({"$diagnoses": err});}, 5);
                }
                if(acknowledge) {
            ...
            err = [util.makeDiagnosis(localize.getMessage(this.cdIsoLang, "1") + " 'client.CvgInPlaceSite._bootStrap()' : " + ex.message + ".\n" + localize.getMessage(this.cdIsoLang, "2"), 4, ex.stack, "01", util.cltFusionNice)];
            if(!acknowledge) {
