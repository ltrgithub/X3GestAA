...
exports.FusionSite = helpers.defineClass(FusionInPlaceSite, null, {
    ...
    _initDisconnectRules: function() {
        ...
        this._disconnectCtrlMap = {
            ...
            "jobPending": {"rnk": 4, "mess": "38", "messForce": "45", "check": this._isJobPending, "release": this._releaseJobPending, "forceClose": this.emergencyCltClose}
        };
    ...
    emergencyCltClose: function(additionalSess){
