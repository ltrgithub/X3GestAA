...
function _getArrayMetaLink(fieldInfo, line, rcdLevel, links) {
    ...
    if(uuid !== null) {
        ...
        root = change[(collName = sapUtil.getBlockInst(fieldInfo.$fieldMeta.$bind))] = [{"$uuid": uuid}];
        root = root[0];
        if(!rcdLevel) {
            root.$properties = {};
...
exports.CommonEventHandlingTools = {
    ...
    toggleFieldAfterClick: function(reply, evtHandlingObj, $field, fieldIst, newValue, notifySrv, act){
