...
exports.CommonEventHandlingTools = {
    ...
    cancelSortArray : function(array, arrayInfo) {
    	console.log("cancelSortArray")
        var meta = {"$properties": {}}, page = array ? array.page : null, bind = arrayInfo && arrayInfo.$fieldMeta ? arrayInfo.$fieldMeta.$bind : null;
        if(page && bind) {
            meta.$properties[bind] = {"$orderBy": null};
            array.applyChange(meta);
        }
    }
