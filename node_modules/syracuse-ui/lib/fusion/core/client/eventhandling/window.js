...
_evtProcWindow.sap = function () {
	...
	function onKeyDown(event) {
        ...
        if (event.target) {
	        ...
	        // TODO : traiter le cas où TAB depuis un input ou autre élément quio n'est pas dans le modèle X3, typiquement champ de séletion rapide liste gauche. Ne pas envoyer le tab serveir dans ce cas là!
        }
        return processed;
	}
	...
	function onClick(event) {
		var processed = undefined, $$field, $field, id, readlId, fieldIst, currIst, $$cont, $$grid;
