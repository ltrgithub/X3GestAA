...
_evtProcList.sap = function() {
	this.eventListeners = function() {
		return [
			["wdgt.list.toggle", beforeToggle, true, true], ["wdgt.list.selline", selectLine, true, true], ["wdgt.list.toggled", afterToggle], ["wdgt.list.sortLocal", sortLocal, true, true], ["wdgt.list.operatorchange", operatorChange, true, true], ["wdgt.list.clearFilter", clearFilter, true, true], ["wdgt.list.operatorclick", operatorClick, true, true], ["wdgt.list.keydown", keyDown, true, true], ["wdgt.list.applyShortCut", applyShortCut, true, true], ["wdgt.list.click", clickQuickSelField, true, true], ["wdgt.list.picker", clickPicker, true, true], ["wdgt.list.calendarclosed", onDatePickerClose, true, true]
		];
	};
	...
	this._triggerFilter = function(opt, $bind, next) {
		...
		opt.result = {
			...
			params: {
				target: fieldInfo.blockIst,
				sudo: [(fieldInfo.array.filter_row && fieldInfo.array.filter_row.fusion_getCriterion()) || [], null]
			}
		};
	...
	function nextQuickSel(reply, evtHandlingObj, fieldInfo, $bind, next) {
		...
		if (exec && !fieldInfo.array.disposed) {
			fieldInfo.array.filter_row.fusion_focusToNextCol($bind ? $bind : fieldInfo.$fieldMeta.$bind, next);
		}
	}
