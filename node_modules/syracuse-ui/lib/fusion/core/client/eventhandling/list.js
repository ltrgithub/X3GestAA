...
_evtProcList.sap = function(){
    ...
    function keyDown(event){
        ...
        console.log("LeftList keyDown " + processed);
        return processed;
    }
    ...
    function _getFieldInfo(event){
        var nl = (event.data && event.data.line) ? event.data.line : 0, fieldInfo = evtTools.getFieldInfo(_getXElement(event.target), nl), $fusionPageMeta = syraUtil.getFusionPageMeta(event.target), winName, record, treeNode = null;
