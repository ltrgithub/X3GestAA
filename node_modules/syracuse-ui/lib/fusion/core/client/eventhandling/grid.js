...
_evtProcGrid.sap = function(){
    ...
    function actionLine(event){
        ...
        if (event.target) {
        	_unSelectLines(fieldInfo.array,(fieldInfo.nl - 1))
    ...
    function selectLine(event){
        ...
        if (event.target) {
           ...
           if(event.data.nativeEvt.shiftKey && l.length >0){
				...
				if(l.length >0) _unSelectLines(fieldInfo.array,(fieldInfo.nl - 1))         	
           }
    ...
    function _unSelectLines(array,serverIndex){
    	array.unSelectLines(serverIndex);
    }
