    ...
    function keyDownCellTab(event){
	    ...
	    if (event.target && !sapUtil.isSpecialKey(keycode)) {
            switch (keycode) {
                ...
                case keys["VK_ESCAPE"]:
                    if (fieldInfo.isEdit) {
						syraUtil.getFusionController(event.target)._sapController._wndwsStack.setDataStoreValue(fieldInfo.currIst.win,fieldInfo.currIst.xid,fieldInfo.currIst.nl, "", {"noStoreCommmit": true})
