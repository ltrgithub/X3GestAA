    ...
    function selectLine(event){
        ...
        if (event.target) {
            ...
            if (l.length > 0 && fieldInfo.nl) {
                ...
                if (event.data.nativeEvt.currentTarget.checked && (serverIndex != l[0].start + l[0].count && serverIndex != l[0].start - 1 || sapUtil.isEmptyGridDataRecord(event.target,{uuid:event.data.uuid}))) {
