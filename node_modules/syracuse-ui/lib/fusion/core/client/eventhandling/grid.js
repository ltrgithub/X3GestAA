...
_evtProcGrid.sap = function(){
    this.eventListeners = function(){
        return [["wdgt.cell.click", clickCellTab, true, true], ["wdgt.cell.change", changeCellTab, true, true], ["wdgt.grid.selline", selectLine, true, true], ["wdgt.record.action", actionLine, true, true], ["wdgt.array.action", actionArray, true, true], ["wdgt.cell.picker", clickPicker, true, true], ["wdgt.cell.calendarclosed", onDatePickerClose, true, true], ["wdgt.cell.keydown", keyDownCellTab, true, true]];
    };
    ...
    function clickPicker(event){
        ...
        if (event.data) {
            if (pickerType = event.data.pickerType) {
                console.log("clickPicker " + pickerType)
                switch (pickerType) {
                    case "menus":
    ...
    function menuCtxPickerClick(event, process, fieldInfo){
        var popupCtx = syraUtil.getPopupCtxFromField(event.target), exclude = {};
    ...
    function keyDownCellTab(event){
        var processed = undefined, fieldInfo = _getFieldInfo(event), doEvt,keycode=event.data.nativeEvt.keyCode,acts=undefined ;
        if (!fieldInfo.isEdit || (keycode != keys["VK_ENTER"] && keycode != keys["VK_ESCAPE"])) {
