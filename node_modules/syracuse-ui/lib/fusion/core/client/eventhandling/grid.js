...
_evtProcGrid.sap = function(){
    this.eventListeners = function(){
        return [["wdgt.cell.click", clickCell, true, true], ];
    };
    ...
    /*TODO : Pour boolean: 
     * si mode commande retour mode commande apres click.
     * si mode saisie reste mode saisie apes click
     *
     */
    function clickCell(event){
        // "target":... "type":... "data": {"nativeEvt:..."}
        var processed = undefined, fieldInfo = {}, newVal, currIst, $fusionPageMeta, newIst, acts, readOnlyByModel, targetType, focus, nl, xid, firstFocus;
        
        if (event.target && ($fusionPageMeta = syraUtil.getFusionPageMeta(event.target))) {
            fieldInfo.nl = event.target.getArticle().$recordUuid + 1
