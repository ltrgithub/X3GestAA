	...
	function selectLine(event) {
		...
		if (fieldInfo.isSpecialNode) {
			...
			if (!itemForm.formulaFull) {
				...
				else itemForm.formulaFull = itemForm.formulaFull.substr(0, itemForm.caretPosition) + fieldInfo.formula + itemForm.formulaFull.substr(Math.max(itemForm.caretPosition, (itemForm.selectionEnd ? itemForm.selectionEnd : 0)));
			}
