...
_evtProcFormula.sap = function() {
	this.eventListeners = function() {
		return [
			["wdgt.list.selline", selectLine, true, true], ["wdgt.field.keydown", keyDown, true, true], ["wdgt.link.click", onClick, true, true], ["wdgt.win.close", onClose, true, true], ["wdgt.win.closeall", onCloseAll, true, true], ["wdgt.win.validate", onValidate, true, true]
		];
	};
