                ...
                case 74:
                    ...
                    if(event.data.nativeEvt.ctrlKey && event.data.nativeEvt.altKey) {
                        setTimeout(function() {
                            ...
                            event.target.page.externalAdapter.onBlockExRpc({"field" : event.target, "call": {"proxy": "TEST_CMI", "values": [["string1 1 origin", "string1 2 origin", "string1 3 origin", "string1 4 origin", "string1 5 origin"], ["string2 1 origin", "string2 2 origin", "string2 3 origin", "string2 4 origin", "string2 5 origin"], "STRING1", [1,2,3,4,5,6]], "callback": _cmiTest, "callbackArgs": [self.sapController, self.sapController.getCurrInst()]}});
                        }, 50);
                    }
                    break;
               case 68:
