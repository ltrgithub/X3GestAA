...
_evtProcWindow.sap = function() {
	...
	function applyEnter(opt) {
		if (opt.target.isTextArea) return true;
	...
	function applyShortCut(opt) {
		...
		} else if (opt.data.shortcuts.tab) {
			return applyTab(opt);
		} else if (opt.data.shortcuts.up) {
			return applyArrowUp(opt);
		} else if (opt.data.shortcuts.down) {
			return applyArrowDown(opt);
		} else if (opt.data.shortcuts.i) {
			return evtTools.applyKeyI(opt);
		} else if (opt.data.shortcuts.d) {
