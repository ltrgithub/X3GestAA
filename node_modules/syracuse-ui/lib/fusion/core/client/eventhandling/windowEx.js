...
_evtProcWindow.sap = function(){
    ...
    function _cmiTest(reply, sapCrl, currFld) {
            ...
            switch (keyCode) {
                case 74:
                    ...
                    if(event.data.nativeEvt.ctrlKey && event.data.nativeEvt.altKey) {
                        setTimeout(function() {
                            //(self.sapController.getSiteController()).triggerAdx("wdgt.xblock.rpc", {"target": event.target, "type": "rpc", "data": {"call": {"proxy": "TEST_ADD", "values": [3.25, 2.78], "callback": _cmiTest, "callbackArgs": [self.sapController, self.sapController.getCurrInst()]}}});
                            //(self.sapController.getSiteController()).triggerAdx("wdgt.xblock.rpc", {"target": event.target, "type": "rpc", "data": {"call": {"proxy": "TEST_CMI", "values": [["string1 1 origin", "string1 2 origin", "string1 3 origin", "string1 4 origin", "string1 5 origin"], ["string2 1 origin", "string2 2 origin", "string2 3 origin", "string2 4 origin", "string2 5 origin"], "STRING1", [1,2,3,4,5,6]], "callback": _cmiTest, "callbackArgs": [self.sapController, self.sapController.getCurrInst()]}}});
                            event.target.page.externalAdapter.onBlockExRpc({"field" : event.target, "call": {"proxy": "TEST_CMI", "values": [["string1 1 origin ùﭸ", "string1 2 origin", "string1 3 origin", "string1 4 origin", "string1 5 origin"], ["string2 1 origin", "string2 2 origin", "string2 3 origin", "string2 4 origin", "string2 5 origin"], "STRING1", [1,2,3,4,5,6]], "callback": _cmiTest, "callbackArgs": [self.sapController, self.sapController.getCurrInst()]}});
                            //event.target.page.externalAdapter.onBlockExRpc({"field" : event.target, "callFunc": true, "call": {"proxy": "TEST_FUNC_CMI", "values": [["string1 1 origin ùﭸ", "string1 2 origin", "string1 3 origin", "string1 4 origin", "string1 5 origin"], ["string2 1 origin", "string2 2 origin", "string2 3 origin", "string2 4 origin", "string2 5 origin"], "STRING1", [1,2,3,4,5,6]], "callback": _cmiTest, "callbackArgs": [self.sapController, self.sapController.getCurrInst()]}});
                        }, 50);
                    }
                    break;
               case 68:
            ...
            if (fieldInfo.readOnlyByModel) {
                this.sapController.setLocalIst(fieldInfo.fieldIst);
               	if(fieldInfo.type == syraUtil.dataTypes.imageType) {
               		// Avoid upload image if readOnly
            		processed = true;
        		}
            }
        }
