...
_evtProcWindow.sap = function(){
    ...
    function onFieldClick(event){
        ...
        if (event.target && (fieldInfo = _getFieldInfo(event.target))) {
            ...
            if (!fieldInfo.readOnlyByModel && !this.sapController.hasFocus(fieldInfo.fieldIst)) {
                ...
                if(event.data.doEvent) {
                ...
                else if(fieldInfo.isCheck || fieldInfo.isRadio) {
                    ...
                    event.result.post = {"exposeReply": true, "callback": _toggleFieldAfterClick, "args": [this, event.target, fieldInfo.fieldIst, newVal]};
                }
                processed = true;
            }
    ...
    function onFieldClickPicker(event){
        ...
        if (event.data) {
            ...
            else if (event.data.isContextMenu) {
                isCtx = true;
                pickerOk = true;
            ...
            if (pickerOk && fieldInfo && !fieldInfo.readOnlyByModel) {
                ...
                if(event.data.doEvent && isCtx) {
                    event.result.post = {"exposeReply": isCtx, "callback": isCtx ? _openFieldCtx : event.data.doEvent, "args": isCtx ? [this, event, event.target, fieldInfo.fieldIst] : []};
                }
                processed = true;
            }
        }
