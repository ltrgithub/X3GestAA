...
_evtProcWindow.sap = function(){
    ...
    function _showSessInfo(sapController, currField, filedInf, curWin){
        ...
        diagnoses.push(util.makeDiagnosis("Current field is : " + (filedInf && filedInf.$fieldMeta && filedInf.$fieldMeta.$bind || "???"), "info", null, 0, null, "", null, []));
