...
exports.Fusion = {
	...
	getServerIndexFromNl:function(nl){
		return (!isNaN(nl) && parseInt(nl,10)>0)?nl-1:1;
	},
	getNlFromServerIndex:function(serverIndex){
		return (!isNaN(serverIndex) && parseInt(serverIndex,10)>=0)?serverIndex+1:0;
	}
};
    ...
    getPopupCtxFromField: function(field){
		if(field && field.arrayLevel && field.arrayLevel=="record"){
			return field.contextMenu && field.contextMenu._popupMenus;
       		...
       		return field &&  field.contextMenu && field.contextMenu._popupMenus;
		}
    },
