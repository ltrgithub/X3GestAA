...
exports.Syra = {
    ...
    pageFacet: {
        lookup: "$lookup",
        modal2: "$modal2", // window type 2 
        modal3: "$modal3", // window type 3 
        edit: "$edit"
    },
    ...
    isDialogFacet: function($facet){
        return ($facet == this.pageFacet.lookup) || ($facet == this.pageFacet.modal2 || ($facet == this.pageFacet.modal3))  ;
    },
