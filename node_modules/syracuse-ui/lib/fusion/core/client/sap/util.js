...
exports.Fusion = {
	...
	setFieldMod: function(field, ist) {
		...
		if (field && field.$isEditMode) {
			field.input && syra_site.dom.toggleClass(field.input, "s-x3mode-command-input", !ist.edit);
			syra_site.dom.toggleClass(field._dataValue, "s-x3mode-command", !ist.edit);
		}
	},
	...
	razStyleOnInput: function(input, styleColl, excludeStyle) {
		_.each(styleColl, function(stl, name) {
			if (name != excludeStyle && stl.css) {
				syra_site.dom.toggleClass(input, stl.css, false);
			}
		});
	},
