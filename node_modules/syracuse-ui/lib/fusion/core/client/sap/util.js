...
exports.Fusion = {
	...
	getIdxFromNL:function(nl){
 	...
 	isEmptyGridDataRecord: function (list,dataRecord){
    	var dataSetRecord,empty=false,value;
    	if(!dataRecord || dataRecord.$serverIndex!==(list.dataset.length-1)) return false
    	for (var key in dataRecord){
    		if(list.$fieldProperties[key]){
    			...
    			switch (list.$fieldProperties[key].$type){
    				...
    				case exports.Syra.dataTypes.iconType : empty=(value==="");break;
