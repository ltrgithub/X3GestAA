...
exports.Fusion = {
    ...
    specialWindow: {
        "selbox": {"name": "AASELECT", "id": "_SELBOX"},
        "choose": {"name": "AACHOOSE", "id": "_CHOOSE"},
        "formula": {"name": "AAFORMULA", "id": "_FORMULA"}
    },
    metaNameMap: {
        "xid": "$XID"
    },
    ...
    focusStyle: {
        "fmtErr": {"css": "s-field-input-error", "code": "fmtErr"},
        "std": {"css": null, "code": "std"}
    },
    ...
    isSpecialWin: function(name){
        return _.find(this.specialWindow, function(winDef) {return winDef.id == name;});
    },
    ...
    needToControlField: function(fldT) {
        ...
        return fldT == srT.stringType || fldT == srT.dateType || fldT == srT.integerType || fldT == srT.decType || fldT == srT.realType || fldT == srT.timeType ? true : false;
    },
    ...
    getObjFieldValue: function(value, modeType, ctxProps){
        return {"v": value, "xFmt": modeType, "ctx": ctxProps};
    },
...
exports.Syra = {
    ...
    getPopupCtxFromField: function(field){
        return field && field._menusController && field._menusController._contextMenu && field._menusController._contextMenu._popupMenus;
    },
    ...
    getPage: function(syraObject){
        var page = syraObject.boxParent ? syraObject.boxParent.getArticle() : syraObject;
        if((!page || !page.$fusionPageMeta) && syraObject.boxParent && syraObject.boxParent.boxParent) {
            page = syraObject.boxParent.boxParent.getArticle();
        }
