...
exports.Fusion = {
    ...
    _adjustIcoFieldData: function(data){
    ...
    appendMnus2Syra: function(representation, menus){
        if (menus) {
            var links = exports.Syra.mapMnus2Links(menus, "txt", "act", "id", "typ", "rnk", "idf");
            exports.Syra.appendLinks2Proto((exports.Syra.getProtoFromPage(representation) || representation), links);
        }
    },
    cmpIst: function(a, b){
        var ret = false;
    ...
    getObjFieldValue: function(value, modeType){
        return {"v": value, "xFmt": modeType};
    },
...
exports.Syra = {
    ...
    getCollFieldsFromProto: function(proto, coll){
        return (proto[coll] && proto[coll].$item ? proto[coll].$item.$ : null);
    },
    ...
    appendLinks2Proto: function(proto, links){
        if (proto.$links === undefined) {
            proto.$links = {};
        }
        _.each(links, function(link){
            if (link) {
                _.extend(proto.$links, link);
            }
        });
    },
