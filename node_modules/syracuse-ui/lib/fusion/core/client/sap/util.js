...
exports.Fusion = {
	...
	checkPopupCard: function(oldIst, newIst, grid) {
		...
		if (!this.cmpIstBlock(oldIst, newIst)) {
			if (grid.popupCardBuilder) {
				grid.popupCardBuilder.togglePopup();
			}
		}
	},
	setFieldMod: function(field, ist) {
		...
		if (field && field.input) {
			syra_site.dom.toggleClass(field.input, "s-x3mode-command", !ist.edit);
		}
	},
...
exports.Syra = {
	...
	getUserLocalPref: function() {
		return syra_site && syra_site.userProfile && syra_site.userProfile.dataset && syra_site.userProfile.dataset.selectedLocale;
	},
