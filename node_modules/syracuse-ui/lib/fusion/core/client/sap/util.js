...
exports.Fusion = {
	...
	goToHelp:function(url,$prototype,target,tokens){
	   var propertie="$baseUrl", baseHelpUrl = ($prototype[propertie] || "http://uranus2:8080/AdxDoc_DOCV7X3/FRA/");
	   url = url.replace("{" + propertie + "}", baseHelpUrl);
	   if(tokens){
	     url = url.replace("{$help}", tokens[0]+".htm");  
	   }
...
exports.Syra = {
	...
	getFusionPageMeta: function(syraObject) {
		var page = this.getPage(syraObject), pageMeta = page ? page.$fusionPageMeta : null;
