...
exports.Fusion = {
    ...
    cnxStatus: {
        ...
        "closedByClt": 0x0008,
        "closedBySrv": 0x0010,
        "closedByPortal": 0x0020,
        "closedPanic": 0x0040,
        "deleting": 0x0080,
        "deleted": 0x0100,
        "deletedFailed": 0x0200,
        "released": 0x0400
    },
    specialScrnId: {
        "buttons": "a",
	...
	isEmptyGridDataRecord: function (list,data){
    	...
    	if(!data.dataRecord || data.dataRecord.$serverIndex<(list.dataset.length-1)) return false
    	for (var key in data.dataRecord){
    		if(list.$fieldProperties[key]){
    			value=data.dataRecord[key]
    			switch (list.$fieldProperties[key].$type){
    				...
    				case exports.Syra.dataTypes.iconType : empty=(value==="-1");break;
