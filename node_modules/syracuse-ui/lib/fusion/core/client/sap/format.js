...
exports.FormatterWrapper = helpers.defineClass(FormatterWrapper, null, {
	svcMapping: {
		"toRaw": {"method": "formatRaw", "raw": undefined},
		"toDisp": {"method": "formatDisp", "raw": false},
		"toEdit": {"method": "formatEdit", "raw": false},
		"rawToEdit": {"method": "formatEdit", "raw": true},
		"rawToDisp": {"method": "formatDisp", "raw": true}
	},
	...
	checkOnFocusOut: function(inputValue, type, fmt, fmtKind, lastRawValue) {
		var output = {"raw": inputValue, "show": inputValue, "$diagnoses": null, "succeeded": true}, format = {"format": fmt};
