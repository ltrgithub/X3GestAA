...
var Plugin = helpers.defineClass(function Plugin() {}, null, {
	...
	serializeReply: function(action, method, instanceId, data, error) {
		return {
			"action": action,
...
var _AsyncPlugin = helpers.defineClass(function() {}, Plugin, {
	launch: function(args) {
		var err = null;
		var winRef = window.open(this.protocol + args || "", "" + this._id, "width=1,height=1");
...
var _IlogPlugin = helpers.defineClass(function() {}, _AsyncPlugin, {
	...
	create: function(params) {
		...
		args.push(["h", isHTTPS ? "1" : "0"]);
		args.push(["l", hoster.getLang() + "/" + hoster.getLang(true)]);
		args.push(["i", this._id]);
		args.push(["s", syra_site.getSessIdCookieName() + "=" + syra_site.getSessionId()]);
		args.push(["a", appType]);
	...
	_serializeReply: function(methodId, method, instanceId, error) {
		...
		return this.serializeReply("PLUGIN_ILOG_ACK", method, instanceId, {
			"property": data
		}, error);
