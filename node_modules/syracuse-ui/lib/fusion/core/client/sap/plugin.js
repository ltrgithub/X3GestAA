...
var _AsyncPlugin = helpers.defineClass(function() {}, Plugin, {
	launch: function(args) {
		var err = null;
		var winRef = window.open(this.protocol + args || "");
...
var _IlogPlugin = helpers.defineClass(function() {}, _AsyncPlugin, {
	...
	create: function(params) {
		...
		args.push(["l", hoster.getLang()]);
		args.push(["i", this._id]);
		args.push(["s", syra_site.getSessionIdCookie() + "=" + syra_site.getSessionId()]);
		args.push(["a", appType]);
		args.push(["u", hoster.getBaseUrl()]);
	...
	destroy: function(params, force) {
		...
		return force ? {} : this._serializeReply(params.methodId, params.method, this._id);
	},
