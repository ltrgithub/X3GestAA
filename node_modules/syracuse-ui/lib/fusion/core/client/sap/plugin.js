...
var urlMaker = require("syracuse-ui/lib/site/tools/url");
...
var _AsyncPlugin = helpers.defineClass(function() {}, Plugin, {
	launch: function(args, isDebugOn) {
		...
		var winRef = window.open(this.protocol + encodeURIComponent(args) || "", "" + this._id, "width=" + winSize + ",height=" + winSize);
