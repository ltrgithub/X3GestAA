...
var printerSetup = require('syracuse-ui/lib/site/tools/printerSetup');
...
exports.PrinterAccess = helpers.defineClass(PrinterAccess, EventManager, {
	initialize: function(params, onInitComplete, sapController, winRank) {
		var winId = sapUtil.getWinId(winRank),
			stackParams;
		stackParams = {
			"id": winId,
			"name": "printerSetup",
			"mainPage": false,
			"$itemPage": printerSetup.getSetupPage(),
	...
	displaySetup: function(params) {
		var dlgId = sapUtil.getWinId(this._winRank),
