...
exports.AsyncJobsManagement = helpers.defineClass(AsyncJobsManagement, null, {
    ...
    register: function(jobType, params){
        var id, job = this._jobTypesClass[jobType] ? new this._jobTypesClass[jobType]() : null, result, $diag = null, self = this, j, lenj;
        if(job) {
            job._typeId = jobType;
    ...
    _getErrMessLabel: function(cdMess, def) {
        return this._siteController.getMessLabel ? this._siteController.getMessLabel(cdMess, "error", def || "...") : def || "...";
    },
