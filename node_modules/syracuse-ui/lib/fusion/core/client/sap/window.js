...
WinModel = helpers.defineClass(WinModel, null, {
        ...
        if ($entityEx.entity) {
            if ($bounds[$entityEx.entity] && ((len = $bounds[$entityEx.entity].length) > 0)) {
                ...
                if ((isDirtyProxy = _instVtbl[$entityEx.type] ? (_instVtbl[$entityEx.type].isDirty || _instVtbl["default"].isDirty) : _instVtbl["default"].isDirty) && $boundField[isDirtyProxy] && !$boundField[isDirtyProxy]()) {
                    ...
                    value = $boundField[_instVtbl[$entityEx.type] && _instVtbl[$entityEx.type].getValue ? _instVtbl[$entityEx.type].getValue : _instVtbl["default"].getValue].call($boundField, entity, index);
                }
    ...
    _setDataImageField: function(entityName, entityBound, data, options){
        ...
        data.v = (data.v && data.v!=="")? {'$url': fusionController.getImageUrl()+"?id="+data.v}:"";
        return this._setDatadField(entityName, entityBound, data, options);
    },
