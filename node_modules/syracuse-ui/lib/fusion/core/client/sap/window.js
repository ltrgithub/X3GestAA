...
var _instVtbl = {"default": {"_getDataInput": "getDataValue", "setFocus": "focus", "_setDataStore": "_setDatadField", "_getDataStore": "_getDataField", "getCtxProps": "_getFieldCtxProps", "isDatasetColl": false, "isDirty": "dirty"}};
        ...
        _.each(entities, function(data, entityName){
            ...
            if ($entities[entityName]) {
                ...
                if (!this._dataset[entityName]) {
                    (this._dataset[entityName] = new EntityStore()).initialize($type, _instVtbl[$type] ? _instVtbl[$type].isDatasetColl : _instVtbl["default"].isDatasetColl, entityName, {"isNodeWS": this._isNodeWS});
                }
                // Set data
