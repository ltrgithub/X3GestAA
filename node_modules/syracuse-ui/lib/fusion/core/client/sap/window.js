...
WinModel = helpers.defineClass(WinModel, null, {
    ...
    getDataFmt: function(entityName){
        var $type, $entityEx = this.getEntityEx(entityName);
        if ($entityEx) {
            $type = $entityEx.type || "default";
            return this[_instVtbl[$type] && _instVtbl[$type]._getDataFmt ? _instVtbl[$type]._getDataFmt : _instVtbl["default"]._getDataFmt].apply(this, arguments);
        }
        else {
            return null;
        }
    ...
    _setDataField: function(entityName, entityBound, winProto, recordSet, data, options, refProps){
        // Adjust "style" meta
        var newRawValue = false, newFmt = false, dataPtr = this._dataset[entityName].data, fmt, refTitle, refValue = {}, entities = {}, rawValue;
    ...
    _getDataField: function(entityName, line, isExternalWrap, onlyValue, opts){
        ...
        data = isExternalWrap ? {"val": dataSet.v, "rcd": null, "meta": onlyValue ? null : dataSet} : (onlyValue ? dataSet.v : dataSet);
    ...
    _getDataColl: function(entityName, line, isExternalWrap, onlyValue, opts){
        ...
        if (line === undefined || line === null) {
            ...
            if (isLinesColl) {
                ...
                data = isExternalWrap ? {"val": dateSet[line - 1][entityName]} : dateSet[line - 1][entityName];
            }
        }
