...
WinModel = helpers.defineClass(WinModel, null, {
        ...
        _.each(entities, function(data, entityName){
            ...
            if ($entities[entityName]) {
                ...
                if (!this._dataset[entityName]) {
                    ...
                    features = store.initialize($type, _instVtbl[$type] ? _instVtbl[$type].isDatasetColl : _instVtbl["default"].isDatasetColl, entityName, $entities[entityName], this._isLocalFmt ? this._fmtWrapper.formatter : null, {"isNodeWS": this._isNodeWS, "locales": this._fmtWrapper.locales});
    ...
    _setDataField: function(entityName, entityBound, winProto, recordSet, data, options, refProps){
        // Adjust "style" meta
        var newValue = false, newFmt = false, dataPtr = this._dataset[entityName].data, fmt, refTitle, refValue = {}, entities = {};
