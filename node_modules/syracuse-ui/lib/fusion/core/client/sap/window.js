...
var _instVtbl = {
    "default": {
        ...
        "setFocus": "focus",
        "setData": "_setDatadField",
        "getData": "_getDataField",
        "getCtxProps": "_getFieldCtxProps",
        "isDatasetColl": false
    }
};
_instVtbl[syraUtil.dataTypes.treeType] = {
    "setData": "_setDataTree",
    "getData": "_getDataTree"
};
_instVtbl[syraUtil.dataTypes.collectionType] = {
    "setFocus": "setFocus",
    "setData": "_setDataColl",
    "getData": "_getDataColl",
    "isDatasetColl": true,
...
WinModel = helpers.defineClass(WinModel, null, {
            ...
            if (data.$mvt) {
                _.each(data.$mvt, function(mvt){
                    ...
                    if (delta && (delta.mvtData.length > 0 || delta.delAll)) {
                        syraElapse += this._bindDataColl(entityName, entityBound, delta.mvtData, {
                            "$isDelta": delta.isDelta,
                            "$range": delta.mvtMeta
                        }, null, oldFashion);
                    }
                }, this);
    ...
    _bindDataColl: function(entityName, entityBound, $resources, record, metaData, oldFashion, logger){
        var elapse = (new Date()).getTime(), update = {
            "$properties": {}
        };
