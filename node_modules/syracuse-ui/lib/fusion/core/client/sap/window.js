...
var _instVtbl = {"default": {"getValue": "getDataValue", "setFocus": "focus", "setData": "_setDatadField", "getData": "_getDataField", "isDatasetColl": false}};
     _instVtbl[syraUtil.dataTypes.treeType] = {"getValue": "getDataValue", "setFocus": "focus", "setData": "_setDataTree", "getData": "_getDataTree", "isDatasetColl": false};
     _instVtbl[syraUtil.dataTypes.collectionType] = {"getValue": "getDataValue", "setFocus": "setFocus", "setData": "_setDataColl", "getData": "_getDataColl", "isDatasetColl": true, "removeFocus": "resetFocus", "setFocusStyle": "setFocusStyle"};
     _instVtbl[syraUtil.dataTypes.rtfType] = {"getValue": "_getEditContents", "setFocus": "focus", "setData": "_setDatadField", "getData": "_getDataField", "isDatasetColl": false, "removeFocus": "resetFocus"};
     _instVtbl[syraUtil.dataTypes.iconType] = util.duplicateObj(_instVtbl["default"]);
...
exports.WinStack = helpers.defineClass(WinStack, null, {
    ...
    setFocus: function (winId, style, entity) {
...
WinModel = helpers.defineClass(WinModel, null, {
    ...
    setFocus: function (style, entity) {
        var $entityEx, $bounds = this._fieldsColl.bound, ret = null, args, setFocusProxy, setFocusStyleProxy;
        if (!entity || entity.length === 0) {
            ...
            if($entityEx.entity) {
                if($bounds[$entityEx.entity] && $bounds[$entityEx.entity].length > 0) {
                    ...
                    setFocusProxy = _instVtbl[$entityEx.type] ? _instVtbl[$entityEx.type].setFocus : _instVtbl["default"].setFocus;
                    ...
                    //$bounds[$entityEx.entity][0][_instVtbl[$entityEx.type] ? _instVtbl[$entityEx.type].setFocus : _instVtbl["default"].setFocus].apply($bounds[$entityEx.entity][0], args);
                    setFocusStyleProxy = _instVtbl[$entityEx.type] ? _instVtbl[$entityEx.type].setFocusStyle : _instVtbl["default"].setFocusStyle;
    ...
    setEntities: function(entities, options){
        ...
        _.each(entities, function(data, entityName) {
            ...
            if($entities[entityName]) {
                ...
                // Set data               
                this[_instVtbl[$type] ? _instVtbl[$type].setData : _instVtbl["default"].setData](entityName, $entities[entityName], $bounds[entityName], data, options);
