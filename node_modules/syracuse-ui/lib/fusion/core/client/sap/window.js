...
var _formulaWin = helpers.defineClass(function() {
	...
	setFocus: function(highlight, style, entity, nl, isEdit, params, opts) {
		var i, len, entities, proto, fusionController, currIst, prevFld;
		if (!this._firstFocus) {
			...
			if (this._formulaFldName) {
				...
				if ((fusionController = syraUtil.getFusionController(this.syraModel)) && fusionController._sapController) {
					if ((prevFld = fusionController._sapController.getBoundField(opts.prevIst, opts.prevIst.nl !== undefined ? {
						"arrayCell": currIst.nl
					} : null))) {
						this._formulaFldMaxL = prevFld.$maxLength || this._formulaFldMaxL;
						// Force format to deal with max lengh... a bit tricky, but...
						if ((currIst = fusionController._sapController.getCurrInst())) {
							currIst.fmt = "K:" + this._formulaFldMaxL + "X";
						}
					}
				}
			}
