    ...
    getValue: function(entity){
        ...
        if ($entityEx.entity) {
            if ($bounds[$entityEx.entity] && $bounds[$entityEx.entity].length > 0) {
                ...
                if((isDirtyProxy = _instVtbl[$entityEx.type] && _instVtbl[$entityEx.type].isDirty) && !$bounds[$entityEx.entity][0][isDirtyProxy].apply($bounds[$entityEx.entity][0], arguments)) {
                    notModified = true;
                    value = undefined;
                }
                else {
