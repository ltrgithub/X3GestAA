...
WinModel = helpers.defineClass(WinModel, null, {
    ...
    getValue: function (entity) {
        var $entityEx, $bounds = this._fieldsColl.bound, ret = null, value = null, modeType = null;
        ...
        if($entityEx.entity) {
            if($bounds[$entityEx.entity] && $bounds[$entityEx.entity].length > 0) {
                ...
                modeType = $entityEx.type && $entityEx.type == syraUtil.defaultType ? sapUtil.fieldModeType.edit : sapUtil.fieldModeType.show;
            }
        }
