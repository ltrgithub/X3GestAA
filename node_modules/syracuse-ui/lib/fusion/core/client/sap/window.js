...
exports.WinStack = helpers.defineClass(WinStack, null, {
    ...
    stack: function(id, winDef, syraPageModel){
        ...
        (this._windows[idEx.id] = new WinModel()).initialize(idEx, winDef, syraPageModel, this._sapController.fmtWrapper);
...
WinModel = helpers.defineClass(WinModel, null, {
    initialize: function(idEx, winDef, syraModel, fmtWrapper){
