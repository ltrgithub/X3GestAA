...
var _instVtbl = {"default": {"getValue": "getDataValue", "setFocus": "focus", "setData": "_setDatadField", "getData": "_getDataField", "isDatasetColl": false}};
     ...
     _instVtbl[syraUtil.dataTypes.collectionType] = {"getValue": "getDataValue", "setFocus": "setFocus", "setData": "_setDataGrid", "getData": "_getDataGrid", "isDatasetColl": true, "removeFocus": "resetFocus"};
...
WinModel = helpers.defineClass(WinModel, null, {
    ...
    _setDataGrid: function(entityName, entity, entityBound, data, options){
        var todo = (new Date()).getTime(), mvtCode, delta, rcd = {}, commit = storeCommit(options);
