	...
	setFocus: function(highlight, style, entity, nl) {
		...
		if (!entity || sapUtil.getScreenRank(entity) == 0) {
			...
			if (($entityEx = this.getEntityEx(entity)) && $entityEx.entity) {
				...
				$screenTab = ($bounds[$entityEx.entity] && $bounds[$entityEx.entity][0] && $bounds[$entityEx.entity][0].boxParent && !$bounds[$entityEx.entity][0].boxParent.$opened) ? $bounds[$entityEx.entity][0].boxParent : null;
