...
exports.AckCallStack = helpers.defineClass(AckCallStack, null, {
    ...
    buildRequest: function(request, target, callParams, isFunc) {
        ...
        try {
            ackCallRqst = this.stackRqst(callParams);
    ...
    stackRqst: function(callParams) {
        var len = this._stack.length;
        this._stack.push((new AckCallRequest()).initialize(callParams, this, len));
...
AckCallRequest = helpers.defineClass(AckCallRequest, null, {
    initialize: function(request, hoster, id, dbgFlags){
        ...
        this._reply = null;
        this._func = request.callFunc && this._desc ? this._desc.ret : null;
            ...
            if(replyJSON.params) {
                ...
                for (i = 0, leni = params.length; i < leni; i++) {
                    ...
                    if(this._argsDesc[paramNum].dim > 1) {
                        this._reply.argsModified[paramNum][param.poste] = this._getArgValFromStrg(this._argsDesc[paramNum].typ, param.resu);
                    }
                    else {
                        this._reply.argsModified[paramNum] = this._getArgValFromStrg(this._argsDesc[paramNum].typ, param.resu);
                    }
                }
            }
            if(this._func) {
                this._reply.return = replyJSON.return ? this._getArgValFromStrg(replyJSON.return.typ, replyJSON.return.typ.resu) : undefined;
            }
            if(replyJSON.debugInfos) {
                rqstJ.debugInfos = util.duplicateObj(replyJSON.debugInfos);
            }
        }
    },
