...
exports.AckCallStack = helpers.defineClass(AckCallStack, null, {
    ...
    buildRequest: function(request, target, callParams, isFunc) {
        var ackCallRqst = null, ret = false, hasFocus, act, srvActM, callP = {}, params = {"target": target};
        try {
            ...
            if(hasFocus) {
                ...
                srvActM = "getSrvAction";
                params.std = [callP];
            }
            else {
                act = isFunc ? "SUP_CELL_FOCUS_SRVFUNC" : "SUP_CELL_FOCUS_SRVCALL";
                srvActM = "getSrvActionEX";
                params.sudo = [null, [callP]];
            }
            request.result = {"$act": requestActions[srvActM](act), "params": params};
...
AckCallRequest = helpers.defineClass(AckCallRequest, null, {
    ...
    _getSpgmDiagnosis: function(spgmErr) {
        var split = spgmErr["errm"].split(".adx : "), stack = null, mess = "";
        if(split.length > 1) {
            mess = split[1];
            stack = split[0];
        }
