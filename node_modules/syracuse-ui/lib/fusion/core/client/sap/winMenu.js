...
var _kVirtualPath = {"file": "file/", "x3ico": "x3icons/"}, _menuWithMagneto = true;
...
exports.MenuManagement = helpers.defineClass(MenuManagement, null, {
	...
	addStatusIco: function(winId, icoId, act){
	...
	removeStatusIco: function(winId, icoId){
		var ret = false;
		if(this.winMenuColl[winId]) {
		}
	},
...
WinMenu = helpers.defineClass(WinMenu, null, {
  	...
  	_addWinProtoAction: function(actions){
   	...
   	buildMenus: function(){
   		...
   		else if (this._winFacet !== syraUtil.pageFacet.lookup){
   	...
   	buildTreeMenusObj: function(){
		...
		function walk(srcItems, trgtItems, ctx) {
   		...
   		if(this._showMagneto && this._winFacet !== syraUtil.pageFacet.lookup) {
