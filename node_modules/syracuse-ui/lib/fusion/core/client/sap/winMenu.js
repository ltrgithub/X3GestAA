  	...
  	_addWinProtoAction: function(actions){
   	...
   	buildMenus: function(){
   		...
   		if(!this._winFacet || this._winFacet === syraUtil.pageFacet.edit) {
 			...
 			map = [{"id": _menuIDs.STATUS_CMN, "rnk": _insertRank.status}, {"id": _menuIDs.DISPLAY_EX, "rnk": _insertRank.help - 10}, {"id": _menuIDs.NAVIGATION_OWN, "rnk": 15}, {"id": _menuIDs.WINDOW_OWN, "rnk": 97}, {"id": menuIDs.HELP_EX, "rnk": _insertRank.help}];
   		}
