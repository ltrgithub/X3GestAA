...
WinMenu = helpers.defineClass(WinMenu, null, {
  	initialize: function(menuManager, winId, winMenus, winProto, winFacet, setMainGrp, showMagneto, session){
    	...
    	if(!this._winFacet || this._winFacet === syraUtil.pageFacet.edit || this._winFacet === syraUtil.pageFacet.modal2) {
    		// Tempory ack (F7)
    		_addMenu(this._menus, this._tabMenusFather, this._menuManager._getMenuItem(_menuIDs.ROOT_SUPERVISOR, this._idMnuCpt++, null, "10", 6, _insertRank.grpUtilities - 2, null, "SRV_ADXEXECUTE", false, {"ico": "274", "icoVp": "x3icomnu", "grp": _kMnuHelper.group.grpExtra.cld}));
    	}
    	if(winProto.$actions) {
