...
exports.MenuManagement = helpers.defineClass(MenuManagement, null, {
	...
	_getWinMenuBar: function(winId, winFacet, winMenusDef, winProto, setMainGrp){
		...
		(this.winMenuColl[winId] = new WinMenu()).initialize(this, winMenusDef, winProto, winFacet, setMainGrp, this._mnuWithMagneto, this._session);
...
WinMenu = helpers.defineClass(WinMenu, null, {
  	initialize: function(menuManager, winMenus, winProto, winFacet, setMainGrp, showMagneto, session){
  	...
  	_addWinProtoAction: function(actions){
        ...
        for (i = 0, len = actsdArray.length; i < len; i++) {
        	...
        	_addMenu(this._menus, null, this._menuManager._getMenuItem(_menuIDs.BTN_WIN, this._menuManager._idMnuCpt++, null, actItm.$title, 1, i + 50, actItm.$act));
        }
