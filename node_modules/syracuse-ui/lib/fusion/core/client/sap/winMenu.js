...
var _menuFlat = false, _menuWithMagneto = true;
var _menuIDs = {	
...
exports.MenuManagement = helpers.defineClass(MenuManagement, null, {
    ...
    _addInternalCoreMenu: function() {
    	...
    	// Items of "SUBMENU_DIAGNOS_CMN"
  		_addMenu(this._coreMenus, this._tabMenusFather, this._getMenuItem(_menuIDs.SUBMENU_DIAGNOS_CMN, this._idMnuCpt++, null, "11", 1, 11, null, "SRV_CALCULATRICE", false, {"ico": "42", "icoVp": "x3ico"}));
		...
		_addMenu(this._coreMenus, this._tabMenusFather, this._getMenuItem(_menuIDs.HELP_EX, this._idMnuCpt++, null, "0", 2, 50, null, null));
  		...
  		_addMenu(this._coreMenus, this._tabMenusFather, this._getMenuItem(_menuIDs.SUBMENU_PRINT_CMN, this._idMnuCpt++, null, "18", 6, 10, null, "SRV_FICHIER_PRINT", false, {"ico": "6", "icoVp": "x3ico"}));
    ...
    dispose: function(){
   	...
   	_getCoreMenuIDs: function() {
		...
		ids[_menuIDs.SUBMENU_PRINT_CMN] = {"tag":"SUBMENU_PRINT_CMN", "txt": this._session.getlabel("text", 3, "Print"), "typ": 5, "opts": {"ico": "s-file-powerpoint", "icoVp": "file", "layout": "row"}};
			...
			for (i = 0, len = srcItemsArray.length; i < len; i++) {
	    		if (!srcItems[srcItemsArray[i]].inactive && !_kMnuHelper.isItemSep(_kMnuTypes[srcItems[srcItemsArray[i]].typ])) {
	    			...
	    			if((_kMnuTypes[srcItems[srcItemsArray[i]].typ] & _kMnuHelper.cat.popup) && srcItems[srcItemsArray[i]].items && (Object.keys(srcItems[srcItemsArray[i]].items)).length > 0) {
    					mnuItem = {"$title": srcItems[srcItemsArray[i]].txt, "$style": style, "$layout": {"$items": []}};
						if((layout = srcItems[srcItemsArray[i]].opts) && (layout = layout.layout)) {
