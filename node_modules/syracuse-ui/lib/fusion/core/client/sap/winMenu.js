...
exports.MenuManagement = helpers.defineClass(MenuManagement, null, {
	...
	_addInternalCoreMenu: function() {
		...
		_addMenu(this.coreMenus, this._tabMenusFather, this._getMenuItem(_menuIDs.SUBMENU_DIAGNOS_CMN, this._idMnuCpt++, syra_fusion.getMessage(logger && logger.isTraceEnable() ? "menuTraceLocalOff" : "menuTraceLocalOn"), null, 1, 13, requestActions.getLocalAction("LCL_TOGGLE_LOG"), null, false, {
			"acl": 2116
		}));
		// Items of "FILE_EX"
