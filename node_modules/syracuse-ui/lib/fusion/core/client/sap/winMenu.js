...
exports.MenuManagement = helpers.defineClass(MenuManagement, null, {
	...
	addMnuBarToProto: function(winId, winFacet, winMenusDef, winProto) {
		...
		/*if (this.coreMenus._isRefreshRegistered) {
			// TODO : à enlever à terme, car plus de raisons d'être ici, à moins que ca change encoer d'ici là...
		...
		} else if ($mnus.length == 1 && (mnuItem = $mnus[0].$layout) && (mnuItem = mnuItem.$items) && !mnuItem.$layout && mnuItem.length == 1) {
