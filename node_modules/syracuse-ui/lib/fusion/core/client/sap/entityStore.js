...
exports.EntityStore = helpers.defineClass(EntityStore, null, {
    ...
    getColumnsDataColl: function(property, raw, sort){
        ...
        if(!sort) {
            ...
            dataCol = this.sortDataColl(property, raw, sort);
        }
        return dataCol;
    },


    sortDataColl: function(sortCol, raw, opts){
        var zero = "0", i, nieme, len, dataColSorted, dataCol = [], intg = false, flt = false, metaFmt = this.metaFmt[sortCol], rawEx = !!(raw && metaFmt);
        ...
        if(opts && opts.onlyColumn) {
            if(opts.onlyData) {
                ...
                dataColSorted = dataCol.sort(function(a, b) {
                    return intg ? parseInt(a || zero, 10) - parseInt(b || zero, 10) : (flt ? parseFloat(a || zero) - parseFloat(b || zero) : a.localeCompare(b));
                });
            }
            else {
                if(rawEx) {
                ...
                dataColSorted = dataCol.sort(function(a, b) {
                    return intg ? parseInt(a.v || zero, 10) - parseInt(b.v || zero, 10) : (flt ? parseFloat(a.v || zero) - parseFloat(b.v || zero) : a.v.localeCompare(b.v));
                 });
           }
        }
        else {
            ...
            if(!rawEx) {
                dataColSorted = dataCol.sort(function(a, b) {
                    return intg ? parseInt(a[sortCol] || zero, 10) - parseInt(b[sortCol] || zero, 10) : (flt ? parseFloat(a[sortCol] || zero) - parseFloat(b[sortCol] || zero) : a[sortCol].localeCompare(b[sortCol]))
                });
            }
            else {
                dataColSorted = dataCol.sort(function(a, b) {
                    return intg ? parseInt(a.$rawV[sortCol].v || zero, 10) - parseInt(b.$rawV[sortCol].v || zero, 10) : (flt ? parseFloat(a.$rawV[sortCol].v || zero) - parseFloat(b.$rawV[sortCol].v || zero) : a.$rawV[sortCol].v.localeCompare(b.$rawV[sortCol].v));
                });
            }
        }
        if (opts && opts.direction && opts.direction == "down") {
