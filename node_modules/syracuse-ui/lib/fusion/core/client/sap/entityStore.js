							...
							if (!this._fmtWrapper || !(dataFmt = this._getMetaFmtColl(rcdArray[j], i, this.metaFmt[rcdArray[j]]))) {
								...
								try {
									if (commit) {
										...
										niemeDataPtr[rcdArray[j]] = skip || yetFormatted ? newData[jd][rcdArray[j]] : this._fmtWrapper.formatter.formatField(dataFmt, newData[jd][rcdArray[j]], true, false);
										...
										if (!skip && !yetFormatted) {
											newData[jd][rcdArray[j]] = this._fmtWrapper.formatter.formatField(dataFmt, newData[jd][rcdArray[j]], true, false);
										}
									}
								} catch (e) {
