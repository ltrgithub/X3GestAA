...
exports.Controller = helpers.defineClass(SapController, null, {
        ...
        if (ret) {
            ...
            this._session.waitSharedRes(100, 30, function(diagnoses){
                if (diagnoses && diagnoses.length > 0) {
                    self._sapException(null, diagnoses, {
                        "typ": "RqstSrv",
    ...
    updateSentData: function(ist, v){
        ...
        if (currIst && !currIst.fmt && sapUtil.isFieldInst(ist.xid)) {
            ...
            this._wndwsStack.setDataValue(ist.win, ist.xid, ist.nl, v, {
                "noUI": true
            });
        }
    },
    ...
    forceValue: function(params, noStoreCommmit, hardForce){
        ...
        if (params.xid && params.hasOwnProperty("v") && params.v != null) {
            ...
            // Set value
            this._wndwsStack.setDataValue(params.win, params.xid, params.nl, params.v, {
    ...
    _stubWinOpen: function(params, parseCtx, func, reply){
        ...
        if (parseCtx.win2Process) {
            ...
            this._siteController.loadRepresentation(loadParams, null, function(page){
                ...
                self._sapException(reply, diagnoses, {
                    "typ": "RqstSrv",
                ...
                }, error, null, parseCtx && parseCtx._techReply ? parseCtx._techReply.replyComplete : null);
                ...
                if (!specialWin) {
                    ...
                    if (specialWin.id == sapUtil.specialWindow.choose.id && winId.appendModel) {
    ...
    _stubSetPrevValue: function(params){
        if (this._isValueChange(params)) {
            this.forceValue(params, false);
        }
        return null;
    },
    /* _isValueChange: function(params){
     var istReq, istRep = {}, fval = true,fld=this.getRequestData().fld;
     if ((istReq = fld.ist) && istReq.nl) {
     istRep.win = params.win
     istRep.xid = params.xid
     istRep.nl = params.nl
     if (sapUtil.cmpIst(istReq, istRep)) {
     fval = !(fld.v === params.v)
     }
     }
     
     
     this._wndwsStack.getValue(params.win, params.xid, params.nl)
     
     return fval;
     },*/
    _isValueChange: function(params){
        var fval = true, WinModel;
        if (params.v == undefined) {
            fval = false
        }
        else 
            if (params.nl && params.nl > 0 && (WinModel = this._wndwsStack.getWindow(params.win))) {
    ...
    _stubSapTarget_ist: function(params, replyCompleteCallback){
        ...
        if (params.ctrlFailed && dispfmtErrMess) {
            // Display message
            params.$diagnoses = params.$diagnoses || [util.makeDiagnosis(this._session.getlabel("error", "12", "Incorrect value, it does not respect field format or field type"), 3, "_stubSapTarget_ist()", "12", util.cltFusionNice)];
