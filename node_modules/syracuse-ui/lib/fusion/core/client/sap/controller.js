...
exports.isSessStatementsOk = function(reply, strict){
    var settings = exports.getSessSetsFromReply(reply), i = 0, l = _sessSetRequiredK.mandatory.length, ok = false, srvOpts;
    if (settings) {
...
exports.Controller = helpers.defineClass(SapController, null, {
    ...
    initSurvivalMode: function(cdLang){
        var self = this;
        this._session = {
            "cdIsoLang": cdLang || localize.defLang
        };
    ...
    _initNewCurrIst: function(params){
        ...
        if (sapUtil.isFieldInst(currIst.xid) && currIst.edit && (!isSameIst || (!sapUtil.isGridInst(currIst) && !params.ctrlFailed))) {
            ...
            if (oldFmt) {
                ...
                this._wndwsStack.setDataStoreValue(currIst.win, currIst.xid, currIst.nl, oldShow, {
                    "noStoreCommmit": true,
                    "discardUnsort": true
                });
            }
        ...
        if (sapUtil.isFieldInst(currIst.xid)) {
            ...
            if (!isSameIst && currIst.fmt && currIst.raw) {
                ...
                if (editVal.succeeded) {
                    this._wndwsStack.setDataStoreValue(currIst.win, currIst.xid, currIst.nl, editVal.edit, {
                        "formatted": true,
                        "noStoreCommmit": true,
                        "discardUnsort": true
                    });
    ...
    _stubSapTarget_selpr: function(params, replyCompleteCallback, dummy, reply){
        var self = this, completeCalled = false, winId = this._wndwsStack.getTopWin(false, true), ret = {"notifyCalled": true};
        (this.getSiteController()).forceUnlockUI();
        ...
        if(params && params.$diagnoses) {
            this._sapException(null, params.$diagnoses, {
                ...
                "param": {"notModified": true}}, null, null, replyCompleteCallback);
        }
        else if (params && params.$facet == "configPrinter") {
