...
exports.Controller = helpers.defineClass(SapController, null, {
	...
	_initNewCurrIst: function(params) {
		var isSameIst, editVal, currIst, oldRaw, oldFmt, oldIst, field;
		...
		if (sapUtil.isFieldInst(currIst.xid) && currIst.edit && (!isSameIst || (!sapUtil.isGridInst(currIst) && !params.ctrlFailed))) {
			...
			if (oldFmt) {
				oldRaw = this._wndwsStack.getDataStoreValue(currIst.win, currIst.xid, currIst.nl, false, true, {
					"rawVal": true
				});
				this._wndwsStack.setDataStoreValue(currIst.win, currIst.xid, currIst.nl, oldRaw, {
					"noStoreCommmit": true,
					"discardUnsort": true
				});
			}
