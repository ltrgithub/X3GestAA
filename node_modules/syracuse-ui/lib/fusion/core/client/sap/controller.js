...
exports.Controller = helpers.defineClass(SapController, null, {
    ...
    _initNewCurrIst: function(params) {
        ...
        if(this.fmtWrapper.settings.localFormat && (!isSameIst || (!sapUtil.isGridInst(currIst) && !params.ctrlFailed)) && sapUtil.isFieldInst(currIst.xid)) {
            ...
            if(oldFmt) {
                ...
                this._wndwsStack.setDataStoreValue(currIst.win, currIst.xid, currIst.nl, oldShow, {"noStoreCommmit": true});
            }
        }
        // Init new context
        ...
        if(this.fmtWrapper.settings.localFormat && sapUtil.isFieldInst(currIst.xid)) {
            ...
            if(!isSameIst && currIst.fmt && currIst.raw) {
                ...
                if(editVal.succeeded) {
                    this._wndwsStack.setDataStoreValue(currIst.win, currIst.xid, currIst.nl, editVal.edit, {"formatted": true, "noStoreCommmit": true});
                }
            }
        }
        return false;
    ...
    forceValue: function(params, noStoreCommmit, hardForce) {
        ...
        if(params.xid && params.hasOwnProperty("v") && params.v != null) {
            ...
            // Set value
            this._wndwsStack.setDataStoreValue(params.win, params.xid, params.nl, params.v, {"noStoreCommmit": noStoreCommmit});
        }
        return null;
    },
