...
exports.Controller = helpers.defineClass(SapController, null, {
    ...
    _getLoadRepParams: function(winParams) {
        var params = {}, specialWin = sapUtil.isSpecialWin(winParams.name), winType = winParams.type;
        if(specialWin) {
    ...
    _stub4glDiagnoses: function(params) {
        var diagAPI = document.site;
        if(params && diagAPI && (diagAPI = diagAPI.showDiagnoses)) {
            diagAPI({"$diagnoses": params});            
        }
        return null;
    },
