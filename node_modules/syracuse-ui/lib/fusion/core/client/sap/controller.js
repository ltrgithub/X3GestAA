        ...
        if (parseCtx.win2Process) {
            ...
            this._siteController.loadRepresentation(loadParams, null, 
                ...
                function (representation){
                    ...
                    var specialWin = sapUtil.isSpecialWin(winId.name), j, i = 0, listProps, listPropsSorted = [], listPropsSorted2, listPropsSortedEx = {};
                    if(!specialWin) {                   
                        ...
                        if((listProps = syraUtil.geChooseLstPropFromProperties(winId.appendModel))) {
                            ...
                            listPropsSorted2 = listPropsSorted.sort();
                            for (j = 0; j < i; j++) {
