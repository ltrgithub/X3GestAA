        ...
        if (parseCtx.win2Process) {
            ...
            this._siteController.loadRepresentation(loadParams, null, 
                ...
                function (representation){
                    ...
                    if(!specialWin) {                   
                        self._winMenus.addMnuBarToProto(loadParams.id, loadParams.$facet || representation.$prototype.$x3facet, winId["mnu"], (syraUtil.getProtoFromPage(representation) || representation));
                    }
