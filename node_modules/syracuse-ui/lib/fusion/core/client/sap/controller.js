...
function _getSrvopRqst (reply) {
    var srvop = _sapK.pNodes.srvOps
    return reply && reply[srvop] && reply[srvop].request;
}
...
exports.Controller = helpers.defineClass(SapController, null, {
    ...
    _initNewCurrIst: function(params) {
        ...
        var test=this._wndwsStack.getBoundField(currIst.win, currIst.xid)
        if(!isSameIst) {
    ...
    stubSapTarget_ist: function(params, replyCompleteCallback, reply) {
    	var ret = null, self = this, dispfmtErrMess = false, isEvilInst, field, highlight, srvops = _getSrvopRqst(reply);
        ...
        if (params.ctrlFailed && dispfmtErrMess) {
            ...
            highlight = srvops && srvops.v ? requestActions.isActFocusSel(srvops.v) : true;
