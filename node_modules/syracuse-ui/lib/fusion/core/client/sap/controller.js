...
function _dispFmtErrBox(params, ctrlObj, replyCompleteCallback) {
    ...
    boxOpts.callback = function(resp, closureMode) {
        ctrlObj._wndwsStack.setFocus(params.win, sapUtil.focusStyle.fmtErr.code, params.xid, sapUtil.getServerIndexFromNl(params.nl), (params.edit === null || params.edit === undefined ? true : params.edit), params);
...
exports.Controller = helpers.defineClass(SapController, null, {
    initialize: function(siteController, srvOpts){
        ...
        (this._ackcallStack = new Ackcall.AckCallStack()).initialize(this);
    ...
    getRequestData: function(inst, action, params) {
        ...
        if(!this._siteController._localOpts.fixture || !this._siteController._localOpts.fixture.on) {
            ...
            valueEx = this._wndwsStack.getValue(this._currCtx.ist.win, this._currCtx.ist.xid, sapUtil.getServerIndexFromNl(this._currCtx.ist.nl));
    ...
    removeFocus: function() {
        ...
        this._wndwsStack.removeFocus(ist.win, ist.xid, sapUtil.getServerIndexFromNl(ist.nl));
    },
    ...
    _stubWinClose: function(params, parseCtx, func) {
        ...
        _.each(params, function(winId){
            if(!this._wndwsStack.shouldDiscardClose(winId, func.open)) {
                this._winMenus.releaseWinMenu(winId);
        ...
        if (parseCtx.win2Process) {
            ...
            this._siteController.loadRepresentation(loadParams, null, 
                ...
                function (representation){
                    ...
                    var specialWin = sapUtil.isSpecialWin(winId.name), j, i = 0, listProps, listPropsSorted = [], listItem, listPropsSortedEx = {};
                    if(!specialWin) {                       
                        self._winMenus.addMnuBarToProto(loadParams.id, loadParams.$facet, winId["mnu"], (syraUtil.getProtoFromPage(representation) || representation));
                    }
                        ...
                        if((listProps = syraUtil.geChooseLstPropFromProperties(winId.appendModel))) {
                            ...
                            listPropsSorted.sort();
                            for (j = 0; j < i; j++) {
                                listProps[listPropsSorted[j]] = listPropsSortedEx[listPropsSorted[j]];
                            }
                            syraUtil.appendProto(syraUtil.get$FromPage(representation), winId.appendModel, function (obj, key, value) {
    ...
    _stubSetPrevValue: function(params) {
        ...
        if (this._isValueChanged(params) || !this._isTargetSamePrevious(arguments[3])) {
            this.forceValue(params, false);
        }
        return null;
    },
	_isTargetSamePrevious:function(reply){
		if(!reply || !reply.sap || !reply.sap.previous || !reply.sap.target || !reply.sap.target.ist) return false;
		return (reply.sap.previous.win==reply.sap.target.ist.win && reply.sap.previous.xid==reply.sap.target.ist.xid && reply.sap.previous.nl==reply.sap.target.ist.nl)
	},
    ...
    _stubSapTarget_ist: function(params, replyCompleteCallback) {
        ...
        var ret = null, self = this, dispfmtErrMess = false;
        ...
        if (params.ctrlFailed && dispfmtErrMess) {
            ...
            ret = this._wndwsStack.setFocus(params.win, params.ctrlFailed ? sapUtil.focusStyle.fmtErr.code : sapUtil.focusStyle.std.code, params.xid, sapUtil.getServerIndexFromNl(params.nl), (params.edit === null || params.edit === undefined ? true : params.edit), params);
   ...
   _sapException: function(reply, diagnoses, recovery, localContext, messCallback, replyCompleteCallback){
    ...
    stackAckCall: function(call){
        return this._ackcallStack.stackRqst(call);
    },
