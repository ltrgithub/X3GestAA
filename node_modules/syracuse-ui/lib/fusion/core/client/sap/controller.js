        ...
        if (parseCtx.win2Process) {
            ...
            this._siteController.loadRepresentation(loadParams, null, 
                ...
                function (representation){
                    ...
                    var specialWin = sapUtil.isSpecialWin(winId.name), winMenusBar, i = 0, listProps, listPropsSorted, listItem;
                    if(!specialWin) {                       
                        ...
                        if((listProps = syraUtil.geChooseLstPropFromProperties(winId.appendModel))) {
                            listPropsSorted = _.sortBy(listProps, function(item, name){
                                return name;
                            });
                            for (listItem in listProps) {
                                listProps[listItem] = listPropsSorted[i++];
                            }
