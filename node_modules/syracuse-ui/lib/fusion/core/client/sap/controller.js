...
exports.Controller = helpers.defineClass(SapController, null, {
	...
	_initNewCurrIst: function(params) {
		...
		if (syra_fusion.sapUtil.isFieldInst(oldIst.xid) && oldIst.edit && (!isSameIst || (!syra_fusion.sapUtil.isGridInst(oldIst) && !params.ctrlFailed))) {
		...
		if (!isSameIst) {
			if (syra_fusion.sapUtil.isGridInst(oldIst)) {
