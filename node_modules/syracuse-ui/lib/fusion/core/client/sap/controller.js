...
exports.Controller = helpers.defineClass(SapController, null, {
    ...
    _initNewCurrIst: function(params) {
        var isSameIst, editVal, currIst, oldShow, oldFmt;
        ...
        if(!isSameIst) {
        	if(sapUtil.isGridInst(currIst)){
	            // Check grid cardview status...
	            sapUtil.checkPopupCard(currIst, params,this._wndwsStack.getBoundField(currIst.win, sapUtil.getBlockInst(currIst.xid)));
	        }
        }
        // Init new context
