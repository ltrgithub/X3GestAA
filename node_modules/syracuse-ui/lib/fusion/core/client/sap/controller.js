...
exports.Controller = helpers.defineClass(SapController, null, {
	...
	_initBlockingNodesArray: function() {
		this._blockingNodesArray = [
			{"id": "NDGTIM_selimp", "instance": "_printerAccess", "checkMethod": "isOnGoing", "release": "abort", "action": requestActions.getProxyAction("PRINTER_SEL_CANCEL"), "params": {}}
		];
	},
	...
	_stubSapMisc_help: function(params) {
		var $proto = this._wndwsStack.getTopWin().syraModel.$prototype;
		if ($proto.$links && $proto.$links.$formHelp) {
			sapUtil.goToHelp($proto.$links.$formHelp.$url, $proto, $proto.$links.$formHelp.$target, (params ? params.tokens : null));
		}
		return null;
	},
	...
	isBlockingNodePending: function() {
		...
		for (i = 0, len = this._blockingNodesArray.length; i < len; i++) {
			...
			if (this[occur.instance] && this[occur.instance][occur.checkMethod].call(this[occur.instance])) {
				actRqst = {"act": occur.action, "params": occur.params};
		...
		if(actRqst) {
			...
			actRqst.options = {"discardCtrl": true, "forceChain": true};
		}
		return actRqst;
	},
