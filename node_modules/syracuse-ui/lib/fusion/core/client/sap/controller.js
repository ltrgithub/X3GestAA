...
exports.Controller = helpers.defineClass(SapController, null, {
	...
	stubWinClose: function(params, parseCtx, func, reply) {
		...
		if (reply && reply.sap && reply.sap.target && reply.sap.target.type === 'portal' && isForceBackUrl(syra_site.lastHref)) {
			history.forceBack(window.location.href === syra_site.lastHref); // force history back to don't keep the fusion url
		}
