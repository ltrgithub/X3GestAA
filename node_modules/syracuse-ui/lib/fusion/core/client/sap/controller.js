        ...
        if(ret) {
            ...
            this._session.waitSharedRes(100, 30, function(diagnoses) {
                if(diagnoses && diagnoses.length > 0) {
                    ...
                    self.winMenus.initialize(self._session, self._session ? self._session.getWinSessMnus() : null);
    ...
    _stubWinClose: function(params, parseCtx, func) {
        ...
        _.each(params, function(winId){
            if(!this._wndwsStack.shouldDiscardCloseOpen(winId, func.open)) {
                this.winMenus.releaseWinMenu(winId);
        ...
        if (parseCtx.win2Process) {
            ...
            this._siteController.loadRepresentation(loadParams, null, 
                ...
                function (representation){
                    ...
                    if(!specialWin) {                   
                        self.winMenus.addMnuBarToProto(loadParams.id, loadParams.$facet || representation.$prototype.$x3facet, winId["mnu"], (syraUtil.getProtoFromPage(representation) || representation));
                    }
