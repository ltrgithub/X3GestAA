...
exports.Controller = helpers.defineClass(SapController, null, {
	...
	_stubWinOpen: function(params, parseCtx, func, reply) {
		...
		if (parseCtx.win2Process) {
			...
			function(error) {
				var err = util.isOurAjaxErrEx(error),
					diagnoses, diagnosis;
	...
	_stubSapTarget_selpr: function(params, replyCompleteCallback, dummy, reply) {
		var self = this,
			printerAccess = new Printer.PrinterAccess();
		...
		if (params && params.$facet == "configPrinter") {
			setTimeout(function() {
				printerAccess.initialize(params, ackSelpr, self, winId)
			}, 80);
		} else {
