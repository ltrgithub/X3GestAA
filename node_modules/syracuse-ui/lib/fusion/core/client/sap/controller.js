    ...
    _checkCurrFieldData: function(fieldData, params) {
        ...
        if(fieldData && (ist = fieldData.ist)) {
            ...
            if(ctrlResult.succeeded && !fieldData.notModified && sapUtil.isFieldInst(ist.xid)) {
                this._wndwsStack.setDataStoreValue(ist.win, ist.xid, ist.nl, ctrlResult.show !== undefined && !this.fmtWrapper.settings.localFormat ? ctrlResult.show : fieldData.v, {"noUI": true});
            }
        }
        return ctrlResult;
    },
