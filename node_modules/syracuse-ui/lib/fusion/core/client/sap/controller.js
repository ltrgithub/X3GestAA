...
exports.Controller = helpers.defineClass(SapController, null, {
    ...
    processReply: function(reply, workingCtx) {
        try {
            ...
            var ret = this._parseReply(reply, workingCtx || (workingCtx = this._initReplyParseCtx()), _sapAuto), st = true, diag;
            if(ret && !ret.ok){
        ...
        if (parseCtx.win2Process) {
            ...
            this._siteController.loadRepresentation(loadParams, null, 
                ...
                function (error){
                    ...
                    self._sapException(reply, diagnoses, {"typ": !parseCtx.pollingMode ? "RqstSrv" : "DelSess", "act": requestActions.getSrvAction("SRV_ABANDON"), "param": {"ist": null, "v": ""}}, error, null, parseCtx && parseCtx._techReply ? parseCtx._techReply.replyComplete : null);
                },
                ...
                winId.stamp.replace(/[:\/\-\s]/g, ""), parseCtx && parseCtx._techReply ? parseCtx._techReply.replyComplete : null);
    ...
    _sapRecoveryDelSess: function(reply, recovery){
        (this.getSiteController()).onSapCloseEmergency();
    },
