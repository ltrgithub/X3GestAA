...
exports.Controller = helpers.defineClass(SapController, null, {
    ...
    _stubSapTarget_ist: function(params) {
    	...
    	var ret = null, self = this, boxParams, boxOpts;
    	// Init new context
	 	...
	 	if (params.ctrlFailed) {
	    	...
	    	setTimeout(function(){syraUtil.msgBox(boxOpts);}, 10);*/
	 		...
	 		if(params.hasOwnProperty("v") && params.v !== null) {
		 		this._stubSetPrevValue(params);	// TODO : à tester!
	 		}
	 		ret = this._wndwsStack.setFocus(params.win, "std", params.xid, params.nl || 1, (params.edit === null || params.edit === undefined ? true : params.edit), params);
