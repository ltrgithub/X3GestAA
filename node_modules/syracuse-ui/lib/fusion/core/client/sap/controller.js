...
exports.Controller = helpers.defineClass(SapController, null, {
	...
	forceValue: function(params, noStoreCommmit, hardForce) {
		var data = {}, collId, istType = params.win ? sapUtil.getEntityType(params.xid, this._wndwsStack.getWindowProto(params.win)) : null;
		// Check data type (by design, forcing value is restricted, except hard force )...
		if(!hardForce && (!istType || istType == syraUtil.dataTypes.choiceType || istType == syraUtil.dataTypes.rtfType || sapUtil.isSpecialScrnId(params.xid))) {
			return null;
		}
		// Set value
