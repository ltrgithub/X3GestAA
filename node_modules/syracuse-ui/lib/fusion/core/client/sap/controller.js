...
exports.Controller = helpers.defineClass(SapController, null, {
    ...
    getRequestData: function(inst, action, params) {
        // Init
        var valueEx = null, data = {"act": action, "fld": {"ist": sapUtil.makeIst("", "", 0)}, "param": params, "tech": {}};
    ...
    _stubSapTarget_ist: function(params, replyCompleteCallback) {
        ...
        if(sapUtil.isGridInst(this._currCtx.ist)){
        	if(!sapUtil.cmpIstGrid(this._currCtx.ist,params,true)){
        		field=this._wndwsStack.getBoundField(this._currCtx.ist.win,sapUtil.getBlockInst(this._currCtx.ist.xid))
        		if(field){
        			field.unSelectLines()
        		}
        	}
        }
        isEvilInst = this._initNewCurrIst(params);
        if (isEvilInst) {
            return ret;
        }
