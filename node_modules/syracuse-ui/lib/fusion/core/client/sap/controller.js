		...
		if (parseCtx.win2Process) {
	    	...
	    	this._siteController.loadRepresentation(loadParams, null, 
		    	function (page){
			    	...
			    	// Post-statement : need to display an other tab than the default one?
			    ...
			    function (representation){
			    	...
			    	var specialWin = sapUtil.isSpecialWin(winId.name), sessMnus, staticMnus;
					if(!specialWin) {				    	
						sessMnus = self._session.getWinSessMnus();
						staticMnus = self._session.getWinStaticMnus();
				    	//TODO : hack!!
				    	...
				    	if(winId["mnu"] || sessMnus || staticMnus){
				    		_.each ([winId["mnu"] || null, sessMnus, staticMnus, 
				    			[[{"typ": 1,"act": 1115,"acl": null,"txt": "Nouveau...","rnk": "10","id": "11332","fid": "5154"}], {"typ": 0,"act": 2819,"acl": null,"txt": "Commentaires...","rnk": "10","id": "11332","fid": "5154"}]],
				    			function(mnus) {
								sapUtil.appendMnus2Syra(representation, mnus, true);
					        });
				    	}
			    	}
