    ...
    _checkCurrFieldData: function(fieldData, params) {
        ...
        if(fieldData && (ist = fieldData.ist)) {
            ...
            if(((!localCtrl && !fieldData.extra.fmt) || (localCtrl && ctrlResult.succeeded)) && !fieldData.notModified && sapUtil.isFieldInst(ist.xid)) {
                this._wndwsStack.setDataStoreValue(ist.win, ist.xid, ist.nl, localCtrl && ctrlResult.show !== undefined ? ctrlResult.show : fieldData.v, {"noUI": true});
            }
        }
        return ctrlResult;
    },
        ...
        if(this.fmtWrapper.settings.localFormat && sapUtil.isFieldInst(currIst.xid)) {
            ...
            if(!isSameIst && currIst.fmt && currIst.raw) {
                ...
                if(editVal.succeeded) {
                    this._wndwsStack.setDataStoreValue(currIst.win, currIst.xid, currIst.nl, editVal.edit, {"noStoreCommmit": true});
                }
            }
        }
        return false;
