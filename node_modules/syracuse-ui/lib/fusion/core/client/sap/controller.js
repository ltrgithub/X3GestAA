...
exports.Controller = helpers.defineClass(SapController, null, {
	...
	forceValue: function(params, noStoreCommmit) {
		...
		// Check data type (by design, forcing value is restricted)...
		if(!istType || istType == syraUtil.dataTypes.choiceType || sapUtil.isSpecialScrnId(params.xid)) {
			return null;
		}
		// Set value
