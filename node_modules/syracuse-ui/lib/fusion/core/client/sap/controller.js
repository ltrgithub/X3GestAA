	...
	_stubWinOpen: function(params, parseCtx, func, reply) {
		...
		if (parseCtx.win2Process) {
			...
			this._siteController.loadRepresentation(loadParams, null, function(page) {
				...
				// if (loadParams.name === "OITM"){
				// 	representation.$prototype.$properties["KA1"] = {
				// 		"$type": "application/x-sentiment",
				// 		"$isEditMode": false,
				// 		"$title": "Sentiment analysis",	
				// 		// "$url": "{$baseurl}/$sentiment/" + representation.openerUrlSegments.fusionParams.fullCode + "{$key}"
				// 	};
				// }
