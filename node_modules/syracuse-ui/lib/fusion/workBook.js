...
exports.WorkBook = helpers.defineClass(WorkBook, null, {
    ...
    setDataBind: function(field, $resources, record, metaData){
        if (metaData) {
            ...
            if (metaData.sty != undefined && field.applyFieldStyle) {
                field.applyFieldStyle({"$valueStyle": metaData.sty});
            }
        }
        return true;
    },
    ...
    onBlockExRpc: function(options){
        var doEvt = document.site.authorPagetrue ? false : this.fusionSite.controller.triggerAdx("wdgt.xblock.rpc", {"target": options.field, "type": "rpc", "data": options});
        if (doEvt && options.doEvent) {
    ...
    onGraphClickPicker: function(options){
        var doEvt = document.site.authorPagetrue ? true : this.fusionSite.controller.triggerAdx("wdgt.graph.picker", {"target": options.field, "type": "picker", "data": options});
        if (doEvt && options.doEvent) {
            options.doEvent();
        }
    },
    onGraphClickLink: function(options){
        var data = {"target": {"$act": options.link.linkId}};
            ...
            if(this.fusionSite && this.fusionSite.controller && this.fusionSite.controller._sapController) {
                ...
                if(!this.fusionSite.uncaughtErrorCount || this.fusionSite.uncaughtErrorCount < 3) {
                    if(this.fusionSite.uncaughtErrorCount === undefined) {
                        ...
                        this.fusionSite.uncaughtErrorObj = {"url": options.url, "ln": options.lineNumber, "err": options.error};
                    }
                ...
                if(bProcess) {
                    ...
                    this.fusionSite.controller._sapController._sapException(null, err, {"typ": "RqstSrv", "act": requestActions.getSrvAction("SRV_FIN_APPLI")});
                }
                else {
