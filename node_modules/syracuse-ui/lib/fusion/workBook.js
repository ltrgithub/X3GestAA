...
exports.WorkBook = helpers.defineClass(WorkBook, null, {
    ...
    onFieldEvent: function(options, redirect){
        ...
        if (!document.site.authorPage) {
            ...
            //Hack for cardview popup waitting fix in field.js (arrayLevel=cell on field cardview)
        ...
        if (options && options.field) {
            switch (options.field.arrayLevel) {
                case "array":
                    ...
                    break;
                case "record":
                    list = options.field.getArticleParent();
                    break;
                case "cell":
                    list = options.field.getArticle().getArticleParent();
                    break;
            }
        }
        ...
        try {
            if (this.fusionSite && this.fusionSite.controller && this.fusionSite.controller._sapController) {
                ...
                if (bProcess) {
                    ...
                    this.fusionSite.controller._sapController._sapException(null, err, {"typ": "DelSess"});
                }
                else {
