...
exports.WorkBook = helpers.defineClass(WorkBook, null, {
    ...
    setDataBind: function(field, $resources, record, metaData){
        if (metaData) {
            ...
            // FDB - .dch=null -> restaure initial values - .dch=[] -> exclude values
    ...
    setPickerValue: function(options){
        ...
        if (this.fusionSite.controller) {
            doEvt = this.fusionSite.controller.triggerAdx("wdgt.field.calendarclosed", {
    ...
    onMenuItemClick: function(options){
        var doEvt = true;
        if (this.fusionSite.controller) {
            doEvt = this.fusionSite.controller.triggerAdx("wdgt.link.click", {
    ...
    onFieldEvent: function(options){
        var doEvt = true;
        this.fusionSite._session.logger.trace({}, "**onFieldEvent : [" + options.event.type + "] on field [" + (syraUtil.getMetaFromObject(options.field)).$bind + "]");
        switch (options.event.type) {
            case "click":
				doEvt=this.fusionSite.controller.triggerAdx("wdgt."+(options.field && options.field.arrayLevel?options.field.arrayLevel:"field")+"." + options.event.type, {
            ...
            case "keydown":
            case "change":
                doEvt = this.fusionSite.controller.triggerAdx("wdgt.field." + options.event.type, {
    ...
    onSelectRecordEvent: function(options){
        ...
        if (list && this.fusionSite.controller && (listMeta = syraUtil.getMetaFromObject(options.field))) {
            ...
            if (isNaN(options.uuidTarget)) 
                return;
            this.fusionSite.controller.triggerAdx("wdgt.list.selline", {
                "target": list,
                "type": "selline",
                "data": {
    ...
    onFieldClickPicker: function(options){
        var doEvt = this.fusionSite.controller.triggerAdx("wdgt.field.picker", {
            "target": options.field,
            "type": "picker",
            "data": options
        });
    ...
    dispose: function(){
        ...
        delete this._lastSelectedSheet;
