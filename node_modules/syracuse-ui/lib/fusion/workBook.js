...
exports.WorkBook = helpers.defineClass(WorkBook, null, {
    ...
    setPickerValue: function(options){
        ...
        if (this.fusionSite.controller) {
            doEvt = this.fusionSite.controller.triggerAdx("wdgt.field.calendarclosed", {"target": options.target, "data": options});
        }
    ...
    _loadDialog: function($itemPage, $facet, opts){
        ...
        options.onClose = function(validated, dispose) {
            if(!dispose) {
                ...
                self.fusionSite.controller.triggerAdx("wdgt.win.close", {"target": dialog, "type": "close"});
    ...
    onFieldClickPicker: function(options){
        var doEvt = this.fusionSite.controller.triggerAdx("wdgt.field.picker", {"target": options.field, "type": "picker", "data": options});
        if (doEvt && options.doEvent) {
            options.doEvent();
        }       
    },
