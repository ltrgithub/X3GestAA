...
exports.WorkBook = helpers.defineClass(WorkBook, null, {
    ...
    onFieldEvent: function(options) {
         ...
         */
        //console.log("**onFieldEvent : [" + options.event.type + "] on field [" + options.field.$item.$bind + "]");
    ...
    onSelectRecordEvent: function(options) {
        ...
        if (list && this.fusionSite.controller && !this.fusionSite.controller.isFixtureMode()) {
            /* options{
             field: self,
             list: self,
            ...
            var clicIdx = parseInt(options.uuidTarget, 10);
            doEvt = this.fusionSite.controller.trigger("wdgt.list.selline", {
                "target": list,
                "type": "selline",
                "data": {
