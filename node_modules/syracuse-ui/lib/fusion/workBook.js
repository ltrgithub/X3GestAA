    ...
    onFieldClickPicker: function(options){
    	...
    	if(options && options.field){
    		switch (options.field.arrayLevel) {
    			case "array"  : list=options.field;break;
    			case "record" : list=options.field.getArticleParent();break;
    			case "cell"   : list=options.field.getArticle().getArticleParent();break;
    		}
    	}
