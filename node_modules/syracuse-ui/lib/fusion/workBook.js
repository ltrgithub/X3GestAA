...
exports.WorkBook = helpers.defineClass(WorkBook, null, {
	...
	_loadDialog: function($itemPage, $facet, opts) {
		...
		$itemPage.boxParent = null;
		dialog = document.site.dialogManager.openBoxDialog(this, options);
	...
	_disposeSheet: function(sheet) {
		...
		if (sheet && !sheet.disposed) {
			...
			if (this._dialogs && (diag = this.findDialog(sheet))) {
				document.site.dialogManager.closeBoxDialog(this, diag);
			}
	...
	dispose: function() {
		document.site.dialogManager.closeBoxDialogs(this, true);
		if (this.fusionSite) {
		...
		if (this.fusionGateway && this.fusionGateway.activatedBook == this) {
			delete this.fusionGateway.activatedBook;
		}
