...
exports.WorkBook = helpers.defineClass(WorkBook, null, {
    ...
    _loadDialog: function($itemPage, $facet, opts){
        ...
        options.onClose = function() {
            ...
            setTimeout(function () {
                self.fusionSite.controller.postSapRqst(requestActions.getSrvAction("SRV_ABANDON"));
            }, 0);
    ...
    onFieldClickPicker: function(options){
        var doEvt = this.fusionSite.controller.trigger("wdgt.field.click", {"target": options.field, "type": "click", "data": options});
        if (doEvt) {
            options.doEvent();
        }       
    },
    ...
    dispose: function(){
        box.prototype._closeChildrenDialogs.call(this);
        var self = this;
        if (self.fusionSite) {
