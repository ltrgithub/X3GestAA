...
exports.WorkBook = helpers.defineClass(WorkBook, null, {
    ...
    applyDesignMetaExt: function(field, $field, $item){
        ...
        if ($field.$fieldStyle && (controller = syraUtil.getFusionController(field))) {
            style = {
                "sty": $field.$fieldStyle
            };
            if (sapUtil.cureStyle(style, $item.$bind, controller.getSession())) {
                field.applyFieldStyle({
                    $fieldStyle: style.sty
                });
            }
        }
        return true;
    ...
    onUncaughtError: function(options){
        ...
        try {
            if(this.fusionSite && this.fusionSite.controller && this.fusionSite.controller._sapController) {
                if(!this.fusionSite.uncaughtErrorCount || this.fusionSite.uncaughtErrorCount < 2) {
                    ...
                    this.fusionSite.uncaughtErrorCount = this.fusionSite.uncaughtErrorCount ? 1 : this.fusionSite.uncaughtErrorCount++;
