    ...
    onFieldEvent: function(options){
        ...
        switch (options.event.type) {
            ...
            case "keydown":
                ...
                break;
            case "change":
				listner="wdgt." + (options.field && options.field.arrayLevel && !sapUtil.isListScreen(syraUtil.getMetaFromObject(options.field).$bind) && syraUtil.getFieldType(options.field) == syraUtil.dataTypes.booleanType && this.fusionSite.controller._sapController.getCurrInst().edit? options.field.arrayLevel  : "field") + "." + options.event.type
               	this.fusionSite._session.logger.trace({}," -----> Listner : [" + listner + "] field type : ["+syraUtil.getFieldType(options.field)+"] Edit :["+this.fusionSite.controller._sapController.getCurrInst().edit+"]");
			    doEvt = this.fusionSite.controller.triggerAdx(listner, {
                    "target": options.field,
                    "type": options.event.type,
