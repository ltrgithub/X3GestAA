...
var _formatApi = {
    "x-integer": {
        ...
        "numberValue": function(val) {
            return integer.numberValue(val);
        },
        "subtract": function(n1, n2) {
            return integer.subtract(n1, n2);
        },
        "add": function(n1, n2) {
            return integer.add(n1, n2);
        }
    },
    "x-decimal": {
        "format": function(value, format) {
        ...
        "parse": function(str, format) {
            var strEx = null, re, ds = this.regionalOptions.decimalSeparator, gs = this.regionalOptions.groupSeparator;
            ...
            return {"value": parseFloat(strEx || str), "str": str, "toString": function () {return this.str;}};
        },
        "numberValue": function(value) {
            var str = value.toString(), re, ds = this.regionalOptions.decimalSeparator;
            if (ds != "." && str.indexOf(".") >= 0){
                re = new RegExp("\\.", "g");
    ...
    "x-datetime": {
        ...
        "parse": function(value, format) {
            return {"value": value, "toString": function () {return this.value;}};
        },
        "formatInput": function(field, value) {
            return value;
        }
