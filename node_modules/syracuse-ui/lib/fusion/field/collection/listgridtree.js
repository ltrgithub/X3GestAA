...
var _CLOSE = "close";
var jQuery = $;
function LGridTree(type) {
    var type = type || "standard";
    util.log("LGridTree - Type[" + type + "]");
    this._type = {
        std: type == "standard",
        rec: type == "recursive",
        pick: type == "picking",
...
exports.LGridTree = helpers.defineClass(LGridTree, Article, {
    /* FRAMEWORK METHODS*/
