...
exports.GridRecord = helpers.defineClass(GridRecord, Article, {
    ...
    _isLineClicked: function(ev){
        return (($(ev.target).data("s-record") != undefined) || $(ev.target).hasClass(this.boxParent.builder._css.noline) || $(ev.target).parents("." + this.boxParent._css.nolineFusion).length !== 0);
    },
