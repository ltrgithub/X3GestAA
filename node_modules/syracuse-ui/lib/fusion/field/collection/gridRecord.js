...
exports.GridRecord = helpers.defineClass(GridRecord, Article, {
    ...
    getOnClickParams: function(ev){
        ...
        if (lineClicked) {
            ...
            var css = this.boxParent.builder._css.cellFusion, isCheck=false,isIcon=false,readOnly=false,disabled=false,xid;
			...
			isIcon=(field.$field.$type == syraUtil.dataTypes.iconType);
