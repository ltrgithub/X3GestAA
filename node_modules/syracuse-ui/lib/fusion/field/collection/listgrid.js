...
var MyFusionGridRec = helpers.defineClass(GridRec, FGridRec, {
...
exports.FBFusionDesktopList = helpers.defineClass(FBFusionDesktopList, FusionDesktopList, {
    createBuilder: function(){
        ...
        this.RecordClass = MyFusionGridRec;
...
exports.FBSyraDesktopList = helpers.defineClass(FBSyraDesktopList, DesktopList, {
    ...
    createBuilder: function(){
        ...
        this.builder = new FBSyraBuilder();
    ...
    clickSelectRecords: function(records){
        util.log("LeftList - clickSelectRecords",records);
        var doEvt = true, self = this;
        var isMulti = self.recordSelector.$selectMode == "multi";
        var clicIdx = parseInt(this.selectedUiid , 10);
        if (!isMulti) {
            jQuery.each(records, function(i, r){
                r.sel = false;
            });
        }
        DesktopList.prototype.clickSelectRecords.call(this, records);
        self.getPage().externalAdapter.onListSelectLine({
            list: self,
            line: clicIdx + 1,
            forceDoEvt: sapUtil.fixtureMode(self),
    ...
    doMeta: function(metaData){
        ...
        if (stts) {
            ...
            jQuery.each(stts, function(i, stt){
                if (stt.length > 2) {
                    var x3Idx = stt[1], gui = sapUtil.Fusion.getState(stt[2]);
                    util.log("doMeta - x3Idx[" + x3Idx + "] - Select[" + gui.$isSelected + "]");
...
function FBSyraBuilder(){
    util.log("FBSyraBuilder");
}
helpers.defineClass(FBSyraBuilder, DesktopHgridBuilder, {  
});
