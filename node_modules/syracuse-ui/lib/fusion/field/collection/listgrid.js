...
exports.FBFusionDesktopList = helpers.defineClass(FBFusionDesktopList, FGrid, {
    _initializeBox: function() {
        if (!this.$item.$X3) this.$item.$X3 = {};
        this.$item.$X3.$hideLineNumber = true;
        FGrid.prototype._initializeBox.call(this);
    },
    createBuilder: function() {
        this.builder = new LGGridBuilder();
        this.builder.list = this;
        this.builder.initialize(MyGridRec);
    },
    ...
    setDataBind: function($resources, record, metaData) {
        if ($resources) {
            FGrid.prototype.setDataBind.call(this, $resources, record, null);
        }
...
var LGGridBuilder = helpers.defineClass(GridBuilder, FBuilder, {
    ...
    removeRows: function() {
        if (this.rowsOrder && this.rowsOrder.length > 0) FBuilder.prototype.removeRows.call(this);
    },
...
exports.FBSyraDesktopList = helpers.defineClass(FBSyraDesktopList, DesktopList, {
    ...
    _selectRecords: function(records, selId) {
        ...
        if (!isMulti) {
			jQuery.each(records,function(i,r){r.sel=false;});
        }
...
helpers.defineClass(GridSyra, SBuilder, {
    drawBuilder: function() {
