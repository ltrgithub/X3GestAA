...
var DesktopList = require("syracuse-ui/lib/field/collection/list").DesktopList;
...
exports.ListGrid = helpers.defineClass(ListGrid, DesktopList, {
            ...
            jQuery.each(stts, function(i, stt){
                if (stt.length > 2) {
                    ...
                    if (gui.$isSelected != null) {
                        self.recordSelector.select(syraId, gui.$isSelected)
                        if (gui.$isSelected) {
            ...
            if (sapUtil.fixtureMode(this)) {
                ...
                if (!this._isMulti()) {
                    ...
                    if (this._mySelSyraId != null && selLine != this._mySelSyraId && this.dataset[this._mySelSyraId]) {
                        this.recordSelector.select(this._mySelSyraId, false);
                    }
    ...
    getQuickSelValues: function(){
        // return this.builder.table.quickFilterRecord.fusionGetInputValues();
    },
    getIst: function(nl){
