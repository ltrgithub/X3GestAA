...
exports.Grid = helpers.defineClass(Grid, DesktopList, {
    ...
    resize: function(height){
        height = height - (this.builder._$$bodySlot.offset().top - this.$$item.offset().top) -17;
        this.applyDesignMetaData({
            $fixedHeight: height
        });
    },
    drawBox: function(){
    ...
    getIst: function(nl){
        return sapUtil.Fusion.makeIst(this.getPage().$fusionPageMeta.winModel.getWinId(), this.getXid(), nl === true && this._mySelSyraId != null ? parseInt(this._mySelSyraId, 10) : null);
    },
    getDataSet: function(){
