...
exports.Grid = helpers.defineClass(Grid, DesktopList, {
    ...
    applyMetaData: function(metaData){
        ...
        if (stts) {
            ...
            jQuery.each(stts, function(i, stt){
                if (stt.length > 2) {
                    var syraId = parseInt(stt[1], 10) - 1, gui = sapUtil.getState(stt[2]);
    ...
    getIst: function(nl){
        return sapUtil.makeIst(this.getPage().$fusionPageMeta.winModel.getWinId(), this.$item.$bind, nl === true && this._mySelSyraId != null ? parseInt(this._mySelSyraId, 10) : null);
    },
	getDataSet:function(){
		return [];
	}
