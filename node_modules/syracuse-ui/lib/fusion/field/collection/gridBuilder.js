...
var ListBuilder = require("syracuse-ui/lib/desktop/field/collection/builder/listBuilder").ListBuilder;
...
exports.Builder = helpers.defineClass(GridBuilder, ListBuilder, {
    initialize: function(){
    ...
    sort: function(){
        ...
        this.sortCriter.forEach(function(crit){
            crit.t = self.list.$field.$item.$properties[crit.p].$type;
        })
    ...
    onRedrawCore: function(){
        ...
        /*if (this.table.quickFilterRecord) {
         this.table.quickFilterRecord.drawBox();
         }*/
    },
    ...
    appendRecord: function(options){
        ...
        return ListBuilder.prototype.appendRecord.call(this, options)
    },
    dispose: function(){
        if (this._$$hscroller) {
