var _fieldTypes = {
    ...
    "application/x-collection$xflgrid": require("./collection/listgrid").ListGrid,
    ...
    "application/x-date": require('syracuse-ui/lib/desktop/field/datetimeField').DesktopDateTime,
    "application/x-integer": require('syracuse-ui/lib/desktop/field/numericField').DesktopNumeric
