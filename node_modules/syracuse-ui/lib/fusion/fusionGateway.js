...
exports.FusionGateway = helpers.defineClass(FusionGateway, null, {
    ...
    detatchAllBooks: function(notifyHoster, timeout, force) {
        ...
        function walkDetach(diagnosis, hardDetach) {
            ...
            if(diagnosis.severity == svrtSuccess) {
                if (curr == max) {
                    ...
                    tabClt[curr++].cltRef.fusionSite.disconnect(walkDetach, timeout, forceEx);
                }
            }
            else {
                currErr = curr - 1;
                if (notifyHoster(diagnosis, currErr, tabClt[currErr].cltRef)) {
                    curr = currErr;
