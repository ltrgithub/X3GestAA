...
exports.FusionGateway = helpers.defineClass(FusionGateway, null, {
    ...
    openBook: function(httpQuery){
        ...
        book.fusionSite.connect(httpQuery, function(metaData, navigate){
            if (metaData) {
    ...
    showSiteFusionHeader: function(show){
        ...
        if (site.fusionHeader) {
            site.fusionHeader.style.display = show ? "" : "none";
        }
        if (site.headerTopRight) {
            site.headerTopRight.style.display = show ? "none" : "";
        }
    },
