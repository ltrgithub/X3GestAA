...
exports.SheetPage = helpers.defineClass(SheetPage, DesktopPage, {
	...
	ensureSiteFusionHeader: function() {
		...
		if (!site.fusionHeaderHomeLink) {
			...
			site.fusionHeaderFunctionLink.setMenu({
				$title: syra_site.localize.fusionHeaderFunctionLink
			});
			site.fusionHeaderHomeLink = syra_site.loadNewItem(site.headerTop, {
				$bind: "$home",
				$category: "link",
				$noText: true,
				$skin: "s-site-fusion-home"
			});
			site.fusionHeaderHomeLink.setMenu({
				$title: syra_site.localize.userProfile_siteTabLink
			});
			site.fusionHeaderHomeLink.$target = "blank";
