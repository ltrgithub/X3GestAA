...
exports.SheetPage = helpers.defineClass(SheetPage, DesktopPage, {
	...
	applyShortCuts: function(shortcurts, focusField) {
		...
		if (shortcurts.esc) {
			...
			if (shortcurts.f9) {
				if (this.focusField && this.focusField.tunnelPicker) {
					this.focusField.tunnelPicker.click();
				}
				return true;
			}
			if (shortcurts.n) {
		...
		return DesktopPage.prototype.applyShortCuts.call(this, shortcurts, focusField);
	},
	dispose: function() {
