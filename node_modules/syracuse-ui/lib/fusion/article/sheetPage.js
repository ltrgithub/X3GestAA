...
exports.SheetPage = helpers.defineClass(SheetPage, DesktopPage, {
    ...
    ensureSiteFusionHeader: function(){
        ...
        if (!site.fusionHeader) {
            site.fusionHeader = document.createElement("div");
            site.fusionHeader.id = "s-site-header-top-right-fusion";
            site.fusionHeader.style.display = "none";
            site.headerTop.appendChild(site.fusionHeader);
            
            var div = document.createElement("div");
            div.setAttribute("id", "s-site-func");
            var cvgAct = requestActions.getSrvAction("SRV_ADXEXECUTE");
            document.site.loadNewItem(site.fusionHeader.appendChild(div), {
                $bind: cvgAct,
                $category: "link",
                $noText: true,
            ...
            div.appendChild(site.fusionHeaderHomeLink);
            site.fusionHeader.appendChild(div);
        }
    },
    ...
    getFieldScope: function(fiedId, isCell){
        var scope = {};
        if (isCell) {
