...
exports.SheetPage = helpers.defineClass(SheetPage, DesktopPage, {
	...
	ensureSiteFusionHeader: function() {
		...
		if (!site.fusionHeaderHomeLink) {
			...
			site.fusionHeaderFunctionLink = syra_site.loadNewItem(site.headerTop, {
				$bind: cvgAct,
				$category: "link",
				$noText: true,
			...
			site.fusionHeaderFunctionLink.domItem.title = syra_site.localize.fusionHeaderFunctionLink;
			...
			site.fusionHeaderHomeLink.title = syra_site.localize.userProfile_siteTabLink;
