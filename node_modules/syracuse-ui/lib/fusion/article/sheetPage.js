	...
	ensureSiteFusionHeader: function() {
		...
		if (!site.fusionHeaderHomeLink) {
			...
			site.fusionHeaderFunctionLink = syra_site.loadNewItem(site.headerTop, {
				...
				$category: "link",
				$noText: true,
				$title: syra_site.fusionGateway.getMessage(null, "siteLinkFunc"),
				$skin: "s-site-func-link",
				$act: cvgAct
			});
			site.fusionHeaderFunctionLink.domItem.style.display = "none";
			site.fusionHeaderFunctionLink.domItem.title = syra_local.fusionHeaderFunctionLink;
			...
			site.fusionHeaderHomeLink.title = syra_local.userProfile_siteTabLink;
