...
exports.FusionBar = helpers.defineClass(FusionBar, BarSplitter, {
    ...
    _onResizeBody: function(){
        if (this.openedBlock) {
            ...
            this.openedBlock.domItem.style.height = blockHeight + "px";
            this.openedBlock.body.style.height = (this.openedBlock.$$item.height() - document.site.getBoundingClientRect(block.header).height) + "px";
