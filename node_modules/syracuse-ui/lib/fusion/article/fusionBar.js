...
exports.FusionBar = helpers.defineClass(FusionBar, SideBar, {
	...
	createBlock: function($item, index, count) {
		...
		block.header = syra_dom.header("s-fusion-block-header", block.domItem);
		...
		block.body = syra_dom.div("s-fusion-block-body", block.domItem);
	...
	resizeSplitter: function(newWidth) {
		SideBar.prototype.resizeSplitter.call(this, newWidth);
		!newWidth && this.resizeBar();
	},
	resizeBar: function(resize) {
		if (this.openedBlock && syra_dom.isVisible(this.slot)) {
			if (resize || this.lastHeight != this.slot.clientHeight) {
				this.lastHeight = this.slot.clientHeight;
				var blockHeight = 0;
				...
				this.openedBlock.body.style.height = (this.openedBlock.domItem.clientHeight - this.openedBlock.header.clientHeight) + "px";
			}
		}
	},
