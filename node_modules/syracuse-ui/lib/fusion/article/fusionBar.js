			...
			if (this.openedBlock) {
				...
				for (var ii = 0, jj = this.blocks.length; ii < jj; ii++) {
					...
					if (block != this.openedBlock) {
						blockHeight += block.domItem.getBoundingClientRect().height;
					}
				}
				...
				this.openedBlock.body.style.height = (inner.height - this.openedBlock.header.getBoundingClientRect().height) + "px";
