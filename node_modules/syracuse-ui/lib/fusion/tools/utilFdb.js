...
exports.log = function() {
	if (window.console) {
		...
		if (window.console.log.apply) window.console.log.apply(window.console, args);
...
exports.logEx = function(options) {
	var console = window.console,
		res = [],
		args, chanel = console ? console.log : null,
		toJson;
	if (console) {
...
function _getLogId() {
	var date = new Date(),
		ts = date.toLocaleTimeString() + ":" + date.getMilliseconds();
	return "(" + (this._logId || "") + " at " + ts + ") ";
}
...
exports.createHandler = function() {
	...
	var handler = function cllbck() {
		...
		if (func) return func.apply(thisObject, nargs);
		else return false;
	};
	return handler;
};
