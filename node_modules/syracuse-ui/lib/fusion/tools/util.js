...
exports.diagnosesToOurErr = function (diagnoses){
    ...
    _.each(diag, function(err, idx){
        this.li[idx] = (err.message || "") + " [" + (err.appCode || err.sdataCode || "") + "] : \n" + (err.stackTrace || "");
        if(err.severity) {
...
exports.duplicateObj = function (input){
    ...
    _.each(input, function(value, key){
    	if(!Array.isArray(value) && !_.isObject(value)) {
        	...
        	this[key] = exports.duplicateObj(value);
        }
    }, output);
    return output;
};
...
exports.getDiagnosesFromAjax = function (errAjax){
