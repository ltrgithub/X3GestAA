...
exports.Grid = helpers.defineClass(Grid, List, {
    _initializeBox: function(RecordClass){
        ...
        (this.builder = new GridBuilder()).initialize(this, RecordClass);
        List.prototype._initializeBox.call(this);
    ...
    _makeSkinField: function(suffix, addCss){
        var css = List.prototype._makeSkinField.call(this, suffix, addCss);
