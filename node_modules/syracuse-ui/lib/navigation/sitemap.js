...
exports.page = {
	draw: function(page) {
		...
		syra_over.openModal(syra_site, {
			...
			resize: function(dlg) {
				if (this.page.isMapLoaded) {
					var height = syra_site.$device == "tablet" ? (syra_site.size.body.height - 60) : syra_site.size.body.height;
					...
					this.page.detailList.scrollview.style.width = maxContentWidth + 3 + "px"; //Add 3 to hide the auto scrollbars
		...
		page.overPanel.overSlot.setAttribute("data-s-dialog", "sitemap");
	},
