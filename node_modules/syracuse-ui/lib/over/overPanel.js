...
Panel.prototype.addResizer = function() {
	this.resizer = new Resizer({
		...
		start: function(resizing) {
			resizing.slot = syra_dom.getBoundingClientRect(this.slot);
			this.panel.$width = resizing.slot.width;
			this.panel.$height = resizing.slot.height;
		},
		drag: function(resizing) {
			if (resizing.deltaX != undefined) {
				this.panel.$width = resizing.slot.width + resizing.deltaX;
			}
			if (resizing.deltaY != undefined) {
				this.panel.$height = resizing.slot.height + resizing.deltaY;
			}
			this.panel.resizePage(false);
