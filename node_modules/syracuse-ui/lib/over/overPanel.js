				...
				if (this.options.$center) {
					...
					if (this.options.position) {
						...
						if (this.options.onresize) {
							var maxHeight = syra_site.footer ? (syra_site.footer.getBoundingClientRect().top - slot.getBoundingClientRect().top) : syra_site.size.popupMaxHeight;
							slot.style.maxHeight = maxHeight + "px";
							this.options.onresize(this, maxHeight);
						}
					} else {
