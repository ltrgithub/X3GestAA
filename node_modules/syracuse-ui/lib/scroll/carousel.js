...
Carousel.prototype.adjustContainerHeight = function(container) {
	var carouselBtnHeight = this.up.link.clientHeight;
	var carouselScrollHeight = syra_site.size.popupMaxHeight - carouselBtnHeight * 2;

	!this.increment && this.setIncrement();

	carouselScrollHeight = Math.floor(carouselScrollHeight / this.increment) * this.increment + carouselBtnHeight * 2;
	container.style.height = container.style.maxHeight = carouselScrollHeight + "px";
};
