...
function Theme(userProfile, slot) {
	...
	syra_dom.span("s-profile-field-title", this.btn).textContent = syra_local.userProfile_theme;
	this.titleItem = syra_dom.span("s-profile-field-value", this.btn);
	syra_dom.addFontIcon("s-profile-field-edit-picker", syra_icon.font.right_arrow, this.btn);
