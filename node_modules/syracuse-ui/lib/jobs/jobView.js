...
exports.JobView = helpers.defineClass(JobView, null, {
    ...
    appendDiagnoses: function($diagnoses){
        ...
        if ($diagnoses) {
            for (var ii = 0; ii < $diagnoses.length; ii++) {
                ...
                label.innerHTML = document.site.formatHTMLMessage($diagnoses[ii].message + self._appendReportUrl());
                self._diag.appendChild(label);
            }
        }
    },
    _appendReportUrl: function(){
        if (this.finalUrl) {
            var link = document.createElement("a");
            a.className = "s-job-view-result-report";
            a.textContent = "report";
            a.setAttribute("href", this.finalUrl);
    ...
    _onEnd: function(onError){
        ...
        self._resBtn.className = onError ? "s-job-view-cancel-disabled" : "s-job-view-success-disabled";
