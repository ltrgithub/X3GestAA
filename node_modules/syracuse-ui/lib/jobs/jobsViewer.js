...
exports.JobsViewer = helpers.defineClass(JobsViewer, null, {
    create: function(){
        ...
        /*
         ...
         toggle.className = "s-jobs-viewer-opened";
         var div = document.createElement("div");
         div.className = "s-jobs-viewer-switch";
    ...
    _removeJobView: function(jobView){
        var self = this;
        jobView.$$item.remove();
        var jobsCount = self.$$core.find("div.s-job-view-item").length;
        if (jobsCount == 0) {
            self._item.style.display = "none";
            //document.site._jobsViewerOpener.style.visibility = "hidden";
    ...
    toggle: function(show, event){
        switch (show) {
            case true:
                ...
                //document.site._jobsViewerOpener.style.visibility = "visible";
