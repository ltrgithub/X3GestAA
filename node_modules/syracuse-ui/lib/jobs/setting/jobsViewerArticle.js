				...
				$layout: {
					$items: [{
						...
						$layout: {
							$layoutType: "row",
							"$isFixedWidth": true,
							"$widths": "50,90,90,50,15",
							$css: $skin + "-card",
							$items: [{
								$layoutType: "stack",
								$css: "s-job-view-types-icons",
								$skin: "s-job-view-types-icons",
								$items: [{
									$bind: "$jobPrintIcon",
									$isTitleHidden: true,
									$category: "link",
