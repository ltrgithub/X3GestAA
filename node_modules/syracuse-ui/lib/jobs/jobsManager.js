...
helpers.defineClass(Job, null, {
	...
	onRequestError: function(error, ignoreOpComplete) {
		...
		syra_diagnose.closeBox("no", _page.msgBoxId)!ignoreOpComplete && this.fusionContext && this.fusionContext.release();
	},
