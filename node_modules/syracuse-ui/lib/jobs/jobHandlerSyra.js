...
exports.JobHandlerSyra = helpers.defineClass(JobHandlerSyra, JobHandler, {
	register: function(params) {
		...
		// store syra job (operation) params in order to retrieve them in case of page refresh
		/*
         if (sessionStorage) {
         var trackersList = sessionStorage.getItem("trackersList") !== "" ? JSON.parse(sessionStorage.getItem("trackersList")) || {} : {};
         trackersList[params.uuid] = params;
         sessionStorage.setItem("trackersList", JSON.stringify(trackersList));
         }*/
	...
	onSuccess: function(data, response, $url, cbck) {
		...
		switch (response.status) {
			...
			case 204:
             ...
             if (sessionStorage) {
             var trackersList = sessionStorage.getItem("trackersList") !== "" ? JSON.parse(sessionStorage.getItem("trackersList")) || {} : {};
             delete trackersList[self.params.uuid];
             sessionStorage.setItem("trackersList", JSON.stringify(trackersList));
             }*/
			default:
