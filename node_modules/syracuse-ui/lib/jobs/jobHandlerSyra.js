...
exports.JobHandlerSyra = helpers.defineClass(JobHandlerSyra, JobHandler, {
	register: function(params) {
		if (params) {
			...
			if (this.params) {
				this.sendRequest(this.buildReqOpt("GET", params.$location));
			}
		}
	},
	...
	onSuccess: function(data, response, $url, cbck) {
		...
		if (response.status != 204 && record != undefined) {
			...
			var scrollTop = syra_site.jobsPage.boundFields.$jobDetails[0].domValueSlot.scrollTop;
			...
			syra_site.jobsPage.boundFields.$jobDetails[0].domValueSlot.scrollTop = scrollTop;
		}
