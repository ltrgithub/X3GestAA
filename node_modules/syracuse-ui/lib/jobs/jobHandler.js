...
exports.JobHandler = helpers.defineClass(JobHandler, null, {
	...
	_applyAlertStyle: function() {
		var self = this;
		var isRecordVisible = (self.jobsViewer && self.jobsViewer.$$item && !self.jobsViewer.$$item.is(":visible")) || !document.site.isScrolledIntoView(self.jobsViewer.getRecord(self.params.uuid).$$item, self.jobsViewer.$$item);
		if (isRecordVisible) {
