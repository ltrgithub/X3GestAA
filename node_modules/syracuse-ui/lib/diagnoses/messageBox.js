...
function _onMessageClick() {
	...
	syra_menus.updateButtonIcon(this.link, this.isOpened ? syra_local.msgbox_diagnose_hide_detail : syra_local.msgbox_diagnose_show_detail, this.isOpened ? "collapse" : "expand");
		...
		if (!this._core) {
			...
			this._bodyBtn = syra_menus.button.add({
				...
				btnclick: function() {
					...
					this.isOpened = this.isOpened;
					syra_menus.updateButtonIcon(this.link, this.isOpened ? syra_local.msgbox_body_picker_opened : syra_local.msgbox_body_picker_closed, this.isOpened ? "collapse_row" : "expand_row");
					syra_menus.button.display(msgBox._selectBtn, this.isOpened);
					msgBox.resizeArticle();
				}
			});
