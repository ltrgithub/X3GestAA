...
exports.MessageBox = helpers.defineClass(MessageBox, RawPage, {
	...
	preformat: function(txt) {
		return "<pre class='s-msgbox-pre'>" + syra_site.formatHTMLText(txt, true) + "</pre>";
	},
	...
	_appendDiagnoses: function($diagnoses) {
		...
		for (var ii = 0, jj = $diagnoses.length; ii < jj; ii++) {
			...
			message.label.innerHTML = syra_site.formatHTMLText($diagnose.message || $diagnose.$message || this.localize.msgbox_diagnose_default_msg, true);
