        ...
        if (shortcurts.tab) {
            if (self.$itemButtons.length > 1) {
                ...
                if (ii < len) {
                    ...
                    document.site.dom.toggleClass(self.getMenuItem(self._focusBtnId).mn, "s-msgbox-button-default", false);
                    self._focusBtnId = self.$itemButtons[ii].$bind;
                    document.site.dom.toggleClass(self.getMenuItem(self._focusBtnId).mn, "s-msgbox-button-default", true);
                    setTimeout(function(){
