...
function _onMessageClick() {
	...
	syra_menus.button.setText(this, this.isOpened ? syra_local.msgbox_diagnose_hide_detail : syra_local.msgbox_diagnose_show_detail, this.isOpened ? "collapse_l" : "expand_l");
		...
		if (!this._core) {
			...
			this._bodyBtn = syra_menus.button.add({
				...
				btnclick: function() {
					...
					this.isOpened = this.isOpened;
					syra_menus.button.setText(this, this.isOpened ? syra_local.msgbox_body_picker_opened : syra_local.msgbox_body_picker_closed, this.isOpened ? "collapse_s" : "expand_s");
