...
exports.DiagnosesPanel = helpers.defineClass(DiagnosesPanel, null, {
    ...
    _applySuccessStyle: function(){
        ...
        if (listArray[0]) {
            this._applyStyleToArray(listArray, "s-diagnose-links-link-slot-success");
        }
        else 
            if (listArrayMain[0]) {
                this._applyStyleToArray(listArrayMain, "s-diagnose-links-link-slot-success");
            }
        
        if (anchorArray[0]) {
            this._applyStyleToArray(anchorArray, "s-diagnose-links-link-success");
        }
        else 
            if (anchorArrayMain[0]) {
                this._applyStyleToArray(anchorArray, "s-diagnose-links-main-link-success");
            }
        this.page.onWindowResize();
    },
