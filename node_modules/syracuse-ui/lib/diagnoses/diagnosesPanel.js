...
exports.DiagnosesPanel = helpers.defineClass(DiagnosesPanel, null, {
	...
	drawFieldDiagnose: function(field, $diagnose, group) {
		if (!field.isDiagnoseDisabled) {
			...
			if (field.boxParent) {
				if (!field.boxParent._diagnosesFields) {
					field.boxParent._diagnosesFields = {};
				}
				var fieldSeverities = field.boxParent._diagnosesFields[field.id];
				if (!fieldSeverities) {
					fieldSeverities = field.boxParent._diagnosesFields[field.id] = {};
				}
