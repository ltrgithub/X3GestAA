...
exports.DiagnosesPanel = helpers.defineClass(DiagnosesPanel, null, {
    ...
    _appendGridCardRecordDiagnose: function(group, $diagnose, options){
        var link = document.createElement("a");
        link.className = "s-diagnose-msg-link";
        link.setAttribute("data-s-article", options.gridCardData.gridArticleId);
        link.setAttribute("data-s-diag-field", options.gridCardData.gridRecordId);
        link.textContent = options.gridCardData.linkText || "Error in grid card";
            ...
            if (message.$diagnoses && message.$diagnoses.length > 0) {
                ...
                for (var ii = 0, jj = message.$diagnoses.length; ii < jj; ii++) {
                    ...
                    if (message.field) {
                        ...
                        if (options && options.gridCardData) {
                            this._appendGridCardRecordDiagnose(group, $diagnose, options);
                        }
                        else {
