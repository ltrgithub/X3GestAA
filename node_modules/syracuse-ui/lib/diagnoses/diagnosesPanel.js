...
exports.DiagnosesPanel = helpers.defineClass(DiagnosesPanel, null, {
                ...
                self.$$item.delegate("a[data-s-picker]", "click", function(){
                    switch (this.getAttribute("data-s-picker")) {
                        ...
                        case "diag-expand":
                            ...
                            break;
                        case "detail":
                            $(this).parent().find("div.s-diag-view-stacktrace").toggle();
                            $(this).toggleClass("s-diag-view-msg-more").toggleClass("s-diag-view-msg-less")
                    ...
                    var hide = $(this).find("div.s-diag-view-msg-hide");
                    if (hide.length > 0) {
    ...
    _openMessagePopup: function(diagLayout, $$label){
        ...
        msgPopup.loadBox($$label[0].innerHTML, severity);
