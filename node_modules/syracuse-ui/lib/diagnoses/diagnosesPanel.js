...
helpers.defineClass(DiagnosesPanel, null, {
	...
	load: function(page) {
		...
		this._closeBtn = syra_menus.addIconButton(syra_local.diag_close, "s-diagnose-close", "close");
		...
		if ((self.page == syra_site) || (self.page.isPageLoaded && !self.page._isDataChanging)) {
			...
			if (count) {
				if (showNext && !self._nextBtn) {
					...
					self._nextBtn.link.title = syra_local.diag_next_tooltip;
				}
			...
			syra_site.dom.display(self._closeBtn, count > 0);
