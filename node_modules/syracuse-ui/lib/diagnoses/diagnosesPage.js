...
exports.show403 = function(error, $diagnoses) {
	...
	syra_site.body.appendChild(_makeTemplate(syra_site.localize.error_page_403, $diagnoses));
...
exports.show404 = function(error, $diagnoses) {
	syra_site.body.style.display = "none";
	syra_site.resetMainPage();
	syra_site.body.appendChild(_makeTemplate(syra_site.localize.error_page_404, $diagnoses));
	syra_site.body.style.display = "";
	return true;
};
exports.show401 = function(error, $diagnoses) {
	syra_site.body.style.display = "none";
	syra_site.resetMainPage();
	syra_site.body.appendChild(_makeTemplate(syra_site.localize.error_page_401, $diagnoses));
	syra_site.body.style.display = "";
	return true;
};