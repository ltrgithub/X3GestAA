    ...
    _refreshViewer: function(showAll){
        if (!this.disableViewer) {
            ...
            self.groups._groups.forEach(function(group){
                ...
                // for menu icons
                var severityIcon = document.createElement("a");
                severityIcon.className = "s-page-menus-icons-" + group.severity;
                var countIcon = document.createElement("a");
                countIcon.className = "s-page-menus-icons-count-" + group.severity;
                ...
                if (count) {
                    ...
                    if (self.$hasMenuIcons) {
                        self.$$menuIcons[0].appendChild(severityIcon);
                        countIcon.textContent = count;
                        self.$$menuIcons[0].appendChild(countIcon);
                    }
                }
                if (count == 0) {
                    domCount.style.display = "none";
                    if (self.$hasMenuIcons) {
                        severityIcon.style.display = "none";
