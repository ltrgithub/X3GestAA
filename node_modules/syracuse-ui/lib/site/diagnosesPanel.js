...
exports.DiagnosesPanel = helpers.defineClass(DiagnosesPanel, null, {
    ...
    _initializeCore: function(){
        ...
        html.className = "s-diag-view-drag";
        var $$diagViewDrag = $(html);
        ...
        document.site.setDraggable(self, $$diagViewDrag);
        ...
        self.$$core.append($$diagViewDrag).append(self.$$header).append(self.$$body);
