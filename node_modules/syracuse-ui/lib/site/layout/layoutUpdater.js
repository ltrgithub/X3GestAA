...
exports.ensureHasParent = function(layout){
    var $layoutType = layout.$layout.$layoutType, $widths = layout.$layout.$widths, $autoSize = layout.$layout.$autoSize;
...
exports.convertToNewLayout = function(layout, $newLayout){
