...
exports.ItemPalette = helpers.defineClass(ItemPalette, RawPage, {
    ...
    _setSwitchMode: function(){
        ...
        this.menuItems.$switchMode.forEach(function(menu){
            menu.setTitle(self.authorPage.$isLightMode ? self.localize.aw_fullMode : self.localize.aw_lightMode);
    ...
    loadBox: function(){
        ...
        self.$prototype.$links = {
            $switchMode: {
                $title: self.localize.aw_lightMode
            },
            $addSection: {
                $title: self.localize.aw_addSection
            },
            $addBlock: {
                $title: self.localize.aw_addBlock
            },
            $addField: {
                $title: self.localize.aw_addField
            }
        };
    ...
    _formatFieldTextLabelAlign: function(isProto){
        ...
        if (isProto) {
            this.$prototype.$properties[$bind] = {
                ...
                $title: this.localize.aw_textLabelAlignment,
                $value: {
                    $type: "application/x-string",
                    
                    $enum: [{
                        $value: false,
                        $title: this.localize.aw_textLabelLeftAligned
                    }, {
                        $value: true,
                        $title: this.localize.aw_textLabelRightAligned
                    }]
                }
            };
        ...
        if (isProto) {
            this.$prototype.$properties[$bind] = {
                ...
                $value: {
                    ...
                    $enum: [{
                        $value: false,
                        $title: this.localize.aw_labelLeftAlignment
                    }, {
                        $value: true,
                        $title: this.localize.aw_labelTopAlignment
                    }]
                }
            };
            this.$prototype[$bind] = false;
        ...
        if (isProto) {
            this.$prototype.$properties[$bind] = {
                ...
                $value: {
                    ...
                    $enum: [{
                        $value: "largest",
                        $title: this.localize.aw_widthLargest
                    }, {
                        $value: "content",
                        $title: this.localize.aw_widthContent
                    }, {
                        $value: "fit",
                        $title: this.localize.aw_widthMaximum
                    }, {
                        $value: "large",
                        $title: this.localize.aw_widthLarge
                    }, {
                        $value: "medium",
                        $title: this.localize.aw_widthMedium
                    }, {
                        $value: "small",
                        $title: this.localize.aw_widthSmall
                    }]
                }
            };
            ...
            return {
                ...
                $skin: "s-aw-field",
                $isEditMode: true,
                $title: this.localize.aw_fieldSize,
                $labelWidth: "auto",
                $format: "$combo"
            };
        }
    ...
    _formatAllFieldsSection: function(){
        return {
            $category: "section",
            $bind: "$field",
            $title: this.localize.aw_allFields,
            $layout: {
                $layoutType: "row",
                $fitToContent: true,
                $items: [{
                    ...
                    $items: [{
                        ...
                        $category: "block",
                        $title: this.localize.aw_fieldLabelsPosition,
                        $layout: {
    ...
    _formatSectionBlock: function(){
        var items = [{
            $category: "section",
            $title: this.localize.aw_appearance,
            $layout: {
            ...
            $category: "section",
            $title: this.localize.aw_structure,
            $layout: {
    ...
    _formatChildLayout: function($category){
        var $enum = [{
            $value: "stack",
            $title: this.localize.aw_layoutStacked
        }];
        if (this.$childCategory != "field") {
            $enum.push({
                $value: "tabs",
                $title: this.localize.aw_layoutInTab
            });
        }
        $enum.push({
            $value: "row",
            $title: this.localize.aw_layoutRow
        });
    ...
    _formatLayout: function(isProto){
        ...
        var $enums = layoutSettings.$columns.map(function($width){
            ...
            return {
                $value: $parts.join("-"),
                $title: $parts.length + " " + self.localize.aw_layoutColumns // + " ( " + $parts.join("% ") + ")"
            };
        });
        $enums.splice(0, 0, {
            $value: "100",
        ...
        self.$prototype.$properties.$boxLayoutType = {
            $type: "application/x-choice",
            $value: {
                $type: "application/x-string",
        ...
        self.$prototype.$boxLayoutType = "100";
        return;
        ...
        return {
            ...
            $layout: {
                ...
                $items: [{
                    ...
                    $menus: [{
                        $items: [{
                            $title: self.localize.selectTemplate,
                            $subMenus: {
                                $skin: "s-aw-composites",
                                $isPopup: true,
                                $icon: {
