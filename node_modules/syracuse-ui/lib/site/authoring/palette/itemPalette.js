...
exports.ItemPalette = helpers.defineClass(ItemPalette, Article, {
    ...
    _addLayoutsHeader: function(){
        ...
        if (this.$prototype.$properties.$boxLayoutType) {
            ...
            var field = this.authorPage.loadNewItem($(div).appendTo(this.authorPage.$$layoutSlot), {
                $bind: "$boxLayoutType",
                $icon: {
                    $inputMode: "icon",
                    $mode: "iconText",
            ...
            div = document.createElement("div");
            div.className = "s-aw-header-layouts-slot";
            field = this.authorPage.loadNewItem($(div).appendTo(this.authorPage.$$layoutSlot), {
                $bind: "$allChildLayout",
                $skin: "s-aw-field",
                $icon: {
                    $inputMode: "icon",
            ...
            this.authorPage.loadNewItem($(div).appendTo(this.authorPage.$$layoutSlot), {
                $category: "links",
