exports.$prototype = {
    "$properties": {
        ...
        "$fieldsIsTopLabelAlignment": {
            "$type": "application/x-choice",
            "$value": {
                "$type": "application/x-string",
                "$enum": [{
                    "$value": false,
                    "$title": "{@labelLeftAlignment}"
                }, {
                    "$value": true,
                    "$title": "{@labelTopAlignment}"
                }]
            }
        },
        "$fieldsIsRightTextLabelAlignment": {
            "$type": "application/x-choice",
            "$title": "{@textLabelAlignment}",
            "$value": {
                "$type": "application/x-string",
                "$enum": [{
                    "$value": false,
                    "$title": "{@textLabelLeftAligned}"
                }, {
                    "$value": true,
                    "$title": "{@textLabelRightAligned}"
                }]
            },
            "$isDisabled": true
        },
    ...
    $localization: {
        ...
        "@sectionAllFields": "All fields",
        "@blockPosition": "Labels position",
        ...
        "@fieldSize": "Size",
        "@widthLargest": "fit to largest content",
        "@widthContent": "fit to content",
        "@widthMaximum": "maximum",
        "@widthLarge": "large",
        "@widthMedium": "medium",
        "@widthSmall": "small",
        "@showLightMode": "show light mode",
...
exports.data = {
    ...
    "$fieldsWidth": "fit",
    "$fieldsIsTopLabelAlignment": true,
            ...
            "$layout": {
                ...
                "$items": [{
                    ...
                    "$items": [{
                        ...
                        "$layout": {
                            "$items": [{
                                "$bind": "$fieldsIsTopLabelAlignment",
                                "$skin": "s-aw-field",
                                "$isEditMode": true,
                                "$isLeftSpaceHidden": true
                            }, {
                                "$bind": "$fieldsIsRightTextLabelAlignment",
                                "$skin": "s-aw-field",
                                "$isEditMode": true,
