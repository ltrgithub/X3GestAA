...
exports.TreeNode = helpers.defineClass(TreeNode, null, {
    ...
    setDesignableItem: function(item){
        ...
        this.ensureItemCss(item);
    },
    ensureItemCss: function(item){
        if (item._tabTitle) {
            document.site.toggleClass(item._tabTitle, "s-aw-item", true);
            document.site.toggleClass(item._body, "s-aw-item", true);
        }
        else {
