...
exports.buildPageCollaborationUrl = function(article, urlSegment) {
	var pageTemplateUrl;
	if (syra_site.getPageTemplateUrl) {
		pageTemplateUrl = syra_site.getPageTemplateUrl(urlSegment.$url);
	}
	if (!pageTemplateUrl) {
		pageTemplateUrl = syra_site.$item.$pageTemplateUrl || ('/page?url=' + encodeURIComponent(urlSegment.$url));
	}
