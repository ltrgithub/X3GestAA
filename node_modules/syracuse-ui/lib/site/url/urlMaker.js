...
exports.buildPageCollaborationUrl = function(article, urlSegment) {
	var pageTemplateUrl = syra_site.$pageTemplateUrl || ('/page?url=' + encodeURIComponent(urlSegment.$url));

	//TEMP to comlete remove
	if (urlSegment.$url.split(":")[0] == "excel") {
		pageTemplateUrl = "excel://$prototypes('{representation}')";
	}



	return syra_site.expressionMaker.parse(article, pageTemplateUrl, {
...
exports.isWorkingCopy = function($url, $sourceUrl) {
