...
exports.BookmarksBar = helpers.defineClass(BookmarksBar, null, {
	...
	checkMainPage: function() {
		...
		var isDisabled = !(activePage && activePage.isBookmarkEnabled);
		var isOn = false;
		if (!isDisabled) {
		...
		document.site.disableItem(this.addPicker, isDisabled);
		document.site.toggleClass(this.addPicker, "s-bookmark-on", false);
		this.onResize();
	},
	onAddClick: function() {
