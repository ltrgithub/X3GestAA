...
function _changeMainPage($url, $itemPage, onHistoryChange) {
	...
	syra_controller.changeMainPage(exports.getSdataUrl($url), $itemPage, onHistoryChange);
};
...
exports.updateCurrentEndpoint = function(newEndpoint) {
	exports.load(syra_site.urlMaker.replaceEndpoint(exports.getCurrentSdataUrl(), newEndpoint));
};
