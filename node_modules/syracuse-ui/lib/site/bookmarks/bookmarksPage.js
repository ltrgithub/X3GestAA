...
exports.BookmarksPage = helpers.defineClass(BookmarksPage, DesktopPage, {
    ...
    notifyChangeToServer: function(){
        document.site.bookmarksManager.notifyChangeToServer(document.site.deltaManager.cleanServerIndex(helpers.object.clone(this.dataset, true)));
    },
    ...
    onMenuClick: function(menuItem){
        if (menuItem.isBookmarkMenuItem) {
            if (document.site.bookmarksManager.onLinkLinkClick(menuItem)) {
    ...
    dispose: function(){
        ...
        document.site.bookmarksManager.refreshNavigationPage();
