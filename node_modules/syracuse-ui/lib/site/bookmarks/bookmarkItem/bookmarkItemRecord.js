			...
			case "$delete":
				if (!this.$isSeparator) {
					...
					if (localizeKey === "nvpConfirmDeleteBookmark") {
						this.localize[localizeKey] = syra_site.expressionMaker.parse(menuItem.articleParent.dataset.$singleField.menuItem, this.localize[localizeKey], menuItem.articleParent.dataset.$singleField.menuItem);
					}
