...
exports.BookmarkMenuBlockRecord = helpers.defineClass(BookmarkMenuBlockRecord, ChildFieldRecord, {
	...
	addExpandPicker: function() {
		if (!this.expandPicker) {
			...
			this.expandPicker.syraItem = this;
			this.expandPicker.syraOnClick = "onExpandBlockClick";
			this.expandPicker.className = "s-nav-admin-block-expand";
	...
	onExpandBlockClick: function(picker) {
