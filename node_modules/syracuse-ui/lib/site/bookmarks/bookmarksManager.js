...
function _defineMenuItemLinks() {
	return {
		$select: {
			...
			$variants: {
				menuItem: {
					$title: syra_site.localize.bookmarksSelectMenu,
		...
		addSeparator: {
			...
			$variants: {
				menuItem: {
					$title: syra_site.localize.bookmarksAddSeparator
				}
			}
		}
...
exports.onManagerClick = function() {
	...
	_dialog = syra_site.dialogManager.openModal(syra_site, {
		...
		$itemPage: {
			...
			$representation: {
				$prototype: {
					...
					$title: syra_site.localize.bookmarksTitle,
					$properties: {
						items: {
...
function _toggleNavigationMenuItemBookMark(navigationMenuItem) {
	syra_site.dom.toggleClass(navigationMenuItem.bookmarkPicker, "s-bookmark-on", navigationMenuItem.isBookmark);
}
...
exports.checkMainPageStatus = function() {
	...
	if (activePage && !activePage.disposed && activePage != _lastCheckedPage) {
		...
		syra_site.dom.disableItem(_barArea.addPicker, !isBookmarkEnabled);
		syra_site.dom.toggleClass(_barArea.addPicker, "s-bookmark-on", isOn);
		exports.onResize();
	}
};
...
exports.load = function(slot) {
	...
	link.syraSiteObserver = "bookmarksManager";
	link.setAttribute("href", "#");
	link.title = syra_site.localize.bookmarksAdd;
	...
	link.syraSiteObserver = "bookmarksManager";
	link.setAttribute("href", "#");
	link.title = syra_site.localize.bookmarksManage;
	...
	link.syraSiteObserver = "bookmarksManager";
	link.setAttribute("href", "#");
	link.textContent = syra_site.localize.bookmarksMore;
	link.title = syra_site.localize.bookmarksMoreTooltip;
