...
exports.notifyChangeToServer = function(dataset) {
	document.site.userProfile.saveBookmarks(_barArea.dataset = dataset || _barArea.dataset, function(dataResult) {
		exports.refresh();
		_refreshManager();
	});
};
...
function _onAddClick() {
	...
	if (page && page.openerUrlSegments) {
		if (!_findMenuItem(page.openerUrlSegments.$url, null, true)) {
			_barArea.dataset.items.push({
				menuItem: {
...
exports.checkMainPage = function() {
	...
	var isOn = false;
	var menuItem = _findMenuItem(document.site.history.getCurrentSdataUrl());
	isOn = !! menuItem;
