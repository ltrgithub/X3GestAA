...
exports.onLinkLinkClick = function(menuItem) {
	...
	if (workBook) {
		if (menuItem.urlSegment.fusionParams) {
			...
			var sapController = workBook.fusionSite && workBook.fusionSite.controller._sapController;
			if (sapController) {
...
exports.onBarLinkClick = function(event, btn) {
	!btn.syraIsDisabled && exports.onLinkLinkClick(btn.menuItem);
};
...
exports.load = function() {
	...
	_links = [];
	_addBtn = syra_menus.addIconButton(syra_local.bookmarksAdd, "s-bookmarks-bar-add", "onAddClick", null, "bookmark_off");
	_addBtn.syraSiteObserver = "bookmarksManager";

	_manageBtn = syra_menus.addIconButton(syra_local.bookmarksManage, "s-bookmarks-bar-manage", "onManagerClick", null, "expand");
	_manageBtn.syraSiteObserver = "bookmarksManager";
	_manageBtn.style.visibility = "hidden";

	_linksSlot = document.createElement("div");
	_linksSlot.id = "s-bookmarks-bar-links";

	_moreBtn = syra_menus.addTextButton(syra_local.bookmarksMore, "s-bookmarks-more-btn", "onMoreClick");
	_moreBtn.syraSiteObserver = "bookmarksManager";
