...
exports.onBarLinkClick = function(event, picker) {
	exports.onLinkLinkClick(picker.menuItem);
};

exports.onNavigationBookMarkClick = function(event, picker) {
...
exports.load = function(slot) {
	...
	link.syraSiteObserver = "bookmarksManager";
	link.setAttribute("href", "#");
	link.title = syra_local.bookmarksAdd;
	...
	link.syraSiteObserver = "bookmarksManager";
	link.setAttribute("href", "#");
	link.title = syra_local.bookmarksManage;
	...
	link.syraSiteObserver = "bookmarksManager";
	link.setAttribute("href", "#");
	link.textContent = syra_local.bookmarksMore;
	link.title = syra_local.bookmarksMoreTooltip;
