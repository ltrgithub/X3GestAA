...
exports.updateTimer = function(httpQuery, $url){
    // do you want to maintain session
    var callbackConfirm = function(){
        //TODO
    }
    
    // if not, you will be logout
    var callbackCancel = function(){
        //TODO
    }
    
    // ONLY FOR CONVERGENCE URLS
    if ($url.search(/\/trans\//i) >= 0) {
        var timeOut = document.site.userProfile.getServerTimeOut && document.site.userProfile.getServerTimeOut() || 120000; // 2 minutes for test
        // clear any previous ongoing timeout
        clearTimeout(httpQuery.serverTimeOutHandler);
        httpQuery.serverTimeOutHandler = setTimeout(function(){
            //TODO
        }, timeout)
    }
}
