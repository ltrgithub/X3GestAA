...
exports.onWindowUnload = function(site){
    ...
    window.onbeforeunload = function(event){
        if (site.fusionGateway && site.fusionGateway._books && site.fusionGateway._books.length > 0) {
            ...
            var alertMsg = localize.d_unload_alert.replace("{booksNb}", site.fusionGateway._books.length);
    ...
    window.onunload = function(){
        if (site.fusionGateway && site.fusionGateway._books && site.fusionGateway._books.length > 0) {
            site.fusionGateway.detachAllBooks(function(diag, client, clientRef, cbck){
                return true;
            }, false, true, true, {
                "panic": true
            });
...
exports.onUserActionUnload = function(callback, cancelCallback){
    ...
    function promptUser(diag, client, clientRef, cbck){
        var options = {};
        options.$message = diag.message || diag.$message || localize.d_userunload_msg;
