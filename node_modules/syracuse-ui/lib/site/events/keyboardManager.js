...
exports.load = function(){
    ...
    _keydowEvent = document.addEventListener("keydown", function(event){
        ...
        var focusField = document.site.itemHelper.findField(event.target);
        var article = document.site.itemHelper.findArticle(event.target);
        var page = _getPage(focusField, article);
        var doEvent = true, isFocusOnMesgBox = false;
