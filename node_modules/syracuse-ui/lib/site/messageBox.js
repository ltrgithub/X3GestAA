...
exports.MessageBox = helpers.defineClass(MessageBox, null, {
    open: function(options){
        ...
        if (stackTrace) {
            ...
            //self.$$bodyPicker.prependTo(self.$$body);
            self.$$body.find("div.s-msgbox-body-msg").after(self.$$bodyPicker);
        }
    ...
    _setMinimumDimensions: function(){
        ...
        //this.$$stackTrace[0].style.minHeight = "30px";
    },
    onWindowResize: function(setMinimumDimensions){
        var body = document.site.$$body[0];
        this.$$item[0].style.maxWidth = (body.clientWidth - 800) + "px";
        this.$$body[0].style.maxHeight = (body.clientHeight - this.$$header.outerHeight() - 150) + "px";
        if (this.$$stackTrace) {
            this.$$stackTrace[0].style.maxHeight = (body.clientHeight - this.$$header.outerHeight() - 250) + "px";
        }
    },
