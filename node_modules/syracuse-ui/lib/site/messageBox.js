...
exports.MessageBox = helpers.defineClass(MessageBox, null, {
    open: function(options){
        ...
        self.$$bodyTxt = $(document.createElement("div")).html(options.$message.replace(/\n/g, "<br/>"));
        self.$$bodyTxt.addClass("s-msgbox-body-text-opened");
        self.$$body.append(self.$$bodyTxt);
        if (self.$$bodyTxt[0].textContent.length > 120) {
            self.$$bodyTxt.toggleClass("s-msgbox-body-text-opened").toggleClass("s-msgbox-body-text-closed");
            var $$picker = $(document.createElement("a")).addClass("s-msgbox-body-picker-closed");
            $$picker.bind("click", function(){
                self.$$bodyTxt.toggleClass("s-msgbox-body-text-opened").toggleClass("s-msgbox-body-text-closed");
                $$picker.toggleClass("s-msgbox-body-picker-closed").toggleClass("s-msgbox-body-picker-opened");
                if (self.dialog) {
                    self.dialog.onWindowResize();
                }
            });
            self.$$body.prepend($$picker);
        }
    ...
    _setMinimumDimensions: function(){
        ...
        this.$$bodyTxt[0].style.minHeight = "30px";
    },
    onWindowResize: function(setMinimumDimensions){
        ...
        this.$$bodyTxt[0].style.maxHeight = (body.clientHeight - this.$$header.outerHeight() - 150) + "px";
