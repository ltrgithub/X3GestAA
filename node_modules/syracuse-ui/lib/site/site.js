...
var urlMaker = require('syracuse-ui/lib/controller/urlMaker');
...
exports.Site = helpers.defineClass(Site, RawPage, {
	...
	dispose: function() {
		...
		this.urlMaker = this.screenDesigners = this.fusionHeaderFunctionLink = this.fusionHeaderHomeLink = this.homeLink = null;
