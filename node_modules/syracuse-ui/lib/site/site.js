...
exports.Site = helpers.defineClass(Site, RawPage, {
	...
	_onLogon: function() {
		...
		this.applyLocalize();
		this.validateAuthoringVisibility();
	},
	...
	resize: function(onBoxToggle) {
		...
		self.resizeTimeOut = setTimeout(function() {
			...
			self._callResizeListener(onBoxToggle);
	...
	validateAuthoringVisibility: function() {
		if (this._authoringLink) {
			this._authoringLink.style.display = (this.userProfile.getAuthoringLevel() === "none") ? "none" : "";
		}
	},
