...
exports.Site = helpers.defineClass(Site, RawPage, {
	...
	dispose: function() {
		...
		window.syra_page = window.syra_menus = window.syra_local = window.syra_site = window.syra_controller = window.syra_diagnose = window.syra_store = window.syra_fields = null;
	},
	...
	loadBox: function(siteOptions) {
		...
		window.syra_fields = fieldHelper;
