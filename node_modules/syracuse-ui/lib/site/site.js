...
var SiteTopPanel = require("./siteTopPanel").SiteTopPanel;
...
var FieldController = require('syracuse-ui/lib/controller/fieldController').FieldController;
...
exports.Site = helpers.defineClass(Site, Article, {
    ...
    setFieldWidth: function(field){
        ...
        if ($width.$charWidth) {
            widthValue = ($width.$charWidth * (field.$field.$size || $width.$size));
            if ($width.$minChar) {
                field.domValueSlot.style.minWidth = ($width.$charWidth * $width.$minChar) + +"em";
            }
        }
        field.domValueSlot.style.maxWidth = widthValue + "em";
    ...
    resize: function(){
        ...
        if (self._$$header && self.$$body) {
            var $$header = (self.authoringView) ? self.authoringView.$$container : self._$$header;
    ...
    _renderSearch: function($$container){
        ...
        document.itemFactory.load(searchField.$$fieldValue, {
            $bind: "$searchLink",
            $category: "link",
            $noText: true,
