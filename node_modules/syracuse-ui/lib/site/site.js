...
exports.Site = helpers.defineClass(Site, RawPage, {
    ...
    showDiagnoses: function(message, item, options){
        ...
        if (item) {
            ...
            page = (article ? article.page : null) || this.mainPage;
        }
    ...
    loadNewPage: function($itemPage, pageCategoryClass){
        ...
        var item = new (pageCategoryClass || this.siteOptions.widgetsLibrary.pageCategories[$pageCategory] || this.siteOptions.widgetsLibrary.defaultPageCategory)();
        ...
        return $article ||
        {
            $layout: {
                $items: [{
                    $category: "section",
                    $layout: {
                        $items: Object.keys($prototype.$properties).map(function($bind){
                            return {
                                $bind: $bind
                            };
                        })
    ...
    createLayout: function(box, $layout){
        ...
        var layout = new this.siteOptions.widgetsLibrary.layouts[$layout.$layoutType]();
        layout.box = box;
