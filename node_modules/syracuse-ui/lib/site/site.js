...
exports.Site = helpers.defineClass(Site, RawPage, {
    ...
    getFieldWidth: function($field, useSmartMode){
        ...
        if (useSmartMode) {
            if (!$maxLength) {
                $maxLength = $field.$displayLength || $field.$maxLength || $width.$maxLength || _fieldSmartWidth.large;
            }
            ...
            if (!widthValue) {
                $maxLength = $maxLength || $field.$displayLength || $width.$maxLength || _fieldSmartWidth.medium;
                widthValue = (_fieldSmartWidth.charWidth * $maxLength);
            }
