...
var BookmarksProvider = require('./bookmarks/bookmarksProvider').BookmarksProvider;
var BookmarksBar = require('./bookmarks/bookmarksBar').BookmarksBar;
...
exports.Site = helpers.defineClass(Site, RawPage, {
    ...
    onMenuClick: function(menuItem){
        ...
        if (menuItem.$bind == "$logout") {
            ...
            if (this.bookmarksProvider) {
                return this.bookmarksProvider.onMenuClick(menuItem);
            }
        }
        return true;
    },
    dispose: function(){
        ...
        $(window).unbind();
        this.bookmarksBar = this.bookmarksProvider = this.dragDropManager = this._uiLocker = this._uiLockerOverlay = this._uiLockerTimeout = null;
        ...
        this.headerLogo = this.headerTopRight = this.headerTop = this.wcReqArray = this.bookmarks = null;
    ...
    drawBox: function(){
        ...
        self.logon(function(){
            ...
            //self._runJobsViewer();
            if (self.bookmarksBar) 
                self.bookmarksBar.refresh();
            self.resize();
        });
    },
    _onLogon: function(){
        ...
        this.bookmarksProvider = new BookmarksProvider();
        this.bookmarksProvider.initialize();
    },
    ...
    _renderHeader: function(){
        ...
        this.bookmarksBar.load(headerRows);
