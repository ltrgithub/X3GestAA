...
var _config = require('syracuse-ui/lib/site/config');
...
exports.Site = helpers.defineClass(Site, DesktopPage, {
	validateLayoutContent: function(article) {
		...
		article.layoutContent && _layoutValidator.validate(article.layoutContent, true);
	},
	...
	ensureArticleVisibility: function(article, resizeIfNeed) {
		...
		this.validateLayoutContent(article);
		resizeIfNeed && article.resizeArticle && article.resizeArticle(true);
	},
	...
	_renderHeader: function() {
		...
		this.header.style.minWidth = _size.minWidth + "px";
	...
	refreshPageDesignerOpener: function(pageDesignerAccess) {
		if (this.pageDesignerBtn && pageDesignerAccess != "unknow") {
			syra_menus.button.visibility(this.pageDesignerBtn, pageDesignerAccess != "disabled" && this.userProfile.hasDesignRight() ? true : false);
		}
	},
	refreshMainPageSecurity: function(page) {
		if (page && !page.disposed) {
			...
			this.refreshPageDesignerOpener(page.mainPageDesignerAccess);
		}
	},
	loadBox: function() {
