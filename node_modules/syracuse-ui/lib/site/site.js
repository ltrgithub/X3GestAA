...
exports.Site = helpers.defineClass(Site, RawPage, {
    ...
    _appendTopPanelOpener: function($$container, topPanelClass){
        ...
        //self.$$diagViewOpener = $("<a class='s-diag-view-open'/>").appendTo($$container).hide();
    },
    openSpy: function(){
    ...
    loadNewPage: function($itemPage){
        ...
        delete $itemPage.$pageCategoryClass;
        delete $itemPage.boxParent;
        delete $itemPage.$$container;
        delete $itemPage.$representation;
        delete $itemPage.onBeforeLoadPage;
        return item;
    },
