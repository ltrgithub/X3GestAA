...
var _qualityManager = require('syracuse-ui/lib/site/quality/qualityManager');
...
exports.Site = helpers.defineClass(Site, RawPage, {
	...
	dispose: function() {
		...
		window.syra_diagnose = window.syra_store = window.syra_fields = window.syra_trackers = window.syra_quality = null;
			...
			callback: function() {
				if (!self.hasLogonFailed) {
					...
					locale.setCurrent(function(err) {
						...
						_qualityManager.onAfterLogon(onAfterLogon);
	...
	loadBox: function(siteOptions) {
		...
		window.syra_quality = _qualityManager;
