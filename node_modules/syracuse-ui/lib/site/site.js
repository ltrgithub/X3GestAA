...
exports.Site = helpers.defineClass(Site, RawPage, {
	findArticle: function(dom) {
		while (dom != null) {
			if (dom.syraarticle) {
				return syra_map[dom.syraarticle];
			}
			dom = dom.parentNode;
		}
	},
	...
	dispose: function() {
		...
		window.syra_menus = window.syra_local = window.syra_site = window.syra_controller = window.syra_diagnose = null;
	},
	...
	gotoNavigationPage: function() {
		syra_menus.clickMenu(this, "$navigation");
	},
	gotoHome: function() {
		syra_menus.clickMenu(this, "$home");
	},
	gotoHelp: function() {
		syra_menus.clickMenu(this, "$help");
	},
