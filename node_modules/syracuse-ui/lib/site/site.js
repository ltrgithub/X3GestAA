...
exports.Site = helpers.defineClass(Site, RawPage, {
	...
	dispose: function() {
		...
		this.headerTop = this.wcReqArray = this.bookmarks = null;

		this.expressionMaker = this.deltaManager = this.localizer = window.onerror = window.onbeforeunload = window.onunload = null;
		window.syra_menus = window.syra_local = window.syra_site = window.syra_controller = window.syra_diagnose = window.syra_store = window.syra_grid = null;
	},
	...
	toggleMainPage: function(page, show) {
		...
		if (show && page.domItem && page.displayed !== true) {
			...
			if (page.hasFlashChildField && page.domItem.parentNode) {
				this.dom.hideFlashContainer(page.domItem, false);
			} else {
			...
			if (!show && page.displayed !== false) {
				...
				if (page.hasFlashChildField) {
					this.dom.hideFlashContainer(page.domItem, true);
				} else {
