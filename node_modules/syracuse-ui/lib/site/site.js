...
var itemHelper = require('syracuse-ui/lib/site/tools/itemHelper');
...
exports.Site = helpers.defineClass(Site, RawPage, {
    ...
    dispose: function(){
        ...
        if (this.itemHelper) {
            this.itemHelper.dispose();
        }
        siteFunctions.dispose(this);
        
        this.siteFunctions = this.browser = this.uiLocker = this.dom = this.layoutUpdater = this.layoutValidator = null;
    ...
    drawBox: function(){
        var self = this;
        siteFunctions.addDragDropManager(self);
        self._renderHeader();
    ...
    onClickPicker: function(btn, event){
        switch (btn.getAttribute("data-s-picker")) {
            case "s-site-top-pn-opener-link":
                siteFunctions.toggleTopPanel(true);
                return false;
    ...
    _renderHeader: function(){
        ...
        siteFunctions.addBookmarkManager(this);
