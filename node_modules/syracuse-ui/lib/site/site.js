		...
		if (menuItem.$bind == "$logout") {
			disconnectUtils.onUserActionUnload(function() {
				...
				document.controller.postQuery(menuItem, null, null, function($location, data) {
					// change session.sid value to prevent site login without authentication #issue2426 #sam91789
					// var docCookies = new DocCookies();
					// docCookies.setItem("syracuse.sid", self.randomStr(2), "", "/");
					// docCookies.removeItem("syracuse.sid", "/");
