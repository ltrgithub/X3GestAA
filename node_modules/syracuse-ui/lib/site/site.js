...
exports.Site = helpers.defineClass(Site, RawPage, {
    ...
    dispose: function(){
        ...
        this.headerLogo = this.headerTopRight = this.headerTop = this.wcReqArray = this.favorites = this.moreItem = null;
    ...
    _renderHeader: function(){
        ...
        var headerRows = document.createElement("div");
        headerRows.id = "s-site-header-rows";
        this.header.appendChild(headerRows);
        
        this.headerTop = document.createElement("div");
        this.headerTop.id = "s-site-header-top";
        headerRows.appendChild(this.headerTop);
        
        var div = document.createElement("div");
        div.id = "s-site-help";
        this.loadNewItem(this.headerTop.appendChild(div), {
        ...
        bottom.id = "s-site-header-favorites";
        headerRows.appendChild(bottom);
               
        this.loadNewItem(bottom, {
            $bind: "$addfavorite",
            $category: "link",
            $noText: true,
            $skin: "s-site-header-favorites-add"
        });
        
        this.favorites = document.createElement("div");
        this.favorites.id = "s-site-header-favorites-links";
        bottom.appendChild(this.favorites);
        
        this.moreItem = this.loadNewItem(bottom, {
            $bind: "$morefavorite",
            $category: "link",
            $skin: "s-site-header-favorites-more"
        });
