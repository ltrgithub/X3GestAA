...
exports.Site = helpers.defineClass(Site, RawPage, {
    ...
    toggleTopPanel: function(show){
        if (show !== false && !this._topPanel) {
            ...
            this._topPanel.$$container = $(this._topPanelContainer).empty().show();
    ...
    _appendTopPanelOpener: function($$container, topPanelClass){
        this.$$container[0].setAttribute("data-s-article", this.id); //ensure for compatibility office
        ...
        $$container[0].appendChild(this._topPanelOpener);
    },
    openSpy: function(){
    ...
    _renderHeader: function(){
        ...
        this.awPageSlot.style.display = "none";
        this.$$container[0].appendChild(this.awPageSlot);
        ...
        this.$$container[0].appendChild(this._topPanelContainer);
    },
    ...
    loadBox: function(siteOptions){
        ...
        this.$$container[0].setAttribute("data-s-article", this.id);
