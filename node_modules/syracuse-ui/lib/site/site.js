...
var DragDrop = require("./behavior/dragDrop").DragDrop;
...
exports.Site = helpers.defineClass(Site, RawPage, {
    ...
    loadNewPage: function($itemPage){
        ...
        //temp hack
        if ($article && $itemPage.$representation.$prototype.$article) {
            var $protoArticle = $itemPage.$representation.$prototype.$article;
