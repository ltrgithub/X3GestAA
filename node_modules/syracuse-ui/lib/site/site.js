...
exports.Site = helpers.defineClass(Site, RawPage, {
	...
	appendDiagnosesPanel: function(page) {
		if (this.mainPage) {
			this.mainPage.appendDiagnosesPanel();
		} else {
			this.diagnosesPanel = new DiagnosesPanel();
			this.diagnosesPanel.appendToPage(page);
		}
	},
	showDiagnoses: function(message, item, options) {
		if (this.mainPage) {
			...
			if (!this.diagnosesPanel) {
				this.appendDiagnosesPanel(this);
			}
