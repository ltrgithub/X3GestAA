...
exports.Site = helpers.defineClass(Site, RawPage, {
    dispose: function(){
        ...
        $(window).unbind();
        this.fusionGateway = this._topPanelClass = this._topPanel = this._topPanelContainer = this.awPageSlot = this.spyGateway = this.spy = this.lastFocusField = null;
    ...
    _appendJobsViewerOpener: function(){
        ...
        // jobs viewer opener
        div = document.createElement("div");
        div.className = "s-jobs-viewer-opener";
    },
