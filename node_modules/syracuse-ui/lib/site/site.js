...
exports.Site = helpers.defineClass(Site, RawPage, {
    ...
    onMenuClick: function(menuItem){
        ...
        if (menuItem.$bind == "$logout") {
            ...
            if (this.favoritesProvider) {
                return this.favoritesProvider.onMenuClick(menuItem);
            }
        }
        return true;
    },
    dispose: function(){
        ...
        this.headerTopRight = this.headerTop = this.wcReqArray = this.favorites = this.more = null;
    ...
    drawBox: function(){
        ...
        self.logon(function(){
            ...
            //self._runJobsViewer();
            if (self.favoritesProvider) 
                self.favoritesProvider.updateSiteFavorites();
            self.resize();
        });
    },
    _onLogon: function(){
        ...
        this.favoritesProvider.initialize();
    },
    ...
    onClickPicker: function(btn, event){
        switch (btn.getAttribute("data-s-picker")) {
            ...
            case "s-site-favorite-link":
                if (this.favoritesProvider) {
                    this.favoritesProvider.onClickPicker(btn, event);
                }
                return false;
        }
        return true;
    ...
    _renderHeader: function(){
        ...
        this.headerTop.appendChild(topLeft);
        ...
        this.headerTop.appendChild(this.headerTopRight);
        ...
        this.favorites.id = "s-site-header-favorites";
        bottom.appendChild(this.favorites);
        
        this.more = document.createElement("div");
        this.more.id = "s-site-favorite-more";
        this.loadNewItem(bottom.appendChild(this.more), {
            $bind: "$morefavorite",
            $category: "link",
            $skin: "s-site-favorite-more-link"
        });
    ...
    _appendJobsViewerOpener: function(){
    ...
    loadBox: function(siteOptions){
        ...
        this.$prototype.$links.$morefavorite = {
            $title: this.localize.siteMoreFavorite
        };
        this.$prototype.$links.$favorite = {};
