...
exports.Site = helpers.defineClass(Site, RawPage, {
	...
	_renderHeader: function() {
		...
		this.homeLink = this.loadNewItem(this.headerTop, {
			...
			$noText: true,
			$skin: "s-site-home",
			$shortCutTip: shortCutsTip["gotToDefaultHome"]
		});
		...
		this.navigationLink = this.loadNewItem(this.headerTop, {
			...
			$shortCutTip: shortCutsTip["goToNavigationPage"]
		});
	...
	onUncaughtError: function(errorMsg, url, lineNumber, error) {
		if (this.mainPage) {
			if (this.mainPage.externalAdapter)
				this.mainPage.externalAdapter.onUncaughtError({
					errorMsg: errorMsg,
					url: url,
