...
var helpCenter = require('syracuse-ui/lib/site/help/helpCenter');
var menusHelper = require('syracuse-ui/lib/menus/menusHelper');
...
exports.Site = helpers.defineClass(Site, RawPage, {
	...
	onMenuClick: function(menuItem) {
		...
		switch (menuItem.$bind) {
			case "$documentation":
				...
				break;
			case "$help":
				helpCenter.openPopup(menuItem);
				return false;
			case "$legal":
				helpCenter.openLegalPage(menuItem);
				return false;
		}
		return res;
	},
	dispose: function() {
		...
		this.pageLoader = this.siteFunctions = this.helpCenter = this.browser = this.uiLocker = this.dom = this.layoutUpdater = this.layoutValidator = null;
		...
		this.currentQuickEdit = this.headerTop = this.wcReqArray = this.bookmarks = null;

		this.expressionMaker = this.deltaManager = this.localizer = window.onerror = window.onbeforeunload = window.onunload = null;
		window.syra_page = window.syra_menus = window.syra_local = window.syra_site = window.syra_controller = window.syra_diagnose = window.syra_store = null;
	},
	...
	toggleMainPage: function(page, show) {
		this.dialogManager.activateAll(page, show);
	...
	onMainPageChange: function($itemPage) {
		...
		// test
		console.log("window.phantomLoadStarted ? : " + window.phantomLoadStarted);
		window.phantomLoadStarted && window.phantomLoadStarted.onLoadMainPage(this.mainPage);

		//console.log("Site checks window.phantomInitialized :" + window.phantomInitialized);
		//console.log("Site checks window.phantomLoadStarted :" + window.phantomLoadStarted);
	...
	_renderHeader: function() {
		...
		siteFunctions.addSearchField(this.headerTop);
