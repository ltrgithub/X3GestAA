...
exports.Site = helpers.defineClass(Site, RawPage, {
    ...
    dispose: function(){
        ...
        this.pagesMap = this.pageDesignerOpener = this._newTabLink = null;
    ...
    resize: function(onBoxToggle){
        ...
        if (this.$$body && this.body) {
            if (this.authorPage && this.authorPage.onBeforeSiteResize) {
                ...
                var newHeight = 0;
                if (this.header) {
                    newHeight = document.site.getBoundingClientRect(this.header).height;
                }
				var rect = document.site.getBoundingClientRect(this.layoutSlot)
                this.body.style.height = (rect.height - newHeight) + "px";
            }
        }
    ...
    enablePageDesign: function(enable){
        if (this.pageDesignerOpener) {
            this.pageDesignerOpener.style.display = enable ? "" : "none";
        }
    },
    ...
    loadNewPage: function($itemPage){
        ...
        item.ensurePageVisibility("loadnewpage");
        return item;
    },
    ...
    ensureUILocker: function(){
        if (this._uiLocker && this._uiLocker.style.display !== "none") {
            ...
            var width = this.layoutSlot.clientWidth, height = this.layoutSlot.clientHeight;
            var top = 0;
