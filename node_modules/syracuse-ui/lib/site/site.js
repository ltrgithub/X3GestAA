...
exports.Site = helpers.defineClass(Site, RawPage, {
    dispose: function(){
        ...
        $(window).unbind();
        this._pageDialogs = this.autoCloseDialogs = this.fusionGateway = this._topPanelClass = this._topPanel = this._topPanelContainer = this.awPageSlot = this.spyGateway = this.spy = this.lastFocusField = null;
    ...
    drawBox: function(){
        ...
        self.logon(function(){
            ...
            //Hack lv : en attendant de trouver la bonne solution (pb de localisation)
            setTimeout(function(){self._onLogon();},1000);
    ...
    _appendTopPanelOpener: function(layoutSlot, topPanelClass){
        ...
        div.setAttribute("id","s-site-top-pn-opener")
        ...
        div.appendChild(this._topPanelOpener)
    ...
    _ensureHeaderLocalized:function(){
    	var link,div,topLeft, topRight;   
        ...
        div=document.createElement("div");
        div.setAttribute("id", "s-site-authoring");
       	link = document.createElement("a");
        link.className="s-site-authoring-link";
        link.setAttribute("href", "#");
        link.setAttribute("data-s-picker", "s-site-authoring-link");
        link.title=this._localize().s_authoring_open_link;
        div.appendChild(link);
        topLeft.appendChild(div);
       
        this._logout=document.createElement("div");
        this._logout.setAttribute("id", "s-site-logout");
        topLeft.appendChild(this._logout);	
       	this._logout.appendChild(this.userProfile.menuItems.$logout[0].$$item[0].cloneNode(true));
        // End top left
        ...
        div.setAttribute("id", "s-site-tab");
       	link = document.createElement("a");
        link.className="s-site-tab-link";
        link.setAttribute("href", "?representation=home.$dashboard");
        link.setAttribute("target", "_blank");
        link.title=this._localize().s_site_tab_link;
        div.appendChild(link);
    ...
    loadNewPage: function($itemPage){
        ...
        if ($itemPage.$representation.$diagnoses) {
            item.showDiagnoses({
                $diagnoses: $itemPage.$representation.$diagnoses
            });
        }
