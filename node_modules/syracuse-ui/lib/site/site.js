...
var legalPageOpener = require('./aside/legalPageOpener');
...
exports.Site = helpers.defineClass(Site, RawPage, {
	isTableDevice: function() {
		return this.$item.$device == "tablet";
	},
	...
	dispose: function() {
		...
		this.layoutUpdater = this.layoutValidator = null;
		...
		this.bookmarksManager = this.dragDropManager = this._uiLocker = this._uiLockerOverlay = this._uiLockerTimeout = null;
	...
	onMainPageChange: function($itemPage) {
		...
		if (this.bookmarksManager) {
			this.bookmarksManager.checkMainPage();
		}
