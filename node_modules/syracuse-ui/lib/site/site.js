...
var _jobsManager = require('syracuse-ui/lib/jobs/jobsManager');
...
var _designStore = require("syracuse-ui/lib/authoring/designStore");
...
exports.Site = helpers.defineClass(Site, RawPage, {
	...
	dispose: function() {
		...
		_themeStyleSheet = _styleSheets = window.syra_page = window.syra_menus = window.syra_local = window.syra_site = window.syra_controller = window.syra_diagnose = window.syra_store = window.syra_fields = null;
	},
