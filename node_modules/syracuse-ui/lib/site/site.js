...
var _manager = {
	...
	bookmarks: require("syracuse-ui/lib/links/bookmarks"),
	config: require('syracuse-ui/lib/site/config'),
	nav: require('syracuse-ui/lib/links/navigation/navigator'),
	...
	getSize: function() {
		if (this.layoutSlot && this.size == undefined) {
			...
			if (this.body) {
				...
				this.size.popupMaxHeight = this.size.body.height;
				this.size.headerPopupMaxHeight = this.size.height;
				if (this.headerBar) {
					this.size.headerPopupMaxHeight -= this.headerBar.clientHeight;
				}
				if (this.footer) {
					this.size.headerPopupMaxHeight -= this.footer.clientHeight;
				}
			}
		}
		return this.size;
