...
exports.Site = _helpers.defineClass(Site, DesktopPage, {
	...
	resizeItem: function() {
		...
		if (this.isOfficeSite && syra_site.header) {
	...
	_renderHeader: function() {
		...
		(this.productNameBtn = this.addItem(this.headerBar, {
			$bind: this.isOfficeSite ? "" : "$home",
			$noText: true,
			$category: "link",
			$skin: "s-header-logo"
		})).setProductName = function(name) {
			if (syra_site.isOfficeSite) {
				this.domItem.className = this.$skin = "s-header-logo + s-readonly";
			} else {
		...
		this.productNameBtn.$isDisabled = this.isOfficeSite;
		...
		this.btns.legal = syra_site.addItem(this.footer, {
			...
			$category: "link",
			$skin: this.isOfficeSite ? "s-footer-office s-footer-legal" : "s-footer-legal"
		}, this);

		if (this.$device !== "tablet" && !this.isOfficeSite) {
