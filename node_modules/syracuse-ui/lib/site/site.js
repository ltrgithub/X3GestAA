...
var BookmarksBar = require('syracuse-ui/lib/site/url/bookmarks/bookmarksBar').BookmarksBar;
...
exports.Site = helpers.defineClass(Site, RawPage, {
	...
	onMenuClick: function(menuItem) {
		...
		if (this.bookmarksBar) {
			res = this.bookmarksBar.onMenuClick(menuItem);
		}
	...
	onMainPageChange: function($itemPage) {
		...
		if (this.bookmarksBar) {
			this.bookmarksBar.checkMainPage();
		}
