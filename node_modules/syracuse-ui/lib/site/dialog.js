...
exports.Dialog = helpers.defineClass(Dialog, null, {
    ...
    _endOpen: function(){
        ...
        if (this._content.$dialogMode == "modal") {
            ...
            this.$$overlay.appendTo(document.site.layoutSlot);
        }
    ...
    _moveToPositionNew: function(onBoxToggle){
        if (this.options.position) {
            ...
            var style = this.layoutSlot.style;
            var left, top;
            if (this.options.$dialogSize == "content") {
            
                left = (body.clientWidth - this.$$layoutSlot.outerWidth()) / 2;
                top = (body.clientHeight - this.$$layoutSlot.outerHeight()) / 2;
            }
            else {
