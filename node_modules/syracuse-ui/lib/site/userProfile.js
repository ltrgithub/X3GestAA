...
exports.UserProfile = _helpers.defineClass(UserProfile, DesktopPage, {
	...
	loadBox: function(initData) {
		...
		if (this.$prototype && this.$prototype.$properties) {
			...
			for (var ii = 0, jj = $binds.length; ii < jj; ii++) {
				...
				field.domTitle.insertBefore(syra_menus.button.add({
					isIndicator: true,
					parent: this,
					iconOnly: true,
					css: "s-mn-icontext",
			...
			syra_site.dom.hide(syra_site.layoutSlot, false);
	...
	notifyDataChange: function(field, value, doNotify) {
		...
		DesktopPage.prototype.notifyDataChange.call(self, field, value);
	},
	...
	applyChange: function(newData) {
		...
		if (!this.currentLangCode) {
			_globals.context.localePreferences = newData.selectedLocale;
	...
	dispose: function() {
		this.saveSiteTimeout && clearTimeout(this.saveSiteTimeout);
