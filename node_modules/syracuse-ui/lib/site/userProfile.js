...
exports.UserProfile = helpers.defineClass(UserProfile, RawPage, {
	...
	getAuthoringLevel: function() {
		var authoringLevel = (this.dataset && this.dataset.selectedRole) ? this.dataset.selectedRole.authoringLevel : null;
		return authoringLevel || "none";
	},
	...
	applyChange: function(newData) {
		...
		document.site.validateAuthoringVisibility();
	},
