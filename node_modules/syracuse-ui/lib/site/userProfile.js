...
exports.UserProfile = helpers.defineClass(UserProfile, RawPage, {
	...
	applyChange: function(newData) {
		...
		if (document.site._topPanelOpener && this.dataset.user) {
			// append user profile info (firstname, lastname and photo)
			// name info
			var nameDiv = document.createElement("div");
			nameDiv.className = "s-site-user-name";
			nameDiv.textContent = (this.dataset.user.firstName ? this.dataset.user.firstName + " " : "") + (this.dataset.user.lastName ? this.dataset.user.lastName : "");

			document.site._topPanelOpener.appendChild(nameDiv);
