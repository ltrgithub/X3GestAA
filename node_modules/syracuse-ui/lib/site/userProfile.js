...
exports.UserProfile = helpers.defineClass(UserProfile, RawPage, {
	...
	onNotifyDataChange: function(field, value) {
		if (field && field.$item.$bind == "choiceTheme") {
			syra_workingCopy.notifyFieldChange(this.page.boundFields.selectedTheme[0], value == 0 ? null : {
				$uuid: value
			});
			return false;
		}
	...
	saveSitePreferences: function() {
		...
		if (!self.saveSiteTimeout) {
			self.saveSiteTimeout = setTimeout(function() {
				...
				syra_workingCopy.getSendBag(self).sitePreferences = self.dataset.sitePreferences;
				self.notifyActionChange(null, self, {
					$save: {
						$isRequested: true
					}
