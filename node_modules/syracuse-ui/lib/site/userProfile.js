...
exports.UserProfile = helpers.defineClass(UserProfile, RawPage, {
	...
	getDateFormat: function(displayFormat) {
		return displayFormat == "DD" ? (this.dataset && this.dataset.selectedLocale && this.dataset.selectedLocale.longDate ? this.dataset.selectedLocale.longDate : "dd MMMM yyyy") : (this.dataset && this.dataset.selectedLocale && this.dataset.selectedLocale.shortDate ? this.dataset.selectedLocale.shortDate : "yyyy-MM-dd");
	},
	getTimeFormat: function(displayFormat) {
		return displayFormat == "TT" ? (this.dataset && this.dataset.selectedLocale && this.dataset.selectedLocale.longTime ? this.dataset.selectedLocale.longTime : "HH:mm:ss") : (this.dataset && this.dataset.selectedLocale && this.dataset.selectedLocale.shortTime ? this.dataset.selectedLocale.shortTime : "HH:mm");
	},
