...
exports.UserProfile = _helpers.defineClass(UserProfile, DesktopPage, {
	...
	addOpener: function() {
		...
		slot.className = "s-header-profile";
		syra_site.headerBar.appendChild(slot);
		this.showNature();
	},
	resizeItem: function() {
		if (this._popup) {
		...
		if (this.openerBtn) {
			if (this.dataset.user) {
				...
				if (this.dataset.user.photo) {
					...
					syra_dom.span("s-header-user-nophoto", this.openerBtn.link);
				}
