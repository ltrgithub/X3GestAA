...
exports.UserProfile = helpers.defineClass(UserProfile, RawPage, {
			...
			if (page.securityViewSlot) {
				...
				if (this.dataset) {
					if (this.dataset.selectedRole) {
						...
						page.security.roleItem.className = "s-security-user-role";
					...
					if (this.dataset.selectedEndpoint) {
						...
						page.security.endpointItem.className = "s-security-user-endpoint";
	...
	_applyNewLocalize: function() {
		if (this.formBlock) {
			var localize = locale.resources(module)();
			this.idMap["s-user-form-block"].setTitle(localize.up_welcome);
		...
		if (site.pageDesignerOpener) {
			site.pageDesignerOpener.title = site.localize.siteAuthoringOpen;
		}
		if (site.fusionHeaderHomeLink) {
			site.fusionHeaderHomeLink.title = site.localize.siteTabLink;
		}
		var selectedLocale = this.getSelectedLocale();
		site.dataset.language = selectedLocale.code || "";
		site.dataset.helpLanguage = selectedLocale.code || "";
	},
	drawBox: function() {
