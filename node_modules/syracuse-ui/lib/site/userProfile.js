			...
			self.formBlock = self.loadNewItem(self.domItem, {
				...
				$layout: {
					$items: [{
						...
						$css: "s-user-profile-field s-user-profile-selectedRole",
						$bind: "selectedRole",
						$title: syra_local.userProfile_up_role
					}, {
						$isEditMode: true,
						$isReferenceTitleVisible: false,
						$css: "s-user-profile-field s-user-profile-selectedEndpoint",
						$bind: "selectedEndpoint",
						$title: syra_local.userProfile_up_endpoint
					}, {
						$isEditMode: true,
						$isReferenceTitleVisible: false,
						$css: "s-user-profile-field s-user-profile-selectedLocale",
						$bind: "selectedLocale",
