			...
			if (this.dataset.user) {
				...
				if (this.dataset.user.photo) {
					this.addItem(syra_dom.div(), {
						imageArea: syra_dom.span("s-user-profile-photo", this.openerBtn.link),
						$skin: "s-user-profile-photo",
						$inplace: true,
						$imageWidth: " ",
						$imageHeight: " ",
						$bind: "photo",
					...
					syra_dom.span("s-user-profile-nophoto", this.openerBtn.link);
				}
				syra_dom.span("s-user-profile-name", this.openerBtn.link).textContent = (this.dataset.user.firstName ? this.dataset.user.firstName + " " : "") + (this.dataset.user.lastName ? this.dataset.user.lastName : "");
			}
