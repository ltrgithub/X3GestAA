    ...
    notifyActionChange: function(target, value){
        if (value.$notifyData || value.$receiveData) {
            try {
                ...
                if (value.$notifyData) {
                    window.opener.document.site.spyGateway.getSpyedPage()._notifyChangeToServer(JSON.parse(this.boundFields.$fieldNotify[0].getDataValue()));
                }
            } 
            catch (error) {
