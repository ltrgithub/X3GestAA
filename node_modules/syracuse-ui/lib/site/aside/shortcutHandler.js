...
exports.actionPage = function(ctx) {
	...
	if (document.site.mainPage.menuItems[ctx.action]) document.site.mainPage.menuItems[ctx.action][0].click();
};
...
exports.goToFunction = function() {
	...
	if (document.site.mainPage.menuItems[menu]) document.site.mainPage.menuItems[menu][0].click();
