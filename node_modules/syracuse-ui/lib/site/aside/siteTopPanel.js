...
exports.SiteTopPanel = helpers.defineClass(SiteTopPanel, Article, {
    loadBox: function(){
        ...
        if (document.site.userProfile) {
            ...
            document.site.userProfile.ensurePageVisibility("applyChange");
    ...
    addNavigationBar: function(){
        ...
        this.page.layoutValidator.validate(this.page.loadNewItem(this.$$body[0], $menu, this).layoutContent, true);
    },
    drawBox: function(){
        ...
        if (this.$prototype.$navigation.$about) {
            this._aboutItem = this.page.loadNewItem(this.$$body[0], {
                $category: "menus",
    ...
    dispose: function(){
        this._localize = this._aboutItem = this.$$topBar = this.$$topUserProfile = this.$urlParams = null;
