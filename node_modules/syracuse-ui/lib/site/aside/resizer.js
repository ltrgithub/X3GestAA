...
exports.Resizer = helpers.defineClass(Resizer, null, {
    ...
    onResize: function(event){
        ...
        if (this.isLeft) {
            ...
            if (!this.maxWidth || width < this.maxWidth) {
                if (width >= this.minWidth) {
                    ...
                    style.width = Math.max(width, this.maxWidth) + "px";
                }
            }
        }
        else {
        ...
        if (this.isTop) {
            ...
            if (!this.maxHeight || height < this.maxHeight) {
                if (height >= this.minHeight) {
                    ...
                    style.height = Math.max(height, this.minHeight) + "px";
                }
            }
        }
        else {
        ...
        if (isResized && this.options.onResize) {
            this.options.onResize(self, true);
        }
    },
    dispose: function(){
        if (this.$$dragSpot) {
