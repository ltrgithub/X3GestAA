    ...
    _bindShortCut: function(){
        ...
        document.site.$$layoutSlot.delegate("*", "keydown keyup", function(event){
            ...
            if (event.type == "keydown") {
                ...
                if ( self.keysDown.length === 2 && ((keyboardShortCut.getModifier() === event.keyCode) || (self.keysDown.length !== 0 && self.keysDown.indexOf(keyboardShortCut.getModifier()) !== -1 && event ))) { // if modifier exists try perform shortcut
