    ...
    _bindShortCut: function(){
        ...
        document.site.$$layoutSlot.delegate("*", "keydown keyup", function(event){
            ...
            if (event.type == "keydown" && !event.originType) {
                ...
                if ((keyboardShortCut.getModifier() === event.keyCode) || (self.keysDown.length !== 0 && self.keysDown.indexOf(keyboardShortCut.getModifier()) !== -1 && event)) {
                    return keyboardShortCut.applyKeyboardShortCut2({
                        isFusion: elem.mainPage.$pageCategory === "fusion",
                        keysDown: self.keysDown,
                        event: event
                    });
                }
            }
