...
exports.LegalPage = helpers.defineClass(LegalPage, DesktopPage, {
	...
	applyChange: function(newData) {
		...
		if (newData && newData.$resources && newData.$resources.length > 0) {
			for (var ii = 0, jj = newData.$resources.length; ii < jj; ii++) {
				newData.$resources[ii].productVersion = document.site.localize.legalProductVersionLabel + " " + newData.$resources[ii].productVersion;
			}
		}
	...
	_appendBanner: function() {
		...
		document.site.dom.toggleClass(this.idMap["s-legal-page-banner"].domTitle, "s-disabled");
	},
