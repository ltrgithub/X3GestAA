"use strict";
exports.domQuery = require("syracuse-ui/lib/site/quality/domQuery");
		...
		if (field.domItem) {
			...
			if (field.$isMandatory !== undefined) {
				if (field.$isMandatory) {
					field.domItem.setAttribute("data-s-q-mandatory", 1);
				} else {
					if (field.domItem.hasAttribute("data-s-q-mandatory")) {
						field.domItem.removeAttribute("data-s-q-mandatory");
					}
				}
			}
			if (field.domTitle) {
			...
			field.domItem.setAttribute("data-s-q-bind", field.domItem.syra_field_bind = field.$item.$bind || "");
			field.domItem.setAttribute("data-s-q-title", field.domItem.syra_field_title = field.getTitle());
			field.$field.$X3Name && field.domItem.setAttribute("data-s-q-x3Name", field.domItem.syra_field_x3Name = field.$field.$X3Name);
...
exports.logFocus = function(field) {
