...
exports.field = {
	...
	findAll: function(root, bind) {
		return bind ? root.querySelectorAll("[data-s-bind='" + bind + "']") : root.querySelectorAll("[data-s-bind]");
	},
	find: function(root, bind) {
		return root.querySelector("[data-s-bind='" + bind + "']");
	},
	focus: function() {
	...
	getBind: function(field) {
		return field.getAttribute("data-s-bind");
	},
