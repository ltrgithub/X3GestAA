...
var _fieldTypes = {
    ...
    "application/x-binary": FileField,
    "application/x-document": FileField,
    ...
    "application/x-progress": require('syracuse-ui/lib/field/progressField').ProgressField,
            ...
            if ($field) {
                ...
                switch ($class) {
                    ...
                    case "application/x-vignette":
                        ...
                        switch ($field.$format) {
                            case "$html":
                                fieldClass = HTMLVignetteField;
                                break;
                            case "$page":
                                fieldClass = vignetteField.PageVignetteField;
                                break;
                            case "$item":
                                fieldClass = vignetteField.ItemVignetteField;
                                break;
                        }
                        break;
