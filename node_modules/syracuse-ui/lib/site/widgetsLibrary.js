...
var SearchFacets = require('syracuse-ui/lib/search/searchFacets').SearchFacets;
			...
			if ($field) {
				...
				switch ($class) {
					case "application/x-array":
						...
						var view = openerUrlSegments.params && openerUrlSegments.params.view;
						if (view == "calendar") {
							fieldClass = planningCalendar.PlanningCalendar;
						}
						break;
