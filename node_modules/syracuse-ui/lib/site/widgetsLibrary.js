...
exports.LazyWidget = helpers.defineClass(LazyWidget, null, {
    loadBox: function(initData){
        ...
        require.async(self.path, function(err, module){
            try {
                var item = new module[self.$item.$format]();
                if (item) {
                    document.itemFactory.initializeItem(item, self.$item, self.boxParent);
...
exports.categories = {
    ...
    tests: {
        create: function($item){
            ...
            return new LazyWidget('syracuse-ui/lib/tests/testFactory', $item);
        }
    },
    searchFacets: {
        create: function(){
