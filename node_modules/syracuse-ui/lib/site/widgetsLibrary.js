...
var arrayBuilder = {
	grid: require("syracuse-ui/lib/field/array/gridBuilder").Builder,
	cards: require("syracuse-ui/lib/field/array/cardBuilder").Builder,
};
				...
				switch ($class) {
					case "application/x-array":
						if (!$field.$item.$properties || $field.$item.$type == "application/x-reference") {
							fieldClass = SingleList;
						} else {
							if ($item.$format != "cards") {
								$item.$format = "grid";
							}
							fieldClass = MultiList;
							$field.$builderClass = arrayBuilder[$item.$format];
						}
