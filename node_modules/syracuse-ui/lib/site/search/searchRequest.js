...
exports.SearchRequest = helpers.defineClass(SearchRequest, RawPage, {
	...
	loadAutoCompleteList: function(searchField) {
		...
		document.site.urlMaker.formatMenuUrl(self, self.$prototype.$links.$queryLink1, self.dataset, function($url, isCanceled) {
		...
		document.site.urlMaker.formatMenuUrl(self, self.$prototype.$links.$queryLink2, self.dataset, function($url, isCanceled) {
			document.controller.sendRequest(self, {
				$location: {
					$url: $url
				}
