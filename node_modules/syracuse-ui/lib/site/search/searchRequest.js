			...
			syra_controller.sendRequest(self, {
				...
				if (data.$query1.length > 0) {
					data.$links = {
						...
						$advancedSearch: {
							$isHidden: false,
							$title: data.$totalResults > 5 ? syra_local.searchAdvanceResults : (self.$hasMoreResults ? syra_local.searchAdvanceResults : syra_local.searchAdvanceDetails)
						}
					};
