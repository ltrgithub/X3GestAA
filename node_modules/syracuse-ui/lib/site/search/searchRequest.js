...
exports.SearchRequest = helpers.defineClass(SearchRequest, RawPage, {
    drawBox: function(){
        ...
        this.$$item[0].appendChild(this.body);
            ...
            document.controller.sendRequest(self, {
                ...
                if (data.$query1.length > 0) {
                    data.$links = {
                        ...
                        $advancedSearch: {
                            $isHidden: false,
                            $title: data.$totalResults > 5 ? localize.advanced_search_label_results : (self.$hasMoreResults ? localize.advanced_search_label_results : localize.advanced_search_label_details)
                        }
                    };
