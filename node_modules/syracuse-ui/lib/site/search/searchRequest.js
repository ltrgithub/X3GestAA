...
exports.SearchRequest = helpers.defineClass(SearchRequest, RawPage, {
    ...
    unloadAutoCompleteList: function(){
        if (this._autoCompleteList) {
            ...
            document.site.dom.empty(this._autoCompleteList);
    ...
    updateLocalization: function(){
        this.applyChange({
            $properties: {
                $search: {
                    $title: document.site.localize.searchFieldTitle
                }
            },
            $links: {
                $searchLink: {
                    $title: document.site.localize.siteSearchLink,
                },
                $advancedSearch: {
                    $title: document.site.localize.searchAdvanceLabel
                }
            }
        });
    },
