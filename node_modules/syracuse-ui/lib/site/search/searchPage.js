...
exports.SearchPage = helpers.defineClass(SearchPage, DesktopPage, {
	...
	_sendOneSearchRequest: function(dataset, options, isDataSource, selectTab) {
		...
		document.site.urlMaker.formatMenuUrl(self, $query, dataset, function($url, isCanceled) {
	...
	drawBox: function() {
		...
		var searchOptionSlot = document.createElement("div");
		searchOptionSlot.className = "s-search-option-slot";
		var searchOptionLabel = document.createElement("label");
		searchOptionLabel.className = "s-search-option-label";
		searchOptionLabel.textContent = document.site.localize.searchOptionLabel;
		searchOptionSlot.appendChild(searchOptionLabel);
		var searchOptionValue = document.createElement("div");
		searchOptionValue.className = "s-search-option-value";
		searchOptionSlot.appendChild(searchOptionValue);
		this.headerCoreRight.appendChild(searchOptionSlot);

		this.loadNewItem(searchOptionValue, {
			$isTitleHidden: true,
	...
	_bindEvents: function(bind) {
		...
		if (self.domItem) {
			if (bind) {
				$(self.domItem).delegate(".s-search-res-carditem-body", "click", function() {
