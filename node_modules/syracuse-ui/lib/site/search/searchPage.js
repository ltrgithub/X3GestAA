...
exports.SearchPage = helpers.defineClass(SearchPage, DesktopPage, {
	...
	fetch: function(options) {
		...
		var searchModeTag = this.$urlParts && this.$urlParts.uri && this.$urlParts.uri.substring(this.$urlParts.uri.lastIndexOf("/") + 1);
		this._setSearchMode(searchModeTag);
	...
	_setSearchMode: function(searchModeTag) {
		switch (searchModeTag) {
			case "$xsearch":
				this.searchMode = "$searchContaining";
				break;
			case "$fsearch":
				this.searchMode = "$searchSimilar";
				break;
			default:
