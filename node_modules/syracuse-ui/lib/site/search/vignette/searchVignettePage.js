...
exports.SearchVignettePage = helpers.defineClass(SearchVignettePage, DesktopPage, {
    ...
    onNotifyDataChange: function(field, value){
        if (field.$item.$bind == "$search") {
            if (value != "") {
				document.site.emptyDom(this.browseLayout);
                //this.resultPage = this.resultPage || document.site.loadNewPage(_getSearchResultItemPage());
            }
            else {
    ...
    _getSearchResultItemPage: function(){
        $itemPage.layoutSlot = this.browseLayout;
    ...
    _buildBrowseView: function(){
        ...
        item.appendChild(this.browseLayout);
