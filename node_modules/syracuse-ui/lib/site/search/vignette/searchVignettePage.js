...
exports.SearchVignettePage = helpers.defineClass(SearchVignettePage, DesktopPage, {
    ...
    sendRequest: function(method, url, onSuccess){
        var self = this;
        ...
        switch (menu.$bind) {
            ...
            case "extLink":
                ...
                self.sendRequest(menu.$method, menu.$url, function(data){
                    ...
                    self.idMap["s-sv-selectedendpoint-section"].setState({
                        $isHidden: false
                    });
                    self.idMap["s-sv-field-section"].setState({
                        $isHidden: false
                    });
                }, self.onErrorHandler, self);
                break;
            case "$back":
                this.applyChange({
                    $links: {
            ...
            case "sv-module-picker":
                ...
                if (!this.selectedModId || (this.selectedModId != modId)) {
                    ...
                    for (var ii = 0, jj = catKeys.length; ii < jj; ii++) {
                        ...
                        categoryItemSlot.className = "s-sv-category-item-slot";
    ...
    _buildBrowseView: function(){
        ...
        header.className = "s-sv-browse-module-header";
        header.textContent = "Modules";
        modulesLayout.appendChild(header);
        ...
        var header = document.createElement("div");
        header.className = "s-sv-browse-categories-header";
        header.textContent = "Categories";
        this.categoriesLayout.appendChild(header);
        ...
        var header = document.createElement("div");
        header.className = "s-sv-browse-vignettes-header";
        header.textContent = "Vignettes";
        this.vignettesLayout.appendChild(header);
                ...
                $layout: {
                    $items: [{
                        ...
                        $items: [{
                            ...
                            $isHidden: true,
                            $clientId: "s-sv-selectedendpoint-section",
                            $layout: {
                                $layoutType: "stack",
                                $items: [{
