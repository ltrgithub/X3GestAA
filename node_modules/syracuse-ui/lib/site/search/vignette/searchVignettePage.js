...
exports.SearchVignettePage = helpers.defineClass(SearchVignettePage, DesktopPage, {
    ...
    sendRequest: function(method, url, onSuccess, parent){
        document.controller.sendRequest(null, {
            ...
            self.onErrorHandler(error, httpquery);
        });
    },
    onMenuClick: function(menu){
        ...
        switch (menu.$bind) {
            ...
            case "extLink":
                ...
                self.sendRequest(menu.$method, menu.$url, self._updatePage, self);
            default:
    ...
    onNotifyDataChange: function(field, value){
        if (field.$item.$bind == "$search") {
            if (value != "") {
                ...
                this.sendRequest("GET", this.requestUrl + ("&search=" + value), this.resultPage.applyChange, this.resultPage);
            }
            else {
