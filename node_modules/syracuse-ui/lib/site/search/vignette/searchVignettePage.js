        ...
        switch ($bind) {
            ...
            case "sv-category-picker":
                ...
                if (!this.selectedCatId || this.selectedCatId != catId) {
                    ...
                    for (var ii = 0, jj = vignettes.length; ii < jj; ii++) {
                        ...
                        if (this.selectedVignettes && this.selectedVignettes[vignettes.$uuid]) {
                            document.site.toggleClass(vignetteItem, "s-selected", true);
                        }
                        vignetteItem.setAttribute("data-s-picker", "sv-vignette-picker");
                        vignetteItem.setAttribute("sv-vignette-id", vignettes[ii].$uuid);
            ...
            case "sv-vignette-picker":
                ...
                if (!isSelected) {
                    ...
                    for (var ii = 0, jj = vignettes.length; ii < jj; ii++) {
                        if (vignettes[ii].$uuid == vignetteId) {
                            (this.selectedVignettes = this.selectedVignettes || {})[vignetteId] = vignettes[ii];
                            break;
                        }
                    }
