	...
	return {
		"$vignetteFunctions": {
			...
			$prototype: {
				...
				$links: {
					$searchStartingWith: {
						$title: "Results starting with '{$search}'",
						$url: "http://server:port/sdata/syracuse/search/syracuse/$search?representation=queryResult.$search&q={$search}&source=functions"
					},
					$searchContaining: {
						$title: "Results containing '{$search}'",
						$url: "http:// server:port/sdata/syracuse/search/syracuse/$search?representation=queryResult.$xsearch&q={$search}&source=functions"
					},
					$searchSimilar: {
						$title: "Results similar to '{$search}'",
						$url: "http:// server:port/sdata/syracuse/search/syracuse/$search?representation=queryResult.$fsearch&q={$search}&source=functions"
					}
				},
				$article: {
					"$layout": {
		...
		$vignetteData: {
			...
			$prototype: {
				...
				$links: {
					$searchStartingWith: {
						$title: "Results starting with '{$search}'",
						$url: "http://server:port/sdata/syracuse/search/syracuse/$search?representation=queryResult.$search&q={$search}&source=data"
					},
					$searchContaining: {
						$title: "Results containing '{$search}'",
						$url: "http:// server:port/sdata/syracuse/search/syracuse/$search?representation=queryResult.$xsearch&q={$search}&source=data"
					},
					$searchSimilar: {
						$title: "Results similar to '{$search}'",
						$url: "http:// server:port/sdata/syracuse/search/syracuse/$search?representation=queryResult.$fsearch&q={$search}&source=data"
					}
				},
				$article: {
					"$layout": {
