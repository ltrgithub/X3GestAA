...
exports.hasPageObserver = function() {
	return _listeners.pageObservers.length > 0;
};

exports.addToPageObservers = function(listener, add) {
	_addToListeners(_listeners.pageObservers, listener, add);
};
exports.addToColResizers = function(listener, add) {
	_addToListeners(_listeners.colResizers, listener, add);
};

exports.addToBarResizers = function(listener, add) {
	_addToListeners(_listeners.barResizers, listener, add);
};
