...
exports.registerPage = function(page) {
	if (!page.isSiteRegisterDisabled) {
		_childPages.push(page);
	}
};
exports.unregisterPage = function(page) {
...
exports.childPages = _childPages = [];
...
exports.onJobsOpenerClick = function() {
	document.site.jobsViewer && document.site.jobsViewer.toggle();
};
...
exports.dispose = function(site) {
	...
	_childPages = _topPanel = helpPopupSlot = _helpPopup = null;
};