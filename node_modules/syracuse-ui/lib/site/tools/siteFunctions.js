...
exports.addLogo = function(slot) {
	...
	product.className = 's-m-product s-m-product-font';
	product.textContent = "ERP X3"; // to determine with the name of the product that will come back from the server
