...
var searcherPage = require('syracuse-ui/lib/search/searcherPage');
...
exports.refreshPageDesignerOpener = function(pageDesignerAccess) {
	if (pageDesignerAccess != "unknow") {
		exports.showPageDesignerOpener(pageDesignerAccess != "disabled" && syra_site.userProfile.hasDesignRight());
	}
};
