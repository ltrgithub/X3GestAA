...
exports.lock = function(delay, isLong, forceFocusLoss){
    if (!_locker) {
        ...
        _dummy.className = "s-uiLocker-loading-blackhole";
        _locker.appendChild(_dummy);
        document.site.layoutSlot.appendChild(_locker);
    }
    ...
    _timeout = setTimeout(function(){
        if (isLong) {
            if (!_overlay) {
                ...
                document.site.layoutSlot.appendChild(_overlay);
            }
...
exports.ensureLock = function(){
    if (_locker && _locker.style.display !== "none") {
        ...
        var width = site.layoutSlot.clientWidth, height = site.layoutSlot.clientHeight;
        var top = 0;
        if (site.header) {
