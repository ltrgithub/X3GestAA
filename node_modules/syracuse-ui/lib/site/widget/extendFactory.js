...
var ExtendField = _helpers.defineClass(function() {}, Field, {
	...
	render: function(slot) {
		...
		self.component = self.api.create({
			...
			userPreferences: (self.page.userPreference && self.page.userPreferences.getForField(self.$item.$bind)) || {},
			...
			savePreferences: function(userPreferences) {
				if (this.page.userPreferences && !this.page.isVignettePage) {
					if (userPreferences) {
						this.userPreferences = userPreferences;
					}
					this.page.userPreferences.saveForField(this.$item.$bind, this.userPreferences);
					this.page.userPreferences.save();
				}
			},
	...
	setDataBind: function(value, record, metaData, $bind) {
		if (this.component && this.component.setDataBind) {
			...
			this.component.setDataBind(value, record, metaData, $bind);
		} else {
	...
	resizeArticle: function() {
		if (this.component && this.component.resize) {
			if (syra_dom.isVisible(this.component.container.div)) {
