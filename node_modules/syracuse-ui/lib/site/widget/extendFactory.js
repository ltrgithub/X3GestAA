...
var ExtendArticle = _helpers.defineClass(function() {}, FieldArticle, {
	loadBox: function() {
		this.$item.$isTitleHidden = true;
		if (this.api.stylesheets) {
			for (var ii = 0, jj = this.api.stylesheets.length; ii < jj; ii++) {
		...
		FieldArticle.prototype.loadBox.call(this);
	},
	drawBox: function() {
		var self = this;
	...
	setAttachedField: function(attachedField) {
		if (this.component) {
			this.component.attachedField = attachedField;
		}
	},
	dispose: function() {
		this.component && this.component.dispose && this.component.dispose();
