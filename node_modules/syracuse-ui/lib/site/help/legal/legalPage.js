...
var $eulaUrl = "/syracuse-ui/lib/site/help/legal/SAGE ERP X3 EULA.pdf";
...
exports.LegalPage = helpers.defineClass(LegalPage, DesktopPage, {
	...
	_appendBanner: function() {
		...
		var section = this.idMap["s-legal-page-banner"];
		section.body.appendChild(bannerSlot);
		section.setState({
			$isHidden: false
		});
		syra_site.dom.toggleClass(section.domTitle, "s-disabled");
	},
