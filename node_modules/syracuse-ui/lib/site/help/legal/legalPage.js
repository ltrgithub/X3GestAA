...
exports.LegalPage = helpers.defineClass(LegalPage, DesktopPage, {
	loadBox: function($prototype) {
		...
		this.$prototype.$links.$eula = {
			$title: syra_local.legalCopyright, // syra_local.legalEula,
			$target: "blank",
			$url: _$eulaUrl
		};
		...
		/*this.coyrRightItem = document.createElement("div");
         this.coyrRightItem.className = "s-site-legal-copyright-item";
         this.coyrRightItem.textContent = syra_local.legalCopyright;
         */
		...
		this.loadNewItem(footer, {
			$category: "link",
			$skin: "s-site-legal-eula",
			$bind: "$eula"
		});
		//footer.appendChild(this.coyrRightItem);
	},
	applyChange: function(newData) {
		if (newData) {
			...
			/*if (this.dataset && this.dataset.$copyright) {
             this.$prototype.$links.$eula = {
             this.coyrRightItem.textContent = this.dataset.$copyright;
             }*/
		}
	},
