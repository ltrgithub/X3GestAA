...
<html lang="en">
<head>
	<script src="syracuse-ui/deps/socket.io-client/socket.io.js"></script>
	<script src="syracuse-ui/deps/jquery/jquery-1.9.1.min.js"></script>
	<script src="syracuse-ui/deps/bootstrap/js/bootstrap.min.js"></script>
	<link rel="stylesheet" type="text/css" href="syracuse-ui/deps/bootstrap/css/bootstrap-theme.css">
	<script>
	$(document).ready(function(){
		var socket = io.connect("pc101931:8124");
		$("#chat").hide();
		$("#name").focus();
