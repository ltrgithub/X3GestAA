...
var SocketHandler = helpers.defineClass(function() {
	...
	/// optConfig : configuration about timeout for reconnect, reconnect option provide by socket io , if nothin it take the default value from socket.io
	...
	unregister: function(id) {
		...
		this.listSocket[id].emit("forceDisconnect");
		delete this.listSocket[id];
