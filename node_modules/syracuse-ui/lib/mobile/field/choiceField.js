    ...
    setDataValue: function(value){
        ...
        if (self.$isEditMode) {
            if (self.currentValue && self.currentValue != value) {
                ...
                var $$prev = self.$$value.find("input[value='" + $prevEnum.$index + "']").attr("checked", false);
                if (self.$isjqmField) {
            ...
            if (self.$selectedEnum) {
                var $$new = self.$$value.find("input[value='" + self.$selectedEnum.$index + "']").attr("checked", true);
                if (document.site.isjqmPageLoaded()) {
            ...
            if (document.site.isjqmPageLoaded()) {
                ...
                indexes.forEach(function(i){
                    if (self.$selectedEnum && self.$selectedEnum.$index && i != self.$selectedEnum.$index) {
                        var $$checkbox = self.$$value.find("input[value='" + i + "']").attr("checked", false);
                        if (self.$isjqmField) {
