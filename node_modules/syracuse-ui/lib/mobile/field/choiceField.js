...
exports.MobileRadioChoice = helpers.defineClass(MobileRadioChoice, ChoiceField, {
    ...
    setDataValue: function(value){
        ...
        if (this.$isEditMode) {
            if (this.currentValue && this.currentValue != value) {
                var $prevEnum = this._findEnum(this.currentValue);
                var $$prev = this.$$dataValue.find("input[value='" + $prevEnum.$index + "']").attr("checked", false);
                if (this.$isjqmField) {
            ...
            this.currentValue = value;
            if (this.$selectedEnum) {
                var $$new = this.$$dataValue.find("input[value='" + this.$selectedEnum.$index + "']").attr("checked", true);
                if (document.site.isjqmPageLoaded()) {
    ...
    render: function(){
        ...
        if (self.$isEditMode) {
            ...
            self.$$fieldset = $("<fieldset data-role='controlgroup'" + (self.$item.halign ? 'data-type="horizontal"' : "") + "/>").appendTo(self.$$dataValue);
