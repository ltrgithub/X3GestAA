    ...
    render: function(){
        ...
        if (self.$isEditMode) {
            ...
            if (self.$field.$links && self.$field.$links.$lookup) {
                self.$$fieldValue = self.$$dataValue = self.$$input = $("<input type='text'/>").addClass("s-field-edit-ref-input");
                if (self.inputId) {
                ...
                self.$$pickerBtn.addClass(self.$skin + "-lookup").bind("click", function(){
                    self.clickLookUp(self);
                }).appendTo(self.$$item);
            }
            else {
                self.$$item.append(self.$$fieldValue = $("<div/>").appendTo(self.$$item));
            }
