...
exports.MobileSite = helpers.defineClass(MobileSite, Site, {
	...
	drawBox: function() {
		...
		self.siteFunctions.addDragDropManager(self);
	...
	_renderHeader: function() {
		...
		this.siteFunctions.addLogo(this, this.headerTop);

		this.siteFunctions.addPageDesignerOpener(this);
		...
		this.siteFunctions.addLogoutButton(this);
