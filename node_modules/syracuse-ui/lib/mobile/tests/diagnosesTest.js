...
//var CommonDiagnosesTest = require("syracuse-ui/lib/common/tests/diagnosesTest").DiagnosesTest;

function MobileDiagnosesTest(){
}

exports.DiagnosesTest = helpers.defineClass(MobileDiagnosesTest, Article, {
    loadBox: function(){
        var self = this;
        self.diagnoseTypes = {
            error: {
