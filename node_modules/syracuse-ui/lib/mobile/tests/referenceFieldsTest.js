...
exports.ReferenceFieldsTest = helpers.defineClass(ReferenceFieldsTest, Article, {
    loadBox: function(){
        var self = this;
        self.$prototype = {
            "$properties": {
                ...
                "application/x-collection": {
                    "$title": "application/x-collection application/x-reference",
                    "$capabilities": "sort,filter",
