...
function MobileMessageBoxTest(){
}

exports.MessageBoxTest = helpers.defineClass(MobileMessageBoxTest, Article, {
    _initializeBox: function(){
        ...
        self.$item = {
            $skin: "s-portlet",
            $layout: {
                $items: self._makeSection(["alert", "fatal", "info", "warning", "question", "prompt"])
            }
        }
