	...
	notifyActionChange: function(target, value) {
		if (value.$applyChange) {
			...
			try {
				...
				authorPage.designedPage.designer.historyTool.notifyUpdate(true);
				delete document.site.mobileGateway.isApplyChangeDisabled;
				authorPage.designedPage.designer.historyTool.onAfterStepChange(helpers.object.clone($article, true));
				diag = {
