...
exports.MobilePage = helpers.defineClass(MobilePage, Page, {
    _initializeBox: function(){
        switch (this.$pageCategory) {
            case "dashboard":
                this.$defaultTheme = document.site.$item.$themes.$dashboard;
                this.$authoringSubType = "dashboard";
                this.$autoFetch = false;
                break;
            case "portlet":
                this.$isMainPage = false;
                this.$defaultTheme = document.site.$item.$themes.$portletPage;
                if (this.$facet == "$demo") {
                    this.$autoFetch = false;
                }
    ...
    _drawHeaderBar: function(){
        ...
        this._$$headerBar.attr("data-role", "header").attr("data-add-back-btn", false).attr("data-position", "fixed").attr("data-theme", this.$theme.$headerBar);
        ...
        document.itemFactory.load(this._$$headerBar, {
            $bind: "$home",
            $category: "link",
            $theme: document.site.$item.$themes.$site.$home,
            $noText: true,
            $icon: {
                $name: "home"
            },
    ...
    _drawFooterBar: function(){
        ...
        // footer bar
        self._$$footerBar = $("<footer class='ui-bar'/>").attr("data-role", "footer").attr("data-position", "fixed").attr("data-theme", self.$theme.$footerBar);
    ...
    drawBox: function(){
        ...
        this.$theme = this.$defaultTheme || document.site.$item.$themes.$defaultPage;
    ...
    appendArticleMenus: function(){
        ...
        self.$menus = self._getFacetMenus();
        if (self.$menus) {
            ...
            self._$$footerMenusBtn.bind("click", function(){
                ...
                menusPage.show({
                    ...
                    $category: "links",
                    $format: "selectmenu",
                    $excludeBind: self.$menus.$linkBox.$excludeBind
                }, self);
            });
            ...
            document.itemFactory.load(self._$$footerBar, {
                ...
                $format: "button",
                $icon: {
                    $name: document.site.$item.$icons.mainAction[self.$menus.$mainAction]
                },
                $theme: document.site.$item.$themes.$site.$mainAction,
                $bind: self.$menus.$mainAction
            }, self);
