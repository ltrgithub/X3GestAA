...
exports.ArticleMenusPage = helpers.defineClass(ArticleMenusPage, null, {
    _initialize: function(){
        ...
        // page
        self.$$item = $("<div>").attr("data-role", "page").attr("data-theme", document.site.$item.$themes.$dialogbox.$page).appendTo(document.site.$$container);
        
        // header
        self.$$header = $("<div>").attr("data-role", "header").attr("data-theme", document.site.$item.$themes.$dialogbox.$header).appendTo(self.$$item);
