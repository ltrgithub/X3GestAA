...
exports.MobileSite = helpers.defineClass(MobileSite, Article, {
    notifyRequestSurvey: function(pendingRequests){
    },
    isjqmPageLoaded: function(){
        return this.mainPage && this.mainPage.$isjqmPage;
    },
    ...
    createPopup: function($$popup, position, closeHandler, boundarySelector){
        return new Popup($$popup, position, closeHandler, boundarySelector);
    }
});

exports.load = function($item, $prototype){
    var site = siteHelper.loadSite({
        siteClass: MobileSite,
        $item: $item,
        $prototype: $prototype,
