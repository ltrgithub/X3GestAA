...
exports.UserProfile = helpers.defineClass(UserProfile, Article, {
    drawBox: function(){
		...
		/* 
         var $$container = document.site.$$userProfileHost.hide();
         self.formBlock = document.itemFactory.load($$container, {
         */
        self.formBlock = document.itemFactory.load(self.$$host = $("<div id='s-user-profile'/>"), {
            $category: "block",
            $title: "Welcome {user}",
    ...
    applyChange: function(newData){
        ...
        if (this.dataset && this.dataset.selectedLocale) {
            document.site.langCode = this.dataset.selectedLocale.code;
            globals.context = {};
            globals.context.localePreferences = this.dataset.selectedLocale;
        }
        document.site.ensureLangCode();
        ...
        var $$pickerBtn = this.boundFields && this.boundFields.selectedLocale && this.boundFields.selectedLocale[0].$$pickerBtn;
        if (country && $$pickerBtn) {
            $$pickerBtn.addClass('s-user-profile-country-' + country);
        }
...
exports.logon = function(onAfterLogon){
    if (document.site.userProfile) {
        $("#s-user-profile").empty();
    ...
    document.controller.loadWorkingCopy({
        ...
        article: document.site.userProfile = new UserProfile(),
        callback: function(){
            onAfterLogon();
        }
    });
