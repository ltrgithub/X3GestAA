...
var mobileSectionBlock = require('syracuse-ui/lib/mobile/article/mobileSectionBlock');
...
exports.categories = {
    ...
    section: {
        create: function($item){
            return new mobileSectionBlock.MobileSection();
        }
    },
    block: {
        create: function($item){
            return new mobileSectionBlock.MobileBlock();
        }
    },
    links: {
        create: function(){
