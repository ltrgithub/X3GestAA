...
exports.MobileDiagnoseViewer = helpers.defineClass(MobileDiagnoseViewer, null, {
    ...
    appenToPage: function(page, $$container){
        this.page = page;
        this.$$item = $("<div id='s-diagnose-viewer-core' data-role='page' data-overlay-theme='b'/>").attr("data-theme", document.site.$item.$themes.$dialogbox.$page).appendTo(document.site.$$container);
    },
    ...
    _initializeCore: function(){
        ...
        // header
        self.$$header = $("<div data-role='header' class='s-diag-view-header'/>").attr("data-theme", document.site.$item.$themes.$dialogbox.$header).appendTo(self.$$item);//.hide();
        ...
        // body
        self.$$body = $("<div/>").attr("data-role", "content").attr("data-theme", document.site.$item.$themes.$dialogbox.$content).addClass("s-diag-view-msg-list").appendTo(self.$$item);
        
        // messages viewer
        self.$$viewer = $("<div/>").appendTo(self.$$body);
        
        // footer
        //self.$$footer = $("<div/>").attr("data-role", "footer").attr("data-theme", document.site.$item.$themes.$dialogbox.$footer).appendTo(self.$$item);
