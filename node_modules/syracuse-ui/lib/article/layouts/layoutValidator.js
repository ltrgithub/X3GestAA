    ...
    setSeparators: function(layout){
        ...
        for (var ii = 0, jj = layout.items.length; ii < jj; ii++) {
            ...
            if (ii > 0) {
                ...
                prevItem.rowSeparator.style.display = (prevItem.isVisible === false) ? "none" : "";
                ...
                if (this.isOnAuthoring) {
                    ...
                    prevItem.rowSeparator.setAttribute("data-s-item", prevItem.id);
                }
