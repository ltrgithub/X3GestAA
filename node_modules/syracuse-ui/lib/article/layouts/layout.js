...
exports.Layout = helpers.defineClass(Layout, null, {
    toggleAuthoring: function(isOn){
        ...
        if (!(this.box.articleParent ? this.box.articleParent : this.box).$item.$isAuthoringDisabled) {
            if (isOn) {
        ...
        switch (this.$layout.$layoutType) {
            ...
            case "row":
                if (!this.tableSlot) {
                    ...
                    this.tableSlot.className = this.box.$skin + "-layout-table-row s-layout-table-row";
