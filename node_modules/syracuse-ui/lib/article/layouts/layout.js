...
exports.Layout = helpers.defineClass(Layout, null, {
    ...
    dispose: function(){
        this.$$item = this._item = this._tabs = this.items = this.layoutParent = this.articleParent = this.boxParent = this.page = this.layoutSlot = this.$item = this.$layout = this.tabOpened = null;
    }
});
