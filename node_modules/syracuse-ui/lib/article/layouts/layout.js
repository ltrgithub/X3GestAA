...
exports.Layout = helpers.defineClass(Layout, null, {
	...
	ensureItemVisibility: function(item, $isHidden) {
		...
		if (item.syraRowSeparator && item.layoutSlot) {
			item.layoutSlot.syraRowSeparatorType = item.syraRowSeparatorType;
			syra_site.dom.toggleClass(item.layoutSlot, item.syraRowSeparator, display == "");
		}
		if (item.isDesigning) {
			var site = syra_site;
