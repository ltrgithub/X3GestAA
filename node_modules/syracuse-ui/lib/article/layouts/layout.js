...
exports.Layout = helpers.defineClass(Layout, null, {
    ...
    ensureLayoutSlot: function(item){
        if (item.$skin) {
            ...
            if (this.layoutParent && this.layoutParent.boxParent) {
                item.layoutSlot.className += " " + this.layoutParent.boxParent.$skin + "-layout-parent";
            }
        }
    ...
    ensureItemVisibility: function(item, $isHidden){
        var display = (!this.isRow && ($isHidden || item.$isHidden)) ? "none" : "";
