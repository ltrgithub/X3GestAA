...
function _minimize(box, callback){
    box.layoutSlot.appendChild(box.$$item[0]);
...
exports.togglePicker = function(box, pickerId, show){
    if (show) {
        ...
        if (box._pickers && box._pickers[pickerId]) {
            document.site.removeDomChild(box._pickers[pickerId]);
            delete box._pickers[pickerId];
        }
    }
};
...
exports.renderExpression = function(box, expression, layoutSlot, $fieldCss, $isEditMode){
        ...
        if (match.property.charAt(0) == "$") {
            ...
            if (value != null) {
                if (value.indexOf && value.indexOf("{") >= 0) {
                    ...
                    box._renderExpression(value, domMatch, $fieldCss, $isEditMode);
                }
                else {
