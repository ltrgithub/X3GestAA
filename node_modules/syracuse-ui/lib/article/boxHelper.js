...
exports.toggleExpandPicker = function(box, designing) {
	if (box.$item.$isBoxCollapsable && !box.$item.$isTitlePicker) {
		...
		document.site.dom.toggleClass(box.expandPicker, "s-close", !box.$opened);
	} else {
		if (box.expandPicker) {
			document.site.dom.removeChild(box.expandPicker);
...
exports.togglePicker = function(box, pickerId, show) {
	...
	if (show) {
		...
		if (box.pickers && box.pickers.items[pickerId]) {
			document.site.dom.removeChild(box.pickers.items[pickerId]);
