...
var helpers = require('syracuse-core/lib/helpers'),
	uiHelper = require('syracuse-ui/lib/field/process/helpers');
...
var imagesRoot = "/syracuse-ui/themes/desktop/sage/process/images",
	libInfoRoot = "/syracuse-ui/lib/field/process";
				...
				case 'fileshape':
                 ...
                 return 'xMinYMin meet';
					...
					shape.attr("xlink:href", function(d) {
						...
						+
						getBibCatSubpath(d.bibid) + getBibName(d.bibid) +
							'/' + d.eltid;
...
function parseLien(chaine) {
	var chaineParse = ""
	if (chaine.indexOf("erpfunc", 0) > -1) {} // lien vers une fonction erp //non g�r�
