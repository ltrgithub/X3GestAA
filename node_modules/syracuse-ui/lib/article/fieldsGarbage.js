...
exports.FieldsGarbage = helpers.defineClass(FieldsGarbage, null, {
    ...
    _getDefinedFieldsObject: function($article, $object, layoutMap, checkProperties){
        var secCount = -1, checkProps = checkProperties || this._$properties, blockCount, cat, currSec = null, currBlock = null, deepMax = 9999, deep = 0, deepS = deepMax, deepB = deepMax;
...
exports.FieldsAutoInsert = helpers.defineClass(FieldsAutoInsert, FieldsGarbage, {
    ...
    _getArticleTitle: function(){
        var code = null, name, pref, i, len, view, viewSel, viewLabel = "";
        ...
        if (this.page.$views && (viewSel = this.page.pageViewSelector)) {
            for (i = 0, len = this.page.$views.length; i < len; i++) {
                view = this.page.$views[i];
                if (view.$key == viewSel.selectedId) {
    ...
    showDiagnoses: function(){
        var result, i, j, len, lenj, $diagKeys, diagField, $diagnoses = [], logger, statsBlocks = null, self = this, statsFields = null, statsSections = null, failed, applyChange = false, change = {
            "$properties": {}
        };
    ...
    insertStats: function(result){
        var i, len, $diagKeys = Object.keys(result), diag, ret = {
            "ok": 0,
            "ko": 0
        };
        for (i = 0, len = $diagKeys.length; i < len; i++) {
