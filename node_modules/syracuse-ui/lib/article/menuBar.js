...
exports.MenuBar = helpers.defineClass(MenuBar, null, {
    ...
    load: function(page){
        ...
        if ($menus) {
            ...
            self._menusBox = document.itemFactory.load(self.$$barBody, {
    ...
    _setDockMode: function(){
        if (this.ensurePreferences().isDocked) {
            this.dockMode.className = "s-page-menu-bar-docked";
            this.$$slot[0].style.width = "150px";
            this._bar.style.top = "";
