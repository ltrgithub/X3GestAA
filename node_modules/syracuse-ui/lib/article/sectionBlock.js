        ...
        if (this.isLazyLoad) {
            ...
            if (!isVisible && this.boxChildItems) {
                ...
                for (var ii = 0, jj = $binds.length; ii < jj; ii++) {
                    if (!this.boxChildItems[$binds[ii]].isInvisible) {
                        isVisible = true;
                        break;
                    }
                }
            ...
            if (isVisible == this.isInvisible || this.isInvisible === undefined) {
                ...
                if ((this.isInvisible !== this.$isHidden) || (!this.isInvisible && !this.$isHidden && this.isItemHidden)) {
                    ...
                    if (this.isInvisible && this.tabTitle) {
                        if (this.layoutParent && this.layoutParent.tabOpened == this) {
                            this.page.layoutValidator.validate(this.layoutParent, true);
                        }
                    }
                }
            }
