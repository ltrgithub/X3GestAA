...
function _addTitle(section, $title) {
	...
	section.showBody(!section.isTabLayout || section.$opened);
}
...
exports.SectionBlock = helpers.defineClass(SectionBlock, null, {
	...
	openTab: function() {
		...
		syra_site.ensureArticleVisibility(this.articleParent, true, this);
	},
	showItem: function(show) {
		this.isItemHidden = !show;
		syra_site.dom.hide(this.domItem, this.isItemHidden);
		syra_site.dom.hide(this.header, this.isItemHidden || this.isTitleHidden);
