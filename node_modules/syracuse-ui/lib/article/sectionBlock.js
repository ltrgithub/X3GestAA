...
function _onOpenerClick(event) {
	...
	if (!section.page.onSectionOpenerClick || section.page.onSectionOpenerClick(section)) {
...
function _addTitle(section, $title) {
	...
	if (section.isTabLayout) {
		...
		tabs.insertBefore(section.header, section.layoutParent.tabStop || null);
...
exports.SectionBlock = helpers.defineClass(SectionBlock, null, {
	...
	openTab: function() {
		...
		this.articleParent.resizeArticle && this.articleParent.resizeArticle(true);
	},
