    ...
    applyChange: function(newData){
        if (newData) {
            ...
            if (Object.keys($properties).length > 0) {
                if (Object.keys(bindsInProperties).length > 0) {
                    var $propBinds = Object.keys($properties);
                    for (var mm = 0, pp = $propBinds.length; mm < pp; mm++) {
                        if (!bindsInProperties[$propBinds[mm]] && $properties[$propBinds[mm]].$diagnoses && $properties[$propBinds[mm]].$diagnoses.length > 0) {
                            document.site.showDiagnoses({
                                $diagnoses: $properties[$propBinds[mm]].$diagnoses
                            }, this);
                        }
                    }
                }
                    ...
                    for (var mm = 0, pp = $binds.length; mm < pp; mm++) {
                        if ($properties[$binds[mm]].$diagnoses && $properties[$binds[mm]].$diagnoses.length > 0) {
                            document.site.showDiagnoses({
                                $diagnoses: $properties[$binds[mm]].$diagnoses
                            }, this);
                        }
                    }
                }
