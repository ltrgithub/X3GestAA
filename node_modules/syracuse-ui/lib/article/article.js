...
exports.Article = helpers.defineClass(Article, Box, {
                ...
                if (!field.$isHidden) {
                    if (field.validate && field.$isEditMode) {
                        ...
                        if (!field.validate(newValue)) {
                            ...
                            this.dataset[$binds[ii]] = newValue;
                        }
                    }
                }
            }
    ...
    formatMenuUrl: function($menu, record, callback){
        if (callback) {
            ...
            var properties;
            var preserveEmptyValues = false;
            if ($menu.$parameters) {
                properties = parametersHelper.parseParameters(this, $menu.$parameters, record);
                preserveEmptyValues = $menu.$parameters.$method === "POST" && $menu.$parameters.$url;
            }
            return this.parseExpression($menu.$url, record, properties, undefined, preserveEmptyValues);
        }
    },
    ...
    parseExpression: function(expression, record, properties, resultObject, preserveEmptyValues){
    ...
    diposeContent: function(){
        ...
        this.idMap = this.boundFields = this.layoutContent = null;
    },
    dispose: function(){
        this.diposeContent();
