                ...
                if (typeof(newValue) == 'object') {
                    ...
                    if (!(recordValue == null || newValue === null)) {
                        if (Array.isArray(newValue)) {
                            var $isFullDelta = $property && $property.$isFullDelta;
                            if (self.page.isDeltaMode || $isFullDelta) {
                                newValue = self.page._applyArrayDelta(recordValue, newValue, $isFullDelta);
                            }
                        }
                        else {
                            newValue = self.page._applyObjectDelta(recordValue, newValue);
                        }
                    }
                }
