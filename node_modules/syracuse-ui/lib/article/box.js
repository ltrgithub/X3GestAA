        ...
        if (this.domTitle) {
            if (title) {
                ...
                if (title.indexOf("{") < 0) {
                    ...
                    this._renderExpression(title, this._textTitle, this.$skin + "-title-field", false);
                }
            }
            else {
        ...
        setTimeout(function(){
            switch (pickerId) {
                case "maximize":
                    ...
                    self._pickers.maximize.className = self._pickers.maximize.className.replace("-maximize", "-minimize");
                ...
                case "minimize":
                    ...
                    self._pickers.maximize.className = self._pickers.maximize.className.replace("-minimize", "-maximize");
