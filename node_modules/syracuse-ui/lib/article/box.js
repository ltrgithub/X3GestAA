...
exports.Box = helpers.defineClass(Box, null, {
    ...
    drawBox: function(){
        ...
        if (this.$item.$expression) {
            ...
            if (!this.loaded && (this.$item.$isContentLoaded || this.page.$facet == "$edit")) {
                this.loadContent();
            }
        }
    },
    ...
    _applyDiagnoseState: function(){
        if (this.boxDiagnose && this.boxDiagnose.diagClassName && this.tabTitle) {
            document.site.toggleClass(this.tabTitle, this.boxDiagnose.diagClassName, true);
        }
    },
