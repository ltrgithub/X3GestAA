...
exports.Box = helpers.defineClass(Box, null, {
		...
		if (this.domTitle) {
			if (title != null && title != "") {
				...
				if (displayTitle.indexOf("{") < 0) {
					...
					var parsedText = syra_site.expressionMaker.render(this, displayTitle, this.textTitle, this.$skin + "-title-field", false);
	...
	_createBoxTitle: function() {
		this.textTitle = this.domTitle = this.domTitle || document.createElement("div");
		this.domTitle.style.display = "none";
