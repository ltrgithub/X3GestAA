...
exports.Box = helpers.defineClass(Box, null, {
	...
	applyDesignMetaData: function(metaData, onAuthoring) {
		...
		if (metaData.$isBoxCollapsable !== undefined || metaData.$isCloseable !== undefined || metaData.$isRefreshable !== undefined || metaData.$isMaximizable !== undefined) {
		...
		if (this._item) {
			...
			if (this.isTabLayout) {
				...
				if (this.$item.$isBoxCollapsable && !this.$item.$isTitlePicker) {
					if (this.domTitle) {
						this.domTitle.className += " s-collapsable";
					}
				}
