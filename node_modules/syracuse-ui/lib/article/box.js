...
exports.Box = helpers.defineClass(Box, null, {
	...
	showItem: function(show) {
		...
		display = (!(this.layoutParent && this.layoutParent.isRow) && !show) ? "none" : "";
	...
	setState: function(state) {
		if (state.$isHidden !== undefined) {
			...
			if (this.$isHidden !== state.$isHidden) {
				...
				if (updated) {
					if (this.page && this.page.designer && this.page.designer.uiSwitchTool) {
						this.page.designer.uiSwitchTool.showHiddenItem(this, this.$isHidden);
					}
				}
			}
		}
