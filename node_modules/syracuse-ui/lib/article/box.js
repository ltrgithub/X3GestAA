...
var ColumnsLayout = require("syracuse-ui/lib/article/layouts/columnsLayout").ColumnsLayout;
...
exports.Box = helpers.defineClass(Box, null, {
    appendLayout: function($layout){
        ...
        var layout;
        if ($layout.$layoutType == "columns") {
            layout = new ColumnsLayout();
        }
        else {
            layout = new Layout();
        }
    ...
    applyDesignMetaData: function(metaData, onAuthoring){
        ...
        if (onAuthoring !== false) {
            ...
            if (metaData.$layout !== undefined) {
                ...
                document.site.layoutAuthoring.convertLayout(this.layoutContent, oldLayout);
    ...
    setTitle: function(title){
        if (title) {
            ...
            if (this._tabTitle) {
                this._tabTitle.textContent = this.getDefaultTitle();
            }
        }
    },
    ...
    appendHeader: function($$container){
        ...
        ($$container || this.$$item).prepend(this._header);
    ...
    _renderExpression: function(expression, $$container, $fieldCss, $isEditMode){
        boxHelper.renderExpression(this, expression, $$container, $fieldCss, $isEditMode);
    },
    openBox: function(open){
        ...
        if (this._tabTitle) {
            ...
            if (this.authoringNode) {
                this.authoringNode.ensureItemCss(this);
            }
    ...
    ensureLayoutMode: function(){
        if (this.$isTabLayout) {
            ...
            this._tabTitle.className = this.$skin + (this.$item.$opened ? "-tab-open" : "-tab");
            ...
            this._header.style.display = this.$item.$isTitleHidden ? "none" : "";
