...
exports.Box = helpers.defineClass(Box, null, {
	...
	notifyAddField: function() {
		if (!this.hasField) {
			this.hasField = true;
			if (this.page != this) {
				if (!this.isLayoutContentRendering) {
					if (!this.$isHidden && this.isItemHidden) {
						this.hideBox(false);
					}
				}
				if (this.boxParent && this.boxParent.notifyAddField) {
					this.boxParent.notifyAddField();
				}
			}
		}
	},
