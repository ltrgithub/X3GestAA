...
exports.Box = helpers.defineClass(Box, null, {
	...
	_ensurePickersVisibiliy: function() {
		if (this._pickers && this._pickers.items) {
			...
			if (this._pickers.items.maximize) {
				this._pickers.items.maximize.style.display = display;
			}
			if (this._pickers.items.refresh) {
				this._pickers.items.refresh.style.display = display;
			}
		}
	},
	getArticle: function() {
