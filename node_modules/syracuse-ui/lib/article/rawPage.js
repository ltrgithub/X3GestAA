...
exports.RawPage = helpers.defineClass(RawPage, Article, {
    ...
    ensureLinkSettings: function($item, $isCollapsable){
        var $skinLink = $item.$skin + "-link";
            ...
            for (var ii = 0, jj = $items.length; ii < jj; ii++) {
                ...
                if ($child.$bind) {
                    ...
                    if ($child.$layout) {
                        ...
                        this.ensureLinkSettings($child, $isCollapsable);
                    }
                }
            }
        }
    ...
    appendMainAction: function($$container){
        var $mainAction = _$mainActions[this.$facet];
        if ($mainAction) {
            this.loadNewItem($$container, {
                $bind: $mainAction,
                $skin: this.$skinMainAction || "s-page-main-link",
                $category: "link"
            });
        }
    },
