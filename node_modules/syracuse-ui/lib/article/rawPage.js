...
exports.RawPage = helpers.defineClass(RawPage, Article, {
    ...
    applyChange: function(newData){
        ...
        this.datasource.applyObjectDelta(this.dataset, newData);
    ...
    appendArticleMenus: function(){
        ...
        if ($menus) {
            ...
            document.itemFactory.load($(self._slot).prependTo(self.$$item), {
