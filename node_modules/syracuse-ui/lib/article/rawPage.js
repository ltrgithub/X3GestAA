...
exports.RawPage = helpers.defineClass(RawPage, Article, {
    ...
    initializeNewItem: function(item, $item, boxParent){
        return document.itemFactory.initializeItem(item, $item, boxParent);
    },
    createNewItem: function($item, boxParent){
        return document.itemFactory.create($item, boxParent);
    },
    loadNewItem: function($$container, $item, boxParent, initData){
        return document.itemFactory.load($$container, $item, boxParent || this, initData);
    },
    dispose: function(){
    ...
    applyChange: function(newData){
        if (newData && newData.$isFullDelta) {
            this.$isFullDelta = true;
            //delete newData.$isFullDelta;
        }
