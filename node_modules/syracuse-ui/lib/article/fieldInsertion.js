...
exports.fieldsInsert = function (designLevel, isFusion, garbageObj) {
	...
	var ctx = {"library": insertLibrary, "page": garbageObj.page}, targetsKeys, target, localize = ctx.page.localize;
	...
	try {
		...
		for(i = 0, len = targetsKeys.length; i < len; i++) {
			...
			// Set diagnosis
			result.diagnoses[targetsKeys[i]] = garbageObj.makeDiagnosis(null, null, targetsKeys[i] + " : " + localize[message], severity, ret ? ret.details : null);
			result[severity]++;
		}
	}
	catch (e) {
