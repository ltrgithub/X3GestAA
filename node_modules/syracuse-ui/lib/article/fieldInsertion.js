...
var _insertFusion = {
	...
	"levelArticle": {
		...
		getlastFreeBlock: function(section, context) {
			...
			return block ? {"block": block, "layout": context.library._getBlockLayout(block, context.$bind, block.field.length)} : null;
		},
		_checkInBlock: function(block, context) {
			...
			return fieldRank >= 0 ? {
				"block": block,
				"layout": context.library._getBlockLayout(block, context.$bind, fieldRank)
			} : null;
		},
		_getBlockLayout: function(block, $bind, rank) {
			var parentSlot = null, slot = null, ctx = {"count": 0}, rankInSlot;
			...
			return {"slot": slot, "parent": parentSlot, "rank": rankInSlot};
		},
