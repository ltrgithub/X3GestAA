...
var _insertFusion = {
	...
	"levelArticle": {
		...
		_getAuthoredSectionForBind: function(bind, sectionRefTitle, context, data) {
			...
			if (!bind || (dataEx && dataEx.byPassById) || (!(context.library._findBlockById(this._$layoutMap, null, context.page.getFieldScope(bind), dataEx, context.page)) && !dataEx.section)) {
