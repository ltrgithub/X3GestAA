...
function _notifyDeleteRecord(page, list, record){
    ...
    list._store.ensureRecordsIndex();
...
function _notifyCreateRecord(page, list, record){
    ...
    if (record) {
        ...
        if (list._store._records.length > 0) {
            options.$serverIndex = list._store._records[list._store._records.length - 1].$serverIndex + 1;
        }
        else {
...
exports.notifyDataChange = function(page, field, value){
    ...
    /*if (sessionStorage) {
        ...
        data.wcpreloadUrl = data.wcpreloadUrl || page.openHttpQuery.workingCopyPreloadUrl;
