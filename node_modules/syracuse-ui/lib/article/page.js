...
exports.DesktopPage = helpers.defineClass(DesktopPage, RawPage, {
    ...
    drawUserProfile: function(userProfile){
        if (document.site.$item.$isUserProfileQuickViewEnabled !== false) {
            if (!this.headerUserProfile) {
                ...
                this._header.appendChild(this.headerUserProfile);
            }
            else {
    ...
    renderDescription: function($description){
        if ($description) {
            if (!this.domDescription) {
                ...
                this._headerLeft.appendChild(this.domDescription);
            }
    ...
    appendHeader: function($$container){
        ...
        this._headerLeft.className = this.$skin + "-head-left";
        this._headerLeft.appendChild(this.domTitle);
    ...
    drawBox: function(){
        ...
        if (this.menuBar && this.menuBar.$$bar && this.$isSearchFacetEnabled) {
            this.loadNewItem(this.menuBar.$$bar, {
...
document.controller.findItem($(this));
		if (this.diagnosesPanel){
