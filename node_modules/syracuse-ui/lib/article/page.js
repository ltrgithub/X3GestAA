...
var DiagnosesPanel = require('syracuse-ui/lib/site/diagnosesPanel').DiagnosesPanel;
...
exports.DesktopPage = helpers.defineClass(DesktopPage, RawPage, {
    ...
    appendArticleMenus: function(){
        if (this.$pageCategory == "vignette") {
            ...
            (this.menuBar = new MenuBar()).load(this);
        }
    ...
    renderDescription: function($description){
        if ($description) {
            if (!this.domDescription) {
                ...
                this._headerCore.appendChild(this.domDescription);
            }
    ...
    appendHeader: function(){
        ...
        this.$$header = $(this.dataSlot.appendChild(this._header));
        this._headerTop = document.createElement("div");
        this._headerTop.className = this.$skin + "-head-top";
        this._header.appendChild(this._headerTop);
        ...
        this.renderDescription(this.$prototype.$description || this.$item.$description);
        this._header.appendChild(this._headerBottom);
    },
    showDiagnoses: function(message, options){
        if (!this.diagnosesPanel) {
            (this.diagnosesPanel = new DiagnosesPanel()).showDiagnoses(message, this, options);
        }
        else {
            this.diagnosesPanel.showDiagnoses(message, this, options);
        }
    },
    appendDiagnosesPanel: function(){
    ...
    drawBox: function(){
        ...
        this.$$item = $(this._item).appendTo(this.$$container);
        ...
        this.appendHeader();
        this.appendDiagnosesPanel();
        this.ensureLayoutMode();
        this.dataSlot.appendChild(this._body);
        this._fitContainer();
    ...
    dispose: function(){
        ...
        this._headerTop = this._headerCore = this._headerBottom = null;
