...
exports.ContextMenu = helpers.defineClass(ContextMenu, null, {
    ...
    removeOpener: function(){
        this.field.removeFromPickerBox(this.menuPicker);
    },
    ...
    loadMenuBox: function(){
        ...
        this._menusBox = this.field.page.loadNewItem($(slot.appendChild(this._menusBoxSlot)), this.options, this.field.getArticle());
