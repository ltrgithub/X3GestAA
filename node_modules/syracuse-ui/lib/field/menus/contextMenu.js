...
exports.ContextMenu = helpers.defineClass(ContextMenu, null, {
    ...
    appendOpener: function(){
        var btn = this.field.createPicker("menus");
        this.field.appendToPickerBox(btn);
        return btn;
    },
    removeOpener: function(){
        this.field._removeButtonToValue(this.$$menuPicker[0])
    },
    ...
    doClickPicker: function(){
        var self = this;
        if (!self._popupMenus) {
            document.site.toggleClass(self.$$menuPicker[0], "s-open", true);
            ...
            self._popupMenus = self.field.boxParent.openDialog({
                ...
                onClose: function(){
                    document.site.toggleClass(self.$$menuPicker[0], "s-open", false);
    ...
    create: function(field, options){
        ...
        self.$$menuPicker = $(self.appendOpener());
        self.loadMenuBox();
        self.$$menuPicker.bind("click", function(){
