...
exports.RecordArticle = helpers.defineClass(RecordArticle, Article, {
    drawBox: function(){
         this.page.($("<div style='display:none'/>").appendTo(this.boxParent.$$container), {
            $category: "links"
        }, this);
    },
});
...
exports.TabularChart = helpers.defineClass(TabularChart, Article, {
    ...
    _getSource: function(value, metaData){
        var self = this, proto = this.$prototype, cube = proto.$cube, items = proto.$item.$properties, xAxisCode = self._meta.xAxis[0].code;
