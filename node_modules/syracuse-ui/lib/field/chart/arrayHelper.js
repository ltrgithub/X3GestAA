...
exports.fixDataSet = function(field, dataSet) {
	var fixedDataSet = dataSet;
	if (field && field.page.externalAdapter.fusionSite) {
		...
		if (sapUtil.isEmptyGridDataRecordEx(field.$prototype.$properties, last)) {
