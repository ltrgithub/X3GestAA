	...
	_setLandingPageCalendarDataBind: function($bindings, dataRecordSet, parentDataRecord, metaData) {
		...
		if (parentDataRecord && parentDataRecord.agenda) {
			...
			$events.forEach(function(event) {
				...
				var startHour = new Date(fcEvent.start).getUTCHours();
				var startMinutes = new Date(fcEvent.start).getMinutes();

				var endHour = new Date(fcEvent.end).getUTCHours();
				var endMinutes = new Date(fcEvent.end).getMinutes();
