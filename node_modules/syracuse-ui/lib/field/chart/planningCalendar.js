...
exports.PlanningCalendar = helpers.defineClass(PlanningCalendar, Article, {
	...
	_createLandingPageCalendarWidget: function(calendarType) {
		...
		var calendar = self._widget.fullCalendar({
			...
			viewRender: function() {
				$('.fc-button.fc-agendaWeek-button.fc-state-default', $('.fc-right')).text(syra_local.plcal_weekagenda);
				$('.fc-button.fc-agendaDay-button.fc-state-default', $('.fc-right')).text(syra_local.plcal_dayagenda);
			},
