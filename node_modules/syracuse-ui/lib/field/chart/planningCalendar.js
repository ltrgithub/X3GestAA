...
exports.PlanningCalendar = helpers.defineClass(PlanningCalendar, Article, {
	...
	drawBox: function() {
		...
		this.page.vignetteField && this.page.vignetteField.toggleDesignButton(this.page.isDesignModeEnabled = false);
	},
	setDataBind: function(dataRecordSet, parentDataRecord, metaData) {
		...
		function filtersActive() {
			...
			return startFilterProp &&
				...
				endFilterProp && self.page.$prototype.$properties.$criteria.$item.$properties[endFilterProp];
		}
