...
exports.TabularChart = helpers.defineClass(TabularChart, Article, {
    ...
    _createChoices: function() {
        ...
        return _createChoices(_localize.chartType, ["area", "areaspline", "bar", "column", "line", "scatter", "spline"]);
    },
    ...
    setDataBind: function(value, record, metaData) {
        // debug && console.log("HighCharts.setDataBind " + this.id + ": value=" + typeof(value);
        //this.value = value;
        if (metaData) {
        ...
        if (value && this._chart) {
            var self = this;
            var settings = self._settingsFromValue(value);
    ...
    _settingsFromValue: function(value) {
        ...
        return value && value.reduce(function(res, current) {
    ...
    _onMeasureClick: function(context) {
        ...
        if (!this.attachedField.$isDisabled) {
            if (this.page.externalAdapter.fusionSite) {
                ...
                if (!event.shiftKey) this._drill(data, event.shiftKey);
            }
        }
