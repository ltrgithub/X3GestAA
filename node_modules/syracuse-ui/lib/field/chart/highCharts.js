...
/*****************************************************************
 exporting.src updated for print : add document.site.resize
 ******************************************************************/
var _style = (function() {
	var map = {
		xy: "line",
...
exports.TabularChart = helpers.defineClass(TabularChart, ChartArticle, {
	...
	_showHideLegend: function() {
		var legend = this._chart.legend;
		// if not initialized we consider it is displayed
		legend.displayed = legend.displayed || (legend.displayed == null);
		if (legend.displayed) {
			legend.group.hide();
			legend.box.hide();
		} else {
		...
		legend.displayed = !legend.displayed;
	},
