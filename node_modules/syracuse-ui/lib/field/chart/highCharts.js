...
var _localize = {
    ...
    powerpointSlide: "Create Powerpoint slide"
};
...
exports.TabularChart = helpers.defineClass(TabularChart, Article, {
    applyDesignMetaData: function(metadata, onAuthoring){
        var self = this;
        if (metadata.$chartType !== undefined || metadata.$choiceType !== undefined) {
            self.$item.$chartType = metadata.$choiceType || metadata.$chartType; //DC temp for test
            if (self._meta) {
    ...
    _processLinks: function(proto){
        ...
        var reprUrl = self.page.$prototype && self.page.$prototype.$representationUrl;
        if (reprUrl) {
            proto.$links = {};
