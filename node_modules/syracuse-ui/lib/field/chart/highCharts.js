...
inject && (function() {
    ...
    aspect.before(WorkBook, ["loadSheet"], function(context, args, result) {
        ...
        var $prototype = $itemPage && $itemPage.$representation && $itemPage.$representation.$prototype || {},
            $properties = $prototype.$properties;
        if ($itemPage.$representation.$url.match(/\.AQFF\./)) {
            helpers.object.forEachKey($properties, function(key, prop) {
...
/*              code: proto.$codeStat || "UNKNOWN",
    ...
    _processLinks: function(proto) {
        var self = this,
            page = this.getPage(),
            reprUrl = page.$prototype && page.$prototype.$representationUrl;
        self._meta.links = [];
...
/*
    ...
    _processAxes: function(proto) {
        ...
        if (axis0) {
            _.each(axis0.$hierarchies, function(hierarchy, idx) {
