...
var Highcharts = require('syracuse-ui/deps/highcharts/highcharts.src');
require('syracuse-ui/deps/highcharts/highcharts-more.src')(Highcharts);
require('syracuse-ui/deps/highcharts/draggable-legend')(Highcharts);
require('syracuse-ui/deps/highcharts/modules/exporting.src')(Highcharts);

// Highcharts.theme.version = Highcharts.version.split(".").map(function(e) {
// 	return parseInt(e, 10);
// });
Highcharts.theme = require('syracuse-ui/themes/desktop/highcharts/theme').getTheme(Highcharts);
