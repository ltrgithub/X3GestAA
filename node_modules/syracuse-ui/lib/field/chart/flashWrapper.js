...
Wrapper.prototype._agenda_DataJson2Xml = function(rawData, meta) {
    ...
    // TODO: get the local menu number from the prototype definition
    ...
    for (var i = 0, len = localMenu && localMenu.length; i < len; i++) {
        xmlDocTag.push('<Categ Id="' + (i + 1) + '" Color="' + (colors[i] || "") + '">' + localMenu[i] + '</Categ>');
    }
    xmlDocTag.push('</Categs>');
