...
Wrapper.prototype._agenda_DataJson2Xml = function(rawData, meta) {
    ...
    var $resources = this.currentData.$resources,
        ...
        // flashInput = xmlBuilder($extension, {
        //     uersLang: userLang
        // });

    // console.log(flashInput.toXml());
    ...
    // flashInput.addData("Titles.Title", "");
    // for (var i = 1; i < 12; i++) {
    //     flashInput.appendData("Titles.
    //         ", {
    //         Num: "" + i,
    //         X3Type: "7"
    //     });
    ...
    actionEnum && actionEnum.forEach(function(m, i) {
        ...
        // flashInput.addData("Categs.Categ", {
        //     Id: "" + (i + 1),
        //     Color: (colors[i] || "")
        // });
    });
    ...
    xmlDocTag.push('</UsedDataSrcPar>');
    xmlDocTag.push('<UserLang>' + userLang + '</UserLang>');
    xmlDocTag.push('</Technical>');
