...
Wrapper.prototype.fxOnGetCtxMenuDone = function(err, mnuDesc) {
    ...
    if (mnuDesc) {
        ...
        _.each(data, function(mnu) {
            if (mnu.label && mnu.label.length > 0 && mnu.linkId) reply += '<MI I="' + mnu.linkId + '"><![CDATA[' + mnu.label + debug + ']]></MI>';
        }, this);
    }
...
Wrapper.prototype._agenda_DataJson2Xml = function(rawData, meta) {
    ...
    // temp hack: seems to be a issue in X3 prototype generator
    var mapping = {
        "INTERL": "INT"
    };

    // TODO: no longer use names, we need to add extra info in the prototype
    forEachKey($properties, function(key, val) {
        if (val.$X3Name) {
            var k = val.$X3Name.split('_')[1];
            k = mapping[k] || k;
            x3map[k] = {
                property: key
            };
    ...
    //  5 DATF      : FCDATEFIN ==> int (DATF ==> val not used)     (see Flash function: fgetAgdEDate)
    ...
    $resources.map(function(r) {
        ...
        for (var i = 0; i < cols.length; i++) {
            ...
            case "KEYACT":
                att = {
                    name: "X3Link",
                    value: "x3://8207_OBJET=TSK&amp;CLES=" + vi
                };
            case "TYPACT":
            case "TIER":
            case "INT":
    ...
    // TODO: manage hard codes data below
    xmlDocTag.push('<Titles>');
    xmlDocTag.push('<Title>Calendrier des activités</Title>');
    xmlDocTag.push('<ColTitle Num="1" X3Type="7">Type d\'action</ColTitle>');
    xmlDocTag.push('<ColTitle Num="2" X3Type="7">Chrono action</ColTitle>');
    xmlDocTag.push('<ColTitle Num="3" X3Type="7">Date début</ColTitle>');
    xmlDocTag.push('<ColTitle Num="4" X3Type="7">Heure début</ColTitle>');
    xmlDocTag.push('<ColTitle Num="5" X3Type="7">Date fin</ColTitle>');
    xmlDocTag.push('<ColTitle Num="6" X3Type="7">Heure fin</ColTitle>');
    xmlDocTag.push('<ColTitle Num="7" X3Type="7">Tiers</ColTitle>');
    xmlDocTag.push('<ColTitle Num="8" X3Type="7">Interlocuteur</ColTitle>');
    xmlDocTag.push('<ColTitle Num="9" X3Type="7">Catégorie</ColTitle>');
    xmlDocTag.push('<ColTitle Num="10" X3Type="7">Objet</ColTitle>');
    xmlDocTag.push('<ColTitle Num="11" X3Type="7">Effectué</ColTitle>');
    xmlDocTag.push('</Titles>');

    xmlDocTag.push('<Categs>');
    xmlDocTag.push('<Categ Id="1" Color="0xFDE6D5">Tâche</Categ>');
    xmlDocTag.push('<Categ Id="2" Color="0xDEF3DD">Appel</Categ>');
    xmlDocTag.push('<Categ Id="3" Color="0xF9FDD5">Rendez-vous</Categ>');
    xmlDocTag.push('</Categs>');

    xmlDocTag.push('</Data>');

    xmlDocTag.push('<Technical>');
    xmlDocTag.push('<FullFileName>/home1/adonix/GX3APP/tmp/109588.ptl</FullFileName>');
    xmlDocTag.push('<HtcProvType>PORTALREQ</HtcProvType>');
    xmlDocTag.push('<pView Code="PDCAGD-M"/>');
    ...
    xmlDocTag.push('<Warning>');
    xmlDocTag.push('<Code>TRTPARERR</Code>');
    xmlDocTag.push('<Img>Alert.jpg</Img>');
    xmlDocTag.push('<Mes>Paramètre non trouvé ou incorrect: DAYBEF (0-400) : </Mes>');
    xmlDocTag.push('</Warning>');
    xmlDocTag.push('<Warning>');
    xmlDocTag.push('<Code>TRTPARDEF</Code>');
    xmlDocTag.push('<Img>Alert.jpg</Img>');
    xmlDocTag.push('<Mes>Paramètre: DAYBEF - Valeur par défaut: 2</Mes>');
    xmlDocTag.push('</Warning>');
    xmlDocTag.push('<Warning>');
    xmlDocTag.push('<Code>TRTPARERR</Code>');
    xmlDocTag.push('<Img>Alert.jpg</Img>');
    xmlDocTag.push('<Mes>Paramètre non trouvé ou incorrect: DAYAFT (0-400) : </Mes>');
    xmlDocTag.push('</Warning>');
    xmlDocTag.push('<Warning>');
    xmlDocTag.push('<Code>TRTPARDEF</Code>');
    xmlDocTag.push('<Img>Alert.jpg</Img>');
    xmlDocTag.push('<Mes>Paramètre: DAYAFT - Valeur par défaut: 7</Mes>');
    xmlDocTag.push('</Warning>');
    xmlDocTag.push('<zzzError>');
    xmlDocTag.push('<Code>X3FORERR</Code>');
    xmlDocTag.push('<Img>Alert.jpg</Img>');
    xmlDocTag.push('<Mes>DDD Variable inexistante Formule: DDD                 )... ( Contexte: Vue portail: PDCAGD-M Composant visuel: FAG )</Mes>');
    xmlDocTag.push('</zzzError>');
    xmlDocTag.push('</Messages>');
    return xmlDocTag.join("");
};
