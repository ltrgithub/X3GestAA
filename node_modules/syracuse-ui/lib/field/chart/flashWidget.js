...
exports.FlashWidget = helpers.defineClass(FlashWidget, ChartArticle, {
    ...
    _executeRecordMenu: function(context){
        ...
        if ($links) 
            this.recordArticle.menuItems[Object.keys($links)[0]][0].click();
    },
    showDiagnoses: function(exception, diagnoses, message){
        var diag, page = syraUtil.getPage(this), ret = false;
        if (exception) {
    ...
    __setDataBind: function(value, record, metaData){
        ...
        if (this.wrapper) {
            ...
            if ((value && value.length > 0) || !this._protoUpToDate || (metaData && !this._protoUpToDate)) {
    ...
    _createWrapper: function(componentType){
        var id = this.id + "_flash", proto = this.$prototype, $fusionController = syraUtil.getFusionController(this);
    ...
    getEnumeration: function(code){
        var $fusionController = syraUtil.getFusionController(this), fusionSess = $fusionController ? $fusionController.getSession() : null;
