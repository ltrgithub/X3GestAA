    ...
    onWindowResize: function() {
        ...
        if (this._chart) {
            ...
            this.resizeTimer = setTimeout(function() {
                debug && self._chart && console.log("OrgChart.resizeTimer " + self.id + ": About to resize - chart.isResizing=" + (self._chart && self._chart.isResizing) + " , size=(" + self.layoutSlot.clientWidth + ", " + self.layoutSlot.style.clientHeight + ")");
