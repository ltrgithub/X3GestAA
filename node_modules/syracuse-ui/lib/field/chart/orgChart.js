...
exports.OrgChart = helpers.defineClass(OrgChart, ChartArticle, {
	...
	_buildTreeBase: function(dataset) {
		...
		dataset.forEach(function(e, i, a) {
			...
			if (id) {
				var data = $bindings.$data && $bindings.$data.map(function($bind) {
					return e[$bind];
				}) || [];
				...
				debug && console.log("OrgChart._buildTreeBase: [" + i + "] id=" + id + ", parentId=" + parentId + ", desc=" + ($bindings.$title ? e[$bindings.$title] : ""));
