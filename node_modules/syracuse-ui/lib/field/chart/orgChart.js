...
var merge = Highcharts.merge,
    ...
    // rightArrowPath = "M11.166,23.963L22.359,17.5c1.43-0.824,1.43-2.175,0-3L11.166,8.037c-1.429-0.826-2.598-0.15-2.598,1.5v12.926C8.568,24.113,9.737,24.789,11.166,23.963z",
    // leftArrowPath = "M20.834,8.037L9.641,14.5c-1.43,0.824-1.43,2.175,0,3l11.193,6.463c1.429,0.826,2.598,0.15,2.598-1.5V9.537C23.432,7.887,22.263,7.211,20.834,8.037z",
    // bottomArrowPath = "M8.037,11.166L14.5,22.359c0.825,1.43,2.175,1.43,3,0l6.463-11.194c0.826-1.429,0.15-2.598-1.5-2.598H9.537C7.886,8.568,7.211,9.737,8.037,11.166z",
    ...
    _buildTree: function(dataset) {
        ...
        dataset.forEach(function(e, i, a) {
            ...
            if (!node.parent) {
                ...
                node.image = image && (imageBaseUrl + image);
                node.values = [];
...
OrgChartWidget.prototype = {
    ...
    draw: function(root) {
        ...
        function drawNode(node) {
            ...
            // var nodeSlot = renderer.label(node.desc, rect.x, rect.y).attr({
            // var nodeSlot = renderer.label(node.desc, rect.x, rect.y, node.image, null, null, true).attr({
            // var nodeSlot = renderer.label(node.desc, rect.x, rect.y).attr({
    ...
    _nodeSlot1: function(str, x, y) {
        var options = Highcharts.getOptions(),
            colors = options.colors,
            renderer = this.chart.renderer;
        return renderer.label(str, x, y, null, null, null).attr({
            r: 5,
            // y: 30,
            // height: 60,
            fill: colors[1]
    ...
    _nodeSlot: function(str, x, y, img) {
        ...
        return this._nodeElement(str, x, y, img, null, null).attr({
            // return this._nodeElement0(str, x, y, null, null, null).attr({
            r: 5,
            // y: 30,
            // height: 60,
            // fill: colors[1],
    ...
    _nodeElement0: function(str, x, y, shape, anchorX, anchorY, useHTML, baseline, className) {
