			...
			this.resizeTimer = setTimeout(function() {
				...
				if (self._chart && self._chart.container && !self._chart.isResizing) {
					if (self.layoutSlot.clientWidth) {
						...
						debug && self._chart && console.log("OrgChart.resizeTimer " + self.id + ": setSize(" + self.layoutSlot.clientWidth + "," + height + ")");
	...
	_buildTree: function(dataset) {
		...
		dataset.forEach(function(e, i, a) {
			...
			if (id) {
				...
				if (!node.parent) {
					node.parent = parent;
					node.desc = ($bindings.$title ? e[$bindings.$title] : "") + ((data.length && $bindings.$title) ? " " : "") + data.join(" ");
