...
exports.DocumentField = helpers.defineClass(DocumentField, Field, {
    ...
    _saltUrl: function(url){
        ...
        return url + sep + "salt=" + Math.round(Math.random() * 1000) + (l && l.code ? "&language=" + l.code : "");
    },
    initialize: function(){
        if (this.$isEditMode) {
    ...
    appendIE9Compatibility: function(btns, $skin){
        ...
        self.uploadFrameHandler = function(){
            ...
            if (self.onuploadFrameLoad) {
                ...
                self.form.setAttribute("action", self.articleParent.parseExpression(self.getDataType().$url));
    ...
    _matchOfficeType: function($type, $acceptedTypes){
        var groups = [["msword", "officedocument.word"], ["ms-excel", "officedocument.spreadsheet"], ["ms-powerpoint", "officedocument.presentation"]];
    ...
    _setFile: function(file){
        ...
        if (file) {
            ...
            $fileUrl = self.articleParent.parseExpression($fileUrl || self.$dataUrl);
