...
function _onBeginUpload(field, file) {
	...
	field.progressValue.className = "s-progress-value";
	field._progress.appendChild(field.progressValue);
	field.selectBtn.parentNode.insertBefore(field._progress, field.selectBtn);
...
exports.DocumentField = helpers.defineClass(DocumentField, Field, {
	...
	setState: function(state) {
		...
		if (state.$isReadOnly !== undefined) {
			syra_site.dom.toggleClass(this._dataValue, "s-readonly", state.$isReadOnly);
	...
	highlightOnEnter: function(on, event, target) {
		...
		if (!this.$isDisabled) {
			this.selectBtn && syra_site.dom.toggleClass(this.selectBtn, "s-enter", on);
			this.removeBtn && syra_site.dom.toggleClass(this.removeBtn, "s-enter", on);
		}
	},
	_renderEditMode: function() {
		...
		var addButton = this.$item.$inplace ? syra_menus.addIconButton : syra_menus.addTextButton;

		this.selectBtn = addButton(syra_local.fdocSelectFile, this.$skin + "-doc-btn s-field-doc-upload", "onSelectClick", null, "upload");
		slot.appendChild(this.selectBtn);

		this.removeBtn = addButton(syra_local.fdocRemoveFile, this.$skin + "-doc-btn s-field-doc-remove", "onRemoveClick", null, "cancel");
		_showBtn(this, this.removeBtn, false);
		slot.appendChild(this.removeBtn);
	...
	_renderDetailMode: function() {
		...
		if (this.anchor) {
			...
			syra_site.dom.removeChild(this.anchor);
		}
		this.anchor = document.createElement("a");
		this.anchor.className = $skin + "-link";
		this.anchor.syraOnClick = "onInputFieldClick";
