...
exports.DocumentField = helpers.defineClass(DocumentField, Field, {
	...
	appendIE9Compatibility: function(btns, $skin) {
		...
		self.uploadFrameHandler = function() {
			...
			if (self.onuploadFrameLoad) {
				...
				self.inputFile.setAttribute("id", inputFileId);
				self.inputFile.setAttribute("name", "datafile");
				self.inputFile.style.width = "0px";
				self.inputFile.style.height = "0px";
				self.inputFile.style.visibility = "hidden";
				self.form.appendChild(self.inputFile);
	...
	_appendActions: function($skin) {
		...
		document.site.setSpecificAttributes(this.inputFile);
