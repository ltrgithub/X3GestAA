...
exports.DocumentField = helpers.defineClass(DocumentField, Field, {
    ...
    _onBeginUpload: function(file){
        ...
        this._legend.textContent = this.getLocalize().fdocUpload + ":" + " " + file.name + " 0%";
    },
    _onProgressUpload: function(file, progress){
        this._legend.textContent = this.getLocalize().fdocUpload + ":" + " " + file.name + " " + progress + "%";
        this.progressValue.style.width = progress + "%";
    },
    _onEndUpload: function(file){
        var self = this;
        self._legend.textContent = file.name + " " + this.getLocalize().fdocUploaded;
        ...
        setTimeout(function(){
            ...
            self._legend.textContent = self.getLocalize().fdocDropSelectFile;
        }, 1500);
    },
    ...
    _appendActions: function($skin){
        ...
        this.selectBtn.setAttribute("title", this.getLocalize().fdocSelectFile);
        this.selectBtn.textContent = this.getLocalize().fdocSelectFile;
        ...
        this.removeBtn.setAttribute("title", this.getLocalize().fdocRemoveFile);
        this.removeBtn.textContent = this.getLocalize().fdocRemoveFile;
    ...
    _renderEditMode: function(){
        ...
        this._legend.textContent = this.getLocalize().fdocDropSelectFile;
        ...
        if (file) {
            ...
            if (file.type !== undefined && this.$field.$acceptedTypes) {
                if (this.$field.$acceptedTypes.indexOf(file.type) < 0) {
                    errors.push(this.getLocalize().fdocNotSupported);
                }
            }
            if (this.$field.$maxByteLength && file.size > this.$field.$maxByteLength) {
                errors.push(this.getLocalize().fdocTooLarge);
            }
            if (errors.length > 0) {
