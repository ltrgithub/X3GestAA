...
exports.DocumentField = helpers.defineClass(DocumentField, Field, {
	...
	_appendActions: function($skin) {
		...
		this.selectBtn.syraOnClick = "onSelectClick";
		this.selectBtn.textContent = this.selectBtn.title = this.localize.fdocSelectFile;
		btns.appendChild(this.selectBtn);

		this.removeBtn = document.createElement("a");
		this.removeBtn.className = $skin + "-remove";
		this.removeBtn.syraOnClick = "onRemoveClick";
		this.removeBtn.setAttribute("href", "#");
		this.removeBtn.textContent = this.removeBtn.title = this.localize.fdocRemoveFile;
