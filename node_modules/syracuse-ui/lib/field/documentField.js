...
exports.DocumentField = helpers.defineClass(DocumentField, Field, {
	...
	dispose: function() {
		...
		if (this._imgLoader) {
			this._imgLoader.onload = this._imgLoader.onerror = null;
		}
		this._imgLoader = this._progress = this._info = this._imageWait = this._legend = this._file = this._imageArea = this.anchor = this.imageUrl = null;
		if (this.uploadFrame) {
