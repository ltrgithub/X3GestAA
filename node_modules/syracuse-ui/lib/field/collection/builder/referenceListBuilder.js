...
exports.Builder = helpers.defineClass(ReferenceListBuilder, ListBuilder, {
    initialize: function(){
    ...
    _addMenus: function(){
        ...
        self.list._menus = document.itemFactory.load($(self.list._topbar.appendChild(div)), {
            $id: self.list.id + "menus",
            $category: "links",
            $skin: self.list.$layoutOptions.menus
        }, self.list);
        self.list._menus.addMenuItem({
            $bind: "$linkRecords",
            $title: localize.rlist_link,
            $category: "link"
