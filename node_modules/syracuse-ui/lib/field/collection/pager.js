...
exports.Pager = helpers.defineClass(Pager, null, {
    ...
    draw: function(){
        ...
        if (this.list.$totalResults) {
            ...
            if (pageTotal <= 1) {
                $$range.text(this.list.$totalResults + " " + this.list._localize.pager_totalRecords);
            }
            else {
                var lastRecordIndex = Math.min((this.list.$startIndex + this.list.$itemsPerPage) - 1, this.list.$totalResults);
                $$range.text(this.list.$startIndex + " - " + lastRecordIndex + " " + this.list._localize.pager_itemOf + " " + this.list.$totalResults);
