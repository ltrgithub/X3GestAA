...
exports.QuantityField = helpers.defineClass(QuantityField, Field, {
	...
	_createValueContainer: function() {
		this._core = this._dataValue = this.domValueSlot = document.createElement("div");
	...
	setFieldWidth: function() {
		if (this.$isEditMode && !this.hasFreeWidth && !this.$item.$rows && !this.$item.$inplace && this.domValueSlot && !this.$item.$isAutoSizeDisabled) {
			...
			this.unitField.domValueSlot.style.maxWidth = this.numField.domValueSlot.style.maxWidth = this.widthValue + "px";
		}
	},
