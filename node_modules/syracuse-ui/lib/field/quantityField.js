...
exports.QuantityField = helpers.defineClass(QuantityField, Field, {
    ...
    setDataBind: function(value, record, metaData, $bind){
        // num field data bind
        this.numField && this.numField.setDataBind(value, record, metaData, $bind);
        
        // unit field data bind
        //var $unitBind = this.unitField.$item.$bind;
        //var unitValue = record[$unitBind];
        this.unitField && this.unitField.setDataBind(record[this.unitField.$item.$bind], record, metaData, this.unitField.$item.$bind);
    },
