...
//link.rel = "stylesheet";
//link.href = "/syracuse-ui/themes/desktop/sage/timeline/timeline.css";
//	
...
var TimelineWrapper = helpers.defineClass(function TimelineWrapper(article) {
	...
	afterBodyLoad: function() {
		...
		img.src = "/syracuse-ui/themes/desktop/sage/timeline/icons/ajax-loader.gif";
	...
	populateJSON: function() {
		...
		for (var j = this.firstRow; j < nbRows; j++) {
			...
			this.timelineJSON.events[i] = {
				...
				'icon': '/syracuse-ui/themes/desktop/sage/timeline/icons/ico_' + wClassName + '.png',
