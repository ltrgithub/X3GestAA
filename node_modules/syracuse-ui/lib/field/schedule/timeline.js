...
window.Timeline_ajax_url = '/syracuse-ui/deps/Timeline/timeline_ajax/simile-ajax-api.js';
window.Timeline_urlPrefix = '/syracuse-ui/deps/Timeline/timeline_js/';
...
require('syracuse-ui/deps/Timeline/timeline_ajax/simile-ajax-api');
require('syracuse-ui/deps/Timeline/timeline_js/timeline-api');
...
//			that.article.externalCall("MOVE_ORDER", [I,DS,DE]);
	...
	setupFilterHighlightControls:function (div, timeline, bandIndices, theme) {
		...
		function flthov(el){el.className='s-timeline-flthov';}
