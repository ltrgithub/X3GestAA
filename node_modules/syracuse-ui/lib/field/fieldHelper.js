...
exports.applyFieldStyle = function(field, metaData){
    if (metaData.$fieldStyle || metaData.$valueStyle) {
        var target = field._input ? field._input : field._dataValue;
        if (field.page.$isFusionPage) {
            ...
            field.$valueStyle = metaData.$fieldStyle || metaData.$valueStyle;
            target.setAttribute("style", field.$valueStyle);
        }
        else {
            if (field.$valueStyle) {
    ...
    if (field.domTitle && metaData.$fieldStyle || metaData.$titleStyle) {
        if (field.page.$isFusionPage) {
            if (field.$titleStyle) {
                var curStyle = field.domTitle.getAttribute("style") || "";
                field.domTitle.setAttribute("style", curStyle.replace(field.$titleStyle, ""));
            }
            field.$titleStyle = metaData.$fieldStyle || metaData.$titleStyle;
            field.domTitle.setAttribute("style", field.$titleStyle);
        }
        else {
            if (field.$titleStyle) {
