...
exports.drawDiagnose = function(field, $diagnose, severityGroup){
    fieldDiagnoseUtils.drawDiagnose(field, $diagnose, severityGroup);
}

exports.emptyDiagnoseSlot = function(field){
    fieldDiagnoseUtils.emptyDiagnoseSlot(field);
}


exports.ensureDiagnoseSlot = function(field){
    fieldDiagnoseUtils.ensureDiagnoseSlot(field);
}

exports.showErrors = function(field, errors, options){
    fieldDiagnoseUtils.showErrors(field, errors, options);
}

exports.showDiagnoses = function(field, diagnoses, options){
    fieldDiagnoseUtils.showDiagnoses(field, diagnoses, options);
}

exports.toggleDiagnose = function(field, css, show){
    fieldDiagnoseUtils.toggleDiagnose(field, css, show);
}
