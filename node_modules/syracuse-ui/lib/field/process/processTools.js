...
exports.appendText = function(forme, container) {
	...
	div.setAttribute('style', 'position:absolute; left:' + forme.xcaptionPos.xleft + 'px; top:' + top + 'px;width: ' + (forme.xcaptionSize.xwidth) + 'px; height: ' + (forme.xcaptionSize.xheight + 10) + 'px; ' + shadow + "vertical-align:" + forme.xcaptionProps.xvertAlignMode + '; z-index:' + forme.xlevel);
	var $$div = $(div);
