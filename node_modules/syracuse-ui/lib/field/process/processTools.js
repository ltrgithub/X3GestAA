...
exports.appendText = function(forme, container) {
	...
	style = 'position:absolute; left:' + forme.xcaptionPos.xleft + 'px; top:' + forme.xcaptionPos.xtop + 'px; width: ' + forme.xcaptionSize.xwidth + 'px; height: ' + (forme.xcaptionSize.xheight + 10) + 'px;';
	style += ' ' + shadow + "vertical-align:" + forme.xcaptionProps.xvertAlignMode + '; z-index:' + forme.xlevel + ';';
