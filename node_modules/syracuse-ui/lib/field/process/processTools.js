...
function _createShadow(xprop) {
	"<filter id='shadow" + xprop.uniqueID + "'>" +
...
exports.appendText = function(forme, cont) {
	var text = "";
	var shadow = '';
	...
	div.attr('style', 'position:absolute; left:' + forme.xcaptionPos.xleft + 'px; top:' + top + 'px;width: ' + (forme.xcaptionSize.xwidth) + 'px; height: ' + (forme.xcaptionSize.xheight + 10) +
		'px; ' +
		shadow +
		"vertical-align:" +
