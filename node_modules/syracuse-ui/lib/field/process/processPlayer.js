    ...
    show: function () {
        ...
        function createAction(action, index, array) {
           ...
           function clickHdl() {
            ...
            var trigger = $$container.find('.trigger' + action.id);
            ...
            switch (action.type) {
                case 'shotip':
                    $$container.find('.target' + action.id).hide();
                    trigger.mouseover(function (e) {
                    $$container.find('.target' + action.id).css('display','block');
                    }) ;
                    trigger.mouseout(function (e) {
                        $$container.find('.target' + action.id).css('display','none');
                    }) ;
                ...
                case 'sho':
                    ...
                    trigger.click(function () {
                        $$container.find('.target' + action.id).show();
                    });
                    break;
                       ...
                       targ.hide() ;
                        ...
                        $$container.click(function(e){
                            ...
                            if (!($(e.currentTarget).is('.trigger'+action.id)) && parenttrigger.size()==0 &&  //
                                !($(e.currentTarget).is('.target'+action.id)) && parenttarget.size()==0)
                                targ.hide() ; 
                        }
                            ) ;
                        break ;
                 ...
                 trigger.click(function (e) {
                    array.forEach(function(a,index,array){
                        if (a.type==="shopopmenu" ){
                            var targets=$$container.find('.target' + a.id ) ; //+':hidden') ;
                            var trig= $$container.find('.trigger' + a.id ) ;
        ...
        function addLink(index,el){
            //el.bind('click', function (e) {
               ...
               if (browsertype.msie){
                    var divtext=$$container.find("div#"+$(el).attr('id')+ 'p');
        ...
        //$$container.append(svgf);
            ...
            for (var gn = 0, sizeG = layers.length; gn < sizeG; gn++) {
                ...
                for (var i = 0; i < group.xpropsArr.length; i++) {
                    if (group.xpropsArr[i].xtext!= ''){
                        appendText(group.xpropsArr[i],$$container);
      ...
      actions.forEach(createAction);
            ...
            var textlinks = $$container.find('a');
