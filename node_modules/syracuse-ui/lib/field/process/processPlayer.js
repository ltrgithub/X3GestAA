            ...
            switch (action.type) {
                case 'shotip':
                    ...
                    var hide= e.currentTarget.firstChild==e.target ;//&& $(e.currentTarget).is('.trigger'+action.id) ;
                       ...
                       // if(hide)
                            svgplot.find('.target' + action.id).hide(600);
                ...
                case 'sho':
                    ...
                    trigger.click(function () {
                        svgplot.find('.target' + action.id).show(600);
                    });
                    break;

                    case 'shopopmenu':
<<<<<<< HEAD
                        var targ=$$container.find('.target' + action.id) ;
                       targ.hide() ;
...
>>>>>>> d61418e2f86dea0ffc34e9e350c5c671382b5d31
                        break ;
                case 'hide':
        ...
        function manageLink(index, el) {
            ...
            children.bind('click', function (e) {
                ...
                document.controller.openPage(self.field.articleParent, linksobj, null);
            });
        ...
        try {
            ...
            defs += '</defs>';
            var svgplot = $('<svg width=' + csize.x /*this.process.contentSize.xwidth*/ //
            +
                'px height=' + csize.y /*this.process.contentSize.xheight*/ + 'px >' + defs + result + '</svg>');
