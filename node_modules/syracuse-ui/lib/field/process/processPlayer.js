...
exports.RecordField = helpers.defineClass(RecordField, Field, {
    drawBox: function() {
...
exports.ProcessPlayer = helpers.defineClass(ProcessPlayer, null, {
    ...
    show: function() {
        ...
        debug && console.log("TabularChart._execLink: link.id=" + context.id  );
        link && /*this. */ _executeRecordMenu(context,fld);
        }
       ...
       function  _executeRecordMenu(context,fld) {
        ...
        var recordField ;
        if (!fld.recordField) {
            fld.recordField = new RecordField();
            
            fld.page.initializeNewItem(fld.recordField, {}, fld);
            fld.recordField.loadBox(item);
        } else {
            fld.recordField.applyChange(item);
        }
        var menuItem = fld.recordField.menuItems[Object.keys(item["$links" || "$actions"])[0]][0];
...
/*trigger.hover(function () {
        ...
        function manageLink(index, el) {
            ...
            children.bind('click', function(e) {
                ...
                /*this.*/ _execLink(linksobj,self.field) ;
