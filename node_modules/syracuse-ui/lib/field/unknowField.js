...
exports.UnknowField = helpers.defineClass(UnknowField, Field, {
    ...
    loadBox: function($$item){
        ...
        this._initCss();
        this._$cssTopField = "s-field-unknow " + this._$cssTopField;
        this._$cssField = "s-field-unknow " + this._$cssField;
        ...
        this.fieldValue.textContent = "Unknown: " + this.$item.$bind + "  type=" + (this.$field.$type || "");
    ...
    ssdhowAdvancedState: function(show){
        if (show) {
