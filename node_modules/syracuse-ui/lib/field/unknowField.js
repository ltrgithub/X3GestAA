...
exports.UnknowField = helpers.defineClass(UnknowField, Field, {
	...
	loadBox: function() {
		...
		switch (this.unknowMode) {
			case "nowidget":
				this.fieldValue.textContent = syra_site.localize.fieldUnknowType + ": " + this.$item.$bind + "  type=" + (this.$field.$type || "");
				break;
			case "noproto":
				this.isItemHidden = true;
				this.fieldValue.textContent = syra_site.localize.fieldNoProtoype + ": " + this.$item.$bind;
