...
exports.MultiArrayField = helpers.defineClass(MultiArrayField, ArrayField, {
	...
	fillList: function(dataRecordSet, parentDataRecord, isDelta) {
		...
		if (this.gridCardBuilder && this.gridCardBuilder.isOutCardMode) {
			this.selector.selectRecord(this.selector.getSelectedRecord() || this.records[0], true); //ensure selection
		}
	...
	onRowCardClick: function(event, btn) {
		this.gridCardBuilder.onRowCardOpenerClick(btn);
	},
	...
	appendCardGraphSlots: function() {
		...
		!$cardItem && this.gridCardBuilder && this.gridCardBuilder.removeOutCardSlot();
		...
		if ($cardItem || this.$item.$graphPosition) {
			...
			this.gridCardBuilder && $cardItem && this.gridCardBuilder.appendOutCardSlot();
