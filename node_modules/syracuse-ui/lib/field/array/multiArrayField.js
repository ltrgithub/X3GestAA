...
exports.MultiArrayField = helpers.defineClass(MultiArrayField, ArrayField, {
	enableDefaultDesigner: function() {
		this.switchDesigner = function(open) {
			...
			if (open && !self.designer) {
				require.async('syracuse-ui/lib/authoring/list/listDesigner', function(err, module) {
	...
	fillList: function(dataRecordSet, parentDataRecord, isDelta) {
		...
		this.showBody(true);
		this.setSortable();
		this.builder.list_onAfterFill && this.builder.list_onAfterFill(dataRecordSet, parentDataRecord, isDelta);
	},
	emptyBody: function() {
