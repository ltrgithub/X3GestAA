...
exports.MultiArrayField = helpers.defineClass(MultiArrayField, ArrayField, {
	...
	reloadLayout: function() {
		...
		this.setDataValue(parentDataset[this.$item.$bind], parentDataset.$properties && parentDataset.$properties[this.$item.$bind], parentDataset);
	},
	...
	initializeList: function() {
		...
		this.$pagePreferences = syra_pagePreferences.getField(this);
	...
	resizeArticle: function() {
		if (!this.disposed && syra_dom.isVisible(this.domItem)) {
			...
			this.chartField && this.chartField.resizeArticle && this.chartField.resizeArticle();
	...
	onNotifyDataChange: function(field, value) {
		if (field.$item.$bind == "$itemsPerPage") {
			...
			this.$pagePreferences.$itemsPerPage = this.paging.getItemsPerPage();
			this.saveListDesign();
			syra_pagePreferences.saveField(this, this.$pagePreferences);
