...
function _moveCols(colSource, colTarget, dropAtEnd) {
	...
	if (colSource.filter_cell) {
		var target = colTarget.filter_cell.slot;
		target.parentNode.insertBefore(colSource.filter_cell.slot, dropAtEnd ? target.nextSibling : target);
	}
