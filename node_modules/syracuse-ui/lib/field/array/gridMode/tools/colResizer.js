...
exports.ColResizer = ColResizer;

ColResizer.prototype.startMove = function() {
	var self = this;
...
ColResizer.prototype.endMove = function() {
	if (this.onmove) {
...
ColResizer.prototype.dispose = function() {
	if (this.titleRow) {
