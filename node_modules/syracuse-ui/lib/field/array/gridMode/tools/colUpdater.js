	...
	return {
		...
		stop: function(context) {
			if (context.isDragging) {
				...
				this.list.$pagePreferences.$columnWidths[this.colSource.$item.$bind] = this.colSource.$item.$width = Math.round(this.colSource.colWidth) + "px";
	...
	return new Draggable({
		...
		mousedown: function(event) {
			if (event.target) {
				...
				if (col) {
					this._ensureColResizer(col);
					this._updater = (col == this.resizingCol) ? _addResizer() : _addReorder();
