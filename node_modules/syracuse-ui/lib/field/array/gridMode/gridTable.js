...
exports.GridTable = helpers.defineClass(GridTable, null, {
	...
	_addColumn: function($key) {
		...
		col.titleCell.className = this.list.$skin + "-title-cell" + (this.isFreeze ? " s-freeze" : "");
	...
	addFieldCol: function($item, $field) {
		...
		col.titleLabel.className = this.list.$skin + "-title-cell-label";
		col.titleLabel.syraTip = 1;
	...
	addRowCardCol: function() {
		...
		this.list.gridCardBuilder.setRowCardOpenerIcon(opener, false);
