...
function _addTitleEmptyItem(col) {
	syra_dom.addDiv("s-grid-title-empty", col.titleCell);
...
exports.GridTable = _helpers.defineClass(GridTable, null, {
	...
	load: function(builder, isFixedCols, slot) {
		...
		this.headSlot = syra_dom.addDiv(css + "-slot-head");
		this.headTable = document.createElement("table");
		this.titleRow = document.createElement("tr");
		this.bodySlot = syra_dom.addDiv(css + "-slot-body");
	...
	_addFilterCell: function(col) {
		...
		syra_dom.addDiv("s-list-filter-cell-empty", td);
	...
	setColWidths: function(fitWidth) {
		var $prefWidths = ((this.builder.isTitleRowVisible !== false) && this.list.$userPreferences && this.list.$userPreferences.$columnWidths) || {};
