...
GridTable.prototype._addFilterCell = function(col) {
	var td = this.builder.filterRecord.cellsMap[col.key] = syra_dom.td("s-list-filter-cell");
	syra_dom.div("s-list-filter-cell-empty", td);
...
GridTable.prototype.addFieldCol = function($item, $field) {
	...
	col.titleCell.syraOnMouseMove = col.titleCell.syraResizerColId = col.titleCell.syraDragSpot = col.titleCell.syraReorderColId = this.list.id;
