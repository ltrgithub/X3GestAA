		...
		if (!(_activeList == list && _activeRecord == record)) {
			if (_activeList == list) {
				...
				list.page.externalAdapter.onFieldClickPicker({
					...
					pickerType: "openCard",
					doEvent: function() {
						_slotCard = syra_dom.div("s-popupcard-slot");
						_slotHeader = syra_dom.div("s-popupcard-slot-header", _slotCard);
						_slotBody = syra_dom.div("s-popupcard-slot-body", _slotCard);
