...
exports.addOutSlot = function(builder) {
	...
	if (!builder.outCardResizer) {
		builder.outCardResizer = _slotResizer.addCardResizer(builder);
	}
	var separator = builder.outCardResizer.separator;
...
exports.removeOutSlot = function(builder) {
	builder.outCardResizer && builder.outCardResizer.dispose();
