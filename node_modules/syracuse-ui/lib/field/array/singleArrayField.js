...
function _appendMenusBar(list) {
	if (list.$isMenuBarAtTop) {
		if (list.bodyInsert) {
			list.bodyInsert.parentNode.insertBefore(list.topbar, list.bodyInsert.parentNode.firstChild);
		} else {
...
exports.SingleArrayField = helpers.defineClass(SingleArrayField, ArrayField, {
	...
	emptyBody: function() {
		syra_dom.removeChild(this.topbar);
	...
	notifyActionChange: function(menuItem, target, value, notifyServer) {
		...
		if (value.$create) {
			...
			syra_form.updateDelta(this, sendBag.dataRecords);
		}
		_appendMenusBar(this);
	},
	endDrawBox: function() {
		...
		syra_dom.removeChild(this.topbarRightSlot); // not used for single field
