...
exports.GraphDecorator = helpers.defineClass(GraphDecorator, null, {
	...
	ensureGraphVisibility: function() {
		...
		this.list.isTableSlotHidden = this.list.$field.$isListHidden || (this.list.$item.$graphPosition == "front" && !(this.list.cardDecorator && this.list.cardDecorator.isOutCardMode));
