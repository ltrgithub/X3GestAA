...
exports.GraphDecorator = helpers.defineClass(GraphDecorator, null, {
    ...
    applyGraphSettings: function(list, metaData){
        ...
        if (list.$item.$graphMode != "list") {
            if (!this._graphSlot) {
                ...
                this._chart = list.page.loadNewItem($(this._graphSlot), {
    ...
    onWindowResize: function(initialize){
        this._chart && this._chart.onWindowResize && this._chart.onWindowResize(initialize);
    },
	setDataBind: function(dataRecordSet, parentDataRecord, metaData){
        this._chart.setDataBind(dataRecordSet, parentDataRecord, metaData);
	},
    dispose: function(){
        if (this._chart) {
