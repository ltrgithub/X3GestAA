...
exports.GraphDecorator = helpers.defineClass(GraphDecorator, null, {
	...
	ensureGraphVisibility: function() {
		...
		this.ensureGraph();
		this.list.tableSlot.style.display = (this.list.$item.$graphPosition == "front" && !this.list.outCardSlot) ? "none" : "";
	...
	applyDesignMetaData: function(metaData, designing) {
		...
		this.list.$item.$graphPosition = this.list.$item.$graphPosition || "bottom";
		if (metaData.$cube) {
