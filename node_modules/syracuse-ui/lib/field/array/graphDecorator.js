...
exports.GraphDecorator = helpers.defineClass(GraphDecorator, null, {
    _selectTab: function(){
        ...
        this._graphTab.className = showGraph ? "s-list-listgraph-tab-open" : "s-list-listgraph-tab";
    ...
    applyGraphSettings: function(list, metaData){
        ...
        if (list.$item.$graphMode != "list") {
            if (!this._graphSlot) {
                ...
                list.$$fieldValue[0].appendChild(this._wrapper);
                ...
                list.chart = document.itemFactory.load($(this._graphSlot), {
                    ...
                    $choiceType: list.$item.$choiceType,
                    $bind: list.$item.$bind
