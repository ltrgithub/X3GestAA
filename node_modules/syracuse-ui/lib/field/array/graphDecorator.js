...
exports.GraphDecorator = helpers.defineClass(GraphDecorator, null, {
	...
	ensureGraphVisibility: function() {
		...
		if (this.list.menusBox) {
			document.site.dom.toggleClass(this.list.menusBox.domTitle, "s-list-graph-switch-on", true);
		}
		this.ensureGraph();
	...
	removeSlot: function() {
		document.site.dom.removeChild(this.separator);
		document.site.dom.removeChild(this.graphSlot);
