...
exports.GraphDecorator = helpers.defineClass(GraphDecorator, null, {
	...
	_showSwitchMenu: function() {
		this.list.applyActionLinkChange({
			$links: {
				"$toggleGraph": {
					$title: this.list.$item.$isGraphTabVisible ? this.list.localize.flSwitchToList : this.list.localize.flSwitchToGraph,
					$iconValue: this.list.$item.$isGraphTabVisible ? "switch-to-list" : "switch-to-graph"
				}
			}
		});
	},
