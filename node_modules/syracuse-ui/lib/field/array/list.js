...
exports.DesktopList = helpers.defineClass(DesktopList, Article, {
    ...
    ensureDataRecords: function(){
        ...
        if (!dataRecords) {
            dataRecords = this.articleParent.dataset[this.$item.$bind] = [];
        }
        return dataRecords;
    },
    ...
    setDataBind: function(dataRecordSet, parentDataRecord, metaData){
        ...
        if (self.page.externalAdapter.setDataBind(self, dataRecordSet, parentDataRecord, metaData)) {
            if (metaData) {
                $isFullDelta = metaData.$isFullDelta;
            ...
            if (dataRecordSet !== undefined) {
                ...
                if ($isFullDelta || (!self.onClientFetch && self.page.isDeltaMode && self._store.hasRecords() && !self.builder.isSingleBuilder)) {
