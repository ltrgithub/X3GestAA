...
exports.DesktopList = helpers.defineClass(DesktopList, Article, {
            ...
            case "$query":
                ...
                if (this.page.$prototype.$filters) {
                    if (this.page.menuBar) {
                        ...
                        this._filtersMenus._ensurePrivateMenus({
                            $filters: {
                                $noFilters: {
                                    $title: this._localize.l_noFilter
                                }
                            }
                        }, "$filters");
                        this._noFiltersMenuItem = this.menuItems[Object.keys(this._filtersMenus._$registeredMenus)[0]][0];
                        this._noFiltersMenuItem.setStyle("nofilter");
    ...
    releaseMode: function(onDispose){
        ...
        this._noFiltersMenuItem = this.builder = this.domTitle = this._mandatoryFlag = this._description = this._helpFlag = null;
    },
    ...
    fitToWidth: function(){
        ...
        var isFusion = document.site.mainPage.$pageCategory === "fusion";
        ...
        var s = first.menuBoxes && first.menuBoxes.length > 0 ? first.menuBoxes[0].$$item[0].clientWidth : 0;
        var currentSize = s;
        if (first.menuItems) {
