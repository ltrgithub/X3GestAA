		...
		if (this.$item.$cards || this.$item.$graphPosition) {
			...
			if (this.$item.$cards) {
				switch (this.$item.$cards.$position) {
					case "left":
						...
						break;
					case "right":
						this.tableSlot.parentNode.appendChild(this.outcardSeparator);
						this.tableSlot.parentNode.appendChild(this.outCardSlot);
						this.outcardSeparator.className = "s-list-outcard-sep-cell";
						this.outCardSlot.className = "s-list-outcard-slot-cell";
						break;
					case "top":
			...
			switch (this.$item.$graphPosition) {
				case "left":
					...
					break;
				case "right":
					this.tableSlot.parentNode.appendChild(this.graphSeparator);
					this.tableSlot.parentNode.appendChild(this.graphSlot);
					this.graphSeparator.className = "s-list-graph-sep-cell";
					this.graphSlot.className = "s-list-graph-slot-cell";
					break;
				case "top":
