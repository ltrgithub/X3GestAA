...
exports.DesktopList = helpers.defineClass(DesktopList, Article, {
	getListFomatter: function() {
		return syra_list[this.$item.$format];
	},
	...
	applyMetaData: function(metaData) {
		...
		if (metaData.$type === undefined) {
			...
			if (metaData.$item && metaData.$item.$properties) {
				...
				var formatter = this.getListFomatter();
				var builder = formatter && formatter.builder;
				builder && builder.applyMetaDataRecords && builder.applyMetaDataRecords(this, $metaRecord);
			}
	...
	dispose: function() {
		...
		this._dataValue = this.globalMetaRecords = null;
	...
	selectHTMLContent: function() {
		...
		this.scrollTable && this.scrollTable.headTable && range.selectNode(this.scrollTable.headTable);
