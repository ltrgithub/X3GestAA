...
exports.DesktopList = helpers.defineClass(DesktopList, Article, {
	...
	scrollToField: function(field) {
		if (this.builder && this.builder.list_scrollToField) {
			this.builder.list_scrollToField(field);
		} else {
	...
	scrollToRecord: function(record) {
		if (record) {
			if (this.builder && this.builder.list_scrollToRecord) {
				this.builder.list_scrollToRecord(record);
			} else {
