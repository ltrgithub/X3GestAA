...
exports.DesktopList = helpers.defineClass(DesktopList, Article, {
    ...
    setDataBind: function(dataRecordSet, parentDataRecord, metaData){
        ...
        if (dataRecordSet !== undefined) {
            if (this.page.$isPartialDelta || (this.page.isDeltaMode && this.hasRecords() && !this.builder.isSingleBuilder)) {
    ...
    dispose: function(){
        ...
        this.helper = this.reorderCapability = this._menus = this.page = this.treeDecorator = this.menuPicker = this._menusBox = null;
        Article.prototype.dispose.call(this);
    },
    
    setFocus: function(name, $serverIndex){
        var record = listHelper.findRecordByServerIndex(this, $serverIndex);
