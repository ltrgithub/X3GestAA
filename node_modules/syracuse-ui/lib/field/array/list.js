...
exports.DesktopList = helpers.defineClass(DesktopList, Article, {
    ...
    loadBox: function(initData){
        ...
        if (this.page.$facet == "$lookup") {
            this.page.dialogWrapper.lookupList = this;
        }
    ...
    setDataBind: function(dataRecordSet, parentDataRecord, metaData){
        ...
        if (this.page.$facet == "$lookup") {
            this.page.dialogWrapper.onFillLookupList();
        }
    },
    validate: function(){
    ...
    setFocus: function(name, $serverIndex){
        var field;
        if ((field = this.getField(name, $serverIndex,true))) {
            return field.focus();
        }
        else {
    ...
    getField: function(name, $serverIndex,select){
        ...
        if (record && !record.disposed) {
            if ((fields = record.boundFields[name]) && fields.length > 0) {
                var found = fields[0];
                if (this.builder.popupCard && this.builder.popupCard.dialog && select) this.unSelectLines($serverIndex);
                if (record.cardview && this.builder.recordCardView == record) {
