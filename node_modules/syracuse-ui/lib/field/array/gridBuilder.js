...
var _gridFilter = require('syracuse-ui/lib/filter/gridFilter');
...
function _checkHeaderVisibility(builder) {
	...
	if (filter && filter.filterable !== filterable) {
		filter.filterable = filterable;
		syra_dom.hide(filter.fixedRow, !filterable);
		syra_dom.hide(filter.dataRow, !filterable);
	}
