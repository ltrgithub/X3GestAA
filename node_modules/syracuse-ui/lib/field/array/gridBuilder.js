...
exports.GridBuilder = helpers.defineClass(GridBuilder, null, {
	...
	record_draw: function(record) {
		...
		for (var ii = 0, jj = this.allColumns.length; ii < jj; ii++) {
			...
			if (col == this.columnsMap.rowCard) {
				record[col.table.$rowKey].appendChild(this.cardDecorator.appendRowCardOpener(record, col));
				continue;
			}
	...
	record_onShowSelection: function(record, selected) {
		...
		selected && this.list.setFocusRecord(record);
	...
	dispose: function(removeItem) {
		if (removeItem) {
			...
			this.cardDecorator && this.cardDecorator.removeOutCardSlot();
		}
