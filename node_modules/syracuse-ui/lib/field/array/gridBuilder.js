...
exports.Builder = helpers.defineClass(Builder, null, {
	...
	reorderItem: function(record, target, isAfter) {
	...
	onResizeRecord: function(record, doResize, boxParent) {
	...
	onRecordApplyChange: function(record, metaData) {
		this.cardDecorator.onRecordApplyChange(record);
	},
	onRecordMenuClick: function(record, menuItem) {
		...
		switch (menuItem.$sourceBind) {
			...
			case "$last":
				...
				break;
			case "$recordCard":
				_popupCardBuilder.togglePopup(this);
				return false;
			default:
	...
	doRecordMenuClick: function(record, $newIndex) {
