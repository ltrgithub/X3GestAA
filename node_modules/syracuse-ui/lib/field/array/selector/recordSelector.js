...
exports.RecordSelector = helpers.defineClass(RecordSelector, null, {
	...
	selectRecord: function(record, selected) {
		if (record) {
			...
			if (record.list.builder.record_onShowSelection) {
				record.list.builder.record_onShowSelection(record, selected);
			} else {
			...
			if (this.list) {
				...
				if (selected && !this.list.$field.$isFusionNavigationList && page && !page.isNavigationPage && page.lastSelectedList != this.list) {
