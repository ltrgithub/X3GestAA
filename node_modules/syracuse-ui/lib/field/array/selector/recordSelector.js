...
exports.RecordSelector = helpers.defineClass(RecordSelector, null, {
	...
	highlightOnEnter: function(host, on, event, target) {
	...
	addCheckBox: function(record, slot, isCheck) {
		...
		syra_fields.renderCheckBock(host, host.id + "-recordSelector", "", !isCheck);
