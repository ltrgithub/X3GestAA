...
exports.SelectorCardRecord = helpers.defineClass(SelectorCardRecord, Article, {
	dispose: function() {
		...
		if (this._popupSlot) {
			syra_site.dom.removeChild(this._popupSlot);
		}
		this.slot = this.menusSlot = this.popupCard = this._popupSlot = null;
	...
	onMenuClick: function(menuItem) {
		if (menuItem.$sourceBind && menuItem.$subRecordKey == "$selectorField") {
			syra_controller.executeMenu(menuItem, null, this.list.recordsMap[this.dataset.$uuid]);
			return false;
		}
		return true;
	},
	onLookupClick: function(field) {
		if (field.$item.$bind == "$selectorField") {
			...
			self.popupCard = syra_site.dialogManager.openPopup(self, {
				content: field,
