...
exports.SelectorCardRecord = helpers.defineClass(SelectorCardRecord, Article, {
	dispose: function() {
		...
		this._popupSlot && syra_site.dom.removeChild(this._popupSlot);
	...
	loadBox: function() {
		...
		this.applyChange(this.list.metaHelper.ensureGlobalMetaRecord(this.list));
	},
	...
	onLookupClick: function(field) {
		if (field.$item.$bind == "$selectorField") {
			...
			self.popupCard = syra_site.dialogManager.openPopup(self, {
				...
				onOpened: function() {
					self.list.builder && self.list.builder.resizeScrollView(field.input.clientWidth);
