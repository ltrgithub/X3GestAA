...
exports.MultiList = helpers.defineClass(MultiList, DesktopList, {
	...
	dispose: function() {
		...
		this.focusedRecord = this.capabilityMaker = this.garbage = this.selector = this.treeDecorator = this.graphDecorator = this.selectorCardRecord = this._autoInsertFields = null;
