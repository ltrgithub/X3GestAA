...
exports.MultiList = helpers.defineClass(MultiList, DesktopList, {
	initializeList: function() {
		this.$userPreferences = (this.page.getFieldUserPreferences && this.page.getFieldUserPreferences(this.$item.$bind)) || {};
		...
		if (this.$prototype.$cube || (this.$prototype.$decorator && this.$prototype.$decorator.$stereotype)) {
			...
			if (!this.page.isVignettePage) {
				this.$isQuickDesignerDisabled = this.$item.$isQuickDesignerDisabled !== false;
			}
		}
	...
	onNotifyDataChange: function(field, value) {
		if (field.$item.$bind == "$itemsPerPage") {
			...
			this.saveArticleUpdate(false, this.saveUserPreferences(field.$item.$bind));
			this.triggerFetch();
		}
		return false;
	},
