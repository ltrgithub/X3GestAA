...
exports.MultiList = helpers.defineClass(MultiList, DesktopList, {
	...
	hasFieldFilterCapability: function($field) {
		return $field.$capabilities && ($field.$capabilities.indexOf("filter") >= 0);
	},
	initializeList: function() {
		...
		for (var ii = 0, jj = $binds.length; ii < jj; ii++) {
			...
			if (!$field.$isExcluded && this.hasFieldFilterCapability($field)) {
