			...
			case "$query":
				if (this._hasVisibleFilters()) {
					if (this.page.menuBar) {
						...
						this.serverFilters.noFilters.menusBuilder.setStyle(this.serverFilters.noFilters, "nofilter");
