...
exports.MultiList = helpers.defineClass(MultiList, DesktopList, {
	...
	toggleFocusRecord: function(record, focused) {
		this.focusedRecord = focused ? record : null;
		syra_site.dom.toggleClass(record.domItem, "s-record-focused", focused);
	},
	...
	highlightSelection: function(record, selected) {
		...
		lastFocus && this.toggleFocusRecord(lastFocus, false);
