	...
	selectServerFilter: function(filterId) {
		if (this.serverFilters) {
			if (this.serverFilters.selected) {
				document.site.dom.toggleClass(this.serverFilters.selected.mn, "s-selected", false);
			...
			document.site.dom.toggleClass(this.serverFilters.selected.mn, "s-selected", true);
		}
	},
