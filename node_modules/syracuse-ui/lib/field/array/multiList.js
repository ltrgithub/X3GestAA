...
exports.MultiList = helpers.defineClass(MultiList, DesktopList, {
	...
	drawBox: function() {
		...
		this.builder && this.builder.list_onAfterDraw();
	},
	...
	applyDesignMetaData: function(metaData, designing) {
		...
		this.builder && this.builder.list_onAfterApplyDesignMetaData && this.builder.list_onAfterApplyDesignMetaData(metaData, designing);
	},
	...
	fillList: function(dataRecordSet, parentDataRecord, isDelta) {
		...
		if (this.builder && this.builder.list_onAfterFill) {
			this.builder.list_onAfterFill();
		}
	},
		...
		if (field) {
			...
			if (this.isClientFetch && !this.findRecordByServerIndex($serverIndex)) {
				...
				if (field) {
					...
					record && this.selector.selectRecord(record.$uuid, true);
					return field.focus(select);
				}
			}
		}
