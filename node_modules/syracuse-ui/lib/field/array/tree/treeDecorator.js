...
exports.TreeDecorator = helpers.defineClass(TreeDecorator, null, {
    ...
    onEndFillList: function(){
        ...
        for (var ii = 0, jj = this.list.records.length; ii < jj; ii++) {
            ...
            if (record.treeNode.parentRecord && !$isNodeLazyLoad && !hasChildren) {
                record.treeNode.slot.style.paddingLeft = (record.treeNode.level * 18) + 18 + "px";
            }
            else {
                record.treeNode.slot.style.paddingLeft = (record.treeNode.level * 18) + "px";
            }
        }
    },
