...
function PagingCapability(list){
    ...
    this.$startIndex = 1;
    this.list.pagingCapability = this;
    this.pageLinks = [];
}
...
exports.PagingCapability = helpers.defineClass(PagingCapability, null, {
    ...
    ensureItemsPerPage: function(){
        this._$itemsPerPage = this._$itemsPerPage || 50;
    },
    ...
    draw: function(){
        if (this._$$item) {
            ...
            if (!this.list.isClientPagingPerPageDisable && this._$totalResults) {
                ...
                if (pageTotal <= 1) {
                    range.textContent = this._$totalResults + " " + this.list.localize.flPagerTotalRecords;
                }
                else {
                    /*var lastRecordIndex = Math.min((this.$startIndex + this._$itemsPerPage) - 1, this._$totalResults);
                     range.textContent = this.$startIndex + " - " + lastRecordIndex + " " + this.list.localize.flPagerItemOf + " " + this._$totalResults;
                     */
                    range.textContent = this._$totalResults + " " + this.list.localize.flPagerTotalRecords;
    ...
    _appendItemsPerPage: function(){
        if (this._$itemsPerPage) {
            ...
            domSize.appendChild(label).textContent = this.list.localize.flPagerPageSize + ":";
            var div = document.createElement("div");
