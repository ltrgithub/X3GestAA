...
exports.Pager = helpers.defineClass(Pager, null, {
	...
	load: function(list, slot) {
		...
		if (!this.list.isClientPagingPerPageDisable && this.list.pagging.$totalResults !== undefined) {
			...
			var pageTotal = Math.ceil(this.list.pagging.$totalResults / this.list.pagging.getItemsPerPage());
			var currentPageIndex = Math.ceil(this.list.pagging.$startIndex / this.list.pagging.getItemsPerPage());
	...
	dispose: function() {
		...
		this.designHideLinkSlot = this.designHideLink = this.list = this._serverSteps = this._item = this._itemsPerPageField = this.pages = null;
	}
});