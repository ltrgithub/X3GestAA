...
function _search(list, value, next, notFound) {
	...
	for (var ii = startIndexes.row;
		...
		for (var jj = startIndexes.col;
			...
			if (dataset[searcher.orderCols[jj].$bind] && _compare(value, dataset[searcher.orderCols[jj].$bind], searcher.orderCols[jj])) {
