...
exports.FieldsSelector = helpers.defineClass(FieldsSelector, null, {
    load: function(list, $$container){
        ...
        self.$$item.delegate("a[data-s-status]", "click", function(){
            ...
            if (status.indexOf("frozen") >= 0) {
                ...
                this.className = "s-list-design-fields-" + status;
            }
            else {
            ...
            $$list.$$ul.children("li").toggleClass("s-list-design-fields-selected", select);
            this.className = select ? "s-list-design-fields-unselect-all" : "s-list-design-fields-select-all";
            return false;
        });
    },
    ...
    _addItem: function(itemList, $bind, $field){
        ...
        itemList.$status.forEach(function($status){
            ...
            btn.className = "s-list-design-fields-" + $status;
            $(btn).prependTo($$li);
        });
    },
