...
function _removeRecord(record, removeDom){
    if (record.list) {
        record.list.updateGridDiagAlert(false, record); // update grid diagnose alert
...
exports.fillList = function(list, dataRecordSet, parentDataRecord, isDelta){
    if (list.isClientFetch && list.paging) {
        //reset clientTotal result 
        delete list.paging.clientTotalRecords;
    }
    ...
    if (isDelta) {
        ...
        if (list.paging) {
            firstIndex = list.paging.$startIndex;
            if (firstIndex !== undefined) {
                --firstIndex;
                if (list.paging.$itemsPerPage !== undefined) {
                    lastIndex = firstIndex + list.paging.$itemsPerPage;
                }
            }
        }
        ...
        if (lastIndex) {
            if (list.records.length > list.paging.$itemsPerPage) {
                while (list.records.length > list.paging.$itemsPerPage) {
            ...
            if (list.isClientFetch && (list.dataset.length <= firstIndex || (list.records.length < list.paging.$itemsPerPage && list.records.length < (list.dataset.length - firstIndex)))) {
                list.paging.setPage(0);
            }
        }
        ...
        if (dataRecordSet) {
            var $startIndex = 1;
            var $itemsPerPage = list.paging.$itemsPerPage || dataRecordSet.length;
            ...
            if (list.isClientFetch && list.paging) {
                list.paging.ensureItemsPerPage();
                if (list.onClientFetch) {
                    list.paging.clientTotalRecords = dataRecordSet.length;
                    $startIndex = list.paging.$startIndex;
                    $itemsPerPage = list.paging.$itemsPerPage;
                }
                else {
                    if (dataRecordSet.length > list.paging.$itemsPerPage) {
                        var options = list.paging.goToClientPage();
