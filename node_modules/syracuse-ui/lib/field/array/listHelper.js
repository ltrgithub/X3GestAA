	...
	if (list.builder.scroller) {
		if (list.$item.$itemsPerPage >= 20) {
			...
			if (!list.leftScrollBtn) {
				if (!document.site.isScrolledIntoView($(list.builder.scroller._hscroller), document.site.mainPage.$$scrollview) && document.site.isScrolledIntoView($(list.builder._headTable), document.site.mainPage.$$scrollview)) {
			...
			if (list.leftScrollBtn) {
				list.leftScrollBtn.style.display = list.rightScrollBtn.style.display = "none";
			}
		}
	}
};
