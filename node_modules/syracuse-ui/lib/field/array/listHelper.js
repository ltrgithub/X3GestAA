	...
	if (metaData.$item) {
		if (metaData.$item.$properties) {
			...
			for (var ii = 0, jj = $binds.length; ii < jj; ii++) {
				...
				if ($updated) {
					if (!redraw) {
						redraw = ($metaField.$isHidden !== undefined) || ($metaField.$isReadOnly !== undefined) || ($metaField.$isDisabled !== undefined) || ($metaField.$fieldStyle !== undefined) || ($metaField.$valueStyle !== undefined) || ($metaField.$titleStyle !== undefined) || ($metaField.$title !== undefined);
					}
