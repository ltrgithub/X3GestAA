		...
		for (var ii = 0, jj = nodes.length; ii < jj; ii++) {
			...
			if (record) {
				...
				if (isCard) {
					...
					record.freezeRow && builder.freezeTable.bodyTable.appendChild(record.freezeRow);
					builder.scrollTable.bodyTable.appendChild(record.dataRow);
				}
