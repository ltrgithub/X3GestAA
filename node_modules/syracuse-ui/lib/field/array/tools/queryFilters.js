...
exports.addLinks = function(list) {
	...
	if ($filters && list.page.menuBar) {
		...
		if ($items.length) {
			...
			list.page.loadNewItem(list.page.menuBar.body, {
				$category: "menus",
				$skin: "s-mn-filters",
			...
			}, list.page).onMenuClick = function(menuItem) {
				list.filler.trigger(list, {
					$filters: menuItem.$item.$sourceBind
				});
				return false;
			};
			syra_menus.menus.applyChange(list.page, {
				$links: $links
			});
