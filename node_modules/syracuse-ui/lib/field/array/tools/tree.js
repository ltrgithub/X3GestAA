...
function _drawRecord(tree, parentNode, record, level) {
	...
	record.treeNode.slot.style[syra_context.isRTL ? "paddingRight" : "paddingLeft"] = (record.treeNode.level * 22) + padding + "px";
	if (skinLevel) {
...
Tree.prototype.getRecordsCount = function() {
	...
	if (this.list.page.isFusionPage && syra_fusion.sapUtil.isEmptyGridDataRecordEx(this.list.$prototype.$item.$properties, this.list.records[count - 1].dataset)) {
