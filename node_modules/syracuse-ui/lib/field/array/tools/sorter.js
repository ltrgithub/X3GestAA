...
exports.render = function(list) {
	...
	if (isSorted && !list.cancelSortPicker) {
		list.cancelSortPicker = syra_menus.addIconButton(syra_local.flUnsort, list.$mnPickersCss, "onCancelSortClick", null, "unsort");
		list.cancelSortPicker.className += " s-mn-list-btn";
		list.topbar.insertBefore(list.cancelSortPicker, list.searcherSlot);
		list.onCancelSortClick = function() {
			exports.cancel(this);
		};
	} else {
		syra_site.dom.display(list.toggleGraphPicker, isSorted);
	}
};