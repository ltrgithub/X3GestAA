...
exports.SlotResizerDDAgent = helpers.defineClass(SlotResizerDDAgent, null, {
	start: function(dropItem) {
		...
		if (dropItem.resizeCard) {
			...
			this.slot = this.list.cardDecorator.outCardSlot;
			this.separator = this.list.cardDecorator.outCardSeparator;
		...
		document.site.getBoundingClientRect(this.slot, this);
	...
	onDragMouseUp: function(target, event) {
		...
		this.list.notifyDesignerUpdate(true);
