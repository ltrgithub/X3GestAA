...
function _ensureGraphVisibility(list) {
	...
	syra_site.dom.hide(list.builder.tableSlot, list.$field.$isListHidden || (list.$item.$graphPosition == "front" && !list.builder.isOutCardMode));
	syra_site.dom.hide(list.graphSlot, list.$item.$graphPosition == "behind");
}
