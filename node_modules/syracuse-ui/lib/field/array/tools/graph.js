...
function _setDataBind(list, parentDataRecord, metaData) {
	if (list.chartField && list.records) {
		...
		list.chartField.setDataBind(dataRecords, parentDataRecord, metaData);
	}
}
	...
	if (exports.isDefined(list)) {
		if (!list.toggleGraph) {
			...
			list.applyGrapDesignMetaData = function(metaData, designing) {
				...
				_draw(this);
				this.chartField && this.chartField.applyDesignMetaData && this.chartField.applyDesignMetaData(metaData);
			};
