	...
	if (list.$switchToList !== false) {
		...
		if (!list.page.isFusionPage) {
			syra_menus.applyChange(list, {
				$links: {
					$pptslide: {
						$title: list.chartField ? list.chartField.extendWidget.locale.highCharts_powerpointSlide : "",
						...
						$confirm: list.chartField ? list.chartField.extendWidget.locale.highCharts_installOfficeAddin : "",
