...
exports.Searcher = helpers.defineClass(Searcher, null, {
	unload: function() {
		...
		this.domItem = this._itemSearchField = this._fieldSlot = null;
	},
	load: function(list) {
		this.list = list;
		this.start = {};
		...
		this._itemSearchField = this.list.page.loadNewItem(this.domItem.appendChild(this._fieldSlot), {
			$bind: "$search",
