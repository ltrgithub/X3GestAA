	...
	drawBox: function() {
		...
		if (this.$addRefresh) {
			syra_menus.button.add({
				...
				css: this.$mnPickersCss + " s-mn-list-btn",
				iconOnly: true,
				fontIcon: "refresh",
				btnclick: function() {
					this.parent.filler.trigger(this);
				}
			});
		}
		...
		if (this.$addMaximize) {
			syra_site.maximizer.toggleButton(this, true, this.topbar, this.$mnPickersCss + " s-mn-list-btn");
		}
