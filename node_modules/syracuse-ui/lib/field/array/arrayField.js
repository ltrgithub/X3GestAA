...
exports.ArrayField = _helpers.defineClass(ArrayField, null, {
	load: function(initData) {
		...
		this.domItem = syra_dom.addDiv(this._$cssField);
		...
		this._core = syra_dom.addDiv("s-list-core");
		if (!this.topbar) {
			this.topbar = syra_dom.addDiv("s-list-topbar");
		}
		...
		this.topbarRightSlot = syra_dom.addDiv("s-list-topbar-right", this.topbar);
		this.pagerSlot = syra_dom.addDiv("s-pager", this.topbarRightSlot);
	...
	addReorder: function(record) {
		if (!record.reorderBtn) {
			record.reorderBtn = syra_dom.addDiv(record.$skin + "-reorder");
