...
exports.ArrayField = helpers.defineClass(ArrayField, Article, {
	...
	drawBox: function() {
		...
		syra_site.dom.hide(this.searcherSlot, true);
		...
		if (this.$addMaximize) {
			syra_site.maximizer.toggleButton(this, true, this.topbarRightSlot, this.$mnPickersCss);
		}
		...
		if (this.builder.showBody) {
			...
			if (show) {
				...
				if (!this.bodyInsert) {
					...
					syra_site.dom.removeChild(this.body);
				}
			}
		}
	},
	...
	appendTitle: function() {
		...
		if (this.domTitle) {
			syra_site.dom.hide(this.domTitle, true);
		}
	},
	...
	setTitle: function($title) {
		...
		if (this.domTitle) {
			syra_site.dom.hide(this.domTitle, this.getTitle().length == 0);
		}
	},
