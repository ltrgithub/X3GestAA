...
exports.ArrayField = helpers.defineClass(ArrayField, Article, {
	...
	drawBox: function() {
		...
		this.topbar.appendChild(this.pagerSlot);

		if (this.$addRefresh) {
			this.refreshPicker = syra_menus.addIconButton(syra_local.box_refresh, this.$mnPickersCss, "onRefreshClick", null, "refresh");
			this.refreshPicker.className += " s-mn-list-btn";
			this.refreshPicker.syrainout = this.id;
		...
		if (this.$addMaximize) {
			...
			this.maximizePicker.syrainout = this.id;
			this.maximizePicker.className += " s-mn-list-btn";
			this.topbar.appendChild(this.maximizePicker);
			this.onMaximizeClick = function() {
				syra_site.maximizer.maximizeItem(this);
				this.maximizePicker.className += " s-mn-list-btn";
			};
		}
	...
	onSortClick: function(event, btn) {
		_sorter.onSortClick(this, btn.syraValue, event);
	},
	onDesignOpenerClick: function() {
		syra_site.switchItemDesigner(this, !this.designer);
	},
	...
	onItemInOut: function(on, event, target) {
		if (target == this.refreshPicker || target == this.maximizePicker) {
