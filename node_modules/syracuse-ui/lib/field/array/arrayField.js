...
exports.ArrayField = helpers.defineClass(ArrayField, null, {
	...
	setDataValue: function(value, metaData, parentDataRecord) {
		...
		this.builder.list_onAfterSetDataBind && this.builder.list_onAfterSetDataBind(value, parentDataRecord, metaData);
	},
