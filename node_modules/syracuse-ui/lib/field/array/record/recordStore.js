...
exports.RecordStore = helpers.defineClass(RecordStore, null, {
    ...
    onReorder: function(sourceRecord, targetRecord, $insert){
        ...
        this._ensureRecordsIndex(sendBag);
    ...
    notifySelectRecords: function(selectedRecords){
        if (selectedRecords) {
            ...
            self._ensureRecordsIndex(sendBag);
    ...
    _ensureRecordsIndex: function(sendBag){
        var self = this;
        self._records.forEach(function(record, index){
            record.dataset.$index = record.$recordIndex = index;
            record.renderRowIndex();
        });
        sendBag.recordDataset.forEach(function(dataRecord){
            if (dataRecord.$index) {
                var record = self._map[dataRecord.$uuid];
                if (record) {
                    dataRecord.$index = record.$recordIndex;
                }
            }
        });
        self.checkMaxItems();
