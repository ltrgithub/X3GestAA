...
exports.FilterCell = helpers.defineClass(FilterCell, null, {
    addOperator: function(field){
        ...
        $(field._dataValue.appendChild(self._operator)).bind("click", function(){
            if (!self.listPopup) {
                self.$$list.empty();
                var operators;
        ...
        if (!self.$$list) {
            ...
            self.$$list = $(field._dataValue.appendChild(list)).delegate("a.s-list-filter-item", "click", function(){
