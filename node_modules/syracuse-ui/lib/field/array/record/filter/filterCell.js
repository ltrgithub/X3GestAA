...
exports.FilterCell = helpers.defineClass(FilterCell, null, {
    ...
    loadField: function($field, $bind){
        var $$container = $(document.createElement("div")).appendTo(this.$$container);
        this.addOperator(this.record.page.loadNewItem($$container, {
            $bind: $bind || this.$bind,
    ...
    ensureDefault: function(){
        ...
        if (this.$field) {
            var defaultFilter, value = this.record.boundFields[this.$bind][0].getDataValue();
            switch (this.$field.$type) {
                case "application/x-date":
                case "application/x-time":
                case "application/x-datetime":
                ...
                case "application/x-string":
                    ...
                    break;
                case "application/x-integer":
                    defaultFilter = (value !== "0" && this.operator === "none") ? "ge" : (value === "0" && this.operator !== "none") ? "none" : undefined;
                    break
                default:
                    defaultFilter = (value !== "" && this.operator === "none") ? "ge" : (value === "" && this.operator !== "none") ? "none" : undefined;
                    break;
