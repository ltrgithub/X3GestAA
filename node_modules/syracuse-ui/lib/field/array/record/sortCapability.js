...
exports.SortCapability = helpers.defineClass(SortCapability, null, {
    ...
    bindEvents: function(){
        ...
        self.list.$$item.delegate("a[data-s-sort]", "click", function(event){
            self._onSortClick(event, $(this).attr("data-s-sort"));
            return false;
        });
    },
    _onSortClick: function(event, $bind){
        var self = this;
        var options = {
            field: self.list,
            event: event,
            ...
            doEvent: function(){
                ...
                if (this._$orderBy) {
                    this._$orderBy.forEach(function($orderItem){
        ...
        self.list.getPage().externalAdapter.onSortClickEvent(options);
    },
