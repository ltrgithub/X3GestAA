...
exports.FilterRecord = helpers.defineClass(FilterRecord, Article, {
    ...
    reorderCells: function(targetIndex, sourceIndex, dropAtEnd){
        var children = this._dataRow.childNodes;
    ...
    appendEmptyCell: function(slot){
        return this._appendCell(slot || this._dataRow);
    },
    ...
    appendFieldCell: function($item, $field){
        var td = this._appendCell(this._dataRow);
    ...
    drawBox: function(){
        ...
        if (this.$$item) {
            ...
            this.boxParent.builder._thead.appendChild(this._dataRow);
            this.$$item = $(this.boxParent.builder._thead.appendChild(this._dataRow));
        }
    },
    ...
    dispose: function(){
        ...
        this._cells = this.list = this.page = this._dataRow = null;
