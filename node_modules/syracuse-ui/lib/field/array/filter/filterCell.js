...
exports.FilterCell = helpers.defineClass(FilterCell, null, {
	...
	render: function(record, layoutSlot, $field, $bind) {
		filterHelpers.renderCell(this, record, layoutSlot, $field, $bind);
	},
	setOperator: function(operator) {
		this._operator.style.backgroundImage = "url('" + syra_site.$item.$iconPath + "list/s-filter-" + (this.operator = operator) + ".png')";
	},
	getValue: function() {
