...
exports.CardRecord = helpers.defineClass(CardRecord, RecordArticle, {
	...
	drawBox: function() {
		...
		if (this.list.treeDecorator) {
			...
			this.cardItem = this.page.loadNewItem(card, this.list.$item.$cards, this);
		}
	...
	dispose: function() {
		this.cardItem = this._item = this.treeNode = this.row = this.slot = this._selectorCheck = this._reorder = this._menusSlot = this._rowIndexCell = this.dataRow = null;
