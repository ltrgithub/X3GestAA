...
exports.CardRecord = helpers.defineClass(CardRecord, RecordArticle, {
	...
	drawBox: function() {
		...
		if (this.list.treeDecorator) {
			...
			if (this.list.selector.useColumnSelector || this.list.$item.$isRowIndexVisible || (this.list.$capability && this.list.$capability.reorder) || this.list.$item.$selectByRowIndex || !this.list.$item.$isMenuRecordHidden) {
				this.list.$capability.reorder && this.list.capabilityMaker.addReorder(this);

				this.toolbar = document.createElement("div");
				if (this.list.selector.useColumnSelector) {
					var selectorSlot = this.cardContent.appendChild(document.createElement("div"));
					this.list.selector.appendToRecord(this, selectorSlot);
	...
	dispose: function() {
		this.rowIndexBtn = this.toolbar = this.cardItem = this.treeNode = this.row = this.cardContent = this.menusSlot = this.rowIndexBtn = this.dataRow = null;
