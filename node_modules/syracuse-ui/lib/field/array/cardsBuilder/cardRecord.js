...
exports.CardRecord = helpers.defineClass(CardRecord, RecordArticle, {
	...
	dispose: function() {
		this.toolbar = this.cardItem = this.domItem = this.treeNode = this.row = this.cardContent = this._selectorCheck = this.menusSlot = this.rowIndexPicker = this.dataRow = null;
