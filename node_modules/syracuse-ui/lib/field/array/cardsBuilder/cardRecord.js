...
exports.CardRecord = helpers.defineClass(CardRecord, RecordArticle, {
	...
	dispose: function() {
		this.rowIndexBtn = this.toolbar = this.cardItem = this.treeNode = this.row = this.cardContent = this._selectorCheck = this.menusSlot = this.rowIndexBtn = this.dataRow = null;
