...
exports.ListDesigner = helpers.defineClass(ListDesigner, Designer, {
		...
		for (var ii = 0, jj = modeTypes.length; ii < jj; ii++) {
			...
			switch (modeType) {
				...
				case "cards":
					...
					this.templatesTool.addColsCountButtons(this.sectionCards, this.designedItem, this.designedArticle.$cardsByRowCount || 1, 6);
	...
	dispose: function() {
		...
		this.graph = this.cardDesigner = this._switchPagerBtns = this.modes = null;
