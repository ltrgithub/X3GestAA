...
exports.ListDesigner = helpers.defineClass(ListDesigner, Designer, {
	...
	onSwitchPagerClick: function(picker) {
	...
	onTemplateClick: function(picker) {
		if (this.templatesTool) {
			if (picker.syraModelType == "colcount") {
				...
				Designer.prototype.onTemplateClick.call(this, picker);
			}
	...
	addSwitchPagerLink: function(slot) {
		if (this.designedArticle.isClientFetch) {
			...
			link.syraOnClick = "onSwitchPagerClick";
			link.syraIsDesign = true;
	...
	appendGroupModes: function() {
		...
		for (var ii = 0, jj = modeTypes.length; ii < jj; ii++) {
			...
			mode.link.title = syra_local["lw_mode_" + modeType];
			mode.link.className = "s-aw-list-mode-" + modeType;
			mode.link.syraOnClick = "onModeClick";
			...
			switch (modeType) {
				...
				case "cards":
					...
					var link = document.createElement("a");
					link.syraOnClick = "onDesignCardClick";
					link.title = link.textContent = syra_local.lw_designCard;
				...
				case "detailgrid":
					...
					var link = document.createElement("a");
					link.syraOnClick = "onDesignCardClick";
					link.title = link.textContent = syra_local.lw_designDetailView;
					link.className = "s-aw-list-design-card-picker";
					body.appendChild(link);
					this.addSwitchPagerLink(body);
					break;
