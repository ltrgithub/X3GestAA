...
exports.SingleRecord = helpers.defineClass(SingleRecord, RecordArticle, {
	...
	parseExpression: function(expression, record, properties, $subRecordKey, ignoreCurrent) {
		if (!record) {
			...
			record = field && field.getDataValue();
	...
	drawBox: function() {
		...
		this.domItem.className = "s-array-record-item";
		...
		this.$$value = $(this.domItem.appendChild(recordValue));
		...
		this.domItem.insertBefore(this.toolbar, recordValue);
		...
		if (this.$isEditMode) {
			...
			if (this.list.$field.$item.$type == 'application/x-reference') {
				...
				this.titleSlot.className = "s-array-record-title";
	...
	dispose: function() {
		this._singleField = this.toolbar = this.$$value = this.domItem = null;
