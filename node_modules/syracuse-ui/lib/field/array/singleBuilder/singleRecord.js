...
exports.SingleRecord = helpers.defineClass(SingleRecord, RecordArticle, {
	...
	applyChange: function(metaData) {
		...
		if (this.menusSlot && !this.menusSlot.parentNode) {
			var slot = this.singleField._dataValue || (this.singleField.variantItem && this.singleField.variantItem._dataValue);
			slot && slot.appendChild(this.menusSlot);
		}
