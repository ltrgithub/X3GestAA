...
exports.SingleRecord = helpers.defineClass(SingleRecord, RecordArticle, {
	...
	onItemEnterLeave: function(onEnter) {
		...
		if (variantItem && variantItem.onItemEnterLeave) {
			variantItem.onItemEnterLeave(onEnter, this);
		} else {
			RecordArticle.prototype.onItemEnterLeave.call(this, onEnter);
		}
	},
	...
	drawBox: function() {
		...
		this.reorderPickerParent = this.recordValue = document.createElement("div");
