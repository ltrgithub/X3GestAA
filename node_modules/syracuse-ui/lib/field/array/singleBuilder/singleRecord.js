...
exports.SingleRecord = helpers.defineClass(SingleRecord, RecordArticle, {
    loadBox: function(initData){
        ...
        // Franck-kevin : plus géréc comme cela append diagnoses if any for reference type single records
    ...
    applyReorderCapability: function(reorder){
        if (this.hasReorderCapability = reorder) {
            if (!this._reorder) {
                ...
                toolbar.appendChild(this._reorder).appendChild(btn).className = "s-array-record-reorder s-list-record-reorder";
