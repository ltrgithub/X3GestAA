...
exports.Scroller = helpers.defineClass(Scroller, null, {
	...
	_scrollColsToLeft: function() {
		//TODO
	},
	_scrollColsToRight: function() {
		//TODO
	},
	_bindButton: function($$btn, left) {
		...
		$$btn.bind("click", function() {
			...
			self._hscroller.scrollLeft = left ? self._hscroller.scrollLeft - cols[ii].scrollWidth : self._hscroller.scrollLeft + cols[ii].scrollWidth;
	...
	dispose: function() {
		...
		this.builder = this.list = this._headSlot = this.bodySlot = this._hscroller = this._$$headSlot = this._$$hscroller = this._$$bodySlot = this._hscrollBody = null;
	}
});