...
exports.Scroller = helpers.defineClass(Scroller, null, {
	...
	getVisibleSize: function() {
		return syra_site.dom.getBoundingClientRect(this.bodySlot);
	},
	...
	getScrollBoundary: function() {
		var boundary = syra_site.dom.getBoundingClientRect(this.bodySlot);
	...
	drawSlots: function(core, header, body) {
		...
		this._hscroller.syraIsMouseEventDisabled = true;
	...
	onListResize: function() {
		...
		if (clientWidth) {
			if (this.list.fitToWidFields && !this.list.isFittedToWidth) {
				...
				syra_site.dom.empty(this.list.sizerow);
				...
				if (this.list.$isDockedHeight) {
					...
					if (this.$fixedBodyHeight || this.list.$item.$fitContainer) {
						if (this.list.$item.$fitContainer) {
							...
							var bodyRect = syra_site.dom.getBoundingClientRect(this.bodySlot);
	...
	_showButtons: function(show) {
		if (show != this.leftBtn.syraIsDisplay) {
			this.leftBtn.syraIsDisplay = show;
			if (show) {
				this.leftBtnStyle.display = "";
				this.rightBtnStyle.display = "";
			} else {
				this.leftBtnStyle.display = "none";
				this.rightBtnStyle.display = "none";
			}
		}
	},
	onPageScrollViewChange: function() {
		if (this.leftBtn) {
			...
			var scrollRect = syra_site.dom.getBoundingClientRect(this.list.page.scrollview);
			var show;
