...
exports.Scroller = helpers.defineClass(Scroller, null, {
	...
	getVisibleSize: function() {
		return {
			height: this._$$bodySlot.height(),
			width: this._$$bodySlot.width()
		};
	},
		...
		if (this.list.isScrollButtonEnabled !== false) {
			if (this.list.records.length > 20) {
				...
				if (this.leftBtn) {
					...
					//this.leftBtn.style.display = this.rightBtn.style.display = this.isScrolledIntoView($(this.list.builder.scroller._hscroller), this.list.page.$$scrollview) ? "none" : "";	
				}
			} else {
	...
	_updateButtonsPosition: function(scroller) {
		if (scroller._areButtonsVisible) {
			var $$scrollview = scroller.list.page.$$scrollview;
