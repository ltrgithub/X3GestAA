...
exports.Scroller = helpers.defineClass(Scroller, null, {
	...
	onHScroll: function() {
		if (!this.firstScrollableColIndex) {
			if (this._bodySlot.scrollLeft != this._hscroller.scrollLeft) {
				this._bodySlot.scrollLeft = this._hscroller.scrollLeft;
			}
			if (this._headSlot.scrollLeft != this._hscroller.scrollLeft) {
				this._headSlot.scrollLeft = this._hscroller.scrollLeft;
			}
		} else {
