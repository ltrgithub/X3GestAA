	...
	if (list.page.scrollview && list.isScrollButtonEnabled !== false && !list.treeDecorator) {
		if (list.records.length > 20) {
			if (!list.scrollLeftBtn) {
				...
				if (list.page && list.page.addScrollViewListener) {
					list.page.addScrollViewListener(list);
				}
			}
...
exports.dispose = function(list) {
	...
	list.scrollLeftBtn && list.page && list.page.removeScrollViewListener && list.page.removeScrollViewListener(list);
