...
exports.ColReorderDDAgent = helpers.defineClass(ColReorderDDAgent, null, {
	...
	onColumnHeaderEnterLeave: function(col, onEnter) {
		if (onEnter) {
			...
			document.site.dom.toggleClass(this.info, "s-drag-ok", this.colTarget != null);
		} else {
	...
	onDragMouseUp: function(target, event) {
		document.site.dom.removeChild(this.info);
		document.site.dom.removeChild(this.cueTop);
		document.site.dom.removeChild(this.cueBottom);
		if (this.colTarget) {
