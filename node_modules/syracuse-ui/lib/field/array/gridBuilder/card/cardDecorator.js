...
exports.CardDecorator = helpers.defineClass(CardDecorator, null, {
	...
	onRecordResize: function(record) {
		if (this.list.bodyTableSlot.clientWidth) {
			if (this.isRowCardMode && record.body) {
				record.layoutSlot.style.width = this.list.bodyTableSlot.clientWidth + "px";
			}
		}
	},
	...
	appendRowCardOpener: function(record) {
		...
		record.rowCardOpener = syra_menus.addIconButton(syra_local.flShowCard, "s-grid-rowcard-picker s-close", "onRowCardClick");
	...
	appendRowCardCol: function(slot, beforeCell) {
		...
		var opener = syra_menus.addIconButton(syra_local.flShowAllCards, "s-grid-rowcard-picker-all s-close", "onRowCardClick");
	...
	onSelectRecord: function(record, selected) {
		...
		if (selected) {
			this.list.popupCardBuilder && this.list.popupCardBuilder.onSelectRecord(record, true);
