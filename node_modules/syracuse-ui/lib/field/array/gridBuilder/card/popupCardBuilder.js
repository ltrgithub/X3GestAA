				...
				if (self._popupCard) {
					...
					self.list.page.externalAdapter.onFieldClickPicker({
						...
						doEvent: function() {
							...
							self._popupCard.dialog = document.site.dialogManager.openBoxDialog(record.page, {
								isAutoClose: false,
								$dialogMode: "modal",
		...
		if (!this._isOnApplyingChange) {
			if (this._popupCard) {
				if (show) {
					...
					record.page.layoutValidator.validate(record.popupCardItem.layoutContent, true);
				}
