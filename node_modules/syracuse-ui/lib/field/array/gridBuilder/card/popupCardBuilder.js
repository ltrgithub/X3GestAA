						...
						doEvent: function() {
							...
							self._popupCard.dialog = document.site.dialogManager.openModal(record.page, {
								...
								onClose: function() {
									if (self._popupCard) {
										self.list.page.externalAdapter.onFieldClickPicker({
											...
											doEvent: function() {
												document.site.dom.removeChild(self._popupCard.slot);
								...
								resizeDialog: function(dlg, isDlgResizing) {
									...
									var rect = document.site.dom.getInnerSize(self._popupCard.slot);
				...
				if (show) {
					if (this._recordPopupCard) {
						if (this._recordPopupCard.popupCardItem) {
							document.site.dom.removeChild(this._recordPopupCard.popupCardItem.domItem);
						}
					}
					this._recordPopupCard = record;
					document.site.dom.empty(this._popupCard.slotCard);
					var $pagerActions;
