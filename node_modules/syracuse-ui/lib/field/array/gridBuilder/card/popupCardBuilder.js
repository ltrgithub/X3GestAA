						...
						doEvent: function() {
							...
							self._popupCard.dialog = document.site.dialogManager.openModal(record.page, {
								...
								resizeDialog: function(dlg) {
									...
									dlg.centerDialog();
									var rect = document.site.getInnerSize(self._popupCard.slot);
									self._popupCard.slotCard.style.width = rect.width + "px";
									self._popupCard.slotCard.style.height = (rect.height - document.site.getBoundingClientRect(self._popupCard.slotHeader).height) + "px";
								},
