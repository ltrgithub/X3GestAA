...
exports.GridBuilder = helpers.defineClass(GridBuilder, null, {
	initialize: function() {
		...
		if (this.$popupCard && !this.popupCardBuilder) {
			this.popupCardBuilder = new PopupCardBuilder();
			this.popupCardBuilder.load(this.list);
		}
	...
	onWindowResize: function() {
		if (!this.disposed && this.scroller) {
			...
			this.cardDecorator.onWindowResize();
		}
	},
	dispose: function() {
		...
		this.list = this.cardDecorator = this.popupCardBuilder = this.emptyData = this.scroller = this.$colBinds = this._$$body = null;
	}
});