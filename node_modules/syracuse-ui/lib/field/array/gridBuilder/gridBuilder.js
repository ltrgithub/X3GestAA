...
exports.Builder = helpers.defineClass(Builder, null, {
	...
	resizeScrollView: function() {
		if (this.scrollTable.bodySlot.clientWidth) {
			if (!this.list.isTableSlotHidden) {
				...
				if (this.emptyDataItem.syraIsDisplay && this.list.$item.$isTitleRowHidden) {
					...
					if (this.freezeTable) {
						...
						this.freezeTable.setColWidths(this);
					...
					this.scrollTable && this.scrollTable.setColWidths(this);
					this.scrollTable.headSlot.style.maxWidth = maxSlotWidth + "px";
					this.scrollTable.bodySlot.style.maxWidth = maxSlotWidth + "px";
					var scrollWidth = this.scrollTable.showScrollBar();
					this.list.tableSlot.style.maxWidth = scrollWidth + (freezeWidth || 0) + "px";
				}!this.list.page.dialogWrapper && _sideButtons.add(this.scrollTable);
			}
		}
	},
