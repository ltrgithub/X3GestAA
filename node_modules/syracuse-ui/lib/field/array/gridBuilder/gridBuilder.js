...
exports.GridBuilder = helpers.defineClass(GridBuilder, null, {
    ...
    reorderColumns: function(colSource, colTarget, dropAtEnd){
        ...
        if (sourceIndex >= 0) {
            ...
            if (this.list.filterCapability && this.list.filterCapability.filterRecord) {
                this.reorderCells(this.list.filterCapability.filterRecord, targetIndex, sourceIndex, dropAtEnd);
            }
    ...
    removeColumn: function($bind){
        ...
        if (this.list.filterCapability && this.list.filterCapability.filterRecord) {
            document.site.removeDomChild(this.list.filterCapability.filterRecord.dataRow.childNodes[index]);
        }
        for (var ii = 0, jj = this.list.records.length; ii < jj; ii++) {
            var record = this.list.records[ii];
    ...
    emptyBody: function(addEmptySlot, onFetch){
        ...
        if (addEmptySlot) {
            ...
            cell.textContent = (!this.list.isClientFetch && onFetch) ? this.list._localize.l_waiting_data : (this.list.$item.$noDataText || this.list._localize.l_noData);
    ...
    _makeTitleRow: function(){
        ...
        if (this.list.treeList) {
            this.orderCols.push(this.list.treeList.appendTreeviewCol(this.titleRow));
        }
        else {
