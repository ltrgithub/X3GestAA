		...
		if (designing) {
			...
			if (metaData.$cards !== undefined) {
				...
				if (this._cardSlot) {
					...
					document.site.removeDomChild(this.list.tableSlot);
					document.site.removeDomChild(this.list.outcardSeparator);
					document.site.removeDomChild(this._cardSlot);
					this.list.outcardSeparator = this.list.tableSlot = this._cardSlot = null;
				}
