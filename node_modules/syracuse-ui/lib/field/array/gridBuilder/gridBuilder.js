...
exports.GridBuilder = helpers.defineClass(GridBuilder, null, {
    ...
    _toggleDataList: function(show){
        if (this._tableBody) {
            ...
            this.list._core.style.visibility = "hidden";
            ...
            this._bodySlot.style.overflow = "auto";
        }
    },
    _initializeSize: function(initialize){
        ...
        delete self._maxCol;
        //  }
        if (!self._maxCol && self.list.$item.$format == "grid" && self._bodySlot.clientWidth) {
            var widthTotal = 0;
            ...
            if (self.list._core.style.visibility == "hidden") {
                self.list._core.style.visibility = "";
            }
        }
    },
    ...
    _ensureScrollBar: function(){
        if (this._bodySlot.scrollHeight != this._bodySlot.clientHeight) {
