...
exports.GridBuilder = helpers.defineClass(GridBuilder, null, {
    ...
    appendFieldCol: function(slot, $item, $field){
        ...
        col.widthValue += 12; //fort padding
    ...
    toggleMenuBoxCol: function(show){
        if (this.cols.$menusBox.isVisible != show) {
            this.cols.$menusBox.isVisible = show;
            this.cols.$menusBox.groupHead.style.display = this.cols.$menusBox.groupBody.style.display = show ? "" : "none";
        }
    },
