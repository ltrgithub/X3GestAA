...
function _addRowIndexCol(list) {
	if (list.$item.$isRowIndexVisible || (list.$capability && list.$capability.reorder) || list.$item.$selectByRowIndex) {
		...
		col.colWidth = (list.$capability && list.$capability.reorder) ? 35 : 25;
	}
}
