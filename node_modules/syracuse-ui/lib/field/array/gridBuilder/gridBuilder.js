...
exports.GridBuilder = helpers.defineClass(GridBuilder, null, {
    ...
    appendFieldCol: function(slot, $item, $field){
        ...
        if (width) {
            ...
            col.widthValue = document.site.getFieldWidth($field,false,titleText.length);
        }
        col.widthValue += 12; //for padding
    ...
    _makeTitleRow: function(){
        ...
        if (this.list.$item.$format == "vgrid") {
            ...
            if (this.list.$prototype.$treeview) {
                this._orderCols.push(this._appendTreeviewCol(this.titleRow));
            }
    ...
    _appendTreeviewCol: function(slot){
        console.log("_appendTreeviewCol");
        var col = this.cols.$treeview = this._appendCol();
        col.slot = slot;
