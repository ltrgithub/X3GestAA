	...
	tb.bodySlot_onScroll = tb.bodySlot.addEventListener("scroll", function(event) {
		...
		if (!syra_site.isInoutDisabled && page.isPageLoaded && !page._isDataChanging) {
			if (tb.headSlot.scrollLeft != this.scrollLeft) {
				console.log("scroll Bodyleft then head " + this.scrollLeft);
				tb.headSlot.scrollLeft = this.scrollLeft;
			} else {
				console.log("scroll Bodyleft " + this.scrollLeft);
			}
		...
		if (!syra_site.isInoutDisabled && page.isPageLoaded && !page._isDataChanging) {
			if (this.scrollLeft) {
				if (tb.bodySlot.scrollLeft != this.scrollLeft) {
					console.log("scroll headLeft then body " + this.scrollLeft);
					tb.bodySlot.scrollLeft = this.scrollLeft;
				} else {
					console.log("scroll HeadLeft " + this.scrollLeft);
				}
			}
		}
