...
exports.FilterRecord = helpers.defineClass(FilterRecord, Article, {
	...
	appendFieldCell: function(col, $field) {
		...
		if (this.list.hasFieldFilterCapability($field)) {
			filterHelpers.renderCell(this.fieldCells[col.$item.$bind] = new FilterCell(), this, cell, $field, col.$item.$bind);
		}
	},
	drawBox: function() {
		this.fieldCells = {};
	...
	_buildFilter: function() {
		...
		for (var ii = 0, jj = $binds.length; ii < jj; ii++) {
			var value = this.fieldCells[$binds[ii]].getValue();
	...
	onNotifyDataChange: function(field, value) {
		...
		if (value == null || value == "") {
			...
			filter && filterHelpers.ensureEqual(filter); //for high this.fieldCells[$bind] is not defined			
		}
		this._buildFilter();
		return false;
	},
