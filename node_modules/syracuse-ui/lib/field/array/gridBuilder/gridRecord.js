...
exports.GridRecord = helpers.defineClass(GridRecord, RecordArticle, {
        ...
        if (this.builder._cardSlot) {
            if (show) {
                if (this.builder.recordCardView) {
                    if (this.builder.recordCardView.cardview) {
                        this.builder.recordCardView.cardview.$$item.detach();
                    }
                ...
                var $pagerActions;
                if (!this.cardview && this.list.isClientFetch && this.list.$item.$cards.$position == "popup") {
                ...
                if (!this.cardview) {
                    ...
                    this.builder._cardSlot.appendChild(this.cardview.$$item[0]);
                }
                if ($pagerActions) {
    ...
    togglePopupCard: function(){
        var self = this;
        if (!self.builder.popupCard || self.builder.popupCard.disposed) {
            ...
            self.builder.popupCard = self.page.openDialog({
                ...
                onClose: function(){
                    ...
                    document.controller.disposeObject(self.builder.popupCard);
                    return true;
                }
            });
