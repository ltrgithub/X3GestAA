...
exports.GridRecord = helpers.defineClass(GridRecord, RecordArticle, {
	...
	drawBox: function() {
		...
		this.dataRow.setAttribute("data-s-record", this.domItem.syraRecord = this.$uuid);
		...
		if (this.list.selector.useColumnSelector) {
			...
			this._selectorCheck = this.list.selector.appendToRecord(this.dataRow.appendChild(td));
		}
