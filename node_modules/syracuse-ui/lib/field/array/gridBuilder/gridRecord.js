...
exports.GridRecord = helpers.defineClass(GridRecord, RecordArticle, {
    ...
    drawBox: function(){
        ...
        if (this.list.$item.$cards && this.list.$item.$cards.$position == "inline") {
            ...
            this.$$item[0].appendChild(th.appendChild(this.cardsOpener));
        }
    ...
    toggleCardView: function(show, slot){
        if (this.builder._cardSlot) {
            ...
            if (!this._cardsRow) {
                ...
                this._cardsRow.setAttribute("data-s-record", this.$uuid);
                this._cardsRow.setAttribute("data-s-article", this.id);
                this.$$item.after(this._cardsRow);
                this._cardsRow.appendChild(this._cardsSlot);
            }
            slot = this._cardsSlot;
            this._cardsRow.style.display = show ? "" : "none";
        }
        if (show) {
            this.cardview = this.list.page.loadNewItem(slot, this.list.$item.$cards, this);
        }
    },
    highlightSelection: function(selected){
        ...
        if (this.list.$item.$cards) {
            if (this._cardsRow) {
                ...
                if (selected) {
                    this.toggleCardView(true, this.builder._cardSlot);
                }
            }
        }
