...
exports.GridRecord = helpers.defineClass(GridRecord, RecordArticle, {
	...
	disposeCard: function() {
		this.layoutSlot = this.layoutContent = this.domItem = this.body = this.rowCard = this.rowCardOpener = this.cardItem = null;
	},
	dispose: function() {
		this.list.fomatter && this.list.fomatter.quickEdit.disposeRecord(this);
		this.disposeCard();
	...
	remove: function() {
		...
		this.rowCard && syra_site.dom.removeChild(this.rowCard.row);
	},
	loadBox: function(initData, isCreateAction) {
		RecordArticle.prototype.loadBox.call(this, initData);
		if (isCreateAction && this.list.cardDecorator) {
			this.list.cardDecorator.isRowCardMode && this.list.cardDecorator.toggleRowCard(this, true);
		}
	},
	drawBox: function() {
		_drawRecord(this);
	...
	loadInlinePage: function($itemPage, options) {
		this.list.fomatter.quickEdit.loadInlinePage(this, $itemPage, options);
	},
