...
exports.GridRecord = helpers.defineClass(GridRecord, RecordArticle, {
	...
	drawBox: function() {
		...
		if (this.builder.$cardItem && this.builder.$cardItem.$position == "inline") {
		...
		if (selected) {
			...
			if (this.list.outCardSlot) {
				...
				if (!this.cardItem) {
					...
					this.cardItem = this.list.page.loadNewItem(this.list.outCardSlot, this.list.$item.$cards, this);
				} else {
					this.list.outCardSlot.appendChild(this.cardItem.$$item[0]);
				}
			}
	...
	removeOutCard: function() {
		if (this.cardItem) {
			this.removeItem(this.cardItem, true, true);
			delete this.cardItem;
		}
	},
	toggleInlineCard: function(show) {
		...
		if (!this.inlineCardRow) {
			...
			this.cardItem = this.list.page.loadNewItem(this.inlineCardCell, this.builder.$cardItem, this);
