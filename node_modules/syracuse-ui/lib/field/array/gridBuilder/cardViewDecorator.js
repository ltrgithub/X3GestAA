...
exports.CardViewDecorator = helpers.defineClass(CardViewDecorator, null, {
    ...
    onRecordDrawBox: function(recordArticle){
        if (this.$cardsPosition == "inline") {
            ...
            btn.setAttribute("data-s-cardview-opener","1");
    ...
    onOpenerClick: function($$opener,article){
        ...
        var $uuidList = (article.list) ? [article.$uuid] : Object.keys(article._store._map);
    ...
    _createCardView: function($$container, recordArticle){
        this.cardview = this.list.page.loadNewItem($$container, this.list.$item.$cards, recordArticle);
    },
