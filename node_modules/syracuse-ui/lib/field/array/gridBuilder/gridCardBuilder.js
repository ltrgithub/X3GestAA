            ...
            list.$item.$cards = {
                $layout: {
                    ...
                    $items: $arrayBinds.map(function($bind){
                        ...
                        return {
                            $category: "section",
                            $title: list.getLocalizedTitle($field.$shortTitle || $field.$title || ""),
                            $layout: {
                                $items: [{
                                    $bind: $bind,
                                    $isTitleHidden: true
                        ...
                        $pagerActions = {
                            $actions: {
                                $first: {
                                    ...
                                    $isDisabled: this.list.paging.$startIndex == 1 && record.$recordIndex == 0
                                },
                                $previous: {
                                ...
                                $next: {
                                    ...
                                    $isHidden: this.list.dataset.length <= 2,
                                    $isDisabled: (this.list.paging.$startIndex + record.$recordIndex) == this.list.dataset.length
                                },
                                $last: {
