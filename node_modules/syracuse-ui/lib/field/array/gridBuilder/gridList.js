...
exports.GridList = helpers.defineClass(GridList, MultiList, {
	...
	scrollToRecord: function(record) {
		if (record) {
			var view;
			if (this.$item && this.$item.$isNavigationList) {
				view = this.builder.scrollTable.bodySlot;
			}
			syra_page.scrollToItem(this.page, record.dataRow, view || this.page.scrollview, true);
		}
	},
	drawBox: function() {
