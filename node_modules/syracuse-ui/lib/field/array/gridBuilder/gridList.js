...
exports.GridList = helpers.defineClass(GridList, MultiList, {
	...
	resizeScrollView: function(newWidth) {
		...
		if (newWidth) {
			if (!this.isTableSlotHidden) {
				...
				this.headTableSlot.style[syra_site.isDocumentRTL ? "marginLeft" : "marginRight"] = headMargin;
	...
	_makeTitleRow: function() {
		...
		if (this.selector.useColumnSelector) {
			this.filterRecord && this.filterRecord.appendFlagCell();
			this.orderCols.push(this.selector.appendToGridHeader(this.titleRow));
		}
		if (!this.$item.$isMenuRecordHidden) {
			this.filterRecord && this.filterRecord.appendCell();
