...
exports.RecordArticle = helpers.defineClass(RecordArticle, Article, {
	...
	applyRecordCapabilities: function(onListMetadata) {
		...
		if (this.$capability["delete"]) {
			$actions.$delete = {
				...
				$confirm: this.list.$confirmDelete,
				$isHidden: false
			};
		}
	...
	dispose: function() {
		this.reorderPickerParent = this.$capability = this.garbage = this.menusBox = this.list = this.menusSlot = this.rowIndexPicker = this.reorderPicker = null;
