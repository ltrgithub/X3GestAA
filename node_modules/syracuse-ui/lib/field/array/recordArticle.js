...
exports.RecordArticle = helpers.defineClass(RecordArticle, Article, {
	...
	highlightOnEnter: function(onEnter, event) {
		...
		if (!this.disposed) {
			if (this.list.builder.record_highlightOnEnter) {
				...
				syra_site.dom.toggleClass(this.domItem, "s-record-enter", onEnter);
			}
		}
	},
	...
	dispose: function() {
		...
		if (this.onDisposeRecord) {
			this.onDisposeRecord(this);
			this.onDisposeRecord = null;
		}
