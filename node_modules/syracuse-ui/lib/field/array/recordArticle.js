...
exports.RecordArticle = helpers.defineClass(RecordArticle, Article, {
	loadBox: function(initData) {
		...
		this.$defaultSkinBlock = this.$defaultSkinBlock || "s-h3";
	...
	dispose: function() {
		this.localize = this.menusBox = this.page = this.list = this.builder = this._menusSlot = this._rowIndexCell = this._reorder = null;
