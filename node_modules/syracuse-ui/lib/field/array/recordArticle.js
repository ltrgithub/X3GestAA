...
exports.RecordArticle = helpers.defineClass(RecordArticle, Article, {
	...
	applyRecordCapabilities: function($recordActions) {
	...
	dispose: function() {
		this.$capability = this.garbage = this.localize = this.menusBox = this.list = this.menusSlot = this.rowIndexPicker = this.reorderPicker = null;
