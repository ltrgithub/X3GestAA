...
exports.RecordArticle = helpers.defineClass(RecordArticle, Article, {
    ...
    onMenuClick: function(menuItem){
        switch (menuItem.$bind) {
            case "$recordPopupCard":
                this.builder.togglePopupCard(this);
                return false;
        }
        return true;
    },
    ...
    _ensureMenusBox: function(){
        ...
        if (!self._menusBox) {
            ...
            if (self.list.$item.$cards && self.list.$item.$cards.$position == "popup") {
                $menuBag.$items = [{
                    $bind: "$recordPopupCard",
    ...
    applyActionLinkChange: function(resources){
        if (resources && (resources.$links !== undefined || resources.$actions !== undefined)) {
            if (!this._menusBox && !this.list.$item.$isMenuRecordHidden) {
    ...
    dispose: function(){
        if (this.list.treeDecorator) {
            this.list.treeDecorator.unregiterRecord(this);
        }
