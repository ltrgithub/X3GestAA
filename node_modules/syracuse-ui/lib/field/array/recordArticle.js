...
exports.RecordArticle = _helpers.defineClass(RecordArticle, null, {
	...
	alternateStyle: function(showAlt) {
		if (this.showAlt != showAlt) {
			...
			syra_dom.toggleClass(this.domItem, "s-record-alt", showAlt);
			this.fixedRow && syra_dom.toggleClass(this.fixedRow, "s-record-alt", showAlt);
		}
	},
	load: function(initData, isCreateAction) {
	...
	onItemInOut: function(onEnter, event, target) {
		if (!this.list.$item.$isHoverDisabled) {
			...
			this.list.treeDecorator && this.list.treeDecorator.onItemInOut(onEnter, event, target);
		}
	},
