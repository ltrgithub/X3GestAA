...
exports.RecordArticle = helpers.defineClass(RecordArticle, Article, {
	...
	setMenusBoxCol: function($quickAction, add, width) {
		if (this.builder && this.builder.setMenusBoxCol) {
			this.builder.setMenusBoxCol($quickAction, add, width);
		}
	},
	...
	onItemEnterLeave: function(event) {
		if (this.list && this.list.selector && this.list.selector.isRowMode) {
	...
	dispose: function() {
		this.localize = this.menusBox = this.page = this.list = this.builder = this._menusSlot = this.rowIndexPicker = this.reorderPicker = null;
