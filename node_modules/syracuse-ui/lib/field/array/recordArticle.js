...
exports.RecordArticle = helpers.defineClass(RecordArticle, Article, {
	...
	onTreeNodeClick: function(event, picker) {
		this.list.treeDecorator.onNodeEvent(this, event, picker);
	},
	...
	onSelectorClick: function(event, picker) {
		this.list.onSelectorClick(event, picker);
	},
	...
	dispose: function() {
		this.reorderPickerParent = this.$capability = this.garbage = this.list = this.menusSlot = this.rowIndexPicker = this.reorderPicker = null;
