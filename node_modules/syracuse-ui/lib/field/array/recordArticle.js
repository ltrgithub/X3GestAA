...
exports.RecordArticle = helpers.defineClass(RecordArticle, Article, {
	...
	alternateStyle: function(showAlt) {
		if (this.showAlt != showAlt) {
			this.showAlt = showAlt;
			syra_dom.toggleClass(this.domItem, "s-list-alt", showAlt);
			this.fixedRow && syra_dom.toggleClass(this.fixedRow, "s-list-alt", showAlt);
		}
	},
