...
exports.checkbox = {
	render: function(item, id, css, isRadio) {
		...
		if (isRadio) {
			box.icon.innerHTML = syra_menus.fontIcons.radio_off;
			box.input.setAttribute("type", "checkbox");
		} else {
			box.icon.innerHTML = syra_menus.fontIcons.checkbox_off;
			box.input.setAttribute("type", "checkbox");
		}
	...
	setIcon: function(item, isChecked) {
		...
		if (icon.syraIsChecked !== isChecked) {
			...
			if (icon.syraIsRadio) {
				icon.innerHTML = isChecked ? syra_menus.fontIcons.radio_on : syra_menus.fontIcons.radio_off;
			} else {
				icon.innerHTML = isChecked ? syra_menus.fontIcons.checkbox_on : syra_menus.fontIcons.checkbox_off;
			}
