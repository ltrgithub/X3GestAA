...
function _showFields(box, show) {
	...
	if (box.isDesktopPage) {
		if (!box.isVignettePage) {
			...
			var icon = box._areAdvancedFieldsVisible ? "advanced_hide" : "advanced_show";
...
function _showButton(page, show, designing) {
	...
	if (page.isDesktopPage) {
		...
		if (page.isVignettePage) {
			...
			var icon = page._areAdvancedFieldsVisible ? "advanced_hide" : "advanced_show";
			...
			syra_menus.button.hide(page._advancedFieldsBtn, !page._hasAdvancedFields);
		}
	} else {
		if (!show) {
