...
function _showFields(box, show) {
	...
	if (box.isDesktopPage) {
		if (!box.isVignettePage) {
			...
			document.site.dom.toggleClass(box._advancedFieldsLink, "s-hide-advanced", box._areAdvancedFieldsVisible);
		}
	} else {
		if (box.vignette) {
		...
		if (picker) {
			...
			document.site.dom.toggleClass(picker, "s-hide-advanced", box._areAdvancedFieldsVisible);
		}
	}
