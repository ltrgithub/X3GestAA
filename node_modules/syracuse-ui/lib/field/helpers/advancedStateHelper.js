	...
	if (box.isDesktopPage) {
		...
		if (box.isVignettePage) {
			...
			if (!box._advancedFieldsSlot) {
				...
				box.header.appendChild(box._advancedFieldsSlot);
				box._advancedFieldsBtn = syra_menus.addTextButton(title, box.$skin + "-head-advanced-fields-link", "onAdvancedClick");
