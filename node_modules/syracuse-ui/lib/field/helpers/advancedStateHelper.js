...
function _showFields(box, show) {
	...
	if (box.isDesktopPage) {
		if (!box.isVignettePage) {
			box._advancedFieldsLink.textContent = box._advancedFieldsLink.title = box._areAdvancedFieldsVisible ? syra_local.box_advanced_hide : syra_local.box_advanced;
		...
		if (picker) {
			picker.title = (box._areAdvancedFieldsVisible) ? syra_local.box_advanced_hide : syra_local.box_advanced;
