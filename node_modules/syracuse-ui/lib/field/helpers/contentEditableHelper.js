...
exports.setInputValue = function(field, val) {
	...
	if (val == "" && field.$item.$isTitlePlaceHolder) {
		...
		document.site.dom.toggleClass(field.input, "s-placeholder", true);
	} else {
		delete field.placeHolderText;
		document.site.dom.toggleClass(field.input, "s-placeholder", false);
	}
};
...
exports.setState = function(field, state) {
	if (state.$isDisabled) {
		...
		delete field.input.syraIsInput;
