...
exports.ChildField = helpers.defineClass(ChildField, Article, {
    ...
    drawBox: function(){
        ...
        this._domItem.appendChild(this._dataValue = this._core);
    ...
    drawDiagnose: function($diagnose, severityGroup){
        ...
        link.textContent = this.$field.$title + ":";
        ...
        this.diagnoseFieldSlot.appendChild(link);
    },
    emptyDiagnoseSlot: function(){
        if (this.diagnoseFieldSlot) {
            document.site.emptyDom(this.diagnoseFieldSlot);
            this.diagnoseFieldSlot.style.visibility = "hidden";
        }
    },
    ensureDiagnoseSlot: function(){
        if (!this.diagnoseFieldSlot && this._dataValue) {
            this.diagnoseFieldSlot = document.createElement("div");
            this.diagnoseFieldSlot.className = "s-field-diagnose";
            this._dataValue.insertBefore(this.diagnoseFieldSlot, this._dataValue.firstChild);
        }
        else {
            document.site.emptyDom(this.diagnoseFieldSlot);
        }
