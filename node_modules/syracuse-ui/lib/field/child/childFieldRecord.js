...
exports.ChildFieldRecord = helpers.defineClass(ChildFieldRecord, null, {
	...
	loadBox: function(initData) {
		...
		this.menusSlot = syra_dom.addDiv(this.list.$skin + "-actions-cell", this.articleParent.header || this.domItem);
		this.domItem.syraItem = this.menusSlot.syraItem = this.id;
		this.page.loadNewItem(syra_dom.addDiv(this.list.$skin + "-record", this.domItem), this.list.$item.$cardItem, this);
	...
	ensureDataSet: function() {
		return this.dataset = syra_dataset.ensure(this.articleParent);
	},
	remove: function() {
