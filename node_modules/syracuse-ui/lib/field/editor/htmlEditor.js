...
function sanitize(html) {
	return rtf.toHtml(rtf.fromHtml(syra_site.formatHTMLText(html)));
}
		...
		if (this.isEditable()) {
			...
			self._editor = $$area.cleditor({
				...
				updateFrame: function(html) {
					...
					var newHtml = syra_site.formatHTMLText(html);
					if (self._editor && self._editor.$area) self._editor.$area.val(newHtml || '');
					return newHtml;
				},
