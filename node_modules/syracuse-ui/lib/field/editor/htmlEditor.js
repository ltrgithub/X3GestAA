...
var resUtil = require('syracuse-core').resource.util;
...
function sanitizeHtml(html) {
	return syra_site.developpementMode ? html : html_sanitize(html, uriRewriter);
}
...
exports.HtmlEditor = helpers.defineClass(HtmlEditor, Field, {
	...
	getInputValue: function() {
		...
		if (this.$isEditMode && this._editor && this._editor.$area) {
			...
			if (this._isRaw) value = _finalizeRawText(value);
		}
		return value;
	},
