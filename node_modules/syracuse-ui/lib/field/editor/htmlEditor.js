					...
					$prototype: {
						$properties: {
							$rows: {
								...
								$title: document.site.localize.htmlEditorTableRows,
								$maxLength: 5
							},
							$columns: {
								$type: "application/x-integer",
								$title: document.site.localize.htmlEditorTableCol,
								$maxLength: 5
							},
							$borderSize: {
								$type: "application/x-integer",
								$title: document.site.localize.htmlEditorTableBorderSize,
								$maxLength: 5
							},
							$withHeader: {
								$type: "application/x-boolean",
								$title: document.site.localize.htmlEditorTableWithHeader
							}
						},
						$links: {}
					},
					$article: {
						$title: document.site.localize.htmlEditorTableTitle,
						$category: "section",
						$layout: {
							$items: [{
								$layoutType: "stack",
...
function getInsertTableDialog(prefix) {
	/*
     var dialog = document.site.page.openDialog({
     $dialogMode: "modal",
     $itemPage: {
     $isEditMode: true,
     $urlParts: {
     ...
     var insertTableDialog = dialog.$$dialogSlot[0].outerHTML;
     dialog.close();
     ...
     '<div class="s-field-slot s-slot-row" style="width: 50%;"><div class=" s-field-top" data-s-field="' +
     prefix +
     '-rows" data-s-inout="' +
     prefix +
     '-rows">' + //
     '<label class="s-field-top-title" for="' +
     prefix +
     '-rows-input">Rows</label>' + //
     '<div class="s-field-top-core"><div class="s-field-value-slot" style="max-width: 240px;"><div class="s-field-value">' + //
     '<input type="text" spellcheck="false" autocorrect="off" class="s-field-input" maxlength="3" data-s-field="' +
     prefix +
     '-rows" id="' +
     prefix +
     '-rows-input"></div></div></div></div></div>' + //
     ...
     '<div class=" s-field-top" data-s-field="' +
     prefix +
     '-border" data-s-inout="' +
     prefix +
     '-border">' + //
     '<label class="s-field-top-title" for="' +
     prefix +
     '-border-input">Border size</label>' + //
     ...
     '<label class="s-field-top-title" for="' +
     prefix +
     '-header-input">With header</label>' + //
     ...
     '<input type="checkbox" spellcheck="false" autocorrect="off" class="s-field-input-boolean" data-s-field="' +
     prefix +
     '-header" id="' +
     prefix +
     '-header-input" checked="checked" data-s-selected="true">' + //
     '<div class="s-slot-sep-row s-h2-sep-row"></div>' + //
     '</div></div>' + //
     '<div class="s-slot-sep-stack s-h2-sep-stack"></div>' + //
     //
