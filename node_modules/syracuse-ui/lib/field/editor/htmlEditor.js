...
function _getCaretPosition(editor) {
	// TODO: make it work with IE
	if (ie) return 0;

	var doc = editor.doc,
		root = doc.body,
		sel = _getSelection(editor),
	...
	caretPos = contents && contents.textContent && contents.textContent.length;

	// var elt = doc.createElement("span");
...
exports.HtmlEditor = helpers.defineClass(HtmlEditor, Field, {
	...
	getCaretPosition: function() {
		// var range = this.$isEditMode && this._editor && _getRange(this._editor);
		// return range && range.startOffset || 0;
		return this.$isEditMode && this._editor && this._editor.doc.body //
		&& _getCaretPosition(this._editor) || 0;
	},
	render: function() {
	...
	_finalizeCreate: function() {
		...
		var $$body = $(this._editor.doc.body);
	...
	_setContents: function(contents, saveStyles) {
		...
		if (this.$isEditMode) {
			this.checksum = checksum(contents);
