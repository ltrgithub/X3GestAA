...
function lazyInit($){
    ...
    $buttons.rawMode.buttonClick = function(e, data){
        ...
        var button = e.target, editor = data.editor, html;
...
exports.HtmlEditor = helpers.defineClass(HtmlEditor, Field, {
 ...
 +
                ...
                updateFrame: function(html){
                    ...
                    debug && console.log('updateFrame:\n' + html);
                    return html;
                },
                updateTextArea: function(html){
                    debug && console.log('updateTextArea:\n' + html);
                    // TODO: cleanup HTML if necessary
                    ...
                    if (!self.standalone) {
                        ...
                        debug && console.log('updateTextArea notifyFieldChange:\n' + newValue);
                        self.notifyFieldChange(newValue, true);
                    }
                    return html;
                }
            })[0];
        ...
        $$body.bind('paste', function(e){
            ...
            if (e && e.clipboardData && e.clipboardData.getData) {
                ...
                if (window.clipboardData && window.clipboardData.getData) { // IE
                    ...
                    setTimeout(function(){
                        var text = $(el).html();
                        debug && console.log("paste after timeout:\n" + text);
                    }, 100);
                }
            debug && console.log("paste:\n" + pastedText);
        });
    ...
    _setRawEditContents: function(contents){
        if (this.$isEditMode && this._editor && this._editor.$area) {
            debug && console.log('_setRawEditContents:\n' + contents);
    ...
    _getPersistentContents: function(contents){
        ...
        if (this._isRaw) {
            ...
            debug && console.log('_getPersistentContents raw:\n' + contents);
        }
        else {
