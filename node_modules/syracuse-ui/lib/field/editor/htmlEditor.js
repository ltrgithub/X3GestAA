...
function getInsertTableDialog(prefix) {
	...
	'<input type="text" spellcheck="false" autocorrect="off" class="s-field-input" maxlength="30" data-s-field="' + prefix + '-rows" id="' + prefix + '-rows-input"></div></div></div></div></div>' + //
	...
	'<input type="text" spellcheck="false" autocorrect="off" class="s-field-input" style="padding-right: 18px;" data-s-field="' + prefix + '-cols" id="' + prefix + '-cols-input">' + //
	...
	'<input type="text" spellcheck="false" autocorrect="off" class="s-field-input" maxlength="30" data-s-field="' + prefix + '-border" id="' + prefix + '-border-input">' + //
	'</div></div></div></div></div>' + //
