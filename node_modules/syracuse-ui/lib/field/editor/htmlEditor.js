...
exports.HtmlEditor = helpers.defineClass(HtmlEditor, Field, {
    ...
    /// ## isDirty()
    /// 
    /// Returns `true` if the content has changed since the field gained the focus.
    /// 
    isDirty: function() {
        // Get the current content to compute the checksum
        var value = this._getPersistentContents(),
            dirty = this._cache.focusInChecksum !== this._cache.checksum;
    ...
    _beforeInputFocusin: function($$input, event) {
        ...
        this._cache.focusInChecksum = this._cache.checksum;
    },
