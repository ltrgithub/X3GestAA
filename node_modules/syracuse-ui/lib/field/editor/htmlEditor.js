...
function lazyInit($){
    ...
    var popupRawModeContent = document.site._msgBox.$$item[0];
    ...
    $buttons.rawMode.buttonClick = function(e, data){
        ...
        $$popup.find(".s-msgbox-buttons-link").unbind("click").bind("click", function(){
            if ($(this).attr('title') === document.site.localize.msgbox_yes) {
                if (!editor.options._isRaw()) {
...
exports.HtmlEditor = helpers.defineClass(HtmlEditor, Field, {
    ...
    isDirty: function(){
        ...
        var value = this._getPersistentContents(), dirty = (this._cache.oldValue !== value);
...
'htmlEditor.isDirty: ' + this.id + ' isDirty=' + dirty + //
    ...
    _getRawEditContents: function(){
        if (this.isEditable() && this._editor && this._editor.doc && this._editor.doc.body) {
