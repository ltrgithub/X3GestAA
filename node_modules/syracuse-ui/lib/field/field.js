...
exports.Field = helpers.defineClass(Field, null, {
		...
		if (event.type == "focusin") {
			...
			if (self.$item && self.$item.$isCellChild) {
				if (self.articleParent.isRecordArticle && self.articleParent.list) {
					var list = self.articleParent.list;
					if (list && list.scroller) {
						list.scroller.ensureFieldVisibility(self);
					}
				}
			}
		} else {
	...
	focus: function(select) {
		if (this.articleParent.scroller) {
			this.articleParent.scroller.ensureFieldVisibility(this);
		} else {
