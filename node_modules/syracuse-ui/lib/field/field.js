...
exports.Field = helpers.defineClass(Field, null, {
	...
	highlightPickers: function(hightLight) {
		if (this.menusBox) {
			document.site.toggleClass(this.menusBox.domItem, "s-mouseenter", hightLight);
		}
		if (this.boxPickers) {
	...
	setDatasetValue: function(value) {
		return this.articleParent.dataset[this.$item.$bind] = this.currentValue = (value === undefined ? this.getDataValue() : value);
	},
	...
	applyShortCuts: function(shortcuts, event) {
		if (shortcuts.down || shortcuts.up || shortcuts["delete"] || shortcuts.insert || shortcuts.right || shortcuts.left) {
