...
exports.Field = helpers.defineClass(Field, null, {
    applyDesignMetaData: function(metaData, onAuthoring){
        if (metaData.$isHidden !== undefined || metaData.$isExcluded !== undefined) {
    ...
    setState: function(state){
        ...
        if (state.$isHidden !== undefined || state.$isExcluded !== undefined) {
            ...
            if (this.$item.$inplace) {
                this.$$dataValue[0].style.display = this.isVisible ? "" : "none";
            }
            else {
                this.layoutSlot.style.display = this.$$item[0].style.display = this.isVisible ? "" : "none";
