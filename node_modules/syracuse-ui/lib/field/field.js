	...
	setState: function(state) {
		if (!this.$item.$isFilterMode) {
			...
			if (state.$isDisabled !== undefined) {
				...
				if (this.input) {
					syra_dom.disableItem(this.input, state.$isDisabled);
					if (this.$item.$contentEditable) {
						_contentEditable.setState(this, state);
					}
				}
				this.domTitle && syra_dom.disableItem(this.domTitle, state.$isDisabled);
				this.descriptionItem && syra_dom.disableItem(this.descriptionItem, state.$isDisabled);
				syra_dom.disableItem(this._dataValue, state.$isDisabled);
			}
