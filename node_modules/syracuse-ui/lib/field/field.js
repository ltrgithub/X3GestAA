...
exports.Field = helpers.defineClass(Field, null, {
    ...
    appendToPickerBox: function(picker){
        if (!this.boxPickers) {
            ...
            this.$$fieldValue[0].appendChild(this.boxPickers).className = "s-field-pickers";
        }
                ...
                doEvent: function(options){
                    switch ($$btn[0].getAttribute("data-s-picker")) {
                        ...
                        case "tunnel":
                            break;
                        case "menus":
                            //self._menusController.contextMenu
                            break;
                        default:
    ...
    _ensureMenuPickerVisible: function(){
        if (this._menusController) {
            this._menusController.ensurePickerVisible(this.$isEditMode || (this.currentValue != null));
        }
    },
