...
exports.Field = helpers.defineClass(Field, null, {
    ...
    getDefaultTitle: function(){
        ...
        return localize.f_defaultTitle;
    },
    getTitle: function(){
    ...
    drawDiagnose: function($diagnose, severityGroup){
        if (this.isDiagnoseInPlace) {
            if (!this._diagnoseFlag) {
                this._diagnoseFlag = document.createElement("a");
                this._diagnoseFlag.className = "s-field-diagnose-flag-" + severityGroup.severity;
                this._addButtonToValue(this._diagnoseFlag);
            }
            var html = document.createElement("a");
            html.setAttribute("data-s-menu", this.id);
            html.setAttribute("data-s-article", this.boxParent.getArticle().id);
            html.className = "s-field-diagnose-link-" + severityGroup.severity;
            ...
            $(label).prepend($(html).text(this.$field.$title + ":")).appendTo(this.domDiagnose);
        }
        else {
            var html = document.createElement("a");
            html.setAttribute("data-s-menu", this.id);
    ...
    emptyDiagnoseSlot: function(){
        if (this.domDiagnose) {
            ...
            if (this._diagnoseFlag) {
                this._removeButtonToValue(this._diagnoseFlag);
                delete this._diagnoseFlag;
            }
        }
    ...
    ensureDiagnoseSlot: function(){
        if (!this.domDiagnose) {
            ...
            if (this.$item.$inplace && article.ensureFieldDiagnoseSlot) {
                this.isDiagnoseInPlace = true;
                article.ensureFieldDiagnoseSlot(this);
            }
            else {
                this._core.appendChild(this.domDiagnose);
            }
        }
        else {
            document.site.emptyDom(this.domDiagnose);
