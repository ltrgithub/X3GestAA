...
var _shortcutInvoker = require("syracuse-ui/lib/events/shortCutInvoker");
...
function _addEscapePicker(field) {
	if (!field.isEscapePickerDisabled && field.input && !field.$isReadOnly && field.page.isFusionPage && !field.$item.$inplace) {
		syra_menus.button.addFieldPicker({
			...
			shortCutTip: shortCutsTip["escape"],
			btnclick: function(event) {
				_shortcutInvoker.applyEscape(this.parent, null, event);
				this.parent.focus();
			}
		});
	}
...
exports.Field = helpers.defineClass(Field, null, {
	...
	focus: function(select) {
		this.boxParent && this.boxParent.ensureOpened && this.boxParent.ensureOpened();
		this.scrollToField();
