...
var menusHelper = require('syracuse-ui/lib/field/helpers/menusHelper');
...
exports.Field = helpers.defineClass(Field, null, {
	...
	loadBox: function() {
		...
		this.menusHelper.setMenus(this, this.$field);
		...
		if (!self.authoringNode && !self.$isDisabled) {
			self.page.externalAdapter.onFieldClickPicker({
				...
				doEvent: function(options) {
					self.menusHelper.clickMenu(self, "$localize");
				}
			});
		}
	},
	...
	setState: function(state) {
		if (!this.$item.$isFilterMode) {
			...
			this.menusHelper.applyState(this);
		}
	...
	applyMetaData: function(metaData, options) {
		if (this.domValueSlot) { //important for reloading and initiliaze method called before render
			if (metaData) {
				...
				this.menusHelper.setMenus(this, metaData);
	...
	dispose: function() {
		...
		this.menusHelper && this.menusHelper.dispose(this);
		...
		this.menusHelper = this.pickersHelper = this.layoutParent = this.boxParent = this.articleParent = this.page = this.parentVariantField = null;
	}
});