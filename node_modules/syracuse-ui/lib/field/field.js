...
exports.Field = helpers.defineClass(Field, null, {
    ...
    toggleAutoCompleteList: function(show){
        ...
        /*
         ...
         if (self._autoCompletePopup) {
         if (show) {
         self._autoCompletePopup.onWindowResize();
         }
         else {
    ...
    onInputKeydown: function(input, event){
        if (this._isAutoComplete && this.getDataValue() !== "") {
            var self = this;
            setTimeout(function(){
            ...
            if (this.getDataValue() == "" && this._autoCompletePopup) {
