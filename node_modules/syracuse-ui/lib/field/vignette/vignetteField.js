...
exports.VignetteField = helpers.defineClass(VignetteField, SectionBlock, {
	...
	refresh: function(onVignetteRefresh) {
		...
		this.renderLayoutContent($refresh && $refresh.$url, onVignetteRefresh);
	},
	onDesignOpenerClick: function() {
		var self = this;
		if (self.page.isLandingPage) {
			syra_site.switchItemDesigner(self, !self.designer);
		} else {
	...
	onDeleteClick: function() {
		syra_site.landingPageMaster.onDeleteVignetteClick(this);
	},
