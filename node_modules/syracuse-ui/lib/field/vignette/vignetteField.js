	...
	addResizer: function() {
		this.resizer = new Resizer({
			...
			start: function(resizing) {
				resizing.body = syra_dom.getBoundingClientRect(this.vignette.body);
				this.$width = resizing.body.width;
				this.$height = resizing.body.height;
			},
			drag: function(resizing) {
				if (resizing.deltaX != undefined) {
					this.$width = resizing.body.width + resizing.deltaX;
					this.vignette.body.style.width = this.$width + "px";
				}
				if (resizing.deltaY != undefined) {
					this.$height = resizing.body.height + resizing.deltaY;
					this.vignette.body.style.height = this.$height + "px";
				}
			},
