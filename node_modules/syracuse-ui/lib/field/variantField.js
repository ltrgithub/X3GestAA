...
exports.VariantField = helpers.defineClass(VariantField, null, {
	...
	addPicker: function(pickerId, cssId, picker) {
		return this.variantItem.addPicker(pickerId, cssId, picker);
	},
	...
	showItem: function(show) {
		this.variantItem.showItem(show);
	},
	...
	setInputWidth: function(widthValue) {
		if (this.variantItem && this.variantItem.setInputWidth) {
			this.variantItem.setInputWidth(widthValue);
		}
	},
	...
	getDatasetValue: function() {
		return this.variantItem.getDatasetValue();
	},
	setDatasetValue: function(value) {
		return this.variantItem.setDatasetValue(value);
	},
	...
	dispose: function() {
		...
		this.$rootLinks = this.rowSeparator = null;
