...
exports.VariantField = helpers.defineClass(VariantField, null, {
		...
		if (value && !this.variantItem) {
			...
			for (var ii = 0, jj = keys.length; ii < jj; ii++) {
				...
				if (this.$field.$variants[$key]) {
					...
					this.variantItem = this.page.addItem(this.layoutSlot, $item, this.boxParent);
	...
	isDirty: function() {
		return this.variantItem.isDirty();
	},
	setDirty: function(dirty) {
		this.variantItem.setDirty(dirty);
	},
	getValue: function() {
		return this.variantItem.getValue();
	},
	...
	onMenuClick: function(options) {
		return this.variantItem.onMenuClick(options);
	},
