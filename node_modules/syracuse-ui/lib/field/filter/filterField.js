...
exports.FilterField = helpers.defineClass(FilterField, null, {
	...
	addMenu: function() {
		...
		self._operator.style.backgroundImage = "url('" + syra_site.$item.$iconPath + "list/s-filter-none.png')";
		...
		$(self.labelAndMenu.appendChild(self._operator)).bind("click", function() {
			if (!self.listPopup) {
				...
				operators.forEach(function(op) {
					...
					link.style.backgroundImage = "url('" + syra_site.$item.$iconPath + "list/s-filter-" + op + ".png')";
	...
	setOperator: function(operator) {
		...
		self._operator.style.backgroundImage = "url('" + syra_site.$item.$iconPath + "list/s-filter-" + (self.operator = operator) + ".png')";
