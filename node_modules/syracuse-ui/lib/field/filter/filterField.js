...
function _onOperatorClick() {
	...
	if (_popup && _popupItem && _popupItem.syraItem == field.id) {
		...
		_popup = syra_dlg.openPopup(field.filterBlock.articleParent, {
...
exports.FilterField = helpers.defineClass(FilterField, null, {
	createField: function($property, $item, filterBlock, index) {
		...
		this.layoutSlot = syra_dom.addDiv(this.$skin + "-field", this.filterBlock.filterBlockContainer);
		this.layoutSlot.syraItem = this.id;
		this.labelAndMenu = syra_dom.addDiv(this.$skin + "-field-header", this.layoutSlot);
		this.valuesSlot = syra_dom.addDiv(this.$skin + "-field-values", this.layoutSlot);
	...
	addValueField: function($bind) {
		var slot = syra_dom.addDiv(this.$skin + "-field", this.valuesSlot);
		var field = this.filterBlock.articleParent.page.loadNewItem(slot, {
			$bind: $bind,
