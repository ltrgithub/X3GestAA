...
exports.ReferenceField = helpers.defineClass(ReferenceField, Field, {
    ...
    render: function(){
        if (this.$isEditMode) {
            ...
            this.$$fieldValue.append(this.$$refTitle);
        }
        else {
    ...
    _ensureMenuPickerVisible: function(){
        if (this._menusController) {
            this._menusController.ensurePickerVisible(this.currentValue && this.currentValue.$value && this.currentValue.$value != "");
        }
    },
