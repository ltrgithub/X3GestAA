        ...
        if (value) {
            ...
            if (this._hasUiid) {
                ...
                if (typeof(value) == 'object') {
                    ...
                    if (this.currentValue.$title == null && this.$refTitle.$field) {
                    ...
                    if (this.currentValue.$value == null && this.$refValue.$field) {
    ...
    _renderCurrentValue: function(){
        if (this.$isEditMode) {
            ...
            if (this.codeMenu) {
                ...
                $details.$description = this.currentValue.$title || this.currentValue.$description || "";
