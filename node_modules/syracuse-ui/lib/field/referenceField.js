...
exports.ReferenceField = helpers.defineClass(ReferenceField, Field, {
	...
	setState: function(state) {
		...
		if (state.$isHidden !== undefined && this.articleParent.isSingleRecord) {
			this.articleParent.domItem.style.display = this.$isHidden ? "none" : "";
		}
	},
	...
	validateMandatoryValue: function(errors) {
		if (this.$isMandatory) {
			if (this._hasUiid) {
				...
				Field.prototype.validateMandatoryValue.call(this, errors, this.getInputValue());
			}
		}
	},
	...
	onItemInOut: function(onEnter, event, target) {
		...
		if (onEnter && this.descriptionText) {
			if (this.$item.$isCellChild || (this._refTitle && this._refTitle.scrollWidth != this._refTitle.clientWidth)) {
				syra_site.dialogManager.titleTip.show(this.descriptionText, this.domItem);
			}
		}
	},
