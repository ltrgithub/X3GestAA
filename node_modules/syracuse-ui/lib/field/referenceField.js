			...
			if (onEnter) {
				if (this.$item.$isCellChild || (this._refTitle && this._refTitle.scrollWidth != this._refTitle.clientWidth)) {
					if (!this.popupTitle) {
						...
						this.popupTitle.className = "s-field-popup";
					}
					this.popupTitle.textContent = this.descriptionText;
					this.popupTitleInfo = syra_site.dialogManager.openPopup(this.page, {
						content: {},
