                                ...
                                if ($key != "$value" && $key != "$etag") {
                                    ...
                                    switch ($key) {
                                        ...
                                        default:
                                            ...
                                            if ($prop) {
                                                if (!$prop.$isReadOnly) {
                                                    if (self.articleParent.$prototype.$properties[$key]) {
                                                        self.articleParent.ensureDataSet()[$key] = self.currentValue[$key];
                                                        sendBag.saveDataChange(self.page, self.articleParent, $key, self.currentValue[$key]);
                                                        copy = false;
                                                    }
                                                }
                                                else {
