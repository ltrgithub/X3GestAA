...
exports.ReferenceField = helpers.defineClass(ReferenceField, Field, {
    ...
    onInputChange: function(input){
        ...
        if (value == "") {
            ...
            if ((this.currentValue && this.currentValue.$value != value) || !this.currentValue) {
                var postValue = {};
                postValue[this.$reference.$value.$prop] = value;
    ...
    getDataValue: function(){
        return this.$field.$item.$value ? this.currentValue : Field.prototype.getDataValue.call(this);
    },
