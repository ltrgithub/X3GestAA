...
exports.NumericField = helpers.defineClass(NumericField, Field, {
	...
	validateKeyPress: function(charCode) {
		...
		// issue #2553, allow "." character to be pressed in the numeric field
		validated = (this.numFormatObj.decimalSeparator != "." && this.numFormatObj.groupSeparator != "." && charCode == ".") || validated;
