...
exports.NumericField = helpers.defineClass(NumericField, Field, {
    ...
    render: function(){
        if (this.$isEditMode) {
            ...
            numPickers.appendChild(this.btnUp = this.createPicker("numeric-up"));
            numPickers.appendChild(this.btnDown = this.createPicker("numeric-down"));
        ...
        try {
            ...
            if (this.$isEditMode) {
                ...
                if (formattedNum && this.$field.$links && this.$field.$links.$details && !this.$item.$isMenusDisabled) {
                    this.appendDetailLink(formattedNum, this.$field.$links.$details);
                }
                else {
