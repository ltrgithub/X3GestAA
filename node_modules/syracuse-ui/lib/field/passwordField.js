...
exports.PasswordField = helpers.defineClass(PasswordField, Field, {
	...
	render: function() {
		...
		if (this.$isEditMode) {
			if (!this.$item.$isConfirmDisabled && this.$field.$capabilities && (this.$field.$capabilities.indexOf("confirm") >= 0)) {
				...
				this.setFieldId(this.confirmInput);
	...
	setState: function(state) {
		...
		if (this.confirmInput && state.$isDisabled !== undefined) {
			document.site.dom.disableItem(this.confirmInput, state.$isDisabled);
		}
	},
	...
	validateType: function(errors, value) {
		if (this.confirmInput && (this.getInputValue() != this.confirmInput.value)) {
			if (this.confirmInput.value)
				errors.push(this.localize.fpwConfirmPasswordError);
			else
				errors.push(this.localize.fpwEnterConfirmationError);
		} else {
			// format value
