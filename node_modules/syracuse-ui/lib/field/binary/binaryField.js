...
exports.BinaryField = helpers.defineClass(BinaryField, Field, {
    ...
    _onEndUpload: function(file){
        ...
        setTimeout(function(){
            ...
            self._$$legend.text(self._localize.bf_dropSelectFile);
        }, 1500);
    },
    ...
    _renderEditMode: function($skin){
        ...
        (self._$$legend = $(dom).appendTo(self._$$info)).text(self._localize.bf_dropSelectFile);
    ...
    _renderDetailMode: function($skin){
        ...
        dom.className = $skin + "-link";
        this.$$anchor = $(dom).prependTo($(this.fieldValue));
    },
