...
exports.BinaryField = helpers.defineClass(BinaryField, Field, {
    ...
    _appendActions: function($skin){
        ...
        self.selectBtn.setAttribute("href", "#");
        self.selectBtn.setAttribute("title", self._localize.bf_selectFile);
        self.selectBtn.textContent = self._localize.bf_selectFile;
        btns.appendChild(self.selectBtn);
        
        self.removeBtn = document.createElement("a");
        self.removeBtn.className = $skin + "-remove";
        self.removeBtn.setAttribute("href", "#");
        self.removeBtn.setAttribute("title", self._localize.bf_removeFile);
        self.removeBtn.textContent = self._localize.bf_removeFile;
        self.removeBtn.style.display = "none";
        btns.appendChild(self.removeBtn);
        
        self._right.appendChild(self.$$btns[0]);
    ...
    _renderEditMode: function($skin){
        ...
        self.$$dropArea = $(self.fieldValue.appendChild(dom)).bind("drop dragenter dragover", function(event){
            switch (event.type) {
                case "drop":
        ...
        self.anchor.className = $skin + "-link";
        self.anchor.setAttribute("disabled", true);
        self.$$anchor = $(self.anchor).prependTo(self.$$dropArea);
        
        self._right = document.createElement("div");
        self._right.className = $skin + "-right";
        self.$$dropArea[0].appendChild(self._right);
        
        
        self._info = document.createElement("div");
        self._info.className = $skin + "-info";
        self._right.appendChild(self._info);
        
        
        self._legend = document.createElement("div");
        self._legend.className = $skin + "-legend";
        self._legend.textContent = self._localize.bf_dropSelectFile;
        self._info.appendChild(self._legend);
