...
var ImageAuthoring = require("syracuse-ui/lib/authoring/field/imageAuthoring").ImageAuthoring;
function ImageField(){
}
...
exports.ImageField = helpers.defineClass(ImageField, BinaryField, {
    getAuthoringWidget: function(designedField){
        if (!this.awAddin) {
            this.awAddin = new ImageAuthoring();
    ...
    loadBox: function($$item){
        ...
        BinaryField.prototype.loadBox.call(this, $$item);
    },
    initialize: function(){
