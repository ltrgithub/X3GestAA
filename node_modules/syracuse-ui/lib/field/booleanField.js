...
function _render(field) {
	...
	if (field.$isEditMode) {
		...
		field.customStyleTarget = field._dataValue;
		...
		var css = " " + field._$cssField + "-read-boolean";
...
exports.BooleanField = helpers.defineClass(BooleanField, Field, {
	...
	setDataValue: function(value) {
		...
		if (this.$isEditMode) {
			...
			if (!this._bool) {
				this._bool = document.createElement("div");
				this._dataValue.appendChild(this._bool);
			}
			this._bool.className = boolValue ? "s-bool-val-on" : "s-bool-val-off";
