...
exports.BooleanField = helpers.defineClass(BooleanField, Field, {
    ...
    /*onFieldInputEvent: function(event){
     switch (event.type) {
     case "focusin":
     this._inputWrapper.className = this.$skinInput + "-bool-slot" + " s-focus";
     break;
     case "focusout":
     this._inputWrapper.className = this.$skinInput + "-bool-slot";
     break;
     }
     Field.prototype.onFieldInputEvent.call(this, event);
     },*/
    render: function(){
        ...
        if (this.$isEditMode) {
            /*     this._inputWrapper = document.createElement("div");
             this.fieldValue.appendChild(this._inputWrapper);
             this._inputWrapper.className = this.$skinInput + "-boolean-slot";
             */
            this._input = document.createElement("input");
            this._input.setAttribute("type", "checkbox");
            this._input.className = this.$skinInput + "-boolean";
            //this.$$input = $(this._inputWrapper.appendChild(this._input));
