...
function _setDataValue(field, value) {
	...
	if (field.$isEditMode) {
		...
		if (value) {
			...
			if (!field._iconFlag) {
				field._iconFlag = syra_menus.button.addIndicator({
					parent: field,
					iconOnly: true,
					css: " s-icon-" + field._$iconValue,
		...
		syra_menus.showMenuPicker(field);
	}
}
...
exports.PhoneField = helpers.defineClass(PhoneField, Field, {
	...
	_createValueContainer: function() {
		...
		if (!this.$isEditMode) {
			...
			this._dataValue.className = css + "s-" + this._$iconValue;
		}
	},
...
exports.UrlField = helpers.defineClass(UrlField, Field, {
	...
	onUrlClick: function() {
		this.currentValue && syra_url.history.load(this.currentValue, "blank", null, false);
	}
