...
exports.TimeSelector = helpers.defineClass(TimeSelector, null, {
	create: function(field, options) {
		syra_map[this.id = (field.id + "timeselector")] = this;
		...
		table.className = "s-time-popup-table";
		table.setAttribute("cellspacing", "0");
		table.setAttribute("cellpadding", "0");

		var row = document.createElement("tr");
		var cell = document.createElement("th");
		cell.className = "s-time-popup-th";
		...
		for (var rr = 0; rr < rowCount; rr++) {
			...
			for (var col = 0; col < this.columns; col++) {
				...
				cell.className = "s-time-popup-td";
				if (cellIndex < cellCount) {
					var link = document.createElement("a");
					link.className = "s-time-popup-a";
	...
	onTimeClick: function(event, picker) {
		...
		picker.className = "s-time-popup-a s-time-select";
