...
exports.DateSelector = helpers.defineClass(DateSelector, null, {
	...
	_appendHead: function() {
		...
		var btn = syra_menus.addIconButton(syra_local.fdpPrevYear, "s-calendar-btn", "onChangePeriode", "CTRL + LEFT", "first_step");
		btn.syraIsPrev = true;
		btn.syraPeriod = "year";
		cell.appendChild(btn);

		// prev month btn
		btn = syra_menus.addIconButton(syra_local.fdpPrevMonth, "s-calendar-btn", "onChangePeriode", "SHIFT + LEFT", "prev_step");
		...
		btn = syra_menus.addIconButton(syra_local.fdpNextMonth, "s-calendar-btn", "onChangePeriode", "movePrevDay", "next_step");
		btn.syraPeriod = "month";
		cell.appendChild(btn);

		btn = syra_menus.addIconButton(syra_local.fdpNextYear, "s-calendar-btn s-calendar-next-year", "onChangePeriode", "CTRL + RIGHT", "last_step");
		btn.syraPeriod = "year";
		cell.appendChild(btn);
	...
	_appendFoot: function() {
		...
		var btn = syra_menus.addIconButton(syra_local.fdpPrevWeek, "s-calendar-btn", "onChangePeriode", "UP", "prev_step");
		btn.syraIsPrev = true;
		btn.syraPeriod = "week";
		cell.appendChild(btn);
		...
		btn = syra_menus.addIconButton(syra_local.fdpNextWeek, "s-calendar-btn", "onChangePeriode", "DOWN", "next_step");
		btn.syraPeriod = "week";
		cell.appendChild(btn);
		row.appendChild(cell);
