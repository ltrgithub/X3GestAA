...
exports.DateSelector = helpers.defineClass(DateSelector, null, {
	...
	create: function(field, options) {
		syra_map[this.id = (field.id + "dateselector")] = this;
	...
	_appendHead: function() {
		...
		var btn = syra_menus.addIconButton(syra_local.fdpPrevYear, "s-calendar-prev s-calendar-prev-year", "onChangePeriode");
		btn.syraIsPrev = true;
		btn.syraPeriod = "year";
		cell.appendChild(btn);

		// prev month btn
		btn = syra_menus.addIconButton(syra_local.fdpPrevMonth, "s-calendar-prev s-calendar-prev-month", "onChangePeriode");
		...
		btn = syra_menus.addIconButton(syra_local.fdpNextMonth, "s-calendar-next s-calendar-next-month", "onChangePeriode");
		btn.syraPeriod = "month";
		cell.appendChild(btn);

		btn = syra_menus.addIconButton(syra_local.fdpNextYear, "s-calendar-next s-calendar-next-year", "onChangePeriode");
		btn.syraPeriod = "year";
		cell.appendChild(btn);
	...
	_appendFoot: function() {
		...
		var btn = syra_menus.addIconButton(syra_local.fdpPrevWeek, "s-calendar-prev", "onChangePeriode");
		btn.syraPeriod = "week";
		cell.appendChild(btn);
		...
		btn = syra_menus.addIconButton(syra_local.fdpNextWeek, "s-calendar-next", "onChangePeriode");
		btn.syraPeriod = "week";
		cell.appendChild(btn);
		row.appendChild(cell);
		...
		btn = syra_menus.addTextButton(syra_local.fdpToday, "s-calendar-today-link", "onTodayClick");
		cell.appendChild(btn);
		row.appendChild(cell);
