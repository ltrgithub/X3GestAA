...
function _onChangePeriode() {
	...
	if (this.period == "month") {
		selector._currentDate = selector._currentDate.addMonths(this.isPrev ? -1 : 1);
	} else
	if (this.period == "year") {
		selector._currentDate = selector._currentDate.addYears(this.isPrev ? -1 : 1);
	} else {
		selector._currentDate = selector._currentDate.addDays(this.isPrev ? -7 : 7);
	}
	selector._drawBody();
}
...
exports.DateSelector = helpers.defineClass(DateSelector, null, {
	...
	_appendFoot: function() {
		...
		this._quickBtn = syra_menus.button.add({
			parent: this,
			slot: cell,
