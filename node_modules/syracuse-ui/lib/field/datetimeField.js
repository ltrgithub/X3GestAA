...
exports.DateTimeField = helpers.defineClass(DateTimeField, Field, {
	applyEscape: function() {
		this.popupPicker && this.popupPicker.close();
		return true;
	},
	...
	render: function() {
		if (this.$isEditMode) {
			if (this.$field.$type != "application/x-datetime") {
				...
				syra_menus.addPicker(this, this.isTimeField ? "time" : "date", this.isTimeField ? syra_local.dfSelectTime : syra_local.dfSelectDate, null, "DOWN,ESC L, ESC F12");
			} else {
				this.input = document.createElement("input");
				this.input.setAttribute("type", "text");
				syra_site.setSpecificAttributes(this.input);
