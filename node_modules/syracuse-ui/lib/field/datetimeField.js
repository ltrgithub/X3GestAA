...
exports.DateTimeField = helpers.defineClass(DateTimeField, Field, {
	...
	render: function() {
		if (this.$isEditMode) {
			if (this.$field.$type != "application/x-datetime") {
				...
				syra_menus.addFieldPicker(this, this.isTimeField ? "time" : "date", this.isTimeField ? syra_local.dfSelectTime : syra_local.dfSelectDate, "DOWN,ESC L, ESC F12");
			} else {
				this.input = document.createElement("input");
				this.input.setAttribute("type", "text");
				syra_site.setSpecificAttributes(this.input);
	...
	setDataValue: function(value) {
		helpers.lvLog("dateTimeField setDataValue ", value, this.$item.$bind);
