    ...
    render: function(){
        if (this.$isEditMode) {
            ...
            // application/x-datetime
                ...
                var input = (this.$$input = $("<input type='text'/>"))[0];
                input.className = this.$skinInput;
				this.$$fieldValue[0].appendChild(input).className = this.$skinInput;
            }
        }
        else {
            ...
            try {
                ...
                if (this.$isEditMode) {
                    ...
                    if (formated && this.$field.$links && this.$field.$links.$details && !this.$item.$isMenusDisabled) {
                        this.appendDetailLink(this.$$fieldValue, formated, this.$field.$links.$details);
                    }
                    else {
                        this.$$fieldValue.text(formated);
                    }
                }
            } 
            catch (error) {
