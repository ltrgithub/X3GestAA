	...
	"application/x-time": {
		formatInput: function(field, val) {
			...
			if (hasAM || hasPM) {
				...
				if (hour > 12) return "invalid time. With AM/PM designator, hour value cannot be greater than 12";
...
exports.DateTimeField = helpers.defineClass(DateTimeField, Field, {
	...
	initialize: function() {
		...
		if (this.$field.$type == "application/x-date") this.formatObj = formatApi.processFormat(this.localFormat);
		if (this.formatEx) {
		...
		if (value !== undefined && value !== null) {
			try {
				...
				if (this.$isEditMode) {
					...
					if (formated && this.$rootLinks.$links && this.$rootLinks.$links.$details && !this.$item.$isMenusDisabled) {
