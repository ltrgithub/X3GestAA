...
exports.DateTimeField = helpers.defineClass(DateTimeField, Field, {
        ...
        if (!this.$isReadOnly) {
            this.page.externalAdapter.setPickerValue({
                ...
                doStatements: function(options){
                    self._input.value = options.value;
                    self._input.focus();
                    self.$$input.change();
                }
            });
    ...
    setDataValue: function(value, record){
        ...
        if (value !== undefined && value !== null) {
            try {
                ...
                if (this.$isEditMode) {
                    this._input.value = dateObj.toString(this.localFormat);
    ...
    getDataValue: function(){
        return this.formatApi.parse(this._input.value, this.localFormat).toString();
    },
