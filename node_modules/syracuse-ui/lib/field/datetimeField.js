...
exports.DateTimeField = helpers.defineClass(DateTimeField, Field, {
	...
	initialize: function() {
		...
		//}
		this.localFormatDisplay = syra_culture.format.get(this.$field.$type, this.$field.$format);
		this.$field.$maxLength = syra_culture.format.getLength(this.localFormatDisplay);
