...
function _toggleList(field, show, filter) {
	if (!field.popupPicker && show !== false) {
		...
		field._list = syra_dom.div("s-over-popup " + (field.$item.$css ? field.$item.$css : ""));
		...
		var position = field.$item.$showPopup == "right" ? {
			my: "left top",
			at: "right top"
		} : {
			my: "left top",
...
exports.render = function(field) {
	...
	field.$skinListItem = field.$item.$skinListItem || "s-over-popup-btn-choice";
