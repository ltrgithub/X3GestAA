...
exports.ComboFormat = helpers.defineClass(ComboFormat, null, {
	...
	render: function() {
		...
		if (this.field.$isEditMode) {
			...
			this.field.pickersHelper.addChoice(this.field);
			this.field._appendLinksPicker();
			if (this.field.$item.$icon) {
				this.field.choicePicker.className += " s-icon";
			...
			if (this.field.$item.$cssMode) {
				this.field.choicePicker.className += " s-cssmode " + this.field.$item.$cssMode.$css;
