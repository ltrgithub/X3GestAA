...
exports.ComboFormat = helpers.defineClass(ComboFormat, null, {
	...
	_setMinWidth: function() {
		this._list.style.minWidth = this.field._input.parentNode.clientWidth + "px";
	},
		...
		if (!self._popup && show !== false) {
			...
			self._popup = document.site.dialogManager.openPopup(self.field.boxParent, {
				...
				position: {
					my: "left top",
					at: "left bottom",
					of: $(self.field._input)
				},
				onresize: function(dialog) {
					if (self.field._input) {
						var parentRect = self.field._input.parentNode.getBoundingClientRect();
