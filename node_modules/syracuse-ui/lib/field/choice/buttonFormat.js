...
exports.ButtonFormat = helpers.defineClass(ButtonFormat, null, {
	...
	setDataValue: function(value) {
		...
		if (this.field.$isEditMode) {
			if (oldSelected) {
				document.site.dom.toggleClass(this._choices[oldSelected.$index], "s-selected", false);
			}
			if (this._$selectedEnum) {
				document.site.dom.toggleClass(this._choices[this._$selectedEnum.$index], "s-selected", true);
			}
		} else {
	...
	onChoiceClick: function(picker) {
		this.setDataValue(this.field.$enum[picker.syraChoice].$value);
	...
	renderLayout: function() {
		...
		if (!this._fieldset) {
			...
			document.site.dom.empty(this._fieldset);
		}
		...
		for (var ii = 0, jj = this.field.$enum.length; ii < jj; ii++) {
			...
			link.syraOnClick = "onChoiceClick";
			link.syraChoice = ii;
			link.setAttribute("data-s-picker2", "onChoiceClick");
			link.setAttribute("data-s-field2", this.field.id);
			...
			if (this.field.$item.$icon) {
				...
				link.syraOnClick = "onChoiceClick";
				link.syraChoice = ii;
				link.setAttribute("data-s-picker2", "choice");
