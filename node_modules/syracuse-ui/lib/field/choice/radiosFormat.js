	...
	setDataValue: function(value) {
		...
		if (this.field.$isEditMode) {
			if (this._$selectedEnum) {
				...
				this._setSelectedState(this._choices[this._$selectedEnum.$index]);
			}
		} else {
			if (value && this.field.$rootLinks.$links && this.field.$rootLinks.$links.$details && !this.field.$item.$isMenusDisabled) {
	...
	renderLayout: function() {
		if (this.field.$isEditMode) {
			...
			for (var ii = 0, jj = this.field.$enum.length; ii < jj; ii++) {
				...
				input.syraFieldId = this.field.id;
