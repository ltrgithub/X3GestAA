...
exports.RadiosFormat = helpers.defineClass(RadiosFormat, null, {
    ...
    focus: function(){
        if (this.field.$isEditMode && !(this.$isHidden || this.$isDisabled)) {
            var index = 0;
    ...
    renderLayout: function(){
        var self = this;
        this.field.$isLayoutContentSizeDisabled = true;
        this._choices = [];
        ...
        for (var ii = 0, jj = this.field.$enum.length; ii < jj; ii++) {
            ...
            if (this.field.$item.$icon) {
                var image = this.$icon.$path + $enum.$value + ".png";
    ...
    dispose: function(){
        this._choices = this.field = this._$selectedEnum = null;
    }
});
