...
exports.RadiosFormat = helpers.defineClass(RadiosFormat, null, {
	focus: function() {
		if (this.field.$isEditMode && !this.field.$isHidden && !this.field.$isDisabled) {
			var index = this.selectedIndex >= 0 ? this.selectedIndex : _getChecked(this);
			this._choices[index >= 0 ? index : 0].checkBox.input.focus();
			return true;
		}
		return false;
	},
	...
	getDataValue: function(event) {
		var index = (event && event.target) ? event.target.syraEnumIndex : -1;
		if (index < 0) {
