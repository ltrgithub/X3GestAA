...
exports.ChoiceField = helpers.defineClass(ChoiceField, Field, {
	...
	applyShortCuts: function(shortcuts, event) {
		var applyed = Field.prototype.applyShortCuts.call(this, shortcuts, event);
		if (!applyed) {
			applyed = this.builder.applyShortCuts ? this.builder.applyShortCuts(shortcuts, event) : false;
		}
		return applyed;
	},
