...
exports.ChoiceField = helpers.defineClass(ChoiceField, Field, {
    ...
    focus: function(){
        return this.builder.focus ? this.builder.focus() : Field.prototype.focus.call(this);
    },
    ...
    localizeEnum: function(){
        for (var ii = 0, jj = this.$enum.length; ii < jj; ii++) {
            var $title = this.$enum[ii].$title;
            if ($title.length > 0 && $title[1] == "@") {
                this.$enum[ii].$title = this.boxParent._renderExpression($title);
            }
            else {
                break;
            }
    ...
    setFieldWidth: function(){
        ...
        /*if (this.domValueSlot && this.$item.$format == "$radios") {
         this.domValueSlot.style.maxWidth = "";
         }*/
    },
