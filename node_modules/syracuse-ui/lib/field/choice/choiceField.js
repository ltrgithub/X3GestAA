...
exports.ChoiceField = helpers.defineClass(ChoiceField, Field, {
	...
	focus: function(select) {
		...
		var res;
		if (this.builder.focus) {
			res = this.builder.focus(select);
			this.scrollToField();
		} else {
	...
	applyDesignMetaData: function(metaData, designing) {
		...
		if (metaData.$format && metaData.$format != this.$item.$format) {
			...
			if (this.builder) {
				syra_site.disposeObject(this.builder);
				delete this.builder;
			}
	...
	highlightOnEnter: function(on, event, target) {
		if (this.builder.highlightOnEnter) {
			this.builder.highlightOnEnter(on, event, target);
		} else {
	...
	dispose: function() {
		this.builder && syra_site.disposeObject(this.builder);
