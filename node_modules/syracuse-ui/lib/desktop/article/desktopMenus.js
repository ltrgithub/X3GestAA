...
exports.DesktopMenus = helpers.defineClass(DesktopMenus, Box, {
    ...
    _appendMore: function($$opener){
        ...
        dom.className = self.$skin + "-more-btn s-close";
        var $$btn = $(dom).text("more");
        
        dom = document.createElement("div");
        dom.className = self.$skin + "-more-body";
        var $$body = $(dom).appendTo(self.$$item).hide();
        ...
        dom.className = self.$skin + "-more-nav";
        return $(dom).appendTo($$body);
    },
