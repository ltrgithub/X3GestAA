...
exports.DesktopPage = helpers.defineClass(DesktopPage, Page, {
    ...
    loadBox: function(initData){
        switch (this.$pageCategory) {
            case "dashboard":
                this._defaultTitle = _localize.dashboardTitle;
            ...
            case "vignette":
                ...
                this._defaultTitle = _localize.vignetteTitle;
                if (this.$facet == "$demo") {
                    this.$autoFetch = false;
                }
                this.$isSearchFacetEnabled = false;
                ...
                break;
            default:
                this._defaultTitle = _localize.pageTitle;
    ...
    appendArticleMenus: function(){
        if (this.$pageCategory != "dashboard") {
            Page.prototype.appendArticleMenus.call(this, (this.$pageCategory == "vignette") ? "prependTo" : null);
        }
    },
    ...
    drawBox: function(){
        ...
        if (this.$item.$skin) {
            console.log("page : draw box $skin is undefined");
        }
