...
exports.DesktopPage = helpers.defineClass(DesktopPage, Page, {
        ...
        switch (this.$pageCategory) {
            ...
            case "portlet":
                ...
                if ($menus) {
                    ...
                    dom.className = this.$skin + "-menu-row";
                    var $$menuRow = $(dom).prependTo(this.$$item);
                    
                    dom = document.createElement("div");
                    dom.className = this.$skin + "-menus";
                    var $$menus = $(dom).prependTo($$menuRow);
    ...
    drawBox: function(){
        ...
        this.$skin = this.$item.$skin || document.site.$item.$layoutOptions[this.$pageCategory].$skin;
