            ...
            switch (forme.xshapeType){
                    ...
                    case 'clipshape' :
	                    ...
	                    img.attr('width',function(d){ 
	                    	var a=Math.abs(d.xanchors[1].x-d.xanchors[0].x);
	                     var b=Math.abs(d.xanchors[3].x-d.xanchors[0].x);
	                      return ((a==0) ? b :a );}) ;
	                    img.attr('height',function(d){ ;
	                    	var a=Math.abs(d.xanchors[1].y-d.xanchors[0].y);
	                     var b=Math.abs(d.xanchors[3].y-d.xanchors[0].y);
	                      return ((a==0) ? b:a );}) ;
	                    img.attr('y',function(d){
	                    	var a=d.xanchors[0].y ;
	                    	var b=d.xanchors[3].y ;
	                    	return (((a<b)?a:b) +'px') ;}) ;
	                    img.attr('x',function(d){
	                    	var a=d.xanchors[0].x ;
	                    	var b=d.xanchors[3].x ;
	                    	return (((a<b)?a:b) +'px') ;}) ;
