...
*/
 ...
 function click(d) {
  ...
  edge.attr('marker-end',function(d){return 'url(#endMarker'+d.uniqueID+')';});
  edge.attr('marker-start',function(d){return 'url(#startMarker'+d.uniqueID+')';});
 ...
 function compare_int_func(a, b) {
  ...
  function constructLinksObj(forme){
         ...
         switch(forme.xlinkProps.xtype){
          ...
          function appendLineMarker(defs,markertype,forme){
          if (markertype!='none'){
          var marker = d3.select(defs).append('marker').attr('id', 'startMarker' + forme.uniqueID);
          marker.attr('viewBox', '0 0 15 15').attr('refX', 5).attr('refY', 6);
          var markershape ;
          switch (markertype) {
          case 'arr1':
           markershape=marker.append('path').attr('d', 'M 0 0 L 10 5 L 0 10 z');
           break;
          case 'arr2':
           markershape=marker.append('path').attr('d', 'M 0 0 L 10 5 L 0 10');
           break;
          case 'diamond1':
           break;
          case 'disc1':
           markershape=marker.append('circle').attr('cx', 6).attr('cy', 6).attr('r', 5) ; 
           break;
          }
   ...
   appendLineMarker(defs,forme.xstrokeProps.xstart.xtype,forme) ;
   appendLineMarker(defs,forme.xstrokeProps.xend.xtype,forme) ;
  }