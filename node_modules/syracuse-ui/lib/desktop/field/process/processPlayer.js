         ...
         function appendShape(forme,el){
            ...
            switch (forme.xshapeType){
                    ...
                    case 'clipshape' :
	                    ...
	                    img.attr('width',function(d){return d.xsize.xwidth;}) ;
	                    img.attr('height',function(d){return d.xsize.xheight;}) ;
	                    img.attr('y',function(d){return d.xcenter.y-d.xsize.xheight/2 +'px' ;}) ;
	                    img.attr('x',function(d){return d.xcenter.x-d.xsize.xwidth/2 +'px' ;}) ;
	...
	appendLineMarker(defs,forme.xstrokeProps.xend.xtype,forme) ;
		...
		for (var gn = 0, sizeG = formesListe.length; gn < sizeG; gn++) {
			var group = formesListe[gn];
				    			var gforme=svgplot.selectAll("g") //
