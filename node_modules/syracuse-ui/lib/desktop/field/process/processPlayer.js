...
*/
        ...
        var points =[] ;
         ...
         function appendShape(forme,el){
            ...
            switch (forme.xshapeType){
                    ...
                    case 'clipshape' :
	                    var g=d3.select(el) ;
	                    var img= g.append('image') ;// d3.select($$container[0]).selectAll("img") ;
	            
	                    img.attr('id',function(d){
	                        return d.uniqueID;
	                    }) ;
	                    ...
	                    /*img.attr('transform',function(d){
	                    	...
	                    	var sinx=(d.xcenter.x-xcoords[0])/d.xsize.xheight ;
	                    	var cosx=(d.xcenter.y-ycoords[0])/d.xsize.xwidth ;
	                    	...
	                    	return 'rotate('+ angle+','+xcoords[0]+',' +ycoords[0] +')';

	                    });*/

	                    img.attr('viewBox',function(d){ 
																						return '0 0 '+d.xsize.xwidth+' '+d.xsize.xheight}) ;
	                    img.attr('preserveAspectRatio','none');
	                    img.attr('z-index',function(d){return d.xlevel ;}) ;
	                    ...
	                    return  '/syracuse-ui/themes/desktop/sage/process/images/' //
	                    +getBibName(d.bibid)+'/'+d.eltid+'.png';}) ;
	                    var links=img.filter(function(forme){return ( forme.xlinkProps.xtype!='none');}) ;//
	...
	appendLineMarker(defs,forme.xstrokeProps.xend.xtype,forme) ;
        ...
        /*var actions=gforme.filter(function(forme){
            return ( forme.xactionProps.trig!=null);
           }) ; 
        actions.on(function(d){
        	var atype ;
