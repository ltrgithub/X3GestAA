...
/*function appendCircle(forme,svgel){
        var circl=d3.select(svgel).append('circle').attr('r', 15).attr('cx',forme.xanchors[0].x).attr('cy',forme.xanchors[0].y).attr('fill',getHexadecimalColor(forme.xfillProps.xcolor)) ;
    }*/
