...
exports.DesktopNumeric = helpers.defineClass(DesktopNumeric, NumericField, {
    ...
    render: function(){
        ...
        if (self.$isEditMode) {
            ...
            $(box).append(self.$$input).append(self.btnUp).append(self.btnDown).appendTo(self.$$dataValue);
            
            self.$$dataValue.delegate("a[data-s-picker]", "click", function(){
