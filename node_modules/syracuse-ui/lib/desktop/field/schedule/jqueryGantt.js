...
exports.render = function(){
    var id = this.$$dataValue.attr("id");
    this.$$widgetBox = $('<div style="height: 400px; border: 1px solid #aaa">').attr('id', "gtt_" + id).addClass('gtt-container').appendTo(this.$$dataValue);
};
