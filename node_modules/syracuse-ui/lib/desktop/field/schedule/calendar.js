...
exports.Calendar = helpers.defineClass(Calendar, Field, {
    ...
    //     Field.prototype.initialize && Field.prototype.initialize.call(this);
    // },
    // onWindowResize: function() {
    //     // debugger;
    //     var $$parent = self.$$dataValue.parent(".s-field-core")
    //     debug && console.log("container: css width=" + self.$$dataValue.css("width") + ", width=" + self.$$dataValue.width());
    //     debug && console.log("parent: css width=" + $$parent.css("width") + ", width=" + $$parent.width());
    // },
    ...
    render: function() {
        ...
        self._widget = $('<div />').attr('id', "cal_" + id) //
        .attr('style', 'width: 800px; margin: 0 auto;') //
        ...
        var calendar = self._widget.fullCalendar({
            ...
            events: function(start, end, callback) {
                var events = self._events && self._events.filter(function(event) {
