...
function _makeData(field){
    var self = field;
    var article = field.boxParent.getArticle();
    var data = field.$data;
    ...
    var nodes = (data.$nodes || []).map(function(node){
        ...
        var value = article.parseExpression(proto.$prototype.$.$value, node);
        var title = proto.$title;
        //
        return (self.$categories[proto.$title]) ? {
            value: value,
            title: title,
            $field: proto,
            $item: node
    ...
    // clone links
    field.$links = (data.$links || []).filter(function(link){
...
function _updateGraph(field){
    ...
    newNodes.append("circle").attr("class", "d3-graph-node").attr("r", function(d){
        ...
        document.controller.openPage(field.boxParent.getArticle(), d.$field.$prototype.$links.$default, d.$item);
...
exports.nodeChart = helpers.defineClass(NodeChart, Field, {
    ...
    setDataValue: function(value){
        ...
        var self = this;
        if (value && value.$url) {
            var article = this.boxParent.getArticle();
            article.getPage().fetch({
                $location: {
                    $url: article.parseExpression(value.$url)
                }
    ...
    render: function(){
        ...
        var $$d3 = $("<div/>").addClass("d3-graph-field").appendTo(this.$$value);
