...
exports.ToolBox = helpers.defineClass(ToolBox, Article, {
    ...
    load: function(chart, $boxItem){
        ...
        self.menusFacade.items.$drillUp[0].onMenuClick = function(){
            self.handlers && self.handlers.drillUp && self.handlers.drillUp.call(null, null);
            return false;
        };
        self.menusFacade.items.$drillUp[0].hide(true);
    },
    show: function(opt){
        var self = this;
    ...
    showDrillUp: function(show){
        this.menusFacade.items.$drillUp[0].hide(!show);
    },
});
...
exports.TabularChart = helpers.defineClass(TabularChart, Article, {
    ...
    _getPref: function(){
        ...
        return _merge(Highcharts.getOptions(), {
            chart: {
    ...
    _getMeasureLabel: function(measure, code){
        ...
        switch (item.$type) {
            ...
            case "application/x-choice":
                item.$value.$constraints.$enum.some(function(element, i, array){
