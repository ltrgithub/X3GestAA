...
exports.RadiosFormat = helpers.defineClass(RadiosFormat, null, {
    ...
    setDataValue: function(value){
        ...
        if (this.field.$isEditMode) {
            ...
            if (this._$selectedEnum) {
                this.field.$$inputValue.find("input[value='" + this._$selectedEnum.$index + "']").attr("checked", true);
            }
        }
        else {
            this.field.$$textValue.text(this._$selectedEnum ? this._$selectedEnum.$title : "");
        }
    },
    ...
    render: function(){
        ...
        if (this.field.$isEditMode) {
            ...
            this._$$fieldset = $(div).appendTo(this.field.$$inputValue);
            this.renderLayout();
        }
        else {
            this.field.$$textValue.addClass("s-choice-combo");
        }
    },
