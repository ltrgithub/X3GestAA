    ...
    clickPicker: function($$btn){
        ...
        if (!self.$isDisabled) {
            if (!self.popupPicker) {
                ...
                self.popupPicker = document.site.createPopup({
                    page: self.boxParent.getPage(),
    ...
    render: function(){
        ...
        if (self.$isEditMode) {
            ...
            if (self.$field.$type != "application/x-datetime") {
                ...
                $(box).append(self.$$input).append(self.$$pickerBtn).appendTo(self.$$value);
            }
            // application/x-datetime
                ...
                var box = document.createElement("div");
                box.className = self.$skinInput + "-box";
                $(box).append(self.$$input).appendTo(self.$$value);
            }
        }
        else {
