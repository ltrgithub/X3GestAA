...
var formatApi = require('syracuse-ui/lib/desktop/field/formatApi');
...
exports.DesktopDateTime = helpers.defineClass(DesktopDateTime, Field, {
    ...
    onInputChange: function($$input, event){
        try {
            ...
            if (document.fieldController.validate(self, valFormatted, [])) {
