...
exports.ListAuthoring = helpers.defineClass(ListAuthoring, Article, {
    ...
    toggleQuick: function(show){
        ...
        if (show) {
            ...
            self.loadBox(self.designedField.$item);
            ...
            self.popup = document.site.createPopup({
                page: self.designedField.getPage(),
                // $size: "content",
                //$isResizable: true,
                ...
                position: {
                    my: "left top",
                    at: "left bottom",
                    of: self.designedField.$$designer
                },
                ...
                boundarySelector: "#" + self.designedField.id
            });
        }
        else {
            if (self.popup) {
    ...
    dispose: function(){
        if (this.designedField) {
            delete this.designedField.quickDesigner;
