...
exports.GraphDecorator = helpers.defineClass(GraphDecorator, null, {
    _selectTab: function(){
        ...
        this.list._listSlot.style.display = showGraph ? "none" : "";
        this._graphSlot.style.display = showGraph ? "" : "none";
        this._listTab.className = showGraph ? "s-list-listgraph-tab" : "s-list-listgraph-tab-open";
        this._graphTabs.className = showGraph ? "s-list-listgraph-tab-open" : "s-list-listgraph-tab";
        
    },
    _appendGraphModeTabs: function(){
        var self = this;
        		
        $(self._listTab = document.createElement("a")).text(localize.graphTabDataListlist);
        self._listTab.setAttribute("data-s-tab", "list");
		
        $(self._graphTab = document.createElement("a")).text(localize.graphTabDataGraph);
        self._graphTab.setAttribute("data-s-tab", "graph");
		
		self._graphTabs = document.createElement("nav");
        self._graphTabs.className = "s-list-listgraph-tabs";
    ...
    applyGraphSettings: function(list, metadata){
        ...
        if (list.$item.$graphMode != "list") {
            if (!this._graphSlot) {
                ...
                var $$listChildren = $(list._listSlot).children();
                list._listSlot = document.createElement("div");
                list._listSlot.className = "s-list-datalist-slot";
                $(this._wrapper.appendChild(list._listSlot)).append($$listChildren);
                ...
                list._coreRight.appendChild(this._wrapper);
                
                list.$item.$graphPosition = list.$item.$graphPosition || "top";
                
                list.chart = document.itemFactory.load($(this._graphSlot), {
            ...
            if (list.$item.$graphMode == "both") {
                ...
                if ($graphPosition == "tab") {
                    ...
                    if ($graphPosition == "left" || $graphPosition == "right") {
                        ...
                        list._listSlot.style.display = "table-cell";
                        ...
                        list._listSlot.style.width = widths[($graphPosition == "left") ? 1 : 0] + "%";
                    }
                    else {
                        this._wrapper.style.display = "";
                        this._wrapper.style.tableLayout = "";
                        this._wrapper.style.width = "";
                        list._listSlot.style.display = "";
                        list._listSlot.style.width = "";
                ...
                list._listSlot.style.display = "none";
                this._graphSlot.style.display = "";
                this._graphSlot.style.width = "";
            }
            ...
            if (this._graphSlot) {
                ...
                this._wrapper.style.display = "";
                this._wrapper.style.width = "";
                this.list._listSlot.style.display = "";
                this.list._listSlot.style.width = "";
