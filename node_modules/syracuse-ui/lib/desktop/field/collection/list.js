...
var GraphAdapter = require("./graphAdapter").GraphAdapter;
...
exports.DesktopList = helpers.defineClass(DesktopList, RawList, {
    ...
    applyDesignMetaData: function(metadata, onAuthoring){
        ...
        if (this.$prototype.$cube) {
            ...
            this.graphAdapter.applyGraphSettings(this, metadata);
        }
        ...
        if (self.$item.$isQuickDesignerEnabled !== false) {
            ...
            self.$$designer = $(dom).bind("click", function(){
                if (!self.quickDesigner) {
                    ...
                    self.quickDesigner.designedField = self;
            ...
            $(dom).append(self.$$designer).prependTo(self.$$topbar);
        }
    },
