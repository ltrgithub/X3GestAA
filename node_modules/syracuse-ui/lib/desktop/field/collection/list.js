...
exports.DesktopList = helpers.defineClass(DesktopList, RawList, {
    ...
    _appendCapabilities: function(record, $$container){
        if (record.capabilities) {
    ...
    _appendCapability: function(record, $capability){
        if (!record.capabilities) {
            ...
            this.builder.appendCapabilitiesSlot();
            record.appendCapabilitiesSlot();
        }
        ...
        /* document.itemFactory.load($(record.capabilities.slot), {
         $bind: "$" + $capability,
         $category: "link",
