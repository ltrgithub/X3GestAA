...
exports.GridCardViewDecorator = helpers.defineClass(GridCardViewDecorator, null, {
    ...
    _bindOpener: function(){
        var self = this;
        self.list.$$item.delegate("a." + self.list.$skin + "-cardview-opener", "click.gridcardviewdecorator", function(){
            var $$opener = $(this);
            ...
            $uuidList.forEach(function($uuid){
                self._toggleRecordCardview(self.list.dataset[$uuid], show);
            });
    ...
    dispose: function(){
        if (this.list && this.list.$$item) {
            this.list.$$item.undelegate(".gridcardviewdecorator");
        }
        delete this.list;
        delete this.cardview;
        delete this.builder;
