...
exports.QuickFilterCell = helpers.defineClass(QuickFilterCell, null, {
    render: function(record, $$container, $field, $bind){
        ...
        self.$$list = $("<div class='s-list-filter-list'/>").appendTo(self.$$container).hide();
        self.hookListClick();
        var link = document.createElement("a");
        link.className = "s-list-filter";
        link.style.backgroundImage = "url('" + document.site.$item.$iconPath + "filter/s-filter-none.png')";
        self.$$operator = $(link).appendTo(self.$$container).bind("click", function(){
            if (!self.listPopup) {
                self.$$list.empty();
                var operators;
                ...
                operators.forEach(function(op){
                    ...
                    $(link).appendTo(self.$$list).text(_localizeOperators[op]);
                });
    ...
    setOperator: function(operator){
        this.$$operator[0].style.backgroundImage = "url('" + document.site.$item.$iconPath + "filter/s-filter-" + (this.operator = operator) + ".png')";
    },
    hookListClick: function(){
        var self = this;
        self.$$list.delegate("a.s-list-filter-item", "click", function(){
