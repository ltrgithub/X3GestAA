...
exports.QuickFilterRecord = helpers.defineClass(QuickFilterRecord, Article, {
    ...
    appendFlagCell: function(){
        var div = document.createElement("div");
        this.appendEmptyCell().appendChild(div).className = this.boxParent.$skin + "-quick-flag";
    },
    ...
    drawBox: function(){
        ...
        if (self.boxParent.$item.$format == "vgrid") {
            /* if (list.recordSelector.appendToRecord) {
             ...
             self._appendCell(list.builder.table.cols.$recordSelector.slot).appendChild(div);
             }*/
