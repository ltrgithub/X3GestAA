...
var ContextMenu = require('syracuse-ui/lib/common/field/menusController').ContextMenu;
...
exports.ListContextMenu = helpers.defineClass(ListContextMenu, ContextMenu, {
    appendQuickActions: function($menuItem){
        ...
        if (!self._quickActions) {
            ...
            self.$quickActions.array.forEach(function($bind){
                ...
                slot.className = "s-list-quick-actions-slot";
        ...
        var menuItem = document.itemFactory.create({
            ...
            $skin: "s-list-quick-actions-link",
            $icon: {
                $mode: "icon",
                $path: "list/s-actions-",
                $width: "20px",
    ...
    clearMenuItems: function(){
        ...
        if (self.hasColumns) {
            self.field.builder.table.setContextMenusCol(null, true);
        }
    },
        ...
        ContextMenu.prototype.create.call(this, field, {
            onBeforeAddMenuItem: function($menuItem){
                if (self.$quickActions[$menuItem.$bind]) {
                    if (self.hasColumns) {
                        self.field.builder.table.setContextMenusCol($menuItem.$bind);
                    }
    ...
    appendOpener: function(){
        ...
        this._menusBtn.className = "s-field-menus-btn s-close";
