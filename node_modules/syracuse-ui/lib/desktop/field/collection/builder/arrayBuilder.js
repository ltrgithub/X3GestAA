...
exports.Builder = helpers.defineClass(ArrayBuilder, RawListBuilder, {
    ...
    _notifyReorder: function(sourceRecord, targetRecord, $insert){
        sourceRecord.$$item[$insert](targetRecord.$$item);
        var $resources = this.list._records.map(function(record){
        ...
        if (!record.$isDeleted) {
            ...
            switch ($capability) {
                 ...
                 */
                    ...
                    self.list._records.splice(record.$recordIndex, 1);
