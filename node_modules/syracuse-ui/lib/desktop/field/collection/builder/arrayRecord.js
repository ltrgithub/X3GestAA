...
exports.ArrayRecord = helpers.defineClass(ArrayRecord, Article, {
    onInputFocusin: function(){
        this.list.setCapabilitiesVisible(this, true);
    },
    onInputFocusout: function(){
        this.list.setCapabilitiesVisible(this, false);
    },
    ...
    appendCapabilitiesSlot: function(){
        $(this.capabilities.slot).prependTo(this.$$value);
    },
    drawBox: function(){
        ...
        if (this.$isEditMode) {
            ...
            this.list._appendCapabilities(this);
        }
