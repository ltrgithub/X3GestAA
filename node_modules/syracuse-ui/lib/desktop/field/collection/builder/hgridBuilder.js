...
exports.Builder = helpers.defineClass(HGridBuilder, RawListBuilder, {
    ...
    applyDesignMetaData: function(metadata, onAuthoring){
        if (onAuthoring) {
            ...
            if (metadata.$cardviewWidth !== undefined) {
                if (this.cardview) {
                    this.cardview.$$cardSlot[0].style.width = this.list.$item.$cardviewWidth + "%";
                }
            }
        }
    },
    ...
    makeColGroup: function(){
        ...
        var cols = "";
        if (self.cardview) {
            cols = self.cardview.onMakeColGroup(cols);
        }
    ...
    _drawDataList: function(){
        ...
        self.$$table.append(list._$$header).append(list._$$body).appendTo(list.$$tableSlot || list.$$listSlot);
