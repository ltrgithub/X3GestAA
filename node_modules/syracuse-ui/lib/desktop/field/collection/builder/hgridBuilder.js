...
exports.Builder = helpers.defineClass(HGridBuilder, RawListBuilder, {
    ...
    drawOrientation: function(){
        ...
        this.$columnsCount = $item.$items.length;
        if ($item.$preView) {
            this.$columnsCount++;
        }
    ...
    drawBuilder: function(){
        var self = this;
        var list = self.list;
        var $skin = list.$skin = list.$item.$skin || self.$defaultSkin;
        self.gridCss = {
        ...
        list.$$list = $(div).appendTo(list.$$value);
        ...
        table.className = $skin;
        table.setAttribute("cellspacing", "0");
        table.setAttribute("cellpadding", "0");
        self.$$table = $(table);
        list._$$header = $(document.createElement("thead"));
        list._$$body = $(document.createElement("tbody"));
        self.$$table.append(list._$$header).append(list._$$body).appendTo(list.$$coreRight);
    ...
    dispose: function(){
        ...
        if (this.quickFilterBox) {
            this.list.removeItem(this.quickFilterBox);
        }
