...
exports.Builder = helpers.defineClass(HGridBuilder, RawListBuilder, {
    ...
    makeColGroup: function(){
        ...
        var cols = "";
        if (self.cardview) {
            self.cardview.makeColGroup(cols);
        }
    ...
    drawBuilder: function(){
        ...
        if (list.$item.$cardview) {
            this.cardview = new GridCardViewDecorator();
            this.cardview.initialize(this);
        }
