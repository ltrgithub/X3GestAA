...
exports.Builder = helpers.defineClass(HGridBuilder, RawListBuilder, {
    ...
    makeColGroup: function(){
        var cols = "<col/>"; //default  for capabilities
        if (this.cardview) {
            cols = this.cardview.onMakeColGroup(cols);
        }
        ...
        this.list.parseItems(function($item, $field){
            var col = "<col";
    ...
    makeTitleRow: function(){
        ...
        self.thCapabilities.style.display = "none";
    ...
    appendCapabilitiesSlot: function(){
        if (this.thCapabilities) {
            this.thCapabilities.style.display = "";
        }
        if (this.tdQuickFilterCapabilities) {
            this.tdQuickFilterCapabilities.style.display = "";
        }
    },
