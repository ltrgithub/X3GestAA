...
exports.GraphAdapter = helpers.defineClass(GraphAdapter, null, {
    _selectTab: function(){
    ...
    applyGraphSettings: function(list, metadata){
        ...
        if (metadata.$columnWidth !== undefined) {
            list.$item.$columnWidth = metadata.$columnWidth;
        }
            ...
            if (list.$item.$graphMode == "both") {
                ...
                if ($graphPosition == "tab") {
                    ...
                    if ($graphPosition == "left" || $graphPosition == "right") {
                        ...
                        var widths = (list.$item.$columnWidth || "50,50").split(",");
