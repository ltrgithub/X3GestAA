...
var _formatBuilder = {
    ...
    "$page": {
        ...
        getAuthoringSettings: function(field){
            return null;
        },
        dispose: function(){
        }
...
function PortletField(){
}

exports.PortletField = helpers.defineClass(PortletField, Box, {
    refresh: function(){
    ...
    getAuthoringSettings: function(){
        return this.formatBuilder.getAuthoringSettings(this);
    },
    maximize: function(){
    ...
    drawBox: function(){
        ...
        this.$skin = this.$item.$skin || "s-portlet-field";
    ...
    _renderLayoutContent: function(){
        if (this.portlet) {
            this.$$body.empty();
            document.controller.disposeObject(this.portlet);
        }
