"use strict";
var HtmlPortletAuthoring = require("./htmlPortletAuthoring").HtmlPortletAuthoring;
...
exports.maximize = function(field){
    ...
    document.site.addEventListener("resize", field);
};
exports.minimize = function(field){
    field.$$iframe[0].style.height = field.$item.$height || "100%";
    document.site.removeEventListener("resize", field);
};
...
exports.getAuthoringWidget = function(){
    return new HtmlPortletAuthoring();
};
