"use strict";
var helpers = require('syracuse-core/lib/helpers'), Field = require('syracuse-ui/lib/common/field/field').Field, rtf = require("syracuse-rtf/lib/rtf");
...
exports.HtmlEditor = helpers.defineClass(HtmlEditor, Field, {
    ...
    render: function(){
        ...
        if (this.$isEditMode) {
            ...
            // this.$$input = $('<textarea>').attr('id', "i" + id).attr('name', "i" + id).addClass(css).appendTo(self.$$dataValue);
            var area = $('<textarea>').attr('id', "i" + id).attr('name', "i" + id).appendTo(self.$$dataValue);
                ...
                if (!self.standalone && self.currentHtml !== newHtml) {
                    setTimeout(function(){
                        ...
                        if (popup.length === 0) {
                            ...
                            self.notifyChange(newValue, true);
                        }
                    }, 100);
                }
            });
    ...
    _setContents: function(contents, saveStyles){
        ...
        if (this.$isEditMode) {
            ...
            this.$$dataValue.empty().append(contents);
        }
