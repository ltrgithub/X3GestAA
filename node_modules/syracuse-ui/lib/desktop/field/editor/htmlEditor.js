...
var helpers = require('syracuse-core/lib/helpers'),
    ...
    rtf = require("syracuse-rtf/lib/rtf");
...
exports.HtmlEditor = helpers.defineClass(HtmlEditor, Field, {
    ...
    render: function() {
        ...
        if (this.$isEditMode) {
            ...
            // this.$$input = $('<textarea>').attr('id', "i" + id).attr('name', "i" + id).addClass(css).appendTo(self.$$value);
            var area = $('<textarea>').attr('id', "i" + id).attr('name', "i" + id).appendTo(self.$$value);
