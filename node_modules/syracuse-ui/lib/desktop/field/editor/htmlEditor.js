...
exports.HtmlEditor = helpers.defineClass(HtmlEditor, Field, {
    setDataValue: function(value){
        ...
        /*this._editor._isRich=value.length==0 || (value && value.indexOf('{')==0 );
    ...
    render: function(){
        ...
        if (this.$isEditMode) {
            ...
            self._editor = area.cleditor({
                ...
                " undo redo | rule image link unlink | cut copy paste pastetext | print source hello ",
