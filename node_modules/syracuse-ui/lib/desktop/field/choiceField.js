...
function _getAuthoringSettings(field){
    return {
        $prototype: {
            "$": {
                $format: {
    ...
    $combo: {
        ...
        render: function(field){
            ...
            if (field.$isEditMode) {
                ...
                field.$$value.append($$box).append(field.$$list);
    ...
    $radios: {
        setDataValue: function(field, value){
            ...
            if (field.$isEditMode) {
                ...
                if (field.$selectedEnum) {
                    field.$$value.find("input[value='" + field.$selectedEnum.$index + "']").attr("checked", true);
                }
            }
            else {
                field.$$value.text(field.$selectedEnum ? field.$selectedEnum.$title : "");
            }
        },
        getInputValue: function(field){
        ...
        render: function(field){
            ...
            if (field.$isEditMode) {
                ...
                field.$$fieldset = $("<fieldset/>").addClass($skin).appendTo(field.$$value);
                field._$$choices = [];
                ...
                field.$$value.addClass("s-choice-combo");
            }
        },
...
exports.DesktopChoiceField = helpers.defineClass(DesktopChoiceField, ChoiceField, {
    ...
    getAuthoringSettings: function(){
        return _getAuthoringSettings(this);
    },
    ...
    applyDisableState: function(state){
        if (state.$isDisabled !== undefined) {
            ...
            this.$$value.toggleClass("s-disabled", state.$isDisabled).find("input").attr("disabled", state.$isDisabled);
        }
    },
    dispose: function(){
