...
exports.AuthoringView = helpers.defineClass(AuthoringView, Article, {
    drawBox: function(){
        ...
        $("<div id='s-author-header-title'/>").text(_localize.title).appendTo($$header);
        ...
        self.tree.loadArticle(document.authoringSite.updatedPage);
    },
    onNotifyRecordChange: function(value, binding){
        var data = {};
        /*if (!this.dataset.application) {
         var httpQuery = document.controller.parseUrl(document.authoringSite.updatedPage.$prototype.$representationUrl);
        ...
        data.content = {
            $article: document.authoringSite.updatedPage.$item
        };
        data[binding] = value;
        return data;
    },
