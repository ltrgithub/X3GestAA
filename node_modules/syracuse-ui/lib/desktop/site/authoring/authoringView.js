...
exports.AuthoringView = helpers.defineClass(AuthoringView, Article, {
    ...
    drawBox: function(){
		...
		var $$tools = $("<div id='s-author-header-tools'/>").appendTo($$header);
        self.$$layoutSlot = $("<div id='s-author-header-layouts'/>").appendTo($$tools);
        self.$$panelActions = $("<div id='s-author-header-panel-actions'/>").appendTo($$tools);
