...
exports.TreeNode = helpers.defineClass(TreeNode, null, {
    ...
    setDesignableItem: function(item){
        ...
        (this.$$dataSlot || item.$$item)[0].style.border = "2px dashed transparent";
    },
                    ...
                    if (node.$authoringLevel == "field") {
                        if (self.$isLightMode) {
                            child.authoringLight = {
                                $$bag: $(document.createElement("div")).append(child.$$item.children()),
                            ...
                            $$value.append($(div).text(child.getTitle()));
                            $$value.appendTo(child.$$item);
                        }
                        else {
