...
var _localize = {
    ...
    widthContent: "fit to content",
    widthLargest: "filt to largest content",
    widthSmall: "small",
    widthMedium: "medium",
    widthLarge: "large",
            ...
            Object.keys($properties).forEach(function($name){
                if (excludeBinds.indexOf($name) < 0) {
                    ...
                    if ($field.$type) {
                        ...
                        $(domValue.appendChild(div)).text($field.$title ? article.getLocalizeText($field.$title) : _localize.defaultFieldTitle);
