...
exports.ItemPalette = helpers.defineClass(ItemPalette, Article, {
    ...
    _setSwitchMode: function(){
        var isLightMode = this.getNode().$isLightMode;
        this.menuItems.$switchMode.forEach(function(menu){
            menu.setTitle(isLightMode ? _localize.fullMode : _localize.lightMode);
            menu.setValue(isLightMode ? "switch-full" : "switch-light");
        });
    },
    ...
    _formatChildLayout: function(isProto, $category){
        if (isProto) {
            var $enum = [{
                $value: "stack",
