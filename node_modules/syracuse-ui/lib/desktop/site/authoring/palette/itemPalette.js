...
var layoutSettings = require('syracuse-ui/lib/desktop/article/layouts/authoring/layoutSettings');
...
exports.ItemPalette = helpers.defineClass(ItemPalette, Article, {
    ...
    onNotifyRecordChange: function(value, binding){
        ...
        self.authoringView.notifyUpdate();
            ...
            Object.keys(newData).forEach(function($prop){
                ...
                switch ($prop) {
                    ...
                    case "$isHidden":
                        ...
                        Object.keys(self.get$Properties()).forEach(function($key){
    ...
    _setSwitchMode: function(){
        ...
        this.menuItems.$switchMode.forEach(function(menu){
            menu.setTitle(self.authoringView.$isLightMode ? self.authoringView.localize.aw_fullMode : self.authoringView.localize.aw_lightMode);
                ...
                if (excludeBinds.indexOf($name) < 0) {
                    ...
                    if ($field.$type) {
                        if (!domCol) {
                            ...
                            domCol.className = "s-author-fields-col";
                            domTable.appendChild(domCol);
                        }
                        var domValue = document.createElement("a");
                        domValue.className = "s-author-fields-field-value";
                        ...
                        $(domValue.appendChild(div)).text($field.$title ? article.getLocalizeText($field.$title) : self.authoringView.localize.aw_defaultFieldTitle);
    ...
    loadBox: function(){
        ...
        self.$prototype.$links = {
            $switchMode: {
                $title: self.authoringView.localize.aw_lightMode
            },
            $addSection: {
                $title: self.authoringView.localize.aw_addSection
            },
            $addBlock: {
                $title: self.authoringView.localize.aw_addBlock
            },
            $addField: {
                $title: self.authoringView.localize.aw_addField
            }
        };
    ...
    _formatFieldTextLabelAlign: function(isProto){
        ...
        if (isProto) {
            this.get$Properties()[$bind] = {
                $type: "application/x-choice",
                $title: this.authoringView.localize.aw_textLabelAlignment,
                $value: {
                    $type: "application/x-string",
                    
                        $enum: [{
                            $value: false,
                            $title: this.authoringView.localize.aw_textLabelLeftAligned
                        }, {
                            $value: true,
                            $title: this.authoringView.localize.aw_textLabelRightAligned
                        }]
                    }
            };
            ...
            this.get$Properties()[$bind] = {
                ...
                $value: {
                    $type: "application/x-string",
                        ...
                        $enum: [{
                            $value: false,
                            $title: this.authoringView.localize.aw_labelLeftAlignment
                        }, {
                            $value: true,
                            $title: this.authoringView.localize.aw_labelTopAlignment
                        }]
                    }
            };
            this.$prototype[$bind] = false;
    ...
    _formatFieldWidth: function(isProto){
        ...
        if (isProto) {
            this.get$Properties()[$bind] = {
                ...
                $value: {
                    $type: "application/x-string",
                        ...
                        $enum: [{
                            $value: "largest",
                            $title: this.authoringView.localize.aw_widthLargest
                        }, {
                            $value: "content",
                            $title: this.authoringView.localize.aw_widthContent
                        }, {
                            $value: "fit",
                            $title: this.authoringView.localize.aw_widthMaximum
                        }, {
                            $value: "large",
                            $title: this.authoringView.localize.aw_widthLarge
                        }, {
                            $value: "medium",
                            $title: this.authoringView.localize.aw_widthMedium
                        }, {
                            $value: "small",
                            $title: this.authoringView.localize.aw_widthSmall
                        }]
                    }
            };
            ...
            return {
                ...
                $skin: "s-author-field",
                $isEditMode: true,
                $title: this.authoringView.localize.aw_fieldSize,
                $labelWidth: "auto",
                $format: "$combo"
            };
        }
    ...
    _formatAllFieldsSection: function(){
        return {
            $category: "section",
            $bind: "$field",
            $title: this.authoringView.localize.aw_allFields,
            $layout: {
                $layoutType: "side",
                $items: [{
                    $layoutType: "stack",
                    ...
                    $items: [{
                        ...
                        $category: "block",
                        $title: this.authoringView.localize.aw_fieldLabelsPosition,
                        $layout: {
    ...
    _formatSectionBlock: function(){
        var items = [{
            $category: "section",
            $title: this.authoringView.localize.aw_appearance,
            $layout: {
            ...
            $category: "section",
            $title: this.authoringView.localize.aw_structure,
            $layout: {
    ...
    _formatChildLayout: function($category){
        var $enum = [{
            $value: "stack",
            $title: this.authoringView.localize.aw_layoutStacked
        }];
        if (this.$childCategory != "field") {
            $enum.push({
                $value: "tabs",
                $title: this.authoringView.localize.aw_layoutInTab
            });
        }
        $enum.push({
            $value: "side",
            $title: this.authoringView.localize.aw_layoutSide
        });
        $enum.push({
            $value: "row",
            $title: this.authoringView.localize.aw_layoutRow
        });
        this.get$Properties().$allChildLayout = {
            $type: "application/x-choice",
            $value: {
                $type: "application/x-string",
    ...
    _addLayoutsHeader: function(){
		var localize = this.authoringView.localize;
        this.authoringView.$$layoutSlot.empty();
        if (this.get$Properties().$boxLayoutType) {
            var div = document.createElement("div");
            ...
            Object.keys(layoutSettings.$composite).forEach(function($key){
                ...
                $links[$key] = {
                    $title: layoutSettings.$composite[$key].$title || localize.aw_layoutComposite
                };
            });
    ...
    _formatLayout: function(isProto){
        ...
        this.get$Properties().$boxLayoutType = {
            $type: "application/x-choice",
            $value: {
                $type: "application/x-string",
