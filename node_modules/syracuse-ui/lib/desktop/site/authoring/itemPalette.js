    ...
    return $protoAddItem ? {
        ...
        $items: [{
            ...
            $items: [{
                ...
                $css: "s-author-designer-link-switch-full",
                $category: "link"
            }]
        }, {
            $layoutType: "stack",
...
helpers.defineClass(ItemPalette, Article, {
    ...
    setSwitchMode: function(switchMenu){
        ...
        switchMenu.$$item[0].className = "s-author-designer-link s-author-designer-link-switch-" + (this.designedNode.$isLightMode ? "full" : "light");
    },
    loadBox: function(){
        var self = this;
