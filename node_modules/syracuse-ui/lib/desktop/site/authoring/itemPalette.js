...
helpers.defineClass(ItemPalette, Article, {
    ...
    setSwitchMode: function(switchMenu){
        ...
        switchMenu.$$item[0].className = "s-author-designer-switch-" + (this.getNode().$isLightMode ? "full" : "light");
    },
    loadBox: function(){
        var self = this;
        ...
        if (self.menuItems.$switchMode) {
            ...
            self.menuItems.$switchMode[0].onMenuClick = function(){
                self.getNode().toggleLightMode();
                self.setSwitchMode(self.menuItems.$switchMode[0]);
                return false;
            };
            self.menuItems.$addItem[0].onMenuClick = function(){
                self._addNewBox(self.getNode().item, self.$childCategory);
                return false;
            };
        }
    },
    ...
    _addNewBox: function(parentBox, $category){
