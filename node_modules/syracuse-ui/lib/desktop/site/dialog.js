...
exports.Dialog = helpers.defineClass(Dialog, null, {
    ...
    _wrapPopup: function(){
        ...
        document.site.setZIndex(self.$$dialog);
        self._namespace = self.$$dialog.attr("id") || document.controller.generateUUID();
        self.$$dialog[0].style.position = "absolute";
        self.$$dialog.attr("id", self._namespace);
        ...
        self.$$dialog[0].style.display = '';
        if (self.options.position) {
            document.site.$$popupContainer.append(self.$$dialog);
            self._reposition();
    ...
    _wrapDialogContent: function(){
        this.$$dialog = (this._content = this.options.content).$$item;
        this._ensureMode();
        this.$$dialog.appendTo(document.site.$$container);
        this.appendOverlay();
        document.site.setZIndex(this.$$dialog);
        this.onWindowResize();
    ...
    _openDialogPage: function(){
        ...
        document.controller.loadRepresentation(self.options.article, self.options.$url, function($itemPage){
            ...
            self._content.onAfterApplyChange = function(){
                self._reposition();
            };
            self._ensureMode();
    ...
    appendOverlay: function(){
        if (this._content.$dialogMode == "modal") {
            ...
            document.site.setZIndex(this.$$overlay = $(overlay));
