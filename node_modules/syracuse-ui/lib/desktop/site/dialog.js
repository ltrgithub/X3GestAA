...
exports.Dialog = helpers.defineClass(Dialog, null, {
    ...
    _openDialogPage: function($itemPage){
        ...
        if ($itemPage) {
            ...
            $itemPage.$isLocalControl = self.options.$isLocalControl;
    ...
    close: function(validated){
        if (this.options && this.options.onClose ? (this.options.onClose(validated !== true) !== false) : true) {
