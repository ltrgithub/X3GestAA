...
exports.MessageBox = helpers.defineClass(MessageBox, null, {
    open: function(options){
        ...
        $(div).appendTo($$header).text(options.$title)
        ...
        self.$$footer = $(div).appendTo(self.$$item);
        ...
        if (options.$$container) {
            ...
            document.site.applyDialogDecorator({
        ...
        self.$$footer.delegate("a.s-msgbox-button", "click", function(){
            var response = {
                $$button: $(this),
        ...
        if (options.$autoClose) {
            ...
            var $$timer = $(div).prependTo($$header).text("( " + count + " )")
