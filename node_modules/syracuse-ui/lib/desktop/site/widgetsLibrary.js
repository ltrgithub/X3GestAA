...
var DesktopMenus = require('syracuse-ui/lib/desktop/article/box').DesktopMenus;
...
exports.fieldTypes = {
    "application/x-choice": choiceField.DesktopChoiceField,
    ...
    "application/x-integer": alphaNumField.DesktopNumeric,
    "application/x-decimal": alphaNumField.DesktopNumeric,
    "application/x-real": alphaNumField.DesktopNumeric,
    "application/x-password": alphaNumField.DesktopPassword,
    "application/x-string$text": alphaNumField.DesktopText,
    "application/x-string$phone": alphaNumField.DesktopPhone,
    "application/x-string$email": alphaNumField.DesktopEmail,
