"use strict";
var MenuItem = require('syracuse-ui/lib/desktop/article/menuItem').MenuItem;
var DesktopMenus = require('syracuse-ui/lib/desktop/article/desktopMenus').DesktopMenus;
var DesktopSectionBlock = require('syracuse-ui/lib/desktop/article/desktopSectionBlock').DesktopSectionBlock;
...
var testFactory = require('syracuse-ui/lib/desktop/tests/testFactory');
var alphaNumField = require('../field/alphaNumField');
var Field = require('../field/field').Field;
var Slot = require('syracuse-ui/lib/desktop/article/slot').Slot;
...
var _layout = require("syracuse-ui/lib/desktop/article/layouts/layout").Layout;
exports.layouts = {
    columns: require("syracuse-ui/lib/desktop/article/layouts/columnsLayout").ColumnsLayout,
    side: _layout,
    row: _layout,
    stack: _layout,
    tabs: require("syracuse-ui/lib/desktop/article/layouts/tabsLayout").TabsLayout,
    composite: _layout
};
...
exports.categories = {
    ...
    section: {
        create: function($item){
            var item = new DesktopSectionBlock();
