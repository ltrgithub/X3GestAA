...
exports.fieldTypes = {
    "application/x-icon": require('syracuse-ui/lib/common/field/iconField').IconField,
    ...
    "application/x-binary": require('syracuse-ui/lib/common/field/binary/fileField').FileField,
    "image": require('syracuse-ui/lib/common/field/binary/imageField').ImageField,
