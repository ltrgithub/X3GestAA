"use strict";
var MenuItem = require('syracuse-ui/lib/article/menuItem').MenuItem;
var DesktopMenus = require('syracuse-ui/lib/article/desktopMenus').DesktopMenus;
...
var VignetteField = require('../field/vignette/vignetteField').VignetteField;
...
exports.fieldTypes = {
    "application/x-icon": require('../field/iconField').IconField,
    ...
    "application/x-binary": require('../field/binary/fileField').FileField,
    "image": require('../field/binary/imageField').ImageField,
    ...
    "application/x-array": require("../field/collection/list").DesktopList,
    "application/x-reference": require('../field/referenceField').ReferenceField,
