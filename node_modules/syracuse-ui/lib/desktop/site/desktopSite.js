...
var Controller = require('syracuse-ui/lib/desktop/controller/controller').Controller;
var FieldController = require('syracuse-ui/lib/desktop/controller/fieldController').FieldController;
...
exports.load = function($item, $prototype){
    return (new DesktopSite()).loadSite({
