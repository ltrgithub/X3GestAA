...
exports.DesktopSite = helpers.defineClass(DesktopSite, Article, {
    ...
    _renderHeader: function(){
        ...
        self.$$topPanelOpener = $("<a id='s-site-top-pn-opener-link'/>").appendTo($$top).bind("click", function(event){
            if (!self.topPanel) {
                self.topPanel = new DesktopTopPanel();
                ...
                self.topPanel.$$container.hide().empty();
                document.controller.disposeObject(self.topPanel);
