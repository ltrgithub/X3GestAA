...
exports.applyEscape = function(item, shortcuts, event) {
	...
	if (!isApplyed) {
		...
		if (item.articleParent && item.articleParent.popupCard && item.articleParent.list && item.articleParent.list.builder && item.articleParent.list.builder.applyEscape) {
