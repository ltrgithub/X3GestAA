...
exports.load = function() {
	...
	window.syra_onbeforeunload = function(event) {
		if (!syra_site.hasDoneLogOut && !syra_site.hasLogonFailed && !syra_site.$officeSite) {
	...
	window.syra_onerror = function(errorMsg, url, lineNumber, error) {
