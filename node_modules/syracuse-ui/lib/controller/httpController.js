...
helpers.defineClass(HttpQuery, null, {
    ...
    _prepareRequest: function(options){
        ...
        // content type
        self.headers["content-type"] = self.headers["content-type"] || (self.dataType === "json" ? "application/json" : null);
                    ...
                    case 404:
                        ...
                        if (document.site && document.site.mainPage && document.site.mainPage.openerHttpQuery) {
                            ...
                            if (document.site.mainPage.openerHttpQuery.workingCopyPreloadUrl) {
                                options.$location.$url = document.site.mainPage.openerHttpQuery.workingCopyPreloadUrl;
                                options.data = document.site.mainPage.dataset;
                                options.$etag = document.site.mainPage.dataset.$etag;
                            }
                            else {
                                if (sessionStorage) {
                                    ...
                                    if (sessionStorage && sessionStorage.getItem(key)) {
                                        ...
                                        options.$location.$url = data.wcpreloadUrl;
                                        options.data = data.dataset;
                                        options.$etag = options.data ? options.data.$etag : options.$etag;
                                    }
                                    else {
                                        return _onResponseError(self, error, options, onError);
                                    }
                                }
                                else {
                                    return _onResponseError(self, error, options, onError);
                            ...
                            document.controller.sendRequest(document.site.mainPage, options);
                        }
                        else {
