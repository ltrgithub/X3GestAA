...
exports.onBeforeUnloadPage = function(options) {
	var wcPage = syra_site.activeWorkingCopy;
	if (wcPage && _storage.hasData(wcPage)) {
		if (!options.page || (!options.page.isPageDesigner && !options.page.isMessageBox && wcPage != options.page)) {
