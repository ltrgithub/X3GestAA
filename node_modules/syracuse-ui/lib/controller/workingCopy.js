...
exports.validateInput = function(field, newValue, errors) {
	...
	field.validateInput && field.validateInput(errors, value);
			...
			if (field.isReferenceField) {
				...
				if (value == "") {
					...
					if ((field.currentValue && field.currentValue.$value != value) || !field.currentValue) {
						...
						syra_workingCopy.notifyFieldChange(field, postValue);
					}
				}
			} else {
				switch (field.$field.$type) {
					...
					case "application/x-quantity":
						...
						if (exports.validateInput(field, valFormatted, [])) {
							doValidate = true;
						}
						break;
					case "application/x-choice":
						if (field.isRadioChoiceField) {
							...
							field.fillSelectedEnum(field.findEnum(field.getDataValue()));
						}
						break;
					case "application/x-password":
						if (field.confirmInput) {
							...
							if (event.target == field.confirmInput) {
								if (exports.validateInput(field, field.confirmInput.value || "")) {
									field.currentValue = "";
									doValidate = true;
								}
							}
