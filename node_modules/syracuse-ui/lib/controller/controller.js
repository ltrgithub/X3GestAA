...
exports.Controller = helpers.defineClass(Controller, null, {
	...
	loadRepresentation: function(article, segments, success, onError, onBeforeOpen, sendRqtOpts) {
		...
		if (typeof(segments) == "string") {
			this.loadRepresentation(article, document.site.urlMaker.parse(article ? document.site.expressionMaker.parse(article, segments) : segments), success, onError, onBeforeOpen, sendRqtOpts);
		} else {
			$representationUrl = segments.$url;
			//xhr.withCredentials = true;
			self.parseUrl(document.site.expressionMaker.parse(article || document.site, document.site.getPageTemplateUrl(segments.$url), {
