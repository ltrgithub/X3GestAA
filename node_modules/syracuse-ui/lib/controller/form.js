...
exports.validateField = function(field, newValue, errors) {
				...
				if (!field.$isHidden && field.$isEditMode) {
					...
					if (!field.unknowMode) {
						...
						try {
							...
							if (!exports.validateField(field, newValue)) {
								isValidated = false;
							} else {
			...
			if (field.isReferenceField) {
				...
				switch (field.$field.$type) {
					...
					case "application/x-quantity":
						...
						if (exports.validateField(field, valFormatted, [])) {
							doValidate = true;
						}
						break;
					...
					case "application/x-password":
						if (field.confirmInput) {
							...
							if (event.target == field.confirmInput) {
								if (exports.validateField(field, field.confirmInput.value || "")) {
									field.currentValue = "";
									doValidate = true;
								}
							}
...
function onFieldNotifyChange_Temp_CONVERGENCE(options) {
	var doEvt = false;
...
exports.notifyFieldChange = function(field, newValue, validated) {
	if (!field.unknowMode) {
		...
		field.currentValue = newValue;
		if (validated || exports.validateField(field, newValue)) {
