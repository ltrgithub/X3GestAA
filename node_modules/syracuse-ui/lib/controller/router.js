...
var _officeHelper = require('syracuse-ui/lib/site/tools/officeHelper');
...
exports.executeMenu = function(menu, article, confirmed) {
	if (menu.$isAction || menu.$url || menu.$sourceUrl) {
		...
		if (!confirmed && !_officeHelper.officeAddinInstalled.call(this, this, menu, menuArticle, menuTitle, exports.executeMenu, [menu, article, true])) {
			return;
		}
		if (menu.$isAction) {
