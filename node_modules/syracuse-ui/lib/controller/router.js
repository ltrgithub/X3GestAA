...
exports.changeMainPage = function($url, $itemPage, onHistoryChange) {
	...
	if (!syra_site.isOfficeSite) {
		...
		if (urlSeg.$facet === "$navigation" &&
			(document.location.href.search(/syracuse-main\/html\/main\.html/i) > -1 || document.location.href.search(/syracuse-main\/html\/main-tablet\.html/i) > -1)) {
			/*
