...
function WorkBook() {
	...
	WorkBook.prototype.onFieldEvent = function(options, redirect) {
		...
		if (options && options.event && options.event.type === "focusin" && options.event.relatedTarget && !options.field.context) {
			console.log("focusin context " + options.field.context + " button prev/next");
