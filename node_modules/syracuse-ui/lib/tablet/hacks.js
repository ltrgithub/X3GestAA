...
function BarSplitter() {
	...
	barSplitter.prototype.ensureState = function() {
		...
		if (this.swipeBar) {
			tabletUtil.logOnServer("ensureState->this.swipeBar s-close: " + this.$isCollapsed);
			...
			var pnode = this.page.dataSlot.parentNode;
			if (this.options.resizeDirection && this.options.resizeDirection.left) {

				this.page.dataSlot.parentNode.insertBefore(this.barSlot, this.page.dataSlot);
			} else if (this.options.resizeDirection && this.options.resizeDirection.right) {
				this.page.dataSlot.parentNode.appendChild(this.barSlot);
			}
			/*if (this.options.swipeDirection && this.options.swipeDirection.left) {
				
				this.page.dataSlot.parentNode.insertBefore(this.barSlot, this.page.dataSlot);
			} else if (this.options.swipeDirection && this.options.swipeDirection.left) {
				this.page.dataSlot.parentNode.appendChild(this.barSlot);
			}*/
		}
	};
