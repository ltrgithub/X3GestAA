...
function field() {
	...
	Field.prototype.loadBox = function($$item) {
		...
		if (this._input) {
			// Add escape button at the end of icons list
			if (!this._tabletEscapePicker) {
				this._tabletEscapePicker = document.createElement("div");
				this.fieldValue.appendChild(this._tabletEscapePicker).className = this.$skin + "-escape";
				this._tabletEscapePicker.appendChild(this.createPicker("escape"));
			}
	...
	Field.prototype.onClickPicker = function(btn) {
		var self = this;
		if (self._tabletEscapePicker && self.page && self.page.externalAdapter) {
