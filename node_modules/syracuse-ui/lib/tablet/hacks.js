...
function removeFlash() {
	...
	flashWidget.FlashWidget.prototype.resizeArticle = function() {};
	...
	flashWidget.CubeChart.prototype.resizeArticle = function() {};
...
function BarSplitter() {
	...
	var resizeBar = barSplitter.prototype.resizeBar;
	barSplitter.prototype.resizeBar = function() {
		resizeBar.call(this);
		if (this.swipeBar) {
	...
	barSplitter.prototype.dispose = function() {
		if (this.swipeBar) {
			...
			if (!dd._observers.barSwiper)
				dd._observers.barSwiper = [];
