...
.s-link.s-menu-icon-test2.ui-link {
	color:  #313131;
	font-size: 0.8em;
}
.ui-btn-up-a {
	...
	background-image: -webkit-gradient(linear, left top, left bottom, from( #ff0fNaN), to( #ff0fNaN )); /* Saf4+, Chrome */
	background-image: -webkit-linear-gradient( #ff0fNaN, #ff0fNaN); /* Chrome 10+, Saf5.1+ */
	background-image:    -moz-linear-gradient( #ff0fNaN, #ff0fNaN); /* FF3.6 */
	background-image:     -ms-linear-gradient( #ff0fNaN, #ff0fNaN); /* IE10 */
	background-image:      -o-linear-gradient( #ff0fNaN, #ff0fNaN); /* Opera 11.10+ */
	background-image:         linear-gradient( #ff0fNaN, #ff0fNaN);
}
...
.ui-btn-hover-a {
	...
	color: #666666;
	text-shadow:  0 1px 0 #ffffff;
	background-image: -webkit-gradient(linear, left top, left bottom, from( #f2f2f2), to( #f2f2f2/)); /* Saf4+, Chrome */
	background-image: -webkit-linear-gradient( #f2f2f2, #f2f2f2); /* Chrome 10+, Saf5.1+ */
	background-image:    -moz-linear-gradient( #f2f2f2, #f2f2f2); /* FF3.6 */
	background-image:     -ms-linear-gradient( #f2f2f2, #f2f2f2); /* IE10 */
	background-image:      -o-linear-gradient( #f2f2f2, #f2f2f2); /* Opera 11.10+ */
...
.mobile-box-tab-body.ui-body-d{
	margin: 0 1.2em;
}
.ui-body-d.ui-btn-up-d {
	border: 1px solid transparent;
	background: transparent;
	color: #666666;
	font-family: "Segoe UI", Tahoma, arial, sans-serif;
}
.ui-btn-active.ui-btn-up-d {
	border: 1px solid transparent;
	color:#9CC110;
	text-shadow:  0 1px 0 #ffffff;
	font-family: "Segoe UI", Tahoma, arial, sans-serif;
	background: url("images/site/ui-btn.png") no-repeat scroll center bottom transparent;
...
.ui-btn-active.ui-btn-hover-d, .ui-btn-hover-d {
	border: 1px solid transparent;
	text-shadow: 0 1px 0 #FFFFFF;
	color:#9CC110;
	background: url("images/site/ui-btn.png") no-repeat scroll center bottom #fff;
	font-family: "Segoe UI", Tahoma, arial, sans-serif;
}
...
.ui-page.ui-body-e.ui-overlay-a.ui-dialog.ui-page-active{
	background:black;
}
...
.ui-btn-active.ui-btn-hover-e, .ui-btn-hover-e {
	color: #00a1de;
	text-shadow:  0 1px 3px #00a1de;
}
...
.ui-overlay-shadow.ui-header.ui-bar-e{
...
.ui-overlay-shadow.ui-content.ui-body-e{
	padding:0;
	border-color: #EEEEEE;
...
body {
	font-size:0.9em;
	background:url("images/site/ui-body-d.png") no-repeat scroll right bottom transparent;
...
.ui-focus {
	-moz-box-shadow: 0px 0px 5px #00a1de;
	-webkit-box-shadow: 0px 0px 5px #00a1de;
	box-shadow: 0px 0px 5px #00a1de;
}
...
.ui-content {
	border-width: 0;
	overflow: visible;
	overflow-x: hidden;/*padding: 15px; 0.1em 0.8em 0.2em*/
	}
...
.pop.in {
	...
	z-index: 10;
	background:none repeat scroll 0 0 #55555;
}
.pop.in.reverse {
	z-index: 0;
	-webkit-animation-name: dontmove;
...
.ui-btn-hidden {
	...
	filter: Alpha(Opacity=.0001); /*font-size: 1px;*/
	border: none;
	line-height: 999px;
}
.ui-collapsible {
...
.ui-collapsible-content {
	...
	background-image: none; /* Overrides ui-btn-up-* *//*font-weight: normal;    /* Overrides ui-btn-up-* */
}
...
label.ui-select {
	/*font-size: 16px;
    line-height: 1.4;  font-weight: normal; margin: 0 0 .3em; display: block; */
	/*color: #00A1DE;*/
	color:#9CC110;
	display: block;
	font-weight: normal;
...
label.ui-slider { /*font-size: 16px;*/
	line-height: 1.4;
	font-weight: normal;
	margin: 0 0 .3em;
	display: block;
