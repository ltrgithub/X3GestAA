...
body,div,dl,dt,dd,ul,ol,li,h1,h2,h3,h4,h5,h6,pre,form,fieldset,input,textarea,p,blockquote,th,td { 
	margin:0;
	padding:0;
	font-family: 'FocoRegular',"Segoe UI",Tahoma,arial,sans-serif;
}
html,body {
	margin:0;
	padding:0;
...
p.login{
	display: block;
	padding: 15px 0px;
	border-bottom: 2px dotted #01775E;
}
p.login a,
p.login a.start,
p.login a.start:hover{
...
.cb-slideshow:after { 
	...
	background-image: url(images/login/sage.png), url(images/login/pattern.png); 
