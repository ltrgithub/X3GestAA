	...
	SVGElement.prototype = {
		...
		*/
		...
		_defaultSetter: function(value, key, element) {
			if (key === 'width' && value && parseInt(value) < 0) {} else
				element.setAttribute(key, value);
		}
	};
	...
	var ColumnSeries = extendClass(Series, {
		...
		translate: function() {
			...
			each(series.points, function(point) {
				...
				point.tooltipPos = chart.inverted ? [yAxis.len + yAxis.pos - chart.plotLeft - plotY, series.xAxis.len - barX - barW / 2] : [barX + barW / 2, plotY + yAxis.pos - chart.plotTop];
