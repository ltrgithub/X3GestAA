...
(function() {
    ...
    var loadMe = function() {
            ...
            try {
                ...
                window.Timeline.loadLocalization = function(jsfile) {
                    for (var l = 0; l < supportedLocales.length; l++) {
                        var locale = supportedLocales[l];
                        if (loadLocale[locale]) {
                            includeJavascriptFiles(Timeline.urlPrefix + "scripts/l10n/" + locale + "/", [jsfile]);
                            // includeCssFiles(Timeline.urlPrefix + "styles/l10n/" + locale + "/", [jsfile.replace(/^(.*\.)(js)$/, "$1css")]);
                        }
                    }
                };
                 ...
                 *  Localized resource will be call back using loadLocalization
                 */
                if (bundle) {
    ...
    if (typeof SimileAjax == "undefined") {
        ...
        var url = useLocalResources ? "http://127.0.0.1:9999/ajax/api/simile-ajax-api.js?bundle=false" : "http://static.simile.mit.edu/ajax/api-2.2.0/simile-ajax-api.js";
