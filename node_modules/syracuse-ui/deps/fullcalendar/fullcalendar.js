...
function isSlotSegCollision(seg1, seg2) {
	/*
	 * Sage modification - the minimum event height is tiny, so we earlier set the min-height to 16px in the css.
	 * This collision function was not taking into consideration this minimum height, hence this change.
	 */
	var seg1Height = Math.max(seg1.top - seg1.bottom, 16);
	var seg1Bottom = seg1.top + seg1Height;

	var seg2Height = Math.max(seg2.top - seg2.bottom, 16);
	var seg2Bottom = seg2.top + seg2Height;
	
	return seg1Bottom > seg2.top && seg1.top < seg2Bottom;
}
