...
(function(jQuery){
    ...
    function initOrigin(l){
        if (l.xorigin == 'left') {
            ...
            if (l.xorigin == 'middle' || l.xorigin == 'centre' || l.xorigin == 'center') {
                l.xorigin = 0.5;
            }
            else 
                if (l.xorigin == 'right') {
        ...
        if (l.yorigin == 'top') {
            ...
            if (l.yorigin == 'middle' || l.yorigin == 'centre' || l.yorigin == 'center') {
                l.yorigin = 0.5;
            }
            else 
                if (l.yorigin == 'bottom') {
    ...
    function setupLayerContents(layer, i, viewportOffset){
        ...
        for (var n = 0; n < layer[i].element.children().length; n++) {
            ...
            // Only bother to store child's dimensions if child has an anchor. 
    ...
    jQuery.fn.jparallax = function(options){
        var self = this;
        // Organise settings into objects 
