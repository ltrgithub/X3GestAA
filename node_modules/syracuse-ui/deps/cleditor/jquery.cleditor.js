...
(function($){
 ...
 MSG_CLASS = "cleditorMsg", // message popup div inside body
    // Test for ie
    ie = $.browser.msie, ie6 = /msie\s6/i.test(navigator.userAgent),    // Test for iPhone/iTouch/iPad
    iOS = /iphone|ipad|ipod/i.test(navigator.userAgent),    // Popups are created once as needed and shared by all editor instances
        ...
        if (ie && command.toLowerCase() == "inserthtml") 
            ...
            if (!success) {
                if ("cutcopypaste".indexOf(command) > -1) 
                    ...
                    command +
                    " command. Try using the keyboard shortcut or context menu instead.", button);
                else 
        ...
        $.each(editor.$toolbar.find("." + BUTTON_CLASS), function(idx, elem){
            ...
            if (editor.disabled) 
                ...
                if (button.getEnabled) {
                    ...
                    if (((inSourceMode || iOS) && button.name != "source") ||
