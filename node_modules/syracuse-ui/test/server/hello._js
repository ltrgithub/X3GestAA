...
var phantom = require("syracuse-phantomjs/node_modules/node-phantom-simple");
...
var ep;
var phOptions = {
	phantomPath: require('os').platform() === "darwin" ? path.join(__dirname, "../../../syracuse-phantomjs/node_modules/phantomjs/bin/phantomjs") : path.join(__dirname, "../../../syracuse-phantomjs/node_modules/phantomjs/lib/phantom/phantomjs")
};
...
asyncTest("Load with cookie", 2, function(_) {

	var cookie = adminTestFixtures.getCookie(_, baseUrl);
...
asyncTest("Load applications query page and click on 'New Application' action", 2, function(_) {
	...
	var status = page.open("http://localhost:3004/syracuse-main/html/main.html?url=/sdata/syracuse/collaboration/syracuse/applications?representation=application.$query", _);
