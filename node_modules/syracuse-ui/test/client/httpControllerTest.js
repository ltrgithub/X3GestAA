"use strict";
var syra_controller = require('syracuse-ui/lib/controller/controller');
...
false &&
	test("Parse Url", function() {
		var httpQuery = syra_controller.parseUrl("http://" + host + corsUrl);
		equal(httpQuery._getHost(), host, "Host:port equal");

		httpQuery = syra_controller.parseUrl("http://sosyrgx3app.sagefr.adinternal.com:8124/index.html");
		equal(httpQuery._getHost(), "sosyrgx3app.sagefr.adinternal.com:8124", "host.domain:port equal");

		httpQuery = syra_controller.parseUrl(corsOrg);
...
asyncTest("CORS request with callbacks", function() {
	...
	// var httpQuery = syra_controller.parseUrl(corsOrg),
	var httpQuery = syra_controller.parseUrl("https://github.com/"),
		failed;
...
// 	// test("CORS request", function() {
// 	var httpQuery = syra_controller.parseUrl(corsUrl),
// 		failed;
