...
test("Flash Xml Builder", function() {
	var xb = flashHelpers.xmlBuilder("application/x-agenda", {
		uersLang: "BRI"
	});
	...
	+ '<VisCmp Type="FAG"/><UsedDataSrcPar/><UserLang>BRI</UserLang></Technical><Messages/></X3PORTAL>', //
	"Initial content");
	...
	xml += '<VisCmp Type="FAG"/><UsedDataSrcPar/><UserLang>BRI</UserLang></Technical><Messages/></X3PORTAL>';
