"use strict";
var JSONQuery = require("syracuse-ui/lib/controller/jsonQuery").JSONQuery;
...
function rootClone(obj) {
    if (!obj || obj instanceof Array || ["boolean", "string", "number"].indexOf(typeof obj) >= 0)
    	throw new Error("invalid clone attempt");
    var result = {};
    for (var key in obj) {
...
function touch (resource) {
	...
	if (!resource.$clientOld || !resource.$serverOld) {
        ...
        if (!resource.$clientOld)
        	resource.$clientOld = clone
		if(!resource.$serverOld)
			resource.$serverOld = clone;
	}
    return resource;
}
...
test("query is a path", function() {
	...
	same(values("$.store.bicycle"), {"color":"red","price":19.95}, "path returning an object");
...
test("using range or list of index", function() {
	same(values("$..book[0][-1:]"), [{"category":"fiction","author":"J. R. R. Tolkien","title":"The Lord of the Rings","isbn":"0-395-19395-8","price":22.99}], "range with -1 to get the last item");
	same(values("$..book[0][:2]"), [{"category":"reference","author":"Nigel Rees","title":"Sayings of the Century","price":8.95},{"category":"fiction","author":"Evelyn Waugh","title":"Sword of Honour","price":12.99}], "range without the start index (start is first)");
	same(values("$.store.book[?(@.price<15)][1:3]"), [{"category":"fiction","author":"Evelyn Waugh","title":"Sword of Honour","price":12.99},{"category":"fiction","author":"Herman Melville","title":"Moby Dick","isbn":"0-553-21311-3","price":8.99}], "with a filter (long syntax) and a range");
	same(values("$..book[0][0,1]"), [{"category":"reference","author":"Nigel Rees","title":"Sayings of the Century","price":8.95},{"category":"fiction","author":"Evelyn Waugh","title":"Sword of Honour","price":12.99}], "path with a list of index");
});
...
test("using map expression", function() {
	...
	same(values("$..book[0][={a:author, b:category + ' ' + title}]"), [{ "a": "Nigel Rees", "b": "reference Sayings of the Century" }, { "a": "Evelyn Waugh", "b": "fiction Sword of Honour" }, { "a": "Herman Melville", "b": "fiction Moby Dick" }, { "a": "J. R. R. Tolkien", "b": "fiction The Lord of the Rings" } ], "with a complex map expression returning a new object");
	...
	var res = [{title : "Tom Simon", address : "2 wall street 15015 New York United States"}, {title : "Bob Gartner", address : "10 rue Fructidor 75017 Paris France"}];
	same(address, res);
...
test("using filter expression", function() {
	same(values("$..[?price<10]"), [{"category":"reference","author":"Nigel Rees","title":"Sayings of the Century","price":8.95},{"category":"fiction","author":"Herman Melville","title":"Moby Dick","isbn":"0-553-21311-3","price":8.99}], "with a filter (short syntax)");
	same(values("$.store..[?price<10]"), [{"category":"reference","author":"Nigel Rees","title":"Sayings of the Century","price":8.95},{"category":"fiction","author":"Herman Melville","title":"Moby Dick","isbn":"0-553-21311-3","price":8.99}], "with a filter (short syntax) starting with a path (the path should exclude searched property above the path)");
	same(values("$..book[0][?(@.isbn)]"), [{"category":"fiction","author":"Herman Melville","title":"Moby Dick","isbn":"0-553-21311-3","price":8.99},{"category":"fiction","author":"J. R. R. Tolkien","title":"The Lord of the Rings","isbn":"0-395-19395-8","price":22.99}], "with a filter expression using truthy value");
	same(values("$..book[0][?(@.price<10)]"), [{"category":"reference","author":"Nigel Rees","title":"Sayings of the Century","price":8.95},{"category":"fiction","author":"Herman Melville","title":"Moby Dick","isbn":"0-553-21311-3","price":8.99}], "another with a filter expression");
	same(values("$..book[0][?(@['price']<10)]"), [{"category":"reference","author":"Nigel Rees","title":"Sayings of the Century","price":8.95},{"category":"fiction","author":"Herman Melville","title":"Moby Dick","isbn":"0-553-21311-3","price":8.99}], "another with a filter expression, different syntax");
	same(values("$..book[0]?price=22.99"), [{"category":"fiction","author":"J. R. R. Tolkien","title":"The Lord of the Rings","isbn":"0-395-19395-8","price":22.99}]);
...
test("distinct expression", function() {
	...
	same(values("$..[^?author~'herman melville']"), [{"category":"fiction","author":"Herman Melville","title":"Moby Dick","isbn":"0-553-21311-3","price":8.99}]);
	same(values("$..[^?author='Herman*']"), [{"category":"fiction","author":"Herman Melville","title":"Moby Dick","isbn":"0-553-21311-3","price":8.99}]);
	same(values("$..[^?@['author']='Herman*']"), [{"category":"fiction","author":"Herman Melville","title":"Moby Dick","isbn":"0-553-21311-3","price":8.99}]);
});

test("like expressions", function() {
	same(values("$.store.book?title='*of the*'"), [{"category":"reference","author":"Nigel Rees","title":"Sayings of the Century","price":8.95},{"category":"fiction","author":"J. R. R. Tolkien","title":"The Lord of the Rings","isbn":"0-395-19395-8","price":22.99}], "could use a * character");
...
test("* character", function() {
	same(values("$.store.*"), [[{"category":"reference","author":"Nigel Rees","title":"Sayings of the Century","price":8.95},{"category":"fiction","author":"Evelyn Waugh","title":"Sword of Honour","price":12.99},{"category":"fiction","author":"Herman Melville","title":"Moby Dick","isbn":"0-553-21311-3","price":8.99},{"category":"fiction","author":"J. R. R. Tolkien","title":"The Lord of the Rings","isbn":"0-395-19395-8","price":22.99}],{"color":"red","price":19.95}], "basic *");
