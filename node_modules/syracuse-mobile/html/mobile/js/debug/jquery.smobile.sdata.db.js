...
(function($) {
	...
	//#2769 - Mobile - Refreshing page (F5) causes JS error
	// We force the use of IndexedDB even if browser propose also WEB SQL (we don't check indexedDB && window.openDatabase == null)
	// With chrome indexed DB seems to workk better than Web SQL
	if (indexedDB) {
