...
(function($) {
	...
	_controls.types._table_header = function(html, fields, $prototype, noDetailLink, edit) {
		if (!fields) return;
		html.push('<div class="table" style="overflow: hidden; white-space: nowrap; width: 100%;"> <table data-role="table" data-mode="reflow" class="s-m-table ui-responsive table-stroke"');
		html.push('>');
		html.push('<thead><tr>');
	...
	_controls.ArrayField = {
		...
		onWindowResize: function(controller, $c, c, orientation) {
