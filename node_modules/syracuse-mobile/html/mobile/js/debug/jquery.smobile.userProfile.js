...
(function($) {
	...
	that.userProfile.setLocale = function(locale, cb) {
		...
		queryLocalePreferences(function(localePreferences) {
	...
	function _updateUserProfileWC(userProfile, locale, localePreferences, cb, ecb) {
		var localePreference = _find(localePreferences.$resources, function(l) {
	...
	function queryLocalePreferences(cb, ecb) {
