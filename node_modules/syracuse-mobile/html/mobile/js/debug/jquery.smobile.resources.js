...
(function($) {
	...
	that.buildDate = function() {
		...
		//#BUILDDATE_START
		Date.parseISO8601("2013-10-25T18:17:22.419Z");
		//#BUILDDATE_END
		return cd;
	};
	that.locale = function() {
		...
		//#START
		{
			...
			"ui": {
				...
				"multivalid": "Process selected lines",
				"multidel": "Delete selected lines",
				...
				"rmvdrafts": "Edit or remove yours drafts before install.",
