...
(function($) {
	...
	that.buildDate = function() {
		...
		//#BUILDDATE_START
		Date.parseISO8601("2017-03-30T08:25:25.236Z");
		//#BUILDDATE_END
		return cd;
	};
	that.buildDateString = function() {
		...
		"2017-03-30T08:25:25.236Z";
		//#BUILDDATE_STRING_END
		return cd;
	};

	that.getLabel = function(id) {
		var lbl = that._locale_flat_data[id];
		return lbl == null ? "**" : lbl;
	};
