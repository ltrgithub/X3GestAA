...
(function($) {
	...
	that.buildDate = function() {
		...
		//#BUILDDATE_START
		Date.parseISO8601("2014-02-07T17:13:42.382Z");
		//#BUILDDATE_END
		return cd;
	};
	that.locale = function() {
		...
		//#START
		{
			...
			"ui.edit_item": "Edit",
			"ui.exception_offline": "The site could be temporarily unavailable or too busy",
			"ui.exception_timeout": "Connection timeout",
			"ui.filter": "Filter",
			"ui.filter_field": "Field",
			"ui.filter_op": "Operator",
			"ui.filter_val": "Value",
			"ui.filtersort": "Avanced",
			...
			"ui.no_db_support": "Your browser don't support HTML5 database.",
			"ui.no_db_support_sol": "Use a modern browser",
			...
			"ui.templateDate": "Last modification:",
			"unmodified": "Record unmodified",
			"resetinput": "This record has been reset. Your input has been lost",
			"yes": "Yes",
			"emptydraftkey": "Can't save draft. Key is empty.",
			"saveasdraft": "Your record as been saved as a draft",
