...
(function($) {
	...
	that.buildDate = function() {
		var cd =
			...
			//#BUILDDATE_START
			Date.parseISO8601("2016-09-14T05:57:18.801Z");
		//#BUILDDATE_END
		return cd;
	};
	...
	that.locale = function() {
		...
		that._locale_flat_data =
...

			{
				...
				"ui.delete_all_drafts": "Delete all drafts",
				...
				"ui.no_db_support": "Your browser does not support the HTML5 database. Please upgrade your browser to the most recent version.",
				"ui.no_db_support_sol": "Your browser does not support the HTML5 database. Please upgrade your browser to the most recent version.",
				"ui.no_db_support_priv": "Your browser seems not to support any kind of HTML5 database. This error message also occurs if you use the browser in Private browsing mode which is not supported.",
				...
				"ui.send_all_drafts": "Send all drafts",
				"ui.sending": "Sending ...",
				"ui.server": "Host name",
				...
				"newVersion": "There is an available version '{0}' newer than the one currently in use: '{1}'\n\n Please press OK to upgrade your client.",
				...
				"about.text": "<h3>Sage X3</h3>",
				"about.update": "Product version",
				...
				"license.serial": "Company registration number:"
			};
