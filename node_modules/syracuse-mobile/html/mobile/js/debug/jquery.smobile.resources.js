...
(function($) {
	...
	that.buildDate = function() {
		...
		//#BUILDDATE_START
		Date.parseISO8601("2014-10-14T12:30:36.989Z");
		//#BUILDDATE_END
		return cd;
	};
	...
	that.locale = function() {
		...
		//#START
		{
			...
			"ui.no_db_support_priv": "Your browser seems to not support any kind of HTML5 database. This error message also occurs if you use the browser in private browsing mode which is not supported.",
