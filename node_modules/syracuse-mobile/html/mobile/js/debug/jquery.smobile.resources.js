...
(function($) {
	...
	that.buildDate = function() {
		...
		//#BUILDDATE_START
		Date.parseISO8601("2014-04-09T11:28:56.697Z");
		//#BUILDDATE_END
		return cd;
	};
	...
	that.locale = function() {
		...
		//#START
		{
			...
			"ui.check_net": "Check your internet connexion",
			"ui.connect": "Connect",
			...
			"ui.edit_item": "Edit",
			"ui.exception_offline": "The server is not responding or is not reachable.\nFor help, contact your network administrator.",
