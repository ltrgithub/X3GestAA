...
(function($) {
	...
	that.controls.SingleField = {
		...
		initData: function(cp, ft, title, opts, $article) {
			...
			if (that.controls.SingleField._isChart(opts)) {
				res = "Chart";
			}
			return res;
		},
		_isChart: function(opts) {
			/*
			if (opts && (opts.bind === "PCLOB" || opts.$bind === "PCLOB"))
				return true;
			*/
			return false;
		},
		handler: function(c, after) {
			...
			} else if (that.controls.SingleField._isChart(options)) {
				var $article = options.$article;
				options.$article = null;
				var controls = [];
				var cc = null,
