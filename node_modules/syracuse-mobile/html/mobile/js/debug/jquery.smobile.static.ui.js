...
(function($) {
	...
	ui.about = function() {
		...
		license.forEach(function(lic) {
			...
			licenses = licenses +  getLabelAndValue(locale.license.serial, lic.serial);
			licenses = licenses +  getLabelAndValue(locale.license.licensedTo, lic.licensedTo.name);
			licenses = licenses +  getLabelAndValue(locale.license.expiryDate, lic.expiryDate);
		...
		var html = 	'<div class="s-m-style s-m-about-box">' +
					...
					'    <hr><div class="s-m-style s-m-license-line"><label class="s-m-style s-m-license-label">' + locale.about.clientVersion + 
					'    </label><div class="s-m-style s-m-license-value">' + $helpers.buildDateString() + '</div></div><a class="s-m-hidden" data-role="button" href="#"></a>';
					'  </div>' +
					'  </div>' +
