...
(function($) {
	...
	ui.about = function() {
		...
		var html = '<div class="s-m-style s-m-about-box">' + $helpers.getLabel("about.text");
		if (licenses) {
			html = html + '<h5>' + $helpers.getLabel("about.update") + " " + version + '</h5>';
		}
		html = html + '<div data-role="tabs" id="aboutTabs">' +
			'  <div data-role="navbar">' +
			'    <ul id="aboutTabs">';
		if (licenses) {
			html = html + '    <li><a href="#" data-href="tabLic" class="ui-btn-active">' + $helpers.getLabel("about.license") + '</a></li>';
			html = html + '    <li><a href="#" data-href="tabLeg">' + $helpers.getLabel("about.legal") + '</a></li>';
		} else {
			html = html + '    <li><a href="#" data-href="tabLeg" class="ui-btn-active">' + $helpers.getLabel("about.legal") + '</a></li>';
		}
		html = html + '    </ul>' +
			'  </div>';
		if (licenses) {
			html = html + '  <div id="tabLic">' +
				licenses +
				...
				'  </div>' +
				'  </div>';
			html = html + '  <div id="tabLeg" class="s-m-hidden"><p class="s-m-legaltext">' + $helpers.getLabel("about.legaltext") + '</p></div>';
		} else {
			html = html + '  <div id="tabLeg" class=""><p class="s-m-legaltext">' + $helpers.getLabel("about.legaltext") + '</p></div>';
		}
		html = html + '</div>' +
			'</div>';
		return {
