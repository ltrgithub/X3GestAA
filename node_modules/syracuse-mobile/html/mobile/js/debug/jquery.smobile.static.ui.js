...
(function($) {
	...
	ui.about = function() {
		...
		var getLabelAndValue = function(label, value) {
			return '<div class="s-m-style s-m-license-line"><label class="s-m-style s-m-license-label">' + label + '</label><div class="s-m-style s-m-license-value">' + value + '</div></div>';
		...
		license.forEach(function(lic) {
			...
			licenses = licenses + getLabelAndValue(locale.license.licensedTo, lic.licensedTo.name);
			licenses = licenses + getLabelAndValue(locale.license.registrationNumber, lic.licensedTo.registrationNumber);
			licenses = licenses + getLabelAndValue(locale.license.reference, lic.licensedTo.reference);

			// No info in license file yet
			// licenses = licenses +  getLabelAndValue(locale.license.userLicense, '????');
			licenses = licenses + getLabelAndValue(locale.license.installedBy, lic.reseller.name);

			// No info in license file yet
			//licenses = licenses +  getLabelAndValue(locale.license.server, '????');
			licenses = licenses + getLabelAndValue(locale.license.expiryDate, $helpers.format(locale.license.expiryDateValue, [startDate, endDate]));
		...
		var html = '<div class="s-m-style s-m-about-box">' +
			...
			'    <ul id="aboutTabs">' +
			'    <li><a href="#" data-href="tabLic" class="ui-btn-active">' + locale.about.license + '</a></li>' +
			'    <li><a href="#" data-href="tabLeg">' + locale.about.legal + '</a></li>' +
			'    </ul>' +
			'  </div>' +
			'  <div id="tabLic">' +
			licenses +
			...
			'      <label class="s-m-style s-m-license-label">' + locale.about.clientVersion + '</label>' +
			'      <div class="s-m-style s-m-license-value">' + $helpers.buildDateString() + '</div>' +
			'    </div>' +
			'    <a class="s-m-hidden" data-role="button" href="#"></a>' +
			'  </div>' +
			'  </div>' +
			'  <div id="tabLeg" class="s-m-hidden"><p class="s-m-legaltext">' + locale.about.legaltext + '</p>' +
			'  </div>' +
			'</div>' +
			'</div>';
		return {
