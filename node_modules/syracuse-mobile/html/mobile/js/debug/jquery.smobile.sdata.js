							...
							function(value, index, next) {
								...
								if (send.$httpMethod == "PUT") {
									switch (value.$httpStatus) {
										...
										case 412:
											//Etag mismatch. Ressource is locked on the server. 
											//The edit form will be reset .
											// The user is informed about the loss of his input

											if (options.editActivity) {
											...
											var opts = {
												text1: $helpers.format(locale.resetinput),
											...
											return  $helpers.confirmDlog.call(opts);
											 */
											return $.sdata.updData(resUrl, {
												data: value,
												original_data: null,
