...
(function($) {
	...
	var _typedItems = {
		...
		logout: function(item) {
			...
			//item.hash = $.smobile.PAGES.logoff.id;
			item.action = "logout";
			item.icon = "logout";
		},
		testerrors: function(item) {
			item.title = "Test errors" //$helpers.locale().maintoolbar...;
			item.action = "testerrors";
			//item.icon = "testerrors";
		}
	};
