					...
					switch (item.code) {
						...
						case "actions":
							if (!linksloaded) {
								...
								links = $proto.extractLinks(proto, proto, controller.getCurrentData(), edit);
						...
						case "links":
							if (!linksloaded) {
								...
								page = controller.getPageData();
								proto = $proto.getProto(page);
								links = $proto.extractLinks(proto, proto, controller.getCurrentData(), false);
								if (edit) linksloaded = false;
							}
							if (links) {
								links.forEach(function(link) {
