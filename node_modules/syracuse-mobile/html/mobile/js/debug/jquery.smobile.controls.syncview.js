...
(function($) {
	...
	that.controls.SyncView = {
		create_buttons: function(controller, b1html, b2html, buttons, id) {
			var hasdata = controller.getValue() ? true : false;
			if (hasdata) {
				var del_itm = {
					linkId: id + "_undo",
		...
		create_items: function(controller, data, html, buttons, id) {
			...
			Object.keys(data).forEach(function(value) {
				...
				list.forEach(function(cd, index) {
					...
					cd.$info.last_error = "This is the error message";
					...
					html.push('<div class="s-m-syncview-date">' + '2012/11/26 - 12:05' + '</div>');
		...
		asyncHandler: function() {
			...
			$sdata.getSyncData(function(data, error) {
				...
				$('#' + id + "_b1").html(b1html.join(''));
				$('#' + id + "_b2").html(b2html.join(''));
		...
		handler: function(c, after) {
			...
			html.push('<ul class="s-m-list syncview"  data-divider-theme="a" id="' + c.id + '_ul" data-role="listview"');
