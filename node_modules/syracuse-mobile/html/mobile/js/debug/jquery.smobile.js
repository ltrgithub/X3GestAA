...
(function($) {
	...
	Controller.prototype = {
		...
		multiSelClick: function(ctrlId, elmt) {
			var self = this,
				multiSel = self.extraData.multiSel;
			if (!multiSel) multiSel = self.extraData.multiSel = {};
			var sel = multiSel[ctrlId];
			if (!sel) sel = multiSel[ctrlId] = [];
			return h && h.hasClass("multisel");
		},
