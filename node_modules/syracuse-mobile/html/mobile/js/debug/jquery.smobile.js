			...
			if (self.editActivity()) {
				...
				var after = function(cbOpts, errors, sDataUrl) {
					if ($helpers.hasErrors()) {
						...
						//  Issue #2811 - Disabled because it forces top saty on edit facte - To test and remove that code
						if (false && sDataUrl) { // set when a new record is created and we are in online mode
