...
(function($) {
	...
	var _addMenus = function(controller, html, options) {
		...
		html.push('">');
		html.push('<select id ="' + controller.prefix + options.id + '" ');
	...
	var _addMultiselMenus = function(controller, html) {
	...
	var _createHeader = function(controller, ui, pgtitle, nopanel, isLocalData) {
		...
		html.push('</div>');
		var multisel = ui.$facet == '$query' && _addMultiselMenus(controller, html);
