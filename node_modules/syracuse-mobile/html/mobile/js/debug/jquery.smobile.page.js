...
(function($) {
	...
	var _createFooter = function(controller, ui) {
	...
	var _buildPage = function(pagename, $currentPage, $page, ui, data, info,
		...
		$footer.html(_createFooter(controller, ui));
		var content = [];
	...
	var _private = {
		...
		getCtxItems: function(facet, representation, data, items, ritems) {
		...
		enhanceHeader: function(data) {
			...
			var ritems = uiData.rpanel && uiData.rpanel.right_panel && uiData.rpanel.right_panel.data && uiData.rpanel.right_panel.data.items || [];
			if (uiData && uiData.$facet && $sdata.config) {
				_private.getCtxItems(uiData.$facet, uiData.$representation,
					data, hbuttons, ritems); // context items
				if (hbuttons.length)
