...
(function($) {
				...
				.forEach(
					function(id, index) {
						...
						if (c.layout) {
							...
							// UI Controls with handler, refresh, events
							// methods - Class defined in
							// $.smobile.controls[c.uiClass]
							// Calls 'handler' method to
							// initcontrol(create html)
							$.smobile.addControl
								.apply(
									controller, [
										parent,
	...
	var _createFooter = function($footer, controller, ui) {
		// Nothing - We can create footer button from a controller / view via controller.footerAddBtns
		// If needed we can create here static buttons by page
		// Add footer buttons
		if (ui.footerActions) {
			...
			foot.html(self.footerHtmlBtns(btns)); //.appendTo(self._getFooter(true));
	...
	var _buildPage = function(pagename, $currentPage, $page, ui, data, info,
		...
		// Set page footer Html on d create buttons if 
