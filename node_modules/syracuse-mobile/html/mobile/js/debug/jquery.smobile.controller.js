...
(function($) {
	...
	Controller.prototype = {
			...
			if (self.editActivity()) {
				...
				var after = function(cbOpts, errors, sDataUrl) {
					...
					var checkUrl = function(url) {
						queryfound = queryfound || (url && url.indexOf("query") > 0);
						// Find details page in history
						return url && url.indexOf("details") > 0;
					};
					var detailFound = $.helpers.historyFind(checkUrl);
		...
		_refreshErrorMessage: function() {
			var errctrl = this.controlByClass("MsgView");
			if (errctrl && errctrl.refresh) {
				errctrl.refresh(controller);
			}
		},
