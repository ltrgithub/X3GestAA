...
(function($) {
	...
	Controller.prototype = {
		...
		_updateActions: function($actions) {
			var self = this;
			if ($actions) {
				var l;
				self.alinks.forEach(function(id) {
					/*	l = self.alinks[id];
					data-action-param={"id":"c1cd495b-555e-47c7-a055-536c44836bd9"}*/
				});
				$('#' + self.prefix + 'right_panel').find("a");
			}
		},
		...
		actionmethod: function(options, params) {
			...
			var _after = function() {
				...
				url += $helpers.encodeJsmQuery('?url=' + $helpers.encodeURIComponent("locastorage://methodres"));
				$.smobile.changePage(url, {
					changeHash: false
				});
				return;
