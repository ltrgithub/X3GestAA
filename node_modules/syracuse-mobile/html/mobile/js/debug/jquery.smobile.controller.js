...
(function($) {
	...
	Controller.prototype = {
		...
		actionmethod: function(options, params) {
			...
			var actParams = postData.$actionParams[params.name] = {
				$isRequested: true,
				$parameters: {}
			};
			var page = self.getPageData();
			if (params.$parameters) {
				for (var pn in params.$parameters) {
					actParams.$parameters[pn] = $proto.parseExpression(params.$parameters[pn], {
						data: self.exprData(),
			...
			var url = $proto.parseExpression(params.url, {
				data: self.exprData(actParams.$parameters),
				$prototype: $proto.getProto(page, params.bind)
			}, "$url");
