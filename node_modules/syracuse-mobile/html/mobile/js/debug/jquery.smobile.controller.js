	...
	Controller.prototype = {
		...
		actionlanguage: function(options) {
			...
			if (!$helpers.online()) {
				...
				// Fetch available language from syracuse server
				$.smobile.userProfile.queryLocalePreferences(function(locales) {
					...
					// Set combo box content to languages from syracuse
					$.smobile.staticui.language_set_items(items);
				...
				var after = function(cbOpts, errors, sDataUrl) {
					...
					if (sDataUrl && $helpers.hasMessages() && $helpers.displayErrorAsMessage()) {
						...
						if ($.helpers.historyBack(function(url) {
							...
							// Find details page in history and goto to this page if found
							return !queryFound && url.indexOf("details") > 0;
						}, false)) {
							// Stop processing 
							return;
						}
