...
(function($) {
	...
	Controller.prototype = {
		...
		multiselActStart: function($selectActs, nbSel) {
			...
			// Hide not selected
			$lst.find("li").not(".multisel").hide();
			// Disable click on lines
			$lst.find("li").addClass("ui-disabled");
			// Remove search form
			self.getSearchForm().hide();
			// Hide actions menu - Show empty title
			var head = $("#" + self.prefix + "headerTab");
			head.find(".s-m-header-cell-select").hide();
			head.find(".s-m-header-cell-ttl").empty().show;
			// Processin Status
		...
		multiselActStop: function($lst) {
			...
			$("#" + self.prefix + "headerTab").find(".s-m-header-cell-ttl").show().html(nbok + " succedeed - " + nbko + " failed");
		},
		...
		getMultiSwitch: function() {
			return $("#" + self.prefix + "headerTab").find('a[data-action="multiswitch"]');
		},
		...
		getSearchForm: function() {
			return $('#' + this.getsDataList().attr('id') + '_search_form');
		},
		multiSelOn: function() {
			var self = this;
		...
		actionmultiswitch: function(options, params) {
			...
			if (self.multiSelOn()) {
				...
				ttl.hide();
				$("#" + self.prefix + "headerTab").find(".s-m-header-cell-select").show();
