...
(function($) {
    ...
    that.controls.TemplatesView = {
        ...
        _buildContainers: function(c, html) {
            ...
            html.push('<li data-role="list-divider">' + locale.ui.newTemplate + '</li>');
            ...
            html.push('<ul class="s-m-list templatesview" data-divider-theme="a" id="' + c.id + '_ul" data-role="listview" data-inset="true">');
