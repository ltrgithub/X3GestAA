...
(function($) {
	...
	that.controls.TemplatesView = {
		...
		_buildContainers: function(c, html, tpl) {
			//var tpl = controller._tpl;//that.controls.TemplatesView._getStoredTemplate();
		...
		_selectTemplate: function($c, c, controller, uuid, lineid) {
			that.controls.TemplatesView._getMatchingTemplate(uuid, controller._tpl, function(template) {
				if (template == null) {
		...
		_getMatchingTemplate: function(uuid, tpl, cb) {
			//var tpl = controller._tpl; //that.controls.TemplatesView._getStoredTemplate();
			var keys = {
				appid: tpl.appid,
				page: tpl.page,
