	...
	that.controls.ArrayRef = {
		_createItem: function(html, cp, value, index, controller, field) {
			...
			if (ioptions.title) {
				...
				html.push('<span class="s-m-style s-m-linkdesc theme'+ settings.preferences.linkDescTheme+'"> ' + $helpers.htmlEncode(ioptions.title) + '<span>');
			}
			html.push('</a>');
		...
		createArrayRef: function(controller, c, fieldData) {
			...
			html.push('<button id="' + c.id + '_new" class="s-m-min40 ui-btn-right" data-role="button" data-mini="true" data-inline="false" data-theme="f" data-icon="plus" data-iconpos="left" ');
			html.push('href="');
