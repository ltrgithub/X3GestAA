...
(function($) {
	...
	$.helpers.historyBack = function(callBack, backIfNotFound, myBackHandler) {
		...
		if (dst) {
			...
			if (myBackHandler) {
				...
				// Works fine but don't clear browser history contrary to window window.history.go(prevIdx - startIdx);
