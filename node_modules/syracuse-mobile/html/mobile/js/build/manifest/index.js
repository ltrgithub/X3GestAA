			...
			ccompile({
				...
				ccompile({
					...
					ccompile({
						...
						options: { 
							warning_level: "VERBOSE",externs: ["../jquery.js", "../json.js", "../console.js", "../md5.js", "../highcharts.js"]
						},
						output: '../../jquery.smobile.fw.js'
					}, function(options) {
						// #4326 - add nonDebugMode
						fs.appendFileSync(options.output, '(function($) {if($){if (!$.smobile) $.smobile = {};$.smobile.nonDebugMode=true;}})(jQuery);');
						lib.mkmanifest({
							filename : "mobile"
							,path : "../../../"
							,dst : "../../../../"
							...
							,version : "v1.0"
							,content : "/favicon.ico\n./moffline.html\n"
							,exclude : ['.*/[.].*', '.*/dev/.*','.*/build/.*', '.*/auth/.*', '.*/debug/.*', '\.cache.manifest','.*/flot/.*', '.*\.src.js', '.*/jquery-latest.min.js']
