...
e.connect.autoLogon=d.autoLogon;e.connect.user=d.user;e.connect.password=d.password;e.offline=d.offline;b.settings("",e);b.setOfflineMode(e.offline);f.smobile.removeAllPages([this.pageInfo.pageId]);f.smobile.goHome(this);a(!1)}}}};m.settings_data=function(){var a={},c=b.settings();c.sdata=c.sdata||{};c.connect=c.connect||{};a.autoLogon=c.connect.autoLogon;a.authType=c.connect.authType||"basic";a.user=c.connect.user||"";a.password=c.connect.password||"";a.offline=c.offline||!1;return a};m.language=
function(){var a=b.locale();return{$title:a.administration.title,content:{cp:{layout:"BlockBodyLayout",data:{}},c11:{uiClass:"Html",data:{html:a.change_language_warning},parent:"cp"},locale:{uiClass:"Combo",data:{label:a.ui.locale,bind:"locale",items:[]},parent:"cp"}},hbuttons:[{title:a.ui.save_item,action:"savelanguage",jmdata:{"data-icon":"s-ok","data-transition":"back"}}],actions:{savelanguage:function(){function a(){n&&n.doRefresh(!0);f.smobile.changePage("#langchanged",{allowSamePageTransition:!0,
reverse:!0})}function d(a,b){j.push(f.extend(!0,{},a));f.sdata.removeFromDB(a.id,b)}function e(){f.smobile.doinstall(j,{},function(a,c){0===a&&c?f.mobile.loading("show",{theme:"a",text:b.locale().ui.installing}):a===c&&f.mobile.loading("hide")},a)}function g(){h.getInstalledApps(!0,function(a){function b(c){c++;c===a.length?e():d(a[c],function(){b(c)})}b(-1)})}function i(){var a=n.getValue().locale,c=b.settings();c.locale=a;b.settings("",c);l(a,function(){g()})}var n=this,j=[],k=n.getValue(),m=b.settings();
k.locale===m.locale?(b.pushInfoMessage(b.locale().langnotchanged),f.smobile.changePage("#home",{allowSamePageTransition:!0,reverse:!0})):h.getSyncCount(function(a){a?(b.pushInfoMessage(b.locale().ui.rmvdrafts_lang),n.doRefresh()):i()})}}}};m.language_data=function(){var a={},c=b.settings();a.locale=c.locale||"en-US";return a};var g={lastCheck:null,checkInterval:0,authurl:i.authUrl,detect:function(a){var b="unknown";(a=a||"")&&(a=a.toUpperCase());0===a.indexOf("BASIC")?b="basic":0===a.indexOf("DIGEST")&&
(b="digest");return b},connect:function(a){var c=b.settings();c.connect=c.connect||{};b.clearErrors();if(i.resetInterval)g.lastCheck=null,i.resetInterval=!1;g.lastCheck&&new Date-g.lastCheck<g.checkInterval||h.GET(h.sdataHost+g.authurl,function(d,e){if(e&&401===e.status){if("basic"===g.detect(e["WWW-Authenticate"])){c.connect=c.connect||{};var f={Authorization:"Basic "+window.btoa((c.connect.user||"")+":"+(c.connect.password||""))};b.clearErrors();return h.GET(h.sdataHost+g.authurl,function(c){g.lastCheck=
