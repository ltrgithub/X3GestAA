...
this.getValue(),f=c.settings();f.sdata=f.sdata||{};f.connect=f.connect||{};f.connect.authType=d.authType;f.connect.autoLogon=d.autoLogon;f.connect.user=d.user;f.connect.password=d.password;f.offline=d.offline;c.settings("",f);c.setOfflineMode(f.offline);e.smobile.removeAllPages([this.pageInfo.pageId]);e.smobile.goHome(this);a(!1)}}};e.helpers.isOfflineAvail()||delete a.content.offline;return a};m.settings_data=function(){var a={},b=c.settings();b.sdata=b.sdata||{};b.connect=b.connect||{};a.autoLogon=
b.connect.autoLogon;a.authType=b.connect.authType||"basic";a.user=b.connect.user||"";a.password=b.connect.password||"";a.offline=b.offline||!1;return a};m.language=function(){var a=c.locale();return{$title:a.administration.title,content:{cp:{layout:"BlockBodyLayout",data:{}},c11:{uiClass:"Html",data:{html:a.change_language_warning},parent:"cp"},locale:{uiClass:"Combo",data:{label:a.ui.locale,bind:"locale",items:[]},parent:"cp"}},hbuttons:[{title:a.ui.save_item,action:"savelanguage",jmdata:{"data-icon":"s-ok",
"data-transition":"back"}}],actions:{savelanguage:function(){function a(){n&&n.doRefresh(!0);e.smobile.changePage("#langchanged",{allowSamePageTransition:!0,reverse:!0})}function d(a,c){j.push(e.extend(!0,{},a));e.sdata.removeFromDB(a.id,c)}function f(){e.smobile.doinstall(j,{},function(a,b){0===a&&b?e.mobile.loading("show",{theme:"a",text:c.locale().ui.installing}):a===b&&e.mobile.loading("hide")},a)}function h(){g.getInstalledApps(!0,function(a){function c(b){b++;b===a.length?f():d(a[b],function(){c(b)})}
c(-1)})}function i(){var a=n.getValue().locale,b=c.settings();b.locale=a;c.settings("",b);l(a,function(){h()})}var n=this,j=[],k=n.getValue(),m=c.settings();k.locale===m.locale?(c.pushInfoMessage(c.locale().langnotchanged),e.smobile.changePage("#home",{allowSamePageTransition:!0,reverse:!0})):g.getSyncCount(function(a){a?(c.pushInfoMessage(c.locale().ui.rmvdrafts_lang),n.doRefresh()):i()})}}}};m.language_data=function(){var a={},b=c.settings();a.locale=b.locale||"en-US";return a};var h={lastCheck:null,
checkInterval:0,authurl:i.authUrl,detect:function(a){var b="unknown";(a=a||"")&&(a=a.toUpperCase());0===a.indexOf("BASIC")?b="basic":0===a.indexOf("DIGEST")&&(b="digest");return b},connect:function(a){var b=c.settings();b.connect=b.connect||{};c.clearErrors();if(i.resetInterval)h.lastCheck=null,i.resetInterval=!1;h.lastCheck&&new Date-h.lastCheck<h.checkInterval||g.GET(g.sdataHost+h.authurl,function(d,f){if(f&&401===f.status){if("basic"===h.detect(f["WWW-Authenticate"])){b.connect=b.connect||{};var e=
{Authorization:"Basic "+window.btoa((b.connect.user||"")+":"+(b.connect.password||""))};c.clearErrors();return g.GET(g.sdataHost+h.authurl,function(b){h.lastCheck=c.hasErrors()?null:new Date;if(b&&!k){var d=b.selectedLocale;o(d,function(){return l(d.code,function(){return a(b,c.hasErrors())})})}l(c.language(),function(){return a(b,c.hasErrors())})},e,{Authenticate:!0})}h.lastCheck=null;return a(null,!0)}h.lastCheck=c.hasErrors()?null:new Date;return a(null,c.hasErrors())},{},{Authenticate:!0})}};
g.capabilities.auth=function(a){return h.connect(a)};g.checkVersionInCache=function(a){var b=e.helpers.buildDateString(),a=a.buildDateString;window.console.log(b);window.console.log(a)};c.authHeaders=function(a,b){var d=c.settings();d.connect=d.connect||{};return d.connect.autoLogon&&"basic"===d.connect.authType&&(a.Authorization="Basic "+window.btoa((d.connect.user||"")+":"+(d.connect.password||"")),b)?!0:!1}})(jQuery);
