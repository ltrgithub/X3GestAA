...
<input id="input3"/><input id="input4" value = "dummy"/>
...
<p> 
<input type="text" id="focusin-timeout" value="Focusin after ajax"/>
<div>Make ajax call sync <input type="checkbox" id="focusin-timeout-cb" value="false"/></div>

<a href="https://www.sage.com" id="myydiv"> test swipe <p>
test swipe <p>
test swipe <p>
<a/>
