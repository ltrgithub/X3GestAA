...
var createCertificateInstance = function(_, name, passphrase) {
	...
	var caString = fs.readFileSync(__dirname + "/../../../../shadow-modules/node_modules/jsx509/test/server/fixtures/" + name + ".crt", "utf8");
	...
	var keyString = fs.readFileSync(__dirname + "/../../../../shadow-modules/node_modules/jsx509/test/server/fixtures/" + name + ".key", "utf8");
...
QUnit.module(module.id, {
	...
	teardown: function() {
		if (doStop) {
			rmdirRec(directory, function(error, data) {
