...
var directory = fsp.join(__dirname, '../../../../certificatetestx/');
...
asyncTest('sign using buffer', pdfFiles.length * certificates.length * 4, function(_) {
	certificates.forEach_(_, function(_, cert) {
		pdfFiles.forEach_(_, function(_, item) {
			var writer, pdfFile, originalSize;
			try {
...
asyncTest('clean up', 1, function(_) {
