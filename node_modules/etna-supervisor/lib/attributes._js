...
- une description par langue si demandée (voir asyrloc)
*/
...
var uExtAttributes = Object.keys(extAttributes).reduce(function(r, name) {
...
function clone(src,dst) {
	...
	typeof(src.$attributes._attributes) === 'object' && src.$attributes._attributes &&
		Object.keys(src.$attributes._attributes).map(function(name) {
			dst.$attributes._attributes[name] = src.$attributes._attributes[name];		
	});

	typeof(src.$attributes._resources) === 'object' && src.$attributes._resources && 
		Object.keys(src.$attributes._resources).map(function(name) {
...
Object.defineProperty( Attributes.prototype, "setAttribute", {
  value :function(attribute,value) {
	...
	var attribute = uExtAttributes[attribute.toUpperCase()];
	if(attribute !== undefined) {
		return this.setAttribute(attribute,value);
	}
	console.log("exception 147");
...
function addIntAttributes(_prototype) {
	...
	Object.defineProperty(_prototype, "ASETATTR", {
	  value :function(attribute,value) {
		try {
			return this.setAttribute(attribute,value);
		} catch(ex) {
	...
	Object.defineProperty(_prototype, "setIntAttribute", {
	  value :function(attribute,value) {
	...
	Object.defineProperty(_prototype, "getIntAttribute", {
	  value :function(attribute) {
	...
	Object.keys(intAttributes).forEach(function(attribute) {
		Object.defineProperty( _prototype, attribute, {
		  set:function(value) { return this.setIntAttribute(attribute,value);},
		  get:function()      { return this.getIntAttribute(attribute);},
		  enumerable: false   
		}) ;
	});
