...
function addIntAttributes(_prototype) {
	...
	// Q to Eric: what's the point? Should be in constructor not in prototype.
	...
	_prototype.getAttributes = function() {
...
function addColAttributes(_prototype) {
	// Q for Eric: array will be shared by all instances. Is this really what you want?
