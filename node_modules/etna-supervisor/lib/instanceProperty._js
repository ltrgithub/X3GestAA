...
var tracerSup = require("syracuse-trace/lib/helper").getTracer("etna.supervisor");
...
var InstanceProperty = exports.InstanceProperty = helpers.defineClass(function(parent, property) {
	...
	getAtextra: function(_, lan) {
		return this.isAtextra ? this.property.getAtextra(_, this.$parent, lan) : undefined;
	},
	...
	*/
	...
	_set: function(_, value, raw) {
		//dbg:console.error("property " + this.name + " SET -> (type :"+ this.property.type.etnaType+ ")");
