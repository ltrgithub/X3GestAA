...
InstanceProperty.prototype.deleteDiagnoses = function() {
	this.diagnoses = undefined;
};

InstanceProperty.prototype.getDiagnoses = function(parent) {
	if (this.diagnoses) {
		var self = this;
...
InstanceProperty.prototype.addDiagnose = function(_, severity, message) {
...
InstanceProperty.prototype.controlFormat = function(_) {
...
InstanceProperty.prototype.controlOthers = function(_) {
	if (false) // TODO
		this.addDiagnose(_,
...
InstanceProperty.prototype._get = function(_, raw) {
...
InstanceProperty.prototype._set = function(_, value, raw) {
...
InstanceProperty.prototype.fromRecord = function(_, record, colnIndex) {
...
InstanceProperty.prototype.clone = function(parent) {
...
InstanceProperty.prototype.revertTo = function() {
	if (!this.snapshotof) return;
	this.snapshotof._value = this._value;
	attributes.revertTo(this, this.snapshotof);
};

InstanceProperty.prototype.propagateValue = function(_, oldValue) {
...
InstanceProperty.prototype.setAsMandatory = function(_) {
