...
Object.defineProperty(InstanceProperty.prototype, "set", {
	value: function(_, value, raw) {
		//dbg:console.log("property " + this.name + " SET -> " + value + " (type :"+ this.property.type.etnaType+ ")");
		...
		if (!raw) {
			...
			//dbg:console.log(this._setCalls+".property " + this.name + ">");
			if (this._setCalls === 1) {
				// Control the new value:
				//dbg:console.log(this._setCalls+".property " + this.name + " control value "+value);
				if (!this.$parent.propertyControlValue(_, this.name, oldValue) && this.$parent.propertyPropagateValue && (oldValue.value !== undefined) && (oldValue.value.x3Compare(value) !== 0)) {
					//dbg:console.log(this._setCalls+".property " + this.name + " propagate old:'"+oldValue.value+"' new:'"+this._value+"'");
