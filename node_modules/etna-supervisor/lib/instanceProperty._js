...
Object.defineProperty(InstanceProperty.prototype, "get", {
	value: function(_, raw) {
		...
		if (!raw && this.property.data && this.property.data.FLGACCGET === 2) {
			...
			console.log("DBG property " + this.name + " GET -> this._getCalls:" + this._getCalls);
...
Object.defineProperty(InstanceProperty.prototype, "set", {
	value: function(_, value, raw) {
		// console.log("property " + this.name + " SET -> " + this._value + " (type :"+ this.property.type.etnaType+ ")");
		...
		if (!raw) {
			...
			//! console.log("DBG property " + this.name + " SET -> this._setCalls:" + this._setCalls);
			if (this._setCalls === 1) {
				// Control the new value:
				//! console.log("DBG property " + this.name + " CONTROL :"+JSON.stringify(oldValue));

				if (!this.$parent.x3Properties(_, "CONTROL", this.name, oldValue) && oldValue !== this._value) {
					//! console.log("DBG property " + this.name + " PROPAGATE");
