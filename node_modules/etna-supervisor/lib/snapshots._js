...
function addSnapshots(_prototype) {
	...
	snapshots.forEach(function(snapshot) {
		...
		_prototype["enable" + snapshot] = function() {
			...
			//dbg:console.error("dbg enable "+snapshot+" "+attEnable+"="+ this.getIntAttribute(attEnable));
		};
		...
		_prototype[lsnapshot] = function() {
			//dbg:console.error("dbg "+lsnapshot+" "+attEnable+" : "+this.getIntAttribute(attEnable));
