...
var InstanceFactory = require('etna-supervisor/lib/meta/instanceFactory');

exports.constructor = util.defineClass(function(superv, repr, facet, path, instanceFactory) {
	this.superv = superv;
	...
	pageProto: function(_) {
		...
		pageProto.$baseUrl = this.superv.baseUrl;
	...
	loadResource: function(_, key, qs) {
		return this.superv.new(_, 'Resource', this, this.instanceFactory.loadInstance(_, key, qs));
	},
	createResource: function(_, qs) {
		return this.superv.new(_, 'Resource', this, this.instanceFactory.createInstance(_, qs));
	},
	query: function(_, qs) {
		var itemsPerPage = qs.count ? parseInt(qs.count, 10) : 20;
		console.log("BEFORE LOAD");
		var resources = this.instanceFactory.loadInstances(_, null, null, itemsPerPage).map_(_, function(_, resource) {
			return this.superv.new(_, 'Resource', this, resource);
		}, this);
