...
exports.constructor = util.defineClass(function(superv, repr, facet, path, clas) {
	...
	loadResource: function(_, key, qs) {
		...
		var resource = this.supervisor.new(_, 'Resource', this, null, this.representation.addSysProperties());
		resource.$methods(_, "AREAD_BEFORE");
		resource.instance = this.class.loadInstance(_, resource, key, qs);
		resource.$methods(_, "AREAD_AFTER");
		return r;
	...
	query: function(_, httpContext, qs) {
		...
		var fromInstanceToResource = function(_, reader, writer) {
			...
			while (instance = reader.read(_)) {
				...
				astatus = resource.$methods(_, "AQUERY_TRANS_AFTER");
