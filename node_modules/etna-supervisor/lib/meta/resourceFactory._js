...
exports.constructor = util.defineClass(function(superv, repr, facet, path, instanceFactory) {
	...
	loadResource: function(_, key, qs) {
		return this.supervisor.new(_, 'Resource', this, this.instanceFactory.loadInstance(_, key, qs));
	},
	createResource: function(_, qs) {
		return this.supervisor.new(_, 'Resource', this, this.instanceFactory.createInstance(_, qs));
	},
	query: function(_, qs) {
