...
exports.defineClass = function(constructor, parent, members) {
	...
	members.AINIT = function(_) {
		...
		if (this.instance && (status = this.instance.propertiesEvent(_))) return status;
	...
	members.propertyPropagateValue = addPropertyEvent("PROPAGATE");
	...
	members.$AINSERT = function(_) {
		...
		return this.withControl(_, function Insert(_, self) {
	...
	members.$AUPDATE = function(_) {
		...
		return this.withControl(_, function Update(_, self) {
	...
	members.$ADELETE = function(_) {
		...
		return this.withControl(_, function Delete(_, self) {
