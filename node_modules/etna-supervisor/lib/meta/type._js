...
module.exports = {
	...
	constructor: util.defineClass(function(superv, data) {
		...
		engineType: function() {
			...
			case 1:
				// tiny int
				return variables.types["J"].def;
			case 2:
				// short integer
				return variables.types["I"].def;
			case 3:
				// long integer - was translatable text ???
				return variables.types["I"].def;
			case 4,5,6:
				return variables.types["N"].def;
			case 7:
				return variables.types["S"].def;
			case 8:
				// date
				return variables.types["D"].def;
			case 10:
				// documnet
				return variables.types["B"].def;
			case 11:
				// uuid
				return variables.types["S"].def;
			case 12:
