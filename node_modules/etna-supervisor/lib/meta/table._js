...
module.exports = {
	...
	constructor: util.defineClass(function(superv, data) {
		...
		delete: function(_, instance) {
			...
			var result = this.supervisor.executeSql(_, sql, values);
			return (result && result.updateCount) ? instance.supervisor.constants.CST_AOK : instance.supervisor.constants.CST_AERROR;
		},
