...
module.exports = {
	...
	constructor: util.defineClass(function(superv, data) {
		...
		data.COLUMNS.forEach(function(col) {
			if (col.LONG && typeof col.LONG === 'string') {
				if (!isNaN(col.LONG) && bcd.toDouble(bcd.fromString(col.LONG)) > 0) col.LONG = bcd.toDouble(bcd.fromString(col.LONG));
				else delete col.LONG;
			}
		});
		this.data = data;
		this.sql = {};
