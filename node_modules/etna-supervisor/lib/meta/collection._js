...
exports.constructor = util.defineClass(function(superv, clas, data) {
	...
	getSql: function(_, colNames, tableNames, wheres, params, descs, cache, raw) {
		...
		tracerJs.debug && tracerJs.debug("property.getSql collection:" + Object.keys(properties));
		this.class.cache = cache;
		Object.keys(properties).forEach_(_, function(_, name) {
			properties[name].getSql && properties[name].getSql(_, colNames, tableNames, wheres, params, descs, cache, raw);
		}, this);
	}
});