...
var Resource = exports.constructor = util.defineClass(function(superv, resourceFactory, instance, slots) {
	...
	set: function(_, name, value) {
		...
		try {
			return this.slot(_, name).set(_, value);
		} catch (e) {
			//External attributes ?
	...
	dataNode: function(_) {
		...
		Object.keys(this.resourceFactory.properties).forEach_(_, function(_, name) {
			...
			if (prop.collection) {
				...
				result[prop.tag] = this.get(_, prop.data.CODFLD);
			} else {
