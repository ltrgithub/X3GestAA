...
var Resource = exports.constructor = baseInstance.defineClass(function(superv, resourceFactory, instance, slots) {
	...
	x3ActionRead: function(_, action) {
		...
		var dargs = delayedArgs(_, this.instance, this.getX3ActionArgs(_, action));
	...
	AQUERY_TRANS_AFTER: function(_) {
		return this.x3ActionRead(_, "AQUERY_TRANS_AFTER");
	},
	AREAD_BEFORE: function(_) {
		return this.x3ActionRead(_, "AREAD_BEFORE");
	},
	AREAD_AFTER: function(_) {
		return this.x3ActionRead(_, "AREAD_AFTER");
	}
});