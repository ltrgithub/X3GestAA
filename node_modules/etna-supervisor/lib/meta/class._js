	...
	constructor: util.defineClass(function(superv, data, group) {
		...
		init: function(_) {
			...
			this.data.COLLECTIONS.forEach_(_, function(_, data) {
				/*dbg*/
				console.log("Class collection:" + data.CODCOL);
				...
				if ((mapping === null) || mapping.TYPLNK !== 3) { // special treatment reserved to collection where TYPLNK=1x1 :
					...
					if (!p) {
						/*dbg*/
						console.log("collection indexed properties:" + name);
						...
						/*dbg*/
						console.log("collection is a collection:" + name);
						p.collection = coln;
					...
					/*dbg*/
					console.log("collection type 1x1:" + name);
