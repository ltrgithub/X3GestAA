...
module.exports = {
	...
	constructor: util.defineClass(function(superv, data, group) {
		...
		queryInstances: function(_, parent, resourceFactory, select, max) {
			return this.reader(_, parent, select, max, null, resourceFactory);
		},
		...
		sqlReader: function(_, parent, select, max, $recordMapper, resourceFactory) {
			...
			var recordMapper = $recordMapper || function() {
					return function(_, record) {
						...
						if (parent === null) {
							var resource = _this.supervisor.new(_, 'Resource', resourceFactory, instance, resourceFactory.representation.addSysProperties());
							instance._resource = resource;
							instance.parent = resource;
						} else
							var astatus = _this.invokeScripts(_, instance, "$AREAD_BEFORE", "");
						instance.fromRecord(_, record);
						if (parent !== null)
							var astatus = _this.invokeScripts(_, instance, "$AREAD_AFTER", "");
						return instance;
