...
module.exports = {
	...
	constructor: util.defineClass(function(superv, data, group) {
		...
		init: function(_) {
			...
			//dbg:console.log("class this.data.TYPCLA:"+this.data.TYPCLA);
			...
			this.data.COLLECTIONS.forEach_(_, function(_, data) {
				//dbg:console.log("Class collection:" + data.CODCOL);
		...
		invokeScripts: function(_, instance, action, $curpro, $curpth, values) {
			...
			///*dbg*/console.log("invokeScripts:"+action);
			var curpro = $curpro || "";
			var curpth = $curpth || "";
