...
module.exports = {
	...
	constructor: baseClass.defineClass(function(superv, data) {
		...
		service: function(_, keys, $service, facet, qs) {
			...
			if (!links || !links[0]) throw new util.HttpError(400, this.supervisor.loadMessParams(_, 149, 40, $service));
			...
			if (!meth) throw new util.HttpError(400, this.supervisor.loadMess(_, 143, 172) + " " + service);
