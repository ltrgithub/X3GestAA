...
module.exports = {
	...
	constructor: baseClass.defineClass(function(superv, data) {
		...
		resourceFactory: function(_, facet) {
			...
			this.resourceFactories[facet].$hasUuid = true;
			this.resourceFactories[facet].$hasProperties = (facet === "$edit");
		...
		service: function(_, keys, $service, facet, qs) {
			...
			if (links && links[0]) {
				...
				throw new util.HttpError(400, this.supervisor.loadMessParams(_, 149, 40, $service));
			}
