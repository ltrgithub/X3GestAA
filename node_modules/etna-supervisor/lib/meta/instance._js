...
var Instance = exports.constructor = baseInstance.defineClass(function(superv, clas, parent, slots) {
	...
	getScriptArgs: function(action, property) {
		return {
			THIS: {
				type: "LY",
				value: this
	...
	$properties: function(_, action, property) {
		return this.$runScripts(_, action, this.getScriptArgs(action, property));
	},
	$methods: function(_, action) {
		return this.$runScripts(_, action, this.getScriptArgs(action, ""));
	},
