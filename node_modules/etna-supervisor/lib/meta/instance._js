...
var Instance = exports.constructor = util.defineClass(function(superv, clas, data, colnIndex) {
	...
	setColumnAttribute:function(_,collection,column,attribut,value) {
		if(this.children[collection]) return this.children[collection].setColAttribute(column,attribut,value);
	},
	...
	AGETATTRIBUTE:function(_,property,attribut) {
		var value = this.getPropertyAttribute(_,property,attribut);
		return (value ? variables.constants.CST_ATRUE : variables.constants.CST_AFALSE)	
	},
