...
var Instance = exports.constructor = util.defineClass(function(superv, instanceFactory, data, colnIndex) {
	...
	loadChildren: function(_, coln) {
		if (coln.mappingData) {
			...
			for (var i = 0; i < count; i++) {
				children.push(this.supervisor.new(_, 'Instance', coln.instanceFactory, this.data, i));
			}
			return children;
		}
	},
	...
	clone: function() {
		var instance = new Instance(this.supervisor, this.instanceFactory, util.clone(this.data, true), this.colnIndex);
