...
var Value 			   = require("etna-supervisor/lib/value").Value;
...
var Instance = exports.constructor = util.defineClass(function(superv, clas, data, colnIndex) {
	...
	afterCreate: function(_) { // for $create action, not $edit
		...
		Object.keys(properties).forEach_(_, function(_, name){
			...
			if(prop.collection)
				this.children[name] = new InstanceCollection(prop.collection.class,this);
			else
				this.data[name] = new Value(prop.type.defaultValue(),this);
		}, this);
