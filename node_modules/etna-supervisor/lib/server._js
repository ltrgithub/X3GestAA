...
var routes = [{
	...
	handler: function(_, context, codcla, key) {
		...
		//console.log('context.get(_, "AFOLD").get(_, "ANBLEG"); ' + context.builtinProperties.USER().getValue(_));
	...
	handler: function(_, context, user) {
		...
		var res = context.supervisor.loadRights(_, user, (rightsEtag || currentEtag));
