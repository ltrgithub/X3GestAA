...
module.exports = function(config) {
	...
	return {
		...
		sqlDate: function(val) {
			return "'" + val.getDate() + '-' + _months[val.getMonth()] + '-' + val.getFullYear() + "'";
		},
		fromSqlDate: function(val) {
			return this.isNullDate(val) ? null : date.fromJsDate(val);
		},
		sqlDatetime: function(val) {
			return val;
		},
		fromSqlDatetime: function(val) {
			return this.isNullDate(val) ? null : datetime.fromJsDate(val);
		},
		nullDate: function() {
