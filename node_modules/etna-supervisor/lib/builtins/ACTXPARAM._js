...
exports.constructor = util.defineClass(function(superv) {
	...
	AGETUSERVALDATE: function(_, parameter) {
		return this._getParam(_, parameter, "DATE");
	},
	...
	_requestAdovalBase: function(_, levcod, code, parameter) {
		...
		var result = sqlDriver.withConnection(_, function(_, cnx) {
			...
			var wparam = sqlDriver.execute(_, cnx, "select A.VALEUR_0 from ADOVAL A Where A.CMP_0=" + param(0) + " and A.FCY_0=" + param(1) + " and A.PARAM_0=" + param(2), params).map(trim);
			if (wparam[0]) {
