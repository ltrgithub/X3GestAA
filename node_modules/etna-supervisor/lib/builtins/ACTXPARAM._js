...
exports.constructor = util.defineClass(function(superv) {
	...
	init: function(_, className) {
		this.class = this.superv.load(_, 'Class', className);
		return this;
	},
	AGETVALNUM: function(_, frame, key, propName) {
		var instance = this.cache[key];
		if (instance === undefined) {
			instance = this.cache[key] = this.class.instanceFactory.loadInstance(_, key);
		}
