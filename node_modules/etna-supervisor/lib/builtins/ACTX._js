...
exports.constructor = util.defineClass(function(superv) {
	...
	this.builtinProperties = {
		...
		LAN     : function(){
			return {
					getValue:function(_){ return superv.LAN(_);}
				}
			},
		LANDEF     : function(){
			return {
					getValue:function(_){ return superv.LANDEF(_);}
				}
			},	
		USER	: function(){
			return {
					getValue:function(_){ return glob.context.x3frame.context.sys.values.ADXUSR;}
				}
			},
	};
	...
	this.builtinChapters = {
		AFOLD : {
			AVERSION:function(){
				return {
					getValue:function(_){ return system.functions.VER$.fn(0);},
				}
			}
		},
		AINTL : {
			TWODIGITYEAR:function(){ 
				return {
					getValue:function(_){ return glob.context.x3frame.context.sys.values.ADXDCS;}
				}
			}
		}
	};
...
/*			SHORTDATE:function(){ return "";},
	...
	ACTX_SET_LANISO:function(_,$laniso) {
		var laniso = this.get(_,"LANISO");
		if(laniso != $laniso) {
			_setProtectedProperty(this,'LANISO',this.supervisor.LANISO(_,$laniso));
		}
	},
