...
exports.CHECK_EQUAL = function(_, v1, v2, title) {
    ...
    if (v11.x3Compare) deepEqual(v11.x3Compare(v22), 0, (title)?title.valueOf( ):undefined || v11.x3ToString() ) ;	
    else deepEqual(1, 0, (title)?title.valueOf( ):undefined || v11v11.x3ToString() ) ;
}
...
exports.CHECK_NOTEQUAL = function(_, v1, v2, title) {
	...
	ok( v11.x3Compare(v22) != 0, (title)?title.valueOf( ):undefined || v11v11.x3ToString() );
}
