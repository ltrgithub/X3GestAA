...
<<<<<<< HEAD
    if (v11.compare) deepEqual(v11.compare(v22), 0, (title)?title.valueOf( ):undefined || v11 ) ;	
    else deepEqual(1, 0, (title)?title.valueOf( ):undefined || v11 ) ;
=======

	if(v11.compare)
		deepEqual(v11.compare(v22), 0, (title)?title.valueOf( ):undefined || v11 ) ;	
	else
		ok( false, "AXUNIT.CHECK_EQUAL : bad operand "+v11.constructor.name);
>>>>>>> 82f70f371e6a370a02c4eadedbc2cd1ffdb902c9
}
...
exports.CHECK_NOTEQUAL = function(_, v1, v2, title) {
	...
	ok( v11.compare(v22) != 0, (title)?title.valueOf( ):undefined || v11 );
}
