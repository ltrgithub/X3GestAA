...
exports.CHECK_EQUAL = function(_, v1, v2, title) {
    ...
    if (bcd.isBCD(v11)) { 
    	...
    	if (typeof v22 === "number") { deepEqual(  v11, v22, title || v11) ;}
    	else if (integer.isInteger(v22)) { deepEqual( v11, integer.toDouble(v22), title || v11) ;}
    	else if (bcd.isBCD(v22)) { deepEqual( ""+v11 , bcd.toString(v22), title || v11) ;}
    	else deepEqual (1, 0, title || v11) ;		
