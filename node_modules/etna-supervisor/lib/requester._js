...
exports.query = function(_, httpContext, script, query) {
	...
	if (!nblines) {
		if (httpContext.facet === "$bulk") {
			nblines = 1000; //TODO : fmet gactx.aparam.agetuservalnum("NBRREQBLK")
			nblines = nblines || 200;
			ifbulk = true;
		} else {
			nblines = 100; //TODO fmet gactx.aparam.agetuservalnum("NBRREQ")
			nblines = nblines || 20;
			ifbulk = false
		}
	}
	...
	//   If REQUID="" and (FORCED_EXEC=1 or IFSHARED=3)
