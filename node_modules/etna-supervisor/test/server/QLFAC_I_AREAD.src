...
Call CHECK_EQUAL(INS0.COLVAL(1).VALUES,"1")
Call CHECK_EQUAL(INS0.COLVAL(2).VALUES,"2")
Call CHECK_EQUAL(INS0.COLVAL(3).VALUES,"3")
...
#[L]ASTATUS = fmet AQCPROC01.SETUP("")
gosub SETUP from AQCPROC01_CSTD
[L]ASTATUS = fmet AQCPROC01.AREAD("QUNIT_001")
Call CHECK_EQUAL([L]ASTATUS,[V]CST_AINFO)
