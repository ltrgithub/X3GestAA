...
if (!config.unit_test || !config.unit_test.x3endpoint || !config.unit_test.run || !config.unit_test.run.x3Deltas) {
	test('X3 DELTAS UNIT TESTS DISABLED FOR NOW', 1, function() {
