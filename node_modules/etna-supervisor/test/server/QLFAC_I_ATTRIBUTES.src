...
Call ADD_TESTCASE("TC_PROPERTY_ATTRIBUTES","TC_PROPERTY_ATTRIBUTES"   ,107) From AXUNIT
...
TC="Property $title"
Call CHECK_EQUAL(TC,TC) From AXUNIT
[L]ASTATUS = fmet INS1.C03P01.AGETATTR("$title")

TC="Property $description"
Call CHECK_EQUAL(TC,TC) From AXUNIT
[L]ASTATUS = fmet INS1.C03P01.AGETATTR("$description")

TC="Property $acceptedTypes"
Call CHECK_EQUAL(TC,TC) From AXUNIT
[L]ASTATUS = fmet INS1.C03P01.AGETATTR("$acceptedTypes")
...
Call CHECK_EQUAL(TC,TC) From AXUNIT
[L]ASTATUS = fmet INS1.C03P01.AGETATTR("$namProParent")
