...
Call ADD_TESTCASE("AQCPROC07_BASIC","AINSERT + AREAD + AUPDATE + ADELETE",22) From AXUNIT
...
Call CHECK_EQUAL([L]MY_STATUS,[V]CST_AOK) From AXUNIT
Call CHECK_EQUAL(INS.TBL1COL1 , "AQC01") From AXUNIT
Call CHECK_EQUAL(INS.TBL1COL2 , "AQC01_COL2_2") From AXUNIT
Call CHECK_EQUAL(INS.TBL2.TBL2COL1 , "AQC01") From AXUNIT
Call CHECK_EQUAL(INS.TBL2.TBL2COL2 , "AQC01.TBL2.COL2_2") From AXUNIT
Gosub WRITE_ERRORS
