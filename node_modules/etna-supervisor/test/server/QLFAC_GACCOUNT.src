...
Funprog TESTSUITE()
  ...
  Call ADD_TESTCASE( "GACCOUNT_AINSERT_VALID"                    , "Creation of valid GACCOUNT record ZUT1000000 using value 'ZUT1'", 17 ) From AXUNIT
  Call ADD_TESTCASE( "GACCOUNT_AINSERT_VALID_2"                  , "Creation of valid GACCOUNT record ZUT300, TYP=2", 15 ) From AXUNIT
  Call ADD_TESTCASE( "GACCOUNT_AINSERT_VALID_3"                  , "Creation of valid GACCOUNT record ZUT400       ", 15 ) From AXUNIT
  Call ADD_TESTCASE( "GACCOUNT_AINSERT_INVALID_DUPLICATE_ACCSHO" , "Creation of GACCOUNT record ZUT200 with duplicate ACCSHO"   , 3  ) From AXUNIT
  Call ADD_TESTCASE( "GACCOUNT_AREAD"                            , "Read GACCOUNT record ZUT1000000"                            , 13 ) From AXUNIT
  Call ADD_TESTCASE( "GACCOUNT_AUPDATE"                          , "Update GACCOUNT record ZUT1000000"                          , 15 ) From AXUNIT
  Call ADD_TESTCASE( "GACCOUNT_AUPDATE_2"                        , "Update GACCOUNT record ZUT300"                              , 15 )  From AXUNIT
  Call ADD_TESTCASE( "GACCOUNT_AUPDATE_3"                        , "Update GACCOUNT record ZUT1000000 with Bad dimension"       , 16)  From AXUNIT
  Call ADD_TESTCASE( "GACCOUNT_SET_TYP_2"                        , "Update of disabled property on GACCOUNT record ZUT400"      , 28 ) From AXUNIT
  Call ADD_TESTCASE( "GACCOUNT_ADELETE"                          , "Delete GACCOUNT record ZUT1000000"                          , 12 ) From AXUNIT

  Call ADD_TESTCASE( "GACCOUNT_AINSERT_INVALID_SHORT_ACCSHO"     , "Creation of GACCOUNT record ZUT200 with short ACCSHO"       , 3 ) From AXUNIT
  Call ADD_TESTCASE( "GACCOUNT_AINSERT_INVALID_FCY"              , "Creation of GACCOUNT record ZUT200 with invalid FCY"        , 3 ) From AXUNIT    #Enable When COMPANY/SITE CLASS IS READY
  Call ADD_TESTCASE( "GACCOUNT_AINSERT_INVALID_ACS"             , "Creation of GACCOUNT record ZUT200 with invalid ACS"        , 6 ) From AXUNIT     #CHANGE To ACTX.USER not PERMITTED
  Call ADD_TESTCASE( "GACCOUNT_AINSERT_INVALID_VLYSTR"           , "Creation of GACCOUNT record ZUT200 with invalid VLYSTR"     , 5 ) From AXUNIT
  Call ADD_TESTCASE( "GACCOUNT_AINSERT_INVALID_VLYEND"           , "Creation of GACCOUNT record ZUT200 with invalid VLYEND"     , 5 ) From AXUNIT
