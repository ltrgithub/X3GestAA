...
$WRITE_ERRORS
  Local Integer I
  For I=1 To maxtab(QLFTCO.AERROR)
    If  QLFTCO.AERROR(I)<>null & QLFTCO.AERROR(I).DEL<>2
      Call CHECK_EQUAL(QLFTCO.AERROR(I).PRO-":"-QLFTCO.AERROR(I).MES,QLFTCO.AERROR(I).PRO-":"-QLFTCO.AERROR(I).MES) From AXUNIT
    Endif
  Next I
Return
