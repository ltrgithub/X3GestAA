...
INS.R01P01 = IKEY
INS.INTDES = "INT_DES1_"+num$(ID)
INS.INTSHO =  "INT_SHO1_"+num$(ID)
...
Call CHECK_EQUAL(INS.INTDES , "INT_DES1_"+num$(ID)) From AXUNIT
Call CHECK_EQUAL(INS.INTSHO , "INT_SHO1_"+num$(ID)) From AXUNIT
...
[L]MY_STATUS = fmet INS.AREAD(IKEY)
Call CHECK_EQUAL([L]MY_STATUS,[V]CST_AOK) From AXUNIT
INS.INTDES = "INT_DES2_"+num$(ID)
INS.INTSHO =  "INT_SHO2_"+num$(ID)
...
Call CHECK_EQUAL([L]MY_STATUS,[V]CST_AOK) From AXUNIT
Call CHECK_EQUAL(INS.R01P01 , IKEY) From AXUNIT
Call CHECK_EQUAL(INS.INTDES , "INT_DES2_"+num$(ID)) From AXUNIT
Call CHECK_EQUAL(INS.INTSHO , "INT_SHO2_"+num$(ID)) From AXUNIT
Gosub WRITE_ERRORS
