...
asyncTest("test query syracuse administration 1", function(_) {
	...
	strictEqual(ctx.searchRequest.query.filtered.query.query_string.query, "testing", "check query string ok : " + ctx.searchRequest.query.filtered.query.query_string.query);
	...
	strictEqual(ctx.searchRequest.query.filtered.query.query_string.query, "admin", "check query string ok : " + ctx.searchRequest.query.filtered.query.query_string.query);
	//check highlight
	...
	strictEqual(ctx.searchRequest.query.filtered.query.query_string.query, "guest", "check query string ok : " + ctx.searchRequest.query.filtered.query.query_string.query);
	...
	strictEqual(ctx.searchRequest.query.filtered.query.query_string.query, "sales manager", "check query string ok : " + ctx.searchRequest.query.filtered.query.query_string.query);
	hl = _extractHighlight(result.result.$resources);
	strictEqual(hl.length !== 0, true, "check highlight " + hl.length);
	...
	try {
		strictEqual(ctx.searchRequest.query.filtered.query.query_string.query, "*setting", "check query string ok : " + ctx.searchRequest.query.filtered.query.query_string.query);
	...
	elasticQuery.search(_, ctx, searchConfig);
	strictEqual(ctx.searchRequest.query.filtered.query.query_string.query, "10.01", "check query string ok : " + ctx.searchRequest.query.filtered.query.query_string.query);

	// search on numeric that is store as integer in elatic
	ctx = _makeContextQuerySearch("17000", result);
	elasticQuery.search(_, ctx, searchConfig);
	strictEqual(ctx.searchRequest.query.filtered.query.query_string.query, "17000", "check query string ok : " + ctx.searchRequest.query.filtered.query.query_string.query);
	strictEqual(result.result.$resources.length != 0, true, "search body response ok : " + result.result.$resources.length);
...
asyncTest("test date query syracuse administration", function(_) {
	...
	elasticQuery.search(_, ctx, searchConfig);
	debugTrace("Query: " + sys.inspect(ctx.searchRequest.query.filtered.query.query_string));
	strictEqual(ctx.searchRequest.query.filtered.query.query_string.query, "2014-12-04", "check query string ok : " + ctx.searchRequest.query.filtered.query.query_string.query);

	// Date that would fail in US format
	ctx = _makeContextQuerySearch("25/12/2014", opts);
	elasticQuery.search(_, ctx, searchConfig);
	strictEqual(ctx.searchRequest.query.filtered.query.query_string.query, "2014-12-25", "check query string ok : " + ctx.searchRequest.query.filtered.query.query_string.query);
...
asyncTest("test query with boolean OR and AND and NOT on syracuse administration", function(_) {
	...
	elasticQuery.search(_, ctx, searchConfig);
	debugTrace("Query: " + sys.inspect(ctx.searchRequest.query.filtered.query.query_string));
	strictEqual(ctx.searchRequest.query.filtered.query.query_string.query, "super && admin", "check query string ok : " + ctx.searchRequest.query.filtered.query.query_string.query);
	...
	elasticQuery.search(_, ctx, searchConfig);
	debugTrace("Query: " + sys.inspect(ctx.searchRequest.query.filtered.query.query_string));
	strictEqual(ctx.searchRequest.query.filtered.query.query_string.query, "super AND admin", "check query string ok : " + ctx.searchRequest.query.filtered.query.query_string.query);
	strictEqual(JSON.stringify(ctx.searchRequest.highlight), '{"fields":{"*":{"highlight_query":{"bool":{"must":[{"match":{"content":{"query":"super","type":"phrase_prefix"}}},{"match":{"content":{"query":"admin","type":"phrase_prefix"}}}]}}}}}', " highligh query ok");
	...
	elasticQuery.search(_, ctx, searchConfig);
	strictEqual(ctx.searchRequest.query.filtered.query.query_string.query, "super OR admin", "check query string ok : " + ctx.searchRequest.query.filtered.query.query_string.query);
	strictEqual(JSON.stringify(ctx.searchRequest.highlight), '{"fields":{"*":{"highlight_query":{"bool":{"must":[{"match":{"content":{"query":"super","type":"phrase_prefix"}}},{"match":{"content":{"query":"admin","type":"phrase_prefix"}}}]}}}}}', " highligh query ok");
	...
	elasticQuery.search(_, ctx, searchConfig);
	strictEqual(ctx.searchRequest.query.filtered.query.query_string.query, "(super AND admin) OR super AND admin", "check query string ok : " + ctx.searchRequest.query.filtered.query.query_string.query);
	strictEqual(JSON.stringify(ctx.searchRequest.highlight), '{"fields":{"*":{"highlight_query":{"bool":{"must":[{"match":{"content":{"query":"super","type":"phrase_prefix"}}},{"match":{"content":{"query":"admin","type":"phrase_prefix"}}}]}}}}}', " highligh query ok");
...
asyncTest("test query syracuse administration 2", 21, function(_) {
	...
	strictEqual(opts.result.$resources.length != 0, true, "search body response ok : " + opts.result.$resources.length);
	var res = '{"filtered":{"query":{"bool":{"should":[{"custom_boost_factor":{"query":{"query_string":{"query":"admi","boost":100,"analyze_wildcard":true,"allow_leading_wildcard":false}},"boost_factor":2.5}},{"constant_score":{"query":{"fuzzy_like_this":{"like_text":"admi","max_query_terms":20,"min_similarity":0.5,"ignore_tf":true,"boost":1}},"boost":1}}]}}}}';
	...
	res = '{"filtered":{"query":{"bool":{"should":[{"custom_boost_factor":{"query":{"query_string":{"query":"admni","boost":100,"analyze_wildcard":true,"allow_leading_wildcard":false}},"boost_factor":2.5}},{"constant_score":{"query":{"fuzzy_like_this":{"like_text":"admni","max_query_terms":20,"min_similarity":0.5,"ignore_tf":true,"boost":1}},"boost":1}}]}}}}';
	strictEqual(res, JSON.stringify(ctx.searchRequest.query), "request ok ");
	strictEqual(opts.result.$resources.length != 0, true, "search body response ok : " + opts.result.$resources.length);
