...
asyncTest("test right filter  ", function(_) {
	...
	strictEqual(JSON.stringify(search.query.filtered.filter), '{"and":[{"and":[{"or":[{"and":[{},{"query":{"field":{"administrator.$key":"test1"}}}]},{"and":[{},{"terms":{"authors.$key":["test1"]}}]},{"and":[{},{"terms":{"members":["test1"]}}]}]},{"query":{"field":{"_type":"typeTest"}}}]}]}', "syracuse right filter ok : " + JSON.stringify(search.query.filtered.filter));
