...
asyncTest("test format resource type date", function(_) {
	var propItem = {
		...
		getUserProfile: function(_) {
			return {
				selectedLocale: function(_) {
					return {
						numberDecimalSeparator: function(_) {
							return sepDecimal;
						},
						numberGroupSeparator: function(_) {
							return groupSep;
						},
...
asyncTest("test format resource type decimal", function(_) {
	var propItem = {
	...
	strictEqual(resVal, "test", " pass a non numeric value");

	var resVal = elasticQuery.formatValue(_, "<em>test</em>", propItem, context); // non numeric with highlight but type decimal
	strictEqual(resVal, "<em>test</em>", " pass a non numeric value with highlight");
	...
	var resVal = elasticQuery.formatValue(_, "<em>test</em>", propItem, context); // non numeric with highlight but type decimal
	strictEqual(resVal, "<em>test</em>", " pass a non numeric value");
