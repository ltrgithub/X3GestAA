...
var testData = require('../../../../test/sdata/fixtures/testDB');
...
describe(module.id, () => {
	...
	it('index french tests', function(_) {
		// test index exists
		var par = {
	...
	it('email field tests', function(_) {
		// test index exists
		var par = {
			url: elasticBaseUrl + "/" + indexName,
			method: 'HEAD'
	...
	it('init indexHelper ', function(_) {
	...
	it('test indexation syracuse administration', function(_) {
		try {
	...
	it('test query syracuse administration 1', function(_) {
	...
	it('test query syracuse administration with noHighlight parameter ', function(_) {
		recOptions.fileName = "test";
		var searchConfig = {
			editDistance: 2,
			prototype: false,
	...
	it('test date query syracuse administration', function(_) {
		recOptions.fileName = "test";
		var searchConfig = {
			editDistance: 2,
			prototype: false,
	...
	it('test query with boolean OR and AND and NOT on syracuse administration', function(_) {
		recOptions.fileName = "test";
		var searchConfig = {
			editDistance: 2,
			prototype: false,
	...
	it('test query syracuse administration 2', function(_) {
	...
	it('test creation elastic search filter', function(_) {
		var search = {
			query: {
				filtered: {}
			}
		...
		var res = '{"query":{"filtered":{"filter":{"and":[{"and":[{"or":[{"query":{"term":{"$uuid":"uuid-1"}}},{"query":{"term":{"test.ap":"test"}}}]},{"query":{"term":{"test.toto":"23"}}}]}]}}}}';
		...
		res = '{"query":{"filtered":{"filter":{"and":[{"and":[{"or":[{"query":{"term":{"$uuid":"uuid-1"}}},{"query":{"term":{"test.ap":"test"}}}]},{"query":{"term":{"test.toto":"23"}}}]},{"and":[{"or":[{"query":{"term":{"$uuid":"uuid-1"}}},{"query":{"term":{"test.ap":"test"}}}]},{"query":{"term":{"test.toto":"23"}}}]}]}}}}';
	...
	it('test delete index  syracuse administration', function(_) {
		try {
			elasticIndex.tracer = tracer;
			elasticIndex.serverConfig = configTest;
			var req = {
