			...
			if (!err) {
                ...
                it('index name should use cloud prefix when asked in config' + item, function (_) {
                    ...
                    try {
                        ...
                        let computedIndexName = adminHelper.getCollaborationEndpoint(_).getIndexName(_, null, "indextestname");
                ...
                it('index name should not use cloud prefix when not required in config' + item, function (_) {
                    ...
                    try {
                        ...
                        let computedIndexName = adminHelper.getCollaborationEndpoint(_).getIndexName(_, null, expectedSingleTenantOnPremiseIndexName);
