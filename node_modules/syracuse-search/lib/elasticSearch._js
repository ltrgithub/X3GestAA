...
exports.dispatch = function(_, request, response) {
	...
	//	tracer && tracer("elasticSearch url segments: "+segments.join(","));
	...
	if (operation && _operationMap[operation]) _operationMap[operation](_, context, contract, application, dataset, entity);
	else if (context.method && _methodMap[context.method]) _methodMap[context.method](_, context, contract, application, dataset, entity);
