...
exports.entity = {
	...
	$init: function(_, instance) {
		...
		elasticHelpers.checkStartSearchEngine(_, searchEngine.getBaseUrl(), instance.$diagnoses, true, true);
		...
		if (instance.$diagnoses.length === 0) {
			...
			try {
				...
				var version = elasticVersion.getElasticVersion(_, searchEngine.getBaseUrl());
