...
function compatibleVersion(instVer, compVer, higher) {
	...
	if (higher) {
		compatibleVersion = !(instVer[0] < compVer[0] || instVer[1] < compVer[1] || instVer[2] < compVer[2]);
	} else {
		compatibleVersion = !(instVer[0] > compVer[0] || instVer[1] > compVer[1] || instVer[2] > compVer[2]);
	}
...
exports.checkVersion = function(_, searchBaseUrl) {
	var instVersion = exports.getElasticVersion(_, searchBaseUrl);
