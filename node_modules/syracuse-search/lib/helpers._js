...
exports.getIndexNameWithMultitenantOrCloudV2Prefix = function(originalIndexName) {
	if (globals.context.tenantId) {
		return globals.context.tenantId + INDEX_NAME_SEPARATOR + originalIndexName;
	}
	if (config.searchEngine && config.searchEngine.indexCloudPrefix) {
		return config.searchEngine.indexCloudPrefix + INDEX_NAME_SEPARATOR + originalIndexName;
	}
