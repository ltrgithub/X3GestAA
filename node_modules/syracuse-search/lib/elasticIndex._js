...
function _createInstanceIndexResource(_, instance, endpoint, options, prototype) {
	...
	function _computeUrl(_, inst) {
		...
		exports.tracer.trace && exports.tracer.trace.fine && exports.tracer.trace("compute url: " + sys.inspect(entity.$urlTemplate));
...
exports.IndexHelper = helpers.defineClass(ElasticIndex, null, {
	...
	updateEntity: function(_, entity, differential, options) {
		...
		exports.tracer.trace && exports.tracer.trace.fine && exports.tracer.trace("entity " + entity.name);
...
function _indexMappingUpdate(_, indexName, entity, searchFacets, opt) {
	...
	exports.tracer.trace && exports.tracer.trace.fine && exports.tracer.trace("elasticIndex.index write mapping; entity: " + entityName + "; " + sys.inspect(mapping, null, 4));
	req.write(_, JSON.stringify(mapping));
	var resp = req.end().response(_);
	exports.tracer.trace && exports.tracer.trace.fine && exports.tracer.trace("elasticIndex.index mapping update status: " + resp.statusCode + "; entity: " + entityName + "; diagnoses: " + sys.inspect(diagnoses));
	//
