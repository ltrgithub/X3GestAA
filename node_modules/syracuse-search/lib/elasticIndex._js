...
exports.deleteEndpointIndex = function(_, endpoint, localeCode, diagnoses) {
	...
	if (globals.context.tenantId) indexName = globals.context.tenantId + '.' + indexName;
...
exports.deleteAllIndex = function(_, context, diagnoses) {
	...
	var patternIndex = "*";
	if (globals.context.tenantId) patternIndex = globals.context.tenantId + '.' + patternIndex;
