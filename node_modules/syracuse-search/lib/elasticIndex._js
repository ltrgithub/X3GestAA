...
function _createInstanceIndexResource(_, instance, endpoint, options, prototype) {
	...
	// manage right
	try {
		elasticVersion.checkVersion(_, exports.serverConfig.baseUrl);
		elasticVersionFilter = elasticVersionFilter || elasticVersion.getElasticVersion(_, exports.serverConfig.baseUrl);
	} catch (e) {
...
exports.IndexHelper = helpers.defineClass(ElasticIndex, null, {
	getIndexName: function(_, opt) {
		...
		return elasticHelpers.getIndexNameWithMultitenantOrCloudV2Prefix(name);
	},
...
exports.deleteEndpointIndex = function(_, endpoint, localeCode, diagnoses) {
	var elasticBaseUrl = exports.serverConfig.baseUrl;
	var indexName = elasticHelpers.getIndexNameWithMultitenantOrCloudV2Prefix(endpoint.getIndexName(_, localeCode));
...
exports.deleteAllIndex = function(_, context, diagnoses) {
	...
	var patternIndex = elasticHelpers.getIndexNameWithMultitenantOrCloudV2Prefix("*");
