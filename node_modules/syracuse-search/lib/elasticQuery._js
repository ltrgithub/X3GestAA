...
exports.search = function(_, context) {
	...
	if (!(config.searchEngine && config.searchEngine.prototype)) {
		...
		var minSimilarity = (config.searchEngine && config.searchEngine.minSimilarity) ? config.searchEngine.minSimilarity : 0.5;
				...
				bool: {
					should: [{
						query_string: {
							...
							boost: 5.0, // Boost results to the top
							//default_operator: "AND",
							analyze_wildcard: true,
							allow_leading_wildcard: false
						}
