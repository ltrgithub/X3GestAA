...
function _getQueryObject(query) {
	var q = query.filtered = query.filtered || {};
	return q;
}
...
exports.search = function(_, context, configOverride) {
	...
	switch (searchType) {
		case "fuzzy":
			...
			q.query = defineExactPlusFuzzyQuery(searchConfig, qProcessed.fulltext);
			break;
		case "exact":
			q.query = defineExactQuery(searchConfig, qProcessed.fulltext);
		...
		default:
			...
			q.query = defineStartWithQuery(searchConfig, qProcessed.fulltext);
			break;
	}
