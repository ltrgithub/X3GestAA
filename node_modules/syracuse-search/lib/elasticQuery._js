...
exports.search = function(_, context) {
	...
	var editDistance = config.searchEngine && config.searchEngine.editDistance ? config.searchEngine.editDistance : 1;
	...
	search.query.filtered.query.query_string = {
		default_field: "_all",
		query: isAroundQuote ? qstr + "~" + (_isSupportEditDistance() && editDistance ? editDistance : "") : qstr, // fuzzy all string if around quote
