...
function defineStartWithQuery(query, searchConfig, q) {
...
function defineExactPlusFuzzyQuery(query, searchConfig, q) {
	...
	} else if (elasticVersionFilter[0] < 1) {
		query.bool.should.push({
...
exports.search = function(_, context, configOverride) {
	...
	switch (searchType) {
		...
		default:
			...
			defineStartWithQuery(q, searchConfig, qProcessed.fulltext);
			break;
	}
