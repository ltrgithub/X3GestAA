...
var tracer = require('syracuse-core').getTracer("search");
...
function defineExactPlusFuzzyQuery(searchConfig, q) {
	...
	if (elasticVersionFilter && (elasticVersionFilter[0] === 1 && elasticVersionFilter[1] >= 5 || elasticVersionFilter[0] > 1)) { // if > 1.5 use function_score key else custome_boost_factor
