...
function Connector() {
	...
	this.registerAgent = function(agentNum) {
		tracer.debug && tracer.debug('registerAgent: ' + agentNum);
		if (agentNum)
			_write(ctiServerMethods.GetMessageCommand(ctiServerMethods.RegisterAgent, [agentNum]));
		else
			_write(ctiServerMethods.GetMessageCommand(ctiServerMethods._RegisterAll, null));
	};

	this.unregisterAgent = function(agentNum) {
		tracer.debug && tracer.debug('unregisterAgent: ' + agentNum);
		if (agentNum)
			_write(ctiServerMethods.GetMessageCommand(ctiServerMethods.UnregisterAgent, [agentNum]));
		else
			_write(ctiServerMethods.GetMessageCommand(ctiServerMethods._UnregisterAll, null));
	};
