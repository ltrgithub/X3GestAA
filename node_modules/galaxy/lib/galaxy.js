...
(function(exports) {
	...
	exports.invoke = function *(that, fn, args, idx) {
		if (typeof fn !== 'function') {
			if (typeof that === 'function' && that['__starred__' + idx] && fn === 'call') {
				return yield that['__starred__' + idx].apply(args[0], args.slice(1));
			}
			fn = that[fn];
		}
	...
	function stackTrace(err) {
		...
		while (extra = err.__async__) {
			if (stackHelper) {
				...
				starredStack = frames.map(function(frame) {
