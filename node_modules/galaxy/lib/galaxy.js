...
(function(exports) {
	...
	if (typeof process !== "undefined") {
		try {
			stackHelper = require('galaxy' + /* defeat streamline-require */ '-stack');
		} catch (ex) {
			stackHelperError = ex.message;
		}
	} else {
		stackHelperError = "long stack traces disabled (cannot load galaxy-stack helper)";
	}
	...
	function isGenerator(val) {
		return val && (
			Object.prototype.toString.call(val) === "[object Generator]" || // v8 native generators
			val.toString() === "[object Generator]"); // regenerator
	}
