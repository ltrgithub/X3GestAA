	...
	switch (last) {
		case "init":
			if (!exports.isAuthenticated()) {
				...
				//console.log(exports.getUserByUrl(_, "http://fr.linkedin.com/in/dbopp").body);
		...
		case "code":
			...
			httpRequest(util.format("https://www.linkedin.com/uas/oauth2/accessToken?grant_type=authorization_code" +
					"&code=%s" +
					"&redirect_uri=%s" +
					"&client_id=%s" +
					"&client_secret=%s",
