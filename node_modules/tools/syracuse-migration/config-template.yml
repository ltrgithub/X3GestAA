...
mongodb:
  # This `path` property is mandatory and indicates where mongodb software is installed
  ...
  destination:
    ...
    port: 27017
    db: syracuse
    drop: true # default to true. The destination database collections will be dropped before insert the new ones
...
# host section defines new host instance configuration changes. It will be also used to rename certificates.
#   'oldHostname', 'hostname' and 'tcpHostName' are mandatory !
...
host:
  oldHostname: my-source-server # The source server hostname will be used to find and replace host information
