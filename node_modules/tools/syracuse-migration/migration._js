...
function mongodump() {
	utils.log("*************** Mongo dump operation begin***************", "cyan");
...
function mongorestore() {
	utils.log("*************** Mongo restore operation begin***************", "cyan");
...
function updateX3Solutions(_) {
	utils.log("*************** X3 solution transformations begin ***************", "cyan");
...
function updateEndpoints(_) {
	utils.log("*************** Endpoints transformations begin ***************", "cyan");
...
function updateHost(_) {
	utils.log("*************** Hosts instances transformation begin ***************", "cyan");
...
function removeHostCertificate(_, hostnameToModify) {
	utils.log("*************** Delete certificates begin ***************", "cyan");
	var nb = client.remove(_, "Certificate", {"name":hostnameToModify});
	utils.log("INFO: Old certificate for host '" + hostnameToModify + "' deleted: " + nb, "green");
	utils.log("WARN: New certificates will be imported when starting your Syracuse server.", "orange");
	utils.log("WARN: ATTENTION: Your new certificates needs to be generated on destination server, and passphrase has to be inserted.", "orange");
