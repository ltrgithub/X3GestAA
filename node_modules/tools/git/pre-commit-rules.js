...
function acceptFile(f) {
	...
	if (ext !== '.json' && ext !== '.js' && ext !== '._js' && !isTextFileExtension(ext)) return false;
	if (f.indexOf('/cvgRecords/') >= 0) return false;
	if (f.indexOf('node_modules/tools/') >= 0) return false;
	if (f.indexOf('node_modules/bundles/') < 0 && f.indexOf('syracuse-') < 0 && f.indexOf('etna-') < 0 && f.indexOf('node_modules/jsx509/') < 0 && f.indexOf("node_modules/license-tool") < 0) return false;
