	...
	if (stringsResourceContents && dirname.indexOf("/entities") >= 0) {
		...
		if (!r) {
			...
			while ((res = re.exec(content0))) {
				content1 += "var " + res[1] + " = {fromJsDate: function(){}, authEnum: function(){}};\n";
			}
			re = /(?:^|\r|\n)\s*function\s+(\w+)/g;
			var res;
			while ((res = re.exec(content0))) {
				content1 += "function " + res[1] + "(){ return {fromJsDate: function(){}, authEnum: function(){}} };\n";
			}
			content1 += "function require(){ return {fromJsDate: function(){}, authEnum: function(){}} };\n";
			...
			try {
				...
				console.error("Cannot handle "+filepath+" Content: "+content1+" Error "+e)
			}
		}
