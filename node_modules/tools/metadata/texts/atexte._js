...
exports.text = {
	title: "text",
	tableName: "ATEXTE",
	distinctKey: "TYPOBJ,NOMOBJ",
	orderBy: "LAN",
	lan: "LAN",

	objectTypes: ["", "DICTIONARY", "SCREENS", "OBJECTS", "DOCUMENTS", "DATATYPES", "ACTIONS", //
  ...
  "TRANSACTIONTYPES", "STYLES", "REPORTS", "REPORTS"],
	entities: [null, "tables", "screens", "objects", null, "datatypes", "actions", //
