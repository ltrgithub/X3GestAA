...
exports.sendMessage = function(_, type, title, message, to, severity, link, from) {
	from = from || "Business Event";
	var msg = eventManager.createMessage(_, type, title, message, from, to, severity, link);
