...
exports.SocketHandler = helpers.defineClass(function(socketio) {
	this.listSocketEvent = {};
	this.socketio = socketio;
	// default event manage for unit test
	if (config.system && config.system.enableDevelopmentFeatures) {
		...
		this.register("unit_test", "/unit_test", function(io, hd) {
			...
			registerEvent: function(io, hd) {

				self.register("unit_test2", "/unit_test2", function(io2, hd) {
	...
	///
	///
	register: function(id, namespace, onConnectionHandler, onDisconnectionHandler, onEventHandler) {
...
var _socketHandler = new exports.SocketHandler();

exports.getSocketHandler = _socketHandler;