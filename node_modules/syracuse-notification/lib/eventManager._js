...
var EventMessage = helpers.defineClass(function(_, type, title, message, from, to, severity) {
...
exports.createMessage = function(_, type, title, message, from, to, severity) {
	tracer.info && tracer.info("Create message");
	var evt = new EventMessage(_, type, title, message, from, to, severity).serialize();
