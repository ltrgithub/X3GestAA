...
exports.httpListener = function(listener, options) {
	...
	return function(request, response) {
		return listener(new HttpServerRequest(request, options), //
			new HttpServerResponse(response, options), _ >> function(err) {
			if (err) {
...
function HttpServer(requestListener, options) {
	...
	var emitter = options.createServer(globals.withContext(exports.httpListener(requestListener, options), globals.context));
