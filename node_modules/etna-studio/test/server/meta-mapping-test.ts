...
describe(module.id, () => {
	...
	helper.x3jsTest(() => {
		...
		function getStudioTestDb(_) {
			...
			const registry = require("@sage/syracuse-lib/src/sdata/sdataRegistry");
			const dataset = {
			...
			const contract = require('../../lib/contract-extension');
			const model = require('@sage/syracuse-lib/src/orm/dataModel').make(contract, dataset.database);
			const db = require('@sage/syracuse-lib/src/orm/dataModel').getOrm(_, model, dataset);
			return db;
		}
