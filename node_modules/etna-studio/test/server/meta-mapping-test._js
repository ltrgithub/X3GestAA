...
helper.x3jsTest(() => {
	...
	function ignore(path) {
		...
		// NUMFLD is user ordering for properties - we ignore it and regenerated it as 10 * NUMLIG when mapping back to meta.
		return /[\.\]](_id|_proxyName|_etag|CREDATTIM|CREUSR|UPDDATTIM|UPDUSR|FLDGRP|AWMAJTYP)$/.test(path);
	}
	...
	asyncTest("meta canonical roundtrip", 1372, function(_) {
