...
helper.x3jsTest(() => {
	...
	function ignore(path) {
		...
		return /[\.\]](_id|_proxyName|_etag|CREDATTIM|CREUSR|UPDDATTIM|UPDUSR|FLDGRP|NUMFLD|AWMAJTYP|TYPPAR)$/.test(path);
	}
	...
	asyncTest("meta canonical roundtrip", 1299, function(_) {
