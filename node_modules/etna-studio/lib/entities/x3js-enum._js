...
function updateAll(_, instance, saving) {
	entityHelper.updateAll(_, enumDescriptor, instance, saving);
}
...
function updateAll(_, instance, saving) {
	...
	const instanceData = entityHelper.deserializedToData(enumDescriptor, instance.serializeInstance(_));
	parsed.data = entityHelper.mergeData(parsed.data, enumDescriptor, instanceData);
