	...
	$services: {
		...
		reloadSource: {
			...
			$execute(_, context, instance) {
				entityHelper.reloadSource(_, classDescriptor, instance);
			},
		},
		saveSource: {
			$method: "POST",
			...
			$title: "Save source",
			$permanent: true,
			$confirm: "Your source file will be overwritten. Do you want to continue?",
			$execute(_, context, instance) {
				entityHelper.saveSource(_, classDescriptor, instance);
			},
		},
	},
	$defaultOrder: [
