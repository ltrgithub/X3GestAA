...
function updateAll(_, instance, saving) {
	...
	const instanceData = entityHelper.deserializedToData(classDescriptor, instance.serializeInstance(_));
	parsed.data = entityHelper.mergeData(parsed.data, classDescriptor, instanceData);
