...
exports.entity = {
	...
	$canEdit: false,
	$capabilities: "",
	$titleTemplate: "Unit test results {stamp}",
		...
		summary: {
			...
			$compute: function(_, instance) {
				...
				if (counters.suiteErrors === 0) {
					return `${counters.caseCount} test cases passed in ${counters.suiteCount} test suites`;
				} else {
					return `${counters.caseErrors}/${counters.caseCount} test cases failed in ${counters.suiteErrors}/${counters.suiteCount} test suites`;
				}
			}
		},
	},
