...
var baseUrl = baseHost + '/api/sky/automation/' + testConfig.dataset + '/';
...
asyncTest('create customer', 21, function(_) {
...
asyncTest('create site', 8, function(_) {
...
asyncTest('create site', 9, function(_) {
...
asyncTest('get default site', 3, function(_) {
...
asyncTest('update site subscription', 129, function(_) {
...
if (cleanup) {
	...
	asyncTest('delete subscription', 2, function(_) {
	...
	asyncTest('delete customer', 2, function(_) {
