...
if (!config.skyAutomation) {
	test('TESTS SKIPPED: module is not enabled in nodelocal.js', function() {
		ok(true, "dummy test");
	});
} else {
...
asyncTest('create site', 23, function(_) {
...
asyncTest('update site subscription', 134, function(_) {
...
if (cleanup) {
	...
	asyncTest('delete site', 4, function(_) {
