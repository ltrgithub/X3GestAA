...
module.exports = function(_, context, instance) {
	...
	//var subscriptions = instance.subscriptions(_);
	//var license = Array.isArray(subscriptions) && subscriptions.length ? subscriptions[0] : null;
	//result = license ? helpers.post(_, collabUrl + 'license', license) : {};
