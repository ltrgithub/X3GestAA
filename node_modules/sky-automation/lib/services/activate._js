...
module.exports = function(_, context, instance) {
    ...
    var loopCounter = 0;
    var application;
    while ((application == null)|| (typeof application === 'undefined')){
    ...
    while (groupIds.length <1){
        ...
        if ((sadmingroup == null) || typeof sadmingroup === 'undefined')){
            var sagroup = {
        ...
        if ((cadmingroup == null) || (typeof cadmingroup === 'undefined')){
    ...
    loopCounter = 0;
    var cadmin
    while ((cadmin == null) || (typeof cadmin === 'undefined')){
    ...
    loopCounter = 0;
    var sadmin;
    while ((sadmin == null ) || (typeof sadmin === 'undefined')){
        result = helpers.client(_, collabUrl + 'users');
        if (result.statusCode !== 200) return helpers.error('get users', result);
