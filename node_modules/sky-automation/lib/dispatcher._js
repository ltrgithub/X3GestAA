...
var map = require('syracuse-main/lib/syracuse').urlMap;
...
map['healthLogs'] = function(_, request, response) {
	...
	ez.reader.decorate(request).transform(ez.transforms.json.parser()).pipe(_, ez.devices.mongodb.writer(collection));
