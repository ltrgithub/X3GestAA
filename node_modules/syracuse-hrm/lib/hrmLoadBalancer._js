...
exports.selectServer = function(_, context, siteOptions, options) {
	...
	try {
		lbFunnel(_, function(_) {
			...
			if (!_site) throw new Error(locale.format(module, "hrmSiteNotFound", JSON.stringify(siteOptions, null, 2), context.request && context.request.url));
