...
var hrmHelper = require('../../lib/hrmHelper');
var wizardHelper = require('../../lib/wizardHelper');
var lb = require('../../lib/hrmLoadBalancer');

// Unit test traces
var trace = require('@sage/syracuse-core').getTracer("hrm.unittest");
...
describe(module.id, () => {
	...
	it('installation with wizard helper API', function(_) {
	...
	it('check installation data', function(_) {
		var siteName;
	...
	it('round robin load balancer tests', function(_) {
		var opt = {
