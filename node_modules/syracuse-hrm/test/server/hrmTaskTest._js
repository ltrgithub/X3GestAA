...
asyncTest("initialize x3 application mock server", 1, function(_) {
...
asyncTest("initialize data for hrm task test ", 1, function(_) {
	var diag = [];
...
asyncTest("initialization for hrm task test ", 7, function(_) {
...
asyncTest("Test x3 task behavior ", 7, function(_) {
