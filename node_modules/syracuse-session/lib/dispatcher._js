...
exports.dispatcher = function(config) {
	return function(_, request, response) {
		if (require('syracuse-main/lib/syracuse').server instanceof mock.MockStreamServer && !request.fromNanny && !request._request.fromNanny || !(syracuse.server instanceof mock.MockStreamServer) && (!config.system || !config.system.enableDevelopmentFeatures)) {
