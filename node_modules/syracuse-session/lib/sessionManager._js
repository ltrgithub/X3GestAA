...
exports.sessionManager = new function() {
	...
	this.setup = function(settings) {
		...
		socketIoHandler && socketIoHandler.register("/session", function(io, handshake) {
			...
			clearTimeout(_listTimeoutSocketIo[sessionId]);
			delete _listTimeoutSocketIo[sessionId];
			...
			_listTimeoutSocketIo[sessionId] = flows.setTimeout(function() {
				if (!io.isOpened()) // if still not opened in n second it's just a interruption due to refresh of little breakdown
