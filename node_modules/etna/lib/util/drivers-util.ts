...
import { Blbfole } from '../engine/runtime/tblbfile';

export function tdsColumnsToRow(columns) {
...
export function tdsAddParameters(req, args) {
	function processParam(name: string, type: string, value: any) {
