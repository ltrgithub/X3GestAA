...
const variables = require('./runtime/variables');
const db = require('./runtime/db');
const bcd = require("./runtime/bcd");
const X3Error = require("./runtime/errors").X3Error;
const config = require("etna/lib/util/nodeconfig").config.etna;

export function generate(node, fname) {
	const used = {};

	var scopeName = ""; // for errors

	const warn = function (node, message) {
