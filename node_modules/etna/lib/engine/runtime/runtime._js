...
'tbcd', 'uuid', 'tblbfile', 'tclbfile'].map(function (name) {
	return require('./' + name);
});
...
function _dumpInstructionCounters() {
	...
	const counters = Object.keys(instCounters).map(function (k) {
...
function dumpCallCounters() {
	const counters = Object.keys(callCounters).map(function (k) {
