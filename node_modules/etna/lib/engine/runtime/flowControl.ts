...
export function labelProg(ns, name) {
	return instructions.PROG({}, "stub", [], instructions.GOSUB(util.instructions.C(ns), name));
};
...
export const instructions = {
	...
	F(name: string, args: types.Expression<any>[]) {
		...
		const aargs = args ? util.instructions.A(args) : util.instructions.C();
	...
	MAIN(e, _) {
		...
		try {
			var r = instructions.GOSUB(util.instructions.C(e), 'MAIN')(_);
			console.log("OK: " + r);
		} catch (e) {
