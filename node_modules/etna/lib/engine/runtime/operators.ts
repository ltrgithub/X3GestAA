...
type unaryOp = (val: any) => any;
type binaryOp = (val1: any, val2: any) => any;
...
function op1(f: unaryOp) {
	return function (f1: types.Expression<any>) {
...
function op2(f: binaryOp) {
	return function (f1: types.Expression<any>, f2: types.Expression<any>) {
...
export const instructions = {
	AND(f1: types.Expression<any>, f2: types.Expression<any>) {
	...
	OR(f1: types.Expression<any>, f2: types.Expression<any>) {
	...
	PLUSEQ(lhs: types.Expression<any>, rhs: types.Expression<any>) {
		return variables.instructions.SET(lhs, exports.instructions.ADD(lhs, rhs));
	},
	MINUSEQ(lhs: types.Expression<any>, rhs: types.Expression<any>) {
		return variables.instructions.SET(lhs, exports.instructions.SUB(lhs, rhs));
	},
	MULEQ(lhs: types.Expression<any>, rhs: types.Expression<any>) {
		return variables.instructions.SET(lhs, exports.instructions.MUL(lhs, rhs));
	},
	DIVEQ(lhs: types.Expression<any>, rhs: types.Expression<any>) {
