...
var basedate = require('syracuse-core').types.date;
...
exports.x3Typename = function(x) {
	...
	if (x === undefined)
		return "undefined";
	if (exports.x3IsString(x))
		return "String";
	if (exports.x3IsInteger(x))
		return "Integer";
	if (exports.x3IsDouble(x))
		return "Double";
	if (exports.x3IsDate(x))
		return "Date";
	if (exports.x3IsDatetime(x))
		return "Datetime";
	if (exports.x3IsBlbfile(x))
		return "Blbfile";
	if (exports.x3IsClbfile(x))
		return "Clbfile";
	if (exports.x3IsUuid(x))
		return "Uuident";
	if (exports.x3IsBCD(x))
		return "BCD";
	if (Array.isArray(x))
		return "Array";
	return "Object";
...
exports.instructions = {
	...
	pragma: function(label) {
		...
		console.log("call of pragma function in runtime");
