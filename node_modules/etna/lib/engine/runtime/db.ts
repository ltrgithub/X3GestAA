...
function closeFiles(abbrevs: string[], local: number) {
	const frame: types.Frame = _.context.x3frame;
...
export const instructions = {
	...
	CLOSEFILE(scope, abbrevs) {
		return function closefile$do(_) {
			closeFiles(abbrevs, scope === 'LOCAL' ? _.context.x3frame.stackLevel : 0);
		};
	},
	LOGICCLOSE(scope, abbrevs) {
		return function logicclose$do(_) {
			closeFiles(abbrevs, _.context.x3frame.stackLevel);
		};
	},
