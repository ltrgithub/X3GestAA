...
export const instructions: { [name: string]: (...args: any[]) => (_: _, ...args: any[]) => any; } = {
	...
	SQLDECL(type: string, name: string, ranges: void) {
		return function sqldecl$do(_: _,  abv: string): types.SqlColumnDesc {
			const frame = util.currentFrame();
	...
	FORF(key: types.Expression<any>, hint: types.Expression<types.Hint>, lock: boolean, where: ContextFn<WKey[]>, 
