...
var base = require('syracuse-core').types.date;

var NULLORIGIN = base.make(1599, 12, 31);
var MIN = base.make(1600, 1, 1);
var MAX = base.make(9999, 12, 31);
var NULL = base.make(0, 0, 0);
