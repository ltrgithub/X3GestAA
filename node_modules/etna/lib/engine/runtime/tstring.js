...
Object.defineProperty(String.prototype, "x3jsAdd", {
	value: function(b) {
		// use toString() rather than valueOf()
		return this + ((b && b.toString) ? b.toString() : b);
	},
	enumerable: false
});
...
Object.defineProperty(String.prototype, "x3jsSub", {
	value: function(b) {
		throw util.badOperand(b);
	},
	enumerable: false
