...
import * as register from '../../engine/register';
import { Parser } from '../../engine/parser';
import * as jsgen from '../../engine/jsgen';
import { version } from '../../engine/version';
import * as scriptDebugger from '../../engine/debugger/server';
...
function collect(key: string) {
	const api = exports['_' + key] = util.any({});
...
export function executeProg(_: _,  mod: any, prog: string, args: types.ProgArg[], _frame?: types.Frame) {
