...
var jsInvoke : (_: _, mod: any, name: string, args: types.ProgArgs) => any;
...
function initCallMonitoring() {
	require('./flowControl').monitorCall = function (frame: types.Frame, action: string) {
...
export function executeProg(_: _,  mod: any, prog: string, args: types.ProgArgs, _frame?: types.Frame) {
...
export var instructions: { [name: string]: types.Instruction<any> };
export var functions: { [name: string]: types.Function };
