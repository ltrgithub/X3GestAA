...
import { Frame, X3Context, X3Session } from './types';
...
export const x3IsDate = core.types.date.isDate;

export const x3IsUuid = Buffer.isBuffer;

export const x3IsDatetime = core.types.datetime.isDatetime;
...
export function currentContext(): X3Context {
	return _.context as any;
}
