...
export function x3ToString(v: any, strict?: boolean): string {
...
export function currentSession(): X3Session {
	return (_.context as any).x3session;
}
export function currentFrame(): Frame {
	return (_.context as any).x3frame;
}
export function currentDebug(): boolean {
	return (_.context as any).debug;
}
export function setCurrentFrame(frame: Frame) {
	(_.context as any).x3frame = frame;
}