...
const dbevaluate = require('./dbevaluate');
const DBTable = require('./dbtable').DBTable;
const DBTableSQL = require('./dbtablesql').DBTableSQL;
const DBTableVAR = require('./dbtablevar').DBTableVAR;
...
function sqlFn(name, type) {
	return function () {
		const thesql = name + "(" + Array.prototype.map.call(arguments, arg => arg.sql).join(',') + ")";
