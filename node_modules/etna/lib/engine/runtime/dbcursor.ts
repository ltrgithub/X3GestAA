...
import { Record } from '../drivers/types';
...
function _dispatch(tables: { [name: string]: DBTableParent }, row: Record, columns?: TableColumns) {
...
export class DBCursor {
	...
	constructor(reader: ez.Reader<Record>, tables: { [name: string]: DBTableParent }, 
	maptrim:  (_: _,  obj: Record) => any, pwhere: types.Expression< boolean[]>[], key: KeyExpression, lvl: number, typ: string, columns?: TableColumns) {
		this.reader = reader;
		this.tables = tables;
