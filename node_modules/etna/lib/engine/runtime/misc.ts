...
export const instructions = {
	CALLJS(mode: string, ns: Expression<any>, name: string, args: Expression<any[]>) {
	...
	BOX(kind: string, args: Expression<any>[]) {
