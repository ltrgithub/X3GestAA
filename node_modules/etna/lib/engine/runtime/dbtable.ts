...
function _buildQuery(_: _, clause: string, dbtable: DBTable, key: TableKey2, wkey: WKey[], 
...
function _writeLobs(_: _,  row, lobVars, outputVars) {
...
export class DBTable extends DBTableParent {
	...
	keys: TableKey[];
	joins: TableJoin[];
	columns: { [colName: string]: Column[] };
	values: { [colName: string]: any };
	types: { [colName: string]: string }
	qrewrite: string;
	constructor(driver: types.Driver, abbrev: string, superv: Supervisor, desc: Table, keys: TableKey[], loc: string) {
	...
	// operation on table --------------------------------------
	// ---------------------------------------------------------
	x3Read(_: _, key: TableKey2, lvl: number, wkey: WKey[], krevert: boolean, lock: boolean, hint: Hint) {
		var rkey: TableKey2;
