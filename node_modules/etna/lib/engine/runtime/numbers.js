...
exports.functions = {
	...
	AR2: {
		...
		fn: function(x) {
			...
			var b = x.x3Abs().x3Mul(bcd.fromInt32(100)).x3Add(bcd.fromDouble(0.5));
	...
	ARR: {
		...
		fn: function(x, y) {
			...
			var val = x.x3Div(y);
			var sign = (val.x3ToDouble().valueOf() < 0) ? -1 : 1;
	...
	INT: {
		...
		fn: function(x) {
			...
			var v = new tdouble.Double(Math.floor(x.x3ToDouble().valueOf()));
			var vi = v.valueOf();
	...
	ANP: {
		...
		fn: function(n, p) {
			...
			var bcdResult = bcd.fromInt32(result);
