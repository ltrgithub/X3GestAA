...
import { Double } from './tdouble';
import * as bcd from './tbcd';
import { Blbfile } from './tblbfile';

export const MAX_INT = Math.pow(2, 31);
export const MIN_SHORTINT = -Math.pow(2, 15);
export const MAX_SHORTINT = Math.pow(2, 15) - 1;
export const MIN_TINYINT = 0;
export const MAX_TINYINT = 255;
	...
	value(size: number) {
		...
		switch (size) {
			...
			case 1:
				...
				break;
			default:
				throw new X3Error(26, "Illegal Number size");
		}
		return b;
	},
	enumerable: false
