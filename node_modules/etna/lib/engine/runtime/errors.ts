...
const errmes$ = exports.errmes$ = function (errn) {
	try {
...
export function moduleName(loc) {
...
export class X3ErrorFrame {
	...
	line: string;
	name: string;
	constructor(file: string, line: string, name: string) {
		this.file = file;
		this.line = line;
		this.name = name;
	}
...
export class X3Error {
	...
	jsStack: string;
	frames: X3ErrorFrame[];
	constructor(errn: number, message: string, jsStack?: string) {
