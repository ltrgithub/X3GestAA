...
function eq(a: any, b: any) {
	...
	if (a.x3Compare) return a.x3Compare(b, true) === 0;
	if (b.x3Compare) return b.x3Compare(a, true) === 0;
	return a === b;
}

function compare(a: any, b: any) {
	if (a == null || b == null) throw new Error("cannot compare " + a + " and " + b);
	if (a.x3Compare) return a.x3Compare(b, true);
	if (b.x3Compare) return -b.x3Compare(a, true);
