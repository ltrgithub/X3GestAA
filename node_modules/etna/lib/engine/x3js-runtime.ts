...
const time = require('syracuse-core').types.time;
...
function classify(x) {
	...
	else if (datetime.isDatetime(x)) return "datetime";else if (Array.isArray(x)) return "array";else return "object";
}

function badOperand(x, expected) {
