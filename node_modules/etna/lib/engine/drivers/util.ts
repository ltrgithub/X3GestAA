...
export function fromSql(_: _,  val, type, driver) {
...
export function toSql(params, driver) {
...
export function maptrim(driver, typesmap, dispatch) {
...
export function mapFromSql(driver, abv, mapsql) {
	return function (_: _,  obj) {
		const result = {};
