...
export function maptrim(driver: types.Driver, typesmap: number[], dispatch: boolean) {
...
export function mapFromSql(driver: types.Driver, abv: string, mapsql: types.SqlColumnsDesc) {
	return function (_: _,  obj: types.Row) {
		const result: any = {};
