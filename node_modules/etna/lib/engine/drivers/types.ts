...
export interface Driver extends BaseDriver {
	reader<T>(_: _, sql: string, args: any[], opts?: DriverReaderOptions): ez.Reader<T>;
	reader<T>(_: _, cnx: Connection, sql: string, args: any[], opts?: DriverReaderOptions): ez.Reader<T>;
