...
import { Connection, Driver, TableDefinition, TableFilter, SqlExecuteOptions } from '../runtime/types';
...
export type Reader<T> = (_: _, cnx: Connection, sql: string, args: any[], opts: SqlExecuteOptions) => ez.Reader<T>;
