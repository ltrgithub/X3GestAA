...
import { Connection, Driver, TableDefinition, TableFilter, SqlExecuteOptions, DriverReaderOptions } from '../runtime/types';
...
export function createPermissions(_: _,  driver: Driver, tableDef: TableDefinition, config: types.PermissionsConfig) {
