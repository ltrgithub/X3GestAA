...
export function createTableReader(_, driver, tableDef, filters) {
...
export function dropTable(_, driver, tableDef) {
	try {
...
export function dropSequence(_, driver, tableDef) {
	try {
...
export function createPermissions(_, driver, tableDef, config) {
