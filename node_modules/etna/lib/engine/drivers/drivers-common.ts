...
export function createTableReader(_: _,  driver, tableDef, filters) {
...
export function dropTable(_: _,  driver, tableDef) {
	try {
...
export function dropSequence(_: _,  driver, tableDef) {
	try {
...
export function createPermissions(_: _,  driver, tableDef, config) {
	const PERMISSION_UPDATE = "UPDATE";
	const PERMISSION_SELECT = "SELECT";
	const PERMISSION_INSERT = "INSERT";
	const PERMISSION_DELETE = "DELETE";

	function grantPermission(_: _,  cnx, roleName, permission, fullTableName) {
	...
	function grantPermissions(_: _,  cnx, roleName, permissions) {
		var result = true;
...
export function reader(creator) {
	return function (_: _,  cnx, sql, args, opts) {
...
export function writer(creator) {
	return function (_: _,  cnx, sql, opts) {
		if (typeof cnx === "string") {
			opts = sql;
			sql = cnx;
			cnx = null;
