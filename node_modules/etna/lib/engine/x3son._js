...
var uuid = require('etna/lib/engine/runtime/tuuid');
...
exports.stringify = function(_, v) {
	...
	if (Array.isArray(v)) {
		...
		s = t + "[" + v.map_(_, function(_, e) {
			return e.toX3son ? e.toX3son(_) : (len(t, e) + format(t, e));
		}).join('') + "];";
		...
		if (v.toX3son) {
			...
			s = "O!{" + Object.keys(v).map(function(k) {
				var t = x3sonLetter(v[k]);
