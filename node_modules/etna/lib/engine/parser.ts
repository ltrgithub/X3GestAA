...
export function Parser(source, fname) {
	var line = 1,
	    pos = 0,
	    bol = 0;
	var statements;
  ...
  */
	...
	function format(node, depth) {
		if (!(node instanceof Node)) {
			if (Array.isArray(node)) return node.map(elt => {
