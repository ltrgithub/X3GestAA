...
exports.Parser = function(source, fname) {
	...
	function extractCodeWithinCheckBlock(node) {
		console.info("in extractCodeWithinCheckBlock");
		return "";
	}
	...
	function parseHashCheck(node) {
		node.tag = 'CHECK';
		var regex = /#CHECK/gm;
		var parsedSource = source.replace(regex, "CHECK");
		console.info("generated script : " + parsedSource);
		return parsedSource;
	}
	
	function parseScript(node) {
		//parsing entete fichier
	...
	var keywords = {
		...
		CHECK: function parseCheck(node) {
			var word = parseWord();
			var text = parseStatementSep();
