...
import { generate } from './compilers/jsgen';
...
false && require("../test/dummy").Factorials(function (err: Error, result: any) {
	console.log("DONE: " + result);
});
false && require("../test/testFlows").MAIN(function (err: Error, result: any) {
	console.log("DONE: " + result);
});