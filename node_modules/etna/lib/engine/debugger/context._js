...
var breakpoint = require('etna/lib/engine/debugger/breakpoint');
var evalue = require('etna/lib/engine/runtime/evaluate').evalue;
var tracer = require('syracuse-core').getTracer("etna.debugger");
...
function _getProperty(_, parents, name, value, context) {
	...
	if (type === "Array") {
		...
		prop.property = value.map_(_, (_, e, i) => {
