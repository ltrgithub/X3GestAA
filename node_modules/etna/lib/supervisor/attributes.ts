...
//vimport * as variables from '../engine/runtime/variables';
...
export interface IAttributesHolder {
	$attributes: Attributes;
	$isSnapshotEnabled: boolean;
	$isSyssnapshotEnabled: boolean;
}

// babel does not support "implements" clause in class declarations so we do not type. 
export type AttributesHolder = any;
...
export class Attributes {
	...
	setResource(_: _,  resource: string, value: any, lan: string) {
		if (resAttributes[resource]) return resAttributes[resource].set(_, this, value, lan);
	}
	getResource(_: _,  resource: string, lan: string) {
...
export function addIntAttributes(_prototype: Prototype) {
	...
	_prototype.setAttribute = function (attribute: string, value: any) {
		const variables = require('../engine/runtime/variables');
