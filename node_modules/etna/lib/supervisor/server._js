...
var routes = [{
	...
	handler: function(_, context, codcla, property, codblb, ident1, ident2) {
	...
	handler: function(_, context, codcla, property, codblb, ident1) {
		var cl = loadClass(_, context, codcla);
	...
	handler: function(_, context, codcla, property, codblb) {
		var cl = loadClass(_, context, codcla);
