	...
	var superv = {
		...
		load: function(_, className, keyValue, dataChildren) {
			...
			if (keyValue !== undefined) {
				...
				script = this.loadBuiltin(_, keyValue);
			}

			if (instance && data && data._etag && instance._etag && data._etag === instance._etag) return instance;

			if (data && (className !== "Class" || script === undefined )) {
				//dbg:console.log("load meta:"+className+" "+keyValue);
				...
				// Give priority to the builtin:
				//dbg:console.log("load builtin:"+className+" "+keyValue);
