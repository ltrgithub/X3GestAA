...
exports.TESTSUITE_START = function (_: _,  suite_id, suite_description) {
	//added for AXUNIT comptability
};

exports.ADD_TESTCASE = function (_: _,  name, title, count) {
	testCases.push({
		name: name.valueOf(),
		title: title.valueOf(),
		count: count
...
exports.RUN_TESTSUITE = function (_: _,  title, description) {
...
exports.CHECK_EQUAL = function (_: _,  v1, v2, title) {
	if (v1 === undefined) {
...
exports.CHECK_NOTEQUAL = function (_: _,  v1, v2, title) {
	const v11 = Array.isArray(v1) ? v1[2][0] === undefined ? v1[1] : v1[2][0] : v1;
	const v22 = Array.isArray(v2) ? v2[2][0] === undefined ? v2[1] : v2[2][0] : v2;
