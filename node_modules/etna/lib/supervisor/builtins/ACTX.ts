...
export function init(_: _,  session: types.X3Session, superv: Supervisor) {
...
class SlotChapter extends Slot {
	chapter: number;
	constructor(parent: util.Helper, chapter: number) {
		super(parent, null);
	...
	slot(_: _,  name: string) {
		...
		if (this.builtinProperties.indexOf(name) >= 0) {
			...
			if (recDb) {
				...
				var property: Property = this.supervisor.new(_, 'Property', this, wprop);
