...
export class ACTXPARAM extends util.Helper {
	...
	AGETVALNUM(_: _,  levcod: number, code: string, parameter: string): number {
		...
		return parseInt(this._getParam(_, levcod, code, parameter, "NUM").value || '0');
	}
	...
	AGETVALDATE(_: _,  levcod: number, code: string, parameter: string): tdate.Date {
		return this._getParam(_, levcod, code, parameter, "DATE").value || tdate.NULL;
	}
	AGETUSERVALNUM(_: _,  parameter: string): number {
		return parseInt(this._getParamUser(_, parameter, "NUM").value || '0');
	}
	...
	AGETUSERVALDATE(_: _,  parameter: string): tdate.Date {
		return this._getParamUser(_, parameter, "DATE").value || tdate.NULL;
	}
