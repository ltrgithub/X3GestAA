...
var errors = require('etna/lib/engine/runtime/errors');
...
exports.CHECK_EQUAL = function(_, v1, v2, title) {
	...
	if (typeof v11.x3ToString !== 'function')
		return console.error(v11), deepEqual(-1, 0, `CHECK_EQUAL: EXPECTED ${v22}, GOT invalid value: typeof=${typeof v11}, val=${v11}`);
	if (v11.x3ToString() === "NaN") {
		return deepEqual(-1, 0, "CHECK_EQUAL : GOT is NaN");
	}
	if (typeof v22.x3ToString !== 'function')
		return deepEqual(-1, 0, `CHECK_EQUAL: EXPECTED invalid value: typeof=${typeof v22}, val=${v22}`);
