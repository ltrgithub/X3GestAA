...
class SlotCollection {
	constructor(parent, property) {
		// note: does not subclass Slot so we have to do all inits
		this.supervisor = parent.supervisor;
		this.property = property;
		this.collection = property.collection;
		this.proName = property.name;
		this.proJsName = property.jsName;
	...
	clone() {
		var to = new SlotCollection(this.$parent, this.property);
