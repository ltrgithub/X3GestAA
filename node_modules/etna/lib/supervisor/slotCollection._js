...
class SlotCollection {
	...
	get(_) {
		...
		if (this.$lazyLoading) {
			this.lines = this.collection.class.loadInstances(_, self.$parent, mapping.getIndex(_, this.supervisor, this.collection.mappingData), this.relKeys).map((_, instance) => {
	...
	newline(_) {
		...
		this.collection.mappingData && this.collection.mappingData.MAPS.filter(map => !!map.PROMAP).forEach_(_, function (_, map) {
