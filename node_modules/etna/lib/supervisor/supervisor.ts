...
export class Supervisor {
	...
	load(_: _, className: string, keyValue: string, dataChildren?: any) {
		...
		if (!data && className === 'Class') {
			...
			if (script && script.Constructor) {
				instance = new script.Constructor(this);
	...
	*/
	...
	loadMessParams(_: _, lib: number, num: number) {
	...
	fillTypeNode(_: _, data: any, node: Node) {
	...
	*/
	loadScript(_: _, name: string, clas?: Class): types.Prog {
		this.loadBuiltins(_);
	...
	loadScripts(_: _, clas: Class):  types.Prog[] {
		if (clas.data.CODTRT) {
