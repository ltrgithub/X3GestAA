...
interface Endpoint {
	getEtnaConfig(_: _, session: types.X3Session): types.EtnaConfig;
	dataset(_: _): string;
}

class Client {
	endpoint: Endpoint;
	session: types.X3Session;
	context: ClientContext;

	constructor(session: types.X3Session, endpoint: Endpoint) {
...
export function getClient(_: _,  session: types.X3Session, endpoint: Endpoint) {
