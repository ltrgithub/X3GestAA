...
class SlotInstance extends Slot {
	...
	get(_, raw) {
		...
		if (instance.$lazyLoading) {
			instance.class.loadInstances(_, instance.$parent, mapping.getIndex(_, instance.supervisor, instance.class.data.dataChildren.ownMapping), instance.relKeys, 1, function (_, record) {
