...
export class Helper {
	...
	getActionArgs(_: _,  type: string, action: string, key?: any, member?: types.ProgArgMembers) {
		...
		if (key) {
			// TODO: clean any cast 
			var index: types.InstanceIndex = util.any(this).index;
	...
	toJSON() {
		...
		return util.any(Object.prototype).toJSON.call(this);
	}
}
