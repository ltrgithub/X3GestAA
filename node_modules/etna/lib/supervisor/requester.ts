...
export function proto(_: _,  httpContext, script, query, facet) {
...
export function query(_: _,  httpContext, request_code, query) {
 ...
 */
	...
	const getExecutionTime = (frq, forced_exec) => {
	...
	const getPortalValue = (record, cod, fields) => {
	...
	const arcv = new ASYRRCV(httpContext.superv, httpContext.qs);
