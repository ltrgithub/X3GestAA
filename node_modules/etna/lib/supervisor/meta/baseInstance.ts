...
export class BaseInstance extends Helper {
	...
	setColumnAttribute(_: _, collection: string, column: string, attribute: string, value: any) {
		...
		if (slot && slot.setColumnAttribute) return slot.setColumnAttribute(column, attribute, value);
	}
	...
	propertyEvent(action: string) {
		return (_: _, prop: Slot, oldValue: any, newValue: any) => {
	...
	propertyInitValue(_: _, prop: Slot, oldValue: any) {
