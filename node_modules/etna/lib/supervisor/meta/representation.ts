...
export interface RepresentationData extends BaseClassData {
	EXPORTED_PROPERTIES: ExportedPropertyData[];
}
...
export class Representation extends BaseClass {
	...
	curpath: string;
	constructor(superv: Supervisor, data: RepresentationData) {
		super(superv, data);
		this.curpath = "";
	}
	...
	filtersProto(_: _,  resourceFactory) {
	...
	service(_: _,  keys, $service, facet, qs) {
		const reply = {};
