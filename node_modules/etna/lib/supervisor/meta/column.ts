...
import { SqlQueryOptions, DriverReaderOptions } from '../../engine/drivers/types';
import * as util from '../util';
import { ColumnMeta } from '../metadata/table';
import { Activ, Table, Type } from './types';
...
export class Column {
	...
	init(_: _) {
		...
		const activ = this.data.CODACT ? this.supervisor.load<Activ>(_, 'Activ', this.data.CODACT) : undefined;
	...
	sqlNames(prefix: string, alias?: string, sqlOpts?: SqlQueryOptions) {
		prefix = prefix || '';
	...
	getSql(_: _,  colNames: string[], tableNames: string[], wheres: string[], params: string[], descs: ColumnDesc[], raw?: boolean, sqlOpts?: DriverReaderOptions) {
