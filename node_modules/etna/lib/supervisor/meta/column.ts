...
export class Column {
	...
	index: number;
	dim: number;
	constructor(superv: Supervisor, table: Table, data: ColumnData) {
	...
	getSql(_: _,  colNames: string[], tableNames: string[], wheres: string[], params: string[], descs: Column[], raw?: boolean, sqlOpts?: types.DriverReaderOptions) {
