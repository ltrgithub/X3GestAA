...
export class SearchResourceFactory extends Helper {
	...
	init(_: _) {
		...
		this.properties = Object.keys(this.class.properties).filter(property => this.class.properties[property].isSearchable && !/.*_REF$/.test(property) || this.class.properties[property].collection).reduce_(_, (_, r, property) => {
