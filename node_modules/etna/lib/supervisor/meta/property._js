...
var newSlotText = require("etna/lib/supervisor/slotText").newSlotText;
var newSlotClob = require("etna/lib/supervisor/slotClob").newSlotClob;
var newSlotBlob = require("etna/lib/supervisor/slotBlob").newSlotBlob;
var newSlotAtextra = require("etna/lib/supervisor/slotAtextra").newSlotAtextra;
...
class Property extends Helper {
	...
	getAtextraKey(_, instance) {
		var keyMaps = this.keyMaps(_);
		return [ident(_,keyMaps.IDENT1(_, instance)), ident(_,keyMaps.IDENT2(_, instance))].join('~');
	}
							...
							if (rs && rs.length) {
								...
								wheres.push("((" +
									rs.reduce_(_, function(_, r, record) {
										var id1 = ident(_,atextra.IDENT1(_, record.record));
										var id2 = ident(_,atextra.IDENT2(_, record.record));
										params.push(id1);
										params.push(id2);
