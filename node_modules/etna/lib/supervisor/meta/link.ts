...
export interface LinkParamData {
	CODPAR: string;
	VALEUR: string;
	TYPINT: number;
	TYPPAR: number;
...
export class Link {
	...
	constructor(superv: Supervisor, anchor: Anchor, data: LinkData) {
   ...
   */
		...
		const prepParam = (repr: Representation, paramData: LinkParamData, key: any) => {
