...
export class Link {
	...
	anchor: string;
	data: LinkData;
	constructor(superv: Supervisor, anchor: string, data: LinkData) {
   ...
   */
		...
		const prepParam = (repr, paramData, key) => {
	...
	params3Expression(_: _,  parameters) {
	...
	url(_: _,  facet, withKey, withWorkingCopy, withTemplate) {
