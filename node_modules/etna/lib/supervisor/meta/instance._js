...
var BaseInstance = require("etna/lib/supervisor/meta/baseInstance").BaseInstance;
...
class Instance extends BaseInstance {
	...
	afterCreate(_, record, colnIndex) { // for $create action, not $edit
		var instance = this;
		this.record = record;
	...
	setInstance(_, record) { // Manages instruction setInstance
		var instance = this;
		if (record) {
			if (record.AUUID) this.$uuid = record.AUUID;
...
exports.constructor = Instance;
exports.newInstance = function(property) {
	return function(parent) {
		return new SlotInstance(parent, property);
	};
};