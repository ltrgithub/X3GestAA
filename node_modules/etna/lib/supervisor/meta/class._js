		...
		addMethods: function(instance) {
			...
			var xmeth = function(clas, method) {
				return function(_) {
					...
					if (vals.length > 0 && (Object.keys(meth).length - 2) > vals.length) throw new X3Error(69, "parameter count mismatch: expected " + (Object.keys(meth).length - 1) + ", got " + vals.length);
			...
			instance.methods["xmetAGETNEXTINFOS"] = xmeth(self, "AGETNEXTINFOS");
