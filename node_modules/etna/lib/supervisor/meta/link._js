...
exports.constructor = util.defineClass(function(superv, anchor, data) {
	...
	paramsFilterExpression: function(_) {
		...
		var filter = "";
		this.params && this.params.filter(function(paramData) {
	...
	paramsEntExpression: function(_) {
		return this.params ? this.params.filter(function(paramData) {
	...
	params3Expression: function(_, parameters) {
		return this.params ? this.params.map(function(paramData) {
			if (paramData.alias)
	...
	keyExpression: function(_) {
		return this.keys ? this.keys.map(function(paramData) {
			return (paramData.alias ? '{' + paramData.alias + '}' : paramData.value);
		}, this).join('~') : "";
	},
