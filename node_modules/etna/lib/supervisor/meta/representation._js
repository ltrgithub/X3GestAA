...
var Sdata = require("etna/lib/engine/sdatagen");
var tuuid = require('etna/lib/engine/runtime/tuuid');
var DBTableVAR = require('etna/lib/engine/runtime//dbtablevar').DBTableVAR;

var activ = require("etna/lib/supervisor/meta/activ");
var constants = require("etna/lib/supervisor/constants");
var extAttributesObject = require("etna/lib/supervisor/attributes").extAttributesObject;
var enumStdLinks = require("etna/lib/supervisor/meta/link").enumStdLinks;
...
class Representation extends BaseClass {
	...
	init(_) {
		...
		this.properties = this.data.PROPERTIES ? this.data.PROPERTIES
	...
	beforeQuery(_) {
		...
		var status = this.action(_, "AQUERY_OPEN");
	...
	afterQuery(_) {
		var status = this.action(_, "AQUERY_CLOSE");
	...
	service(_, keys, $service, facet, qs) {
		...
		var param = cl.methods[service].getServiceArgs(_, keys, qs);
