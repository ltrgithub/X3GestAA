...
class Representation extends BaseClass {
	...
	init(_) {
		...
		this.exportedProperties = this.data.EXPORTED_PROPERTIES ? this.data.EXPORTED_PROPERTIES.sort((ep1, ep2) => ep1.ORDPRO - ep2.ORDPRO).map_(_, (_, data) => this.supervisor.new(_, 'ExportedProperty', this, data), this) : [];
