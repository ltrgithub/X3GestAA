...
var baseClass = require("etna/lib/supervisor/meta/baseClass");
var Cache = require("etna/lib/supervisor/cache").Cache;

var newInstanceProperty = require("etna/lib/supervisor/instanceProperty").newInstanceProperty;
var newInstanceReference = require("etna/lib/supervisor/instanceReference").newInstanceReference;
var newInstanceCollection = require("etna/lib/supervisor/instanceCollection").newInstanceCollection;
...
module.exports = {
	...
	constructor: baseClass.defineClass(function(superv, data) {
		...
		action: function(_, action, frame) {
