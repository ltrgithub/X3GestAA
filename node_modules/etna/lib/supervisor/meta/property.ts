 ...
 "C06P02_REF": {
	...
	loadReference(_: _,  instance: Instance) {
		this.loadReferenceData = this.loadReferenceData || ((_: _,  id: string, instance: Instance) => {
			...
			const addTextTransform = (_: _, superv: Supervisor, attribute: string, reference: Instance, column: string, refReader: RefReader) => {
			...
			//TODO : "COLDEC", "COLLNG"
			var refMaps: { [name: string]: (column: string) => (item: Instance) => any; } = {
				SYMBOL(column) {
