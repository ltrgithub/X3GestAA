...
export class Type {
	...
	init(_: _) {
		...
		const makeMediaRule = rule => {
			return function (_: _,  slot, value) {
		...
		const makeMediaLazyRule = rule => {
			return function (_: _,  property, keys) {
...
export function	fillTypeNode(_: _,  superv, data, node) {
