...
const format = require('etna/lib/engine/runtime/format');
...
export const etnaType2TypTyp = Object.keys(typTyp2EtnaType).reduce((r, k) => (r[typTyp2EtnaType[k]] = k, r), {});
const mapTypeRule = {
	1: "INIT",
	2: "CONTROL",
	3: "PROPAGATE",
...
export function	getConstructor(data) {
	switch (data.TYPTYP) {
		case 1:
			return TypeJ;
		case 2:
...
export function	fillTypeNode(_, superv, data, node) {
