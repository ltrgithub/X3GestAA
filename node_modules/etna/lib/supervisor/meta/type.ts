...
export const etnaType2TypTyp = Object.keys(typTyp2EtnaType).reduce((r, k) => (r[typTyp2EtnaType[util.any(k)]] = +k, r), {} as Dict<number>);
...
export class TypeLob extends Type {
	static promote(type: Type): TypeLob { return util.any(type); }
	...
	contentType(_: _,  slot?: Slot) {
		...
		if (slot !== undefined && this.rules && this.rules.READ_MEDIA_CNT) {
			...
			var astatus = this.applyRule(_, rule, util.any(args));
