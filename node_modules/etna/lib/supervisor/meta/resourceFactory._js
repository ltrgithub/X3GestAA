...
var activ = require("etna/lib/supervisor/meta/activ"); // GH 6167
...
class ResourceFactory extends Helper {
	...
	filterRep(_, name) {
		if (this.representation._filters === undefined || this.representation._filters[name] === undefined) {
			...
			this.representation.data.FILTERS && this.representation.data.FILTERS.forEach_(_, function(_, elt) { // GH 6167		
