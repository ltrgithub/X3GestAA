...
class ResourceFactory extends Helper {
	...
	itemProto(_, proto, facet) {
		...
		proto.$properties = {};
		Object.keys(self.properties).filter(name => !self.properties[name].isExtraRef).forEach_(_, function (_, name) {
	...
	get tag2PropertyName() {
		if (this._tag2PropertyName === undefined) {
			var self = this;
			this._tag2PropertyName = Object.keys(self.properties).reduce((r, property) => {
