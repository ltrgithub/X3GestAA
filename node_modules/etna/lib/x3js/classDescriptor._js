...
function isReadOnly(_, instance) {
	...
	else return /^(4gl|inProgress)$/.test(instance.status(_));
}
...
module.exports = {
	...
	layout: {
		query: ['name', 'dictCode', 'title', 'module'],
		detail: {
			header: ['name', 'dictCode', 'title', 'module', 'endpoint'],
			tabs: {
				general: ['status', 'comment', 'kind', 'activityCode', 'capabiities', 'table', 'contextProperties', 'linkedObject', 'scripts'],
