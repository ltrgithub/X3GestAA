...
function asPropertyDescriptor(desc: Descriptor): PropertyDescriptor { return util.any(desc); };
function asCollectionDescriptor(desc: Descriptor): CollectionDescriptor { return util.any(desc); };
...
export function generateSourceCode<T>(_: _,  parsed: Parsed, descriptor: FullDescriptor<T>) {
