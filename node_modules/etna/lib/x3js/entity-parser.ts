...
export function parseFile(_: _,  filePath, descriptor) {
	try {
...
export function parseSource(_: _,  source, filePath, descriptor) {
...
export function parseSourceFiles(_: _,  subdir, descriptor, superv, tracker) {
