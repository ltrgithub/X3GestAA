...
entityHelper.updateAll = function(_, desc, instance, saving) {
	...
	const helper = entityHelper.create(superv, desc);
	const filePath = helper.sourceFilename(instance.module(_), instance.name(_));
	...
	const instanceData = helper.instanceToCanonical(_, instance);
