	...
	$data(_, full) {
		return Object.keys(this.slots).reduce_(_, (_, r, name) => {
			...
			if (slot instanceof SlotCollection) {
				...
				r[name] = x3jsUtil.toJs(slot.value, slot.property.type);
			}
			return r;
		}, {});
	}
