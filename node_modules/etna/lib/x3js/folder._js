"use strict";
/// !doc
/// [x3js dev guide](x3js-development-guide) > [x3js APIs](x3js-apis) > x3js folder
/// 
/// # x3js folder
/// 
/// The _folder_ object is the root of metadata for an X3 folder. Through this object you can
/// access the list of classes, tables, ..., as well as folder parameters.
///
/// The folder is usually obtained from an existing instance, as `instance.$folder`.
...
(function() {
	...
	class Folder {
		constructor(supervisor) {
			...
			/// #### Managers
			/// 
			/// * `folder.classes`: classes manager.
			/// * `folder.tables`: tables manager.
