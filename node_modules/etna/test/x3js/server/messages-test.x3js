...
if (typeof Proxy !== "undefined" && config.unit_test && config.unit_test.etnaEndPoint) {
	...
	asyncTest("retrieving and formatting messages", 3, _ => {
	...
	test("retrieving message names", 1, () => {
		deepEqual(BusinessIntelligence.$names(), ['factTable', 'dimensionUsedByHierarchy'], 'message names');
	});
