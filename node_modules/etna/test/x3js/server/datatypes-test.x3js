...
if (typeof Proxy !== "undefined" && config.unit_test && config.unit_test.etnaEndPoint) {
	...
	asyncTest("basic create", 6, (_) => {
		...
		strictEqual(obj.boolVal$, true, "verifying bool property");
		...
		strictEqual(obj.datetimeVal$, datetimeVal, "verifying datetime property");
		strictEqual(obj.uuidVal$, uuidVal, "verifying uuid property");
		start();
	});
