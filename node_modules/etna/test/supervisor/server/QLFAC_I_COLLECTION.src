...
Call ADD_TESTCASE("TC_AUPDATE","TC_AUPDATE"-"1 header class - 2 subclasses (Update first subclass)" ,22) From AXUNIT
#Call ADD_TESTCASE("TC_ADELETE","TC_ADELETE"-"1 header class - 2 subclasses (Delete first subclass)" ,71) From AXUNIT
...
MY_INSTANCE.KEY1="TESTUPDATE"
MY_INSTANCE.FIELD1="Header"
[L]SUBCOL0_NUM = fmet MY_INSTANCE.SUBCOL0.AADD([V]CST_ALASTPOS)
MY_INSTANCE.SUBCOL0(SUBCOL0_NUM).KEY1 = "TESTUPDATE"
...
MY_INSTANCE.SUBCOL0(SUBCOL0_NUM).SUBCOL1(SUBCOL1_NUM).KEY1 = "TESTUPDATE"
...
MY_INSTANCE.SUBCOL0(SUBCOL0_NUM).SUBCOL1(SUBCOL1_NUM).SUBCOL2(SUBCOL2_NUM).KEY1 = "TESTUPDATE"
...
MY_INSTANCE.SUBCOL0(SUBCOL0_NUM).SUBCOL1(SUBCOL1_NUM).SUBCOL2(SUBCOL2_NUM).SUBCOL3(SUBCOL3_NUM).KEY1 = "TESTUPDATE"
...
If [L]MY_STATUS = [V]CST_AOK
   ...
   EVENT = "ADELETE1_AQCCOL10"
   Call DISP_MSG(EVENT,MY_INSTANCE)
   EVENT="ADELETE1_AQCCOL11"
   Call DISP_MSG(EVENT,MY_INSTANCE)
   EVENT="ADELETE1_AQCCOL12"
   Call DISP_MSG(EVENT,MY_INSTANCE)
   EVENT="ADELETE1_AQCCOL13"
   Call DISP_MSG(EVENT,MY_INSTANCE)
   EVENT="ADELETE1_AQCCOL14"
   Call DISP_MSG(EVENT,MY_INSTANCE)
...
IDX+=1 : EVENT_ADELLINE1_AQCCOL10(IDX)="Event Action Execute CSTD=[AQCCOL12_CSTD] CLASS=[C_AQCCOL12] CURPTH=[] AEVENT=[ADELLINE_AFTER]"
IDX+=1 : EVENT_ADELLINE1_AQCCOL10(IDX)="Event Action Execute CSTD=[AQCCOL10_CSTD] CLASS=[C_AQCCOL12] CURPTH=[SUBCOL1] AEVENT=[ADELLINE_AFTER]"
IDX+=1 : EVENT_ADELLINE1_AQCCOL10(IDX)="Event Action Execute CSTD=[AQCCOL10_CSTD] CLASS=[C_AQCCOL12] CURPTH=[SUBCOL0.SUBCOL1] AEVENT=[ADELLINE_AFTER]"
