...
const aqcUser="AQCORE";

QUnit.module("x3Deltas");
...
function testIssue2208() {
	asyncTest("Issue 2208" + x3Helper.gitHubIssue(2208), _ => {
		function create(_, i) {
			var id = "2208_" + i;
...
function testAQCPROR01() {
	asyncTest("AQCPROR01 - Create OK", _ => {
...
function testAQCPROC01() {
	...
	asyncTest("AQCPROC01 - Create NOK (existing object)", _ => {
		var id = "QUNIT_001";
		var refId = "R01P01_01";
	...
	asyncTest("AQCPROC01 - Create NOK (mandatory field)", _ => {
		var id = "QUNIT_003";
		var refId = "R01P01_01";
	...
	asyncTest("AQCPROC01 - Create NOK (invalid reference)", _ => {
		var id = "QUNIT_004";
		var refId = "R01P01_05";
	...
	asyncTest("AQCPROC01 - SAM 90758 " + x3Helper.gitHubIssue(1841), _ => {
		var id = "SAM_90758";
	...
	asyncTest("AQCPROC01 - MOBILE $edit " + x3Helper.gitHubIssue(1440), _ => {
		var id = "QUNIT_005";
		var refId = "R01P01_01";
	...
	// TODO  ?
	return;
	asyncTest("AQCPROC01 - SAM 89053 (Unexpected end of session while editing an entity) :", _ => {
		var id = "QUNIT_005";
		var property = "BEFORE";
		...
		var users = apsadx.query(_, "&where=(DOSSIER%20eq%20%27SUPERV%27)%20and%20(USER%20eq%20%27" + aqcUser + "%27)&count=100");
...
function testAQCPROC02() {
	...
	asyncTest("AQCPROC02 - Create NOK (existing object)", _ => {
		var id = "QUNIT_001";
		var refId1 = "R01P01_01";
		var refId2 = "R01P01_02";
	...
	asyncTest("AQCPROC02 - Create NOK (mandatory field 1)", _ => {
		var id = "QUNIT_002";
		var refId1 = "R01P01_01";
		var refId2 = "R01P01_02";
	...
	asyncTest("AQCPROC02 - Create NOK (mandatory field 2)", _ => {
		var id = "QUNIT_002";
		var refId1 = "R01P01_01";
		var refId2 = "R01P01_02";
	...
	asyncTest("AQCPROC02 - Create NOK (invalid reference 1)", _ => {
		var id = "QUNIT_003";
	...
	asyncTest("AQCPROC02 - Create NOK (invalid reference 2", _ => {
		var id = "QUNIT_003";
		var refId1 = "R01P01_01";
...
function testAQCPROC03() {
	asyncTest("AQCPROC03 - Create OK (1 line)", _ => {
		var id = "QUNIT_001";
		var refId = "R01P01_01";
		var lineId = 101;
	...
	asyncTest("AQCPROC03 - Create OK (2 lines)", _ => {
		var id = "QUNIT_002";
		var data;
	...
	asyncTest("AQCPROC03 - Create OK (4 lines)" + x3Helper.gitHubIssue(1350), _ => {
		var id = "QUNIT_006";
		var data;
	...
	asyncTest("AQCPROC03 - CRUD OK (1 line)", _ => {
		var id = "QUNIT_003";
		var refId = "R01P01_01";
		var lineId = 101;
		var uuid = helpers.uuid.generate();
	...
	asyncTest("AQCPROC03 - CRUD OK (2 lines)", _ => {
		var id = "QUNIT_004";
		var data;
	...
	asyncTest("AQCPROC03 - DelLine OK  (2 lines)", _ => {
		var id = "QUNIT_005";
		var data;
...
function testAQCPROC04() {
	asyncTest("AQCPROC04 - Create OK (1 line)", _ => {
		var id = "QUNIT_001";
		var uuid = helpers.uuid.generate();
		var data;
	...
	asyncTest("AQCPROC04 - Create OK (2 lines)", _ => {
		var id = "QUNIT_002";
		var uuid = helpers.uuid.generate();
		var data;
	...
	asyncTest("AQCPROC04 - CRUD OK (1 line)", _ => {
		var id = "QUNIT_003";
		var uuid = helpers.uuid.generate();
		var data;
	...
	asyncTest("AQCPROC04 - CRUD OK (2 lines)", _ => {
		var id = "QUNIT_004";
		var uuid = helpers.uuid.generate();
		var data;
...
function testAQCPROC05() {
	asyncTest("AQCPROC05 - Create OK (1 line)", _ => {
		var id = "QUNIT_001";
		var refId = "R01P01_01";
		var uuid = helpers.uuid.generate();
		var data;
	...
	asyncTest("AQCPROC05 - Create OK (2 lines)", _ => {
		var id = "QUNIT_002";
		var data;
	...
	asyncTest("AQCPROC05 - CRUD OK (1 line)", _ => {
		var id = "QUNIT_003";
		var refId = "R01P01_01";
		var uuid = helpers.uuid.generate();
		var data;
	...
	asyncTest("AQCPROC05 - CRUD OK (2 lines)", _ => {
		var id = "QUNIT_004";
		var data;
...
function testAQCPROR02() {
	asyncTest("AQCPROR02 - Create OK", _ => {
...
function testAQCPROC06() {
	asyncTest("AQCPROC06 - Create OK" + x3Helper.gitHubIssue(1093), _ => {
		var id = "QUNIT_001";
	...
	asyncTest("AQCPROC06 - Create NOK (invalid reference 1)", _ => {
		var id = "QUNIT_002";
	...
	asyncTest("AQCPROC06 - Create NOK (invalid reference 2)", _ => {
		var id = "QUNIT_003";
		var refIdP1 = "R02P01_01";
		var refIdP2 = 1000;
...
function testAQCPROC07() {
	asyncTest("AQCPROC07 - Create OK", _ => {
		var id = "QUNIT_001";
		var id2 = id + "T1C1";
		var id3 = id + "T2C2";
	 ...
	 */
	asyncTest("AQCPROC07 - Create OK (! with link 1x1 managed!)", _ => {
		var id = "QUNIT_x01";
		var id2 = id + "T1C1";
		var id3 = id + "T2C2";
	...
	/* test � supprimer lorsque Christophe aura mis en place la gestion des cl�s :
	 */
	asyncTest("AQCPROC07 - CRUD OK (! with link 1x1 managed!)", _ => {
		var id = "QUNIT_x02";
		var id2 = id + "T1C1";
		var id3 = id + "T2C2";
...
function testAQCPROC08() {
	asyncTest("AQCPROC08 - Create OK", _ => {
		var id = "QUNIT_001";
		...
		representation.setProperties(_, {
			"AQCP08COL": [col[0].C08P02, col[1].C08P02, col[2].C08P02]
		});
		var response = representation.save(_);
	...
	asyncTest("AQCPROC08 - Create NOK" + x3Helper.gitHubIssue(1309), _ => {
		var id = "QUNIT_002";
		...
		representation.setProperties(_, {
			"AQCP08COL": [col[0].C08P02]
		});
		var data = representation.save(_);

		//Check the object:
		strictEqual(data.AQCP08COL.length, 1, "AQCP08COL length=1");
		strictEqual(data.AQCP08COL[0], "0123456789", "AQCP08COL[0].C08P02='0123456789'");
		start();
	});
}
...
function testAQCPROC09() {
	asyncTest("AQCPROC09 - Create OK", _ => {
		var id = "QUNIT_001";
		var refIdP1 = "R02P01_01";
		var refIdP2 = 1;
...
function testAQCPROR03() {
	asyncTest("AQCPROR03 - Create OK", _ => {
		function create(_, id1, num) {
			var id = id1;
...
function testAQCPROC11() {
	asyncTest("AQCPROC11 - Create OK " + x3Helper.gitHubIssue(1541), _ => {
...
function testAQCPROC12() {
	...
	asyncTest("AQCPROC12 (US 87071/2) - Create OK", _ => {
		function setId(r, num) {
			r.id = "QUNIT_" + num;
		}
	...
	asyncTest("AQCPROC12 - CRUD OK (empty symbol)", _ => {
		var num = 5;
...
function testAQCPROC14() {
	asyncTest("AQCPROC14 - Create OK with 1 detail", _ => {
		var id = "QUNIT_001_";
		var delta = {
			"TBL1COL1": id + "T1C1",
			"TBL1COL2": id + "T1C2",
	...
	asyncTest("AQCPROC14 - Create OK with 0 detail", _ => {
		var id = "QUNIT_002_";
		var delta = {
			"TBL1COL1": id + "T1C1",
			"TBL1COL2": id + "T1C2"
...
function testSAM95076() {
	asyncTest("AQCPROC01 - SAM 95076 " + x3Helper.gitHubIssue(1841), _ => {
		// The entitiy SAM_90758 is cannot be deleted :ADELETE_CONTROL_BEFORE returns AERROR
		var id = "SAM_90758";
...
testAQCPROC12();
testAQCPROC11();
testAQCPROC03(); // Denormalized collection
testAQCPROC05();
testAQCPROC09();
testAQCPROC04(); // Class which contains an array of references (array = collection of 1 property)
testAQCPROC07(); // 1x1 Relation
testAQCPROC08(); // Class which contains an array of strings
testAQCPROC14();
testSAM95076();
testAQCPROC01(); // Includes protected entity SAM_90758
