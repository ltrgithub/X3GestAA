...
Funprog TESTSUITE()
  ...
  Call ADD_TESTCASE("TC_CASCADEDELETE_1","TC_CASCADEDELETE_1" ,11) From AXUNIT
...
TC="cascade - delete Parent-Child-SubChild-A"
Call CHECK_EQUAL(TC,TC) From AXUNIT
...
TC="cascade - delete Parent-Child-SubChild-B"
Call CHECK_EQUAL(TC,TC) From AXUNIT
...
TC="cascade - delete Parent-Child-SubChild-C"
Call CHECK_EQUAL(TC,TC) From AXUNIT
...
TC="cascade - delete Parent-Child-SubChild-D"
Call CHECK_EQUAL(TC,TC) From AXUNIT
