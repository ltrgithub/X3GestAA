...
[L]MY_STATUS = fmet INS.AREAD("AQC06_F2")
if([L]MY_STATUS <> [V]CST_AERROR) : Callmet INS.ADELETE() : Endif

[L]MY_STATUS = fmet INS.AREAD("AQC062_F1")
if([L]MY_STATUS <> [V]CST_AERROR) : Callmet INS.ADELETE() : Endif

[L]MY_STATUS = fmet INS.AREAD("AQC062_F2")
if([L]MY_STATUS <> [V]CST_AERROR) : Callmet INS.ADELETE() : Endif
...
Call ADD_TESTCASE("AQCQRY06_BASIC","AINSERT + AREAD + AUPDATE + ADELETE",216) From AXUNIT
Call ADD_TESTCASE("AQCQRY06_CONTROLS","AINSERT CONTROLS",14) From AXUNIT
