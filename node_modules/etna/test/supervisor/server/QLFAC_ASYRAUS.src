...
Call ADD_TESTCASE("ASYRAUS_CREATION","Creation of ASYRAUS ZAUS",7) From AXUNIT
#TODO Call ADD_TESTCASE("ASYRAUS_CREATION_PROFIL","Creation of ASYRAUS ZAUSx using profil",2) From AXUNIT
#TODO Call ADD_TESTCASE("ASYRAUS_READ","Read ASYRAUS ZAUS",1) From AXUNIT
...
Local Integer I
# Expect OK
#TODO [L]MY_STATUS = fmet QLFAUS.AINSERT()
#TODO Call CHECK_EQUAL("Insert valid"-num$([L]MY_STATUS),"Insert valid"-num$([V]CST_AOK)) From AXUNIT
#TODO Gosub WRITE_ERRORS
FreeGroup QLFAUS
End
...
For [AFT] Where [F:AFT]ALLACS<>2
  ...
  #TODO [L]MY_STATUS = fmet QLFAUS.AINSERT()
  #TODO Call CHECK_EQUAL([L]MY_STATUS,[V]CST_AOK) From AXUNIT
  #TODO Gosub WRITE_ERRORS
  FreeGroup QLFAUS
  Break
Next
