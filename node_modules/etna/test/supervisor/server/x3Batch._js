...
function testIssue1475() {
	asyncTest("AQCQRY02 Create OK" + x3Helper.gitHubIssue(1475), _ => {
		var data = {
			"FIELD01": 200,
			"FIELD02": 2001
		};
	...
	asyncTest("AQCQRY02 CRUD OK" + x3Helper.gitHubIssue(1475), _ => {
		var data1 = {
			"FIELD01": 201,
			"FIELD02": 2011
		};
...
function testIssue1704() {
	asyncTest("AQCQRY02 Delete" + x3Helper.gitHubIssue(1704), _ => {
		var batch = new Batch("AQCQRY02", "AQCQRY02");
		var data = {
			"FIELD01": 123,
			"FIELD02": 2001
...
function testIssue2362() {
	asyncTest("AQMDEVICE Delete" + x3Helper.gitHubIssue(2362), _ => {
...
function testIssue2306() {
	asyncTest("AQMFIELDSM Update" + x3Helper.gitHubIssue(2306), _ => {
...
function testIssueAQMDEVICE() {
	...
	asyncTest("AQMDEVICE $create 1", _ => {
	...
	asyncTest("AQMDEVICE $create 2", _ => {
		var batch = new Batch("AQMDEVICE", "AQMCRUDM");
		var data = {
			"WMENU": 1,
			"MODULE": 1,
	...
	asyncTest("AQMDEVICE $create 3", _ => {
		var batch = new Batch("AQMDEVICE", "AQMCRUDM");
		var data = {
			"WMENU": 1,
			"MODULE": 1,
	...
	asyncTest("AQMDEVICE $create 4", _ => {
		var batch = new Batch("AQMDEVICE", "AQMCRUDM");
		var data = {
			"WMENU": 1,
			"MODULE": 1,
...
function testIssue3207() {
	...
	asyncTest("Issue 3207" + x3Helper.gitHubIssue(3207), _ => {
		...
		for (var i = 0; i < response["ADEVADEVICEL"].length; i++) {
			...
			["ADEV_UNIT", "STATE"].forEach(property => {
