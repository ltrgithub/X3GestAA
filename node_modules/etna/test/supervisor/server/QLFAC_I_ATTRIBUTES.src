...
Call ADD_TESTCASE("TC_PROPERTY_ATTRIBUTES","TC_PROPERTY_ATTRIBUTES"   ,109) From AXUNIT
...
Call ADD_TESTCASE("TC_COMPATIBILITY","TC_COMPATIBILITY",9) From AXUNIT
...
Call ADD_TESTCASE("TC_ISSUE_4838","TC_ISSUE_4838",10) From AXUNIT
...
#_rightAccess is internal => error 50
TC="Property $_rightAccess"
Call CHECK_EQUAL(TC,TC) From AXUNIT
EX=50
[L]ASTATUS = fmet INS1.C03P01.AGETATTR("$_rightAccess")
EX=50
...
Call CHECK_EQUAL(TC,TC) From AXUNIT
EX=50
[L]ASTATUS = fmet INS1.C03P01.AGETATTR("$x3Format")
EX=50
...
EX=50
Call CHECK_EQUAL(TC,TC) From AXUNIT
[L]TC = fmet INS1.C03P01.AGETATTR("$title")

TC="Property $description"
EX=50
Call CHECK_EQUAL(TC,TC) From AXUNIT
[L]TC = fmet INS1.C03P01.AGETATTR("$description")

TC="Property $acceptedTypes"
EX=50
Call CHECK_EQUAL(TC,TC) From AXUNIT
[L]TC = fmet INS1.C03P01.AGETATTR("$acceptedTypes")
...
Call CHECK_EQUAL(TC,TC) From AXUNIT
EX=50
[L]TC = fmet INS1.C03P01.AGETATTR("$namProParent")
...
INS1.COL(2).C03P02 = 10+[L]LINE
Call CHECK_EQUAL(INS1.COL(2).C03P02,10+[L]LINE) From AXUNIT

[L]LINE = fmet INS1.COL.AADD([V]CST_AFIRSTPOS)
Call CHECK_EQUAL([L]LINE,1) From AXUNIT
INS1.COL(1).C03P02 = 10
Call CHECK_EQUAL(INS1.COL(1).C03P02,10) From AXUNIT

#set INS1.COL(1).C03P02 as ReadOnly
[L]ASTATUS = fmet INS1.COL(1).C03P02.ASETATTR("$isReadOnly",[V]CST_ATRUE)
[L]IS_READONLY = fmet INS1.COL(1).C03P02.AGETATTR("$isReadOnly")
Call CHECK_EQUAL([L]IS_READONLY,[V]CST_ATRUE) From AXUNIT

#let's try to modify INS1.COL(1).C03P02
C03P02 =  INS1.COL(1).C03P02
Gosub SET_EX_ISREADLONY
INS1.COL(1).C03P02 = 20
Call CHECK_EQUAL(INS1.COL(1).C03P02,C03P02) From AXUNIT

#set INS1.COL(1).C03P02 as writtable:
[L]ASTATUS = fmet INS1.COL(1).C03P02.ASETATTR("$isReadOnly",[V]CST_AFALSE)
Call CHECK_EQUAL(fmet INS1.COL(1).C03P02.AGETATTR("$isReadOnly"),[V]CST_AFALSE) From AXUNIT

#let's try to modify INS1.COL(1).C03P02
INS1.COL(1).C03P02 = 21
Call CHECK_EQUAL(INS1.COL(1).C03P02,21) From AXUNIT
...
#let's try to modify INS1.COL(1).C03P02
INS1.COL(1).C03P02 = 23
Call CHECK_EQUAL(INS1.COL(1).C03P02,23) From AXUNIT
...
#let's try to modify INS1.COL(1).C03P02
INS1.COL(1).C03P02 = 24
Call CHECK_EQUAL(INS1.COL(1).C03P02,24) From AXUNIT
...
#let's try to modify INS1.COL(1).C03P02
INS1.COL(1).C03P02 = 26
Call CHECK_EQUAL(INS1.COL(1).C03P02,26) From AXUNIT

#set INS1.COL(2) as writtable
[L]ASTATUS = fmet INS1.COL(2).ASETATTR("$isReadOnly",[V]CST_AFALSE)
Call CHECK_EQUAL(fmet INS1.COL(2).AGETATTR("$isReadOnly"),[V]CST_AFALSE) From AXUNIT

#let's try to modify INS1.COL(1).C03P02
INS1.COL(2).C03P02 = 11
Call CHECK_EQUAL(INS1.COL(2).C03P02,11) From AXUNIT

#set INS1.COL(2) as ReadOnly
[L]ASTATUS = fmet INS1.COL(2).ASETATTR("$isReadOnly",[V]CST_ATRUE)
Call CHECK_EQUAL(fmet INS1.COL(2).AGETATTR("$isReadOnly"),[V]CST_ATRUE) From AXUNIT

#let's try to modify INS1.COL(2).C03P02
Gosub SET_EX_ISREADLONY
INS1.COL(2).C03P02 = 12
Call CHECK_EQUAL(INS1.COL(2).C03P02,11) From AXUNIT
...
#let's try to modify INS1.COL(2).C03P02
INS1.COL(2).C03P02 = 13
Call CHECK_EQUAL(INS1.COL(2).C03P02,13) From AXUNIT
...
Call CHECK_EQUAL([L]LINE,1) From AXUNIT
INS1.COL(1).C03P02 = 1
INS1.COL(1).C03P03 = "ref01"
Call CHECK_EQUAL(INS1.COL(1).C03P02,1) From AXUNIT
Call CHECK_EQUAL(INS1.COL(1).C03P03,"ref01") From AXUNIT

[L]LINE = fmet INS1.COL.AADD([V]CST_ALASTPOS)
Call CHECK_EQUAL([L]LINE,2) From AXUNIT
INS1.COL(2).C03P02 = 2
INS1.COL(2).C03P03 = "ref02"
Call CHECK_EQUAL(INS1.COL(2).C03P02,2) From AXUNIT
Call CHECK_EQUAL(INS1.COL(2).C03P03,"ref02") From AXUNIT
...
Gosub SET_EX_ISREADLONY
INS1.COL(1).C03P02 = 10
INS1.COL(1).C03P03 = "ref10"
Gosub SET_EX_ISREADLONY
INS1.COL(2).C03P02 = 20
INS1.COL(2).C03P03 = "ref20"


Call CHECK_EQUAL(INS1.COL(1).C03P02,    1)   From AXUNIT
Call CHECK_EQUAL(INS1.COL(2).C03P02,    2)   From AXUNIT
Call CHECK_EQUAL(INS1.COL(1).C03P03,"ref10") From AXUNIT
Call CHECK_EQUAL(INS1.COL(2).C03P03,"ref20") From AXUNIT
...
[L]LINE = fmet INS1.COL.AADD([V]CST_ALASTPOS)
Call CHECK_EQUAL([L]LINE,4) From AXUNIT
INS1.COL(4).C03P02 = 4

Call CHECK_EQUAL(INS1.COL(1).C03P02,    1)   From AXUNIT
Call CHECK_EQUAL(INS1.COL(2).C03P02,    2)   From AXUNIT
Call CHECK_EQUAL(INS1.COL(3).C03P02,    3)   From AXUNIT
Call CHECK_EQUAL(INS1.COL(4).C03P02,    4)   From AXUNIT
...
Call CHECK_EQUAL(INS1.COL(4).C03P02,    0)   From AXUNIT
...
[L]ASTATUS     = fmet INS1.ASETATTRIBUTE("C03P01","$isReadOnly","true")
[L]IS_READONLYCH = fmet INS1.AGETATTRIBUTE("C03P01","$isReadOnly")
Call CHECK_EQUAL([L]IS_READONLYCH,"true") From AXUNIT

[L]ASTATUS     = fmet INS1.ASETATTRIBUTE("C03P01","$isReadOnly","false")
[L]IS_READONLYCH = fmet INS1.AGETATTRIBUTE("C03P01","$isReadOnly")
Call CHECK_EQUAL([L]IS_READONLYCH,"false") From AXUNIT
...
INS1.COL(1).C03P02.$isReadOnly = [V]CST_ATRUE
Call CHECK_EQUAL(INS1.COL(1).C03P02.$isReadOnly,[V]CST_ATRUE) From AXUNIT
Call CHECK_EQUAL(INS1.COL(1).C03P02.$isReadOnly,fmet INS1.COL(1).C03P02.AGETATTR("$isReadOnly") ) From AXUNIT
...
[L]IS_READONLY=[V]CST_AFALSE
EX=10
[L]IS_READONLY = fmet INS1.AGETATTRIBUTE("C03P01","$ISREADONLY")
Call CHECK_EQUAL([L]IS_READONLY,[V]CST_AFALSE) From AXUNIT

Call CHECK_EQUAL(fmet INS1.AGETATTRIBUTE("C03P01","$ISREADONLY"),"true") From AXUNIT
[L]IS_READONLYCH = fmet INS1.AGETATTRIBUTE("C03P01","$ISREADONLY")
Call CHECK_EQUAL(IS_READONLYCH,"true") From AXUNIT
End
