...
Call ADD_TESTCASE("AQCRULE_BASIC","AINSERT + AREAD + AUPDATE + ADELETE",2) From AXUNIT
...
Call CHECK_EQUAL(INS.RULE1,"RULE_INIT_CONTROL_PROPAGATE") From AXUNIT
INS.FIELD01 = "AQC01"

INS.RULE1 = "AQC01"
Call CHECK_EQUAL(INS.RULE1,"AQC01_CONTROL_PROPAGATE") From AXUNIT
