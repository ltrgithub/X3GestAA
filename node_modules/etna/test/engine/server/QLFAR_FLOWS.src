...
$ERROR_RECURSE
#TODO CALLJS SYNC FAIL("Error during error") From "etna/lib/engine/helpers"
Resume

$ERROR_SUB
#TODO  CALLJS SYNC FAIL("T5") From "etna/lib/engine/helpers"
Return
...
# If X = 1 Then GOT += "A": CALLJS SYNC FAIL("T1") From "etna/lib/engine/helpers" : GOT += "B": Endif
# Onerrgo ERROR_END
# If X = 2 Then GOT += "C": CALLJS SYNC FAIL("T2") From "etna/lib/engine/helpers" : GOT += "D": Endif
# Onerrgo
# If X = 3 Then GOT += "E": CALLJS SYNC FAIL("T3") From "etna/lib/engine/helpers" : GOT += "F": Endif
# Onerrgo ERROR_RECURSE
# If X = 4 Then GOT += "G": CALLJS SYNC FAIL("T4") From "etna/lib/engine/helpers" : GOT += "H": Endif
# Onerrgo
