...
Call ADD_TESTCASE("NUM_TEST", "numeric formats", 24) From AXUNIT
...
Call ADD_TESTCASE("NUM_BASIC", "Number basic", 38) From AXUNIT
Call ADD_TESTCASE("NUM_HASH_MARK", "Number Float 1", 25) From AXUNIT
Call ADD_TESTCASE("NUM_FLOAT", "Number Float 2", 70) From AXUNIT
...
Call ADD_TESTCASE("SERIES1_TEST", "Date series 2", 77) From AXUNIT
Call ADD_TESTCASE("SERIES2_TEST", "Number series 2", 42) From AXUNIT
...
Callmet GACTX.ACTX_SET_LANISO("fr-FR")                       # Change language
...
#BUG X3 : Call CHECK_EQUAL(format$('N-+:11F',-1), '         +0') From AXUNIT
#BUG X3 : Call CHECK_EQUAL(format$('N-+:11F',-1.2), '         +0') From AXUNIT
...
#BUG X3 : Call TESTOPTIONS('D:DD[/]MM[/]YY', FALSE, '281000', '  /  /  ', 56)
...
#BUG X3 ? Call TESTOPTIONS('DZ:YY[-]MM', FALSE, '052006', '  -  ', 56)
#40
...
Call TESTOPTIONS('DZ:DD[-]MM[-]YYYY', FALSE, '500506', '06-05-1950', 0)
Call TESTOPTIONS('DZ:DD[-]MM[-]YYYY', FALSE, '510506', '06-05-1951', 0)
Call TESTOPTIONS('DZ:DD[-]MM[-]YYYY', FALSE, '490506', '06-05-2049', 0)
...
#BUG X3: Call TESTOPTIONS('N:[Debut]3[abc].2#[Fin]', FALSE, '150', 'Debut150abc,00Fin', 0)
#BUG X3: Call TESTOPTIONS('N:[Debut]3[abc].2#[Fin]', TRUE, '150', 'Debut150abc,00Fin', 0)
