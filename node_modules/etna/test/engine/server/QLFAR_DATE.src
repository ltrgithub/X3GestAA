...
Call ADD_TESTCASE("TC_NDAY", "'NDAY' - Number of days since 01/01/1600",5) From AXUNIT
Call ADD_TESTCASE("TC_NDAYDATE", "'NDAY$' - Return date based on number of days since 01/01/1600",5) From AXUNIT
Call ADD_TESTCASE("TC_BEGDATE", "BEGDATE: Beginning date",5) From AXUNIT
