...
Append S4(1),"BBBBBBBBBBBBBBBBBBBB"
Call CHECK_EQUAL(S4(0),"AAAAAAAAAAAAAAAAAAAA") From AXUNIT
Call CHECK_EQUAL(S4(1),"BBBBBBBBBBBBBBBBBBBB") From AXUNIT

TC="Test multiple dimensions"
Call CHECK_EQUAL(TC,TC) From AXUNIT
Local Clbfile S4(1)(2,2)
Append S4(0,0),"AAAAAAAAAAAAAAAAAAAA"
Append S4(0,1),"BBBBBBBBBBBBBBBBBBBB"
Call CHECK_EQUAL(S4(0,0),"AAAAAAAAAAAAAAAAAAAA") From AXUNIT
Call CHECK_EQUAL(S4(0,1),"BBBBBBBBBBBBBBBBBBBB") From AXUNIT
End
