...
var fs = require("fs");
var Parser = require("etna/lib/engine/compilers/parser").Parser;
var jsgen = require('etna/lib/engine/compilers/jsgen');
...
asyncTest("max", _ => {
    ...
    compile('this.NUMLIG=max(this.NUMLIG,this.APARENT.AOR(ILINE).NUMLIG)', true);
	start();
});
...
asyncTest("DECL", _ => {
	...
	compile('Local Integer AI(J)', true);
	start();
});

// asyncTest("Delete", _ => {
// 	compile('Rewrite [F]', true);
// 	compile('Delete [F]', true);
// 	start();
// });
