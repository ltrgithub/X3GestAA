...
Funprog TESTSUITE()
    Call ADD_TESTCASE("TEST_WR_READ", "Test base", 16) From AXUNIT
	...
	#TODO ?Call ADD_TESTCASE("TEST_SQL", "Test sql", 10) From AXUNIT	
	Call ADD_TESTCASE("TEST_FORFROMTO", "Test from to", 4) From AXUNIT	
	Call ADD_TESTCASE("TEST_FORSQL", "Test forsql", 1) From AXUNIT
...
$BIDERROR
Call CHECK_EQUAL( errn, 28 ) From AXUNIT
Resume
...
#I = clalev([F:ABV])
#FILEN = format$("D:"+adxfmt(0),date$)-time$
...
Subprog TEST_FORSQL( ) 
	#dbgetna
	For (Char V0(30), Char V1(30)) From "3" Sql "Select ABREV_0, MOT_0 from AABREV" As [ABV]
