...
Funprog TESTSUITE()
    ...
    Call ADD_TESTCASE("TEST_BCD", "Test base bcd", 34) From AXUNIT
    Call ADD_TESTCASE("TEST_CROSS", "Test base cross bcd", 34) From AXUNIT
    Call ADD_TESTCASE("TEST_FUNCTIONS", "Test function on  bcd", 74) From AXUNIT
