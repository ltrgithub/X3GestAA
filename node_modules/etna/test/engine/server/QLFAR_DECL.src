...
Call CHECK_EQUAL(dim(WDT), 1)

Call CHECK_EQUAL(num$(WDT), num$(WDT2))

Call CHECK_EQUAL(num$(WDT), "0000-00-00T00:00:00Z")

WDT2=datetime$
WDT=WDT2
Call CHECK_EQUAL(num$(WDT), num$(WDT2))

WDT2=gdatetime$('2012-05-25T15:21:29Z')
Call CHECK_EQUAL(num$(WDT2), '2012-05-25T15:21:29Z')
...
Call CHECK_EQUAL(dim(WINST), 1)
#Call CHECK_EQUAL(WINST=null, 1)

Local Instance WINST2 Using C_AQCPROC01
WINST2 = NewInstance C_AQCPROC01
Call CHECK_EQUAL(type(WINST2), 524)
Call CHECK_EQUAL(dim(WINST2)>=0, 1)
Call CHECK_EQUAL(dim(WINST2), 1)

#Local Char CLASSNAME(10)
#CLASSNAME = "C_AQCPROC01"
#Local Instance WINST3 Using =CLASSNAME
#WINST3 = NewInstance =CLASSNAME
#Call CHECK_EQUAL(type(WINST3), 524)
#Call CHECK_EQUAL(dim(WINST3)>=0, 1)
#Call CHECK_EQUAL(dim(WINST3), 1)
