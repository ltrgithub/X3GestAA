...
Call ADD_TESTCASE("TWOKEYUNLIMWH2", "For With Key two parts table unlimited with two where", 18) From AXUNIT
Call ADD_TESTCASE("VTBREAD", "Test Read", 7) From AXUNIT
...
&   Char    D(25))
&             From Variable
&   [L]TA,[L]TB,[L]TC,[L]TD As [ANB] Where A <= 5
...
Filter [ANB] Where A <= 5 and ([ANB]C = "STR6" or [ANB]C = "STR7") Order By Key KK=[ANB]A;[ANB]B
...
For [ANB]
    ...
    N+=1
Next
Call CHECK_EQUAL(N, 2) From AXUNIT
...
&   Char    D(25))
&             From Variable
&   [L]TA,[L]TB,[L]TC,[L]TD As [ANB] Where A <= 5 and ([ANB]C = "STR6" or [ANB]C = "STR7")
