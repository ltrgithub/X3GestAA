...
Call ADD_TESTCASE("BASIC", "Basic", 40) From AXUNIT
Call ADD_TESTCASE("ONEKEY", "Basic With Key one part", 120) From AXUNIT
Call ADD_TESTCASE("TWOKEY", "Basic With Key two parts", 40) From AXUNIT
Call ADD_TESTCASE("TWOKEYUNLIM", "Basic With Key two parts table unlimited", 40) From AXUNIT
Call ADD_TESTCASE("TWOKEYUNLIMWH1", "Basic With Key two parts table unlimited with one where", 42) From AXUNIT
