...
Call ADD_TESTCASE("TC_FILE", "Script file errors", 3) From AXUNIT
...
Call ADD_TESTCASE("TC_LABELS", "Label errors", 18) From AXUNIT
Call ADD_TESTCASE("TC_VARIABLES", "Variable errors", 12) From AXUNIT
...
EX=20
Call TEST From QLFAR_COMPILE_XXX

EX=20
Gosub TEST From QLFAR_COMPILE_XXX
Onerrgo
End
...
Call CHECK_EQUAL(TT,TT) From AXUNIT
If pat(ver$(0),"etna*")>0
 #the file exists but not the label
 EX=39
Else
 EX=20
Endif
...
EX=20
Gosub TEST From QLFAR_COMPILE_LABEL1
...
EX=20
Gosub TEST From QLFAR_COMPILE_LABEL2
...
EX=20
Gosub TEST From QLFAR_COMPILE_LABEL3
...
EX=20
Gosub TEST From QLFAR_COMPILE_LABEL4
...
EX=20
Gosub TEST From QLFAR_COMPILE_LABEL5
...
EX=20
Gosub TEST From QLFAR_COMPILE_LABEL6
Onerrgo
End
...
EX=20
Gosub TEST From QLFAR_COMPILE_VAR2
...
EX=20
Gosub TEST From QLFAR_COMPILE_VAR3
...
EX=20
Gosub TEST From QLFAR_COMPILE_VAR4
...
EX=20
Gosub TEST From QLFAR_COMPILE_VAR5
Onerrgo
End
