...
exports.toBoolean = function(obj) {
	return typeof obj === 'string' ? (/^(y(es)?|true|1)$/).test(obj) : !!obj;
};
...
exports.mime = {
	...
	fromContent: function getMimeFromContent(data, def) {
		if (!data) return def;
		if (typeof(data) === "string") {
			data = new Buffer(data.substring(0, 8), "binary");
		}
		...
		if ((data[0] === 0x4d && data[1] === 0x4d && data[2] === 0x00 && data[3] === 0x2a) || (data[0] === 0x49 && data[1] === 0x49 && data[2] === 0x2a && data[3] === 0x00)) {
			return "image/tiff";
		}
		return def;
	},
	...
	types: {
		...
		".yml": "text/yaml",
		".zip": "application/zip",
		// additional types for MS click-once
