...
function getLogger(logType, logFunc) {
	var tracer = null;
	...
	switch (traceConfig.transport) {
		case "storagearea":
			// traceOptions.transport = saFunction;
			break;
		case "mongo":
			// traceOptions.transport = mongoFunction;
			break;
		default: // console
			break;
	}
	tracer = require("syracuse-trace").logger(traceOptions);
