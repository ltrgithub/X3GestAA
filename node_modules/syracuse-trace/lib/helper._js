...
exports.syncConfigs = function(_) {
	//console.log("Tracers: "+JSON.stringify(Object.keys(tracers),null,2));
	...
	Object.keys(_tracers).forEach_(_, function(_, name) {
		//console.log("Create or update configurations needed by tracers : "+name);
	...
	configs.filter_(_, function(_, c) {
		...
		//console.log("Remove or update configurations not needed by tracers : "+c.name(_));
		var removed = false;
