...
/// ## lmHash
/// ``` javascript
/// var lmHash = helpers.lmHash(passw);  
/// ```
...
/// ## ntlmHash
/// ``` javascript
/// var lmHash = helpers.ntlmHash(passw);  
/// ```
...
///
var ntlmHash = exports.ntlmHash = function(passw){
	return crypto.createHash('md4').update(new Buffer(passw,'ucs2')).digest("hex");  
};

/// ## ntlmv2Hash
/// ``` javascript
/// var lmHash = helpers.ntlmv2Hash(target, user, passw);  
/// ```
...
/// and LMv2 Responses. 
///
exports.ntlmv2Hash = function(target, user, passw){
	var _ntlmHash = ntlmHash(passw);
