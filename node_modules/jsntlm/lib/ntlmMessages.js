...
var des_encrypt = function(ks, str, encoding){
	...
	var tokencrypt = crypto.createCipheriv('des-cbc', ks, iv);
...
exports.Type1Message = helpers.defineClass(function(session, domain) {
	...
	try {
        ...
        var unqualifiedHost = convertHost(session.host);
...
exports.Type3Message = helpers.defineClass(function(session, user, password, domain) {
