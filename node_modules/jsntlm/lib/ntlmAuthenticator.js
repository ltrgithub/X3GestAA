...
exports.NtlmAuthenticator = helpers.defineClass(function(user, password, domain) {
	this.user = user;
	...
	generateNegociateMessage: function() {
		...
		var message = new Type1Message(this.session, this.domain);
	...
	generateAuthenticateMessage: function(challenge) {
	    ...
	    var message = new Type3Message(this.session, this.user, this.password, this.domain, this.clientChallenge, this.clientChallenge2, this.randomSessionKey, this.timestamp);
