...
test("4.2.4 NTLMv2 Authentication", function() {
    ...
    var negociateMessage = ntlmEngine.generateNegociateMessage("connectionOriented", DOMAIN_NAME, WORKSTATION_NAME);
    var authenticateMessage = ntlmEngine.generateAuthenticateMessage("connectionOriented", negociateMessage, USER_NAME, PASSWORD, DOMAIN_NAME, WORKSTATION_NAME, challengeMessage.toString('base64'), CLIENT_CHALLENGE, CLIENT_CHALLENGE, RANDOM_SESSION_KEY, TIME);
