...
test("4.2.4 NTLMv2 Authentication", function() {
	...
	var ntlmAuthentication = new NtlmAuthenticator(USER_NAME, PASSWORD, WORKSTATION_NAME, DOMAIN_NAME, {
    ...
    var authenticateMessage = ntlmAuthentication.generateAuthenticateMessage(challengeMessage.toString('base64'));
