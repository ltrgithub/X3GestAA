...
/// ```
/// 
exports.httpRequest = function(domain, user, password, workstation, options, callback) {
	var ntlmAuthentication = new NtlmAuthenticator(user, password, workstation, domain);
	// Create NTLM session
