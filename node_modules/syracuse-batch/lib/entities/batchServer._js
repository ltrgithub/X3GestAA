...
exports.entity = {
	...
	$functions: {
		...
		stop: function(_, context, stopPendings) {
			this.getClient(_).stop(_, context, this, stopPendings);
		},
	...
	$events: {
		...
		$afterSave: [
			...
			function(_, instance) { // named user check
				console.error("ACT " + instance._notifyActive + " " + instance.active(_));
