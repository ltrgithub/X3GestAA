...
exports.entity = {
	...
	$events: {
		$beforeSave: [
			...
			function(_, instance) {
				if (instance.$snapshot && instance.$snapshot.maxQueries(_) !== instance.maxQueries(_)) {
					...
					if (instance.maxQueries(_) > 0) {
						...
						if (bsClient) {
							...
							var alreadyExists = bsClient._updateSrvInQueue(_, instance._parent.$diagnoses, instance.description(_), instance.maxQueries(_));
							if (!alreadyExists) {
