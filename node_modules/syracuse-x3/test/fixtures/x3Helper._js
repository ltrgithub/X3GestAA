...
var baseUrl = "http://localhost:" + config.unit_test.QLF.localPort;
...
exports.url = function(_url) {
	return "/sdata/x3/erp/" + config.unit_test.QLF.dataset + "/" + (_url || "");
};

exports.x3Url = function(_url) {
	return baseUrl + "/sdata/x3/erp/" + config.unit_test.QLF.dataset + "/" + (_url || "");
};
