...
exports.x3Url = function(url) {
  return baseUrl + "/sdata/x3/erp/"+config.QLF.dataset+"/"+url;
}
...
exports.get = function(_, cookie, url, statusCode, facet) {
	...
	strictEqual(response.statusCode, statusCode || 200, "GET:"+url);
...
exports.post = function(_, cookie, url, data, statusCode, returnFullResponse) {
	...
	strictEqual(response.statusCode, statusCode || 201, "POST:"+url);
...
exports.delete = function(_, cookie, url, data, statusCode, returnFullResponse) {
	...
	strictEqual(response.statusCode, statusCode || 201, "DELETE:"+url);
	if(returnFullResponse)
		return {headers: response.headers, body: JSON.parse(response.readAll(_))};
	else
		return JSON.parse(response.readAll(_));
...
exports.put = function(_, cookie, url, data, statusCode, returnFullResponse) {
	...
	strictEqual(response.statusCode, statusCode || 200, "PUT:"+url+" OK");
	if(returnFullResponse)
		return {headers: response.headers, body: JSON.parse(response.readAll(_))};
	else
		return JSON.parse(response.readAll(_));
...
function _initialize(_,initialized) {
