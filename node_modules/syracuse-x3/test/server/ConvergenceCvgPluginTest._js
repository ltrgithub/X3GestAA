...
asyncTest("listenNode -  callui CR Developper - test with http request and simulation buffer", function(_) {
	...
	var res = JSON.stringify(put(_, cookie, "requestSvc?act=1025&trackngId=3", cvgSession.sid, {
		act: 1025,
		fld: {
			fmtKind: "EDIT",
			ist: {
	...
	var res = JSON.stringify(put(_, cookie, "requestSvc?act=1025&trackngId=4", cvgSession.sid, {
		act: 1025,
		fld: {
			fmtKind: "EDIT",
			ist: {
	...
	res = put(_, cookie, "requestSvc?act=532&trackngId=5", cvgSession.sid, {
		act: 532,
		param: {
			method: "new",
			plugin: {
