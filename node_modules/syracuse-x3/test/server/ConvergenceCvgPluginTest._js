...
function getPlugin(_, cookie, suburl, sessionId, statusCode, fullResponse, noStatusCheck) {
	var res = adminTestFixtures.get(_, cookie, baseUrl + "/trans/x3/erp/SUPERV/$plugin('" + sessionId + "')/" + suburl, statusCode, fullResponse, null, noStatusCheck);
	if (!noStatusCheck) {
		return res;
	}
	if (statusCode === res.statusCode) {
		...
		var nb = 0;
		do {
			res = adminTestFixtures.get(_, cookie, baseUrl + "/trans/x3/erp/SUPERV/$plugin('" + sessionId + "')/" + suburl, statusCode, fullResponse, null, noStatusCheck);
...
function get(_, cookie, suburl, sessionId, statusCode, fullResponse, noStatusCheck) {
	var res = adminTestFixtures.get(_, cookie, baseUrl + "/trans/x3/erp/SUPERV/$sessions('" + sessionId + "')/" + suburl, statusCode, fullResponse, null, noStatusCheck);
	if (!noStatusCheck) {
		return res;
	}
	if (statusCode === res.statusCode) {
		...
		var nb = 0;
		do {
			res = adminTestFixtures.get(_, cookie, baseUrl + "/trans/x3/erp/SUPERV/$sessions('" + sessionId + "')/" + suburl, statusCode, fullResponse, null, noStatusCheck);
			ok(true, "polling - status code " + res.statusCode + " nbtry " + nb);
			flows.sleep(_, 100);
...
function post(_, cookie, suburl, sessionId, data, statusCode, fullResponse, noStatusCheck) {
	var res = adminTestFixtures.post(_, cookie, baseUrl + "/trans/x3/erp/SUPERV/$sessions('" + sessionId + "')/" + suburl, data, statusCode, fullResponse, noStatusCheck);
	if (!noStatusCheck) {
		return res;
	}
	if (statusCode === res.statusCode) {
		...
		var nb = 0;
		do {
			res = adminTestFixtures.post(_, cookie, baseUrl + "/trans/x3/erp/SUPERV/$sessions('" + sessionId + "')/" + suburl, data, statusCode, fullResponse, noStatusCheck);
			nb++;
		} while (res.statusCode !== statusCode && nb < 10);
		strictEqual(res.statusCode, statusCode, " status code " + res.statusCode);
		return res.body;
...
function postPlugin(_, cookie, suburl, sessionId, data, statusCode, fullResponse, noStatusCheck) {
	...
	var res = adminTestFixtures.post(_, cookie, baseUrl + "/trans/x3/erp/SUPERV/$plugin('" + sessionId + "')/" + suburl, data, statusCode, fullResponse, noStatusCheck);
	if (!noStatusCheck) {
		return res;
	}
	if (statusCode === res.statusCode) {
		...
		var nb = 0;
		do {
			res = adminTestFixtures.post(_, cookie, baseUrl + "/trans/x3/erp/SUPERV/$plugin('" + sessionId + "')/" + suburl, data, statusCode, fullResponse, noStatusCheck);
			nb++;
		} while (res.statusCode !== statusCode && nb < 10);
		strictEqual(res.statusCode, statusCode, " status code " + res.statusCode);
		return res.body;
...
function putPlugin(_, cookie, suburl, sessionId, data, statusCode, fullResponse, noStatusCheck) {
	var res = adminTestFixtures.put(_, cookie, baseUrl + "/trans/x3/erp/SUPERV/$plugin('" + sessionId + "')/" + suburl, data, statusCode, fullResponse, noStatusCheck);
	if (!noStatusCheck) {
		return res;
	}
	if (statusCode === res.statusCode) {
		...
		var nb = 0;
		do {
			res = adminTestFixtures.put(_, cookie, baseUrl + "/trans/x3/erp/SUPERV/$plugin('" + sessionId + "')/" + suburl, data, statusCode, fullResponse, noStatusCheck);
			nb++;
		} while (res.statusCode !== statusCode && nb < 10);
		strictEqual(res.statusCode, statusCode, " status code " + res.statusCode);
		return res.body;
...
function put(_, cookie, suburl, sessionId, data, statusCode, fullResponse, noStatusCheck) {
	var res = adminTestFixtures.put(_, cookie, baseUrl + "/trans/x3/erp/SUPERV/$sessions('" + sessionId + "')/" + suburl, data, statusCode, fullResponse, noStatusCheck);
	if (!noStatusCheck) {
		return res;
	}
	if (statusCode === res.statusCode) {
		...
		var nb = 0;
		do {
			res = adminTestFixtures.put(_, cookie, baseUrl + "/trans/x3/erp/SUPERV/$sessions('" + sessionId + "')/" + suburl, data, statusCode, fullResponse, noStatusCheck);
			nb++;
		} while (res.statusCode !== statusCode && nb < 10);
		strictEqual(res.statusCode, statusCode, " status code " + res.statusCode);
		return res.body;
...
function del(_, cookie, suburl, sessionId, statusCode, fullResponse, noStatusCheck) {
	var res = adminTestFixtures.del(_, cookie, baseUrl + "/trans/x3/erp/SUPERV/$sessions('" + sessionId + "')/" + suburl, statusCode, fullResponse, noStatusCheck);
	if (!noStatusCheck) {
		return res;
	}
	if (statusCode === res.statusCode) {
		...
		var nb = 0;
		do {
			res = adminTestFixtures.del(_, cookie, baseUrl + "/trans/x3/erp/SUPERV/$sessions('" + sessionId + "')/" + suburl, statusCode, fullResponse, noStatusCheck);
			nb++;
		} while (res.statusCode !== statusCode && nb < 10);
		strictEqual(res.statusCode, statusCode, " status code " + res.statusCode);
		return res.body;
		...
		"sap": {
			"target": {
				...
				"plugin": {
					...
					"blind3": "blind3",
					"blind4": "blind4",
					"endpointProxy": "/sdata/syracuse/collaboration/syracuse/$service/upload"
				}
			}
		},
		"session": {
