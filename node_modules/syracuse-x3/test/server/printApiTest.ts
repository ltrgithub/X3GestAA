...
var PrintClient = require('../../lib/clients/print/PrintClient');
...
describe(module.id, () => {
	...
	it('ChangePriority and ListJobs', function(_) {
	...
	it('List imprimantes', function(_) {
	...
	it('Get State and Result on unknow Job', function(_) {
	...
	it('OuvImp; GetState; GetReport', function(_) {
	...
	it('putFile - bad directory name ', function(_) {
		var cli = PrintClient.getClient(_, hostname, port, cnxId, recOptions);
		strictEqual(cli.pid != null && cli.pid >= 0, true, "pid: " + cli.pid);
		stop();
	...
	it('putFile - upload runtime folder ', function(_) {
		var cli = PrintClient.getClient(_, hostname, port, cnxId, recOptions);
		strictEqual(cli.pid != null && cli.pid >= 0, true, "pid: " + cli.pid);
		stop();
	...
	it('putFile - bad location', function(_) {
		var cli = PrintClient.getClient(_, hostname, port, cnxId, recOptions);
		strictEqual(cli.pid != null && cli.pid >= 0, true, "pid: " + cli.pid);
		stop();
		var buf = new Buffer("test upload \n. end", "utf8");
	...
	it('deleteFile - bad location', function(_) {
		var cli = PrintClient.getClient(_, hostname, port, cnxId, recOptions);
		strictEqual(cli.pid != null && cli.pid >= 0, true, "pid: " + cli.pid);
		stop();
		try {
