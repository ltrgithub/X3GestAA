...
asyncTest("async connection test", 8, function(_) {
	...
	var body = adminTestFixtures.get(_, cookie, serverUrl + "/sdata/x3/erp/X3/sample?representation=sample.$query&trackngId=test_track_2&callbackUrl=" + encodeURIComponent(callBackUrl), 202);
	// wait for callback
