...
asyncTest("listenNode -  http - new gantt  launch plugin with delete ", function(_) {
	...
	get(_, cookie, "requestSvc?$trackers=2", cvgSession.sid, 200, false);
...
asyncTest("listenNode -  http - new gantt  launch plugin with download/upload ", function(_) {
	...
	cvgClient.activeRequest.listenNodeNDEXECI(_, {}, {}, CvgIst.IST_WIN_ZERO, "XDT_ILOG:UPLOAD", 0, [
		[],
		[]
	], [
		[{
	...
	res = getPlugin(_, cookie, "requestSvc?$trackers=2", cvgSession.sid, 200);
	console.log("test ");
	//strictEqual(res, '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":null,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"update","methodId":2,"upload":"test"}}}}', "check response with upload");
	ok(true, "get tracker session 202");

	// test call plugin on upload
	putPlugin(_, cookie, "blobSvc", cvgSession.sid, "12345", 202);
	get(_, cookie, "requestSvc?$trackers=2", cvgSession.sid, 202, false);
	...
	strictEqual(res, '{"sap":{"target":{"type":"box","box":{"type":0,"def":0,"tit":"","li":["990=\\u0001N\\u0001X15X2F\\n"],"to":0}}},"session":{"settings":{"mnu":[],"fmtExt":{},"datePivot":1957,"dateOrder":0,"dateSep":"/","thousandSep":",","decimalSep":".","timeSep":":"}},"srvop":{"request":{"id":0,"v":1025,"rqtdist":null,"connect":1,"server":""}}}', "box for the client ok");
...
asyncTest("listenNode -  callilog - new gantt/scale", function(_) {
	...
	cvgClient.cvgPlugin.ND_IHM[1] && cvgClient.cvgPlugin.ND_IHM[1].timeout && clearTimeout(cvgClient.cvgPlugin.ND_IHM.ilog.timeout);
...
asyncTest("listenNode -  callilog - update gantt/scale", function(_) {
	...
	cvgClient.cvgPlugin.ND_IHM[1].generateResponse(_, false, false);
