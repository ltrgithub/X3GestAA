...
asyncTest("listenNode -  callilog - test with http request", function(_) {
	...
	strictEqual(res, '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":null,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"new","methodId":1,"cookieSess":null}}},"session":{"settings":{"mnu":[],"datePivot":1957,"dateOrder":0,"dateSep":"/","thousandSep":",","decimalSep":".","timeSep":":"}},"srvop":{"request":{"id":0,"v":1025,"rqtdist":null,"connect":1,"server":""}}}', "generate reply to the client ND_IHM new ");
	stream2.writed = null;
	...
	strictEqual(res, '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":1,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"update","methodId":2}}}}', "get update ND_IHM for the plugin client");
	...
	strictEqual(res, '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":1,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"delete","methodId":3}}}}', "check target delete nd_ihm gantt");
	ok(true, "get tracker client - ND_IHM delete ok 200");
	res = JSON.stringify(get(_, cookie, "requestSvc?$trackers=3", cvgSession.sid, 200));
	strictEqual(res, '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":1,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"delete","methodId":3}}},"session":{"settings":{"mnu":[],"datePivot":1957,"dateOrder":0,"dateSep":"/","thousandSep":",","decimalSep":".","timeSep":":"}},"srvop":{"request":{"id":0,"v":1025,"rqtdist":null,"connect":1,"server":""}}}', "check target delete nd_ihm gantt");
...
asyncTest("listenNode -  callilog - test with http request with callui Download", function(_) {
	...
	strictEqual(JSON.stringify(res.reply), '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":1,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"update","methodId":2,"download":[{"UIAction":"GetFile","UILocalDir":"Temp","UILocalFile":"test_d_1.txt","UIRemoteFile":"TRT/ZZILOG.src","UIDownLoad":"ILOG"}]}}}}', "validate no download  is present in reply (already sent) ");
	stream2.setToRead(binaryNode.ND_SLF_DOWNLOAD);
	...
	strictEqual(JSON.stringify(res), '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":1,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"update","methodId":2}}}}', "validate no download  is present in reply (already sent)");
	// notig
...
asyncTest("listenNode -  http - new gantt  launch plugin with download/upload ", function(_) {
	...
	res = getPlugin(_, cookie, "requestSvc?$trackers=2", cvgSession.sid, 200);
	strictEqual(JSON.stringify(res), '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":1,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"update","methodId":2,"upload":"test_upload_1.txt"}}}}', "check response with upload");
	ok(true, "get tracker session 202");
	...
	strictEqual(res, '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":1,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"update","methodId":2,"upload":"test_upload_1.txt"}}}}', "check response with upload");
	//console.log(res);
	...
	res = JSON.stringify(get(_, cookie, "requestSvc?$trackers=2", cvgSession.sid, 200, false));
	strictEqual(res, '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":1,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"delete","methodId":3}}},"session":{"settings":{"mnu":[],"datePivot":1957,"dateOrder":0,"dateSep":"/","thousandSep":",","decimalSep":".","timeSep":":"}},"srvop":{"request":{"id":0,"v":1081,"rqtdist":null,"connect":1,"server":""}}}', "receive delete after sent action 525 (delete) from plugin");
...
asyncTest("listenNode -  callilog - new gantt/scale", function(_) {
	...
	cvgClient.generateResponse(_, false, false);
	strictEqual(JSON.stringify(cvgClient.response), '{"head":{"statusCode":200},"body":{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":null,"module":"unitTest","method":"new","methodId":1,"cookieSess":null}}},"session":{"settings":{"mnu":[],"datePivot":1957,"dateOrder":0,"dateSep":"/","thousandSep":",","decimalSep":".","timeSep":":"}},"srvop":{"request":{"id":0,"v":1,"connect":1,"server":""}}}}', "ND_IHM new gantt client reply ok");
...
asyncTest("listenNode -  callilog - update gantt/scale", function(_) {
	...
	cvgClient.generateResponse(_, false, false);
	strictEqual(JSON.stringify(cvgClient.response), '{"head":{"statusCode":200},"body":{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"scale","type":"asynchronous","id":null,"module":"unitTest","method":"new","methodId":6,"cookieSess":null}}},"session":{"settings":{"mnu":[],"datePivot":1957,"dateOrder":0,"dateSep":"/","thousandSep":",","decimalSep":".","timeSep":":"}},"srvop":{"request":{"id":0,"v":1,"connect":1,"server":""}}}}', "ND_IHM new scale");
