...
asyncTest("listenNode -  callilog - test with http request", function(_) {
	...
	strictEqual(stream.writed && stream.writed.toString("hex"), "00000000193030313d0176616c752066697220756e69742074657374200a0000000000", "write client reply , notif plugin and client ok");
