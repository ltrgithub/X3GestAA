...
asyncTest("listenNode -  http - new gantt  launch plugin with download ", function(_) {
	console.log("-------");
	var id = "id";
	var clientId = "clientId";
	var session = new Session(null, id, clientId);
	...
	ok(true, "get tracker plugin 202");
	console.log("res " + JSON.stringify(getPlugin(_, cookie, "requestSvc?$trackers=1", cvgSession.sid, 202)));
