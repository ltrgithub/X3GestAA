...
asyncTest("listenNode -  callilog - new gantt/scale", function(_) {
	...
	cvgClient.cvgPlugin["ilog-" + 1].processRequest(_, context, JSON.stringify({
		act: 523,
		param: {
			method: "new",
			plugin: {
...
asyncTest("listenNode -  callilog - update gantt/scale", function(_) {
	...
	strictEqual(JSON.stringify(cvgClient.cvgPlugin["ilog-default"].response), '{"head":{"statusCode":200},"body":{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":12,"module":"unitTest","method":"update","methodId":2}}}}}', "ND_IHM update gantt, target plugin serialized in response to plugin client");
	...
	cvgClient.cvgPlugin["ilog-default"].generateResponse(_, false, false);
	strictEqual(JSON.stringify(cvgClient.cvgPlugin["ilog-default"].response), '{"head":{"statusCode":200},"body":{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"scale","type":"asynchronous","id":12,"module":"unitTest","method":"update","methodId":7}}}}}', "ND_IHM update gantt, target plugin serialized in response to plugin client");
	...
	cvgClient.cvgPlugin["ilog-default"].generateResponse(_, false, false);
	strictEqual(JSON.stringify(cvgClient.cvgPlugin["ilog-default"].response), '{"head":{"statusCode":200},"body":{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":12,"module":"unitTest","method":"delete","methodId":3}}}}}', "ND_IHM update gantt, target plugin serialized in response to plugin client");
	...
	cvgClient.cvgPlugin["ilog-default"].generateResponse(_, false, false);
	strictEqual(JSON.stringify(cvgClient.cvgPlugin["ilog-default"].response), '{"head":{"statusCode":200},"body":{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"scale","type":"asynchronous","id":12,"module":"unitTest","method":"delete","methodId":8}}}}}', "ND_IHM update gantt, target plugin serialized in response to plugin client");
