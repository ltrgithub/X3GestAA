...
function get(_, cookie, suburl, sessionId, statusCode, fullResponse) {
	console.log("get $session " + suburl);
...
function postPlugin(_, cookie, suburl, sessionId, data, statusCode, fullResponse) {
	console.log("post $plugin " + suburl);
...
function put(_, cookie, suburl, sessionId, data, statusCode, fullResponse) {
	console.log("put $session " + suburl);
...
asyncTest("listenNode -  callilog - test with http request", function(_) {
	...
	strictEqual(res, '{"sap":{"target":{"type":"box","box":{"type":0,"def":0,"tit":"","li":["990=\\u0001N\\u0001X15X2F\\n"],"to":0}}},"session":{"settings":{"mnu":[],"fmtExt":{},"datePivot":1957,"dateOrder":0,"dateSep":"/","thousandSep":",","decimalSep":".","timeSep":":"}},"srvop":{"request":{"id":0,"v":1025,"rqtdist":null,"connect":1,"server":""}}}', "info box to the client");
	...
	strictEqual(res, '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":null,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"delete","methodId":3}}},"session":{"settings":{"mnu":[],"fmtExt":{},"datePivot":1957,"dateOrder":0,"dateSep":"/","thousandSep":",","decimalSep":".","timeSep":":"}},"srvop":{"request":{"id":0,"v":1025,"rqtdist":null,"connect":1,"server":""}}}', "check target delete nd_ihm gantt");
...
asyncTest("listenNode -  http - new gantt  launch plugin with download/upload ", function(_) {
	...
	putPlugin(_, cookie, "blobSvc?trackngId=3", cvgSession.sid, "", 202);
	getPlugin(_, cookie, "blobSvc?$trackers=3", cvgSession.sid, 202, false);
	...
	strictEqual(res, '{"sap":{"target":{"type":"box","box":{"type":0,"def":0,"tit":"","li":["990=\\u0001N\\u0001X15X2F\\n"],"to":0}}},"session":{"settings":{"mnu":[],"fmtExt":{},"datePivot":1957,"dateOrder":0,"dateSep":"/","thousandSep":",","decimalSep":".","timeSep":":"}},"srvop":{"request":{"id":0,"v":1081,"rqtdist":null,"connect":1,"server":""}}}', "box for the client ok");
...
asyncTest("listenNode -  callilog - update gantt/scale", function(_) {
	...
	cvgClient.cvgPlugin.ND_IHM["ilog-default"].generateResponse(_, false, false);
	strictEqual(JSON.stringify(cvgClient.cvgPlugin.ND_IHM[1].response), '{"head":{"statusCode":200},"body":{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"scale","type":"asynchronous","id":12,"module":"unitTest","method":"update","methodId":7}}}}}', "ND_IHM update gantt, target plugin serialized in response to plugin client");


	cvgClient.razModification();
	stream.setToRead(binaryNode.ND_GIST);

	cvgClient.cvgPlugin.ND_IHM.ilog.processRequest(_, context, JSON.stringify({
		act: 524,
		param: {
			method: "update",
	...
	cvgClient.cvgPlugin.ND_IHM.ilog && cvgClient.cvgPlugin.ND_IHM.ilog.timeout && clearTimeout(cvgClient.cvgPlugin.ND_IHM.ilog.timeout);
