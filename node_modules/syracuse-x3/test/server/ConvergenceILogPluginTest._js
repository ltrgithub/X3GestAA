...
var streamTest = helpers.defineClass(function() {
	...
	read: function(_, size) {
		...
		while (this.offset > this.readed.length) {
			...
			flows.sleep(_, 1000); // wait 1s before try again
		}
...
var binaryNode = {
	"ND_IHM_gantt_delete": new Buffer([00, 0x00, 0x02, 0x12, 0x09, 0x00, 0x00, 0x00, 0x00, 0x2d, 0x49, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x3d, 0x01, 0x33, 0x0d, 0x0a, 0x49, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x3d, 0x01, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x69, 0x6e, 0x67, 0x5c, 0x76, 0x36, 0x5c, 0x78, 0x33, 0x69, 0x6c, 0x6f, 0x67, 0x2e, 0x64, 0x6c, 0x6c, 0x0a, 0x00, 0x00, 0x00, 0x00, 0x00]),
	"ND_IHM_gantt_update": new Buffer([00, 0x00, 0x02, 0x12, 0x09, 0x00, 0x00, 0x00, 0x00, 0x2d, 0x49, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x3d, 0x01, 0x32, 0x0d, 0x0a, 0x49, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x3d, 0x01, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x69, 0x6e, 0x67, 0x5c, 0x76, 0x36, 0x5c, 0x78, 0x33, 0x69, 0x6c, 0x6f, 0x67, 0x2e, 0x64, 0x6c, 0x6c, 0x0a, 0x00, 0x00, 0x00, 0x00, 0x00]),
...
asyncTest("listenNode -  callilog - test with http request", function(_) {
	...
	var killTimeout = localConfig.plugin.killTimeoutOnCreate = 100; // more than plugin execution
	cvgClient = new CvgClient(_, session, stream, {}, null, context);
	cvgClient.killPluginTimoeut = 12000;
	...
	console.log(" buff " + binaryNode.ND_IHM_gantt_new.toString("hex"));
