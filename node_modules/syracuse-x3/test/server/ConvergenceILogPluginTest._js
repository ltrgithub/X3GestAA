...
asyncTest("listenNode -  callilog - test with http request", function(_) {
	...
	strictEqual(stream2.writed && stream2.writed.toString("hex"), "0000000015756e646566696e65643d01756e646566696e65640a0000000000", "write client reply , notif plugin and client ok");
...
asyncTest("listenNode -  callilog - new gantt/scale", function(_) {
	...
	strictEqual(stream.writed.toString("hex"), "0000000015756e646566696e65643d01756e646566696e65640a0000000000", "data write after receive client ack and plugin ack");
	stream.writed = null;
	...
	// send register to validate the plugin is ok
	strictEqual(stream.writed.toString("hex"), "0000000015756e646566696e65643d01756e646566696e65640a0000000000", "data write after receive plugin ack and timeout apply and after receive client ack");
	stream.writed = null;
