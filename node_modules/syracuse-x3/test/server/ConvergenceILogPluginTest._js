...
function getPlugin(_, cookie, suburl, sessionId, statusCode, fullResponse) {
	var res = adminTestFixtures.get(_, cookie, baseUrl + "/trans/x3/erp/SUPERV/$plugin('" + sessionId + "')/" + suburl, statusCode, fullResponse);
	return res;
}
...
function postPlugin(_, cookie, suburl, sessionId, data, statusCode, fullResponse) {

	return adminTestFixtures.post(_, cookie, baseUrl + "/trans/x3/erp/SUPERV/$plugin('" + sessionId + "')/" + suburl, data, statusCode, fullResponse);
}

function putPlugin(_, cookie, suburl, sessionId, data, statusCode, fullResponse) {
	return adminTestFixtures.put(_, cookie, baseUrl + "/trans/x3/erp/SUPERV/$plugin('" + sessionId + "')/" + suburl, data, statusCode, fullResponse);
}
...
asyncTest("listenNode -  callilog - test with http request", function(_) {
	...
	cvgClient = new CvgClient(_, session, stream2, {}, null, context);
	...
	strictEqual(res, '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":null,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"new","methodId":1,"cookieSess":"syracuse.sid.undefined=; HttpOnly"}}},"session":{"settings":{"mnu":[],"datePivot":1957,"dateOrder":0,"dateSep":"/","thousandSep":",","decimalSep":".","timeSep":":"}},"srvop":{"request":{"id":0,"v":1025,"rqtdist":null,"connect":1,"server":""}}}', "generate reply to the client ND_IHM new ");
	stream2.writed = null;
	...
	flows.sleep(_, 100); // wait proces of node

	ok(true, "get tracker plugin 200 - IHM update gantt");
	res = JSON.stringify(getPlugin(_, cookie, "requestSvc?$trackers=1", cvgSession.sid, 200));
	strictEqual(res, '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":null,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"update","methodId":2}}}}', "get update ND_IHM for the plugin client");
	...
	res = JSON.stringify(getPlugin(_, cookie, "requestSvc?$trackers=2", cvgSession.sid, 200));
	strictEqual(res, '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":null,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"delete","methodId":3}}}}', "check target delete nd_ihm gantt");
	ok(true, "get tracker client - ND_IHM delete ok 200");
	res = JSON.stringify(get(_, cookie, "requestSvc?$trackers=3", cvgSession.sid, 200));
	strictEqual(res, '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":null,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"delete","methodId":3}}},"session":{"settings":{"mnu":[],"datePivot":1957,"dateOrder":0,"dateSep":"/","thousandSep":",","decimalSep":".","timeSep":":"}},"srvop":{"request":{"id":0,"v":1025,"rqtdist":null,"connect":1,"server":""}}}', "check target delete nd_ihm gantt");
	...
	strictEqual(!cvgClient.cvgPlugin[1], true, "no plugin in client after delete ");

	start();
});

asyncTest("listenNode -  callilog - test with http request with callui Download", function(_) {
	var id = "id";
	var clientId = "clientId";
	var session = new Session(null, id, clientId);
	var cookie = adminTestFixtures.getCookie(_, baseUrl, "admin", "admin").join(" ");
	...
	strictEqual(JSON.stringify(res.reply), '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":null,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"new","methodId":1,"download":[{"UIAction":"GetFile","UILocalDir":"Temp","UILocalFile":"test_d_1.txt","UIRemoteFile":"TRT/ZZILOG.src","UIDownLoad":"ILOG"}]}}}}', "validate download is present in reply ");
	// no reply 200 so get again a polling
	ok(true, "get tracker session 202");
	get(_, cookie, "requestSvc?$trackers=2", cvgSession.sid, 202, false);
	...
	strictEqual(JSON.stringify(res.reply), '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":null,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"update","methodId":2,"download":[{"UIAction":"GetFile","UILocalDir":"Temp","UILocalFile":"test_d_1.txt","UIRemoteFile":"TRT/ZZILOG.src","UIDownLoad":"ILOG"}]}}}}', "validate no download  is present in reply (already sent) ");

	stream2.setToRead(binaryNode.ND_SLF_DOWNLOAD);
	flows.sleep(_, 100); //time to be process before set a new node to be process
	...
	flows.sleep(_, 100);
	res = getPlugin(_, cookie, "requestSvc?$trackers=2", cvgSession.sid, 200);
	strictEqual(JSON.stringify(res), '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":null,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"update","methodId":2}}}}', "validate no download  is present in reply (already sent)");
	// notig
	...
	ok(true, "get tracker plugin - ND_IHM delete ok 200");
	res = JSON.stringify(getPlugin(_, cookie, "requestSvc?$trackers=3", cvgSession.sid, 200));
	strictEqual(res, '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":null,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"delete","methodId":3}}}}', "check target delete nd_ihm gantt");
	ok(true, "get tracker client - ND_IHM delete ok 200");
	res = JSON.stringify(get(_, cookie, "requestSvc?$trackers=3", cvgSession.sid, 200));
	strictEqual(res, '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":null,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"delete","methodId":3}}},"session":{"settings":{"mnu":[],"datePivot":1957,"dateOrder":0,"dateSep":"/","thousandSep":",","decimalSep":".","timeSep":":"}},"srvop":{"request":{"id":0,"v":1025,"rqtdist":null,"connect":1,"server":""}}}', "check target delete nd_ihm gantt");
...
asyncTest("listenNode -  http - new gantt  launch plugin with delete ", function(_) {
	var id = "id";
	var clientId = "clientId";
	var session = new Session(null, id, clientId);
	var cookie = adminTestFixtures.getCookie(_, baseUrl, "admin", "admin").join(" ");
...
asyncTest("listenNode -  http - new gantt  launch plugin with download/upload ", function(_) {
	var id = "id";
	var clientId = "clientId";
	var session = new Session(null, id, clientId);
	var cookie = adminTestFixtures.getCookie(_, baseUrl, "admin", "admin").join(" ");
	...
	res = getPlugin(_, cookie, "requestSvc?$trackers=2", cvgSession.sid, 200);
	strictEqual(JSON.stringify(res), '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":null,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"update","methodId":2,"upload":"test_upload_1.txt"}}}}', "check response with upload");
	ok(true, "get tracker session 202");
	...
	ok(true, "get tracker plugin 200 - IHM update gantt");
	res = JSON.stringify(getPlugin(_, cookie, "blobSvc?$trackers=3", cvgSession.sid, 200));
	strictEqual(res, '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":null,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"update","methodId":2,"upload":"test_upload_1.txt"}}}}', "check response with upload");
	...
	ok(true, "get tracker plugin 200 - IHM update gantt");
	res = JSON.stringify(getPlugin(_, cookie, "blobSvc?$trackers=5", cvgSession.sid, 200));
	strictEqual(res, '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":null,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"update","methodId":2,"upload":"test_upload_1.txt"}}}}', "check response with upload");
	...
	ok(true, "get tracker plugin 200 - IHM update gantt");
	res = JSON.stringify(getPlugin(_, cookie, "blobSvc?$trackers=4", cvgSession.sid, 200));
	// send plugin response
	ok(true, "send plugin delete - 200");
	...
	res = JSON.stringify(get(_, cookie, "requestSvc?$trackers=2", cvgSession.sid, 200, false));
	strictEqual(res, '{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":null,"module":"Scheduling\\\\v6\\\\x3ilog.dll","method":"delete","methodId":3}}},"session":{"settings":{"mnu":[],"datePivot":1957,"dateOrder":0,"dateSep":"/","thousandSep":",","decimalSep":".","timeSep":":"}},"srvop":{"request":{"id":0,"v":1081,"rqtdist":null,"connect":1,"server":""}}}', "receive delete after sent action 525 (delete) from plugin");
	...
	flows.sleep(_, 100); // wait proces of node
	res = JSON.stringify(get(_, cookie, "requestSvc?$trackers=3", cvgSession.sid, 200, false));
...
asyncTest("listenNode -  http - new gantt failed launch plugin", function(_) {
	var id = "id";
	var clientId = "clientId";
	var session = new Session(null, id, clientId);
	var cookie = adminTestFixtures.getCookie(_, baseUrl, "admin", "admin").join(" ");
	...
	cvgClient = new CvgClient(_, session, stream2, {}, null, context);
	cvgClient.killPluginTimoeut = 1000;
	cvgSession._cvgClient = cvgClient;
	cvgClient.cdlang = "FRA";
	...
	flows.sleep(_, 2000);
	strictEqual(stream2.writed && stream2.writed.toString("hex"), "00000000203939303d014e015831355832460074696d656f757420657870697265642d310a0000000000", "write client reply , notif plugin and client ok");
	stream2.setToRead(binaryNode.NDOBOXI);

	get(_, cookie, "requestSvc?$trackers=2", cvgSession.sid, 202, false);


	//TODO check with not 200 in unit test get(_, cookie, "requestSvc?$trackers=2", cvgSession.sid, 200, false);
...
asyncTest("listenNode -  callilog - new gantt/scale", function(_) {
	...
	cvgClient.killPluginTimoeut = 2000;
	cvgClient.cdlang = "FRA";
	...
	cvgClient.generateResponse(_, false, false);
	strictEqual(JSON.stringify(cvgClient.response), '{"head":{"statusCode":200},"body":{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":null,"module":"unitTest","method":"new","methodId":1,"cookieSess":"syracuse.sid.undefined=; HttpOnly"}}},"session":{"settings":{"mnu":[],"datePivot":1957,"dateOrder":0,"dateSep":"/","thousandSep":",","decimalSep":".","timeSep":":"}},"srvop":{"request":{"id":0,"v":1,"connect":1,"server":""}}}}', "ND_IHM new gantt client reply ok");
	...
	cvgClient.cvgPlugin.ND_IHM[1].processRequest(_, context, JSON.stringify({
		act: 523,
		param: {
			method: "new",
			plugin: {
	...
	cvgClient.cvgPlugin.ND_IHM["ilog-default"].processRequest(_, context, JSON.stringify({
		act: 523,
		param: {
			method: "new",
	...
	cvgClient.cvgPlugin.ND_IHM[1] && cvgClient.cvgPlugin.ND_IHM[1].timeout && clearTimeout(cvgClient.cvgPlugin.ND_IHM[1].timeout);
...
asyncTest("listenNode -  callilog - update gantt/scale", function(_) {
	...
	cvgClient = new CvgClient(_, session, stream, {}, null, context);
	cvgClient.killPluginTimoeut = 100;
	...
	cvgClient.generateResponse(_, false, false);
	strictEqual(JSON.stringify(cvgClient.response), '{"head":{"statusCode":200},"body":{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"scale","type":"asynchronous","id":12,"module":"unitTest","method":"new","methodId":6,"cookieSess":"syracuse.sid.undefined=; HttpOnly"}}},"session":{"settings":{"mnu":[],"datePivot":1957,"dateOrder":0,"dateSep":"/","thousandSep":",","decimalSep":".","timeSep":":"}},"srvop":{"request":{"id":0,"v":1,"connect":1,"server":""}}}}', "ND_IHM new scale");
	...
	cvgClient.cvgPlugin.ND_IHM["ilog-default"].generateResponse(_, false, false);
	strictEqual(JSON.stringify(cvgClient.cvgPlugin.ND_IHM["ilog-default"].response), '{"head":{"statusCode":200},"body":{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":12,"module":"unitTest","method":"update","methodId":2}}}}}', "ND_IHM update gantt, target plugin serialized in response to plugin client");
	...
	cvgClient.cvgPlugin.ND_IHM["ilog-default"].generateResponse(_, false, false);
	strictEqual(JSON.stringify(cvgClient.cvgPlugin.ND_IHM["ilog-default"].response), '{"head":{"statusCode":200},"body":{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"scale","type":"asynchronous","id":12,"module":"unitTest","method":"update","methodId":7}}}}}', "ND_IHM update gantt, target plugin serialized in response to plugin client");
	...
	cvgClient.cvgPlugin.ND_IHM["ilog-default"].generateResponse(_, false, false);
	strictEqual(JSON.stringify(cvgClient.cvgPlugin.ND_IHM["ilog-default"].response), '{"head":{"statusCode":200},"body":{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"gantt","type":"asynchronous","id":12,"module":"unitTest","method":"delete","methodId":3}}}}}', "ND_IHM update gantt, target plugin serialized in response to plugin client");
	...
	cvgClient.cvgPlugin.ND_IHM["ilog-default"].generateResponse(_, false, false);
	strictEqual(JSON.stringify(cvgClient.cvgPlugin.ND_IHM["ilog-default"].response), '{"head":{"statusCode":200},"body":{"sap":{"target":{"type":"plugin","plugin":{"class":"ILOG","name":"scale","type":"asynchronous","id":12,"module":"unitTest","method":"delete","methodId":8}}}}}', "ND_IHM update gantt, target plugin serialized in response to plugin client");
	...
	cvgClient.cvgPlugin.ND_IHM["ilog-default"] && cvgClient.cvgPlugin.ND_IHM["ilog-default"].timeout && clearTimeout(cvgClient.cvgPlugin.ND_IHM["ilog-default"].timeout);
