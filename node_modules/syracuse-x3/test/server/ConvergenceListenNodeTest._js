...
asyncTest("listenSendingArgs ", function(_) {
	...
	var param = ["1077", "BbA", "7~test1~est38~~ãbc^7~test2^7~test3^7~test4"];
	cvgClient.activeRequest.listenActionArgsDOLEFTLISTLINE(cvgClient, param);
	strictEqual(JSON.stringify(param), '["1077","B,@,@",[{"type":7,"value":"test1~est38~~ãbc"},{"type":7,"value":"test2"},{"type":7,"value":"test3"},{"type":7,"value":"test4"}]]', " select element where key contains '~' character");
