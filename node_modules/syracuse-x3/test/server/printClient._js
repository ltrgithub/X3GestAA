...
<<<<<<< HEAD
asyncTest("AllPrinter", 5, function(_) {
	var cli = new PrintClient(_, "ecchambard-001", 1890);
	strictEqual(cli.pid != null && cli.pid >= 0 , true, "pid: "+cli.pid);
	var comm = cli.communicator;
	comm.send_ND_DISPLAYALLPRINTER(_);
	cli._disconnect(_);
	start();
});
...
asyncTest("GetState on unknow Job", 2, function(_) {
=======
asyncTest("GetResult on unknow Job", 2, function(_) {
>>>>>>> 087c576862418e5767adc92f7648d14510db4cb0
	var cli = new PrintClient(_, "ecchambard-001", 1890);
