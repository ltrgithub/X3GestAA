...
var Representation = function(_repName) {
  ...
  this.setup = function(_) {
    ...
    var url  = x3Helper.x3Url(this.repName+"(%27%27)/$services/SETUP?representation="+this.repName+".$query&trackingId="+this.uuid);
  ...
  this.query = function(_,_param) {
    ...
    if(typeof(_param)== 'undefined') {
      var data = x3Helper.get(_, _getCookie(_), x3Helper.x3Url(this.repName+"?representation="+this.repName+".$query"), 200);
    } else if (typeof(_param)== 'string') {   
      var data = x3Helper.get(_, _getCookie(_), x3Helper.x3Url(this.repName+"?representation="+this.repName+".$query"+_param), 200);
     } else if (typeof(_param)== 'number') {   
      var data = x3Helper.get(_, _getCookie(_), x3Helper.x3Url(this.repName+"?representation="+this.repName+".$query"), _param);
     } 
...
function testAQCQRY01(_) {
  ...
  asyncTest("AQCQRY01 - setup", function(_) {
   ...
   asyncTest("AQCQRY01(FIELD01 asc) - first page", function(_) {
    ...
    strictEqual(query.$links.$next.$url,'{$baseUrl}/AQCQRY01?representation=AQCQRY01.$query&key=gt.F1_020&orderBy=FIELD01',query.$links.$next.$url) 
  ...
  asyncTest("AQCQRY01(asc) - second page", function(_) {
    ...
    strictEqual(query.$links.$previous.$url,'{$baseUrl}/AQCQRY01?representation=AQCQRY01.$query&key=lt.F1_021&orderBy=FIELD01',query.$links.$previous.$url) 
    strictEqual(query.$links.$next.$url    ,'{$baseUrl}/AQCQRY01?representation=AQCQRY01.$query&key=gt.F1_040&orderBy=FIELD01',query.$links.$next.$url) 
  ...
  asyncTest("AQCQRY01(FIELD01 asc) - last page", function(_) {
    ...
    strictEqual(query.$links.$previous.$url,'{$baseUrl}/AQCQRY01?representation=AQCQRY01.$query&key=lt.F1_081&orderBy=FIELD01',query.$links.$previous.$url) 
  ...
  asyncTest("AQCQRY01(FIELD01 asc) - penultimate page", function(_) {
    ...
    strictEqual(query.$links.$previous.$url,'{$baseUrl}/AQCQRY01?representation=AQCQRY01.$query&key=lt.F1_061&orderBy=FIELD01',query.$links.$previous.$url) 
    strictEqual(query.$links.$next.$url    ,'{$baseUrl}/AQCQRY01?representation=AQCQRY01.$query&key=gt.F1_080&orderBy=FIELD01',query.$links.$next.$url) 
    key =  getkey(query.$links.$next.$url);
 ...
 asyncTest("AQCQRY01(FIELD01 desc) - first page", function(_) {
    ...
    strictEqual(query.$links.$next.$url,'{$baseUrl}/AQCQRY01?representation=AQCQRY01.$query&key=lt.F1_081&orderBy=FIELD01 desc',query.$links.$next.$url) 
    strictEqual(false,("$previous" in query.$links),"$previous");  
    key =  getkey(query.$links.$next.$url);
  ...
  asyncTest("AQCQRY01(FIELD01 desc) - second page", function(_) {
    ...
    strictEqual(query.$links.$previous.$url,'{$baseUrl}/AQCQRY01?representation=AQCQRY01.$query&key=gt.F1_080&orderBy=FIELD01 desc',query.$links.$previous.$url) 
    strictEqual(query.$links.$next.$url    ,'{$baseUrl}/AQCQRY01?representation=AQCQRY01.$query&key=lt.F1_061&orderBy=FIELD01 desc',query.$links.$next.$url) 
    key =  getkey(query.$links.$previous.$url);
    start(); 
  });  
  ...
  asyncTest("AQCQRY01(FIELD01 desc) - last page", function(_) {
    ...
    strictEqual(query.$links.$previous.$url,'{$baseUrl}/AQCQRY01?representation=AQCQRY01.$query&key=gt.F1_020&orderBy=FIELD01 desc',query.$links.$previous.$url) 
    strictEqual(false,("$next" in query.$links),"$previous");  
    key =  getkey(query.$links.$previous.$url);
  ...
  asyncTest("AQCQRY01(FIELD01 desc) - penultimate page", function(_) {
    ...
    strictEqual(query.$links.$previous.$url,'{$baseUrl}/AQCQRY01?representation=AQCQRY01.$query&key=gt.F1_040&orderBy=FIELD01 desc',query.$links.$previous.$url) 
    strictEqual(query.$links.$next.$url    ,'{$baseUrl}/AQCQRY01?representation=AQCQRY01.$query&key=lt.F1_021&orderBy=FIELD01 desc',query.$links.$next.$url) 
    key =  getkey(query.$links.$next.$url);
  ...
  asyncTest("AQCQRY01(FIELD02 asc) - back to first page", function(_) {
   ...
   asyncTest("AQCQRY01 - (FIELD01 like 'F1_01%')", function(_) {
    var representation = new  Representation("AQCQRY01");
    var query = representation.query(_,"&where=(FIELD01%20like%20'F1_01%25')");
    var count=20;
  ...
  asyncTest("AQCQRY01 - (FIELD01 between 'F1_020' and 'F1_035')", function(_) {
    var representation = new  Representation("AQCQRY01");
    var query = representation.query(_,"&where=(FIELD01%20between%20'F1_020'%20and%20'F1_035')");
...
function testAQCQRY02(_) {
  ...
  asyncTest("AQCQRY02 - setup", function(_) {
   ...
   asyncTest("AQCQRY02(FIELD01 asc) - first page", function(_) {
    ...
    strictEqual(query.$links.$next.$url,'{$baseUrl}/AQCQRY02?representation=AQCQRY02.$query&key=gt.20&orderBy=FIELD01',query.$links.$next.$url) 
    strictEqual(false,("$previous" in query.$links),"$previous"); 
    start(); 
  });  
  ...
  asyncTest("AQCQRY02(asc) - second page", function(_) {
    ...
    strictEqual(query.$links.$previous.$url,'{$baseUrl}/AQCQRY02?representation=AQCQRY02.$query&key=lt.21&orderBy=FIELD01',query.$links.$previous.$url) 
    strictEqual(query.$links.$next.$url    ,'{$baseUrl}/AQCQRY02?representation=AQCQRY02.$query&key=gt.40&orderBy=FIELD01',query.$links.$next.$url) 
    key =  getkey(query.$links.$previous.$url);
  ...
  asyncTest("AQCQRY02(FIELD01 asc) - last page", function(_) {
    ...
    strictEqual(query.$links.$previous.$url,'{$baseUrl}/AQCQRY02?representation=AQCQRY02.$query&key=lt.81&orderBy=FIELD01',query.$links.$previous.$url) 
    strictEqual(false,("$next" in query.$links),"$previous");  
    key =  getkey(query.$links.$previous.$url);
  ...
  asyncTest("AQCQRY02(FIELD01 asc) - penultimate page", function(_) {
    ...
    strictEqual(query.$links.$previous.$url,'{$baseUrl}/AQCQRY02?representation=AQCQRY02.$query&key=lt.61&orderBy=FIELD01',query.$links.$previous.$url) 
    strictEqual(query.$links.$next.$url    ,'{$baseUrl}/AQCQRY02?representation=AQCQRY02.$query&key=gt.80&orderBy=FIELD01',query.$links.$next.$url) 
    key =  getkey(query.$links.$next.$url);
 ...
 asyncTest("AQCQRY02(FIELD01 desc) - first page", function(_) {
    ...
    strictEqual(query.$links.$next.$url,'{$baseUrl}/AQCQRY02?representation=AQCQRY02.$query&key=lt.81&orderBy=FIELD01 desc',query.$links.$next.$url) 
    strictEqual(false,("$previous" in query.$links),"$previous");  
    key =  getkey(query.$links.$next.$url);
  ...
  asyncTest("AQCQRY02(FIELD01 desc) - second page", function(_) {
    ...
    strictEqual(query.$links.$previous.$url,'{$baseUrl}/AQCQRY02?representation=AQCQRY02.$query&key=gt.80&orderBy=FIELD01 desc',query.$links.$previous.$url) 
    strictEqual(query.$links.$next.$url    ,'{$baseUrl}/AQCQRY02?representation=AQCQRY02.$query&key=lt.61&orderBy=FIELD01 desc',query.$links.$next.$url) 
    key =  getkey(query.$links.$previous.$url);
    start(); 
  });  
  ...
  asyncTest("AQCQRY02(FIELD01 desc) - last page", function(_) {
    ...
    strictEqual(query.$links.$previous.$url,'{$baseUrl}/AQCQRY02?representation=AQCQRY02.$query&key=gt.20&orderBy=FIELD01 desc',query.$links.$previous.$url) 
    strictEqual(false,("$next" in query.$links),"$previous");  
    key =  getkey(query.$links.$previous.$url);
  ...
  asyncTest("AQCQRY02(FIELD01 desc) - penultimate page", function(_) {
    ...
    strictEqual(query.$links.$previous.$url,'{$baseUrl}/AQCQRY02?representation=AQCQRY02.$query&key=gt.40&orderBy=FIELD01 desc',query.$links.$previous.$url) 
    strictEqual(query.$links.$next.$url    ,'{$baseUrl}/AQCQRY02?representation=AQCQRY02.$query&key=lt.21&orderBy=FIELD01 desc',query.$links.$next.$url) 
    key =  getkey(query.$links.$next.$url);
...
function testAQCQRY03(_) {
  ...
  asyncTest("AQCQRY03 - setup", function(_) {
   ...
   asyncTest("AQCQRY03 - orderBy=FIELD02%20desc", function(_) {
    var representation = new  Representation("AQCQRY03");
    var date = new Date();
    var query = representation.query(_,'&orderBy=FIELD02%20desc')//&where=FIELD02%20lt%20'+date.toISOString());
    
    for (var i=0;i<10;i++){
      strictEqual(query.$resources[i].FIELD01%10,0,"FIELD01."+i+"="+query.$resources[i].FIELD01); 
    } 
    start(); 
  });  

   asyncTest("AQCQRY03 - FIELD02 <= (date-1)", function(_) {
    var representation = new  Representation("AQCQRY03");
    var date = new Date();
    var query = representation.query(_,'&key=lt.'+date.toISOString().substring(0,10)+'T00:00:00Z&orderBy=FIELD02%20desc')//&where=FIELD02%20lt%20'+date.toISOString());
