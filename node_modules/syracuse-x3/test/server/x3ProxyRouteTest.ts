...
var endPoint = testAdmin.modifyCollaborationEndpoint("collaboration_test");
...
describe(module.id, () => {
	...
	it('init database', function(_) {
		...
		var db = testAdmin.newMongoDb(endPoint.datasets["collaboration_test"].database, server, {});
		db = db.open(_);
		db.dropDatabase(_);
		//
	...
	it('x3 endpoint route', function(_) {
		requestCount++;
		var body;
		cookie = getCookie(_);
