...
asyncTest("init", 1, function() {
	require('streamline/lib/globals').context = {};
...
test("string c directive", 26, function() {
	...
	testFormatErr('fr', 'K:3c', '222', 'Test Unexpected format char \'c\'',true ,{skipBadDynFmt : false});
	// skipBadDynFmt = true - returns parameter's value
	testOptions('K:3c', false, '222', '222',{skipBadDynFmt : true});
});
...
test("Strict mode", 24, function() {
	...
	testFormatErr('fr', "X+-03z:8.2#", '+12', 'Unexpected format character', true, {skipBadFormat : false});
	testOptions("X+-03z:8.2#", true, '12', '12', true);
	testOptions("X+-03z:8.2#", false,  "+12", "+12");	
	// #553 for dates
	testFormatErr('fr', "D:JJ[/]MM[/]AAAA", '+12', 'Unexpected format character', true, {skipBadFormat : false});
