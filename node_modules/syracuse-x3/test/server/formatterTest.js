...
function newFormatter(opts,lang) {
	...
	var fmtr = new CvgFormatter(options);
	fmtr.typeDate=typeDate;
	return fmtr;
}
...
function testEditToDisplay(lang, fmt, value, expected, opts, srvVal) {
	...
	try{
		...
		strictEqual(got, expected, fmt + " : Edit: " + formatter.getFormatEdit(fmt) +": '" + value + "' -> '" + got + "' - dateOrder: " + formatter.typeDate);
	} catch (ex) {
		ok( false,"Ko : formatEditToDisplay Error : fmt:" + fmt + " : value:'" + value + "' :" + ex.message +  " : expected:'" + expected + "' - dateOrder: " + formatter.typeDate);
	}	
}
...
function testBadEditToDisplay(lang, fmt, value, message, opts, srvVal) {
	...
	try{
		var got=formatter.formatEditToDisplay(new CvgFormat(fmt), value, srvVal);
		ok( false, fmt + " : Edit: " + formatter.getFormatEdit(fmt) + " : '" + value  + "'->'" + got + "' : formatEditToDisplay Ok : Unexpected valid operation : " + message  + " - dateOrder: " + formatter.typeDate);
	} catch (ex) {
		ok( true,  fmt + " : Edit: " + formatter.getFormatEdit(fmt) + " : '"  + value + "' : formatEditToDisplay Ko : Error expected : "  + message + " - errMsg: " + ex.message + " - dateOrder: " + formatter.typeDate);
	}	
}
...
test("Parse user input value ", 44 , function() {
