...
// !!!!! IF RE ENABLE IT, PLEASE PASS x3solution instance in config object and call init(_)
// var client = x3Client.create(config).init(_); // MUST BE DONE IN ASYNCHRONOUS FUNCTION !!!
