...
it('test without folder  ', function() {
	var sadFsqFile = new SadFsqFile({
		name: "zzvposys_37298203",
		extension: "tra",
		path: "/tmp"
...
it('test with describer that is a pathfile   ', function() {
	var sadFsqFile = new SadFsqFile({
...
it('test with path name and extension  ', function() {
	var sadFsqFile = new SadFsqFile({
		path: "C:/",
		name: "AEXP1",
		extension: "json"
