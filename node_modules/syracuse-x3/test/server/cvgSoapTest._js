...
asyncTest("Ws Classic Soap Client -  connect / disconnect ", function(_) {
	...
	strictEqual(cli.isAlive() !== null, true, "client connected ok");

	console.log(JSON.stringify(cli._x3SessionSettings, null, 2));
	strictEqual(cli._x3SessionSettings.ADXLangIso, "fr-FR", "client langue");
	strictEqual(cli._x3SessionSettings.cdLang, "FRA", "client langue");
	...
	strictEqual(cli.isAlive() !== null, false, "client disconnected ok");
