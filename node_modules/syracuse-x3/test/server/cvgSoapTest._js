...
it('Ws Classic Soap Client -  connect / disconnect ', function(_) {
	...
	var cli = new CvgClientWS().init(_, context, wsCall.context, recOptions);
	...
	cli = new CvgClientWS().init(_, context, wsCall.context, recOptions);
	strictEqual(cli.stream !== null, true, "client connected ok");
	...
	try {
		...
		cli = new CvgClientWS().init(_, context, wsCall.context);
...
it('Ws Classic Soap Client -  call sub program', function(_) {
...
it('Ws Classic Soap Client -  technical Subprogram', function(_) {
	recOptions.fileName = "cvgClientWS_techsubprogs_1.json";
	var res;
	var wsCall = new WsCall().init({
		name: "QLFWSADD"
	});
	...
	recOptions.fileName = "cvgClientWS_techsubprogs_2.json";
	cli = new CvgClientWS().init(_, context, wsCall.context, recOptions);
	...
	recOptions.fileName = "cvgClientWS_techsubprogs_3.json";
	cli = new CvgClientWS().init(_, context, wsCall.context, recOptions);
	...
	recOptions.fileName = "cvgClientWS_techsubprogs_4.json";
	cli = new CvgClientWS().init(_, context, wsCall.context, recOptions);
	try {
	...
	recOptions.fileName = "cvgClientWS_techsubprogs_5.json";
	cli = new CvgClientWS().init(_, context, wsCall.context, recOptions);
	try {
	...
	recOptions.fileName = "cvgClientWS_techsubprogs_6.json";
	cli = new CvgClientWS().init(_, context, wsCall.context, recOptions);
	...
	recOptions.fileName = "cvgClientWS_techsubprogs_7.json";
	wsCall = new WsCall().init({
		name: "QLFWSADD"
	});
	wsCall.context = ctx;
	...
	recOptions.fileName = "cvgClientWS_techsubprogs_8.json";
	cli = new CvgClientWS().init(_, context, wsCall.context, recOptions);
	wsCall = new WsCall().init({
		name: "QLFWSADD"
	});
