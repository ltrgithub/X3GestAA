...
asyncTest("Ws Classic Soap Client -  connect / disconnect ", function(_) {
	...
	var cli = new CvgClientWS(_, context.endpoint(_), context.user(_), "fr-FR", context);
	...
	var cli = new CvgClientWS(_, context.endpoint(_), context.user(_), "en-US", context);
	strictEqual(cli.stream !== null, true, "client connected ok");
	...
	// failed bad endpoint
	try {
		cli = new CvgClientWS(_, context.endpointBidon(_), context.user(_), "en-US", context);
	...
	// failed bad user
	cli = new CvgClientWS(_, context.endpoint(_), context.userBidon(_), "en-US", context);
...
asyncTest("Ws Classic Soap Client -  call sub program", function(_) {
	var cli = new CvgClientWS(_, context.endpointSUPERV(_), context.user(_), "en-US", context);
	...
	strictEqual(JSON.stringify(reply), '', " reply QLFWSSLP:DOSLEEP ok");
