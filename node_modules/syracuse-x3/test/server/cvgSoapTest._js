...
//	cli = new CvgClientWS().init(_, context, recOptions);
//	try {
//		res = cli._changeLogin(_, "AP", "ENG", new TechInfo());
...
//	cli = new CvgClientWS().init(_, context, recOptions);
//	try {
//		res = cli._changeLogin(_, "TCA", "ENG", new TechInfo());
...
//	cli = new CvgClientWS().init(_, context, recOptions);
//	try {
//		res = cli._changeLogin(_, "AP", "FRI", new TechInfo());
...
//	var wsCall = new CvgWSCall(techInfo, "FRA", {name:"QLFWSADD"});
//	
//	var decription = cli._getDescription(_, wsCall, techInfo);
//
...
//
//	cli = new CvgClientWS().init(_, context, recOptions);
//	wsCall = new CvgWSCall(techInfo, "FRA", {name:"QLFWSADD"});
//	var techinfo = new TechInfo();
//	try  {
//		cli._recupHDAT(_, wsCall, "33333333333333", techinfo);
//	} catch(e) {
//		if (e instanceof CvgWsException) {
//			ok(true, "bad timestamp, update description to check");
//		}
//	}
//	
...
//	cli._getDescription = function(_, wsCall, techInfo, ignoreCache) {
