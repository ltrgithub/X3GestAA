...
var adxwhat = require('../../lib/clients/adxwhat/adxwhatClient');
...
describe(module.id, () => {
	...
	var whatUnitConfig = config.x3adxwhat && config.x3adxwhat.qunit || {};
	var connCtx = {
		hostname: whatUnitConfig.server ? whatUnitConfig.server : "aws-x3-devsup",
	...
	it('Get environment variables', function(_) {
