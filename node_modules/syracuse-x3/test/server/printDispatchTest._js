...
var jobData1 = {
	...
	"__wJobID": "GX3APP-1476659-20150311175644-37",
	"+STATE": "LAUNCHED",
	"+OUT": "DISPLAY",
	"__wJobRank": "16",
	...
	"__CDUSER": "AP",
	"__ADXSOL": "X3DVLP",
	"__APPLICATION": "GX3APP;aws-x3-devx3;2050",
	"__APPRPT": "GX3APP;aws-x3-devx3;2050",
	"__RPTLAN": "FRA",
	"X3DOS": "GX3APP;aws-x3-devx3;2050;150;FRA",
	"__JOBLINKED": "",
	"__REQUETE": "25561900",
	"_Orientation": "0",
	"_PaperSize": "44",
...
function httpRequest(_, method, url, heads, buffer) {
	cookie = getCookie(_, baseUrl);
	var head = {
		cookie: cookie,
		"unittest": recOptions.recMode
	};
...
asyncTest("filePut / fileDelete  operation", function(_) {
	...
	httpRequest(_, "PUT", "/print/" + printHostname + ":" + printPort + "/$filePut('UNIT_TEST')?fileName=qunit-test-dispatcher.txt&location=" + filesLoc[0], {
		"accept": "application/json",
		"content-type": "application/json"
	}, new Buffer("unit test dispatcher upload", "utf8"));
	strictEqual(statusCode, 204, "Status code OK: " + statusCode);

	httpRequest(_, "PUT", "/print/" + printHostname + ":" + printPort + "/$filePut('UNIT_TEST')?fileName=qunit-test-dispatcher.txt&location=bid", {
		"accept": "application/json",
		"content-type": "application/json"
	}, new Buffer("unit test dispatcher upload", "utf8"));
	strictEqual(statusCode, 500, "Status code OK: " + statusCode);
	...
	httpRequest(_, "DELETE", "/print/" + printHostname + ":" + printPort + "/$filePut('UNIT_TEST')?fileName=qunit-test-dispatcher.txt&location=" + filesLoc[0], {
		"accept": "application/json",
		"content-type": "application/json"
	}, new Buffer("unit test dispatcher upload", "utf8"));
	strictEqual(statusCode, 204, "Status code OK: " + statusCode);

	httpRequest(_, "DELETE", "/print/" + printHostname + ":" + printPort + "/$filePut('UNIT_TEST')?fileName=qunit-test-dispatcher.txt&location=bid", {
		"accept": "application/json",
		"content-type": "application/json"
	}, new Buffer("unit test dispatcher upload", "utf8"));
	strictEqual(statusCode, 500, "Status code OK: " + statusCode);
