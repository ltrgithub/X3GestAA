...
asyncTest("filePut / fileDelete  operation", function(_) {
	...
	httpRequest(_, "PUT", "/print/" + printHostname + ":" + printPort + "/$fileSvc('UNIT_TEST')?fileName=qunit-test-dispatcher.txt&location=" + filesLoc[0], {
		"accept": "application/json",
		"content-type": "application/json"
	}, new Buffer("unit test dispatcher upload", "utf8"));
	strictEqual(statusCode, 204, "Status code OK: " + statusCode);

	httpRequest(_, "PUT", "/print/" + printHostname + ":" + printPort + "/$fileSvc('UNIT_TEST')?fileName=qunit-test-dispatcher.txt&location=bid", {
		"accept": "application/json",
		"content-type": "application/json"
	}, new Buffer("unit test dispatcher upload", "utf8"));
	strictEqual(statusCode, 500, "Status code OK: " + statusCode);
	...
	httpRequest(_, "DELETE", "/print/" + printHostname + ":" + printPort + "/$fileSvc('UNIT_TEST')?fileName=qunit-test-dispatcher.txt&location=" + filesLoc[0], {
		"accept": "application/json",
		"content-type": "application/json"
	}, new Buffer("unit test dispatcher upload", "utf8"));
	strictEqual(statusCode, 204, "Status code OK: " + statusCode);
