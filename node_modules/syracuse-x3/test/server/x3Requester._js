...
function testPrototypeAQCREQ3() {
	asyncTest("Requester-Prototype" + x3Helper.gitHubIssue(5975), function(_) {
		//console.log("Test");
...
function testPayloadAQCREQ3() {
	asyncTest("Requester-Payload" + x3Helper.gitHubIssue(5975), function(_) {
		//console.log("Test");
...
function _checkRequesterPayloadAQCREQ1_1(_, query, facet) {
	...
	var i;
	for (i = 0; i < payload.$totalResults; i++) {
		console.log(i + " " + payload.$totalResults);
		ok("line_no(" + payload.$resources[i].line_no + ")", "line_no(" + i + ")");
	}
	ok("CRY(0)=" + payload.$resources[0].CRY, "CRY(0)=AN");
	ok("CRY(1)=" + payload.$resources[1].CRY, "CRY(1)=AR");
	ok("CRY(6)=" + payload.$resources[6].CRY, "CRY(6)=FR");
...
function testPayloadAQCREQ1() {
	asyncTest("Requester-Payload" + x3Helper.gitHubIssue(5975), function(_) {
		//console.log("Test");
		_checkRequesterPayloadAQCREQ1_1(_, "AQCREQ1");
		start();
	});
}
