...
var Representation = function(_repName) {
	...
	this.setProperties = function(_, _delta, _isDisabled, _status) {
		...
		var response;
		ok(true, "DBG setProperties url:" + _delta.$url);
	...
	this.save = function(_, _property, _status) {
		...
		ok(true, "DBG delete response:" + JSON.stringify(rdelete));
...
function testAQCPROC01(_) {
	...
	asyncTest("AQCPROC01 - SAM 89053 (Unexpected end of session while editing an entity) :", function(_) {
		...
		//Delete the session
		apsadx.delete(_, users.$resources[0].ID, 200);
