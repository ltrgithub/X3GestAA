...
function testAQCPROC05(_) {
  asyncTest("AQCPROC05 - Create OK (1 line)", function(_) {
    ...
    representation.setProperties(_,{"AQCP05COL":[{"$index":0,"$uuid": uuid,"C05P03": refId,"C05P03_REF": {"INTDES":"","INTSHO":""}}]}); 
     var response = representation.save(_);
  ...
  asyncTest("AQCPROC05 - Create OK (2 lines)", function(_) {
    ...
    representation.setProperties(_,{"AQCP05COL":[{"$index":1,"$uuid": uuid,"C05P03": refId,"C05P03_REF": {"INTDES":"","INTSHO":""}}]}); 
    var response = representation.save(_);
  ...
  asyncTest("AQCPROC05 - CRUD OK (1 line)", function(_) {
    ...
    /*dbg*/ok("update",JSON.stringify(response)); 
    refId = "R01P01_02";
    representation2.setProperties(_,{"AQCP05COL":[{"$index":0,"$uuid": response.AQCP05COL[0].$uuid,"C05P03": refId,"C05P03_REF": {"INTDES":"","INTSHO":""}}]}); 
    response = representation2.save(_);
    data = representation2.read(_,id);
    /*dbg*///ok("save",JSON.stringify(data)); 
    strictEqual(data.AQCP05COL.length,1,"AQCP05COL length=1");
  ...
  asyncTest("AQCPROC05 - CRUD OK (2 lines)", function(_) {
    ...
    //Modify the second line
    refId = "R01P01_04";
    representation2.setProperties(_,{"AQCP05COL":[{"$index":1,"$uuid": response.AQCP05COL[1].$uuid,"C05P03": refId,"C05P03_REF": {"INTDES":"","INTSHO":""}}]}); 
    response = representation2.save(_);
...
function testAQCPROC06(_) {
  asyncTest("AQCPROC06 - Create OK", function(_) {
    var id      = "QUNIT_001";
...
function testAQCPROC08(_) {
  ...
  asyncTest("AQCPROC08 - Create NOK (issue #1331)", function(_) {
    var id      = "QUNIT_002";
