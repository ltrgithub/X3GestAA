...
module(config.QLF.folder+".x3Deltas", {
	setup: function() {},
	teardown: function() {
		if (doStop) {
			setTimeout(function() {
...
var Representation = function(_repName) {
  ...
  this.update = function(_,_key,_delta) {
    ...
    if(typeof(_delta)== 'undefined') {
      ...
      ok(true,"DBG update url:"+url);
      ok(true,"DBG update delta:"+JSON.stringify(_delta));
      this.workingCopy = x3Helper.post(_, _getCookie(_),url,_delta,200); 
      ok(true,"DBG update delta response:"+JSON.stringify(this.workingCopy));
  }
  ...
  this.setProperties = function(_,_delta,_isDisabled,_status) {
    ...
    /*dbg*/ok(true,"setProperties:"+JSON.stringify(_delta));
    var response;
    var status = (typeof(_status) == 'undefined')? 200 : _status;
    //!ok("setProperties","setProperties status:"+status);
    response = x3Helper.put(_, _getCookie(_),_delta.$url,_delta,status);
    /*dbg*/ok(true,"setProperties:"+JSON.stringify(response));
  ...
  this.save = function(_,_property,_status) {
    ...
    /*dbg*/ok(true,"DBG save url:"+url);
    /*dbg*/ok(true,"DBG save response:"+JSON.stringify(response));    
    if(_property == null) {
  ...
  this.read = function(_,_key) {
    ...
    /*dbg*/ok(true,"DBG read:"+JSON.stringify(data));
    return data;
  }
  ...
  this.query = function(_,_query) {
    ...
    /*dbg*///ok("query","query:"+JSON.stringify(data));
    return data;
  }
}
...
function testAQCPROR01(_) {
  asyncTest("AQCPROR01 - Create OK", function(_) {
    function create(_,id1,num) {
      ...
      representation.setProperties(_,{"R01P01":id1}); 
      representation.setProperties(_,{"INTDES" :"INTDES " +num}); 
      representation.setProperties(_,{"INTSHO" :"INTSHO " +num}); 
    ...
    function read(_,id1,num) {
      ...
      strictEqual(data.R01P01         ,id1            ,"R01P01="+id1);
...
function testAQCPROC01(_) {
  asyncTest("AQCPROC01 - CRUD OK", function(_) {
    ...
    //set the reference :
    var refId = "R01P01_01";
    representation.setProperties(_,{"C01P02": refId,"C01P02_REF":{}}); 
    //Save the instance
    var response = representation.save(_);
  ...
  asyncTest("AQCPROC01 - SAM 89053 (Unexpected end of session while editing an entity) :", function(_) {
    ...
    representation.create(_);
    representation.setProperties(_,{"C01P01":id}); 
    representation.setProperties(_,{"PROPERTY":property}); 
    //set the reference :
    var refId = "R01P01_01";
    representation.setProperties(_,{"C01P02": refId,"C01P02_REF":{}}); 
    //Save the instance
    ...
    var users = apsadx.query(_,"&where=(DOSSIER%20eq%20%27SUPERV%27)%20and%20(USER%20eq%20%27"+config.QLF.user+"%27)&count=100");
    ...
    //Delete the session
    apsadx.delete(_,users.$resources[0].ID,500);
    
    property = "AFTER"            
    representation.setProperties(_,{"PROPERTY":property},null,404); 
...
function testAQCPROC02(_) {
  asyncTest("AQCPROC02 - CRUD OK", function(_) {
    ...
    representation.setProperties(_,{"C02P02": refId1,"C02P02_REF":{}}); 
    representation.setProperties(_,{"C02P03": refId2,"C02P02_REF":{}}); 
    var response = representation.save(_);
    ...
    refId1 = "R01P01_03";
    refId2 = "R01P01_04";
    representation2.setProperties(_,{"C02P02": refId1,"C02P02_REF":{}}); 
    representation2.setProperties(_,{"C02P03": refId2,"C02P02_REF":{}}); 
...
function testAQCPROC03(_) {
  asyncTest("AQCPROC03 - Create OK (1 line)", function(_) {
    ...
    representation.setProperties(_,{"AQCP03COL":[{"$index":0,"$uuid": uuid}]}); 
    representation.setProperties(_,{"AQCP03COL":[{"$index":0,"$uuid": uuid,"C03P02": lineId}]}); 
    representation.setProperties(_,{"AQCP03COL":[{"$index":0,"$uuid": uuid,"C03P03": refId,"C03P03_REF": {"INTDES":"","INTSHO":""}}]}); 
    var response = representation.save(_);
  ...
  asyncTest("AQCPROC03 - Create OK (2 lines)", function(_) {
    ...
    representation.setProperties(_,{"AQCP03COL":[{"$index":1,"$uuid": uuid}]}); 
    representation.setProperties(_,{"AQCP03COL":[{"$index":1,"$uuid": uuid,"C03P02": lineId}]}); 
    representation.setProperties(_,{"AQCP03COL":[{"$index":1,"$uuid": uuid,"C03P03": refId,"C03P03_REF": {"INTDES":"","INTSHO":""}}]}); 
    var response = representation.save(_);
  ...
  asyncTest("AQCPROC03 - Create OK (4 lines)"+x3Helper.gitHubIssue(1350) , function(_) {
    ...
    var  col = [
    {"C03P02":101         ,"C03P03":"R01P01_01","$uuid" :helpers.uuid.generate()},
    {"C03P02":102         ,"C03P03":"R01P01_02","$uuid" :helpers.uuid.generate()},
    {"C03P02":103         ,"C03P03":"R01P01_03","$uuid" :helpers.uuid.generate()},
    {"C03P02":104         ,"C03P03":"R01P01_04","$uuid" :helpers.uuid.generate()}];
    
    var i=0    
    representation.setProperties(_,{"AQCP03COL":[{"$index":0,"$uuid": col[i].$uuid,"C03P02": col[i].C03P02,"C03P03": col[i].C03P03,"C03P03_REF": {}}]}); 
    representation.setProperties(_,{"AQCP03COL":[{"$index":0,"$uuid": col[++i].$uuid,"C03P02": col[i].C03P02,"C03P03": col[i].C03P03,"C03P03_REF": {}}]}); 
    representation.setProperties(_,{"AQCP03COL":[{"$index":0,"$uuid": col[++i].$uuid,"C03P02": col[i].C03P02,"C03P03": col[i].C03P03,"C03P03_REF": {}}]}); 
    representation.setProperties(_,{"AQCP03COL":[{"$index":0,"$uuid": col[++i].$uuid,"C03P02": col[i].C03P02,"C03P03": col[i].C03P03,"C03P03_REF": {}}]}); 
  ...
  asyncTest("AQCPROC03 - CRUD OK (1 line)", function(_) {
    ...
    representation.setProperties(_,{"AQCP03COL":[{"$index":0,"$uuid": uuid}]}); 
    representation.setProperties(_,{"AQCP03COL":[{"$index":0,"$uuid": uuid,"C03P02": lineId}]}); 
    representation.setProperties(_,{"AQCP03COL":[{"$index":0,"$uuid": uuid,"C03P03": refId,"C03P03_REF": {}}]}); 
     var response = representation.save(_);
    ...
    lineId = 102;
    refId = "R01P01_02";
    representation2.setProperties(_,{"AQCP03COL":[{"$index":0,"$uuid": response.AQCP03COL[0].$uuid,"C03P02": lineId,"C03P03": refId,"C03P03_REF": {"INTDES":"","INTSHO":""}}]}); 
    response = representation2.save(_);
    /*dbg*/ok("save",JSON.stringify(response)); 
    data = representation2.read(_,id);
    /*dbg*/ok("data",JSON.stringify(data)); 
    strictEqual(data.AQCP03COL.length,1,"AQCP03COL length=1");
  ...
  asyncTest("AQCPROC03 - CRUD OK (2 lines)", function(_) {
    ...
    lineId = 104;
    refId = "R01P01_04";
    representation2.setProperties(_,{"AQCP03COL":[{"$index":1,"$uuid": response.AQCP03COL[1].$uuid,"C03P02": lineId,"C03P03": refId,"C03P03_REF": {"INTDES":"","INTSHO":""}}]}); 
    response = representation2.save(_);
  ...
  asyncTest("AQCPROC03 - DelLine OK  (2 lines)", function(_) {
    ...
    representation.setProperties(_,{"AQCP03COL":[{"$index":1,"$uuid": uuid}]}); 
    representation.setProperties(_,{"AQCP03COL":[{"$index":1,"$uuid": uuid,"C03P02": lineId}]}); 
    representation.setProperties(_,{"AQCP03COL":[{"$index":1,"$uuid": uuid,"C03P03": refId,"C03P03_REF": {}}]}); 
    // Third line
    lineId = 103;
    refId  = "R01P01_03";
    uuid   = helpers.uuid.generate();  
    ...
    representation2.setProperties(_,{"AQCP03COL":[{"$index":1,"$isDeleted":true,"$uuid": response.AQCP03COL[1].$uuid}]}); 
    response = representation2.save(_);
...
function testAQCPROC04(_) {
  asyncTest("AQCPROC04 - Create OK (1 line)", function(_) {
    ...
    var refId  = "R01P01_01";
    representation.setProperties(_,{"AQCP04COL":[{"R01P01": refId}]}); 
    var response = representation.save(_);
    
    data = representation.read(_,id);
    /*dbg*///ok("save",JSON.stringify(data));
    strictEqual(data.AQCP04COL.length,1,"AQCP04COL length=1");
    strictEqual(data.AQCP04COL[0].R01P01  ,refId   ,"AQCP04COL[0].R01P01=" + refId);
    start(); 
  });
  ...
  asyncTest("AQCPROC04 - Create OK (2 lines)", function(_) {
    ...
    var refId1  = "R01P01_01";
    var refId2  = "R01P01_02";
    representation.setProperties(_,{"AQCP04COL":[{"R01P01": refId1},{"R01P01": refId2}]}); 
    var response = representation.save(_);
    
    data = representation.read(_,id);
    /*dbg*///ok("save",JSON.stringify(data));
    strictEqual(data.AQCP04COL.length,2,"AQCP04COL length=2");
    strictEqual(data.AQCP04COL[0].R01P01  ,refId1   ,"AQCP04COL[0].R01P01=" + refId1);
    strictEqual(data.AQCP04COL[1].R01P01  ,refId2   ,"AQCP04COL[1].R01P01=" + refId2);
    start(); 
  }); 
 ...
 asyncTest("AQCPROC04 - CRUD OK (1 line)", function(_) {
    ...
    response = representation2.update(_,id);
    refId  = "R01P01_02";
    representation2.setProperties(_,{"AQCP04COL":[{"R01P01": refId}]}); 
  ...
  asyncTest("AQCPROC04 - CRUD OK (2 lines)", function(_) {
    ...
    refId1  = "R01P01_03";
    refId2  = "R01P01_04";
    representation2.setProperties(_,{"AQCP04COL":[{"R01P01": refId1},{"R01P01": refId2}]}); 
    var response = representation2.save(_);
...
function testAQCPROC05(_) {
  asyncTest("AQCPROC05 - Create OK (1 line)", function(_) {
    ...
    representation.setProperties(_,{"AQCP05COL":[{"$index":0,"$uuid": uuid}]}); 
    representation.setProperties(_,{"AQCP05COL":[{"$index":0,"$uuid": uuid,"C05P03": refId,"C05P03_REF": {}}]}); 
     var response = representation.save(_);
  ...
  asyncTest("AQCPROC05 - Create OK (2 lines)", function(_) {
    ...
    refId  = "R01P01_02";
    uuid   = helpers.uuid.generate(); 
    representation.setProperties(_,{"AQCP05COL":[{"$index":1,"$uuid": uuid}]}); 
    representation.setProperties(_,{"AQCP05COL":[{"$index":1,"$uuid": uuid,"C05P03": refId,"C05P03_REF": {}}]}); 
    var response = representation.save(_);
  ...
  asyncTest("AQCPROC05 - CRUD OK (1 line)", function(_) {
    ...
    /*dbg*/ok("update",JSON.stringify(response)); 
    refId = "R01P01_02";
    representation2.setProperties(_,{"AQCP05COL":[{"$index":0,"$uuid": response.AQCP05COL[0].$uuid,"C05P03": refId,"C05P03_REF": {}}]}); 
    response = representation2.save(_);
    data = representation2.read(_,id);
    /*dbg*///ok("save",JSON.stringify(data)); 
    strictEqual(data.AQCP05COL.length,1,"AQCP05COL length=1");
  ...
  asyncTest("AQCPROC05 - CRUD OK (2 lines)", function(_) {
    ...
    //Modify the second line
    refId = "R01P01_04";
    representation2.setProperties(_,{"AQCP05COL":[{"$index":1,"$uuid": response.AQCP05COL[1].$uuid,"C05P03": refId,"C05P03_REF": {}}]}); 
    response = representation2.save(_);
...
function testAQCPROR02(_) {
  asyncTest("AQCPROR02 - Create OK", function(_) {
    function create(_,id1,id2) {
      ...
      representation.delete(_,id);
      representation.create(_);
      representation.setProperties(_,{"R02P01":id1}); 
      representation.setProperties(_,{"R02P02":id2}); 
      representation.setProperties(_,{"INTDES" :"INTDES " +id2}); 
      representation.setProperties(_,{"INTSHO" :"INTSHO " +id2}); 
      var response = representation.save(_);
    }  
...
function testAQCPROC06(_) {
  asyncTest("AQCPROC06 - Create OK"+x3Helper.gitHubIssue(1093), function(_) {
    ...
    representation.setProperties(_,{"C06P02": refIdP1,"C06P02_REF":{},"C06P03": refIdP2}); 
    var response = representation.save(_);
  ...
  asyncTest("AQCPROC06 - CRUD OK", function(_) {
    ...
    refIdP1 = "R02P01_02";
    refIdP2 = 2;
    representation2.setProperties(_,{"C06P02": refIdP1,"C06P02_REF":{},"C06P03": refIdP2}); 
    var response = representation2.save(_);
    //Read the object :
    data = representation2.read(_,id);
    //Check the object:
...
function testAQCPROC07(_) {
  asyncTest("AQCPROC07 - Create OK", function(_) {
    ...
    representation.delete(_,id);
    representation.create(_);
    representation.setProperties(_,{"TBL1COL1":id}); 
    representation.setProperties(_,{"TBL1COL2":id2}); 
    //! link managed by X3 : representation.setProperties(_,{"TBL2COL1":id}); 
    representation.setProperties(_,{"TBL2COL2":id3}); 
    var response = representation.save(_);
  ...
  /* test à supprimer lorsque Christophe aura mis en place la gestion des clés :
  */
  asyncTest("AQCPROC07 - Create OK (! with link 1x1 managed!)", function(_) {
    ...
    representation.setProperties(_,{"TBL1COL1":id}); 
    representation.setProperties(_,{"TBL1COL2":id2}); 
    representation.setProperties(_,{"TBL2COL1":id}); 
    representation.setProperties(_,{"TBL2COL2":id3}); 
    var response = representation.save(_);
  ...
  */
  asyncTest("AQCPROC07 - CRUD OK (! with link 1x1 managed!)", function(_) {
    ...
    id2     = id+"T1C1u";
    id3     = id+"T2C2u";    
    representation2.setProperties(_,{"TBL1COL1":id}); 
    representation2.setProperties(_,{"TBL1COL2":id2}); 
    representation2.setProperties(_,{"TBL2COL1":id}); 
    representation2.setProperties(_,{"TBL2COL2":id3});    
    response = representation2.save(_); 
...
function testAQCPROC08(_) {
  asyncTest("AQCPROC08 - Create OK", function(_) {
    ...
    representation.create(_);
    var  col = [
    {"C08P02":"0"         ,"$uuid" :helpers.uuid.generate()},
    {"C08P02":"01234"     ,"$uuid" :helpers.uuid.generate()},
    {"C08P02":"0123456789","$uuid" :helpers.uuid.generate()}];
     
    representation.setProperties(_,{"C08P01":id}); 
    representation.setProperties(_,{"AQCP08COL":[{"$index":0,"$uuid": col[0].$uuid,"C08P02": col[0].C08P02},{"$index":1,"$uuid": col[1].$uuid,"C08P02": col[1].C08P02},{"$index":2,"$uuid": col[2].$uuid,"C08P02": col[2].C08P02}]}); 
    var response = representation.save(_);
  ...
  asyncTest("AQCPROC08 - Create NOK"+x3Helper.gitHubIssue(1309), function(_) {
    ...
    representation.create(_);
    var  col = [
    {"C08P02":"01234567890123456789"         ,"$uuid" :helpers.uuid.generate()}];
     
    representation.setProperties(_,{"C08P01":id}); 
    representation.setProperties(_,{"AQCP08COL":[{"$index":0,"$uuid": col[0].$uuid,"C08P02": col[0].C08P02}]}); 
...
function testAQCPROC09(_) {
  asyncTest("AQCPROC09 - Create OK", function(_) {
    ...
    representation.delete(_,id);
    representation.create(_);
    representation.setProperties(_,{"C09P01":id}); 
    representation.setProperties(_,{"AQCP09COL":[{"$index":0,"$uuid": helpers.uuid.generate(),"C09P02": refIdP1,"C09P03":refIdP2}]}); 
    var response = representation.save(_);
...
function testAQCPROR03(_) {
  asyncTest("AQCPROR03 - Create OK", function(_) {
    function create(_,id1,num) {
      ...
      representation.delete(_,id);
      representation.create(_);
      representation.setProperties(_,{"R03P01":id1}); 
      representation.setProperties(_,{"INTDES" :"INTDES " +num}); 
      representation.setProperties(_,{"INTSHO" :"INTSHO " +num}); 
      representation.setProperties(_,{"SYMBOL" :"S"       +num}); 
      var response = representation.save(_);
    }  
...
function testAQCPROR04(_) {
  asyncTest("AQCPROR04 - setup", function(_) {
    ...
    function create(_,num) {
      ...
      representation.create(_);  
      representation.setProperties(_,{"R04P01" :representation.p1}); 
      representation.setProperties(_,{"R04P02" :representation.p2}); 
      representation.setProperties(_,{"INTDES" :"INTDES " +num}); 
      representation.setProperties(_,{"INTSHO" :"INTSHO " +num}); 
      var response = representation.save(_);
    }  
...
function testAQCPROC11(_) {
  asyncTest("AQCPROC11 - Create OK "+x3Helper.gitHubIssue(1541), function(_) {
    ...
    representation.delete(_,id);
    representation.create(_);
    representation.setProperties(_,{"C11P01": refIdP1,"C11P02": refIdP2,"C11P01_REF":{}}); 
...
function testAQCPROC12(_) {
  ...
  asyncTest("AQCPROC12 (US 87071/2) - Create OK", function(_) {
    ...
    function create(_,num) {
      ...
      representation.setProperties(_,{"C12P01": representation.id,"C12P02": C12P02,"C12P02_REF":{},"C12P03":C12P03}); 
      var response = representation.save(_);
   ...
   asyncTest("AQCPROC12 - CRUD OK", function(_) {
      ...
      representation.setProperties(_,{"C12P01": id,"C12P02": C12P02,"C12P02_REF":{},"C12P03":C12P03}); 
      var response = representation.save(_);
      ...
      C12P02        = "R03P01_02";
      C12P02_SYMBOL = "S2";
      representation.setProperties(_,{"C12P02": C12P02,"C12P02_REF":{}}); 
      var response = representation.save(_);
    ...
    asyncTest("AQCPROC12 - CRUD OK (empty symbol)", function(_) {
      ...
      representation.create(_);
      representation.setProperties(_,{"R03P01":idRef}); 
      representation.setProperties(_,{"INTDES" :"INTDES " +num}); 
      representation.setProperties(_,{"INTSHO" :"INTSHO " +num}); 
      representation.setProperties(_,{"SYMBOL" :""}); 
      var response = representation.save(_);
      ...
      representation2.setProperties(_,{"C12P01": id,"C12P02": idRef,"C12P02_REF":{},"C12P03":C12P03}); 
      var response = representation2.save(_);
