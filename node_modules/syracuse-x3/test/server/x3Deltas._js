...
var Representation = function(_repName) {
	...
	this.setProperties = function(_, _delta, _isDisabled, _status) {
		/*dbg*/
		//console.log("*** setProperties:",_delta);
		...
		//console.log("*** _delta.$url:",_delta.$url);
		/*dbg*/
		ok(true, "setProperties:" + JSON.stringify(_delta));
		var response;
		response = x3Helper.put(_, _getCookie(_), _delta.$url, _delta);
		/*dbg*/
		ok(true, "setProperties:" + JSON.stringify(response));
		if ((typeof(_isDisabled) != 'undefined') && (_isDisabled != null)) {
			/*dbg*/
...
//!>>>>>>> 474be76425434680710f1e3f13e10a74d3305d9c
