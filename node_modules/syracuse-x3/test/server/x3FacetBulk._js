...
if (!config.unit_test || !config.unit_test.x3endpoint || !config.unit_test.run || !config.unit_test.run.x3FacetBulk) {
	return test('X3 BULK UNIT TESTS DISABLED FOR NOW', 1, function() {
