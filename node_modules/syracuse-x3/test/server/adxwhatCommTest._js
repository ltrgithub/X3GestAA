...
/* jshint -W079 */
/* jshint unused: false */
/* global QUnit: false, asyncTest: false, test: false, strictEqual: false, start: false */
...
test("write buffer CONNECT (safev1): connect adxwhat client", function() {
...
test("write buffer CONNECT (safev2): connect adxwhat client", function() {
...
test("write buffer ASK : PATH", function() {
