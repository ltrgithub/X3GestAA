...
var x3client = require('../../lib/client');
...
var port = (config.unit_test && config.unit_test.x3mockPort) || 3005;
...
describe(module.id, () => {
	...
	it('initialize syracuse test server', function(_) {
		var db = testAdmin.initializeTestEnvironnement(_);
