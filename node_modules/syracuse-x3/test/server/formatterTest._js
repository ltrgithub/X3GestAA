...
test("basic formatting", 69, function() {
...
test("string c directive", 30, function() {
	var opt = {
		dateSep: '_',
		datePivot: 1950,
		dynFormats: {
...
test("number series 2", 122, function() {
...
test("Parse user input value ", 86, function() {
