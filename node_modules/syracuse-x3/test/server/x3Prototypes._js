...
asyncTest("COMPANY    parse", function(_) {_checkJSONs(_,"COMPANY") ;  start();});
...
asyncTest("ZQAB       parse", function(_) {_checkJSONs(_,"ZQAB") ;  start();});
asyncTest("ZQREQH     parse", function(_) {_checkJSONs(_,"ZQREQH") ;  start();});
asyncTest("ZTESTSUITE parse", function(_) {_checkJSONs(_,"ZTESTSUITE") ;  start(); });
asyncTest("ZZSERVICE  parse", function(_) {_checkJSONs(_,"ZZSERVICE") ;  start(); });
asyncTest("YITEMX     parse", function(_) {_checkJSONs(_,"ZZSERVICE") ;  start(); });
asyncTest("YITEMXS    parse", function(_) {_checkJSONs(_,"ZZSERVICE") ;  start(); });
asyncTest("YORDHEAX   parse", function(_) {_checkJSONs(_,"ZZSERVICE") ;  start(); });

asyncTest("ZQLFPROC01   parse", function(_) {_checkJSONs(_,"ZQLFPROC01") ;  start(); });
asyncTest("ZQLFPROC02   parse", function(_) {_checkJSONs(_,"ZQLFPROC02") ;  start(); });
asyncTest("ZQLFPROC03   parse", function(_) {_checkJSONs(_,"ZQLFPROC03") ;  start(); });
asyncTest("ZQLFPROC04   parse", function(_) {_checkJSONs(_,"ZQLFPROC04") ;  start(); });
asyncTest("ZQLFPROC05   parse", function(_) {_checkJSONs(_,"ZQLFPROC05") ;  start(); });
asyncTest("ZQLFPROC06   parse", function(_) {_checkJSONs(_,"ZQLFPROC06") ;  start(); });
...
asyncTest("YITEMX     prototype", function(_) {_checkPrototypes(_,"YITEMX") ;  start(); });
asyncTest("YITEMXS    prototype", function(_) {_checkPrototypes(_,"YITEMXS") ;  start(); });
asyncTest("YORDHEAX   prototype", function(_) {_checkPrototypes(_,"YORDHEAX") ;  start(); });
asyncTest("ZQAB       prototype", function(_) {_checkPrototypes(_,"ZQAB") ;  start();});
...
asyncTest("ZQLFPROC01  prototype", function(_) {_checkPrototypes(_,"ZQLFPROC01") ;  start(); });
asyncTest("ZQLFPROC02  prototype", function(_) {_checkPrototypes(_,"ZQLFPROC02") ;  start(); });
asyncTest("ZQLFPROC03  prototype", function(_) {_checkPrototypes(_,"ZQLFPROC03") ;  start(); });
asyncTest("ZQLFPROC04  prototype", function(_) {_checkPrototypes(_,"ZQLFPROC04") ;  start(); });
asyncTest("ZQLFPROC05  prototype", function(_) {_checkPrototypes(_,"ZQLFPROC05") ;  start(); });
