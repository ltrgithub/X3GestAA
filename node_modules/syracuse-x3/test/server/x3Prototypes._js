...
function testParse(_) {
  ...
  asyncTest("AQCPROC08   parse", function(_) {_checkJSONs(_,"AQCPROC08") ;  start(); });
  asyncTest("AQCPROC08   parse", function(_) {_checkJSONs(_,"AQCPROC09") ;  start(); });
  asyncTest("AQCPROC10   parse", function(_) {_checkJSONs(_,"AQCPROC10") ;  start(); });
  asyncTest("AQCPROC11   parse", function(_) {_checkJSONs(_,"AQCPROC11") ;  start(); });
  asyncTest("AQCPROC12   parse", function(_) {_checkJSONs(_,"AQCPROC12") ;  start(); });
} 
...
function testPrototype() {                  
  ...
  asyncTest("AQCPROC08  prototype", function(_) {_checkPrototypes(_,"AQCPROC08") ;  start(); });
  asyncTest("AQCPROC09  prototype", function(_) {_checkPrototypes(_,"AQCPROC09") ;  start(); });
  asyncTest("AQCPROC10  prototype", function(_) {_checkPrototypes(_,"AQCPROC10") ;  start(); });
  asyncTest("AQCPROC11  prototype", function(_) {_checkPrototypes(_,"AQCPROC11") ;  start(); });
  asyncTest("AQCPROC12  prototype", function(_) {_checkPrototypes(_,"AQCPROC12") ;  start(); });
}
...
function testDevice() {
  asyncTest("AQCPROC01", function(_) {
    ...
    //ok(true,JSON.stringify(prototype));
    prototype = x3Helper.get(_, _getCookie(_), x3Helper.x3Url("$prototypes('AQCPROC01.$query')?device=mobile"), 404); 
    //ok(true,JSON.stringify(prototype));
    prototype = x3Helper.get(_, _getCookie(_), x3Helper.x3Url("$prototypes('AQCPROC01.$query')?device=tablet"), 404); 
    //ok(true,JSON.stringify(prototype));
  ...
  asyncTest("AQCPROC01M", function(_) {
    var prototype = x3Helper.get(_, _getCookie(_), x3Helper.x3Url("$prototypes('AQCPROC01M.$query')?device=desktop"), 404); 
    //ok(true,JSON.stringify(prototype));
    prototype = x3Helper.get(_, _getCookie(_), x3Helper.x3Url("$prototypes('AQCPROC01M.$query')?device=mobile"), 200); 
    //ok(true,JSON.stringify(prototype));
    prototype = x3Helper.get(_, _getCookie(_), x3Helper.x3Url("$prototypes('AQCPROC01M.$query')?device=tablet"), 404); 
    //ok(true,JSON.stringify(prototype));
    prototype = x3Helper.get(_, _getCookie(_), x3Helper.x3Url("$prototypes('AQCPROC01M.$query')"), 404); 
                  
    start(); 
  });

  asyncTest("AQCPROC01T", function(_) {
    var prototype = x3Helper.get(_, _getCookie(_), x3Helper.x3Url("$prototypes('AQCPROC01T.$query')?device=desktop"), 404); 
    //ok(true,JSON.stringify(prototype));
    prototype = x3Helper.get(_, _getCookie(_), x3Helper.x3Url("$prototypes('AQCPROC01T.$query')?device=mobile"), 404); 
    //ok(true,JSON.stringify(prototype));
    prototype = x3Helper.get(_, _getCookie(_), x3Helper.x3Url("$prototypes('AQCPROC01T.$query')?device=tablet"), 200); 
    //ok(true,JSON.stringify(prototype));
    prototype = x3Helper.get(_, _getCookie(_), x3Helper.x3Url("$prototypes('AQCPROC01T.$query')"), 404); 
  ...
  asyncTest("AQCPROC10", function(_) {
    ...
    //ok(true,JSON.stringify(prototype));
    prototype = x3Helper.get(_, _getCookie(_), x3Helper.x3Url("$prototypes('AQCPROC10.$query')?device=mobile"), 404); 
    //ok(true,JSON.stringify(prototype));
    prototype = x3Helper.get(_, _getCookie(_), x3Helper.x3Url("$prototypes('AQCPROC10.$query')?device=tablet"), 404); 
    //ok(true,JSON.stringify(prototype));
