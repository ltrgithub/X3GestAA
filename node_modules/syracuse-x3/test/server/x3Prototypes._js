...
function _checkPrototype(_, _representation, _facet, _statusCode) {
	...
	/*dbg*/ //ok(true, "_checkPrototype:"+_representation+"."+_facet);
...
function testPrototypes() {
	...
	asyncTest("AOBJET      prototype", function(_) {
		_checkPrototype(_, "AOBJET", "query", 200);
		_checkPrototype(_, "AOBJET", "details", 200);
		_checkPrototype(_, "AOBJET", "lookup", 200);
		_checkPrototype(_, "AOBJET", "edit", 406);
		_checkPrototype(_, "AOBJET", "summary", 406);
		_checkPrototype(_, "AOBJET", "bulk", 200);
		start();
	});
	asyncTest("APLCOM      prototype", function(_) {
		...
		_checkPrototype(_, "APLCOM", "summary", 406);
	...
	asyncTest("ATABDIV     prototype", function(_) {
		...
		_checkPrototype(_, "ATABDIV", "summary", 406);
	...
	asyncTest("ATYPE       prototype", function(_) {
		...
		_checkPrototype(_, "ATYPE", "edit", 406);
		_checkPrototype(_, "ATYPE", "summary", 406);
