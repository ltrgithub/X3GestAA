...
function testUS89048() {
  asyncTest("User story 89048/1", function(_) {
    ...
    strictEqual(prototype.$filters.FILTERA.$title,"{@12892}","FILTERA.$title="+prototype.$filters.FILTERA.$title);
    strictEqual(prototype.$filters.FILTERA.$where,"left$(C01P01,1) = 'Q'","FILTERA.$where="+prototype.$filters.FILTERA.$where);
    
    ok("FILTERB" in prototype.$filters,"FILTERA="+JSON.stringify(prototype.$filters.FILTERA));
    strictEqual(prototype.$filters.FILTERB.$title,"{@12892}","FILTERB.$title="+prototype.$filters.FILTERB.$title);
    strictEqual(prototype.$filters.FILTERB.$where,"1 = 1","FILTERB.$where="+prototype.$filters.FILTERB.$where);
    start(); 
  });
