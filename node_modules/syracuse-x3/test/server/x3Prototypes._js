...
function testUS89048() {
  asyncTest("User story 89048/1", function(_) {
    ...
    strictEqual(prototype.$filters.FILTERC.$where,"(((((((((left(FIELD01, 1) eq \"A\") or (left(FIELD01, 1) eq \"B\")) or (left(FIELD01, 1) eq \"C\")) or (left(FIELD01, 1) eq \"D\")) or (left(FIELD01, 1) eq \"E\")) or (left(FIELD01, 1) eq \"F\")) or (left(FIELD01, 1) eq \"G\")) or (left(FIELD01, 1) eq \"H\")) or (left(FIELD01, 1) eq \"I\"))"
,"FILTERC.$where="+prototype.$filters.FILTERC.$where);
    start(); 
  });
...
function testDevice() {
  ...
  asyncTest("AQCPROC01M", function(_) {
    var prototype = x3Helper.get(_, _getCookie(_), x3Helper.x3Url("$prototypes('AQCPROC01M.$query')?device=desktop"), 406); 
    //ok(true,JSON.stringify(prototype));
    prototype = x3Helper.get(_, _getCookie(_), x3Helper.x3Url("$prototypes('AQCPROC01M.$query')?device=phone"), 200); 
    //ok(true,JSON.stringify(prototype));
    prototype = x3Helper.get(_, _getCookie(_), x3Helper.x3Url("$prototypes('AQCPROC01M.$query')?device=tablet"), 406); 
    //ok(true,JSON.stringify(prototype));
    prototype = x3Helper.get(_, _getCookie(_), x3Helper.x3Url("$prototypes('AQCPROC01M.$query')"), 406); 
