...
asyncTest("ZAPLCOM    parse", function(_) {_checkJSONs(_,"ZAPLCOM") ;  start(); });
...
asyncTest("ZZJHA      parse", function(_) {_checkJSONs(_,"ZZJHA") ;  start(); });
...
asyncTest("ZAPLCOM    compare",10, function(_) {_compareJSONs(_,"ZAPLCOM") ;  start(); });
...
asyncTest("ZZJHA      compare",10, function(_) {_compareJSONs(_,"ZZJHA") ;  start(); });
