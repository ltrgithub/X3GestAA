...
module(config.QLF.folder + ".x3Prototypes", {
	setup: function() {},
	teardown: function() {
		if (doStop) {
			setTimeout(function() {
...
function testParse(_) {
	asyncTest("ACLAIDX     parse", function(_) {
		_checkJSONs(_, "ACLAIDX");
		start();
	});
	asyncTest("AFCTIDX     parse", function(_) {
		_checkJSONs(_, "AFCTIDX");
		start();
	});
	asyncTest("AOBJET      parse", function(_) {
		_checkJSONs(_, "AOBJET");
		start();
	});
	asyncTest("APLCOM      parse", function(_) {
		_checkJSONs(_, "AOBJET");
		start();
	});
	asyncTest("APSADX      parse", function(_) {
		_checkJSONs(_, "APSADX");
		start();
	});
	asyncTest("AREPIDX     parse", function(_) {
		_checkJSONs(_, "AREPIDX");
		start();
	});
	asyncTest("ATABDIV     parse", function(_) {
		_checkJSONs(_, "ATABDIV");
		start();
	});
	asyncTest("ATABLE      parse", function(_) {
		_checkJSONs(_, "ATABLE");
		start();
	});
	asyncTest("ATRACE      parse", function(_) {
		_checkJSONs(_, "ATRACE");
		start();
	});
	asyncTest("ATYPE       parse", function(_) {
		_checkJSONs(_, "ATYPE");
		start();
	});
	asyncTest("AVOLUME     parse", function(_) {
		_checkJSONs(_, "AVOLUME");
		start();
	});
	asyncTest("POSCOD      parse", function(_) {
		_checkJSONs(_, "POSCOD");
		start();
	});
	asyncTest("TABLAN      parse", function(_) {
		_checkJSONs(_, "TABLAN");
		start();
	});
	asyncTest("TABUNIT     parse", function(_) {
		_checkJSONs(_, "TABUNIT");
		start();
	});
	asyncTest("AQCPROC01   parse", function(_) {
		_checkJSONs(_, "AQCPROC01");
		start();
	});
	asyncTest("AQCPROC02   parse", function(_) {
		_checkJSONs(_, "AQCPROC02");
		start();
	});
	asyncTest("AQCPROC03   parse", function(_) {
		_checkJSONs(_, "AQCPROC03");
		start();
	});
	asyncTest("AQCPROC04   parse", function(_) {
		_checkJSONs(_, "AQCPROC04");
		start();
	});
	asyncTest("AQCPROC05   parse", function(_) {
		_checkJSONs(_, "AQCPROC05");
		start();
	});
	asyncTest("AQCPROC06   parse", function(_) {
		_checkJSONs(_, "AQCPROC06");
		start();
	});
	asyncTest("AQCPROC07   parse", function(_) {
		_checkJSONs(_, "AQCPROC07");
		start();
	});
	asyncTest("AQCPROC08   parse", function(_) {
		_checkJSONs(_, "AQCPROC08");
		start();
	});
	asyncTest("AQCPROC08   parse", function(_) {
		_checkJSONs(_, "AQCPROC09");
		start();
	});
	asyncTest("AQCPROC10   parse", function(_) {
		_checkJSONs(_, "AQCPROC10");
		start();
	});
	asyncTest("AQCPROC11   parse", function(_) {
		_checkJSONs(_, "AQCPROC11");
		start();
	});
	asyncTest("AQCPROC12   parse", function(_) {
		_checkJSONs(_, "AQCPROC12");
		start();
	});
}
...
function testPrototype() {
	asyncTest("ACLAIDX    prototype", function(_) {
		_checkPrototypes(_, "ACLAIDX");
		start();
	});
	asyncTest("AFCTIDX    prototype", function(_) {
		_checkPrototypes(_, "AFCTIDX");
		start();
	});
	asyncTest("AOBJET     prototype", function(_) {
		_checkPrototypes(_, "AOBJET");
		start();
	});
	...
	asyncTest("APSADX     prototype", function(_) {
		_checkPrototypes(_, "APSADX");
		start();
	});
	asyncTest("AREPIDX    prototype", function(_) {
		_checkPrototypes(_, "AREPIDX");
		start();
	});
	asyncTest("ATABDIV    prototype", function(_) {
		_checkPrototypes(_, "ATABDIV");
		start();
	});
	asyncTest("ATABDIVH   prototype", function(_) {
		_checkPrototypes(_, "ATABDIVH");
		start();
	});
	...
	asyncTest("ATRACE     prototype", function(_) {
		_checkPrototypes(_, "ATRACE");
		start();
	});
	asyncTest("ATYPE      prototype", function(_) {
		_checkPrototypes(_, "ATYPE");
		start();
	});
...
function testCompare() {
	...
	asyncTest("AOBJET     compare", 10, function(_) {
		_compareJSONs(_, "AOBJET");
		start();
	});
...
function testDevice() {
	...
	asyncTest("AQCPROC01M" + x3Helper.gitHubIssue(1621), function(_) {
	...
	asyncTest("AQCPROC01T", function(_) {
	...
	asyncTest("AQCPROC10", function(_) {
