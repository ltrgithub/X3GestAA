      ...
      for(var p in o1) {
         if(! p in ["$baseUrl"]){
          try {
            ...
            test.message = toString.call(o1[p])+" <> "+toString.call(o2[p]);
            console.log("JSON type NOK",test.message);
            return test;
          }
                
          if((toString.call(o1[p]) == "[object Object]") || (toString.call(o1[p]) == "[object Array]")) {
            test = compareObjects(o1[p],o2[p]);
            ...
            try {
              ...
              test.message = o1[p]+" <> "+o2[p];
              console.log("JSON value NOK",test.message);
              return test;
            }
        	}
        }
...
asyncTest("ACLAIDX    JSON", function(_) {_compareJSONs(_,"ACLAIDX") ;  start(); });
asyncTest("AFCTIDX    JSON", function(_) {_compareJSONs(_,"AFCTIDX") ;  start(); });
asyncTest("AOBJET     JSON", function(_) {_compareJSONs(_,"AOBJET") ;  start(); });
asyncTest("APSADX     JSON", function(_) {_compareJSONs(_,"APSADX") ;  start(); });
asyncTest("AREPIDX    JSON", function(_) {_compareJSONs(_,"AREPIDX") ;  start(); });
asyncTest("ATABDIV    JSON", function(_) {_compareJSONs(_,"ATABDIV") ;  start(); });
asyncTest("ATABLE     JSON", function(_) {_compareJSONs(_,"ATABLE") ;  start();});
asyncTest("ATRACE     JSON", function(_) {_compareJSONs(_,"ATRACE") ;  start(); });
asyncTest("AUTILIS    JSON", function(_) {_compareJSONs(_,"AUTILIS") ;  start();}); 
asyncTest("AVOLUME    JSON", function(_) {_compareJSONs(_,"AVOLUME") ;  start();});
asyncTest("COMPANY    JSON", function(_) {_compareJSONs(_,"COMPANY") ;  start();});
asyncTest("FACILITY   JSON", function(_) {_compareJSONs(_,"FACILITY") ;  start(); });
asyncTest("POSCOD     JSON", function(_) {_compareJSONs(_,"POSCOD") ;  start(); });
asyncTest("TABCOUNTRY JSON", function(_) {_compareJSONs(_,"TABCOUNTRY") ; start();});
asyncTest("TABLAN     JSON", function(_) {_compareJSONs(_,"TABLAN") ;   start(); });
asyncTest("TABUNIT    JSON", function(_) {_compareJSONs(_,"TABUNIT") ;  start(); });
asyncTest("ZAPLCOM    JSON", function(_) {_compareJSONs(_,"ZAPLCOM") ;  start(); });
asyncTest("ZQREQH     JSON", function(_) {_compareJSONs(_,"ZQREQH") ;  start();});
asyncTest("ZTESTSUITE JSON", function(_) {_compareJSONs(_,"ZTESTSUITE") ;  start(); });
asyncTest("ZZJHA      JSON", function(_) {_compareJSONs(_,"ZZJHA") ;  start(); });
asyncTest("ZZSERVICE  JSON", function(_) {_compareJSONs(_,"ZZSERVICE") ;  start(); });
