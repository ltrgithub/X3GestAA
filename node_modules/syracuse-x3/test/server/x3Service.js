...
asyncTest("About", function(_) {
	...
	strictEqual(about.applicationServer, config.QLF.serverHost, "serverHost:" + about.folder);
	strictEqual(parseInt(about.port), config.QLF.serverPort, "serverHost:" + about.folder);
