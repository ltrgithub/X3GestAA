...
// close all reused sessions for given Syracuse session. Parameter "reason" is optional
exports.closeReuseSession = function(_, syraid, reason) {
	funnelReuse(_, function(_) {
		_listReuse[syraid] && _listReuse[syraid].forEach_(_, function(_, cvgClient) {
			...
			cvgClient.disconnectClient(_, {}, reason || "closed by administrator");
		});
