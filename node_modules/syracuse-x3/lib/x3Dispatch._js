...
var _connectMap = {
	...
	"delete": function(_, context) {
			...
			context.httpSession.closeCvgSession(context.cvgSessionId, context.parameters.reuse, "Closed by client (Delete)", _);
			if (!context.parameters.panic) context.replyDeleted(_);
	}
}
