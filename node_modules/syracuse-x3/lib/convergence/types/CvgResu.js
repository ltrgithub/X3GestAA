...
CvgResu.read = function(reader) {
	...
	switch (tag) {
		...
		case CvgResu.TAG_SHORT:
			return new CvgResu(CvgResu.TDO_SHORT, reader.nextShort());
		case CvgResu.TAG_INT:
			return new CvgResu(CvgResu.TDO_INT, reader.nextLong());
		case CvgResu.TAG_BCD:
			if (len !== 17) throw new Error("bad bcd len: " + len);
			return new CvgResu(CvgResu.TDO_BCD, reader.nextBcd());
		case CvgResu.TAG_STRU:
			return new CvgResu(CvgResu.TDO_ALPHA, reader.nextUnicode(len));
		case CvgResu.TAG_DATE:
			if (len !== 3) throw new Error("bad date len: " + len);
			return new CvgResu(CvgResu.TDO_DATE, reader.nextDate());
		case CvgResu.TAG_BLOB:
			return new CvgResu(CvgResu.TDO_BLOB, reader.nextBlob());
		case CvgResu.TAG_CLOB:
			return new CvgResu(CvgResu.TDO_CLOB, reader.nextClob());
		default:
