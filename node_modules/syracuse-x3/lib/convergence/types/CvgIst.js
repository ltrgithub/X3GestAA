...
var CvgIst = helpers.defineClass(function(ist, idx) {
	...
	isFieldLineIstRed: function() {
		return (this.idx > -1 && ((this.ist & 0xFF) || this.idx > 0));
	},
	...
	isBlocAllLinesBlocIstRed: function() {
		return (!(this.ist & 0xFF) && (this.idx === 0 || this.idx === -1));
	},
	...
	isFieldAllLinesColumnIstRed: function() {
		// (this.field !== 0 && this.idx >= -1);
		return ((this.ist & 0xFF) && this.idx >= -1);
	},
	// abbrev for this.isAllLinesOfBlocIst(), when isBaseBloc() has already been tested
	isAllLinesOfBlocIstRed: function() {
		// this.field === 0 && this.idx === -1
		return (!(this.ist & 0xFF) && this.idx === -1);
	},
	// abbrev for this.isLineIst(), when isBaseBloc() has already been tested
	isLineIstRed: function() {
		return (!(this.ist & 0xFF) && this.idx > 0);
	},
