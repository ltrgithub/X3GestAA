...
var CvgFormatter = helpers.defineClass(function(values) {
	this.settings = {};
	var p;
	for (p in template) {
	...
	formatEditToDisplay: function(format, val, srvVal) {
		...
		if (format.format[0] == 'D') {
			...
			try {
				...
				//  Try edit Format
				var newFmt = new CvgFormat(editFmt);
				val = this.unformatField(newFmt, this.formatField(newFmt, val, false, true), true);
			}
		}
