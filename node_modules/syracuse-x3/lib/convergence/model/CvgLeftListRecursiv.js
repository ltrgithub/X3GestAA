...
var CvgLeftListRecursiv = exports.CvgLeftListRecursiv = helpers.defineClass(function(aStackedWindow, aScreen, aEntityIndexBaseOne, aId, aListFormat, aNbColumns) {
	...
	appendLeftListLine: function(aIdx, aBranche, aTxt, aVal, aClf, aClp) {
		...
		if (aClp.length === 0) {
			...
			CvgLeftList.prototype.appendLeftListLine.call(this, wLeftListNode);
		} else {
	...
	toJsonAddRCD: function(line, record) {
		if (line instanceof CvgLeftListLineNode) {
			if (record.length === 0) {
			...
			return CvgLeftList.prototype.toJsonAddRCD.call(this, line, record);
		}
	},
