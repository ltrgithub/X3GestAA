...
var CvgCallUiOpenFile = exports.CvgCallUiOpenFile = helpers.defineClass(function(client, type, url) {
	...
	addOpenFile: function(type, url) {
		this.targetlist.push([type, url]);
	},
	toJSON: function() {
		return {
			openf: {
