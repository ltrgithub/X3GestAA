...
CvgPluginTarget.create = function(client, pluginCall) {
	return new CvgPluginTarget(client, pluginCall.name, pluginCall.method, pluginCall.methodid, pluginCall.type, pluginCall.id, pluginCall.module, pluginCall.class);
};