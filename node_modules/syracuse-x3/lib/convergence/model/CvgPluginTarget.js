...
var CvgPluginTarget = exports.CvgPluginTarget = helpers.defineClass(function(cli, name, method, type, id, module, klass) {
...
CvgPluginTarget.create = function(client, pluginCall, id) {
	return new CvgPluginTarget(client, pluginCall.name, pluginCall.method, pluginCall.type, id, pluginCall.module, pluginCall.class);
};