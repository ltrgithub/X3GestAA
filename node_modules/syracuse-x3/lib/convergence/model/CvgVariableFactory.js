...
exports.CvgVariableFactory = {
	instanciateLeftListColumn: function(aRequester, srcLine, aEntityIndexBaseOne, aVarId) {
		return new CvgVariableAlpha(srcLine, aEntityIndexBaseOne, aVarId, aVarId, CvgResuTdo.STRU, new CvgFormat(""), CvgEntity.x3AffModeToEntityState(CvgEntity.X3VAR_MAF_SAISI));
	},
		...
		switch (wDataType) {
			...
			case CvgResuTdo.STRU:
				if (wInputType === VAR_TYPE_RICHEDIT) {
					...
					wVariable = new CvgVariablePass(client, srcLine, aEntityIndexBaseOne, wVarName, wVarId, wDataType, wFormat, wEntityState);
			...
			case CvgResuTdo.DATE:
				if (aVariableNode.$.DAI != null) {
					wVariable = new CvgVariablePeriod(srcLine, aEntityIndexBaseOne, wVarName, wVarId, wDataType, wFormat, wEntityState);
				} else {
					wVariable = new CvgVariableDate(srcLine, aEntityIndexBaseOne, wVarName, wVarId, wDataType, wFormat, wEntityState);
				}
				break;
