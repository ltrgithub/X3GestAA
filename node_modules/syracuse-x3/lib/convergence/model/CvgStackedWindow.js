...
var CvgStackedWindow = exports.CvgStackedWindow = helpers.defineClass(function(aClient, aWindowId, aFunctionId, aDescr, aStamp, aEnityIndexBaseOne) {
	...
	var map = adminHelper.getMenuItemMap();
	map.menu[this.client.applicationName + "." + this.client.contractName + "." + this.id] = helpers.object.clone(map.menu[this.client.applicationName + "." + this.client.contractName + "." + this.functionId]);
	// Add $stacked info since menu map is not used only by breadcrumb
	map.menu[this.client.applicationName + "." + this.client.contractName + "." + this.id].$stacked = true;
	//
}, CvgEntity, {
