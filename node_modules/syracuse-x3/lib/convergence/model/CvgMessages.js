...
var CReplyMessages = Array; //require('syracuse-x3/lib/convergence/CReplyMessages').CReplyMessages;

var CvgMessages = exports.CvgMessages = helpers.defineClass(function(clientObs) {
	CReplyMessages.call(this);
	this.clientObs = clientObs;
}, CReplyMessages, {
	addMessage: function(aType, aMessage) {
		addElement(new CvgMessage(aType, clientObs, aMessage, false));
	},
