...
var CvgVariableCombo = exports.CvgVariableCombo = helpers.defineClass(function(srcLine, aEntityIndexBaseOne, aVarName, aID, aTdo, aFormat, aEntityState, aLocalMenu, window) {
	...
	clone: function() {
		var wVariable = new CvgVariableCombo(this.srcLine, this.entityIndexBaseOne, this.name, this.id, this.dataType, this.format, this.state, this.localMenu, this.win);
