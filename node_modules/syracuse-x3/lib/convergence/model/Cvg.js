...
var Cvg = exports.Cvg = {
	...
	affSynchroneActionToString: function(aAction) {
		switch (aAction) {
		case Cvg.AFF_SYNCHRONE_ACTION_CLOSE:
			return "CLO";

		case Cvg.AFF_SYNCHRONE_ACTION_MODIFY:
			return "MOD";

		case Cvg.AFF_SYNCHRONE_ACTION_OPEN:
			return "OPE";
	...
	affSynchroneTypeToString: function(aType) {
		...
		case Cvg.AFF_SYNCHRONE_TYPE_VALIDCAR:
			return "VLC_";

		case Cvg.AFF_SYNCHRONE_TYPE_PROGRESS:
			return "PROG";
