...
var CvgEntity = exports.CvgEntity = helpers.defineClass(function(aClient, aId, aEntityIndexBaseOne, aEntityTyp, windows) {
	...
	calculateState: function() {
		...
		if (this.lastStampModVisible != -1) {
			state = _calcJsonNewEntityState(this.state, this.visible);
		}
		if (this.lastStampModSelected != -1) {
			state = _calcJsonNewEntityState(this.state, this.selected ? STATE_SELECT : STATE_NOT_SELECT);
		}
		if (this.lastStampModActzo != -1) {
			state = _calcJsonNewEntityState(this.state, this.actzo);
		}
		//	if (state !== this.stateToJSon) {
		this.state = state;
		//	}
