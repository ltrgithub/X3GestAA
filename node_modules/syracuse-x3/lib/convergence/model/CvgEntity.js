...
var CvgEntity = exports.CvgEntity = helpers.defineClass(function(aClient, aId, aEntityIndexBaseOne, aEntityTyp, windows) {
	...
	// override to add the entity in windows cache
	setJsonType: function(aType) {
		CvgObservable.prototype.setJsonType.call(this, aType);
		if (!this.srcLine || this.srcLine.isEntrySup)
			this.win && this.win.addCache(this.getAdxIst(), this);
	},
	...
	setLastStampMod: function(lastStampMod, metadata) {
		...
		switch (metadata) {
			case 'ACT':
				...
				this.calculateState();
				objVal.value = this.state;
				objVal.extra = this.getReadableState();
				meta = "STT";
				break;
			case 'PCOL':
