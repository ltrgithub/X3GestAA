	...
	setServerFormat: function(aFormat) {
		...
		if (wChangeVisibility) {
			...
			if (this.hasColumnFormater()) {
				...
				console.log("format visible "+this.state);
				console.log("format visible "+this.lastStampModState);
