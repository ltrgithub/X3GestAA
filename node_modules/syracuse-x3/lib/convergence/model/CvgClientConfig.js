...
var CvgClientConfig = exports.CvgClientConfig = helpers.defineClass(function(params) {
	...
	this.adxHttpPub = params.adxHttpPub;
	this.server = params.server;
	this.port = params.port;
	this.codeLangIso = params.codeLangIso;
	
	this.syraPreferences = params && params.syraPreferences || {};
	this.addPrefsIfMissing(this.syraPreferences);
	...
	addPrefsIfMissing: function(target) {
		function fusionPrefAdd(syraId, cfgId, def) {
			if (target[syraId] == undefined)
				target[syraId] = def.toString();
		}
		fusionPrefAdd("dateOrder", "IDate", "0"); // Month-Day-Year
