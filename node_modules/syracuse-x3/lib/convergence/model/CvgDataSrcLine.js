...
var CvgVariable = require('./CvgEntity').CvgVariable;
...
var CvgDataSrcLine = exports.CvgDataSrcLine = helpers.defineClass(function(requester, dataSrc, id, nbVars, zeroBaseIdx) {
	...
	cellHasBeenModified: function() {
		if (!this.modified) {
			if (this.zeroBaseLineIdx !== undefined && this.dataSrc) {
				this.dataSrc.linesModified[this.uuid] = this;
				this.modified = true;
	...
	razModification: function() {
		this.modified = false;
		this.comboDchModif = false;
		/*var keys = Object.keys(this.varsModified);*/

		for (var i = 0; i < this.vars.length; i++) {

			this.vars[i].razModification();
		}
		/*this.varsModified = {};*/
	...
	traverseSettable: function(aStructIst, aSetter) {
		...
		if (aStructIst.isBaseBloc()) {
			...
			if (aStructIst.isLineIstRed()) {
				...
				var CActiveStateSetter = require('../client/CvgRequest').CActiveStateSetter;
