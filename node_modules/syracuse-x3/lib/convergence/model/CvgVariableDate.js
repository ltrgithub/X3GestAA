...
var CvgVariableDate = exports.CvgVariableDate = helpers.defineClass(function(srcLine, entityIdx, name, aID, aTdo, fmt, state) {
	...
	formatX3ToDisplay: function(aData) {
		...
		if (aData.value.length !== 8) {
			_postDiag(this,this.fmtExcepMsg('ERROR_FORMAT_EXCEPTION', 'FORMAT_RTOS', aData.value, "NOT AN ADONIX_DATE YYYYMMDD"), "_callFormater" +  this.getAdxId());
			return aData.value + " ???";
		}
		return this._callFormater(aData.value);
	},
	...
	unFormatData: function(aValue) {
		...
		aValue = this._callUnFormater(aValue);
