...
var CvgVariableDate = exports.CvgVariableDate = helpers.defineClass(function(srcLine, aEntityIndexBaseOne, aVarName, aID, aTdo, aFormat, aEntityState, aLocalFormatAndSep, aPivotDate) {
	...
	formatX3ToDisplay: function(aData) {
		...
		if (wValue.length !== 8) {
			var wMess = this.buildMsgFormatterException('ERROR_FORMAT_EXCEPTION', 'FORMAT_RTOS', wValue, "NOT AN ADONIX_DATE AAAAMMJJ");
	...
	formatEditToDisplay: function(aValue) {
		if (aValue === "")
			...
			return CvgVariable.prototype.formatEditToDisplay.call(this, aValue);
	},
	...
	isYearLessPivotYear: function(aYear) {
		var isLess = parseInt(aYear, 10) < this.pivotYear;
		return isNaN(isLess) ? false : isLess;
	},
	setServerResu: function(resu) {
		if (resu != null && CvgDate.DATE_ZERO === resu.value) {
			resu = null;
		}
