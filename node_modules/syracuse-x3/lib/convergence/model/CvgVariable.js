...
var CvgVariable = exports.CvgVariable = helpers.defineClass(function(srcLine, aEntityIndexBaseOne, aVariableName, aVariableId, aDataType, aFormat, aEntityState) {
	...
	buildMsgFormatterException: function(aMessKey, aWhatFormatKey, value, e) {
		...
		var mess = this.client.getMessage(aMessKey);
		var what = this.client.getMessage(aWhatFormatKey);
		return locale.format(mess, what, this.id, e.message);
	},
	...
	callUnFormater: function(aValue) {
		...
		if (this.client.hasValidFormater() && this.hasValidFormat()) {
			try {
				...
				throw new CvgFormatException(this.client, e, this.buildMsgFormatterException('ERROR_UNFORMAT_EXCEPTION', 'UNFORMAT_STOR', aValue, e));
			}
		}
		// No format
		...
		if (this.client.hasValidFormater() && this.hasValidFormat()) {
			try {
				...
				try {
					...
					throw new CvgFormatException(this.client, e, this.buildMsgFormatterException('ERROR_FORMAT_EXCEPTION', 'FORMAT_ETOS', aValue, e2.message));
				}
			}
			return res;
		} else {
