...
var CvgVariable = exports.CvgVariable = helpers.defineClass(function(srcLine, idx1, name, id, type, fmt, state) {
	...
	setOptimChvl : function(){
		console.log("active disable optim "+this.getObservableId()+" line "+this.srcLine.zeroBaseLineIdx );
	...
	toJSON: function() {
		...
		if( this.formatStr!=null && this.formatStr !== "" && this.formatModified ) 
			object.fmt = this.formatStr;
