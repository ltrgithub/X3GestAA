	...
	callUnFormater: function(aValue) {
		...
		if (this.client.hasValidFormater() && this.hasValidFormat()) {
			try {
				...
				throw new CvgFormatException(this.client, null, this.buildMsgFormatterException('ERROR_UNFORMAT_EXCEPTION', 'UNFORMAT_STOR', aValue, e));
			}
		}
		// No format
		...
		if (this.client.hasValidFormater() && this.hasValidFormat()) {
			try {
				...
				try {
					...
					throw new CvgFormatException(this.client, null, this.buildMsgFormatterException('ERROR_FORMAT_EXCEPTION', 'FORMAT_ETOS', aValue, e3));
				}
			}
			return res;
		} else {
