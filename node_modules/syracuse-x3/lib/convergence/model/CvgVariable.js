...
var CvgVariable = exports.CvgVariable = helpers.defineClass(function(srcLine, aEntityIndexBaseOne, aVariableName, aVariableId, aDataType, aFormat, aEntityState) {
	...
	callFormater: function(aValue) {
		if (this.client.formater && this.hasValidFormat()) {
			try {
				...
				this.client.addLogicalErrorMess(this, "callFormater", this.getAdxId(), this.fmtExcepMsg('ERROR_FORMAT_EXCEPTION', 'FORMAT_RTOS', aValue, e));
			}
		}
		return aValue;
	},
	...
	formatX3ToDisplay: function(aData) {
		if (this.mustBeFormatted && aData.value != null) this.callFormater(aData.value);
		return aData.value;
	},
	formatX3ToEdit: function() {
		...
		if (this.acceptEditFormat() && this.mustBeFormatted && val != null && this.hasValidFormat() && this.client.formater) {
			try {
				...
				this.client.addLogicalErrorMess(this, "formatEdit", this.id, this.fmtExcepMsg('ERROR_UNFORMAT_EXCEPTION', 'UNFORMAT_STOE', val, e));
			}
		}
		return val;
	},
	...
	getValueForJson: function() {
		...
		if (this.client.clientConfig.fmtLocalFormat) return  this.serverValue == null ? "": this.serverValue;
