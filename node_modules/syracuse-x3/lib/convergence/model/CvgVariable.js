...
var CvgVariable = exports.CvgVariable = helpers.defineClass(function(srcLine, aEntityIndexBaseOne, aVariableName, aVariableId, aDataType, aFormat, aEntityState) {
	...
	formatEditToDisplay: function(aValue) {		
		if (this.acceptEditFormat() && this.client.hasValidFormater() && this.hasValidFormat()) {
	...
	formatX3ToEdit: function() {
		...
		if (this.acceptEditFormat() && this.mustBeFormatted && val != null && this.hasValidFormat() && this.client.hasValidFormater()) {
			try {
				return this.client.formater.formatEdit(this.format, val, true);
			} catch (e) {
				this.client.addLogicalErrorMess(this, "formatEdit", this.id, this.buildMsgFormatterException('ERROR_UNFORMAT_EXCEPTION', 'UNFORMAT_STOE', val, e));
			}
		}
		return val;
	},
