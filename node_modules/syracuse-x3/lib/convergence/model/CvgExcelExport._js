...
var CvgExcelExport = exports.CvgExcelExport = helpers.defineClass(function(_, client, ist, params, serverUrl) {
	this.client = client;
	this.ist = ist;
	this.params = params;
	...
	generateXlsx: function(_) {
		...
		officeXls.render(_, stream, {data: result, serverUrl: this.serverUrl});
