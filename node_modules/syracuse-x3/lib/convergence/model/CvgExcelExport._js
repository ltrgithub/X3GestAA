...
var tracerXls = require('@sage/syracuse-core').getTracer("classic.xlsExport");
...
var CvgExcelExport = helpers.defineClass(function(_, client, ist, serverUrl, params) {
	...
	generateXlsx: function(_) {
		...
		tracerXls.info && tracerXls.info("Data sent to excel addin: " + JSON.stringify(result, null, 2));

		var stream = ez.devices.buffer.writer();
		...
		this.client.services.blobSvc.register(uuid, stream.toBuffer(), null, {
