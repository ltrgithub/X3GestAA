...
var CvgImpConfig = exports.CvgImpConfig = helpers.defineClass(function(client, datasource, meta, cvgDiagnoses) {
	...
	toJSON: function() {
		...
		if(this.cvgDiagnoses) {
			return {"type": "selpr", "selpr": {"$facet": "configPrinter", "$diagnoses": this.cvgDiagnoses.toJSON()}};
		}
...
var CvgImpMore = exports.CvgImpMore = helpers.defineClass(function(client, infos, cvgDiagnoses) {
	CvgObservable.call(this, client);
	this.bac = infos.bac;
	...
	toJSON: function() {
		if(this.cvgDiagnoses) {
			return {"type": "selpr", "selpr": {"$facet": "morePrinter", "$diagnoses": this.cvgDiagnoses.toJSON()}};
		}
		else {
			return {
				type: "selpr",
				selpr: {
					$facet: "morePrinter",
					$data : {
						paperSource: {"setch": this.bac},
						paperSize: {"setch": this.paperSize}
					}
				}
			};
		}
