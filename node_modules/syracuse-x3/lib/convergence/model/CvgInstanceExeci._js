...
var CvgResuTagLib = require('../types/CvgResu').TAG_LIB;
var CvgExcelExport = require('./CvgExcelExport');
var CvgCsvExport = require('./CvgCsvExport');
...
var CvgInstanceExeci = helpers.defineClass(function(_, ist, spgm, dbgflag, paramDefs, paramVal, client, serverUrl) {
	...
	process: function(_) {
		...
		if (this.spgm === "PROXY_DISPATCH") {
			...
			} else if (this.spgm === "setDataTableExtractToCsv") {
				this.json.params = CvgCsvExport.setDataTableExtractToCsv(_, this.client, this.instance, this.serverUrl, this.json.params);
			}
	...
	genExeciNode: function(_, resu, errl, errm, errn, errp, errt, error) {
		...
		this.client.processAsyncAction(_, body, false, true, true, true);
	},
	format: {
		get: function() {
