...
var CustomException = helpers.defineClass(function(client, e, message) {
	...
	this.message = (message ? message : "") + (e && e.message ?  e.message : ""); //set the error message
	this.inner = e;
...
var CvgException = exports.CvgException = helpers.defineClass(function(client, e, message) {
	...
	this.diagnose = new CvgDiagnose(client, 'ERROR', 'Exception', this.message, null, e && e.stack, null, false)
}, CustomException, {
});
...
var CvgFormatException = exports.CvgFormatException = helpers.defineClass(function(client, e, message) {
	...
	this.diagnose = new CvgDiagnose(client, 'ERROR', 'Format', this.message, null, e && e.stack, "format",false)
}, CustomException, {
});