		...
		if (this.isBlocGrid()) {
			...
			for (i = 0; i < this.lines.length; i++) {
				...
				if (line != null && !line.isDisposed()) {
					...
					if (this.metaScope && (this.metaScope.full || this.metaScope.lines && this.metaScope.lines.indexOf(i) !== -1)) {
	...
	traverseSettable: function(aStructIst, aSetter) {
		...
		try {
			...
			// inferieure designee
				...
				if (aSetter.applyMeta && this.metaScope.lines.indexOf(wI) === -1) {
					this.metaScope.lines.push(wI);
				}
