...
var DESCS = [
	...
	[173, "ND_IHM", "[PF[U"], /*  Interface avec IHM	*/
...
var NODES = [];
var MAP = {};
var ACTION_ENDING = ['NDGIST', 'NDOBOXI', 'NDEXECI', 'ND_ASKUI', 'NDGTIM', 'ND_LIM', 'ND_IHM'];
...
MAP.ND_IHM.waitUser = true; // callilog
MAP.ND_SLF.autoReplyAck = true; // callilog
...
function processNode(_, client, request, reader, node, phase) {
	...
	if (!node.skipHandler) { // no need to call dummyHandler!
		var nam = "listenNode" + node.name;
		...
		if (fn) {
			...
			switch (args.length) {
				case 2:
					results = client[nam](_, args[0], args[1]);
					break;
				case 3:
					results = client[nam](_, args[0], args[1], args[2]);
					break;
				case 4:
					results = client[nam](_, args[0], args[1], args[2], args[3]);
					break;
				case 5:
					results = client[nam](_, args[0], args[1], args[2], args[3], args[4]);
					break;
				case 7:
					results = client[nam](_, args[0], args[1], args[2], args[3], args[4], args[5], args[6]);
					break;
				case 9:
					results = client[nam](_, args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8]);
					break;
				default:
			...
			if (fn) {
				switch (args.length) {
					case 2:
						results = request[nam](_, args[0], args[1]);
						break;
					case 3:
						results = request[nam](_, args[0], args[1], args[2]);
						break;
					case 4:
						results = request[nam](_, args[0], args[1], args[2], args[3]);
						break;
					case 5:
						results = request[nam](_, args[0], args[1], args[2], args[3], args[4]);
						break;
					case 7:
						results = request[nam](_, args[0], args[1], args[2], args[3], args[4], args[5], args[6]);
						break;
					case 9:
						results = request[nam](_, args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8]);
						break;
					default:
...
exports.readVal = readVal; // for deserialisation of action  // Dummy comment to clean up rollout repository #6948