...
exports.X3Automata = helpers.defineClass(function() {
	this.protocolVersion = currentprotocol; // by default
	this.desc = DESC[currentprotocol]; // by default
	this.suffixListen = currentprotocol.substring(currentprotocol.length - 2);
}, null, {
