...
function processNode(_, client, request, reader, node, phase) {
	...
	tracerProtocol.info && tracerProtocol.info("Process Node: " + node.name);
	...
	tracerProtocol.info && tracerProtocol.info("NODE HANDLER: " + node.name + ": args=" + JSON.stringify(args.slice(2)));
