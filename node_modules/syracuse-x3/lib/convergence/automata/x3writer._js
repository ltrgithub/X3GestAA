...
var Actions67 = require('syracuse-x3/lib/convergence/client/CvgAction').Actions67;
...
var ACTIONS = {
	150067: new Actions67().init()
};

exports.X3Writer = helpers.defineClass(function() {
	var self = this;
	this.serializers = {
	...
	serializeActionParams: function(_, client, act, params) {
		...
		var desc = this.actions.Descriptors[act] || {
