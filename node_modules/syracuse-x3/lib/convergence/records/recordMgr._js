...
var udatetime = require('@sage/syracuse-core').types.datetime;
var ufs = require('streamline-fs');
var upath = require('path');
var x3helpers = require('../../helpers');
var _config = x3helpers.config("offlineRecords", null, {});
...
var _mgr = exports.recordMgr = new function() {
	...
	this.newRecorder = function(_, stream, opts, cliCfg, config) {
		try {
			...
			var klass = require('./recorder').Recorder;
	...
	this.cvgRecordGet = function(_, fileName, readContent, config) {
		...
		try {
			...
			return {
				...
				creationDate: udatetime.fromMillis(data.stats.ctime),
				lastModifDate: udatetime.fromMillis(data.stats.mtime),
