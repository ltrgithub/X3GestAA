...
var _mgr = exports.recordMgr = new function() {
	...
	this.newStreamPlay = function(_){
		try{
			_initFuture(_);
			_tracer && _tracer("recordMgr - new streamPlayer");			
			if (this._currentPlayer==null) throw "player not initialized";
