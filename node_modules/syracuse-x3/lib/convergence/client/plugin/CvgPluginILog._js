...
exports.CvgPluginILog = helpers.defineClass(function(client, id, killTimeoutOnCreate) {
	...
	toJSON: function() {
		var plug = {
			"class": this.class && this.class.toUpperCase(),
			name: this.name,
			type: this.type,
			id: this.method === "New" ? null : this.id,
			module: this.module,
			method: this.method.toLowerCase(),
			methodId: this.methodid
		};
		if (this.client.isPlugin && this.download) {
			plug.download = this.download;
		}
		if (this.client.isPlugin && this.upload) {
			plug.upload = this.upload;
		}
		if (plug.method === "new") {
			//add cookie session
