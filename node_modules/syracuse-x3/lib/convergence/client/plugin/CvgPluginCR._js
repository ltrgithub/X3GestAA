...
exports.CvgPluginCR = helpers.defineClass(function(client, id) {
	...
	addBlindProperties: function(_, values) {
		...
		var endpoint = adminHelper.getEndpoint(_, {
			jsonWhere: {
				x3ServerFolder: this.Folder,
				x3SolutionName: this.Solution
			}
		});
		if (endpoint)
	...
	specialAction532: function(_, context, body, tracker) { // tracker not used in that case but is passed by the caller
