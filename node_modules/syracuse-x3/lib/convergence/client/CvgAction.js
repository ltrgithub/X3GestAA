...
var RAW_ACTIONS = [
	...
	['SRV_EXECI_RESPONSE', 1081, 'ISSUBUxVxYxW'],
	...
	['SRV_LIST_PAGE_DOWN', 1073, 'IW'], // ist + key
	// Action serveur 1024 + ACK_REWD (48)
	['SRV_LIST_PAGE_UP', 1072, 'IW'], // ist + optional key
...
exports.SuperActions = [
	...
	},	
	{
		...
		processNextAction: function(actNum, reqTarg, respTarg, checkNumLine){
			...
			if(check){
				...
				return reqTarg.win === respTarg.win && reqTarg.blocAlphaId === respTarg.blocAlphaId;
			}
		},
	},
	{
	...
	},
	{
		...
		processNextAction: function(actNum, reqTarg, respTarg, checkNumLine){
			var check = false, istReq = CvgIst.fromAction(respTarg), istResp = CvgIst.fromAction(respTarg);
			if (reqTarg.nl > 0) {
				check = processNextAction(actNum, reqTarg, respTarg, checkNumLine);
			}
			else {
				check = istReq.win === istReq.win && istReq.screen === istResp.screen && istReq.bloc === istResp.bloc;
			}
			return check;
		}
	},
