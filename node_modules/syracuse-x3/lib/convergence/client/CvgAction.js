...
exports.Actions67 = helpers.defineClass(function() {}, null, {
	init: function() {
		this.RAW_ACTIONS = [
		...
		this.actions = this.RAW_ACTIONS.reduce(function(actions, desc) {
			actions[desc[0]] = desc[1];
			return actions;
		}, {});

		this.Descriptors = this.RAW_ACTIONS.reduce(function(actions, desc) {
			actions[desc[1]] = {
				name: desc[0],
				id: desc[1],
				params: desc[2]
