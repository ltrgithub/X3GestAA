...
exports.CvgRequest = helpers.defineClass(function(aClient, aAdonixReply, sendContext) {
	...
	listenNodeNDDSLB: function(_, reader, node, ist, value) {
		...
		if (v && v instanceof CvgVariableCombo) {
	...
	listenNodeNDGTIM: function(_, reader, node, properties) {
		...
		try {
			...
			if (datasource.startPage && datasource.stopPage && datasource.startPage > 0 && datasource.stopPage !== 0 && datasource.stopPage <= 1000000 && datasource.stopPage >= datasource.startPage) {
