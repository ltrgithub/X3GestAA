...
var CvgRequest = exports.CvgRequest = helpers.defineClass(function(aClient, aAdonixReply, aParams, sendContext) {
	...
	listenNodeND_ASKUI: function(_, reader, node) {
		...
		new CvgDiagnose(this.client, 'WARNING', 99, "ASKUI node not supported", "ND_ASKUI", null, "Protocol" ,true);
	},
	...
	listenNodeNDINED: function(_, reader, node) {
		...
		// TODO: translate message
		new CvgDiagnose(this.client, 'WARNING', 99, "NDINED node not supported", "NDINED", null, "Protocol" ,true);
	},

	listenNodeND_INT: function(_, reader, node) {
		// TODO: translate message
		new CvgDiagnose(this.client, 'WARNING', 99, "ND_INT node not supported", "ND_INT", null, "Protocol" ,true);
	...
	listenNodeNDSYSTEM: function(_, reader, node) {
		// TODO: translate message
		new CvgDiagnose(this.client, 'WARNING', 99, "NDSYSTEM node not supported", "NDSYSTEM", null, "Protocol" ,true);
		return [0];
	},
	
	listenNodeNDEDBK: function(_, reader, node) {
		// TODO: translate message
		new CvgDiagnose(this.client, 'WARNING', 99, "NDEDBK node not supported", "NDEDBK", null, "Protocol" ,true);
		return [0, 0];
	},
	
	listenNodeND_OCX: function(_, reader, node) {
		// TODO: translate message
		new CvgDiagnose(this.client, 'WARNING', 99, "ND_OCX node not supported", "ND_OCX", null, "Protocol" ,true);
		return [0, 0, 0, 0, 0];
	},
	listenNodeND_IHM: function(_, reader, node) {
		// TODO: translate message
		new CvgDiagnose(this.client, 'WARNING', 99, "ND_IHM node not supported", "ND_IHM", null, "Protocol" ,true);
		return [0, 0, 0, 0, 0];
	},
	listenNodeNDGTDT: function(_, reader, node) {
		// TODO: translate message
		new CvgDiagnose(this.client, 'WARNING', 99, "NDGTDT node not supported", "NDGTDT", null, "Protocol" ,true);
		return [0, 0, 0, 0, 0];
	},
...
//					this.client.closeClient(_, null, 3);
	...
	listenSendingArgsAckResi: function(aCommClient,aParams, ist, call){
		...
		aParams.push(ist);
		var callParams = rpc.xml ? jsxml.parse(rpc.xml) : rpc.json;
