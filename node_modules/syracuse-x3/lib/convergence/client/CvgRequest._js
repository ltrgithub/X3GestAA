...
/* TODO overload
	...
	listenNodeNDRESULT: function(_, reader, node, ist, errn, errl, errp, errt, errm, resu, tblParams, tblResus) {
		var list = this.client.trackLists.RPC;
		var rpc = list[list.length - 1];
		if (rpc)
			rpc.setReply(errn, errl, errp, errt, errm, resu[0], tblParams[0], tblResus[0]);
	},
...
//		console.log("JSON:\n"+JSON.stringify(call.json,null,2));
		...
		new CvgReplyAckCall(this.client, spgmId);
