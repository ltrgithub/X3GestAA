...
var CLeftListAppender = exports.CLeftListAppender = helpers.defineClass(function(aIdx, aBranche, aTxt, aVal, aClf, aClp) {
	...
	setModifiable: function(ist, obj) {
		var leftList =obj.appendLeftListLine(this.idx, this.branche, this.txt, this.val, this.clf, this.clp);
		this.done = true;
		return this.done;
	}
});
...
var CServerColorSetter = exports.CServerColorSetter = helpers.defineClass(function(aColor) {
	CvgModifier.call(this);
	this.color = aColor;
}, CvgModifier, {
	setModifiable: function(ist, obj) {
...
var CvgRequest = exports.CvgRequest = helpers.defineClass(function(aClient, aAdonixReply, sendContext) {
	...
	listenNodeNDOFLD: function(_, reader, node, ist, txt1, txt2, txt3, int1, txt4, txt5) {
		var ist = new CvgIst(ist.winAlphaId+",AH,A");
		//ist.screen = 34;
		//ist.bloc = 1;
		//ist.idx = -1;
		var line = [];
		line.push(new CvgResu(CvgResuTag["STRU"], txt1));
		line.push(new CvgResu(CvgResuTag["STRU"], txt2));
		line.push(new CvgResu(CvgResuTag["STRU"], txt3));
		line.push(new CvgResu(CvgResuTag["STRU"], parseInt(int1, 10)));
		line.push(new CvgResu(CvgResuTag["STRU"], txt4));
		line.push(new CvgResu(CvgResuTag["STRU"], txt5));
		var clf = [];
		var done = this.client.traverseSettable(ist, new CLeftListAppender(-1, 0, "", line, clf, null));
		if( !done ){
			console.log("line not appened :  NDOFLD to list "+ist.toJSON());
		}
	},
	...
	listenNodeNDOUVIMP: function(_, reader, node, properties) {
		...
		if (properties['+STATE'] && properties['+STATE'] === "LAUNCHED") {			
			try{
				...
				printClient = PrintClient.getClient(_, srvId.host, srvId.port, true);	
			...
			try{
				...
				printClient = PrintClient.getClient(_, hostname, port);
	...
	listenSendingArgsAckCall: function(aCommClient, aParams){
		var call = aParams && aParams.length > 2 ? aParams[2] : null, ist = aParams && aParams.length > 1 ? aParams[1] : null;
		// Check params
