...
var CvgRequest = exports.CvgRequest = helpers.defineClass(function(aClient, aAdonixReply, sendContext) {
	...
	listenNodeNDGTIM: function(_, reader, node, properties) {
		...
		try {
			...
			datasource.orientation = properties._Orientation ? parseInt(properties._Orientation, 10) || nullVal : nullVal;
			...
			datasource.duplex = properties._PrtDescDuplex ? parseInt(properties._PrtDescDuplex, 10) || nullVal : nullVal;
