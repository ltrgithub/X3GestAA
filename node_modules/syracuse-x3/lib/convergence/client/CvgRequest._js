...
var CvgRequest = exports.CvgRequest = helpers.defineClass(function(aClient, aAdonixReply, sendContext) {
	...
	this.help = null;
	this.workingCtx = {};
	// stock timing for write, read node and analyse node 
	this.timing = {
		binary: {
			read: [],
			write: []
	...
	listenNodeND_ASKUI: function(_, reader, node, properties) {
		try {
			new CvgAskUiAction(this.client, properties);
		} catch (e) {
			throw e;
		} finally {
	...
	listenNodeNDCHVB: function(_, reader, node, ist, resus) {
		...
		if (this.client.boClient.variable && !this.client.boClient.token) {
			try {
				...
				new CvgDiagnose(this.client, 'ERROR', 99, e.message, e.stack, null, "Convergence Server", null, true);
			}
		}
