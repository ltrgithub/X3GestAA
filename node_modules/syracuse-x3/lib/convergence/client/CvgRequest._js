...
var CvgRequest = exports.CvgRequest = helpers.defineClass(function(aClient, aAdonixReply, aParams, sendContext) {
	...
	buildIstDatasOfAction: function(aParam) {
		...
		if (ist.editedResuTyp === CvgResu.TAG_NULL) {
			return ist;
		}
...
/* TODO overload
	...
	listenSendingArgsAckCall: function(aCommClient,aParams,xml){
	   var jsCall = jsxml.parse(xml);
	   console.log(JSON.stringify(jsCall,null,2));
	   // name of subprog
	   ...
	   console.log("ackCall : "+JSON.stringify(aParams,null,2));
	},
	...
	listenSendingArgs: function(body, aCommClient, aParams) {
		...
		case CvgAction.SRV_CALLREMOTESPGM:
			if (body.param.call && body.param.call.xml)
				this.listenSendingArgsAckCall(this,aParams,body.param.call.xml);
			else
