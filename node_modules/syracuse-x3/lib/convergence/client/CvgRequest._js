...
var CvgRequest = exports.CvgRequest = helpers.defineClass(function(aClient, aAdonixReply, aParams, sendContext) {
	...
	listenNodeND_ASKUI: function(_, reader, node) {
		this.client.sendAction(_, new CvgResu(CvgResuTdo["STRU"], "-99,Not supported"), [], [CvgAction.SRV_ASKUI_RESPONSE]);
	...
	listenNodeNDINED: function(_, reader, node) {
		this.client.sendAction(_, new CvgResu(CvgResuTdo["STRU"], ""), [], [CvgAction.SRV_EXECUTE]);
		// TODO: translate message
...
//					this.client.closeClient(_, null, 3);
	...
	listenSendingArgsAckResi: function(aCommClient,aParams, ist, rpc){
		...
		aParams.push(returnVal);
		// push params
		aParams.push(rpc.json.params);
