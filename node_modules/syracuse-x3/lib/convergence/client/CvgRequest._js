...
exports.CvgRequest = helpers.defineClass(function(aClient, aAdonixReply, sendContext) {
	...
	listenActionArgsBRWCHANGELINE: function(aClient, aParams) {
		this.listenActionArgsDOLEFTLISTLINE(aClient, aParams);
	},
	listenActionArgsBRWSELECTLINE: function(aClient, aParams) {
		this.listenActionArgsDOLEFTLISTLINE(aClient, aParams);
	},
	listenActionArgsTREEEXPANDLINE: function(aClient, aParams) {
		this.listenActionArgsDOLEFTLISTLINE(aClient, aParams);
	},
	listenActionArgsTREESELECTLINE: function(aClient, aParams) {
		this.listenActionArgsDOLEFTLISTLINE(aClient, aParams);
	},
	/**
