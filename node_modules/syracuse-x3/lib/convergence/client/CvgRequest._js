...
exports.CvgRequest = helpers.defineClass(function(aClient, aAdonixReply, sendContext) {
	...
	listenNodeND_ASKUI: function(_, reader, node, properties) {
		try {
			...
			this.workingCtx.pendingBlockingNode = {
				...
				"act": this.client.x3writer.actions.actions.SRV_ASKUI_RESPONSE,
				"param": {},
				"fld": {
					"ist": null,
	...
	listenNodeNDINED: function(_, reader, node) {
		this.client.x3writer.sendAction(_, this.client, new CvgResu(CvgResuTdo.STRU, ""), [], [this.client.x3writer.actions.actions.SRV_EXECUTE]);
	...
	listenNodeNDOBOXI: function(_, reader, node, typBox, btnNum, msg, ttl, wSleep) {
		...
		try {
			...
			this.workingCtx.pendingBlockingNode = {
				"id": "NDBOXI",
				"proxy": "processAsyncAction",
				"act": this.client.x3writer.actions.actions.SRV_CHAMP_SUIVANT,
				"param": {},
				"fld": {
					fmtKind: "SHOW",
					ist: null,
	...
	listenSendingArgs: function(body, aCommClient, aParams) {
		...
		var absCalled = CvgRequestAbs.prototype.listenSendingArgs.call(this, body, aCommClient, aParams);
		if (!absCalled) {
			switch (body.act) {
				case this.client.x3writer.actions.actions.SRV_BRWCHANGELINE:
				case this.client.x3writer.actions.actions.SRV_BRWSELECTLINE:
				case this.client.x3writer.actions.actions.SRV_TREECHANGELINE:
				case this.client.x3writer.actions.actions.SRV_TREEEXPANDLINE:
				case this.client.x3writer.actions.actions.SRV_TREESELECTLINE:
					return this.listenActionArgsDOLEFTLISTLINE(aCommClient, aParams);
				case this.client.x3writer.actions.actions.SRV_BRWRAPIDESEL:
					return this.listenActionArgsBRWRAPIDESEL(aCommClient, aParams);
				case this.client.x3writer.actions.actions.SRV_LIST_PAGE_DOWN:
					return this.listenActionArgsLIST_PAGE_DOWN(aCommClient, aParams);
				case this.client.x3writer.actions.actions.SRV_LIST_PAGE_UP:
					return this.listenActionArgsLIST_PAGE_UP(aCommClient, aParams);
				case this.client.x3writer.actions.actions.SRV_PICKING:
