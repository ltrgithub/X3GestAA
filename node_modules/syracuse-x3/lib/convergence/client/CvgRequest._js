...
var CvgRequest = exports.CvgRequest = helpers.defineClass(function(aClient, aAdonixReply, aParams, sendContext) {
	...
	listenNodeND_ASKUI: function(_, reader, node) {
		console.log("ND_ASKUI nodes are ignored in fusion client");

		this.client.sendAction(_, new CvgResu(CvgResuTdo["STRU"], "-99,Demande de service non supportée"), [], [CvgAction.SRV_ASKUI_RESPONSE]);
	},

	
	listenNodeNDINED: function(_, reader, node) {
		console.log("NDINED nodes are ignored in fusion client");
