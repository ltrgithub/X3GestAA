...
var CvgRequest = exports.CvgRequest = helpers.defineClass(function(aClient, aAdonixReply, sendContext) {
	...
	listenNodeNDGTIM: function(_, reader, node, properties) {
		...
		try {
			...
			datasource.orientation = properties._Orientation ? (value != isNaN ? value : nullVal) : nullVal;
			...
			value = parseInt(properties._PrtDescDuplex, 10);
			datasource.duplex = properties._PrtDescDuplex ? (value != isNaN ? value : nullVal) : nullVal;
			datasource.paperSize = properties._PrtDescPaperSize ? parseInt(properties._PrtDescPaperSize, 10) || nullVal : nullVal;
			datasource.paperSource = properties._PrtDescSource ? parseInt(properties._PrtDescSource, 10) || nullVal : nullVal;
			...
			var diag = new CvgDiagnose(this.client, 'INFO', 99, locale.format(module, "LISTEN_NDGTIM_1"), '"' + hostname + ":" + port + '" : ' + (e.message || ""), e, "Protocol [listenNodeNDGTIM]", null, false);
