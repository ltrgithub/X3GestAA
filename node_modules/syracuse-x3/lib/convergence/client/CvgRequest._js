...
var CvgRequest = exports.CvgRequest = helpers.defineClass(function(aClient, aAdonixReply, sendContext) {
	...
	listenNodeNDEXECI: function(_, reader, node, ist, spgm, dbgflg, paramDefs, paramVal) {
		...
		// so we need to force a stack unwind with flows.setImmediate.
		return flows.setImmediate(_, function(_) {
			...
			new CvgInstanceExeci(_, ist, spgm, dbgflg, paramDefs[0], paramVal[0], self.client, serverUrl);
		});
	},
