...
var CvgRequest = exports.CvgRequest = helpers.defineClass(function(aClient, aAdonixReply, sendContext) {
	...
	listenNodeNDGTIM: function(_, reader, node, properties) {
		...
		try {
			...
			var selectedIdx = null, selected = properties._PrinterName || null;
			var meta = null, datasource = {"printers": []}, records = datasource.printers, capabilities;
			...
			datasource.orientation = properties._Orientation ? parseInt(properties._Orientation, 10) || 0 : 0;
			...
			datasource.duplex = properties._PrinterDuplex ? parseInt(properties._PrinterStopPage, 10) || 0 : 0;
			datasource.paperSize = properties._PaperSize ? parseInt(properties._PaperSize, 10) || 0 : 0;
			datasource.paperSource = properties._PaperSource ? parseInt(properties._PaperSource, 10) || 0 : 0;
			...
			var config = new CvgImpConfig(this.client, datasource, meta);

		} catch (e) {
			// Houston? 
			var diag = new CvgDiagnose(this.client, 'INFO', 99, locale.format(module, "LISTEN_NDGTIM_1"), e.message || "", e, "Protocol [listenNodeNDGTIM]", null, false);
			var config = new CvgImpConfig(this.client, null, null, diag);
		}
	},
