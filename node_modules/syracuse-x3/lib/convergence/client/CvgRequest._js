	...
	setModifiable: function(aStructIst, aModifiable) {
		...
		if (this.done) {
			...
			if (wDataSrc.hasDimOverFlow()) {
				this.setLogicalErrMess(this.cli.getMessage('ERROR_DIM_OVERFLOW', String.valueOf(wDataSrc.dim), String.valueOf(this.nbLines), String.valueOf(wDataSrc.lines.length)));
			}
		} else {
			this.setLogicalErrMess(this.cli.getMessage('ERROR_NOT_RIGHT_MODIFIABLE', aModifiable.getAdxId(), 'CvgDataSrc'));
		}
...
//				if (this.client.connecting)
//					this.client.closeClient(_, true, null, 3);
				break;
			}
