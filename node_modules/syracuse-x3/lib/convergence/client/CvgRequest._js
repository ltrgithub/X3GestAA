		...
		try {
			if (properties) {
				...
				if (!this.client.cvgPlugin.ND_IHM["ilog"]) {
					plug = this.client.cvgPlugin.ND_IHM["ilog"] = new CvgPlugin(_, this.client, localConfig.plugin && localConfig.plugin.killTimeoutOnCreate || 120000); // default 120s if it's not defined
				} else {
