...
var CvgMenuWin = require('../model/CvgMenuWin').CvgMenuWin;
var CvgWinMenuList = require('../model/CvgMenuWin').CvgWinMenuList;
...
exports.CvgReply = CvgReply; // Dummy comment to clean up rollout repository #6948