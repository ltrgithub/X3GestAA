...
var CvgReply = exports.CvgReply = helpers.defineClass(function(client, actionId) {
	...
	setTargetAdxId: function(ist, request) {
		...
		if (target == null) throw new Error("Target entity not found[" + ist.toString() + "]");
		if (!(target instanceof CvgEntity)) throw new Error("Bad target class [" + ist.toString() + "] - CvgEntity expected");
