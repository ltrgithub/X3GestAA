...
exports.CvgClient = helpers.defineClass(function() {
		...
		if (specialAction.proxy === "srvImp") {
			...
			switch (specialAction.id) {
				...
				case "CLIENT_DELETE":
					...
					this._clientILogDeletePlugin(_, "ilog-default", body);
	...
	_clientILogDeletePlugin: function(_, defaultId, body) {
		// get id of the plugin
		delete this.cvgPlugin.ND_IHM;
		this.cvgPlugin.ND_IHM = {};
	},
	...
	executeCallUiReportDev: function(_, value) {
		//this.cvgPlugin.reportDev =
	},
	...
	newILogPlugin: function(_) {
		...
		var plug = this.cvgPlugin.ND_IHM["ilog-default"] = new CvgPluginILog(this, "ilog-default", this.killPluginTimoeut || 20000);
		return plug;
	},
	...
	execCallUi: function(_, values) {
		switch (values.UIAction) {
			...
			case "ReportDev":
				return this.executeCallUiReportDev(_, values);
				//case "PutFileAlways":
