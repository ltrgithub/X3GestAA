	...
	executeGetUiBO: function(_, key) {
		try {
			if (key === "GetBoToken") {
				...
				this.clientConfig._params.GetBoHost = this.boClient.boserv ? this.boClient.boserv : null;
			} else if (key === "GetBoPort") {
				this.clientConfig._params.GetBoPort = this.boClient.boport ? this.boClient.boport : null;
			}
		} catch (e) {
