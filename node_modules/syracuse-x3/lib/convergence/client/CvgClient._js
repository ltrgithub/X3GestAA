...
var CvgClient = exports.CvgClient = helpers.defineClass(function(_, cvgSession, stream, aConfig, recorder) {
	...
	listenNodeNDOMNCO: function(_, reader, node, flag, actId, txt) {
		// console.log("listenNodeNDOMNCO - actId="+ actId + " - flag=" + flag + " - txt=" + txt);
		var type = (flag & 0x08) >> 3 === 0;
		if (!type && actId > 0)
		{
			var removeBtns = (flag & 0x40) !== 0;
			// console.log("new CvgMenuCtx - removeBtns=" + removeBtns);
			if (removeBtns)  _postDiag(this, "removeCtxButtons not implemented", "NDOMNCO");
