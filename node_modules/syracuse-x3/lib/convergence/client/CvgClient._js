...
var CvgClient = exports.CvgClient = helpers.defineClass(function(_, stream, aConfig, recorder) {
	...
	listenNodeNDCTSU: function(_, reader, node, type, subType, compl) {
		...
		if (this.currentDynFormat == null) {			
			this._sessDynFormat[type] = this.currentDynFormat = {};
		}
		/*
		 ...
		 */
			...
			this.currentDynFormat.subType = subType;
		}
		/*
		 ...
		 */
			 ...
			 */
			this.currentDynFormat.complement = compl;
			this.currentDynFormat = null;
		}
	},
...
//				};
		...
		if (true === connect){
			...
			for (var p in this._sessDynFormat) {
				var dynFmt= this._sessDynFormat[p];
				var res = {};
