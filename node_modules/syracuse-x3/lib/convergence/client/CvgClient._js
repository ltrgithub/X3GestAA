		...
		try {
			...
			if (this.isAlive()) {
				if (this.clientConfig.modePLAY) {
					...
					if (this.activeRequest && this.activeRequest.workingCtx.pendingBlockingNode) {
						...
						pendingNode = this.activeRequest.workingCtx.pendingBlockingNode;
						// Response is not used
						// var resp = this[pendingNode.proxy](_, {
						this[pendingNode.proxy](_, {
							act: pendingNode.act,
							fld: pendingNode.fld || {
								notModified: true
							},
