...
exports.CvgClient = helpers.defineClass(function(_, cvgSession, stream, aConfig, recorder, context) {
		...
		if (specialAction.proxy === "srvImp") {
			...
			switch (specialAction.id) {
				case "REPLY_PLUGIN":
					...
					x3writer.props1Serializer.build(_buildPluginResponse(_, body && body.param && body.param.plugin), true);
					break;
				default:
	...
	_buildPluginResponse: function(_, paramPlug) {
		// TODO implem the generation of property as expected by the runtime
		return {};
	},
