...
//				};
		...
		for (var i = 0; i < lists.X3ERROR.length; i++) {
			response.srvop.$x3error = response.srvop.$x3error || [];
			response.srvop.$x3error.push(JSON.parse(JSON.stringify(lists.X3ERROR[i])));
		}	
