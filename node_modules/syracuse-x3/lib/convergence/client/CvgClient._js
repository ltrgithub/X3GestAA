...
var _recordMgr = require('syracuse-x3/lib/convergence/records/CvgRecordMgr').recordMgr;
...
var CvgClient = exports.CvgClient = helpers.defineClass(function(_, stream, aConfig) {
	// Activate dump
	if (false && localConfig && localConfig.dump) {
		//this._spy = new Spy(_, stream);
		this._recorder = CvgRecorder.newRecorder(_, stream);
	}
