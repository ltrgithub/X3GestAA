...
var CvgClient = exports.CvgClient = helpers.defineClass(function(_, cvgSession, stream, aConfig, recorder,context) {
	...
	processAction: function(_, body, connect,mergeMode) {
		try {
			...
			this.newActiveRequest(reply, {"ctxNDSLB": this.ctxNDSLB, "reqNum": body.tech && body.tech.id ? body.tech.id : 0, "target": target,"connect":connect},mergeMode);	
			var resu, extras = [];
			if (body.fld) {
				if (body.fld.v != null){
					var entity =null;
	...
	processRequest: function(_, context, bodyStr) {
		...
		var body = JSON.parse(bodyStr), resp="";
