...
exports.CvgClient = helpers.defineClass(function() {
	...
	_clientILogDeletePlugin: function(_, body) {
		// get id of the plugin
		console.log("delete plugin " + JSON.stringify(Object.keys(this.cvgPlugin)));

		var id = this.cvgPlugin["ilog-default"].id;
		delete this.cvgPlugin["ilog-default"];
		delete this.cvgPlugin["ilog-" + id];
		console.log("delete plugin " + JSON.stringify(Object.keys(this.cvgPlugin)));
	},
