...
exports.CvgClient = helpers.defineClass(function(_, cvgSession, stream, aConfig, recorder, context) {
	...
	processRequest: function(_, context, bodyStr) {
		...
		if (this.isProcessingRequest) { // process already oin progrss
			...
			var diag = new CvgDiagnose(this, null, 409, "a request is already processing", null, error, origin, "BUSY", true, null);
			...
			if (this.isAlive()) {
				if (this.clientConfig.modePLAY) {
					...
					flows.setTimeout(function(_) {
						console.log("ask Kill client uuid=[" + self.uuid + "] reasons=" + reason + " panic=" + (params.panic ? params.panic : false));
