...
function _addCacheAction(_, edp, entityName, id, isMiss) {
...
*/
	...
	// for stats
	cache && _addCacheAction(_, context.endpoint, context.entityName, context.instanceId, cache && cache.isInvalid);
