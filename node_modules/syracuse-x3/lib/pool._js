...
function _isCached(entityName) {
	return entityName === "SINVOICEV";
}

function getCacheClass(_) {
	if (!dataCacheClass)
		dataCacheClass = new cacheClass(_);
	return dataCacheClass;
...
*/
	...
	if (cache && cache.isInvalid) _toCache(_, context.entityName, context.instanceId, cache);
