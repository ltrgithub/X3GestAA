...
var CONNECT_ACTION = require('syracuse-x3/lib/fusion/CDefAction').CONNECT_ACTION;
...
var CAdapiClient = exports.CAdapiClient = helpers.defineClass(function(stream, adxInfos, aConfig, aType) {
	...
	executeCallUiSetHangHup: function(values) {
		if (values.UITimehangup1)
			this.maxTimeBeforeHangUp = values.UITimehangup1 < 1 ? -1 : values.UITimehangup1;
		if (values.UITimehangup2)
			this.maxTimeBeforeAutomaticHangUp = values.UITimehangup2 < 1 ? -1 : values.UITimehangup2;
		return {
			Sethangup: 1
		};
	},
