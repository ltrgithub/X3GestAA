...
var CFormaterJava = exports.CFormaterJava = helpers.defineClass(function() {}, null, {
	...
	formatField: function(format, value, bool) {
		// hack to get date format
		if (value && value.length === 8) return value.substring(6) + "/" + value.substring(4, 6) + "/" + value.substring(0, 4);
		return "" + value;
	}
});
...
var CAdapiClient = exports.CAdapiClient = helpers.defineClass(function(stream, aConfig, aType) {
	...
	addStatusIconDef: function(instance, aNumText, aTxt, aImgId, aActionId) {
		var winFound = null;
		for (i = 0; i < this.stackedWindows.length && winFound == null; i++) {
	...
	listenNodeNDPKAR: function(_, reader, node) {
		...
		if (this.adxIstsOfPickedLines.length > 0) {
			...
			if (wLeftListLine != null) {
				...
				addLogicalErrorMess(this, "NDPKAR", wArgIst.toString(), wMess);
			}
