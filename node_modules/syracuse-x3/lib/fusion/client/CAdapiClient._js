...
var CAdapiClient = exports.CAdapiClient = helpers.defineClass(function(stream, adxInfos, aConfig, aType) {
	...
	processSuperAction: function(_, body) {
		throw new Error("SUPERACTION NIY: " + body.act);
	},
	...
	filterSessionSettings: function() {
		...
		var res = {};
		for (var i in map){
			if (this.sessionSettings[i])
				res[map[i]] = this.sessionSettings[i];
			else if (this.appSrvSessionSettings[i])
				res[map[i]] = this.appSrvSessionSettings[i];
		}
		return res;
	},
