...
var SuperAction = helpers.defineClass(function(name, code, actions, stableTarget) {
	this.name = name;
	this.code = code;
...
new SuperAction("SUP_LIST_SELLINEEX", 781, ['SRV_GETFOCUS', 'SRV_SELLINE'], true);
