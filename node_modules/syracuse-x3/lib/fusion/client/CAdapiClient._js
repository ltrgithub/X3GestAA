...
var CAdapiClient = exports.CAdapiClient = helpers.defineClass(function(aAdapiConfig, aType) {
	...
	this.adapiResources = new CAdapiResourcesHelper();
	...
	listenNodeNDPKAR: function(_, reader, node) {
		...
		if (this.adxIstsOfPickedLines.length > 0) {
			...
			if (wLeftListLine != null) {
				...
				wActionArgs.add(wArgIst);
				var wMess = this.adapiResources.getMessage(CAdapiResources.KEYMESS_ERROR_CANT_GET_PICKED_LINE_KEY, String.valueOf(wArgIst.idx));
