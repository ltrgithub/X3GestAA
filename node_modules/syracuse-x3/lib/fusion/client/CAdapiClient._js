...
var CAdapiClient = helpers.defineClass(function(aAdapiConfig, aType) {
	TODO_SUPER(aAdapiConfig, aType);
	...
	listenNodeNDACTOBJ: function(node) {
		...
		if (num > WIN_NOHIDDEN) {
			var win = findModifiable(node.getNodeArgIst(0).ist);
	...
	listenNodeNDOTXSC: function(aSegmentNode) {
		var wIst = aSegmentNode.getNodeArgIst(0).ist;
