...
/* TODO overload
	...
	loadWindowDescription: function(_, wWindowsId) {
		...
		function getWindowXml(_, wWindowsId){
			//TODO TC
			console.log("wWindowsId: "+wWindowsId);
...
//			return require('fs').readFileSync("./data/OAMK.xml", 'utf8');
		...
		return jsxml.parse(getWindowXml(_, wWindowsId));
	},
	 ...
	 */
	listenNodeNDOWIN: function(_, req, node, wIst, wWindowsId, wFunctionId, wStamp) {
		...
		//try {
			...
			wWindowsId, wFunctionId, descr, wStamp, wIst.winStr);
