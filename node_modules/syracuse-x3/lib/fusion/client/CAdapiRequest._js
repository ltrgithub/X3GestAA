...
var CAdapiRequest = exports.CAdapiRequest = helpers.defineClass(function(aAdapiClient, aAdonixReply, aParams, sendContext) {
	...
	listenNodeNDCHFM: function(aSegmentNode) {
		...
		if (!wFormatSetter.done()) {
			...
			(this.reply).addLogicalErrorMess(this, METH_NDCHFM, wArgIst.ist.toStringDescr(), wMessLE);
			aSegmentNode.setLogicalErrFlag();
		}
		return true;
	}
	...
	listenNodeNDCHGR: function(aSegmentNode) {
		...
		if (!wStateSetter.done()) {
			(this.reply).addLogicalErrorMess(
			this, METH_NDCHGR, wArgIst.ist.toStringDescr(), buildListenNodeMessage(
	...
	listenNodeNDCHVB: function(aSegmentNode) {
		...
		if (!wValueSetter.done()) {
			...
			(this.reply).addLogicalErrorMess(this, METH_NDCHVB, wArgIst.ist.toStringDescr(), wMessLE);
			aSegmentNode.setLogicalErrFlag();
		}
		return true;
	}
	...
	listenNodeNDCSTL: function(aSegmentNode) {
		...
		if (!wStyleSetter.done()) {
			...
			(this.reply).addLogicalErrorMess(this, METH_NDCHST, wArgIst.ist.toStringDescr(), wMessLE);
			aSegmentNode.setLogicalErrFlag();
		}
		return true;
	}
	...
	listenNodeNDGLAR: function(aSegmentNode) {
		...
		if (!wLeftListLineSelecter.done()) {
			...
			(this.reply).addLogicalErrorMess(this, METH_NDGLAR, wArgIst.ist.toStringDescr(), wMessLE);
			aSegmentNode.setLogicalErrFlag();
		}
		return true;
	}
	...
	listenNodeNDINSLI: function(aSegmentNode) {
		...
		if (wDataSrcInserter.hasLogicalErrMess()) {
			...
			(this.reply).addLogicalErrorMess(this, METH_NDINSLI, wArgIst.ist.toStringDescr(), wMessLE);
			aSegmentNode.setLogicalErrFlag();
		}
		return true;
	}
	...
	listenNodeNDOCAR: function(aSegmentNode) {
		...
		if (!wDefs.isComplete()) {
			...
			(this.reply).addLogicalErrorMess(this, METH_NDOCAR, wArgIst.ist.toStringDescr(), wMess);
		}
	...
	listenNodeNDOLAR: function(aSegmentNode) {
		...
		if (!wVal.isComplete() || !wClf.isComplete() || !wClp.isComplete()) {
			...
			}(this.reply).addLogicalErrorMess(this, METH_NDOLAR, wArgIst.ist.toStringDescr(), wMess);
		}
		this.adapiClient.traverseSettable(
	...
	listenNodeNDSUPLI: function(aSegmentNode) {
		...
		if (wDataSrcDeleter.hasLogicalErrMess()) {
			...
			(this.reply).addLogicalErrorMess(this, METH_NDSUPLI, wArgIst.ist.toStringDescr(), wMessLE);
			aSegmentNode.setLogicalErrFlag();
		}
		return true;
	}
