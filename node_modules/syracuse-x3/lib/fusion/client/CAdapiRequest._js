...
var CEntityStateSetter = helpers.defineClass(function(aEntityState) {
	TODO_SUPER();
...
var CLeftListPickingSelecter = helpers.defineClass(function(selected) {
	TODO_SUPER();
...
var CLeftListSelecterByKey = helpers.defineClass(function(selected, aCle, request) {
	TODO_SUPER();
	this.selected = selected;
	this.cle = aCle;
...
var CServerStateSetter = helpers.defineClass(function(aState) {
	TODO_SUPER();
