...
var CAdapiRequest = exports.CAdapiRequest = helpers.defineClass(function(aAdapiClient, aAdonixReply, aParams, sendContext) {
	...
	listenNodeNDCHVL: function(aSegmentNode) {
		...
		var ist = aSegmentNode.getNodeArgIst(0).ist;
	...
	listenNodeNDCTIT: function(_, req, node, wArgIst, wTitle) {
		this.adapiClient.traverseSettable(wArgIst.ist, new CServerTitleSetter(wTitle));
		return true;
	}
	...
	listenNodeNDOLAR: function(aSegmentNode) {
		...
		this.adapiClient.traverseSettable(
		wArgIst.ist, new CLeftListAppender(wIdx, wBranche, wTxt, wVal, wClf, wClp));
		return true;
	}
	...
	listenNodeNDRZAR: function(aSegmentNode) {
		this.adapiClient.traverseSettable(
		aSegmentNode.getNodeArgIst(0).ist, new CLeftListDeleter());
		return true;
	}
