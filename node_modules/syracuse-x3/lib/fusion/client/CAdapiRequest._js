	...
	buildIstDatasOfAction: function(aParam) {
		...
		try {
			...
			if (v.acceptEditFormat() && istData.isEditFormat()) {
				...
				this.reply.addAdapiInstance(CAdapiInstance.newprevious(cli, istData.ist, v.format.format, istData.editedValue, this.adonixReply == null ? false : this.adonixReply.stayInCommandMode));
			}
