...
var CvgException = require('syracuse-x3/lib/fusion/model/CvgException').CvgException;
var CvgWindow = require('syracuse-x3/lib/fusion/model/CvgWindow').CvgWindow;
var CvgMessage = require('syracuse-x3/lib/fusion/model/CvgMessage').CvgMessage;
...
var CvgRequest = exports.CvgRequest = helpers.defineClass(function(aClient, aAdonixReply, aParams, sendContext) {
	...
	buildIstDatasOfAction: function(aParam) {
		...
		try {
			...
			var adapi = CvgInstance.newtarget(cli, ist.ist, v.format.format, ist.editedValue, this.reply == null ? false : this.reply.stayInCommandMode);
...
/* TODO overload
	...
	listenActionArgsPICKING: function(aClient, aParams) {
		...
		for (var i = 0; i < wSTAdxids.length; i++) {
			...
			wAdapiPickedLine = new CvgPickedLine(wStructIst, wAction);
	...
	listenNodeNDOBOXI: function(_, reader, node, wTypeBox, wChx, wMessText, wMessTitre, wSleep) {
		...
		if (wTypeBox == OU_BIF) {
			...
			if (wPos == 0 || wPos == 1) {
				...
				var wAdapiMessage = new CvgMessage(wAffSynchroneType, wAffSynchroneAction, wMessText, wMessTitre, -1, wSleep, -1, this.client);
