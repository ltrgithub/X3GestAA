	...
	*/
	...
	findTargetEntity: function() {
		...
		if (wTargetEntity == null) {
			...
			wMess = CStringFacilities.sprintf(wMess, this.targetIst == null ? "NULL" : this.targetIst.toStringDescr());
			this.adapiClient.addLogicalErrorMess(this, LIB_METHOD_GET_TARGET_FORMAT, this.targetIst == null ? "NULL" : this.targetIst.alphanumCodage, wMess);
		}
	...
	validTargetFormat: function(aFormat) {
		if (aFormat == null || !aFormat.isValid()) {
			...
			wMess = CStringFacilities.sprintf(wMess, this.targetIst.toStringDescr());
			this.adapiClient.addLogicalErrorMess(this, LIB_METHOD_GET_TARGET_FORMAT, this.targetIst.alphanumCodage, wMess);
			return wMess;
		} else {
