...
var CAdapiInstances = require('syracuse-x3/lib/fusion/model/CAdapiInstances').CAdapiInstances;
var CAdapiEntity = require('syracuse-x3/lib/fusion/model/CAdapiEntity').CAdapiEntity;
var CAdapiMessages = require('syracuse-x3/lib/fusion/model/CAdapiMessages').CAdapiMessages;
var AdapiMenuWin = require('syracuse-x3/lib/fusion/model/AdapiMenuWin').AdapiMenuWin;
var AdapiWinMenuList = require('syracuse-x3/lib/fusion/model/AdapiMenuWin').AdapiWinMenuList;
