...
var CvgInstances = require('syracuse-x3/lib/fusion/model/CvgInstances').CvgInstances;
var CvgEntity = require('syracuse-x3/lib/fusion/model/CvgEntity').CvgEntity;
var CvgMessages = require('syracuse-x3/lib/fusion/model/CvgMessages').CvgMessages;
var CvgMenuWin = require('syracuse-x3/lib/fusion/model/CvgMenuWin').CvgMenuWin;
var CvgWinMenuList = require('syracuse-x3/lib/fusion/model/CvgMenuWin').CvgWinMenuList;
...
var CvgReply = exports.CvgReply = helpers.defineClass(function(aClient, aOrderId, aSTAT, aReplyMessages) {
	...
	*/
	addTargetInstance: function() {
		...
		try {
			...
			if (wVariable instanceof CvgVariableDate) {
				wInstance.setRawValue(wVariable.getServerValStr());
			}
		} catch (e) {
			console.error(e);
	...
	setStatusNOTOK: function(e) {
		...
		this.messages.splice(0, 0, new CvgMessage(CAdonix.MSG_ERROR, 0, wMess, "", 0, 0, 0));
	},
	...
	addAskOpenFile: function(aUrl) {
		if (this.callUiOpenFiles == null) {
			this.callUiOpenFiles = new CvgAskOpenFiles();
		}
