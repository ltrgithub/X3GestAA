...
var CvgClientConfig = require("syracuse-x3/lib/fusion/model/CvgClientConfig").CvgClientConfig;
var CvgModifier = require('syracuse-x3/lib/fusion/model/CvgModifier').CvgModifier;
var CvgEntity = require('syracuse-x3/lib/fusion/model/CvgEntity').CvgEntity;
var CvgStackedWindows = require('syracuse-x3/lib/fusion/model/CvgStackedWindows').CvgStackedWindows;
var CvgStackedWindow = require('syracuse-x3/lib/fusion/model/CvgStackedWindow').CvgStackedWindow;
var CvgReply = require('syracuse-x3/lib/fusion/client/CvgReply').CvgReply;
var CvgRequest = require('syracuse-x3/lib/fusion/client/CvgRequest').CvgRequest;
var CvgInstance = require('syracuse-x3/lib/fusion/model/CvgInstance').CvgInstance;
var CvgMenuAct = require('syracuse-x3/lib/fusion/model/CvgMenuAct').CvgMenuAct;
var CvgMenuCtx = require('syracuse-x3/lib/fusion/model/CvgMenuCtx').CvgMenuCtx;
var CvgDataSrc = require('syracuse-x3/lib/fusion/model/CvgDataSrc').CvgDataSrc;
var CvgDataSrcLine = require('syracuse-x3/lib/fusion/model/CvgDataSrcLine').CvgDataSrcLine;
var CvgVariable = require('syracuse-x3/lib/fusion/model/CvgVariable').CvgVariable;
...
var CvgAction = require('syracuse-x3/lib/fusion/client/CvgAction').Actions;
var CvgSuperAction = require('syracuse-x3/lib/fusion/client/CvgAction').SuperActions;
var ActionDescriptors = require('syracuse-x3/lib/fusion/client/CvgAction').Descriptors;
var nodeconfig = require('syracuse-main/lib/nodeconfig');
var formatter = require('syracuse-x3/lib/formatter/format');
var CONNECT_ACTION = require('syracuse-x3/lib/fusion/client/CvgAction').CONNECT_ACTION;
				...
				if (!body.fld.ist) {
					...
					if (entity && entity instanceof CvgVariable) {
						...
						try {
							...
							var adapi = CvgInstance.newtarget(this, ist, entity.format.format, body.fld.v, this.activeRequest.reply == null ? false : this.activeRequest.reply.stayInCommandMode);
