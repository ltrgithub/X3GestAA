...
CStructIst.fromAction = function(param) {
	console.error("CStructIst.fromAction="+JSON.stringify(param,null,2));
	...
	return new CStructIst(make(win, screen, bloc, field), param.nl);
}