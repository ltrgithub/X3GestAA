...
var CStructIst = exports.CStructIst = helpers.defineClass(function(ist, ln) {
	if (arguments.length > 2) {
		this.ist = make(arguments[0], arguments[1], arguments[2], arguments[3]);
		this.ln = arguments[4] || 0;
	} else {
	...
	toString: function() {
		return this.winStr + this.screenStr + this.blocStr + this.field;
	},
	win0: {
		get: function() {
			return this.win - 2;
	...
	isAllLinesOfBlocIst: function() {
		return this.win != 0 && this.screen != 0 && this.bloc != 0 && this.field == 0 && this.ln == -1;
	},
	isAllLinesOfColumnIst: function() {
		return this.isBaseFieldIst() && this.ln == -1;
	},
	isBaseFieldIst: function() {
		return this.win != 0 && this.screen != 0 && this.bloc != 0 && this.field != 0;
	},
	isBlocIst: function() {
		return this.win != 0 && this.screen != 0 && this.bloc != 0 && this.field == 0 && this.ln == 0;
	},
	isCellIst: function() {
		return this.isFieldIst() && this.ln > 0;
	},
	isColumnIst: function() {
		return this.isBaseFieldIst() && this.ln == 0;
	},
	isFieldIst: function() {
		return this.isBaseFieldIst() && this.ln > -1;
	},
	...
	isRecordIst: function() {
		return this.isBlocIst() && this.ln != 0;
	},
