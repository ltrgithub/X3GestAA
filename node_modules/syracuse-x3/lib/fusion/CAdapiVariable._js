...
var CAdapiVariable = helpers.defineClass(function() {}, CAdapiEntity, {

	private CAdapiDataSrcLine this.srcLine;
	private CStructResu this.browserValue = null;
	private int this.dataType = CStructResu.TDO_ALPHA;
	private int this.decimal;
	private boolean this.mustBeFormated = false;
	private String this.name;
	private int this.resuType = CStructResu.X3TYP_STRU;
	private boolean this.withDecimal;
	/**
	 */

	protected CAdapiVariable(srcLine, aEntityIndexBaseOne, aVariableName, aVariableId, aDataType, aFormat, aEntityState) {
	...
	// True si la valeur formatee a du sens - false pour tout ce qui n'a pas de
	// format d edition de menu
	...
	, cloneValues: function(var) {
		TODO_SUPER.cloneValues(var);
		var.this.browserValue = this.browserValue;
	}, dispose: function(){
		TODO_SUPER.dispose();
		this.srcLine = null;
