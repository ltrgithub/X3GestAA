...
CStructResu.read = function(reader) {
	...
	switch (tag) {
		...
		case CStructResu.TAG_DCB:
			if (len !== 17) throw new Error("bad dcb len: " + len);
			// TODO
			console.log("!!! DCB len=" + len + ", data=" + reader.data.slice(reader.pos).toString('hex'))
			val = 0;
			reader.pos += len;
