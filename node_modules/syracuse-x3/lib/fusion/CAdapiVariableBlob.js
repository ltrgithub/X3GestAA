...
var CAdapiVariableBlob = exports.CAdapiVariableBlob = helpers.defineClass(function(srcLine, aEntityIndexBaseOne, aVarName, aID, aTdo, aSize, aFormat, aEntityState, aUrl) {
	...
	controlBlobSize: function(aBlob) {
		...
		if (aBlob.length > wMaxSize) {
			throw CAdapiException.newFmtException(this.adapiClient, null, this.adapiClient.adapiResources.getMessage(CAdapiResources.KEYMESS_ERROR_UPLOAD_BLOB, aBlob.length.toString(), this.id, wMaxSize.toString(), this.size.toString()));
		}
	},
