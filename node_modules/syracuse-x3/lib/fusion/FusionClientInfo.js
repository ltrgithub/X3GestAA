...
var FusionClientInfo = helpers.defineClass(function(msgCode, msgDef, errCode) {
	...
	apendToJSon: function(o, errMsg) {
		...
		o.put('msgCode', 500 + this.msgCode);
		o.put('msgDefault', this.msgDef);
		o.put('errCode', this.errCode.name());
		...
		o.put('errMsg', errMsg == null ? "" : errMsg);
		return o;
	},
});
