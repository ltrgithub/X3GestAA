...
/* TODO overload
	...
	callFormater: function(aValue) {
		try {
			...
			this.client.addLogicalErrorMess(this, "callFormater", this.getAdxId(), buildMsgFormatterException('ERROR_FORMAT_EXCEPTION', 'FORMAT_RTOS', aValue, e));
		}
	...
	callUnFormater: function(aValue) {
		if (this.client.hasValidFormater() && this.hasValidFormat()) {
			try {
				...
				throw new CAdapiException(this.client, e, buildMsgFormatterException('ERROR_UNFORMAT_EXCEPTION', 'UNFORMAT_STOR', aValue, e), true);
			}
		}
		// No format
		...
		if (this.client.hasValidFormater() && this.hasValidFormat()) {
			try {
				...
				try {
					...
					throw new CAdapiException(this.client, e, buildMsgFormatterException('ERROR_FORMAT_EXCEPTION', 'FORMAT_ETOS', aValue, e), true);
				}
			}
			return res;
		} else {
		...
		if (this.acceptEditFormat() && this.mustBeFormatted && val != null) {
			if (this.hasValidFormat() && this.client.hasValidFormater()) {
				try {
					...
					this.client.addLogicalErrorMess(this, "callUnformaterToEdit", this.id, buildMsgFormatterException('ERROR_UNFORMAT_EXCEPTION', 'UNFORMAT_STOE', val, e));
				}
			}
		}
		return res;
