...
var ArrayList = Array;
/**
 * Impl�mentation d'une demande de service interactif
 *
 ...
 * @version 141
 */
var CAdapiAskUiAction = exports.CAdapiAskUiAction = helpers.defineClass(function() {
	this.list = new ArrayList();
}, null, {
	addOneParam: function(aId, aValue) {
		this.list.add([aId, aValue]);
	},
