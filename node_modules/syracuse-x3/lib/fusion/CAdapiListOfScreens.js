...
var CAdapiListOfScreens = exports.CAdapiListOfScreens = helpers.defineClass(function(aAdapiRequesterWindow) {
	...
	traverseSettable: function(aStructIst, aAdapiSetter) {
		...
		if (wAdapiScreen == null) {
			var wMess = this.adapiClient.adapiResources.getMessage(CAdapiResources.KEYMESS_ERROR_SCRN_UNKNOWN, CAdapiScreen.screenZeroBaseIdxToWhatScreen(wI), size().toString(), this.adapiRequesterWindow.id);
