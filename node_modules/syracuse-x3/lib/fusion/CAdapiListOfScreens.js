...
var CAdapiListOfScreens = exports.CAdapiListOfScreens = helpers.defineClass(function(aAdapiRequesterWindow) {
	...
	pushScreenLeftList: function(aAdapiScreen) {
		...
		this.pushEntity(aAdapiScreen.id, aAdapiScreen);
	},
	...
	traverseSettable: function(aStructIst, aAdapiSetter) {
		...
		if (wAdapiScreen == null) {
			var wMess = this.getAdapiClient().adapiResources.getMessage(CAdapiResources.KEYMESS_ERROR_SCRN_UNKNOWN, CAdapiScreen.screenZeroBaseIdxToWhatScreen(wI), this.length.toString(), this.adapiRequesterWindow.id);
