...
var CAdapiVariableNum = require('syracuse-x3/lib/fusion/CAdapiVariableNum').CAdapiVariableNum;
var CAdapiVariableCheck = require('syracuse-x3/lib/fusion/CAdapiVariableCheck').CAdapiVariableCheck;
var CAdapiVariableRadio = require('syracuse-x3/lib/fusion/CAdapiVariableRadio').CAdapiVariableRadio;
var CAdapiVariableCombo = require('syracuse-x3/lib/fusion/CAdapiVariableCombo').CAdapiVariableCombo;
var CAdapiVariableRTF = require('syracuse-x3/lib/fusion/CAdapiVariableRTF').CAdapiVariableRTF;
var CAdapiVariableIMG = require('syracuse-x3/lib/fusion/CAdapiVariableIMG').CAdapiVariableIMG;
var CAdapiVariablePass = require('syracuse-x3/lib/fusion/CAdapiVariablePass').CAdapiVariablePass;
var CAdapiVariableIcone = require('syracuse-x3/lib/fusion/CAdapiVariableIcone').CAdapiVariableIcone;
var CAdapiVariableAlpha = require('syracuse-x3/lib/fusion/CAdapiVariableAlpha').CAdapiVariableAlpha;
var CAdapiVariablePeriod = require('syracuse-x3/lib/fusion/CAdapiVariablePeriod').CAdapiVariablePeriod;
...
exports.CAdapiVariableFactory = {
	...
	instanciateVariable: function(aAdapiRequester, srcLine, aEntityIndexBaseOne, aId, aVariableNode, aForcedTDO) {
		...
		var wFormatDef = aForcedTDO != 0 ? CAdapiEntity.EMPTY : aVariableNode.$.FMT;
		...
		case CStructResu.TDO_DATE:
			{
				var wLocalformat = wConfig.getIntParam("date.format");
				var wDatePivot = wConfig.getIntParam("date.pivot");
				wFormat = this.valiDateFormat(adapiClient, wConfig, wFormat);
		...
		wVariable.mustBeFormated = wConfig.isInteractiveSession() && aForcedTDO == 0;
	...
	valiDateFormat: function(aAdapiClient, aConfig, aFormat) {
		if (!aFormat.isValid()) {
			aFormat = new CAdapiFormat(valiServerDateFormatDef(aConfig.getServerDateFormat()));
