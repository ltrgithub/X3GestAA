...
var CAdapiLeftList = exports.CAdapiLeftList = helpers.defineClass(function(aStackedWindow, aAdapiScreen, aEntityIndexBaseOne, aId, aListFormat, aNbColumns) {
	CAdapiDataSrc.call(this, aStackedWindow, aAdapiScreen, aEntityIndexBaseOne, aId, 300, aNbColumns, null, CAdapiDataSrc.TYPE_LEFTLIST);
	...
	setServerSelectLine: function(selected, aCle) {
		...
		var found = selIdx > -1;
		if (this.isListFormat(FMT_PICKING_FLAT)) {
			if (found) {
