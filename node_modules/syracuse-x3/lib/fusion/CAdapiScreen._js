...
var CAdapiScreen = helpers.defineClass(function(requesterWindow, idxbaseOne, aScreenId, aListOfEntity) {
	...
	getAdxId: function() {
		...
		return new StringBuilder().append(this.adapiRequesterWindow.adxId).append(',').append(this.entityIndexBaseOneInAlphanumFormat).toString();
	},
	getJsonKey: function() {
		return this.adapiObservableId.substring(1, 2);
	},
