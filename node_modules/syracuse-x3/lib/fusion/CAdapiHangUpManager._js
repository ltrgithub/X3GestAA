 ...
 * puisse se tuer si le hangUp est atteint et que le client Web n'est pas là.
 * 
 * @author apisu
 * 
 ...
 * 
 */
var CAdapiHangUpManager = helpers.defineClass(function() {}, Thread, {

	private static int DEFAULT_TEMPO_HANGUP_CHECK = 100;
	private static CAdapiHangUpManager sHangUpManager = null;

	public static CAdapiHangUpManager getHangUpManager() {
