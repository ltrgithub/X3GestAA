	...
	instanciateLocalMenus: function(aAdapiRequesterWindow, aWindowDescription, aLocalMenus) {
		...
		while (wI < wMax) {
			...
			if (aLocalMenus[wNumId] != null) {
				throw new CAdapiException(aAdapiRequesterWindow.client, "CANT_ADD_LOCALMENU - AlreadyExist");
			}
			aLocalMenus.addLocalMenu(this.instanciateLocalMenu(aAdapiRequesterWindow.client, wNumId, wLocalMenuId, wNbChoices, wLocalMenuNode));
			wI++;
		}
	}
}
