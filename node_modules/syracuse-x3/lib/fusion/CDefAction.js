...
var RAW_ACTIONS = [
	...
	['SRV_BRWCHANGELINE', 1051, 'ID'],
	// Action serveur 1024 + ACK_ULST (43)
	['SRV_BRWDESELECTLINE', 1067, 'ID'],
	...
	['SRV_LIST_PAGE_DOWN', 1073, 'ID'], // ist + key
	// Action serveur 1024 + ACK_REWD (48)
	['SRV_LIST_PAGE_UP', 1072, 'ID'], // ist + optional key
...
var processNextAction = function(actNum, reqTarg, respTarg, checkNumLine) {
	...
	console.error("reqTarg ="+JSON.stringify(reqTarg));
	console.error("respTarg="+JSON.stringify(respTarg));
