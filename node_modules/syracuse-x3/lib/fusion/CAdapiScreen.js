...
var CAdapiScreen = exports.CAdapiScreen = helpers.defineClass(function(requesterWindow, idxbaseOne, aScreenId, aListOfEntity) {
	CAdapiEntity.call(this, requesterWindow && requesterWindow.adapiClient, aScreenId, idxbaseOne, 'SCREEN');
	...
	getAdxId: function() {
		...
		return "" += this.adapiRequesterWindow.getAdxId() + ',' + this.entityIndexBaseOneInAlphanumFormat;
	},
	getJsonKey: function() {
