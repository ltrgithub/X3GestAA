...
var CModificationsErazor = exports.CModificationsErazor = helpers.defineClass(function() {}, CTraverser, {
	doWhenTraverse: function(aValue, aIdx, aWhen) {
		...
		if (typeof aValue.traverseChilds === 'function') {
			...
			return false; //pour ne pas arr�ter de "traverser" les "Values"
		}
	}
});

var CAdapiStackedWindows = exports.CAdapiStackedWindows = helpers.defineClass(function() {
	Array.call(this);
}, Array, {
	...
	traverseSettable: function(aStructIst, aSetter) {
		...
		if (!aStructIst.isWindowIst()) {
			return wAdapiRequesterWindow.traverseSettable(aStructIst, aSetter);
		} else {
			return aSetter.setAdapiModifiable(aStructIst, wAdapiRequesterWindow);
		}
	}
});