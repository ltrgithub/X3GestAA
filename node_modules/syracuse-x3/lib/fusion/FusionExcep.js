...
var CSDataEntryNoPayload = function() {};

var SDataEntryExcep = helpers.defineClass(function(schema, t) {
	TODO_SUPER(schema);
	this.exep = t;
...
var FusionExcep = helpers.defineClass(function(info, reason, s, e) {
	...
	toJSon: function() {
		...
		if (this.reason != null && !this.reason.isEmpty()) {
			r.put('errMsg', this.reason);
		}
		if (this.diag != null) {
			r.put('diagnoses', this.diag.toJSONArray());
		}
		return r;
	}
