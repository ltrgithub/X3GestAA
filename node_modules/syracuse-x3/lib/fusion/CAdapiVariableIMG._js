...
var CAdapiVariableBlob = function() {};
...
var CAdapiVariableIMG = helpers.defineClass(function(srcLine, aEntityIndexBaseOne, aVarName, aID, aTdo, aSize, aFormat, aEntityState) {
	TODO_SUPER(srcLine, aEntityIndexBaseOne, aVarName, aID, aTdo, aSize, aFormat, aEntityState, srcLine.adapiClient.adapiClientConfig.urlServerBlob);
}, CAdapiVariableBlob, {
	clone: function() {
	...
	getBlob: function() {
		if (hasValueBlob()) {
			return new CAdapiBlob(this.serverValResu, null);
		} else {
