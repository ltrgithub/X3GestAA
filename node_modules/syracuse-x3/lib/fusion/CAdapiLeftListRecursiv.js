...
var CAdapiLeftListRecursiv = exports.CAdapiLeftListRecursiv = helpers.defineClass(function(aStackedWindow, aAdapiScreen, aEntityIndexBaseOne, aId, aListFormat, aNbColumns) {
	CAdapiLeftList.call(this, aStackedWindow, aAdapiScreen, aEntityIndexBaseOne, aId, aListFormat, aNbColumns);
	...
	appendLeftListLine: function(aIdx, aBranche, aTxt, aVal, aClf, aClp) {
		...
		if (aClp.size() == 0) {
			...
			this.superAppendLeftListLine(wLeftListNode);
		} else {
	...
	traverseSettable: function(aStructIst, aAdapiSetter) {
		if (aStructIst.isLineIst()) {
			...
			return CAdapiLeftList.prototype.traverseSettable.call(this,aStructIst, aAdapiSetter);
		}
	},
