...
var CAdapiLeftList = require('syracuse-x3/lib/fusion/model/CAdapiLeftList').CAdapiLeftList;
var CAdapiListOfLocalMenus = require('syracuse-x3/lib/fusion/model/CAdapiListOfLocalMenusFactory').CAdapiListOfLocalMenus;
var CAdapiListOfLocalMenusFactory = require('syracuse-x3/lib/fusion/model/CAdapiListOfLocalMenusFactory').CAdapiListOfLocalMenusFactory;
var CAdapiListOfScreens = require('syracuse-x3/lib/fusion/model/CAdapiListOfScreens').CAdapiListOfScreens;
var CAdapiListOfDataSrcs = require('syracuse-x3/lib/fusion/model/CAdapiListOfDataSrcs').CAdapiListOfDataSrcs;
var CAdapiListOfDataSrcsFactory = require('syracuse-x3/lib/fusion/model/CAdapiListOfDataSrcsFactory').CAdapiListOfDataSrcsFactory;
var CAdapiListOfLeftLists = require('syracuse-x3/lib/fusion/model/CAdapiListOfLeftLists').CAdapiListOfLeftLists;
var CAdapiWindow = require('syracuse-x3/lib/fusion/model/CAdapiWindow').CAdapiWindow;
var CAdapiScreen = require('syracuse-x3/lib/fusion/model/CAdapiScreen').CAdapiScreen;
var CAdapiStackedWindow = require('syracuse-x3/lib/fusion/model/CAdapiStackedWindow').CAdapiStackedWindow;
var CAdapiListOfLeftListsFactory = require('syracuse-x3/lib/fusion/model/CAdapiListOfLeftListsFactory').CAdapiListOfLeftListsFactory;
var CAdapi = require('syracuse-x3/lib/fusion/model/CAdapi').CAdapi;
var AdapiStatusBar = require('syracuse-x3/lib/fusion/model/AdapiStatusBar').AdapiStatusBar;
...
var CAdapiStackedWindow = exports.CAdapiStackedWindow = helpers.defineClass(function(aClient, aWindowId, aFunctionId, aDescr, aStamp, aEnityIndexBaseOne) {
	CAdapiEntity.call(this, aClient, aWindowId, aEnityIndexBaseOne, 'WINDOW');
	this.statusBar = null;
	this.opened = false;
	this.window = null;
	...
	this.screens = new CAdapiListOfScreens(this);
	...
	if (this.hasDescrDom()) {
		...
		CAdapiStackedWindow.newScreens(this.client, this, this.descrDom, this.screens, this.listOfDataSrcs);
		CAdapiListOfLeftListsFactory.instanciateLeftLists(this, this.screens, this.descrDom, this.listOfLeftLists);
	}
}, CAdapiEntity, {
	addStatusIconDef: function(instance, aNumText, aTxt, aImgId, aActionId) {
		if (this.statusBar == null) {
			this.statusBar = new AdapiStatusBar();
		}
...
*/
	...
	setStamp: function(aStamp) {
		try {
			this.timeStamp = CAdapi.timeStampFormats(aStamp, this.client.formater.dateOrder);
		} catch (e) {
			console.error(e);
			this.timeStamp = "";
		}
...
CAdapiStackedWindow.newScreens = function(client, adapiRequesterWindow, windowDescription, adapiScreens, listOfDataSrcs) {
