		...
		if (wLocalMenusNodes && wMax > 0) {
			...
			while (wI < wMax) {
				...
				if (aLocalMenus[wNumId] != null) {
					throw new CAdapiException(aRequesterWindow.client, "CANT_ADD_LOCALMENU - AlreadyExist");
				}
...
CAdapiListOfLocalMenusFactory.instanciateLocalMenu = function(aClient, aId, aLocalMenuID, aNbChoices, aLocalMenuNode) {
	var wLocalMenu;
	try {
		...
		throw new CAdapiException(aClient, e, "CANT_ADD_LOCALMENU - instanciateLocalMenu");
	}
	return wLocalMenu;
}