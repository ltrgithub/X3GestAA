...
var CAdapiLeftList = exports.CAdapiLeftList = helpers.defineClass(function(aStackedWindow, aScreen, aEntityIndexBaseOne, aId, aListFormat, aNbColumns) {
	CAdapiDataSrc.call(this, aStackedWindow, aScreen, aEntityIndexBaseOne, aId, 300, aNbColumns, null, CAdapiDataSrc.TYPE_LEFTLIST);
	...
	appendLeftListLine: function(aIdx, aBranche, aTxt, aVal, aClf, aClp) {
		...
		CAdapiDataSrc.prototype.appendLeftListLine.call(this, wLeftListLine);
	...
	changeColumnsFormats: function(aFormats) {
		...
		if (aFormats.length > this.nbColumns) {
			wLeftListLine = CAdapiListOfLeftListsFactory.instanciateNewLeftListEntrySup(this.stackedWindow, this, aFormats.length);
	...
	isHierarchic: function() {
		return CAdapiLeftList.isHierarchicFormat(this.listFormat);
	},
	isListFormat: function(aListFormat) {
		return this.listFormat == aListFormat;
	},
	isRecursive: function() {
		return CAdapiLeftList.isRecursiveFormat(this.listFormat);
	},
	razModification: function() {
		this.nbColumnModified = false;
		this.columnTitleModified = false;

		CAdapiDataSrc.prototype.razModification.call(this);
	},
	...
	setServerSelectLine: function(selected, aCle) {
		...
		var found = selIdx > -1;
		if (this.isListFormat(CAdapiLeftList.FMT_PICKING_FLAT)) {
			if (found) {
...
CAdapiLeftList.FMT_HIERARCHIC = 2;
CAdapiLeftList.FMT_PICKING_FLAT = 5;
CAdapiLeftList.FMT_PICKING_HIERARCHIC = 3;
CAdapiLeftList.FMT_RECURSIVE = 4;

CAdapiLeftList.isHierarchicFormat = function(aFormat) {
	return aFormat == CAdapiLeftList.FMT_HIERARCHIC || aFormat == CAdapiLeftList.FMT_PICKING_HIERARCHIC;
}

CAdapiLeftList.isRecursiveFormat = function(aFormat) {
	return aFormat == CAdapiLeftList.FMT_RECURSIVE;
}