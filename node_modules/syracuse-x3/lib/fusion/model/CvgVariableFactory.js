...
var CvgVariableNum = require('syracuse-x3/lib/fusion/model/CvgVariableNum').CvgVariableNum;
var CvgVariableCheck = require('syracuse-x3/lib/fusion/model/CvgVariableCheck').CvgVariableCheck;
var CvgVariableRadio = require('syracuse-x3/lib/fusion/model/CvgVariableRadio').CvgVariableRadio;
var CvgVariableCombo = require('syracuse-x3/lib/fusion/model/CvgVariableCombo').CvgVariableCombo;
var CvgVariableRTF = require('syracuse-x3/lib/fusion/model/CvgVariableRTF').CvgVariableRTF;
var CvgVariableIMG = require('syracuse-x3/lib/fusion/model/CvgVariableIMG').CvgVariableIMG;
var CvgVariablePass = require('syracuse-x3/lib/fusion/model/CvgVariablePass').CvgVariablePass;
var CvgVariableIcone = require('syracuse-x3/lib/fusion/model/CvgVariableIcone').CvgVariableIcone;
var CvgVariableAlpha = require('syracuse-x3/lib/fusion/model/CvgVariableAlpha').CvgVariableAlpha;
var CvgVariablePeriod = require('syracuse-x3/lib/fusion/model/CvgVariablePeriod').CvgVariablePeriod;
...
exports.CvgVariableFactory = {
	instanciateLeftListColumn: function(aRequester, srcLine, aEntityIndexBaseOne, aVarId) {
		...
		var wVariable = new CvgVariableAlpha(srcLine, aEntityIndexBaseOne, aVarId, aVarId, CvgResu.TDO_ALPHA, wEF, CvgEntity.x3AffModeToEntityState(CvgEntity.X3VAR_MAF_SAISI));
	...
	instanciateVariable: function(aRequester, srcLine, aEntityIndexBaseOne, aId, aVariableNode, aForcedTDO) {
		...
		var wEntityState = CvgEntity.x3AffModeToEntityState(extactType(aVariableNode.$.MAF));
