		...
		if (wLocalMenusNodes && wMax > 0) {
			...
			while (wI < wMax) {
				...
				if (aLocalMenus[wNumId] != null) {
					throw new CvgException(aRequesterWindow.client, "CANT_ADD_LOCALMENU - AlreadyExist");
				}
...
CvgListOfLocalMenusFactory.instanciateLocalMenu = function(aClient, aId, aLocalMenuID, aNbChoices, aLocalMenuNode) {
	...
	try {
		...
		throw new CvgException(aClient, e, "CANT_ADD_LOCALMENU - instanciateLocalMenu");
	}
	return wLocalMenu;
}