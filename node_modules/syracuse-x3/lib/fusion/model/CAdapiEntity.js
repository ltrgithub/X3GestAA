...
var CAdapiEntity = exports.CAdapiEntity = helpers.defineClass(function(aClient, aId, aEntityIndexBaseOne, aEntityTyp) {
	...
	setServerFormat: function(aFormat) {
		...
		if (this.format == null || aFormat.format !== this.format.format) {
			this.setLastStampMod(getTick(), 'FMT');
		}
		this.format = aFormat;
	...
	storeFormat: function(aFormat) {
		if (this.format == null || this.format.format !== aFormat.format) {
			this.lastStampModFmt = getTick();
		}
		this.format = aFormat;
	},
