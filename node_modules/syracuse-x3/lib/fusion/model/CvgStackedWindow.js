...
var CvgListOfLocalMenus = require('syracuse-x3/lib/fusion/model/CvgListOfLocalMenusFactory').CvgListOfLocalMenus;
var CvgListOfLocalMenusFactory = require('syracuse-x3/lib/fusion/model/CvgListOfLocalMenusFactory').CvgListOfLocalMenusFactory;
var CvgListOfScreens = require('syracuse-x3/lib/fusion/model/CvgListOfScreens').CvgListOfScreens;
var CvgListOfDataSrcs = require('syracuse-x3/lib/fusion/model/CvgListOfDataSrcs').CvgListOfDataSrcs;
var CvgListOfDataSrcsFactory = require('syracuse-x3/lib/fusion/model/CvgListOfDataSrcsFactory').CvgListOfDataSrcsFactory;
var CvgListOfLeftLists = require('syracuse-x3/lib/fusion/model/CvgListOfLeftLists').CvgListOfLeftLists;
var CvgWindow = require('syracuse-x3/lib/fusion/model/CvgWindow').CvgWindow;
...
var CvgListOfLeftListsFactory = require('syracuse-x3/lib/fusion/model/CvgListOfLeftListsFactory').CvgListOfLeftListsFactory;
var Cvg = require('syracuse-x3/lib/fusion/model/Cvg').Cvg;
var CvgStatusBar = require('syracuse-x3/lib/fusion/model/CvgStatusBar').CvgStatusBar;
...
CvgStackedWindow.newScreens = function(client, adapiRequesterWindow, windowDescription, adapiScreens, listOfDataSrcs) {
	...
	while (i < max) {
		...
		adapiScreen = new CvgScreen(adapiRequesterWindow, i + 1, id);
		adapiScreens.pushEntity(id, adapiScreen);
		CvgListOfDataSrcsFactory.newScreenDataSrcs(adapiRequesterWindow, screenNode, adapiScreen, listOfDataSrcs);
		i++;
	}
}