...
var CAdapiVariableBlob = require('syracuse-x3/lib/fusion/model/CAdapiVariableBlob').CAdapiVariableBlob;
...
var CAdapiVariableIMG = exports.CAdapiVariableIMG = helpers.defineClass(function(srcLine, aEntityIndexBaseOne, aVarName, aID, aTdo, aSize, aFormat, aEntityState) {
	CAdapiVariable.call(this, srcLine, aEntityIndexBaseOne, aVarName, aID, aTdo, aSize, aFormat, aEntityState, srcLine.client.clientConfig.getUrlServerBlob());
}, CAdapiVariableBlob, {
	clone: function() {
