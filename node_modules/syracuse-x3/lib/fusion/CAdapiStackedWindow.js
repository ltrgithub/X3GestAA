...
var AdapiStatusBar = require('syracuse-x3/lib/fusion/AdapiStatusBar').AdapiStatusBar;
	...
	setNDOWinComplementDescr: function(aComplementDescr) {
		...
		if (this.window != null && aComplementDescr.indexOf(';') > -1) {
			...
			if (wST.countTokens() >= 3) {
				wST.nextToken(); // titre
				this.window.setNbLignes(wST.nextToken()); // ligne
				this.window.setNbColonnes(wST.nextToken()); // colonne
			}
		}
	},
