...
var CAdapiEntity = helpers.defineClass(function(aAdapiClient, aId, aEntityIndexBaseOne, aEntityTyp) {
	...
	getAdxIst: function() {
		return new CStructIst(this.tracer, this.adxId);
	},
	...
	getFatherWindowId: function() {
		...
		return this.adxId == null ? null : this.adxIst.winAlphaId;
	},
	...
	getServerValInt: function() {
		return this.serverValue != null ? this.serverValue.intValue : -1;
	},
	getServerValResu: function() {
		return this.serverValue;
	},
	getServerValStr: function() {
		return this.serverValue != null ? this.serverValue.value : EMPTY;
	},
	getState: function() {
	...
	getTracer: function() {
		return this.adapiClient != null ? this.adapiClient.tracer : CTracerNull.instance;
	},
	...
	setServerValue: function(aStructResu) {
		...
		if (!this.formatModified && this.columnFormater != null && !this.columnFormater.equals(this.format)) {
			forceServerFormat(this.columnFormater.format);
		}
		forceChange();
	}
