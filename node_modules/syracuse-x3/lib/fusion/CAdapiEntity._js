...
var CAdapiEntity = helpers.defineClass(function(aAdapiClient, aId, aEntityIndexBaseOne, aEntityTyp) {
	TODO_SUPER(aAdapiClient);
	this.entityState = STATE_DEFAULT;
	...
	if (w26E1 > 0) {
		wSB.append('@' + w26E1);
		wSB.append('@' + this.entityIndexBaseOne % 26);
	} else {
		wSB.append('@' + this.entityIndexBaseOne);
	}
