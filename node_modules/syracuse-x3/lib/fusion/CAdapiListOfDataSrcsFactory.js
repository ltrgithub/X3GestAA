...
var CAdapiListOfDataSrcsFactory = exports.CAdapiListOfDataSrcsFactory = {
	...
	newScreenDataSrcs: function(aStackedWindow, aScreenNode, aAdapiScreen, aAdapiDataSrcs) {
		...
		while (wI < wMax) {
			...
			wAdapiDataSrc = this.newEmptyDataSrc(aStackedWindow, aAdapiScreen, wI + 1, wDataSourceID, wDataSourceNode);
			aAdapiScreen.pushDataSrc(wDataSourceID, wAdapiDataSrc);
			aAdapiDataSrcs.pushEntity(wDataSourceID, wAdapiDataSrc);
			wI++;
		}
	}
};