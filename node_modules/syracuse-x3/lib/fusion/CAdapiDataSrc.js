...
var CAdapiDataSrc = exports.CAdapiDataSrc = helpers.defineClass(function(aRequester, aScreen, aEntityIndexBaseOne, aDataSourceID, aDim, aNbField, aVarBasPage, dataSrcType) {
	...
	traverseSettable: function(aStructIst, aSetter) {
		var CServerStateSetter = require('syracuse-x3/lib/fusion/client/CAdapiRequest').CServerStateSetter;
		try {
			...
			// inferieure designee
				...
				if (wI < 0 || wI >= this.lines.length) {
					var wMess = this.client.getMessage('ERROR_LINE_UNKNOWN', wMess, wI, this.lines.length, this.getAdxId());
...
CAdapiDataSrc.TYPE_LEFTLIST = 'Q';
CAdapiDataSrc.TYPE_SCREEN = 'E';

CAdapiDataSrc.aftbTypToString = function(aAftbTyp) {
	switch (aAftbTyp) {
		case AFTB_START_COMPLETE:
			return 'AFTB_START_COMPLETE';
		case AFTB_END:
			return 'AFTB_END';
		case AFTB_START_PARTIAL:
			return 'AFTB_START_PARTIAL';
		case AFTB_START_COMPLEMENT:
			return 'AFTB_START_COMPLEMENT';
		default:
