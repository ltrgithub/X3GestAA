...
var CAdapiDataSrc = exports.CAdapiDataSrc = helpers.defineClass(function(aAdapiRequester, aAdapiScreen, aEntityIndexBaseOne, aDataSourceID, aDim, aNbField, aVarBasPage, dataSrcType) {
	...
	buildMessErrorTraverse: function(aStructIst, aAdapiSetter, aKeyOfMessSuffix) {
		var wMess = this.adapiClient.adapiResources.getMessage(CAdapiResources.KEYMESS_ERROR_TRAVERSE_SETTABLE, aStructIst.toString(), this.getAdxId(), module.id);
		// TODO TCA
	...
	getAdxId: function() {
		return this.adapiScreen == null ? null : "" + this.adapiScreen.getAdxId() + ',' + this.entityIdxAlpha;
	},
		...
		try {
			...
			// inferieure designee
				...
				if (wI < 0 || wI >= this.lines.length) {
					var wMess = this.adapiClient.adapiResources.getMessage(CAdapiResources.KEYMESS_ERROR_LINE_UNKNOWN, wMess, wI, this.lines.length, this.getAdxId());
