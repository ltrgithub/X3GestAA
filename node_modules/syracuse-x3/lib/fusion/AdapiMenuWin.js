...
var AdapiWinMenuList = exports.AdapiWinMenuList = helpers.defineClass(function() {}, null, {
	// Préserve l'ordre d'insertion
	addMenu: function(menu) {
		this.winMenus.put(menu.getAdxId(), menu);
	},
	containsMenu: function(menuId) {
		return this.winMenus.containsKey(menuId);
	},
	toJson: function() {
		var res = [];
