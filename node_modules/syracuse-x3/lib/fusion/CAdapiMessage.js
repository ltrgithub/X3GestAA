...
/* TODO overload
	...
	addWebServerLocicalMess: function(aListOfLocicalMess) {
		if (aListOfLocicalMess != null) {
			if (this.webServerLocicalMess == null) {
				this.webServerLocicalMess = [];
			}
			this.webServerLocicalMess.concat(aListOfLocicalMess);
		}
	},
	/* TODO overload
	addWebServerLocicalMess: function(aLocicalMess) {
		if (aLocicalMess != null) {
			...
			this.webServerLocicalMess.push(aLocicalMess);
		}
	},*/
	clone: function() {
	...
	traverseChilds: function(aTraverser) {
		...
		var wLogicalMessage;
		var wMax = this.webServerLocicalMess != null ? this.webServerLocicalMess.length : 0;
		var wI = 0;
		while (wI < wMax) {
			wLogicalMessage = this.webServerLocicalMess[wI];
