...
var CAdapiDataSrcLine = exports.CAdapiDataSrcLine = helpers.defineClass(function(requester, dataSrc, id, nbVars, zeroBaseIdx) {
	...
	traverseSettable: function(aStructIst, aAdapiSetter) {
		 ...
		 */
			...
			return this.traverseSettableFields(aStructIst, aAdapiSetter);
		}
		/*
		 ...
		 */
			...
			if (wContinue && aAdapiSetter instanceof CAdapiRequest.CServerStateSetter) {
				wContinue = this.traverseSettableFields(aStructIst, aAdapiSetter);
			}
			return wContinue;
		} else {
			var wMess = this.getRsrcMess(CAdapiResources.KEYMESS_ERROR_TRAVERSE_SETTABLE, aStructIst.alphanumCodage, this.getAdxId(), module.id);
			// TODO TCA
			// module.id is not corresponding to aAdapiSetter.class
			//var wMess = getRsrcMess(CAdapiResources.KEYMESS_ERROR_TRAVERSE_SETTABLE, aStructIst.alphanumCodage, this.getAdxId(), CStringFacilities.getClasseName(aAdapiSetter.class));
			aAdapiSetter.setLogicalErrMess(wMess);
			return false;
		}
	},
