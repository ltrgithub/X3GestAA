...
var FusionConfig = {
	...
	getJSONMainInfo: function() {
		...
		cfgCtx.systemarch = getStr("all.control.systemarch", EMPTY);
		cfgCtx.systembits = getStr("all.control.systembits", EMPTY);
		cfgCtx.systemtype = getStr("all.control.systemtype", EMPTY);
		cfgCtx.sdataPort = getStr("runtime.bundle_sdata.http.port", EMPTY);
		cfgCtx.jettyPort = getStr("runtime.service.jetty.port", EMPTY);
		cfgCtx.installpatch = getStr("all.control.installpatch", EMPTY);
		cfgCtx.installvers = getStr("all.control.installvers", EMPTY);
		cfgCtx.installversname = getStr("all.control.installversname", EMPTY);
		cfgCtx.installversnum = getStr("all.control.installversnum", EMPTY);
		cfgCtx.installfix = getStr("all.control.installfix", EMPTY);
		cfgCtx.installminor = getStr("all.control.installminor", EMPTY);
		cfgCtx.installfix = getStr("all.control.installfix", EMPTY);
