...
exports.webProxy = function(_, context, webServerPath, config) {
	...
	wl.push("^(.*)/TMP/.*\.(ilacl|iladi|ilbox|ilcgd|ilcpv|ilctn|ildih|ilfeat|ilfeed|ilfocus|ilhsh|illnk|ilmat|ilmfg|ilmwg|ilope|ilpar|ilpha|ilrpw|ilsle|ilsto|iltco|iltun|iltuv|iltwd|ilwst)$");
