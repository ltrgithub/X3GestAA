	...
	execute: function(_, modul, body) {
		...
		try {
			...
			if (e.message === "Cannot call method 'apply_' of undefined") {
				return genErrorHead(404, "The method '" + body['function'] + "' doesn't exists.", e.safeStack);
			} else if (e.message === "Cannot find module '" + modul + "'") {
				return genErrorHead(404, e.message, e.safeStack);
			} else if (e.message === "forbidden") {
				return genErrorHead(403, "The module '" + modul + "' is not authorized to be called from X3", e.safeStack);
			} else {
				...
				if (!future) {
					if (body && body['return'] != null) {
						try {
							...
							return genErrorHead(500, "Property " + body['return'] + " doesn't exists.", e.safeStack);
						}
