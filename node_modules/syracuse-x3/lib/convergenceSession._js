...
function FusionSession(fsid) {
	traceSessions && traceSessions("New FusionSession - " + fsid);
	this.sessionUrl = "";
	this.isXmlSessionFormat = false;
	this.sid = fsid;
	//Set by session.updateFusionSession
	this.lastAccess=0;
}
...
sessionProto.connect = function(_, context, config) {
	...
	this.sessInfo={
			...
			timeoutReuse: nodeconfig.config.x3fusion.reuseTimeout || 120000
	};
	var adxInfo={
...
// FDB - Return fusionSession entity data
...
exports.newFusionSession = function(_, fsid) {
