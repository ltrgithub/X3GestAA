...
var tracerStd = require('syracuse-core/lib/trace').getTracer("classic.std");
var tracerAction = require('syracuse-core/lib/trace').getTracer("classic.action");
var tracerProtocol = require('syracuse-core/lib/trace').getTracer("classic.protocol");
var tracerSession = require('syracuse-core/lib/trace').getTracer("classic.session");
