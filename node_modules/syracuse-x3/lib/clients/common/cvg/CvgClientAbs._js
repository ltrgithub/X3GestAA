...
exports.CvgClientAbs = helpers.defineClass(function(stream, aConfig, recorder, context) {
	...
	execAckCall: function(_, subprogName, debugInfo, params, techInfo) {
		...
		var res = JSON.parse(JSON.stringify(this._trackLists.RPC[0]));
