...
exports.CvgClientAbs = helpers.defineClass(function() {
	...
	processAsyncAction: function(_, body, connect, mergeMode, noResp) {
		...
		try {
			...
			var p = body.act && this.x3writer.actions.Descriptors[body.act] && this.x3writer.actions.Descriptors[body.act].listenHandler && this.x3writer.actions.Descriptors[body.act].listenHandler(_, {
				body: body,
				client: self,
				params: params
			});
