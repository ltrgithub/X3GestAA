...
exports.CvgRequestAbs = helpers.defineClass(function(aClient, aAdonixReply, sendContext) {
	...
	listenSendingArgs: function(body, aCommClient, aParams) {
		...
		var res = false;
		switch (body.act) {
			case this.client.x3writer.descriptors.actions.SRV_EXECI_RESPONSE:
				...
				res = true;
				break;
			case this.client.x3writer.descriptors.actions.SRV_CALLREMOTEFUNC:
			case this.client.x3writer.descriptors.actions.SRV_CALLREMOTESPGM:
