...
var CvgModifier = require('../../../convergence/model/CvgModifier').CvgModifier;
var CvgDataSrc = require('../../../convergence/model/CvgDataSrc').CvgDataSrc;
var CvgEntity = require('../../../convergence/model/CvgEntity').CvgEntity;
var CvgFormat = require('../../../convergence/model/CvgFormat').CvgFormat;
var CvgResu = require('../../../convergence/types/CvgResu').CvgResu;
var CvgResuTdo = require('../../../convergence/types/CvgResu').TDO;
var CvgResuTag = require('../../../convergence/types/CvgResu').TAG;
var CvgIst = require('../../../convergence/types/CvgIst').CvgIst;
var CvgLeftListLineNode = require('../../../convergence/model/CvgLeftListLineNode').CvgLeftListLineNode;
var CvgException = require('../../../convergence/model/CvgException').CvgException;
var CvgWindow = require('../../../convergence/model/CvgWindow').CvgWindow;
var CvgMessage = require('../../../convergence/model/CvgMessage').CvgMessage;
var CvgVariableCombo = require('../../../convergence/model/CvgVariableCombo').CvgVariableCombo;
var CvgPickedLine = require('../../../convergence/model/CvgPickedLine').CvgPickedLine;
var CvgReplyAckCall = require('../../../convergence/model/CvgReplyAckCall');

var CvgInstanceExeci = require('../../../convergence/model/CvgInstanceExeci');
var CvgDiagnose = require('../../../convergence/model/CvgDiagnose');
var CvgSessionOpen = require('../../../convergence/model/CvgSessionOpen');
var CvgAskUiAction = require('../../../convergence/model/CvgAskUiAction');
var CvgReboot = require('../../../convergence/model/CvgReboot');
var PrintClient = require('../../print/PrintClient');
var PrintHelpers = require('../../print/PrintHelpers');
var CvgReport = require('../../../convergence/model/CvgReport');
var CvgImp = require('../../../convergence/model/CvgImp');


var CvgHelp = require('../../../convergence/model/CvgHelp').CvgHelp;
...
exports.CvgRequestAbs = helpers.defineClass(function(aClient, aAdonixReply, sendContext) {
	...
	listenActionArgsEXECI_RESPONSE: function(aCommClient, opt) {

		var aParams = opt.params;
		var ist = opt.body.fld.ist;
		var rpc = opt.body.param.reply;
	...
	listenActionArgsCALLREMOTEFUNC: function(aCommClient, opt) {
		return this.listenActionArgsCALLREMOTESPGM(aCommClient, opt);
	},
	listenActionArgsCALLREMOTESPGM: function(aCommClient, opt) {
		var aParams = opt.params;
		...
		for (i = 0; i < paramDefs.length; i++) {
			...
			if (listResu) {
				...
				// ensure nb resu match with nb attribute
				for (var i = 0; i < nb; i++) values.push(new CvgResu.fromX3Type(x3typ, null));
			}
		}
		// tab def
		aParams.push(defs);
