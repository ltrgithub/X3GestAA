...
exports.CvgClientWS = helpers.defineClass(function() {
	...
	init: function(_, context, wsCall, recOptions) {
		...
		this.cliCfg = this._getContextConfig(_, wsCall.context);
		var stream = null;
	...
	_getContextConfig: function(_, wsCallContext) { // TODO refactor to set that method in super class
		var endpoint = wsCallContext.endpoint;
		return {
