...
exports.CvgClientWS = helpers.defineClass(function() {
	...
	execWS: function(_, context, params, techInfo, nbtry, isAlign) {
		try {
			...
			if (!(result && !result.errn && !result.errm)) {
				...
				switch (ww_ok) {
					...
					case 1:
						...
						return wsCall.generateResult(description, paramsResult, this._x3SessionSettings.cdLang, isAlign);
	 ...
	 */
	_recupHDAT: function(_, wsName, stamp, techInfo, debugInfo) {
