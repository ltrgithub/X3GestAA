...
exports.CvgClientWS = helpers.defineClass(function() {
		...
		try {
			...
			switch (ww_ok) {
				...
				case 6: // database closed
					throw new CvgWsException(this, null, locale.format(module, "sgbdClosed"));
				case 7: //must resign
				...
				case 9:
					...
					break;
				default:
					throw new CvgWsException(this, null, locale.format(module, "spgmNoResult", wsCall.name, ok));
			}
	...
	_flush: function(_, wsCall) {
		...
		if (ok === 1) {
			...
			throw new CvgWsException(this, null, locale.format(module, "alreadyFlushAdx", wsCall.name, ok));
		} else {
			throw new CvgWsException(this, null, locale.format(module, "spgmNoResult", wsCall.name, ok));
		}
	},
