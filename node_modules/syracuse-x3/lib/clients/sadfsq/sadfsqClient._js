...
exports.SadFsqClient = helpers.defineClass(function(_, context, user, password, secured, options, recOptions) {
	...
	} else if (context.x3solution) {
		// always use MAIN x3 server
		commonClient.CommonClient.call(this, _, opt, context.x3solution(_).serverHost(_), context.x3solution(_).serverPort(_), user, password, secured);
	} else {
