...
//		{
//            "name" : "HP Laser01",
//            "driver" : "Laser Print serie A",
//            "port": "198.25.36.3",
//            "devmode": "DEEFSAD54DS0D44DABCA5SBE526734545D43",
//            "location": "3ième étage",
//            "comment": "En service",
//            "startpage": null, 
//            "stoppage": null,
//            "copies": 2,
...
//        },
	...
	send_ND_EXTRA_PRINTER: function(_,prName, prPort, prDriver,prPaperSizeId){
		...
		console.log('req '+buf.toString('hex'));
		this.stream.write(_,buf);
		...
		console.log("hexa "+bufBin.toString('hex'));
