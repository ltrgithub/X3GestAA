...
var printComm = exports.printComm = helpers.defineClass(function(_, client) {
	this.client = client;
	...
	/// Dump the list of jobs. At first it is not necessary to implement this node serialization on the server  node.js, because this functionality is built into the supervisor via PSIMP function (which should also be available in full Syracuse, as well as the function PSADX).  
	/// 
	/// ---
	/// 
