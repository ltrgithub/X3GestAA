...
var printComm = exports.printComm = helpers.defineClass(function(_, stream) {
	...
	connect: function(_) {
		...
		this.send_ND_CALLUI(_, this.technoVers, this.technoVers);
		
		var head = this.stream.read(_, 5);
		var len = head.readInt32BE(1);
		this.srvTechnoVers = getProperties(this.stream.read(_, len));
	},
	/*
