		...
		if (trackAct == null) {
			...
			try {
				if (trackAct == "START") {
					...
					tracker = self._trackers[trackId] = new ConvTracker(_, context, trackId, observer, connectAct != null);
					data = null;
					var statusCode = 500;
					try {
						if (self._cvgClient.recorder) {
						...
						observer.generateResponse(_, 'C' === connectAct || 'R' === connectAct);
						...
						console.log("stop tracker" + trackId);
