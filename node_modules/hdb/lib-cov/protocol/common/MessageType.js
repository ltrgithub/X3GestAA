...
if (! _$jscoverage['protocol/common/MessageType.js']) {
  _$jscoverage['protocol/common/MessageType.js'] = [];
  _$jscoverage['protocol/common/MessageType.js'][14] = 0;
  _$jscoverage['protocol/common/MessageType.js'][16] = 0;
}
_$jscoverage['protocol/common/MessageType.js'][14]++;
"use strict";
_$jscoverage['protocol/common/MessageType.js'][16]++;
module.exports = {NIL: 0, EXECUTE_DIRECT: 2, PREPARE: 3, ABAP_STREAM: 4, XA_START: 5, XA_JOIN: 6, EXECUTE: 13, READ_LOB: 16, WRITE_LOB: 17, FIND_LOB: 18, PING: 25, AUTHENTICATE: 65, CONNECT: 66, COMMIT: 67, ROLLBACK: 68, CLOSE_RESULT_SET: 69, DROP_STATEMENT_ID: 70, FETCH_NEXT: 71, DISCONNECT: 77, EXECUTE_ITAB: 78, FETCH_NEXT_ITAB: 79, INSERT_NEXT_ITAB: 80, BATCH_PREPARE: 81};
