...
exports.Unzip = function(buffer, filehandler, options) {
	...
	function scanForCentralDir() {
		...
		if (pos <= 0)
		{
			throw "Unable to locate end of central directory";
		}
	...
	*/
	function procCentralDir(_) {
		...
		while (true)
		{
			...
			if (header !== 0x02014b50) {
				throw "Invalid header signature for central directory";
			}
	...
	function procFile(_) {
		...
		{
			throw "Invalid header signature for file block";
		}
		...
		if (!uncompressedData) {
			throw "No handler for compression method id: " + method;
		}
