...
test("written buffer SEBF : write remote file", function(_) {
	...
	var buff = comm._getBufSEBF(sadFsqFile, 150);
	...
	var buff = comm._getBufSEBF(sadFsqFile, 23);
	var bytes = Buffer.concat([new Buffer([0x02, 0x00, 0x05, 0x08, 0x00, 0x00, 0x00, 0x17]), fileBin.slice(0, 23)]);
