...
function completeTest(param, i) {
	...
	asyncTest("client class instanciation", function(_) {
		...
		var connCtx2 = {
			server: sadUnitConfig.server ? sadUnitConfig.server : "sodaix02",
			port: sadUnitConfig.port ? sadUnitConfig.port : 17000,
			user: sadUnitConfig.user2 ? sadUnitConfig.user2 : "tchambar",
			pass: sadUnitConfig.pass2 ? sadUnitConfig.pass2 : "CRYPT:tdosdoQo2tgrTqseugrpgr",
			secure: sadUnitConfig.secure ? sadUnitConfig.secure : true
		};
		...
		sadfs3 = new SadFsqClient(_, "ecvmdev2003x64", 1818, "SAGEFR\\apisu", "Sage-2010", true, recOptions);
