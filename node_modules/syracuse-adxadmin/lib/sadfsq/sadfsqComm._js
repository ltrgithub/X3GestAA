...
exports.SadFsqComm = helpers.defineClass(function(_, stream) {
	...
	/////////////////////// TODO 
	_writeBufVID: function(fd) { //TODO
		var buffers = getBuffers(VID, {
			fd: fd
		});
		return bufferConcat([buffers.init, buffers.lenUtil, buffers.order, buffers.fd]);
	},

	processVID: function(_, fd) { //TODO
	},

	_writeBufTFF: function(fd) { //TODO
	},

	processTFF: function() { //TODO
	},
	...
	_writeBufOUS: function(sadFile, mod, mask) { //TODO
		...
		return bufferConcat([buffers.init, buffers.lenUtil, buffers.order, buffers.canonicalBufLen, buffers.canonicalLen, buffers.canonical, buffers.mod, buffers.mask]);
	...
	processOUS: function(_, options, mod, mask) {
		this._checkStream();
		this.stream.write(_, this._writeBufOUS(fd));
	...
	processLBF: function(_, fd, lenToRead) {
		this._checkStream();
		this.stream.write(_, this._writeBufLBF(fd, lenToRead));
		tracer && tracer("\n### Read buffer for order: LBF ###");
		var size = lenToRead;
