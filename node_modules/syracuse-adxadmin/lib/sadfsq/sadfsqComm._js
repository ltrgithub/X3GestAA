...
exports.SadFsqComm = helpers.defineClass(function(_, stream) {
	...
	_getBufLaunch: function(params) { //TODO
		...
		bufServiceId.writeInt8(serviceId);

		var bufLenUuser = new Buffer(1);
		bufLenUser.writeInt8(bufPass.length);
		var bufLenPass = new Buffer(1);
		bufLenUPass.writeInt8(bufUser.length);

		var bufLenUtil = new Buffer(1);
		bufLenUtil.writeInt8(bufUser.length * 2 + bufPass.length + 3);
