...
exports.SadFsqFile = helpers.defineClass(function(options) {
	...
	this.volume = options.volume ? options.volume : null;
	this.server = options.server ? options.server : null;
	this.canonical = options.canonical ? options.canonical : null;
	...
	this.binary = options.binary ? options.binary : new Buffer([]); // binary readed or to write (setted during readFile or writeFile)
	this.fileInfo = {};
	this.err = [];
	this.fd = options.fd ? options.fd : null;
	this.pid = options.pid ? options.pid : null;
