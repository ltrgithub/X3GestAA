...
asyncTest(".bbb files", 8, function(_) {
	fs.mkdir("patchunittest/d1");
	fs.mkdir("patchunittest/d2");
	...
	write.makeChecksums("patchunittest/d1", _);
	write.makeChecksums("patchunittest/d2", _);
	write.copyRec("patchunittest/d1", "patchunittest/d2", true, _);
	strictEqual(write.exists("patchunittest/d2/test3.bbb", _), true, "No deletion of patchunittest/d2/test3.bbb")
	...
	strictEqual(write.exists("patchunittest/d2/test1.bbb", _), false, "No creation of patchunittest/d2/test1.bbb")
	write.copyRec("patchunittest/d1", "patchunittest/d2", false, _);
	strictEqual(write.exists("patchunittest/d2/test3.bbb", _), true, "No deletion of patchunittest/d2/test3.bbb")
	strictEqual(fs.readFile("patchunittest/d2/test3.bbb", "utf8", _), "test23", "Correct content of patchunittest/d2/test3.bbb")
	strictEqual(fs.readFile("patchunittest/d2/test2.bbb", "utf8", _), "test22", "Correct content of patchunittest/d2/test2.bbb")
	strictEqual(write.exists("patchunittest/d2/test1.bbb", _), false, "No creation of patchunittest/d2/test1.bbb")	
