...
asyncTest("create_text", 1, function(_) {
	patch.patch("patchunittest", "node_modules/syracuse-patch/test/fixtures/new_format_create_text.patch", {}, _);
...
asyncTest("no_lf_at_end", 1, function(_) {
	patch.patch("patchunittest", "node_modules/syracuse-patch/test/fixtures/new_format_no_lf_at_end.patch", {}, _);
	var errors = unit.testhash("patchunittest", { '/test.txt': '5573b41b7439efe2e8464ffb8b9bf3c2ac319f94' }, _);
	strictEqual(errors, "");
	start(); });

asyncTest("changes", 1, function(_) {
	patch.patch("patchunittest", "node_modules/syracuse-patch/test/fixtures/new_format_changes.patch", {}, _);
...
asyncTest("add_lf_at_end", 1, function(_) {
	patch.patch("patchunittest", "node_modules/syracuse-patch/test/fixtures/new_format_add_lf_at_end.patch", {}, _);
	var errors = unit.testhash("patchunittest", { '/test.txt': '9e89a7597986d94be045e55763d8994c7f370689' }, _);
	strictEqual(errors, "");
	start(); });

asyncTest("binary", 1, function(_) {
	patch.patch("patchunittest", "node_modules/syracuse-patch/test/fixtures/new_format_binary.patch", {}, _);
...
asyncTest("more_changes", 1, function(_) {
	patch.patch("patchunittest", "node_modules/syracuse-patch/test/fixtures/new_format_more_changes.patch", {}, _);
...
asyncTest("remove", 1, function(_) {
	patch.patch("patchunittest", "node_modules/syracuse-patch/test/fixtures/new_format_remove.patch", {}, _);
