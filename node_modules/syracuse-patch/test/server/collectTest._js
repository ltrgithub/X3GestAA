...
asyncTest("collect files", 9, function(_) {
	// write some patch files
	fs.mkdir("patchunittest/"+write.TEMP_DIRECTORY);
	...
	// var resultingPatchFile = fs.readFile("patchunittest/"+write.TEMP_DIRECTORY+"/lastpatch.bbb", "utf8", _);
