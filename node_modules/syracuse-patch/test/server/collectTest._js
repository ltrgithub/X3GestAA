...
function writeDummyPatchFile(path, version1, version2, append, frame, _, streamlineConfig) {
...
asyncTest("collect files with streamline configuration", 11, function(_) {
	...
	writeDummyPatchFile("patchunittest/patch1.dat", 0, 1, false, false, _);
	writeDummyPatchFile("patchunittest/patch2.dat", 1, 2, false, true, _, true);
	writeDummyPatchFile("patchunittest/patch3.dat", 3, 4, false, true, _);
	writeDummyPatchFile("patchunittest/patch3.dat", 2, 3, true, true, _, true);
	writeDummyPatchFile("patchunittest/patch5.dat", 6, 8, true, true, _, true);
	var error = true;
	try {
		integrate.collectFiles("patchunittest", "patchunittest/patch1.dat", "aaaaaaaaaa3", "aaaaaaaaaa2", _);
		error = false;
	...
	strictEqual(error, true, "patch file does not fit");
	strictEqual(integrate.collectFiles("patchunittest", "patchunittest/patch2.dat", "aaaaaaaaaa2", "aaaaaaaaaa1", _), "", "patch already integrated");
	strictEqual(integrate.collectFiles("patchunittest", "patchunittest/patch2.dat", "aaaaaaaaaa1", "aaaaaaaaaa0", _), "syracuse patch 1 1 2013-03-22 1 2 aaaaaaaaaa1 aaaaaaaaaa2\nsyracuse patchcomment comment2\nsyracuse streamline {\"test\":2}\nblabla 2\n", "new patch with streamline configuration");
	...
	writeDummyPatchFile("patchunittest/patch4.dat", 4, 5, false, true, _);
	strictEqual(integrate.collectFiles("patchunittest", "patchunittest", "aaaaaaaaaa0", "aaaaaaaaaa7", _), "syracuse patch 1 0 2013-03-25 1 5 aaaaaaaaaa0 aaaaaaaaaa5\nsyracuse patchcomment comment5\nsyracuse streamline {\"test\":3}\nblabla 1\nblabla 2\nblabla 3\nblabla 4\nblabla 5\n", "new patch, all (even more) files in directory (2 streamline configurations)");
	strictEqual(integrate.collectFiles("patchunittest", "patchunittest", "aaaaaaaaaa6", "aaaaaaaaaa7", _), "syracuse patch 1 6 2013-03-28 1 8 aaaaaaaaaa6 aaaaaaaaaa8\nsyracuse patchcomment comment8\nsyracuse streamline {\"test\":8}\nblabla 8\n", "new patch with streamline configuration, last file");
	writeDummyPatchFile("patchunittest/patch9.dat", 5, 6, false, true, _, true);
	strictEqual(integrate.collectFiles("patchunittest", "patchunittest", "aaaaaaaaaa0", "aaaaaaaaaa7", _), "syracuse patch 1 0 2013-03-28 1 8 aaaaaaaaaa0 aaaaaaaaaa8\nsyracuse patchcomment comment8\nsyracuse streamline {\"test\":8}\nblabla 1\nblabla 2\nblabla 3\nblabla 4\nblabla 5\nblabla 6\nblabla 8\n", "new patch, all (even more) files in directory (4 streamline configurations)");
