...
var isFibers = true; //require('streamline/lib/globals').runtime == "fibers-fast";
...
// test for source maps
isFibers && asyncTest("source map with streamline", 6, function(_) {
...
//test for source maps
isFibers && asyncTest("source map with streamline and uglify", 6, function(_) {
