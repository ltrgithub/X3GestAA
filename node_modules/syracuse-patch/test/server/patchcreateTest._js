...
function performTest(_, async, orig_module, transformed_module, parameter, consumer, text) {
	...
	try {
		...
		tracer && tracer("XXXXXXXXXXXXXXXXXXXXXXX" + e + " " + e.stack);
		stack_orig = e.stack;
	}
	var stack_trans;
	try {
		...
		tracer && tracer("XXXXXXXXXXXXXXXXXXxxxxXXXXX" + e + " " + e.stack);
		stack_trans = e.stack;
	}
...
asyncTest("source map with uglify", 6, function(_) {
	...
	try {
		...
		performTest(_, false, orig_module, transformed_module, 0, consumer, "parameter 0");
		performTest(_, false, orig_module, transformed_module, 1, consumer, "parameter 1");
...
asyncTest("source map with streamline", 6, function(_) {
	...
	try {
		...
		performTest(_, true, orig_module, transformed_module, 0, consumer, "parameter 0");
		performTest(_, true, orig_module, transformed_module, 1, consumer, "parameter 1");
