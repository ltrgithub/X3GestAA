...
asyncTest("makeRule nocrypt abc.txt", 3, function(_) {
	var rule;
	rule = p.makeRule("hide", "abc.txt", true);
...
//Test 
asyncTest("findRule", 25, function(_) {
	...
	var config = { transformationRules: rules};
	var t = p.findRule("D node_modules/syracuse-patch/test/fixtures/abc.js", config, true)
	strictEqual(t.file, "node_modules/syracuse-patch/test/fixtures/abc.js", "filename");
	...
	strictEqual(t.file, "node_modules/syracuse-patch/test/fixtures/zzz.js", "filename");
	strictEqual(t.mode, "D", "mode");
	...
	strictEqual(t.file, "str.js", "filename");
