...
function _applyRule(rulename, filename, mode, config, _) {
	...
	if (rulename === "uglify" || rulename === "streamline") // change streamline file name when uglifying
	...
	if (mode === "D") { // delete and mark file for commit
		...
		if ((rulename === "uglify" || rulename === "encrypt" || rulename === "streamline") && /\._?js$/.test(filename)) {
