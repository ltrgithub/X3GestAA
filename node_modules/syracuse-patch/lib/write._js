...
function exists(path, callback) {
	fs.exists(path, function(res, error) { callback(error, res)});
} 

//asynchronous unlink
function unlink(path, callback) {
	fs.unlink(path, function(ex) { callback(null, ex)});
}
...
function rmdir(path, callback) {
	fs.rmdir(path, function(ex) { callback(null, ex)});
}

//asynchronous unlink
function rename(path, callback) {
	fs.rename(path, function(ex) { callback(null, ex)});
}
exports.rename = rename;

//asynchronous unlink
function mkdir(path, callback) {
	fs.mkdir(path, function(ex) { callback(null, ex)});
}
...
function chmod(path, mode, callback) {
	fs.chmod(path, mode, function(ex) { callback(null, ex)});
}
