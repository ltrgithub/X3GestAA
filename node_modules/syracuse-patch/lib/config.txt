...
ignore shadow-modules/node_modules/(grunt|look|nodetime|syracuse-phantomjs|v8-profiler|js-beautify|jshint|memwatch|nodelint|streamline-doctool|tools|uglify-js|git-node)/**/*
copy shadow-modules
# copy native modules only for desired platforms
copy shadow-modules/(tools|node_modules|(darwin|linux|win32)-x64-v8-3.28)/**/*
ignore shadow_modules/**/*
copy node_modules/public/**/*

# no development tools
ignore node_modules/(bruno|js-beautify|jshint|memwatch|nodelint|streamline-doctool|tools|uglify-js|git-node)/**/*
...
# unused
ignore node_modules/(html5-binary|node-lint|sage-sso|x3-engine)/**/*
...
# syracuse-auth is internal module
...
ignore node_modules/syracuse-tablet/native/**/*


# copy external modules
copy node_modules/(babel-*|npm-shadow|html-escape|coffee-script|fibers|ghm|jsurl|js-xml|jsntlm|mongodb|node-oauth|streamline*|mongodb|ez-*|mustache|aws-sdk|xml-crypto)/**/*
...
ignore **/.*
ignore **/*.(c|cpp|h|sh|asm|md|afm|as|cc|tbl|msg|gyp)
...
uglify node_modules/public/**/*
copy node_modules/syracuse-core/lib/streamline-loader.js
...
uglify node_modules/syracuse-sdata/lib/httpHelper.*
uglify node_modules/syracuse-sdata/lib/parser/*
