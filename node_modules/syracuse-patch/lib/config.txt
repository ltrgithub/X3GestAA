...
ignore node_modules/(bruno|js-beautify|jshint|memwatch|nodelint|streamline-doctool|tools|uglifyjs2)/**/*
# unit tests
# ignore node_modules/(test-runner|test-contract)/**/*
# do not deliver phantomjs
ignore node_modules/syracuse-phantomjs/**/*
# unused
ignore node_modules/(galaxy*|html5-binary|node-lint|sage-sso|socket.io|x3-engine)/**/*
...
# copying of dependencies is further down (to avoid copying just external modules of parts which are ignored!) 
