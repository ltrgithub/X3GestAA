...
[OPTIONS]
streamline {"fibers": true, "fast": true, "cache": true, "verbose": false, "aggressive": true}
...
ignore node_modules/(bruno|js-beautify|jshint|memwatch|nodelint|streamline-doctool|tools|uglifyjs2|git-node)/**/*
# unit tests
# ignore node_modules/(test-runner|test-contract)/**/*
# do not deliver phantomjs
ignore node_modules/syracuse-phantomjs/**/*
# unused
ignore node_modules/(galaxy*|html5-binary|node-lint|sage-sso|x3-engine)/**/*
...
copy node_modules/(html-escape|coffee-script|fibers|ghm|jsurl|jsxml|jsntlm|mongodb|node-oauth|streamline*|mongodb|ez-*|mustache|aws-sdk|xml-crypto)/**/*
copy node_modules/**/(node_modules|deps)/**/*


# files in main directory
uglify (index|nanny|licdb).js
ignore *
