...
# unused
ignore node_modules/(galaxy-stack|html5-binary|node-lint|sage-sso|x3-engine)/**/*
...
copy node_modules/(babel-*|galaxy|npm-shadow|html-escape|coffee-script|fibers|ghm|jsurl|jsxml|jsntlm|mongodb|node-oauth|streamline*|mongodb|ez-*|mustache|aws-sdk|xml-crypto)/**/*
