...
[FILES]
# for 7.1, still use noCrypt 2, for 7.0 use noCrypt -1
noCrypt  2
...
# streamline-auth is internal module
hide node_modules/streamline-auth/**/*

# copy external modules (mysql is used in persistencejs within syracuse-orm and must be provided!)
copy node_modules/(coffee-script|fibers|ghm|jsurl|jsxml|mysql|mongodb|node-oauth|streamline*|mongodb)/**/*
copy node_modules/**/(node_modules|deps)/**/*


# files in main directory
uglify (index|nanny).js
copy (policy|license).json
ignore *
...
streamline node_modules/sprint1/**/*
