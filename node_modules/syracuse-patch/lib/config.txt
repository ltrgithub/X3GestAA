...
# unused
ignore node_modules/(galaxy*|html5-binary|mysql|node-lint|sage-sso|socket.io|x3-engine)/**/*
...
copy node_modules/(coffee-script|fibers|ghm|jsurl|mongodb|node-oauth|streamline*|mongodb)/**/*
