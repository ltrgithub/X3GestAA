...
[OPTIONS]
streamline {"runtime": "fibers", "cache": true, "verbose": false, "aggressive": true}
...
ignore shadow-modules/*/node_modules/(grunt|look|nodetime|syracuse-phantomjs|v8-profiler|js-beautify|jshint|memwatch|streamline-doctool|tools|uglify-js|git-node)/**/*
# copy native modules only for desired platforms
if (!DOCKER) copy shadow-modules
if (!DOCKER) copy shadow-modules/((linux|win32)-x64-v8-(4.5|5.1))/**/*
if (DOCKER) copy shadow-modules/linux-x65-v8-4.5/**/*

ignore shadow_modules/**/*
copy node_modules/public/**/*

# no development tools
ignore node_modules/(js-beautify|jshint|memwatch|streamline-doctool|tools|uglify-js|git-node)/**/*

# unit tests
# ignore node_modules/(test-runner|test-contract)/**/*
# do not deliver phantomjs
ignore node_modules/syracuse-phantomjs/**/*
# unused
...
ignore node_modules/syracuse-license/add-on.zip
...
copy node_modules/(babel-*|npm-shadow|html-escape|coffee-script|fibers|jsurl|js-xml|jsntlm|mongodb|streamline*|mongodb|ez-*|mustache|aws-sdk|xml-crypto)/**/*
copy node_modules/**/(node_modules|deps)/**/*


# files in main directory
copy (index|nanny|licdb).js
ignore *
...
# streamline node_modules/syracuse-ui/lib/tests/**/*

# etna name mapping hack (don't ignore for now)
copy node_modules/etna/test/x3js/fixtures/name-mappings.json
...
# syracuse-auth is internal module. Do not change md5.min.js
copy node_modules/syracuse-auth/html/deps/**/*
ignore node_modules/syracuse-auth/lib/pfx/**/*
streamline node_modules/syracuse-auth/html/**/*
hide node_modules/syracuse-auth/**/*

# ignore some parts which are not interesting at customer site
ignore node_modules/syracuse-ui/lib/fusion/dataTest/**/*
ignore node_modules/syracuse-x3/lib/convergence/data/cvgRecords/*
ignore node_modules/syracuse-x3/lib/unused.zip
ignore node_modules/syracuse-ui/addins/sageFlash/sfChart.js
...
uglify node_modules/public/**/*
copy node_modules/syracuse-core/streamline-loader.js
copy node_modules/syracuse-load/lib/syragent.js
uglify node_modules/syracuse-(core|ui|rtf|load)/**/*
# include ui packages
uglify node_modules/ui-*/**/*
uglify node_modules/syracuse-main/html/**/*
uglify node_modules/msoffice/**/*
uglify node_modules/syracuse-core/lib/http.*
uglify node_modules/syracuse-sdata-parser/**/*
uglify node_modules/syracuse-x3/lib/cvgPageConverter.*
...
encrypt node_modules/sage-id/**/*
encrypt node_modules/js*/**/*
uglify node_modules/syracuse-license/index.js
ignore node_modules/syracuse-license/**/add-on.zip
hide node_modules/syracuse-license/*
# ignore this config file
ignore node_modules/syracuse-patch/**/config.txt
encrypt node_modules/syracuse-perfmon/**/*
hide node_modules/syracuse-patch/**/*
# encrypt remaining sources in node_modules/syracuse-* and src
...
ignore node_modules/etna/**/*.d.ts
hide node_modules/etna*
hide node_modules/etna*/**/*
