...
var relNumberCmp = require('@sage/syracuse-core').helpers.relNumberCmp;
...
// file for version information at customer's site (redundant information - also in src/load-balancer/balancer.ts)
...
function writeFile(targetFile, content, _) {
	...
	try { // delete file first (to avoid problems with lower/upper case renaming under Windows)
		...
		tracer.warn && tracer.warn("Warning: unlink " + e);
	}
	try {
