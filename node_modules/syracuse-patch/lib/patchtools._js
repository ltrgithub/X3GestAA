...
function checkChecksumsAll(_) {
	var future = [];
	future[0] = checkChecksumsV(exports.BASE_DIRECTORY, null);                        
	if (exists(exports.BASE_DIRECTORY+"/"+exports.RELEASE_DIRECTORY, _))
		future[1] = checkChecksumsV(exports.BASE_DIRECTORY+"/"+exports.RELEASE_DIRECTORY, null);
	if (exists(exports.BASE_DIRECTORY+"/"+exports.TEMP_DIRECTORY, _))
		future[2] = checkChecksumsV(exports.BASE_DIRECTORY+"/"+exports.TEMP_DIRECTORY, null);
