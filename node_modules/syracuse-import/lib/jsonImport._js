...
exports.importTest = function(_, filename, ifNoneMatch) {
	...
	try {
		...
		return !ifNoneMatch.updDate || (Math.abs(ifNoneMatch.updDate.getTime() - modTime) > 10000);
	} catch (e) {
...
exports.jsonImport = function(_, db, filename, options) {
	...
	if (options.ifNoneMatch) {
		...
		if (automaticData.updDate && (Math.abs(automaticData.updDate.getTime() - modTime.getTime()) < 10000)) {
		...
		console.log("File import " + filename);
	} else {
