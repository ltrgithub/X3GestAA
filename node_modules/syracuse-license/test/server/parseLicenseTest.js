...
test('Some error situations', 6, function() {
	...
	strictEqual(callException([
		[], null
	], [license, policy]), "Error: No product or policy information available", "Call without product");
	var licenseR = {
		"product": {
			"code": "ERPSTD",
			"version": "1.0",
	...
	strictEqual(callException([
		[], null
	], [license, policy]), "Error: No product or policy information available", "Call without policy");
	var licenseR = {
		"product": {
			"code": "ERPSTD",
			"version": "1.0",
	...
	strictEqual(callException([
		[], null
	], [policy, license]), "Error: Missing validity in file type 'License' for product 'ERPSTD' version 1.0", "No validity");
	var licenseR = {
		"product": {
			"code": "ERPSTD",
			"version": "1.0",
	...
	strictEqual(callException([
		[], null
	], [policy, license]), "Error: Missing validity start in file type 'License' for product 'ERPSTD' version 1.0", "Missing valid from");
	var licenseR = {
		"product": {
			"code": "ERPSTD",
			"version": "1.0",
	...
	strictEqual(callException([
		[], null
	], [license, policy]), "Error: Validity start has wrong format 123-456-78 in file type 'License' for product 'ERPSTD' version 1.0", "Wrong valid from format in module");
	var licenseR = {
		"product": {
			"code": "ERPSTD",
			"version": "1.0",
	...
	strictEqual(callException([
		[], null
	], [license, policy]), "Error: Validity end has wrong format 123-456-78 in file type 'License' for product 'ERPSTD' version 1.0", "Wrong valid to format in module");
...
test('Partner licenses', 19, function() {
	...
	var res = check._p([
		[], null
	], [license, policy, licensePartner, policyPartner], diagnoses);
...
test('Total license validity', 22, function() {
	var policyR = {
		"product": {
			"code": "ERP",
			"version": "7.0",
	...
	strictEqual(res[1].validLicenses.length, 0, "no valid license");
	...
	strictEqual(res[1].validLicenses.length, 1, "no valid license");
	var validLic = res[1].validLicenses[0];
	strictEqual(validLic.expiryDate, today.addDays(5).toString(), "correct validity");
	strictEqual(validLic.partnerId, "", "correct partner ID");
	strictEqual(validLic.productCode, "ERP", "correct product code");
	strictEqual(validLic.productVersion, "7.0", "correct product version");
	strictEqual(validLic.productTitle["en-US"], "X3", "correct product title");
	strictEqual(validLic.policyCode, "ERPSTD", "correct policy code");
	strictEqual(validLic.policyVersion, "1.0", "correct policy version");
	strictEqual(validLic.policyTitle["en-US"], "X3S", "correct policy title");
	...
	strictEqual(res[0].length, 1, "number of raw licenses after deletion");
	strictEqual(res[1].validLicenses.length, 0, "no valid license");
});