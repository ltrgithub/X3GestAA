...
test('Pre-Parse license test', 29, function() {
	var pol1 = {
		"partnerId": "A",
		"product": {
			"code": "ERPSTD",
	...
	var lic3Wrong = { // wrong value of WSPERIOD
		"fileType": "License",
		"generationStamp": "2014-01-03-08:34:10Z",
		"partnerId": "",
		"product": {
	...
	var lic3Correct = { // correct value of WSPERIOD
		"fileType": "License",
		"generationStamp": "2014-01-03-08:34:10Z",
		"partnerId": "",
		"product": {
	...
	try {
		var res = check._preParseLicenses([JSON.stringify(lic3Wrong)]);
		strictEqual(false, true, "No error");
	} catch (e) {
		strictEqual(e.message.indexOf('DAY2') > 0, true, "Correct complaining about wrong value of WSPERIOD");
	}
	// the following should run without error, because WSPERIOD is correct
	var res = check._preParseLicenses([JSON.stringify(lic3Correct)]);
...
test('Parse license test', 195, function() {
	var pol1 = {
		"partnerId": "",
		"product": {
			"code": "ERP",
