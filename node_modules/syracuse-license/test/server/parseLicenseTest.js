...
test('Pre-Parse license test', 20, function() {
	var pol1 = {
		"partnerId": "A",
		"product": {
			"code": "ERPSTD",
	...
	strictEqual(res.partnerContents, "", "No partner");
...
test('Parse license test', 168, function() {
	var pol1 = {
		"partnerId": "",
		"product": {
			"code": "ERP",
...
test('evaluate badges', 27, function() {
	...
	var productInfo = {};
	var diagnoses = [];
	var res = check._evaluateBadges(["A", "B", "D"], parsedData, badgeInfo, productInfo, false, "phone", diagnoses);
	...
	var productInfo = {};
	var diagnoses = [];
	var res = check._evaluateBadges(["A", "B"], parsedData, badgeInfo, productInfo, true, "desktop", diagnoses);
	...
	strictEqual(res, true, "concurrent badges for desktop: Products found");
	strictEqual(badgeInfo.C[0], -1, "users for C");
...
test("X3 license info", 21, function() {
	var diagnoses = [];
	var parsedLicense = {
		badges: {
			ACCTCLRK: {
	...
	var res = check._getX3LicenseInfoInt("ERP10", "1.0", "", parsedLicense, diagnoses);
	strictEqual(res, undefined, "Wrong product");
	var res = check._getX3LicenseInfoInt("ERP", "10.0", "", parsedLicense, diagnoses);
