...
test('Pre-Parse license test', 28, function() {
	var pol1 = {
		"partnerId": "A",
		"product": {
			"code": "ERPSTD",
...
test('Parse license test', 193, function() {
	var pol1 = {
		"partnerId": "",
		"product": {
			"code": "ERP",
	...
	strictEqual(res[1].products.ERP.modules.A, true, "module A of ERP licensed");
	strictEqual(res[1].products.ERP.modules.ZZ, true, "module ZZ of ERP licensed");
	// licenses for different partners
	var res = check._p([
	...
	strictEqual( !! res[1].products.ERP, false, "module ZZ of ERP not licensed");
	strictEqual(res[1].sessionControl, "named", "named license");
	// licenses for different applications: no base product
	var res = check._p([
	...
	strictEqual(res1.activityCodes.A, true, "Activity code A");
	strictEqual(res2.activityCodes.A, true, "Activity code A 2");
	...
	strictEqual(res1.languages.A, true, "Language A");
	strictEqual(res2.languages.A, true, "Language A 2");
	strictEqual(res1.parameterKits.A, true, "parameterKits A");
	strictEqual(res2.parameterKits.A, true, "parameterKits A 2");
	strictEqual(res1.legislations.A, true, "legislations A");
	strictEqual(res2.legislations.A, true, "legislations A 2");
...
test('evaluate badges', 30, function() {
...
test("X3 license info", 22, function() {
	var diagnoses = [];
	var parsedLicense = {
		badges: {
			ACCTCLRK: {
...
test("check ISO date", 8, function() {
