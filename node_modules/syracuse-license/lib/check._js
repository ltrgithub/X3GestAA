	...
	for (var i = 0; i<partners.length; i++) {
		...
		parsed.modules.forEach(function (module) {
			...
			if (module.validity[1]) {
				...
				if (valid) expires.push({module: module.code, expire: module.validity[1], partner: parsed.partnerId}); 
			}
			// module is licensed
			if (valid) licensedModules[module.code] = 1;
		});
