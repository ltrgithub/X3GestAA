...
exports.step = function(_, length, poolMetadata) {
	console.error("STEP " + length + " " + util.format(poolMetadata))
...
function _updateOldInfo(_, data, pd, timeString, key, productCode, test) {
	var db;
	var entity;
	console.error("Update old " + key + " " + util.format(data.object) + " " + timeString)
	...
	for (var k in data.object) {
		...
		console.error("Update old " + k + " " + timeString + " " + stamp)
		...
		if (timeString.indexOf(stamp) !== 0) {
			...
			console.error("Daten " + counter + " " + stamp + " " + productCode + " " + key + " " + inst)
			if (inst) {
...
function _step(_, length, productCode, data, key, licenseData, timeString, noupdate) {
	...
	console.error("In step " + productCode + " " + timeString)
	...
	if (!pd.licenseStart) {
		...
		console.error("VGL " + timeString + " " + pd.timeString)
