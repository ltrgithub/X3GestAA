...
exports.moduleName = function(loc) {
	...
	return "x3://host:port/folder/" + s.substring(0, s.lastIndexOf('.'));
}
...
X3Frame.prototype.toString = function() {
	return "    at " + this.name + " (" + this.file + (this.line ? ":" + this.line : "") + ")";
}

function X3Error(errn, message) {
	Error.captureStackTrace(this, X3Error);
	this.message = message || errmes$(errn);
