...
"use strict";
var functions = require("../lib/functions").functions;
...
for (var REPETONS = 1; REPETONS <= 10000; REPETONS++) {
	var CHAINE = ""
	for (var I = 0; I <= 10; I++) {
		...
		if (REPETONS == 1) 
			TRACE_ERRBOX(CHAINE + "  ==>" + J + " mot" + string$(J > 1, "s"))
		
		if (J != I + (I >= 2)) 
			TRACE_ERRBOX("Erreur : la longueur calculée par COMPTE_MOTS n'est pas bonne " + J)
		if (J != K) 
			TRACE_ERRBOX("Erreur : la longueur calculée par DECOMPTE_MOTS n'est pas bonne " + K)
		
		if (J != L) 
			TRACE_ERRBOX("Erreur : la longueur calculée par RECOMPTE_MOTS n'est pas bonne " + K)
