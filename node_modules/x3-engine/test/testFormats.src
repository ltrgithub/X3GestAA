Call INIT(trtcou,48) From XUNIT
...
For J=1 To (I-2)/2
  ...
  Call CHECK_EQUAL(FORMATS_ALPHA(J), RESULT, RESULTATS_ALPHA(J)) From XUNIT
Next J
...
For J=1 To (I-2)/2
  ...
  Call CHECK_EQUAL(FORMATS_DATE(J), RESULT, RESULTATS_DATE(J)) From XUNIT
Next J
...
For J=1 To (I-2)/2
  ...
  Call CHECK_EQUAL(FORMATS_NUM(J), RESULT, RESULTATS_NUM(J)) From XUNIT
Next J
