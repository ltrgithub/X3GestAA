var z = require('x3-engine/lib/runtime').instructions,r=require,e=exports,p=[],B=z.B,NL=z.NL,A=z.A,PROG=z.PROG,DECL=z.DECL,SET=z.SET,V=z.V,C=z.C,END=z.END,GO=z.GO,IF=z.IF,LT=z.LT,F=z.F,BOX=z.BOX,SUB=z.SUB,EQ=z.EQ,ADD=z.ADD,PLUSEQ=z.PLUSEQ,OR=z.OR,NE=z.NE,NOT=z.NOT,EVALUE=z.EVALUE,AND=z.AND,MINUSEQ=z.MINUSEQ;z.BEGIN(module);NL(0);z.MAIN(e);e.MAIN=B();PROG(e,'INITALL',[],B(
NL(1),DECL('VI','SILENT')
,NL(1),SET(V('SILENT'),C(1))
,NL(1),END())); 
PROG(e,'INIT',['TRT','COUNT'],B(
NL(2),IF(LT(F('DIM',[V('SILENT')]),C(0)),p,1,B(DECL('VI','SILENT'),GO(p,1)))));p[1]=B(
