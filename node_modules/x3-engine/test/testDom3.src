...
For J=1 To (I-2)/2
  ...
  Errbox RESULT-RESULTATS_ALPHA(J)-string$(RESULT=RESULTATS_ALPHA(J),"ok")-string$(RESULT<>RESULTATS_ALPHA(J),"boum!!!")
Next J
...
For J=1 To (I-2)/2
  ...
  Errbox ctrans(RESULT," ","+")-ctrans(RESULTATS_DATE(J)," ","+")-string$(RESULT=RESULTATS_DATE(J),"OK")-string$(RESULT<>RESULTATS_DATE(J),"boum!!!")
Next J
...
For J=1 To (I-2)/2
  ...
  Errbox ctrans(RESULT," ","+")-ctrans(RESULTATS_NUM(J)," ","+")-string$(RESULT=RESULTATS_NUM(J),"OK")-string$(RESULT<>RESULTATS_NUM(J),"boum!!!")
Next J
