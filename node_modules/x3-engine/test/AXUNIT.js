var z = require('x3-engine/lib/runtime').instructions,r=require,e=exports,p=[],B=z.B,NL=z.NL,A=z.A,REQ=z.REQ,GOSUB=z.GOSUB,END=z.END,PROG=z.PROG,DECL=z.DECL,CALL=z.CALL,C=z.C,GO=z.GO,IF=z.IF,LT=z.LT,F=z.F,V=z.V,SET=z.SET,ADD=z.ADD,EQ=z.EQ,WHILE=z.WHILE,PLUSEQ=z.PLUSEQ,SUB=z.SUB,RAZ=z.RAZ,RANGE=z.RANGE,GT=z.GT,AND=z.AND,INDEX=z.INDEX,NE=z.NE,OR=z.OR,LE=z.LE,NOT=z.NOT,ONERRGO=z.ONERRGO,CASE=z.CASE,TYPEV=z.TYPEV,WHEN=z.WHEN,RESUME=z.RESUME,RET=z.RET,USUB=z.USUB,CV=z.CV,NIY=z.NIY,FORF=z.FORF,KEY=z.KEY,WHERE=z.WHERE,EVALUE=z.EVALUE,BREAK=z.BREAK,CLOSE=z.CLOSE,OPEN=z.OPEN,IOMODE=z.IOMODE,WRSEQ=z.WRSEQ,FORV=z.FORV,BOX=z.BOX;z.BEGIN(module);NL(0);z.MAIN(e);e.MAIN=B(GOSUB(C(e),'TEST_')
,NL(1),END()); 
...
,NL(1),IF(LT(F('DIM',[V('GXUNIT_ID')]),C(0)),p,1,B(DECL('VS','GXUNIT_ID',A([C(255)])),GO(p,1)))));p[1]=B(
NL(1),SET(V('GXUNIT_ID'),V('SUITE_ID'))
,NL(1),IF(LT(F('DIM',[V('GXUNIT_SUITE_DESCRIPTION')]),C(0)),p,2,B(DECL('VS','GXUNIT_SUITE_DESCRIPTION',A([C(255)])),GO(p,2))));p[2]=B(
NL(1),SET(V('GXUNIT_SUITE_DESCRIPTION'),V('SUITE_DESCRIPTION'))
,NL(1),IF(LT(F('DIM',[V('GXUNIT_CASE_ID')]),C(0)),p,3,B(DECL('VI','GXUNIT_CASE_ID'),GO(p,3))));p[3]=B(
NL(1),SET(V('GXUNIT_CASE_ID'),C(0))
,NL(1),IF(LT(F('DIM',[V('GXUNIT_CASE_SUCCESS')]),C(0)),p,4,B(DECL('VI','GXUNIT_CASE_SUCCESS'),GO(p,4))));p[4]=B(
NL(1),SET(V('GXUNIT_CASE_SUCCESS'),C(0))
,NL(1),IF(LT(F('DIM',[V('GXUNIT_CASE_FAILURE')]),C(0)),p,5,B(DECL('VI','GXUNIT_CASE_FAILURE'),GO(p,5))));p[5]=B(
NL(1),SET(V('GXUNIT_CASE_FAILURE'),C(0))

,NL(2),IF(LT(F('DIM',[V('GXUNIT_LOG_NAME')]),C(0)),p,6,B(DECL('VS','GXUNIT_LOG_NAME',A([C(255)])),GO(p,6))));p[6]=B(
...
PROG(e,'INIT_UNIT',[],B(
NL(3),IF(LT(F('DIM',[V('GXUNIT_TSTAMP')]),C(0)),p,7,B(DECL('VS','GXUNIT_TSTAMP',A([C(20)])),GO(p,7)))));p[7]=B(
NL(1),IF(EQ(V('GXUNIT_TSTAMP'),C('')),p,8,B(
NL(1),SET(V('GXUNIT_TSTAMP'),F('TIMESTAMP$'))
,GO(p,8))));p[8]=B(
NL(2),IF(LT(F('DIM',[V('GXUNIT_MODULE_NAME')]),C(0)),p,9,B(DECL('VS','GXUNIT_MODULE_NAME',A([C(255)])),GO(p,9))));p[9]=B(
...
NL(3),IF(LT(F('DIM',[V('GXUNIT_SUITE_RESULT')]),C(0)),p,12,B(DECL('VT','GXUNIT_SUITE_RESULT',A([C(2)])),GO(p,12))));p[12]=B(
NL(1),RAZ([V('GXUNIT_SUITE_RESULT')])
,NL(1),IF(LT(F('DIM',[V('GXUNIT_JSON')]),C(0)),p,13,B(DECL('VT','GXUNIT_JSON',A([C(8)])),GO(p,13))));p[13]=B(
NL(1),RAZ([V('GXUNIT_JSON')])

,NL(2),IF(LT(F('DIM',[V('GXUNIT_CASES')]),C(0)),p,14,B(DECL('VS','GXUNIT_CASES',A([C(100)]),A([RANGE(C(1)),C(2)])),GO(p,14))));p[14]=B(
NL(1),IF(LT(F('DIM',[V('GXUNIT_CASE_COUNT')]),C(0)),p,15,B(DECL('VI','GXUNIT_CASE_COUNT'),GO(p,15))));p[15]=B(
NL(1),IF(LT(F('DIM',[V('GXUNIT_CURRENT_CASE')]),C(0)),p,16,B(DECL('VI','GXUNIT_CURRENT_CASE'),GO(p,16))));p[16]=B(
NL(1),IF(LT(F('DIM',[V('GXUNIT_CASE_ASSERT_COUNT')]),C(0)),p,17,B(DECL('VI','GXUNIT_CASE_ASSERT_COUNT',A([RANGE(C(1)),C(2)])),GO(p,17))));p[17]=B(
NL(1),END()); 
...
NL(9),IF(GT(F('DIM',[V('GXUNIT_SUITE_ERROR')]),C(0)),p,18,B(
...
,NL(2),IF(LT(F('DIM',[V('GXUNIT_CASESTAMP')]),C(0)),p,19,B(DECL('VS','GXUNIT_CASESTAMP',A([C(20)])),GO(p,19)))));p[19]=B(
NL(1),SET(V('GXUNIT_CASESTAMP'),F('TIMESTAMP$'))
,NL(1),IF(LT(F('DIM',[V('GXUNIT_DESCRIPTION')]),C(0)),p,20,B(DECL('VS','GXUNIT_DESCRIPTION',A([C(255)])),GO(p,20))));p[20]=B(
NL(1),SET(V('GXUNIT_DESCRIPTION'),V('DESCRIPTION'))
,NL(1),IF(LT(F('DIM',[V('GXUNIT_TESTID')]),C(0)),p,21,B(DECL('VI','GXUNIT_TESTID'),GO(p,21))));p[21]=B(
...
,NL(2),IF(LT(F('DIM',[V('GXUNIT_ERROR')]),C(0)),p,22,B(DECL('VI','GXUNIT_ERROR'),GO(p,22))));p[22]=B(
...
NL(7),IF(OR(LT(F('DIM',[V('GXUNIT_CURRENT_CASE')]),C(0)),OR(LE(V('GXUNIT_CURRENT_CASE'),C(0)),AND(GT(F('DIM',[V('GXUNIT_SUITE_RESULT')]),C(0)),GT(F('LEN',[V('GXUNIT_SUITE_RESULT')]),C(0))))),p,26,B(
NL(1),IF(LT(F('DIM',[V('GXUNIT_SUITE_ERROR')]),C(0)),p,27,B(DECL('VT','GXUNIT_SUITE_ERROR',A([C(3)])),GO(p,27))),GO(p,26)))));p[27]=B(
...
,NL(1),DECL('LI','STAT')
,NL(1),IF(LT(F('DIM',[V('GSTACK')]),C(0)),p,28,B(DECL('VT','GSTACK',A([C(7)])),GO(p,28))));p[28]=B(
...
NL(7),IF(LT(F('DIM',[V('GXUNIT_RESULT')]),C(0)),p,29,B(DECL('VT','GXUNIT_RESULT',A([C(10)])),GO(p,29)))));p[29]=B(
NL(1),IF(LT(F('DIM',[V('GXUNIT_SUCCESS')]),C(0)),p,30,B(DECL('VI','GXUNIT_SUCCESS'),GO(p,30))));p[30]=B(
NL(1),IF(LT(F('DIM',[V('GXUNIT_FAILURE')]),C(0)),p,31,B(DECL('VI','GXUNIT_FAILURE'),GO(p,31))));p[31]=B(
NL(1),END()); 
...
e.CHECK_FAILED=B(
NL(3),DECL('LI','STAT')
,NL(1),IF(LT(F('DIM',[V('GSTACK')]),C(0)),p,59,B(DECL('VT','GSTACK',A([C(7)])),GO(p,59))));p[59]=B(
...
NL(1),IF(EQ(V('DOSSIER'),C('')),p,68,B(SET(V('DOSSIER'),V('NOMAP')),GO(p,68))));p[68]=B(
...
NL(3),IF(GT(F('CLALEV',[CV('F','TRT_','null')]),C(0)),p,74,B(NIY({tag:'CLOSE',scope:'LOCAL',target:'FILE',classes:A([CV('?','TRT_','null')])}),GO(p,74))));p[74]=B(
...
NL(1),NIY({tag:'GOTO',label:'END_SUITE'})
,GO(p,83)))));p[83]=B(
...
,NL(1),CALL(C(e),V('SUBPRG'),[EQ(V('FROM'),V('GXUNIT_MODULE_NAME'))])
...
PROG(e,'LOG_NAME',[],B(
NL(7),IF(LT(F('DIM',[V('GXUNIT_LOG_NAME')]),C(0)),p,87,B(DECL('VS','GXUNIT_LOG_NAME',A([C(255)])),GO(p,87)))));p[87]=B(
...
,NL(1),IF(GT(F('DIM',[V('GXUNIT_TSTAMP')]),C(0)),p,89,B(NIY({tag:'KILL',expressions:A([V('GXUNIT_TSTAMP')])}),GO(p,89)))));p[89]=B(
NL(1),IF(GT(F('DIM',[V('GXUNIT_ID')]),C(0)),p,90,B(NIY({tag:'KILL',expressions:A([V('GXUNIT_ID')])}),GO(p,90))));p[90]=B(
NL(1),IF(GT(F('DIM',[V('GXUNIT_DESCRIPTION')]),C(0)),p,91,B(NIY({tag:'KILL',expressions:A([V('GXUNIT_DESCRIPTION')])}),GO(p,91))));p[91]=B(
NL(1),IF(GT(F('DIM',[V('GXUNIT_SUCCESS')]),C(0)),p,92,B(NIY({tag:'KILL',expressions:A([V('GXUNIT_SUCCESS')])}),GO(p,92))));p[92]=B(
NL(1),IF(GT(F('DIM',[V('GXUNIT_FAILURE')]),C(0)),p,93,B(NIY({tag:'KILL',expressions:A([V('GXUNIT_FAILURE')])}),GO(p,93))));p[93]=B(
NL(1),IF(GT(F('DIM',[V('GXUNIT_TESTID')]),C(0)),p,94,B(NIY({tag:'KILL',expressions:A([V('GXUNIT_TESTID')])}),GO(p,94))));p[94]=B(
NL(1),IF(GT(F('DIM',[V('GXUNIT_RESULT')]),C(0)),p,95,B(NIY({tag:'KILL',expressions:A([V('GXUNIT_RESULT')])}),GO(p,95))));p[95]=B(
NL(1),IF(GT(F('DIM',[V('GXUNIT_ERROR')]),C(0)),p,96,B(NIY({tag:'KILL',expressions:A([V('GXUNIT_ERROR')])}),GO(p,96))));p[96]=B(
NL(1),IF(GT(F('DIM',[V('GXUNIT_FILE')]),C(0)),p,97,B(NIY({tag:'KILL',expressions:A([V('GXUNIT_FILE')])}),GO(p,97))));p[97]=B(
NL(1),END(C('ok'))); 
...
NL(4),IF(LT(F('DIM',[V('GXUNIT_MODULE_NAME')]),C(0)),p,98,B(DECL('VS','GXUNIT_MODULE_NAME',A([C(255)])),GO(p,98)))));p[98]=B(
