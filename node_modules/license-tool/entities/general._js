...
module.exports = {
	$title: "General",
	$modes: "create,display,extra*,edit,svb", // svb: enable save button in the beginning
	$links: {
		$extra: {
	...
	$save: function(_, wc, diagnoses) {
		...
		if (wc.$_$_partner) {
			try {
				helper.setPartnerFile(wc.$_$_partner.toString("utf8"));
				fs.writeFile(helper.PARTNER_FILE, wc.$_$_partner, _);
			} catch (e) {
				helper.addError(locale.format(module, "partnerFile", e), diagnoses);
			}
		}
	},
};