...
char* MEMDUP(char* p, int l) { char* np = (char*)malloc(l); memcpy(np, p, l); return np; }
// warning b used twice in macro
#define BUFFER_NEW2(a, b) Buffer::New(Isolate::GetCurrent(), MEMDUP(a, b), b).ToLocalChecked()
#else
