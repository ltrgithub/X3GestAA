...
<Project DefaultTargets="Build" ToolsVersion="4.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{B6D5FB29-9A26-3C08-CE63-22DC49507CE0}</ProjectGuid>
  ...
  <ItemDefinitionGroup Condition="'$(Configuration)|$(Platform)'=='Debug|x64'">
    <ClCompile>
      <AdditionalIncludeDirectories>c:\git_syracuse\Syracuse\.node-gyp\0.8.17\src;c:\git_syracuse\Syracuse\.node-gyp\0.8.17\deps\uv\include;c:\git_syracuse\Syracuse\.node-gyp\0.8.17\deps\v8\include;%(AdditionalIncludeDirectories)</AdditionalIncludeDirectories>
    ...
    <Link>
      <AdditionalDependencies>c:\git_syracuse\Syracuse\.node-gyp\0.8.17\x64\node.lib;%(AdditionalDependencies)</AdditionalDependencies>
  ...
  <ItemGroup>
    <ClCompile Include="..\src\crypt.cc" />
  </ItemGroup>
