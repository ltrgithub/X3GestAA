...
/// clientOptions: timeout: after this time (in seconds), the request data will be deleted
exports.Mock = Mock;
...
/// - options: options which will be passed to HttpServerRequest, HttpServerResponse
