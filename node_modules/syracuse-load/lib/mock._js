...
exports.attachEngineIO = function(engine, client, findClient, transferSocket) {
	/*TODO fix issue with https

	if (!engine) engine = require('socket.io/node_modules/engine.io')(client, {
	...
	engine.on('connection', function(socket) {
		...
		if (!mockClient) {
			...
			console.log("Cannot find client for engine.io connection" + util.format(socket.request.headers));
...
MockSocket.prototype.write =
	MockSocket.prototype.send = function(data, callback) {
