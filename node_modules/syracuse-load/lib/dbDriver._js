...
exports.open = function(configdata, _) {
	...
	console.log("Open with config "+util.format(configdata))
...
exports.updateAll = function(collection, condition, set, _) {
	collection.update(condition, {$set: set}, {safe: true, multi: true}, _);
}
...
exports.findInstance = function(attr, list) {
	if (!attr) return null;
	var id = attr._uuid;
...
exports.setRelatedInstance = function(related) {
	return related ? { _uuid: related._id} : null;
}
