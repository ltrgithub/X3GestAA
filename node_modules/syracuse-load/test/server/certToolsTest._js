...
asyncTest('CA Certificate operations in file system', 44, function(_) {
	var directory = 'certificatetestx/';
	var i = 0;
	while (fs.existsSync(directory) && i < 10) { // avoid clash with existing directory
		directory = 'certificatetestx' + i + '/';
		i++;
	}
	try {
...
asyncTest('Certificate operations in file system', 103, function(_) {
	var directory = 'certificatetestx/';
	var i = 0;
	while (fs.existsSync(directory) && i < 10) { // avoid clash with existing directory
		directory = 'certificatetestx' + i + '/';
...
asyncTest("Sign and verify test", 4, function(_) {
	var directory = 'certificatetestx/'
	var i = 0;
	while (fs.existsSync(directory) && i < 10) { // avoid clash with existing directory
		directory = 'certificatetestx' + i + '/';
