...
function AFB120(_,_root) {
  ...
  this.import = function(_,fileIn,fileOut)  {
    ...
    var variants = require(__dirname + "/afb120.json");
    var groups   = require(__dirname + "/afb120Groups.json");
    var relbank  = require(__dirname + "/x3relbank.json");
    var mapX3    = require(__dirname + "/afb120_2_relbank.json");
...
var path=__dirname + "\\..\\test\\fixtures\\AFB120\\";
var fileIn  = path + "afb_02.txt";
var fileOut = path + "RELBANK-afb_02.json";

monitor("new AFB120");
var quicken = new AFB120(_,path);  
