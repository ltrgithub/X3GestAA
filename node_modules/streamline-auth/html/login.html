...
function init() {
  ...
  if (oauth2s.length > 0) {
    ...
    oauth2s.forEach(function(oauth2, i) {
      ...
      div.firstChild.href = oauth2.href;
      div.firstChild.textContent = oauth2.title;
    });
  }
    ...
    <div class="s-text" style="float:left;padding-bottom:0;">
      ...
      <div style="visibility:{{passwordVisibility}};float:left;width:100%;">
        <div style="float:left; width:100%;">
          <div id="error-msg" style="float:left;font-size:0.3em;color:red;line-height:1em;">{{loginError}}</div>
        </div>
        <div style="float:left; width:100%;">
