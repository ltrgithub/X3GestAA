...
ReadableTrackingBuffer = (function() {
  ...
  ReadableTrackingBuffer.prototype.readAsStringUBigIntLE = function(length) {
    this.assertEnoughLeftFor(length);
    this.position += length;
    return convertLEUBytesToString(this.buffer.slice(this.position - length, this.position));
  };
  ...
  ReadableTrackingBuffer.prototype.readAsStringUInt32LE = function( ) {
    return this.readAsStringUBigIntLE(4);
  };

  ReadableTrackingBuffer.prototype.readAsStringUInt64LE = function( ) {
    return this.readAsStringUBigIntLE(8);
  };

  ReadableTrackingBuffer.prototype.readAsStringUInt96LE = function( ) {
    return this.readAsStringUBigIntLE(12);
  };

  ReadableTrackingBuffer.prototype.readAsStringUInt128LE = function( ) {
    return this.readAsStringUBigIntLE(16);
  };
