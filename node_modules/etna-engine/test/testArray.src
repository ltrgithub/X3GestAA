Call INIT(trtcou,39) From XUNIT
Call SIMPLE_TEST
Call SORT_TEST
Call INSERT_TEST
Call DELETE_TEST
...
$ERROR
	CallJS sync print("ERROR"-errm) From "etna-engine/lib/helpers"
End
...
SubProg SORT_TEST()
    ...
    Call CHECK_EQUAL("Sorta S,D Order By S(indice) Desc", func DUMP_S(STRINGS), LSORT) From XUNIT
    Call CHECK_EQUAL("Sorta S,D", func DUMP_I(INTS), DBYL) From XUNIT
    Sorta INTS,STRINGS
