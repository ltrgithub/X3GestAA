...
Call ADD_TESTCASE("TC_INTEGER1","TC_INTEGER1"-"Integer array(1..)",NBTEST) From AXUNIT
...
Call ADD_TESTCASE("TC_SHORTINT0","TC_SHORTINT0"-"Shortint array(0..)",NBTEST) From AXUNIT
Call ADD_TESTCASE("TC_SHORTINT1_6","TC_SHORTINT1_6"-"Shortint array(1..6)",NBTEST+2) From AXUNIT
Call ADD_TESTCASE("TC_SHORTINT1","TC_SHORTINT1"-"Shortint array(1..)",NBTEST) From AXUNIT
...
Call ADD_TESTCASE("TC_TINYINT0","TC_TINYINT0"-"Tinyint array(0..)",NBTEST) From AXUNIT
Call ADD_TESTCASE("TC_TINYINT1_6","TC_TINYINT1_6"-"Tinyint array(1..6)",NBTEST+2) From AXUNIT
Call ADD_TESTCASE("TC_TINYINT1","TC_TINYINT1"-"Tinyint array(1..)",NBTEST) From AXUNIT
...
Call ADD_TESTCASE("TC_DECIMAL0","TC_DECIMAL0"-"Decimal array(0..)",NBTEST) From AXUNIT
Call ADD_TESTCASE("TC_DECIMAL1_6","TC_DECIMAL1_6"-"Decimal array(1..6)",NBTEST+2) From AXUNIT
Call ADD_TESTCASE("TC_DECIMAL1","TC_DECIMAL1"-"Decimal array(1..)",NBTEST) From AXUNIT
...
Subprog TC_DATE0
Local Date AI(0..): Local Integer I
Gosub DEF_DATE
Call CHECK_EQUAL(dim(AI),32767)
If pat(ver$(0),"etna*")>0
Call CHECK_EQUAL(maxtab(AI), 6)
...
Subprog TC_DATE0_5
Local Date AI(0..5): Local Integer I
Gosub DEF_DATE
Call CHECK_EQUAL(dim(AI), 6)
Call CHECK_EQUAL(maxtab(AI), 6)
Call CHECK_EQUAL(min(AI), [02/06/2014])
...
Subprog TC_DATE6
Local Date AI(6): Local Integer I
Gosub DEF_DATE
Call CHECK_EQUAL(dim(AI), 6)
Call CHECK_EQUAL(maxtab(AI), 6)
Call CHECK_EQUAL(min(AI), [02/06/2014])
...
Subprog TC_DATE1
Local Date AI(1..): Local Integer I : I=1
Gosub DEF_DATE
Call CHECK_EQUAL(dim(AI),32767)
Call CHECK_EQUAL(maxtab(AI), 6)
Call CHECK_EQUAL(min(AI), [02/06/2014])
...
Subprog TC_DATE1_6
Local Date AI(1..6): Local Integer I : I=1
Gosub DEF_DATE
Call CHECK_EQUAL(dim(AI), 6)
Call CHECK_EQUAL(maxtab(AI), 6)
Call CHECK_EQUAL(min(AI), [02/06/2014])
