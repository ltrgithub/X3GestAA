...
Call ADD_TESTCASE("TC_GDATETIME", "GDATETIME$ -Function ", 9) From AXUNIT
...
Call ADD_TESTCASE("TC_OP_OPERATIONS", "OP_OPERATIONS-Operation on datetimes", 7) From AXUNIT
Call ADD_TESTCASE("TC_OP_LOGICAL", "OP_LOGICAL-Logical peration on datetimes", 4) From AXUNIT
Call ADD_TESTCASE("TC_TRANSCLASS", "TRANSCLASS- datetime<->chaîne", 2) From AXUNIT
Call ADD_TESTCASE("TC_SADXXX", "SADXXX-Datetime column update in a database", 8) From AXUNIT
...
Local Char MY_DATE(10),MY_GOTSTR(20),MY_EXPECTSTR(20)
Local Datetime MY_GOT,MY_EXPECT

MY_DATE=format$("D:YYYY[-]MM[-]DD", "20140625")
MY_GOT=gdatetime$(MY_DATE +"T00:00:00Z")
MY_EXPECT=gdatetime$("2014-06-25T00:00:00Z")
MY_GOT_STR=num$(MY_GOT)
MY_EXPECT_STR=num$(MY_EXPECT)
Call CHECK_EQUAL(MY_GOT_STR,MY_EXPECT_STR) From AXUNIT

#Call CHECK_EQUAL(MY_GOT,MY_EXPECT) From AXUNIT   # Error in axunit prevents running this test based on datetime types
End
...
Local Datetime CURRENTDTM
Local Char CURRENTDTMSTR(20)
Local Char GOT(20), EXPECT(20)
