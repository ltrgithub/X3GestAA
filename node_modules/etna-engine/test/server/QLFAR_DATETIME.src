...
#*!
Funprog TESTSUITE()
Call ADD_TESTCASE("TEST_GDATETIME", "Fonction gdatetime$", 9) From AXUNIT
#Call ADD_TESTCASE("TEST_DATETIME", "Fonction datetime$", 3) From AXUNIT
#Call ADD_TESTCASE("TEST_SADXXX", "Sauvegarde er récupération d'un champ Datetime de la BD", 8) From AXUNIT

#Call ADD_TESTCASE("TEST_NUM", "Fonction num$", 1) From AXUNIT
#Call ADD_TESTCASE("TEST_TRANSCLASS", "Transclass datetime<->chaîne", 2) From AXUNIT
#Call ADD_TESTCASE("TEST_COMPARE_DATETIME", "Comparison of Datetime-values", 8) From AXUNIT
...
Call TRACE("EXPECT:"+EXPECT) From ASYRCOM 

Call TRACE("call gdatetime:"+ONLYDATEZ) From ASYRCOM 
MYDATE=gdatetime$(ONLYDATEZ)

Call TRACE("call num$") From ASYRCOM 
GOT= num$(MYDATE)

Call TRACE("GOT:"+GOT) From ASYRCOM 
Call CHECK_EQUAL(GOT,EXPECT) From AXUNIT
End
