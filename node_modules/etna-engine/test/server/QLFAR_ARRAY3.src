...
GTRACE = "QLFAR_ARRAY3_"+GACTX.USER
...
If WCAS="0.."
 ...
 STR = 0
 MAXI = 9
 Call CHECK_EQUAL(maxtab (CAR1),-1)
...
Elsif WCAS="5.."
 ...
 STR = 5
 MAXI = 14
 Call CHECK_EQUAL(maxtab (CAR1),4)
 Call CHECK_EQUAL(dim(CAR1),32767)
 Call CHECK_EQUAL(dim(CAR1,0),1)
 Call CHECK_EQUAL(dim(CAR1,1),32767)
...
Elsif WCAS="0..9"
 ...
 STR = 0
 MAXI = 9
 Call CHECK_EQUAL(maxtab (CAR1),9) #*
 Call CHECK_EQUAL(dim(CAR1),10)
 Call CHECK_EQUAL(dim(CAR1,0),1)
 Call CHECK_EQUAL(dim(CAR1,1),10)
 Call CHECK_EQUAL(dim(CAR1,-1),0)
...
Case WCAS
 When "0.."
  Call CHECK_EQUAL(maxtab (CAR1),12)
 When "1.."
...
Case WCAS
 When "0.."
  Call CHECK_EQUAL(CAR1(maxtab (CAR1)-1),"A8")
 When "1.."
  Call CHECK_EQUAL(CAR1(maxtab (CAR1)),"A10")
 When "0..9"
  Call CHECK_EQUAL(CAR1(maxtab (CAR1)-1),"A5")#*
 When "10"
  Call CHECK_EQUAL(CAR1(maxtab (CAR1)-1),"A5")#*
 When "1..10"
 ...
 When "5..14"
  Call CHECK_EQUAL(CAR1(maxtab (CAR1)),"A11") #*
Endcase
Call CHECK_EQUAL(dim(CAR1,0),1)
If WCAS="0.."
 Call CHECK_EQUAL(dim(CAR1),32767)
...
#Déclaration d'un tableau x*3*5 de chaînes de longueur maximale 10
    ...
    Integer RES1,RES2
    Call CHECK_EQUAL(num$(type(TOTO))-num$(dim(TOTO)),'20 32767')
    Call CHECK_EQUAL(maxtab (TOTO),-1)
     Call CHECK_EQUAL(dim (TOTO, 0),3)
    Call CHECK_EQUAL(dim (TOTO, 1),32767)
    ...
    Next I
    #dbgetna
    Infbox "dim(TOTO, 0):"+num$(dim(TOTO, 0))
    Infbox "dim(TOTO, -1):"+num$(dim(TOTO, -1))
    For I=1 To dim(TOTO, 0)
     Infbox "Add elt:"-num$(I+dim(TOTO,-1))+","+num$(I-1)+","+num$(I)
     TOTO(I+dim(TOTO,-1),I-1,I)=num$(I)
     Infbox "maxtab:"+num$(maxtab (TOTO))
    Next I
...
#Déclaration d'un tableau 12*3*5 de chaînes de longueur maximale 10
    ...
    Integer RES1,RES2
    Call CHECK_EQUAL(num$(type(TOTO))-num$(dim(TOTO)),'20 12')
    Call CHECK_EQUAL(maxtab (TOTO),11) #*
    Call CHECK_EQUAL(dim (TOTO, 0),3)
    Call CHECK_EQUAL(dim (TOTO, 1),12)
    Call CHECK_EQUAL(dim (TOTO, -1),0)
...
#Déclaration d'un tableau x*3*4 de chaînes de longueur maximale 10
    Char TOTO(10) (-5..,3,4)
    Integer RES1,RES2
    #TRUC =  num$(type(TOTO))-num$(dim(TOTO))
    Call CHECK_EQUAL(num$(type(TOTO))-num$(dim(TOTO)), '20 32767')
    ...
    Next I
    Call CHECK_EQUAL(maxtab (TOTO),-2)
