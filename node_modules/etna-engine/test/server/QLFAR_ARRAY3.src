...
Call TESTSUITE()
Sorta I+1 CAR, NOM, NUM Order By NUM(indice) Desc, NUM(indice) Asc
...
NBTEST = 8
Call ADD_TESTCASE("TC_INSA0","Function Insa 0..",NBTEST) From AXUNIT
Call ADD_TESTCASE("TC_INSA1","Function Insa 1..",NBTEST) From AXUNIT
Call ADD_TESTCASE("TC_INSA0_9","Function Insa 0..9",NBTEST) From AXUNIT
Call ADD_TESTCASE("TC_INSA1_10","Function Insa 1..10",NBTEST) From AXUNIT

NBTEST = 3
Call ADD_TESTCASE("TC_DELA0","Function Dela 0..",NBTEST) From AXUNIT
Call ADD_TESTCASE("TC_DELA1","Function Dela 1..",NBTEST) From AXUNIT
Call ADD_TESTCASE("TC_DELA0_9","Function Dela 0..9",NBTEST) From AXUNIT
Call ADD_TESTCASE("TC_DELA1_10","Function Dela 1..10",NBTEST) From AXUNIT
