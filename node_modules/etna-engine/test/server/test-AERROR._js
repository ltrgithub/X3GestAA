...
asyncTest("TC_AERROR", function(_) {
	...
	strictEqual(err[0].PRO, "FIELD1");
	strictEqual(err[1].PRO, "");
	strictEqual(err[2].PRO, "LINCOL(1).KEY1");
	strictEqual(err[3].PRO, "LINCOL(2).LINNO");
	strictEqual(err[4].PRO, "LINCOL(1)");
	strictEqual(err[5].PRO, "LINCOL(1).KEY1");
	strictEqual(err[6].PRO, "LINCOL(2).LINNO");
