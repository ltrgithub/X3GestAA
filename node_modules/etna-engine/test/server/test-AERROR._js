...
asyncTest("TC_AERROR", function(_) {
	...
	strictEqual(err[0].get(_, "CAT"), 5);
	strictEqual(err[1].get(_, "CAT"), 6);
	strictEqual(err[2].get(_, "CAT"), 7);
	strictEqual(err[3].get(_, "CAT"), 0);
	strictEqual(err[4].get(_, "CAT"), 0);
	strictEqual(err[5].get(_, "CAT"), 0);
	strictEqual(err[6].get(_, "CAT"), 0);
	...
	instance_c3.ASETERRORCAT(_, "FIELD1", "Message Instance3 property FIELD1", constants.CST_AERROR, 5);
	instance_c3.ASETERRORCAT(_, "", "Message Instance3", constants.CST_AFATAL, 6);

	stat = instance_c3.AGETERRORSFROM(_, instance_c1, "Instance1 Env");
	strictEqual(stat, constants.CST_AOK);

	err = instance_c3.getDiagnoses(_);

	strictEqual(err[0].get(_, "CPY"), 1);
	strictEqual(err[1].get(_, "CPY"), 1);
	strictEqual(err[2].get(_, "CPY"), 1);
	strictEqual(err[3].get(_, "CPY"), 1);
	strictEqual(err[4].get(_, "CPY"), 1);
	strictEqual(err[5].get(_, "CPY"), 1);
	strictEqual(err[6].get(_, "CPY"), 1);
	strictEqual(err[7].get(_, "CPY"), 0);
	strictEqual(err[8].get(_, "CPY"), 0);

	strictEqual(err[0].get(_, "ENV"), "Instance1 Env");
	strictEqual(err[1].get(_, "ENV"), "Instance1 Env");
	strictEqual(err[2].get(_, "ENV"), "Instance1 Env");
	strictEqual(err[3].get(_, "ENV"), "Instance1 Env");
	strictEqual(err[4].get(_, "ENV"), "Instance1 Env");
	strictEqual(err[5].get(_, "ENV"), "Instance1 Env");
	strictEqual(err[6].get(_, "ENV"), "Instance1 Env");
	strictEqual(err[7].get(_, "ENV"), "");
	strictEqual(err[8].get(_, "ENV"), "");
