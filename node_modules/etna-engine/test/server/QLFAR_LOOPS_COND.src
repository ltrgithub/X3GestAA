...
GTRACE = "QLFAR_LOOPS_COND_"+GACTX.USER
...
TT="12: Loop on a start and end Decimal"
Call CHECK_EQUAL(TT, TT ) From AXUNIT
  Local Decimal START_DECIMAL, END_DECIMAL, IDX_DECIMAL
  Local Decimal LOOPCOUNT_DECIMAL
  START_DECIMAL = 1.7
  END_DECIMAL = 1.70001
  LOOPCOUNT_DECIMAL = 0
...
TT="13: Loop on a start and end Decimal with step negative"
Call CHECK_EQUAL(TT, TT ) From AXUNIT
  Local Decimal START_DECIMAL, END_DECIMAL, IDX_DECIMAL
  Local Decimal LOOPCOUNT_DECIMAL
  Local Integer LOOPCOUNT
