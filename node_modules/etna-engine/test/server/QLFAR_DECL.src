...
Call ADD_TESTCASE("TC_DECL_FLOAT","test TC_DECL_FLOAT",2) From AXUNIT
Call ADD_TESTCASE("TC_DECL_DOUBLE","test TC_DECL_DOUBLE",NBTEST) From AXUNIT

Call ADD_TESTCASE("TC_DECL_INTEGER","test TC_DECL_INTEGER",8) From AXUNIT
Call ADD_TESTCASE("TC_DECL_DECIMAL","test TC_DECL_DECIMAL",10) From AXUNIT
