...
Funprog TESTSUITE()
Call ADD_TESTCASE("SIMPLE_TEST", "simple test", 54) From AXUNIT
Call ADD_TESTCASE("SORT_TEST", "sort test", 94) From AXUNIT
Call ADD_TESTCASE("INSERT_TEST", "insert test", 20) From AXUNIT
Call ADD_TESTCASE("DELETE_TEST", "delete test", 20) From AXUNIT
...
Global Char LETTERS, DIGITS, LSORT, LSORTS, DSORT, LBYD, DBYL, DBYL2,LSORTPART,ISORTPART
LETTERS = "DAAFBCBBAF"
DIGITS =  "5531244153"
LSORT =   "AAABBBCDFF"
LSORTD =  "FFDCBBBAAA"
...
Subprog SORT_TEST()
    ...
    Call CHECK_EQUAL(func DUMP_I(INTS,0,10), DBYL2, "Sorta S,D")
    Sorta INTS,STRINGS
    ...
    #Call CHECK_EQUAL(func DUMP_S(STRINGS,0,10), LSORTPART, "Sorta partial")
    #Call CHECK_EQUAL(func DUMP_I(INTS,0,10), ISORTPART, "Sorta partial")
...
Subprog INSERT_TEST()
 ...
 Call CHECK_EQUAL(func DUMP_S(STRINGS,0,10), left$(LETTERS, 2)+"XYZ"+mid$(LETTERS, 3, 5), "Insa S")
 Call CHECK_EQUAL(func DUMP_I(INTS,0,10), left$(DIGITS, 2)+"000"+mid$(DIGITS, 3, 5), "Insa I")
 Gosub FILL
 Insa 2, 3, 7 STRINGS, INTS
 STRINGS(2) = 'X' : STRINGS(3) = 'Y' : STRINGS(4) = 'Z'
 Call CHECK_EQUAL(func DUMP_S(STRINGS,0,10), left$(LETTERS, 2)+"XYZ"+mid$(LETTERS, 3, 3) +right$(LETTERS, 9), "Insa S")
 Call CHECK_EQUAL(func DUMP_I(INTS,0,10), left$(DIGITS, 2)+"000"+mid$(DIGITS, 3, 3) + right$(DIGITS, 9), "Insa I")
End
...
Subprog DELETE_TEST()
 ...
 Call CHECK_EQUAL(func DUMP_S(STRINGS,0,10), left$(LETTERS, 2)+right$(LETTERS, 6)+"XYZ", "Dela S")
 Call CHECK_EQUAL(func DUMP_I(INTS,0,10), left$(DIGITS, 2)+right$(DIGITS, 6)+"000", "Dela I")
 Gosub FILL
 Dela 2, 3, 7 STRINGS, INTS
 STRINGS(5) = 'X' : STRINGS(6) = 'Y' : STRINGS(7) = 'Z'
 Call CHECK_EQUAL(func DUMP_S(STRINGS,0,10), left$(LETTERS, 2)+mid$(LETTERS, 6, 3)+"XYZ"+right$(LETTERS, 9), "Dela S")
 Call CHECK_EQUAL(func DUMP_I(INTS,0,10), left$(DIGITS, 2)+mid$(DIGITS, 6, 3)+"000"+right$(DIGITS, 9), "Dela I")
End
