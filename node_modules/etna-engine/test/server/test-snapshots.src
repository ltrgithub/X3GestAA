...
Call CHECK_EQUAL( INS.COL(0).C03P02,10)  From AXUNIT
Call CHECK_EQUAL( INS.COL(1).C03P02,11)  From AXUNIT
Call CHECK_EQUAL( INS.COL(1).C03P02.$isHidden, CST_ATRUE)  From AXUNIT
Call CHECK_EQUAL( INS.COL(1).C03P02.$filename, "$filename 11")  From AXUNIT
Return
...
Call CHECK_EQUAL(LINE,0) From AXUNIT
...
INS.COL(0).C03P02 = 20
INS.COL(1).C03P02.$filename = "$filename 21"
INS.COL(1).C03P02.$isHidden = CST_AFALSE

# Check the instance
Call CHECK_EQUAL( maxtab(INS.COL),2) From AXUNIT
Call CHECK_EQUAL( INS.C03P01, "6" )  From AXUNIT
Call CHECK_EQUAL( INS.C03P01.$isHidden,CST_AFALSE)  From AXUNIT
Call CHECK_EQUAL( INS.COL(0).C03P02,20)  From AXUNIT
Call CHECK_EQUAL( INS.COL(1).C03P02.$isHidden, CST_AFALSE)  From AXUNIT
Call CHECK_EQUAL( INS.COL(1).C03P02.$filename, "$filename 21")  From AXUNIT
...
ASTATUS = fmet INS.COL.ADEL(0)
Call CHECK_EQUAL(maxtab(INS.COL),2) From AXUNIT
Call CHECK_EQUAL(INS.COL(0).C03P02,11)  From AXUNIT
...
# Modify the instance:
INS.COL(1).C03P02 = 101
INS.COL(1).C03P02.$filename = "$filename 21"
Call CHECK_EQUAL( INS.COL(1).C03P02, 101)  From AXUNIT
Call CHECK_EQUAL( INS.COL(1).C03P02.$filename, "$filename 21")  From AXUNIT
