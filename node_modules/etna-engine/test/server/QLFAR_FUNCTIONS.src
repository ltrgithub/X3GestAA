...
Call ADD_TESTCASE("TC_TRTCOU","Function trtcou",1) From AXUNIT
...
Integer EX
Onerrgo ERROR
Call CHECK_EQUAL(parse('date$') , 0)
Call CHECK_EQUAL(parse('date$$'), 5)
End
...
Subprog TC_UNI
#TODO Call CHECK_EQUAL(uni(1,2,3,4,5,6,7), 0)
#TODO Call CHECK_EQUAL(uni(1,1,3,4,5,6,7), 2)
#TODO Call CHECK_EQUAL(uni(1,2,1,4,5,6,7), 3)
#TODO Call CHECK_EQUAL(uni(1,2,3,4,5,6,1), 7)
Local Integer AI(1..),I :
I+= 1 : AI(I) =  I
I+= 1 : AI(I) =  I
I+= 1 : AI(I) =  I
...
Call CHECK_EQUAL(cos(pi/2), 0)
Call CHECK_EQUAL(cos(pi/3), 0.5)
Call CHECK_EQUAL(ar2(cos(pi/4)), ar2(sqr(2)/2))
Call CHECK_EQUAL(ar2(cos(pi/6)), ar2(sqr(3)/2))

# On calcule désormais en degrés
[S]adxmda = 0
Call CHECK_EQUAL(cos(0) , 1)
Call CHECK_EQUAL(cos(90), 0)
Call CHECK_EQUAL(ar2(cos(45)), 0.71 )
Call CHECK_EQUAL(ar2(cos(30)), 0.87 )

# On calcule désormais en grades
[S]adxmda = 2
Call CHECK_EQUAL(cos(0)    , 1)
Call CHECK_EQUAL(cos(100)  , 0)
Call CHECK_EQUAL(ar2(cos(50))  , 0.71 )
Call CHECK_EQUAL(ar2(cos(100/3)), 0.87 )
End
...
[S]adxmda = 0
Call CHECK_EQUAL(sin(0)    , 0)
Call CHECK_EQUAL(ar2(sin(45)) , 0.71)
...
[S]adxmda = 2
Call CHECK_EQUAL(sin(0)    , 0)
Call CHECK_EQUAL(ar2(sin(50)) , 0.71)
...
Call CHECK_EQUAL(ar2(tan(pi/6)), ar2(sin(pi/6)/cos(pi/6)))
...
Subprog TC_ASH
Call CHECK_EQUAL(ar2(ash(1)), 0.88)
...
Subprog TC_CH
Call CHECK_EQUAL(ar2(ch(1)),1.54)
Call CHECK_EQUAL(ch(0), 1)
End

Subprog TC_SH
Call CHECK_EQUAL(ar2(sh(1)),1.18)
Call CHECK_EQUAL(sh(0), 0)
End

Subprog  TC_TH
Call CHECK_EQUAL(ar2(th(1)),0.76)
Call CHECK_EQUAL(th(0), 0)
Call CHECK_EQUAL(ar2(sh(3)/ch(3)), ar2(th(3)))
End
...
# On calcul désormais en radians
[S]adxmda = 1
Call CHECK_EQUAL(ar2(acos(cos(pi/6))), ar2(pi/6))
End

Subprog TC_ASIN
# On calcul désormais en radians
[S]adxmda = 1
Call CHECK_EQUAL(ar2(asin(sin(pi/6))), ar2(pi/6))
End

Subprog TC_ATAN
# On calcul désormais en radians
[S]adxmda = 1
Call CHECK_EQUAL(ar2(atan(tan(pi/6))), ar2(pi/6))
End

Subprog TC_EXP
Call CHECK_EQUAL(exp(0), 1)
Call CHECK_EQUAL(ar2(exp(1)), 2.72)
End
...
Call CHECK_EQUAL(format$("N:6.2",1234567.12),"******.**")
...
Subprog TC_TRTCOU
Call CHECK_EQUAL(trtcou, '@SUPERV.TRT/QLFAR_FUNCTIONS$adx')
End

Subprog TC_VER
Call CHECK_EQUAL(ver$(0),"Version 17r.214 21/05/2014")
