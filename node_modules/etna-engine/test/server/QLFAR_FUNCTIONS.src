...
Call ADD_TESTCASE("TC_VAR","Function var()", 20) From AXUNIT
...
Integer EX
Onerrgo ERROR
Call CHECK_EQUAL(parse('date$') , 0)  From AXUNIT
Call CHECK_EQUAL(parse('date$$'), 5)  From AXUNIT
End
...
Call CHECK_EQUAL(pat('TC','*TC*') , 1) From AXUNIT
Call CHECK_EQUAL(pat(' TC','*TC*'), 1) From AXUNIT
Call CHECK_EQUAL(pat('TC ','*TC*'), 1) From AXUNIT
Call CHECK_EQUAL(pat(' TC ','*TC*'), 1) From AXUNIT
Call CHECK_EQUAL(pat('TC ','#TC'), 0) From AXUNIT
Call CHECK_EQUAL(pat('TC ','1TC'), 0) From AXUNIT
Call CHECK_EQUAL(pat('TC','##TC'), 0) From AXUNIT
Call CHECK_EQUAL(pat('2TC','##TC'), 0) From AXUNIT
Call CHECK_EQUAL(pat('23TC','##TC'), 1) From AXUNIT
Call CHECK_EQUAL(pat('TC','TC##'), 0) From AXUNIT
Call CHECK_EQUAL(pat('TC3','TC##'), 0) From AXUNIT
Call CHECK_EQUAL(pat('TC34','TC##'), 1) From AXUNIT
Call CHECK_EQUAL(pat('TC','!'), 0) From AXUNIT
Call CHECK_EQUAL(pat('TC','!!'), 1) From AXUNIT
Call CHECK_EQUAL(pat('T#','!!'), 0) From AXUNIT
Call CHECK_EQUAL(pat('TC','!!!'), 0) From AXUNIT
Call CHECK_EQUAL(pat('TC','?'), 0) From AXUNIT
Call CHECK_EQUAL(pat('TC','??'), 1) From AXUNIT
Call CHECK_EQUAL(pat('T#','??'), 1) From AXUNIT
Call CHECK_EQUAL(pat('!TC5','?!!#'), 1) From AXUNIT
End
...
Call CHECK_EQUAL(var(1,2,3,4,5,6,7), 4)  From AXUNIT
Call CHECK_EQUAL(var(5,10,15,20,25,30,35), 100)  From AXUNIT
End
...
[S]adxmda = 0
Call CHECK_EQUAL(ar2(cos(0)) , 1)  From AXUNIT
Call CHECK_EQUAL(ar2(cos(90)), 0)  From AXUNIT
Call CHECK_EQUAL(ar2(cos(45)), 0.71 )  From AXUNIT
Call CHECK_EQUAL(ar2(cos(30)), 0.87 )  From AXUNIT

# On calcule désormais en grades
[S]adxmda = 2
Call CHECK_EQUAL(ar2(cos(0))    , 1)  From AXUNIT
Call CHECK_EQUAL(ar2(cos(100))  , 0)  From AXUNIT
Call CHECK_EQUAL(ar2(cos(50))   , 0.71 )  From AXUNIT
Call CHECK_EQUAL(ar2(cos(100/3)), 0.87 )  From AXUNIT
End
...
Call CHECK_EQUAL(ar2(sin(pi)), 0) From AXUNIT
...
[S]adxmda = 0
Call CHECK_EQUAL(sin(0)    , 0) From AXUNIT
Call CHECK_EQUAL(ar2(sin(45)) , 0.71) From AXUNIT
Call CHECK_EQUAL(sin(90)      , 1) From AXUNIT
Call CHECK_EQUAL(ar2(sin(180)), 0) From AXUNIT

# Grades
[S]adxmda = 2
Call CHECK_EQUAL(sin(0)    , 0) From AXUNIT
Call CHECK_EQUAL(ar2(sin(50)) , 0.71) From AXUNIT
Call CHECK_EQUAL(sin(100)     , 1) From AXUNIT
Call CHECK_EQUAL(ar2(sin(200)), 0) From AXUNIT
End
...
[S]adxmda = 0
Call CHECK_EQUAL(tan(0), 0) From AXUNIT
Call CHECK_EQUAL(ar2(tan(45)), 1) From AXUNIT

# On calcul désormais en grades
[S]adxmda = 2
Call CHECK_EQUAL(tan(0), 0) From AXUNIT
Call CHECK_EQUAL(ar2(tan(50)), 1) From AXUNIT
End
