...
GTRACE = "QLFAR_COMPILE_"+GACTX.USER
...
Callmet GACTX.ACTX_SET_LANISO("en-EN")
...
EX=20
Call TEST From QLFAR_SUB_COMPILE_QUOTE1

TT="Mismatched quotes"
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_QUOTE2
Onerrgo
End
...
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_PARENS1

Local Char TT(255)
TT="Mismatched parenthesis"
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_PARENS2
Onerrgo
End
...
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_IF1

TT="Missing If"
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_IF2
Onerrgo
End
...
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_CASE1

TT="Missing case "
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_CASE2


TT="Missing case and endcase "
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_CASE3

TT="First line after case is a comment "
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_CASE4
Onerrgo
End
...
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_LABEL1

TT="Missing call label"
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_LABEL2


TT="Missing gosub label"
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_LABEL3


TT="Missing onerrgo label"
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_LABEL4

TT="Duplicate label"
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_LABEL5

TT="Duplicate label 2"
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_LABEL6
Onerrgo
End
...
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_FOR1

TT="Missing for"
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_FOR2

TT="Missing iternation variable"
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_FOR3
Onerrgo
End
...
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_WHILE1

TT="Missing while"
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_WHILE2
...
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_UNTIL1

TT="Missing repeat"
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_UNTIL2
Onerrgo
End
...
#Call CHECK_EQUAL(TT,TT) From AXUNIT
#EX=20
#Call TEST From QLFAR_SUB_COMPILE_VAR1

TT="Date in invalid format [yyyy/mm/dd]"
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_VAR2

TT="Valid Date format with invalid year"
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_VAR3

TT="Valid Date format with invalid year"
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_VAR4

TT="Valid Date format with invalid day"
Call CHECK_EQUAL(TT,TT) From AXUNIT
EX=20
Call TEST From QLFAR_SUB_COMPILE_VAR5
Onerrgo
End
