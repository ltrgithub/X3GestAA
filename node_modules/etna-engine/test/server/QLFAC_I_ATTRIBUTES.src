...
GTRACE = "QLFAR_ATTRIBUTES_"+GACTX.USER
...
Call ADD_TESTCASE("TC_ACTX_ATTRIBUTES"	        ,"TC_ACTX_ATTRIBUTES"	    ,13 ) From AXUNIT
Call ADD_TESTCASE("TC_INSTANCE_ATTRIBUTES"		,"TC_INSTANCE_ATTRIBUTES"   ,27) From AXUNIT
...
Call ADD_TESTCASE("TC_MISC"    					,"TC_MISC" 					,4) From AXUNIT
Call ADD_TESTCASE("TC_COMPATIBILITY"    	    ,"TC_COMPATIBILITY" 		,2) From AXUNIT
Call ADD_TESTCASE("TC_ETNA_SYNTAX"    	        ,"TC_ETNA_SYNTAX" 	    	,14) From AXUNIT
...
ASTATUS = fmet INS1.C03P01.ASETATTR("$isReadonly",[V]CST_ATRUE)
[L]IS_READONLY = Fmet INS1.C03P01.AGETATTR("$isReadonly")
Call CHECK_EQUAL([L]IS_READONLY,[V]CST_ATRUE) From AXUNIT

ASTATUS = fmet INS1.C03P01.ASETATTR("$isReadonly",[V]CST_AFALSE)
[L]IS_READONLY = Fmet INS1.C03P01.AGETATTR("$isReadonly")
...
ASTATUS = fmet INS1.ASETATTR("$isReadonly",[V]CST_ATRUE)
...
ASTATUS = fmet INS1.ASETATTR("$isReadonly",[V]CST_AFALSE)
[L]IS_READONLY = Fmet INS1.AGETATTR("$isReadonly")
Call CHECK_EQUAL([L]IS_READONLY,[V]CST_AFALSE) From AXUNIT
...
ASTATUS = fmet INS2.C03P01.ASETATTR("$isReadonly",[V]CST_ATRUE)
...
ASTATUS = fmet INS1.C03P01.ASETATTR("$isHidden"  ,[V]CST_AFALSE)
ASTATUS = fmet INS1.C03P01.ASETATTR("$filename"  		,"filename")
ASTATUS = fmet INS1.C03P01.ASETATTR("$contentType"  	,"contentType")
ASTATUS = fmet INS2.C03P01.ASETATTR("$isDisabled",[V]CST_ATRUE)
ASTATUS = fmet INS2.C03P01.ASETATTR("$isDeleted" ,[V]CST_ATRUE)
...
ASTATUS = fmet GACTX.USER.ASETATTR("$isReadonly",[V]CST_AFALSE)
...
ASTATUS = fmet GACTX.USER.ASETATTR("$_isReadonly",[V]CST_AFALSE)
ASTATUS = fmet GACTX.USER.ASETATTR("$isReadonly" ,[V]CST_AFALSE)
[L]IS_READONLY = Fmet GACTX.USER.AGETATTR("$isReadonly")
Call CHECK_EQUAL([L]IS_READONLY,[V]CST_ATRUE) From AXUNIT
...
ASTATUS = fmet INS1.COL(0).C03P02.ASETATTR("$isReadonly",[V]CST_ATRUE)
...
ASTATUS = fmet INS1.COL(0).C03P02.ASETATTR("$isReadonly",[V]CST_AFALSE)
...
ASTATUS = fmet INS1.COL(0).ASETATTR("$isReadonly",[V]CST_ATRUE)
...
ASTATUS = fmet INS1.COL(0).ASETATTR("$isReadonly",[V]CST_AFALSE)
...
ASTATUS = fmet INS1.COL.ASETATTR("$isReadonly",[V]CST_ATRUE)
...
ASTATUS = fmet INS1.COL.ASETATTR("$isReadonly",[V]CST_AFALSE)
...
ASTATUS = fmet INS1.COL(1).ASETATTR("$isReadonly",[V]CST_AFALSE)
...
ASTATUS = fmet INS1.COL(1).ASETATTR("$isReadonly",[V]CST_ATRUE)
...
ASTATUS = fmet INS1.COL.ASETCOLUMNATTR("C03P02","$isReadonly",[V]CST_ATRUE)
ASTATUS = fmet INS1.COL.ASETCOLUMNATTR("C03P02","$isHidden"  ,[V]CST_AFALSE)
...
ASTATUS = fmet INS1.COL.ASETCOLUMNATTR("C03P02","$isReadonly",[V]CST_AFALSE)
...
Subprog TC_MISC
Local Integer IS_READONLY,LINE,C03P02,ASTATUS
Local Instance INS1 Using C_AQCPROC03
