...
Call ADD_TESTCASE("TC_ACTX_ATTRIBUTES","TC_ACTX_ATTRIBUTES"     ,30 ) From AXUNIT
Call ADD_TESTCASE("TC_PROPERTY_ATTRIBUTES","TC_PROPERTY_ATTRIBUTES"   ,135) From AXUNIT
...
EX=147
INS1.C03P01 = "INS1-6"
Call CHECK_EQUAL(INS1.C03P01,"INS1-6") From AXUNIT
...
Call CHECK_EQUAL([L]ASTATUS,[V]CST_ATRUE) From AXUNIT
Call CHECK_EQUAL(fmet INS1.C03P01.AGETATTR("$isDeleted"),[V]CST_ATRUE) From AXUNIT
Call CHECK_EQUAL(INS1.C03P01.$ISDELETED,[V]CST_ATRUE) From AXUNIT
INS1.C03P01.$ISDELETED=[V]CST_AFALSE
Call CHECK_EQUAL(INS1.C03P01.$ISDELETED,[V]CST_AFALSE) From AXUNIT

TC="Property isLoaded"
Call CHECK_EQUAL(TC,TC) From AXUNIT
[L]ASTATUS = fmet INS1.C03P01.ASETATTR("$isLoaded",[V]CST_ATRUE)
Call CHECK_EQUAL([L]ASTATUS,[V]CST_ATRUE) From AXUNIT
Call CHECK_EQUAL(fmet INS1.C03P01.AGETATTR("$isLoaded"),[V]CST_ATRUE) From AXUNIT
Call CHECK_EQUAL(INS1.C03P01.$ISLOADED,[V]CST_ATRUE) From AXUNIT
INS1.C03P01.$ISLOADED=[V]CST_AFALSE
Call CHECK_EQUAL(INS1.C03P01.$ISLOADED,[V]CST_AFALSE) From AXUNIT

TC="Property isLobFound"
Call CHECK_EQUAL(TC,TC) From AXUNIT
[L]ASTATUS = fmet INS1.C03P01.ASETATTR("$isLobFound",[V]CST_ATRUE)
Call CHECK_EQUAL([L]ASTATUS,[V]CST_ATRUE) From AXUNIT
Call CHECK_EQUAL(fmet INS1.C03P01.AGETATTR("$isLobFound"),[V]CST_ATRUE) From AXUNIT
Call CHECK_EQUAL(INS1.C03P01.$ISLOBFOUND,[V]CST_ATRUE) From AXUNIT
INS1.C03P01.$ISLOBFOUND=[V]CST_AFALSE
Call CHECK_EQUAL(INS1.C03P01.$ISLOBFOUND,[V]CST_AFALSE) From AXUNIT

TC="Property isExcluded"
Call CHECK_EQUAL(TC,TC) From AXUNIT
[L]ASTATUS = fmet INS1.C03P01.ASETATTR("$isExcluded",[V]CST_ATRUE)
Call CHECK_EQUAL([L]ASTATUS,[V]CST_ATRUE) From AXUNIT
Call CHECK_EQUAL(fmet INS1.C03P01.AGETATTR("$isExcluded"),[V]CST_ATRUE) From AXUNIT
Call CHECK_EQUAL(INS1.C03P01.$ISEXCLUDED,[V]CST_ATRUE) From AXUNIT
INS1.C03P01.$ISEXCLUDED=[V]CST_AFALSE
Call CHECK_EQUAL(INS1.C03P01.$ISEXCLUDED,[V]CST_AFALSE) From AXUNIT

TC="Property isRequested"
Call CHECK_EQUAL(TC,TC) From AXUNIT
[L]ASTATUS = fmet INS1.C03P01.ASETATTR("$isRequested",[V]CST_ATRUE)
Call CHECK_EQUAL([L]ASTATUS,[V]CST_ATRUE) From AXUNIT
Call CHECK_EQUAL(fmet INS1.C03P01.AGETATTR("$isRequested"),[V]CST_ATRUE) From AXUNIT
Call CHECK_EQUAL(INS1.C03P01.$ISREQUESTED,[V]CST_ATRUE) From AXUNIT
INS1.C03P01.$ISREQUESTED=[V]CST_AFALSE
Call CHECK_EQUAL(INS1.C03P01.$ISREQUESTED,[V]CST_AFALSE) From AXUNIT

TC="Property isDelta"
Call CHECK_EQUAL(TC,TC) From AXUNIT
[L]ASTATUS = fmet INS1.C03P01.ASETATTR("$isDelta",[V]CST_ATRUE)
Call CHECK_EQUAL([L]ASTATUS,[V]CST_ATRUE) From AXUNIT
Call CHECK_EQUAL(fmet INS1.C03P01.AGETATTR("$isDelta"),[V]CST_ATRUE) From AXUNIT
Call CHECK_EQUAL(INS1.C03P01.$ISDELTA,[V]CST_ATRUE) From AXUNIT
INS1.C03P01.$ISDELTA=[V]CST_AFALSE
Call CHECK_EQUAL(INS1.C03P01.$ISDELTA,[V]CST_AFALSE) From AXUNIT

TC="Property isEditMode"
Call CHECK_EQUAL(TC,TC) From AXUNIT
[L]ASTATUS = fmet INS1.C03P01.ASETATTR("$isEditMode",[V]CST_ATRUE)
Call CHECK_EQUAL([L]ASTATUS,[V]CST_ATRUE) From AXUNIT
Call CHECK_EQUAL(fmet INS1.C03P01.AGETATTR("$isEditMode"),[V]CST_ATRUE) From AXUNIT
Call CHECK_EQUAL(INS1.C03P01.$ISEDITMODE,[V]CST_ATRUE) From AXUNIT
INS1.C03P01.$ISEDITMODE=[V]CST_AFALSE
Call CHECK_EQUAL(INS1.C03P01.$ISEDITMODE,[V]CST_AFALSE) From AXUNIT
...
INS1.C03P01.$FILENAME=AVOID.ACHAR
Call CHECK_EQUAL(INS1.C03P01.$FILENAME,AVOID.ACHAR) From AXUNIT
...
INS1.C03P01.$CONTENTTYPE=AVOID.ACHAR
Call CHECK_EQUAL(INS1.C03P01.$CONTENTTYPE,AVOID.ACHAR) From AXUNIT
