...
#*!
Funprog TESTSUITE()
Call ADD_TESTCASE("TC_FOR",         "For clause", 60) From AXUNIT
...
Call ADD_TESTCASE("TC_CLOSE",       "Close, Logicclose", 18) From AXUNIT
...
#Call ADD_TESTCASE("TC_FROM",        "For From To clause", 6) From AXUNIT
...
$FOR_LINK_LEFT_OUTER
  ...
  For [F:LNKZ]
    CNT+=1
  Next
  Call CHECK_EQUAL(MESSAGE,CNT,208) 
...
$FOR_LINK_INNER
  ...
  For [F:LNKZ]
    CNT+=1
  Next
  Call CHECK_EQUAL(MESSAGE,CNT,226)
  Filter [LNKZ]
  LogicClose File [BPAZ],[TCYZ],[LNKZ]
Return
...
Call CHECK_EQUAL(MESSAGE-"results (2)",[L]RESULTS(2),60) # why 210?
