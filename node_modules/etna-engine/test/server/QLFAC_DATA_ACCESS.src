...
#*!
Funprog TESTSUITE()
Call ADD_TESTCASE("TC_WHERE",       "Where clause", 31) From AXUNIT
#Call ADD_TESTCASE("TC_FOR",         "For clause", 31) From AXUNIT
#Call ADD_TESTCASE("TC_WITH",        "With clause", 2) From AXUNIT
#Call ADD_TESTCASE("TC_ORDERBY",     "Order By clause, reckey", 7) From AXUNIT
#Call ADD_TESTCASE("TC_ORDERWITH",   "Order With clause", 2) From AXUNIT
#Call ADD_TESTCASE("TC_READ",        "Read clause, Readlock, ", 22) From AXUNIT
#Call ADD_TESTCASE("TC_LOOK",        "Look clause ", 24) From AXUNIT
#Call ADD_TESTCASE("TC_G_ABV",       "KEYNAME, KEYLEN, KEYUNIQ, currind, currlen ...", 39) From AXUNIT
...
Trbegin [AQCREQ3]
  ...
  If AQCREQ3_CNT=1
    For CNT=1 To 5
      [F:AQCREQ3]COD=num$(CNT)+right$(COD,2)
      Write [F:AQCREQ3]
      If fstat
        Break 2
      Endif
