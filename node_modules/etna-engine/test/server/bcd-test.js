...
test('string roundtrip', 92, function() {
	...
	roundtrip('9.9999999999999999999999999999999e-130', '1.0e-129'); // odd scale
});
...
test('add', 16, function() {
	...
	add('1e41', '1e9', '1.0e41');
	add('1e41', '1.000111000222e9', '1.0e41');
...
test('multiply', 14, function() {
	...
	multiply('11111111111111111111111111111111', '9.000000000000000000000000000001', '1.0e32');
	multiply('11111111111111111111111111111111', '90.000000000000000000000000000001', '1.0e33');
	multiply('1e60', '1e64', '1.0e124');
	multiply('1e125', '1e-125', '1');
	multiply('1e125', '1e-130', '0.00001');
	multiply('1e-60', '1e-70', '1.0e-130');
});
...
test('div', 20, function() {
	...
	divide('1.0e124', '1e64', '1.0e60');
	divide('1', '1e-125', '1.0e125');
	divide('0.00001', '1e-130', '1.0e125');
	divide('1.0e-130', '1e-70', '1.0e-60');
});