...
Call ADD_TESTCASE("DATE_TEST", "date formats", 25) From AXUNIT
Call ADD_TESTCASE("NUM_TEST", "numeric formats", 25) From AXUNIT

# Test cases matching formatterTest.js - 29 sections
Call ADD_TESTCASE("BASIC1_TEST", "Basic formatting", 32) From AXUNIT
Call ADD_TESTCASE("BASIC2_TEST", "Date basic", 25) From AXUNIT
Call ADD_TESTCASE("DATE1_TEST", "Date with country format", 8) From AXUNIT
Call ADD_TESTCASE("DATE2_TEST", "Date Z", 25) From AXUNIT
Call ADD_TESTCASE("DATE3_TEST", "Date with text", 25) From AXUNIT
Call ADD_TESTCASE("DATE4_TEST", "Date with missing components", 25) From AXUNIT
Call ADD_TESTCASE("NUM1_TEST", "Number basic", 33) From AXUNIT
Call ADD_TESTCASE("NUM2_TEST", "Number Float", 17) From AXUNIT
Call ADD_TESTCASE("NUM3_TEST", "Double Float", 17) From AXUNIT
Call ADD_TESTCASE("NUM4_TEST", "Number z3 (thousands sep)", 9) From AXUNIT
Call ADD_TESTCASE("NUM5_TEST", "Number - (leading sign)", 6) From AXUNIT
Call ADD_TESTCASE("NUM6_TEST", "Number N alone", 15) From AXUNIT
...
Call ADD_TESTCASE("STRING1_TEST", "String > tests", 10) From AXUNIT
Call ADD_TESTCASE("STRING2_TEST", "String padding tests", 15) From AXUNIT
Call ADD_TESTCASE("STRING3_TEST", "String case conversions", 27) From AXUNIT
Call ADD_TESTCASE("STRING4_TEST", "String L option", 2) From AXUNIT
Call ADD_TESTCASE("STRING5_TEST", "String c directive", 11) From AXUNIT
#
Call ADD_TESTCASE("DYNAMIC_TEST", "Dynamic formats", 10) From AXUNIT
Call ADD_TESTCASE("SERIES1_TEST", "Date series 2", 92) From AXUNIT
Call ADD_TESTCASE("SERIES2_TEST", "Number series 2", 60) From AXUNIT
Call ADD_TESTCASE("SERIES3_TEST", "String series 2", 23) From AXUNIT
Call ADD_TESTCASE("EDIT1_TEST", "Edit Format", 5) From AXUNIT
Call ADD_TESTCASE("EDIT2_TEST", "X3 -> Edit -> Display Format", 6) From AXUNIT
Call ADD_TESTCASE("PARSE_TEST", "Parse user input value", 7) From AXUNIT
Call ADD_TESTCASE("STRICT1_TEST", "Strict mode", 8) From AXUNIT
...
EXPECT = "January   01,13 01: 10"
Call CHECK_EQUAL(RESULT, EXPECT) From AXUNIT

RESULT = format$("DD4",MY_DATETIME)
EXPECT = "January   01,2013 01:10:20"
Call CHECK_EQUAL(RESULT, EXPECT) From AXUNIT
...
&                  "K:#[ ]##[ ]##[ ]#B[ ]###[ ]###[ ]##",  "2500613564564", "2 50 06 13 564 564   ",
&                  "DZ:DD[/]MM[/]YY",  "20080221", "21/02/08",
&                  "DZ:DD[/]MM[/]YY",  "20080221", "21/02/08",
&                  "DZ:DD[/]MM[/]YY",  "21/02/08", "08/02/21",
&                  "D:YYYY[_]MM[_]DD",  "20121128", "2012_11_28",
&                  "DZ:DDMMYYYY",  "20090506", "06052009",
&                  "DZ:DD[/]MM[/]YY",  "20090506", "06/05/09",
&                  "DzZ:DD[/]MM[/]YY",  "20090506", "06/05/09",
&                  "Dz:DD[/]MM[/]YY",  "20090506", "06/05/09",
&                  "Dz:DD[ ]MMMMMMMMMM[ ]YYYY",  "20080102", "02 Janvier    2008"
...
Local Date VALUES_DATE
EX=10
VALUES_DATE = "21/02/"+num$(year(date$))

Local Date VALUES_DATE
EX=10
VALUES_DATE="2012_11_28"
...
Local Date VALUES_DATE
EX=10
VALUES_DATE = "27/12/07"
RESULT_STR=format$("DZ:DD[/]MM[/]YY",VALUES_DATE)
Call CHECK_EQUAL(RESULT_STR, "07/12/27") From AXUNIT
#              "DZ:DD[/]MM[/]YY",  "27/12/07", "07/12/27"
...
# TESTOPTIONS(fmt, raw, value, expected, opts)
# if raw=false the value is in DDMMYY type structure.
# if raw=true then the value YYMMDD style format (it could also be YYYYMMDD or have delimiters.


EX=10
DATE_STR="01102"
VALUES_DATE=DATE_STR

EX=10
VALUES_DATE = "01/02/08"
RESULT_STR=format$('D:DD[/]MM[/]YY',VALUES_DATE)
Call CHECK_EQUAL(RESULT_STR, '08/02/01') From AXUNIT

EX=56
VALUES_DATE = "01011601"
...
VALUES_DATE = "281001"
RESULT_STR=format$('D:DD[/]MM[/]YY',VALUES_DATE)
Call CHECK_EQUAL(RESULT_STR, '01/10/28') From AXUNIT

# YYYYMMDD
VALUES_DATE = "20001201"
RESULT_STR=format$('D:DD[/]MM[/]YY',VALUES_DATE)
Call CHECK_EQUAL(RESULT_STR, '01/12/00') From AXUNIT

EX=10
DATE_STR='10/12/05ddd'
VALUES_DATE=DATE_STR
...
# No unformat options
#Call TESTOPTIONS('DZ:DD[/]MM[/]YY', TRUE, '15991231', '  /  /  ')
#Call TESTOPTIONS('DZ:DD[/]MM[/]YY', FALSE, '', '  /  /  ')
#Call TESTOPTIONS('DZ:DD[/]MM[/]YY', TRUE, '', '  /  /  ')
#Call TESTOPTIONS('DZ:DD[/]MM[/]YY', TRUE, '15991231', '  /  /  ')
...
#**
#* DATE3_TEST - Date with text options
#*!
...
#**
#* DATE4_TEST - Date with missing components
#*!
Subprog DATE4_TEST
Local Integer EX
Local Date VALUES_DATE
...
VALUES_DATE="15991231"
RESULT_STR=format$('DZ:DD[/]MM',VALUES_DATE)
Call CHECK_EQUAL(RESULT_STR, '  /  ') From AXUNIT
...
VALUES_DATE=[30/06/2010]
RESULT_STR=format$('DZ:DD[/]MM[/]YYYY',VALUES_DATE)
Call CHECK_EQUAL(RESULT_STR, '30/06/2010') From AXUNIT

EX=10
VALUES_DATE="05/06/2010"

End

#**
#* NUM1_TEST - number basic
#*!
Subprog NUM1_TEST
...
&        'N:11.2','150', '        150,00',
&        "N-3z:14.0#","14322", "        +14.322,",
&        "N-3zv1:14.0#","14322", "+14.322,",
&        "N3z:14.0#","14322", "         14.322,",
&        "N3zv1:14.0#","14322", "14.322,",
&        'N+z:3.2#','', '      ',
&        'N+:3.2#','', '  0,00',
&        'N+z:3.2#','.', '      ',
&        'N+:3.2#','.', '  0,00'
...
I=3
For FORMRES= 'N+z3:11F', '0.7', '        0,7',
&            'Nv+z3:11F', '0.7', '0,7',
&            'N+z3:11F', '0.256', '      0,256',
&            'Nv+z3:11F', '0.256', '0,256',
&            'N+z:5F', '12.345', '12,34',
&            'N+z:5F', '.12345', '0,123',
&            'N+z:5F', '0.12345', '0,123',
&            'N+z:5F', '000.12345', '0,123',
&            'N+z:5F', '', '     ',
&            'N+:5F', '', '    0',
&            'N+:5F', '.', '    0',
&            'N+:5F', '00000.0000', '    0',
&            'N+z3:15F', '123456789.012345768', '      123457000',
&            'N+z3:15F', '+123456789.012345768', '      123457000',
&            'N-z3:15F', '123456789.012345768', '     +123457000',
&            'N-z3:15F', '1234.12345', '       +1.234,12',
&            'N-z3:15F', '12345.12345', '       +12.345,1'
...
Next
For J=1 To (I-3)/3
    VALUES_FLOAT = val(VALUES(J))
    RESULT_STR=format$(FORMATS(J),VALUES_FLOAT)
    Call CHECK_EQUAL(RESULT_STR, RESULTS(J)) From AXUNIT
Next
...
&            'N+:5F', '.', '    0',
&            'N+:5F', '00000.0000', '    0',
&            'N+z3:15F', '123456789.012345768', '      123456789',
&            'N+z3:15F', '+123456789.012345768', '      123456789',
&            'N-z3:15F', '123456789.012345768', '     +123456789',
&            'N-z3:15F', '1234.12345', '    +1.234,12345',
&            'N-z3:15F', '12345.12345', '   +12.345,12345'
...
Next
For J=1 To (I-3)/3
    VALUES_DOUBLE = val(VALUES(J))
    RESULT_STR=format$(FORMATS(J),VALUES_DOUBLE)
    Call CHECK_EQUAL(RESULT_STR, RESULTS(J)) From AXUNIT
Next
...
Call TESTOPTIONS('N+z3:11.2#', FALSE, '1234567911.88', ' 1 234 567 911,88', 0)
Call TESTOPTIONS('N-z3:9.6#', FALSE, '123456789.012345768', '123 456 789,012345', 0)
[S]adxsca=SAV_ADXSCA
End
...
Local Char SAV_ADXSCA(30) : SAV_ADXSCA=[S]adxsca
[S]adxsca = ".. ,**$_"
#Call  TESTUNFORMAT('fr', "N-3zv*:14.2", '+*** *14 322,3', '14322.3', 0)
#Call  TESTUNFORMAT('fr', "N-3zv0:14.2", '+000 014 322,3', '14322.3', 0)
Call TESTOPTIONS('N+D*:####2.##3#', FALSE, '+150.23', '***150,23000', 0)
Call TESTOPTIONS('N+D0:####2.##3#', FALSE, '+150.23', '000150,23000', 0)
Call TESTOPTIONS('N+D*:####2.##3#', TRUE, '+150.23', '***150,23000', 0)
Call TESTOPTIONS('N+D0:####2.##3#', TRUE, '+150.23', '000150,23000', 0)
Call TESTOPTIONS('N-D*3:####2.##3#', TRUE, '+150.23', '***150,23000+', 0)
Call TESTOPTIONS('N-D03:####2.##3#', TRUE, '+150.23', '000150,23000+', 0)
...
#**
#* "STRING1_TEST", "String > tests"
#*!

Subprog STRING1_TEST
Local Integer FALSE : FALSE = 0
Local Integer TRUE : TRUE = 1

Call TESTOPTIONS('KT:35X>25X', FALSE, '((1-(C6/(C5+(C5=0))))*100)/(C7+(C7=0))', '((1-(C6/(C5+(C5=0))))*100)/(C7+(C7=0))                      ', 0)
Call TESTOPTIONS('KT:35X>25X', TRUE, '((1-(C6/(C5+(C5=0))))*100)/(C7+(C7=0))', '((1-(C6/(C5+(C5=0))))*100)/(C7+(C7=0))                      ', 0)
Call TESTOPTIONS('KTv1:35X>25X', FALSE, '((1-(C6/(C5+(C5=0))))*100)/(C7+(C7=0))', '((1-(C6/(C5+(C5=0))))*100)/(C7+(C7=0))', 0)
Call TESTOPTIONS('KTv1:35X>25X', TRUE, '((1-(C6/(C5+(C5=0))))*100)/(C7+(C7=0))', '((1-(C6/(C5+(C5=0))))*100)/(C7+(C7=0))', 0)
Call TESTOPTIONS('K:10X>30X', FALSE, 'abcdefghijklmnopqrst12345~~', 'abcdefghijklmnopqrst12345~~             ', 0)
Call TESTOPTIONS('K:10X>30X', TRUE, 'abcdefghijklmnopqrst12345~~', 'abcdefghijklmnopqrst12345~~             ', 0)
Call TESTOPTIONS('K:>10X', FALSE, 'abcdefghijklmnopqrst12345~~', 'abcdefghij', 0)
Call TESTOPTIONS('K:>10X', TRUE, 'abcdefghijklmnopqrst12345~~', 'abcdefghij', 0)
Call TESTOPTIONS('K:[Debut]10X[Milieu]>20X[Fin]', FALSE, 'abcdefghijklmnopqrst12345~~', 'DebutabcdefghijMilieuklmnopqrst12345~~   Fin', 0)
Call TESTOPTIONS('K:[Debut]10X[Milieu]>20X[Fin]', TRUE, 'abcdefghijklmnopqrst12345~~', 'DebutabcdefghijMilieuklmnopqrst12345~~   Fin', 0)
...
#    }
#  };
Call TESTOPTIONS('KTD:A11B', TRUE, 'BONJOUR', 'BONJOUR     ', 0)
Call TESTOPTIONS('KTD:A11u', TRUE, 'BONJOUR', 'BONJOUR     ', 0)
...
#**
#* "STRING5_TEST", "String adxtut c directive"
#*!
Subprog STRING5_TEST
Local Integer FALSE : FALSE = 0
Local Integer TRUE : TRUE = 1

Call TESTOPTIONS('K:3c', TRUE,"ddd", "DDD", 0)
Call TESTOPTIONS('K:3c', FALSE, 'ddd', 'DDD', 0)
Call TESTOPTIONS('K:3c', FALSE, 'abc', 'ABC', 0)
Call TESTOPTIONS('K:4c', FALSE, '2-bc', '2-BC', 0)
Call TESTOPTIONS('K:3c', FALSE, 'A-bC2', 'A-B', 0)
Call TESTOPTIONS('K:3c', FALSE, 'A-BC2', 'A-B', 0)
Call TESTOPTIONS('K:3c', FALSE, '2/_', '2/_', 0)
Call TESTOPTIONS('K:3c', FALSE, '222', '222', 0)
Call TESTOPTIONS('K:3c', FALSE, '222', '222', 0)
Call TESTOPTIONS('K:3c', FALSE, '2Z2', '2Z2', 0)
Call TESTOPTIONS('K:3c', FALSE, '2-2', '2-2', 0)

End

#**
#* "DYNAMIC_TEST", "Dynamic formats"
#*!
Subprog DYNAMIC_TEST
Local Integer FALSE : FALSE = 0
Local Integer TRUE : TRUE = 1

Call TESTOPTIONS('K:3c', FALSE, 'ae_', 'AE_', 0)
Call TESTOPTIONS('K:4B>2B', FALSE, 'abcDef', 'ABCDEF', 0)
Call TESTOPTIONS('K:4p>2p', FALSE, 'abc--Defdh', '      ', 0)
  # TEST CHAINES DYNFORMATS With INFINITE RECURSION
Call TESTOPTIONS('K:4u>2u', FALSE, 'abc--Defdh', '      ', 0)
Call TESTOPTIONS('K:4q>2q', FALSE, 'abc--Defdh', '      ', 0)
Call TESTOPTIONS('K:4p2q', FALSE, 'ab-cDef', '      ', 0)
Call TESTOPTIONS('K:4c', FALSE, 'A', 'A   ', 0)
Call TESTOPTIONS('K:4c', FALSE, '2', '2   ', 0)
Call TESTOPTIONS('K:4c', FALSE, '2A2', '2A2 ', 0)
Call TESTOPTIONS('K:6c', FALSE, '2/A_2-', '2/A_2-', 0)
...
Call TESTOPTIONS('D:DD[/]MM[/]YY', FALSE, '2/3/6', '  /  /  ', 10)
...
Call TESTOPTIONS('D:[debut]DD[.]MM[.]YY[fin]', FALSE, '16/03/63', "debut  .  .  fin", 56)
#10
Call TESTOPTIONS('D:[debut]DD[.]MM[.]YYYY[fin]', FALSE, '16/03/63', "debut  .  .  fin", 56)
Call TESTOPTIONS('D:DD[/]MMMMMMMMMM[/]YY', TRUE, '19620517', '17/Mai       /62', 0)
Call TESTOPTIONS('D:DD[/]MMMMMMMMMM[/]YY', FALSE, '17051962', '17/Mai       /62', 56)
Call TESTOPTIONS('D:DD[/]MMMMMMMMMM[/]YYYY', FALSE, '170562', '  /          /  ', 56)
Call TESTOPTIONS('D:[start]DD[.]MM[.]YY[fin]', FALSE, '14120', 'debut  .  .    fin', 10)
Call TESTOPTIONS('D:[debut]DD[.]MMMM[.]YYYY[fin]', FALSE, '16032006', '', 56)
Call TESTOPTIONS('D:[debut]DD[.]MMMMMMMMM[.]YYYY[fin]', TRUE, '20060509', 'debut09.Mai      .2006fin', 56)
Call TESTOPTIONS('D:DD[/]MMMMMMMMMM[/]YY', TRUE, '19620517', '17/Mai       /62', 0)
Call TESTOPTIONS('D:DD[/]MMMMMMMMMM[/]YY', FALSE, '17051962', '', 56)
Call TESTOPTIONS('D:DD[/]MMMMMMMMMM[/]YYYY', FALSE, '170562', '', 56)
#20
   #OPTION Z and z
Call TESTOPTIONS('DZz:DD[/]MM[/]YY', FALSE, '', '        ', 10)
Call TESTOPTIONS('DZz:DD[/]MM[/]YY', TRUE, '', '        ', 10)
Call TESTOPTIONS('DZz:DD[/]MMM[/]YY', FALSE, '', '         ', 10)
Call TESTOPTIONS('DZz:DD[/]MMM[/]YY', TRUE, '', '         ', 10)
...
Call TESTOPTIONS('DZz:DD[/]MMM[/]YY', TRUE, '15991231', '         ', 0)
#30
...
Call TESTOPTIONS('DZ:MMM[-]YYYY', FALSE, '052006', 'MAY-2020', 56)
#40
Call TESTOPTIONS('DZ:MMM[-]YYYY', TRUE, '052006', 'MAY-2020', 56)
...
Call TESTOPTIONS('DZz:MM[-]DD', TRUE, '', '', 10)
Call TESTOPTIONS('DZz:YY[-]MM[-]DD', TRUE, '15991231', '        ', 0)
Call TESTOPTIONS('DZ:MM[-]DD[-]YYYY', FALSE, '2006/05/17', '  -  -    ', 10)
#50
...
Call TESTOPTIONS('DZ:DD[_]MM', FALSE, '06/13/11', '11_03', 0)
Call TESTOPTIONS('DZ:DD[_]MM', TRUE, '06/13/11', '11_03', 0)
Call TESTOPTIONS('DZ:DD[_]MM[_]YYYY', FALSE, '06/13/11', '11_03_2006', 0)
Call TESTOPTIONS('DZ:DD[_]MM[_]YYYY', TRUE, '06/13/11', '11_03_2006', 0)
Call TESTOPTIONS('DZz:DD[_]MM', FALSE, '', '', 10)
#70
Call TESTOPTIONS('DZz:DD[_]MM', TRUE, '', '', 10)
Call TESTOPTIONS('DZz:MM[_]YY', FALSE, '', '', 10)
Call TESTOPTIONS('DZz:MM[_]YY', TRUE, '', '', 10)
...
Call TESTOPTIONS('DZ:YY[-]MM', FALSE, '052006', '06-05', 56)
#80
Call TESTOPTIONS('DZ:MMM[-]YYYY', FALSE, '052006', 'MAY-2006', 56)
Call TESTOPTIONS('DZ:YY[-]MM', FALSE, '0506', '06-05', 10)
Call TESTOPTIONS('DZ:DD[-]MM[-]YYYY', FALSE, '050649', '06-05-2049', 56)
Call TESTOPTIONS('DZ:DD[-]MM[-]YYYY', FALSE, '050650', '06-05-2050', 56)
Call TESTOPTIONS('DZ:DD[-]MM[-]YYYY', FALSE, '050651', '06-05-1951', 56)
Call TESTOPTIONS('DZ:DD[-]MM[-]YYYY', FALSE, '490506', '06-05-2049', 0):[S]adxdcs=1950
Call TESTOPTIONS('DZ:DD[-]MM[-]YYYY', FALSE, '500506', '06-05-1950', 0)
Call TESTOPTIONS('DZ:DD[-]MM[-]YYYY', FALSE, '510506', '06-05-1951', 0)
Call TESTOPTIONS('DZ:DD[-]MM[-]YYYY', FALSE, '51056', '06-05-1951', 10)
Call TESTOPTIONS('DZ:DD[-]MM[-]YYYY', FALSE, '060549', '06-05-2049', 56)
#90
Call TESTOPTIONS('DZ:DD[-]MM[-]YYYY', FALSE, '060550', '06-05-2050', 56)
Call TESTOPTIONS('DZ:DD[-]MM[-]YYYY', FALSE, '060551', '06-05-1951', 56)
End
...
Call TESTOPTIONS('N:[Debut]3[abc].2#[Fin]', FALSE, '150', 'Debut150abc000Fin', 0)
Call TESTOPTIONS('N:[Debut]3[abc].2#[Fin]', TRUE, '150', 'Debut150abc000Fin', 0)
...
#20
[S]adxsca=".. ,**$_"
Call TESTOPTIONS('N3z:14#', TRUE, '         14.322', '            14', 0)
Call TESTOPTIONS('N+3zv*:14.0#', FALSE, '14322', '*********14 322,', 0)
Call TESTOPTIONS('N-3z:14.0#', FALSE, '14322', '        +14 322,', 0)
Call TESTOPTIONS('N-3zv1:14.0#', FALSE, '14322', '+14 322,', 0)
Call TESTOPTIONS('N3z:14.0#', FALSE, '14322', '         14 322,', 0)
Call TESTOPTIONS('N3zv1:14.0#', FALSE, '14322', '14 322,', 0)
Call TESTOPTIONS('N+z3:11.2#', FALSE, '345678911.88', '  345 678 911,88', 0)
Call TESTOPTIONS('N-D0:[debut]####8.[Fin]##5#[Fin]', FALSE, '+21150.213', 'debut000000021150,Fin2130000Fin+', 0)
Call TESTOPTIONS('N-D0:3.0#', FALSE, '+150', '150,+', 0)
Call TESTOPTIONS('N-D0:0.6#', FALSE, '+,123', ',******+', 0)
#30
Call TESTOPTIONS('N-0:0.6#', FALSE, '+,123', ',******', 0)
Call TESTOPTIONS('N-:4.1#', TRUE, '+150.3', '+150,3', 0)
Call TESTOPTIONS('N-:4.0#', FALSE, '+150', '+150,', 0)
Call TESTOPTIONS('N-D0:[debut]####2.[Fin]##3#[Fin]', FALSE, '+150.23', 'debut000150,Fin23000Fin+', 0)
...
Call TESTOPTIONS('Nz:7.6#', FALSE, '  - 3.2', '              ', 0)
...
Call TESTOPTIONS('K:5X>5X', FALSE, 'abcdefgh~~ijklmnopq', 'abcdefgh~~', 0)
Call TESTOPTIONS('K:3A', FALSE, 'AB ', 'AB ', 0)
Call TESTOPTIONS('K:3A', FALSE, 'AB2', '   ', 0)
Call TESTOPTIONS('K:3c', FALSE, 'AB ', 'AB ', 0)
Call TESTOPTIONS('K:3c', FALSE, 'AA ', 'AA ', 0)
Call TESTOPTIONS('K:3c', FALSE, 'AB2', 'AB2', 0)
Call TESTOPTIONS('K:3A', FALSE, 'AB ', 'AB ', 0)
Call TESTOPTIONS('K:3A', FALSE, 'AB2', '   ', 0)
Call TESTOPTIONS('K:3c', FALSE, 'AB ', 'AB ', 0)
Call TESTOPTIONS('K:3c', FALSE, 'AA ', 'AA ', 0)
...
Local Integer EX
  ...
  #Call TESTBADEDITTODISPLAY('FR', "D:DD[/]MM[/]YYYY", "02213", "Bad month 21",  )
  Call TESTEDITTODISPLAY('FR', "D:DD[/]MM[/]YYYY", "02213", "21/02/2003", 10)
#  TESTBADEDITTODISPLAY('FR', "D:DD[/]MM[/]YYYY", "02213", "Bad month 21", 0)
#  TESTBADEDITTODISPLAY('FR', "D:DD[/]MM[/]YYYY", "20213", "Bad month 21", 0)
#  TESTBADEDITTODISPLAY('FR', "D:DD[/]MM[/]YYYY", "20213", "Bad month 20", 0)
#  TESTBADEDITTODISPLAY('FR', "D:DD[/]MM[/]YYYY", "20213", "Bad month 21", 0)
#  TESTBADEDITTODISPLAY('FR', 'D:DD[/]MM[/]YYYY', '1012', "Test year expected", 0)
#  TESTBADEDITTODISPLAY('FR', 'D:DD[/]MM[/]YYYY', '10', "Test month expected", 0)
#  TESTBADEDITTODISPLAY('FR', "D:DD[/]MM[/]YY", "412/08/12", "Bad day number", 0)
#  TESTBADEDITTODISPLAY('FR', "D:DD[/]MM[/]YY", "12/858/12", "Bad month number", 0)
#  TESTBADEDITTODISPLAY('FR', "D:DD[/]MM[/]YY", "31/02/12", "Bad date", 0)
#  // FULL Date INPUT With SEPARATORS
  Call TESTEDITTODISPLAY('FR', "D:DD[/]MM[/]YY", "28/11/12", "12/01/28", 0)
  Call TESTEDITTODISPLAY('EN', "D:MM[/]DD[/]YY", "11/28/12", "08/12/11", 0)
...
#  TESTBADEDITTODISPLAY('EN', "D:MM[/]DD[/]YYYY", "13/02/2012", "Date is not valid", 0)
#
#  TESTBADEDITTODISPLAY('FR', "D:DD[/]MM[/]YY", "021112fqsfqsf", "Bad input data", 0)
#  TESTBADEDITTODISPLAY('FR', "Dz:DD[/]MM[/]YY", "30/06/12dd", "Bad input data", 0)
...
#  // Date DISPLAYED IN ENGLISH/FRENCH BUT INPUT With FRENCH/ENGLISH DATEORDER
  Call TESTEDITTODISPLAY('FR', "D:MM[/]DD[/]YYYY", "31/12/05", "02/05/2031", 0)
  Call TESTEDITTODISPLAY('EN', "D:DD[/]MM[/]YYYY", "12/31/05", "05/01/2012", 0)
...
#  //# 1218
#  // YY ACEPTS 2005
  Call TESTEDITTODISPLAY('FR', "D:DD[/]MM[/]YY", "1/2/2005", "01/02/05", 56)
#  // YYYY ACEPTS 5
  Call TESTEDITTODISPLAY('FR', "D:DD[/]MM[/]YYYY", "1/2/5", "01/02/2005", 10)
#  // YYYY and YY don'T ACEPT 3 DIGIT and MORE THAN 4 DIGITS year
#  TESTBADEDITTODISPLAY('fr', "D:DD[/]MM[/]YY", "21/06/214", "Bad date number")
#  TESTBADEDITTODISPLAY('fr', "D:DD[/]MM[/]YY", "21/06/10254", "Bad date number")
#  TESTBADEDITTODISPLAY('fr', "D:DD[/]MM[/]YYY", "21/06/214", "Bad date number")
#  TESTBADEDITTODISPLAY('fr', "D:DD[/]MM[/]YYY", "21/06/10254", "Bad date number")
...
#**
#* "STRICT1_TEST", "Strict mode"
#*!

Subprog STRICT1_TEST
Local Integer FALSE : FALSE = 0
Local Integer TRUE : TRUE = 1
Local Integer EX
...
#  // #553 - skipBadFormat set to true by default
#  // If A BAD FORMATS (BAD SYNTAX) OCCURS
#  // --> FORMAT/UNFORMAT RETURNS THE Value PASSED As PARAMETER - SEE COMMENT IN FORMAT.JS
#  // --> !! NO DATA CONTROL ON CLIENT SIDE
#  TESTFORMATERR('fr', "X+-03z:8.2#", '+12', 'Unexpected format character', TRUE, {
#    SKIPBADFORMAT: FALSE
#  })
Call  TESTOPTIONS("X+-03z:8.2#", TRUE, '12', '12', 0)
Call  TESTOPTIONS("X+-03z:8.2#", FALSE, "+12", "+12", 0)
#  // #553 for dates
#  TESTFORMATERR('fr', "D:JJ[/]MM[/]AAAA", '+12', 'Unexpected format character', TRUE, {
#    SKIPBADFORMAT: FALSE
#  })
#  // SKIPBADFORMAT==TRUE By Default - RETRUNS ORGINAL Value - NO CONTROL
Call  TESTOPTIONS("D:JJ[/]MM[/]BBBB", TRUE, '20121110', '  /  /    ', TRUE)
#  TESTUNFORMAT('fr', "D:JJ[/]MM[/]CCCCC", '10/11/12', "10/11/12", 0)
#Call  TESTFORMAT('fr', "D:JJ[/]MM[/]CCCCC", '10/11/12', "10/11/12", 0)
End
...
Append GXUNIT_RESULT, format$("K:50X","Test: "+FORMATS-VALUES)+chr$(10)
...
Case left$(FORMATS,1)
  ...
  When "D"
    VALUES_DATE = VALUES
    Append GXUNIT_RESULT, "  ["+num$(VALUES_DATE)+"]  "+VALUES+"  "
...
Call SET_LOCALE(LANG)
Call TESTOPTIONS(FORMATS,TRUE,VALUES,RESULTS,ERR)

End

Subprog SET_LOCALE(LANG)
Value Char LANG

Case tolower(LANG)
  When "en"  : Call SET_LOCALE("en-US") From ASYRQLF
  When "fr"  : Call SET_LOCALE("en-US") From ASYRQLF
Endcase
End
