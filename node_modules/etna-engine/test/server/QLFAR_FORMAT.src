...
GTRACE = "QLFAR_FORMAT_"+GACTX.USER
...
Call ADD_TESTCASE("ADXSCA_TEST", "adxsca", 4) From AXUNIT
...
Local Char FR_ADXSCA(10)
Local Char US_ADXSCA(10)
...
FR_ADXSCA="??"   : # obsolete
FR_ADXSCA+=" "   : # thousands separator
FR_ADXSCA+=","   : # decimal separator
FR_ADXSCA+="#"   : # numeric overflow character
FR_ADXSCA+="*"   : # padding character
FR_ADXSCA+="???" : # obsolete

US_ADXSCA="??"   : # obsolete
US_ADXSCA+=","   : # thousands separator
US_ADXSCA+="."   : # decimal separator
US_ADXSCA+="#"   : # numeric overflow character
US_ADXSCA+="*"   : # padding character
US_ADXSCA+="???" : # obsolete

[S]adxsca = FR_ADXSCA
Call CHECK_EQUAL([S]adxsca,FR_ADXSCA) From AXUNIT

RESULT = format$("Nv0:11.2",NUM)
Call CHECK_EQUAL(RESULT,"1234567,89") From AXUNIT

[S]adxsca = US_ADXSCA
Call CHECK_EQUAL([S]adxsca,US_ADXSCA) From AXUNIT
...
Callmet GACTX.ACTX_SET_LANISO("en-US")                       # Change language
...
Callmet GACTX.ACTX_SET_LANISO("fr-FR")                     # Force to French
  [S]adxsca="??"   : # Obsolète
  [S]adxsca+="."   : # séparateur groupes de 3 chiffres - digit separator
  [S]adxsca+=","   : # séparateur décimal - radix point
  [S]adxsca+="#"   : # caractère dépassement - numeric overflow character
...
Callmet GACTX.ACTX_SET_LANISO("en-US")                     # Force to English-US
...
Call TESTOPTIONS('D:[debut]DD[.]MM[.]YY[fin]', FALSE, '16/03/2014', "debut  .  .  fin", 50)
Call TESTOPTIONS('D:[debut]DD[.]MM[.]YY[fin]', FALSE, '16/03/63', "debut  .  .  fin", 50)
Call TESTOPTIONS('D:[debut]DD[.]MM[.]YYYY[fin]', FALSE, '16/03/63', "debut  .  .  fin", 50)
...
Call TESTOPTIONS('DZz:DD[/]MM', TRUE, '15991231', '     ', 0) : Callmet GACTX.ACTX_SET_LANISO("fr-FR")
Call TESTOPTIONS('DZ:MM[-]DD[-]YYYY', FALSE, '17/05/2006', '  -  -    ', 50)
Call TESTOPTIONS('DZ:MMM[-]YYYY[-]DD', FALSE, '17/05/2006', '   -    -  ', 50)
Call TESTOPTIONS('DZ:MMM', FALSE, '17/05/2006', '   ', 50)
Call TESTOPTIONS('DZ:MMM', FALSE, '05', '   ', 50)
Call TESTOPTIONS('DZ:MMM', FALSE, '5', '   ', 50)
Call TESTOPTIONS('DZ:YYYY', FALSE, '2006', '    ', 50)
Call TESTOPTIONS('DZ:YYYY', FALSE, '6', '    ', 50)
Call TESTOPTIONS('DZ:YY[-]MM', FALSE, '052006', '  -  ', 56)
#40
Call CHECK_EQUAL("->40","->40") From AXUNIT
Call TESTOPTIONS('DZ:YY[-]MM', FALSE, '0506', '05-06', 50)
...
Call TESTOPTIONS('DZ:MMM[-]YYYY[-]DD', FALSE, '2006/05/17', '   -    -  ', 50)
Call TESTOPTIONS('DZ:MMM', FALSE, '2006/05/17', '   ', 50)
Call TESTOPTIONS('DZ:MMM', FALSE, '05', '   ', 50)
Call TESTOPTIONS('DZ:MMM', FALSE, '5', '   ', 50)
Call TESTOPTIONS('DZ:YYYY', FALSE, '2006', '    ', 50)
Call TESTOPTIONS('DZ:YYYY', FALSE, '6', '    ', 50)
...
Call TESTOPTIONS('DZ:MMM[-]YYYY', FALSE, '0605', '', 50)
Call TESTOPTIONS('DZz:DD[_]MM[_]YY', FALSE, '', '        ', 50)
#60
Call CHECK_EQUAL("->60","->60") From AXUNIT
Call TESTOPTIONS('DZz:DD[_]MM[_]YY', TRUE, '', '        ', 50)
Call TESTOPTIONS('DZ:DD[_]MM', FALSE, '1705', '', 50)
Call TESTOPTIONS('DZ:DD[_]MM', TRUE, '1705', '', 50)
Call TESTOPTIONS('DZ:DD[_]MM', FALSE, '0517', '', 50)
Call TESTOPTIONS('DZ:DD[_]MM', TRUE, '0517', '  _  ', 50)
Call TESTOPTIONS('DZ:DD[_]MM', FALSE, '06/13/11', '11_03', 50)
Call TESTOPTIONS('DZ:DD[_]MM', TRUE, '06/13/11', '11_03', 50)
Call TESTOPTIONS('DZ:DD[_]MM[_]YYYY', FALSE, '06/13/11', '11_03_2006', 50)
Call TESTOPTIONS('DZ:DD[_]MM[_]YYYY', TRUE, '06/13/11', '11_03_2006', 50)
#70
Call CHECK_EQUAL("->70","->70") From AXUNIT
Call TESTOPTIONS('DZz:MM[_]DD[_]YY', TRUE, '15991231', '        ', 0)
Call TESTOPTIONS('DZ:MMM[-]YYYY[-]DD', FALSE, '05/17/2006', 'MAY-2006-17', 50)
Call TESTOPTIONS('DZ:MMM', FALSE, '05', 'MAY', 50)
Call TESTOPTIONS('DZ:MMM', FALSE, '5', 'MAY', 50)
Call TESTOPTIONS('DZ:YYYY', FALSE, '2006', '2006', 50)
Call TESTOPTIONS('DZ:YYYY', FALSE, '6', '2006', 50)
...
Call TESTOPTIONS('DZ:YY[-]MM', FALSE, '0506', '06-05', 50)
...
Callmet GACTX.ACTX_SET_LANISO(LANG)
