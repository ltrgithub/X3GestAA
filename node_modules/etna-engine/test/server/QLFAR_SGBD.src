...
Funprog TESTSUITE()
	...
	Call ADD_TESTCASE("TEST_NESTED_LOOP", "Test nested loop", 9) From AXUNIT
	...
	Call ADD_TESTCASE("TEST_G", "Test class G", 4) From AXUNIT
...
Subprog TEST_NESTED_LOOP( )

Local File ACCES[ACC]
Local Integer L1,L2,L3

Filter [ACC] Where [ACC]USR <> "" And [ACC]USR < "AD"
...
For [ACC]CODACC(1)
	...
	Next
Next
Call CHECK_EQUAL( L1, 19 ) From AXUNIT
Call CHECK_EQUAL( L2, 711 ) From AXUNIT

Filter [ACC] Where [ACC]USR <> "" And [ACC]USR < "AD" and [ACC]CODACC <> ""
...
For [ACC]PRFCOD(1)
   ...
   Next 
Next
Call CHECK_EQUAL( L1, 1 ) From AXUNIT
Call CHECK_EQUAL( L2, 86 ) From AXUNIT
Call CHECK_EQUAL( L3, 692 ) From AXUNIT
...
Local File AQCDBTYPES [ABV]
Local Char NAM(30)
Local Integer NBZ, KYU
[F:ABV]C5 = 10

NAM = [G:ABV]adxfname
Call CHECK_EQUAL( NAM, "AQCDBTYPES" ) From AXUNIT
NBZ = [G:ABV]nbzon
Call CHECK_EQUAL( NBZ, 12 ) From AXUNIT
NAM = [G:ABV]keyname(0)
