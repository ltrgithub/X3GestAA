...
Funprog TESTSUITE()
	...
	Call ADD_TESTCASE("TEST_REWRITE", "Test Rewrite", 5) From AXUNIT
...
For [ACC]CODACC(1)
	...
	Next
Next
Call CHECK_EQUAL( L1, 16 ) From AXUNIT
Call CHECK_EQUAL( L2, 450 ) From AXUNIT
...
Call CHECK_EQUAL( L3, 434 ) From AXUNIT
...
Rewrite [ABV]CODE=202

Read [ABV]CODE=202
Call CHECK_EQUAL( [ABV]C5, 20000 ) From AXUNIT

dbgetna
Rewrite [ABV]CODE=205
Call CHECK_EQUAL( fstat, 5 ) From AXUNIT
