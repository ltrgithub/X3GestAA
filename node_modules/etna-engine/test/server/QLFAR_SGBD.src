...
Funprog TESTSUITE()
	...
	Call ADD_TESTCASE("TEST_FOR_FUNC", "Test For with functions", 34) From AXUNIT
	...
	#Call ADD_TESTCASE("TEST_FOR_EVALUE", "Test For with evalue", 2) From AXUNIT
