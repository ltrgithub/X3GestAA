...
Funprog TESTSUITE()
    ...
    Call ADD_TESTCASE("TEST_ERROR0", "Test instance/Collection", 39) From AXUNIT
...
INSTANCE1 = NewInstance C_AQCCOL01
...
Callmet INSTANCE1.ASETERROR("FIELD1", "Celine DION sings AC/DC", [V]CST_AERROR)
Callmet INSTANCE1.ASETERRORCAT("", "Elvis Alive", [V]CST_AFATAL, 6)
Callmet INSTANCE2_1.ASETERROR("KEY1", "The Cure remix", [V]CST_AERROR)
