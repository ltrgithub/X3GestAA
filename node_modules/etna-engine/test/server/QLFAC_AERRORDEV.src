...
Funprog TESTSUITE()
    ...
    Call ADD_TESTCASE("TEST_ERROR0", "Test instance/Collection", 70) From AXUNIT
...
dbgetna
ST = fmet INSTANCE3.ASEARCHINFOS( [V]CST_ALL, "", [V]CST_AOK, 2)
Call CHECK_EQUAL(ST, [V]CST_AOK) From AXUNIT

ST = fmet INSTANCE3.AGETNEXTINFOS( RSTATUS, RPROP, RPROP_LAB, RERR_MESS, RERR_MESS,RENVIRONMENT)
Call CHECK_EQUAL(ST, [V]CST_AOK) From AXUNIT
