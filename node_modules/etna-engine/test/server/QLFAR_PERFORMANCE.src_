...
GTRACE = "QLFAR_PERFORMANCE_"+GUSER
...
Call TESTSUITE_START("PERFORMANCE", "Performance Tests") From AXUNIT
#Call ADD_TESTCASE("TC_PERF_DATETIME", "Timestamp", 10) From AXUNIT
#Call ADD_TESTCASE("TC_PERF_STRINGS", "String performance", 7) From AXUNIT
#Call ADD_TESTCASE("TC_PERF_DATES", "Date performance", 5) From AXUNIT
Call ADD_TESTCASE("TC_PERF_NUMS", "Numeric performance", 6) From AXUNIT
#Call ADD_TESTCASE("TC_PERF_CLOBS", "Clob performance", 25) From AXUNIT
Local Clbfile  SUITE_RESULT
SUITE_RESULT = func AXUNIT.RUN_TESTSUITE("PERFORMANCE", "Performance")
End SUITE_RESULT


Subprog TC_PERF_DATETIME
Local Char TT(255)
Local Integer I,J
Local Char TITLES(25),TITLES_DES(75)
Local Char TIM(30)
Local Decimal TIMING_MS
TITLES = "TEST_DATETIME"
TITLES_DES = "Datetime"
TIM=num$(datetime$)
I=instr(1,TIM,".")
J=instr(1,TIM,"Z")
