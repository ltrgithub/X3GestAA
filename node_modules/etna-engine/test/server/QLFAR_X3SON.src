...
Subprog PARS_PROPS(STR, POS, INST)
	...
	While (POS < len(STR) and mid$(STR, POS, 1) <> '}')
		...
		Infbox "ASSIGN"-PROPNAME-PROPVAL
...
Funprog PARS_ONE(STR, POS)
	...
	While 1
		...
		When 'D'
			...
			RESULT(IDX) = gdat$(val(mid$(STR, POS + 6, 2)), val(mid$(STR, POS + 4, 2)), val(mid$(STR, POS, 4)))
			POS += 8
		When 'T'
		...
		When 'O'
			...
			If IDX = 1
				...
				RESULT = R_INST
			Endif
			Infbox "NEWINSTANCE CLNAME"-CLNAME
