...
GTRACE = "QLFAR_TSTRING_"+GACTX.USER
...
Call CHECK_EQUAL(A,"ABCD")
Call CHECK_EQUAL(len(A),4)
...
Local Char C(10)
C="ABCDEFGHIJ"
Call CHECK_EQUAL(C,"ABCDEFGHIJ")
Call CHECK_EQUAL(len(C),10)
...
Local Char D(10)
[L]D="ABCDEFGHIJ"
Call CHECK_EQUAL([L]D,"ABCDEFGHIJ")
Call CHECK_EQUAL(len([L]D),10)
[L]D="ABCDEFGHIJKLMNOPQRSTUVWXYZ"
Call CHECK_EQUAL([L]D,"ABCDEFGHIJ")
Call CHECK_EQUAL(len([L]D),10)

Global Char D(20)
[V]D="ABCDEFGHIJ"
Call CHECK_EQUAL([V]D,"ABCDEFGHIJ")
Call CHECK_EQUAL(len([V]D),10)
[L]D="ABCDEFGHIJ"
Call CHECK_EQUAL([V]D,[L]D)
[V]D="ABCDEFGHIJKLMNOPQRSTUVWXYZ"
Call CHECK_EQUAL([V]D,"ABCDEFGHIJKLMNOPQRST")
Call CHECK_EQUAL(len([V]D),20)
Call CHECK_FALSE(len([V]D)=len([L]D)) From AXUNIT
Call CHECK_EQUAL(D,"ABCDEFGHIJ")
Call CHECK_EQUAL(len(D),10)
Global Char D(10)
Local Char D(10)
Call CHECK_EQUAL(len([L]D),len([V]D))
Call CHECK_EQUAL(type([L]D),type([V]D))
...
Local Date D
Call CHECK_EQUAL(RR+D,"ABCD000000")
