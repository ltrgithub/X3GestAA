...
Funprog TESTSUITE()
    ...
    Call ADD_TESTCASE("TEST_OPENCLOSE", "Test open/close basic write read, delete/rename file", 9) From AXUNIT
	Call ADD_TESTCASE("TEST_ALLTYPES", "Test open/close all types", 28) From AXUNIT
	Call ADD_TESTCASE("TEST_CHARTABLE", "Test open/close and table of char", 16) From AXUNIT
	Call ADD_TESTCASE("TEST_OPENCLOSE_BOM", "Test open/close basic write read, delete/rename file with bom", 9) From AXUNIT
