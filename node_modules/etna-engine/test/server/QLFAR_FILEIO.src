...
Funprog TESTSUITE()
	...
	Call ADD_TESTCASE("TEST_PUTGETALLTYPES", "Test putseq/getseq all types",8) From AXUNIT
...
Putseq 7, CHRVAR, INTVAR, SHTVAR, DTEVAR,TNYVAR,UIDVAR,DTMVAR Using [FAB]
Seek First + 0 Using [FAB]
CHRVAR = ""
INTVAR = 0
SHTVAR = 0
...
Getseq 7, CHRVAR, INTVAR, SHTVAR, DTEVAR,TNYVAR,UIDVAR,DTMVAR Using [FAB]
Call CHECK_EQUAL( CHRVAR, "tralala" ) From AXUNIT
Call CHECK_EQUAL( INTVAR, 4 ) From AXUNIT
Call CHECK_EQUAL( SHTVAR, 2 ) From AXUNIT
Call CHECK_EQUAL( DTEVAR, Date$ ) From AXUNIT
