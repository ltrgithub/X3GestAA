...
# ---------- TEST_SUITE IO  functions       -------------------------
# ------------------------------------------------------------------

Funprog TESTSUITE()

    #Call ADD_TESTCASE("TEST_OPENCLOSE", "Test open/close/adxseek",16) From AXUNIT
    #Call ADD_TESTCASE("TEST_BASIC", "Test open/close basic write read, delete/rename file", 13) From AXUNIT
	#Call ADD_TESTCASE("TEST_ALLTYPES", "Test open/close read write all types", 28) From AXUNIT
	#Call ADD_TESTCASE("TEST_CHARTABLE", "Test open/close and table of char", 15) From AXUNIT
	...
	#Call ADD_TESTCASE("TEST_WR_RDSEQ_CLOB", "Test wrseq/rdseq clob",4) From AXUNIT	
	#Call ADD_TESTCASE("TEST_WR_RDSEQ_RANGE", "Test wrseq/rdseq range",6) From AXUNIT
	#Call ADD_TESTCASE("TEST_PUT_GETSEQ_RANGE", "Test putseq/getseq range",6) From AXUNIT
	#Call ADD_TESTCASE("TEST_PUT_GETSEQ_INDEXED", "Test putseq/getseq indexed table ",5) From AXUNIT
	#Call ADD_TESTCASE("TEST_WR_RDSEQ_INDEXED", "Test readseq/wrseq indexed table ",5) From AXUNIT
...
Local Integer R
    ...
    NAME = filpath("","etna","txt","","")
    NAME2 = filpath("","etna2","txt","","")
    Openo NAME, 0 Using [FAB]
    INF = filinfo( NAME, 7 )
    Call CHECK_EQUAL( INF, 0 ) From AXUNIT
...
TNYVAR = 1
DTEVAR = "20040701"
DTMVAR = GDATETIME$("2015-07-01T10:30:32Z")
UIDVAR = TOUUID("288eadf8-43a6-4a15-8659-5330411430ea")
CLBVAR = "tralala0"
...
TNYVAR = 2
DTEVAR = "20040702"
DTMVAR = GDATETIME$("2015-07-02T10:30:32Z")
UIDVAR = TOUUID("288eadf8-43a6-4a15-8659-5330411430ea")
CLBVAR = "tralalaa1"
Wrseq CHRVAR,INTVAR,SHTVAR,DCBVAR,TNYVAR,DTEVAR,DTMVAR,UIDVAR,CLBVAR Using [FAB]
CHRVAR = "myline2"
...
TNYVAR = 3
DTEVAR = "20040703"
DTMVAR = GDATETIME$("2015-07-03T10:30:32Z")
UIDVAR = TOUUID("288eadf8-43a6-4a15-8659-5330411430ea")
CLBVAR = "tralalaaa2"
Wrseq CHRVAR,INTVAR,SHTVAR,DCBVAR,TNYVAR,DTEVAR,DTMVAR,UIDVAR,CLBVAR Using [FAB]
...
Next
INTVAR = 0
Wrseq CHRVAR(1),CHRVAR(2),CHRVAR(3),CHRVAR(4),INTVAR Using [FAB]
For I = 1 To 4
...
Seek First + 0 Using [FAB]
Rdseq CHRVAR(1),CHRVAR(2),CHRVAR(3),CHRVAR(4),INTVAR Using [FAB]
For I = 1 To 4
...
Local Char NAME2(250)
Local Char CHRVAR(20)
Local Integer INTVAR
Local Integer R
Local Integer SAV

NAME2 = filpath("","etna","txt","","")

Openo NAME2, 0 Using [FAB]
Iomode adxifs ";" Using  [FAB]
Iomode adxium 1 Using  [FAB]

Call CHECK_EQUAL( filinfo( NAME2, 7 ), 0 ) From AXUNIT
CHRVAR = "line0"
INTVAR = 25
Wrseq CHRVAR,INTVAR Using [FAB]
CHRVAR = "line1"
...
Local Date DTEVAR
Local Integer INF
Local Integer TINT(1..20)

INTVAR = 522
NAME = filpath("","etna2","dmp","","")
infbox NAME
Openo NAME, 0 Using [FAB]
putseq 1, INTVAR Using [FAB]
putseq 20, TINT Using [FAB]
Openo Using [FAB]

NAME = filpath("","etna","dmp","","")
...
SHTVAR = 0
TNYVAR = 0
UIDVAR = TOUUID("00000000-0000-0000-0000-000000000000")
DCBVAR= 0
...
Subprog TEST_WR_RDSEQ_CLOB( )
Local Char CHRVAR(20)
Local Integer INTVAR
Local Clbfile CLBVAR
Local Char STR(255)
Local Integer TT(1..4,1..4)
Local Integer TTT(1..10)
Local Integer INF
...
Wrseq CHRVAR,CLBVAR,INTVAR Using [FAB]
Openo Using [FAB]
...
Rdseq CHRVAR,CLBVAR,INTVAR Using [FAB]
Call CHECK_EQUAL( CHRVAR, "line0" ) From AXUNIT
Call CHECK_EQUAL( INTVAR, 25 ) From AXUNIT
Call CHECK_EQUAL( CLBVAR, STR ) From AXUNIT
...
Subprog TEST_WR_RDSEQ_RANGE( )
Local Char CHRVAR(20)
Local Integer INTVAR(1..10)
...
Wrseq CHRVAR, INTVAR(2..5) Using [FAB]
Seek First + 0 Using [FAB]
...
Rdseq CHRVAR, INTVAR(2..5) Using [FAB]
Call CHECK_EQUAL( CHRVAR, "line0" ) From AXUNIT
Call CHECK_EQUAL( INTVAR(2), 25 ) From AXUNIT
Call CHECK_EQUAL( INTVAR(3), 26 ) From AXUNIT
Call CHECK_EQUAL( INTVAR(4), 27 ) From AXUNIT
Call CHECK_EQUAL( INTVAR(5), 28 ) From AXUNIT
...
Putseq 5, CHRVAR, INTVAR(2..5) Using [FAB]
Seek First + 0 Using [FAB]
...
Getseq 5, CHRVAR, INTVAR(2..5) Using [FAB]
Call CHECK_EQUAL( CHRVAR, "line0" ) From AXUNIT
Call CHECK_EQUAL( INTVAR(2), 25 ) From AXUNIT
Call CHECK_EQUAL( INTVAR(3), 26 ) From AXUNIT
Call CHECK_EQUAL( INTVAR(4), 27 ) From AXUNIT
...
Subprog TEST_PUT_GETSEQ_INDEXED( )
Local Char CHRVAR(20)
Local Integer INTVAR(1..10)
Local Char NAME(250)
...
Putseq 2, CHRVAR, INTVAR(2) Using [FAB]
Putseq 2, CHRVAR, INTVAR(3) Using [FAB]
Putseq 2, CHRVAR, INTVAR(4) Using [FAB]
...
Getseq 2, CHRVAR, INTVAR(2) Using [FAB]
Call CHECK_EQUAL( CHRVAR, "line0" ) From AXUNIT
Call CHECK_EQUAL( INTVAR(2), 25 ) From AXUNIT
Getseq 2, CHRVAR, INTVAR(3) Using [FAB]
Call CHECK_EQUAL( INTVAR(3), 26 ) From AXUNIT
Getseq 2, CHRVAR, INTVAR(4) Using [FAB]
Call CHECK_EQUAL( INTVAR(4), 27 ) From AXUNIT
...
Wrseq CHRVAR, INTVAR(2) Using [FAB]
Wrseq CHRVAR, INTVAR(3) Using [FAB]
Wrseq CHRVAR, INTVAR(4) Using [FAB]
...
Rdseq CHRVAR, INTVAR(2) Using [FAB]
Call CHECK_EQUAL( CHRVAR, "line0" ) From AXUNIT
Call CHECK_EQUAL( INTVAR(2), 25 ) From AXUNIT
Rdseq CHRVAR, INTVAR(3) Using [FAB]
Call CHECK_EQUAL( INTVAR(3), 26 ) From AXUNIT
rdseq CHRVAR, INTVAR(4) Using [FAB]
Call CHECK_EQUAL( INTVAR(4), 27 ) From AXUNIT
