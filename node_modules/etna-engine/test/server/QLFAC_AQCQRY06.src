...
Call ADD_TESTCASE("AQCQRY06_BASIC","AINSERT + AREAD + AUPDATE + ADELETE",125) From AXUNIT
Call ADD_TESTCASE("AQCQRY06_CONTROLS","AINSERT CONTROLS",12) From AXUNIT
...
INS.FIELD13="This is a test of BCLOB entry" # andatory CLOB
INS.FIELD14=datetime$ # [BRJOU] was INS.CREDATTIM # mandatory date time (GH 7104)
...
#TEST AREAD
Call CHECK_NOTEQUAL("AQCQRY06.AREAD('AQCQRY06')","") From AXUNIT
...
#Call CHECK_EQUAL(INS.FIELD08, "0") From AXUNIT  GH 7098
