...
Subprog CHECK_DECODE_UTF8(STRIN, EXPECT)
  ...
  BLB = toBlbfile(STRIN, GASCII) : # iso-8859-1 bytes
...
Funprog ENCODE(STRIN)
  ...
  BLB = toBlbfile(STRIN, GUTF8) : # utf-8 bytes
  CLB = toClbfile(BLB,  GASCII) : # iso-8859-1
