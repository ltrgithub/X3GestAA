...
Funprog TESTSUITE()
    ...
    Call ADD_TESTCASE("TEST_MESS1_FRA", "Test MESS apl FRA", 200) From AXUNIT
    Call ADD_TESTCASE("TEST_MESSUPP_FRA", "Test MESS upper FRA", 100) From AXUNIT
    Call ADD_TESTCASE("TEST_MESS1_CHI", "Test MESS apl CHI", 200) From AXUNIT
    Call ADD_TESTCASE("TEST_MESSUPP_CHI", "Test MESS upper CHI", 200) From AXUNIT
...
EXPECT = "到期日匹配"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,111,1))
EXPECT = "TEST"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,112,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,113,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,114,1))
EXPECT = "行"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,115,1))
EXPECT = "不能删除"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
...
EXPECT = "未授权功能"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,124,1))
EXPECT = "不能连接到表格"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,125,1))
EXPECT = "目录生成"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,126,1))
EXPECT = "没有定义属性"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,127,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,128,1))
EXPECT = "G 行变化"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,129,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,130,1))
EXPECT = "用户至少要能用一种功能"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,131,1))
EXPECT = "最大期限太小"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,132,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,133,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,134,1))
EXPECT = "服务器已开启"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,135,1))
EXPECT = "报告选择"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,136,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,137,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,138,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,139,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,140,1))
EXPECT = "VALIDATION DE LA CLASSE"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,141,1))
EXPECT = "已用标志"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,142,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,143,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,144,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,145,1))
EXPECT = "VÉRIFICATION DISPONIBILITÉ SVN"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,146,1))
EXPECT = "NIVEAU +"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,147,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,148,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,149,1))
EXPECT = "JSON MAL FORMÉ"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,150,1))
EXPECT = "对象不存在"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,151,1))
EXPECT = "上次读取"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,152,1))
EXPECT = "X3WEB"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,153,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,154,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,155,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,156,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,157,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,158,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,159,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,160,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,161,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,162,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,163,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,164,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,165,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,166,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,167,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,168,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,169,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,170,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,171,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,172,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,173,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,174,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,175,1))
EXPECT = "PORTRAIT"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,176,1))
EXPECT = "文档代号"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,177,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,178,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,179,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,180,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,181,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,182,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,183,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,184,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,185,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,186,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,187,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,188,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,189,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,190,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,191,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,192,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,193,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,194,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,195,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,196,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,197,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,198,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,199,1))
EXPECT = ""
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
GOT = toupper(mess(1,200,1))
EXPECT = "AMOUNT CONVERSION INTO LETTERS"
Call CHECK_EQUAL( GOT, EXPECT ) From AXUNIT
