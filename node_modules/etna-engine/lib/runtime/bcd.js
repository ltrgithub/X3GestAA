...
var toInteger = exports.toInteger = function(bcd) {
	//	Differents Test d'Overflow
	if (!isInt32(bcd, 0)) throw new X3Error(50, "toInteger");
	...
	return integer.fromDouble( bcd[SIGN] !== 0 ? l : -l ) ;
}

var fromInteger = exports.fromInteger = function (val) {
	return exports.fromInt32( val.valueOf() ) ;
}
