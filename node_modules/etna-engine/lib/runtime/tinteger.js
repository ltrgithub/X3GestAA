...
Object.defineProperty(Number.prototype, "x3ToBlbfile", {
	value: function(size) {
		...
		switch (size) {
			case 8:
				...
				b.writeInt8(int8(((hi) >> 24) & 0xff), 0);
				b.writeInt8(int8(((hi) >> 16) & 0xff), 1);
				b.writeInt8(int8(((hi) >> 8) & 0xff), 2);
				b.writeInt8(int8(((hi)) & 0xff), 3);

				b.writeInt8(int8(((lo) >> 24) & 0xff), 4);
				b.writeInt8(int8(((lo) >> 16) & 0xff), 5);
				b.writeInt8(int8(((lo) >> 8) & 0xff), 6);
				b.writeInt8(int8((lo) & 0xff), 7);
				break;
			case 4:
				b.writeInt8(int8(((this) >> 24) & 0xff), 0);
				b.writeInt8(int8(((this) >> 16) & 0xff), 1);
				b.writeInt8(int8(((this) >> 8) & 0xff), 2);
				b.writeInt8(int8((this) & 0xff), 3);
				break;
			case 3:
			...
			case 2:
				b.writeInt8(int8(((this) >> 8) & 0xff), 0);
				b.writeInt8(int8((this) & 0xff), 1);;
				break;
			case 1:
				b.writeInt8(int8((this) & 0xff), 0);;
				break;
			default:
