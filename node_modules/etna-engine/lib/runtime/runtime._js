...
var modules = ['arrays', 'dates', 'db', 'evaluate', 'fileio', 'flowControl', 'misc', 'numbers', 'operators', 'stats', 'strings', 'system', 'util', 'variables', 'tbcd', 'uuid'].map(function(name) {
	return require('./' + name);
});
...
exports.exit = function(code) {
	if(config.monitorInstructions) _dumpInstructionCounters();
