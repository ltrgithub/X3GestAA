...
var modules = ['arrays', 'dates', 'db', 'evaluate', 'fileio', 'flowControl', 'misc', 'numbers', 'operators', 'stats', 'strings', 'system', 'util', 'variables', 'tbcd', 'tinteger','tstring', 'uuid'].map(function(name) {
	return require('./' + name);
});
