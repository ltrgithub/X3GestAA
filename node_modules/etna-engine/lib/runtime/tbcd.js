...
var BCD = (function() {
  function BCD( v ) {
    ...
    else if (tstring.isInteger( v ))
      this.value = bcd.fromInt32( v.valueOf( ) ) ;
    else if (tdouble.isInteger( v ))
  ...
  BCD.prototype.toString = function( v ) {
    return new tstring.String( bcd.toString( this.value ) ) ;
  } ;

  BCD.prototype.toInteger = function() {
    return new Integer( bcd.toInt32( this.value ) ) ;
  } ;
  ...
  BCD.prototype.add = function( b ) {
    if (tdouble.isDouble(b)) {
      ...
      return bcd.add( this.value, b.toBCD( ).valueOf( )) ;
  ...
  BCD.prototype.sub = function( b ) {
    if (tdouble.isDouble(b)) {
      ...
      return bcd.sub( this.value, b.toBCD( ).valueOf( )) ;
    } else throw util.badOperand(b);
  } ;
  ...
  BCD.prototype.mul = function( b ) {
    if (tdouble.isDouble(b)) {
      ...
      return bcd.multiply( this.value, b.toBCD( ).valueOf( )) ;
    } else throw util.badOperand(b);  
  } ;
  ...
  BCD.prototype.div = function( b ) {
    if (tdouble.isDouble(b)) {
      ...
      return bcd.divide( this.value, b.toBCD( ).valueOf( )) ;
    } else throw util.badOperand(b);  
  } ;
