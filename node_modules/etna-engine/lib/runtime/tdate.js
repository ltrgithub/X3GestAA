...
var Date = (function() {
  ...
  Date.prototype.toString = function() {
     return (this.isZero())? "00/00/0000": this._value.toString("dd/MM/yyyy");
  };
  ...
  Date.prototype.compare = function(v) {
    return (this._value > v._value)?1:(this._value < v._value)?-1:0;
  };

  Date.prototype._addOrSub = function( v ,op) {
    if(v.isNumeric() ) {
      var diff = op*v.valueOf();
      return new Date(this._value.addDays((diff >= 0)?Math.floor(diff):Math.ceil(diff)));
    }
  ...
  Date.prototype.abs = function( ) {
    return new Date( Math.abs( this._value )) ;
  };
  ...
  Date.prototype.nday = function(origin) {
    return (this.isZero())? new tinteger.Integer(-1): new tinteger.Integer(this._value.daysDiff(origin._value));
  };

  Date.prototype.addDays = function(n) {
    if(n.isNumeric()) {
      return (n.valueOf() >=0)? this.add(n): exports.make(0,0,0);
    }   
  }
