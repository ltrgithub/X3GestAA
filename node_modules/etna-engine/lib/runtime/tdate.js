...
Object.defineProperty(_prototype, 'toInteger', {
  value: function() {
...
Object.defineProperty(_prototype, 'toDouble', {
  value: function() {
    return new Date( this ) ;
  },
  enumerable: false,
...
Object.defineProperty(_prototype, 'toDatetime', {
  value: function() {
...
Object.defineProperty(_prototype, 'toBCD', {
  value: function() {
    throw util.badOperand() ;
  },
  enumerable: false,
...
Object.defineProperty(_prototype, 'isString', {
  value: function() {
    return false ;
  },
  enumerable: false,
...
Object.defineProperty(_prototype, '_addOrSub', {
  value : function( v ,op) {
    ...
    if (isDate(v)) return this.daysDiff(v);
    if(v.isString()) return this.toString() + v;
    throw util.badOperand();
  },
  enumerable: false
});
...
Object.defineProperty(_prototype, 'x3Year', {
  get: function() {
    return this.x3IsZero() ? new Number(0) : new Number(this.year);
  },
  enumerable: false,
});
