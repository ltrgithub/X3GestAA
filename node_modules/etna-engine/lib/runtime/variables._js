...
exports.initStack = function(superv) {
	...
	declVar(cx.sys,'ADXDCS', 'VI', 1940);
	declVar(cx.sys,'ADXDLREC', 'VI', 0);
	declVar(cx.sys,'ADXIFS', 'VS', ',');
	declVar(cx.sys,'ADXIRS', 'VS', '\n');
	declVar(cx.sys,'ADXIUM', 'VI', 0);
	declVar(cx.sys,'ADXMBM', 'VI', 0) ;
	declVar(cx.sys,'ADXMDA', 'VI', 0);
	declVar(cx.sys,'ADXMOTHER', 'VS', [1,exports.types["S"].def,["SUPERV","SUPERV"],0,7]);
	...
	declVar(cx.sys,'INDCUM', 'VI', 0); // Used by sigma
