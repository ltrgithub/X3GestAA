...
exports.initStack = function(superv) {
	...
	// declVar(cx.sys,'ADXCPW','VS64','');
	// declVar(cx.sys,'ADXCTX','VS','');
	// declVar(cx.sys,'ADXCUS','VS24','');
	// declVar(cx.sys,'ADXDBC','VS127','');
	// declVar(cx.sys,'ADXDBO','VS127','');
	// declVar(cx.sys,'ADXDBX','VS127','');
	declVar(cx.sys,'ADXDCS','VI',1940); // Pivot date
	// declVar(cx.sys,'ADXDIR','VS254','');
	// declVar(cx.sys,'ADXDLREC','VI',0);
	// declVar(cx.sys,'ADXDPG','VS127','');
	// declVar(cx.sys,'ADXDWEEK','VI',0);
	declVar(cx.sys,'ADXFMT','VS',''); // Date format
	declVar(cx.sys,'ADXFMT2','VS','');
	// declVar(cx.sys,'ADXFTL','VI',0);
	// declVar(cx.sys,'ADXGTB','VJ',0);
	declVar(cx.sys,'ADXIFS','VS','');//Field separator
	declVar(cx.sys,'ADXIRS','VS2','\n');//Record separator
	declVar(cx.sys,'ADXIUM','VI',0);//Character set
	// declVar(cx.sys,'ADXKPG','VS','');
	// declVar(cx.sys,'ADXKSP','VS','');
	// declVar(cx.sys,'ADXLIG','VJ',0);
	// declVar(cx.sys,'ADXLOG','VI',0);
	//declVar(cx.sys,'ADXMBM','VI',0);
	declVar(cx.sys,'ADXMDA','VI',0);//Angular mode
	// declVar(cx.sys,'ADXMOTHER', 'VS13', [1,exports.types["S"].def,["SUPERV","SUPERV"],0,7]);
	// declVar(cx.sys,'ADXMPGPRO','VS127','');
	// declVar(cx.sys,'ADXMPGTRT','VS127','');
	// declVar(cx.sys,'ADXMPR','VI',0);
	// declVar(cx.sys,'ADXMSO','VI',0);
	// declVar(cx.sys,'ADXMTO','VI',0);
	// declVar(cx.sys,'ADXMUA','VI',0);
	// declVar(cx.sys,'ADXMXL','VJ',0);
	// declVar(cx.sys,'ADXOVF','VS','');
	// declVar(cx.sys,'ADXOVS','VS','');
	// declVar(cx.sys,'ADXROB','VS254','');
	// declVar(cx.sys,'ADXSAX','VS254','');
	// declVar(cx.sys,'ADXSCA','VS10','');
	declVar(cx.sys,'ADXSCA','VS','?? .#*???');
	// declVar(cx.sys,'ADXSES','VI',0);
	// declVar(cx.sys,'ADXSQLREC','VI',0);
	// declVar(cx.sys,'ADXTCT','VS254','');
	// declVar(cx.sys,'ADXTLK','VS254','');
	// declVar(cx.sys,'ADXTMS','VS254','');
	// declVar(cx.sys,'ADXTRL','VS','');
	// declVar(cx.sys,'ADXTRO','VS2','');
	// declVar(cx.sys,'ADXTRP','VS254','');
	// declVar(cx.sys,'ADXTUL', 'VS', [1,exports.types["S"].def,[],0,30]);
	// declVar(cx.sys,'ADXTUT', 'VS', [1,exports.types["S"].def,[],0,30]);
	// declVar(cx.sys,'ADXTUC', 'VS', [1,exports.types["S"].def,[],0,30]);
	// declVar(cx.sys,'ADXUPREC','VI',0);
	// declVar(cx.sys,'ADXUSR','VS','');
	// declVar(cx.sys,'ADXWRB','VI',0);
	declVar(cx.sys,'DATESYST', 'VD', date.today(false)) ;
	declVar(cx.sys,'FSTAT','VI',0);
	declVar(cx.sys,'INDCUM','VI',0);
	declVar(cx.sys,'INDICE','VI',0);
	declVar(cx.sys,'MESSNAME', 'VS', superv.LAN) ;
