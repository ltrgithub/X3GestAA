...
exports.initStack = function(superv) {
	...
	declVar(cx.globals, 'AVOID', 'VY', {
		$exported: true,
		ADATE: exports.types['D'].def,
		ADATTIM: exports.types['E'].def,
		ASHORT: exports.types['J'].def,
		AINT: exports.types['I'].def,
		ACHAR: exports.types['S'].def,
		ADEC: exports.types['N'].def,
		ACLOB: exports.types['T'].def,
		ABLOB: exports.types['B'].def,
		AUUID: exports.types['Z'].def,
	});
