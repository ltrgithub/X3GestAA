...
exports.initStack = function(superv) {
	...
	declVar(cx.sys, 'ADXTUL', 'CS', [1, exports.types["S"].def, ['c'], 0, 30]);
	declVar(cx.sys, 'ADXTUT', 'CS', [1, exports.types["S"].def, ['A#'], 0, 30]);
	declVar(cx.sys, 'ADXTUC', 'CS', [1, exports.types["S"].def, ['-/_,'], 0, 30]);
