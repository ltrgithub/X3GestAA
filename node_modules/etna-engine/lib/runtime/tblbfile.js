...
var Blbfile = helpers.defineClass(function(v) { // constructor
	...
	x3ToInteger: function() {
		...
		switch (b.length) {
			case 8:
				var hi = int32((uint8(b.readInt8(0)) << 24) + (uint8(b.readInt8(1)) << 16) + (uint8(b.readInt8(2)) << 8) + uint8(b.readInt8(3)));
				var lo = int32((uint8(b.readInt8(4)) << 24) + (uint8(b.readInt8(5)) << 16) + (uint8(b.readInt8(6)) << 8) + uint8(b.readInt8(7)));
