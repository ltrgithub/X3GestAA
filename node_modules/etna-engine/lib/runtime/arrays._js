...
function _evalOrder(order) {
	return function evalOrder$do(_) {
		...
		//console.log("frame.orderCount = "+frame.orderCount);
		//console.log("frame.values.INDICE ="+frame.values.INDICE);
...
exports.functions = {
	MAXTAB: {
		...
		fn: function(arr) {
		    ...
		    //console.log("MAXTAB: arr=" + JSON.stringify(arr));
			return arr[4]===null?(arr[3]===0?arr[2].length-1:arr[2].length):arr[4]-arr[3]+1
		}
	},
};
...
exports.instructions = {
	...
	SORTA: function(rep, vars, orders) {
		...
		return function sorta$do(_) {
			...
			//console.log(" aVV -- arr = "+JSON.stringify(arr));

			var orderVals = aorders(_);
			//console.log(" a -- orderVals = "+JSON.stringify(orderVals));
			frame.orderCount = 0;
