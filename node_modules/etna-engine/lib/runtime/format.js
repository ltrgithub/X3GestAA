...
exports.format = function($fmt, $val) {
	...
	/*dbg*/
	console.error("adxtul:" + glob.context.x3frame.context.sys.values.ADXTUL);
	/*dbg*/
	console.error("adxtuc:" + glob.context.x3frame.context.sys.values.ADXTUC);
	/*dbg*/
	console.error("adxtut:" + glob.context.x3frame.context.sys.values.ADXTUT);
