...
exports.binaryOps = {
	...
	SUB: function sub(a, b) {
		...
		if (bcd.isBCD(a) && bcd.isBCD(b)) return bcd.sub( a, b ) ;
	...
	MUL: function mul(a, b) {
		...
		if (bcd.isBCD(a) && bcd.isBCD(b)) return bcd.multiply( a, b ) ;
