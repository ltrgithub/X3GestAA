...
var _commandsMap = {
	...
	source: function(_, resp, options) {
		...
		log.info("source: fullpath=" + fullpath + ", uri=" + sys.inspect(uri));
...
function _getProperty(_, parents, name, value, context) {
	...
	// if (parent == null)
	// 	log.info("_getProperty: property=" + sys.inspect(value, {
	// 		depth: 3
	// 	}));
	// log.info("_getProperty: parent=" + parent + ", name=" + name + ", value=" + value + ", type=" + type);
