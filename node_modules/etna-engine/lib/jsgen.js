...
exports.generate = function(node, fname) {
	...
	var stub = "if (typeof(requireScript)==='undefined'){var requireScript=function(cb,name){require(name);cb();}};";
	var head = stub + "var z = require('etna-engine/lib/runtime').instructions,r=requireScript,e=exports,p=[],B=z.B,NL=z.NL";
	for (var key in used) {
		head += "," + key + "=z." + key;
	}
