...
//var sbuf = require('etna-engine/lib/drivers/sqlbuffer') ;
...
module.exports = function(config) {
	...
	return {
		...
		reader: function(_, cnx, sql, args, opts) {
			...
			if (opts.close) throw new Error("internal error: opts.close != null");
			if (cnx == null) {
				var self = this;
				cnx = self.allocConnection(_);
				opts.close = function(_) {
					self.releaseConnection(cnx);
				};
			}
