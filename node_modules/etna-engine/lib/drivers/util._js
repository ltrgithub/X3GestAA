...
exports.maptrim = function(driver, typesmap, dispatch) {
	...
	return function(_, obj) {
		//trace && trace("trim:"+JSON.stringify(obj));
		if (dispatch) {
			var result = Object.keys(obj).reduce_(_, function(_, record, k, idx) {
			...
			var result = Object.keys(obj).reduce_(_, function(_, o, k, idx) {
...
exports.mapFromSql = function(driver, abv, mapsql) {
	return function(_, obj) {
		var result = {};
		result[abv] = Object.keys(obj).reduce_(_, function(_, o, k, idx) {
			var fromSql = exports.fromSql;
