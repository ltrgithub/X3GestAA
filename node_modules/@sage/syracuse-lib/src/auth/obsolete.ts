...
export const clearRedir = _clearRedir;
...
export function getAuthModuleObsolete(request, redirect, _) {
...
export function noAccess(_, request, response, status, user, noRedirect) {
...
export function verifyUser(request, response, data, _) {
...
export function updateSessionWithID(request, response, _sessions, cookie, data, _) {
...
export function setTempLogin(data) {
...
export function getTempLogin(key, keep) {
