...
import * as sageId from '../../src/sage-id';

export function checkUserLogin(_, session, login, request) {
...
export function fromCertificate(_, session, login) {
...
export function fromLoginPage(_, request, method, login, password, challenge, serverName) {
