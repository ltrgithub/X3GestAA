	...
	$functions: {
		...
		getEtnaConfig(_, session) {
			...
			switch (etnaConfig.sql.driver) {
				case "oracle":
					etnaConfig.sql.database = this.etnaOracleSID(_);
					etnaConfig.sql.port = this.etnaDatabasePort(_);
					etnaConfig.sql.hostname = this.etnaDatabaseHost(_);
					break;
				case "sqlServer":
					etnaConfig.sql.database = this.etnaDatabaseName(_);
					etnaConfig.sql.hostname = this.etnaSQLInstance(_);
					break;
				case "hdb":
					etnaConfig.sql.port = this.etnaDatabasePort(_);
					etnaConfig.sql.hostname = this.etnaDatabaseHost(_);
					etnaConfig.sql.schema = this.etnaDatabaseSchema(_);
					break;
				default:
