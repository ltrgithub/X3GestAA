...
export function query(_, context, parameters, entity, facet, func, where) {
...
export function matchOrEmptyFilter(_, filters, property, value) {
	if (value) {
		var filter = {};
		var val = {};
		var emptyStr = {};
...
export function findMatchingEndpoint(_, context, endpointName) {
	var epMatch;
