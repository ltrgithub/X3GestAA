	...
	$properties: {
		excelReportMode: {
			...
			$enum(_, instance) {
				...
				var exportOptions = (repr && repr.indexOf(".$details") !== -1) ? ["choose_tpl", "new_tpl", "mod_tpl"] : ["choose_tpl", "new_tpl", "mod_tpl", "no_tpl", "new_csv"];
	...
	$relations: {
		...
		document: {
			...
			$isDisabled: function(_, instance) {
				return instance.excelReportMode(_) === "new_tpl" || instance.excelReportMode(_) === "no_tpl" || instance.excelReportMode(_) === "new_csv";
			},
