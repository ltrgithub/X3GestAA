...
var _listLoaderMap = {
	syracuse(ep, context, parameters, _) {
	...
	x3(ep, context, parameters, _) {
		...
		try {
			...
			var client = x3Api.pool.getClient(_, globals.context.session, ep);
		} catch (e) {
	...
	other(_, ep, res, context, parameters) {
		// do nothing
	}
};
