...
export const entity = {
	...
	$functions: {
		...
		convertFusionArticle(_, pageDef, endpoint, version, opt) {
			var options = opt || {};
			var converter = require('./classicPageConverter');
			//
		...
		convertLocalization(_, pageDef, endpoint, version, opt) {
			var options = opt || {};
			var converter = require('./classicPageConverter');
			//
			var c = this.content(_);
		...
		diagnoseFusionArticle(_, pageDef, variant, endpoint, version, opt) {
			var options = opt || {};
		...
		$onExportResource(_, key, resource, localizations) {
		...
		$onImportResource(_, resource, proto, localization) {
