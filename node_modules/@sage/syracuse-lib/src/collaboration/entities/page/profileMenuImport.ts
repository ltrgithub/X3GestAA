...
export const entity = {
	...
	$functions: {
		importMenuProfile(_, diags, tracker) {
			...
			var _menuTypesMap = {
				PROCESS(_, vg, admDb, menuItemEnt, application, filter, options) {
					var ft = filter || {};
					ft.jsonWhere = ft.jsonWhere || {};
				...
				REQUEST(_, vg, admDb, menuItemEnt, application, filter, options) {
					//
				...
				WEBPAGE(_, vg, admDb, menuItemEnt, application, filter, options) {
					//
					//var compl = JSON.parse(vg.COMPLEMENT(_) || "{}");
					//
					var ft = filter || {};
				...
				STAT(_, vg, admDb, menuItemEnt, application, filter, options) {
					var ft = filter || {};
					ft.jsonWhere = ft.jsonWhere || {};
