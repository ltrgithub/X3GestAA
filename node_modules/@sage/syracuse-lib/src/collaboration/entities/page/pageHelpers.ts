...
export const AuthoringHelper = helpers.defineClass(function () {}, null, {
	$setId(_, context, id) {
	...
	getSaveVariant(_, saveAsOption, modelRepresentation) {
		var pageDef;
...
export const Factory = {
	getPageFromContext(_, db, pageType, pageContext, device) {
