...
import { Certificate } from 'jsx509';
import { integrity } from 'jsx509';
...
export function deleteData(instance, ca, _) {
...
export function fillInstance(instance, ca, _) {
	var pemCertificate;
	var pemKey;
	var passphrase;
...
export const entity = {
	...
	$functions: {
		...
		/// 
		verify(_, algorithm, data, signature, options) {
			try {
