...
export const contract = {
	...
	entities: {
		...
		msSqlService: require('./entities/services/ms-sql-service').entity,
		oracleService: require('./entities/services/oracle-service').entity,
		mongoService: require('./entities/services/mongo-service').entity,
	},
	representations: {
	...
	dbMeta: {
		...
		alwaysSyncScript: [{
			script: "../../collaboration/updateScripts/alwaysSyncScript"
		}],
		updateScript: [{
			...
			script: "../../collaboration/updateScripts/updateScript_F_120636_office_document_upload",
			version: 1
		}, {
			script: "../../collaboration/updateScripts/updateScript_11-P02",
			version: 1
		}, {
			script: "../../collaboration/updateScripts/updateScript_2017Rx",
			version: 1
		}, {
			script: "../../collaboration/updateScripts/updateScript_etna",
			version: 1
		}]
	}
};

registry.extendContract(contract);