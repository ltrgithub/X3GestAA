...
import * as entityClasses from './entities';
...
var _allEvents = ["$beforeSave", "$canSave", "$afterSave", "$afterDelete"];
...
var DataModel = helpers.defineClass(function(contract) {
	...
	unregisterEntities(_, entitiesNames) {
		var self = this;
	...
	getRepresentation(_, name, facet) {
	...
	entityByClassName(name) {
		return this.classMap[name];
	},
	getIndexedEntities(_) {
		var self = this;
...
export function make(contract, dataset) {
...
export function getSyncData(_, orm) {
...
export function getOrm(_, model, dataset) {
