...
function _safeCall(_, instance, propName, fn, field, val) {
	if (typeof(fn) != "function") {
		instance.$addError(instance._meta.name + "." + propName + " must be a function for " + field, propName);
		return;
	}
	...
	return flows.withContext(_ => propRef.funnel(_, (_) => {
		...
		try {
			...
			factoryTracer.error && factoryTracer.error("Error executing " + fn.name + " for " + instance._meta.name + "." + propName, e);
		} finally {
