...
import * as PdfDocument from 'streamline-pdfkit';
import * as PdfImage from 'streamline-pdfkit/lib/image';
...
export function render(_, context, data, proto, options) {
