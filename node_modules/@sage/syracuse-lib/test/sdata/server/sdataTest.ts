...
var endPoint = testAdmin.modifyCollaborationEndpoint("unit_test");
...
describe(module.id, () => {
	...
	var db;
	it('initialize environment', function(_) {
...
// }
	...
	*/
	...
	it('method override', function(_) {
			// $payload create a security issue and is no longer supported
	...
	ok(/x-da531cc304d9/.test(body.$diagnoses[0].$message), "Got x-da531cc304d9 error");
...
it("Sync protocol csrf attack", function(_) {
	requestCount++;
	var cookie = getCookie(_);
	var entityNamePlural = "secUsers";
	var body = post(_, cookie, entityNamePlural, {
		login: "csrf1",
	}, 201);
	var uuid = body.$uuid;
	body = get(
	...
	body = get(
		_,
		cookie,
		entityNamePlural + "(login eq \"csrf2\")?representation=" + entityNamePlural + ".$details",
		404);
