...
describe(module.id, () => {
	function post(_, cookie, url, data, statusCode) {
		return testAdmin.post(_, cookie, baseUrl + "/sdata/qunit/sdataTest/unit_test_data/" + url, data, statusCode);
	}

	function del(_, cookie, url, statusCode) {
		return testAdmin.del(_, cookie, baseUrl + "/sdata/qunit/sdataTest/unit_test_data/" + url, statusCode);
	}

	function put(_, cookie, url, data, statusCode) {
		return testAdmin.put(_, cookie, baseUrl + "/sdata/qunit/sdataTest/unit_test_data/" + url, data, statusCode);
	}

	function get(_, cookie, url, statusCode, headers) {
		return testAdmin.get(_, cookie, baseUrl + "/sdata/qunit/sdataTest/unit_test_data/" + url, statusCode, false, headers);
	}

	var db, cookie;
	it('init database', function(_) {
		testAdmin.initializeTestContract(_, require('../fixtures/testDB'), "unit_test_data");
		//
