...
*/
		adminEp = get(_, cookie, "endPoints(dataset eq 'unit_test')");
	});
	...
	testSettings.forEach(function(test) {
		...
		var importFile = fsp.join(__dirname, "../fixtures/exportTestSamples/" + test.profileDescr + "-import.json");
		...
		function testCheck(_) {
			...
			var infpath = importFile; //fsp.join(__dirname, "../../../../../..", importFile);
