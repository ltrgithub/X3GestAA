...
var adminHelper = require("@sage/syracuse-lib/src/collaboration/helpers");
...
describe(module.id, () => {
	...
	var fs = require('streamline-fs'),
		...
		pdfUtils = require('@sage/syracuse-lib/src/pdf/utils'),
		pdfObject = require('@sage/syracuse-lib/src/pdf/object'),
