...
var not = require('@sage/syracuse-lib/src/scheduler/scheduler');
var evt = require('syracuse-email/lib/entities/notificationEvent');
...
describe(module.id, () => {
	...
	it('test array function', function(_) {
	...
	it('schedule one task', function(_) {
	...
	it('scheduleAll with equal times', function(_) {
		var entity = db.model.getEntity(_, "eventTime");
		var testData = [6];
		not._setTestData(db, testData);
		var now = Date.now();
