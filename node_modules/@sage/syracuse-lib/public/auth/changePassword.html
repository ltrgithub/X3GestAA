...
<html>
	...
	<head>
		...
		<link href="/@sage/syracuse-lib/public/auth/changePassword.css" rel="stylesheet"/>
		<script src="/@sage/syracuse-lib/public/auth/deps/md5.min.js"></script>
		<script>
function submit() {
  var login = document.formular.login.value;
  var salt = document.formular.salt.value;
