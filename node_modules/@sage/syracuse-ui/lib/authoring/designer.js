...
var _historyTool = require("@sage/syracuse-ui/lib/authoring/tools/historyTool");
var _templatesTool = require("@sage/syracuse-ui/lib/authoring/tools/templatesTool");
...
function _clearUnknowFields(page) {
	if (page.noProtoFields) {
		...
		syra_layout.validateLayoutContent(page);
	}
}
