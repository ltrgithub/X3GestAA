"use strict";
var officeSiteAdapter = require('syracuse-ui/lib/office/officeSiteAdapter');
...
var WordInterface = require('syracuse-ui/lib/office/word/wordInterface').WordInterface;
...
exports.checkLogon = function() {
		...
		syra_site.wordInterface = new WordInterface();
		syra_site.wordInterface.onLogin();
	}
