...
exports.WordPage = helpers.defineClass(WordPage, DesktopPage, {
	...
	drawPage: function() {
		this.$mailMergeGridPrototype = this.createMailMergeDataPrototype(this.$prototype.$properties.$resources.$item.$properties, this.$item);
