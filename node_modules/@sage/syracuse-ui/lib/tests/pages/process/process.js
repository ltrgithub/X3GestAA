...
var _processes = ["ACH05_002", "actions", "api_shape_dashed_borders", "apishape_rotations", "arrows", "layers", "line_caps_and_joints", "bezier", "bullet", "bezier_shape_dashed_borders", "bezier_fill", "pattern", "pattern_and_rotation", "radial_gradient", "linear_gradient_and_transition", "linear_gradient_stop_colors", "linear_gradient_rotation_shapes", "text_rotation", "filling", "text_positionning", "shadow", "text_formatting", "img_rotations", "img_scaling", "rotations_and_deformations", "links", "links2", "demo_process", "demo_process2", "test"];
...
exports.load = function(page, finish) {
	...
	syra_item.ensureMediaTypes(page.$prototype, function() {
		...
		page.runUnitProcess = function(unit) {
			require.async("@sage/syracuse-ui/lib/tests/pages/process/data/" + unit.$title, function(err, module) {
				if (!page.flashImage) {
					page.flashImage = page.rightCol.appendChild(document.createElement("div"));
					page.addItem(page.rightCol, {
						$bind: "process",
						$isTitleHidden: true,
						$isEditMode: false
					});
				...
				syra_dom.empty(page.flashImage);
