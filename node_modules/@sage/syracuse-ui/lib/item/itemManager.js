...
var _menuItem = require('syracuse-ui/lib/links/menuItem');
var _section = require('syracuse-ui/lib/item/section');
var MenuGroup = require('syracuse-ui/lib/links/menuGroup').MenuGroup;
var DateTimeField = require('syracuse-ui/lib/field/datetime/datetimeField').DateTimeField;
...
var RichDataField = require('syracuse-ui/lib/field/vignette/richData/richDataVignetteField').RichDataVignetteField;
...
exports.fieldTypes = {
	...
	"text/xml": RichDataField,
	"application/json": RichDataField,
	"application/x-filter": require('syracuse-ui/lib/filter/view/filterField').FilterField,
...
exports.bind = function(item, $bind) {
	if (item && $bind) {
		...
		if (article.isFusionPage) {
			//#7858 sheetPage overides defaut binding as data and meta are in aother storage
