...
var _quickEditBuilder = require("@sage/syracuse-ui/lib/field/array/gridMode/tools/quickEditBuilder");
var _paging = require("@sage/syracuse-ui/lib/field/array/tools/paging");
var _lookup = require("@sage/syracuse-ui/lib/field/reference/lookup");
var _tunnel = require("@sage/syracuse-ui/lib/field/reference/tunnel");
...
exports.applyChange = function(field, metaData) {
	if (metaData) {
		if (field.applyMenusChange) {
			field.applyMenusChange(metaData);
		} else {
