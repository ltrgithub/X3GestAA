...
var VignetteField = require('@sage/syracuse-ui/lib/field/vignette/htmlVignetteField');
...
exports.DHTMLVignetteField = helpers.defineClass(DHTMLField, HTMLField, {
	...
	_sessTouch: function() {
		...
		var self = this;
		var delay = syra_site.userProfile.sessionTimeOut;
		delay -= Math.ceil(delay / 2);
		if (this._sessTouchHandler) {
			clearTimeout(this._sessTouchHandler);
		}
		this._sessTouchHandler = setTimeout(function() {
			_touch();
			self._sessTouch();
		}, delay);
	},
	dispose: function() {
		...
		HTMLField.prototype.dispose.call(this);
	}
});