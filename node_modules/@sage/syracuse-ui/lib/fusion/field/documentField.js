...
var DocumentField = require('@sage/syracuse-ui/lib/field/documentField').DocumentField;
...
exports.CvgDocumentField = helpers.defineClass(CvgDocumentField, DocumentField, {
	render: function() {
		...
		syra_button.disable(this.removeBtn, true);
	},
...
exports.FusionImageField = helpers.defineClassEx(FusionImageField, DocumentField, {
	initialize: function() {
		this.$field.$acceptedTypes = ["image/jpg", "image/jpeg", "image/png", "image/gif", "image/bmp"];
