 ...
 */
var printerHelpers = require('@sage/syracuse-ui/lib/site/aside/printerSetup').helpers;
...
_evtProcSelimp.sap = function() {
	this.eventListeners = function() {
		return [
			...
			["wdgt.record.action", onRecordAction, true, true],
			["wdgt.record.picker", onRecordSel, true, true],
			["wdgt.grid.selline", onRecordSel, true, true],
			["wdgt.cell.click", onRecordSel, true, true],
