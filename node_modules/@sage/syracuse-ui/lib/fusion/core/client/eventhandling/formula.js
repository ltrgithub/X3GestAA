...
_evtProcFormula.sap = function() {
	this.eventListeners = function() {
		return [
			...
			["wdgt.field.keydown", keyDown, true, true],
			["wdgt.field.keyup", keyUp, true, true],
			["wdgt.field.mousedown", onFieldMD, true, true],
			["wdgt.field.click", click, true, true],
			["wdgt.link.click", onLinkClick, true, true],
			["wdgt.record.picker", clickRecordPicker, true, true],
			["wdgt.win.close", onClose, true, true],
			["wdgt.win.closeall", onCloseAll, true, true],
			["wdgt.win.validate", onValidate, true, true],
