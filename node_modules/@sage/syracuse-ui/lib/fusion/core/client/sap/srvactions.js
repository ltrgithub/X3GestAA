...
var _srvActionEx = {
	...
	"SUP_CURRENTFIELD_SELECT": 45, //chaine menucontext + lookup if ok
	"SUP_EXPCSVGRID": 46 // export csv full grid
};
var _proxyAction = {
	"PRINTER_SEL_OPTS": 1,
	...
	"PRINTER_OPTS_OK": 5,
	"PLUGIN_ILOG_ACK_NEW": 10,
	"PLUGIN_ILOG_REG": 11,
	"PLUGIN_ILOG_NOTIFY": 12,
	"PLUGIN_ILOG_CLOSE": 13,
	"PLUGIN_ILOG_UPLOAD": 14,
	"PLUGIN_ILOG_ACK_CLOSE": 15,
	"PLUGIN_CRDEV_ACK": 20
};
var _localAction = {
	"LCL_TOGGLE_LOG": 1
...
exports.getLocalAction = function(action) {
	return (_localAction[action] + exports.localActionStart);
};
