	...
	create: function(params) {
		...
		switch (this._subClass) {
			...
			default:
				...
				if (params.ODBCType && params.ODBCBase && params.ODBCServer) {
					args.push(["o", (params.ODBCName || params.Solution || "") + "~" + (params.ODBCDriver || "") + "^" + params.ODBCType + "|" + params.ODBCBase + "@" + params.ODBCServer + ":" + (params.ODBCPort || "")]);
				}
