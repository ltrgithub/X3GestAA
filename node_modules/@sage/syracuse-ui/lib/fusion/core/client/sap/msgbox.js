...
exports.getMsgBoxOpts = function(boxParams, opts) {
	...
	if (finalType == 1 || finalType == 2) {
		...
		boxOpts.mode = (finalType == 1) ? "ok,cancel" : "yes,no";
		boxOpts.defaultButton = !boxParams.def || boxParams.def <= 1 ? (finalType == 1 ? "ok" : "yes") : exports._getMsgBoxDefaultRet(finalType, boxParams.def, true);
	}
