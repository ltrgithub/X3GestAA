...
var _devTools = require('@sage/syracuse-ui/lib/site/aside/devToolsPanel');
var _escaper = require('@sage/html-sanitizer').escaper({});
var _externalAdapter = require("@sage/syracuse-ui/lib/utility/externalAdapter");
var DesktopPage = require("@sage/syracuse-ui/lib/page/desktopPage").DesktopPage;
var _locale = require('streamline-locale');
var _searcher = require('@sage/syracuse-ui/lib/search/searcher');
var SocketHandler = require('@sage/syracuse-ui/lib/notifications/socketHandler');
var _ext = require('@sage/syracuse-ui/lib/extend/extendGateway');

var functionalTools = {
	formula: require('@sage/syracuse-ui/lib/site/aside/formula'),
	printerSetup: require('@sage/syracuse-ui/lib/site/aside/printerSetup')
};
var _manager = {
	fusion: require('@sage/syracuse-ui/lib/fusion/fusionGateway').gateway,
	filter: require("@sage/syracuse-ui/lib/filter/manager"),
	config: require('@sage/syracuse-ui/lib/site/config'),
	help: require('@sage/syracuse-ui/lib/help/helpCenter'),
	item: require("@sage/syracuse-ui/lib/item/itemManager"),
	localizer: require('@sage/syracuse-ui/lib/localization/localizer'),
	button: require('@sage/syracuse-ui/lib/links/button'),
	fields: require('@sage/syracuse-ui/lib/field/helpers/fieldHelper'),
	menus: require('@sage/syracuse-ui/lib/links/menusHelper'),
	pageBuilder: require("@sage/syracuse-ui/lib/page/pageBuilder"),
	layout: require("@sage/syracuse-ui/lib/item/layoutManager"),
	maximizer: require('@sage/syracuse-ui/lib/utility/maximizer'),
	article: require("@sage/syracuse-ui/lib/item/article"),
	icon: require("@sage/syracuse-ui/lib/utility/icon"),
	preference: require('@sage/syracuse-ui/lib/controller/preference'),
};
if (window.external) { // Check for external COM interface (Office)
	_manager.office = require("@sage/syracuse-ui/lib/office/officeAdapter")
}
