...
exports.NumericField = helpers.defineClass(NumericField, Field, {
	...
	initialize: function() {
		...
		if (!this.formatApi) {
			this.formatApi = syra_culture.getFormatApi(this.$numeric.$type);
			this.numFormatObj = syra_format.getNumberFormatObj(this.$numeric.$type);
