...
exports.HTMLVignetteField = helpers.defineClass(HTMLVignetteField, VignetteField, {
			...
			if (this._iframe) {
				if (this.isMaximized) {
					...
					if (this.$item.$height) {
						...
						var bodyHeight = this.page.scrollview.clientHeight - this.page.size.headerHeight;
						this.body.style.height = bodyHeight + "px";
						var diff = this.page.scrollview.scrollHeight - this.page.scrollview.clientHeight;
						if (diff) {
							this.body.style.height = Math.max(Math.floor(bodyHeight / 2), bodyHeight - diff) + "px";
						}
					}
				}
			}
	...
	_getSecurityLevel: function() {
		...
		var sec = syra_site.userProfile.security;
