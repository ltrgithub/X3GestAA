...
function _ensureFieldVisibility(field) {
	field.showField(!field.$isHidden && (!field.boxParent.hasAdvancedFields || field.boxParent.advancedFieldsVisibled));
}
...
function _showButton(page, show, designing) {
	...
	if (page.isDesktopPage) {
		...
		if (page.isVignettePage) {
			...
			_showFields(page.vignetteField.page,
				page.vignetteField.page.advancedFieldsVisibled ? !page.vignetteField.page.advancedFieldsVisibled : false);
		} else {
			...
			if (!page.advancedFieldsBtn) {
				page.advancedFieldsBtn = syra_button.add({
					parent: page,
					slot: (page.headerBottom || page.header),
					text: title,
