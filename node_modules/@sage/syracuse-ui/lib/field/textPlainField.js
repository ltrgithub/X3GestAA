...
exports.TextPlainField = helpers.defineClass(TextPlainField, Field, {
	initialize: function() {
		this.setTextRows(this.getTextRows() || 5);
				...
				accept: self.$contentType,
					...
					if (response.ok) {
						if (typeof(response.data) === 'string') {
							Field.prototype.setValue.call(self, response.data);
						} else {
							syra_form.invalidateField(self, locale.format(syra_local.fieldBadDataType, "string", typeof(response.data)));
						}
					} else {
