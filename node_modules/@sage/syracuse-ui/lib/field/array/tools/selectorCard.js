...
SelectorCard.prototype.dispose = function() {
	this.popupCard && this.popupCard.close();
...
SelectorCard.prototype.load = function() {
	...
	this.domItem = syra_dom.div(this.list.$skin + "-record-selector");
	this.domItem.syraItem = this.id;
	this.domItem.setAttribute("data-s-record", this.$uuid);
	this.page.addItem(syra_dom.div(this.list.$skin + "-record", this.domItem), this.$item, this);
...
SelectorCard.prototype.onSelectRecord = function() {
	if (this.popupCard) {
...
SelectorCard.prototype.onLookupClick = function(field) {
	if (field.$item.$bind == "$selectorField") {
		var self = this;
		if (!self._popupSlot) {
			self._popupSlot = syra_dom.div(this.list.$skin + "-record-selector-popup");
		}
		self._popupSlot.appendChild(self.list.domItem);
		self.popupCard = syra_popup.open({
