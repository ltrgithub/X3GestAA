...
var ArrayField = require("@sage/syracuse-ui/lib/field/array/arrayField").ArrayField;
var _selector = require('./tools/selector');
var _graph = require("./tools/graph");
var FieldsGarbage = require('@sage/syracuse-ui/lib/page/tools/fieldsGarbage').FieldsGarbage;
var _selectorCard = require("./tools/selectorCard");
var _tree = require("./tools/tree");
var _gridBuilder = require("@sage/syracuse-ui/lib/field/array/gridBuilder").GridBuilder;
var _cardsBuilder = require("@sage/syracuse-ui/lib/field/array/cardsBuilder").CardsBuilder;

function _applyPageSortWhereCapabilities(list, newData) {
	list.paging.applyMetadata(newData);
	list.sorter.applyMetadata(newData);
...
exports.MultiArrayField = helpers.defineClass(MultiArrayField, ArrayField, {
	enableDefaultDesigner: function() {
		this.switchDesigner = function(open) {
			...
			if (open && !self.designer) {
				require.async('@sage/syracuse-ui/lib/authoring/list/listDesigner', function(err, module) {
	...
	initializeList: function() {
		...
		switch (this.articleParent.$facet) {
			case "$query":
				syra_filter.query.addLinks(this);
			...
			case "$select":
				...
				break;
			default:
				this.resizable = !this.$fitContainer;
				...
				if (this.articleParent.searchVignetteBlock) {
		...
		if (this.page.$autoFetch || this.page.$reactAutoFetch) {
