				...
				if (tab && tab.layoutContent) {
					syra_alert.ask({
						...
						onClose: function(closeBy) {
							if (closeBy == "yes") {
								syra_ldp.ldpRecord.removeTab(tab);
							}
						}
					});
				}
