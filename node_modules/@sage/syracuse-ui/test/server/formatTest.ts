...
var formatter = require("@sage/syracuse-ui/lib/field/helpers/format");
...
describe(module.id, () => {
	...
	it('test simple format ', function(_) {
		...
		value = formatter.format("testabcde123A1", 'KTDB:4X5A3#2b', "application/x-string");
		strictEqual(value, "testABCDE123a1", "with unknown format and known format and valid string for kown format, value=testabcde123A1 format=KTDB:4X5A3#2b res=" + value);
	...
	it('test super format ', function(_) {
		...
		value = formatter.format('aZ2', 'K:A3c', "application/x-string", formatExt);
		strictEqual(value, "AZ2", "format super type, value='aZ2' format=K:A3c res=" + value);
