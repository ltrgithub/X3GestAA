...
import { IFieldProps, EditField, DetailField } from '../../field';
...
describe('Test Suite for stringField', function () {
    ...
    it('<StringField /> static sdataType getter should return "application/x-string" ', () => {
        expect(StringField.sdataType).toBe('application/x-string');
    });

    it('<StringField /> should render <DetailField /> if !hidden !editable ', () => {
        props = { value: 'the value' };
        const wrapper = shallow(<StringField {...props} />);
        expect(wrapper.find(DetailField)).toHaveLength(1);
    });
