...
export class Module extends React.Component<IModuleProps, {}>{
	renderSubModules() {
		...
		return <ul className="s_sitemap_submodules">
			{lines}
		</ul>;
	}
	render() {
		return <li className="s_sitemap_module" id={this.props.module.$uuid}>
			<Link
				...
				highlightTextFocused={this.props.searchResult.searchCurrentItem ? (this.props.searchResult.searchCurrentItem.uuid === this.props.module.$uuid) : false}/>
			{!this.props.module.collapsed && this.renderSubModules()}
		</li>;
	}
}