...
export default class SitemapPage extends React.Component<ISitemapPageProps, {}>{
	...
	rollUp(): Promise<void> {
		return transitionHelper.removeClassWithAnimation(this.pageNode, 's_sitemap_page_moving_in', 1000).then(() => {
			this.searchBar.clear();
		});
	}

	rollDown(): Promise<void> {
		return transitionHelper.addClassWithAnimation(this.pageNode, 's_sitemap_page_moving_in', 1000);
	}
