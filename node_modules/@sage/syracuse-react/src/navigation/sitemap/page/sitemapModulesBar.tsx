		...
		for (let mod of this.props.modules) {
			...
			body.push(<div key={mod.$uuid}>
				<Link
					...
					highlightTextOccurence={this.props.searchResult.searchCurrentItem ? this.props.searchResult.searchCurrentItem.occurence : null}
					highlightTextFocused={this.props.searchResult.searchCurrentItem ? (this.props.searchResult.searchCurrentItem.uuid === (mod.$uuid + "_bar")): false}/>
...
/*
					highlightTextFocused={this.props.searchResult.searchCurrentItem ? ((this.props.searchResult.searchCurrentItem.uuid === mod.$uuid) && this.props.searchResult.searchCurrentItem.isBarModule): false}/>
