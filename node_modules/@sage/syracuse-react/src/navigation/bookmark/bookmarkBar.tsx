...
class BookmarksList extends React.Component<{
	...
	render() {
		...
		let displayFavoriteToolbar = this.props.showBookmarkHeader; 
		return <HotKeyLinks>
			<div className="s_profile_bar_list_item_primary_top">
				<Link title={displayFavoriteToolbar ? getLocalString("bookmarks_hide_toolbar") : getLocalString("bookmarks_show_toolbar")}
					onClick={this.props.onToggleBookmarkHeader}
