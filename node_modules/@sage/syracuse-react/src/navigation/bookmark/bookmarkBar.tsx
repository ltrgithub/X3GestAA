...
class BookmarksList extends React.Component<{
	...
	toggleBookmarkHeader: any,
	onToggleBookmarkHeader: any,
	showBookmarkHeader:any,
}, {}>{
	list: ScrollList;
	onSwitch = () => {
        this.props.onToggleBookmarkHeader();
		this.props.toggleBookmarkHeader();
	}
	...
	render() {
		...
		let displayFavoriteToolbar = this.props.showBookmarkHeader; //to do replace once the favorites toolbar has been implemented
		let hideFavoriteToolbarLink = false;//To do remove when implement favorites bar
		return <HotKeyLinks>
			{!hideFavoriteToolbarLink && <div className="s_profile_bar_list_item_primary_top">
				<Link title={displayFavoriteToolbar ? getLocalString("bookmarks_hide_toolbar") : getLocalString("bookmarks_show_toolbar")}
...
export class BookmarkBar extends React.Component<IBookmarkBarProps, {}> {
	...
	onPopupRender = () => {
		return <BookmarksList
			...
			toggleBookmarkHeader={this.props.toggleBookmarkHeader}
			onToggleBookmarkHeader={this.togglePopup}
			showBookmarkHeader={this.props.showBookmarkHeader}
		/>;
