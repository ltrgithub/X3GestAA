...
export const BookmarkHeaderListItem = (props: IBookmarkHeaderListItemProps) =>
    <li>
        <Link className="s_profile_bar_bookmarks_textlink" title={props.menu.title} value={props.menu} onClick={props.onBookmarkClick} />
    </li>;
...
export const BookmarkHeaderIcons = (props: IBookmarkHeaderIconsProps) =>
    <div className="s_profile_bar_bookmarks_icon" style={{ visibility: props.show ? 'visible' : 'hidden' }}>
