...
describe('ProfileController', () => {
    ...
    describe('Snapshots', () => {
        ...
        it('should compare to snapshot with visible search field', () => {
            props.searchFacet = true;
            let component = Enzyme.render(<ProfileController {...props} />);
            expect(component).toMatchSnapshot();
        });
    ...
    describe('Interactions', () => {
        ...
        afterEach(() => {
            jest.useRealTimers();
            ReactDom.unmountComponentAtNode(component.getDOMNode().parentElement);
        });
        ...
        describe('Profile Panel', () => {
            beforeEach(() => {
                profile.dataset.selectedLocale = { description: 'English (United Kingdom)' };
                profile.dataset.lastName = 'Doe';
            });

            afterEach(() => {
                delete profile.dataset.selectedLocale;
            });

            it('should toggle the profile panel when the profile panel link is clicked', () => {
                expect(document.querySelector('.s_profile_panel')).toBeNull();
                component.find('.s_profile_bar_textlink_profile_panel').simulate('click');
                expect(document.querySelector('.s_profile_panel')).not.toBeNull();
                component.find('.s_profile_bar_textlink_profile_panel').simulate('click');
                expect(document.querySelector('.s_profile_panel')).toBeNull();
            });

            it('should call the onLogout prop if the logout button is clicked', () => {
                component.find('.s_profile_bar_textlink_profile_panel').simulate('click');
                expect(document.querySelector('.s_profile_panel_logout')).not.toBeNull();
                expect(props.onLogout).not.toBeCalled();
                TestHelper.simulate.click(document.querySelector('.s_profile_panel_logout'));
