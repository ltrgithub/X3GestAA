    ...
    componentDidUpdate(prevProps: IProps, prevState: IState) {
        if (this.props.profile) {
            ...
            if (prevState.sitemapOpened != this.state.sitemapOpened) {
                ...
                const rollPromise = !this.state.sitemapOpened ? this.sitemapPageController.rollUp() : this.sitemapPageController.rollDown();
                rollPromise.then(() => { this.sitemapTransitionInProgress = false; });
            }
        }
    }
