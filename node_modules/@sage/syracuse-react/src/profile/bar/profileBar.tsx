	...
	render() {
		...
		return <header className="s_profile_bar" onClick={this.props.onHeaderClick}>
			<ul className="s_profile_bar_bar">
				...
				<SitemapLink css={'s_profile_bar_iconlink_sitemap'} opener={true} profile={this.props.profile} opened={this.props.sitemapOpened} onClick={this.props.onToggleSitemap} />
