...
export default class Application extends React.Component<{}, {
    ...
    ensureMainPage = () => {
        this.body && this.body.showMainPage();
    }
    ...
    render() {
        ...
        return <article id='s_app'>
            ...
            <ProfileController
                office={this.state.office}
                onToggleSitemap={this.body && this.body.onToggleSitemap}
                ...
                bookmarkDisabled={!mainPageProps || mainPageUrl.$facet == '$navigation' || mainPageUrl.$facet == '$landing'}
            ...
            <AppBody ref={(body) => this.body = body} mainPageProps={mainPageProps} fullReactMode={this.state.fullReactMode} />
            <AjaxWatcher />
            <div id={OVER_ROOT_ID}>
