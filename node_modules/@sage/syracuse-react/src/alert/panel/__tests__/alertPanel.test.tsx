...
import { IDiagnose, IPanelField, IAlertPanel, Severity } from '../../alert';
    ...
    describe('Fields', () => {
        describe('Error', () => {
            ...
            it('should render fields', () => {
                ...
                expect(component.find('.s_alertpanel_diagnose_msg_pre').text()).toBe('Test Diagnose Panel Message');
            });
    ...
    describe('Levels', () => {
        ...
        describe('Multi', () => {
            ...
            it('should render various panels according to the props correctly', () => {
                ...
                expect(component.find('.s_alertpanel_diagnose_banner').at(0)).toHaveClassName('s_alert_banner_success');
                expect(component.find('.s_alertpanel_diagnose_banner').at(1)).toHaveClassName('s_alert_banner_error');

                expect(component.find('.s_alertpanel_diagnose').at(1).find('.s-alertpanel_toggle_details').length).toBe(1);

                expect(component.find('.s_alertpanel_diagnose_banner').at(2)).toHaveClassName('s_alert_banner_info');
                expect(component.find('.s_alertpanel_diagnose_banner').at(3)).toHaveClassName('s_alert_banner_error');
                expect(component.find('.s_alertpanel_diagnose_banner').at(4)).toHaveClassName('s_alert_banner_warning');
            });
        });
    });
});
