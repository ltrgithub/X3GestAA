...
class SyraPageModal implements SyraModal.ISyraModal {
    ...
    onResize = (dom: PageModalDom) => {
        if (this.page) {
            this.page.domItem.style.maxHeight = dom.maxHeight + "px";
            this.page.contentSlot.style.maxHeight = dom.maxHeight + "px";
            this.page.resizeItem(true);
            if (this.page.bars && this.page.bars.length) {
                let dialogWidth = dom.modalContent.getBoundingClientRect().width;
                dom.modalContent.style.width = dialogWidth + "px";
            }
        }
    }
    onOk = () => {
