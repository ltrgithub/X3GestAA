...
function loadLibInfo(cb) {
	...
	syra_ajax.send({
		url: "/ui-chart/public/deps/flash/FLASH/FlowCharting/xtec/sage_libraries/sage_basic/sgx_libsinfo.txt",
...
exports.stylesheets = ["/ui-visual-process/public/player.css"];
