...
module.exports = {
	...
	getDefaultFontSize: function(native) {
		return rtfBuilder.getDefaultFontSize(native);
	},
	getDefaultFontFace: function(opts) {
		return rtfBuilder.getDefaultFontFace(opts);
	}
};