...
var RTF = require("../fixtures/rtfHelper").RTF;
...
describe(module.id, () => {
	...
	it('Combine Basic Emphasis', function() {
		var rtf = new RTF();
	...
	it('lquote rquote stylesheet tab', function() {
		var rtf = new RTF("{\\stylesheet{ Normal;}{\\s1 heading 1;}{\\s2 heading 2;}{\\s3 heading 3;}}");
		//rtf.equals("\\lquote quotes\\lquote\\tab after tab", "'quotes'<span style=\"margin-left: 10pt\">after tab</span>", "lquote rquote stylesheet tab");
		rtf.equals("\\lquote quotes\\lquote\\tab after tab", "'quotes'<blockquote>after tab</blockquote>", "lquote rquote stylesheet tab");
	});
	it('X3 RTF Editor Input', function() {
	...
	it('Standard Font sizes', function() {
		var rtf = new RTF(),
	...
	it('Unicode', function() {
		...
		rtf.equals("aaa \\u233?\\u233?\\u233? bbb", "aaa ééé bbb", "Mixing ansi and unicode characters");
	});
	it('More Fonts', function() {
		var rtf = new RTF();
		rtf //
			.charset("\\rtf1\\ansi") //
	...
	it('Bullet and Numbering', function() {
		var rtf = new RTF();
		rtf //
			.charset("\\rtf1\\ansi") //
...
', "Bullet list");
	...
	it('Alignment', function() {
		...
		rtf.equals( //
			...
			'<blockquote><div align="center"><p>centered text + left margin</p></div></blockquote>', //
	...
	it('Misc', function() {
		...
		rtf.equals( //
			"##  ## 2 blanks between hash signs", //
			"## &nbsp;## 2 blanks between hash signs", //
			"2 blanks");

		rtf.equals( //
			"##   ## 3 blanks between hash signs", //
			"## &nbsp; ## 3 blanks between hash signs", //
			"3 blanks");

		rtf.equals( //
			"##    ## 4 blanks between hash signs", //
			"## &nbsp; &nbsp;## 4 blanks between hash signs", //
			"4 blanks");

		rtf.equals( //
			"##     ## 5 blanks between hash signs", //
			"## &nbsp; &nbsp; ## 5 blanks between hash signs", //
			"5 blanks");
		/*
		rtf.equals( //
			"{\\fs22\\highlight2 1}{\\fs36\\highlight2 2}{\\fs52\\highlight2 3}456\\par", //
			"<p><span style='font-size: 11pt;'><span style='font-size: 11pt;'><span style='background-color: #ff0000;'>1</span></span></span><span style='font-size: 18pt;'><span style='background-color: #ff0000;'>2</span></span><span style='font-size: 26pt;'><span style='background-color: #ff0000;'>3</span></span><span style='font-size: 11pt;'>456</span></p>", //
