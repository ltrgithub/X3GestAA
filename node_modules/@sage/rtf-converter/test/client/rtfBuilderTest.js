...
var rtfbuilder = require("../../lib/buildrtf");
...
describe(module.id, () => {
	...
	function testConvert(html, result, name) {
		...
		deepEqual(rtf, "{\\rtf1\\ansi" + (['\\', '{'].indexOf(result.charAt(0)) !== -1 ? "" : " ") + result.replace(/<<prefix>>/, "\\uc0\\pard\\" + _defFS) + "}", name);
	}

	var _defFS = rtfbuilder.getDefaultFontSize(true);
	...
	it('basic', function() {
		...
		testConvert("<span style='font-size:7.5pt'>fontsize7.5pt</span>", //
			"{\\fonttbl{\\f0 MS Sans Serif;}}<<prefix>>\\fs15 fontsize7.5pt\\" + _defFS + "\\par");
		...
		testConvert("<ul><li><font face='Arial'><span style='font-size:12pt'>item1</span></font></li><li>item2</li></ul>", //
			prefix+"{\\fonttbl{\\f0 Arial;}}\\pard {\\pntext }{\\*\\pn \\pnlvlblt {\\pntxtb \\'b7 }}{\\f0 {\\" + _defFS + " item1}}\\par {\\pntext }item2\\par \\pard "+suffix, "unordered bulleted list with text formatting ");
		*/
	});
	it('Left indent', function() {
		/*Non indent
    Indent 1
        Indent 2
        Indent 2
...
*/
	...
	it('bullets', function() {
		...
		testConvert("<ul><li><font face='Arial'><span style='font-size:12pt'>item1</span></font></li><li>item2</li></ul>", //
			"{\\fonttbl{\\f0 MS Sans Serif;}{\\f1 Arial;}{\\f2 Symbol;}}<<prefix>>\\pard{\\pntext\\f2\\'B7\\tab}{\\*\\pn\\pnlvlblt\\pnf1\\pnindent0{\\pntxtb\\'B7}}\\f0\\li420\\f1\\fs24 item1\\" + _defFS + "\\par{\\pntext\\f2\\'B7\\tab}item2\\par\\pard", "unordered bulleted list with text formatting ");
...
\\f0\\li840\\f0\\fs17 item 1\\" + _defFS + "\\par\
{\\pntext\\f1\\'B7\\tab}\\f0\\fs17 item 2\\" + _defFS + "\\par\
{\\pntext\\f1\\'B7\\tab}\\f0\\fs17 item 3\\" + _defFS + "\\par\
{\\pntext\\f1\\'B7\\tab}\\f0\\fs17 item 4\\" + _defFS + "\\par\\pard\\pard\\par", //
			"single bullet list ");
 ...
 */
	...
	it('Multi-line - SAM BUG 92644', function() {
