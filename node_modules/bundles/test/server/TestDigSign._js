"use strict";
// Override module var defined by CommonJS.
var module = QUnit.module;
// load the module being tested
var check = require("bundles/sage-pt-print");

// declare the module name before the tests
module('sage-pt-print');

asyncTest('Check digital signature', 4, function(_) {
	...
	deepEqual(resp.value, "true", "Digital signature ok and Data ok = ok");

	resp = check.verifyReport(_, b64DataFileOK, b64digSignNOK);
	deepEqual(resp.value, "false", "Digital signature ok and Data nok = nok");

	resp = check.verifyReport(_, b64DataFileNOK, b64digSignOK);
	deepEqual(resp.value, "false", "Digital signature nok and Data ok = nok");

	resp = check.verifyReport(_, b64DataFileNOK, b64digSignNOK);
	deepEqual(resp.value, "false", "Digital signature nok and Data nok = nok");
