...
function postSoap(_, service, method, data) {
	...
	var response = httpClient.httpRequest(_, {
		method: "post",
		url: globals.context.session.host + '/soap-generic/x3/erp/x3/CAdxWebServiceXmlCC?oauth2=salesforce',
		headers: {
	...
	var result = {};
	try {
		result = jsonResult["soapenv:Envelope"]["soapenv:Body"];
	} catch (err) {
		result = jsonResult;
	}
...
exports.soapSave = function(_, codelang, poolAlias, publicName, requestXml) {
	...
	var resultXml = body.saveResponse.saveReturn;
	return resultXml;
};
...
exports.soapRead = function(_, codelang, poolAlias, publicName, keyName, keyValue) {
	...
	var resultXml = body.readResponse.readReturn;
	return resultXml;
};
...
exports.soapModify = function(_, codelang, poolAlias, publicName, keyName, keyValue, requestXml) {
	...
	var resultXml = body.modifyResponse.modifyReturn;
	return resultXml;
};