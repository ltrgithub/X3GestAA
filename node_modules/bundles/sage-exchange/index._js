...
exports.getRedirectUrl = function(_, values, ttl) {
	...
	var httpRoot = require('syracuse-main/lib/syracuse').config.sdata.httpRoot;
	open.open(httpRoot + '/bundles/sage-exchange/redirect?id=' + id);
};
