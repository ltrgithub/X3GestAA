...
var request_ = {
		...
		"Currency": "USD", // ISO4217 currecy code, EUR, GBP...
		//"NotificationURL": "http://172.28.8.145:8124/syracuse-main/html/main.html",
...
var registrationOptions = {
		...
		proxy: proxy || { ignoreProxy : true }
}

exports.createTokenRequest = function createTokenRequest (request) {
	var obj = sagepay.createTokenRequest(function(err, result) {
		if (err) 
			throw err;
	}, request || request_, registrationOptions);

	return obj;
}

exports.sendSPSNotificationResponse = function createTokenRequest (request, response) {
	var obj = sagepay.sendSPSNotificationResponse(function(err, request, response) {
		if (err) 
			throw err;
	}, request, response);
