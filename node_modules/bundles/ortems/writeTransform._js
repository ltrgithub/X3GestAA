...
exports.transformKey = function (_, parsedUrl) {
	var transformationData = _getTransformationData(_, parsedUrl);

	var transformedKey = "";
	if (parsedUrl.key.indexOf("~") > 0 && transformationData.X3KEYFMT  && transformationData.X3KEYFMT.length) {
		var splitKeys = parsedUrl.key.split("~");
