...
exports.parseRequestUrl = function(_, requestUrl) {
	...
	result.facet = this.getFacet(_, result.representation);
...
exports.getRecord = function(_, endpoint, representationName, key) {
	...
	try {
		...
		var instance = entity && db.fetchInstance(_, entity, key);
		data = instance && instance.serializeInstance(_);
	} catch (e) {
		data = {
			"mess": "fetchInstance error: " + e.message + ((exports.$debug === true) ? "\n  at " + e.stack : ""),
			"sev": "error"
		};
	}
	return data;
