	...
	$services: {
		...
		importToMongo: {
			...
			$execute: function(_, context, instance) {
				...
				var data = JSON.parse(context.request.readAll(_));
				var absoluteFilenames = data.absoluteFilenames;
				...
				var syncInstance = sync.newSync(endPoint.getEtnaConfig(_), context.tracker);
		...
		importPatches: {
			...
			$execute: function(_, context, instance) {
				...
				try {
					...
					console.log("XXXXXXXXXXXX Error : " + err.stack);
