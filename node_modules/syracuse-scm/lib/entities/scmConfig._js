	...
	$services: {
		...
		importPatches: {
			...
			$execute: function(_, context, instance) {
				...
				console.log("ENDPOINT NAME = " + data.endPoint);
				...
				data.patchNames.forEach_(_, function(_, patchFilename) {
					...
					patch.path(_, "PATCH/" + patchFilename);
				...
				update.version(_, "10.0.0"); // SDD TEMP HACK
				update.save(_);

				var errorMessage = undefined;
				try {
					console.log("TTTTTTTTTTTTTTTT APPLYUPDATE.1");
					update.applyUpdate(_, context);
					console.log("TTTTTTTTTTTTTTTT APPLYUPDATE.2");
				} catch (err) {
