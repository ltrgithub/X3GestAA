...
exports.parseForConflicts = function(_, etnaConfig, superv, entityType, jsonFile, options) {

	var atLeastOneConflictFixed = false;

	var localizedLabels = {};

	function _findDifferences(_, superv, entityDescriptor, propName, path, valLocal, valRemote, options) {
		...
		function indexArray(entityDescriptor, array) {
		...
		function getOrderBy(entityDescriptor) {
