            ...
            success: function(data, statusText, xhr){
                ...
                for (var i = 1; i < parts.length - 1; i++) {
                    ...
                    if (key === "sources") 
                        ...
                        _modules[location].__resources = JSON.parse(body);
                }
                if (key === "sources") 
                    _known.push(arg);
                return callback();
    ...
    function _sandbox(path, that, opts){
        ...
        try {
            ...
            var require = function(id, that, opts){
                return _sandbox(_combine(path, id), that, opts);
            };
            ...
            throw new Error("module initialization failed: " + path + ": " + ex.stack);
        }
    }
