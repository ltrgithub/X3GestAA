exports.countries=[{code: "AD", description: "Andorra"},
...
{code: "CD", description: "Congo(Democratic Republic of the)"},
...
{code: "FÖ", description: "Faroe Islands"},
...
{code: "KP", description: "Korea(Democratic People's Republic of)"},
...
{code: "MK", description: "The Former Yugoslav Republic of Macedonia"},
...
{code: "PS", description: "Palestinian Territories"},
{code: "PT", description: "Portugal"},
{code: "PY", description: "Paraguay"},
{code: "QC", description: "Quebec (Canadian province)"},
...
{code: "SU", description: "Union of Soviet Socialist Republics(until December 1991)"},
{code: "SV", description: "El Salvador"},
{code: "SY", description: "Syria(Syrian Arab Republic)"},
...
{code: "ZR", description: "Zaire(see CD - Congo, the Democratic Republic of the)"},
