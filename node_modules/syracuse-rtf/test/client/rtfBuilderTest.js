...
test('basic', function() {
	testConvert("<b>bold</b>", "\\b bold", "simple tag ");
	testConvert("first line<br>next line<br>and another one", "first line\\line next line\\line and another one", "newlines ");

	testConvert("<font face='Arial'>fontarial</font>", "{\\fonttbl{\\f0 Arial;}}\\f0 fontarial", "font face ");
	...
	"\\fs15 fontsize7.5pt", "font-size ");
	testConvert("<font color='#ff0000'>red</font>", //
	"{\\colortbl;\\red255\\green0\\blue0;}\\cf1 red", "font color ");
	testConvert("<span style='color:rgb(255,0,0)'>redstyle</span>", //
	"{\\colortbl;\\red255\\green0\\blue0;}\\cf1 redstyle", "color ");
	testConvert("<span style='background-color:rgb(255,0,0)'>redbackground</span>", //
	"{\\colortbl;\\red255\\green0\\blue0;}\\highlight1 redbackground", //
	"background color ");
	testConvert("<div align='center'>centered text</div>", //
	"\\pard\\qc centered text\\par\\pard", "alignement  ");

	testConvert("<b>ﻼ</b>", "\\b\\u65276", "unicode character alone");
	testConvert("<b>beforeﻼafter</b>", "\\b before\\u65276 after", "unicode character inside text ");

	testConvert("<div style='margin-left:40px'>left indented text</div>", //
	"\\pard\\li600 left indented text\\par\\pard", "indentations paragraphe ");
...
test('bullets', function() {
	testConvert("<ul><li>item1</li><li>item2</li></ul>", //
	"{\\fonttbl{\\f0 Symbol;}}\\pard{\\pntext\\f0\\'B7\\tab}{\\*\\pn\\pnlvlblt\\pnf1\\pnindent0{\\pntxtb\\'B7}}item1\\par{\\pntext\\f0\\'B7\\tab}item2\\par", "unordered bulleted list  ");

	testConvert("<ul><li><font face='Arial'><span style='font-size:12pt'>item1</span></font></li><li>item2</li></ul>", //
	"{\\fonttbl{\\f0 Arial;}{\\f1 Symbol;}}\\pard{\\pntext\\f1\\'B7\\tab}{\\*\\pn\\pnlvlblt\\pnf1\\pnindent0{\\pntxtb\\'B7}}\\f0\\fs24 item1\\par{\\pntext\\f1\\'B7\\tab}item2\\par", "unordered bulleted list with text formatting ");
...
<li><font face="MS Sans Serif"><span style="font-size: 8.5pt;">item 4</span></font></li>\
	...
	"{\\fonttbl{\\f0 MS Sans Serif;}{\\f1 Symbol;}}\\pard\\li720\\pard{\\pntext\\f1\\'B7\\tab}{\\*\\pn\\pnlvlblt\\pnf1\\pnindent0{\\pntxtb\\'B7}}\
\\f0\\fs17 item 1\\par\
...
test('Multi-line - SAM BUG 92644', function() {
	...
	"Ligne 1 Ligne 1 Ligne 1\\line Ligne 2 Ligne 2 Ligne 2 \\line Ligne 3 Ligne 3 Ligne 3\\line", // -->
