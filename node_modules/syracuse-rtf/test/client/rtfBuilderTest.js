...
test('basic', function() {
	testConvert("<b>bold</b>", "{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard\\b bold\\b0\\par", "simple tag ");
	testConvert("first line<br>next line<br>and another one", "{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard first line\\par next line\\par and another one\\par", "newlines ");

	testConvert("<font face='Arial'>fontarial</font>", "{\\fonttbl{\\f0 MS Sans Serif;}{\\f1 Arial;}}\\uc0\\pard\\f1 fontarial\\par", "font face ");
	testConvert("<font face='Arial'>fontarial</font>" + // -->
		...
		"\\uc0\\pard{\\f1 fontarial}\\f2 fontbitstreamcharter\\par", //
		"font face x2");
	testConvert("<span style='font-size:7.5pt'>fontsize7.5pt</span>", //
		"{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard\\fs15 fontsize7.5pt\\fs16\\par");
	testConvert("<font color='#ff0000'>red</font>", //
		"{\\fonttbl{\\f0 MS Sans Serif;}}{\\colortbl;\\red255\\green0\\blue0;}\\uc0\\pard\\cf1 red\\cf0\\par", "font color ");
	testConvert("<span style='color:rgb(255,0,0)'>redstyle</span>", //
		"{\\fonttbl{\\f0 MS Sans Serif;}}{\\colortbl;\\red255\\green0\\blue0;}\\uc0\\pard\\cf1 redstyle\\cf0\\par", "color ");
	testConvert("<span style='background-color:rgb(255,0,0)'>redbackground</span>", //
		"{\\fonttbl{\\f0 MS Sans Serif;}}{\\colortbl;\\red255\\green0\\blue0;}\\uc0\\pard\\highlight1 redbackground\\highlight0\\par", //
		"background color ");
	testConvert("<div align='center'>centered text</div>", //
		"{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard\\pard\\qc centered text\\par\\pard\\par", "alignement  ");

	testConvert("<b>ﻼ</b>", "{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard\\b\\u65276\\b0\\par", "unicode character alone");
	testConvert("<b>beforeﻼafter</b>", "{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard\\b before\\u65276 after\\b0\\par", "unicode character inside text ");

	testConvert("<b>étage</b>", "{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard\\b\\u233 tage\\b0\\par", "simple unicode character");

	testConvert("<div style='margin-left:40px'>left indented text</div>", //
		"{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard\\li600 left indented text\\pard\\par", "indentations paragraphe ");

	testConvert("<p style='margin:0cm 0cm 10px; text-align:right'>Align right</p>", //
		"{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard\\pard\\qr Align right\\par\\pard\\par", "Align and copy/past from word");
	testConvert("<p style='margin: 0cm 0cm 10pt;'><font size='3'><font face='Calibri'>Align left</font></font></p>", //
		"{\\fonttbl{\\f0 MS Sans Serif;}{\\f1 Calibri;}}\\uc0\\pard\\fs24\\f1 Align left\\par", "Align left and copy/past from word");
	testConvert("<p><span style='font-size: 11pt; background-color: #ff0000;'>1</span><span style='font-size: 18pt; background-color: #ff0000;'>2</span><span style='font-size: 26pt; background-color: #ff0000;'>3</span>456</p>", //
		"{\\fonttbl{\\f0 MS Sans Serif;}}{\\colortbl;\\red255\\green0\\blue0;}\\uc0\\pard{\\fs22\\highlight1 1}{\\fs36\\highlight1 2}{\\fs52\\highlight1 3}456\\par", "Background-color and font size");
	testConvert(">> &nbsp;<<", "{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard >>  <<\\par", "2 blanks");
	testConvert(">> &nbsp; <<", "{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard >>   <<\\par", "3 blanks");
	testConvert(">> &nbsp; &nbsp;<<", "{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard >>    <<\\par", "4 blanks");
	testConvert(">> &nbsp; &nbsp; <<", "{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard >>     <<\\par", "5 blanks");
	...
	testConvert("<ul><li><font face='Arial'><span style='font-size:12pt'>item1</span></font></li><li>item2</li></ul>", //
		prefix+"{\\fonttbl{\\f0 Arial;}}\\pard {\\pntext }{\\*\\pn \\pnlvlblt {\\pntxtb \\'b7 }}{\\f0 {\\fs16 item1}}\\par {\\pntext }item2\\par \\pard "+suffix, "unordered bulleted list with text formatting ");
	*/
});
...
*/
	testConvert('Non indent<blockquote style="margin: 0 0 0 40px; border: none; padding: 0px;"><div>Indent 1</div></blockquote><blockquote style="margin: 0 0 0 40px; border: none; padding: 0px;"><blockquote style="margin: 0 0 0 40px; border: none; padding: 0px;"><div>Indent 2</div></blockquote><blockquote style="margin: 0 0 0 40px; border: none; padding: 0px;"><div>Indent 2</div></blockquote></blockquote><blockquote style="margin: 0 0 0 40px; border: none; padding: 0px;"><div>Indent 1</div></blockquote><div>Non indent</div>', //
		"{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard Non indent\\par\\li600 Indent 1\\par\\pard\\li1200 Indent 2\\par\\pard\\li1200 Indent 2\\par\\pard\\li600 Indent 1\\par\\pard Non indent\\par", "Left indented chrome fist form");
	...
	testConvert('<p>Non indent</p><blockquote style="margin: 0 0 0 40px; border: none; padding: 0px;"><p>Indent 1</p></blockquote><blockquote style="margin: 0 0 0 40px; border: none; padding: 0px;"><blockquote style="margin: 0 0 0 40px; border: none; padding: 0px;"><p>Indent 2</p></blockquote><blockquote style="margin: 0 0 0 40px; border: none; padding: 0px;"><p>Indent 2</p></blockquote></blockquote><blockquote style="margin: 0 0 0 40px; border: none; padding: 0px;"><p>Indent 1</p></blockquote><p>Non indent</p>', //
		"{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard Non indent\\par\\li600 Indent 1\\par\\pard\\li1200 Indent 2\\par\\pard\\li1200 Indent 2\\par\\pard\\li600 Indent 1\\par\\pard Non indent\\par", "Left indented chrome second form");
	...
	testConvert('Non indent<div><blockquote style="margin: 0 0 0 40px; border: none; padding: 0px;"><div>Indent 1</div></blockquote></div><blockquote style="margin: 0 0 0 40px; border: none; padding: 0px;"><div><blockquote style="margin: 0 0 0 40px; border: none; padding: 0px;"><div>Indent 2</div><div>Indent 2</div></blockquote>Indent 1</div></blockquote>Non indent', //
		"{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard Non indent\\par{\\li600 Indent 1\\par\\pard}\\li1200 Indent 2\\par Indent 2\\par\\pard\\li600 Indent 1\\par\\pard Non indent\\par", "Left indented chrome third form");
	...
	testConvert('Non indent<br><div style="margin-left: 40px;">Indent 1<br><div style="margin-left: 40px;">Indent 2<br>Indent 2<br></div>Indent 1<br></div>Non indent<br>', //
		"{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard Non indent\\par\\li600 Indent 1\\par\\li1200 Indent 2\\par Indent 2\\par\\li600 Indent 1\\par\\pard Non indent\\par", "Left indented FireFox first form");
	...
	testConvert('<p>Non indent</p><p style="margin-left: 40px;">Indent 1</p><p style="margin-left: 80px;">Indent 2</p><p style="margin-left: 80px;">Indent 2</p><p style="margin-left: 40px;">Indent 1</p><p>Non indent<br></p>', //
		"{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard Non indent\\par\\li600 Indent 1\\par\\pard\\li1200 Indent 2\\par\\pard\\li1200 Indent 2\\par\\pard\\li600 Indent 1\\par\\pard Non indent\\par\\par", "Left indented FireFox second form");
...
test('bullets', function() {
	testConvert("<ul><li>item1</li><li>item2</li></ul>", //
		"{\\fonttbl{\\f0 MS Sans Serif;}{\\f1 Symbol;}}\\uc0\\pard\\pard{\\pntext\\f1\\'B7\\tab}{\\*\\pn\\pnlvlblt\\pnf1\\pnindent0{\\pntxtb\\'B7}}\\f0\\li420item1\\par{\\pntext\\f1\\'B7\\tab}item2\\par\\pard", "unordered bulleted list  ");

	testConvert("<ul><li><font face='Arial'><span style='font-size:12pt'>item1</span></font></li><li>item2</li></ul>", //
		"{\\fonttbl{\\f0 MS Sans Serif;}{\\f1 Arial;}{\\f2 Symbol;}}\\uc0\\pard\\pard{\\pntext\\f2\\'B7\\tab}{\\*\\pn\\pnlvlblt\\pnf1\\pnindent0{\\pntxtb\\'B7}}\\f0\\li420\\f1\\fs24 item1\\fs16\\par{\\pntext\\f2\\'B7\\tab}item2\\par\\pard", "unordered bulleted list with text formatting ");
...
<li><font face="MS Sans Serif"><span style="font-size: 8.5pt;">item 4</span></font></li>\
		...
		"{\\fonttbl{\\f0 MS Sans Serif;}{\\f1 Symbol;}}\\uc0\\pard\\li720\\pard{\\pntext\\f1\\'B7\\tab}{\\*\\pn\\pnlvlblt\\pnf1\\pnindent0{\\pntxtb\\'B7}}\
\\f0\\li840\\f0\\fs17 item 1\\fs16\\par\
{\\pntext\\f1\\'B7\\tab}\\f0\\fs17 item 2\\fs16\\par\
{\\pntext\\f1\\'B7\\tab}\\f0\\fs17 item 3\\fs16\\par\
{\\pntext\\f1\\'B7\\tab}\\f0\\fs17 item 4\\fs16\\par\\pard\\pard\\par", //
		"single bullet list ");
...
test('Multi-line - SAM BUG 92644', function() {
	...
	testConvert("Ligne 1 Ligne 1 Ligne 1<br>Ligne 2 Ligne 2 Ligne 2 <br>Ligne 3 Ligne 3 Ligne 3<br>", // -->
		"{\\fonttbl{\\f0 MS Sans Serif;}}\\uc0\\pard Ligne 1 Ligne 1 Ligne 1\\par Ligne 2 Ligne 2 Ligne 2 \\par Ligne 3 Ligne 3 Ligne 3\\par", // -->
