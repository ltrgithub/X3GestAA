...
test('basic', function() {
	testConvert("<b>bold</b>", "\\uc0\\pard\\b bold\\b0", "simple tag ");
	testConvert("first line<br>next line<br>and another one", "\\uc0\\pard first line\\par next line\\par and another one", "newlines ");
	...
	testConvert("<span style='font-size:7.5pt'>fontsize7.5pt</span>", //
		"\\uc0\\pard\\fs15 fontsize7.5pt\\fs24");
	...
	testConvert("<span style='color:rgb(255,0,0)'>redstyle</span>", //
		"{\\colortbl;\\red255\\green0\\blue0;}\\uc0\\pard\\cf1 redstyle\\cf0", "color ");
	...
	testConvert("<b>ﻼ</b>", "\\uc0\\pard\\b\\u65276\\b0", "unicode character alone");
	testConvert("<b>beforeﻼafter</b>", "\\uc0\\pard\\b before\\u65276 after\\b0", "unicode character inside text ");

	testConvert("<b>étage</b>", "\\uc0\\pard\\b\\u233 tage\\b0", "simple unicode character");

	testConvert("<div style='margin-left:40px'>left indented text</div>", //
		"\\uc0\\pard\\pard\\li600 left indented text\\pard", "indentations paragraphe ");
...
test('bullets', function() {
	testConvert("<ul><li>item1</li><li>item2</li></ul>", //
		"{\\fonttbl{\\f0 Symbol;}}\\uc0\\pard\\pard{\\pntext\\f0\\'B7\\tab}{\\*\\pn\\pnlvlblt\\pnf1\\pnindent0{\\pntxtb\\'B7}}item1\\par{\\pntext\\f0\\'B7\\tab}item2\\par\\pard", "unordered bulleted list  ");

	testConvert("<ul><li><font face='Arial'><span style='font-size:12pt'>item1</span></font></li><li>item2</li></ul>", //
		"{\\fonttbl{\\f0 Arial;}{\\f1 Symbol;}}\\uc0\\pard\\pard{\\pntext\\f1\\'B7\\tab}{\\*\\pn\\pnlvlblt\\pnf1\\pnindent0{\\pntxtb\\'B7}}\\f0\\fs24 item1\\fs24\\par{\\pntext\\f1\\'B7\\tab}item2\\par\\pard", "unordered bulleted list with text formatting ");
...
\\f0\\fs17 item 1\\fs24\\par\
{\\pntext\\f1\\'B7\\tab}\\f0\\fs17 item 2\\fs24\\par\
{\\pntext\\f1\\'B7\\tab}\\f0\\fs17 item 3\\fs24\\par\
{\\pntext\\f1\\'B7\\tab}\\f0\\fs17 item 4\\fs24\\par\\pard\\pard", //
		"single bullet list ");
...
test('Multi-line - SAM BUG 92644', function() {
	...
	testConvert("Ligne 1 Ligne 1 Ligne 1<br>Ligne 2 Ligne 2 Ligne 2 <br>Ligne 3 Ligne 3 Ligne 3<br>", // -->
		"\\uc0\\pard Ligne 1 Ligne 1 Ligne 1\\par Ligne 2 Ligne 2 Ligne 2 \\par Ligne 3 Ligne 3 Ligne 3\\par", // -->
