...
test('Bullet and Numbering', 1, function() {
    ...
    // rtf.equals("\\bullet item1\\par\\bullet item2", "<li>item1</li><p><li>item2</li></p>", "Simple Bullets with paragraphs");

    // An bullet is converted by word as below: 
    // <span style='font-size:8.5pt;font-family:Symbol'>·</span><span
    // style='font-size:8.5pt;font-family:"MS Sans Serif","sans-serif"'>item1</span>

    rtf.equals("{\\pntext\\f1\\'A5\\tab}{\\*\\pn\\pnlvlblt\\pnf1\\pnindent0" + //
    "{\\pntxtb\\'A5}}\\fi-15\\li15\\lang1036\\f0\\fs17 item 1\\par\n" + "{\\pntext\\f1\\'A5\\tab}item 2\\par\n" + //
    "{\\pntext\\f1\\'A5\\tab}item 3\\par" + //
    "{\\pntext\\f1\\'A5\\tab}item 4\\par", //
    "<ul><li>item1</li><li>item2</li><li>item3</li></ul>", "Bullet list");
});
