...
function RTF() {
    ...
    return {
        equals: function(rtf, result, name) {
            strictEqual(escape(convert.toHtml(header + rtf + suffix)), escape(result), name);
            return this;
        },
...
test('Basic', 18, function() {
    ...
    rtf.equals("{\\fs15 fontsize7.5pt}", //
    '<span style="font-size:7.5pt;">fontsize7.5pt</span>', //
    "font-size ");
