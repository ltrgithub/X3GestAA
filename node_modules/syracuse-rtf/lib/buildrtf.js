			...
			rules.forEach(function(e) {
				...
				switch (stylerule[0]) {
					...
					case 'margin-bottom':
						...
						break;
					case 'margin':
						if (!$(n).attr('style').search("text-align")) { // special case : copy from word with alignement twice margin and text-align. The best way will be to clean html before but ...
							$(n).contents().each(visit);
							if (n.nodeName === "P") {
								bld.control("par");
							}
