...
function builder(documentModel) {
	...
	if (colors.length > 1) {
		...
		colors.forEach(function(e) {
			if (e[0] == 0 && e[1] == 0 && e[2] == 0) rtftext += ';';
			else rtftext += "\\red" + e[0] + "\\green" + e[1] + "\\blue" + e[2] + ";";
		});
		rtftext += "}";
	}
...
exports.buildRtf = function(html) {
			...
			rules.forEach(function(e) {
				...
				switch (stylerule[0]) {
					case 'color':
						...
						} else var idx = findColorInColortbl(stylerule[1]);
	...
	function visit(i, e) {
		...
		var grp = $e.contents().length > 0 && e.nextSibling != null && !$e.is("ul") && !$e.is("li");
		if (grp) bld.fragment("{");
		processNode(e, i);
