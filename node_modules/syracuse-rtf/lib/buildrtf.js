...
exports.buildRtf = function(html) {
	...
	if (html.includes('body')) {
		html = html.replace('<body', '<p><span');
		html = html.replace('</body>', '</span></p>');
	}
