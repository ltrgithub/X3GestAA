...
<body>
	<div class="container">
		<div class="s-text-containt">
			<div class="s-text">
				<div class="s-product">
                <span class="s-m-signin">{{signInLabel}} </span>
				...
				<div class="s-visibility-{{passwordVisibility}}">
					<div class="z-field">
						<input id="username"  autocomplete="{{loginAutoComplete}}" placeholder="{{loginLabel}}" type="text">
					</div>
					<div class="z-field">
						<input id="password"  autocomplete="{{passwordAutoComplete}}" placeholder="{{passwordLabel}}" type="password">
					</div>
					<div class="z-field s-visibility-{{keepConnectedVisibility}}" id="check">
    				...
    				<input style="display:none;" onclick="javascript:authenticate(); return false;" type="submit"><!-- to capture enter key -->
    			</div>
				</form>
			</div>
