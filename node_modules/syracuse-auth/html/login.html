...
<body>
	<div class="container">
		<div class="s-text-containt">
			<div class="s-text">
				<div class="s-product">
                <span class="s-m-signin">Sign in for </span>
			...
			<div class="s-text s-visibility-{{oauth2Visibility}}" >
				<div class="s-product-other">{{oauth2Title}}</div>
				<div id="oauth2-0" class="z-action" >
					<a href=""></a>
				</div>
			</div>
