		...
		<div class="s-text-containt">
			<div class="s-text">
				...
				<div class="s-visibility-{{passwordVisibility}}">
					...
					<div class="s-visibility-{{passwordVisibility}}">
						<div class="z-field">
							<input id="username"  autocomplete="{{loginAutoComplete}}" onclick="javascript:askResign()" onkeypress="javascript:askResign()" placeholder="{{loginLabel}}" type="text">
						</div>
						<div class="z-field">
							<input id="password"  autocomplete="{{passwordAutoComplete}}" onclick="" placeholder="{{passwordLabel}}" type="password">
						</div>
						<div class="z-field" id="check" style="visibility:hidden;">
