...
function genPage(_, request, response) {
	var params = {};
	['loginLabel', 'passwordLabel', 'dbGo', 'ldapGo', 'oauth2Title', 'sageIdTitle', 'sageIdSignOn', 'sageIdRegister', 'sageIdRegisterExist'].forEach(function(label) {
...
function submit(_, request, response) {
	if (!require('syracuse-auth/lib/dispatcher').ensureAuthenticated(_, request, response)) return;
