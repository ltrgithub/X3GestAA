...
function genPage(_, request, response) {
	...
	var params = {};
	['loginLabel', 'passwordLabel', 'keepConnectedLabel', 'dbGo', 'ldapGo', 'oauth2Title', 'sageIdTitle', 'sageIdSignOn', 'sageIdRegister', 'sageIdRegisterExist', 'loggedAtLabel', 'keepConnectedLabel', 'forgetMeLabel'].forEach(function(label) {
