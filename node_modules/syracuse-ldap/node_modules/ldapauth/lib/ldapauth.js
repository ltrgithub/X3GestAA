...
// EM: remove dependency var bcrypt = require('bcrypt');
...
// EM: remove dependency   this._salt = bcrypt.genSaltSync();
}

// EM: unbinding adminClient and userClient unconditionally, because otherwise node will not terminate
