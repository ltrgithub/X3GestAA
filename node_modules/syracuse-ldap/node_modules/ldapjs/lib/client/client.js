    ...
    connectSocket(function (err) {
      if (!err) {
        ...
        self._connectRetry = null;
    	  ...
    	  // hack: extract callback from queue and call it directly
    	  if (self.queue && self.queue._queue && self.queue._queue[0] && self.queue._queue[0][3]) {
    		  var q = self.queue._queue.shift();
    		  q[3](err);
    	  } else
    		  retry.backoff(err);
      }
