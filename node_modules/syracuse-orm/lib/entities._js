...
exports.Entity = helpers.defineClass(Entity, null, {
	...
	addServicesLinks: function(reprType, resource, isChild) {
		...
		forEachKey(self.$services, function(key, service) {
			...
			s.$description = _getTranslatedString(stringRes, [entity.alias, "$services", key, "$description"], true) || service.$description || key;
			s.$confirm = _getTranslatedString(stringRes, [entity.alias, "$services", key, "$confirm"], true) || service.$confirm || key;
