...
helpers.defineClass(X3DbHandle, null, {
	...
	postAction: function(_, operation, entity, facet, params, representation) { //TODO test
		...
		// if params is string, then it's the object key, or a filter otherwise
		//
		var trackingId = helpers.uuid.generate(_);

		var url = this._baseUrl + "/" + entity.name + "/$template/$workingCopy?representation=" + (representation ? representation : entity.name) + "." + facet + "&traeckingId=" + trackingId;
		...
		// TOOD check if creation of working copy works fine
