...
function Factory(entityMeta) {
	...
	_proto.syncCreateChild = function(_, relationName, key, data) {
		...
		if((relationName === "vignettes") && (targetType.factory._meta.name !== targetType.factory._entityMeta.name)) {
			var a = targetType.factory._meta.name;
			var b = targetType.factory._entityMeta.name;
			console.error("FATAL FACTORY VIGNETTES FACTORY TYPEOF META ("+typeof a+") != _META ("+b+") - (2603)");
			console.error("FATAL FACTORY VIGNETTES FACTORY META ("+a+") != _META ("+b+") - (2604)");
		}
