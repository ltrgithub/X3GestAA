...
function _addDiscussionFeed(_, resource) {
	var adminDb = adminHelper.getCollaborationOrm(_);
	var feed = adminDb.fetchInstance(_, adminDb.model.getEntity(_, "discFeed"), {
		jsonWhere: {
			resourceId: resource.$uuid
		}
	});
	resource.discussionFeed = feed ? feed.message(_) : {};

}

exports.addDiscussionFeed = _addDiscussionFeed;
