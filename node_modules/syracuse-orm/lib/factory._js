...
var heapdumpLoaded = require.resolve('heapdump');
...
function Factory(entityMeta) {
	...
	var Instance = heapdumpLoaded //
	? eval("(function " + helpers.string.capitalize(entityMeta.name) + "(connection) { Constructor.call(this, connection); })") //
	: Constructor;
