...
var adminEndpoint = adminTestFixtures.modifyCollaborationEndpoint("mongodb_example");
//add model
var testEp = {
...
asyncTest("init database", 1, function(_) {
	...
	var _db = adminTestFixtures.newMongoDb(adminEndpoint.datasets["mongodb_example"].database, server, {});
	_db = _db.open(_);
	_db.dropDatabase(_);
	var server = new mongodb.Server(testEp.datasets["mongodb_example"].hostname, testEp.datasets["mongodb_example"].port, {});
	var _db = adminTestFixtures.newMongoDb(testEp.datasets["mongodb_example"].database, server, {});
	_db = _db.open(_);
	_db.dropDatabase(_);
