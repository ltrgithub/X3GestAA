...
var endPoint = testHelpers.modifyCollaborationEndpoint("mongodb_example");
var testEp = {
...
asyncTest("init database", 1, function(_) {
	...
	var _db = new mongodb.Db(testEp.datasets["test"].database, server, {});
	_db = _db.open(_);
	_db.dropDatabase(_);
...
asyncTest("get database handle", 0, function(_) {
	db = dataModel.getOrm(_, _getModel(), testEp.datasets.test);
