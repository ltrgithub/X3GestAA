...
asyncTest("atomic counter", 7, function(_) {
	strictEqual(db.getCounterValue(_, "dom1", "code1", true), 1, "Counter first val ok");
	strictEqual(db.getCounterValue(_, "dom1", "code1", 10), 11, "Counter increment 10 val ok");
	strictEqual(db.getCounterValue(_, "dom1", "code1", true), 12, "Counter increment true val ok");
	strictEqual(db.getCounterValue(_, "dom1", "code2", 1), 1, "Counter code isolation val ok");
	strictEqual(db.getCounterValue(_, "dom2", "code1", 10), 10, "Counter domain isolation val ok");
	// no increment
	strictEqual(db.getCounterValue(_, "dom2", "code1"), 10, "No increment val ok");
	strictEqual(db.getCounterValue(_, "dom2", "code1"), 10, "No increment val (2) ok");
