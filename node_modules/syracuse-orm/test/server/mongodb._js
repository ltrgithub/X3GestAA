...
module('mongodb'); //the name of the module you want to test
asyncTest('MongoDb driver test', 5, function(_) {

	var sys = require("util");
	var mongodb = require('streamline-mongodb');
	//var Connection = require('streamline-mongodb').Connection, BSON = require('streamline-mongodb').BSONNative;
	var server = new mongodb.Server('localhost', 27017, {});

	// connecting
	var db = new mongodb.Db('test_mongo', server, {});
	...
	while (doc = cursor.nextObject(_)) {
		console.log("doc: " + sys.inspect(doc));
	}
	...
	docs.forEach(function(doc) {
		//	    console.log("Doc from Array " + sys.inspect(doc));
		// TODO
	});
