...
function config(persistence, dialect) {
  ...
  persistence.schemaSync = function (tx, callback, emulate) {
    var args = argspec.getArgs(arguments, [
        ...
        // TODO: review: defaultValue was function() {} before I introduced futures
    ...
    if (!callback)
      return persistence.future.call(this, this.schemaSync, [tx, null, emulate], 1);
  ...
  persistence.DbQueryCollection.prototype.list = function(tx, callback) {
    ...
    callback = args.callback;
    if (!callback)
      return persistence.future.call(this, this.list, [tx]);
