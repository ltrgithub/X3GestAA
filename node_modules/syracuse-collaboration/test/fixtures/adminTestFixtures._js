...
exports.modifyCollaborationEndpoint = function(datasetName, fctModel, testData, initScript) {
	...
	contract.dbMeta.initScript = initScript || "syracuse-admin-init-unittest.json";
