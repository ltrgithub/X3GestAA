...
asyncTest("create restrictions on documents", 50, function(_) {
	// ========== Documents =============
...
asyncTest("read restrictions on teams", 12, function(_) {
	// ========== Teams ===========
...
asyncTest("update restrictions on documents", 32, function(_) {
	// ========== Documents =============
...
asyncTest("delete restrictions on documents", 26, function(_) {
	// ========== Documents =============	
	// Who can delete a document not associated to a team ? phgat
