...
asyncTest("create restrictions on teams", 8, function(_) {
	...
	var dd = body.$properties.administrator.$diagnoses;
...
asyncTest("create restrictions on documents", 51, function(_) {
	...
	ok(body.teams == null || (Array.isArray(body.teams) && body.teams.lenght === 0), "Document (WC) save with paric that is not a member of the team the team is not associated");
