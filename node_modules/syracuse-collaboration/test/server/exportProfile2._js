...
testSettings.forEach_(_, function(_,test) {
 ...
 var importFile=test.profileDescr+"-import.json" ;
 var exportFile=test.profileDescr+"-export.json" ;
 ...
 var exportItems=test.exportItems ;
	function testFunc(_) {
		...
		var entity=model.getEntity("exportProfile") ;
		var profileInst = db.fetchInstance(_, entity, {jsonWhere:{code:profileCode}});
		
		jsonExport.jsonExport(_,profileInst,exportFile );
		...
		/*indata.forEach(function(it){
		var type= it.$type ;	
		}) ;
		forEachKey(, function(key, action) {
		});*/
