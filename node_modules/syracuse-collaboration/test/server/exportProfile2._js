...
asyncTest("very simple entity: entityAttribute", 16, function(_) {
	...
	var diag = [];
	jsonImport.jsonImport(_, db, "very-simple-export-profile.json", {}/*{$diagnoses:diag, tracer:console.log}*/);
...
asyncTest("combined key export profile, key properties not included in property selection ", 16, function(_) {
	...
	var diag = [];
	jsonImport.jsonImport(_, db, "combined-key-export-profile.json", {}/*{$diagnoses:diag, tracer:console.log}*/);
