...
//------------------------------------------------------
asyncTest("Create LDAP group instance", 5, function (_) {
    ...
    var elist = db.fetchInstances(_, entity, { jsonWhere: { description: "X3-STUB-EP" } });
    strictEqual(elist.length, 1, "Instance X3-STUB-EP saved");

    entity = db.model.getEntity(_, "role");
    var role = db.fetchInstance(_, entity, { jsonWhere: { code: "ADMIN" } });
    ...
    var groups = db.fetchInstances(_, entity, { jsonWhere: { description: "LDAP-GROUP-TEST" } });
    strictEqual(groups.length, 1, "Instance LDAP-GROUP-TEST saved");


    entity = db.model.getEntity(_, "user");
    var user = db.fetchInstance(_, entity, { jsonWhere: { login: "admin" } });
...
asyncTest("Init X3 sample database", 4, function (_) {
...
// LDAP get all groups 
//-------------------------------------------------
asyncTest("LDAP get all groups", 1, function (_) {
...
//-------------------------------------------------
asyncTest("LDAP import users test", 8, function (_) {
...
//-------------------------------------------------
asyncTest("LDAP update users", 5, function (_) {
...
//-------------------------------------------------
/*
asyncTest("LDAP delete users", 2, function (_) {
