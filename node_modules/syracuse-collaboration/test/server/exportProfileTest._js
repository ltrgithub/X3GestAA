...
{
	nbr : 6,
	profileDescr : "mandatory-relation",
	profileCode : "MREP",
	exportItems : [{
		className : "x3servers",
		title : "X3servers",
...
testSettings.forEach_(_, function(_, test) {
	...
	function testFunc(_) {
		...
		ok(diagnoses.length>0,"warnings raised" ) ;	
		same(diagnoses[0].severity, "warning","warning raised: "+diagnoses[0].message) ;
		//same(diagnoses[0].message, locale.format("syracuse-collaboration","mandatoryRelationProperty","applicationRef","endPoint"));
     	}
      });
