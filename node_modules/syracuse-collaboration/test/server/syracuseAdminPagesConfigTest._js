...
var doStop = false;
module("syracuseAdminPageConfigTest", {
	setup: function() {},
	teardown: function() {
		if (doStop) {
...
asyncTest("init database", 1, function(_) {
	...
	var db = new mongodb.Db(endPoint.datasets["mongodb_admin_test"].database, server, {});
	db = db.open(_);
	db.dropDatabase(_);
...
asyncTest("create configurations", 14, function(_) {
	...
	console.log("create config 2.1.0.0============");
	body = put(_, cookie, body.$url, data);
...
asyncTest("page modification history", 17, function(_) {
	...
	console.log("modify page (1)");
	body = put(_, cookie, pageUrl, body, 200);
	console.log("modify page body(1): " + sys.inspect(body, null, 4));
	...
	console.log("body(385): " + sys.inspect(body, null, 4));
	...
	// get page version 1
/*	body = get(_, cookie, "pageDatas('" + pageDataUuid + "')/$service/getVersion?_version=1", 200);
	console.log("body(408): " + sys.inspect(body, null, 4));
	strictEqual(body.testName, "version2100 mod(1)", "getVersion test 1 ok");
	strictEqual(body.$testValue1, "A dollar property", "getVersion test 2 ok");*/
	//	console.log("body: "+sys.inspect(body, null, 4));
	//
	start();
});
