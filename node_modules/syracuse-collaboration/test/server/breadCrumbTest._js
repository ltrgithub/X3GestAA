...
asyncTest("Test breadcrumb generation ", function(_) {
	...
	var breadCrumb = adminHelper.menuMapToBreadCrumb(adminHelper.getReverseMenuMap(_, date, id));
	...
	// unknow key
	var breadCrumb = adminHelper.menuMapToBreadCrumb(adminHelper.getReverseMenuMap(_, date, ""));
