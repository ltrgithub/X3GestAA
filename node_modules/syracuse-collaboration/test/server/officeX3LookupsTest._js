...
if (config.unit_test.suppress.officeX3Lookup) {
	test('TESTS SKIPPED: module is suppressed in nodelocal.js', 1, function() {
		ok(true, "dummy test");
	});
} else {
...
var doStop = false;
	...
	if (adminTestFixtures.getX3TestEndpointData(_) != null) {
	// conditional tests
