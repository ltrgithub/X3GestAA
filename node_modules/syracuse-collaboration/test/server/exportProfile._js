...
asyncTest("export Profile", 12, function(_) {
	...
	var entityIt=model.getEntity("exportProfileItem") ;
	var entityAttr=model.getEntity("entityAttribute") ;
	var appEntity=model.getEntity("application") ;
	var epEntity=model.getEntity("endPoint") ;
	console.error("dobar den  DARY");


	//function _addEndPointToApplication(_, endpoint, app, index) {
