...
var mobileAppEntity = require("syracuse-collaboration/lib/entities/mobile/mobileApplication").entity;
...
asyncTest("get mobile app meta data", 6 + 3 * Object.keys(pagesToCheck).length, function(_) {
	var res;
	...
	if (res != null) {
		...
		strictEqual(res.$dashboards.UNITTEST != null, true, "homedashboard in meta data");
