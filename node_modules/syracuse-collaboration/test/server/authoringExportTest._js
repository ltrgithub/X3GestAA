...
asyncTest("standard profile export test", 6, function(_) {
	...
	tracer && tracer("Exported object is: "+sys.inspect(res, null, 6));
	// prototypes check
	deepEqual(res.$prototypes.pageDef.$key, ["application", "representation", "facet"], "pageDef prototype key ok");
	...
	strictEqual(res.$items[2].title.default, "PageDef1 title", "Title exported ok");
	strictEqual(res.$items[2].description.default, "PageDef1 description", "Description exported ok");
