...
var baseUrl = "http://localhost:3004/sdata/syracuse/collaboration/unit_test";
...
asyncTest("Get navigation page tests", 8, function(_) {
	...
	var resp = adminTestFixtures.get(_, cookie, testUrl + "/pages('syracuse.collaboration.syracuse.home.$navigation,$page,')", 200, true);
	...
	// simulate cache
	var resp = adminTestFixtures.get(_, cookie, baseUrl + "/pages('syracuse.collaboration.syracuse.home.$navigation,$page,')", 304, true, {
		"if-none-match": etag
	});
	...
	menu.save(_);
	// get
	var resp = adminTestFixtures.get(_, cookie, baseUrl + "/pages('syracuse.collaboration.syracuse.home.$navigation,$page,')", 200, true, {
		"if-none-match": etag
	});
...
//                  U_IT1
//          U_B1
//          F_B2 // removed F_IT3 and removed FSB2
//              U_SB2
//      U_MOD1

asyncTest("navigation page update test", 28, function(_) {
	// import
	var diag = [];
