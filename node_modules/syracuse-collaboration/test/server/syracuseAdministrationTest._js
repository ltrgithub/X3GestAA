...
asyncTest("create page datas", 19, function(_) {
	...
	console.log("create page datas.create page 1:" + sys.inspect(body, null, 4));
	strictEqual(body.$authorUrl, baseUrl+contractUrl+"pageDatas('" + page1Uuid + "')/$workingCopies?representation=pageData.$edit", "Author url test");
...
asyncTest("test page fetch", 15, function(_) {
	requestCount++;
	var body;
...
asyncTest("user profile test", 11, function(_) {
	// language part========
	cookie = getCookie(_, "yoda", "yoda");
	// get userProfile WC
