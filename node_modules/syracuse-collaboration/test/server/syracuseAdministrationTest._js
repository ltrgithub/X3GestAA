...
asyncTest("group hierarchie test", 13, function(_) {
	...
	tracer && tracer("group hierarchie test body(1): "+sys.inspect(body,null,4));
	...
	tracer && tracer("body grp: " + sys.inspect(body));
	tracer && tracer("grp: ================");
...
asyncTest("link user and groups", 30, function(_) {
	...
	//	tracer && tracer("body(319): "+sys.inspect(body,null,4));
