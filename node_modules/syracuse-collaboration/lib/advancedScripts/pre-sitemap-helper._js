...
exports.cleanNavPage = function(_, db, application, contract, options) {
	...
	mods.forEach_(_, function(_, mod) {
		...
		exports._tracer && exports._tracer("\t" + nbUnlink + " submodules unlinked from module '" + mod.code + "'");
	...
	exports._tracer && exports._tracer(nbUnlink + " modules unlinked from navigation page 'home'");

	// re import everything !!!
	var importHandler = require("syracuse-import/lib/jsonImport");
	importHandler.jsonImport(_, db, application + "-" + contract + "-init.json", {
		importMode: "insert",
		$diagnoses: []
	});
};