...
var uuid = require('syracuse-core').helpers.uuid;
...
function getEndpointLogin(_) {
	...
	if (!up) return "";
	var endpoint = up.selectedEndpoint(_);
	return "" + up.user(_).getEndpointLogin(_, endpoint.$uuid).toLowerCase();
}
	...
	$properties: {
		...
		sessionType: {
			...
			$compute: function(_, instance) {
				...
				// SESSIONTYPE: when you change this, you have also to change the code in syracuse-license/lib/check marked with SESSIONTYPE
				if (last) {
