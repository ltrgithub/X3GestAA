...
exports.entity = {
	...
	$properties: {
		...
		representation: {
			...
			$description: "Representation to be indexed. Leave empty for all representations"
		}
	},
	$relations: {
		endpoint:{
...
/*				h.updateIndex(_, instance.differentialUpdate(_), {
					...
					representation: instance.representation(_) 
					//tracer: console.log
				});*/
		...
		deleteIndex: {
			...
			$execute: function(_, context, instance) {
				...
				var ep = instance.endpoint(_);
				instance.$diagnoses = instance.$diagnoses || [];
				index.deleteEndpointIndex(_, context, ep, null, instance.$diagnoses);
			}
		},
