...
exports.entity = {
	...
	$init: function(_, instance) {
		...
		elasticHelpers.checkStartSearchEngine(_, _getUrlSearchEngine(_), instance.$diagnoses, true, true);
		...
		if (instance.$diagnoses.length === 0) {
			...
			try {
				...
				instance.$diagnoses.push({
					$severity: "info",
					$message: locale.format(module, "elasticVersion", _getUrlSearchEngine(_), version.join("."))
				});
			} catch (e) {
				instance.$diagnoses.push({
					$severity: "error",
