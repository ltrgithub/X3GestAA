...
exports.configureTemplateSelection = function(_, params, context) {
	var entity = context.model.getEntity(_, "msoExcelReportMode");
	if (entity && entity.$properties.excelReportMode) {
		if (params.$msoExcelRepr && params.$msoExcelRepr.indexOf(".$details") > 0) {
			entity.$properties.excelReportMode.$enum.length = 3;
		} else {
			entity.$properties.excelReportMode.$enum = new Array({
				$value: "choose_tpl",
