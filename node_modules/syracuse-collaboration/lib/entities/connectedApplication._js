...
exports.entity = {
	...
	$functions: {
		...
		generateToken: function(_, params, options = {}) {
			...
			let exp = options.expiration || this.expiration(_);
			try {
	...
	$services: {
		...
		generateToken: {
			...
			$facets: ["$details"],
			$execute: function(_, context, instance, parameters) {
				var y = fs.readFile("c:\\Dev\\test.yml", 'utf8', _);
				instance.generateToken(_, y);
				instance.save(_);
			}
		},
	},
