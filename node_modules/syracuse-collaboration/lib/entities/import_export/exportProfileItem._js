...
exports.entity = {
	...
	$properties: {
		...
		/*$compute: function(_, instance) {
				return (instance._parent.application(_) && instance._parent.application(_).application(_)) || "syracuse";
			}*/
		...
		/*$compute: function(_, instance) {
				return (instance._parent_.application(_) && instance._parent.application(_).contract(_)) || "syracuse";
			}*/
