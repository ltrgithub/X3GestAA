...
var cvg=require('syracuse-x3/lib/convergenceSession');

// This entity is not persistent
// Data are provided on demand by convergenceSession.cvgAdmReuseClients
exports.entity = {
	$lockType: "noLock",
	$canDelete: false,
	$canCreate: false,
	...
	$fetchInstances: function(_, context, parameters) {
		...
		var entity = context.db.model.getEntity("fusionReuseClient");
