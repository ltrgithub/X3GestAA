...
function getX3Rights(_, ep, user) {
	...
	try {
		var db_rights = db.getUserRights(_, rights, !cache);
...
exports.entity = {
	...
	$services: {
		...
		etnaTest: {
			...
			$execute: function(_, context, instance, parameters) {
				require('etna-etl/lib/sync').newSync(instance.getEtnaConfig(_), context && context.tracker).exportMetadataAndPush(_, "tables", ['ATABLE', 'AABREV']);
			},
		},
*/
		etnaExportMeta: {
