	...
	$services: {
		...
		checkServer: {
			...
			$execute: function(_, context, instance) {
				...
				if (des.solution.name !== solution) throw new Error(locale.format(module, "differentSolution", solution, des.solution.name));
				...
				if (resp.statusCode < 400) {
					...
					if (folders.solution !== solution) throw new Error(locale.format(module, "differentSolution2", solution, folders.solution));
