	...
	$services: {
		...
		checkHelpBaseUrl: {
			...
			$execute: function(_, context, instance) {
				...
				var response, respData, hasErrors = false;
				...
				if (response.statusCode !== 200) {
					instance.$addError(locale.format(module, "helpUrlError", respData && respData.toString("utf8")));
					hasErrors = true;
				}
				if (!hasErrors) {
					instance.$addDiagnose("info", locale.format(module, "helpUrlOK"));
				}
			}
		},
		etnaExportMeta: {
