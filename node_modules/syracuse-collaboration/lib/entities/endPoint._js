...
exports.entity = {
	...
	$properties: {
		...
		etnaDatabaseHost: {
			...
			$isDefined: function(_, instance) {
				return instance.useEtna(_) && /^(oracle|hdb)$/.test(instance.etnaDriver(_));
			},
		},
		...
		etnaDatabaseSchema: {
			...
			$isMandatory: function(_, instance) {
				return instance.useEtna(_) && instance.etnaDriver(_) === "hdb";
			},
			$isDefined: function(_, instance) {
				return instance.useEtna(_) && instance.etnaDriver(_) === "hdb";
			},
		...
		etnaDatabaseUser: {
			...
			$isReadOnly: function(_, instance) {
				return instance.useEtna(_) && /^(oracle|sqlServer)$/.test(instance.etnaDriver(_));
			},
		},
	...
	$services: {
		...
		etnaTest: {
			...
			$execute: function(_, context, instance, parameters) {
				require('etna-etl/lib/sync').newSync(instance.getEtnaConfig(_), context && context.tracker).exportMetadataAndPush(_, ['ATABLE', 'AABREV']);
			},
		},
		etnaExportMeta: {
			...
			$execute: function(_, context, instance, parameters) {
				require('etna-etl/lib/sync').newSync(instance.getEtnaConfig(_), context && context.tracker).exportMetadataAndPush(_);
			},
		},
		etnaImportMeta: {
			...
			$execute: function(_, context, instance, parameters) {
				require('etna-etl/lib/sync').newSync(instance.getEtnaConfig(_), context && context.tracker).importMetadata(_);
			},
		},
		etnaExportData: {
			...
			$execute: function(_, context, instance, parameters) {
				require('etna-etl/lib/sync').newSync(instance.getEtnaConfig(_), context && context.tracker).exportData(_);
			},
		},
		importExportData: {
			...
			$execute: function(_, context, instance, parameters) {
				require('etna-etl/lib/sync').newSync(instance.getEtnaConfig(_), context && context.tracker).importData(_);
			},
		},
		initSearchIndex: {
			$method: "POST",
