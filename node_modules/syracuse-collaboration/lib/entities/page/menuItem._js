...
//			}
		...
		representation: {
			...
			$lookup: function(_, instance) {
				...
				if (baseUrl && instance.application(_) && instance.application(_).protocol(_) === "x3"){
					
					return {
						$type: "application/json;vnd.sage=syracuse",
						$url: baseUrl+"/AREPIDX?representation=AREPIDX.$lookup",
						$fieldMap: { representation: "NAME", entity: "CLASSE" }
					}
				}else if (baseUrl && instance.application(_) && instance.application(_).protocol(_) === "syracuse"){
					return {
						$type: "application/json;vnd.sage=syracuse",
						$url: baseUrl+"/lookupRepresentations?application={applicationName}&contract={contractName}&dataset={endpointName}&representation=lookupRepresentation.$lookup",
						$fieldMap: { representation: "name", entity: "entityName" }
					}
				}
