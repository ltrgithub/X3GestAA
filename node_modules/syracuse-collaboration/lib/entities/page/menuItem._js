		...
		representation: {
			...
			$lookup: function(_, instance) {
				if (instance.application(_)){
					var options = {
						application: instance.applicationName(_),
						contract: instance.contractName(_),
						dataset: instance.endpointName(_),
						representationField: "representation",
						entityField: "entity"
					}
					return adminHelper.getLookupRepresentations(_, options);
			...
			$lookup: function(_, instance) {
				if (instance.application(_)){
					var options = {
						...
						contract: instance.contractName(_),
						dataset: instance.endpointName(_),
						representationField: "fusionFunction",
					}
					return adminHelper.getLookupRepresentations(_, options);
