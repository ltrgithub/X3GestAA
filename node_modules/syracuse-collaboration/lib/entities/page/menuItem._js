		...
		representation: {
			...
			$lookup: function(_, instance) {
					...
					if (instance.application(_) && instance.application(_).protocol(_) === "x3"){
						console.log("Prototcol=X3");
						var baseUrl = instance.endpoint(_) && instance.endpoint(_).getBaseUrl(_);
						console.log("BaseUrl="+baseUrl);
						return {
							$type: "application/json;vnd.sage=syracuse",
							$url: baseUrl+"/AREPIDX?representation=AREPIDX.$lookup",
							field: "name",
						}
					}else{
						console.log("Prototcol=Syracuse");
						return {
