...
exports.entity = {
		...
		authorized: function(_, fctAuth) {
			...
			switch (this.linkType(_)) {
				...
				case "$representation":
					...
					var isThere = ent && (!ent.hasOwnProperty("restriction") || ent.restriction);
					var rep = fctAuth.$representations && fctAuth.$representations[rep];
					isThere = isThere || (rep && (!rep.hasOwnProperty("restriction") || rep.restriction));
					return ((fctAuth.$mode === "authorize") && isThere) || ((fctAuth.$mode != "authorize") && !isThere);
				default:
					return true;
			}
	...
	$searchIndex: {
		$fields: ["code", "title", "description", "linkType", "application", "representationRef", "facet", "fusionFunction", "fusionKey", "dashboard", "categories", "module", "requestName", "processName", "statName"]
	}
};