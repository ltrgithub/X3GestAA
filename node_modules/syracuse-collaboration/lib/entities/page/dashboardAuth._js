...
exports.entity = {
	...
	$actions: {
		$save: function(_, instance) {
			return {
				$parameters: {
					$url: "{$baseUrl}/authoringSaveParams/$template/$workingCopies?representation=authoringSaveParam.$edit&role={$role}"+(instance._pageId ? "pageType=dashboard&variantId=" + instance._pageId : ""),
					$method: "POST",
					$properties: {
						parameters: {
