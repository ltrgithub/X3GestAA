...
exports.entity = {
	...
	$actions: {
		$save: function(_, instance) {
			...
			if (!v) {
				r.$parameters = {
					$url: "{$baseUrl}/authoringSaveParams/$template/$workingCopies?representation=authoringSaveParam.$edit&role={$role}&pageType=dashboard&variantId={variantId}&pageContext={pageContext}",
					$method: "POST",
					$properties: {
						parameters: {
