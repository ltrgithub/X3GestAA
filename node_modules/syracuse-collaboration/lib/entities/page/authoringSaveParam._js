...
exports.entity = {
	...
	$functions: {
		...
		_getPageDef: function(_, representation) {
			...
			return pageHelpers.Factory.getPageFromContext(_, this._db, this._pageType, c);
		},
		...
		_canCreateModel: function(_) {
			...
			var sp = globals.context.session && globals.context.session.getSecurityProfile(_);
			return !this._existsModelVariant && (!sp || !sp.authoringLevel(_) || (sp.authoringLevel(_) === "sage"));
		},
