			...
			$propagate: function(_, instance, val) {
				...
				switch (val) {
					...
					case "factory_variant":
						...
						instance.variantCode(_, adminHelper.getFactoryOwner(_));
						instance.variantTitle(_, adminHelper.getFactoryOwner(_));
						instance.variantDescription(_, adminHelper.getFactoryOwner(_));
						break;
					case "model_variant":
						instance.isFactory(_, true);
