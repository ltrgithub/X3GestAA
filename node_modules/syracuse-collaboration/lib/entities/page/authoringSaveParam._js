...
/*				if(instance._variantId)
					values.push({
						$title: locale.format(module, "currentVariantEnumTitle"),
...
//					instance._loadVariantData(_);
	...
	$relations: {
		roles: {
			...
			$type: "roles",
			$isDefined: function(_, instance) {
				return !instance.personalCopy(_) && !instance.isFactory(_);
//				return (instance.saveAsOption(_) !== "personal_copy") && !instance.isFactory(_);
//				return (instance.saveAsOption(_) !== "personal_copy") && (instance.saveAsOption(_) !== "factory_variant");
			}
		},
		users: {
