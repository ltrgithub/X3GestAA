...
function _getMenuItem(_, vg, admDb, menuItemEnt, application, filter, options) {
	...
	// Cannot update if it does not exist and cannot create
...
exports.entity = {
	...
	$functions: {
		importMenuProfile: function(_, diags, tracker) {
			...
			var codePrefix = (self.setAsFactory(_) ? "STD_" : "USR_") + app.application(_).toUpperCase() + "_" + app.contract(_).toUpperCase() + "_";
