...
exports.entity = {
	...
	//	    var localePref = instance._db.fetchInstance(_, instance._db.getEntity(_, "localePreference"), {
	//	        jsonWhere: {
	//	            code: {
	...
	//	        }
	//	    });
	//	    var defLocale = instance.locales(_).add(_);
	//	    defLocale.locale(_, localePref);
	//	},
	$functions: {
		importMenuProfile: function(_, diags, tracker) {
			...
			if (self.setAsFactory(_)) {
				if (factoryOwner === "SAGE") {
					...
					codePrefix = "ADN_" + app.application(_).toUpperCase() + "_" + app.contract(_).toUpperCase() + "_";
				}
			} else {
				codePrefix = "USR_" + app.application(_).toUpperCase() + "_" + app.contract(_).toUpperCase() + "_";
			}
			// start
