...
//			var roleId = userProfile.selectedRole(_) && userProfile.selectedRole(_).$uuid;
	...
	$searchIndex: {
		$fields: ["title", "description", "representation", "facet", "authorName", "authorType", "application"]
	},
	$defaultOrder: [["title", true]],
	$exportProfile: {
		$key: ["application", "representation", "facet"],
		$properties: ["title", "description", "representation", "facet", "authorName", "authorType"],
		$relations: {
			application: {
