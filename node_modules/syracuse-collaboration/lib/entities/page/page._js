...
function _getNavigationPage(_, context, params) {
	...
	return _fromPrototypeCache(_, cacheId, "navigationPage") || _toPrototypeCache(_, cacheId, "navigationPage", (function(_) {
		...
		var blockItemsProto = blockProto.$properties.items;
		var blockItemsMILks = blockItemsProto.$links = blockItemsProto.$links || {};
		blockItemsMILks.$select = {
			$variants: {
				menuItem: subModEnt.$relations.items.getLink("$select", "menuItem")
			}
		}
		//
