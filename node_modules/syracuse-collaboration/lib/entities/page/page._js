...
function _getNavigationPage(_, context, params) {
	...
	return _fromPrototypeCache(_, cacheId, "navigationPage") || _toPrototypeCache(_, cacheId, "navigationPage", (function(_) {
		...
		//
		navPageProto.$url += "?include=modules.code,modules.title,modules.submodules.code,modules.submodules.title";
		// modules
		...
		// rights structure
		var admFctRights = up.getAccessRightAuthorizations(_, adminEp);
		var selEpFctRights = (selectedEpId !== adminEp.$uuid) ? up.getAccessRightAuthorizations(_, selectedEp) : admFctRights;
	...
	return _fromPrototypeCache(_, cacheId, "landingPage") || _toPrototypeCache(_, cacheId, "landingPage", (function(_) {
		function _serializeLandingPage(_, lp) {
			var res = {
				...
				vignettes: lp.vignettes(_).toArray(_).filter_(_, function(_, lv) {
