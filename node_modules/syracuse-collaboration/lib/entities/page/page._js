...
function _getNavigationPage(_, context, params) {
	...
	return _fromPrototypeCache(_, cacheId, "navigationPage") || _toPrototypeCache(_, cacheId, "navigationPage", (function(_) {
		...
		// rights structure
		var admFctRights = adminMode && up.getAccessRightAuthorizations(_, adminEp);
		var selEpFctRights = adminMode && ((selectedEpId !== adminEp.$uuid) ? up.getAccessRightAuthorizations(_, selectedEp) : admFctRights);
