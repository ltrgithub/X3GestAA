...
function _getPage(_, context, params, etag) {
	...
	/////
	// TODO: Caching resources
	// - Recup last variant UPDDATE
	// - Compute ETAG : UUID variant0 + date last variant modified + date last fusion proto
	// check if-non-match --> 304 no content
	/////
