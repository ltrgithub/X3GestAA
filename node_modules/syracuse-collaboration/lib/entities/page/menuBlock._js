			...
			items.forEach_(_, function(_, it) {
				...
				if (res_it && (!res_it.menuBlock && !res_it.menuItem)) {
					...
					try {
						...
						console.error("it meta properties : " + sys.inspect(it._meta._$properties));
						console.error("it meta relations : " + sys.inspect(it._meta._$relations));
						//console.error("it meta refering entities : " + sys.inspect(it._meta.referingEntities));
						...
						console.error("it _relation : " + sys.inspect(it._relation));
