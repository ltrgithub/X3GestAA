	...
	$services: {
		representation : {
			...
			$execute : function(_, context, instance) {				
				...
				delete res.representations;
				if (true || !res.entities || Object.keys(res.entities).length == 0 || !res.pages || Object.keys(res.pages).length ==0){
					throw new Error(locale.format(module, "noRepresentation", instance.title(_), params.endpointName));					
				}else{
