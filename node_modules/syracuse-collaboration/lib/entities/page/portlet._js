...
function _scanPageForRepresentations(facet, proto, list, added, badLinks) {
		...
		representation : {
			...
			$execute : function(_, context, instance) {	
				...
				var _sendError = function  (_, status, msg, stack, diagnoses){
					...
					context.reply(_, status, {"$diagnoses" : diags});	
				}			
				if (!instance) {
					...
					list.forEach_(_, function(_, representation) {
						if (!res.pages[representation]) {
							...
							if (ok) {
								...
								_scanPageForRepresentations(opts.facet, page.$prototype, cl, list, badLinks);	
							}
						}
					});
					list = cl;
