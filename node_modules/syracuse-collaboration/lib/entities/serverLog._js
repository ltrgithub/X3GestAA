...
exports.entity = {
	...
	$relations: {
		owner: {
			$title: "Owner",
			$type: "user",
			//$isMandatory: true // change owner relation to be not mandatory in V7 and U8 because scheduler can't find user in global context
			// This problem is solved since U9
		}
	},
