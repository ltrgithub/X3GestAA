...
exports.entity = {
	...
	$properties: {
        reportMode: {
            $title: "Word report",
            $enum: ["choose_tpl", "new_tpl", "mod_tpl"],
            $enumCaptions: ["Choose existing template", "Create template", "Modify template"],
            $default: "choose_tpl"
        }
	},
    $relations: {
