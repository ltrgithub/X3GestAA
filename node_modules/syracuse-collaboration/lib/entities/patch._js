...
exports.batchIntegration = function(file, _) {
	...
	try {
		...
		setLock(_, false, settings);
		console.log("Error in patch integration " + e.stack);
...
exports.entity = {
	...
	$helpPage: "Administration-reference-Patch-integration",
	$properties: {
		localhost: {
			...
			$execute: function(_, context, instance) {
				...
				try {
					...
					if (config.mockServer) {
						...
						var options = {
							path: "/nannyCommand/notifyOtherNannies/notifyOne/consistency",
							method: "POST"
						};
