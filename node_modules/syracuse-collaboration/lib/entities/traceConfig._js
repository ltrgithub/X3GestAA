...
var serverModules = {
	...
	hrmProxy: "hrmProxy",
	hrmLoadBalancer: "hrmLoadBalancer",
	help: "help",
	search: "search",
	...
	$functions: {
		$setId: function(_, context, id) {
			...
			Object.keys(serverModules).forEach_(_, function(_, key) {
				...
				a_mod.expiry(_, traceConfig && traceConfig.expiry || 120);
			});
		}
	},
	/// ## Services
		...
		submit: {
			...
			$execute: function(_, context, instance) {
				...
				mods.forEach_(_, function(_, mod) {
					...
					traceConfig.level = mod.level(_);
					traceConfig.transport = mod.transport(_);
					traceConfig.expiry = mod.expiry(_);
				});
			}
		},
		reset: {
