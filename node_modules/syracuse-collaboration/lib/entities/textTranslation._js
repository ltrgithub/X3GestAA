...
var extractTexts = require("syracuse-translation/lib/translation");
	...
	$services: {
	    fromSyracuseToX3: {
			...
			$execute : function(_, context, instance) {
				...
				extractTexts.extractResources(_, instance, opt ,context);
			}
		},
	    fromX3toSyracuse: {
			$method : "GET",
			...
			$execute : function(_, context, instance) {
				var opt = context.parameters.parameters && jsurl.parse(context.parameters.parameters);
				extractTexts.updateResources(_, instance, opt ,context);
			}
		},
		deleteAll: {
			$method : "GET",
			...
			$execute : function(_, context, instance) {
				var opt = context.parameters.parameters && jsurl.parse(context.parameters.parameters);
				extractTexts.deleteAll(_, instance, opt ,context);
			}
		},
		testCreate: {
			$method: "POST",
			...
			$execute: function(_, context, instance) {
				...
				var ent = db.getEntity(_, "ZZAPLSTD", "$edit");
