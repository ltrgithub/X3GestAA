...
exports.entity = {
	...
	$properties: {
		...
		authoringLevel: {
			...
			$enum: function(_, instance) {
				...
				values.push({
					$title: locale.format(module, "partnerAuthLevelLabel"),
					$value: "partner"
				});
				values.push({
		...
		factoryOwner: {
			...
			$isMandatory: function(_, instance) {
				return instance.authoringLevel(_) === "partner";
			},
	...
	$functions: {
		...
		hasFactoryRights: function(_) {
			return this.authoringLevel(_) === "sage" || this.authoringLevel(_) === "partner";
		},
		canUpdateFactoryInstance: function(_, instance, ignoreInstance) {
			if (ignoreInstance || instance.$factory) {
				if (this.authoringLevel(_) === "sage") return true;
				if (this.authoringLevel(_) === "partner") {
