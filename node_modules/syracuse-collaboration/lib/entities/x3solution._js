...
exports.entity = {
	...
	$properties: {
		...
		solutionName: {
			...
			$propagate: function(_, instance, val) {
				if (val && instance.serverHost(_) && instance.serverPort(_)) instance.synchronize(_);
			}
		},
		serverHost: {
			...
			$isMandatory: true,
			$propagate: function(_, instance, val) {
				if (val && instance.solutionName(_) && instance.serverPort(_)) instance.synchronize(_);
			}
		},
		serverPort: {
			...
			$isMandatory: true,
			$propagate: function(_, instance, val) {
				if (val && instance.solutionName(_) && instance.serverHost(_)) instance.synchronize(_);
			}
		},
		serverTimeout: {
	...
	$searchIndex: {
		$fields: ["solutionName", "serverHost", "serverPort", "endpoints"]
	},
	$functions: {
		webHostname: function(_) {
			return this.serverHost(_);
		},
		baseUrl: function(_) {
