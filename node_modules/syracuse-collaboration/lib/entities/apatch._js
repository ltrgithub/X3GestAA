			...
			$execute : function(_, context, instance) {
				...
				if (!fs.existsSync(sem)) {
					...
					try {
						...
						patchcreate.patch(instance.newPatch(_), instance.startFromRelease(_), instance.newRelease(_), instance.newReleaseNumber(_), instance.comment(_), instance.baseRelease(_), instance.patchFile(_), sha1Old, sha1New, instance.x3Information(_), instance.checkSource(_), _);
						console.log("After");
