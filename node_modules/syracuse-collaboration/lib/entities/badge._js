...
exports.updateBadges = function(_) {
	...
	for (var i = keys.length - 1; i >= 0; i--) {
		...
		if (dbBadge) { // update existing badge
			...
			var keys1 = Object.keys(badge.title);
			var locales = dbBadge.getPropAllLocales(_, "title");
			if (keys1.length !== Object.keys(locales).length || keys1.some(function(key) {
				return keys1[key] !== locales[key];
			})) {
...
exports.entity = {
	$canCreate: false,
	$allowFactory: true,
	$helpPage: "Administration-reference-Badges",
	$properties: {
		code: {
			$title: "Name",
			$isMandatory: true,
