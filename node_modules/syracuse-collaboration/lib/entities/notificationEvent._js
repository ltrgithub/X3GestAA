...
var notificationTime = require('./notificationTime');
...
exports.entity = {
	...
	$functions: {
		...
		schedule: function(_, key, executionTime, parameters, mode) {
			return notificationTime.schedule(_, this, key, executionTime, parameters, mode);
		},
		/// -------------
		...
		scheduleAll: function(_, data, mode) {
			return notificationTime.scheduleAll(_, this, data, mode);
		},
