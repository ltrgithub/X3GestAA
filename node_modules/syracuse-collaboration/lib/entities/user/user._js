...
exports.entity = {
	...
	$capabilities: "wordReport,mailMerge,pdfReport,excelReport,mailTemplate",
	$allowFactory: true,
		...
		$canSave: [
			...
			function(_, instance) {
				...
				instance.groups(_).toArray(_).forEach_(_, function(_, grp) {
					var canSaveSecLevel = grp.role(_) && grp.role(_).securityProfile(_) ? grp.role(_).securityProfile(_).canSaveSecLevel(_, instance) : true;
					canSave = canSave && canSaveSecLevel;
				});
