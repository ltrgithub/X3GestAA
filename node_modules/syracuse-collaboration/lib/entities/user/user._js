	...
	$properties: {
		...
		oldSignature: {
			...
			$isHidden: function(_, instance) {
				...
				return true;*/
				if (!instance.enableBasic(_) && !instance.enableLdap(_)) {
					return !noAdmin(_);
				}
				return true;
			}
		...
		signature: {
			...
			$isHidden: function(_, instance) {
				...
				return (instance.enableBasic(_) || instance.enableLdap(_));
			}
		},
		email: {
