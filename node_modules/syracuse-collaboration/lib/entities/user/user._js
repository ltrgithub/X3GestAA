		...
		testuser: {
			...
			$execute: function(_, context, instance, parameters) {
				try {
					...
					var cu = uc.user;
				//	var res = cu(_, "asdf3", "ADMIN", "R4Y9L", "R4X9L", "mrs", "fn", "ln", "fn.ln@gmx.de", "123456789", "9876554", 2);
					var de = uc.deactivate;
					var res = de(_, "03030")
					console.log("OKx " + res + " <<");
				} catch (e) {
		...
		$canSave: [
			...
			function(_, instance) {
				...
				if (instance.$created && !instance.salt(_)) {
					instance.salt(_, instance.login(_)); // initialize salt with login name (allows put request)
				}
