...
exports.entity = {
	$properties: {
		...
		issuer: {
			...
			$pattern: "^[a-zA-Z][\\w\\.\\:\\/\\-\\%\\=\\?\\&]*$",
			$patternMessage: "Issuer must start with a letter A to Z or a to z, followed by characters a to z, A to Z, 0 to 9 and special characters _-/:.=?&%",
			$isMandatory: true
		},
		responseAttribute: {
