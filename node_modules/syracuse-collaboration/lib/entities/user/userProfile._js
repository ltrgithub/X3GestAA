	...
	$properties: {
		developpementMode: {
			...
			$compute: function(_, instance) {
				return ((globals.context.config || {}).system || {}).enableDeveloppementFeatures || helpers.enableDeveloppementFeatures;
			}
		},
		enableTestRobot: {
		...
		authoringLevel: {
			...
			$compute: function(_, instance) {
				...
				return (sp && sp.authoringLevel(_)) || ((((globals.context.config || {}).system || {}).enableDeveloppementFeatures || helpers.enableDeveloppementFeatures) ? "sage" : "none");
			}
		}
		/*		photo: {
			$title: "Photo",
