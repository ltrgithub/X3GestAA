	...
	$functions: {
		...
		loadUserProfile: function(_, user, defaultLocale, paramUserProfile) {
			...
			try {
				...
				if (localeCode) this.selectedLocale(_, localeCode ? user.getUserLocaleByCode(_, localeCode) || user.getUserLocaleByCode(_, "en-US") : user.getUserLocaleByCode(_, "en-US"));
