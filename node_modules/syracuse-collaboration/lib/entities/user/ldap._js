...
function updateUsers(_, instance, users, diagnoses, del, translateTable) {
	...
	l = undefined; // for garbage collection
	...
	$services: {
		...
		usersFromLdap: {
			...
			$execute: function(_, context, instance) {
				...
				updateUsers(_, instance, allUsers, instance.$diagnoses, false, translateTable);
