...
exports.entity = {
	...
	$functions: {
		...
		importUsers: function(_, tracker) {
			...
			tracker && tracker(locale.format(module, "start"), "-", 0);
			var translateTable = _makeTranslateTable(instance, attribs, _);
			tracker && tracker(locale.format(module, "getUsers"), "-", 1);
			var allUsers = getAllUsers(instance, true, _, attribs);
			tracker && tracker(locale.format(module, "updateUsers"), "-", 20);
			updateUsers(_, instance, allUsers, diags, false, translateTable, tracker);
