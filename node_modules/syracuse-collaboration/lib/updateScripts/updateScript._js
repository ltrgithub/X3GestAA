...
_scripts[55] = function(_, db) {
	...
	exports.tracer && exports.tracer("Executing update script to version: 55; import standard authorings, menus, dashboard");
	...
	//
	["syracuse-admin-init.json", "syracuse-admin-templates.json", "x3-init.json", "x3-dashboards-user.json", "x3-dashboards-home.json", "x3-pages.json"].forEach_(_, _applyScript);
	//
	exports.tracer && exports.tracer("Update script to version: 55 executed");
}
...
// !!!!!! In branch 7P2 and before DO NOT modify this script anymore but use dedicated ones !!!!!!
