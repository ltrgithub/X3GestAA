...
_scripts[54] = function(_, db) {
	...
	//
	["syracuse-admin-init.json", "syracuse-admin-template.json", "x3-init.json", "x3-dashboards-user.json", "x3-dashboards-home.json", "x3-pages.json"].forEach_(_, _applyScript);
	//
