...
_scripts[7] = function(_, db) {
	...
	exports.tracer && exports.tracer("Executing update script to version: 7; import standard authorings, menus, dashboard");
	...
	["syracuse-admin-templates.json", "x3-init.json",  "x3-global-modules.json", "x3-erp-menus.json", 
	 "x3-global-sitemap.json", "x3-erp-homepages.json", "x3-pages.json"].forEach_(_, _applyScript);
	//
