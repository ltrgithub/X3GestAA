...
exports.contract = {
	...
	entities: {
		hack5: require('./entities/hack5').entity,
		smartSheet: require('./entities/smartSheet').entity,
		smartSheetTab: require('./entities/smartSheetTab').entity,
		...
		cacheAdmin: require('./entities/cacheAdmin').entity,
		dataCache: require('./entities/dataCache').entity,
		// tools
		...
		discFeed: require('./entities/discFeed').entity,

		// Cache Statistics
		cacheAction: require('./entities/cache/cacheAction').entity,
		cacheStats: require('./entities/cache/cacheStats').entity,

		profileSync: require('./entities/profileSync').entity,
	...
	representations: {
		...
		//discfeed: require('./representations/discfeed').representation,
		cacheStats: require('./representations/cacheStats').representation
