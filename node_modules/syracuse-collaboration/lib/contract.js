exports.contract = {
    ...
    entities: {
        ...
        importSession: require('./entities/importSession').entity,
        importSessionType: require('./entities/importSessionType').entity,
...
//        pagePortlet: require('./entities/page/pagePortlet').entity,
        ...
        documentInternalTag: require('./entities/storage/documentInternalTag').entity,
        // lookups
        ...
        // Export Profile
        exportProfile: require('./entities/exportProfile').entity,
        exportProfileItem: require('./entities/exportProfileItem').entity,
        exportProfileObject: require('./entities/exportProfileObject').entity,
        lookupObject: require('./entities/lookupObject').entity,
        entityAttribute: require('./entities/entityAttribute').entity,
        selectExportTarget: require('./entities/selectExportTarget').entity,
        ...
        ZZAPLSTD: require('./entities/ZZAPLSTD').entity,
    },
    representations: {
