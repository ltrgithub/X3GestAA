...
exports.contract = {
	...
	entities: {
		...
		historyLogSetting: require('./entities/historyLogSetting').entity,
		historyLog: require('./entities/historyLog').entity,
		historyLogItem: require('./entities/historyLogItem').entity,
	...
	representations: {
		...
		historyLog: require('./representations/historyLog').representation,
