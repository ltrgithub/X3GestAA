...
//        pagePortlet: require('./entities/page/pagePortlet').entity,
        ...
        // storage area
        team: require('./entities/team').entity,
        document: require('./entities/document').entity,
        storageVolume: require('./entities/storageVolume').entity,
        storageVolumeItem: require('./entities/storageVolumeItem').entity,
        uploadVolumeItem: require('./entities/uploadVolumeItem').entity,
        documentTag: require('./entities/documentTag').entity,
        documentTagCategory: require('./entities/documentTagCategory').entity,
        // lookups
