...
exports.contract = {
	...
	entities: {
		...
		traceSetting: require('syracuse-trace/lib/entities/traceSetting').entity,
		traceConfig: require('syracuse-trace/lib/entities/traceConfig').entity,
		traceConfigModule: require('syracuse-trace/lib/entities/traceConfigModule').entity,
		traceLog: require('syracuse-trace/lib/entities/traceLog').entity,
		traceSessionConfig: require('syracuse-trace/lib/entities/traceSessionConfig').entity,
