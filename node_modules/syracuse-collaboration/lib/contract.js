...
exports.contract = {
	...
	entities: {
		...
		ediXmlPath: require('./entities/edi/ediXmlPath').entity,
	...
	representations: {
		...
		ediProcess: require('./representations/edi/ediProcess').representation,
	...
	dbMeta: {
		...
		automaticImport: [
			...
			"syracuse-sky-soap-menu.json",
			"syracuse-sky-symphony-menu.json"
		],
		updateScript: [{
