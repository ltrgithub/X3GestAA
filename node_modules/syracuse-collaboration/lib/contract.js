...
exports.contract = {
	...
	entities: {
		...
		translationTool: require('./entities/translation/translationTool').entity,
		// Security
	...
	dbMeta: {
		initScript: ["syracuse-admin-init.json", "syracuse-admin-templates.json", "x3-init.json", "x3-global-modules.json",
			"x3-erp-menus.json", "x3-global-sitemap.json", "x3-erp-homepages.json", "x3-pages.json", "x3-mobile-dashboards.json"
		],
		automaticImport: ["x3-global-modules.json"],
		updateScript: [{
