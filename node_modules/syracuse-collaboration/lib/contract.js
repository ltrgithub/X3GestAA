...
if (config.system.enableDevelopmentFeatures) {
	contract.entities.translationTool = require('./entities/translation/translationTool').entity;
	contract.representations.translationTool = require('./representations/translationTool').representation;
}
