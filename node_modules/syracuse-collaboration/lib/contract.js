...
exports.contract = {
    ...
    entities: {
        ...
        fusionSession: require('./entities/fusionSession').entity,
        fusionReuseClient: require('./entities/fusionReuseClient').entity,
        ...
        printJob: require('./entities/printJob').entity,
