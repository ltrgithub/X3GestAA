...
//        pagePortlet: require('./entities/page/pagePortlet').entity,
        ...
        // Soap Web services
        soapWebService: require('./entities/soapWebService').entity,
        soapEntity: require('./entities/soapEntity').entity,
        soapRepresentation: require('./entities/soapRepresentation').entity,
        // Soap Stubs
        soapStub: require('./entities/soapStub').entity,
    },
    representations: {
