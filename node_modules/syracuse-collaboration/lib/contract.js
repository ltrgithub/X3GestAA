...
exports.contract = {
	...
	entities: {
		...
		// HRM
		hrmSite: require('./entities/hrm/hrmSite').entity,
		hrmServer: require('./entities/hrm/hrmServer').entity,
		...
		ediCache: require('./entities/edi/ediCache').entity,
		ediProcess: require('./entities/edi/ediProcess').entity,

		filterTest: require('./entities/filterTest').entity,
		AMENLOC: require('./entities/translation/AMENLOC').entity,
		APLSTD: require('./entities/translation/APLSTD').entity,
		TABLAN: require('./entities/translation/TABLAN').entity,

		// Mobile
		mobileApplication: require('./entities/mobile/mobileApplication').entity,
		mobileDashboard: require('./entities/mobile/mobileDashboard').entity,
		mobileDashboardVignette: require('./entities/mobile/mobileDashboardVignette').entity,
		mobileGadget: require('./entities/mobile/mobileGadget').entity,
		mobileRepresentation: require('./entities/mobile/mobileRepresentation').entity,
		mobileMigrateDashboard: require('./entities/mobile/mobileMigrateDashboard').entity,
		mobileGadgetParam: require('./entities/mobile/mobileGadgetParam').entity,
	},
	representations: {
		...
		// Mobile
		mobileGadget: require('./representations/mobile/mobileGadget').representation,
		mobileDashboard: require('./representations/mobile/mobileDashboard').representation,
		mobileApplication: require('./representations/mobile/mobileApplication').representation
	},
	searchFacets: {
		group: {
			$title: "Groups",
...
require('syracuse-etl/lib/contract').extendContract(exports.contract);
require('syracuse-flamegraph/lib/contract').extendContract(exports.contract);
registry.extendContract(exports.contract, require('syracuse-trace/lib/contract').contract);
require('syracuse-uml/lib/contract').extendContract(exports.contract);



if (((config || {}).system || {}).enableDevelopmentFeatures) {
	exports.contract.entities.translationTool = require('./entities/translation/translationTool').entity;
	exports.contract.representations.translationTool = require('./representations/translationTool').representation;
}