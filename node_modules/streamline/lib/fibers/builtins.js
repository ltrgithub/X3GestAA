...
(function(exports) {
	...
	exports.funnel = function(max) {
		...
		var fun = fstreamline__.streamlinify(funCb, 0);
	...
	Object.defineProperty(Array.prototype, 'forEach_', {
		...
		writable: true,
		enumerable: false,
		value: fstreamline__.create(function(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) fstreamline__.invoke(fn, "call", [thisObj , _ , this[i] , i , this], 1);
				}
			} else {
	...
	Object.defineProperty(Array.prototype, 'map_', {
		...
		value: fstreamline__.create(function(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				...
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) result[i] = fstreamline__.invoke(fn, "call", [thisObj , _ , this[i] , i , this], 1);
				}
			} else {
				var fun = funnel(par);
				result = this.map(function(elt, i, arr) {
					return fun(false, fstreamline__.create(function(_) {
						return fstreamline__.invoke(fn, "call", [thisObj , _ , elt , i , arr], 1);
					}, 0,__filename,161));
				});
				for (var i = 0; i < len; i++) {
		...
		value: fstreamline__.create(function(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) {
						var elt = this[i];
						if (fstreamline__.invoke(fn, "call", [thisObj , _ , elt , i , this], 1)) result.push(elt);
					}
				}
			} else {
				fstreamline__.invoke(this, "map_", [_ , par , fstreamline__.create(function(_, elt, i, arr) {
					if (fstreamline__.invoke(fn, "call", [thisObj , _ , elt , i , arr], 1)) result.push(elt);
				}, 0,__filename,193) , thisObj], 0);
			}
			return result;
		}, 0,__filename,179)
	});
		...
		value: fstreamline__.create(function(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				for (var i = 0; i < len; i++) {
					...
					if (has.call(this, i) && !fstreamline__.invoke(fn, "call", [thisObj , _ , this[i] , i , this], 1)) return false;
				}
			} else {
				var fun = funnel(par);
	...
	Object.defineProperty(Array.prototype, 'some_', {
		...
		value: fstreamline__.create(function(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				for (var i = 0; i < len; i++) {
					if (has.call(this, i) && fstreamline__.invoke(fn, "call", [thisObj , _ , this[i] , i , this], 1)) return true;
				}
			} else {
				var fun = funnel(par);
				var futures = this.map(function(elt, i, arr) {
	...
	Object.defineProperty(Array.prototype, 'reduce_', {
		...
		writable: true,
		enumerable: false,
		value: fstreamline__.create(function(_, fn, v, thisObj) {
			thisObj = thisObj !== undefined ? thisObj : this;
			var len = this.length;
			for (var i = 0; i < len; i++) {
	...
	Object.defineProperty(Array.prototype, 'sort_', {
		...
		writable: true,
		enumerable: false,
		value: fstreamline__.create(function(_, compare, beg, end) {var _qsort_ = fstreamline__.create(_qsort, 0,__filename,313);
			var array = this;
			beg = beg || 0;
			...
			function _qsort(_, beg, end) {
				...
				if (nbeg < end) (_qsort_.fstreamlineFunction || 0)(_ , nbeg , end);
				if (beg < nend) (_qsort_.fstreamlineFunction || 0)(_ , beg , nend);
			}
			(_qsort_.fstreamlineFunction || 0)(_ , beg , end);
			return array;
		}, 0,__filename,308)
	});
