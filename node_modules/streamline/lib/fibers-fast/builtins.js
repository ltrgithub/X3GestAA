...
(function(exports) {
	...
	exports.funnel = function(max) {
		...
		var funCb = function(callback, fn) {
				...
				if (max < 0 || max == Infinity) return fstreamline__.create(fn,0)(  callback);
				...
				function _doOne() {
					...
					active++;
					fstreamline__.createBound(current,'fn',0)(  function(err, result) {
						active--;
						if (!closed) {
		...
		var fun = fstreamline__.star(funCb, 0);
		...
		value: function(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				...
				result = this.map(function(elt, i, arr) {
					return fstreamline__.spin(null, fun, [false , function(_) {
