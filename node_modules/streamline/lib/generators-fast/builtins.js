/*** Generated by streamline 0.12.1 (generators-fast) - DO NOT EDIT ***/var galaxy = require("../generators-fast/runtime");(function(){})();galaxy.unstar(function*(_) { /**
...
(function(exports) {
	...
	exports.funnel = function(max) {
		...
		var funCb = function(callback, fn) {
				...
				function _doOne() {
					...
					active++;
					galaxy.unstarBound(current,'fn',0)(  function(err, result) {
						active--;
						if (!closed) {
	...
	Object.defineProperty(Array.prototype, 'forEach_', {
		...
		value: function*(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) (yield fn.call(thisObj, _, this[i], i, this));
				}
			} else {
				(yield this.map_(_, par, fn, thisObj));
			}
			return this;
		}
	});
	...
	Object.defineProperty(Array.prototype, 'map_', {
		...
		value: function*(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				...
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) result[i] = (yield fn.call(thisObj, _, this[i], i, this));
				}
			} else {
				var fun = funnel(par);
				result = this.map(function(elt, i, arr) {
					return galaxy.spin.call(this, fun(false , function*(_) {
						return (yield fn.call(thisObj, _, elt, i, arr));
					}), 0);
				});
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) result[i] = (yield result[i](_));
				}
			}
			return result;
		}
		...
		value: function*(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) {
						var elt = this[i];
						if ((yield fn.call(thisObj, _, elt, i, this))) result.push(elt);
					}
				}
			} else {
				(yield this.map_(_, par, function*(_, elt, i, arr) {
					if ((yield fn.call(thisObj, _, elt, i, arr))) result.push(elt);
				}, thisObj));
			}
			return result;
		}
		...
		value: function*(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				for (var i = 0; i < len; i++) {
					...
					if (has.call(this, i) && !(yield fn.call(thisObj, _, this[i], i, this))) return false;
				}
			} else {
				var fun = funnel(par);
				...
				for (var i = 0; i < len; i++) {
					if (has.call(this, i) && !(yield futures[i](_))) {
						fun.close();
						return false;
					}
				}
	...
	Object.defineProperty(Array.prototype, 'some_', {
		...
		value: function*(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				for (var i = 0; i < len; i++) {
					if (has.call(this, i) && (yield fn.call(thisObj, _, this[i], i, this))) return true;
				}
			} else {
				var fun = funnel(par);
				var futures = this.map(function(elt, i, arr) {
	...
	Object.defineProperty(Array.prototype, 'reduce_', {
		...
		value: function*(_, fn, v, thisObj) {
			...
			var len = this.length;
			for (var i = 0; i < len; i++) {
				if (has.call(this, i)) v = (yield fn.call(thisObj, _, v, this[i], i, this));
			}
			return v;
		}
	});
	...
	Object.defineProperty(Array.prototype, 'sort_', {
		...
		value: function*(_, compare, beg, end) {
			...
			function* _qsort(_, beg, end) {
				...
				if (end == beg + 1) {
					if ((yield compare(_, array[beg], array[end])) > 0) {
						var tmp = array[beg];
						array[beg] = array[end];
						array[end] = tmp;
					}
				...
				while (nbeg <= nend) {
					while (nbeg < end && (yield compare(_, array[nbeg], o)) < 0) nbeg++;
					while (beg < nend && (yield compare(_, o, array[nend])) < 0) nend--;
