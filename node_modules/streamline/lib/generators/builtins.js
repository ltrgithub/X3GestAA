/*** Generated by streamline 0.7.0a (generators) - DO NOT EDIT ***/var galaxy = require("streamline/lib/generators/runtime"); ((function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__0.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_) { /**
...
(function(exports) {
	...
	exports.funnel = function(max) {
		...
		var fun = (function(unstarred__) {  function F(_, fn) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__0.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, fn) {
			return (yield galaxy.invoke(null, funCb, [_, fn], 0));
		}, 0));
		fun.close = function() {
			queue = [], closed = true;
		};
	...
	Object.defineProperty(Array.prototype, 'forEach_', {
		...
		writable: true,
		enumerable: false,
		value: (function(unstarred__) {  function F(_, options, fn, thisObj) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__0.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, options, fn, thisObj) {
	...
	Object.defineProperty(Array.prototype, 'map_', {
		...
		value: (function(unstarred__) {  function F(_, options, fn, thisObj) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__0.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				...
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) result[i] = (yield galaxy.invoke(fn, "call", [thisObj, _, this[i], i], 1));
				}
			} else {
				var fun = funnel(par);
				result = this.map(function(elt, i) {
					return fun(null, (function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__0.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_) {
						return (yield galaxy.invoke(fn, "call", [thisObj, _, elt, i], 1));
					}, 0)));
				});
				for (var i = 0; i < len; i++) {
		...
		value: (function(unstarred__) {  function F(_, options, fn, thisObj) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__0.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) {
						var elt = this[i];
						if ((yield galaxy.invoke(fn, "call", [thisObj, _, elt], 1))) result.push(elt);
					}
				}
			} else {
				(yield galaxy.invoke(this, "map_", [_, par, (function(unstarred__) {  function F(_, elt) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__0.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, elt) {
					if ((yield galaxy.invoke(fn, "call", [thisObj, _, elt], 1))) result.push(elt);
				}, 0)), thisObj], 0));
			}
			return result;
		...
		value: (function(unstarred__) {  function F(_, options, fn, thisObj) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__0.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				for (var i = 0; i < len; i++) {
					...
					if (has.call(this, i) && !(yield galaxy.invoke(fn, "call", [thisObj, _, this[i]], 1))) return false;
				}
			} else {
				var fun = funnel(par);
	...
	Object.defineProperty(Array.prototype, 'reduce_', {
		...
		writable: true,
		enumerable: false,
		value: (function(unstarred__) {  function F(_, fn, v, thisObj) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__0.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, fn, v, thisObj) {
			thisObj = thisObj !== undefined ? thisObj : this;
			var len = this.length;
			for (var i = 0; i < len; i++) {
	...
	Object.defineProperty(Array.prototype, 'sort_', {
		...
		writable: true,
		enumerable: false,
		value: (function(unstarred__) {  function F(_, compare, beg, end) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__0.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, compare, beg, end) {var _qsort_ = (function(unstarred__) {  function F(_, compare, beg, end) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__0.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(_qsort, 0));
			var array = this;
			beg = beg || 0;
