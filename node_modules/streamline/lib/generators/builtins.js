/*** Generated by streamline 0.7.0a (generators) - DO NOT EDIT ***/var galaxy = require("galaxy"); ((function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__ = unstarred__.__starred__;  F.__starred__.__unstarred__ = F;  return F;})(galaxy.unstar(function*(_) { /**
...
(function(exports) {
	...
	exports.funnel = function(max) {
		...
		var fun = (function(unstarred__) {  function F(_, fn) {   return unstarred__.apply(this, arguments);  };  F.__starred__ = unstarred__.__starred__;  F.__starred__.__unstarred__ = F;  return F;})(galaxy.unstar(function*(_, fn) {
	...
	Object.defineProperty(Array.prototype, 'forEach_', {
		...
		writable: true,
		enumerable: false,
		value: (function(unstarred__) {  function F(_, options, fn, thisObj) {   return unstarred__.apply(this, arguments);  };  F.__starred__ = unstarred__.__starred__;  F.__starred__.__unstarred__ = F;  return F;})(galaxy.unstar(function*(_, options, fn, thisObj) {
		...
		value: (function(unstarred__) {  function F(_, options, fn, thisObj) {   return unstarred__.apply(this, arguments);  };  F.__starred__ = unstarred__.__starred__;  F.__starred__.__unstarred__ = F;  return F;})(galaxy.unstar(function*(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				...
				result = this.map(function(elt, i) {
					return fun(null, (function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__ = unstarred__.__starred__;  F.__starred__.__unstarred__ = F;  return F;})(galaxy.unstar(function*(_) {
	...
	Object.defineProperty(Array.prototype, 'filter_', {
		...
		value: (function(unstarred__) {  function F(_, options, fn, thisObj) {   return unstarred__.apply(this, arguments);  };  F.__starred__ = unstarred__.__starred__;  F.__starred__.__unstarred__ = F;  return F;})(galaxy.unstar(function*(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				...
				(yield galaxy.invoke(this, "map_", [_, par, (function(unstarred__) {  function F(_, elt) {   return unstarred__.apply(this, arguments);  };  F.__starred__ = unstarred__.__starred__;  F.__starred__.__unstarred__ = F;  return F;})(galaxy.unstar(function*(_, elt) {
					if ((yield galaxy.invoke(fn, "call", [thisObj, _, elt], 1))) result.push(elt);
				}, 0)), thisObj], 0));
			}
			return result;
	...
	Object.defineProperty(Array.prototype, 'reduce_', {
		...
		writable: true,
		enumerable: false,
		value: (function(unstarred__) {  function F(_, fn, v, thisObj) {   return unstarred__.apply(this, arguments);  };  F.__starred__ = unstarred__.__starred__;  F.__starred__.__unstarred__ = F;  return F;})(galaxy.unstar(function*(_, fn, v, thisObj) {
			thisObj = thisObj !== undefined ? thisObj : this;
			var len = this.length;
			for (var i = 0; i < len; i++) {
	...
	Object.defineProperty(Array.prototype, 'sort_', {
		...
		writable: true,
		enumerable: false,
		value: (function(unstarred__) {  function F(_, compare, beg, end) {   return unstarred__.apply(this, arguments);  };  F.__starred__ = unstarred__.__starred__;  F.__starred__.__unstarred__ = F;  return F;})(galaxy.unstar(function*(_, compare, beg, end) {var _qsort_ = (function(unstarred__) {  function F(_, compare, beg, end) {   return unstarred__.apply(this, arguments);  };  F.__starred__ = unstarred__.__starred__;  F.__starred__.__unstarred__ = F;  return F;})(galaxy.unstar(_qsort, 0));
			var array = this;
			beg = beg || 0;
