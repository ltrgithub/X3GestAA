/*** Generated by streamline 0.7.0 (callbacks) - DO NOT EDIT ***/ "use strict"; var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb,__tryCatch=__rt.__tryCatch; var fs = require("fs");
...
function _exists(_, fname) { var __frame = { name: "_exists", line: 13 }; return __func(_, this, arguments, _exists, 0, __frame, function __$_exists() {




    return (function(cb) { fs.exists(fname, function(result) { cb(null, result); }); })(__cb(_, __frame, 5, 8, _, true)); });};


function mtime(_, fname) { var __frame = { name: "mtime", line: 21 }; return __func(_, this, arguments, mtime, 0, __frame, function __$mtime() { return (function __$mtime(_) {
      return _exists(__cb(_, __frame, 1, 8, function ___(__0, __1) { var __2 = __1; return (function __$mtime(__then) { if (__2) { return fs.stat(fname, __cb(_, __frame, 1, 28, function ___(__0, __4) { var __3 = __4.mtime; return _(null, __3); }, true)); } else { __then(); } ; })(function __$mtime() { return _(null, 0); }); }, true), fname); })(__cb(_, __frame, -20, 6, _, true)); });};
      ...
      return mtime(__cb(_, __frame, 8, 16, function ___(__0, __3) { mtimeDst = __3;
        ...
        return fs.readFile(path, "utf8", __cb(_, __frame, 13, 15, function ___(__0, __4) { content = __4;
          ...
          banner = ((shebang + le) + banner); return (function __$exports_compileFile__1(_) {
            var __1 = mtimeDst; if (!__1) { return _(null, __1); } ; return fs.readFile(dstName, "utf8", __cb(_, __frame, 27, 31, _, true)); })(__cb(_, __frame, -78, 6, function ___(__0, __5) { transformed = __5;
            ...
            transformed = (banner + _transform(transform, content, options)); return (function __$exports_compileFile__1(__then) {
              if (((options.action === "compile") || !dontSave)) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$exports_compileFile__1() {
                      ...
                      return fs.writeFile(dstName, transformed, "utf8", __cb(_, __frame, 38, 3, __then, true)); }); })(function ___(ex, __result) { __tryCatch(_, function __$exports_compileFile__1() { if (ex) { __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(_); }, true)); }, true)); }, true), dstName); }, true), path); });};
...
exports.loadFile = function exports_loadFile__2(_, path, options) { var ext, basename, dirname, mtimejs, dontSave, jsbase, js, fiberjs, transform, banner, content, shebangparse, shebang, le, matches; var __frame = { name: "exports_loadFile__2", line: 128 }; return __func(_, this, arguments, exports_loadFile__2, 0, __frame, function __$exports_loadFile__2() {
    options = _extend({ }, (options || { }));

    ext = fspath.extname(path); return (function __$exports_loadFile__2(__then) {
      if (((ext !== ".js") && (ext !== "._js"))) {

        return _exists(__cb(_, __frame, 6, 6, function ___(__0, __2) { return (function __$exports_loadFile__2(__then) { if (__2) { path = (path + (ext = "._js")); __then(); } else {
              return _exists(__cb(_, __frame, 7, 11, function ___(__0, __3) { return (function __$exports_loadFile__2(__then) { if (__3) { path = (path + (ext = ".js")); __then(); } else { return _(null); } ; })(__then); }, true), (path + ".js")); } ; })(__then); }, true), (path + "._js")); } else { __then(); } ; })(function __$exports_loadFile__2() {
      ...
      fiberjs = ((((dirname + "/") + jsbase) + "--fibers") + ext); return (function __$exports_loadFile__2(_) {
        var __1 = options.fibers; if (!__1) { return _(null, __1); } ; return mtime(__cb(_, __frame, 18, 34, function ___(__0, __3) { var __2 = (mtimejs = __3); return _(null, __2); }, true), fiberjs); })(__cb(_, __frame, -127, 6, function ___(__0, __4) { return (function __$exports_loadFile__2(__then) { if (__4) {
            js = fiberjs; __then(); } else {

            return mtime(__cb(_, __frame, 21, 12, function ___(__0, __5) { mtimejs = __5; __then(); }, true), js); } ; })(function __$exports_loadFile__2() {
          ...
          return fs.readFile(js, "utf8", __cb(_, __frame, 28, 15, function ___(__0, __6) { content = __6;
            shebangparse = parseShebang(content);
            shebang = shebangparse[0];
            le = shebangparse[2];
            content = shebangparse[1];
            ...
            banner = ((shebang + le) + banner); return (function __$exports_loadFile__2(__then) {
              ...
              if ((ext === "._js")) {
                return cachedTransform(__cb(_, __frame, 37, 9, _, true), content, path, transform, banner, options); } else { return (function __$exports_loadFile__2(__then) {
                  if (matches = streamlineRE.exec(content)) {
                    content = removeMarker(content, matches, options);
                    return cachedTransform(__cb(_, __frame, 40, 9, _, true), content, path, transform, banner, options); } else {

                    return _(null, content); } ; })(__then); } ; })(_); }, true)); }); }, true)); }); });};
...
function mkdirs(_, path) { var p, i, segs, seg; var __frame = { name: "mkdirs", line: 190 }; return __func(_, this, arguments, mkdirs, 0, __frame, function __$mkdirs() {
    p = "";
    i = 0;
    segs = path.split("/").slice(0, -1); return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$mkdirs() { __more = false;
        var __3 = (i < segs.length); if (__3) {
          ...
          p += (((i++ ? "/" : "")) + seg); return (function __$mkdirs(_) {
            var __1 = (i > 1); if (!__1) { return _(null, __1); } ; return _exists(__cb(_, __frame, 7, 16, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true), p); })(__cb(_, __frame, -189, 6, function ___(__0, __2) { return (function __$mkdirs(__then) { if (__2) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$mkdirs() {
...
function cachedTransform(_, content, path, transform, banner, options) { var i, dir, f, transformed; var __frame = { name: "cachedTransform", line: 213 }; return __func(_, this, arguments, cachedTransform, 0, __frame, function __$cachedTransform() {
    path = path.replace(/\\/g, "/");
...
exports.compile = function exports_compile__3(_, paths, options) { var failed, transform, cwd;
  function _compile(_, path, options) { var stat, ext, jsPath, source, coffee, compiled, matches; var __frame = { name: "_compile", line: 245 }; return __func(_, this, arguments, _compile, 0, __frame, function __$_compile() {
      return fs.stat(path, __cb(_, __frame, 1, 13, function ___(__0, __3) { stat = __3; return (function __$_compile(__then) {
          if (stat.isDirectory()) {
            return fs.readdir(path, __cb(_, __frame, 3, 3, function ___(__0, __4) { return __4.forEach_(__cb(_, __frame, 3, 3, __then, true), function __1(_, f) { var __frame = { name: "__1", line: 248 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
              ...
              if (stat.isFile()) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$_compile() {
                      ...
                      return exports.loadFile(__cb(_, __frame, 8, 4, function __$_compile() {
                            ...
                            return exports.compileFile(__cb(_, __frame, 11, 5, __then, true), path, options); } else { return (function __$_compile(__then) {
                              if (((ext === ".coffee") && (path[((path.length - ext.length) - 1)] !== "_"))) {
                                jsPath = (path.substring(0, (path.length - ext.length)) + ".js"); return (function __$_compile(_) {
                                  var __2 = options.force; if (__2) { return _(null, __2); } ; return mtime(__cb(_, __frame, 14, 26, function ___(__0, __4) { return mtime(__cb(_, __frame, 14, 43, function ___(__0, __5) { var __3 = (__4 > __5); return _(null, __3); }, true), jsPath); }, true), path); })(__cb(_, __frame, -244, 6, function ___(__0, __5) { return (function __$_compile(__then) { if (__5) {
                        ...
                        failed++; __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(__then); } ; })(_); }, true)); }); }; var __frame = { name: "exports_compile__3", line: 244 }; return __func(_, this, arguments, exports_compile__3, 0, __frame, function __$exports_compile__3() {
    ...
    return paths.forEach_(__cb(_, __frame, 48, 1, function __$exports_compile__3() {
      ...
      if (failed) { return _(new Error((("errors found in " + failed) + " files"))); } ; _(); }, true), function __1(_, path) { var __frame = { name: "__1", line: 292 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _compile(__cb(_, __frame, 1, 2, _, true), fspath.resolve(cwd, path), options); }); }); });};
