...
asyncTest("trampoline", 1, function __16(_) {
  function sums(_, n) { var fn; var __frame = { name: "sums", line: 442 }; return __func(_, this, arguments, sums, 0, __frame, function __$sums() {
    ...
    return sums(__cb(_, __frame, 8, 8, function ___(__0, __1) { equals(__1, (50000 * 100001));
      start(); _(); }, true), 100000); });});


asyncTest("queue overflow", 5, function __17(_) { var queue, produce, consume; var __frame = { name: "__17", line: 453 }; return __func(_, this, arguments, __17, 0, __frame, function __$__17() {
    queue = flows.queue(2);
    ...
    produce = function __1(_) { var __frame = { name: "__1", line: 456 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return queue.write(__cb(_, __frame, 1, 8, function __$__1() { return queue.write(__cb(_, __frame, 2, 8, function __$__1() { return queue.write(__cb(_, __frame, 3, 8, function __$__1() { return queue.write(__cb(_, __frame, 4, 8, function __$__1() { _(); }, true), 25); }, true), 16); }, true), 9); }, true), 4); }); }(false);





    consume = function __2(_) { var __frame = { name: "__2", line: 462 }; return __func(_, this, arguments, __2, 0, __frame, function __$__2() { return queue.read(__cb(_, __frame, 1, 20, function ___(__0, __1) { strictEqual(__1, 4); return queue.read(__cb(_, __frame, 2, 20, function ___(__0, __2) { strictEqual(__2, 9); return queue.read(__cb(_, __frame, 3, 20, function ___(__0, __3) { strictEqual(__3, 16); return queue.read(__cb(_, __frame, 4, 20, function ___(__0, __4) { strictEqual(__4, 25); _(); }, true)); }, true)); }, true)); }, true)); }); }(false);
    return produce(__cb(_, __frame, 15, 1, function __$__17() {
      return consume(__cb(_, __frame, 16, 1, function __$__17() {
        strictEqual(queue.peek(), undefined);
        start(); _(); }, true)); }, true)); });});


asyncTest("queue length, contents, alter", 8, function __18(_) { var queue; var __frame = { name: "__18", line: 474 }; return __func(_, this, arguments, __18, 0, __frame, function __$__18() {
    queue = flows.queue();
    return queue.write(__cb(_, __frame, 2, 7, function __$__18() {
      return queue.write(__cb(_, __frame, 3, 7, function __$__18() {
        return queue.write(__cb(_, __frame, 4, 7, function __$__18() {
          return queue.write(__cb(_, __frame, 5, 7, function __$__18() {
            ...
            return queue.read(__cb(_, __frame, 13, 19, function ___(__0, __1) { strictEqual(__1, 25);
              strictEqual(queue.peek(), 9);
              return queue.read(__cb(_, __frame, 15, 19, function ___(__0, __2) { strictEqual(__2, 9);
                strictEqual(queue.peek(), undefined);
                start(); _(); }, true)); }, true)); }, true), 25); }, true), 16); }, true), 9); }, true), 4); });});


asyncTest("trampoline preserves context", 2, function __19(_) { var globals, fn, result; var __frame = { name: "__19", line: 494 }; return __func(_, this, arguments, __19, 0, __frame, function __$__19() {
    globals = require("streamline/lib/globals");
    fn = function fn__1(_) { var __frame = { name: "fn__1", line: 496 }; return __func(_, this, arguments, fn__1, 0, __frame, function __$fn__1() {
        return _(null, globals.context.val); }); };

    globals.context.val = "abc";
    return flows.trampoline(__cb(_, __frame, 6, 20, function ___(__0, __2) { result = __2;
