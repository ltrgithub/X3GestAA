								...
								case "application/json":
									...
									if (layout.cards) {
										fieldData.forEach(function(value, index) {
											html.push('<li>');
											if (layout.$items) _controls.types._cards(html, layout.$items, field.$proto, value, controller, false, index, field.$bind);
											html.push('</li>');
										});
									} else {
										if (layout.$items) {
						...
						if (p === "detail") {
							...
							if (cd && Array.isArray(cd) && (p >= 0)) {
								...
								*/
								...
								$layout = $proto.auth.compositionLayout(null, pp, null, false);
