(function($) {
	...
	_controls.types._table_row = function(html, fields, $prototype, value, controller, edit, index) {
		...
		if (edit) {
			html.push('<td>');
			html.push('<a href="#" data-role="button"  data-index="'+index+'" data-action="edit" xdata-iconpos="notext" data-mini="true" data-icon="edit"');
			html.push('>'+that.locale().ui.edit_item+'</a>');
			html.push('</td>');
			html.push('<td>');
			html.push('<a href="#" data-role="button"  xdata-iconpos="notext" data-index="'+index+'" data-action="delete" data-mini="true"data-icon="delete"');
	...
	_controls.types._cards = function(html, fields, $prototype, value, controller, edit, index) {
		...
		if (edit) {
			html.push('<tr>');
			html.push('<td>');
			html.push('<a href="#" data-role="button"  xdata-iconpos="notext"  data-index="'+index+'" data-action="edit" data-mini="true" data-icon="edit"');
			html.push('>'+that.locale().ui.edit_item+'</a>');
			html.push('</td>');
			html.push('<td>');
			html.push('<a href="#" data-role="button"  xdata-iconpos="notext"  data-index="'+index+'" data-action="delete" data-mini="true"data-icon="delete"');
