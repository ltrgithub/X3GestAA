...
(function($) {
	...
	_controls.types._cards = function(html, fields, $prototype, value, controller, edit, index, parentBind) {
		...
		if (edit) {
			...
			html.push('<a href="#" class="" data-role="button"  data-index="'+index+'" data-action="detail" data-iconpos="left" data-theme="f" data-inline="true"  data-mini="true" data-icon="false">');
			html.push("...");
		}
		...
		events: function($c, c) {	
			...
			if (!edit) {
				$c.click(function(e) {
					...
					if (!target) return;
					var p = $(target).attr("data-action"), page;
					if (p) {
						if (p === "detail") {
