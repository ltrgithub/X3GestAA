...
(function($) {
	...
	_controls.types._table_header = function(html, layout, $prototype, edit) {
		...
		if (layout.noDetailLink !== true){
			html.push('<th data-priority="' + fields.length + '">' + $helpers.htmlEncode($helpers.locale().ui.array_detail) + '</th>');
		}
		html.push('</tr></thead>');
		html.push('<tbody>');
	};
	_controls.types._table_row = function(html, layout, $prototype, value, controller, edit, index) {
		var fields = layout.$items;
		html.push('<tr>');
		var prop = $prototype.$properties;
		var first = true;
								...
								case "application/json":
									...
									if (layout.cards) {
										...
										if (layout.$items) {
											html.push('<li>');
											//html.push('<div>'); 
											_controls.types._table_header(html, layout, field.$proto);
											fieldData.forEach(function(value, index) {
												_controls.types._table_row(html, layout, field.$proto, value, controller, false, index);
