...
(function($) {
	...
	that.controls.SyncView = {
		create_buttons: function(controller, b1html,b2html , buttons, id) {
			...
			if (hasdata) {
				var del_itm = {linkId: id+ "_undo", title:$helpers.locale().ui.sync_cancel_all, action: "undo" , "jmdata": {"data-iconpos":"top", "data-theme":"b", "data-icon":"delete", "data-transition": "none"}};
