...
(function($) {
	...
	that.controls.SyncView = {
		create_buttons: function(controller, b1html,b2html , buttons, id) {
			...
			if (hasdata) {
				var del_itm = {linkId: id+ "_undo", title:$helpers.locale().ui.sync_cancel_all, action: "undo" , "jmdata": {"data-iconpos":"top", "data-theme":"g", "data-icon":"delete", "data-transition": "none"}};
				that._addLink(b1html, del_itm, controller, function() {	
					b1html.push($helpers.htmlEncode(del_itm.title));
				});	
				buttons.push(del_itm.linkId);
				var send_itm = {linkId: id+ "_sync", title:$helpers.locale().ui.sync_send_all, action: "sync", "jmdata": {"data-iconpos":"top","data-icon":"arrow-u", "data-theme":"f", "data-transition": "none"}};
				...
				var rinstall_itm = {linkId: id+ "_install", title:$helpers.locale().ui.sync_resync_data, action: "resync", "jmdata": {"data-iconpos":"top", "data-icon":"arrow-d", "data-theme":"f", "data-transition": "none"}};
		...
		handler: function(c, after) {
			...
			html.push('<ul class="s-m-list"  id="'+c.id + '_ul" data-role="listview"');
