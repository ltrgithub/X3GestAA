	...
	ui.settings = function() {	
		...
		return {
			...
			"content": { 
				...
				"c1": {"uiClass":"CheckBox", "data" : { "label": locale.ui.transparent_logon, "bind": "autoLogon" }, "parent": "cp" },
				"c2": {"uiClass":"Combo", "data" : { "label": locale.ui.auth_type, "bind": "authType","value": "basic", "items":[ {value: "basic", title:"Basic"}] }, "parent": "cp" },
				...
				"avanced": {"layout":"CollapsibleLayout", "parent": "cp", "data" : {"text": locale.ui.avanced_options, "collapsed": true}},
				"d1": {"uiClass":"CheckBox", "data" : { "label": locale.ui.dev_mode, "bind": "devmode" }, "parent": "avanced" },
				"d2": {"uiClass":"Edit", "data" : { "label": "Device Name", "bind": "deviceName" }, "parent": "avanced" },
				"d3": {"uiClass":"CheckBox", "data" : { "label": "Ignore errors on install", "bind": "installWithErrors" }, "parent": "avanced" }
			},
			"hbuttons":[
