...
(function($) {
	...
	var layout = {
		...
		CollapsibleLayout:function(layoutData) {
			var  options= layoutData.data
			var b = ['<div id="'+layoutData.id+'" data-role="collapsible"  data-iconpos="right" data-collapsed="'+(options.collapsed?"true":"false")+'"'];
			b.push(' "data-expanded-icon": "arrow-u"');
			b.push(' "data-collapsed-icon": "arrow-d"'); 
