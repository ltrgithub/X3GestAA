...
(function($) {
	$.smobile =  $.smobile || {};
	$.smobile.locale = function() {
		if ($.smobile._locale) return $.smobile._locale; 
		$.smobile._locale = {
			"administration": {
				"title": "Sage ERP X3 Syracuse",
				"welcome": "Welcome"
			},
			"maintoolbar": {
				"home": "Home",
			...
			"errorpagetitle": "Defult Error Page",
			...
			"ui": {
				...
				"sync_sync_data": "Resynchronize local database",
				...
				"mandatory_field": "\"{0}\" is required.",
				"minlength_field": "Please enter at least {0} characters.",
				"picture_file": "Choose a file",
				"picture_photo": "Take a photo",
				"picture_nocamera": "No camera found."
