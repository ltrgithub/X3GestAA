...
(function($) {
	...
	that.controls.Picture = {
		...
		createPicture: function(controller, c) {
			...
			html.push('<a id="' + c.id + '_file" class="s-m-min40 ui-btn-right" data-theme="f" data-role="button" data-mini="true" data-icon="plus" data-iconpos="top" data-inline="true">' + $helpers.locale().ui.picture_file + '</a>');
			html.push('</div>');
			html.push('</div>');
			return {
				html: html.join(''),
