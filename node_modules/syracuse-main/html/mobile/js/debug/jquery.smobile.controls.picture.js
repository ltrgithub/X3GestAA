(function($) {
	...
	that.controls.Picture = {
		...
		createPicture: function(controller, c) {
			...
			html.push('"/></center>');
			html.push('</div>'); 
			html.push('<a id="'+c.id+'_file" data-theme="f" data-role="button" data-mini="true" data-icon="file" data-inline="true">'+that.locale().ui.picture_file+'</a>');
			html.push('<a id="'+c.id+'_photo" data-theme="f" data-role="button" data-mini="true" data-icon="photo" data-inline="true">'+that.locale().ui.picture_photo+'</a>');
			html.push('</div>'); 
			return { 
				html: html.join(''),
				bind: options.bind,
