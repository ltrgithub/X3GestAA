...
(function($) {
	...
	var _createHeaderRight = function(controller, uiData) {
		...
		if (uiData && uiData.roptions && uiData.roptions.nopanel) {
			...
			html.push('<a id="'+controller.prefix+'right_panel" href="#'+ controller.prefix +'rpanel" data-role="button"  data-theme="a"  data-inline="true" data-iconpos="notext" data-icon="bars" data-corners="false" data-iconshadow="false" data-shadow="false"> </a>');
		//html.push('</div>');
		return html;
	};
	...
	var _private =  { 
		...
		representation2ui: function(params, data) {	
			...
			if (params.facet ==  "$dashboard") {
				...
				var content = {"$title": {uiClass: "Html", "data": {"html": "<h3></h3>"}}, "error": {"uiClass": "ErrorView"}};
