...
(function($) {
	...
	Controller.prototype = {
		...
		openSortDialog: function() {
			var controller = this;
			if ($.smobile.openSortDlg) { // declared in jquery.smobile.controls.filter.js
				var order = $.smobile.controls.SDataSorter._getOrderBy(controller);
				$.smobile.openSortDlg(controller, order, controller.getSortFields());
			}
		},
