...
(function($) {
	...
	var _createHeaderRight = function(controller) {
		var html = [];
		//html.push('<div id="'+controller.prefix+'headerright" data-type="horizontal" data-role="controlgroup" class="ui-btn-right">');
		html.push('<a id="'+controller.prefix+'right_panel" href="#'+ controller.prefix +'rpanel" data-inline="true" data-iconpos="notext" data-icon="bars" data-corners="false" data-iconshadow="false" data-shadow="false"></a>');
		//html.push('</div>');
		return html;
	};
	var _buildPage = function (pagename, $currentPage, $page, ui, data, info, pageInfo, $template, cb) {
		...
		var _afterSetTitle = function() {
			if (pageInfo && pageInfo.page && pageInfo.page.home) { 
				...
				var headerRight = _createHeaderRight(controller);
	...
	var _loadDataAndDesign = function (query, page, cb) {
		...
		var _addappItems = function (items, ritems) {
			...
			var item = {code: "actions", title: $sdata.config.title, items: []};
			var item = {code: "links", title: $sdata.config.title, items: []};
			
			item = {code: "footer", title: $sdata.config.title, items: []};
	...
	that.createPage = function(page) {
		...
		if (page.page.isHome && !page.page.useAppId)
			$page.addClass("s-m-home-bckg");
		else
			$page.addClass("s-m-page-bckg");
