			...
			$.sdata.authenticate(function(ad, error, offline) {
				...
				if (!postData) {
					...
					if (params.$parameters) {
						var stag = (url.indexOf("?")?"&":"?");
						var inUrl = true;
						Object.keys(params.$parameters).forEach(function(pn){
							postData[pn] =  $.proto.parseExpression(params.$parameters[pn], {data: controller.exprData(), $prototype: $.proto.getProto(page, params.bind)},"$parameters");
							if (inUrl && (postData[pn] != null)) {
								url = url + stag + pn + "=" + encodeURIComponent(postData[pn]);
								stag =  "&";
							}							
