...
(function($) {
	...
	function _filterUi(controller) {
		...
		res.hbuttons = [
			{ title: $helpers.locale().ui.ok_item, action: "saveFilter", "jmdata": {"data-icon":"check", "data-transition": "none"} },
			{ title: $helpers.locale().ui.remove_item, action: "clearFilter", "jmdata": {"data-icon":"delete", "data-transition": "none"} }
