	...
	*/
	...
	that.pushAjaxError = function(jqXHR, textStatus, errorThrown, url, method) {
		...
		if (diag && diag.$diagnoses && diag.$diagnoses.length) {
			...
			var err = errorThrown.message ? errorThrown.message : errorThrown.toString();
			if (userMsg==null) userMsg = err;
			else detail += "\n" + err;
		} else if (jqXHR.statusText) {
			if (userMsg==null) userMsg = statusText;
			else detail += "\n" + statusText;
		}
