(function($) {
	...
	that.settings = {
		"CollapsibleLayout": {
			jmdata: function(root) { return {"data-mini":"false", "data-theme":"d", "data-content-theme":"d", "data-inset": (root?"false":"false") }}
		},
	...
	that.generateForm = function(map, cid, content, parentId, root, facet) {
		...
		if (root) {
			cp = "c" + cid;
			cid++;
			content[cp] = {layout:"BlockLayout", data: {jmdata: that.settings.CollapsibleSetsLayout.jmdata()}, parent: parentId};
		}
		if (map.fields) {
