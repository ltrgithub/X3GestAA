		...
		if (map.fields) {
			map.fields.forEach(function(field) {
				if (field.$isSection) {
					...
					var o= null;
					if (field.title) 
						o = {layout:"CollapsibleLayout", data:{facet: facet, jmdata: {"data-theme":"b", "data-content-theme":"d", "data-inset": root?"false":"true"}, text: field.title, collapsed: false, size: 6}};
					if (o) {
						if (cp) o.parent = cp;
						var np = "c"+cid;
						cid++;
