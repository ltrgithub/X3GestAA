...
(function($) {
	...
	that._extractDiag = function(data, prop, res) {
		...
		Object.keys(data).forEach(function(pn){	
			...
			if (Array.isArray(o)){
				for (var i = 0, len=o.length; i<len; i++) {
					var co = o[i];
					if (typeof co === "object") {
						_extractErrors(co, "", false, path?(path +'.'+pn + '['+ i+']'):pn, res);
					}
				}
			} else if (typeof o === "object") {
				_extractErrors(o, "", false, path?(path +'.'+pn):pn, res);
				//
			}
		});
		return res;
