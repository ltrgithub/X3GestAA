	...
	*/	 
	...
	var _indexDB = {
		...
		_removeFromDB: function(db, id, cb) {
			if (!_checkDBHandler(db, cb)) return;
			var tx = db.transaction(["apps", "draft", "sdata", "sdatafrav"], IDBTransaction.READ_WRITE);
			var sdata = tx.objectStore("sdata");
			var draft = tx.objectStore("draft");
			var sdatafrav = tx.objectStore("sdatafrav");
			_indexDB._uninstallDraft(draft, sdata, sdatafrav,  id, function(){
