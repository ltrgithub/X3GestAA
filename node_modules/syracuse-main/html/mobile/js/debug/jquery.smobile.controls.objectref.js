			...
			$ul.click(function(e) {
				if (e && e.target) {
					...
					if (p === "delete") {
						...
						ui = that.detailUiData(controller, cp, fieldData[p], layout.$items, {canDelete: false});
						...
						ui = that.detailUiData(controller, cp,nv, layout.$items, {canDelete: false});
