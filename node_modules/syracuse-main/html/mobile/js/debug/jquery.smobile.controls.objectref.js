...
(function($) {
	...
	_controls.ArrayObjectRef={
		...
		events: function($c, c) {
			...
			$ul.click(function(e) {
				if (e && e.target) {
					var target = e.target, cp, ui, layout;
					// lift up 2 levels
					...
					if (p === "delete") {
						...
						ui = that.detailUiData(controller, cp, fieldData[p], layout, {canDelete: false});
						...
						ui = that.detailUiData(controller, cp,nv, layout, {canDelete: false});
