(function($) {
	...
	_controls.ArrayObjectRef={
		...
		_addLast: function(controller, options, cp, id, html, fieldData) {
			...
			html.push('<a id="'+id+'_new" data-role="button" data-shadow="false" data-action="new" data-corners="false" data-mini="true" data-theme="d" data-icon="plus" data-iconpos="left" ');
			html.push('href="#">');
