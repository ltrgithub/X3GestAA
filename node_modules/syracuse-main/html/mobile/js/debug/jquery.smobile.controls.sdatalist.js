	...
	that.controls.SDataList={
		...
		createItems: function(controller, options, html) {
			...
			resources.forEach(function(value, index) {
				...
				if (info.addFav) {
					html.push('<div class="s-m-fav-item" data-action="setfavorite" data-action-param="'+index+'"><div data-action-param="'+index+'" data-action="setfavorite" class="ui-icon ui-icon-s-fav-off"></div></div>');
