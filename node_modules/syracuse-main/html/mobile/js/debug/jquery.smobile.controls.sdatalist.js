		...
		handler: function(c, after) {
			...
			if (hasPagination) {
				...
				if (hasPagination) {
					...
					if (pagination.prev) {
						pagination.prev = {si: Math.max(ccd.$startIndex-ccd.$itemsPerPage, 1), count: cd.$itemsPerPage }; 
					}
					pagination.next = (ccd.$startIndex -1 + ccd.$itemsPerPage) < ccd.$totalResults; 
					if (pagination.next) {
						pagination.next = {si: ccd.$startIndex+ccd.$itemsPerPage, count: cd.$itemsPerPage }; 
					}
				}
			}
