...
(function($) {
	...
	that.controls.SDataList={
		...
		handler: function(c, after) {
			...
			html.push('<td class="all"><input data-type="text"  data-mini="true" /></td>');
			html.push('<td class="space"></td>');
			html.push('<td class="button"><a href="#" data-role="button" data-mini="true" data-icon="search">Search</a></td>');
