...
(function($) {
	...
	that.controls.List={
		handler: function(c, after) {
			...
			html.push('<div class="ui-body"><ul id="'+c.id + '" data-role="listview"');
			...
			items.forEach(function(item, index){
				...
				if (cd.divider) {
					...
					if (cd.icon || cd.menu) {
						html.push(' class="' + (cd.menu?that.ui.consts.menu_icon:that.ui.consts.normal_icon)  +'"');
						cd.css = [(cd.menu?that.ui.consts.menu_icon:that.ui.consts.normal_icon)];
					} 
					html.push('>');
					// create content
					var content = "";
