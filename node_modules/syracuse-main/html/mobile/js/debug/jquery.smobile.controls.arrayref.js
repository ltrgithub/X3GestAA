...
(function($) {
	...
	that.controls.ArrayRef={
		...
		createArrayRef: function(controller, c, fieldData) {
			...
			var  html = [];
    		html.push('<ul id="'+c.id + '" class="s-m-list" data-role="listview"');
			...
			html.push('<a id="'+c.id+'_new" data-role="button" data-mini="true" data-theme="f" data-icon="plus" data-iconpos="left" ');
			html.push('href="');
