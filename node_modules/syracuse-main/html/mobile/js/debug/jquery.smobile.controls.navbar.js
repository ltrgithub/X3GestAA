		...
		_handler: function(controller, c, after, syncCount){
			...
			items.forEach(function(item, index) {
				...
				if (item.action === "popup") {
					...
					hafter.push('<div data-role="popup" id="'+ item.popupId+ '" data-theme="d">');
					hafter.push('<ul data-role="listview" data-inset="true" style="min-width:210px;" data-theme="d">');
					hafter.push('<li data-role="divider" data-theme="e">Choose an action</li>');
					hafter.push('<li><a href="#">View details</a></li>');
					hafter.push('<li><a href="#">Edit</a></li>');
					hafter.push('<li><a href="#">Disable</a></li>');
					hafter.push('<li><a href="#">Delete</a></li>');
					hafter.push('</ul>');
