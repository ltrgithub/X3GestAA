		...
		_addinstalled:function(controller, id, iapps, html, refresh) {
			...
			if (iapps && iapps.length) {	
				iapps.forEach(function(cd, index){
					...
					html.push('</div><div class="ui-block-b"><button data-iconpos="top" data-mini="true" data-theme="f" data-icon="delete" id="'+ cd.id + '_remove" data-inline="false">'+that.locale().applicationmanager.uninstall+ '</button></div></div>');
		...
		_addtoinstall:function(controller, id, appsList, html, refresh) {
			...
			if (appsList && appsList.length) {	
				appsList.forEach(function(cd, index){
					...
					html.push('<div class="ui-grid-a"><div class="ui-block-a">');
					html.push($.smobile.ui.menuItem(cd.title, cd.description, cd.icon));
					html.push('</div><div class="ui-block-b"><button data-iconpos="top" data-mini="true" data-theme="f" data-icon="plus" id="'+ cd.id + '_install" data-inline="false">'+that.locale().applicationmanager.install+ '</button></div></div>');
