...
.ui-body-a, .ui-overlay-a {
	...
	background: #4d4f53 /*{a-body-background-color}*/;
	background-image: -webkit-gradient(linear, left top, left bottom, from( #4d4f53 /*{a-body-background-start}*/), to( #4d4f53 /*{a-body-background-end}*/)); /* Saf4+, Chrome */
	background-image: -webkit-linear-gradient( #4d4f53 /*{a-body-background-start}*/, #4d4f53 /*{a-body-background-end}*/); /* Chrome 10+, Saf5.1+ */
	background-image:    -moz-linear-gradient( #4d4f53 /*{a-body-background-start}*/, #4d4f53 /*{a-body-background-end}*/); /* FF3.6 */
	background-image:     -ms-linear-gradient( #4d4f53 /*{a-body-background-start}*/, #4d4f53 /*{a-body-background-end}*/); /* IE10 */
	background-image:      -o-linear-gradient( #4d4f53 /*{a-body-background-start}*/, #4d4f53 /*{a-body-background-end}*/); /* Opera 11.10+ */
	background-image:         linear-gradient( #4d4f53 /*{a-body-background-start}*/, #4d4f53 /*{a-body-background-end}*/);
}
.ui-overlay-a {
...
.ui-body-c, .ui-overlay-c {
	...
	text-shadow: 0 /*{c-body-shadow-x}*/ 1px /*{c-body-shadow-y}*/ 0 /*{c-body-shadow-radius}*/ #383838 /*{c-body-shadow-color}*/;
	background:url(images/m-body-background.png);
}
.ui-overlay-c {
	background-image: none;
	border-width: 0;
...
.ui-btn-up-c {
	border: 1px solid #333333 /*{c-bup-border}*/;
	background: #3C3E41 /*{c-bup-background-color}*/;
	font-weight: bold;
...
.ui-btn-hover-c {
	...
	background: #333 /*{c-bhover-background-color}*/;
	font-weight: bold;
...
.ui-body-d, .ui-overlay-d {
	...
	background:#333333;
	background-image:-webkit-gradient(linear, left top, left bottom, from( #3C3E41 ), to( #333333));
	background-image:-webkit-linear-gradient( #3C3E41, #333333 );
	background-image:-moz-linear-gradient( #3C3E41, #333333 );
	background-image:-ms-linear-gradient( #3C3E41, #333333 );
	background-image:-o-linear-gradient( #3C3E41, #333333 );
	background-image:linear-gradient( #3C3E41, #333333 )
}
.ui-btn-up-d {
	background:none;
...
.ui-bar-e {
	border-color:transparent;
	border-bottom: 1px dotted #34B233;
	color: #34B233;
	background:none;
	font-size: 14px;
...
-----------------------------------------------------------------------------------------------------------*/
.ui-btn-active {
	border: 1px solid #007f64 /*{global-active-border}*/;
	background: #34b233 /*{global-active-background-color}*/;
	font-weight: bold;
	color: #333 /*{global-active-color}*/;
	cursor: pointer;
	text-shadow: none;
	text-decoration: none;
	background-image: -webkit-gradient(linear, left top, left bottom, from( #34b233 /*{global-active-background-start}*/), to( #34b233 /*{global-active-background-end}*/)); /* Saf4+, Chrome */
	background-image: -webkit-linear-gradient( #34b233 /*{global-active-background-start}*/, #34b233 /*{global-active-background-end}*/); /* Chrome 10+, Saf5.1+ */
	background-image:    -moz-linear-gradient( #34b233 /*{global-active-background-start}*/, #34b233 /*{global-active-background-end}*/); /* FF3.6 */
	background-image:     -ms-linear-gradient( #34b233 /*{global-active-background-start}*/, #34b233 /*{global-active-background-end}*/); /* IE10 */
	background-image:      -o-linear-gradient( #34b233 /*{global-active-background-start}*/, #34b233 /*{global-active-background-end}*/); /* Opera 11.10+ */
	background-image:         linear-gradient( #34b233 /*{global-active-background-start}*/, #34b233 /*{global-active-background-end}*/);
	font-family: Helvetica, Arial, sans-serif /*{global-font-family}*/;
}
