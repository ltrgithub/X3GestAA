...
exports.main = function() {
	...
	site.onMainPageChange = function($itemPage) {
		...
		this.designStore.showPageOpener(true);
		...
		$.auth = self.mobileGateway = {
			...
			loadData: function(data, info) {
				...
				syra_site.onMainPageChange({
					openerUrlSegments: syra_url.parse(info.url.origUri),
			...
			onShowTargetPageDiagnoses: function(message, options) {
				this._jsonPage && syra_diagnose.showDiagnoses(message, this._jsonPage, options);
			},
