    ...
    siteFactory.load({
        $layoutOptions: {
            ...
            authoring: {
                ...
                section: "s-aw-designer-h1",
                block: "s-aw-designer-h2",
                menus: "s-page-menus"
            },
            list: {
                menus: "s-list-menus",
        ...
        $module: "ERP X3",
        $pageTemplateUrl: "/sdata/syracuse/collaboration/syracuse/pages('{endpoint}.{representation},{target},{variant}')?role={$role}",
        ...
        $navigation: {
            ...
            $dashboard: {
                ...
                "arrayTest": {
                    ...
                    "$url": "?representation=s-uitest-array.$test"
                },
				"office" :{
					"$title": "Office",
