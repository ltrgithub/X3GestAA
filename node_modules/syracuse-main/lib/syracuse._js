...
if (process.argv[2] && process.argv[2].substr(0, 1) === "N") {
	console.error("MockStreamServer"+process.stdoutOld)
	exports.server = new mock.MockStreamServer(disp, process.stdoutOld, process.stdin);
} else {
	exports.server = new streams.HttpServer(disp);	
}	
