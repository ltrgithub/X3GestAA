...
uiModules.forEach(function(uiModule) {
	authenticatedRoutes[uiModule] = (function(_, req, resp) {
...
*/
	try {
		...
		if (/^\/[^\/]+\/public\//.test(request.url) && !/\/(syracuse-ui|ui-chart|ui-d3-graph|ui-schedule|ui-sql-designer|ui-text|ui-visual-process|uml-designer|syracuse-react)\//.test(request.url)) {
