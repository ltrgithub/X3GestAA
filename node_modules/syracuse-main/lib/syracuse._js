...
function disp(request, response, _) {
	...
	try {
		...
		if ((mem2.rss - mem1.rss) / 1024 / 1024 > 5 || (mem2.heapTotal - mem1.heapTotal) / 1024 / 1024 > 5 || (mem2.heapUsed - mem1.heapUsed) / 1024 / 1024 > 5) {
			...
			console.log("  memory usage before=" + JSON.stringify(mem1) + " after=" + JSON.stringify(mem2));
