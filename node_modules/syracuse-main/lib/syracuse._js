...
var requireDispatcher = require('streamline-require/lib/server/require').dispatcher({
	...
	whiteList: [
		/^(syracuse-(main\/html|ui|core|rtf|office|msoffice|sdata\/lib\/(parser|httpHelper))|streamline|jsurl|js-xml|test-runner|html-escape|html5-binary|node-oauth)(\/|$)/,
		/^syracuse-sdata\/lib\/httpHelper/,
		/^msoffice\/lib\//,
		/^(ez-streams|streamline-runtime|regenerator\/runtime)(\/|$)/,
