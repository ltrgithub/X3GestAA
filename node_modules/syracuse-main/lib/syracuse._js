...
require('syracuse-core/lib/errorHelper').configure(config.system || {}); // to get safeStack
...
var staticShadowProvider = require('streamline-static/lib/staticProvider').staticProvider({
...
var requireDispatcher = require('streamline-require/lib/server/require').dispatcher({
	...
	whiteList: [
		/^(syracuse-(main\/html|ui|core|rtf|office|msoffice|sdata\/lib\/(parser|httpHelper))|streamline|jsurl|js-xml|test-runner|html-escape|node-oauth)(\/|$)/,
