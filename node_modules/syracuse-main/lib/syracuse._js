...
var studio = require('syracuse-studio/lib/studioDispatch');
...
var studioDispatcher = studio.dispatcher(config);
...
var _map = {
	...
	studio: function(_, request, response) {
		return sessionManager.sessionManagement(_, request, response, {
			authRequired: true,
			forceAuth: true
		}) && studioDispatcher(_, request, response);
	},
