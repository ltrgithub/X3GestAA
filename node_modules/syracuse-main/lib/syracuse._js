...
// temporary - deactivate socket on https while load balancer. it failed and the mock is closed
var isHttps = false;
...
if (exports.server instanceof mock.MockStreamServer) {
	if (!isHttps) { // temporary - deactivate socket on https while load balancer. it failed and the mock is closed
