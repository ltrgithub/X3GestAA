...
var requireDispatcher = require('streamline-require/lib/server/require').dispatcher({
	...
	whiteList: [
		/^(syracuse-(main\/html|ui|core|rtf|sdata\/lib\/parser)|streamline|jsurl|jsxml|test-runner|html-escape|html5-binary|node-oauth)\//,
...
process.on('exit', function() {
	...
	var output = require('syracuse-trace/lib/helper').getTempMessages();
