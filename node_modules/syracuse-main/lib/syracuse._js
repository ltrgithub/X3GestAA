...
var twitterDispatcher = require('twitter/lib/dispatcher').dispatcher(config);
...
var discussionFeedDispatcher = function(_, request, response) {
	...
	var feed = {
		...
		message: JSON.parse(request.readAll(_)),
	};
...
var authenticatedRoutes = {
	...
	discussionFeed: discussionFeedDispatcher,
...
var mainRoutes = {
	...
	linkedin: require("syracuse-linkedin/lib/linkedin").dispatcher,
...
//Enable socket.io
exports.socket = require('socket.io').listen(exports.server);
socketHandler.create(_);
