...
config.security.profile = config.security.profile || {};
// Default is to reject all kind of MS Office, OpenOffice, LibreOffice, StarOffice documents
config.security.profile.officeDocumentBlackList = config.security.profile.officeDocumentBlackList || /(msword|ms-word|ms-excel|ms-powerpoint|openxmlformats-officedocument|oasis.opendocument|stardivision)/i;
