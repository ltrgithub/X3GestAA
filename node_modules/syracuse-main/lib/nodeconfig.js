...
// auto-register applications in the applications directory.
fs.readdirSync(path.join(__dirname, '../../applications')).forEach(function(app) {
	config.sdata.endpoints.push({
		contract: "applications/" + app + "/lib/contract",
		datasets: {},
	});
});
//
