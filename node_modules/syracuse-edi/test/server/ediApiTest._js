...
asyncTest("decode/Generate Edi File Xml File", function(_) {
	...
	ok(true, "Dummy - please replace with real test below")
		/*
			var option = {
				xmlFile: uuid[0],
				protocol: uuid[1],
...
// test for certificate existence
asyncTest("certificate existence", 1, function(_) {
	strictEqual(false, EdiProcess.certificateExists(_, "1c2bcz9x"), "Certificate 1c2bcz9x does not exist");
	start();
})
