...
asyncTest("start test environment ", function(_) {
	...
	prototype_EDISIHEndFlag = JSON.parse(fs.readFile(_defDataDir + "context/EDISIHEndFlag.json", 'utf-8', _));
...
asyncTest("generate EDI file API", function(_) {
	...
	var fileBuff = {};
	fileBuff["CABFAC"] = fs.readFile(_defDataDir + "ediFiles/CABFAC", 'utf-8', _);
	fileBuff["LINFAC"] = fs.readFile(_defDataDir + "ediFiles/LINFAC", 'utf-8', _);
	...
	fileBuff["CABFAC1"] = fs.readFile(_defDataDir + "ediFiles/CABFAC1", 'utf-8', _);
	fileBuff["LINFAC1"] = fs.readFile(_defDataDir + "ediFiles/LINFAC1", 'utf-8', _);
	...
	var sadfs = new SadFsqClient(_, endpoint, "apisu", "apisu", false, recOptions);
	fileBuff["CABFAC2"] = fs.readFile(_defDataDir + "ediFiles/CABFAC2", 'utf-8', _);
	fileBuff["LINFAC2"] = fs.readFile(_defDataDir + "ediFiles/LINFAC2", 'utf-8', _);
	var read = sadfs.readFile(_, {
	...
	var sadfs = new SadFsqClient(_, endpoint, "apisu", "apisu", false, recOptions);
	fileBuff["CABFAC3"] = fs.readFile(_defDataDir + "ediFiles/CABFAC3", 'utf-8', _);
	fileBuff["LINFAC3"] = fs.readFile(_defDataDir + "ediFiles/LINFAC3", 'utf-8', _);
	var read = sadfs.readFile(_, {
	...
	var seqFileJson = JSON.parse(fs.readFile(_defDataDir + "context/seqFileSIHMultipleEndFlag.json", 'utf-8', _));
	var SIHJson = JSON.parse(fs.readFile(_defDataDir + "context/jsonSIHmultipleEndFlag.json", 'utf-8', _));
	...
	var sadfs = new SadFsqClient(_, endpoint, "apisu", "apisu", false, recOptions);
	fileBuff["CABFAC4"] = fs.readFile(_defDataDir + "ediFiles/CABFAC4", 'utf-8', _);
	fileBuff["LINFAC4"] = fs.readFile(_defDataDir + "ediFiles/LINFAC4", 'utf-8', _);
	var read = sadfs.readFile(_, {
	...
	var seqFileJson = JSON.parse(fs.readFile(_defDataDir + "context/seqFileTruncate.json", 'utf-8', _));
	var SIHJson = JSON.parse(fs.readFile(_defDataDir + "context/jsonTruncate.json", 'utf-8', _));
	...
	recOptions.fileName = "checkGenerateEdiCache4.json";
	var sadfs = new SadFsqClient(_, endpoint, "apisu", "apisu", false, recOptions);
	fileBuff["CABFAC5"] = fs.readFile(_defDataDir + "ediFiles/CABFAC5", 'utf-8', _);
	var read = sadfs.readFile(_, {
	...
	var seqFileJson = JSON.parse(fs.readFile(_defDataDir + "context/seqFileallIn1file.json", 'utf-8', _));
	uuidJSONMultiple = EdiEntity.createEdiCacheEntity(_, {
		json: SIHJson,
		type: EdiType.JSONCACHE,
		id: "testTruncate",
	...
	var sadfs = new SadFsqClient(_, endpoint, "apisu", "apisu", false, recOptions);
	fileBuff["CABFAC6"] = fs.readFile(_defDataDir + "ediFiles/CABFAC6", 'utf-8', _);
	var read = sadfs.readFile(_, {
...
asyncTest("test parsing xsd file", function(_) {
	var jsXsd = jsxml.parse(fs.readFile(_defDataDir + "context/xsdSample.xsd", 'utf-8', _));
	...
	var jsXsd = jsxml.parse(fs.readFile(_defDataDir + "context/xsdSample2.xsd", 'utf-8', _));

	var list = EdiEntity.executeParseXsd(jsXsd);
	strictEqual(Object.keys(list).length, 10, "number of element generated ok " + Object.keys(list).length);
	strictEqual(JSON.stringify(Object.keys(list)), '["shiporder.item.price","shiporder.item.quantity","shiporder.item.note","shiporder.item.title","shiporder.shipto.country","shiporder.shipto.city","shiporder.shipto.address","shiporder.shipto.name","shiporder.orderperson","shiporder.$.orderid"]', "check elements in the result");

	var jsXsd = jsxml.parse(fs.readFile(_defDataDir + "context/xsdSample3.xsd", 'utf-8', _));
	...
	var jsXsd1 = jsxml.parse(fs.readFile(_defDataDir + "context/xsdSample4Import.xsd", 'utf-8', _));

	var jsXsd2 = jsxml.parse(fs.readFile(_defDataDir + "context/xsdSample4.xsd", 'utf-8', _));
	...
	var result = fs.readFile(_defDataDir + "context/xsdSample4result.json", 'utf-8', _);
...
asyncTest("test parsing xsd file with storage area", function(_) {
	...
	var jsXsd = fs.readFile(_defDataDir + "context/xsdSample.xsd", 'utf-8', _);
	...
	strictEqual(JSON.stringify(resStored), '{"startIndex":1,"count":20,"elems":[{"id":1,"path":"shiporder.item[0..unbounded].price","type":"xs:decimal"},{"id":2,"path":"shiporder.item[0..unbounded].quantity","type":"xs:positiveInteger"},{"id":3,"path":"shiporder.item[0..unbounded].note","type":"xs:string"},{"id":4,"path":"shiporder.item[0..unbounded].title","type":"xs:string"},{"id":5,"path":"shiporder.shipto.country","type":"xs:string"},{"id":6,"path":"shiporder.shipto.city","type":"xs:string"},{"id":7,"path":"shiporder.shipto.address","type":"xs:string"},{"id":8,"path":"shiporder.shipto.name","type":"xs:string"},{"id":9,"path":"shiporder.orderperson","type":"xs:string"},{"id":10,"path":"shiporder.$.orderid","type":"xs:string"}],"totalResult":10}', "result ok");
	...
	var jsXsd = fs.readFile(_defDataDir + "context/xsdSample2.xsd", 'utf-8', _);
	var doc = sa.open(_, null);
	sa.write(_, doc, {
		description: "xsdSample",
		content: {
	...
	strictEqual(JSON.stringify(resStored), '{"startIndex":1,"count":20,"elems":[{"id":1,"path":"shiporder.item[0..unbounded].price","type":"xs:decimal"},{"id":2,"path":"shiporder.item[0..unbounded].quantity","type":"xs:positiveInteger"},{"id":3,"path":"shiporder.item[0..unbounded].note","type":"xs:string"},{"id":4,"path":"shiporder.item[0..unbounded].title","type":"xs:string"},{"id":5,"path":"shiporder.shipto.country","type":"xs:string"},{"id":6,"path":"shiporder.shipto.city","type":"xs:string"},{"id":7,"path":"shiporder.shipto.address","type":"xs:string"},{"id":8,"path":"shiporder.shipto.name","type":"xs:string"},{"id":9,"path":"shiporder.orderperson","type":"xs:string"},{"id":10,"path":"shiporder.$.orderid","type":"xs:string","restriction":{"base":"xs:string","pattern":"[0-9]{6}"}}],"totalResult":10}', "result ok");
	...
	//strictEqual(JSON.stringify(result.json), '{"shiporder.item.price":{"path":"shiporder.item.price","type":"xs:decimal"},"shiporder.item.quantity":{"path":"shiporder.item.quantity","type":"xs:positiveInteger"},"shiporder.item.note":{"path":"shiporder.item.note","type":"xs:string"},"shiporder.item.title":{"path":"shiporder.item.title","type":"xs:string"},"shiporder.shipto.country":{"path":"shiporder.shipto.country","type":"xs:string"},"shiporder.shipto.city":{"path":"shiporder.shipto.city","type":"xs:string"},"shiporder.shipto.address":{"path":"shiporder.shipto.address","type":"xs:string"},"shiporder.shipto.name":{"path":"shiporder.shipto.name","type":"xs:string"},"shiporder.orderperson":{"path":"shiporder.orderperson","type":"xs:string"},"shiporder.$.orderid":{"path":"shiporder.$.orderid","type":"xs:string","restriction":{"base":"xs:string","pattern":"[0-9]{6}"}}}', "result json ok");

	// test with import xsd
	var jsXsd = fs.readFile(_defDataDir + "context/xsdSample4.xsd", 'utf-8', _);
	var doc = sa.open(_, null);
	sa.write(_, doc, {
	...
	var jsXsd = fs.readFile(_defDataDir + "context/xsdSample4import.xsd", 'utf-8', _);
	...
	var res = fs.readFile(_defDataDir + "context/xsd4SampleStorage.json", 'utf-8', _);

	strictEqual(resStored.elems.length, 20, "result number page ok");
	console.log(JSON.stringify(resStored));

	strictEqual(JSON.stringify(resStored), '{"startIndex":0,"count":20,"elems":[{"id":0,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.taxCodes.taxCode[0..unbounded].orderOfPrecedence","type":"xs:decimal"},{"id":1,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.taxCodes.taxCode[0..unbounded].primacyIndicator","type":"xs:boolean"},{"id":2,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.taxCodes.taxCode[0..unbounded].valueText","type":"xs:string"},{"id":3,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.taxCodes.taxCode[0..unbounded].value","type":"xs:decimal"},{"id":4,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.taxCodes.taxCode[0..unbounded].taxationLocale","type":"xs:string"},{"id":5,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.taxCodes.taxCode[0..unbounded].taxationCountry","type":"xs:string"},{"id":6,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.taxCodes.taxCode[0..unbounded].type","type":"xs:string"},{"id":7,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.taxCodes.taxCode[0..unbounded].reference2","type":"xs:string"},{"id":8,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.taxCodes.taxCode[0..unbounded].reference","type":"xs:string"},{"id":9,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.taxCodes.taxCode[0..unbounded].label","type":"xs:string"},{"id":10,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.taxCodes.taxCode[0..unbounded].deleted","type":"xs:boolean"},{"id":11,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.taxCodes.taxCode[0..unbounded].active","type":"xs:boolean"},{"id":12,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.taxCodes.taxCode[0..unbounded].applicationID","type":"xs:string"},{"id":13,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].accountingType","type":"xs:string"},{"id":14,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].currentCommittedCostBalanceDate","type":"xs:date"},{"id":15,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].currentCommittedCostBalance","type":"xs:decimal"},{"id":16,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].currentRevenueBudgetDate","type":"xs:date"},{"id":17,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].currentRevenueBudget","type":"xs:decimal"},{"id":18,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].currentCostBudgetDate","type":"xs:date"},{"id":19,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].currentCostBudget","type":"xs:decimal"}],"totalResult":96813}', "result first page ok");
	...
	strictEqual(resStored.elems.length, 20, "result number page ok");
	strictEqual(JSON.stringify(resStored), '{"startIndex":20,"count":20,"elems":[{"id":20,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].currentCostBudget","type":"xs:decimal"},{"id":21,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].lastRevenueTransactionDate","type":"xs:date"},{"id":22,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].currentRevenueBalance","type":"xs:decimal"},{"id":23,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].lastCostTransactionDate","type":"xs:date"},{"id":24,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].currentCostBalance","type":"xs:decimal"},{"id":25,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].originatorDocument","type":"xs:string"},{"id":26,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].duration","type":"xs:duration"},{"id":27,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].forecastEndDate","type":"xs:date"},{"id":28,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].originalEndDate","type":"xs:date"},{"id":29,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].endDate","type":"xs:date"},{"id":30,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].startDate","type":"xs:date"},{"id":31,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].completionStatus","type":"xs:string"},{"id":32,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].status","type":"xs:string"},{"id":33,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].description","type":"xs:string"},{"id":34,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].shortName","type":"xs:string"},{"id":35,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].name","type":"xs:string"},{"id":36,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].type","type":"xs:string"},{"id":37,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].reference2","type":"xs:string"},{"id":38,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].reference","type":"xs:string"},{"id":39,"path":"tradingAccount.cases.case[0..unbounded].interactions.interaction[0..unbounded].project.contacts.contact[0..unbounded].purchaseCredits.purchaseCredit[0..unbounded].projectLines.projectLine[0..unbounded].isGroupingflag","type":"xs:boolean"}],"totalResult":96813}', "result first page ok");
	...
	/*
     ...
     var list = fs.readdir(_defDataDir + "context/ubl/", 'utf-8', _);
     var docs = [];
     list && list.forEach_(_,function(_,filename){
         var jsXsd = fs.readFile(_defDataDir + "context/ubl/"+filename, 'utf-8', _);
             docs.push(sa.writeAll(_, {
                 description: "UPDATE",
                 content: {
                 contentType: "application/xml",
                 fileName: filename,
    ...
    docs && docs.foeEach_(_,function(_,doc){
       doc.deleteSelf(_);
    });*/
	start();
});
