...
asyncTest("read receipt file", function(_) {
	...
	EdiProcess.mvArchiveFiles(_, protocolJson, ["testMoveEnd.txt"], null, opt); // for unit test
...
asyncTest("generate EDI file API", function(_) {
	...
	console.log("file '" + fileBuff['CABFAC4'] + "'");
...
asyncTest("generate import file API", function(_) {
	...
	var read = sadfs.readFile(_, {
		path: "/home1/adonix/GX3APP/TMP/TESTAP/import/test2"
	}, {
		flag: "r",
		encoding: "utf-8"
	});
