...
asyncTest("generate EDI file API", function(_) {
	...
	var sadfs = new SadFsqClient(_, endpoint.x3server(_).serverHost(_), endpoint.x3server(_).serverPort(_), "apisu", "apisu", false, recOptions);
	var read = sadfs.readFile(_, {
		path: "/home1/adonix/GX3APP/TMP/TESTAP/ISSUE/CABFAC1.undefined"
	}, {
		flag: "r",
		encoding: "utf-8"
	});
	...
	read = sadfs.readFile(_, {
		path: "/home1/adonix/GX3APP/TMP/TESTAP/ISSUE/LINFAC1.undefined"
	}, {
		flag: "r",
		encoding: "utf-8"
	});
	...
	var read = sadfs.readFile(_, {
		path: "/home1/adonix/GX3APP/TMP/TESTAP/ISSUE/CABFAC2.undefined"
	}, {
		flag: "r",
		encoding: "utf-8"
	});
	...
	read = sadfs.readFile(_, {
		path: "/home1/adonix/GX3APP/TMP/TESTAP/ISSUE/LINFAC2.undefined"
	}, {
		flag: "r",
		encoding: "utf-8"
	});
	...
	var read = sadfs.readFile(_, {
		path: "/home1/adonix/GX3APP/TMP/TESTAP/ISSUE/CABFAC3.undefined"
	}, {
		flag: "r",
		encoding: "utf-8"
	});
	...
	read = sadfs.readFile(_, {
		path: "/home1/adonix/GX3APP/TMP/TESTAP/ISSUE/LINFAC3.undefined"
	}, {
		flag: "r",
		encoding: "utf-8"
	});
