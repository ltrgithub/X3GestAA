...
asyncTest("test parsing xsd file", function(_) {
	...
	var cacheuuid = EdiProcess.executeParseXsd(_, {
		db: db,
		id: "sample1"
	}, jsXsd);

	// get uuid fo the document
	var ediCache = EdiEntity.getEdiCacheEntity(_, {
		db: db,
		uuid: cacheuuid
	});
	var content = sa.readAll(_, {
		jsonWhere: {
			$uuid: ediCache.xmlPathId(_)
		}
	}).toString('utf8');
	var doc = sa.getDocumentInstance(_, {
		jsonWhere: {
	...
	strictEqual(content.split('\n').length, 11, "number of element generated ok " + content.split('\n').length);
	console.log("content test 1 '" + '{"path":"shiporder[0..n].item.price","type":"xs:decimal"}\n{"path":"shiporder[0..n].item.quantity","type":"xs:positiveInteger"}\n{"path":"shiporder[0..n].item.note","type":"xs:string"}\n{"path":"shiporder[0..n].item.title","type":"xs:string"}\n{"path":"shiporder[0..n].shipto.country","type":"xs:string"}\n{"path":"shiporder[0..n].shipto.city","type":"xs:string"}\n{"path":"shiporder[0..n].shipto.address","type":"xs:string"}\n{"path":"shiporder[0..n].shipto.name","type":"xs:string"}\n{"path":"shiporder[0..n].orderperson","type":"xs:string"}\n{"path":"shiporder[0..n].$.orderid","type":"xs:string"}\n' + "'");
	console.log("content test 2 '" + content + "'");
	strictEqual(content, '{"path":"shiporder[0..n].item.price","type":"xs:decimal"}\nXm{"path":"shiporder[0..n].item.quantity","type":"xs:positiveInteger"}\n\r{"path":"shiporder[0..n].item.note","type":"xs:string"}\n\r{"path":"shiporder[0..n].item.title","type":"xs:string"}\n\r{"path":"shiporder[0..n].shipto.country","type":"xs:string"}\n\r{"path":"shiporder[0..n].shipto.city","type":"xs:string"}\n\r{"path":"shiporder[0..n].shipto.address","type":"xs:string"}\n\r{"path":"shiporder[0..n].shipto.name","type":"xs:string"}\n\r{"path":"shiporder[0..n].orderperson","type":"xs:string"}\n\r{"path":"shiporder[0..n].$.orderid","type":"xs:string"}\n\r', "check content result");
	...
	doc && doc.deleteSelf();
	strictEqual(content.split('\n').length, 11, "number of element generated ok " + content.split('\n').length);
	strictEqual(content, '{"path":"shiporder[0..n].item.price","type":"xs:decimal"}\n\r{"path":"shiporder[0..n].item.quantity","type":"xs:positiveInteger"}\n\r{"path":"shiporder[0..n].item.note","type":"xs:string"}\n\r{"path":"shiporder[0..n].item.title","type":"xs:string"}\n\r{"path":"shiporder[0..n].shipto.country","type":"xs:string"}\n\r{"path":"shiporder[0..n].shipto.city","type":"xs:string"}\n\r{"path":"shiporder[0..n].shipto.address","type":"xs:string"}\n\r{"path":"shiporder[0..n].shipto.name","type":"xs:string"}\n\r{"path":"shiporder[0..n].orderperson","type":"xs:string"}\n\r{"path":"shiporder[0..n].$.orderid","type":"xs:string","restriction":{"base":"xs:string","pattern":"[0-9]{6}"}}\n\r', "check content result");
	...
	doc && doc.deleteSelf();
	strictEqual(content.split('\n').length, 26, "number of element generated ok " + content.split('\n').length);
	strictEqual(content, '{"path":"Root.Orders[0..n].Order.ShipInfo.ShipCountry","type":"xs:string"}\n\r{"path":"Root.Orders[0..n].Order.ShipInfo.ShipPostalCode","type":"xs:string"}\n\r{"path":"Root.Orders[0..n].Order.ShipInfo.ShipRegion","type":"xs:string"}\n\r{"path":"Root.Orders[0..n].Order.ShipInfo.ShipCity","type":"xs:string"}\n\r{"path":"Root.Orders[0..n].Order.ShipInfo.ShipAddress","type":"xs:string"}\n\r{"path":"Root.Orders[0..n].Order.ShipInfo.ShipName","type":"xs:string"}\n\r{"path":"Root.Orders[0..n].Order.ShipInfo.Freight","type":"xs:decimal"}\n\r{"path":"Root.Orders[0..n].Order.ShipInfo.ShipVia","type":"xs:integer"}\n\r{"path":"Root.Orders[0..n].Order.ShipInfo.$.ShippedDate","type":"xs:dateTime"}\n\r{"path":"Root.Orders[0..n].Order.RequiredDate","type":"xs:dateTime"}\n\r{"path":"Root.Orders[0..n].Order.OrderDate","type":"xs:dateTime"}\n\r{"path":"Root.Orders[0..n].Order.EmployeeID","type":"xs:token"}\n\r{"path":"Root.Orders[0..n].Order.CustomerID","type":"xs:token"}\n\r{"path":"Root.Customers[0..n].Customer.FullAddress.Country","type":"xs:string"}\n\r{"path":"Root.Customers[0..n].Customer.FullAddress.PostalCode","type":"xs:string"}\n\r{"path":"Root.Customers[0..n].Customer.FullAddress.Region","type":"xs:string"}\n\r{"path":"Root.Customers[0..n].Customer.FullAddress.City","type":"xs:string"}\n\r{"path":"Root.Customers[0..n].Customer.FullAddress.Address","type":"xs:string"}\n\r{"path":"Root.Customers[0..n].Customer.FullAddress.$.CustomerID","type":"xs:token"}\n\r{"path":"Root.Customers[0..n].Customer.Fax","type":"xs:string"}\n\r{"path":"Root.Customers[0..n].Customer.Phone","type":"xs:string"}\n\r{"path":"Root.Customers[0..n].Customer.ContactTitle","type":"xs:string"}\n\r{"path":"Root.Customers[0..n].Customer.ContactName","type":"xs:string"}\n\r{"path":"Root.Customers[0..n].Customer.CompanyName","type":"xs:string"}\n\r{"path":"Root.Customers[0..n].Customer.$.CustomerID","type":"xs:token"}\n\r', "check content result");
	...
	strictEqual(content.split('\n').length, 93081, "number of element generated ok " + content.split('\n').length);
...
/*asyncTest("test parsing xsd file with storage area", function(_) {
	...
	var result = EdiProcess.parseXsd(_, {
		xsdUuid: [doc.$uuid],
		idProcess: "testxsdStorag"
	});


	strictEqual(result.uuid != null, true, "result contains an uuid");
	...
	var result = EdiProcess.parseXsd(_, {
		xsdUuid: [doc1.$uuid, doc2.$uuid],
		idProcess: "testxsdStorage2"
	});

	strictEqual(result.uuid != null, true, "result contains an uuid");
	var res = fs.readFile(_defDataDir + "context/xsd4SampleStorage.json", 'utf-8', _);
	strictEqual(JSON.stringify(result.json), res, "result json ok");

	var result = EdiProcess.parseXsd(_, {
		xsdUuid: [doc1.$uuid, doc2.$uuid],
		uuid: result.uuid,

		idProcess: "testxsdStorage3"
	});
	strictEqual(result.uuid != null, true, "result contains an uuid");
	strictEqual(JSON.stringify(result.json), res, "result json ok");
