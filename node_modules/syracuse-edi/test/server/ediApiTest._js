...
asyncTest("generate EDI file API", function(_) {
	...
	console.log("pouett " + JSON.stringify(result));
	...
	fileBuff["CABFAC"] = fs.readFile(_defDataDir + "ediFiles/CABFACMultipleEndFlag.txt", 'utf-8', _);

	strictEqual(read, fileBuff["CABFAC"], "file  CABFAC with multiple end flag");
	...
	fileBuff["LINFAC"] = fs.readFile(_defDataDir + "ediFiles/LINFACMultipleEndFlag.txt", 'utf-8', _);

	strictEqual(read, fileBuff["LINFAC"], "file  LINFAC with multiple end flag");
