...
asyncTest("test parsing xsd file with storage area", function(_) {
	...
	strictEqual(JSON.stringify(resStored), '{"startIndex":1,"count":20,"elems":[{"id":1,"path":"shiporder.item[0..n].price","type":"xs:decimal"},{"id":2,"path":"shiporder.item[0..n].quantity","type":"xs:positiveInteger"},{"id":3,"path":"shiporder.item[0..n].note","type":"xs:string"},{"id":4,"path":"shiporder.item[0..n].title","type":"xs:string"},{"id":5,"path":"shiporder.shipto.country","type":"xs:string"},{"id":6,"path":"shiporder.shipto.city","type":"xs:string"},{"id":7,"path":"shiporder.shipto.address","type":"xs:string"},{"id":8,"path":"shiporder.shipto.name","type":"xs:string"},{"id":9,"path":"shiporder.orderperson","type":"xs:string"},{"id":10,"path":"shiporder.$.orderid","type":"xs:string"}],"totalResult":10}', "result ok");
	...
	var jsXsd = fs.readFile(_defDataDir + "context/facturae.xsd", 'utf-8', _);
	...
	strictEquals(resStored.totalResult, 458, " size of xml path ok");
	strictEquals(resStored.count, 20, " size of xml path ok");
