...
asyncTest("test parsing xsd file", function(_) {
	...
	var docUuid = EdiProcess.executeParseXsd(_, {
		db: db,
		id: "sample1"
	}, jsXsd);
	console.log("doc uuid " + docUuid);
	...
	strictEqual(Object.keys(path).length, 10, "number of element generated ok " + Object.keys(path).length);

	strictEqual(JSON.stringify(path), '{"0":{"path":"shiporder[0..n].item.price","type":"xs:decimal"},"1":{"path":"shiporder[0..n].item.quantity","type":"xs:positiveInteger"},"2":{"path":"shiporder[0..n].item.note","type":"xs:string"},"3":{"path":"shiporder[0..n].item.title","type":"xs:string"},"4":{"path":"shiporder[0..n].shipto.country","type":"xs:string"},"5":{"path":"shiporder[0..n].shipto.city","type":"xs:string"},"6":{"path":"shiporder[0..n].shipto.address","type":"xs:string"},"7":{"path":"shiporder[0..n].shipto.name","type":"xs:string"},"8":{"path":"shiporder[0..n].orderperson","type":"xs:string"},"9":{"path":"shiporder[0..n].$.orderid","type":"xs:string"}}', "check content result");
	...
	var path = JSON.parse(content);
	strictEqual(Object.keys(path).length, 10, "number of element generated ok " + Object.keys(path).length);
	strictEqual(JSON.stringify(path), '{"0":{"path":"shiporder[0..n].item.price","type":"xs:decimal"},"1":{"path":"shiporder[0..n].item.quantity","type":"xs:positiveInteger"},"2":{"path":"shiporder[0..n].item.note","type":"xs:string"},"3":{"path":"shiporder[0..n].item.title","type":"xs:string"},"4":{"path":"shiporder[0..n].shipto.country","type":"xs:string"},"5":{"path":"shiporder[0..n].shipto.city","type":"xs:string"},"6":{"path":"shiporder[0..n].shipto.address","type":"xs:string"},"7":{"path":"shiporder[0..n].shipto.name","type":"xs:string"},"8":{"path":"shiporder[0..n].orderperson","type":"xs:string"},"9":{"path":"shiporder[0..n].$.orderid","type":"xs:string","restriction":{"base":"xs:string","pattern":"[0-9]{6}"}}}', "check content result");
	...
	doc && doc.deleteSelf();
	var path = JSON.parse(content);
	strictEqual(Object.keys(path).length, 25, "number of element generated ok " + Object.keys(path).length);
	strictEqual(JSON.stringify(path), '{"0":{"path":"Root.Orders[0..n].Order.ShipInfo.ShipCountry","type":"xs:string"},"1":{"path":"Root.Orders[0..n].Order.ShipInfo.ShipPostalCode","type":"xs:string"},"2":{"path":"Root.Orders[0..n].Order.ShipInfo.ShipRegion","type":"xs:string"},"3":{"path":"Root.Orders[0..n].Order.ShipInfo.ShipCity","type":"xs:string"},"4":{"path":"Root.Orders[0..n].Order.ShipInfo.ShipAddress","type":"xs:string"},"5":{"path":"Root.Orders[0..n].Order.ShipInfo.ShipName","type":"xs:string"},"6":{"path":"Root.Orders[0..n].Order.ShipInfo.Freight","type":"xs:decimal"},"7":{"path":"Root.Orders[0..n].Order.ShipInfo.ShipVia","type":"xs:integer"},"8":{"path":"Root.Orders[0..n].Order.ShipInfo.$.ShippedDate","type":"xs:dateTime"},"9":{"path":"Root.Orders[0..n].Order.RequiredDate","type":"xs:dateTime"},"10":{"path":"Root.Orders[0..n].Order.OrderDate","type":"xs:dateTime"},"11":{"path":"Root.Orders[0..n].Order.EmployeeID","type":"xs:token"},"12":{"path":"Root.Orders[0..n].Order.CustomerID","type":"xs:token"},"13":{"path":"Root.Customers[0..n].Customer.FullAddress.Country","type":"xs:string"},"14":{"path":"Root.Customers[0..n].Customer.FullAddress.PostalCode","type":"xs:string"},"15":{"path":"Root.Customers[0..n].Customer.FullAddress.Region","type":"xs:string"},"16":{"path":"Root.Customers[0..n].Customer.FullAddress.City","type":"xs:string"},"17":{"path":"Root.Customers[0..n].Customer.FullAddress.Address","type":"xs:string"},"18":{"path":"Root.Customers[0..n].Customer.FullAddress.$.CustomerID","type":"xs:token"},"19":{"path":"Root.Customers[0..n].Customer.Fax","type":"xs:string"},"20":{"path":"Root.Customers[0..n].Customer.Phone","type":"xs:string"},"21":{"path":"Root.Customers[0..n].Customer.ContactTitle","type":"xs:string"},"22":{"path":"Root.Customers[0..n].Customer.ContactName","type":"xs:string"},"23":{"path":"Root.Customers[0..n].Customer.CompanyName","type":"xs:string"},"24":{"path":"Root.Customers[0..n].Customer.$.CustomerID","type":"xs:token"}}', "check content result");
	...
	doc && doc.deleteSelf();
	var path = JSON.parse(content);
	strictEqual(Object.keys(path).length, 93080, "number of element generated ok " + Object.keys(path).length);
