...
asyncTest("test parsing xsd file with storage area", function(_) {
	...
	strictEqual(JSON.stringify(resStored), '{"startIndex":1,"count":20,"elems":[{"id":1,"path":"shiporder.item[0..n].price","type":"http://www.w3.org/2001/XMLSchema:decimal"},{"id":2,"path":"shiporder.item[0..n].quantity","type":"http://www.w3.org/2001/XMLSchema:positiveInteger"},{"id":3,"path":"shiporder.item[0..n].note","type":"http://www.w3.org/2001/XMLSchema:string"},{"id":4,"path":"shiporder.item[0..n].title","type":"http://www.w3.org/2001/XMLSchema:string"},{"id":5,"path":"shiporder.shipto.country","type":"http://www.w3.org/2001/XMLSchema:string"},{"id":6,"path":"shiporder.shipto.city","type":"http://www.w3.org/2001/XMLSchema:string"},{"id":7,"path":"shiporder.shipto.address","type":"http://www.w3.org/2001/XMLSchema:string"},{"id":8,"path":"shiporder.shipto.name","type":"http://www.w3.org/2001/XMLSchema:string"},{"id":9,"path":"shiporder.orderperson","type":"http://www.w3.org/2001/XMLSchema:string"},{"id":10,"path":"shiporder.$.orderid","type":"http://www.w3.org/2001/XMLSchema:string"}],"totalResult":10}', "result ok");
	...
	strictEqual(JSON.stringify(resStored), '{"startIndex":1,"count":20,"elems":[{"id":1,"path":"shiporder.item[0..n].price","type":"http://www.w3.org/2001/XMLSchema:decimal"},{"id":2,"path":"shiporder.item[0..n].quantity","type":"http://www.w3.org/2001/XMLSchema:positiveInteger"},{"id":3,"path":"shiporder.item[0..n].note","type":"http://www.w3.org/2001/XMLSchema:string"},{"id":4,"path":"shiporder.item[0..n].title","type":"http://www.w3.org/2001/XMLSchema:string"},{"id":5,"path":"shiporder.shipto.country","type":"http://www.w3.org/2001/XMLSchema:string"},{"id":6,"path":"shiporder.shipto.city","type":"http://www.w3.org/2001/XMLSchema:string"},{"id":7,"path":"shiporder.shipto.address","type":"http://www.w3.org/2001/XMLSchema:string"},{"id":8,"path":"shiporder.shipto.name","type":"http://www.w3.org/2001/XMLSchema:string"},{"id":9,"path":"shiporder.orderperson","type":"http://www.w3.org/2001/XMLSchema:string"},{"id":10,"path":"shiporder.$.orderid","type":"xs:string","restriction":{"base":"xs:string","pattern":"[0-9]{6}"}}],"totalResult":10}', "result ok");
	...
	strictEqual(resStored.totalResult, 448, " size of xml path ok");
	...
	strictEqual(resStored.totalResult, 462, " size of xml path ok");
	strictEqual(resStored.count, 20, " size of xml path ok");
...
asyncTest("decode/Generate Edi File Xml File", function(_) {
	...
	var option = {
		xmlFile: JSON.parse(readFile("context/xmlFileFacturae.json", 'utf-8', _));,
		protocol: JSON.parse(readFile("context/protocol.json", 'utf-8', _));,
		prototype: JSON.parse(readFile("context/EDISIH1FACTURA_$details.json", 'utf-8', _));,
		sadfsq: {
			recOptions: recOptions
		},
		folder: "GX3APP",
