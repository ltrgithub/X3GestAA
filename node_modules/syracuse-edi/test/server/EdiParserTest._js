...
asyncTest("test with prototype", 11, function(_) {
	var prototype = {
		$properties: {
			val: {
	...
	strictEqual(JSON.stringify(map), JSON.stringify({
		...
		"array": {
			"": "A.D",
			"ref4.CUR": ["C", "0", null, [0, "ref.CUR", 9, 1, 0, 0], "L", "0", null, [0, "ref.CUR", 13, 1, 0, 0]]
		},
		"ref2.ref3.CUR": ["A.C"],
		"ref2.array2": {
			"": "A.E",
...
asyncTest("different mappings test", 22, function(_) {
	var mappings = [{
		xml: "A.B",
		json: "u"
	}, {
	...
	strictEqual(JSON.stringify(map), JSON.stringify({
		...
		"u": ["A.B", "10", null, [0, "a", 6, "ab'cd", 0, 0], "A.C", "0", null, [0, "a", 2, 'ab"cd', 0, 0], "A.D", "0", null, [0, "a", 3, "abcd", 0, 0]]
	}), "several");
	var map = helpersTool.preprocessMapping(_, [{
		xml: "A.B",
		json: "u",
...
asyncTest("preprocess test", 22, function(_) {
...
asyncTest("converter test", 17, function(_) {
	// empty XML
	var map = helpersTool.preprocessMapping(_, [{
		xml: "A.B[0..n].C",
		json: "u.v"
...
asyncTest("fine points about conditions", 26, function(_) {
	...
	strictEqual(JSON.stringify(map), JSON.stringify({
		...
		"u": {
			...
			"v": {
				"": "C",
				"s": ["D", "0", null, [0, "z", 9, 1, 0, 0]],
				"x": ["E", "0", null, [1, "w", 9, 1, 0, 0]],
				"y": ["F", "0", null, [2, "t", 9, 1, 0, 0]]
			}
		}
	}), "process map")
	var converted = helpersTool.convert({
	...
	strictEqual(JSON.stringify(map), JSON.stringify({
		...
		"u": {
			"": "A.B",
			"v": ["A", "0", null, [1, "a", 9, 2, 6, 12, 1, "b", 9, 3, 0, 12, 1, "d", 9, 4, 18, 30, 1, "e", 9, 5, 24, 30, 1, "f", 9, 6, 0, 30, 1, "g", 9, 7, 0, 0]]
		}
	...
	strictEqual(JSON.stringify(map), JSON.stringify({
		...
		"u": {
			"": "A.B",
			"v": ["A", "0", null, [1, "a", 9, 2, 12, 6, 1, "b", 9, 3, 12, 24, 1, "c", 9, 4, 0, 18, 1, "d", 9, 5, 0, 24, 1, "e", 9, 6, 0, 0]]
		}
	...
	strictEqual(JSON.stringify(map), JSON.stringify({
		...
		"u": {
			"": "A.B",
			"v": ["A", "0", null, [1, "e", 9, 6, 0, 6, 1, "c", 9, 4, 18, 12, 1, "d", 9, 5, 18, 0, 1, "a", 9, 2, 0, 24, 1, "b", 9, 3, 0, 0]]
		}
	...
	strictEqual(JSON.stringify(map), JSON.stringify({
		...
		"u": {
			"": "A.B",
			"v": ["A", "0", null, [1, "e", 9, 6, 0, 6, 1, "a", 9, 2, 18, 12, 1, "b", 9, 3, 18, 0, 1, "c", 9, 4, 0, 24, 1, "d", 9, 5, 0, 0]]
		}
	...
	strictEqual(JSON.stringify(map), JSON.stringify({
			...
			"u": {
				"": "A.B",
				"v": ["A", "0", null, [1, "a", 9, 1, 0, 6, 1, "b", 9, 2, 12, 24, 1, "c", 9, 3, 18, 24, 1, "d", 9, 4, 0, 24, 1, "e", 9, 5, 30, 42, 1, "f", 9, 6, 36, 42, 1, "g", 9, 7, 0, 42, 1, "h", 9, 8, 0, 0]]
			}
		}),
		"and condition with more than 2 operators")
	console.log("HHH" + JSON.stringify(map));
