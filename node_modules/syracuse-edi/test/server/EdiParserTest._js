...
asyncTest("different mappings test", 18, function(_) {
	...
	strictEqual(JSON.stringify(map), JSON.stringify({
		...
		"u": ["A.B", "10", null, ["a", 15, "ab'cd"], "A.C", "0", null, ["a", 10, 'ab"cd'], "A.D", "0", null, ["a", 11, "abcd"]]
	}), "several");
	var map = helpersTool.preprocessMapping(_, [{
		xml: "A.B",
		json: "u",
...
asyncTest("parse xml file", function(_) {
	...
	var option = EdiProcess.createContextParserXmlFile(xmlFile, {})
	...
	var option = EdiProcess.createContextSerializerXmlFile(xmlFile, {
		fileNames: {
