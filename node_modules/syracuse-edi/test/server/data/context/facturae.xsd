                ...
                <xs:element name="Invoices" type="InvoicesType">
                    <xs:annotation>
                        <xs:documentation xml:lang="en">
                            Set of invoices contained in the file. For all numeric elements, calculations will always be carried out rounding up to the corresponding decimal places.
                        </xs:documentation>
                        <xs:documentation xml:lang="es">
    ...
    <xs:complexType name="FileHeaderType">
        <xs:sequence>
            ...
            <xs:element name="Modality" type="ModalityType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Single or Batch. If it is "single" (I) the amounts of the fields of group Batch will match their corresponding fields of group InvoiceTotals and field InvoicesCount will always take the value "1". If it is a "batch" (L), the value of field InvoicesCount will always be > "1".
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:element name="InvoiceIssuerType" type="InvoiceIssuerTypeType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Party who signs the invoice. If the value "TE" (Issuer type) is chosen, all sections of group ThirdParty must be filled in.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Tipo Emisor Factura. Puede tomar 3 valores (EM, RE y TE), que se describen como “Proveedor (antes denominado emisor)”, “Destinatario (antes denominado cliente o receptor)” y “Tercero”, respectivamente. Si toma el valor "TE" el grupo ThirdParty será obligatorio cumplimentarlo en todos sus apartados.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
    ...
    <xs:complexType name="BatchType">
        <xs:sequence>
            ...
            <xs:element name="TotalOutstandingAmount" type="AmountType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Sum of the amounts TotalOutstandingAmount of the File, up to eight decimal points. It is the amount which will be effectively debited deducted the payments on account made and non-inclusive of any amount withheld.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Total a pagar. Suma de los importes TotalOutstandingAmount del Fichero, hasta ocho decimales. Es el importe que efectivamente se adeuda, una vez descontados los anticipos y sin tener en cuenta las retenciones.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
            <xs:element name="TotalExecutableAmount" type="AmountType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Sum of the differences of the amounts (TotalOutstandingAmount and WithholdingAmount) of the file = Sum of the amounts TotalExecutableAmount, up to eight decimal points. It is the amount that is debited less any amount withheld as a performance guarantee.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Total a Ejecutar. Sumatorio de las diferencias de los importes (TotalOutstandingAmount y WithholdingAmount) del fichero = Sumatorio de los Importes TotalExecutableAmount, hasta ocho decimales. Es el importe que se adeuda minorado en un posible importe retenido en garantía de cumplimientos contractuales.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
    ...
    <xs:complexType name="BusinessType">
        <xs:sequence>
            ...
            <xs:element name="PartyIdentification" type="PartyIdentificationType" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Party Identification; Fill with your Invoicing program identification number for the party.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
    ...
    <xs:complexType name="InvoiceHeaderType">
        <xs:sequence>
            ...
            <xs:element name="InvoiceDocumentType" type="InvoiceDocumentTypeType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        It can be a complete, abbreviated or self invoice, a payment on account, ticket... In this standard tickets are not considered.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Tipo documento factura. Puede tomar 3 valores (FC, FA y AF), que se describen como “Factura completa u ordinaria”, “Factura simplificada” y “Código sin uso desde la entrada en vigor del RD 1789/2010. Se mantiene por compatibilidad hacia atrás. Antes significaba autofactura. Para indicar que se trata de una factura expedida por el destinatario, se recomienda emplear el elemento InvoiceIssuerType empleando el valor RE, que significa Destinatario”, respectivamente.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
    ...
    <xs:complexType name="InvoiceIssueDataType">
        <xs:sequence>
            ...
            <xs:element name="OperationDate" type="xs:date" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Date on which the service is rendered or the good is delivered. ISO 8601:2004. This date is mandatory where it is not the same as the Issue Date.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:element name="InvoicingPeriod" type="PeriodDates" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Only when necessary: Service provided temporarily or Summary. This information is compulsory when data InvoiceClass (Type) takes the value "OC" or "CC". ISO 8601:2004.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:element name="TaxCurrencyCode" type="CurrencyCodeType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        ISO 4217:2001 Alpha-3 code of the currency in which the tax is paid.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
    ...
    <xs:complexType name="ExchangeRateDetailsType">
        <xs:sequence>
            <xs:element name="ExchangeRate" type="DoubleUpToEightDecimalType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Art. 79.eleven of Law 37/92 of 28th December on the Value Added Tax. Seller rate fixed by Banco de España in force when the chargeable event occurs. Up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Tipo de Cambio. Artº 79.once de la Ley 37/92 de 28 de diciembre del Impuesto sobre el Valor Añadido. Cambio vendedor fijado por el Banco de España y vigente en el momento del devengo. Hasta ocho decimales.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
    ...
    <xs:complexType name="CorrectiveType">
        <xs:sequence>
            <xs:element name="InvoiceNumber" type="TextMax20Type" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Number of the invoice being corrected. Mandatory where “CorrectionMethod” (Code of the correction method applied) takes the value “01” or “02”.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:element name="TaxPeriod" type="PeriodDates">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Natural period in which the tax effects of the invoice to be corrected were produced; and therefore in which taxes were paid, and which is now adjusted. ISO 8601:2004.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:element name="CorrectionMethod" type="CorrectionMethodType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Numerical code to identify the method applied to correct an invoice. “01” – all items to be corrected in the original invoice are reflected. “02” – only items already corrected are noted. “03” – “Bulk deal” in a given period correction method. “04” – Authorized by the Tax Agency.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:element name="CorrectionMethodDescription" type="CorrectionMethodDescriptionType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Description of the method associated with the code indicated in the previous field. "01" – “Full items” correction method. "02" – “Corrected items only” correction method. “03” – “Bulk deal” in a given period correction method. “04” – Authorized by the Tax Agency.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
    ...
    <xs:complexType name="InvoiceLineType">
        <xs:sequence>
            ...
            <xs:element name="ReceiverTransactionDate" type="xs:date" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Date on which the buyer party carried out the transaction.
                    </xs:documentation>
            ...
            <xs:element name="UnitOfMeasure" type="UnitOfMeasureType" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Unit of measure in which the Quantity is expressed. UN/CEFACT Recommendation No.20, Revision 4 and UN/CEFACT Recommendation No.21, Revision 5.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:element name="UnitPriceWithoutTax" type="DoubleUpToEightDecimalType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Unit price of the goods or service rendered, in the currency indicated in the Header of the Invoice. Always without Taxes. Up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:element name="TotalCost" type="DoubleUpToEightDecimalType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Result: Quantity x UnitPriceWithoutTax. Up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:element name="GrossAmount" type="DoubleUpToEightDecimalType">
                <xs:annotation>
                    ...
                    <xs:documentation xml:lang="es">
                        Importe bruto. Resultado: TotalCost - DiscountAmount + ChargeAmount. Hasta ocho decimales.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
            <xs:element name="TaxesWithheld" type="TaxesType" minOccurs="0">
            ...
            <xs:element name="TaxesOutputs">
                <xs:annotation>
                    ...
                    <xs:documentation xml:lang="es">
                        Impuestos repercutidos. Es una secuencia de elementos, cada uno de los cuales contiene la información de un impuesto repercutido.
                    </xs:documentation>
                </xs:annotation>
                <xs:complexType>
                    <xs:sequence>
            ...
            <xs:element name="LineItemPeriod" type="PeriodDates" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Information about the period in which the service is rendered. ISO 8601:2004.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:element name="TransactionDate" type="xs:date" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Effective date when the service was rendered or the goods delivered. ISO 8601:2004.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
        ...
        <xs:sequence>
            ...
            <xs:element name="SpecialTaxableEventReason" type="TextMax2500Type">
                <xs:annotation>
                    ...
                    <xs:documentation xml:lang="es">
                        Justificación de la fiscalidad especial que se aplica en esta operación. Como este elemento se define a nivel de línea, no de impuesto, es necesario especificar a qué impuesto se refiere. Para establecer esta relación, al comienzo de este elemento se indicará el código del impuesto al que corresponde según la lista de código de impuestos del tipo “TaxTypeCodeType”. Si hubiera varios impuestos con el código “05” (“Otro”), se añadirán los valores de sus campos “TaxRate”, “TaxableBase” y “TaxAmount”, en este orden, hasta que sea posible discernirlos; es decir: 05 [valor “TaxRate”] [valor “TaxableBase”] [valor “TaxAmount”]…
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
        </xs:sequence>
    ...
    <xs:complexType name="InvoiceTotalsType">
        <xs:sequence>
            <xs:element name="TotalGrossAmount" type="DoubleUpToEightDecimalType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        (TGA) Total sum of the gross amounts of the invoice items. Up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:element name="GeneralDiscounts" type="DiscountsAndRebatesType" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Discounts on the Total Gross Amount. There will be as many blocks of fields GeneralDiscounts as there are different discount types applied to the same invoice.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Descuentos sobre el Total Importe Bruto. Habrá tantos bloques de campos GeneralDiscounts como clases de descuentos diferentes se apliquen a nivel de factura.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
            <xs:element name="GeneralSurcharges" type="ChargesType" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Charges on the Total Gross Amount. There will be as many blocks of fields GeneralSurcharges as types of charges/surcharges are applied to the invoice.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Cargos sobre el Total Importe Bruto. Habrá tantos bloques de campos GeneralSurcharges como clases de cargos/recargos se apliquen, a nivel de factura.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
            <xs:element name="TotalGeneralDiscounts" type="DoubleUpToEightDecimalType" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Sum of different fields GeneralDiscounts. Up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Total general de descuentos. Sumatorio de los importes de los diferentes campos GeneralDiscounts. Hasta ocho decimales.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
            <xs:element name="TotalGeneralSurcharges" type="DoubleUpToEightDecimalType" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Sum of different fields GeneralSurcharges. Up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:element name="TotalGrossAmountBeforeTaxes" type="DoubleUpToEightDecimalType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Result: TotalGrossAmount - TotalGeneralDiscounts + TotalGeneralSurcharges. Up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:element name="TotalTaxOutputs" type="DoubleUpToEightDecimalType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Sum of different fields Tax Amounts + Total Equivalence Surcharges. Up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Total impuestos repercutidos. Sumatorio de todas Cuotas y Recargos de Equivalencia. Hasta ocho decimales.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
            <xs:element name="TotalTaxesWithheld" type="DoubleUpToEightDecimalType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Sum of different fields TaxAmount. Up to eight decimal points.
                    </xs:documentation>
            ...
            <xs:element name="InvoiceTotal" type="DoubleUpToEightDecimalType">
                <xs:annotation>
                    ...
                    <xs:documentation xml:lang="es">
                        Total factura. Resultado de: TotalGrossAmountBeforeTaxes + TotalTaxOutputs - TotalTaxesWithheld. Hasta ocho decimales.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
            <xs:element name="Subsidies" type="SubsidiesType" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Subsidies, grants or aids for acquisition of certain goods granted by General government.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Subvenciones por adquisición de determinados bienes. Habrá tantos bloques de campos Subsidies como subvenciones se apliquen. En el caso de que la subvención se aplique solo a parte de las operaciones facturadas, en el subelemento SubsidyDescription se especificará también a qué operación corresponde.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
            <xs:element name="PaymentsOnAccount" type="PaymentsOnAccountType" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Payments made on account of the Invoices Total. There will be as many blocks PaymentsOnAccount as types of payments on account applied to the invoice.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:element name="TotalOutstandingAmount" type="DoubleUpToEightDecimalType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Result: InvoiceTotal - (SubsidyAmount + TotalPaymentsOnAccount). Up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Total a pagar. Resultado de: InvoiceTotal - (Total subvenciones + TotalPaymentsOnAccount). En Total subvenciones se suman las cantidades especificadas en los bloques Subsidies. Hasta ocho decimales.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
            <xs:element name="TotalPaymentsOnAccount" type="DoubleUpToEightDecimalType" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Sum of the fields PaymentOnAccountAmount. Up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Total de anticipos. Sumatorio de los campos PaymentOnAccountAmount. Hasta ocho decimales.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
            ...
            <xs:element name="TotalExecutableAmount" type="DoubleUpToEightDecimalType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Result: TotalOutstandingAmount - WithholdingAmount + Reimbursable expenses + Financial expenses. Up to eight points
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Total a ejecutar. Resultado de: TotalOutstandingAmount - Total de Cantidades retenidas + TotalReimbursableExpenses + TotalFinancialExpenses. En Total de Cantidades retenidas se sumaran las cantidades especificadas en los bloques AmountsWithheld. Hasta ocho decimales.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
    ...
    <xs:complexType name="SubsidyType">
        <xs:sequence>
            ...
            <xs:element name="SubsidyRate" type="DoubleUpToEightDecimalType" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Rate applied to the Invoice Total. Percentages are reflected up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Porcentaje de la Subvención. Porcentaje a aplicar al Total Factura. Los porcentajes se reflejan con hasta 8 decimales.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
            <xs:element name="SubsidyAmount" type="DoubleUpToEightDecimalType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Amount to be applied to the Invoice Total. Up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Importe de la Subvención. Importe a aplicar al Total Factura. Hasta ocho decimales.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
        </xs:sequence>
    ...
    <xs:complexType name="PaymentOnAccountType">
        <xs:sequence>
            ...
            <xs:element name="PaymentOnAccountAmount" type="DoubleUpToEightDecimalType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Amount of each payment on account. Up to eight decimal points.
                    </xs:documentation>
    ...
    <xs:complexType name="AmountsWithheldType">
        <xs:sequence>
            ...
            <xs:element name="WithholdingRate" type="DoubleUpToEightDecimalType" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Rate withheld on Payment Total. Percentages are reflected up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Porcentaje de Retención. Porcentaje sobre el Total a Pagar. Los porcentajes se reflejan con hasta 8 decimales.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
            <xs:element name="WithholdingAmount" type="DoubleUpToEightDecimalType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Amount to be withheld on Payment Total. Up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Importe de Retención. Importe a retener sobre el Total a Pagar. Hasta ocho decimales.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
        </xs:sequence>
    ...
    <xs:complexType name="InstallmentType">
        <xs:sequence>
            ...
            <xs:element name="RegulatoryReportingData" type="RegulatoryReportingDataType" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Statistical Code.Customs tariff code set by the Bank of Spain applicable to cross-border transactrions
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:element name="DebitReconciliationReference" type="TextMax60Type" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Reference assignede by the party who pays the invoice.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
    ...
    <xs:complexType name="AdditionalDataType">
        <xs:sequence>
            <xs:element name="RelatedInvoice" type="TextMax40Type" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Number and Series code of any related invoice as agreed by the Issuer/Recipient.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
    ...
    <xs:complexType name="DiscountType">
        <xs:sequence>
            ...
            <xs:element name="DiscountRate" type="DoubleUpToEightDecimalType" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Rate to be applied to the Total Gross Amount (TGA). Percentages are reflected up to 8 decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Porcentaje a descontar del Total Importe Bruto (TIB). Los porcentajes se reflejan con hasta 8 decimales.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
            <xs:element name="DiscountAmount" type="DoubleUpToEightDecimalType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Amount to be discounted from the TGA. Up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
    ...
    <xs:complexType name="ChargeType">
        <xs:sequence>
            ...
            <xs:element name="ChargeRate" type="DoubleUpToEightDecimalType" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Rate to be charged to the TGA. Percentages are reflected up to 8 decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:element name="ChargeAmount" type="DoubleUpToEightDecimalType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Amount to be charged to the TGA. Always up to eight decimal places.
                    </xs:documentation>
    ...
    <xs:complexType name="TaxType">
        <xs:sequence>
            ...
            <xs:element name="TaxRate" type="DoubleUpToEightDecimalType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Rate to be applied in each case. Up to eight decimal points.
                    </xs:documentation>
    ...
    <xs:complexType name="TaxOutputType">
        <xs:sequence>
            ...
            <xs:element name="TaxableBase" type="AmountType">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Total Gross Amount + Surcharges – Global Discounts/invoice, for each type, rate and Equivalence Surcharge. Taxable base of the taxes. Up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:element name="TaxAmount" type="AmountType" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Amount resulting from applying the corresponding rate to the taxable base. Up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:element name="SpecialTaxAmount" type="AmountType" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Special amount resulting from applying the corresponding rate to the special taxable base. Up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
                        Cuota especial. Importe resultante de aplicar el tipo de gravamen sobre la base imponible del régimen especial del grupo de entidades. Hasta ocho decimales.
                    </xs:documentation>
                </xs:annotation>
            </xs:element>
            ...
            <xs:element name="EquivalenceSurchargeAmount" type="AmountType" minOccurs="0">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Result of applying the Equivalence Surcharge percentage to the Taxable Base. Up to eight decimal points.
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
...
-->
    ...
    <xs:simpleType name="ReasonCodeType">
        <xs:restriction base="xs:string">
            ...
            <xs:enumeration value="04">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        "Name and surnames/Corporate name – Issuer (Sender)"
                    </xs:documentation>
            ...
            <xs:enumeration value="06">
                <xs:annotation>
                    <xs:documentation xml:lang="en">"Issuer’s Tax Identification Number"</xs:documentation>
                    <xs:documentation xml:lang="es">"Identificación fiscal Emisor/Obligado"</xs:documentation>
                </xs:annotation>
            </xs:enumeration>
            <xs:enumeration value="07">
                <xs:annotation>
                    <xs:documentation xml:lang="en">"Receiver’s Tax Identification Number"</xs:documentation>
                    <xs:documentation xml:lang="es">"Identificación fiscal Receptor"</xs:documentation>
                </xs:annotation>
            </xs:enumeration>
            <xs:enumeration value="08">
                <xs:annotation>
                    <xs:documentation xml:lang="en">"Issuer’s address"</xs:documentation>
                    <xs:documentation xml:lang="es">"Domicilio Emisor/Obligado"</xs:documentation>
                </xs:annotation>
            </xs:enumeration>
            <xs:enumeration value="09">
                <xs:annotation>
                    <xs:documentation xml:lang="en">"Receiver’s address"</xs:documentation>
    ...
    <xs:simpleType name="PaymentMeansType">
        <xs:restriction base="xs:string">
            ...
            <xs:enumeration value="17">
                <xs:annotation>
                    <xs:documentation xml:lang="en">Banker’s draft</xs:documentation>
    ...
    <xs:simpleType name="TaxTypeCodeType">
        <xs:restriction base="xs:string">
            ...
            <xs:enumeration value="10">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        IECDPCAC: Excise duties on oil derivates in Canaries
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
            ...
            <xs:enumeration value="26">
                <xs:annotation>
                    <xs:documentation xml:lang="en">
                        Excise duty applied to manufactured tobacco in Canaries
                    </xs:documentation>
                    <xs:documentation xml:lang="es">
