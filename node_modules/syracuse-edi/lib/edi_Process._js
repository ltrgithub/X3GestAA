...
exports.createContextParserXmlFile = function(xmlFile, option) {
	...
	option.configParser = {
		parser: "xml",
		elems: _createContextXmlFile(xmlFile, mapFilesCode),
	};
	return option;
}
...
exports.validateMapping = function(_, opt) {
		...
		var option = exports.createContextParserXmlFile(xmlFile, opt);
...
exports.decodeEdiFiles = function(_, idProcess, opt) {
	...
	try {
		...
		if (seqFile) {
			...
			option = exports.createContextParserXmlFile(xmlFile, option);
...
function _createContextXmlFile(xmlFile, mapFilesCode) {
	var elems = [];
...
exports.createContextSerializerXmlFile = function(xmlFile, option) {

	option.configSerializer = {
		serializer: "xml",
		elems: _createContextXmlFile(xmlFile, option.fileNames),
	};
	...
	try {
		...
		if (uuids.length > 0) {
			...
			if (!xmlFile) {
				...
				mapField = xmlMap;
				option = exports.createContextSerializerXmlFile(xmlFile, opt);
