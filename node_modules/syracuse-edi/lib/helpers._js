...
require('syracuse-core/lib/trace').getTracer("edi.entity");
require('syracuse-core/lib/trace').getTracer("edi.process");
require('syracuse-core/lib/trace').getTracer("edi.parser");
require('syracuse-core/lib/trace').getTracer("edi.serializer");
