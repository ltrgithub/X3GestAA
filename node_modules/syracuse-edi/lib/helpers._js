...
require('@sage/syracuse-core').getTracer("edi.entity");
require('@sage/syracuse-core').getTracer("edi.process");
require('@sage/syracuse-core').getTracer("edi.parser");
require('@sage/syracuse-core').getTracer("edi.serializer");
...
exports.xmlFilePropertyMap = {
	...
	elems: {
		...
		idXmlPath: "EXF_EXFD_PATHID",
		condition: "EXF_EXFD_CONDITIONPAT"
	},
	extId: "KEYPROTOPATH",
	cacheUuid: "UUIDXMLTYP",
...
exports.EdiClass = helpers.defineClass(function(_, db, entityName) {
	entityName = entityName || "ediCache";
