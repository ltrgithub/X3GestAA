...
exports.getEntity = function(_, ep, entityName, id, etag) { // get data of an entity
	try {
...
exports.getPrototype = function(_, endpoint, repName, facet) {
	//TODO  change by getting data from the cache. we can't recall in the same socket the prototype from X3
