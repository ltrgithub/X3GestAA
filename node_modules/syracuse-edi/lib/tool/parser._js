			...
			if (records) {
				...
				records.forEach(function(record) {
					...
					elems.filter(function(prev, cur) {
						return configParser.elems[cur] && configParser.elems[cur].fileId === filename && configParser.elems[cur].flag === recFlag;
		...
		Object.keys(input).forEach(function(filename) {
			...
			lines && lines.forEach(function(line) {
				configParser.elems.filter(function(prev, cur) {
					...
					return configParser.elems[cur] && configParser.elems[cur].fileId === filename;
