...
exports.decodeEdiFiles = function(_, idProcess, opt) {
	...
	try {
		...
		seqFile[sqMap.elem].forEach(function(item, idx, arr) {
			var classInstname = mapFilesCode[sqMap.classInstance] || null;
				...
				try {
					...
					if (res) {
						...
						var sta = { // TODO manage severity warning
							uuid: uuid,
							fileNames: Object.keys(document).reduce(function(previousValue, currentValue, index, array) {
								return currentValue + "." + encodingContext.EXT;
							})
						};
						// purge json in cache
						if (!opt.keepCache) {
