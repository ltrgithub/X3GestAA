...
*/
	...
	//exportMetadataAndPush(_, ['AABREV']);

	//exportMetadataAndPush(_, ['AABREV']);
	//exportMetadataAndPush(_, undefined, "commit message global");

	//	gitCommitAndPush(_, "remove all");
...
if (program.importMeta || program.all) importMetadataToMongo(_);
