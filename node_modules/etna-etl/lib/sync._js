...
exports.newSync = function(_, endpoint, tracker) {
	...
	function _syncTextServer(_, baseUrl) {
		console.log("syncTextServer:" + baseUrl);
		...
		// Export ATEXTE
		console.log("syncTextServer buildExecute");
		...
		function syncLan(_, lan) {
			console.log("synchronize language:" + lan);
			var textResults = exporter.buildExecute(_, null, "NUMERO_0, LAN_0, TEXTE_0, COMMENT_0", "ATEXTE", "NUMERO, LAN", {
				LAN: lan
			}, null, null);
