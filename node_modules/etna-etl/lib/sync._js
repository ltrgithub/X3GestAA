...
exports.newSync = function(config, tracker) {
	...
	if (!nodeLocalConfig.etl || !nodeLocalConfig.etl.metaFolder)
		throw new Error("Missing etl.metaFolder in nodelocal.js.");

	var solutionPath = config.solutionPath || path.resolve(__dirname, '../../../tmp');
	config.metaFolder = nodeLocalConfig.etl.metaFolder;
