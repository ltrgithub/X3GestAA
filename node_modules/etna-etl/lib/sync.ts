...
export function newSync(_: _, endpoint: any, tracker?: Tracker) {
	...
	function _initTextsServer(_: _, baseUrl: string, product: string, type: string, post: string, getSql: (driver:Driver, args:any), transform:(context:any,record:any), afterTransform?:(driver:Driver,context:any,lan:string)) {
