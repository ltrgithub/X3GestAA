	...
	function _initMenus(_: _, baseUrl: string, product: string) {
		return _initTextsServer(_, baseUrl, product, "APLSTD", "SYNC_APLSTD",
			(driver:Driver, args:any) => {
				...
				return "select a.LANCHP_0, a.LANNUM_0, a.LAN_0, a.LANMES_0, a.LANORI_0 , b.MENLOCAL_0 from APLSTD a"
			...
			(context:any,record:any) => {
				...
				else if(record.LANNUM === 0) context.codes = {};
				return record;	
			});
	}

	function _initTextsServer(_: _, baseUrl: string, product: string, type: string, post: string, getSql: (driver:Driver, args:any), transform:(context:any,record:any)) {
