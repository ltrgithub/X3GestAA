...
import { Dict, Exporter, Tracker, Descriptor, FileStruct } from './exporter'
...
exports.run = function (_: _, exporter: Exporter, entity: Descriptor, tracker: Tracker, entityNames: string[], options?: Options) {
