...
if (program.exportMeta) sync.exportMetadataAndPush(_);
	...
	// sync.exportMetadataAndPush(_, 'actions', ['CONTSEL'], options);
	...
	// sync.exportMetadataAndPush(_, 'globvars', ['GABAN'], options);
	...
	sync.exportMetadataAndPush(_, 'representations', ['AVOLUME', 'POSCOD', 'APSADX', 'TABLAN', 'TABUNIT', 'AQCLNK01'], options);
