...
if (program.exportMeta) sync.exportMetadataAndPush(_);
	...
	//sync.exportMetadataAndPush(_, 'actions', ['ABIIMP'], {skipGit:true, skipTexts:true});
	// sync.exportMetadataAndPush(_, 'actions', ['ABATPAR'], {skipGit:true, skipTexts:true});
	//sync.exportMetadataAndPush(_, 'activitycodes', ['ABI'], {skipGit:true, skipTexts:true});
	...
	sync.exportMetadataAndPush(_, 'tables', ['ATABLE'], {
		skipGit: true,
		skipTexts: true
	});
