...
//var x3 = require("etna-etl/lib/sync").extractMetadataFromX3(_);
...
if (program.exportMeta) sync.exportMetadataAndPush(_);
	...
	// sync.exportMetadataAndPush(_, 'tables', ['ABANK', 'ATABLE', 'AABREV'], {skipGit:true, skipTexts:true});
	...
	sync.exportMetadataAndPush(_, 'actions', ['ABIIMP'], {
		skipGit: false,
		skipTexts: true
	});
