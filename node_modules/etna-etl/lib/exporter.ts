...
export interface Exporter {
    ...
    resourceExists(_: _, res: Resource): string;
...
export function newExporter(config: ExporterConfig): Exporter {
    ...
    function getResourcePath(_: _, res: Resource) {
        ...
        return path.join(absoluteFolder, '_' + res.fileName + ".json");
    }

    function resourceExists(_: _, res: Resource) {
        return fs.exists(getResourcePath(_,res), _, _);
    }

    function writeResource(_: _, res: Resource) {
        var absoluteFilename = getResourcePath(_,res);
