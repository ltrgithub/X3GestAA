...
asyncTest("Call generic ws operation 'run' on 'QLFWSADD'", function(_) {
	var recFileName = "genericSoapTest_QLFWSADD_RUN";
	// force new cookie
...
<FLD NAME=\"R\" >0</FLD>\
	...
	checkMessage(messages.type, 3, messages.message, "Bad input parameters.");
...
asyncTest("Call generic ws operation 'query' on 'OAUS'", function(_) {
	var recFileName = "genericSoapTest_OAUS_QUERY";
	// force new cookie
	cookie = getCookie(_, true);
...
asyncTest("Call generic ws operation 'read' on 'OAUS'", function(_) {
	var recFileName = "genericSoapTest_OAUS_READ";
	// force new cookie
	cookie = getCookie(_, true);
...
asyncTest("Call generic ws operation 'save' on 'OAUS'", function(_) {
	var recFileName = "genericSoapTest_OAUS_SAVE";
	// force new cookie
	cookie = getCookie(_, true);
	...
	<TAB DIM=\"20\" ID=\"AUS5_2\" SIZE=\"2\">\
		<LIN NUM=\"1\">\
			...
			<FLD NAME=\"ZROL\" TYPE=\"Char\">Tests unitaires</FLD>\
			<FLD NAME=\"BPR\" TYPE=\"Char\">TEST1</FLD>\
		</LIN>\
		<LIN NUM=\"2\">\
			<FLD NAME=\"ROL\" TYPE=\"Char\">AQC</FLD>\
			<FLD NAME=\"ZROL\" TYPE=\"Char\">Tests unitaires</FLD>\
			<FLD NAME=\"BPR\" TYPE=\"Char\">TEST5</FLD>\
		</LIN>\
	</TAB>\
</PARAM>";
...
asyncTest("Call generic ws operation 'delete' on 'OAUS'", function(_) {
	var recFileName = "genericSoapTest_OAUS_DELETE";
	// force new cookie
	cookie = getCookie(_, true);
