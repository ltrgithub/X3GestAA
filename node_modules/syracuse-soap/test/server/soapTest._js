...
asyncTest("init database", 1, function(_) {
	...
	db = new mongodb.Db("mongodb_admin_test", server, {});
	db = db.open(_);
	db.dropDatabase(_);
...
asyncTest("parents", 84, function(_){
	try{		
		...
		// READ
		body = postSoap(_, "testMultiple", "readParent", {_key: parent}).parent;
...
asyncTest("paging", 43, function(_){
	...
	body = postSoap(_, "testPageds", "listPaged", {_count: "1", _orderBy: {orderBy:{binding: "name"}}});
	...
	body = postSoap(_, "testPageds", "listPaged", {_count: "1", _pageInfo: "2", _orderBy: {orderBy:{binding: "name"}}});
	...
	body = postSoap(_, "testPageds", "listPaged", {_count: "3", _pageInfo: "1", _orderBy: {orderBy:{_binding: "name",_descending: "true"}}});
