...
var CvgOutputBuilder = helpers.defineClass(function(description, lang, options) {
...
exports.CvgOutputBuilderXml = helpers.defineClass(function(description, lang, resultParamMap, options) {
	CvgOutputBuilder.call(this, description, lang, options);
...
exports.CvgOutputBuilderJson = helpers.defineClass(function(description, lang, resultParamMap, options) {
	CvgOutputBuilder.call(this, description, lang, options);
	this.resultParamMap = resultParamMap;
	this.currentIdx = 0;
}, CvgOutputBuilder, {
			...
			if (field.$.DIM > 1 && field.$.MEN) {
				...
				for (var i = 0; i < field.$.DIM; i++) {
					...
					if (_p && _p.resu) {
						...
						_lst.push(_val);
						_lstLbl.push(this.findMenuLabel(field.$.MEN, _p.resu));
					}
				}
				if (_lst.length > 0) elt[field.$.NAM] = _lst;
