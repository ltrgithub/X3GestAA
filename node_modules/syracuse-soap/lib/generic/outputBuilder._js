...
var OutputBuilder = helpers.defineClass(function(description, lang, options) {
...
exports.OutputBuilderXml = helpers.defineClass(function(description, lang, resultParamMap, options) {
	OutputBuilder.call(this, description, lang, options);
...
exports.OutputBuilderJson = helpers.defineClass(function(description, lang, resultParamMap, options) {
	OutputBuilder.call(this, description, lang, options);
	this.resultParamMap = resultParamMap;
	this.currentIdx = 0;
}, OutputBuilder, {
