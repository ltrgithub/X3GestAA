...
exports._process = function(_, request, response) {
	...
	try {
		switch (cmdName) {
			case "update":
				var diags = soapClassicPool.updateExternal(_, parsed.query.uuid);
...
function getPortsMessages(_, out) {
	var res = {};
	var lines = out.split(/[\r\n]+/);
...
var parsers = {
	getInfos: getPortsMessages,
	update: getPortsMessages,
	stop: getPortsMessages,
};
