...
exports.WsCall = helpers.defineClass(function() {
	...
	init: function(params, requestConfig) {
		...
		this.adapiPub = ["adxwss.requestid=" + helpers.uuid.generate('-')];
	...
	_traceRequestSummary: function() {
		if (this.wsTraces) {
			this.addWsTrace("### Begin Request summary");
			this.addWsTrace("*** request config: \r\n" + JSON.stringify(this.requestConfig, null, 2));
			this.addWsTrace("*** Object keys: [nb:" + (this.itemKeys != null ? this.itemKeys.length : 0) + "]\r\n" + JSON.stringify(this.itemKeys, null, 2));
			this.addWsTrace("*** Line keys: [nb:" + (this.par != null ? this.par.length : 0) + "]" + (this.par ? "\r\n" + JSON.stringify(this.par, null, 2) : ""));
			this.addWsTrace("*** Block key: [nb:" + (this.tab != null ? 1 : 0) + "]" + (this.tab ? "\r\n" + JSON.stringify(this.tab, null, 2) : ""));

			this.addWsTrace("### End Request summary\r\n");
