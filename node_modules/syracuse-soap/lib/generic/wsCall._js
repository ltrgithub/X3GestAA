...
var TechInfo = require('./techInfo').TechInfo;
...
exports.WsCall = helpers.defineClass(function() {
	...
	init: function(params, requestConfig) {
		...
		if (this.flow != null && typeof this.flow !== "string") throw new Error(locale.format(module, "noCdata"));
		...
		this.wsTraces && this._traceRequestSummary();
		return this;
	},
