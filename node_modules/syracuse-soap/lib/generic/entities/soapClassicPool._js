...
function parseDiagnoses(instance, input) {
...
exports.entity = {
	...
	$functions: {
		...
		start: function(_, force, context) {
			var pool = this.getPool(_, true).start(_, force, context, this);
			console.log("pool start " + JSON.stringify(pool, null, 2));
			return pool;
		},
		...
		start: {
			...
			$execute: function(_, context, instance, parameters) {
				...
				if (lbMode) {
					...
					parseDiagnoses(instance, result);
				} else {
