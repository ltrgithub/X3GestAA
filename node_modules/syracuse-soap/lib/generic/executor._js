...
var AckcallExecutor = helpers.defineClass(function(serviceName) {
	...
	intercept: function(_, context) {
		var pool, wsClient, response, responseRoot, useSoapStyle, wsCall, responseProperties, responseNodeName, returnNodeName;
		try {
			wsCall = new WsCall();
			// start total timer
			...
			var responseNodeNameNs = "wss:" + responseNodeName;
			responseRoot = {};
