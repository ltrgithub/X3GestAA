...
var _invokeMap = {
	post: function(_, context) {
		var test = {
				  "$prototype":{
					  "$descriptor": "prototype GetMortgagePayment.$response",
					  "$type": "application/json",
					  "$prototype": "http://ecchambard-001:8124/soap-stubs/syracuse/collaboration/syracuse/Mortgage/MortgageSoap12/$prototypes('GetMortgagePayment.$response')",
					  "$baseType": "application/json;vnd.sage=syracuse",
					  "$baseUrl": "http://ecchambard-001:8124/soap-stubs/syracuse/collaboration/syracuse/Mortgage/MortgageSoap12",
					  "$value": "Use this Web service to figure out your monthly mortgage payment",
					  "$title": "GetMortgagePayment",
					  "$description": "GetMortgagePaymentSoapOut : GetMortgagePayment : Use this Web service to figure out your monthly mortgage payment",
					  "$representation": "GetMortgagePayment",
