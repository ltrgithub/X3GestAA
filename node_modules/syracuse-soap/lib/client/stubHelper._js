...
var stubHelper = helpers.defineClass(function(_, name, wsdl, url, options, isIncomingChild) {
...
exports.create = function(_, name, wsdl, url, options, isIncomingChild){
	try{

		var stub = new stubHelper(_, name, wsdl, url, options, isIncomingChild);
