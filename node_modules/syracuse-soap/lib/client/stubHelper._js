...
//			console.log("getSubNode: ns="+ns+" && name="+name);
//			console.log("Node="+(node != null));
			...
			if (name.indexOf(':') !== -1){
//				if(node.$ && node.$.xmlns === getNamespaceUrl(ns)){
//					return node[splitNs(name).type];
//				}else{
					return node[name];
//				}
			}else{
//				if(node.$ && node.$.xmlns){
//					console.log("xmlns="+node.$.xmlns);
//					console.log("ns url="+getNamespaceUrl(ns));
//				}
//				if(node.$ && node.$.xmlns === getNamespaceUrl(ns)){
//					return node[name];
//				}else{
...
//				schemas = getSubNode(types, null, 'schema');
						...
						function inspectElement(elt, nature){
							...
							function handleRestriction(restriction){
								...
								forEachKey(restriction, function(key, value) {
									...
									// Handle whiteSpace
									else if (key === _whiteSpace){
										// TODO
										nyi(key);
									}
									// Handle minInclusive
									else if (key === _minInclusive){
										// TODO
										nyi(key);
									}
									// Handle maxInclusive
									else if (key === _maxInclusive){
										// TODO
										nyi(key);
									}
									// Handle minExclusive
									else if (key === _minExclusive){
										// TODO
										nyi(key);
									}
									// Handle maxExclusive
									else if (key === _maxExclusive){
										// TODO
										nyi(key);
									}
									// Handle fractionDigits
									else if (key === _fractionDigits){
										// TODO
										nyi(key);
									}
									// Handle totalDigits
									else if (key === _totalDigits){
										// TODO
										nyi(key);
									}
									else if (key !== '$'){
							...
							function handleComplexType(_cp){
								...
								forEachKey(_cp, function(key, value) {
									...
									else if (key === _simpleContent){
										// TODO
										nyi(key);
									}
									else if (key === _complexContent){
										// TODO
										nyi(key);
									}
									else if (key === _group){
									...
									else if (key === _sequence){
										handleSequence(value);
									}
									else if (key === _attribute){
										if (Array.isArray(value)){
									...
									else if (key === _attributeGroup){
										// TODO
										nyi(key);
									}
									else if (key === _anyAttribute){
										// TODO
										nyi(key);
									}
									else if (key !== '$'){
		...
		// XSD elements
		var _all = xsdNs+":all";
		var _annotation = xsdNs+":annotation";
		var _any = xsdNs+":any";
		var _anyAttribute = xsdNs+":anyAttribute";
		var _appInfo = xsdNs+":appInfo";
		var _attribute = xsdNs+":attribute";
		var _attributeGroup = xsdNs+":attributeGroup";
		var _choice = xsdNs+":choice";
		var _complexContent = xsdNs+":complexContent";
		var _complexType = xsdNs+":complexType";
		var _documentation = xsdNs+":documentation";
		var _element = xsdNs+":element";
		var _extension = xsdNs+":extension";
		var _field = xsdNs+":field";
		var _group = xsdNs+":group";
		var _import = xsdNs+":import";
		var _include = xsdNs+":include";
		var _key = xsdNs+":key";
		var _keyref = xsdNs+":keyref";
		var _list = xsdNs+":list";
		var _notation = xsdNs+":notation";
		var _redefine = xsdNs+":redefine";
		var _restriction = xsdNs+":restriction";
		var _schema = xsdNs+":schema";
		var _selector = xsdNs+":selector";
		var _sequence = xsdNs+":sequence";
		var _simpleContent = xsdNs+":simpleContent";
		var _simpleType = xsdNs+":simpleType";
		var _union = xsdNs+":union";
		var _unique = xsdNs+":unique";


		// XSD restrictions
		var _enumeration = xsdNs+":enumeration";
		var _pattern = xsdNs+":pattern";
		var _whiteSpace = xsdNs+":whiteSpace";
		var _length = xsdNs+":length";
		var _minLength = xsdNs+":minLength";
		var _maxLength = xsdNs+":maxLength";
		var _minInclusive = xsdNs+":minInclusive";
		var _maxInclusive = xsdNs+":maxInclusive";
		var _minExclusive = xsdNs+":minExclusive";
		var _maxExclusive = xsdNs+":maxExclusive";
		var _fractionDigits = xsdNs+":fractionDigits";
		var _totalDigits = xsdNs+":totalDigits";
