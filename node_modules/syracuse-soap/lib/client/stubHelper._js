...
var stubHelper = helpers.defineClass(function(_, instance, wsdl, isIncomingChild) {
	...
	getWsdl: function(_, url){
		...
		var options = {};
		if (this.instance && this.instance.authentication(_) !== "none"){
			options.auth = {
									...
									if (value.type){
										...
										if (xsdComplexType){
											...
											if (xsdSimpleType){
												...
												throw new Error("XSD type '"+eltType+"' not found.");
											}
										}
...
exports.create = function(_, instance, wsdl, isIncomingChild){
	try{

		var stub = new stubHelper(_, instance, wsdl, isIncomingChild);
