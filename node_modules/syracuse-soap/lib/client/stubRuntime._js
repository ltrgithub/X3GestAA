...
var httpHelper = require("syracuse-core/lib/http");
var clientHelper = require("syracuse-httpclient/lib/helper");
...
//						"xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance"
		...
		if (resp){
			...
			if (resp.statusCode === 200 && resp.body){
				...
				throw new Error(resp.body || httpHelper.getStatusMessage(resp.statusCode));
			}
		}else{
