...
//					if (sHelper.isChild(title,element.$item, entityName)){
//						console.log("CHILD");
//						formatted.$.type = "tns:" + entityType + "--list";
//					}
					// TODO: UNCOMMENT WHEN £PROTOTYPE WILL BE AVAILABLE WITH X3
					//if (entityType != null ){
					if (entityType != null &&  ((!complexTypeExists(entityType + "--type") && !complexTypeExists(entityType + "--list"))  ||  (sHelper.isChild(title,element, entityName)))     ){
						formatted.$.type = "tns:" + entityType + "--list";
