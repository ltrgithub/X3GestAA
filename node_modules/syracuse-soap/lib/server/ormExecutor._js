...
var ormExecutor = helpers.defineClass(function(_,entityName, context) {
	...
	if (context.applicationRef && context.applicationRef.protocol(_) !== "syracuse"){
	...
	if (!this.context.entity && this.context.db) { // TEST to allow stubs
		console.log("NAME="+entityName);
		this.context.entity = this.context.db.getEntity(_, entityName);

		console.log("ENTITY="+util.inspect(this.context.entity));
