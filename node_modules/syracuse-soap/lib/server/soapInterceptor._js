	...
	translateRequest: function(_, soapAction, reqBody){
		...
		if (reqBody[nsSoap + "Envelope"].$[namespaceDeclaration]){
			...
			if (opRequest.$ && opRequest.$.xmlns){
				...
				throw new Error("Namespace declaration not found: "+namespaceDeclaration);
			}
		}
