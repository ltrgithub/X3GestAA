...
exports.getSoapWebServices = function(_, context){
...
exports.getSoapWebService = function(_, serviceName, context){
	...
	if (instances.length > 1)
		throw context.notFound("Severals web services found for name: " + serviceName);

	if (instances.length !== 1)
		throw context.notFound("Web service not found: " + serviceName);
