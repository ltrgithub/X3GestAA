...
colProto.aggregate = function(aggregation, options, _) {
	if (typeof options === "function") return this.obj.aggregate(aggregation, ~_);
	else return this.obj.aggregate(aggregation, options, ~_);
}
