...
asyncTest("index construction", 8, function (_) {
    ...
    try {
        ...
        var key1=fsp.join(__dirname, "resources",unitTest+"-en.json","key1") ;
        strictEqual(index[key1].text,inputJson["key1"] , "key1") ;
        var key2=fsp.join(__dirname, "resources",unitTest+"-en.json","key2") ;
        strictEqual(index[key2].text,inputJson["key2"] , "key2") ;
        var key3=fsp.join(__dirname, "resources",unitTest+"-en.json","key3") ;
...
//setTimeout(function(){
    ...
    try {
        ...
        var rec=db.fetchInstance(_,entity,{sdataWhere: "lanchp eq 10030 and lan eq 'ENG' and lannum eq "+idx[key1].id});
