...
test("UNIT TEST DISABLED - NEEDS WORK", 1, function() {
    ok(true, "dummy test");
});
return;
...
asyncTest("initialize syracuse test server", 1, function (_) {
    ...
    syracuse.syracuse.initializerStatus.on("initialized", _ << function(_) {
...
asyncTest("update of the message in syracuse", 25, testUpdtSyrFunc);
asyncTest("update of the message in X3", 11, testUpdtX3Func);
setTimeout(function(){asyncTest("clean up", 1, cleanup)} ,10);
setTimeout(function(){asyncTest("clean up testdir", 1, cleanupTestdir)} ,60);
