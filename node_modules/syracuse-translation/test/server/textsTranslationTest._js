...
asyncTest("update of the message in syracuse", 16, function (_) {
    try {
        ...
        //console.log("AFTER INJECT RESOURCES: " + JSON.stringify(res, null, 2));
...
*/
        //console.log("AFTER INJECT RESOURCES 2: " + JSON.stringify(res, null, 2));
