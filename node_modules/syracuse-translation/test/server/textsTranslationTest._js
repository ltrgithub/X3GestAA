...
function testUpdtSyrFunc(_) {
   // tracer = trace;
    ...
    inputJson["tropLong"] = "Un message beaucoup beaucoup beaucoup beaucoup beaucoup beaucoup beaucoup beaucoup beaucoup trop trop trop trop trop trop trop trop long";
    inputJson["key9"] = "ninth key";
    inputJson["tropLong2"] = "Un autre message beaucoup beaucoup beaucoup beaucoup beaucoup beaucoup beaucoup beaucoup beaucoup trop trop trop trop trop trop trop trop long";
    ...
    tracer && tracer ("index before 1st extraction: "+JSON.stringify(index,null,2));
   ...
   //tracer("ID=9: "+rec.LANMES(_)) ;
    ...
    //tracer && tracer("ID=10: "+rec10.LANMES(_)) ;
   ...
   // tracer&& tracer("ID=1: "+rec.LANMES(_)) ;
...
asyncTest("update of the message in syracuse", 20, testUpdtSyrFunc);
