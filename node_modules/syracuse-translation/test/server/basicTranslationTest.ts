...
var textTranslation = require('../../lib/translation');
var messageStore = require('../../lib/messageStore');
// var transHelper = require('../../lib/helper');
//
...
describe(module.id, () => {
	...
	/*it('Translation read', function(_) {
	...
	*/
	function disabled0() {}
	/*
	it('Translation update', function(_) {
	...
	*/
	// it('Translation delete', function(_) {
	// 	var id = uuid.generate();
	// 	var chp = cfg.updateChapter || 10046;
	// 	var ep = cfg.endPointRead || "SUPERV";
	...
	function disabled() {
		it('localizationKeys basic', function(_) {
			var json = {
					"$prototypes": {
						"localePreference": {
							"$key": "code"
	...
	// it('localizationKeys dashboard user', function(_) {
	...
	it('Traverse source resources', function(_) {
