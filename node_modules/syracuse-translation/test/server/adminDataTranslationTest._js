...
function testUpdtSyrFunc(_) {
    ...
    context.request.headers={
       ...
       var body = post(_, cookie, "translationTools/$template/$workingCopies?representation=translationTool.$edit",//
        ...
        var rec=db.fetchInstance(_,entity,{sdataWhere: "LANCHP eq "+adminChapter+" and LAN eq 'ENG' and LANNUM eq 1"});
        ...
        rec=db.fetchInstance(_,entity,{sdataWhere: "LANCHP eq "+adminChapter+" and LAN eq 'ENG' and LANNUM eq 1"});
        ok(rec!=null,"record created")
        var msg=rec.LANMES(_) ;
        ...
        var body = get(_, cookie, "APLSTDs?sdataWhere=(LANCHP eq "+adminChapter+" and LAN eq 'ENG' and LANNUM eq 2)");
...
function testUpdtX3Func(_) {
    ...
    cookie = getCookie(_);
        ...
        var db = dataModel.getOrm(_, _getModel(), endPoint.datasets.mongodb_admin_test);
        var entity=db.getEntity(_,"APLSTD") ;
        var rec=db.fetchInstance( _,entity, {sdataWhere: "LANCHP eq "+adminChapter+" and LAN eq 'ENG' and LANNUM eq 3"}) ;
