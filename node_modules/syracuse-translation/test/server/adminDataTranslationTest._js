...
asyncTest("index construction", 10, function (_) {
    var context={request: {}} ;
    cookie = getCookie(_);
    ...
    "$localization": {
       ...
       var appli = adminHelper.getCollaborationApplication(_);
        ...
        strictEqual(index["title_73df3cab-42b9-4dbf-b04b-00f177ceb1d2"].text,expected["title_73df3cab-42b9-4dbf-b04b-00f177ceb1d2"] , "menuItemA") ;
        strictEqual(index["title_3d4299f4-15a0-439e-b506-5e9ad7c143b7"].text,expected["title_3d4299f4-15a0-439e-b506-5e9ad7c143b7"] , "menuItemB") ;
        strictEqual(index["title_53a3cffa-33ab-4f57-86cd-bb576036c9fe"].text,expected["title_53a3cffa-33ab-4f57-86cd-bb576036c9fe"] , "menuItemC") ;
...
function testUpdtSyrFunc(_) {
    ...
    try {
        ...
        var rec=db.fetchInstance(_,entity,{sdataWhere: "lanchp eq 10032 and LAN eq 'ENG' and LANNUM eq 1"});
        if (!rec)
...
asyncTest("update of the admin resource on syracuse side", 11, testUpdtSyrFunc);
