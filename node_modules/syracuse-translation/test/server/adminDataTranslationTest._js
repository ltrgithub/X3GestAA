...
tracer && tracer("create a record in X3: APLSTD" );
...
function testUpdtSyrFunc(_) {
    ...
    try {
        ...
        strictEqual( diag[0].message, 'update conflict for title_3d4299f4-15a0-439e-b506-5e9ad7c143b7 : menuItemBD vs  menuItemBF',"warning message") ;
...
asyncTest("update of the admin resource on syracuse side", 8, testUpdtSyrFunc);
asyncTest("update of the message in X3", 10, testUpdtX3Func);
