...
//
var StubFiler = require("./stubFiler").StubFiler;
//
...
asyncTest("index construction", 9, function(_) {
	...
	//
	translation.extractAdminResources(_, null, opt, null);
	// en checks
	...
	strictEqual(index["stub_file"]["title_veryLongMessage"].text, "This is a message of more than 123 characters. In fact it makes precisely 128 characters. With this stub to fi", "long message truncation");
	//
