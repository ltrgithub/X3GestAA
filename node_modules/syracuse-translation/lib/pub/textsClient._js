...
// = ATEXTE functions
// =================================================================
exports.deleteText = function(_, product, num, lan) {
	// console.log("deleteText:"+ [product, num, lan].join(','));

	var resp = _del(_, _apiPath("ATEXTE", [product, num, lan]));
...
exports.createText = function(_, product, lan, text, comment, legacy) {
	// console.log("createText:"+ [product, lan, text, comment, legacy].join(','));
	var data = {
		"TEXTE": text,
		"COMMENT": comment,
		"LAN": lan,
...
exports.updateText = function(_, product, num, lan, text, comment) {
	// console.log("updateText:"+ [product, num, lan,  text, comment].join(','));

	var data = {
		"TEXTE": text,
		"COMMENT": comment
	};
	var resp = _put(_, _apiPath("ATEXTE", [product, num, lan]), data);
