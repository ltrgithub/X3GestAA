...
function _createEntry(_, endpoint, contractUrl, chapter, id, message, ut) {
    ...
    try {
        ...
        //console.log("diagnose after create: "+sys.inspect(diags)) ;


        //console.log("diagnose save : "+sys.inspect(diag)) ;
        msg.save(_);

        msg.getAllDiagnoses(_, diags);
        if (_hasErrors(_, msg)) {
            console.log("diagnose after save : " + sys.inspect(diags));
            return false;
        }
        return true;
