...
function _getLanguages(_,instance) {
   ...
   // var cookie = getCookie(_);
    ...
    var entity=dbX3.getEntity(_, 'TABLAN', "$query");
 ...
 where+=")";
    ...
    var langs = dbX3.fetchInstances(_, entity, {sdataWhere : where}) ; //' /*+sys.inspect(x3langs)*/});
    var x3langs={} ;
    langs.forEach_(_, function(_, e) {
        console.log(e.LAN(_)+'  : ' + e.LANISO(_)) ;
       // if (isoCodes[e.LANISO(_)]  ) 
