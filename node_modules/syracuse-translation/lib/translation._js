...
var itemTypesToKeep = ["landingPage", "menuCategory", "portlet", "notificationEvent", "notificationTheme", "msoWordTemplateDocument", "mobileGadget"];
...
function _filterLocalizations(json) {
	...
	items.forEach(function(item) {
		...
		if (itemTypesToKeep.indexOf(item.$type) !== -1) {
			...
			tracer && tracer("_filterLocalizations excluding type=" + item.$type + ", code=" + item.code);
		}
	});
