...
function _getLanguages(_,url) 
{ 
  console.log("_getLanguages") ;
  //console.log("*************TOTO: "+sys.inspect(ep)) ;
  
  //console.log("*************TOTO: "+sys.inspect(ep.$functions)) ;
  console.log("*************TOTO: "+sys.inspect(ep.getBaseUrl(_))) ;
...
console.log("contractUrl: "+url) ;
    ...
    console.log("PP: "+JSON.stringify(resp)) ;
    return resp;
