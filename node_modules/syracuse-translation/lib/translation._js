...
function _createEntry(_, endpoint, contractUrl,chapter, id, message,ut) {
        ...
        var diags=msg.$diagnoses;
        console.log("diagnose create: "+sys.inspect(diags)) ;
        var diag=[];
        msg.getAllDiagnoses(_,diag);
            ...
            function _checkEntry(_, key, message) {
                ...
                if (x3message) {
                   ...
                   // tracer && tracer("inject message " + dirkey + ":" + key);
                    ...
                    _createEntry(_, instance.endpoint(_), contractUrl,10031 ,index[dirkey][key].id, message,unitTestFlg);
                    } 
                    catch(ex){
