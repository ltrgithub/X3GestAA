...
var _filterImport = {
	pageLayout: function(data, proto) {
		return data.filter(function(item) {
			return item.$type === "pageLayout";
		});
	},
...
var _extractFilters = {
	"x3-erp-homepages.json": _filterExtract.pageLayout,
...
var _importfilters = {
	"x3-erp-homepages.json": _filterImport.pageLayout,
