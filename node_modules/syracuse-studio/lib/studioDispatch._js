...
var _datasetMap = {
	...
	operation: function(_, context) {
		...
		if (!ses || !ses.$uuid) {
			tracer && tracer("studio-operation failed: studioSession" + ses + ', $uuid=' + ses.$uuid);
			// return context.reply(_, 403, "Not registered");
...
exports.dispatcher = function(config) {
	return function(_, request, response) {
		var context = new Context(request, response, config),
			...
			studioSession = (context.httpSession || {}).studioSession;
