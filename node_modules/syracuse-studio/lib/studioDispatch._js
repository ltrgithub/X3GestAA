...
var etnaDebugger = require('@sage/etna/lib/engine/debugger/server');
var proxyManager = require('./dbgp/proxyManager');
var proxyClient = require('./dbgp/proxyClient');
var sdataLocalizedText = locale.format.bind(undefined, require.cache[require.resolve('@sage/syracuse-lib/src/sdata/sdataDispatch')]);
...
var tracer = require('@sage/syracuse-core').getTracer("studio.dispatch");
