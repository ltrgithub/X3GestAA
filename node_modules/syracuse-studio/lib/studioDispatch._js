...
var _proxyServiceOperationMap = {
	...
	state: {
		...
		get: function(_, context, id) {
			var dbgpClient = _getDbgpClient(context, "admin"),
				proxyState = null,
				headers = {
			...
			proxyState = dbgpClient.getState(_, {
				v: context.parameters.v || context.parameters.verbose
			});
			dbgpClient.close();
	...
	connect: {
		...
		post: function(_, context, id) {
			...
			var dbgpClient = _getDbgpClient(context, "session", sid),
