...
/// 
exports.createStudioSession = function(context, id) {
	var ses = studioSessions[id] || (studioSessions[id] = new StudioSession(id));
...
function precond(ses) {
	...
	var studioSession = exports.getStudioSession(context);
	if (!studioSession)
