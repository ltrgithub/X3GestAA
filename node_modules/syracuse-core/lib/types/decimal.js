...
exports.validate = function(value, constraints, errors){
	...
	if (!(value instanceof BigDecimal)) {
		errors.push("value must be a decimal");
		return;
	}
	if (constraints.$minimum != null) {
		if (constraints.$minimumCanEqual) {
			if (value.compare.compareTo(_make(constraints.$minimum))<0)
	...
	if (constraints.$maximum != null) {
		if (constraints.$maximumCanEqual) {
			if (value.compare.compareTo(_make(constraints.$maximum))>0)
...
exports.ZERO=function() {return _make(0);};
exports.ONE=function() {return _make(1);};
exports.TEN=function() {return _make(10);};
