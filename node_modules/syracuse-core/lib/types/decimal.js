...
exports.validate = function(value, constraints, errors) {
	...
	if (constraints.$minimum != null) {
		if (constraints.$minimumCanEqual) {
			if (value.compare.compareTo(_make(constraints.$minimum)) < 0) errors.push("value must be >= " + constraints.$minimum);
		} else {
			if (value.compare.compareTo(_make(constraints.$minimum)) <= 0) errors.push("value must be > " + constraints.$minimum);
		}
	}
	if (constraints.$maximum != null) {
		if (constraints.$maximumCanEqual) {
			if (value.compare.compareTo(_make(constraints.$maximum)) > 0) errors.push("value must be <= " + constraints.$maximum);
		} else {
			if (value.compare.compareTo(_make(constraints.$maximum)) >= 0) errors.push("value must be < " + constraints.$maximum);
		}
	}
