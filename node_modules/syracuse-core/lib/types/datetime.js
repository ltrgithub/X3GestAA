		...
		if (format == null) {
			...
			_walkFormat(format, {
				...
				S: function(repeat) {
					...
					else new Error("bad format directive S: " + repeat);
				}
			});
			return result;
		}
...
exports.parse = function(str, format) {
	if (str == null) throw new Error("datetime is null");
		...
		d: function(arg) {
			switch (arg) {
				...
				case 4:
					...
					break;
				default:
					throw new Error("bad day format: " + format.substring(j)); // replaced i with j
			}
		},
		M: function(arg) {
			switch (arg) {
		...
		y: function(arg) {
			switch (arg) {
				...
				case 4:
					...
					break;
				default:
					throw new Error("bad year format: " + format.substring(j)); // replaced i with j
			}
		},
		H: function(arg) {
			switch (arg) {
				...
				case 2:
					...
					break;
				default:
					throw new Error("bad hour format: " + format.substring(j));
			}
		},
		h: function(arg) {
			switch (arg) {
		...
		m: function(arg) {
			switch (arg) {
				case 2:
					...
					break;
				default:
					throw new Error("bad minute format: " + format.substring(j));
			}
		},
		s: function(arg) {
			switch (arg) {
				case 2:
					...
					break;
				default:
					throw new Error("bad second format: " + format.substring(j));
			}
		},
		t: function(arg) {
			switch (arg) {
				...
				case 2:
					...
					break;
				default:
					throw new Error("bad AM/PM marker format: " + format.substring(j));
			}
		}
	});
