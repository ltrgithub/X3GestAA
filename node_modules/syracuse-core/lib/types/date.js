...
exports.validate = function(value /*:any*/ , constraints /*:TypeConstraint*/ , errors /*:string[]*/ ) {
	if (value == null) {
		if (constraints.$isMandatory)
			return errors.push(locale.format(module, "valMan"));
		if (!constraints.$isNullable)
			return errors.push(locale.format(module, "valNull"));
		return;
	}
...
var DateObj = helpers.defineClass(function(value) {
	this._value = value;
...
function _walkFormat(format /*:string*/ , map /*:{[key:string] : (arg: any) => void }*/ ) {
	var i = 0,
		len = format.length;
