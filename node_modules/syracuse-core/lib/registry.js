...
exports.put = function(ns: string, key ? : string, atb ? : string, val ? : string): any {
...
exports.delete = function(ns: string, key ? : string, atb ? : string): void {
	var cat, entry;
...
exports.get = function(ns: string, key ? : string, atb ? : string): any {
	var cat, entry;
	cat = root[ns];
	if (arguments.length === 1) {
		return cat;
...
exports.scanExtensions = function(fn: (exts: string[], sub: string, pack: any) => void): void {
	var fs = require('fs');
