...
function getSiteStatus(_, request, response) {
	...
	console.log(sslPath)
	var url = options.baseUrl + "sites?representation=site.%24query&count=5&where=(site%20like%20'%25teambuilderuk%25')&startIndex=1";
	...
	var resp = httpClient(clientOptions).end().response(_);
