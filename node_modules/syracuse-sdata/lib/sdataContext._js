...
*/
	...
	sortInstancesArray: function(_, resources, parameters, defaultOrder) {
		...
		while (--i > 0) {
			...
			sortFunctions[i] = props[prop] && props[prop].$computeSortValue; // #8661  check if the properties are define dfor the current instance - not the case if rel is not defined
