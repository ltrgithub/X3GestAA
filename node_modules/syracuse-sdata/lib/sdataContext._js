...
exports.Context = helpers.defineClass(Context, HttpContext, {
	...
	writeLastResponse: function(_) {
		...
		this.reply(_, this.httpSession.lastResp.statusCode, this.httpSession.lastResp.body, this.httpSession.lastResp.headers);
...
*/
		...
		self.httpSession.lastResp.body = result;
	...
	replyProperty: function(_, instance, propertyName) {
		...
		if (prop.isExternalStorage()) {
			...
			if (agent && agent.indexOf(" Chrome/") >= 0) // Chrome bug: does not accept comma in filename SAM 105846
			{
