...
function getLinkedInProfile(_, email) {
	var map = {
		"a": "http://fr.linkedin.com/in/dbopp",
		"mathias.walz@sage.de": "http://de.linkedin.com/pub/mathias-walz/97/206/354",
		"b": "http://de.linkedin.com/pub/norbert-butzke/85/b87/138",
		"c": "http://fr.linkedin.com/in/sophierebeyrotte/de"
	};
	var url = map[email];
	if (!url) return null;
	...
	bpartnerHack: function(_, context) {
		...
		try {
			...
			if (linkedin.isAuthenticated()) {
				...
				return context.reply(_, 307, null, {
					"location": linkedin.getAuthUrl()
				});
			}
			context.reply(_, 200, x3Body, {
				"content-type": "application/json"
