...
function getPosition(_, linkedInPayload, x3Payload){
	...
	positions.forEach(function(pos) { 	
		...
		var x3 = {};
			...
			console.log("BILLY START " + cpy.name);
			console.log("BILLY " + JSON.stringify(x3,null,2));
...
function getGeneral(_, linkedInPayload, x3Payload){
	// console.log("BILLYa" + typeof linkedInPayload);
	// console.log(linkedInPayload);
	// console.log("BILLYb");
	
	

	//x3Payload.LNKIMG = {"$url" : "http://www.hdwallpapersimages.com/wp-content/uploads/2014/01/Winter-Tiger-Wild-Cat-Images.jpg"};
	...
	//x3Payload.LNKIMG = {"$url" : "https://media.licdn.com/mpr/mprx/0_T_Ic9YuCdCccVos1_XHk9jpSdb-MsoI1iC0e9pDY9C6e5mpPD5RRZyMKFdtbJDo088ddJU0J6W4y"};
...
var _x3Hacks = {
	...
	protoHack: function(_, context) {
		...
		try {
			...
			//console.log(sys.inspect(x3Body));
	...
	bpartnerHack: function(_, context) {
		...
		try {
			...
			// exract email from request.
			//if (linkedin.isAuthenticated() || true) {

			//var email = "mathias.walz@sage.de";
...
var _x3DatasetMap = {
	walk: function(_, context, name, id) {
		...
		//console.log(sys.inspect(context));
		...
		if (context.parameters.search) {
			...
			} else return x3pool.send(_, context); // TODO manage calendar
		}
	},
