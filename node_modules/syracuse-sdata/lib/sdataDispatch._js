...
var _syracuseDatasetMap = {
	...
	sentiment: function(_, context, id) {
		context.sentimentName = id;
		return _dispatch(_, context, _sentimentMap);
	},
...
// URL is http://host/sdata/syracuse/sentiment/dataset/$sentiment[('name')][?q='sentiment string']
// URL is http://localhost:8124/sdata/syracuse/sentiment/collaboration/$sentiment('name')
...
var _sentimentMap = {
	get: function(_, context) {
		return context.reply(_, 200, {
			...
			"text": context.sentimentName
		});

		// return sentiment.get(_, context);
	},
	put: function(_, context) {},
	"delete": function(_, context) {}
};
