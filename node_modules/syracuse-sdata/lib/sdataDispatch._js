...
var _sdataMap = {
	...
	fsearch: function(_, context, id) {
		return _dispatch(_, context, _fSearchMap);
	},
	xsearch: function(_, context, id) {
		return _dispatch(_, context, _xSearchMap);
	}
};
...
var _xSearchMap = {
	get: function(_, context) {
		return searchEngine.xsearch(_, context);
	},
	put: function(_, context) {
		return searchEngine.updateIndex(_, context);
	},
...
var _fSearchMap = {
	get: function(_, context) {
		return searchEngine.fsearch(_, context);
	},
	put: function(_, context) {
		return searchEngine.updateIndex(_, context);
	},
