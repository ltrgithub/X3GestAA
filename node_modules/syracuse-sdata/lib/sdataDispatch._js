...
uploadHelpers.registerRejector(function(_, contentType, detectedType, buf) {
	...
	// Reject all kind of MS Office, OpenOffice, LibreOffice, StarOffice documents
	var re = /(msword|ms-word|ms-excel|ms-powerpoint|openxmlformats-officedocument|oasis.opendocument|stardivision)/i;
	if (re.test(contentType) || re.test(detectedType)) {
