...
function postasync(_, cookie, url, data, statusCode) {
	var response = streams.httpRequest({
		method: "post",
		url: url.indexOf("http") == 0 ? url : baseUrl + "/sdata/qunit/sdataTest/test/" + url,
		headers: {
...
asyncTest("Sync protocol", 175, function(_) {
	...
	console.log("BLDD3xx " + sys.format(body));
...
asyncTest("prototypes test", 54, function(_) {
	...
	strictEqual(body.$properties.polyChild.$variants.tree.$type, "application/x-pointer", "Poly Child tree item ok");
	// poly list
	...
	strictEqual(body.$properties.selfLoopChild.$type, "application/x-pointer", "Self loop child prototype ok");
	strictEqual(body.$properties.selfLoopChild.$prototype, "#loopTest1", "Self loop child prototype url ok");
	strictEqual(body.$properties.selfLoopChildren.$item.$type, "application/x-pointer", "Self loop child prototype ok");
	strictEqual(body.$properties.selfLoopChildren.$item.$prototype, "#loopTest1", "Self loop child prototype url ok");
	strictEqual(body.$properties.loop2Child.$item.$properties.loop1Child.$type, "application/x-pointer", "Self loop child prototype ok");
	strictEqual(body.$properties.loop2Child.$item.$properties.loop1Child.$prototype, "#loopTest1", "Self loop child prototype url ok");
	strictEqual(body.$properties.loop2Child.$item.$properties.loop1Children.$item.$type, "application/x-pointer", "Self loop child prototype ok");
	strictEqual(body.$properties.loop2Child.$item.$properties.loop1Children.$item.$prototype, "#loopTest1", "Self loop child prototype url ok");
	strictEqual(body.$properties.loop2Children.$item.$properties.loop1Child.$type, "application/x-pointer", "Self loop child prototype ok");
	strictEqual(body.$properties.loop2Children.$item.$properties.loop1Child.$prototype, "#loopTest1", "Self loop child prototype url ok");
	strictEqual(body.$properties.loop2Children.$item.$properties.loop1Children.$item.$type, "application/x-pointer", "Self loop child prototype ok");
	strictEqual(body.$properties.loop2Children.$item.$properties.loop1Children.$item.$prototype, "#loopTest1", "Self loop child prototype url ok");
