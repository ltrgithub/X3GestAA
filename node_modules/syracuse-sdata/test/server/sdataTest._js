...
asyncTest("prototypes test", 25, function(_) {
	...
	strictEqual(body.$properties.children.$item.$type, "application/x-object", "Child $item type ok");
	ok(body.$properties.children.$item.$item.$properties.string != null, "Child has properties ok");
	// poly reference
