...
asyncTest('Default Style Sheet', 16, function(_) {
...
asyncTest('Extend Style', 7, function(_) {
	var sst = stylesheet.create(_, null);
	ok(sst != null, "Default style definition not null");
	var css = {
		// "default": {
	...
	console.log("pageTitleDef=" + sys.inspect(pageTitleDef, false, 10));
	console.log("pageTitle=" + sys.inspect(pageTitle, false, 10));
