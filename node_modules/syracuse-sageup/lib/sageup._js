...
exports.sendToEDI = function(_, options){
	try{
		if (options != null){
			...
			return cli.execHttpRequest(_, options.method, options.url, sdataXml);
...
function checkOptions(options){
	if (options.host == null)
		throw new Error("The server hostname or IP adress is required in 'options' parameter.");
	if (options.url == null)
...
// Make temp document in fs from sa
