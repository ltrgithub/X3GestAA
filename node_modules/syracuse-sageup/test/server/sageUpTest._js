...
<eInvoice xmlns="http://schemas.sage.com/edi/commercialsupplier">\
<application>\
<code>'+code+'</code>\
...
<binary>'+bufPdf.toString('base64')+'</binary>\
		...
		//Post invoice
		var resp = cli.post(_, "/sdata/edi/commercialsupplier/18195082/eInvoice", payloadInvoiceTest);
...
function getInvoiceById(_, id){
	var resp = cli.get(_, "/sdata/edi/commercialsupplier/18195082/eInvoice('"+id+"')");
...
function deleteInvoice(_, id){
	//Delete invoice
	cli.del(_, "/sdata/edi/commercialsupplier/18195082/eInvoice('"+id+"')");
}

//Get invoices
function listInvoices(_){
	cli.get(_, "/sdata/edi/commercialsupplier/18195082/eInvoices");

}

//Get companies
function getCompanies(_){
	cli.get(_, "/sdata/edi/commercialsupplier/18195082/eCompanies");
}

//Get company 78973447
function getCompany(_, id){
	cli.get(_, "/sdata/edi/commercialsupplier/18195082/eCompany('"+id+"')");
}

//Get schema
function getSchema(_){
	cli.get(_, "/sdata/edi/commercialsupplier/18195082/$schema");
}
...
var auth = sageup.getAuthenticationOld("141795","testsagex3user1@sage.com","SIRET","44403090200018","supplier");
var options = {
