...
$(function() {
	...
	that.pagebeforechange = function(e, data) {
			var step = _step;
			var $helpers = $.helpers;
			var $sdata = $.sdata;
		...
		that.pagehide = function(fromPage, data) {
		...
		that.pageshow = function(event, ui) {
			_log && _log(_step, "pageshow");
			var page = $(event.target);
			$.helpers.removeJqmClass(page);
			$.helpers.removeJqmClass($(document.body));
			page.show();
