...
describe("Welcome page customization", function() {
	...
	describe("Customization", function() {
		...
		it("Open panel", function() {
			this.timeout(2000);
			return UT.DOM.click(UT.SEL.$$Action("pageConfig"))
				.then(function() {
					// Wait for config mode to become active
					return UT.DOM.waitVisible(UT.SEL.$$Action("configTile"), 500);
				})
				.then(function() {
				...
				.then(function($tile) {
					return UT.DOM.click(UT.SEL.$$Action("configTile"), $tile);
				})
				.then(function() {
		...
		it("Customize color and title", function() {
			this.timeout(2000);
			return UT.DOM.click(UT.SEL.$$Action("clickColor", "orange"))
				.then(function() {
		...
		it("Close panel", function() {
			...
			return UT.DOM.click(UT.SEL.$$Action("$validate"))
				.then(function() {
					return UT.DOM.click(UT.SEL.$$Action("cancelPageConfig"));
				});
		});
