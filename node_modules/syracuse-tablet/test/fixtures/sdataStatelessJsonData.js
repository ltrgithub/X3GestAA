...
exports.testCases = [
	 ...
	 */
	{
		...
		"$exec": {
			"$url": "{$baseUrl}/$prototypes('AQTCRUD.$details')",
			"$method": "GET"
		},
		"$check": {
			"$code": 200,
	 ...
	 */
	{
		...
		"$exec": {
			"$url": "{$baseUrl}/$prototypes('AQTCRUD.$edit')",
			"$method": "GET"
		},
		"$check": {
			"$code": 200,
	 ...
	 */
	{
		...
		"$exec": {
			"$url": "{$baseUrl}/$prototypes('AQTCRUD.$create')",
			"$method": "GET"
		},
		"$check": {
			"$code": 200,
	...
	/*
	 * Execute GET on persistent class (edit facet)
	 */
	{
		"$title": "Test GET action $edit facet",
		"$exec": {
