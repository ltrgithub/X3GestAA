...
<script>
	...
	require
			...
			function loadMain(lang, rsrc){
				...
				require(["syracuse-tablet/test/js/main", "jquery", "hammer", "bootstrap", "handlebars" ], function(main) {
					main.main(lang, rsrc);
				});
			}
	...
	<header id="testsheader">
		<nav class="navbar navbar-inverse" role="navigation">
			<div class="container-fluid">
				...
				<li>
					<button type="button" id="testsrun" class="btn btn-default navbar-btn dropdown-toggle" data-toggle="dropdown"> RUN <span class="caret"></span></button>
