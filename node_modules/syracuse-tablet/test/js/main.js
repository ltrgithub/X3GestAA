...
var modalTest = require('syracuse-tablet/test/js/modalTest');
...
var _doSettings = function() {
	...
	modalTest.settings(ctx, function(act, md, params) {
		var pref = "login-";
		var login = _globalCtx.getLogin();
		var user = md.find("#" + pref + "user"),
			pwd = md.find("#" + pref + "password"),
			dvlp = md.find("#" + pref + "endpoint-dvlp");
...
var _initModules = function() {
	...
	return initLocale.init()
		...
		.then(function() {
			return globals.init(true, st, cache, utils);
		})
		.then(function() {
		...
		_initModules()
			.then(function() {
				...
				_runModules = [
					...
					require('syracuse-tablet/test/js/testFormatApi'),
					require('syracuse-tablet/test/js/testDeferred'),
					require('syracuse-tablet/test/js/testDeferredFdb'),
					require('syracuse-tablet/test/js/testAuthoring')
				];
