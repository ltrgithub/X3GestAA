...
var sdataUtil = require('syracuse-tablet/html/js/sdata/sdatawhere/whereUtils');
	...
	"children": [{
		"children": [{
			"children": [{
				...
				"children": null,
				"type": "literal",
				"value": "2014-06-16T00:00:00.000Z"
			}],
			"type": "operator",
			"value": {
				"code": ">=",
...
// parser.parse('((VLYDAT ge @2014-06-16@) or (VLYDAT eq @@))');
var utilArg1 = {
	"children": [{
		"children": [{
			"children": null,
