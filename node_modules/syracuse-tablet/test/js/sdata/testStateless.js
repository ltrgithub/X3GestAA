...
var tests = require('syracuse-tablet/test/fixtures/sdataStatelessJsonData');

var hostUrl = window.location.protocol + "//" + window.location.host;
var baseUrl = hostUrl + "/mobile1/x3/erp/SUPERV";
var testcase;
...
exports.test = function() {
	...
	try {
		...
		var testRequests = tests.testCases.map(function(a) {
			return a;
		});
