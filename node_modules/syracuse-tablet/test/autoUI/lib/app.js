...
exports.ensureLogin = function() {
	return UT.App.waitPage("login")
		...
		.then(function(matchedPage) {
			return UT.SEL.isModal(matchedPage, "select-context");
		})
...
exports.openDesignPage = function() {
	var $$$designPage = UT.SEL.$$Action("linkClicked", "designPage");
...
exports.closeDesignPage = function() {
	...
	return UT.DOM.click($$$closeDesignPage, null, UT.App.waitModal$("confirm"))
		.then(function() {
			return UT.DOM.click(UT.SEL.$$Action("yes"));
		});
};
 ...
 */
exports.navToTestPage = function(page) {
	return UT.DOM.click(
