...
exports.authArrayDispaly = function(option) {
	//------------- Display link click --------------------------------------------------------
	return UT.Dom.click(UT.Sel.Xpath("//a[@aria-controls='collapse_auth_prop_arrayDisplay']"))
		.then(function() {
			//--- Card/table/carousel link click -----------------------------------------------------------------
			return UT.Dom.waitLocated(UT.Sel.Id("auth_opt_arrayDisplay_" + option), 1000)
				.then(function() {
					return UT.Dom.click(UT.Sel.Id("auth_opt_arrayDisplay_" + option))
						.then(function() {
