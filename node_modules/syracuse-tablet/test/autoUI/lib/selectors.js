...
exports.Page = function(pageName) {
	return {
		css: '[data-s-ut-page-is-current="' + pageName + '"]'
			//css: '[data-page-name="' + pageName + '"]'
	};
};
 ...
 */
exports.X3Link = function(linkName) {
	var link = '[data-sdata-link-name="' + linkName + '"]';
	return {
		css: link
	};
};
...
/**
 * Select action defined by name in $actions of X3 prototype, e.g. $save
 */
exports.X3Action = function(actionName) {
	var action = '[data-sdata-action-name="' + actionName + '"]';
	return {
		css: action
	};
};