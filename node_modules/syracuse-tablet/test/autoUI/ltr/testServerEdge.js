...
browser.sleep(4000);
//-------------------- level select -----------------------------------------------------------------------
//(browser.wait(until.elementLocated(By.xpath('//tr[@data-s-ut-row-idx="1"][@data-action="rowSelect"]/td[2]/div[@data-s-ut-field-x3name="CODE"]')), 30000)).click();
(browser.wait(until.elementLocated(By.xpath('//div[@data-s-ut-field-x3name="CODE"]')), 30000)).click();
...
browser.sleep(1500);
//----- Chart -------------------------------
(browser.wait(until.elementLocated(By.xpath('//div[@id="auth_opt_arrayDisplay_chart"]/label[@id="auth_opt_arrayDisplay_chart_lab"]')), 10000)).click();
browser.sleep(1500);
//----- Options ------------------------------
...
browser.getTitle().then(function(title) {
	if (expectedTitle === title) {
		console.log("Edge - Verification Successful - The correct title is displayed on the Edge page.=" + title);
	} else {
