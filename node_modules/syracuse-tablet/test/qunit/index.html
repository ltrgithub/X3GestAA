...
<script src="../../html/deps/requirejs/require.js"></script>

<link rel="stylesheet" href="deps/qunit-1.23.1/qunit.css">
...
<script>
	require.config({
		...
		'paths' : {
			...
			'main': 'syracuse-tablet/html/js/wc/main',
			
			'QUnit': 'syracuse-tablet/test/qunit/deps/qunit-1.23.1/qunit',
			'tests': 'syracuse-tablet/test/qunit/tests/_all',
		},
		'shim' : {
			'jquery-waiting': {
				'deps' : [ 'jquery' ]
