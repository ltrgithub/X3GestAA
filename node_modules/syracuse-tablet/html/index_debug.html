...
<script>
	...
	requirejs.onError = function(err) {
		window.logIos && window.logIos("ERROR REQUIRE")
		window.logIos && window.logIos(JSON.stringify(err, null, 2));
		throw err;
	};
	...
	require([ 'mobile-detect' ], function(md) {
		window.logIos && window.logIos("MOBILE DETECT LOADED")
		window.MobileDetect = md;
	});

	require([ "main" ], function() {
		window.logIos && window.logIos("MAIN LOADED")
...
<body>
<!-- 
<div style="height:300px;width:100%;overflow-y:auto;color:red;z-index:2000000;left:0;position:absolute;background-color:black;" id="logios"></div>
 -->
	<div id="s-m-site-all">
