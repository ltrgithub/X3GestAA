...
<script id="IOSWRAPPER">
	...
	var _IOSNativeInterface = function(){
		...
		*/
		this.callMethod = function(domain, method, param){
			...
			webkit.messageHandlers.callMethod.postMessage(this._serializeToIOSDictionnary(["domain", "method", "params"], args));
			return promise;
		}
		/*
		...
		*/
		this.prosessException = function(promiseID, serializedError){
			try{
				...
				window.smNativeLogger.logError("Native call iosServiceException", e)
			}
		}
		/*
	...
	*/
	function iosServiceException (promiseID, serializedError){
		if (!window.smNativeInterface) return;
		window.smNativeInterface.prosessResponse(promiseID, serializedError);
	};
	/*
