...
<script src="js/helpers/native/nativeIOSInterface.js" id="IOSWRAPPER"></script>
				...
				'shim' : {
					...
					'main' : {
						'deps' : [ "jquery", "bootstrap", "bootstrap-select",
								"bootstrap-switch", "jquery-minicolors",
								"bootstrap-slider", "jquery-waiting",
								"jquery-ui", "nativePrototypes",
								"jqueryPlugins", "highcharts",
								"highcharts-more", "highcharts-exporting",
								"mobile-detect" ]
					}
				}
			});
