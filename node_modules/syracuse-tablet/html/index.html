...
<link rel="stylesheet" href="./deps/bootstrap-select/select.min.css" />
...
<script>
	...
	require.config({
		...
		'paths' : {
			...
			"bootstrap-select" : "/syracuse-tablet/html/deps/bootstrap-select/select.min",
	...
	function loadMain(lang, rsrc){
		...
		require(["syracuse-tablet/html/js/main", "jquery", "hammer", "bootstrap", "handlebars", "bootstrap-select", "jquery-waiting"  ], function(main) {
			main.main(lang, rsrc);
		});
	}
...
<script id="vignetteTmpl" type="text/x-handlebars-template">
		<section id="{{uuid}}" class="s-m-content-vignette">
				<div class="alert alert-warning" role="alert">Page type[{{type}}] name[{{name}}] under construction</div>
		</section>
</script>
<!-- FOR DEVELOPMENT PHASE -->
<script id="contructionVignetteContentTmpl" type="text/x-handlebars-template">
<div class="alert alert-warning" role="alert">VIGNETTE type[{{type}}] name[{{name}}] under construction</div>
</script>
<script id="contructionContentTmpl" type="text/x-handlebars-template">
<div class="container  s-m-app-bkg home">
	<div class="container">
		<div class="row">
