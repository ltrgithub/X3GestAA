...
<script>
	...
	require.config({
		...
		'paths' : {
			...
			'jqm-custom-min' : '/syracuse-tablet/html/deps/jquery-mobile-1.4.3/jquery.mobile.custom.min',
			'jqm-custom' : '/syracuse-tablet/html/deps/jquery-mobile-1.4.3/jquery.mobile.custom',
