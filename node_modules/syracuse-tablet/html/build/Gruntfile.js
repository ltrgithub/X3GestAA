	...
	grunt.initConfig({
		...
		copy: {
			...
			dist_deps: {
				 ...
				 * nativeIOSInterface.js must be loaded in HTML page
				 */
				src: ['deps/**/*.*', 'js/startup.js', 'js/helpers/native/nativeIOSInterface.js', 'js/helpers/nativePrototypes.js', 'js/helpers/jqueryPlugins.js', 'js/helpers/jsutils.js', 'js/resources/**/*.*'],
				dest: '../../dist',
		...
		requirejs: {
			compile_min_debug: {
				options: {
					...
					baseUrl: '../../../',
					name: 'syracuse-tablet/html/js/wc/main',
