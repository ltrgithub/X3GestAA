...
.s-m-bg-magenta.s-m-auth {
	background-color: fade(@color-magenta, @auth-fade-color-amount);
	color: @color-white;
}
.s-m-bg-pink.s-m-auth {
	background-color: fade(@color-pink, @auth-fade-color-amount);
	color: @color-white;
}
.s-m-bg-teal.s-m-auth {
	background-color: fade(@color-teal, @auth-fade-color-amount); 
	color: @color-white;
}
.s-m-bg-lime.s-m-auth {
	background-color: fade(@color-lime, @auth-fade-color-amount);
	color: @color-white;
}
.s-m-bg-brown.s-m-auth {
	background-color: fade(@color-brown, @auth-fade-color-amount);
	color: @color-white;
}
...
.s-m-bg-red.s-m-auth {
	background-color: fade(@color-red, @auth-fade-color-amount);
	color: @color-white;
}
