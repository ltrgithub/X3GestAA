...
.s-m-page.s-m-full.smartphone > section.s-m-main-content {
  ...
  /* Default font size for smartphone*/
  font-size: 12px;
}
/* Full page title */
...
.s-m-stack:not(.s-m-theme-advanced) > header > btn.collapsed:before {
  content: "\f077";
}
.s-m-stack:not(.s-m-theme-advanced) > header > btn.expanded:before {
  content: "\f078";
}
.s-m-stack.s-m-theme-advanced > header > btn.collapsed:after {
  content: "\f141";
}
.s-m-stack.s-m-theme-advanced > header > btn.expanded:after {
  content: "\f00d";
...
.s-m-stack > content > .s-m-row > .s-m-cell {
  padding-left: 0px;
}
...
/** FDB fields in blocks **/
.s-m-layout.s-m-cell > .cell > .s-m-control:not(.s-m-chart) {
  padding: 0.5em;
}
/* no padding-top for first control - We can have both with/without wrapper - TODO optimize*/
/*
.s-m-page > .s-m-layout > .s-m-control:first-child, .s-m-page > .s-m-main-content > .s-m-layout > .s-m-control:first-child, .s-m-page > .s-m-main-content > .s-m-scroll-wrapper > .s-m-layout > .s-m-control:first-child {
	padding-top: 0;
}
*/
.s-m-control.header,
...
/*  Detail - File content - not empty*/
.s-m-control.s-m-field.s-m-binary > .s-m-value > a > span {
  font-size: 5em;
}
/*  Detail - Empty image/file content */
.s-m-control.s-m-field.s-m-empty > .s-m-value {
  font-size: 15em;
}
.s-m-control.s-m-field.s-m-binary > .s-m-value.s-m-empty {
  color: #dddddd;
}
/* VIGNETTES */
...
a.s-m-link-page:hover,
a.s-m-link-page:focus {
  color: inherit;
  background-color: inherit;
}
...
.s-m-page.s-m-full.chartdetail .s-m-control {
  padding: 0px;
}
.s-m-page.s-m-full.chartdetail .s-m-layout.s-m-cell > .cell > .s-m-control:not(.s-m-chart) {
  padding: 0px;
}
...
/* 
	Could be used to fade colors of tiles during authoring a bit to enhance readability
	
@auth-fade-color-amount: 50%;

.s-m-bg-transparent.s-m-auth {
}
.s-m-bg-mediumpurple.s-m-auth {
	background-color: fade(@color-medium-purple, @auth-fade-color-amount);
	color: @color-white;
}
.s-m-bg-purple.s-m-auth {
	background-color: fade(@color-purple, @auth-fade-color-amount);
	color: @color-white;
}
.s-m-bg-skyblue.s-m-auth {
	background-color: fade(@color-skyblue, @auth-fade-color-amount);
	color: @color-white;
}
.s-m-bg-sagegreen.s-m-auth {
	background-color: fade(@color-sagegreen, @auth-fade-color-amount); 
	color: @color-white;
}
.s-m-bg-darkgrey.s-m-auth {
	background-color: fade(@color-darkgrey, @auth-fade-color-amount);
	color: @color-white;
}
.s-m-bg-lightgreen.s-m-auth {
	background-color: fade(@color-lightgreen, @auth-fade-color-amount);
	color: @color-white;
}
.s-m-bg-orange.s-m-auth {
	background-color: fade(@color-orange, @auth-fade-color-amount);
	color: @color-white;
}
.s-m-bg-blue.s-m-auth {
	background-color: fade(@color-blue, @auth-fade-color-amount);
	color: @color-white;
}
.s-m-bg-mediumgrey.s-m-auth {
	background-color: fade(@color-medium-grey, @auth-fade-color-amount);
	color: @color-white;
}
.s-m-bg-green.s-m-auth {
	background-color: fade(@color-green, @auth-fade-color-amount);
	color: @color-white;
}
*/
.navbar-fixed-top,
