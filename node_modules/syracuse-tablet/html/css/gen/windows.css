...
/* TEMPLATES PANEL */
.s-m-control.edittemplates > article > section.panel.create {
  margin-bottom: -1px;
}
.s-m-page.smartphone.portrait .s-m-control.edittemplates > article > section.panel.avail > div > ul > li {
  padding: 10px 5px;
}
.s-m-control.edittemplates > article span.btn > span {
  font-size: 0.9em;
}
