...
/* Font size icon in header/footer is 1.8em */
.s-m-page.s-m-full > header .navbar-nav > li > a .fa,
.s-m-page.s-m-full > footer .navbar-nav > li > a .fa {
  font-size: 1.8em;
}
/* Font size icon in header/footer is 1.8em - We reduce the padding to have 50Px height for header */
.s-m-page.s-m-full > header .navbar-nav > li > a,
.s-m-page.s-m-full > footer .navbar-nav > li > a {
  padding-top: 12px;
  padding-bottom: 12px;
}
...
.container-fluid.s-m-header.tablet {
  padding-right: 0px;
}
.s-m-header.tablet .dropdown {
  padding-right: 15px;
}
.s-m-header.tablet .s-m-header-nav {
  float: left;
  font-size: 2.3em;
  padding-right: 13px;
}
...
.smartphone .s-m-freshness {
  top: 38px;
}
.tablet .s-m-freshness {
  top: 50px;
}
.s-m-fresh {
  color: #41a940;
...
.s-m-header-links > .dropdown a {
  z-index: 1000;
}
.s-m-header-links > .dropdown a.list-group-item.disabled {
  color: inherit;
  background-color: inherit;
  opacity: 0.7;
}
.s-m-header-links > a > i {
  display: block;
}
.s-m-header-links > a > span {
  font-size: 0.6em;
  position: relative;
  top: -5px;
  display: block;
...
.s-m-header.smartphone .s-m-header-brand {
  font-size: 1.5em;
}
.smartphone .s-m-header-labels .s-m-header-label {
  display: inline-block;
  white-space: nowrap;
  overflow: inherit;
  text-overflow: ellipsis;
}
.tablet .s-m-header-labels .s-m-header-label {
  color: #41a940;
  float: left;
  font-size: 24px;
...
.s-m-header-links > div > a > span {
  color: #4d4f53;
}
.s-m-header-links > div > a > div {
  display: inline-block;
  padding-right: 0.5em;
  text-align: right;
  top: -5px;
...
.s-m-header-links > div > a > div > span {
  display: block;
}
.s-m-header-links > div > a > div > span.username {
  color: #333333;
  font-size: 16px;
}
.s-m-nav-text.userrole {
  color: #333333;
  font-size: 11px;
}
.s-m-header-links > div > a > img,
.s-m-header-links > div > img {
  /*width: 3.4em;*/
  display: inline-block;
  /*float:right;*/
  padding-top: 0.3em;
...
.s-m-header-links > div > ul {
  right: 0;
  left: inherit;
}
.s-m-header-links > div > ul > li > a {
  border: 0px;
}
.s-m-header.smartphone > div > a {
  padding: 0 0.3em 0 0.3em;
  float: right;
}
.smartphone > .s-m-header-labels {
  line-height: 43px;
  color: #41a940;
  text-overflow: ellipsis;
  overflow: hidden;
...
.btn-group.s-m-ismultisel > div > button.btn > span {
  margin-left: 10px;
  font-family: monospace;
}
