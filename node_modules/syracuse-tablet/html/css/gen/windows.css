...
.s-m-page.s-m-nested .s-m-control.s-m-array.s-m-card.s-m-std {
  display: table;
  table-layout: fixed;
  width: 100%;
}
.s-m-page.s-m-nested .s-m-control.s-m-array.s-m-card.s-m-std > .s-m-title {
  display: table-row;
}
.s-m-page.s-m-nested .s-m-control.s-m-array.s-m-card.s-m-std > header {
  display: table-row;
}
.s-m-page.s-m-nested .s-m-control.s-m-array.s-m-card.s-m-std > .s-m-value {
  display: table-row;
  height: 100%;
}
td.s-m-record > section.s-m-card.s-m-std {
  padding: 5px;
  position: relative;
  background-color: rgba(250, 250, 250, 0.1);
  color: #ffffff;
}
td.s-m-record.s-m-last-selected > section.s-m-card.s-m-std {
  background-color: #9a9b9c;
  color: #ffffff;
}
td > section.s-m-card.s-m-std > .s-m-layout {
  overflow: hidden;
}
...
td > section.s-m-card.s-m-std span.badge.index {
  background-color: #41a940;
...
td > section.s-m-card.s-m-std > div.s-m-status {
  top: 0;
  right: 0;
  font-size: 1.3em;
  position: absolute;
}
td > section.s-m-card.s-m-std > div.s-m-status > div.s-m-status-icon {
  padding: 2px 2px 2px 2px;
  float: right;
  display: inline-block;
}
td > section.s-m-card.s-m-std > div.s-m-status-color {
  padding: 5px;
}
