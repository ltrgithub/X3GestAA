...
.pagesettings > .header > .modal-title {
  margin-top: 0;
  padding-top: 0.25em;
}
.pagesettings > nav.navbar {
  background-color: transparent;
  padding-right: 8px;
  padding-left: 8px;
  width: 400px;
...
.s-m-schedulemsg input[readonly] {
  background-color: transparent;
}
.pagesettings .s-m-schedulemsg td {
  padding-top: 4px;
}
.pagesettings td {
  padding-right: 4px;
...
.s-m-pinandlivetile td {
  padding-bottom: 8px;
}
.modal-dialog table.s-m-pinandlivetile td {
  padding-right: 10px;
}
