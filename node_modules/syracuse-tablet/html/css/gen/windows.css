...
.s-m-header > .s-m-header-links > #multiSelMenuActions > div > .btn > .badge {
  border-radius: 30px;
  font-family: arial;
  font-size: 1em;
  font-weight: bold;
...
.btn-group.s-m-ismultisel > div > button.btn > span.caret,
.btn-group.s-m-ismultisel > div > button.btn > span.badge {
  margin-left: 10px;
