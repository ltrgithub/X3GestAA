...
/*
	Classes to set background color attribute with predefined color set
*/
.s-m-bg-mediumpurple {
  background-color: #b29cdb;
  color: #ffffff;
...
.s-m-bg-mediumpurple a:hover,
.s-m-bg-purple a:hover,
.s-m-bg-skyblue a:hover,
.s-m-bg-sagegreen a:hover,
.s-m-bg-darkgrey a:hover,
.s-m-bg-lightgreen a:hover,
.s-m-bg-orange a:hover,
.s-m-bg-blue a:hover,
.s-m-bg-mediumgrey a:hover,
.s-m-bg-green a:hover {
  color: #ffffff;
}
a:active,
a:visited,
...
.s-m-control.s-m-field.s-m-qty > .s-m-value {
  float: left;
}
