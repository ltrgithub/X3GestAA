...
.s-m-stack > content > .s-m-layout.s-m-row {
  margin-left: 0px;
}
...
/* Default cell color */
.s-m-cell > .cell.s-m-bg.s-m-default {
  background-color: #4d4f53;
  color: #ffffff;
}
/* No background for cell that hosts a chart */
.s-m-cell.s-m-chart > .cell.s-m-bg.s-m-default {
  color: inherit;
  background-color: inherit;
}
/*
...
/* default tile color */
.s-m-tile.s-m-bg.s-m-default {
  background-color: #4d4f53;
  color: white;
}
.s-m-tile.s-m-chart.s-m-bg.s-m-default {
  color: inherit;
  background-color: inherit;
}
...
.s-m-tile.s-m-enabled > header,
.s-m-tile.s-m-bg.s-m-default.s-m-enabled > header,
.s-m-cell.s-m-enabled > .cell > header {
  background-color: #41a940;
}
...
.s-m-array.s-m-card > .s-m-value.s-m-bg.s-m-default {
  background-color: #4d4f53;
  color: #ffffff;
}
.s-m-array.s-m-table > .s-m-value.s-m-bg.s-m-default {
  background-color: inherit;
  color: inherit;
}
...
.s-m-page.s-m-nested .s-m-control.s-m-array.s-m-card > .s-m-title {
  display: table-row;
}
.s-m-page.s-m-nested .s-m-control.s-m-array.s-m-card > header {
  display: table-row;
}
.s-m-page.s-m-nested .s-m-control.s-m-array.s-m-card > .s-m-value {
  display: table-row;
  height: 100%;
}
...
section.s-m-card.s-m-bg.s-m-default {
  background-color: rgba(250, 250, 250, 0.1);
  color: #ffffff;
}
...
.s-m-control.s-m-field.s-m-qty > .s-m-value.edit {
  width: 70%;
}
...
.s-m-control.s-m-field:not(.s-m-top) > span.s-m-error {
  left: 30%;
  width: 70%;
  top: 3em;
}
...
.s-m-layout.s-m-cell > .cell > .s-m-control:not(.s-m-chart) > span.s-m-error {
  width: 100%;
}
...
.s-m-control.s-m-auth.s-m-auth-selected {
  background: url("../../img/auth/s-field-selected.png") repeat scroll center center transparent;
