...
.modal.diagnoses.tablet .modal-title.error {
  color: #cb3500;
}
.modal.diagnoses.tablet .modal-title.warning {
  color: #ff8240;
}
.modal.diagnoses.tablet .modal-title.info {
  color: #009fda;
}
...
.modal.diagnoses.mobile .modal-title.error {
  color: #9e3039;
}
.modal.diagnoses.mobile .modal-title.info {
  color: #009fda;
}
