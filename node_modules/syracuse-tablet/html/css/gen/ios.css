 ...
 */
aside.s-m-free .s-m-panel.breadcrumbs {
  box-shadow: 0 5px 15px rgba(0, 0, 0, 0.5);
  left: 20px;
  background-color: #ffffff;
}
...
aside.s-m-panel.s-m-left > .s-m-panel {
  box-shadow: 0 5px 15px rgba(0, 0, 0, 0.5);
}
...
.s-m-page.s-m-full.smartphone.portrait > aside.s-m-panel.s-m-free {
  width: auto;
}
.s-m-page.s-m-full.smartphone.landscape > aside.s-m-panel.s-m-free {
  width: auto;
}
.s-m-page.s-m-full.smartphone.portrait > aside.s-m-panel {
  width: 80%;
}
.s-m-page.s-m-full.smartphone.portrait > aside.s-m-panel.s-m-two-columns {
  width: 95%;
}
.s-m-page.s-m-full.smartphone.landscape > aside.s-m-panel {
  width: 50%;
}
...
.s-m-page.s-m-full.tablet > aside.s-m-panel:not(.dialogpanel) > .s-m-panel.s-m-control.s-m-ctrl:not(.breadcrumbs) {
  width: 300px;
}
...
aside.s-m-panel:not(.s-m-free) > .s-m-control {
  padding-top: 0em;
  padding-bottom: 0em;
  height: 100%;
  width: 100%;
...
.s-m-header > .s-m-header-links > a > i {
  display: block;
}
...
/** MULTI BUTTONS **/
.modal.multibuttons .modal-footer .btn.btn-default {
...
.modal.diagnoses .modal-footer .btn.btn-default {
  background-color: transparent !important;
  border-color: transparent !important;
  color: black;
}
...
.modal.confirm .modal-footer .btn.btn-default {
  background-color: transparent !important;
  border-color: transparent !important;
  color: black;
}
