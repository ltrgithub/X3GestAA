...
.s-m-breadcrumbs .s-m-item a {
  border: 1px solid blue;
}
.s-m-breadcrumbs .s-m-text {
  display: inline-block;
  padding-left: 5px;
  padding-right: 5px;
}
.s-m-breadcrumbs .s-m-sep {
...
.breadcrumbs .s-m-breadcrumbs-text {
  vertical-align: inherit;
  padding: 0 10px 0 10px;
}
.s-m-breadcrumbs-item > .fa {
  vertical-align: middle;
}
/*
...
.s-m-page.s-m-full.tablet > aside.s-m-panel:not(.dialogpanel) > .s-m-panel.s-m-control.s-m-ctrl {
  width: 300px;
}
