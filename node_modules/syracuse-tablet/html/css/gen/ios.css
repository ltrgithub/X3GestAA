...
/* TEMPLATES PANEL */
.edittemplates > article > section.panel.create {
  margin-bottom: -1px;
}
.edittemplates > article > section.panel.create .input-group {
  padding-left: 10px;
  padding-right: 10px;
}
...
/* smartphone portrait */
.s-m-page.smartphone.portrait .edittemplates > article > section.panel.avail > div > ul > li {
  padding: 10px 7px;
}
.s-m-page.smartphone.portrait .edittemplates > article > section.panel > .panel-heading {
  padding-left: 7px;
  padding-right: 7px;
}
.s-m-page.smartphone.portrait .edittemplates > article > section.panel.create > .panel-body {
  padding-left: 7px;
  padding-right: 7px;
}
/* All tables */
...
.edittemplates #tmpl-panel-filter {
  float: right;
  max-width: 40%;
}
