...
.waiting-blocks-play-0 {
  background-color: #b0c5ee;
}
.waiting-blocks-play-1 {
  background-color: #caddfb;
}
.modal-body {
  overflow-y: auto;
...
/*
 * Customize bootstrap column class boundaries
 * ===========================================
 * NOTE: IF you change the pixel sizese here, you also have to check the s-m-auth-col-simulate* classes assigned to a device 
 * class in siteLayout.js
 * 
 */
/*
 * Matches
 * iPhone 4, 5 landscape and portrait
 * Nexus 5 portrait
 * iPhone 6 portrait
 ...
 * Nexus 5 landscape (640)
 * Nexus 7 portrait (600)
 * iPad Mini portrait (768)
 * iPad portrait (768)
 * Nexus 10 portrait (800)
 */
/*
 * Matches:
 * iPhone 6 Plus landscape (960)
 * Nexus 7 landscape (960)
 */
/*
 * Matches: 
 * iPad Mini landscape (1024)
 * iPad landscape (1024)
 * Nexus 10 Landscape (1080)
 */
aside.s-m-freeleft .s-m-panel.breadcrumbs {
  left: 20px;
}
.breadcrumbs .s-m-items a.home {
...
.breadcrumbs .home .s-m-text {
  color: #c8006e;
}
/*
	Colors used for both, layout tile and layout cell colors
*/
/*See $imgHeight authoring property*/
/* Greater than @z-index-catchevt otherwise the click doesn't work if there's a chart behind*/
/* Left/Right panel Controls - fixed and full height -> bottom:0*/
.s-m-page.s-m-full > aside.s-m-panel {
  position: absolute;
  top: 0px;
  bottom: 0px;
  /* Z-index > the one ofheader and footer - use LESS variable*/
  z-index: 10001;
  display: none;
}
aside.s-m-panel > .s-m-panel {
  box-shadow: 0 5px 15px rgba(0, 0, 0, 0.5);
}
aside.s-m-panel.s-m-freeleft .s-m-panel,
aside.s-m-panel.s-m-freeright .s-m-panel {
  background-color: #ffffff;
}
.s-m-page.s-m-full.smartphone.portrait > aside.s-m-panel.s-m-right.dialogpanel,
.s-m-page.s-m-full.smartphone.portrait > aside.s-m-panel.s-m-right.sortfilter {
  width: 100%;
}
.s-m-page.s-m-full.smartphone.landscape > aside.s-m-panel.s-m-right.dialogpanel,
.s-m-page.s-m-full.smartphone.landscape > aside.s-m-panel.s-m-right.sortfilter {
  width: 100%;
}
.s-m-page.s-m-full.tablet > aside.s-m-panel.dialogpanel,
.s-m-page.s-m-full.tablet > aside.s-m-panel.sortfilter {
  width: 50%;
}
.s-m-page.s-m-full.smartphone.portrait > aside.s-m-panel.s-m-freeleft,
.s-m-page.s-m-full.smartphone.portrait > aside.s-m-panel.s-m-freeright {
  width: auto;
  min-width: 150px;
}
.s-m-page.s-m-full.smartphone.landscape > aside.s-m-panel.s-m-freeleft,
.s-m-page.s-m-full.smartphone.landscape > aside.s-m-panel.s-m-freeright {
  width: auto;
  min-width: 150px;
}
.s-m-page.s-m-full.smartphone.portrait > aside.s-m-panel.s-m-right,
.s-m-page.s-m-full.smartphone.portrait > aside.s-m-panel.s-m-left {
  width: 100%;
}
.s-m-page.s-m-full.smartphone.portrait > aside.s-m-panel.s-m-two-columns {
  width: 95%;
}
.s-m-page.s-m-full.smartphone.landscape > aside.s-m-panel.s-m-right,
.s-m-page.s-m-full.smartphone.landscape > aside.s-m-panel.s-m-left {
  width: 50%;
}
.s-m-page.s-m-full.smartphone.landscape > aside.s-m-panel.s-m-two-columns {
  width: 80%;
}
.s-m-page.s-m-full.tablet > aside.s-m-panel.s-m-right.dialogpanel,
.s-m-page.s-m-full.tablet > aside.s-m-panel.s-m-left.dialogpanel {
  width: 50%;
}
.s-m-page.s-m-full.tablet > aside.s-m-panel .s-m-panel.s-m-ctrl.global {
  width: 300px;
}
.s-m-page.s-m-full.tablet > aside.s-m-panel.s-m-freeright > .s-m-panel,
.s-m-page.s-m-full.smartphone.landscape > aside.s-m-panel.s-m-freeright > .s-m-panel,
.s-m-page.s-m-full.smartphone.portrait > aside.s-m-panel.s-m-freeright > .s-m-panel {
  width: auto;
  height: auto;
  max-height: 95%;
  min-width: 150px;
...
.s-m-page > aside.s-m-panel.s-m-freeright > .s-m-panel .navbar-nav > li > a > span {
  padding-left: 4px;
  padding-right: 12px;
}
.s-m-page.s-m-full.tablet > aside.s-m-panel > .s-m-panel.s-m-control.s-m-ctrl.share {
  color: #ffffff;
}
.s-m-page.s-m-full.tablet > aside.s-m-panel > .s-m-panel.s-m-control.s-m-ctrl.share td {
  padding-right: 4px;
  padding-top: 4px;
}
.s-m-page.s-m-full.tablet > aside.s-m-panel > .s-m-panel.s-m-control.s-m-ctrl.share > .s-m-side-panel {
  padding: 0px 10px 0px 10px;
}
.s-m-page.s-m-full.smartphone > aside.s-m-panel > .s-m-panel.s-m-control.s-m-ctrl.share > .s-m-side-panel {
  padding-left: 5px;
  padding-right: 5px;
}
.s-m-page.s-m-full.smartphone > aside.s-m-panel > .s-m-panel.s-m-control.s-m-ctrl.share > .s-m-side-panel {
...
.s-m-page.s-m-full.smartphone > aside.s-m-panel > .s-m-panel.s-m-control.s-m-ctrl.share > .s-m-side-panel .form-group > table {
  table-layout: fixed;
  width: 100%;
  border-spacing: 5px;
  border-collapse: separate;
...
.s-m-page.s-m-full.smartphone > aside.s-m-panel > .s-m-panel.s-m-control.s-m-ctrl.share > .s-m-side-panel .form-group > table td > .input-group {
  border-spacing: 0px;
}
/* 50%/70% on tablet for dialog panel with the close box */
.s-m-page.s-m-full.tablet.landscape > aside.s-m-panel.dialogpanel,
.s-m-page.s-m-full.tablet.landscape > aside.s-m-panel.sortfilter {
  width: 50%;
}
.s-m-page.s-m-full.tablet.portrait > aside.s-m-panel.dialogpanel,
.s-m-page.s-m-full.tablet.portrait > aside.s-m-panel.sortfilter {
  width: 70%;
}
/* Left panel - Left positioned*/
aside.s-m-panel.s-m-left {
  left: 0px;
}
/* Right panel - Right positioned*/
aside.s-m-panel.s-m-right {
  right: 0px;
}
aside.s-m-freeleft {
  left: 20px;
...
/* Panel control H/W is given by parent */
aside.s-m-panel.s-m-left > .s-m-control,
aside.s-m-panel.s-m-right > .s-m-control {
  padding-top: 0em;
  padding-bottom: 0em;
  height: 100%;
  width: 100%;
}
aside.s-m-panel > .s-m-control > .s-m-side-panel {
  overflow: hidden;
}
/*Common free left/ free right*/
.s-m-freeleft .s-m-control,
.s-m-freeright .s-m-control {
  padding: 0;
  margin: 0;
}
.s-m-freeleft .s-m-items,
.s-m-freeright .s-m-items {
  padding: 0;
  margin: 0;
  white-space: nowrap;
  overflow: visible;
...
.s-m-freeleft .s-m-item,
.s-m-freeright .s-m-item {
  display: inline-block;
...
.s-m-freeleft .s-m-items a,
.s-m-freeright .s-m-items a {
  display: block;
  padding-top: 8px;
  padding-bottom: 8px;
}
.s-m-freeleft .s-m-text,
.s-m-freeright .s-m-text {
  display: inline-block;
  vertical-align: bottom;
...
/* Panel */
.s-m-panel .navbar-brand {
  padding: 15px 8px;
}
.s-m-panel .navbar-brand > div {
  padding-top: 4px;
  padding-bottom: 4px;
}
.s-m-panel .navbar-nav {
  margin: 0;
}
.s-m-page > aside.s-m-panel .navbar-brand {
  color: #41a940;
  font-size: 24px;
  font-weight: normal;
  padding: 0;
}
.s-m-page > aside.s-m-panel.s-m-left .navbar-brand {
  color: #ffffff;
  font-size: inherit;
  font-weight: normal;
  padding: 0;
...
.s-m-page > aside.s-m-panel .navbar-nav > li > a {
  padding: 10px 5 10px 5px;
  text-align: left;
  white-space: nowrap;
}
.s-m-page > aside.s-m-panel .navbar-nav > li > a.disabled {
  cursor: not-allowed;
  opacity: 0.7;
}
.s-m-side-panel .navbar-nav > li.s-m-separator {
  border-bottom: 1px solid;
  margin-bottom: 1.1em;
}
/* 25px to display icon left */
.s-m-page > aside.s-m-panel .navbar-nav > li > a > span {
  padding-left: 25px;
}
.s-m-page > aside.s-m-panel .navbar-nav.header > li > a > span {
  padding-left: 0px;
  color: #ffffff;
}
.s-m-page > aside.s-m-panel .navbar-nav.header > li > a {
  padding: 0px;
}
/* absolute to display icon left */
.s-m-page > aside.s-m-panel .navbar-nav > li > a > i {
  position: absolute;
}
.s-m-page > aside.s-m-panel .navbar-nav.header > li > a > i {
  right: 0px;
}
/* LEFT/RIGHT PANEL - BASED on Metro-Bootstrap navbar-side*/
.s-m-side-panel {
  position: relative;
  height: 100%;
  z-index: 1000;
...
.s-m-side-panel .navbar-header {
  float: none;
  padding-top: 0px;
  overflow: hidden;
  white-space: nowrap;
}
.s-m-side-panel.left .navbar-header {
  padding-top: 8px;
  padding-bottom: 12px;
}
.s-m-side-panel.left .container-fluid {
  background: linear-gradient(135.24deg, #430446 0%, #074288 100%);
}
.s-m-profile-photo {
...
.s-m-side-panel .navbar-nav {
  float: none;
}
.s-m-side-panel .navbar-nav.s-m-panel-slot:not(:last-child) {
  border-bottom: 1px solid #979797;
}
.s-m-side-panel .navbar-nav.s-m-panel-slot {
  padding-top: 8px;
  padding-bottom: 8px;
}
.s-m-side-panel .navbar-collapse {
  padding-right: 0;
  padding-left: 0;
  padding-top: 30px;
  margin-bottom: 50px;
}
.s-m-side-panel .navbar-nav > li {
  float: none;
}
.s-m-side-panel .navbar-nav > li > a {
  display: inline-block;
  width: 100%;
  padding-left: 15px;
}
.s-m-side-panel .navbar-nav > li > a:hover {
  background: rgba(85, 85, 85, 0.5);
}
.s-m-side-panel .navbar-nav.s-m-panel-slot .fa {
  color: #757575;
  padding-top: 3px;
}
.s-m-side-panel .navbar-nav.s-m-panel-slot.header .fa {
  color: #ffffff;
}
.s-m-side-panel.closed {
  width: 85px;
}
.s-m-side-panel.closed .navbar-nav .fa {
  font-size: 2em;
}
.s-m-side-panel.closed .navbar-nav span {
  font-size: 12px;
}
.s-m-side-panel.closed .navbar-nav > li > a {
  padding-left: 0px;
  padding-right: 0px;
  text-align: center;
}
.s-m-side-panel.closed .navbar-nav > li > a > span {
  display: none;
}
.s-m-side-panel.closed .navbar-brand > span {
  display: none;
}
/* Resize panel icon position*/
.s-m-side-panel-options {
  padding-left: 0px;
  padding-right: 0px;
  padding-top: 40px;
  width: 100%;
...
/* Div that catchs click to close panel*/
.s-m-side-panel-dismiss {
  display: none;
  height: 100%;
  /* set also width to screen left for right panel*/
  left: 0;
  position: absolute;
  top: 0;
  /* MAX z-index - less variable*/
  z-index: 10000;
  /* background-color: red;
	    opacity: 0.4;*/
  /* set also width to screen right for left panel*/
  right: 0px;
  opacity: .3;
  background-color: #ffffff;
}
.s-m-side-panel-dismiss.right,
.s-m-side-panel-dismiss.left,
.s-m-side-panel-dismiss.freeleft,
.s-m-side-panel-dismiss.freeright {
  display: block;
}
/*Dialog panel*/
.s-m-dialogPanel,
.s-m-panel .filtersort {
  background-color: #ffffff;
  border: 1px solid rgba(0, 0, 0, 0.2);
}
.s-m-dialogPanel > .header {
  /*like .modal-header*/
  padding-left: 8px;
  height: 50px;
  background-color: transparent;
...
.s-m-dialogPanel > .header > .modal-title {
  margin-top: 0;
  padding-top: 10px;
}
.s-m-dialogPanel .list-group-item {
  border: 0px;
  /*like .modal-header*/
  padding-left: 8px;
  height: 50px;
...
.s-m-dialogPanel .list-group-item:not(:first-child) {
  border-top: 1px solid #dddddd;
}
.s-m-dialogPanel > nav.navbar,
.filtersort > nav.navbar {
  background-color: transparent;
  padding-right: 8px;
  padding-left: 8px;
  padding-top: 8px;
...
.s-m-dialogPanel > .header button,
.s-m-dialogPanel > .header button:hover,
.filtersort .header button,
.filtersort .header button:hover,
.filtersort .header button:focus {
  font-size: 1.5em;
  padding: 0px;
  border: 0;
  width: 50px;
...
/*Pageshare*/
.s-m-dialogPanel.pageshare input[readonly] {
  background-color: transparent;
}
.s-m-dialogPanel.pageshare td {
  padding-right: 4px;
  padding-top: 4px;
}
/* TWO COLUMNS */
aside.s-m-panel.s-m-two-columns {
  width: 100%;
}
aside.s-m-panel.s-m-two-columns .s-m-panel-content {
  height: 100%;
...
aside.s-m-panel.s-m-two-columns .s-m-side-panel {
  width: 100%;
}
/* TEMPLATES PANEL */
.edittemplates > article > section.s-m-memo.create {
  margin-bottom: -1px;
}
.edittemplates > article > section.s-m-memo.create .input-group {
  padding-left: 10px;
  padding-right: 10px;
}
.edittemplates > article span.btn {
  font-size: 1em;
}
.edittemplates > article span.btn > i {
  font-size: 14px;
}
.s-m-page.smartphone .edittemplates > article span.btn {
  font-size: 0.9em;
}
.edittemplates .s-m-list-wrapper {
  overflow: hidden;
}
.edittemplates ul.s-m-scroll-elmt {
  margin: -1px;
}
/* smartphone portrait */
.s-m-page.smartphone.portrait .edittemplates > article > section.s-m-memo.create.avail > div > ul > li {
  padding: 10px 7px;
}
.s-m-page.smartphone.portrait .edittemplates > article > section.s-m-memo.create > .panel-heading {
  padding-left: 7px;
  padding-right: 7px;
}
.s-m-page.smartphone.portrait .edittemplates > article > section.s-m-memo.create.create > .panel-body {
  padding-left: 7px;
  padding-right: 7px;
}
/* All tables */
.edittemplates .list-group-item table {
  width: 100%;
}
.smartphone .edittemplates td.s-m-input-label {
  width: 25%;
}
.tablet .edittemplates td.s-m-input-label {
  width: 15%;
}
.edittemplates section > header {
  padding: 16px 0px 0px 0px;
  font-size: 1.5em;
}
/* Main tables */
.edittemplates table.s-m-tmpl-itm > tbody > tr > td:first-child {
  width: 100%;
  padding-right: 5px;
}
.edittemplates table.s-m-tmpl-itm > tbody > tr > td:last-child {
  float: right;
}
.s-m-page.smartphone .edittemplates table.s-m-tmpl-itm > tbody > tr > td:first-child {
  font-size: 12px;
}
.edittemplates table.s-m-tmpl-itm-act td {
  padding: 1px;
}
.edittemplates table.s-m-tmpl-itm-act td > span {
  /* for apply btn - 1px white on the right */
  width: 100%;
}
.edittemplates .s-m-tmpl-itm-ttl {
  padding: 1px;
  font-weight: bold;
}
.edittemplates .s-m-tmpl-itm-info {
  font-size: 11px;
}
.edittemplates .s-m-tmpl-itm-info > span:last-child {
  float: right;
  max-width: 50%;
}
.edittemplates div[data-action="create"] {
  float: right;
}
.edittemplates #tmpl-panel-create-btn {
  font-weight: bold;
  width: 100%;
}
.edittemplates #tmpl-panel-create-btn-clear-addon {
  background-color: inherit;
}
.edittemplates .s-m-filter select {
  padding: 6px 6px 6px 6px;
}
.s-m-page.smartphone .edittemplates #tmpl-panel-filter {
  font-size: 12px;
}
.edittemplates span[data-action="saveItemTitle"] > i {
  font-size: 14px;
}
.edittemplates .s-m-noitem {
  padding: 40px 15px 40px 15px;
  text-align: center;
}
/*=================== Panel filter Sort ===========================*/
.s-m-control.filtersort > .s-m-side-panel ul.nav-pills {
  display: table;
  width: 100%;
}
.s-m-control.filtersort > .s-m-side-panel .nav.nav-pills a,
.s-m-control.filtersort > .s-m-side-panel .nav.nav-pills a:hover {
  background-color: transparent;
  color: #990069;
}
.s-m-control.filtersort > .s-m-side-panel .tab-content a:hover {
  background-color: transparent;
}
.s-m-control.filtersort > .s-m-side-panel ul.nav-pills > li {
  display: table-cell;
  float: none;
}
.s-m-control.filtersort > .s-m-side-panel ul.nav-pills > li.active {
  text-decoration: underline;
}
.s-m-control.filtersort > .s-m-side-panel .tab-content {
  padding: 5px;
}
.s-m-control.filtersort > .s-m-side-panel .tab-content > .btn-group {
  margin-bottom: 5px;
}
/****************************************************************************/
/* 							SORT/filter/memo								*/
/****************************************************************************/
.filtersort .list-group-item {
  position: relative;
  display: block;
  padding: 10px 15px;
  margin-bottom: -1px;
...
.filtersort .list-group-item:last-child {
  border-bottom: 1px solid #dddddd;
}
#sorttabroot > ul > li,
#filterlist > ul > li,
...
#sorttabroot > ul > li > span,
#filterlist > ul > li > span,
#memotabroot ul > li > span {
  display: table-cell;
  padding-top: 10px;
  padding-bottom: 10px;
  overflow: hidden;
...
#filterlist > ul > li > .s-m-filter,
#sorttabroot > ul > li > .s-m-order,
#memotabroot ul > li > .s-m-memo {
  display: table-cell;
  font-size: 1.5em;
  width: 30px;
  text-align: center;
...
/* FILTER SORT PANEL*/
/* Separator in filter list */
.s-m-filter-separator {
  display: block;
  text-align: center;
  margin-top: 8px;
  margin-bottom: 8px;
...
#filterlist > .btn-group {
  width: 100%;
  text-align: center;
}
#filterlist > .btn-group > a {
  float: none;
  border-radius: 100px;
}
.s-m-control.filtersort > .s-m-side-panel ul.nav-pills {
...
/****************************************************************************/
.s-m-order.enabled {
  background-color: rgba(0, 50, 97, 0.87);
  color: white;
}
/* Table - sorted array header */
th.s-m-sorted > div {
  display: table;
  width: 100%;
  table-layout: fixed;
}
th.s-m-sorted > div > span {
  text-overflow: ellipsis;
  overflow: hidden;
  display: table-cell;
}
...
#filteredit div .s-m-control.s-m-field .s-m-title {
  color: #fff;
}
#filteredit div .btn-group.btn-group-justified {
  padding-top: 1em;
}
#filteredit div div div.s-m-value.edit input.error {
  border: 2px solid red;
}
#filteredit div div div.s-m-value.edit select.error {
  border: 2px solid red;
}
#formtabform div .s-m-control.s-m-field .s-m-title {
  color: #333333;
}
/****************************************************************************/
/* 							Memo											*/
...
#memotabroot .list-group-item.selected {
  background-color: #004089;
}
#memotabroot .list-group-item.selected a,
#memotabroot .list-group-item.selected span {
  color: white;
}
.s-m-control.s-m-array.s-m-chart .s-m-no-data-title,
.s-m-control.s-m-array .s-m-no-data-title {
  font-family: "Lucida Grande", "Lucida Sans Unicode", Verdana, Arial, Helvetica, sans-serif;
  font: bold 16px "Trebuchet MS", Verdana, sans-serif;
  text-align: center;
}
.s-m-control.s-m-array:not(.s-m-chart-array) .s-m-no-data-title {
  padding-top: 10px;
}
.s-m-control.s-m-array.s-m-chart .s-m-no-data-title {
  color: #4d4f53;
...
.s-m-control.s-m-array.s-m-chart .s-m-no-data-label,
.s-m-control.s-m-array .s-m-no-data-label {
  font-size: 1.3em;
  text-align: center;
  padding: 20px;
}
/* APPLICATION HEADER CSS - FK*/
/* Full page header*/
.s-m-page.s-m-full > header {
  box-sizing: border-box;
  position: absolute;
  width: 100%;
  z-index: 1000;
  /* Padding top/bottom to have a space between main content and header*/
  margin-bottom: 5px;
  /** no overflow hidden due to dropdownlist in header**/
  ...
  border-bottom: 0px;
  z-index: 1;
  /*to display bottom shadow in all case*/
}
.s-m-page.s-m-full .s-m-control.header > .s-m-header > div.s-m-header-labels,
.s-m-page.s-m-full .s-m-control.header > .s-m-header > div.s-m-header-nav {
  width: 1%;
}
.s-m-page.s-m-full .s-m-control.header > .s-m-header > div.s-m-header-links {
  width: 100%;
}
.s-m-page.s-m-full.smartphone > header {
  padding: 0px;
}
/******************************
* HEADER TABLET AND SMARTPHONE
*******************************/
.s-m-control.header {
  display: table;
  /* auto to allow multiple actions on the right part (authoring actions)*/
  table-layout: auto;
  width: 100%;
  padding-top: 0;
  padding-bottom: 0;
  /* visible To allow dropdown list in header and footer*/
  overflow: visible;
}
.s-m-control.header > .s-m-header {
  display: table-row;
  width: 100%;
}
.offline .s-m-control.header > .s-m-header {
  box-shadow: 0px 4px 0px #ff5800 inset;
}
.s-m-control.header > .s-m-header > div {
  display: table-cell;
  vertical-align: top;
  white-space: nowrap;
}
.s-m-control.header > .s-m-header.s-m-dasboard-config > .s-m-header-links.dashboard-header-switch {
  font-size: 1.5em;
  min-width: 50%;
  text-align: center;
}
.s-m-control.header > .s-m-header.s-m-dasboard-config > .dashboard-header-btn > button {
  font-size: 1.5em;
  padding: 5px;
  border: 0;
  width: 50px;
...
.s-m-dasboard-config > .s-m-header-labels {
  font-size: 1.7em;
}
.s-m-dasboard-config > .s-m-header-labels > .s-m-header-label {
  font-size: 1em;
}
.s-m-dasboard-config > .dashboard-header-btn > ul > li > a {
  border: 0px;
}
.s-m-header.smartphone {
  padding-right: 0px;
  padding-left: 0px;
}
.s-m-header > .s-m-header-nav,
.s-m-header > .s-m-header-links {
  font-size: 1.5em;
  color: #ffffff;
}
.s-m-header > .s-m-header-nav,
.s-m-header > .s-m-header-links > .s-m-header-slot {
  display: inline-block;
}
.s-m-header > .s-m-header-links > .s-m-header-slot.left {
  float: left;
}
.s-m-header > .s-m-header-links > .s-m-header-slot {
  float: right;
...
.s-m-header > .s-m-header-nav,
.s-m-header > .s-m-header-links > .s-m-header-slot:not(:first-child) {
  padding-left: 0px;
}
.s-m-header > .s-m-header-links > .s-m-header-slot > #multiSelMenuActions {
  padding-top: 8px;
}
.s-m-header > .s-m-header-links > .s-m-header-slot.left > a {
  padding-left: 0px;
}
s-m-header-slot .s-m-header.smartphone > .s-m-header-nav {
  padding-left: 0.3em;
}
.s-m-header > .s-m-header-nav > a,
.s-m-header > .s-m-header-nav > .s-m-test-wrapper {
  text-align: center;
  float: left;
  padding: 10px 0.3em 0 0;
  min-width: 35px;
  color: #ffffff;
}
.s-m-header > .s-m-header-nav > .s-m-test-wrapper {
...
/* link added to test the native wrapper */
.s-m-header > .s-m-header-nav > .s-m-test-wrapper {
  font-size: 0.7em;
  top: 8px;
  position: relative;
}
/* like there's a min-width we have to centner the icon (backDom)*/
.s-m-header > .s-m-header-links a {
  text-align: center;
  float: right;
...
.s-m-header > .s-m-header-links a > span {
  font-size: 0.6em;
  position: relative;
  top: -5px;
  display: block;
}
.s-m-header.smartphone > .s-m-header-links {
  padding-top: 0;
}
.s-m-header.smartphone > .s-m-header-links a > i {
  line-height: 40px;
}
.s-m-header > .s-m-header-labels {
  color: #ffffff;
  overflow: hidden;
  white-space: nowrap;
  line-height: 50px;
...
.s-m-header.smartphone > .s-m-header-labels {
  line-height: 43px;
  padding: 3px 0px 0px 5px;
}
.s-m-header > .s-m-header-labels > .s-m-header-label {
  font-size: 1.5em;
...
.s-m-header.smartphone > .s-m-header-labels > .s-m-header-label {
  letter-spacing: normal;
}
.s-m-header > .s-m-header-labels > .s-m-header-brand {
  display: inline-block;
...
.s-m-header.smartphone > .s-m-header-labels > .s-m-header-brand {
  font-size: 1.5em;
}
/* USER INFO */
.s-m-header > .s-m-header-links > .s-m-header-user-info {
  padding-right: 15px;
  z-index: 1000;
  float: right;
}
.s-m-header > .s-m-header-links > .s-m-header-user-info a.list-group-item.disabled {
  color: inherit;
  background-color: inherit;
  opacity: 0.7;
}
.s-m-header > .s-m-header-links > .s-m-header-user-info > a > div {
  display: inline-block;
  text-align: right;
  top: -6px;
  position: relative;
...
.s-m-header > .s-m-header-links > .s-m-header-user-info > a > div > span {
  display: block;
}
.s-m-header > .s-m-header-links > .s-m-header-user-info > a > div > span.s-m-nav-text {
  font-size: 16px;
}
.s-m-header > .s-m-header-links > .s-m-header-user-info > a > div > span.s-m-nav-text.userrole {
  font-size: 11px;
}
.s-m-header > .s-m-header-links > .s-m-header-user-info > a > span.usericon {
  font-size: 32px;
  top: -8px;
  position: relative;
  color: #4d4f53;
}
.s-m-header > .s-m-header-links > .s-m-header-user-info > ul > li > a {
  border: 0px;
}
/* MULTISELECTION SMARTPHONE ONLY */
/*s-m-ismultisel - tune displays of icon and text below in header */
.s-m-header > .s-m-header-links > .s-m-link.s-m-ismultisel {
  position: relative;
  padding-right: 0px;
  padding-left: 10px;
  top: -7px;
}
.s-m-header > .s-m-header-links > a.s-m-link.s-m-ismultisel[data-action="multiSelection"] {
  padding-right: 5px;
}
.s-m-header > .s-m-header-links > .s-m-link.s-m-ismultisel > span {
  top: -8px;
  font-size: 12px;
  position: relative;
  text-align: center;
...
.s-m-header > .s-m-header-links > .btn-group.s-m-ismultisel {
  float: left;
}
.s-m-header > .s-m-header-links > .btn-group.s-m-ismultisel > .dropdown > .btn {
  padding: 3px 3px;
  position: relative;
  font-size: 12px;
}
.s-m-page.smartphone.portrait > header #multiSelMenuActions {
  max-width: 140px;
}
/******************************
* FRESHNESS
*******************************/
.s-m-control.header > .s-m-freshness {
...
.s-m-page.smartphone > header > .s-m-control.header > .s-m-freshness {
  top: 50px;
  z-index: 1;
}
.s-m-page.tablet > header > .s-m-control.header > .s-m-freshness {
  top: 50px;
}
.s-m-freshness.s-m-fresh {
  color: #41a940;
}
.s-m-freshness.s-m-tainted {
  color: #ff5800;
}
.s-m-freshness.s-m-verytainted {
  color: #cb3500;
}
.s-m-act-msg.fresh {
...
.s-m-act-msg.verytainted {
  background-color: #cb3500;
}
/******************************
* DASHBOARD CONFIG
*******************************/
.s-m-control.header > .s-m-header.s-m-dasboard-config > .s-m-header-links {
  padding-top: .3em;
}
.s-m-control.header > .s-m-header.s-m-dasboard-config > .s-m-header-links.dashboard-header-switch {
  font-size: 1.5em;
...
.s-m-control.header > .s-m-header.s-m-dasboard-config > .dashboard-header-btn {
  min-width: 0%;
  /* to clean after build release */
}
.s-m-dasboard-config > .dashboard-header-btn > ul > li > a {
  border: 0px;
}
/******************************
* SEARCH INPUT only for ARRAY
*******************************/
nav.s-m-search {
  display: inline-block;
  float: right;
...
.smartphone.landscape nav.s-m-search {
  width: 35%;
  padding-top: 8px;
}
.smartphone.portrait nav.s-m-search {
  width: 50%;
  padding-top: 8px;
}
.tablet.landscape nav.s-m-search {
  width: 40%;
  padding-top: 6px;
}
.tablet.portrait nav.s-m-search {
  width: 40%;
  padding-top: 6px;
}
.s-m-search > .input-group > .input-group-addon > .glyphicon {
  padding-left: 5px;
  padding-right: 5px;
}
.s-m-search > .input-group > .input-group-addon {
  padding: 0 0 0 0;
}
/*********************************************
*  Navigation stack bar
**********************************************/
header nav.s-m-navigation-stackbar {
  margin-top: 2px;
  position: relative;
}
.smartphone header nav.s-m-navigation-stackbar {
  margin-top: 5px;
  margin-left: 10px;
}
header nav.s-m-navigation-stackbar .btn-group {
  width: 20px;
  color: white;
  position: absolute;
  top: 5px;
...
header nav.s-m-navigation-stackbar .btn-group button,
header nav.s-m-navigation-stackbar .btn-group .open button.btn.btn-primary {
  background-color: transparent;
  border: none;
}
header nav.s-m-navigation-stackbar.dropdown-menu > .active > a,
header nav.s-m-navigation-stackbar.dropdown-menu > .active > a:hover,
header nav.s-m-navigation-stackbar.dropdown-menu > .active > a:focus {
  color: black;
  background-color: inherit;
}
header nav.s-m-navigation-stackbar .btn-group button a {
  color: inherit;
}
.s-m-navigation-stackbar > .nav.nav-pills {
  background-color: transparent;
  height: 100%;
}
.s-m-navigation-stackbar > .nav-justified > li {
  display: inline-block;
  width: auto;
}
header nav.s-m-navigation-stackbar > .nav.nav-pills.nav-justified > li,
header nav.s-m-navigation-stackbar > .nav.nav-pills.nav-justified > li.active {
  background-color: transparent;
  padding-top: 5px;
  border: none;
}
header nav.s-m-navigation-stackbar > .nav.nav-pills.nav-justified > li.active a {
  border-bottom: 2px solid rgba(255, 255, 255, 0.8);
}
header nav.s-m-navigation-stackbar > .nav.nav-pills.nav-justified a,
header nav.s-m-navigation-stackbar > .nav.nav-pills.nav-justified a:focus {
  color: #ffffff;
  white-space: nowrap;
  margin-right: 24px;
  vertical-align: bottom;
}
/* Draft list menu item*/
.s-m-page > aside.s-m-panel .navbar-nav > li > a[data-naction="draftsList"] > span.badge {
  float: right;
  /* to override the text is larger than width */
  position: absolute;
  right: 5px;
  padding-left: 5px;
}
...
.s-m-draft-item > div > div {
  display: table-row;
  width: 100%;
  line-height: 1.8em;
}
.s-m-draft-item > div > div > div {
  display: table-cell;
  overflow: hidden;
  white-space: nowrap;
  text-overflow: ellipsis;
...
.s-m-draft-item.error {
  box-shadow: -5px 0px 0 #cb3500 inset;
}
.s-m-draft-item.selected.error {
  box-shadow: 2px 2px 0 #009fda inset, 0px -2px 0 #009fda inset, -5px 0px 0 #cb3500 inset;
}
.s-m-draft-item.unsavedchanges {
  box-shadow: -5px 0px 0 #41a940 inset;
}
.s-m-draft-item.offline {
  box-shadow: -5px 0px 0 #ff5800 inset;
}
.s-m-draft-item:not(.selected) > span.badge.checked {
  display: none;
}
.s-m-draft-item.selected > span.badge.checked {
  width: 15px;
  height: 15px;
  color: white;
...
.s-m-draft-item > span.badge.index {
  background-color: #41a940;
...
.s-m-draft-item.selected > span.badge.index {
  margin-right: 0px;
}
.s-m-draft-item.selected {
  box-shadow: 2px 2px 0 #009fda inset, -2px -2px 0 #009fda inset;
}
.s-m-draft-item.selected.synchronized {
  box-shadow: 2px 2px 0 #eeb8a6 inset, -2px -2px 0 #eeb8a6 inset;
  opacity: 0.5;
}
.s-m-draft-item.selected.synchronized > span.badge.checked {
  background-color: #eeb8a6;
}
.s-m-draft-item.selected [data-params="edit"] {
  display: none;
}
.s-m-draft-header {
  display: table;
...
#draftSelectMenuId > div > .btn > .badge {
  border-radius: 30px;
  font-family: arial;
  font-size: 1em;
  font-weight: bold;
...
#draftSelectMenuId.btn-group > div > button.btn > span.badge {
  font-family: monospace;
  margin-left: 0px;
}
#draftSelectMenuId.btn-group > div > button.btn > span:not(.badge) {
  margin-left: 10px;
}
#draftFiltersMenu {
  float: right;
...
.smartphone .s-m-dashboard-header-btn-role {
  right: 56px;
}
.smartphone .s-m-dashboard-header-role-number {
  right: 43px;
}
.s-m-dashboard-header-btn-role {
  font-size: 18px;
  position: absolute;
  top: 16px;
  right: 124px;
...
.s-m-dashboard-header-role-number {
  font-size: 10px;
  position: absolute;
  top: 24px;
  right: 111px;
...
dashboard-header-btn .btn-danger:hover {
  background-color: transparent !important;
  color: #ffffff;
}
.dashboard.welcome > header {
...
.s-m-hub-group > header > btn {
  width: 30px;
  text-align: center;
}
.s-m-hub-group > header > span.title[contentEditable="true"] {
  background-color: white;
  display: inline-block;
}
.s-m-hub-group > header > input.title {
  font-size: 16px;
  height: 28px;
}
.s-m-hub-group > header > input.title[readonly] {
  border: 0px;
  font-size: 20px;
  background-color: transparent;
}
/***************************************
 	Drag and drop dashboard elements
 ****************************************/
.s-m-ui-drop {
  visibility: visible;
  z-index: 2000;
...
.s-m-header.s-m-dasboard-config > div.s-m-header-title {
  width: 100%;
  padding-right: 150px;
  padding-left: 20px;
  text-align: center;
...
.s-m-dasboard-config > .s-m-header-title > input {
  font-size: 1em;
  width: 100%;
  padding-right: 30px;
}
...
div.insert btn {
  margin-left: -18px;
  /*btn width div by 2 to center it*/
}
...
.s-m-tile div.insert.left > btn {
  top: 50%;
  margin-top: -18px;
}
.s-m-tile div.insert.right > btn {
  top: 50%;
  margin-top: -18px;
}
.s-m-tile-edit.s-m-draggable {
  outline: 8px double grey;
}
/***************************************
	Smartphone footer edit dashboard
***************************************/
.s-m-footer.smartphone {
  display: table-row;
  width: 100%;
  padding-left: 0px;
  padding-right: 0px;
}
.s-m-page.s-m-full.smartphone > footer {
  background-color: #ffffff !important;
  color: #ffffff !important;
  display: block !important;
}
.dashboard-template table > tbody > tr > td:first-child {
  width: 100%;
  padding-right: 5px;
}
.dashboard-template table > tbody > tr > td:first-child {
...
.modal-header .s-m-modal-btn-cancel,
.modal-header .s-m-modal-btn-logout {
  background-color: transparent !important;
...
.modal-dialog .list-group-item:not(:first-child) {
  border-top: 1px solid #dddddd;
}
#s-m-modal-parent .modal-footer {
  padding-left: 0px;
  padding-right: 0px;
}
.modal-title {
...
.modal-header > buttons {
  /* ignore whitespaces between buttons in header */
}
.modal-header .btn {
  font-size: 1.5em;
  padding: 5px;
...
/*
	BUTTONS
*/
.btn.s-m-modal-btn-validate {
  background-color: #41a940;
  color: #ffffff;
  font-family: 'Glyphicons Halflings';
}
.s-m-modal-btn-validate:before {
  content: "\e013";
}
.btn.s-m-modal-btn-cancel {
  background-color: #e74c3c;
  color: #ffffff;
  font-family: 'Glyphicons Halflings';
}
.s-m-modal-btn-cancel:before {
  content: "\e014";
}
.btn#s-m-msg-stacks {
  float: left;
...
.modal.half_right .modal-dialog {
  width: 100%;
  height: 100%;
  padding-left: 50%;
  margin: 0;
}
.modal-open .modal.half_right {
  overflow-x: hidden;
  overflow-y: hidden;
}
.modal.half_right .modal-content {
  height: 100%;
}
.modal.half_right .modal-header {
  position: absolute;
  width: 100%;
  top: 0;
}
.modal.half_right .modal.body {
  position: absolute;
}
.modal.half_right .modal-footer {
  position: absolute;
  width: 100%;
  bottom: 0;
}
...
.modal.half_center .modal-dialog {
  width: 75%;
  height: 100%;
  padding-left: 25%;
  margin: 0;
}
.modal-open .modal.half_center {
  overflow-x: hidden;
  overflow-y: hidden;
}
.modal.half_center .modal-content {
  height: 100%;
}
.modal.half_center .modal-header {
  position: absolute;
  width: 100%;
  top: 0;
}
.modal.half_center .modal.body {
  position: absolute;
}
.modal.half_center .modal-footer {
  position: absolute;
  width: 100%;
  bottom: 0;
}
table.s-m-translation {
  width: 100%;
}
table.s-m-translation td {
  width: 50%;
}
table.s-m-translation td > input {
  width: 100%;
}
/** MULTI BUTTONS **/
.modal.multibuttons button[data-action] {
  padding-left: 20px;
  padding-right: 20px;
}
.modal.multibuttons button.btn-sm[data-action] {
  padding-left: 10px;
  padding-right: 10px;
  margin-left: 5px;
}
.modal.multibuttons.tablet .modal-dialog {
  width: 70%;
  margin-top: 17%;
  margin-left: 15%;
}
.modal.multibuttons.mobile .modal-dialog {
  width: 98%;
  margin-top: 8%;
  margin-left: 1%;
}
.modal.multibuttons.mobile .modal-content {
  padding: 2%;
}
.config-tile .s-m-item-group {
  width: 45%;
  display: inline-block;
  vertical-align: top;
}
.config-tile .s-m-item-group .form-control {
  border: none;
  color: #275cc7;
  box-shadow: none;
}
.config-tile .s-m-item-group .form-control option {
  border: none;
  color: #545855;
  font-size: 1.2em;
}
.modal.config-tile a[data-action="addGroup"] {
  margin-left: 12px;
  color: #275cc7;
}
.full.modal.config-tile .btn.btn-default {
  color: white;
}
.modal.config-tile .btn.btn-default {
  color: #545855;
}
.modal.config-tile label {
  padding-top: 10px;
  font-size: 1.5em;
  width: 100%;
  color: #990069;
...
.modal.config-tile label:not(first-child) {
  padding-top: 30px;
}
.modal.config-tile .modal-body {
  padding: 0px 15px 0px 15px;
}
.modal.config-tile input {
  width: 100%;
}
/*
	SIZES
*/
.modal.config-tile .s-m-list-icons a {
...
.modal.config-tile .s-m-list-icons a:hover,
.modal.config-tile .s-m-list-icons a.active {
  color: rgba(84, 88, 85, 0.5);
}
.modal.config-tile .s-m-list-icons a i {
  font-size: 1.7em;
  padding-top: 5px;
}
/*
	COLORS
*/
.modal.config-tile .s-m-list-colors a {
  width: 39px;
  display: block;
  float: left;
  position: relative;
...
.modal.config-tile .s-m-list-colors a.active {
  border: 2px solid #333;
  border-radius: 20px;
}
.modal.config-tile .s-m-list-colors a:hover {
  border: 2px solid #AAA;
  border-radius: 20px;
}
.modal.config-tile .s-m-list-colors a div {
  height: 30px;
  border-radius: 20px;
  border: 1px solid rgba(255, 255, 255, 0.8);
}
.modal.config-tile .s-m-list-colors .s-m-bg.s-m-color-white {
  border: #dddddd 1px solid;
}
/*
	SIZES
*/
.modal.config-tile .btn-primary.dropdown-toggle {
  background-color: transparent;
  border: none;
  color: #337ab7;
  width: 100%;
...
.modal.config-tile .btn-primary.dropdown-toggle .caret {
  margin-left: 20px;
}
.modal.config-tile .dropdown-toggle li {
...
.modal.config-tile #clickGroup .dropdown-menu li:first-child {
  border-bottom: 1px solid rgba(0, 0, 0, 0.3);
  padding: 4px 2px 4px 2px;
}
.modal.config-tile .dropdown-menu > li > a {
  line-height: 2em;
}
/*
	BUTTONS
*/
.btn.s-m-modal-btn-logout {
  background-color: #cb3500;
  color: #ffffff;
...
.s-m-modal-btn-logout:before {
  content: "\f08b";
}
/*
* TABLET
*/
.modal.diagnoses.tablet .modal-dialog,
.modal.confirm.tablet .modal-dialog,
.modal.multibuttons.tablet .modal-dialog {
  width: 70%;
  margin-top: 17%;
  margin-left: 15%;
}
.modal.diagnoses.tablet .modal-content,
.modal.confirm.tablet .modal-content,
.modal.multibuttons.tablet .modal-content {
  padding-left: 2%;
  padding-right: 2%;
}
.modal.diagnoses.tablet .modal-title,
.modal.confirm.tablet .modal-title,
.modal.multibuttons.tablet .modal-title {
  font-size: 2em;
}
.modal.diagnoses.tablet .modal-header,
.modal.confirm.tablet .modal-header,
.modal.multibuttons.tablet .modal-header {
  border-bottom: none;
}
.modal.diagnoses .modal-header .modal-title,
.modal.confirm .modal-header .modal-title,
.modal.multibuttons .modal-header .modal-title {
  color: inherit;
  margin-top: 0px;
}
.modal.diagnoses.tablet .modal-body,
.modal.confirm.tablet .modal-body,
.modal.multibuttons.tablet .modal-body {
  overflow: hidden;
}
.diagnoses .btn-default,
.diagnoses .btn-default:hover,
.diagnoses .btn-default:focus,
.diagnoses .btn-default:active,
.confirm .btn-default,
.confirm .btn-default:hover,
.confirm .btn-default:focus,
.confirm .btn-default:active,
.multibuttons .btn-default,
.multibuttons .btn-default:hover,
.multibuttons .btn-default:focus,
.multibuttons .btn-default:active {
  border: none;
  color: inherit;
}
.diagnoses .btn-default[data-action="more"],
.diagnoses .btn-default[data-action="more"]:hover,
.diagnoses .btn-default[data-action="more"]:focus,
.diagnoses .btn-default[data-action="more"]:active {
  color: #990069;
}
.diagnoses .btn-default[data-action="$cancel"],
.diagnoses .btn-default[data-action="$cancel"]:hover,
.diagnoses .btn-default[data-action="$cancel"]:focus,
.diagnoses .btn-default[data-action="$cancel"]:active,
.confirm .btn-default,
.confirm .btn-default:hover,
.confirm .btn-default:focus,
.confirm .btn-default:active,
...
.modal.diagnoses.tablet .modal-footer,
.modal.confirm.tablet .modal-footer,
.modal.multibuttons.tablet .modal-footer {
  border-top: none;
  padding-bottom: 8px;
}
.modal.diagnoses.tablet .s-m-modal-diag-content section {
  height: 150px;
  display: none;
...
.modal.diagnoses.tablet .s-m-modal-diag-goto {
  margin-top: 1em;
  text-align: center;
  padding-right: 5%;
}
.modal.diagnoses.tablet .s-m-modal-diag-goto a {
  font-size: 2em;
  padding: 1em;
}
.modal.diagnoses.tablet .s-m-msg-stack-content {
  position: relative;
  width: 100%;
  display: block;
}
...
* SMARTHONE / MOBILE
*/
.modal.diagnoses.mobile,
.modal.confirm.mobile,
.modal.multibuttons.mobile {
  overflow-y: hidden;
}
.modal.diagnoses.mobile .modal-dialog,
.modal.confirm.mobile .modal-dialog,
.modal.multibuttons.mobile .modal-dialog {
  width: 98%;
  margin-top: 4%;
  margin-left: 1%;
}
.modal.diagnoses.mobile .modal-content,
.modal.confirm.mobile .modal-content,
.modal.multibuttons.mobile .modal-content {
  padding: 2%;
}
.modal.diagnoses.mobile .modal-title,
.modal.confirm.mobile .modal-title,
.modal.multibuttons.mobile .modal-title {
  font-size: 2em;
}
.modal.diagnoses .modal-header,
.modal.confirm .modal-header,
.modal.multibuttons .modal-header {
  background-color: transparent;
  box-shadow: none;
  -moz-box-shadow: none;
  -webkit-box-shadow: none;
...
.modal.diagnoses.mobile .modal-header,
.modal.confirm.mobile .modal-header,
.modal.multibuttons.mobile .modal-header {
  border-bottom: none;
}
.diagnoses .s-m-modal-diag-content,
.confirm .s-m-modal-diag-content,
.multibuttons .s-m-modal-content {
  color: #54585a;
}
.modal.diagnoses.mobile .modal-body,
.modal.confirm.mobile .modal-body,
.modal.multibuttons.mobile .modal-body {
  overflow: hidden;
  padding: 0;
  padding-left: 15px;
}
.modal.diagnoses.mobile .modal-footer,
.modal.confirm.mobile .modal-footer,
.modal.multibuttons.mobile .modal-footer {
  padding-top: 8px;
  border-top: none;
}
#s-m-modal-parent > .modal.diagnoses .modal-footer,
#s-m-modal-parent > .modal.confirm .modal-footer,
#s-m-modal-parent > .modal.multibuttons .modal-footer {
  padding: 8px 0px 0px 2px;
}
.modal.diagnoses.mobile .s-m-modal-diag-content section {
  display: none;
  border-top: 1px solid rgba(0, 0, 0, 0.1);
  border-bottom: 1px solid rgba(0, 0, 0, 0.1);
  -webkit-box-shadow: inset 0px 0px 8px rgba(0, 0, 0, 0.1);
...
.modal.diagnoses.mobile .s-m-modal-diag-goto {
  margin-top: 1em;
  text-align: center;
  padding-right: 5%;
}
.modal.diagnoses.mobile .s-m-modal-diag-goto a {
  font-size: 1.5em;
  padding: 0.6em;
}
.modal.diagnoses.mobile .s-m-msg-stack-content {
  position: relative;
  width: 100%;
  display: block;
}
...
* TABLET
*/
.modal.field.tablet .modal-title {
  font-family: FocoRegular;
  font-size: 2em;
}
.modal.field.tablet .modal-header {
  border-bottom: none;
}
.modal.field.tablet .modal-footer {
  border-top: none;
}
/*
* MOBILE / SMARTPHONE
...
.modal.field.mobile .modal-dialog {
  width: 100%;
  margin-top: 0;
}
.modal.field.mobile .modal-content {
  padding: 2%;
}
.modal.field.mobile .modal-title {
  font-family: FocoRegular;
  font-size: 2em;
}
.modal.field.mobile .modal-header {
  border-bottom: none;
  padding-left: 0;
}
.modal.field.mobile .modal-body {
  overflow: hidden;
  padding: 0;
  padding-left: 0;
}
.modal.field.mobile .modal-footer {
  border-top: none;
  text-align: center;
}
.s-m-header-brand > .s-m-brand {
  color: #545855;
  font-weight: 300;
}
.modal.show-legal .s-m-title {
  display: inline-block;
  width: 40%;
}
.modal.show-legal .s-m-value {
  display: inline-block;
}
.modal.show-legal .s-m-product-update-value {
  padding-left: 0.5em;
  font-size: 20px;
}
.modal.show-legal .modal-body {
  padding-left: 30px;
  padding-right: 30px;
  padding-bottom: 30px;
  padding-top: 0px;
...
.modal.show-legal .pageInfo > .s-m-field {
  font-size: 0.9em;
}
.modal.show-legal .pageInfo > .s-m-field > .s-m-title {
  width: 20%;
}
.modal.show-legal .pageInfo > .s-m-field > .s-m-value {
...
.show-legal .form-group {
  margin-bottom: 0px;
  padding-left: 10px;
  padding-right: 10px;
  padding-bottom: 30px;
}
.show-legal .form-group:not(:last-child) {
  border-bottom: 1px solid #999999;
}
.show-legal .s-m-scroll-element {
  background-color: #ffffff;
...
li.s-m-sync-tree-item {
  color: black;
  list-style-type: none;
}
.s-m-sync-tree-item > .s-m-tree-label {
  white-space: nowrap;
}
.s-m-sync-tree-item > .s-m-tree-label:before {
  font-family: "FontAwesome";
  padding-right: 10px;
  float: left;
}
.s-m-sync-tree-item.selected > .s-m-tree-label:before {
  content: "\f046";
}
.s-m-sync-tree-item > .s-m-tree-label:before {
  content: "\f096";
}
li.s-m-sync-tree-item.collapsed > ul {
  display: none;
}
li.s-m-sync-tree-item > div {
  display: inline-block;
}
li.s-m-sync-tree-item > .s-m-tree-icon-expand,
li.s-m-sync-tree-item > .s-m-tree-icon-leaf {
  padding-right: 10px;
  font-family: "FontAwesome";
}
li.s-m-sync-tree-item > .s-m-tree-icon-leaf:before {
  /* no icon for now */
}
li.s-m-sync-tree-item > .s-m-tree-icon-expand:before {
  content: "\f0d8";
}
li.s-m-sync-tree-item.collapsed > .s-m-tree-icon-expand:before {
  content: "\f0d7";
}
.sync-offline .s-m-modal-btn-sync {
  width: 80%;
}
.sync-offline .s-m-modal-btn-sync-stop {
  width: 80%;
  background-color: orange;
}
li.s-m-sync-tree-item.sync-progress {
  font-style: italic;
  color: orange;
}
li.s-m-sync-tree-item.sync-done {
  color: green;
}
.sync-offline .s-m-modal-btn-sync-stop .s-m-sync-total {
  float: right;
}
.sync-offline #s-m-sync-no-data-id {
  display: none;
}
#s-m-sync-no-data-id center {
  font-size: 20px;
  font-weight: bold;
}
#s-m-sync-no-data-id .panel {
  display: none;
}
/*
.sync-offline .s-m-modal-btn-sync-stop .s-m-sync-total .ok {
}
.sync-offline .s-m-modal-btn-sync-stop .s-m-sync-total .error {
}
...
.modal.settings .s-m-confirm {
  display: table-cell;
  width: 100%;
}
.modal.settings .s-m-cancel {
  display: table-cell;
  background-color: #ff5800;
}
.modal.settings .s-m-cancel:before {
  content: "\e014";
  color: #ffffff;
  font-family: "Glyphicons Halflings";
}
.modal.settings .progress {
  height: 50px;
}
.modal.settings .progress-bar {
  padding-top: 15px;
}
.modal.settings .s-m-cache-btn span {
  width: 100%;
  display: block;
}
.s-m-cache-btn > div > span {
  font-weight: normal;
  font-size: 10px;
}
.s-m-cache-btn {
...
/* CSS Changes due to working copy implementation
 * done in separate file to allow better merging later 
 */
.s-m-header > .s-m-header-links > a > span {
  font-size: inherit;
  position: relative;
...
div.s-m-wc-waiting > div {
  display: table-cell;
  vertical-align: middle;
  color: green;
  font-size: 50px;
}
.s-m-vignette div.s-m-wc-waiting > div {
  font-size: 18px;
}
/* WOCO FDB - ADDED STYLES */
.s-m-array.s-m-control > table[data-ncontroller-id] {
  width: 100%;
}
.s-m-record.s-m-empty.s-m-withtitle .s-m-control.s-m-field > .s-m-value,
...
body {
  font-family: roboto, "Segoe UI Light", "Segoe UI", "Segoe WP", "Helvetica Neue", sans-serif;
}
/* Used by application vignettes */
.s-m-sage-app-icon,
.s-m-sage-gadget-icon {
  font-family: 'sageMobileApps';
  speak: none;
  font-style: normal;
  font-weight: normal;
  font-variant: normal;
...
.s-m-color-medium-purple {
  background-color: #b29cdb;
  color: #ffffff;
}
.s-m-color-mediumpurple {
  background-color: #b29cdb;
  color: #ffffff;
}
.s-m-color-darkgrey {
...
.s-m-color-medium-grey {
  background-color: #9a9b9c;
  color: #ffffff;
}
.s-m-color-mediumgrey {
  background-color: #9a9b9c;
  color: #ffffff;
}
.s-m-color-green {
...
/* TODO see if actualy needed (sophie)*/
* {
  box-sizing: border-box;
}
*::before,
...
.s-m-color-medium-purple a:hover,
.s-m-color-mediumpurple a:hover .s-m-color-purple a:hover,
.s-m-color-skyblue a:hover,
.s-m-color-medium-grey a:hover,
.s-m-color-sagegreen a:hover,
.s-m-color-darkgrey a:hover,
.s-m-color-lightgreen a:hover,
.s-m-color-orange a:hover,
.s-m-color-blue a:hover,
.s-m-color-mediumgrey a:hover,
.s-m-color-green a:hover {
  color: #ffffff;
}
/*Waiting replace tag a by span*/
.s-m-color-medium-purple a,
.s-m-color-mediumpurple a,
.s-m-color-purple a,
.s-m-color-skyblue a,
.s-m-color-medium-grey a,
.s-m-color-sagegreen a,
.s-m-color-darkgrey a,
.s-m-color-lightgreen a,
.s-m-color-orange a,
.s-m-color-blue a,
.s-m-color-mediumgrey a,
.s-m-color-green a {
  color: #ffffff;
}
.s-m-color-white a:hover,
.s-m-color-white a {
  color: #000000;
}
.fa.fa-caret-square-o-right:hover,
.fa.fa-caret-square-o-right:focus {
  background-color: #41a940;
}
.alert.alert-info {
  background-color: #009fda;
...
/* =============== Temporarily: waiting final design =================*/
.s-m-site-auth-panel-content .btn-default,
#s-m-auth-panel-header-id .btn-default,
.s-m-value .btn-default,
.btn-toolbar .btn-default {
  background-color: #41a940 !important;
  border-color: #3a9739;
  color: #ffffff;
}
.s-m-site-auth-panel-content .btn-default.disabled,
.s-m-site-auth-panel-content .btn-default[disabled],
#s-m-auth-panel-header-id .btn-default.disabled,
#s-m-auth-panel-header-id .btn-default[disabled],
.s-m-value .btn-default.disabled,
.s-m-value .btn-default[disabled],
...
.s-m-site-auth-panel-content .btn-default:hover,
.s-m-site-auth-panel-content .btn-default.hover,
.s-m-site-auth-panel-content .btn-default:focus,
.s-m-site-auth-panel-content .btn-default.focus,
.s-m-site-auth-panel-content .btn-default:active,
.s-m-site-auth-panel-content .btn-default.active,
.s-m-site-auth-panel-content .btn-default.active,
#s-m-auth-panel-header-id .btn-default:hover,
#s-m-auth-panel-header-id .btn-default.hover,
#s-m-auth-panel-header-id .btn-default:focus,
#s-m-auth-panel-header-id .btn-default.focus,
#s-m-auth-panel-header-id .btn-default:active,
#s-m-auth-panel-header-id .btn-default.active,
.s-m-value .btn-default:hover,
.s-m-value .btn-default.hover,
.s-m-value .btn-default:focus,
.s-m-value .btn-default.focus,
.s-m-value .btn-default:active,
.s-m-value .btn-default.active,
...
.btn-toolbar .btn-default.active {
  background-color: #338432 !important;
  border-color: #296a28;
  color: #ffffff;
}
/*=============to remove after end UI changes */
...
.share .btn-default.active,
.dashboard-template .btn-default:hover,
.dashboard-template .btn-default.hover,
.dashboard-template .btn-default:focus,
.dashboard-template .btn-default.focus,
.dashboard-template .btn-default:active,
.dashboard-template .btn-default.active,
.edittemplates .btn-default:hover,
.edittemplates .btn-default.hover,
.edittemplates .btn-default:focus,
.edittemplates .btn-default.focus,
.edittemplates .btn-default:active,
.edittemplates .btn-default.active,
.filtersort .btn-default:hover,
.filtersort .btn-default.hover,
.filtersort .btn-default:focus,
.filtersort .btn-default.focus,
.filtersort .btn-default:active,
.filtersort .btn-default.active {
  background-color: rgba(0, 50, 97, 0.87) !important;
}
.share .btn-default,
.dashboard-template .btn-default,
.edittemplates .btn-default,
.filtersort .btn-default {
  background-color: #004089 !important;
  border-color: rgba(0, 0, 0, 0.4);
  color: #ffffff;
}
.share .btn-default.disabled,
.share .btn-default[disabled],
.dashboard-template .btn-default.disabled,
.dashboard-template .btn-default[disabled],
.edittemplates .btn-default.disabled,
.edittemplates .btn-default[disabled],
.filtersort .btn-default.disabled,
.filtersort .btn-default[disabled] {
  background-color: rgba(0, 50, 97, 0.5) !important;
}
/*==================end to remove */
/* ================== End temporarily =====================*/
.btn-default {
...
/* Just let bootstrap put opacity*/
...
/* Filters in queries - Blue background for full cell*/
.nav.nav-pills.nav-justified > li {
  border-color: transparent transparent #dddddd;
  border-style: solid;
  border-width: 0 0 1px;
}
.nav.nav-pills.nav-justified > li.active {
  background-color: transparent;
  border-color: #41a940 #dddddd transparent;
  border-style: solid;
...
.nav.nav-pills.nav-justified > li > a:focus {
  background-color: inherit;
}
.panel.panel-primary.s-m-panel-auth-prop.s-m-auth-prop-type-default > .panel-heading:hover,
.panel.panel-primary.s-m-panel-auth-prop.s-m-auth-prop-type-default > .panel-heading:focus,
.panel.panel-primary.s-m-panel-auth-prop.s-m-auth-prop-type-expert > .panel-heading:hover,
.panel.panel-primary.s-m-panel-auth-prop.s-m-auth-prop-type-expert > .panel-heading:focus {
  opacity: 0.9;
}
.btn-group.variants-list {
  margin-bottom: 20px;
}
.btn-group-justified {
  border-collapse: separate;
...
.s-m-schedulemsg > .btn-group-justified {
  padding-left: 4px;
  padding-right: 4px;
}
.btn-primary,
...
/* TODO USE LESS VARIABLES FOR : zindex, colors, header/footer height...
	There a hierarchy in z-index management - use LES Variable - z-index header/footer, z-index waiting bckg, ...
*/
html {
  height: 100%;
  margin: 0;
...
.fa.fa-caret-square-o-right {
  background-color: rgba(65, 169, 64, 0.75);
  color: #ffffff;
  padding: 0 0 0 4px;
  width: 20px;
  line-height: 20px;
...
/* Use less variable - must be greater than z-index of dismiss div for panels (10000) */
.modal {
  z-index: 20000;
  position: absolute;
}
...
.s-m-filtertabs > .nav.nav-pills {
  background-color: transparent;
}
/* display:table-cell;width:1% to prevent stacked display by bootstrap if width < 768px */
.s-m-filtertabs > .nav-justified > li {
  display: table-cell;
  width: 1%;
}
/* Fields not found */
.s-m-control.s-m-unfound > .s-m-value,
.s-m-table > .s-m-error {
  border: solid 1px #cb3500;
  color: #000000;
  width: 100%;
...
/* disable cursor hand on anchor tags */
.s-m-page a {
  cursor: default;
}
/* Override .waiting-background*/
.s-m-page > .waiting-background,
#s-m-app-id > .waiting-background {
  position: absolute;
}
/* Use it to put text after an icon in nav-bar*/
.s-m-nav-text {
  padding-left: 7px;
}
/* No hover on tablet - Same as tbody - TODO See if there's a less variable*/
.table-hover > tbody > tr:hover > td,
.table-hover > tbody > tr:hover > th {
  background-color: transparent;
}
/* BOOTSTRAP OVERRIDES - END */
/* Keep browser touch actions enabled for scrolling - The client is a mobile application so we need them */
i {
  -webkit-user-select: none;
  /* disable text select on icons */
}
body {
  margin: 0;
  padding: 0;
...
#s-m-app-id {
  ...
  top: 0px;
  left: 0px;
  /* H/W are calculated and set by JS*/
  background-color: transparent;
}
/* login page - vertical alignment*/
.s-m-login-info {
  margin-bottom: 20px;
}
#login-reason {
...
.s-m-page.s-m-full {
  ...
  height: 100%;
  width: 100%;
  /* needed for authoring when containing div is shrinked to device size
	   if we do not put this, scrolling displays page content above header and below footer */
  overflow: hidden;
}
/* Full page content*/
.s-m-page.s-m-full > section.s-m-main-content {
  box-sizing: border-box;
  font-size: 14px;
  height: auto;
  overflow: hidden;
...
.s-m-page.s-m-full.smartphone > section.s-m-main-content {
  padding: 5px 10px 5px 10px;
  font-size: 12px;
}
/* Full page title */
section.s-m-main-content .s-m-page-title {
  color: #41a940;
  font-size: large;
  margin-top: 10px;
...
.s-m-page.s-m-full.smartphone > .s-m-main-content .s-m-page-title {
  font-size: medium;
}
.s-m-page.s-m-full > footer {
  overflow: visible;
  /* visible to allow dropdownlist in footer - see multiselection actions*/
  position: absolute;
  width: 100%;
  z-index: 1000;
...
/* page controls */
.s-m-page > section.s-m-breadcrumbs,
.s-m-page > section.s-m-topToolbar {
  position: absolute;
  padding: 0;
  margin: 0;
  display: block;
...
.s-m-topToolbar > .s-m-control {
  padding: 0px;
}
/* Nested page into a vignette*/
/* UTILS - RECTANGLE*/
.s-m-rect {
  border: solid 2px blue;
  opacity: .5;
}
/* Wraps elements (s-m-scroll-elmt) for scrolling  - Set to fixed height for native scrolling */
.s-m-scroll-wrapper {
  position: relative;
  overflow: hidden;
  width: 100%;
...
/* elment that scrolls - relative and auto*/
.s-m-scroll-elmt {
  height: auto;
  position: relative;
}
...
.s-m-layout.s-m-stack > content {
  /* fdb added to fix display of chart in a stack layout - Chart test hub - Propagate parent's height */
  height: 100%;
  display: inline-block;
  width: 100%;
}
...
/* Query inside a vignette*/
.s-m-page.s-m-nested.query > .s-m-stack > header {
  height: 0px;
  padding-top: 0px;
  padding-bottom: 3px;
}
.s-m-stack > header > .s-m-title {
  display: inline;
}
.s-m-stack.s-m-theme-advanced > header {
  text-align: right;
  padding-top: 8px;
}
.s-m-stack.s-m-theme-advanced > header > .s-m-title {
  display: none;
}
.s-m-theme-b > header {
  margin-left: 16px;
...
.s-m-stack.s-m-theme-c > header {
  color: #06a7e5;
}
.s-m-stack > header > btn {
  height: 24px;
  width: 24px;
  background: transparent;
  font-family: "FontAwesome";
...
.s-m-stack.s-m-theme-advanced > header > btn {
  padding-right: 0px;
}
.s-m-stack.s-m-theme-advanced > header > btn.expanded:before {
  background-color: rgba(0, 0, 0, 0.1);
  color: #9a9b9c;
  padding: 2px 5px 3px 4px;
  border-radius: 20px;
}
.s-m-stack.s-m-theme-advanced > content > .s-m-row {
  background-color: rgba(0, 0, 0, 0.1);
}
.s-m-stack > content > .s-m-array {
  margin-left: 0px;
}
/*
 	ROW
...
.s-m-layout.s-m-row.row.s-m-empty {
  display: none;
}
/* Customer optimization - An empty cell that takes the full width is not displayed*/
.s-m-row > .s-m-cell.s-m-fullwidth.s-m-empty {
  display: none;
}
/*
  Cell container with padding to seperate cells
*/
.s-m-row > .s-m-cell {
  padding: 5px;
  height: 100%;
...
/*
  Inner cell content to have a border arround cells in row layout mode
*/
.s-m-row > .s-m-cell > .cell {
  width: 100%;
  height: 100%;
}
/*
...
.s-m-layout.s-m-hub-group {
  position: absolute;
}
.s-m-layout.s-m-hub-group > header.edit {
  width: 100%;
}
.s-m-layout.s-m-hub-group > header.edit > input {
  border: 0px;
  border-bottom: 1px solid #41a940;
  background: transparent;
}
.s-m-layout.s-m-hub-group > header {
  color: #41a940;
  font-size: 20px;
  height: 30px;
  padding-left: 2px;
...
.s-m-layout.s-m-hub-group > header > .s-m-group-actions {
  position: absolute;
  top: 0px;
  right: 0px;
}
...
.s-m-bg.s-m-color-white {
  border: #dddddd solid 1px;
}
/* Just if the parent is a dashboard */
.s-m-cell.dashboard > .cell:not(.s-m-bg),
.s-m-cell.dashboard > .s-m-tile:not(.s-m-bg) {
  border: #dddddd solid 1px;
}
.s-m-tile section.s-m-icon .fa {
  display: block;
}
.s-m-tile.small section.s-m-icon {
  font-size: 24px;
}
.s-m-tile.medium section.s-m-icon,
.s-m-tile.wide section.s-m-icon {
  font-size: 52px;
}
.s-m-tile.large section.s-m-icon {
  font-size: 96px;
}
.s-m-tile.full section.s-m-icon {
  font-size: 96px;
}
.s-m-tile.all section.s-m-icon {
  font-size: 96px;
}
.s-m-tile > header,
.s-m-cell > .cell > header {
  position: absolute;
  left: 0px;
  padding-left: 5px;
  padding-right: 5px;
...
.s-m-tile > header > span.title {
  overflow: hidden;
  max-width: 100%;
  float: left;
}
.s-m-tile > header.s-m-has-act-icon > span.title {
  max-width: 90%;
}
/* Easy way to manage the title's width according to the number of icons - If more complicated use the same way as page header - table display */
.s-m-tile > header.s-m-has-act-icon.s-m-has-ttl-icon > span.title {
  max-width: 82%;
}
/* for medium size vignette */
.s-m-tile.medium > header.s-m-has-act-icon > span.title {
  max-width: 80%;
}
.s-m-tile.medium > header.s-m-has-act-icon.s-m-has-ttl-icon > span.title {
  max-width: 72%;
}
.s-m-tile > header > i.s-m-ttl-icon {
  float: left;
  padding-top: 3px;
}
.s-m-cell > .cell > header {
...
header > i[data-action="togglePinVignette"] {
  padding-top: 3px;
}
.s-m-ttl-icon {
  padding-right: 5px;
...
.s-m-control.s-m-field.error {
  /*#6785*/
  overflow: visible;
}
.s-m-control.s-m-theme-largetitle {
  font-family: FocoRegular;
  font-size: 25px;
}
/** FDB fields in blocks except chart **/
.s-m-layout.s-m-cell:not(.s-m-chart) > .cell > .s-m-control:not(.s-m-vignette) {
  padding: 3px;
}
.s-m-control.footer {
  margin-top: 5px;
  /*Table to position left/right icon cells*/
  display: table;
  width: 100%;
  padding-top: 0;
  /* visible To allow dropdown list in header and footer*/
...
/* Something that is scrolled must be relatively positioned! */
.s-m-scroll-element {
  position: relative;
}
.s-m-control > .s-m-title {
  color: inherit;
  font-weight: bold;
  overflow: hidden;
  padding-right: 5px;
...
.s-m-control.s-m-field > .s-m-value.edit > .input-group {
  width: 100%;
}
.s-m-control.s-m-field.s-m-img > .s-m-title,
.s-m-control.s-m-field.s-m-clob > .s-m-title {
  vertical-align: top;
}
/* Label position left - inline-block - top -> block for value */
.s-m-control.s-m-field > .s-m-title {
  display: inline-block;
  width: 30%;
}
.s-m-control.s-m-field > .s-m-value {
  display: inline-block;
  width: 70%;
}
.s-m-control.s-m-field.s-m-top > .s-m-title {
  width: 100%;
}
.s-m-control.s-m-field.s-m-top > .s-m-value,
.s-m-control.s-m-field.s-m-title-hidden > .s-m-value {
  display: block;
  width: 100%;
}
.s-m-control.s-m-field.s-m-right {
  text-align: right;
}
.s-m-control.s-m-field.s-m-left {
  text-align: left;
}
.s-m-control.s-m-field.s-m-center {
  text-align: center;
}
.s-m-control.s-m-unknown > .s-m-value {
  background-color: #9a9b9c;
  color: #ffffff;
  font-style: oblique;
}
/* CHARTS */
.s-m-control.s-m-array.s-m-chart {
  height: 100%;
  width: 100%;
  display: block;
  padding: 0px;
...
.s-m-control.s-m-array.s-m-chart.s-m-hidden {
  display: none;
}
.s-m-control.s-m-array.s-m-chart > div.s-m-value {
  height: 100%;
  width: 100%;
}
/* Chart slot*/
.s-m-control.s-m-array.s-m-chart > div.s-m-value > div.s-m-slot {
  height: 100%;
  width: 100%;
  position: absolute;
  top: 0px;
...
.s-m-page.s-m-full.chartdetail .s-m-array.s-m-chart > div.s-m-value > div.s-m-slot {
  /* trick to display chart right border - TODO improve display*/
  padding-right: 4px;
  margin-bottom: -1px;
}
.s-m-control.s-m-array.s-m-chart > .s-m-value > div.s-m-catchevt {
  z-index: 100;
  height: 100%;
  width: 100%;
  position: absolute;
...
/* ARRAYS - General arrays classes */
/* Hide actions if readOnly in a row*/
.s-m-record.readonly .s-m-control.s-m-icon {
  display: none;
}
.s-m-record.readonly td.s-m-icon {
  display: none;
}
.s-m-array {
  /* fdb added to fix border issue in authoring */
  height: 100%;
  /* For H scrolling - relative position to calculate the offset / parent*/
  position: relative;
}
.s-m-page.query .s-m-array {
  padding-top: 0px;
}
.s-m-control.s-m-array.empty > .s-m-value > span {
  text-align: center;
  font-size: 1.5em;
  width: 100%;
  padding: 30px;
...
.s-m-control.s-m-array.s-m-card.empty > .s-m-value > span {
...
.s-m-array > header > nav.s-m-stdheader,
.s-m-array > header > nav.s-m-filtertabs {
  display: inline-block;
  width: 100%;
  margin-top: 2px;
  height: 100%;
}
.s-m-array > header > nav.s-m-stdheader > nav.s-m-pagin {
  float: left;
}
.s-m-array > header > nav.s-m-stdheader > nav.s-m-pagin > ul.pagination {
  font-size: smaller;
  padding: 0;
  margin: 0;
}
...
.s-m-array > header > nav.s-m-stdheader > .s-m-filterSort {
  font-size: large;
  float: right;
  padding-right: 4px;
  padding-top: 5px;
}
.s-m-array > header > nav.s-m-stdheader > .s-m-filterSort .fa.fa-bars {
  background-color: transparent;
  color: inherit;
  padding: 4px;
}
...
/* Filter tab color */
.s-m-array > header > .s-m-filtertabs > .nav.nav-pills.nav-justified a {
  color: #009fda;
}
.s-m-array > header > nav.s-m-filtertabs a:focus {
  color: #ffffff;
}
.pagination > li > a,
.pagination > li > span {
...
/* Remove the space between row in card - bootstrap*/
.s-m-card .row:before,
.s-m-card .row:after {
  display: none;
}
.s-m-array.s-m-card tr.s-m-last-selected {
  background-color: #9a9b9c;
  color: #ffffff;
}
...
.s-m-control.s-m-array.s-m-card:not(.s-m-carousel) > .s-m-value {
  height: 100%;
}
.s-m-control.s-m-array.s-m-card > .s-m-value > table {
  border-collapse: separate;
  position: relative;
  font-size: 1em;
  border-spacing: 8px;
...
.s-m-control.s-m-array.s-m-carousel td.s-m-record > section.s-m-card {
  padding: 0px;
  height: 100%;
}
/* Force background for cards in vignettes*/
.s-m-page.s-m-nested .s-m-control.s-m-array > .s-m-value > .s-m-scroll-wrapper {
  background-color: transparent;
}
/* display: table to be able to calcultate have the right height for s-m-value (height:100%) in vignettes*/
.s-m-page.s-m-nested .s-m-control.s-m-array.s-m-card {
  width: 100%;
}
td.s-m-record > section.s-m-card {
  padding: 5px;
  position: relative;
}
section.s-m-card {
...
td.s-m-record.s-m-last-selected > section.s-m-card {
  background-color: #9a9b9c;
  color: #ffffff;
}
td > section.s-m-card > .s-m-layout {
  overflow: hidden;
}
td.s-m-record:not(.s-m-multi-selected) > section.s-m-card > span.badge.checked {
  display: none;
}
td.s-m-record.s-m-multi-selected > section.s-m-card > span.badge.checked {
  display: block;
  width: 15px;
  height: 15px;
  color: white;
...
section.s-m-card span.badge.index {
  background-color: #41a940;
  border-radius: 100px 0 0;
  bottom: 0;
  color: #ffffff;
  ...
  right: 0;
  position: absolute;
  /* display overlaps the data */
  z-index: 10;
}
/* To not have white background in nested arrays */
.s-m-control.s-m-array.s-m-table > .s-m-value table > tbody > tr > td {
  background-color: inherit;
}
/* Mandatory 100% to calculate the cell Padding see builderTable*/
.s-m-control.s-m-array.s-m-table > .s-m-value table > tbody > tr > td > .s-m-control > .s-m-value {
  width: 100%;
}
/* Temporarily - hide fields title if cell is empty  but keeps the room*/
td.s-m-empty.s-m-filled .s-m-title {
  visibility: hidden;
}
/* CARDS PAGINATION*/
tbody.s-m-card-pagin {
  text-align: center;
  font-size: smaller;
  line-height: 0.9em;
}
caption.s-m-card-pagin {
  /* DIY to display the pagination close to the cell */
  background-color: #dddddd;
  margin: 7px;
  text-align: center;
  font-size: small;
...
/* Single array with separator */
.s-m-array.s-m-separator > .s-m-value > section > .s-m-control,
.s-m-array.s-m-separator > .s-m-value > section > .s-m-control > .s-m-value {
  display: inline;
  padding: 0px;
  margin: 0px;
}
.s-m-array.s-m-separator > .s-m-value > section > span.s-m-separator {
  display: inline-block;
  width: 15px;
  text-align: center;
}
/* TABLE  - General Table classes */
.s-m-table .s-m-control.s-m-field > .s-m-numeric.s-m-value {
  text-align: right;
}
/* X3 error in row data - To improve*/
tr.error {
  border-width: 2px;
...
/* for a query nested in a vignette -> no scroll -> vignette's scroll*/
.s-m-page.s-m-nested.query .s-m-table > .s-m-value {
  overflow: visible;
}
/* ARRAY TABLE */
.s-m-table table {
  /*Remove 20px from bootstrap table*/
  margin-bottom: 0px;
  /* fixed display */
  table-layout: fixed;
  /* for scrolling*/
...
.s-m-table.s-m-single-array table {
  /* shift top to offset the hidden thead*/
  margin-top: -8px;
}
.s-m-table table > thead > tr {
  overflow: hidden;
  border: solid 1px #dddddd;
}
/*Set icon width in columns - TODO use less variable*/
.s-m-table table > thead > tr > th.s-m-icon,
.s-m-table table > tbody > tr > td.s-m-icon {
  width: 38px;
}
.s-m-table tr.s-m-last-selected {
  background-color: #beeffa;
}
.s-m-table tr.s-m-even {
  background-color: #dff0d8;
}
.s-m-table tr.s-m-even.s-m-last-selected {
  background-color: #beeffa;
}
.s-m-table table > tbody > tr > td > .s-m-control {
  padding: 0em;
}
.s-m-table table > thead > tr > th {
  margin: 0;
  overflow: hidden;
  padding: 5px;
...
.s-m-table table > tbody {
  background-color: #ffffff;
  border: 1px solid #dddddd;
  color: #000000;
}
.s-m-table table > tbody > tr > td {
  margin: 0;
  overflow: hidden;
  border-left: solid 1px #dddddd;
  white-space: nowrap;
...
.s-m-table table > tfoot > tr > td > .s-m-control.s-m-btn {
  text-align: center;
  padding-top: 0px;
}
th.s-m-rowidx {
...
/* BUTTON CONTROL*/
/* TODO - 12px according BS .btn left padding - Use LESS variable*/
.s-m-control.s-m-btn > button > i {
  padding-right: 12px;
}
/* ICON FIELD - TODO use LESS variables */
.s-m-control.s-m-icon > a > span {
  font-size: 1.3em;
}
.s-m-icon-link {
  display: table-cell;
...
.s-m-url > .s-m-value > .s-m-icon-link {
  padding-left: 8px;
}
.s-m-control.s-m-url > .s-m-value {
  display: inline;
}
/* COTROL FIELD */
.s-m-control.s-m-field > .s-m-value {
...
.s-m-control.s-m-field.s-m-gauge > .s-m-value {
  display: block;
  width: 100%;
}
.s-m-control.s-m-auth.s-m-unit {
  border: none;
}
/* hidden control */
.s-m-control.s-m-hidden {
  display: none;
}
/* Force display with a dedicated style in authoring*/
.s-m-control.s-m-auth.s-m-hidden {
  color: #dddddd;
  display: block;
}
.s-m-control.s-m-auth.s-m-hidden > .s-m-value > input {
  background-color: #d3d3d3;
}
/* Temporarily to align unit fields  */
.s-m-control.s-m-field.s-m-unit {
  padding-left: 10px;
  padding-top: 0px;
}
/* Temporarily to align unit fields  */
.s-m-control.s-m-field.s-m-ref .s-m-descr {
  font-size: 0.75em;
  font-style: italic;
}
span[href] .s-m-descr {
...
.s-m-control.s-m-field.s-m-qty > .s-m-value > .s-m-control.s-m-field.s-m-unit {
  display: inline;
}
.s-m-control.s-m-field.s-m-qty > .s-m-value.edit > .s-m-control.s-m-field.s-m-unit {
  display: none;
}
.s-m-control.s-m-field.s-m-qty > .s-m-value > .s-m-control.s-m-field.s-m-unit > .s-m-value {
  vertical-align: top;
}
.s-m-control.s-m-field > input {
  border: 1px solid gray;
}
.s-m-control.s-m-field > input:focus {
  border: 2px solid green;
}
.s-m-page.details .s-m-control.s-m-field > span.s-m-error {
  width: 100%;
  padding: 0px;
  top: 2.5em;
}
.s-m-page.details .s-m-control.s-m-field > span.s-m-error > p {
  left: 0px;
}
/* Fields errors in table array - Edit mode */
.s-m-array.s-m-table .s-m-record .s-m-control.s-m-field.error {
  border: solid 1px #cb3500;
}
/* s-m-field > s-m-error css is tricky - please chek all case if you modify (inside cell, outside cell) * (top aligned, left aligned) * (title hidden, not title hidden) */
.s-m-control.s-m-field > span.s-m-message {
  font-size: 0.8em;
  font-weight: normal;
  display: block;
  position: absolute;
...
.s-m-control.s-m-field > span.s-m-message > p {
  color: #ffffff;
  margin: 0px;
  padding-left: 3px;
  position: relative;
...
.s-m-page.details .s-m-control.s-m-field > span.s-m-message {
  position: relative;
  top: -0.5em;
}
.s-m-control.s-m-field > span.s-m-message > p.s-m-error {
  background-color: #cb3500;
}
.s-m-control.s-m-field > span.s-m-message > p.s-m-info {
  background-color: #009fda;
}
.s-m-control.s-m-field > span.s-m-message > p.s-m-warning {
  background-color: #ff8240;
}
.s-m-control.s-m-field.s-m-top > span.s-m-message {
  left: 0px;
  width: 100%;
  top: 5.4em;
}
.cell > .s-m-control.s-m-field > span.s-m-message {
  padding-right: 4px;
}
.cell > .s-m-control.s-m-field > span.s-m-message > p {
  left: 1px;
}
.cell > .s-m-control.s-m-field.s-m-top > span.s-m-message {
  padding-right: 6px;
}
.cell > .s-m-control.s-m-field.s-m-top > span.s-m-message > p {
  left: 3px;
}
.s-m-control.s-m-field.s-m-title-hidden > span.s-m-message,
.s-m-control.s-m-field.s-m-top.s-m-title-hidden > span.s-m-message {
  width: 100%;
  left: 1px;
}
/* Fields not in a cell */
.s-m-layout.s-m-stack > content > .s-m-control.s-m-field.s-m-title-hidden > span.s-m-message {
  left: 0px;
}
.s-m-layout.s-m-stack > content > .s-m-control.s-m-field.s-m-title-hidden > span.s-m-message > p {
  top: -2px;
}
.s-m-control.s-m-field.error > .s-m-value input {
  border-color: #cb3500;
  box-sizing: border-box;
  font-weight: normal;
}
/* Forces hidden fields to display if there's an error */
.s-m-control.s-m-field.s-m-hidden.error {
  display: inherit;
}
.s-m-control.s-m-field.hidden {
  display: none;
}
.s-m-control.s-m-field-choice-radio-title {
  display: inline-block;
}
/* Value before label - Use LESS variables for width*/
.s-m-control.s-m-valuefirst > .s-m-value {
  float: left;
  width: 30%;
}
.s-m-control.s-m-valuefirst > .s-m-title {
  float: right;
  width: 70%;
}
/* Image field */
/* Temporarily to align input fields  */
/*.s-m-control.s-m-field.s-m-img > .s-m-title, .s-m-control.s-m-field.s-m-binary > .s-m-title {
    float: none;
}*/
.s-m-control.s-m-field.s-m-img > .s-m-value > a > span {
  height: 15em;
  background-size: contain;
  background-repeat: no-repeat;
}
/* */
.s-m-control.s-m-field.s-m-img > .s-m-value > a > img {
  max-height: 300px;
  background-size: contain;
  background-repeat: no-repeat;
  width: auto;
...
/* Hide file input*/
.s-m-control.s-m-field.s-m-img > .s-m-value > input {
  /* have to set height to 0 instead of display:none because of safari web browser*/
  /*display:none;*/
  height: 0px;
  width: 0px;
  overflow: hidden;
...
/* image core */
.s-m-img-layout > section > a > span {
  /*height: 15em;*/
  background-size: contain;
  background-repeat: no-repeat;
}
.s-m-img-layout > section > a > span.s-m-empty {
  height: auto;
  background-size: contain;
  background-repeat: no-repeat;
  color: #dddddd;
}
.s-m-img-layout > section > a > span.s-m-doc {
  height: initial;
  background-size: contain;
  background-repeat: no-repeat;
  font-size: 5em;
}
.s-m-img-layout > section > a > img {
  max-height: 15em;
  background-size: contain;
  background-repeat: no-repeat;
  width: auto;
...
/* image footer */
.s-m-img-layout > footer {
  background-color: rgba(0, 0, 0, 0.5);
  height: 1.5em;
}
.s-m-img-layout > footer > a {
  color: #ffffff;
  display: inline-block;
  padding-left: 4px;
  padding-right: 8px;
}
.s-m-img-layout > footer > a[naction="$delete"] {
  float: right;
}
.s-m-img-layout > footer > a[disabled] {
  display: none;
}
/* VIGNETTES */
.s-m-control.s-m-vignette {
  height: 100%;
  overflow: hidden;
  padding: 5px;
  width: 100%;
}
/* Chart display - no padding to not se the background - just the border of the chart */
.s-m-tile.s-m-chart:not(.s-m-bg),
.s-m-cell.s-m-chart > .cell:not(.s-m-bg) {
  border: none;
}
.s-m-tile.s-m-chart > .s-m-control.s-m-vignette,
.s-m-cell.s-m-chart > .cell > .s-m-control.s-m-vignette {
  padding: 0px;
}
.s-m-cell .s-m-control.s-m-vignette {
  min-height: 30px;
}
/* Enriched text fields (CLOB) */
.s-m-control.s-m-field > .s-m-clob.s-m-value > section {
  border: 1px solid rgba(0, 0, 0, 0.1);
}
.s-m-value.edit.s-m-clob.s-m-text-plain > section {
  border: none;
}
.s-m-value.edit.s-m-clob.s-m-text-plain .s-m-enriched-text-content {
  margin: 0px;
}
.s-m-control.s-m-field > .s-m-clob.s-m-text-plain.s-m-value > section {
  border: 1px solid rgba(0, 0, 0, 0.1);
}
.s-m-control.s-m-field.s-m-clob.s-m-text-plain > .s-m-value.edit > section {
  border: 0px solid rgba(0, 0, 0, 0.1);
}
.s-m-enriched-text {
  position: relative;
}
.s-m-control.s-m-field.s-m-clob.s-m-text-plain > .s-m-value.edit > section > .s-m-enriched-text .s-m-enriched-text-content {
  margin: 0px;
}
.s-m-control.s-m-field.s-m-clob.s-m-text-plain > .s-m-value > section > div {
  overflow: hidden;
}
.s-m-control.s-m-field.s-m-clob > .s-m-value > section > div {
  padding: 0px;
  white-space: normal;
  overflow: hidden;
}
/*### Enriched text fields expander (button)*/
.s-m-control.s-m-field.s-m-clob > .s-m-value > button {
  margin-top: 0.5em;
  float: right;
}
.s-m-enriched-text .s-m-enriched-text-content {
  margin: 7px;
  white-space: normal;
  overflow: hidden;
  padding: 0px;
...
/*Contener btn expende for text (rich plain html)*/
.s-m-enriched-text-expander {
  float: right;
}
.s-m-enriched-text-expander a {
...
.s-m-control.s-m-field.s-m-clob.s-m-text-plain > .s-m-value.edit > section > .s-m-enriched-text > .s-m-enriched-text-expander {
  position: absolute;
  width: 100%;
  padding-right: 2px;
  top: 0;
...
/* Do not set background in vignettes displayed in a tile since color will come from tile */
.s-m-tile > .s-m-control.s-m-vignette {
  background-color: transparent;
}
.s-m-vignette.s-m-error {
  border: 2px solid transparent;
  color: #4d4f53;
}
.s-m-vignette.s-m-error > a {
  background-color: #cb3500;
  color: #ffffff;
  display: block;
  padding: 10px;
}
.s-m-vignette.s-m-control.footer {
  padding-bottom: 35px;
  display: block;
}
.s-m-control.s-m-vignette > footer {
  position: absolute;
  bottom: 0;
  left: 0px;
  z-index: 50;
...
.s-m-vignette > footer > span[data-action] {
  position: relative;
  font-size: 1.8em;
}
.s-m-vignette > div.s-m-wait-root {
  position: absolute;
  bottom: 5px;
  right: 0;
  z-index: 101;
...
.s-m-vignette > div.s-m-wait-root > .s-m-waiting.wheel {
  width: 100%;
}
.s-m-vignette > .s-m-waiting.bckg {
  position: absolute;
  top: 0;
  right: 0;
  height: 100%;
  ...
  background-color: transparent;
  opacity: 0.7;
  /* > than full page footer z-index*/
  z-index: 100;
  overflow: hidden;
}
.s-m-vignette > section {
  overflow: hidden;
  height: 100%;
  width: 100%;
}
.s-m-vignette > section > .s-m-page {
  /* height=100% to avoid V scrolling in vignettes - otherwise set height with auto */
  height: 100%;
  width: 100%;
  /* for scrolling */
  position: relative;
...
.s-m-link-page > section.s-m-title {
  display: table-row;
  font-size: 1.1em;
}
.s-m-link-page > section.s-m-title > div {
  display: table-cell;
  text-overflow: ellipsis;
  overflow: hidden;
  height: 100%;
...
.s-m-link-page > section.s-m-icon {
  display: table-row;
  width: 100%;
  height: 100%;
}
.s-m-link-page > section.s-m-icon > div {
  display: table-cell;
  vertical-align: middle;
  width: 100%;
}
.s-m-page:not(.welcome) .s-m-vignette .s-m-link-page {
  text-align: center;
}
.s-m-page:not(.welcome) .s-m-vignette .s-m-link-page > .s-m-title {
  padding: 0px;
  margin: 0px;
}
.s-m-page.smartphone:not(.welcome) .s-m-vignette .s-m-link-page > .s-m-title {
  font-size: 1.4em;
}
/*DASHBOARD*/
.dashboard .vignette.frame {
  background-color: transparent;
  height: 100%;
}
.dashboard .vignette.content {
  height: 100%;
  width: 100%;
}
/* Displays a grey box if a dashboard does not contain any vignettes */
.s-m-dashboard-msg-empty {
  position: absolute;
...
.s-m-act-msg-slot.tablet.landscape {
  width: 40%;
}
.s-m-act-msg-slot.tablet.portrait {
  width: 50%;
}
.s-m-act-msg-slot.smartphone.landscape {
  width: 50%;
}
.s-m-act-msg-slot.smartphone.portrait {
  width: 80%;
}
.s-m-act-msg {
  padding: 1.5em;
...
.s-m-modal-layout > header > button {
  font-size: 2em;
  padding-right: 0.2em;
}
.s-m-modal-content > div > header {
  padding: 0.5em;
  font-family: FocoRegular;
  font-size: 2em;
  color: #41a940;
}
.s-m-modal-content > div > header.error {
  color: #cb3500;
}
.s-m-modal-content > div > section {
  font-family: arial;
  padding: 1em;
}
.s-m-modal-content > div > footer {
  padding: 1em;
  float: right;
}
.s-m-modal-parent {
...
.s-m-modal-btn-cancel.btn-default {
  background-color: #ff5800;
  color: #ffffff;
  font-family: "Glyphicons Halflings";
}
.s-m-modal-btn-validate {
  background-color: #41a940;
  color: #ffffff;
  font-family: "Glyphicons Halflings";
}
/******************************
* FOOTER TABLET AND SMARTPHONE
*******************************/
.s-m-control.footer > .s-m-navbar {
  height: 50px;
  width: 100%;
  background-color: #000000;
  color: #ffffff;
...
.s-m-control.footer > .s-m-navbar > .s-m-navbar-left {
  float: left;
}
.s-m-control.footer > .s-m-navbar > .s-m-navbar-right {
  float: right;
}
.s-m-control.footer > .s-m-navbar > .s-m-navbar-right > span {
  margin-left: 5px;
}
.s-m-control.footer > .s-m-navbar a {
  color: #ffffff;
  text-decoration: none;
}
.s-m-control.footer > .s-m-navbar .s-m-nav-text {
  font-size: small;
  color: #ffffff;
  padding-left: 0px;
}
...
.s-m-footer.tablet .s-m-link {
  display: inline-block;
  min-width: 50px;
  /* Force bootstrap a tag color - black*/
  color: #ffffff;
}
.s-m-footer.tablet .s-m-link > span {
  max-width: 100px;
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
}
.s-m-footer.tablet > .s-m-footer-left,
.s-m-footer.tablet > .s-m-footer-right {
  display: table-cell;
  padding-top: 5px;
}
.s-m-footer.tablet > .s-m-footer-left > .s-m-link {
  float: left;
  padding-left: 15px;
}
.s-m-footer.tablet > .s-m-footer-right > .s-m-link {
  float: right;
  padding-right: 15px;
}
.s-m-footer.tablet a.s-m-link i {
  display: block;
  text-align: center;
  font-size: 1.5em;
  top: -2px;
...
.s-m-footer.tablet a.s-m-link span {
  display: block;
  text-align: center;
  font-size: 1em;
  vertical-align: bottom;
...
/*    MULTISELECTION                 */
/*************************************/
.s-m-array.s-m-table .s-m-record.s-m-multi-selected {
  background-color: #41a940;
}
.s-m-array.s-m-table .s-m-record.s-m-multi-selected.error {
  background-color: #eeb8a6;
  color: #4d4f53;
  border: none;
}
.s-m-array.s-m-table .s-m-record.s-m-multi-selected.success {
  background-color: #a0d49f;
  color: #4d4f53;
}
.s-m-array.s-m-card td.s-m-record.s-m-multi-selected.error > section.s-m-card {
  background-color: #eeb8a6;
  color: #4d4f53;
  border: none;
}
.s-m-array.s-m-card td.s-m-record.s-m-multi-selected.success > section.s-m-card {
  background-color: #a0d49f;
  color: #4d4f53;
}
.s-m-record.s-m-multi-selected > section.s-m-card {
  box-shadow: 2px 2px 0 #009fda inset, -2px -2px 0 #009fda inset;
}
.s-m-array.s-m-card .s-m-control.s-m-field > .s-m-numeric.s-m-value {
  text-align: left;
}
/* only badge and caret - text has no margin*/
.s-m-panel.multiSelection .btn-group > div > button.btn > span:not(.title) {
  font-family: monospace;
}
.s-m-panel.multiSelection .btn-group > div > button.btn > span.title {
  margin-left: 10px;
  margin-right: 10px;
}
.s-m-page.s-m-full.smartphone > header #multiSelMenuActions {
  padding-left: 0.3em;
}
#multiSelMenuActions > div > .btn > .badge {
  border-radius: 30px;
  font-family: arial;
  font-size: 1em;
  font-weight: bold;
}
#multiSelMenuActions .dropdown-menu > li > a {
  text-align: inherit;
  float: inherit;
  color: #333333;
  margin-left: 8px;
}
.s-m-panel.multiSelection > .s-m-footer > .s-m-footer-right > .btn-group > div > ul.dropdown-menu {
  right: 0px;
}
.s-m-panel.multiSelection > .s-m-footer > .s-m-footer-right > .btn-group > div > ul.dropdown-menu > li > a {
  color: #000000;
  font-weight: bold;
  line-height: 2em;
  width: 100%;
}
.s-m-page.tablet .s-m-multisel-diag {
  font-size: smaller;
}
.s-m-control.s-m-array.s-m-table > .s-m-value table > tbody > tr.s-m-multisel-diag > td {
  padding: 0px;
}
tr.s-m-multisel-diag > td > .alert {
  padding: 5px;
  overflow: hidden;
  margin: 0px;
  text-overflow: ellipsis;
...
tr.s-m-multisel-diag > td > div.alert,
section.s-m-multisel-diag > div.alert {
  padding: 5px;
  overflow: hidden;
  margin: 0px;
  text-overflow: ellipsis;
...
/** ARRAY STATUS - BEGIN **/
.s-m-control.s-m-row-status {
  text-align: center;
  font-size: 1.2em;
}
section.s-m-card > div.s-m-status {
  top: 0;
  right: 0;
  font-size: 1.3em;
  position: absolute;
...
section.s-m-card > div.s-m-status > div.s-m-status-icon {
  padding: 2px 2px 2px 2px;
  float: right;
  display: inline-block;
}
section.s-m-card > div.s-m-status-color {
  padding: 5px;
}
thead > tr > th.s-m-row-status {
  width: 30px;
}
section.auth-checkboxList > .s-m-list > .s-m-item.btn-group {
  display: block;
  float: none;
}
section.auth-checkboxList > .s-m-list > .s-m-item > label {
  font-weight: normal;
}
section.auth-editableList .list-group-item {
  background-color: inherit;
}
section.auth-editableList > ul > li {
  padding: 5px;
  display: table;
  width: 100%;
  table-layout: fixed;
}
section.auth-editableList > ul > li > span {
  display: table-row;
  width: 100%;
}
section.auth-editableList > ul > li > span > span {
  display: table-cell;
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
...
section.auth-editableList > ul > li > span > span[data-action] {
  font-size: 1.5em;
  width: 30px;
  text-align: center;
}
section.auth-editableList .authMsg.s-m-error {
  border: 2px solid transparent;
  color: #cb3500;
  background-color: #ffffff;
  font-weight: bold;
...
section.auth-colorPalettePicker .auth-paletteItem,
section.auth-iconPalettePicker .auth-paletteItem {
  margin: 0px;
  padding: 0px;
  width: 25px;
  height: 25px;
...
section.auth-colorPalettePicker > .input-group > span.form-control {
  text-align: center;
}
section.auth-iconPalettePicker > .input-group > span.form-control {
  text-align: center;
}
section.auth-iconPalettePicker > .input-group > span.form-control > div.iconIcon {
  font-size: 1.8em;
}
section.auth-iconPalettePicker > .input-group > span.form-control > div.iconName {
  display: inline;
  padding-left: 10px;
  top: -3px;
  position: relative;
}
.auth-paletteItem.s-m-color-white {
  border: #dddddd 1px solid;
}
section.auth-colorPalettePicker .auth-paletteItem.current {
  border: 2px black solid;
}
section.auth-colorPalettePicker .authPaletteSection {
  color: #000000;
  margin-bottom: 5px;
}
section.auth-iconPalettePicker .auth-paletteItem.current {
  color: #cb3500;
}
section.auth-iconPalettePicker > div.dropdown-menu {
  color: #000000;
  width: 100%;
  padding-left: 10px;
  padding-right: 10px;
}
section.auth-colorPalettePicker input.form-control[readonly],
section.auth-iconPalettePicker input.form-control[readonly] {
  background-color: inherit;
}
/** ARRAY STATUS - END **/
/**  search in grid - Begin **/
table > thead > tr > th.s-m-search {
  font-style: normal;
  font-weight: normal;
  background-color: #41a940;
}
/* Same border because it's a customized addon */
...
/**  search in grid - End **/
/* Authoring. Gauge. Segments - Begin */
.s-m-g-seg-value section {
  text-align: center;
}
.s-m-auth-g-segments .nav.nav-pills {
  display: table;
  width: 100%;
}
.s-m-auth-g-segments .nav.nav-pills li.active {
  border-color: #41a940 #dddddd transparent;
  border-style: solid;
  border-width: 4px 1px 0;
}
.s-m-auth-g-segments .nav.nav-pills li {
  border-color: transparent transparent #dddddd;
  border-style: solid;
  border-width: 0 0 1px;
  display: table-cell;
...
.s-m-auth-minsize > span {
  height: 100%;
  vertical-align: middle;
  display: table-cell;
}
/* Authoring. Gauge. Segments - End */
.fa.s-m-icon-small {
  font-size: inherit;
}
.fa.s-m-icon-medium {
...
.s-m-panel-diag-error {
  border-color: #cb3500;
}
.s-m-panel-diag-error > .panel-heading {
  color: #ffffff;
  background-color: #cb3500;
  border-color: #cb3500;
}
.s-m-panel-diag-error > .panel-heading + .panel-collapse > .panel-body {
  border-top-color: #cb3500;
}
.s-m-panel-diag-error > .panel-heading .badge {
  color: #cb3500;
  background-color: #ffffff;
}
.s-m-panel-diag-error > .panel-footer + .panel-collapse > .panel-body {
  border-bottom-color: #cb3500;
}
.s-m-center {
  text-align: center;
}
.s-m-control.s-m-row-index {
  padding: 0px;
}
.s-m-control.s-m-row-index > .badge {
  width: 22px;
  height: 22px;
  border-radius: 11px;
  font-size: 10px;
...
/*chartdetail*/
.s-m-page.s-m-full.chartdetail .s-m-layout.s-m-stack > .s-m-row > .s-m-cell {
  padding: 0px;
}
.s-m-page.s-m-full.chartdetail .s-m-tile:not(.s-m-bg),
.s-m-page.s-m-full.chartdetail .s-m-row > .s-m-cell:not(.s-m-bg) {
  color: inherit;
  background-color: inherit;
}
.s-m-page.s-m-full > .s-m-topToolbar .btn.s-m-selected {
  background-color: rgba(0, 50, 97, 0.87);
  border-color: rgba(0, 0, 0, 0.4);
  color: #ffffff;
}
/* Force hidden in chart detail to preserve show/hide chart/arrta/both in authoring	*/
.s-m-page.s-m-full.chartdetail .s-m-control.s-m-auth.s-m-hidden {
  display: none;
}
/*phone*/
.s-m-phone > span:not(:empty) {
  border: 1px solid rgba(0, 0, 0, 0.2);
...
.s-m-bg .s-m-phone > span:not(:empty) {
  border: 1px solid rgba(250, 250, 250, 0.2);
  background-color: rgba(250, 250, 250, 0.2);
}
.s-m-phone > span:not(:empty) > span:before {
  padding-right: 8px;
}
/*email*/
.s-m-email > span:not(:empty) {
  border: 1px solid rgba(0, 0, 0, 0.2);
  background-color: rgba(0, 0, 0, 0.2);
  display: inline-block;
...
.s-m-bg .s-m-email > span:not(:empty) {
  border: 1px solid rgba(250, 250, 250, 0.2);
  background-color: rgba(250, 250, 250, 0.2);
}
.s-m-email > span:not(:empty) > span:before {
  padding-right: 8px;
}
/* card optimization - customers */
.s-m-card .s-m-control {
  padding-bottom: 0px;
  padding-top: 0.3em;
}
.s-m-card .s-m-row {
...
/*Binary + Document*/
.s-m-document > .s-m-value > span:before {
  display: block;
}
.s-m-binary > .s-m-value > span:before {
  display: block;
}
/*  CAROUSEL */
.s-m-carousel footer {
...
.s-m-carousel-indicators span.active {
  margin: 0;
  width: 12px;
  height: 12px;
  background-color: #ffffff;
}
.s-m-carousel-indicators {
  top: 3px;
  position: absolute;
  bottom: 10px;
  left: 50%;
...
.s-m-login-back.fa:before {
  font-size: 32px;
}
/* Highlight dom elmt when a link/action is clicked */
.s-m-highlighted {
  opacity: 0.5;
}
/* Highlight dom elmt when a link/action is armed (mouse is down but not released yet) */
.s-m-armed {
  opacity: 0.5;
}
/* Buttons used in authoring header and footer */
/*
 *
 * CSS Classes for icons used by authoring
 *
 */
li.s-m-auth-tree > p:before {
  color: inherit;
  float: left;
  font-family: "FontAwesome";
  font-size: 14px;
...
li.s-m-auth-tree.s-m-auth-tree-string > p:before {
  /* fa-font */
  content: "\f031";
}
li.s-m-auth-tree.s-m-auth-tree-integer > p:before {
  /* fa-font */
  content: "\f031";
}
li.s-m-auth-tree.s-m-auth-tree-decimal > p:before {
  /* fa-font */
  content: "\f031";
}
li.s-m-auth-tree.s-m-auth-tree-date > p:before {
  /* fa-font */
  content: "\f031";
}
li.s-m-auth-tree.s-m-auth-tree-image > p:before {
  /* fa-photo */
  content: "\f03e";
}
li.s-m-auth-tree.s-m-auth-tree-boolean > p:before {
  /* fa-check:before */
  content: "\f00c";
}
li.s-m-auth-tree.s-m-auth-tree-choice > p:before {
  /* fa-navicon */
  content: "\f0c9";
}
li.s-m-auth-tree.s-m-auth-tree-document > p:before {
  /* fa-file */
  content: "\f15b";
}
li.s-m-auth-tree.s-m-auth-tree-plain > p:before {
  /* fa-file-text */
  content: "\f15c";
}
li.s-m-auth-tree.s-m-auth-tree-html > p:before {
  /* fa-font */
  content: "\f031";
}
li.s-m-auth-tree.s-m-auth-tree-rtf > p:before {
  /* fa-font */
  content: "\f031";
}
li.s-m-auth-tree.s-m-auth-tree-quantity > p:before {
  /* fa-font */
  content: "\f031";
}
li.s-m-auth-tree.s-m-auth-tree-reference > p:before {
  /* fa-font */
  content: "\f031";
}
li.s-m-auth-tree.s-m-auth-tree-array > p:before {
  /* .fa-list */
  content: "\f03a";
}
/*
 ...
 *
 */
li.s-m-auth-tree.s-m-auth-tree-page > p {
  color: #00b311;
}
li.s-m-auth-tree.s-m-auth-tree-page > p:before {
  /* -fa-file-o */
  content: "\f016";
  color: #00b311;
}
li.s-m-auth-tree.s-m-auth-tree-hub > p {
  color: #00b311;
}
li.s-m-auth-tree.s-m-auth-tree-hub > p:before {
  /* fa-th */
  content: "\f00a";
  color: #00b311;
}
li.s-m-auth-tree.s-m-auth-tree-hubGroup > p {
  color: #00b311;
}
li.s-m-auth-tree.s-m-auth-tree-hubGroup > p:before {
  /* fa-th */
  content: "\f00a";
  color: #00b311;
}
li.s-m-auth-tree.s-m-auth-tree-tile > p {
  color: #06a7e5;
}
li.s-m-auth-tree.s-m-auth-tree-tile > p:before {
  /* .fa-square-o */
  content: "\f096";
  color: #06a7e5;
}
li.s-m-auth-tree.s-m-auth-tree-cell > p {
  color: #06a7e5;
}
li.s-m-auth-tree.s-m-auth-tree-cell > p:before {
  /* .fa-square-o */
  content: "\f096";
  color: #06a7e5;
}
li.s-m-auth-tree.s-m-auth-tree-vignette > p {
  color: #00b311;
}
li.s-m-auth-tree.s-m-auth-tree-vignette > p:before {
  /* .fa-external-link */
  content: "\f08e";
  color: #00b311;
}
li.s-m-auth-tree.s-m-auth-tree-stack > p {
  color: #06a7e5;
}
li.s-m-auth-tree.s-m-auth-tree-stack > p:before {
  /* fa-bars */
  content: "\f0c9";
  color: #06a7e5;
}
li.s-m-auth-tree.s-m-auth-tree-row > p {
  color: #00b311;
}
li.s-m-auth-tree.s-m-auth-tree-row > p:before {
  /* fa-ellipsis-h */
  content: "\f141";
  color: #00b311;
}
...
.s-m-auth-col-simulate-xs .col-xs-offset-12 {
  margin-left: 100%;
}
.s-m-auth-col-simulate-xs .col-xs-11 {
  width: 91.66666667%;
}
.s-m-auth-col-simulate-xs .col-xs-offset-11 {
  margin-left: 91.66666667%;
}
.s-m-auth-col-simulate-xs .col-xs-10 {
  width: 83.33333333%;
}
.s-m-auth-col-simulate-xs .col-xs-offset-10 {
  margin-left: 83.33333333%;
}
.s-m-auth-col-simulate-xs .col-xs-9 {
  width: 75%;
}
.s-m-auth-col-simulate-xs .col-xs-offset-9 {
  margin-left: 75%;
}
.s-m-auth-col-simulate-xs .col-xs-8 {
  width: 66.66666667%;
}
.s-m-auth-col-simulate-xs .col-xs-offset-8 {
  margin-left: 66.66666667%;
}
.s-m-auth-col-simulate-xs .col-xs-7 {
  width: 58.33333333%;
}
.s-m-auth-col-simulate-xs .col-xs-offset-7 {
  margin-left: 58.33333333%;
}
.s-m-auth-col-simulate-xs .col-xs-6 {
  width: 50%;
}
.s-m-auth-col-simulate-xs .col-xs-offset-6 {
  margin-left: 50%;
}
.s-m-auth-col-simulate-xs .col-xs-5 {
  width: 41.66666667%;
}
.s-m-auth-col-simulate-xs .col-xs-offset-5 {
  margin-left: 41.66666667%;
}
.s-m-auth-col-simulate-xs .col-xs-4 {
  width: 33.33333333%;
}
.s-m-auth-col-simulate-xs .col-xs-offset-4 {
  margin-left: 33.33333333%;
}
.s-m-auth-col-simulate-xs .col-xs-3 {
  width: 25%;
}
.s-m-auth-col-simulate-xs .col-xs-offset-3 {
  margin-left: 25%;
}
.s-m-auth-col-simulate-xs .col-xs-2 {
  width: 16.66666667%;
}
.s-m-auth-col-simulate-xs .col-xs-offset-2 {
  margin-left: 16.66666667%;
}
.s-m-auth-col-simulate-xs .col-xs-1 {
  width: 8.33333333%;
}
.s-m-auth-col-simulate-xs .col-xs-offset-1 {
  margin-left: 8.33333333%;
}
.s-m-auth-col-simulate-sm .col-sm-12 {
  width: 100%;
}
.s-m-auth-col-simulate-sm .col-sm-offset-12 {
  margin-left: 100%;
}
.s-m-auth-col-simulate-sm .col-sm-11 {
  width: 91.66666667%;
}
.s-m-auth-col-simulate-sm .col-sm-offset-11 {
  margin-left: 91.66666667%;
}
.s-m-auth-col-simulate-sm .col-sm-10 {
  width: 83.33333333%;
}
.s-m-auth-col-simulate-sm .col-sm-offset-10 {
  margin-left: 83.33333333%;
}
.s-m-auth-col-simulate-sm .col-sm-9 {
  width: 75%;
}
.s-m-auth-col-simulate-sm .col-sm-offset-9 {
  margin-left: 75%;
}
.s-m-auth-col-simulate-sm .col-sm-8 {
  width: 66.66666667%;
}
.s-m-auth-col-simulate-sm .col-sm-offset-8 {
  margin-left: 66.66666667%;
}
.s-m-auth-col-simulate-sm .col-sm-7 {
  width: 58.33333333%;
}
.s-m-auth-col-simulate-sm .col-sm-offset-7 {
  margin-left: 58.33333333%;
}
.s-m-auth-col-simulate-sm .col-sm-6 {
  width: 50%;
}
.s-m-auth-col-simulate-sm .col-sm-offset-6 {
  margin-left: 50%;
}
.s-m-auth-col-simulate-sm .col-sm-5 {
  width: 41.66666667%;
}
.s-m-auth-col-simulate-sm .col-sm-offset-5 {
  margin-left: 41.66666667%;
}
.s-m-auth-col-simulate-sm .col-sm-4 {
  width: 33.33333333%;
}
.s-m-auth-col-simulate-sm .col-sm-offset-4 {
  margin-left: 33.33333333%;
}
.s-m-auth-col-simulate-sm .col-sm-3 {
  width: 25%;
}
.s-m-auth-col-simulate-sm .col-sm-offset-3 {
  margin-left: 25%;
}
.s-m-auth-col-simulate-sm .col-sm-2 {
  width: 16.66666667%;
}
.s-m-auth-col-simulate-sm .col-sm-offset-2 {
  margin-left: 16.66666667%;
}
.s-m-auth-col-simulate-sm .col-sm-1 {
  width: 8.33333333%;
}
.s-m-auth-col-simulate-sm .col-sm-offset-1 {
  margin-left: 8.33333333%;
}
.s-m-auth-col-simulate-md .col-md-12 {
  width: 100%;
}
.s-m-auth-col-simulate-md .col-md-offset-12 {
  margin-left: 100%;
}
.s-m-auth-col-simulate-md .col-md-11 {
  width: 91.66666667%;
}
.s-m-auth-col-simulate-md .col-md-offset-11 {
  margin-left: 91.66666667%;
}
.s-m-auth-col-simulate-md .col-md-10 {
  width: 83.33333333%;
}
.s-m-auth-col-simulate-md .col-md-offset-10 {
  margin-left: 83.33333333%;
}
.s-m-auth-col-simulate-md .col-md-9 {
  width: 75%;
}
.s-m-auth-col-simulate-md .col-md-offset-9 {
  margin-left: 75%;
}
.s-m-auth-col-simulate-md .col-md-8 {
  width: 66.66666667%;
}
.s-m-auth-col-simulate-md .col-md-offset-8 {
  margin-left: 66.66666667%;
}
.s-m-auth-col-simulate-md .col-md-7 {
  width: 58.33333333%;
}
.s-m-auth-col-simulate-md .col-md-offset-7 {
  margin-left: 58.33333333%;
}
.s-m-auth-col-simulate-md .col-md-6 {
  width: 50%;
}
.s-m-auth-col-simulate-md .col-md-offset-6 {
  margin-left: 50%;
}
.s-m-auth-col-simulate-md .col-md-5 {
  width: 41.66666667%;
}
.s-m-auth-col-simulate-md .col-md-offset-5 {
  margin-left: 41.66666667%;
}
.s-m-auth-col-simulate-md .col-md-4 {
  width: 33.33333333%;
}
.s-m-auth-col-simulate-md .col-md-offset-4 {
  margin-left: 33.33333333%;
}
.s-m-auth-col-simulate-md .col-md-3 {
  width: 25%;
}
.s-m-auth-col-simulate-md .col-md-offset-3 {
  margin-left: 25%;
}
.s-m-auth-col-simulate-md .col-md-2 {
  width: 16.66666667%;
}
.s-m-auth-col-simulate-md .col-md-offset-2 {
  margin-left: 16.66666667%;
}
.s-m-auth-col-simulate-md .col-md-1 {
  width: 8.33333333%;
}
.s-m-auth-col-simulate-md .col-md-offset-1 {
  margin-left: 8.33333333%;
}
.s-m-auth-col-simulate-lg .col-lg-12 {
  width: 100%;
}
.s-m-auth-col-simulate-lg .col-lg-offset-12 {
  margin-left: 100%;
}
.s-m-auth-col-simulate-lg .col-lg-11 {
  width: 91.66666667%;
}
.s-m-auth-col-simulate-lg .col-lg-offset-11 {
  margin-left: 91.66666667%;
}
.s-m-auth-col-simulate-lg .col-lg-10 {
  width: 83.33333333%;
}
.s-m-auth-col-simulate-lg .col-lg-offset-10 {
  margin-left: 83.33333333%;
}
.s-m-auth-col-simulate-lg .col-lg-9 {
  width: 75%;
}
.s-m-auth-col-simulate-lg .col-lg-offset-9 {
  margin-left: 75%;
}
.s-m-auth-col-simulate-lg .col-lg-8 {
  width: 66.66666667%;
}
.s-m-auth-col-simulate-lg .col-lg-offset-8 {
  margin-left: 66.66666667%;
}
.s-m-auth-col-simulate-lg .col-lg-7 {
  width: 58.33333333%;
}
.s-m-auth-col-simulate-lg .col-lg-offset-7 {
  margin-left: 58.33333333%;
}
.s-m-auth-col-simulate-lg .col-lg-6 {
  width: 50%;
}
.s-m-auth-col-simulate-lg .col-lg-offset-6 {
  margin-left: 50%;
}
.s-m-auth-col-simulate-lg .col-lg-5 {
  width: 41.66666667%;
}
.s-m-auth-col-simulate-lg .col-lg-offset-5 {
  margin-left: 41.66666667%;
}
.s-m-auth-col-simulate-lg .col-lg-4 {
  width: 33.33333333%;
}
.s-m-auth-col-simulate-lg .col-lg-offset-4 {
  margin-left: 33.33333333%;
}
.s-m-auth-col-simulate-lg .col-lg-3 {
  width: 25%;
}
.s-m-auth-col-simulate-lg .col-lg-offset-3 {
  margin-left: 25%;
}
.s-m-auth-col-simulate-lg .col-lg-2 {
  width: 16.66666667%;
}
.s-m-auth-col-simulate-lg .col-lg-offset-2 {
  margin-left: 16.66666667%;
}
.s-m-auth-col-simulate-lg .col-lg-1 {
  width: 8.33333333%;
}
.s-m-auth-col-simulate-lg .col-lg-offset-1 {
  margin-left: 8.33333333%;
}
/*
 	Classes for select and hover effects in page
*/
/*
	Controls
*/
.s-m-control.s-m-auth {
  border: 1px dashed #9346c2;
  margin: 5px;
}
.s-m-control.s-m-auth.s-m-vignette {
  margin: 0px;
}
.s-m-control.s-m-auth.s-m-auth-hover {
  border: 1px solid #00aba9;
}
.s-m-control.s-m-auth.s-m-auth-selected {
  background-image: url('../../img/auth/s-field-selected.png');
...
*/
.s-m-layout.s-m-auth {
  border: 1px dashed #06a7e5;
  padding: 10px;
}
.s-m-layout.s-m-auth.s-m-auth-hover {
...
.s-m-page.s-m-auth.s-m-auth-hover {
  border: 1px solid #f09609;
}
.s-m-page.s-m-auth.s-m-auth-selected {
  border: 1px solid #f09609;
}
.s-m-layout.s-m-auth.s-m-row.s-m-auth-selected,
.s-m-layout.s-m-auth.s-m-stack.s-m-auth-selected,
.s-m-layout.s-m-auth.s-m-hub-group.s-m-auth-selected {
  background-image: url('../../img/auth/s-field-selected.png');
  background-repeat: repeat;
  border: 1px solid #f09609;
}
.s-m-layout.s-m-auth.s-m-cell.s-m-auth-selected,
.s-m-layout.s-m-auth.s-m-tile.s-m-auth-selected {
  border: 1px solid #ff8235;
}
/*
empty layout nodes are expanded a bit to allow to add content
*/
.s-m-layout.s-m-auth:empty {
  height: 100px;
}
/* 
Make sure empty elements are big enought during authoring 
*/
.s-m-layout.s-m-auth.s-m-stack > content:empty {
  height: 100px;
  display: block;
}
.s-m-layout.s-m-row.s-m-auth:empty {
  height: 100px;
}
.s-m-layout.s-m-cell.s-m-auth > .cell:empty {
  height: 100px;
}
/* 
If authoring is active, we move the header of the hub group a bit upwards so it's not hidden
*/
.s-m-hub-group.s-m-auth > header {
  margin-top: -10px;
}
/*
	Drop helper
*/
.s-m-auth-drag-helper {
...
.s-m-auth-drag-helper:before {
  font-family: "FontAwesome";
  padding-right: 0.5em;
  float: left;
}
.s-m-auth-drag-helper.drop_disabled:before {
  content: "\f05e";
}
.s-m-auth-drag-helper.drop_move:before {
  content: "\f047";
}
.s-m-auth-drag-helper.drop_add:before {
  content: "\f067";
}
.s-m-auth-drag-helper > p {
  padding-left: 30px;
  display: block;
}
#s-m-auth-drag-helper-label-id {
  font-weight: bold;
  padding-bottom: 0px;
}
#s-m-auth-drag-helper-desc-id {
  font-size: 0.75em;
  font-style: italic;
}
/*
...
*/
/* tree in left panel */
li.s-m-auth-tree.s-m-auth-hover-droptarget > p {
  border: 1px solid red !important;
}
/* in page */
.s-m-auth.s-m-auth-hover-droptarget.s-m-top-stack {
  border: 1px solid red !important;
}
/*
	Styles used by authoring header toolbar
*/
#s-m-auth-panel-header-id {
  display: block;
  position: absolute;
  z-index: 2000;
  padding: 0px;
...
s-m-auth-panel-header-id label {
  line-height: 1;
}
#s-m-auth-settings-id > label {
  padding-right: 4px;
}
.btn-auth-header {
  color: #ffffff;
...
.btn-auth-header.active,
.open > .dropdown-toggle.btn-auth-header {
  color: #ffffff;
  background-color: #000000;
  border-color: #000000;
}
.btn-auth-header:active:hover,
.btn-auth-header.active:hover,
.open > .dropdown-toggle.btn-auth-header:hover,
.btn-auth-header:active:focus,
.btn-auth-header.active:focus,
.open > .dropdown-toggle.btn-auth-header:focus,
.btn-auth-header:active.focus,
.btn-auth-header.active.focus,
.open > .dropdown-toggle.btn-auth-header.focus {
  color: #ffffff;
...
.btn-auth-header.disabled:hover,
.btn-auth-header[disabled]:hover,
fieldset[disabled] .btn-auth-header:hover,
.btn-auth-header.disabled:focus,
.btn-auth-header[disabled]:focus,
fieldset[disabled] .btn-auth-header:focus,
.btn-auth-header.disabled.focus,
.btn-auth-header[disabled].focus,
fieldset[disabled] .btn-auth-header.focus {
  background-color: #000000;
...
.btn-auth-header .badge {
  color: #000000;
  background-color: #ffffff;
}
#s-m-auth-panel-header-id > .btn-group:nth-child(2) {
  padding-left: 5em;
}
/* Buttons used in authoring header*/
.btn.btn-auth-header.active {
  background-color: #009fda;
  border: 1px solid transparent;
  box-shadow: none;
}
.btn.btn-auth-header.active:hover,
.btn.btn-auth-header.active:focus {
  background-color: #009fda;
  border: 1px dotted white;
  box-shadow: none;
  color: white;
}
.btn.btn-auth-header:hover,
.btn.btn-auth-header:focus {
  color: #009fda;
  border: 1px solid transparent;
}
#s-m-auth-header-actions-id label {
  padding-right: 0.5em;
}
.btn.btn-auth-header.disabled {
  visibility: hidden;
}
#auth-btn-undo-id > label:before {
  padding-right: 0.5em;
}
#auth-btn-undo-all-id > label:before {
  padding-right: 0.5em;
}
#s-m-auth-panel-footer-id {
...
#s-m-auth-panel-left-id input[type="radio"] {
  left: -999em;
  position: absolute;
}
/*
...
li.s-m-auth-tree > p.s-m-auth-selected,
li.s-m-auth-tree > p.s-m-auth-hover.s-m-auth-selected,
li.s-m-auth-tree > p.s-m-auth-selected:before,
li.s-m-auth-tree > p.s-m-auth-hover.s-m-auth-selected:before {
  background-color: #ff8235;
  color: #fff;
}
li.s-m-auth-tree > p.s-m-auth-hover {
  border: 1px dotted #ff8235;
  padding: 0px;
}
#s-m-auth-tree-box {
  position: relative;
...
div#auth-lp-cnt-containers-clpse {
  background-color: white;
}
.s-m-auth-btn-container {
  width: 40px;
  height: 40px;
  position: relative;
  display: inline-block;
...
/* 
	Content add panel, prototype fields
*/
#auth-lp-cnt-props-clpse {
  background-color: white;
}
#s-m-auth-panel-left-id .panel.panel-primary.s-m-panel-auth-prop > .panel-heading {
  background: none repeat scroll 0 0 #009fda;
}
#s-m-auth-panel-left-id .panel.panel-primary.s-m-panel-auth-prop {
  margin-bottom: 1px;
}
li.s-m-auth-tree.s-m-auth-tree-nothing {
  padding-left: 20px;
  font-style: italic;
}
li.s-m-auth-tree.s-m-auth-tree-vignette.disabled > p {
  font-style: italic;
  color: grey;
}
li.s-m-auth-tree.s-m-auth-tree-vignette.disabled > p:before {
  color: grey;
}
#s-m-auth-panel-right-id {
  display: block;
  position: absolute;
  z-index: 2000;
  padding: 0px;
...
#s-m-auth-panel-right-id input[type="radio"] {
  left: -999em;
  position: absolute;
}
#s-m-auth-panel-right-id .tab-pane {
  height: 100%
	padding: 0px;
}
/*
	Panel listing properties for selection
*/
.s-m-auth-prop-list {
  padding-left: 10px;
}
.s-m-auth-prop-list > label {
  display: inline;
  font-size: 12px;
  font-weight: normal;
  width: 30%;
}
.s-m-auth-prop-list > p {
  width: 70%;
  display: inline;
}
.s-m-auth-prop-list > p:after {
  content: "\a";
  white-space: pre;
}
/*
	Collapsible panel and icon for collapsible
*/
#s-m-auth-panel-right-id .panel-group .panel + .panel {
  margin-top: 0px;
}
.s-m-panel-auth-prop > .panel-heading {
  padding: 5px;
}
.s-m-panel-auth-prop > .panel-collapse {
  background: none repeat scroll 0 0 #4d4f53;
  padding: 5px 0;
}
.s-m-panel-auth-prop.panel-primary {
  border: 0px;
}
.s-m-panel-auth-prop.panel-primary > .panel-heading {
  border: 0px;
  border-bottom: 1px solid #4d4f53;
}
.s-m-panel-auth-prop.panel-primary > .panel-heading > a {
  text-decoration: none;
  color: white;
}
.s-m-panel-auth-prop.panel-primary > .panel-heading > a:active > h4,
.s-m-panel-auth-prop.panel-primary > .panel-heading > a:hover > h4 {
  font-weight: lighter;
}
/* Group seperator in property accordion */
.auth-group-seperator {
  height: 20px;
}
.panel.panel-primary.s-m-panel-auth-prop.s-m-auth-prop-type-default > .panel-heading {
  background: none repeat scroll 0 0 #009fda;
}
.panel.panel-primary.s-m-panel-auth-prop.s-m-auth-prop-type-expert > .panel-heading {
  background: none repeat scroll 0 0 #41a940;
}
.panel.panel-primary.s-m-panel-auth-prop.s-m-auth-prop-type-child {
  background-color: transparent;
}
.panel.panel-primary.s-m-panel-auth-prop.s-m-auth-prop-type-child > .panel-heading {
  margin-left: 10px;
  background: none repeat scroll 0 0 #008cc1;
}
.panel.panel-primary.s-m-panel-auth-prop.s-m-auth-prop-type-child > .panel-collapse {
  padding-left: 10px;
  padding-right: 10px;
}
.panel.panel-primary.s-m-panel-auth-prop.s-m-auth-prop-type-child-child {
  background-color: transparent;
}
.panel.panel-primary.s-m-panel-auth-prop.s-m-auth-prop-type-child-child > .panel-heading {
  margin-left: 20px;
  background: none repeat scroll 0 0 #007aa7;
}
.panel.panel-primary.s-m-panel-auth-prop.s-m-auth-prop-type-child-child > .panel-collapse {
  padding-left: 20px;
  padding-right: 20px;
}
.panel-group .s-m-auth-g-apply-slot {
  padding-left: 20px;
  padding-right: 5px;
}
.panel-group .s-m-auth-g-apply-slot button {
  white-space: normal;
}
#s-m-auth-panel-right-id textarea {
  background: none repeat scroll 0 0 #4d4f53;
  color: white;
  margin-bottom: 5px;
}
/*
	Radio buttons with check icon
*/
label.s-m-auth-btn-radio-icon {
  white-space: nowrap;
  padding-left: 30px;
  padding-right: 30px;
}
label.s-m-auth-btn-radio:hover {
  text-decoration: underline;
}
.s-m-auth-btn-radio-icon:after {
  font-family: 'Glyphicons Halflings';
  content: "";
  font-size: 15px;
  line-height: 22px;
...
.s-m-auth-btn-radio-icon.active:after {
  content: "\e013";
  margin-left: -20px;
}
/*
...
.auth-btn-color.active {
  border: 1px dotted white;
}
/*
	CELL SIZE SELECTION PROPERY
*/
.auth-size-device-header {
  width: 100%;
  padding: 5px 10px;
}
.auth-btn-size-sel {
...
.s-m-site-auth-panel-content > header {
  background-color: #333;
  height: 40px;
  width: 100%;
  padding: 10px 15px;
...
#authPanelControlTitle {
  padding-left: 10px;
}
/*
Make color black for select html component
*/
.panel.panel-primary.s-m-panel-auth-prop select {
  color: #333333;
}
#auth_opt_card_design,
#auth_opt_chart_design {
  width: 100%;
}
/*
ICON SELECTION
...
.s-m-site-auth-panel-content > .nav-pills > li.active > a,
.nav-pills > li.active > a:hover,
.s-m-site-auth-panel-content > .nav-pills > li.active > a:focus {
  text-decoration: none;
  color: #ffffff;
  background-color: #4d4f53;
}
.s-m-site-auth-panel-content > .nav > li > a:hover,
.s-m-site-auth-panel-content > .nav > li > a:focus {
  background-color: #333;
  color: #ffffff;
}
.s-m-site-auth-panel-content > .nav-pills > li.active > a,
...
/*
	Splitters
*/
#s-m-auth-splitter-right-id,
#s-m-auth-splitter-left-id {
  position: absolute;
  background-color: black;
  padding: 0px;
  z-index: 1010;
...
.s-m-device-wrapper {
  background: #0a0809;
  /* Old browsers */
  background: -moz-linear-gradient(45deg, #0a0809 0%, #0a0e0a 66%, #505256 67%, #505256 96%);
  /* FF3.6+ */
  background: -webkit-gradient(linear, left bottom, right top, color-stop(0%, #0a0809), color-stop(66%, #0a0e0a), color-stop(67%, #505256), color-stop(96%, #505256));
  /* Chrome,Safari4+ */
  background: -webkit-linear-gradient(45deg, #0a0809 0%, #0a0e0a 66%, #505256 67%, #505256 96%);
  /* Chrome10+,Safari5.1+ */
  background: -o-linear-gradient(45deg, #0a0809 0%, #0a0e0a 66%, #505256 67%, #505256 96%);
  /* Opera 11.10+ */
  background: -ms-linear-gradient(45deg, #0a0809 0%, #0a0e0a 66%, #505256 67%, #505256 96%);
  /* IE10+ */
  background: linear-gradient(45deg, #0a0809 0%, #0a0e0a 66%, #505256 67%, #505256 96%);
  /* W3C */
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#0a0809', endColorstr='#505256', GradientType=1);
  /* IE6-9 fallback on horizontal gradient */
  border: 1px solid #555;
  border-radius: 10px;
  box-shadow: 0 10px 20px #000000, 0 0 3px 0 rgba(0, 0, 0, 0.3) inset, 0 0 6px 3px rgba(0, 0, 0, 0.2) inset;
  position: absolute;
}
/* Application container*/
#s-m-app-container-id {
  background-color: transparent;
  position: absolute;
  /* for scrolling - set to auto by authoring*/
  overflow: hidden;
}
#s-m-app-container-id.s-m-preview {
  background-color: #4d4f53;
  /* auto if device size is greater than screen size*/
  overflow: auto;
}
/* Application in preview mode*/
#s-m-app-container-id.s-m-preview #s-m-app-id {
  background-color: white;
}
.auth-btn-color.active {
  border: 1px solid white;
...
/* #8143 - center the dialog on IOS */
.modal.multibuttons .modal-dialog {
  width: auto;
}
.modal-dialog {
  margin: 2px;
