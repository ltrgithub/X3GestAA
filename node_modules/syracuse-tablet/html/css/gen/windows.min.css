.modal-body{overflow-y:auto}.s-m-bg-purple{background-color:#ff0097}.s-m-bg-magenta{background-color:#a200ff}.s-m-bg-teal{background-color:#00aba9}.s-m-bg-lime{background-color:#8cbf26}.s-m-bg-brown{background-color:#a05000}.s-m-bg-pink{background-color:#e671b8}.s-m-bg-orange{background-color:#f09609}.s-m-bg-blue{background-color:#1ba1e2}.s-m-bg-red{background-color:#e51400}.s-m-bg-green{background-color:#393}.s-m-auth-btn-block{text-align:left;font-weight:normal;padding:5px;width:100%}.s-m-auth-btn-radio-color{float:right;width:20px;height:15px;border:1px solid black}label.s-m-auth-btn-radio-icon{padding-left:30px}.s-m-auth-btn-radio-icon:after{font-family:'Glyphicons Halflings';content:"";float:left;font-size:15px;line-height:22px}.s-m-auth-btn-radio-icon.active:after{content:"\e013";margin-left:-20px}.panel-heading [data-toggle="collapse"]:after{font-family:'Glyphicons Halflings';content:"\e072";float:left;color:black;font-size:15px;line-height:22px;-webkit-transform:rotate(-90deg);-moz-transform:rotate(-90deg);-ms-transform:rotate(-90deg);-o-transform:rotate(-90deg);transform:rotate(-90deg)}.panel-heading [data-toggle="collapse"].collapsed:after{-webkit-transform:rotate(90deg);-moz-transform:rotate(90deg);-ms-transform:rotate(90deg);-o-transform:rotate(90deg);transform:rotate(90deg)}/*!
