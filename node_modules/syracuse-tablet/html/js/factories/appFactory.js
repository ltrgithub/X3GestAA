...
var DefHomePage = require('syracuse-tablet/html/js/pages/pageDefHome').Page;
var VignetteError = require('syracuse-tablet/html/js/pages/pageVignetteError').Page;
var LoginPage = require('syracuse-tablet/html/js/pages/pageLogin').Page;
var SettingsPage = require('syracuse-tablet/html/js/pages/pageSettings').Page;
...
var _createPage = function($parent, state) {
	var res = null,
		type = state.type;
	if (type == "static" && state.name == "login") {
		res = new LoginPage($parent, state);
	} else if (type == "static" && state.name == "settings") {
		res = new SettingsPage($parent, state);
	} else if (type == "static" && state.name == "about") {
		res = new AboutPage($parent, state);
	} else if (type == "static" && state.name == "defhome") {
		res = new DefHomePage($parent, state);
	} else if (type == "static" && state.name == "vignetteerror") {
...
var _createVignetteCtrlr = function(ctrlrPage, info) {
	var ctrlr = new VignetteCtrlr(ctrlrPage, info);
