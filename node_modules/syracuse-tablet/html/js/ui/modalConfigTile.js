...
var _templateTablet = {
	...
	content: ' \
			<div class="form-group"> \
				...
				<div class="s-m-list-colors" style="width: {{colorsWidth}}px;">\
					{{#each colors}} \
				...
				<div class="s-m-scroll-wrapper">\
				<div class="s-m-list-sizes" style="width: {{sizesWidth}}px;">\
					{{#each sizes}} \
				...
				<div class="s-m-scroll-wrapper">\
				<div class="s-m-list-icons" style="width: {{iconsWidth}}px;">\
					{{#each icons}} \
	...
	function ApplicationSelectionDialog(tile) {
		...
		getDisplayFlags: function() {
			...
			if (self.deviceType === "tablet") {
				displayFlags.modalClass = "config-tile half_center";
			} else {
		...
		_getDataContext: function() {
			...
			data.colorsWidth = data.colors.length * 54;
			data.sizesWidth = data.sizes.length * 94;
			data.iconsWidth = ((data.icons.length + 3) / 4) * 54;
