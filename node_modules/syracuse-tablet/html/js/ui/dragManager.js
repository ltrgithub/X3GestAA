...
var _Klass = utils.defineClass(
	...
	function DragManager(dragOpts, dropOpt, $$parent) {
		...
		this.params;
		this.dragEnable = dragOpts.enable;
		notifications.subscribe(this, ["sm.drag.state.change"]);
	}, null, {
		notifDragStateChange: function(enable) {
			console.log("notifDragStateChange " + enable)
			...
			$(self.dragOpts.selector).draggable(
				$.extend(true, self.dragOpts.options, {
					...
					drag: function(event, ui) {
						if (!self.dragEnable) return false
					},
