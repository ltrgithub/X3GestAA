				...
				$.extend(true, self.dragOpts.options, {
					...
					drag: function(event, ui) {
						if (!self.dragEnable) {
							...
							event.stopPropagation(); // to avoid the page scrolling id case of none native scroll
						}
					},
					stop: function(event, ui) {
						self.dragEnable = self.dragOpts.enable;
						self._notif.publish("stop", $(this), ui);
					},
					// Used is the hack of jsquery.ui.touch-punch to disabled/enabled the capability 
					// to scroll the page or not when tile dragging is processing or not (just touch the tile to scroll the page)
					isOnDrag: function() {
