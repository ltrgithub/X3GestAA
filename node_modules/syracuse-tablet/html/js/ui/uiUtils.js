...
var _addFieldModal = function($$md, fieldId) {
	if (fieldId) {
		application.modalsMap = application.modalsMap || {};
		application.modalsMap[fieldId] = $$md;
	}
};
...
var _removeFieldModal = function(fieldId) {
	if (application.modalsMap) {
		delete application.modalsMap[fieldId];
	}
};
...
var _closeModal = function(id) {
	if (application.modalsMap) {
		application.modalsMap[id].modal('hide');
	}
};
