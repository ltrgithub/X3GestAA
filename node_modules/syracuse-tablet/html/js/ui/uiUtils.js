...
/**
Get template id according to widget type
**/
var _getFieldTmplId = function(widgetType) {
	var tmplId;
	switch (widgetType) {
...
var _createDomElement = function(tag, classList, content, attrList) {
	if (!tag) {
...
exports.getFieldTmplId = _getFieldTmplId;
