...
var _bindActions = function(object, selector, $elmt) {
	...
	$elmt.bind("click", function(evt) {
		...
		if ((target.nodeName.toLowerCase() === "a" && target.className.indexOf("sm-field-choice-combo-item") > -1) || (target.nodeName.toLowerCase() === "input" && target.getAttribute("type") == "radio")) {
			while (target) {
