...
exports.pageIcon = function(name) {
	...
	if (name === "pinPage_1") return "fa fa-star-o";
	if (name === "pinPage_2") return "fa fa-star";
...
var _emptyImageIconNames = ["image", "user", "users", "warning", "file-movie-o", "file-photo", "paperclip", "film"];
...
var _urlIconNames = ["globe", "map-marker", "street-view", "road", "bed", "cutlery", "glass", "train", "subway", "taxi", "ship", "plane"];
var _urlIcons = null;
