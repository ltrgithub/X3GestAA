...
exports.pageIcon = function(name) {
	if (name === "clearCache") return "fa fa-history fa-2x";
	if (name === "switchContext") return "fa fa-user fa-2x";
	if (name === "search") return "glyphicon glyphicon-search fa-2x";
	if (name === "sidePanel") return "glyphicon glyphicon-align-justify fa-2x";
	if (name === "home") return "fa fa-home fa-2x";
	if (name === "designPage") return "fa fa-paint-brush fa-2x";
	if (name === "back") return "fa fa-arrow-circle-o-left fa-2x";
};
