...
exports.pageIcon = function(name) {
	...
	if (name === "addGroup") return "fa fa-plus";
	if (name === "addHiddenTile") return "fa fa-cubes";
	if (name === "dashboardShare") return "fa fa-share-alt";
	if (name === "dashboardList") return "fa fa-bars"; // dashboard footer not edit mode for authorized user
	if (name === "templateList") return "fa fa-bars"; //config footer
	if (name === "dashboardSaveAs") return "fa fa-floppy-o";
};
