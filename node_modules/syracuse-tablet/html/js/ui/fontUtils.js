...
var _panelActionIconMap = {
	"home": "fa fa-home",
	"pin": "fa fa-star-o",
	"unpin": "fa fa-star",
	"openactionspanel": "fa fa-ellipsis-h",
	"switchContext": "fa fa-caret-down",
	"mail": "fa fa-envelope",
	...
	"search": "fa fa-search",
	"sortFilter": "fa fa-filter",

	"pageConfig": "fa fa-pencil",
	"addGroup": "fa fa-sitemap",
	"myDashboardTemplates": "fa fa-list-ul",
	"myAvailableTemplates": "fa fa-list-ul",
	"myDashboard": "fa fa-chevron-left",
	"showEditTemplates": "fa fa-file-text-o",
	"showEditTemplatesEmpty": "fa fa-file-o",
	"draftsRunStop": "fa fa-stop",
	"draftsRunSynch": "fa fa-upload",
	"draftsRemove": "fa fa-trash"
};

exports.panelActionIcon = function(name) {
	return _panelActionIconMap[name] || "";
}