...
var _Klass = utils.defineClass(
	...
	function() {
		...
		onTodayClick: function() {
			...
			this.field.setFieldValue(this.dateApi.fromInternalValue(this._currentDate._value).toString(this.field.localFormat), this._currentDate._value);
		},
		onDayClick: function(picker) {
			this.field.setFieldValue(this.dateApi.fromInternalValue(picker.syraValue).toString(this.field.localFormat), picker.syraValue);
		},
