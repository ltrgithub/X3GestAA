...
var _Klass = utils.defineClass(
	function ModalSelectContext(context, endpoints, roles, languages, displayOpts) {
		var self = this;
		...
		_getDataContext: function() {
			var self = this;
			return settings.getLoginRememberMe().then(function(rememberMe) {
				var showEndpoints = self.displayOpts.hideEndpoints !== true && self.initParam.endpoints.length > 0;
				var showRoles = self.displayOpts.hideRoles !== true && self.initParam.roles.length > 0;
				...
				if (showRememberMe) {
					[{
							description: locale.text("login.rememberme.always"),
							code: "always"
						}, {
							description: locale.text("login.rememberme.never"),
							code: "never"
						}
						/*, {
						description: locale.text("login.rememberme.nativeonly"),
						code: "nativeonly"
					}*/
				...
				if (self.initParam.context) {
					...
					self.initParam.languages.some(function(lang) {
						if (utils.sameLanguage(lang.code, utils.getNavigatorLanguage("en-US"))) {
							lang.selected = true;
							return true;
						}
					});
