...
var _templateAll = {
	...
	footer: '<buttons class="pull-left"><button type="button" id="s-m-msg-stacks" class="btn btn-default" data-action="more">{{stackShow}}</button></buttons><button type="button" class="btn btn-default" data-action="$cancel">{{close}}</button>'
};
