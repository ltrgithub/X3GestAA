			...
			<div class="s-m-scroll-wrapper s-m-scroll-wrapper-v">\
				<div class="form-group s-m-scroll-element"> \
					...
					<div id="s-m-cache-btns-id" class="btn-group btn-group-justified"> \
						<label id="s-m-cache-clear-1week-id" class="btn btn-primary" data-action="clearCache" data-params="clear,1week">{{label_cache_week1}}</label> \
						<label id="s-m-cache-clear-week2-id" class="btn btn-primary" data-action="clearCache" data-params="clear,2week">{{label_cache_week2}}</label> \
						<label id="s-m-cache-clear-month-id" class="btn btn-primary" data-action="clearCache" data-params="clear,month">{{label_cache_month}}</label> \
						<label id="s-m-cache-clear-all-id" class="btn btn-primary" data-action="clearCache" data-params="clear,all">{{label_cache_all}}</label> \
					</div> \
					<div style="display:table-row;"> \
		...
		_clearCache: function(param) {
			...
			if (action === "confirm") {
				...
				switch (data) {
					...
					case "month":
						dt = new Date(today);
						dt.setDate(today.getDate() - 31);
						break;
					case "all":
						dt = null;
						break;
				}
				dt = dt ? dt.toJSON().slice(0, 10) + "-00-00-00" : "0000-00-00-00-00-00";
