...
var nativeApp = require('syracuse-tablet/html/js/helpers/nativeSageX3WUPApp');
				...
				<div class="form-group s-m-scroll-element"> \
					...
					{{#if showConfigServers}} \
						...
						<div class="btn-group btn-group-justified"> \
							<div class="btn-group"> \
								<label class="btn btn-primary" data-action="configServers" data-params="">{{label_config_servers}}</label> \
							</div> \
						</div> \
					{{/if}} \
	...
	function ModalSettings(settings) {
		...
		_getDataContext: function() {
			...
			if (nativeApp.isSageX3WUPApp()) {
				...
				data.label_config_servers = locale.text("settings.servers.config");
			}
