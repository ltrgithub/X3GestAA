...
var modalDiag = require('syracuse-tablet/html/js/ui/modals/modalDiagnoses-Copie');
...
var _diagnoses = function(title, diag, cb) {
	var modal = new ModalDiagnoses(title, diag, cb);
	modal.show();
...
var _confirm = function(action, cb) {
	...
	var modal = new ModalConfirm(null, action, function(message, modal, params) {
...
var _simpleConfirm = function(message, cb) {
	var modal = new ModalConfirm(message, null, function(message, modal, params) {
		if (cb && (message === "yes" || message === "no")) {
			_execCb(cb, "yes" === message);
		}
	}, true);
...
exports.simpleConfirmPromise = function(options) {
	...
	var modal = new ModalConfirm(options.message, null, function(message, modal, params) {
	...
	/*_modalStatic("confirm", {
		message: _checkMsg(options.message),
		yes: locale.text("yes"),
		no: locale.text("no")
	}, function(message, modal, params) {
		if (message === "yes" || message === "no") {
