...
var _asynchDiagnoses = function(title, diag, forceDisplay) {
	...
	return modal.show() //Better to not force display forceDisplay === true)
};
...
var _asynchError = function(title, e) {
	...
	return _asynchDiagnoses(title, diag) //Better to not force display , true);
};
...
var _error = function(title, e, cb) {
	...
	return _diagnoses(title, diag, callBack) //Better to not force display , true);
};
