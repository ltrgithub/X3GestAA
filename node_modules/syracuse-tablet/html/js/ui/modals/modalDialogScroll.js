...
var _templateAll = {
	header: '\
		<buttons class="pull-left"> \
			<button type="button" class="btn btn-default  s-m-modal-btn-back" data-action="$cancel"></button> \
		</buttons> \
		{{#if buttonValidate }}\
