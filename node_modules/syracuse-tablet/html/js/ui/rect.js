...
var _Klass = utils.defineClass(function rect(top, left, height, width) {
	 ...
	 * $$parent			optional
	 * 					should be specified if pos is relative
	 * pos				optional
	 * 					fixed / relative
	 */
	showInDocument: function(timeoutOrColor, $$parent, pos, color) {
		var timeout;
		if (typeof timeoutOrColor === "string") {
			color = timeoutOrColor;
			timeout = null;
		} else {
			timeout = timeoutOrColor;
		}
