...
exports.AuthPage = utils.defineClass(
	function AuthPage() {
		...
		enableAuthCss: function() {
			...
			$(".s-m-auth", self.$$page).on("click", self._onElementClick);
			$(".s-m-auth", self.$$page).on("mouseover", self._onElementMouseOver);
			$(".s-m-auth", self.$$page).on("mouseout", self._onElementMouseOut);
		},
		...
		disableAuthCss: function() {
			...
			$(".s-m-auth", self.$$page).off("click", self._onElementClick);
			$(".s-m-auth", self.$$page).off("mouseover", self._onElementMouseOver);
			$(".s-m-auth", self.$$page).off("mouseout", self._onElementMouseOut);
