...
var _elementsNoAuthoring = [
	...
	".s-m-main-content > .s-m-scroll-wrapper > .s-m-stack", // do not allow to select root level stack
...
exports.AuthPage = utils.defineClass(
	function AuthPage() {
		...
		enableAuthCss: function() {
			...
			$(".s-m-control.s-m-hidden").toggle(true);
		...
		disableAuthCss: function() {
			...
			$(".s-m-control.s-m-hidden").toggle(false);
