...
function _checkBgColor(fullPage, parent, node, key, properties, errors) {
	...
	var valid = authoringPropertiesLayouts.properties.tileColor.values.map(function(e) {
		return e.value;
	});
...
function _checkTileSize(fullPage, parent, node, key, properties, errors) {
	var value = node[key];
	var valid = authoringPropertiesLayouts.properties.tileSize.values.map(function(e) {
		return e.value;
	});
