...
var authoringPropertiesLayouts = null;
/**
 *authoringPropertiesLayouts initialized at call otherwise there's a conflict
 **/
function getAuthoringPropertiesLayouts() {
	if (!authoringPropertiesLayouts) {
		authoringPropertiesLayouts = require('syracuse-tablet/html/js/authoring/authoringPropertiesLayouts');
	}
