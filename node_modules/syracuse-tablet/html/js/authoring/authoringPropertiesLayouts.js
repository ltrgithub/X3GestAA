...
var _properties = {
	 ...
	 */
	"tileColor": function(controller, sel, data) {
		this.name = "bgColor";
		this.key = "$bgColor";
		this.colorChange = function(value, sel, data, prop) {
			authPropsGeneral.setValue(this, sel, data, (value ? value.name : ""));
			authPropsGeneral.notifyChangePropUI(this.$$parent, sel, data);
		};
		this.createMarkup = _createMarkupRadioBgColor;
	},
	/*{
		"key": "$bgColor",
		"default": "darkgrey",
 ...
 */
var _layoutProps = {
	"stack": [_properties.layoutTitle, _properties.layoutCollapsible, _properties.layoutTheme],
	"row": [],
...
function _createMarkupRadioBgColor($$parent, prop, sel, data) {
	...
	this.paletteColor.setValue(data.articleSelection.$bgColor ? {
		name: data.articleSelection.$bgColor,
		css: "s-m-color-" + data.articleSelection.$bgColor
	} : null);
}
