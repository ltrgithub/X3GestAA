...
exports.Panel = utils.defineClass(function() {
	...
	_buildPageStructTree: function(article) {
		...
		function _walkNode(node, $$parent) {
	...
	_buildProtoStructTree: function() {
		...
		if (jsutils.isInstanceOf(page, "DashboardPage")) {
			...
			props.forEach(function(key) {
				self._addVignette(page.prototype, key, $$ul);
			});
		} else {
			self._addPage(page.prototype, $$ul);
		}
	},

	_addVignette: function(proto, vignette, $$parent) {
		var self = this;
	...
	_addPage: function(proto, $$parent) {
		var self = this;
		var label = "?";
