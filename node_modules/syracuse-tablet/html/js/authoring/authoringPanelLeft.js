...
exports.Panel = utils.defineClass(function() {
	...
	notifPageLoaded: function(page) {
		var self = this;
		if (globals.getCurrentPage().isDashboard()) {
			// fdb - only dashboard - dashboard is reloaded so we must wait page loading to get all the controls
	...
	setSelection: function($$newSel) {
		...
		if ($$newSel) {
			...
			path = $$newSel.attr("data-layout-path");
		} else {
