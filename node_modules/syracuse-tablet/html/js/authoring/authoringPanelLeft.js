...
exports.Panel = utils.defineClass(function AuthoringPanelLeft() {
	...
	_buildPageStructTree: function() {
		...
		function _walkNode(node, $$parent, bindParent) {
			...
			var $$item = $('<li class="s-m-auth-tree s-m-auth-tree-' + typeClass + ' s-m-draggable s-m-droppable" data-ctrl-id="' + id + '" data-auth-drag-action="move">').appendTo($$parent);
