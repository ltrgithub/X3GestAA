...
var AuthInterface = utils.defineClass(function() {
	...
	_displayAuth: function(page) {
		...
		self.$$authJSONPage.val(JSON.stringify(page.article, null, " "));
	},
	...
	selectionChangeHandler: function(sel) {
		...
		if (article) {
			$("#authJSONSelection").val(JSON.stringify(article, null, " "));
		}
	},
	...
	_onApplySelection: function() {
		...
		var articlePage = JSON.stringify(data.articlePage, null, " ");
