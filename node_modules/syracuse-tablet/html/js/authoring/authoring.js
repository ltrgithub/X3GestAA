...
var AuthInterface = utils.defineClass(function() {
	...
	notifications.subscribe(self, ["sm.auth.context.changed"]);
	...
	/**
	 * fdb - When we change orientation, device, scale
	 * type = orientation, device, scale
	 */
	notifAuthContextChanged: function(type) {
		...
		// Ex: query filters are forced to t'abs' for smartphone so we musn't display property 'Filters' for $resources is device= smartphone
