...
var AuthInterface = utils.defineClass(function() {
	...
	_ensureAuthPanel: function() {
		...
		var ctx = {
			...
			authCodeDefault: "DEFAULT",
			authTitleDefault: "DEFAULT",
			authDescriptionDefault: "DEFAULT"
		};
	...
	_updateLayout: function() {
		...
		var articleParsed = JSON.parse(article);
...
function _saveAuthoring(page, opts) {
	...
	var pageData = {
		...
		saveAsOption: opts.saveAs, // "factory_variant", // personal_copy", "global_variant", "factory_variant" -> "shared_copy" not yet
