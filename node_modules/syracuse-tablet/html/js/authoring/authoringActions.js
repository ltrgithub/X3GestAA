...
var _actionProperties = ["footerHeader", "refreshPage", "multiselection"];
 ...
 * 		$pageActionSettings
 * 		[{name: actionName, $title:"", options: [{id:footerHeader, checked:true/false},{id:refreshPage, checked:true/false}]}
...
var _properties = {
	...
	"actionSettings": function(controller, sel, data) {
		...
		this.initMarkup = function(controller, sel, data) {
			...
			/**
			 * actionList = [{name: actionName, $title:"", options: [{id:footerHeader, checked:true/false},{id:refreshPage, checked:true/false}]}
			 */
		...
		this._updateParams = function(record) {
			...
			this.paramActionUpdate(record.name || _noValue, true);
		...
		this.paramActionUpdate = function(value, forceAddValue) {
			var selectOpts = [{
		...
		this.paramOptionsAdd = function($$root) {
			...
			_actionProperties.forEach(function(x) {
				opts.list.push({
					id: x,
