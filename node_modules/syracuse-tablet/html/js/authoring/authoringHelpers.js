...
var _PropertyPanel = function($$parent) {
	...
	this.addDestroy = function($$content, handler, prop) {
		this.destroyHandlers.push(jsutils.bindFn(handler, null, $$content, prop));
	};
};
	...
	props.forEach(function(prop) {
		...
		if (prop.createMarkup) {
			...
			if (prop.destroyMarkup) {
				propertyPanel.addDestroy($$content, prop.destroyMarkup, prop);
			}
		} else {
			if (prop.applyMarkup) {
