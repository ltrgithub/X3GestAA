...
exports.genNewArticle = function(opts, synch) {
	...
	if (jsutils.isInstanceOf(opts.page, "DashboardPage")) {
		return exports.generateDashboardArticle(proto, opts.orientation, synch);
	} else {
		return _generateRegularArticle(proto, opts.orientation, synch);
	}
};

exports.generateDashboardArticle = function(proto, orientation, synch) {
...
function _generateRegularArticle(proto, orientation, synch) {
	proto = $.isPlainObject(proto) ? proto : proto.json;
