...
var _properties = {
	...
	"chartDetailButton": function(controller, sel, data) {
		...
		this.createButtonMarkup = function() {
			...
			var text = locale.text("auth.chartDetail." + (saveDesign ? "saveDesign" : "openDesign"));
			this.$$Button = $('<button id="auth_opt_chart_design" type="button" class="btn btn-default">' + text + '</button>');
		...
		this.onClickButton = function(evt, closeDesign) {
			if (closeDesign) {
				eventListener.triggerAction(this.controller.$$elmt, "saveChartDetail");
		...
		this.isSaveButton = function() {
			return this.controller && this.controller.state.type == "chartdetail";
		};
	},
...
exports.getChartDetailBackButton = function(controller) {
	return new _properties.chartDetailButton(controller);
};