...
var _properties = {
	...
	"arrayCardBgColor": {
		...
		"createMarkup": function($$parent, prop, sel, data) {
			...
			this.paletteColor = authComponents.newComponent("colorPalettePicker", opts);
			this.paletteColor.createMarkup($$parent);
			this.paletteColor.setValue(authPropsGeneral.getColorInfo(data.articleSelection.$cardBgColor));
		}
	},
	// only card
...
exports.getModuleProperties = function($$elmt, controller, props, sel, data) {
	if (!data.control.prototype.isSingleArray()) {
		props.push(_properties.arrayCardsPerRow, _properties.arrayCardsMinWidth, _properties.arrayCardsEmptyCells, _properties.arrayCardButton, _properties.arrayBgColor, _properties.arrayCardBgColor);
	}
};
