...
var _templates = {
	authPanelHeader: '\
		...
		<div class="btn-group"> \
			...
			<button class="btn btn-auth-header" id="s-m-auth-remove-cnt-id" type="button"><label class="glyphicon glyphicon-erase"></label>{{label_remove_container}}</button> \
	...
	authPanelCardMinSizeSliderControl: ' \
		<div class="form-group"> \
	...
	authPanelPropertyGSegmentsNumber: '\
		<div class="form-group">\
			...
			<button class="btn btn-default btn-block">{{label_apply}}</button> \
		</div>\
	',
	gaugeBorderInput: '\
		<textarea class="form-control" id={{id}} rows="1">{{value}}</textarea>\
	...
	',
	gaugeSegments: '\
		<div class="s-m-auth-g-segments">\
			<ul class="nav nav-pills" role="tablist"> \
				{{#each tabs}}\
					<li role="tab"><a href="#{{id}}" data-toggle="tab">{{title}}</a></li> \
				{{/each}}\
			</ul> \
			<div class="tab-content">\
				{{#each tabs}}\
					<div id="{{id}}" role="tabpanel" class="tab-pane">\
						...
						<div class="s-m-g-seg-info-block">\
							...
							<div class="s-m-g-seg-value">\
								<input type=range min=0 max=1 value="{{value_propstart}}" id="{{id}}-propstart" step=0.1>\
								<output for={{id}}-propstart id="{{id}}-propstart-output">{{value_propstart}}</output>\
							</div>\
						</div>\
						<div class="s-m-g-seg-info-block">\
							<div class="s-m-g-seg-label">\
							...
							<div class="s-m-g-seg-value">\
								<input type=range min=0 max=1 value="{{value_propend}}" id="{{id}}-propend" step=0.1>\
								<output for={{id}}-propend id="{{id}}-propstart-output">{{value_propend}}</output>\
							</div>\
						</div>\
						<div class="s-m-g-seg-info-block">\
							<div class="s-m-g-seg-label">\
