...
var _templates = {
	authPanelHeader: '\
		...
		<div class="btn-group"> \
			...
			<button class="btn btn-auth-header" id="s-m-auth-new-layout-id" type="button"><label class="glyphicon glyphicon-blackboard"></label>{{label_new_layout}}</button> \
		</div> \
	...
	authPanelCardMinSizeSliderControlWithOutput: '\
		<div class="form-group"> \
