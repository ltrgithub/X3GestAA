...
var _templates = {
	authPanelHeader: '\
		...
		<div class="btn-group pull-right"> \
			<div class="btn-group "> \
				<button id="auth-btn-undo-id"  class="btn btn-auth-header" type="button"><label class="glyphicon glyphicon-step-backward">{{label_undo}}</label></button> \
				<button id="auth-btn-undo-all-id"  class="btn btn-auth-header" type="button"><label class="glyphicon glyphicon-fast-backward">{{label_undo_all}}</label></button> \
