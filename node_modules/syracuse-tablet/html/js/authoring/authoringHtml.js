...
var _templates = {
	authPanelHeader: '\
		...
		<div class="btn-group pull-right"> \
			<div class="btn-group "> \
				<button id="auth-btn-undo-id"  class="btn btn-auth-header" type="button"><label class="glyphicon glyphicon-step-backward"></label>{{label_undo}}</button> \
				<button id="auth-btn-undo-all-id"  class="btn btn-auth-header" type="button"><label class="glyphicon glyphicon-fast-backward"></label>{{label_undo_all}}</button> \
