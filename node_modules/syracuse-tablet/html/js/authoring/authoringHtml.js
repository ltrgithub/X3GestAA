...
var _templates = {
	oldAuthPanelHeader: '\
		...
		<div class="btn-group"> \
			...
			<button class="btn btn-auth-header disabled" id="s-m-auth-remove-cnt-id" type="button"><label class="glyphicon glyphicon-erase"></label>{{label_remove_container}}</button> \
		</div> \
		<div class="btn-group pull-right"> \
			...
			<button id="auth-btn-save-id"  class="btn btn-auth-header" type="button"><div class="glyphicon glyphicon-ok"></label></button> \
			<button id="auth-btn-close-id" class="btn btn-danger" type="button"><div class="glyphicon glyphicon-remove"></label></button> \
		</div>',
	authPanelHeader: '\
		<div style="display:table;table-layout:fixed;;width:100%;">\
			<div style="display:table-row;width:100%; ">\
				...
				<div style="display:table-cell;">\
					<div style="display:table;">\
						<div style="display:table-row;">\
							<button style="display:table-cell;" class="btn btn-auth-header" id="s-m-auth-new-layout-id" type="button"><label class="glyphicon glyphicon-blackboard"></label>{{label_new_layout}}</button> \
							<button style="display:table-cell;" class="btn btn-auth-header" id="s-m-auth-remove-all-id" type="button"><label class="glyphicon glyphicon-erase"></label>{{label_remove_all}}</button> \
							<button style="display:table-cell;" class="btn btn-auth-header disabled" id="s-m-auth-remove-id" type="button"><label class="glyphicon glyphicon-trash"></label>{{label_remove}}</button> \
							<button style="display:table-cell;" class="btn btn-auth-header disabled" id="s-m-auth-remove-cnt-id" type="button"><label class="glyphicon glyphicon-erase"></label>{{label_remove_container}}</button> \
						</div>\
					</div>\
				</div>\
				<div style="display:table-cell;width:300px;">\
