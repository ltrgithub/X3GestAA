...
var authPropChart = require('syracuse-tablet/html/js/authoring/authoringPropertiesChart');
...
exports.Panel = utils.defineClass(function AuthoringPanelRight() {
	...
	notifAuthSetPage: function(page) {
		...
		var chartDetail = page.state.type == "chartdetail";
		if (chartDetail) {
			notifications.publish("sm.auth.top.button", "add", authPropChart.getChartDetailBackButton(page));
		}
