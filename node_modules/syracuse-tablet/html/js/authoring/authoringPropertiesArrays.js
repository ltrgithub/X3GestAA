...
var _properties = {
	...
	arrayCardButton: function(controller, sel, data) {
		...
		this.buttonMarkup = function() {
			var closeDesign = this.controller.state.type == "carddesign";
			this.$$Button = $('<button id="' + "auth_opt_" + this.name + '" type="button" class="btn btn-default">' + (closeDesign ? "Save card design" : "Open card design") + '</button>');
			this.$$Button.on("click", jsutils.bindFn(this.onClickButton, this, closeDesign));
			return this.$$Button;
		};
