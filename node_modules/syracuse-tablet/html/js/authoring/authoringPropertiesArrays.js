...
var _statusColorPalette = ["medium-purple", "darkgrey", "purple", "sagegreen", "blue", "orange", "skyblue", "lightgreen", "medium-grey", "green", "white", "black", "grey", "alert", "warning", "info"];
var _statusIconPalette = ["medium-purple", "darkgrey", "purple", "sagegreen", "blue", "orange", "skyblue", "lightgreen", "medium-grey", "green", "white", "black", "grey", "alert", "warning", "info"];
var _templates = {
	subtitle: '\
	...
	"arrayStatus": function(controller, sel, data) {
		...
		*/
		...
		this.statusListAdd = function(sel, data) {
			...
			this.listStatusDisplayer = components.newComponent("editableList", opts);
		...
		this.paramFieldAdd = function($$root) {
			...
			this.fieldSelector = components.newComponent("select", opts);
		...
		this.paramOperatorAdd = function($$root) {
			...
			this.operatorSelector = components.newComponent("select", opts);
		...
		this.paramColorAdd = function($$root) {
			...
			_statusColorPalette.forEach(function(c) {
				opts.palette.push({
					name: c,
					css: "s-m-status-" + c
				});
			});
			this.paletteColor = components.newComponent("colorPalettePicker", opts);
		...
		this.paramIconAdd = function($$root) {
			...
			this.paletteIcon = components.newComponent("iconPalettePicker", opts);
