...
var _templates = {
	...
	statusLine: '\
		<span style="float:left">{{field}} {{operator}} {{value}}</span>\
		<span style="float:right;width:{{sizeColor}}px;height:{{sizeColor}}px;background-color:{{bgcolor}};margin-right:5px;"></span>'
};
