...
var _statusPalette = ["red", "blue", "orange", "yellow", "green"];
		...
		*/
		...
		this.validateRecord = function(errorMsg) {
			...
			var _fail = function(msg) {
				if (errorMsg === true) {
					var text = msg || locale.text("auth.arrayCardStatus.invalid");
		...
		this.paramColorAdd = function($$root) {
			...
			this.paletteComponent = components.newComponent("palettePicker", opts);
