...
exports.HomeController = utils.defineClass(
	function HomeController(dataset, page, options) {
		this.page = page;
		this.options = options || {};
		this.configActive = options.forceConfigActive;
	...
	Base, {
		...
		showMyDashboardTemplates: function() {
		...
		saveContext: function() {
			this._article = this._article || $.extend(true, {}, this.page.getArticle());
			this._meta = this._meta || $.extend(true, {}, this.page.pageData.meta);
		},
		restoreContext: function() {
			this.page.pageData.page.$article = $.extend(true, {}, this._article || this.page.getArticle())
