	...
	Base, {
		...
		_checkUIAdapterAction: function(actionName, method) {
			...
			return first.then(function(goAhead, beforeContext) {
				...
				return method.call(self, actionName).then(function(successOrPage) {
					...
					if (currentPage && currentPage.afterOnSdataActionClicked) {
						currentPage.afterOnSdataActionClicked(actionName, success, beforeContext);
					}
					return success;
				});
			}).fail(function(result) {
		...
		setActionAdapterArrayOptions: function($arrayOptions) {
