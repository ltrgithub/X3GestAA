...
exports.isDevelopmentModeAllowed = function() {
	return exports.isDesktop() && !exports.isNativeWrapper() && exports.isDvlpMode();
};
exports.isAuthoringModeAllowed = function() {
	return exports.isDesktop() && !exports.isNativeWrapper() && exports.getAuthoringLevel() !== "none";
};
...
exports.isUnitTestMode = function() {
