...
var _notifUserAgentChanged = function() {
	...
	if (log) {
		log("isMobile", _globals.isMobile);
		log("isTestNativeWrapper", _globals.isTestNativeWrapper);
	}
};
...
/**
 * mobile client config given by nodelocal.js (mobileClientConfig property)
 */
...
exports.getMobileClientConfig = function() {
	return _mobileClientConfig;
};
...
exports.getHttpTimeout = function(url) {
	...
	return _mobileClientConfig.httpTimeout != null && !isNaN(_mobileClientConfig.httpTimeout) ? _mobileClientConfig.httpTimeout : _defMobileClientConfig.httpTimeout;
};