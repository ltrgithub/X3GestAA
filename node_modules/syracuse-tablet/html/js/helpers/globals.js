...
var _updateMobileDetect = function() {
	var agt = navigator.userAgent;
	_globals.mobileDetect = new MobileDetect(agt);
	...
	$(document.body).toggleClass("s-m-mobile-device", _globals.isMobile === true);
};
...
exports.updateMobileDetect = _updateMobileDetect;
exports.defaultOS = _defaultOS;
// Returns the os for style ios/windows/android
exports.getStyleOS = function() {
	var os = _globals.mobileDetect == null ? _defaultOS : _globals.mobileDetect.os();
	switch (os) {
		case "AndroidOS":
			return "android";
...
exports.isOs = function(os) {
	if (_globals.mobileDetect == null) {
		return os === _defaultOS;
	}
	switch (_globals.mobileDetect.os()) {
		case "AndroidOS":
			return os === "android";
		case "WindowsMobileOS":
		case "WindowsPhoneOS":
...
exports.isNativeScrolling = function() {
	...
	_isNativeScrollingStatus = exports.isNativeWrapper() && nativeExtCall.isSupported("smApp", "NativeScrollingSupported");
};
...
exports.isDebugDeviceSimlator = function() {
	return exports.isMobile() && exports.isNativeWrapper() === false;
};
