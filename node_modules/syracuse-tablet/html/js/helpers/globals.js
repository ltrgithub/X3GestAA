...
var _init = function(dvlpMode, storage, cache, utilsModule) {
	_globals.isDvlpMode = dvlpMode || exports.showTestApplications();
...
exports.PANELDASHBOARDTEMPLATES = "panelpagedashboardtemplates";
...
exports.showTestApplications = function() {
	if (exports.isTestNativeWrapper()) {
		return true;
	}
	var url = jsutils.getCurrentUrl();
	return url && url.query && url.query.showTestApplications != null;
};