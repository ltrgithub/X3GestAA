...
exports.isNativeScrolling = function() {
	// false - IOS - We want to force non-native scrolling because IOS scrolling is worse than native
	// TODO Check how we could improve IOS native scrolling
	if (false && exports.isMobile()) {
		return true;
	}
