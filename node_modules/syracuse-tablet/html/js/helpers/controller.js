...
var _Klass = utils.defineClass(
	function(id, prototype, article, options) {
		...
		getControl: function(id) {
			return this._controlsMap ? this._controlsMap[id] : null;
		},
		getLayout: function(id) {
			return this._layoutsMap ? this._layoutsMap[id] : null;
		},
		getStructElmt: function(id) {
			return this.getControl(id) || this.getLayout(id) || null;
		},
		/**
		...
		addEventListener: function(eventName, method) {
			...
			this._evtListener[eventName] = utils.bindFn(method, this);
		},
