 ...
 */
exports.getFooterHeight = function(deviceType, status) {
	return _heights[deviceType ? deviceType : _getDeviceType()]["footer"][status || "opened"];
};
exports.getHeaderHeight = function(deviceType) {
	return _heights[deviceType ? deviceType : _getDeviceType()]["header"];
};