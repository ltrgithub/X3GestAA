...
function _layoutMainContainers() {
	...
	if (authoringActive === true) {
		...
		// Auto scale
		// _layoutParameters.authoringParameters.scale = Math.min(Math.min(applicationWidth / appView.width, applicationHeight / appView.height), 1);

		appView.left = (applicationWidth - appView.width * _layoutParameters.authoringParameters.scale) / 2;
		appView.top = (applicationHeight - appView.height * _layoutParameters.authoringParameters.scale) / 2;
	...
	if (authoringActive && _layoutParameters.authoringParameters.scale !== 1) {
		$$app.css({
			"transform": "scale(" + _layoutParameters.authoringParameters.scale + ", " + _layoutParameters.authoringParameters.scale + ")",
	...
	var orientation = authoringActive ? _layoutParameters.authoringParameters.orientation : _currentOrientation;
