...
exports.getUrlContext = function() {
	...
	// Check if there's a context to restore in url
	...
	if (!context.endpoint || !context.history || !context.applicationName || !Array.isArray(context.history) || context.history.length === 0) {
		if (globals.getModal()) {
