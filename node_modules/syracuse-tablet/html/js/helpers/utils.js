...
var _getUTCTime = function(date) { // date can be a date object or an ISODate (""2015-11-10-12-04-50")
	if (typeof(date) === "string") {
		var Val = date.split("-");
		date = new Date(Val[0], parseInt(Val[1], 10) - 1, Val[2], Val[3], Val[4], Val[5]);
	}
...
exports.getUTCTime = _getUTCTime;
