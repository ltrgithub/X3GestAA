...
var _getPropByPath = function(object, path, cacheParent) {
	...
	if (cacheParent) {
		if (cacheParent._cachePath && cacheParent._cachePath[pathStr] != null) {
			return cacheParent._cachePath[pathStr];
		}
	}
	...
	if (cacheParent) {
		...
		cacheParent._cachePath[pathStr] = data;
	}
	return data;
};
/**
 ...
 * arguments that follow context are apssed to fn call back after the regular parameters
 * @param {Function} fn
