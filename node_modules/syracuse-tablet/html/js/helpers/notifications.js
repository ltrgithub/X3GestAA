...
var _callHandler = function(callBack, object, args) {
	...
	if (jsutils.isInstanceOf(object, "Page") && !object.isActive()) return;
	if (jsutils.isInstanceOf(object, "StructElmt") && (object.controller == null || !object.controller.isActive())) return;
