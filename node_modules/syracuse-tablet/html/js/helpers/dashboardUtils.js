...
var _devOnlyApps = [
	"$welcome_sagesalescustomers",
	"$welcome_sagesalesinquiries",
	"$welcome_sagsalesactions",
	"$welcome_sagepurchaseactions",
	"$welcome_sagepurchaseinquiries",
	"$welcome_sageexpenses",
	"$welcome_PHYELT_MOBILE",
	"$welcome_sageavailablestock",
	"$welcome_clientTestApplication"
];
...
function _getUnbindGadgets(article, prototype) {
	...
	unbind.forEach(function(value) {
		if (!(value === "$welcome_$welcomeApplication" || (globals.showTestApplications() === false && _devOnlyApps.indexOf(value) > -1))) { // main app : no gadget
