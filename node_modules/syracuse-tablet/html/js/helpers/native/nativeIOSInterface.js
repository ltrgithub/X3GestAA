...
(function() {
	...
	var _IOSNativeInterface = function() {
			...
			this.convertIOSData = function(type, dataStr) {
				...
				window.smNativeLogger.log("convertIOSData", type, (dataStr || "").substr(0, 100))
	...
	window.iosJavascriptServiceCall = function(objectName, methodName, type, params) {
		try {
			...
			window.smNativeLogger.log("iosJavascriptServiceCall", objectName, methodName, type, JSON.stringify(res).substr(0, 100));
