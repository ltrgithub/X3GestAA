...
exports.sharePageLink = function(options) {
	...
	// Url must contain all information required to allow the webapp to navigate back to the current page including it's eventual state (like filters)
	options.url = options.sDataUrl;
