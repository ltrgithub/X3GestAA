...
var _ShareManager = function(bookmarks) {
	...
	this.handleLink = function(data) {
		...
		if (this.enabled === true) {
			if (true) {
				...
				// Just to test outside a native wrapper - Simulates the asynchronous process
				var self = this;
				self.pendingLinks = self.pendingLinks || [];
				self.pendingLinks.push(data);
				setTimeout(function() {
					self.notifApplicationReady();
				}, 100);
			}
		} else {
