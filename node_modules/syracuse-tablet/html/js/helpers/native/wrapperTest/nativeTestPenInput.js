...
var _TestNativeWrapper = function() {
	...
	this.getPenTextInput = function() {
		setTimeout(function() {
			log && log("Pen Input GET ");
			window.smPenInputJS.penInputTextFinished({
				Action: "ok",
				Matches: ["Pencil input..."]
			});
		}, 100);
	};
	this.getAnnotatedImageSupported = function(options) {
		return true;
	};
