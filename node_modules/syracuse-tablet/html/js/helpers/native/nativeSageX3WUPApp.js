...
exports.getReconnectToken = function() {
	...
	return window.smNativeApp && window.smNativeApp.getReconnectToken && window.smNativeApp.getReconnectToken();
};
exports.setReconnectToken = function(token) {
	if (true) {
		return localStorage.setItem("reconnectToken", token);
	}
	return window.smNativeApp && window.smNativeApp.setReconnectToken && window.smNativeApp.setReconnectToken(token);
};
