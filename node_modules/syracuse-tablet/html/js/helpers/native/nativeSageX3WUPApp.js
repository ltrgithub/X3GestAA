...
/**
 * Management of reconnection
 * Returns the user context to restore (context)
 * {
 * 		userCtx:
 * 		userProfile:
 *  	context:
...
/**
 * Management of reconnection
 * Returns history context to restore
 */
 ...
 * For test wrapper
 */
exports.notifBeforeUnload = function() {
	if (!exports.isTestNativeWrapper()) return;
	// Remove syracuse cookies
	ajax("GET", "/requireJS/reconnect?disconnect");
};
