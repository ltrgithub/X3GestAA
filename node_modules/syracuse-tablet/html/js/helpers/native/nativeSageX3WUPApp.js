...
if (!(window.smWrapperJS)) {
	window.smWrapperJS = {
		...
		applicationClosing: function() {
			return nativeTestUtils.callAppNativeInterface("X3WUPApp", "applicationClosing");
		},
		...
		applicationResuming: function(dataString) {
			return nativeTestUtils.callAppNativeInterface("X3WUPApp", "applicationResuming", dataString);
		}
	};
}
