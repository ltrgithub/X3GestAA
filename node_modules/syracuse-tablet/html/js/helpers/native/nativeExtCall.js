...
var log = require('syracuse-tablet/html/js/helpers/logger').getLogger("nativeExtCall", true);
...
exports.callMethod = function(domain, method, data) {
	...
	if (_isPromise(ret)) {
		return ret.then(function(result) {
			log && log("--> Result callMethod (" + domain + ", " + method + ") =" + result);
			try {
				result = JSON.parse(result);
			} catch (e) {
				log && log("--> Error parsing result");
			}
			return result;
		});
	} else {
