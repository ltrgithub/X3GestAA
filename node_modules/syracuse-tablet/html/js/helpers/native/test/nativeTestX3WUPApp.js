...
var log = require('syracuse-tablet/html/js/helpers/logger').getLogger("X3WUPApp", true);
...
var _TestNativeWrapper = function() {
	...
	this.setReconnectContext = function(context) {
		try {
			null && log && log("setReconnectContext", context);
	...
	this.getReconnectContext = function() {
		try {
			...
			null && log && log("getReconnectContext", context);
			return context;
		} catch (e) {
			console.log(e);
			return null;
