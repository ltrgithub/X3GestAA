...
exports.appendTestVoiceCommandsMenu = function($$root) {
	if (!_testMode || !window.smVoice || !window.smVoice.appendTestVoiceCommandsMenu) return;
	return window.smVoice.appendTestVoiceCommandsMenu.call(window.smVoice, $$root);
};
/**
 *
 */
