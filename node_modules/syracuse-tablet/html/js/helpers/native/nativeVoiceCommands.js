...
var _BookmarkMgr = function(bookmarks) {
	...
	this.popPendingBookmark = function() {
		var bmk = this.findPendingBookmark();
	...
	this.findPendingBookmark = function() {
		if (!this.pendingCommands) return null;
		var bmk = null;
		this.pendingCommands.some(function(cmd) {
			if (!cmd || cmd.command !== "openBookmark") return;
			bmk = cmd;
			return true;
		});
		return bmk;
	};
	this.hasPendingBookmark = function() {
		return this.findPendingBookmark() != null;
	};
	this.init();
};
/**
 ...
 *
 */
exports.hasPendingBookmark = function() {
	return _bookmarkManager.hasPendingBookmark();
};
/**
 *
 */
exports.popPendingBookmark = function() {
	return _bookmarkManager.popPendingBookmark();
};
