...
exports.supports = function(capability) {
	if (capability === "camera") {
		var supported = (window && window.smImage && window.smImage.supportsPictureFromCamera && window.smImage.supportsPictureFromCamera() && true) || false;
		log && log("Camera support: " + supported);
		return supported;
	}
	return false;
};
...
exports.getPictureFromCamera = function(options) {
	...
	if (window && window.smImage && window.smImage.getPictureFromCamera) {
