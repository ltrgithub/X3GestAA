...
var _modules = {
	...
	"imageScale": require('syracuse-tablet/html/js/helpers/native/nativeImage'),
	...
	"extLink": require('syracuse-tablet/html/js/helpers/native/nativeApp'),

	"GPS": require('syracuse-tablet/html/js/helpers/native/nativeSensors'),
	"scanBarcode": require('syracuse-tablet/html/js/helpers/native/nativeBarcode')
};
