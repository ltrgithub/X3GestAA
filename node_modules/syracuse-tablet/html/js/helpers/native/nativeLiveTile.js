...
function _getTileDataStruct(options) {
	var param = {
		...
		Bind: options.bind || "$resources" // Name of property to use for live tile. 
		// E.g. $resources = array so it will be the number of records in the array.
		// E.g. BPCNAM = property, so value of property will be used
	};
	return param;
}
