...
var _Prototype = utils.defineClass(function(json, parent) {
	...
	data: function(prop) {
		...
		if (prop.charAt(0) == "@") return self.localization(prop);
		return self.json[prop] ? self.json[prop] : self.parent ? self.parent.data(prop) : null;
	},
	/**
	...
	localization: function(prop) {
		var self = this;
		var loc = self.proto.$localization || {};
		return loc[prop] ? loc[prop] : self.parent ? self.parent.localization(prop) : null;
	},
	/**
