...
var _Prototype = utils.defineClass(function(json, parent) {
	...
	getMetaData: function(name) {
		if (name.smStartsWith('$')) {
			// Meta for query array
			if (name === "$resources") return null;
			throw new Error("getMetaData - Unexpected property name [" + name + "]");
		}
		if (!this._metaData) this._metaData = {};
		var meta = this._metaData[name];
		if (meta) return meta;
		meta = this._metaData[name] = $.extend({}, _defMetaData, this.property(name));
		return meta;
	},
