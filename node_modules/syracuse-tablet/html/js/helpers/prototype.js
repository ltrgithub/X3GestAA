...
var _Prototype = utils.defineClass(function(json, parent) {
	...
	isSingleArray: function() {
		var json = this.json.$item ? this.json : this.parent ? this.parent.json : null;
		return json && json.$type === "application/x-array" && (json.$item.$properties == null || json.$item.$type == "application/x-reference");
	}
});
/**
