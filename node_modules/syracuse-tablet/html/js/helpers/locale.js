...
exports.getDateFormat = function() {
	...
	return (di && di.formatPatterns && di.formatPatterns.shortDate) || "dd/MM/yyyy";
};

exports.getDateTimeFormat = function() {
	var di = _getDatetimeInfo();
	var date = (di && di.formatPatterns && di.formatPatterns.shortDate) || "dd/MM/yyyy";
	var time = (di && di.formatPatterns && di.formatPatterns.shortTime) || "HH:mm:ss";
	return date + " " + time;
};
exports.getTimeFormat = function() {
	var di = _getDatetimeInfo();
	return (di && di.formatPatterns && di.formatPatterns.longTime || "HH:mm:ss");
};
exports.getTimeFormatShort = function() {
	var di = _getDatetimeInfo();
	return (di && di.formatPatterns && di.formatPatterns.shortTime || "HH:mm");
};
...
exports.getDecimalInfo = _getDecimalInfo;