...
var _traceCpt = function() {
	if (_cpts.count % 50 === 0) console.log('deferreds : ' + JSON.stringify(_cpts));
};
...
var myDeferred = function(func) {
	...
	// just to count resolve/rejects and compate to the number of deferred created
	...
	deferred.promise = function() {
		...
		myPromise.then = function() {
			...
			if (typeof callBack === 'function') {
				...
				return then.apply(myPromise, args);
			}
		};
		return myPromise;
	};
