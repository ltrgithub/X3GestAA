...
var _templates = {
		...
		<div class="panel panel-default"> \
			<div class="panel-heading" role="tab" id="heading_{{id}}"> \
				<h4 class="panel-title"> \
					<a data-toggle="collapse" data-parent="#accordion" href="#collapse_{{id}}" {{#if expand}} aria-expanded="true"{{/if}} aria-controls="collapse_{{id}}">{{label}}</a> \
				</h4> \
			</div> \
			<div id="collapse_{{id}}" class="panel-collapse collapse_{{id}} {{#if expand}}in{{/if}}" role="tabpanel" aria-labelledby="heading_{{id}}"> \
			</div> \
		</div>',
	...
	authPanelPropertyRadio: ' \
		<div class="btn-group" data-toggle="buttons"> \
			{{#each options}} \
				<div class="btn-group"> \
					<label class="btn btn-primary" id="{{this.id}}_lab" data-s-m-auth-value="{{this.value}}"> \
...
define('syracuse-tablet/html/js/authoring/authoringProperties',['require','exports','module','syracuse-tablet/html/js/helpers/locale','syracuse-tablet/html/js/authoring/authoringHtml','syracuse-tablet/html/js/helpers/notifications'],function (require, exports, module) {
...
exports.selectElement = function(sel) {
	...
	var domItem = $$elmt[0];
	if (domItem) {
		_OnSelectionChange.apply(domItem);
	}
};
...
define('syracuse-tablet/html/js/authoring/authoring',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/helpers/locale','syracuse-tablet/html/js/helpers/notifications','syracuse-tablet/html/js/authoring/authoringHelpers','syracuse-tablet/html/js/ui/modal','syracuse-tablet/html/js/authoring/authoringProperties','syracuse-tablet/html/js/authoring/authoringHtml'],function (require, exports, module) {
...
var _Klass = utils.defineClass(
	...
	function(options) {
		...
		_doLinkAction: function(link, control) {
			...
			var deferred = $.Deferred();
			try {
				var payload = control ? control.controller.getDao().getActionPayload(link) : null;
				dispatcher.dispatch({
					$url: link.sdataurl,
