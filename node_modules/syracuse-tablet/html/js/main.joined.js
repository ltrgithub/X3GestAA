		...
		function(controller, article, prototype) {
			...
			buildFieldValue: function(parentSlot, buildOptions) {
				...
				if (self.$isEditMode) {
					...
					if (self.choiceList.length > 0) {
						self.createFieldValueElement(parentSlot, self._getChoiceTitle(value));
					}
				}
			},
...
define('syracuse-tablet/html/js/controls/array/builderTable', ['require', 'exports', 'module', 'syracuse-tablet/html/js/helpers/utils', 'syracuse-tablet/html/js/controls/array/builderBase', 'syracuse-tablet/html/js/ui/uiUtils', 'syracuse-tablet/html/js/helpers/prototype'], function(require, exports, module) {
	"use strict";
...
define('syracuse-tablet/html/js/controls/array/arrayStd', ['require', 'exports', 'module', 'syracuse-tablet/html/js/helpers/utils', 'syracuse-tablet/html/js/controls/array/arrayBase', 'syracuse-tablet/html/js/controls/array/builderTable'], function(require, exports, module) {
	"use strict";
...
define('syracuse-tablet/html/js/controls/array/builderGridHoriz', ['require', 'exports', 'module', 'syracuse-tablet/html/js/helpers/utils', 'syracuse-tablet/html/js/controls/array/builderBase', 'syracuse-tablet/html/js/ui/uiUtils'], function(require, exports, module) {
	"use strict";
...
define('syracuse-ui/themes/desktop/sage/highcharts/theme', ['require', 'exports', 'module'], function(require, exports, module) {
	var theme = {
		//colors: ['#007f64', '#34b233', '#4d4f53', '#9a9b9c', '#ff5800', '#009fda', '#6639b7' /*green brightgreen darkgrey midgray orange blue purple*/ , '#409f8b', '#67c566', '#7a7b7e', '#b3b4b5', '#ff8240', '#40b7e3', '#8c6bc9', /*75%*/ /*'#7fbfb1','#99d899','#a6a7a9','#cccdcd','#ffab7f','#7fcfec','#b29cdb',50%*/ ],
		colors: ['#BF7070', '#BFB730', '#7ABF30', '#7373FF', '#BF7730', '#BF3080', '#30BF9F', '#FF7373', '#FFF773', '#85FF00', '#3030BF', '#FF9F40', '#FF40BC', '#1699A6', '#FF0000', '#FFF100', '#00FF00', '#0000FF', '#FF7F00', '#FF00A6', '#00FFC6', '#A60000', '#A69C00', '#56A600', '#90B2FF', '#A65200', '#A6006C', '#00A681', '#FF4040', '#FFF440', '#A3FF40', '#3673FF', '#FFB873', '#FF76CE', '#73FFED'],
		chart: {
