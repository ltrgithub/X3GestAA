...
var _deviceSizes = {
	phone: {
		width: 640, // Nexus 5
		height: 360,
		bootstrapTweakClass: "s-m-auth-col-simulate-xs",
	},
	minitablet: { // Nexus 7
		width: 960,
		height: 600,
		bootstrapTweakClass: "s-m-auth-col-simulate-md"
	},
	tablet: { // Nexus 10
		width: 1280,
		height: 800,
		bootstrapTweakClass: "s-m-auth-col-simulate-lg"
	}
};
...
function _layoutMainContainers() {
	...
	if (authoringActive === true) {
		...
		containerClass = template.bootstrapTweakClass;
