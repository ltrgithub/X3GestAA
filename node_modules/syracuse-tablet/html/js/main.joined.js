...
define('syracuse-tablet/html/js/ui/modal',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/ui/uiUtils','syracuse-tablet/html/js/helpers/locale','syracuse-tablet/html/js/helpers/logger','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/helpers/notifications','syracuse-tablet/html/js/helpers/jsutils','syracuse-tablet/html/js/ui/modalDiagnoses'],function (require, exports, module) {
...
var _error = function(title, e, cb) {
	...
	/* now, to be done!
	var diag = _convertToDiagnoses(e);
	_diagnoses(title, diag, cb);
	*/
};

/*
 * Takes what evers is given as parameter into a compliant diagnoses
 */
function _convertToDiagnoses(obj) {
	// TODO:
}
...
define('syracuse-tablet/html/js/authoring/authoringVal',['require','exports','module','syracuse-tablet/html/js/helpers/locale'],function (require, exports, module) {
...
var _Page = utils.defineClass(
	function Page($$parent, state, prototype, article, options) {
		...
		savedCtxCreate: function() {
			return {
				scrollLeft: this.$$contentElmt.scrollLeft(),
				scrollTop: this.$$contentElmt.scrollTop(),
		...
		savedCtxRestore: function(ctx) {
			if (!ctx) return;
			this.$$contentElmt.scrollLeft(ctx.scrollLeft);
			this.$$contentElmt.scrollTop(ctx.scrollTop);
			this._hilightLastSelectedRow(ctx.lastSelectedRow);
		},
	...
	if (url && url.length) {
		...
		if (action) {
			...
			for (var p in action) {
				...
				var v = dao ? dao.parseExpression(action[p]) : action[p];
				html.push(' ' + p + '="' + encodeURIComponent(v) + '"');
			}
			if (css) {
				html.push(' class="' + css + '"');
			}
	...
	function(controller, article, prototype, options) {
		...
		setLabelPosition: function($lp) {
			...
			function left() {
				...
				$$title.css("float", "left").css("width", "30%").css("text-align", "inherit");
				$$value.css("float", "none").css("text-align", "inherit");
			}

			function right() {
				self.$$elmt.prepend($$value);
				$$title.css("float", "right").css("width", "70%").css("text-align", "inherit");
				$$value.css("float", "left").css("text-align", "inherit");
			}
			...
			function top() {
				...
				$.each(arr, function(index, $$ee) {
					$$ee.css("float", "none").css("width", "inherit").css("text-align", "center");
				});
			}
...
var _Klass = utils.defineClass(
	function(control, options) {
		 ...
		 */
		selectLastSelectedRow: function(rowId, rowIdx, show, selector) {
			var self = this;
			selector = selector || "tbody > tr:nth-child(" + (rowIdx + 1) + ")";
	...
	function(control, options) {
		...
		_buildTableRow: function(tabBody, rowData, idx, options) {
			...
			self._columnInfo.forEach(function(col, idx) {
				...
				fieldProto = col.$activity != null ? self._getOtherColProto(col, rowId) : col.proto;
				if (!col.control) {
		...
		_getOtherColProto: function(colInfo, rowId) {
			...
			var json = {
				$action: {
					"data-action": colInfo.$action || builderBase.ACTROWDETAIL,
					"data-params": "{$uuid}"
				}
			};
...
define('syracuse-tablet/html/js/controls/array/ctrlArray',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/controls/ctrlBase','syracuse-tablet/html/js/ui/uiUtils','syracuse-tablet/html/js/ui/modal','syracuse-tablet/html/js/application/eventListener','syracuse-tablet/html/js/sdata/sdataUtils','syracuse-tablet/html/js/controls/array/builderTable','syracuse-tablet/html/js/controls/array/builderCardV','syracuse-tablet/html/js/controls/array/builderCardH'],function (require, exports, module) {
...
var _Klass = utils.defineClass(
	function(controller, article, prototype, options) {
		...
		selectLastSelectedRow: function(rowId, show) {
			var self = this;
			var info = self._getRowById(rowId);
			if (info) {
				self.builder.selectLastSelectedRow(rowId, info.idx, show);
			}
		},
		/**
		 * Refreshes the control
		 ...
		 **/
		getRowDetailDao: function(rowId) {
			var self = this;
			if (!self._arrayData || !self._arrayData.$resources) return null;
			if (rowId == null || rowId.length == 0) return self.getDao().getArrayEmptyRow(self.prototype);
			var dao = self._getRowById(rowId);
			return dao ? dao.row.clone() : null;
		},
...
define('syracuse-tablet/html/js/main',['require','exports','module','syracuse-tablet/html/js/ui/modal','syracuse-tablet/html/js/ui/uiUtils','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/helpers/jsutils','syracuse-tablet/html/js/init/initStyles','syracuse-tablet/html/js/init/initLocale','syracuse-tablet/html/js/init/initModules','syracuse-tablet/html/js/init/initLogin'],function (require, exports, module) {
