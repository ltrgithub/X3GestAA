...
exports.getApplicationJson = function() {
...
var _pageNotify = function(event, page) {
	try {
		...
		var args;
		if (page !== null && globals.smInstanceOf(page, "page")) {
...
define('syracuse-tablet/html/js/helpers/utils',['require','exports','module','syracuse-tablet/html/js/helpers/logger','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/helpers/notifications'],function (require, exports, module) {
...
var _modalError = function(title, e, cb) {
	var app = globals.getApplicationJson();
	if (app) {
		return globals.getApplicationJson().modalError(title, e, cb);
	} else {
		_alertError(title, e);
	}
};
				...
				var doAjax = function() {
					try {
						...
						promise.complete(function(jqXHR, textStatus) {
							...
							// Exception that occurs in resolve are handled by our hack of jq deferred
...
var _modal = function(html, cb) {
	...
	if (globals.getApplicationJson().currentPage) {
		globals.getApplicationJson().currentPage.waitWheelStop();
	}
	/* Always to retry read template and display alert if not found */
	var h = $(html).modal({
		keyboard: false,
...
var _createPage = function($parent, state, options) {
	...
	try {
		if (type === "html" && state.name === "login") {
			...
			globals.getApplicationJson().dao.getDashboardInfo(state.dashboardUuid).then(function(info) {;
			...
			globals.getApplicationJson().dao.getRegularPageInfo(state)
				.then(function(info) {
...
var _BreadCrumb = function() {
	...
	self.getHistory = function(page) {
		var res = [];
		window.$sm.getApplicationJson.$elmt.find(".page.breadcrumb").each(function(ix) {
...
define('syracuse-tablet/html/js/application/eventListener',['require','exports','module','syracuse-tablet/html/js/helpers/logger','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/ui/modal','syracuse-tablet/html/js/helpers/notifications'],function (require, exports, module) {
...
var _doAction = function($$target, app, act, params, controlId) {
	...
	try {
		...
		$.when(object[method].apply(object, params)).then(function(todo) {
			if (todo) {
				if (todo.page) {
					globals.getApplicationJson().changePage(todo.page);
				}
			}
		}).fail(function(e) {
			fail(e);
...
var _triggerAction = function($$elmt, act, params, controlId) {
	if (!$$elmt) return;
	_doAction($$elmt, globals.getApplicationJson(), act, params, controlId);
};
...
var _PageLoader = utils.defineClass(
	function(callerInterface) {
		...
		this.factory = globals.getApplicationJson().factory;
	}, null, {
...
define('syracuse-tablet/html/js/pages/html/pageTemplates',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/helpers/logger','syracuse-tablet/html/js/helpers/templating','syracuse-tablet/html/js/ajax/ajax'],function (require, exports, module) {
	...
	try {
		...
		templates.exec(root + _consts.tmplHead, ctxHeader, {
			...
			if (header == null && ctxHeader != null) {
				_defHeaderCtx.application = globals.getApplicationJson().getTitle();
...
define('syracuse-tablet/html/js/sdata/sdataHttp',['require','exports','module','syracuse-tablet/html/js/helpers/logger','syracuse-tablet/html/js/ajax/ajax','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/helpers/locale'],function (require, exports, module) {
...
define('syracuse-tablet/html/js/sdata/sdataCommonResources',['require','exports','module','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/sdata/sdataUtils','syracuse-tablet/html/js/sdata/sdataHttp','syracuse-tablet/html/js/ajax/ajax','syracuse-tablet/html/js/helpers/utils'],function (require, exports, module) {
		...
		_readCurrentVersion: function() {
			...
			self._executeSql('SELECT version FROM version', null).then(function(result) {
				...
				self._executeSql('CREATE TABLE version (version TEXT)').then(function(status) {
					...
					utils.modalError("Error Creating version table", status, function() {
						deferred.reject(status);
					});
				});
			});
...
exports.getPageInfo = function(name, options) {
	...
	if (options) {
		...
		if (gadgetId) {
			state.options.gadget = globals.getApplicationJson().dao.getGadget(gadgetId);
		}
	}
	state.name = name;
	if (!state.transition) {
		// Default transition
		state.transition = globals.getApplicationJson().$config("transition");
	}
	// Readable id
...
define('syracuse-tablet/html/js/init/initContext',['require','exports','module','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/helpers/locale','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/pages/html/modalSelectContext','syracuse-tablet/html/js/helpers/notifications','syracuse-tablet/html/js/sdata/sdataCommonResources','syracuse-tablet/html/js/storage/localStorage','syracuse-tablet/html/js/application/settings'],function (require, exports, module) {
			...
			var _dialog = function(ctx) {
				...
				selectNewContext.then(function(context) {
					if (context && context.action === "ok") {
						...
						globals.getApplicationJson().logout().always(function() {
							deferred.resolve(null);
						});
					}
				}).fail(function(e) {
...
define('syracuse-tablet/html/js/ui/fontUtils',['require','exports','module','syracuse-tablet/html/js/ui/iconList'],function (require, exports, module) {
...
exports.pageIcon = function(name) {
	...
	if (name === "home") return "glyphicon glyphicon-home";
...
define('syracuse-tablet/html/js/helpers/prototype',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/helpers/logger','syracuse-tablet/html/js/application/gadget','syracuse-tablet/html/js/sdata/sdataUtils','syracuse-tablet/html/js/ui/fontUtils'],function (require, exports, module) {
var utils = require('syracuse-tablet/html/js/helpers/utils');
...
var _Prototype = utils.defineClass(function(json, parent) {
	...
	getPrototype: function(prop, override) {
		if (prop === "$item") {
			...
			if (this.isSingleArray(true)) {
				...
				newJson.$properties[_SINGLEARRAYPROP] = json;
				json = newJson;
			}
		} else {
	...
	toArticle: function() {
		...
		for (var prop in props) {
			if (props[prop].$isExcluded !== true) {
				...
				if (forceNoTitle) {
					p.$isTitleHidden = forceNoTitle;
				}
				article.$items.push(p);
			}
		}
		return article;
	},
	...
	isSingleArray: function(noFail) {
		...
		if (jsonArray == null || jsonArray.$type !== "application/x-array") {
			if (noFail) return false;
			throw new Error("Unexpected parent array");
		}
		this.$singleArray = jsonArray.$item.$properties == null || jsonArray.$item.$type == "application/x-reference";
 ...
 */
exports.ROWIDXPROP = _ROWIDXPROP;
...
define('syracuse-tablet/html/js/helpers/constants',['require','exports','module'],function (require, exports, module) {

exports.DASHBOARD_PAGE_FACET = "$mobileDashboard";
});

define('syracuse-tablet/html/js/application/pageHelper',['require','exports','module','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/sdata/entities/clientContract','syracuse-tablet/html/js/helpers/prototype','syracuse-tablet/html/js/helpers/constants'],function (require, exports, module) {
...
var _getRowdetailPage = function(state, options, currentPage) {
	...
	// Page name used to store the page - current page name + control name
	var name = currentPage.state.name + "." + ctrl.$bind;
...
var _registerDashboard = function(id, meta, appMetaData) {
	var info = $.extend(true, {}, _getDefPageInfo(meta.$dashboardName + "." + constants.DASHBOARD_PAGE_FACET, "dashboard"), meta.$pageInfo);
		...
		.then(function(wc) {
			...
			return exports.savePageDefinitionWC(opts, send)
				.then(function(wcSaved) {
					return $.extend(true, {}, wc, wcSaved);
				});
		});
};
});

define('syracuse-tablet/html/js/authoring/properties',['require','exports','module','syracuse-tablet/html/js/helpers/locale'],function (require, exports, module) {var locale = require('syracuse-tablet/html/js/helpers/locale');
...
define('syracuse-tablet/html/js/authoring/authoringHelpers',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/helpers/locale','syracuse-tablet/html/js/authoring/authoringSData','syracuse-tablet/html/js/ui/modal','syracuse-tablet/html/js/authoring/properties'],function (require, exports, module) {
...
define('syracuse-tablet/html/js/authoring/authoring',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/helpers/locale','syracuse-tablet/html/js/helpers/notifications','syracuse-tablet/html/js/authoring/authoringHelpers','syracuse-tablet/html/js/ui/modal','syracuse-tablet/html/js/authoring/properties'],function (require, exports, module) {
...
var _template = '\
	...
	<div class="tab-content"> \
		<div id="authPanelControl" class="tab-pane panel-body active"> \
			...
			<ul class="nav nav-pills" role="tablist"> \
				<li class="active"><a href="#authPanelControlSimple" role="tab" data-toggle="tab">{{label_simple}}</a></li> \
				<li><a href="#authPanelControlExpert" role="tab" data-toggle="tab">{{label_expert}}</a></li> \
			</ul> \
			<div class="tab-content"> \
				<div id="authPanelControlSimple" class="tab-pane panel-body"> \
					simple tab \
				</div> \
					<div id="authPanelControlExpert" class="tab-pane panel-body"> \
...
var AuthInterface = utils.defineClass(function() {
	...
	showAuthoringPanel: function() {
		...
		if (self.$$authPanelRight && self.$$authPanelRight.is(":visible")) {
			...
			self._showAuthPanel();
			self._displayAuth(globals.getApplicationJson().currentPage);
		}
	},
	...
	_initJSONArticles: function() {
		...
		self.$$authPanelControlSimple.empty();
	},
	...
	selectionChangeHandler: function(sel) {
		...
		var props = authProps.getProperties(sel.$$elmt);
		console.log(props);
	},
	...
	_updateLayoutPage: function() {
		var self = this;
		var page = globals.getApplicationJson().currentPage;
...
var _Application = utils.defineClass(
	function($$elmt, factory) {
		...
		getTitle: function() {
			return this.dao.getApplicationJsonName();
		},
		...
		notifSwitchApp: function(appName) {
			...
			try {
				var appInfo = globals.getValidApplications()[appName];
				/* Todo - check if application changed with id and timestamp */
				if (!appInfo) throw new Error("notifSwitchApp - NULL appInfo (" + appName + ")");
				log && log("Switch to Syracuse Mobile Application " + appName);
				if (self.currentPage) {
		...
		back: function(state) {
			...
			if (self.homePageId === "$welcomeDashboard." + constants.DASHBOARD_PAGE_FACET) {
				return;
			}
			if (!state) {
				throw new Error("Back", "Unexpected null history state");
			}
			if (state.name === "$welcomeDashboard." + constants.DASHBOARD_PAGE_FACET) {
		...
		gotoWelcomeApplication: function() {
			var self = this;
			var welcomeApp = globals.getValidApplications()['$welcomeApplication'];
			return settings.getMyApplicationDetail(welcomeApp).then(function(appDetail) {
				self.dao.setApplication(appDetail);
	...
	switch (type) {
		...
		case _types.array:
			if (prototype.data("$cube")) {
				...
				c = new _ctor.ArrayQuery(controller, article, prototype, options);
			} else if (prototype.isLookup()) {
				c = new _ctor.ArrayLookup(controller, article, prototype, options);
			} else {
				// Child array
...
var _Parser = utils.defineClass(
	function(page) {
		...
		doParse: function($article, prototype, parent, layoutPath) {
			var self = this;
			var num = 0;
			if ($article.$layoutType) {
				...
				if (lyt && $article.$items) {
					$article.$items.forEach(function($itm) {
						self.doParse($itm, prototype, lyt, layoutPath + "-" + num);
						num++;
					});
				}
				return lyt;
		...
		parse: function($article, prototype, opts) {
			...
			try {
				...
				return self.doParse($article, prototype, null, (opts && opts.layoutPath) || "0");
			} catch (e) {
...
define('syracuse-tablet/html/js/pages/page',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/helpers/logger','syracuse-tablet/html/js/ui/uiUtils','syracuse-tablet/html/js/helpers/articleParser','syracuse-tablet/html/js/controls/ctrlFactory','syracuse-tablet/html/js/helpers/notifications'],function (require, exports, module) {
...
var _templates = {
	fullpage: '\
		<section class="s-m-page s-m-full {{type}} {{subtype}}" id="{{pageid}}" data-appid="{{appid}}" {{#if parentId}}data-parent-id="{{parentId}}"{{/if}} class="ctrl-event-click" style=""> \
			<header></header> \
...
var _Page = utils.defineClass(
	function($$parent, state, prototype, article, options) {
		...
		destroy: function() {
			var self = this;
			console.log('destroy page ' + self.state.name);
			self.destroyLayout();
			if (self.onResizeHandler) {
		 ...
		 * options:
		 * 			dontLoadData:	true to not load the data
		...
		loadStructure: function() {
			...
			try {
				...
				self.rootLayout = articleParser.article2Controls(self, self.article, self.prototype, {
					layoutPath: self.state && self.state.options && self.state.options.layoutPath
				});
				deferred.resolve();
			} catch (e) {
				deferred.reject(e);
		...
		/**
		 * Destroy content to be restored updateLayout
		 * TODO - Review FDB
		 */
		...
		updateLayout: function(article) {
			...
			return $.smResolve()
				.then(function() {
					return self.destroyLayout();
				})
				.then(function() {
					return self._initStaticControls();
				})
				.then(function() {
					return self.load({
						dontLoadData: true
		...
		afterRender: function() {
			...
			// Trigger resize to fit chart to vignettes
			setTimeout(function() {
		 ...
		 * currentPage is the page ths will be replaced by this
		...
		resizeHandler: function() {
			var $$charts = $(".s-m-chart-slot");
			for (var i = 0; i < $$charts.length; i++) {
				var chartSlot = $$charts[i];
				var $$cs = $(chartSlot);
				$$cs.show();
				var chart = $$cs.highcharts();
				if (chart) {
					chart.setSize($$cs.width(), $$cs.height(), false);
				}
			}
		},
...
/* Regsuiter page to allow smInstanceOf ("page)*/
globals.registerClass(_Page, "page");
exports.Page = _Page;
});
...
var _Page = utils.defineClass(
	function($parent, state, prototype, article) {
		...
		_beforeAddContent: function() {
			var self = this;
			if (!self.isVignette) self.addTitle(globals.getApplicationJson().getTitle() + " - " + self.prototype.data("$title"));
		},
		...
		notifLookupSelection: function(rowData, controlId) {
			...
			try {
				...
				utils.modalError("notifLookupSelection failed", e);
			}
		},
		/** Event sm.action.link
		...
		notifActionLink: function(success, link, result) {
			...
			try {
				...
				utils.modalError("notifActionLink failed", e);
			}
		},
		_displayActionMsg: function(success, name, data, cb) {
			...
			modal.info("Action " + name + (success ? " succeeded" : "failed") + '\n' + this.id, data, cb);
		}
	});
...
define('syracuse-tablet/html/js/pages/pageLookup',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/helpers/notifications','syracuse-tablet/html/js/pages/pageRegular','syracuse-tablet/html/js/application/eventListener'],function (require, exports, module) {
...
define('syracuse-tablet/html/js/pages/html/pageLogin',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/pages/page','syracuse-tablet/html/js/application/authentication','syracuse-tablet/html/js/helpers/notifications','syracuse-tablet/html/js/helpers/locale'],function (require, exports, module) {
	...
	function($parent, state) {
		...
		buildHtmlContent: function() {
			...
			try {
				var html = [];
				if (self.appList) {
					var curApp = globals.getApplicationJson();
...
var _Dao = utils.defineClass(
	function(appli) {
		...
		getApplicationJsonName: function() {
			var self = this;
...
define('syracuse-tablet/html/js/application/appFactoryDeps',['require','exports','module','syracuse-tablet/html/js/application/application','syracuse-tablet/html/js/pages/pageDashboard','syracuse-tablet/html/js/pages/pageRegular','syracuse-tablet/html/js/pages/pageRowDetail','syracuse-tablet/html/js/pages/pageLookup','syracuse-tablet/html/js/pages/html/pageLogin','syracuse-tablet/html/js/pages/html/pageSettings','syracuse-tablet/html/js/pages/html/pageAbout','syracuse-tablet/html/js/application/daoApp','syracuse-tablet/html/js/application/daoSdata','syracuse-tablet/html/js/application/appFactory'],function (require, exports, module) {
...
var _Klass = utils.defineClass(
	function(controller, $type, article, options) {
		...
		createRootElement: function(css, $$parent) {
			var self = this;
			var e = self.setRootElement(uiUtils.createDomElement("div", css, null, {
				"id": self.id
			}), $$parent);
			return e;
		},
		setRootElement: function(e, $$parent) {
			...
			e.attr("data-layout-path", self.options.layoutPath);
			return e;
		}
	}
);
...
define('syracuse-tablet/html/js/controls/field/ctrlFieldBase',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/controls/ctrlBase','syracuse-tablet/html/js/ui/uiUtils','syracuse-tablet/html/js/helpers/locale','syracuse-tablet/html/js/helpers/formatApi','syracuse-tablet/html/js/controls/validator'],function (require, exports, module) {
...
define('syracuse-tablet/html/js/controls/field/ctrlNumeric',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/controls/field/ctrlFieldBase','syracuse-tablet/html/js/controls/validator','syracuse-tablet/html/js/helpers/locale','syracuse-tablet/html/js/ui/uiUtils'],function (require, exports, module) {
...
define('syracuse-tablet/html/js/controls/field/ctrlQuantity',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/controls/field/ctrlFieldBase','syracuse-tablet/html/js/helpers/formatApi','syracuse-tablet/html/js/ui/uiUtils','syracuse-tablet/html/js/controls/ctrlFactory'],function (require, exports, module) {
			...
			if (self.$isEditMode) {
				...
				if (self.choiceList.length > 0) {
					...
					// default format is '$combo'
						...
						// build list
						$.each(self.choiceList, function(index, choiceItem) {
							var parsedTitle = choiceItem.$title.indexOf("{") < 0 ? choiceItem.$title : utils.parseExpression(choiceItem.$title, self.dao, self.prototype);
...
var _Klass = utils.defineClass(
	...
	function(controller, article, prototype, options) {
		...
		applyMetaData: function(metaData) {
			var self = this;
			Base.prototype.applyMetaData.call(self, metaData);
...
define('syracuse-tablet/html/js/controls/array/arrayBase',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/controls/ctrlBase','syracuse-tablet/html/js/ui/uiUtils','syracuse-tablet/html/js/ui/modal'],function (require, exports, module) {
		...
		getRowDetailDao: function(params) {
			...
			switch (params.activity) {
				...
				case "display":
					...
					break;
				case "create":
					console.log(self.controller.prototype.data("$url"));
					throw new Error("CREATE ROW -> We need to call the server to get an empty record");
					break;
				default:
...
define('syracuse-tablet/html/js/controls/array/builderBase',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/ui/uiUtils','syracuse-tablet/html/js/ui/fontUtils','syracuse-tablet/html/js/sdata/sdataUtils','syracuse-tablet/html/js/controls/ctrlFactory'],function (require, exports, module) {
 ...
 * type: 	grid / card
 * 			used to propagate the context in build html for child controls
 */
var _Klass = utils.defineClass(
	function(control, type, options) {
		...
		isExcluded: function(item) {
			return item == null || item.$isExcluded === true || _isExcluded.indexOf(item.$type) >= 0;
		},
		 ...
		 */
		appendField2Cell: function($$parent, fieldName, fieldProto, rowData) {
			var self = this;
...
define('syracuse-tablet/html/js/controls/array/builderGrid',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/controls/array/builderBase','syracuse-tablet/html/js/ui/uiUtils','syracuse-tablet/html/js/helpers/prototype','syracuse-tablet/html/js/ui/modal','syracuse-tablet/html/js/application/daoSdata'],function (require, exports, module) {
	...
	function(control, options) {
		...
		_createColumnInfo: function(options) {
			...
			var edit = self.control.controller.isEditMode(),
				overflow = self.columnInfo.length != cols.length;
		...
		_buildTableHead: function(root, options) {
			...
			self.columnInfo.forEach(function(col) {
				...
				uiUtils.createDomElement('th', col.css, title, null, tr);
			});
		},

		_buildTableFoot: function(root, options) {
			var self = this;
			if (self.control.controller.isEditMode()) {
				var cell = $('<tfoot><tr><td colspan="' + self.columnInfo.length + '"></td></tr></tfoot>').appendTo($(root)).find("td");
		...
		_buildTableRow: function(tabBody, rowData, idx, options) {
			...
			self.columnInfo.forEach(function(col, idx) {
				...
				fieldProto = col.$activity != null ? self._getOtherColProto(col, rowData.getValue("$uuid")) : col.$item;
...
/**
 * Array control for a DETAIL/EDIT FACET
 * TODO - Merge with arrayStd if nothing special except readArrayData
 */
var _Klass = utils.defineClass(
	function(controller, article, prototype, options) {
		var self = this;
		Base.call(self, controller, article, prototype, options);
		self.setBuilder(new builderGrid(self, options));
	}, Base, {

		readArrayData: function(controllerDao) {
			return controllerDao.getArrayData(this.$bind, this.prototype);
		}
	});
...
var _Klass = utils.defineClass(
	function(control, options) {
		var self = this;
		Base.call(self, control, "card", options);
		/*
...
var _Klass = utils.defineClass(
	function(controller, article, prototype, options) {
		...
		if (self.controller.isVignette) {
			...
			self.setBuilder(new builderCardHoriz(self, options));
		} else {
			self.setBuilder(new builderGrid(self, options));
		}
	}, Base, {
...
define('syracuse-tablet/html/js/controls/array/builderLookup',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/controls/array/builderGrid','syracuse-tablet/html/js/ui/uiUtils'],function (require, exports, module) {

var utils = require('syracuse-tablet/html/js/helpers/utils');
var Base = require('syracuse-tablet/html/js/controls/array/builderGrid').Klass;
var uiUtils = require('syracuse-tablet/html/js/ui/uiUtils');

/**
 * x-array control class for lookup
 *
 */
var _Klass = utils.defineClass(
	function(control, options) {
...
define('syracuse-tablet/html/js/controls/array/arrayLookup',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/controls/array/arrayBase','syracuse-tablet/html/js/controls/array/builderLookup'],function (require, exports, module) {

var utils = require('syracuse-tablet/html/js/helpers/utils');
var Base = require('syracuse-tablet/html/js/controls/array/arrayBase').Klass;
var builder = require('syracuse-tablet/html/js/controls/array/builderLookup').Klass;
...
var _Klass = utils.defineClass(
	function(controller, article, prototype, options) {
		var self = this;
		Base.call(self, controller, article, prototype, options);
		self.setBuilder(new builder(self, options));
	}, Base, {

		readArrayData: function(controllerDao) {
			return controllerDao.getLookupData(this.prototype);
		}
...
define('syracuse-tablet/html/js/controls/layout/layoutStack',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/controls/layout/layoutBase','syracuse-tablet/html/js/ui/uiUtils'],function (require, exports, module) {
...
var _Klass = utils.defineClass(
	function(controller, type, article, opts) {
		 ...
		 * CSS-DEPENDEND: Needs to be adjusted on major size or page layout changes
		 */
		self.pageContentHeightSubstraction = 200;
		self.minLandscapeHeight = 550;
	}, Base, {
		...
		_buildCellStructure: function(controllerDao, buildOptions) {
			...
			self.children.forEach(function(layout) {
				...
				if (!cell) {
					...
					cell.domItem = uiUtils.createDomElement("div", ["s-m-tile-wrapper"], null, null, self.$$elmt);
					self.cells.push(cell);
				}
				if (size === "small") {
					layout.buildHtml($(cell.domItem), controllerDao, buildOptions);
					layout.domItem = layout.$$elmt[0];
...
define('syracuse-tablet/html/js/controls/layout/layoutTile',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/controls/layout/layoutBase','syracuse-tablet/html/js/ui/uiUtils'],function (require, exports, module) {
...
var _Klass = utils.defineClass(function(controller, type, article, opts) {
	...
	buildHtml: function($$parent, controllerDao, buildOptions) {
		...
		var color = self.article.$tileColor;
		if (!color) {
			color = "lime";
		}
		self.$$elmt.addClass("tile-" + color);
		$.each(self.children, function(index, child) {
			child.buildHtml(self.$$elmt, controllerDao, buildOptions);
		});
	}
...
var _Klass = utils.defineClass(
	...
	function(controller, article, prototype, opts) {
		...
		changePage: function(state, options) {
			...
			return this._loadPage(state, options);
		},
		/**
		 * Refresh current page - called from eventListener
		 */
		...
		_loadRepresentation: function(gadget, name, options) {
			...
			options.layoutPath = self.options.layoutPath + "-0";
							...
							{{#if showLinks}} \
								...
								<li>\
									<a href="#" data-action="switchContext"> \
										<span class="' + fontUtils.pageIcon("switchContext") + '" /> {{user}}\
									</a>\
								</li>\
							{{/if}} \
						</ul>\
...
define('syracuse-tablet/html/js/controls/page/actionManager',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/sdata/sdataUtils','syracuse-tablet/html/js/ui/modal','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/sdata/sdataDispatcher','syracuse-tablet/html/js/sdata/sdataUtils','syracuse-tablet/html/js/ui/fontUtils','syracuse-tablet/html/js/helpers/notifications'],function (require, exports, module) {
...
var _Klass = utils.defineClass(
	...
	function(options) {
				...
				if (self.getLinks().some(function(l) {
					...
					if (link.$confirm) {
						...
						if (self.options.noRedirection === true) {
							...
							globals.getApplicationJson().changePage(link.page, pageOpts);
						}
					} else {
		...
		_doLinkAction: function(link, control) {
			...
			var deferred = $.Deferred();
			try {
				var payload = control ? control.getDao().getActionPayload(link) : null;
				dispatcher.dispatch({
					$url: link.sdataurl,
					...
					if (!utils.isError(e) && $.isPlainObject(e)) {
						// $diagnose
...
define('syracuse-tablet/html/js/controls/page/ctrlPageFooter',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/sdata/sdataUtils','syracuse-tablet/html/js/controls/structElmt','syracuse-tablet/html/js/ui/modal','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/sdata/sdataDispatcher','syracuse-tablet/html/js/sdata/sdataUtils','syracuse-tablet/html/js/controls/page/actionManager','syracuse-tablet/html/js/ui/fontUtils'],function (require, exports, module) {
	...
	leftpanel: '\
		<li style="display:none">\
			<a href="#" data-action="sidePanel" data-params="toggle,left">\
				<span class="' + fontUtils.pageIcon("sidePanel") + '"/>\
			</a>\
		</li>',
	rightpanel: '\
		<li style="display:none">\
...
var _Klass = utils.defineClass(
	...
	function(controller, $type, options) {
		 ...
		 * template: is the template to open
		 * 		 		ex: home ->  leftHome to go to home page
		 * 					panel -> rightPanel or leftPanel to open/close the panel
		 * To improve according to the needs
		 */
		enablePanel: function(panel, template) {
			var self = this;
			if (!self.$$elmt || template == null || template.length == 0) return;
		...
		_actFooterLink: function(uuid) {
			...
			self.actionManager.triggerLink(uuid, self).then(function() {
				...
				if (utils.isError(e)) {
					...
					utils.modalError("Footer action error", e);
				}
			});
		}
	});
...
var _Klass = utils.defineClass(
	...
	function(controller, $type, side, options) {
		...
		publishReady: function(data) {
			notifications.publish("sm.side.panel.ready", this.$type, data);
		},
...
var _Klass = utils.defineClass(
	...
	function(controller, $type, options) {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			var self = this;
			self.actionManager = new ActionManager({
				$links: self.controller.prototype.getLinks(self.getDao(), "hidden"),
				noMessage: false
			});
			var context = {
				title: "Actions",
	...
	function(controller, $type, options) {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			...
			var curApp = globals.getApplicationJson(),
				title;
			try {
				self.apps = globals.getValidApplications();
				var actionsHtml = [];
				Object.keys(self.apps).forEach(function(name, idx) {
					...
					if (curApp.uuid != app.$uuid) {
						...
						title = app.title || app.applicationName;
					}
				});
				var context = {
		...
		afterRender: function() {
			...
			self.publishReady(isWelcomeApp ? "" : isMobileAppHomePage ? "reload" : self.appCount ? "panel" : "home");
		},
...
var _Klass = utils.defineClass(
	...
	function(controller, article, prototype) {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			var self = this;
			self.createRootElement(["s-m-control s-m-field s-m-unknown"], $$parent).text("Unknown type: " + self.$type);
		}
	}
);
...
define('syracuse-ui/themes/desktop/sage/highcharts/theme',['require','exports','module'],function (require, exports, module) {var theme = {
	//colors P5: ['#BF7070','#BFB730','#7ABF30','#7373FF','#BF7730','#BF3080','#30BF9F','#FF7373','#FFF773','#85FF00','#3030BF','#FF9F40','#FF40BC','#1699A6','#FF0000','#FFF100','#00FF00','#0000FF','#FF7F00','#FF00A6','#00FFC6','#A60000','#A69C00','#56A600','#90B2FF','#A65200','#A6006C','#00A681','#FF4040','#FFF440','#A3FF40','#3673FF','#FFB873','#FF76CE','#73FFED'],
	
colors: [// Sage brand colors:bright green, orange,blue,sage green,dark gey,purple,mid grey
'#41a940',
'#ff5800',
'#009fda',
'#4d4f53',
...
define('syracuse-tablet/html/js/controls/chart/ctrlCubeChartBase',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/controls/ctrlBase','syracuse-tablet/html/js/helpers/formatApi','syracuse-tablet/html/js/controls/chart/ctrlCubeChartTheme','syracuse-tablet/html/js/helpers/locale','syracuse-ui/themes/desktop/sage/highcharts/theme'],function (require, exports, module) {
	...
	function(controller, article, prototype, options) {
		...
		_buildEditBinaryField: function(parentSlot, docUrl, empty) {
			...
			if (self.isImage) {
				...
				// *document* core
				core = uiUtils.createDomElement("span", [fontUtils.binaryIcon(self.cssType, "default"), "s-m-doc"], null, null, core);
...
define('syracuse-tablet/html/js/controls/ctrlIcon',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/ui/fontUtils','syracuse-tablet/html/js/ui/uiUtils','syracuse-tablet/html/js/controls/ctrlBase'],function (require, exports, module) {
...
var _Klass = utils.defineClass(
	...
	function(controller, article, prototype) {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			var self = this;
			var classes = ["s-m-control s-m-icon"];
			self.createRootElement(classes, $$parent);
			self.$$elmt.html(ctrlBase.genHtmlCtrlLink(self.prototype, {
				tag: 'a',
				css: ''
			}, function(html) {
...
define('syracuse-tablet/html/js/controls/ctrlButton',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/ui/fontUtils','syracuse-tablet/html/js/ui/uiUtils','syracuse-tablet/html/js/controls/ctrlBase'],function (require, exports, module) {
...
var _Klass = utils.defineClass(
	...
	function(controller, article, prototype) {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			var self = this;
			var classes = ["s-m-control s-m-btn"];
			self.createRootElement(classes, $$parent);
			self.$$elmt.html(ctrlBase.genHtmlCtrlLink(self.prototype, {
				tag: 'button',
...
define('syracuse-tablet/html/js/controls/chart/ctrlGaugeChart',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/helpers/locale','syracuse-tablet/html/js/controls/field/ctrlFieldBase','./chartstheme'],function (require, exports, module) {
...
var _Klass = utils.defineClass(function(controller, article, prototype, opts) {
	var self = this;
	Base.call(self, controller, article, prototype, opts);
	self.formatter = self.initFormatter();
	// css to add to fieldSlot elmt
...
var Gauge = require('syracuse-tablet/html/js/controls/chart/ctrlGaugeChart').Klass;
...
function _updateWelcomeDashboard(dashboard, appMetaData) {
	...
	Object.keys(apps).forEach(function(appName) {
		...
		if (app.applicationName !== appMetaData.$application.applicationName) {
	...
	notifLogin: function(userProfile, deferred) {
		var _fail = function(e) {
			if (deferred) {
				...
				utils.modalError("notifLogin failed", e);
			}
		};
		try {
			var userCtx = {
		...
		return auth.check()
			...
			.then(function(profile) {
				...
				auth.logout().then(function() {
					...
					utils.modalError("exports.init failed", e);
				});
			});
	} catch (e) {
...
function _startup() {
	return initStyles.init()
		...
		.then(function() {
			...
			utils.modalError("_startup error", e);
		});
}
