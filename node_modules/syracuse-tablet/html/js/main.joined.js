...
var _Klass = utils.defineClass(
	function(control, options) {
		...
		buildHtml: function(arrayData, buildOptions) {
			...
			Base.prototype.buildHtml.call(self, arrayData, buildOptions);
			if (!self.$article) return;
			var cardsPerLine = self.$article.$cardsPerLine;
				...
				"$items": [{
					...
					"$items": [{
						...
						"$article": {
							...
							"$items": [{
								"$bind": "$resources",
								"$title": "QUERY - $display=cardH - $cardsPerLine=1 - $displayEmptyCells=true",
								"$article": {
									"$display": "cardV",
				...
				"$items": [{
					...
					"$items": [{
						...
						"$article": {
							...
							"$items": [{
								"$bind": "$resources",
								"$title": "$display=cardV - $cardsPerRow=2 - $displayEmptyCells=true",
								"$article": {
									"$display": "cardV",
									"$displayEmptyCells": true,
									"$cardsPerRow": 2,
				...
				"$items": [{
					...
					"$items": [{
						...
						"$article": {
							...
							"$items": [{
								"$bind": "$resources",
								"$title": "$display=cardH - $cardsPerLine=1 - $displayEmptyCells=true",
								"$article": {
									"$cardsPerLine": 1,
									"$displayEmptyCells": true,
									"$display": "cardH",
					...
					"$items": [{
						...
						"$article": {
							...
							"$items": [{
								"$bind": "$resources",
								"$title": "$display=cardH - $cardsPerLine=3 - $displayEmptyCells=true",
								"$article": {
									"$cardsPerLine": 3,
									"$displayEmptyCells": true,
									"$display": "cardH",
