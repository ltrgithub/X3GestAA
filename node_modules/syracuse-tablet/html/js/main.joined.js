...
var _Page = utils.defineClass(
	function($parent, state, prototype, article, options) {
		...
		loadData: function(options) {
			...
			var rowDao = ctrl.rowDetailGetDao(self.state.options.dataParams);
 ...
 * 		$addEmptyCells 		Display or not empty cells true by default
 */
var _Klass = utils.defineClass(
	function(control, options) {
		var self = this;
		...
		buildHtml: function(arrayData, buildOptions) {
			...
			if (true || cardsPerRow > 1) {
				...
				var dispEmpty = self.$article.$addEmptyCells;
...
var _Klass = utils.defineClass(
	function(controller, article, prototype, options) {
		 ...
		 **/
		rowDetailGetDao: function(params) {
			var self = this;
				...
				"$items": [{
					...
					"$items": [{
						...
						"$article": {
							...
							"$items": [{
								"$bind": "$resources",
								"$title": "$display=cardV - $cardsPerRow=3 - $addEmptyCells=true",
								"$article": {
									"$cardsPerRow": 3,
									"$addEmptyCells": true,
									"$display": "cardV",
