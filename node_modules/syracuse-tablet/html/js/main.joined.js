...
var _deviceSizes = {
	...
	sm: { // iPad portrait
		width: 768, //// Bootstrap changes at min 768,
		height: 1024,
	},
	md: { // 7" tablet landscape (Nexus 7), Ipad 2 landscape 
		width: 1024, // Bootstrap changes at min 992,
		height: 768
	},
	lg: { // 10" tablet landscape (Nexus 10)
		width: 1200,
		height: 800
	}
}
...
function _layoutMainContainers() {
	...
	if (authoringActive === true) {
		...
		var device = _layoutParameters.authoringParameters.device || "lg";
		var template = _deviceSizes[device] || _deviceSizes["ld"];
		appView = {
			left: 0,
			top: 0,
	...
	authPanelLeftStructure: '\
		<div class="s-m-site-auth-panel-content"> \
			<div class="btn-group btn-group-justified" data-toggle="buttons" id="auth_device_size"> \
				<div class="btn-group"> \
					<label class="btn btn-primary"> \
						<input type="radio" name="device_options" id="auth_device_xs">{{label_vsmall}} \
					</label> \
				</div> \
				<div class="btn-group"> \
					<label class="btn btn-primary"> \
						<input type="radio" name="device_options" id="auth_device_sm">{{label_small}} \
					</label> \
				</div> \
				<div class="btn-group"> \
					<label class="btn btn-primary"> \
						<input type="radio" name="device_options" id="auth_device_md">{{label_medium}} \
					</label> \
				</div> \
				<div class="btn-group"> \
					<label class="btn btn-primary active"> \
						<input type="radio" name="device_options" id="auth_device_lg" checked>{{label_large}} \
					</label> \
				</div> \
			</div> \
		</div>',
