 ...
 * All layouts will be updated if orientation has changed
 */
 ...
 */
exports.triggerResizeInternal = function() {
...
var _templates = {
	authPanelMainStructure: '\
		...
		<div class="tab-content"> \
			<div id="authPanelControl" class="tab-pane panel-body active"> \
				<ul class="list-group"> \
					<li id="authPanelControlTitle"></li> \
					<li id="authPanelControlType"></li> \
				</ul> \
				<ul class="nav nav-pills" role="tablist"> \
	...
	authPanelPropertyRadio: ' \
		<div class="btn-group" data-toggle="buttons"> \
			{{#each options}} \
				<div class="btn-group s-m-btn-col-2"> \
	...
	authPanelPropertyRadioColor: ' \
		<div class="btn-group" data-toggle="buttons"> \
			{{#each options}} \
				<div class="btn-group s-m-btn-col-2"> \
					<label class="btn btn-color-{{color}}" id="{{this.id}}_lab" data-s-m-auth-value="{{this.value}}"> \
						<input type="radio" name="{{group}}" id="{{this.id}}">{{this.label}} \
					</label> \
				</div> \
			{{/each}} \
...
define('syracuse-tablet/html/js/authoring/authoringProperties',['require','exports','module','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/helpers/locale','syracuse-tablet/html/js/authoring/authoringHtml','syracuse-tablet/html/js/helpers/notifications'],function (require, exports, module) {
...
exports.getProperties = function(sel) {
...
exports.createPropertyPanel = function($$parent, sel, data) {
	var props = authProps.getProperties(sel);
	if (!props) {
		return;
	}
...
define('syracuse-tablet/html/js/authoring/authoringLayout',['require','exports','module'],function (require, exports, module) {

/*
 * Calculate layout of authoring panel
 */
exports.updateLayout = function(panel) {
	var width = $(window).width();
	var height = $(window).height();

	if (panel.$$authPanelRight.is(":visible")) {
		var panelWidth = panel.$$authPanelRight.width();
		panel.$$authPanelRight.css("left", width - panelWidth + "px");
		panel.$$authPanelRight.css("height", height + "px");
		
		$("#s-m-app-id").css("width", width - panelWidth + "px");

		panel.$$authPanelRight.find(".tab-pane").css("height", height - 150 + "px");
		panel.$$authJSONPage.css("height", (height - 220) + "px");
		panel.$$authJSONSelection.css("height", (height - 250) + "px");
		panel.$$authPanelControlSimple.css("height", (height - 270) + "px");
		panel.$$authPanelControlExpert.css("height", (height - 250) + "px");
	}
	else
	{
		$("#s-m-app-id").css("width", width + "px");
	}
}

});

define('syracuse-tablet/html/js/authoring/authoring',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/helpers/locale','syracuse-tablet/html/js/helpers/notifications','syracuse-tablet/html/js/authoring/authoringHelpers','syracuse-tablet/html/js/ui/modal','syracuse-tablet/html/js/authoring/authoringProperties','syracuse-tablet/html/js/authoring/authoringHtml','syracuse-tablet/html/js/authoring/authoringLayout','syracuse-tablet/html/js/ui/uiUtils'],function (require, exports, module) {
...
var AuthInterface = utils.defineClass(function() {
	...
	notifAuthChangePropUi: function(sel, data) {
		...
		authLayout.updateLayoutPage(sel);
	},
...
define('syracuse-tablet/html/js/helpers/siteLayout',['require','exports','module','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/authoring/authoring','syracuse-tablet/html/js/authoring/authoringLayout'],function (require, exports, module) {
...
define('syracuse-tablet/html/js/application/eventListener',['require','exports','module','syracuse-tablet/html/js/helpers/logger','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/ui/modal','syracuse-tablet/html/js/helpers/notifications','syracuse-tablet/html/js/helpers/siteLayout'],function (require, exports, module) {
...
var _bindEvents = function(app) {
	...
	$(window).on("resize", function(evt) {
		siteLayout.updateLayout();
	});
	// resize only page layout
	$(window).on("resizeInternal", function(evt) {
		siteLayout.updateLayout(true);
	});
};
/**
 * Trigger an action
...
define('syracuse-tablet/html/js/init/initContext',['require','exports','module','syracuse-tablet/html/js/helpers/globals','syracuse-tablet/html/js/helpers/locale','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/ui/modalSelectContext','syracuse-tablet/html/js/helpers/notifications','syracuse-tablet/html/js/sdata/sdataCommonResources','syracuse-tablet/html/js/storage/localStorage','syracuse-tablet/html/js/application/settings'],function (require, exports, module) {
...
var _createControl = function(controller, parentStructElmt, article, prototype, options) {
	...
	if (options && options.isTableCell === true) {
...
define('syracuse-tablet/html/js/helpers/prototype',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/helpers/logger','syracuse-tablet/html/js/application/gadget','syracuse-tablet/html/js/sdata/sdataUtils','syracuse-tablet/html/js/ui/fontUtils','syracuse-tablet/html/js/helpers/articleParser'],function (require, exports, module) {
var utils = require('syracuse-tablet/html/js/helpers/utils');
...
var _Prototype = utils.defineClass(function(json, parent) {
	...
	getPrototype: function(prop, override) {
		var json;
		if (false && prop === "$resources") {
			json = this.getDataByPath("$properties.$resources.$item");
		} else if (prop === "$item") {
			json = this.data(prop);
...
var _refreshBrowserHistory = function(app, push) {
	if (window.history.length <= app.browserHistory) {
		window.history.pushState({}, utils.UUID(), null);
	} else {
		window.history.replaceState({}, utils.UUID(), null);
	}
	log && log((push ? "push" : "pop") + " - win=" + window.history.length + " - app=" + app.history.length + " - ref=" + app.browserHistory);
};
/**
 * Subscriptions
 */
var _subscribe = function(self) {
	notifications.subscribe(self, ["sm.context.changed", "sm.switch.app", "sm.modal.open", "sm.modal.close"], 1);
};
/**
...
var _Application = utils.defineClass(
	function($$elmt, factory) {
		...
		// History stack
		self.history = [];
		self.browserHistory = window.history.length;
	}, null, {
		/**
			...
			if (!self._pageLoader) {
				...
				self._pageLoader = new pageLoader.Klass({
					...
					historyPush: function(state) {
						...
						_refreshBrowserHistory(self, true);
					},
			...
			try {
				...
				if (state) {
					if (!state.isWelcomePage && !state.isLogin) {
						...
						if (state) _refreshBrowserHistory(self, false);
					} // if current state is welcome page we goto this page

				}
				setTimeout(function() {
					if (state === null || state.isWelcomePage) {
...
var _Dao = utils.defineClass(
	function(appli) {
		...
		registerAdditionalPage: function(id, proto, article) {
			...
			page.$page = page.$page || {};
			page.$page.$prototype = page.$page.$prototype || proto;
			page.$page.$article = page.$page.$article || article;
			return page;
		}
	});
...
var _Klass = utils.defineClass(
	...
	function(controller, article, prototype, options) {
		...
		if (!options.isTableCell && info && info.unitFieldProto && !info.unitFieldProto.data("$isExcluded")) {
...
define('syracuse-tablet/html/js/controls/array/builderBase',['require','exports','module','syracuse-tablet/html/js/helpers/utils','syracuse-tablet/html/js/ui/uiUtils','syracuse-tablet/html/js/ui/fontUtils','syracuse-tablet/html/js/sdata/sdataUtils','syracuse-tablet/html/js/controls/ctrlFactory','syracuse-tablet/html/js/helpers/articleParser'],function (require, exports, module) {
...
var _Klass = utils.defineClass(
	function(control, type, options) {
		...
		appendField2Cell: function($$parent, fieldName, fieldProto, rowData) {
			...
			ctrlFactory.appendField2Cell($$parent, self.control.controller, articleParser.createArticle(fieldName, fieldProto), fieldProto, rowData);
		}
	});
...
var _Klass = utils.defineClass(
	...
	function(controller, article, prototype, opts) {
		...
		hasBtnsBar: function() {
			return this.openLinkInVignette || this.enableRefresh;
		},
		...
		_loadRepresentation: function(gadget, name, options) {
			...
			options.openLinkInVignette = self.openLinkInVignette;
		...
		refreshBtnsBar: function() {
			var self = this;
			var show = false;
			if (self.$$footer.is(":empty")) {
				$(_getHtml("buttonsBar", self)).prependTo(self.$$footer);
			}
			if (self.openLinkInVignette) {
...
exports.dashboards = {
	"testGridDashboard": {
		"$dashboardName": "testGridDashboard",
		"$title": "Gird authring dashboard",
		"$description": "Test gird authoring",
		"$vignettes": {
			"testAQMDEVICEQuery": {
				"$uuid": "testAQMDEVICEQuery",
				"$displayStyle": "$full"
