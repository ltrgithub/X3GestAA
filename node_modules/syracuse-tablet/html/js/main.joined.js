...
function _layoutMainContainers() {
	...
	var applicationWidth = width - authPanelRightWidth - authPanelRightSplitterWidth;
...
var _properties = {
	...
	// only cardH
	"arrayDisplayEmptyCells": {
		"key": "$displayEmptyCells",
		"default": true,
		values: [{
			value: true
		}, {
...
exports.getProperties = function(sel, data, controller) {
	...
	if ($$elmt.hasClass("s-m-layout")) {
		...
		var displayEmptyCells = _getArrayDisplayEmptyCells(sel, data, controller);
...
//Only for card<xxx>
function _getArrayDisplayEmptyCells(sel, data) {
	var valPos = _getValueOrDefault(_properties.arrayDisplay, sel, data);
	if (valPos === "table") {
		return _propertyValuesHideAll(_properties.arrayDisplayEmptyCells, true);
	} else {
		return _propertyValuesHideAll(_properties.arrayDisplayEmptyCells, false);
	}
}
...
var _Klass = utils.defineClass(
	function(control, options) {
		...
		// Article of control itself with $bind, $isTitleHidden, $cardsPer<xxx>, all that does affact the control itself
