...
var authoringPropertiesGeneral = require('syracuse-tablet/html/js/wc/authoring/authoringPropertiesGeneral');
var authoringPropertiesCtrls = require('syracuse-tablet/html/js/wc/authoring/authoringPropertiesCtrls');
var authoringPropertiesLayouts = require('syracuse-tablet/html/js/wc/authoring/authoringPropertiesLayouts');
var authoringPropertiesPages = require('syracuse-tablet/html/js/wc/authoring/authoringPropertiesPages');
...
exports.getProperties = function(sel, data) {
	...
	var controller = authHelpers.findController($$elmt);
