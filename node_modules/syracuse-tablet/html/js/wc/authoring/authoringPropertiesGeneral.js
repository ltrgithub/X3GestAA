...
// TODO:
var sdataCommonResources = null; // require('syracuse-tablet/html/js/sdata/sdataCommonResources');
var modalTranslationPage = require('syracuse-tablet/html/js/wc/ui/modals/modalTranslationPage');
...
var _properties = {
	...
	"translation": function(controller, sel, data) {
		if (!data.articleSelection.$localization ||
			$.isEmptyObject(data.articleSelection.$localization[authCommons.getCurrentUserLang()])) return null;
		...
		this.onChange = function($$parent, data, event, componentSelect) {
			...
			context.currentLang = {
				'value': authCommons._getCurrentUserLang(),
				'title': getLangDescription(authCommons._getCurrentUserLang(), componentSelect.options.options)
			};
