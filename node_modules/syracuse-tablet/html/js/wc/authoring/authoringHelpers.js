...
exports.saveAuthoring = function(page, opts) {
	...
	return $.smResolve()
		.then(function() {
			...
			isCreation = pageData.variant == null;
		...
		.then(function(data) {
			...
			view = data.$actions.saveAs.$links.$view;
			view.$selected = true;
		...
		.then(function(variants) {
			...
			// Update views in the living page object so they are respected on next save
			page.pageData.page.$views = page.pageData.page.$views || [];
			page.pageData.page.$views.forEach(function(view) {
				view.$selected = false;
			});
			page.pageData.page.$views.push(view);
			return view;
		});
};
