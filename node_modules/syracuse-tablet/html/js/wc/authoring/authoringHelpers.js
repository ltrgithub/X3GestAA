...
exports.getPropertiesVariants = function(page) {
	...
	viewSelected = $.smFind(page.views, function(view) {
...
exports.getPropertiesCurrentVariant = function(page) {
	...
	var viewSelected = $.smFind(page.views, function(view) {
		return view.$selected;
	});
...
exports.rebuildArticleByPageStruct = function(page, states) {
	...
	var rootLayout = page.rootLayout;
	var $localization = page.pageData.article && page.pageData.article.$localization || {};
	var $localizationNew = {};
	var jsonArticlePage = {};
