"use strict";
var authArrayGeneral = require('syracuse-tablet/html/js/wc/authoring/arrays/authArrayGeneral');
var authArrayTable = require('syracuse-tablet/html/js/wc/authoring/arrays/authArrayTable');
var authArrayCard = require('syracuse-tablet/html/js/wc/authoring/arrays/authArrayCard');
var authArrayStatus = require('syracuse-tablet/html/js/wc/authoring/arrays/authArrayStatus');
var authArrayCarousel = require('syracuse-tablet/html/js/wc/authoring/arrays/authArrayCarousel');
var authoringPropertiesChart = require('syracuse-tablet/html/js/wc/authoring/arrays/authoringPropertiesChart');
