...
var authHelpers = require('syracuse-tablet/html/js/wc/authoring/authoringHelpers');
var authoringPanelRight = require('syracuse-tablet/html/js/wc/authoring/authoringPanelRight');
var authoringPanelLeft = require('syracuse-tablet/html/js/wc/authoring/authoringPanelLeft');
var authoringPage = require('syracuse-tablet/html/js/wc/authoring/authoringPage');
var authoringHeader = require('syracuse-tablet/html/js/wc/authoring/authoringHeader');
var authoringFooter = require('syracuse-tablet/html/js/wc/authoring/authoringFooter');
...
var modalSaveAuth = require('syracuse-tablet/html/js/wc/ui/modals/modalSaveAuth');
...
var _authEvents = ["sm.page.loaded", "sm.all.vignettes.loaded", "sm.auth.change.item.prop.ui", "sm.auth.change.prop.ui", "sm.auth.close", "sm.auth.save", "sm.auth.new.layout", "sm.auth.set.page", "sm.auth.display.changed", "sm.auth.undo"];
/*
...
var AuthInterface = utils.defineClass(function AuthoringInterface() {
	...
	enable: function() {
		...
		authHelpers.getPageVariants(page.getAuthoringName()).then(function(variants) {
				...
				self.isActive = true;
				self.isDirty = false;
				authCommons.setAuthoringActive(true);
			})
			.fail(function(e) {
	...
	disable: function() {
		...
		self.isActive = false;
		self._unscribe();
		authCommons.setAuthoringActive(false);
	},
	...
	notifAuthChangeItemPropUi: function(data) {
		...
		//vignetteToUpdt = data.control.page.vignette;
		//TODO: Only update vignette
		//}
	...
	notifAuthSave: function() {
		...
		var propertiesVariantSelected = authHelpers.getPropertiesCurrentVariant(authCommons.getCurrentPage().getArticle());
		...
		var context = {
			...
			variants: authHelpers.getPropertiesVariants(authCommons.getCurrentPage().getArticle()),
		};
	...
	checkBack: function() {
		...
		/*
		var pageType = authCommons.getCurrentPage().state.type;
