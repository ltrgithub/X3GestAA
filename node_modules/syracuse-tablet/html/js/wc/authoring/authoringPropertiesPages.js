...
var authoringActions = require('syracuse-tablet/html/js/wc/authoring/page/authoringActions');
var authoringChartDetail = require('syracuse-tablet/html/js/wc/authoring/page/authoringChartDetail');
...
exports.getModuleProperties = function($$elmt, controller, props, sel, data) {
	...
	if (!page.isCardDetail() && !page.isVignette()) {
