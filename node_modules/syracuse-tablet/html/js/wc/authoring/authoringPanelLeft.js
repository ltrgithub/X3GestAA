...
var authDrag = require('syracuse-tablet/html/js/wc/authoring/authoringDrag');
...
exports.Panel = utils.defineClass(function AuthoringPanelLeft() {
	...
	notifPageLoaded: function(page) {
		var self = this;
		if (authCommons.getCurrentPage().isDashboard()) {
			self._resetContent(authCommons.getCurrentPage().getArticle());
		}
	},
