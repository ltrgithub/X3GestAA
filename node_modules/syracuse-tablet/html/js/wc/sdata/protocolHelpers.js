...
exports.checkTransformDataset = function(appList) {
	var datasetJson = {
		vignettes: [],
		$mobileGadgets: {}
	};
	appList.forEach(function(app) {
		...
		datasetJson.$mobileGadgets[app.$uuid] = {
			...
			"$url": "{$hostPort}/mobile2/syracuse/collaboration/syracuse/mobileApplications(applicationName%20eq%20'" + app.applicationName + "')?representation=mobileApplication.$details&$mobileEndpoint=x3.erp.GX3APP",
			"$method": "GET"
		};
	})
	return datasetJson;
