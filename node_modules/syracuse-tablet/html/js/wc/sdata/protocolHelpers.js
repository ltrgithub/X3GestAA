...
exports.checkTransformDataset = function(appList, endpoint) {
	var datasetJson = {
		vignettes: [],
		$mobileGadgets: {}
	};
	...
	appList.forEach(function(app) {
		...
		datasetJson.$mobileGadgets[app.$uuid] = {
			...
			"$url": "{$hostPort}/mobile2/syracuse/collaboration/syracuse/mobileApplications(applicationName%20eq%20'" + app.applicationName + "')?representation=mobileApplication.$details&$mobileEndpoint=" + endpoint,
			"$method": "GET"
		};
	})
	return datasetJson;
}
exports.defaultHomeArticle = function(datasetJson) {
		var article = {
			"$layoutType": "hub",
			"$items": [{
				"$layoutType": "hubgroup",
