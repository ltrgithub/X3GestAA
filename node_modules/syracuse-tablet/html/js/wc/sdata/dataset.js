...
var Dataset = utils.defineClass(
	...
	null, {
		...
		getLinkDrillDown: function() {
			var path = "$links.$drillDown";
			return this.resolveExpression(this.prototype.getValueByPath(path).$url);
		},
		getLinkLeverUp: function() {
			var path = "$links.levelUp";
			// hack for moment because baseurl is not ok for stat (???)
			return protoHelpers.getHostPort() + this.resolveExpression(this.prototype.getValueByPath(path).$url);
		},
		/** 
