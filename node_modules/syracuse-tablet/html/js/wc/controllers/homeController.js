...
exports.HomeController = utils.defineClass(
	...
	Base, {
		...
		headerFooterToggle: function() {
			...
			//TODO : manage a special footer for smartphone when editing welcome
			if (!isSmartphone && this._footer == null) {
				panelInfo = {
					name: "footerEditHome",
					topIndex: 0,
					selector: "footer",
			...
			if (!isSmartphone) this.uiAdapter.attachedControlsMgr.toggleControls("footerEditHome", "footer")
		},
