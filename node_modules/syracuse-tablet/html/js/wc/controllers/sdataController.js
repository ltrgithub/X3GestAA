...
exports.SdataController = utils.defineClass(
	...
	Base, {
		 ...
		 */
		openLink: function($link, options, loadOptions, $linkName) {
			var self = this;
			...
			function _openLink() {
				...
				if ($url.indexOf("$services") < 0 && $link.$method !== "DELETE") {
					return self.gotoUrl($url, $link.$method, options, loadOptions);
				} else {
		...
		/**
		 * TODO :manage properly context and context propagation
		 */
		getSavedContext: function(propName) {
			this._savedContext = this._savedContext || {};
			return this._savedContext[propName] ? this._savedContext[propName] : this._savedContext;
		},
		setSavedContext: function(propName, ctx) {
			this._savedContext = this._savedContext || {};
			this._savedContext[propName] = this._savedContext[propName] || {}
			this._savedContext[propName] = ctx || {}
			return this._savedContext[propName]
		},
	}
);