...
var _selectors = {
	date: {
		...
		"android": null,
		"ios": null,
		"default": require('syracuse-tablet/html/js/wc/ui/datetimeSelectors/dateSelector').Klass,
		"handler": require('syracuse-tablet/html/js/wc/ui/datetimeSelectors/selectorSwitchHandler').Klass
	},
	datetime: {
		"windows": null,
		"android": null,
		"ios": null,
		"default": require('syracuse-tablet/html/js/wc/ui/datetimeSelectors/datetimeSelector').Klass,
		"handler": require('syracuse-tablet/html/js/wc/ui/datetimeSelectors/selectorSwitchHandler').Klass
	},
	time: {
		"windows": null,
		"android": null,
		"ios": null,
		"default": require('syracuse-tablet/html/js/wc/ui/datetimeSelectors/timeSelector').Klass,
		"handler": require('syracuse-tablet/html/js/wc/ui/datetimeSelectors/selectorSwitchHandler').Klass
	}
};
