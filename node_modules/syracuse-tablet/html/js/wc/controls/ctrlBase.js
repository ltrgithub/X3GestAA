...
var localeModule = require('syracuse-tablet/html/js/wc/helpers/locale');
		...
		getArticleText: function(property) {
			...
			var text = prop && prop.replace(/\{\@(\S+)\}/g, function(m, g) {
				...
				var match = (localization && localization[g]) ||
					...
					($articleLocalizationDashboard && $articleLocalizationDashboard[locale] && $articleLocalizationDashboard[globals.fallbackLocaleCode][g]);
