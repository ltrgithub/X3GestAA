 ...
 * Render array header
 */
exports.RendererHeader = utils.defineClass(
	function rendererHeader(control) {
		...
		render: function() {
			...
			var options = {
				showPagination: true,
				showFilters: this.control._filters.$filtersAllowed(),
				showSortFilter: FiltersSort.filterSortAllowed(this.control),
				showSearch: true // TODO : compute showsearch (authoring etc ...)
			}
			...
			this.control.$$elmt.append(this.$$elmt);
			this.update();
			return this.$$elmt;
		},
