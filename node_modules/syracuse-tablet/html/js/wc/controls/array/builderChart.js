...
exports.BuilderChart = utils.defineClass(
	function builderChart(control) {
		...
		buildHtml: function(arrayData, $$parent, refresh) {
			var self = this
			Base.prototype.buildHtml.call(this, arrayData, $$parent, refresh);
		...
		_displayChart: function(refresh) {
			var self = this;
			...
			setTimeout(function() {
				...
				var updtScroller = false; // TODO
				if (updtScroller && stackPage) {
					// Needed to update the scroller
					notifications.notifyController("sm.scroller.update", stackPage);
				}
			}, 10);
		},
