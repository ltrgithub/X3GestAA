	...
	function builderCarousel(control) {
		...
		buildCardH: function(visibleTds, bs, parentH, parentW) {
			...
			if (!this._$$footer) {
				...
				this._$$footer.on("click", hammerScroller.Hammer.bindFn(this._onClickFooter, this))
			}
		...
		initScroller: function($$container) {
			...
			if (this._getInterval() > 0) {
				this._timeout = setTimeout(hammerScroller.Hammer.bindFn(this._onTimeout, this), this._getInterval());
			}
		},
