...
exports.CtrlComplexArray = utils.defineClass(
	function CtrlComplexArray(controller, article, prototype, options) {
		...
		savedCtxCreate: function(opts) {
			...
			var searchCtx = this._search ? this._search.savedCtxCreate(opts) : null;
			if (searchCtx) {
		...
		savedCtxGetSearch: function() {
			var ctx = this.page.savedCtxCtrlRead(this);
			return ctx ? ctx.$search : null;
		},
		/**
