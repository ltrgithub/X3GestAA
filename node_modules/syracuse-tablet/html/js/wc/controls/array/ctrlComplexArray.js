	...
	function CtrlComplexArray(controller, article, prototype, options) {
		...
		_checkAuthoring: function() {
			...
			if (isChartDetail || page.options.isVignette === true) {
				this.article.$arrayOptions.showPagination = false;
				this.article.$arrayOptions.showSortFilter = false;
				this.article.$arrayOptions.showSearch = false;
			}
			if (isChartDetail) {
		...
		_newBuilderHeader: function() {
			...
			if (this._search == null || globals.isOffLine()) {
