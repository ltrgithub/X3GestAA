...
var sdataRequester = require('syracuse-tablet/html/js/wc/sdata/sdataRequester');
var escaper = require('syracuse-tablet/html/js/wc/helpers/html-escape/index').escaper({
	warn: console.warn.bind(console),
	allowedAttributes: ["style"],
	allowedTags: ["span"]
});
var rtf = require('syracuse-tablet/html/js/wc/helpers/syracuse-rtf/index');
...
exports.CtrlText = utils.defineClass(
	function CtrlText(controller, article, prototype, options) {
		...
		onBlur: function(justCheck) {
			var res = Base.prototype.onBlur.call(this);
