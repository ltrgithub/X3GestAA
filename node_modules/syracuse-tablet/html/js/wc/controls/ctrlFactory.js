...
var PanelHeaderEditHomeTablet = require('syracuse-tablet/html/js/wc/controls/panels/header/panelHeaderEditHomeTablet').PanelHeaderEditHomeTablet;
...
function _createControlType(controller, article, parent, opts) {
	...
	switch ($type) {
		...
		case "application/x-panel-footer-edithome-tablet":
			...
			break;
		case "application/x-panel-header-edithome-tablet":
			ctor = PanelHeaderEditHomeTablet;
			break;
	}
