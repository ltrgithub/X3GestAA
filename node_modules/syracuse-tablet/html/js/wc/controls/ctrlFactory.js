...
var CtrlDocument = require('syracuse-tablet/html/js/wc/controls/fields/ctrlDocument').CtrlDocument;
var CtrlBinary = require('syracuse-tablet/html/js/wc/controls/fields/ctrlDocument').CtrlBinary;
...
var CtrlFilter = require('syracuse-tablet/html/js/wc/controls/fields/ctrlFilter').CtrlFilter;
...
var PanelHeaderMultiselSmartphone = require('syracuse-tablet/html/js/wc/controls/panels/header/panelHeaderMultiselSmartphone').PanelHeaderMultiselSmartphone;
var PanelHeaderMultiselSmartphoneRun = require('syracuse-tablet/html/js/wc/controls/panels/header/panelHeaderMultiselSmartphoneRun').PanelHeaderMultiselSmartphoneRun;
var PanelFooterMultiselTablet = require('syracuse-tablet/html/js/wc/controls/panels/footer/panelFooterMultiselTablet').PanelFooterMultiselTablet;
var PanelFooterMultiselTabletRun = require('syracuse-tablet/html/js/wc/controls/panels/footer/panelFooterMultiselTabletRun').PanelFooterMultiselTabletRun;
var PanelHeaderEditHome = require('syracuse-tablet/html/js/wc/controls/panels/header/panelHeaderEditHome').PanelHeaderEditHome;
var PanelFooterEditHomeTablet = require('syracuse-tablet/html/js/wc/controls/panels/footer/panelFooterEditHomeTablet').PanelFooterEditHomeTablet;
var PanelFooterEditHomeSmartphone = require('syracuse-tablet/html/js/wc/controls/panels/footer/panelFooterEditHomeSmartphone').PanelFooterEditHomeSmartphone;
...
var ChartDetailToolBar = require('syracuse-tablet/html/js/wc/controls/panels/toolBars/chartDetailToolBar').ChartDetailToolBar;
var PanelShare = require('syracuse-tablet/html/js/wc/controls/panels/aside/panelShare').PanelShare;
/**
