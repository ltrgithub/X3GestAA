	...
	Base, {
		...
		multiSelTriggerAction: function($actionName) {
			if ($actionName === "showdiagnoses") {
				...
				this._processStart($actionName).then(function() {
		...
		_processStart: function($actionName) {
			...
			return $.smResolve().then(function() {
				...
				return {
					...
					link: protocolHelpers.adjustLinkProtocol(self._page.controller.dataset.getLink($actionName), self._getUsedProtocol())
				}
			}).then(function(info) {
