...
exports.MultiSelectionPanelController = utils.defineClass(
	...
	Base, {
		...
		_multiSelUpdateStatus: function() {
			...
			var nbRecords = this._panel.page.getQueryArray().getNbRecords();
		...
		_multiSelToggleUnselected: function(show) {
			...
			if (this._panel.page.$$contentElmt.find(".s-m-array.s-m-card").length > 0) {
				...
				this._panel.page.getQueryArray().notifyScrollerUpdate();
			}
		},
		/**
