...
var _scrollerId = 1;
var _ctor = {
	desktop: require('syracuse-tablet/html/js/wc/helpers/scroller/hammerScroller').Klass,
	native: require('syracuse-tablet/html/js/wc/helpers/scroller/nativeScroller').Klass
};
