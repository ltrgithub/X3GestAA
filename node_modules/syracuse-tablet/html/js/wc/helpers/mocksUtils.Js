...
"http://localhost:8124/syracuse-tablet/html/index_debug.html"
	?url=http://localhost:8124/mobile2/$client/$local/$dataset/mobileDashboard('MY_EXPENSES')
	&article="MY_EXPENSES_STACK"
...
exports.getPageUrl = function(){
	var curUrl = jsutils.getCurrentUrl();
	var server = curUrl.protocol + "://" + curUrl.host + ":" + curUrl.port + "/";
	
	var res = [server, curUrl.file, "?url=", server, ];
	res.push(curUrl.protocol)
