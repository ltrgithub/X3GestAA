...
exports.filterSortUpdateUrl = function(opt) {
	...
	if (options.$filters) {
		...
		if (options.$filters.id === "nofilter") {
	...
	//TODO
	// build search clause
	if (options.searchInfo) { // = self.searchInfoRead();
		searchClause = exports.getSearchClause(options.searchInfo);
		if (!exports.isValidWhere(searchClause)) {
			searchClause = null;
			filterMsg = true;
		}
	}
