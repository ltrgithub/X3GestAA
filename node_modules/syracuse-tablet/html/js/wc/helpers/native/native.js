...
var log = require('syracuse-tablet/html/js/wc/helpers/logger').getLogger("native", false);
...
var nativeJSCall = require('syracuse-tablet/html/js/wc/helpers/native/nativeJSCall');

var _modules = {
	"nativeShare": require('syracuse-tablet/html/js/wc/helpers/native/nativeShare'),
	"nativeLiveTile": require('syracuse-tablet/html/js/wc/helpers/native/nativeLiveTile'),
	"nativeMessages": require('syracuse-tablet/html/js/wc/helpers/native/nativeMessages'),
	"nativePenInput": require('syracuse-tablet/html/js/wc/helpers/native/nativePenInput'),
	"nativeImage": require('syracuse-tablet/html/js/wc/helpers/native/nativeImage'),
	"nativeVoiceCommands": require('syracuse-tablet/html/js/wc/helpers/native/nativeVoiceCommands'),
	"nativeApp": require('syracuse-tablet/html/js/wc/helpers/native/nativeApp'),
	"nativeSensors": require('syracuse-tablet/html/js/wc/helpers/native/nativeSensors'),
	"nativeBarcode": require('syracuse-tablet/html/js/wc/helpers/native/nativeBarcode')
};
 ...
 * var nativeVoiceCommmands = require('syracuse-tablet/html/js/wc/helpers/native/native').getModule("voiceCommands");
 */
var _testMode = false;
var _testWrappers = {};
