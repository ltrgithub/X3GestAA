...
var log = require('syracuse-tablet/html/js/wc/helpers/logger').getLogger("nativeLiveTile");
var nativeTestLiveTile = require('syracuse-tablet/html/js/wc/helpers/native/wrapperTest/nativeTestLiveTile');
...
exports.addLiveTile = function(options) {
	console.log(" addLiveTile", options)
