...
var log = require('syracuse-tablet/html/js/wc/helpers/logger').getLogger("nativeWUPApp", false);
var nativeTestApp = require('syracuse-tablet/html/js/wc/helpers/native/wrapperTest/nativeTestApp');
...
if (!(window.smWrapperJS)) {
	window.smWrapperJS = {
		...
		applicationClosing: function() {
			var currentHistoryStack = modules.get("appController").App.nativeApplicationClosing();
