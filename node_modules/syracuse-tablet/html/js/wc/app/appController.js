...
var log = require('syracuse-tablet/html/js/wc/helpers/logger').getLogger("appController", true);
...
var _appClass = utils.defineClass(
	...
	null, {
		...
		/**
		 * The default endpoint is used in gadgets that do not have a fixed endpoint set
		 *
		...
		setAuthoringActive: function(active) {
			this.authoringActive = active;
		},
		getAuthoringActive: function() {
			return this.authoringActive;
		}
	}
);
