...
var controllerModule = require("syracuse-tablet/html/js/wc/controllers/controller");
...
exports.registerEvents = function($$container) {
	...
	$$container.on("click", "[data-nevent]", function(e) {
	...
	events.forEach(function(event) {
		$$container.on(event, "[data-nevent][data-nevent-ctrl-" + event + "]", function(e) {
...
function _eventHandler(event, eventName) {
	...
	if ($$nevent.attr("data-nevent-ctrl-" + type) != null) {
		controlRequest = true;
	}

	var $$controller = $$ctrl.closest("[data-controller-id]");
	...
	var ctrl = ctrlId && controller && controller.getControl(ctrlId);
