...
exports.createPage = function(pageCreateData) {
	...
	console.log('createPage', url, protoHelpers.getReprFromUrl(url))
	...
	return $.smResolve()
		.then(function() {
			...
			} else if (pageCreateData.name === "HOME") {
				fetchOptions.isHome = true
				return _fetchSDataPageHomeData(url, fetchOptions, method)
...
function _fetchSDataPageHomeData(url, options) {
	return $.smResolve()
		.then(function() {
			return sdataReq.fetchPageHomeData(url, options);
		})
		.then(function(pageData) {
