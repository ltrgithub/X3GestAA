...
exports.Page = utils.defineClass(
	...
	Base, {
		...
		_ensureController: function() {
			this.controller = new HomeController(this.pageData.dataset, null, this.pageData.isWorkingCopy);
		...
		_actPageConfig: function() {
			alert("Edit button called by button in welcome page");
			// TODO: https://jira-sage.valiantyscloud.net/browse/X3-17956
		},
		/**
		...
		getVoiceCommands: function() {
			// TODO: https://jira-sage.valiantyscloud.net/browse/X3-17981
			// Build list based on real welcome page content
			return $.smResolve([{
				title: "Kunden",
				page: {
