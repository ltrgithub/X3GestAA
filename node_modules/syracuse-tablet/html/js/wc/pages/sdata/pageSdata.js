...
exports.Page = utils.defineClass(
	function PageSdata(pageData, options) {
		...
		options = options || {};
		//Not very pretty. Maybe create a class pageSdataDetail and maybe pageSdataLocaldetail in place of below
		if (isDetails) {
			options.nativeCapabilities = {
				"liveTile": isDetails,
				"scheduleMessage": isDetails,
				"share": isDetails
			};
		}
		...
		this.actionAdapter.showPageShare = this.controller.hasNativeCapabilities();;
	},
	Base, {
		destroy: function() {
		...
		/**
		 * Returns $details/$edit/$create
		 */
		getActivity: function() {
			var page = this.isChild() ? this.getRootPage() : this;
			var facet = page.pageData.prototype.getFacet();
			if (facet === "$edit") {
				return page.pageData.isCreate === true ? "$create" : facet;
			}
			return facet;
		},
		unbuild: function() {
		...
		// START UI ADAPTER
		//
		afterOnSdataActionClicked: function(actionName, success, controller) {
