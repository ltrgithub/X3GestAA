...
exports.Page = utils.defineClass(
	...
	Base, {
		...
		initStructure: function() {
			...
			this.rootLayout = articleParser.parseArticle(this.controller, this.pageData.article, this);
			if (!this.rootLayout) {
		...
		fetchNewPageData: function($link) {
			...
			var fetchData = sdataReq.fetchPageData({
				...
				.then(function(pageData) {
					...
					self.rootLayout = articleParser.parseArticle(self.controller, self.pageData.article, self);
					self.rootLayout.set$$container(self.$$contentRoot);
					self.rootLayout.buildHtml();
				});
		...
		onPageDataChanged: function() {
			...
			if (this.options.isVignette !== true) { // Vignettes will report to their dashboard and not directly notify here
