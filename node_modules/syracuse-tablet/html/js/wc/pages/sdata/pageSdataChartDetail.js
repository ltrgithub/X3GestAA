	...
	Base, {
		...
		_setArticlesSettings: function($article, chartSettings) {
			...
			if (articles.arrayChartArticle && articles.arrayArticle) {
				...
				articles.arrayChartArticle.$items[0].$arrayOptions.showPagination = (chartSettings.display === "chartOnly" && articles.arrayArticle.$items[0].$arrayOptions.showPagination);
			}
		...
		getArticles: function(node, articles) {
			...
			for (var i = 0; i < node.$items.length; i++) {
				...
				} else if (node.$items[i].$display === "table") {
