...
exports.Page = utils.defineClass(
	...
	Base, {
		...
		_createPageData: function(pageData) {
			...
			pageData = $.extend(true, {}, pageData);
			pageData.dataset = dataset;
			pageData.prototype = prototype;
			pageData.article = articleParser.createDefaultArticle(dataset.prototype);
			return pageData;
		},
