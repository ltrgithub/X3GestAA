 ...
 */
var _updateServerUserProfile = function(userProfile, context) {
	var change = false;
	var upChanges = {};
	var endPoints = null;
...
exports.init = function(fromUserAction, contextToRestore, offlineLogin) {
	...
	if (offlineLogin) {
		...
		step = sdataCommonResources.isConnectionAlive().then(function(alive) {
	...
	return step.then(function() {
		...
		return _updateServerUserProfile(userProfile, selectedContext);
	}).then(function(selectedContext) {
