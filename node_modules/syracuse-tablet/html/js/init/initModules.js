...
exports.init = function() {
	return $.smResolve().then(function() {
		...
		return storage.init(supportedDB)
			.then(function() {
				cache = new sdataCache.SDataCache(storage.getStorage());
			})
			.then(function() {
				globals.init(jsutils.isDvlpVersion() || utils.forceDvlpMode(), storage.getStorage(), cache, utils);
			...
			.then(function() {
				if (globals.showTestApplications()) {
					demos.init();
				}
