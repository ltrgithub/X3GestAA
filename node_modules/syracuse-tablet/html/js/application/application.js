			...
			var loader = new pageLoader.Klass({
				...
				succeeded: function(dstPage, parentNotifInfo, back) {
					...
					if (parentNotifInfo && parentNotifInfo.notifId) {
						 ...
						 */
						if (parentNotifInfo.parentId === "RIGHTPANEL" || parentNotifInfo.parentId === "LEFTPANEL") {
							notifications.pageNotify("sm.panel.lookup.selection", self.currentPage, parentNotifInfo.parentId, parentNotifInfo.controlId, parentNotifInfo.notifData);
						} else {
