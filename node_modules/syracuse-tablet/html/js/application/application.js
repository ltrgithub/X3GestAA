	...
	function($$elmt, factory) {
		...
		_addRemovePinPage: function(add) {
			...
			if (add) {
				...
				dashboardWelcomeUtils.removePinnedPage(pageData.id, dashboardWelcomeUtils.groupType("quickLinks"), true);
				var notify = {
					severityClass: "success",
					title: "",
				...
				globals.getModal().notify(notify);
				notifications.publish("sm.welcomeDashboard.changed");
		...
		changePage: function(pageName, pageOptions, changePageOpts, savedContext) {
			...
			return step
				.then(function() {
					...
					pageOptions.welcomePage = self.welcomeApplication || false;
