...
var _Application = utils.defineClass(
	function($$elmt, factory) {
		...
		destroy: function() {
			...
			pageHelper.removeAllChildPages(self.$$elmt);
			self.currentPage = null;
				...
				self._pageLoader = new pageLoader.Klass({
					...
					setCurrentPage: function(page) {
						...
						if (page.state.isLogin === true) {
							...
							pageHelper.removeAllChildPages(self.$$elmt, page);
						}
					},
		...
		historyReset: function(page) {
			...
			pageHelper.removeAllChildPages(this.$$elmt, page);
			this.history = [];
		},
		/**
		 * Call cb(state)
		...
		changePage: function(state, options) {
			var self = this;
			return pageRegistry.getPageInfo(state, options, self.currentPage)
