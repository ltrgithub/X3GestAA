...
var _subscribe = function(self) {
	notifications.subscribe(self, ["sm.modal.open", "sm.modal.close", "sm.main.layout.changed", "sm.user.logged.in", "sm.page.share.changed"], 1);
};
/**
...
var _Application = utils.defineClass(
	function($$elmt, factory) {
		...
		notifPageShareChanged: function(data) {
			/* data: {
                liveTile: true
                pinWelcome: true
                schedule: {
