...
var _check = function() {
	return ajax("GET", _config.userProfile, null, null, {
		...
		if (result && result.status === 200 && result.responseJSON) {
			...
			if (res && res.mobileClientConfig) {
				// Set the config given by nodelocal.js
				globals.setMobileClientConfig(res.mobileClientConfig);
			}
			return res;
...
var _checkAvailableAuthentications = function() {
	...
	ajax("GET", _config.svcAvailableAuth, null, {
		...
		console.log("_availableAuthentications succeeded", JSON.stringify(_availableAuthentications, null, 2));
