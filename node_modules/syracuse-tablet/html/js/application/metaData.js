...
exports.getWelcomeApplication = function(switchContext) {
...
exports.updateWelcomeDashboard_old = function(newDashboard) {
		var opt = {
			articleParsed: newDashboard.$article,
			gadgets: newDashboard.$gadgets,
			vignette: newDashboard.$vignettes,
		}
		exports.updatePageAuthoring(newDashboard.$dashboardName, opt);
				...
				if (dashboard && dashboard.$update) {
					return dashboard.$update(dashboard).then(function(dashboard) {
						return _initWelcomeApplication().then(function() {
							return exports.updateWelcomeDashboard(dashboard).then(function(dashboard) {
								return dashboard;
							});
