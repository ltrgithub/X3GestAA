 ...
 */
// TODO_META: Check parent proto need at this point
...
function _ensureRegularPageDetailsArticle(pageInfo, pageDetails) {
	...
	if (article && Object.keys(article).length === 0) {
		...
		// Use the article defined for the case this representation is displayed fullscreen (not as vignette)
		// Generate an article if there is none
