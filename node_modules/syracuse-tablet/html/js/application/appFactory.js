...
var _createDaoSdata = function(data, prototype, parent) {
	if (prototype.isStatistics()) {
		return new _ctor.DaoSdataStats(data, prototype, parent);
	} else {
		return new _ctor.DaoSdata(data, prototype, parent);
	}
};
