...
exports.logoutForgetMe = function() {
	return exports.getLogoutForgetMe().then(function(val) {
		var val = val || "nonnativeonly";
		if (val === "always") return true;
		if (val === "never") return false;
		// "nonnativeonly"
		return !nativeApp.isSageX3WUPApp();
...
exports.getLogoutForgetMe = function() {
	return _readSettingsUser().then(function() {
		if (_settingsUser.logoutForgetMe == null) {
			return "nonnativeonly";
		}
		return _settingsUser.logoutForgetMe;
	});
};
...
exports.setLogoutForgetMe = function(value) {
	return _readSettingsUser().then(function(apps) {
		if (_settingsUser.logoutForgetMe !== value) {
			_settingsUser.logoutForgetMe = value;
			_writeSettingsUser();
		}
	});
};