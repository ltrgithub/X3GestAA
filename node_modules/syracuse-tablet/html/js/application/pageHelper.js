...
var _getPageInfo = function(state, options, currentPage) {
	...
	if (options) {
		...
		if (gadgetId) {
			state.options.gadget = _findGadgetData(gadgetId, currentPage);
		}
	}
	if (!state.transition) {
		// Default transition
...
function _findGadgetData(id, page) {
	var prop = page && page.prototype && page.prototype.property(id);
...
var _registerDashboard = function(id, meta, appMetaData) {
	...
	info.dashboardName = meta.$dashboardName;
	_registerPage(info);
};
/**
