...
var _Dao = utils.defineClass(function(data, prototype, parent, options) {
	...
	getQueryData: function(protoArray) {
		var self = this;
		if (self._cache.queryData) return self._cache.queryData;
		self._cache.queryData = {
		...
		rsrcs.forEach(function(rsrc) {
			self._cache.queryData.$resources.push(new _Dao(rsrc, rowProto, self));
		});
		return self._cache.queryData;
	},
