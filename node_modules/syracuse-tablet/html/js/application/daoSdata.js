...
var _Dao = utils.defineClass(function(data, prototype, parent, $bind) {
	 ...
	 * !! we pass parent because this.parent could be a clone of the real parent and update doesnt work
	 * !! See ctrlArray._actRowDetail and pageRegular.notifRowdetailUpdate
	 * Retrun true if change has been detected
	 */
	updateParentRow: function(parent) {
		// Important to force parent if any
		parent = parent || this.parent;
		if (!parent || !this.data || $.isEmptyObject(this.data)) return false;
		var id = this.data.$uuid;
		var grid = parent.data[this.$bind];
