...
var _Klass = utils.defineClass(
	...
	function(controller, cssToToggle) {
		...
		_selAction = [{
			title: locale.text("multiselect.action.download"),
			params: "$download",
			style: "display:none"
		}, {
			title: locale.text("multiselect.action.unselectall"),
			params: "$unselectall",
			style: "display:none"
		}, {
			title: locale.text("multiselect.action.selectall"),
			params: "$selectall",
			style: "display:none"
		}, {
			title: locale.text("multiselect.action.invert"),
			params: "$invert",
			style: "display:none"
		}, {
			title: locale.text("multiselect.action.hideunselected"),
			params: "$hideunselected",
			style: "display:none"
		}, {
			title: locale.text("multiselect.action.showunselected"),
		...
		_startDownloadAction: function(ctrlArray) {
			...
			console.log(data);
			var modal = new modalSyncOffline.Modal(ctrlArray);
