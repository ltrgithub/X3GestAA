...
var _handleActionEvt = function(evt, app) {
	...
	try {
		...
		if ($$actionElmt.length > 0) {
			...
			_doAction($$target, act, param, controlId, evt);
			return;
		}
	} catch (e) {
		fail(e);
...
var _bindControlEvents = function(app) {
	...
	var events = ["click", "blur", "change", "focus"];
...
var _openChartDetailPage = function(control) {
	if (!control || !control.$$elmt) return;
	var attrs = {
		"data-control-id": control.id,
		"data-parent-id": control.controller.id,
		"data-nav": "chartdetail",
		"data-nav-target": "application",
		"data-sdata-url": control.controller.getOriginalSdataUrl(),
		"data-params": control.getUserPrefsId()
	};
	_triggerNavigation(control.$$elmt, attrs);
};
exports.openChartDetailPage = _openChartDetailPage;
