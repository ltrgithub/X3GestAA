...
var _getLinks = function(controller, toolbar, options) {
...
var _Klass = utils.defineClass(
	...
	function(toolbar, options) {
		 ...
		 */
		updateLinks: function(controller, deviceType) {
			var self = this;
			...
			self.links = _getLinks(controller, self.toolbar, self.options);
			if (self.options.addCancelEditAction && !controller.isChild && controller.isEditMode()) {
...
exports.create = function(controller, toolbar, opts, createIfNoLik) {
	var am = new _Klass(toolbar, opts || {});
	am.updateLinks(controller);
	return am;
};