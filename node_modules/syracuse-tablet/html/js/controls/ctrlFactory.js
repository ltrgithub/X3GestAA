...
var _createControl = function(controller, parent, article, prototype, parser) {
	...
	switch (type) {
		...
		case _types.array:
			if (prototype.isQuery()) {
				c = new ArrayQuery(controller, article, prototype);
			} else if (prototype.isLookup()) {
				c = new ArrayQLookup(controller, article, prototype);
			} else {
				c = new Array(controller, article, prototype);
			}
			break;
...
var _createLayout = function(controller, parent, article, parser) {
