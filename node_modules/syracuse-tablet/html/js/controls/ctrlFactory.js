...
var _createPageControl = function(id, controller, options) {
	...
	switch (id) {
		...
		case _types.filtersortpanel:
			c = new _ctor.FilterSortPanel(controller, _types.filtersortpanel, options);
			break;
 ...
 * Creates panels
 */
var _createPanel = function(id, controller, options) {
	options = options || {};
	switch (id) {
		case _types.pageactionpanel:
			if (controller.state.type != "regular") return null;
			return new _ctor.RegularActionPanel(controller, _types.pageactionpanel, options);
		case _types.usersmartphonepanel:
			return new _ctor.UserSmartphonePanel(controller, _types.usersmartphonepanel, options);
			break;
		case _types.filtersortpanel:
			return new _ctor.FilterSortPanel(controller, _types.filtersortpanel, options);
		case _types.navigationpanel:
			return new _ctor.NavigationPanel(controller, _types.navigationpanel, options);
		default:
			throw new Error("Unknown page control[" + id + "]");
	}
	return c;
