...
var _types = {
	...
	pagefooter: "application/x-pagefooter",
	pageactionpanel: "application/x-pageactionpanel",
	navigationpanel: "application/x-navigationpanel"
};
/**
	...
	switch (type) {
		...
		case _types.array:
			if (prototype.data("$cube")) {
				...
				c = new _ctor.ArrayLookup(controller, article, prototype);
			} else {
				// Child array
 ...
 */
var _createPageControl = function(id, controller) {
	var c;
	switch (id) {
		case "header":
			c = new _ctor.PageHeader(controller, _types.pageheader);
			break;
		case "footer":
			c = new _ctor.PageFooter(controller, _types.pagefooter);
			break;
		case "actionpanel":
			switch (controller.state.type) {
				case "dashboard":
					c = new _ctor.DashboardActionPanel(controller, _types.pageactionpanel);
					break;
				case "regular":
					c = new _ctor.RegularActionPanel(controller, _types.pageactionpanel);
					break;
				default:
		...
		case "navigationpanel":
			c = new _ctor.NavigationPanel(controller, _types.navigationpanel);
			break;
		default:
