...
var PanelGlobal = require('syracuse-tablet/html/js/controls/panels/aside/panelGlobalBase').PanelGlobalBase;
...
var NavigationStackBar = require('syracuse-tablet/html/js/controls/panels/navigationBar/navigationStackBar').NavigationStackBar;
/**
...
function _createControlType(controller, article, parent, opts) {
	...
	switch ($type) {
		...
		case "application/x-panel-actions":
			ctor = PanelActions;
			break;
		case "application/x-panel-global":
			ctor = PanelGlobal;
			break;
		...
		case "application/x-panel-edittemplates":
			...
			break;
		case "application/x-navigation-stackbar":
			ctor = NavigationStackBar;
			break;
	}
