...
var _types = {
	...
	panelpagesettings: "tablet/x-page-panel-pagesettings",
	// end page controls
	icon: "tablet/x-icon",
...
var _createPanel = function(controller, panelId, options) {
	...
	switch (panelId) {
		...
		case globals.PANELPAGESETTINGS:
			return new _ctor.PageSettingsPanel(controller, _types.panelpagesettings, panelId, options);
		default:
