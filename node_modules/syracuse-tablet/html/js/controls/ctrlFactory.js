...
var _createVignetteFooter = function(type, vignette, options) {
	return new _ctor.VignetteFooter(_types.vignettefooter, vignette, options);
};
/**
 * Creates panels
...
exports.createVignetteFooter = _createVignetteFooter;
