...
var _createPanel = function(controller, panelId, options) {
	...
	var type = _types[panelId];
	if (!type) return null;
	switch (type) {
		case _types.pageactionpanelregular:
			return new _ctor.PageActionPanelRegular(controller, _types.pageactionpanelregular, panelId, options);
		case _types.userpanelsmartphone:
			return new _ctor.UserPanelSmartphone(controller, _types.userpanelsmartphone, panelId, options);
			break;
