	...
	switch (type) {
		...
		case _types.array:
			if (controller.isVignette()) {
				// Display always simple array in vignettes
				c = new _ctor.Array(controller, article, prototype);
			} else {
				// Use different implementations for full screen lists
...
var _createPageHeader = function(page, article, prototype) {
	return new _ctor.PageHeader(page, prototype, prototype);
};
