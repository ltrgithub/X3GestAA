...
var _types = {
	...
	panelpagedashboardtemplates: "tablet/x-page-panel-dashboardtemplates",
	dashboardConfigheader: "tablet/x-page-dashboard-config-header",
	dashboardConfigfooter: "tablet/x-page-dashboard-config-footer",
	// end page controls
	icon: "tablet/x-icon",
...
var _createDashboardConfigHeader = function(controller, options) {
	// need to extend because the control can add options
	return new _ctor.DashboardConfigHeader(_types.dashboardConfigheader, controller, $.extend(true, {}, options));
};
var _createDashboardConfigFooter = function(controller, options) {
	// need to extend because the control can add options
	return new _ctor.DashboardConfigFooter(_types.dashboardConfigfooter, controller, $.extend(true, {}, options));
};
/**
 * Creates panels
...
var _createPanel = function(controller, panelId, options) {
	...
	switch (panelId) {
		...
		case globals.PANELDASHBOARDTEMPLATES:
			return new _ctor.PageDashboardTemplatePanel(controller, _types.panelpagedashboardtemplates, panelId, options);
		default:
...
exports.createDashboardConfigHeader = _createDashboardConfigHeader;
exports.createDashboardConfigFooter = _createDashboardConfigFooter;
