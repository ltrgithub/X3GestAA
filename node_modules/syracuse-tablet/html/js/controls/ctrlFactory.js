...
var _types = {
	...
	panelpagetemplate: "tablet/x-page-panel-templates",
	// end page controls
	icon: "tablet/x-icon",
...
var _createPanel = function(controller, panelId, options) {
	...
	switch (panelId) {
		...
		case globals.PANELPAGETEMPLATE:
			return new _ctor.PageTemplatePanel(controller, _types.panelpagetemplate, panelId, options);
		default:
