			...
			if (this.$isEditMode) {
				...
				if (self.choiceList.length > 0) {
					...
					// default format is '$combo'
						...
						self.selectionBtn = uiUtils.createDomElement("button", ["btn", "btn-default", "dropdown-toggle"], this._getChoiceTitle(value), {
							"type": "button",
						...
						// building list
						$.each(self.choiceList, function(index, choiceItem) {
							var listItem = uiUtils.createDomElement("li", (choiceItem.$value == value) ? ["active"] : null);
