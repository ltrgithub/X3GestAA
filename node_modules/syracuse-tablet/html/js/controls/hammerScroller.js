 ...
 * 		options.valMax			maximum top - 0 by default - 50 for pages with header...
 * 		options.direction		h/v
 * 		options.isPageScroller	true/false
 */
var _consts = {
	pan: {
...
var _Klass = utils.defineClass(function hammerScroller($$elmt, options, parentMgr) {
	...
	this.valMax = options.dvalMax != null ? options.dvalMax : 0;
