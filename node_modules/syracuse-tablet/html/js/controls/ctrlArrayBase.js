...
var _GridArticleBuilder = utils.defineClass(
	function(gridCtrl) {
		...
		buildHtml: function(html, data, buildOptions) {
			var self = this;
			self.buildHtmlBefore(html, data, buildOptions);
			self.buildTtlHtml(html, data, buildOptions);
			self.buildContentHtml(html, data, buildOptions, buildOptions);
			self.buildHtmlAfter(html, data, buildOptions);
		},
		buildHtmlBefore: function(html, data, buildOptions) {
			var self = this;
			html.push('<div class="');
		...
		buildHtmlAfter: function(html, data, buildOptions) {
			var self = this;
			html.push('</div>');
		},
		buildTtlHtml: function(html, data, buildOptions) {
			var self = this;
			if (!self._titleHtml) {
		...
		buildContentHtml: function(html, data, buildOptions) {
			var self = this;
...
var _GridHtmlBuilder = utils.defineClass(
	function(gridCtrl) {
		...
		buildHtml: function(html, data) {
			...
			self.buildTtlHtml(html);
			self.buildContentHtml(html);
		...
		buildContentHtml: function(html) {
			var self = this;
			var props = self.grid.itemProto.data("$properties");
			var keys = Object.keys(props);
			var widths = _getWidths(self, keys.length, self.maxCols);
...
var _Klass = utils.defineClass(
	function(controller, article, prototype) {
		...
		buildHtml: function(html, data, buildOptions) {
			...
			self.gridBuilder.buildHtml(html, data, buildOptions);
		},
		/**
