...
var _Klass = utils.defineClass(
	function(controller, article, prototype) {
		...
		self.dipsplay = "grid-article" // "grid-article"; "grid-html";
	}, Base, {
		/**
		...
		buildHtml: function(html, controllerDao, buildOptions) {
			...
			if (!self.gridBuilder) {
				if (self.dipsplay === "grid-article") {
					self.gridBuilder = new Builder.GridArticleBuilder(self);
				} else if (self.dipsplay === "grid-html") {
					self.gridBuilder = new Builder.GridHtmlBuilder(self);
				} else {
