	...
	function(controller, article, prototype) {
		...
		buildFieldValue: function(parentSlot, buildOptions) {
			...
			if (self.$isEditMode) {
				...
				if (self.choiceList.length > 0) {
					parentSlot.appendChild(uiUtils.createDomElement("div", ["sm-field-value-read"], self._getChoiceTitle(value)));
				}
			}
		},
		...
		setValue: function(value) {
			var self = this;
			Base.prototype.setValue.call(self, value);
