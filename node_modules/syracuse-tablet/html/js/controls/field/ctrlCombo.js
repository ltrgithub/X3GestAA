				...
				if (self.choiceList.length > 0) {
					...
					if (self.prototype.data("$format") == '$radios') {
						...
						$.each(self.choiceList, function(index, choiceItem) {
							...
							var inputDom = uiUtils.createDomElement("input", ["sm-field-choice-radio", "ctrl-evt-click"], null, {
								"type": "radio",
								"value": index,
					...
					// default format is '$combo'
						...
						var btnTxt = value ? self._getChoiceTitle(value) : self.choiceList[0].$title;
						...
						$.each(self.choiceList, function(index, choiceItem) {
							...
							listItem.appendChild(uiUtils.createDomElement("a", ["sm-field-choice-combo-item", "ctrl-evt-click"], choiceItem.$title, {
								"href": "#"
							}));
