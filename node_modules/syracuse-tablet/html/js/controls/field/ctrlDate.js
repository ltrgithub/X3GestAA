				...
				$(self.picker).click(function() {
					...
					switch (self.getPropertyType()) {
						case "application/x-time":
							ctrlSelector = new selector.time();
							break;
						case "application/x-date":
							ctrlSelector = new selector.date();
							break;
						case "application/x-datetime":
							ctrlSelector = new selector.datetime();
							break;
						default:
							throw new Error("Expected date/time/datetime type. Got " + self.getPropertyType());
					}

					var selectorDom = ctrlSelector.create(self);
					...
					var $$selectorModal = modal.field(self.getTitle(), selectorDom.outerHTML, function(modalEvent, $$modalElmt) {
						...
						if (modalEvent == 'shown.bs.modal') {
							ctrlSelector.setContainer($$modalElmt);
