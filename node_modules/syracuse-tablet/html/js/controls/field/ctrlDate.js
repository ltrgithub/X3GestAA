...
var DateSelector = require('syracuse-tablet/html/js/ui/dateSelector').DateSelector;
		...
		buildFieldValue: function(parentSlot, buildOptions) {
			...
			if (this.$isEditMode) {
				...
				$(self.picker).click(function() {
					modal.info("Date time selector", "implement in progress", function(modalEvent, $$modalElmt) {
