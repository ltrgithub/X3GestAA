		...
		buildFieldValue: function(parentSlot, buildOptions) {
			...
			if (this.$isEditMode) {
				...
				$(self.picker).click(function() {
					modal.info("Date time selector", "implementation in progress", function(modalEvent, $$modalElmt) {
						// build content on open
						if (modalEvent == 'shown.bs.modal') {
							self.dateSelector = new DateSelector();
				...
				parentSlot.appendChild(self.fieldValue = uiUtils.createDomElement("div", ["sm-field-value-read"], value));
			}
		},
