	...
	function(controller, article, prototype) {
		...
		buildFieldValue: function(parentSlot, buildOptions) {
			...
			if (self.$isEditMode) {
				...
				self.domInput = uiUtils.createDomElement("input", ["sm-field-input", "form-control", "ctrl-evt-blur"], null, {
					"type": "text",
					"value": value
				}, inputGroup);
		...
		setFieldValue: function(value) {
			...
			// TODO TO IMPROVE
			// Should not be here at all, a control should not do UI management of dialogs!
			// Remove this whole function and use setFieldValue from parent class
