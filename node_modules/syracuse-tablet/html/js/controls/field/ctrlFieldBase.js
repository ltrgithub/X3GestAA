...
var _Klass = utils.defineClass(
	...
	function(controller, article, prototype) {
		...
		self.formatter = self.initFormatter(); //formatApi.getFormatter(self.$type, self.$format);
		self.$isEditMode = controller.isEditMode() === true || article.$isEditMode === true;
		...
		getPropertyType: function() {
			return this.prototype.data("$type");
		},
		...
		afterRender: function() {
			...
			self.applyMetaData(self._getMetatData());
		},
