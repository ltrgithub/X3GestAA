...
var _Klass = utils.defineClass(
	...
	function(controller, article, prototype) {
		...
		getPropertyType: function(prototype) {
			var self = this;
			return (prototype || self.prototype).data("$type");
		},
		...
		getFieldProperties: function() {
			var self = this;
			return $.extend(true, {}, self.prototype.json, self.article, self.dao.getValue("$properties") && self.dao.getValue("$properties")[self.$bind]);
		},
		applyMetaData: function(metaData) {
			...
			if (metaData && metaData.$isHidden != null) {
				self.$$elmt.toggleClass("s-m-field-hidden", metaData.$isHidden);
			} else {
				var $properties = self.getFieldProperties();
				if ($properties.$isHidden) {
					self.$$elmt.toggleClass("s-m-field-hidden", true);
				}
			}
