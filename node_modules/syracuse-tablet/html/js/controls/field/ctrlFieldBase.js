...
var _Klass = utils.defineClass(
	...
	function(controller, article, prototype) {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			...
			var classes = ["s-m-control sm-field-slot"];
			if (self.prototype.data("$isAdvanced") === true) {
				classes.push("sm-field-advanced");
			}
		...
		buildFieldTitle: function(parentSlot, buildOptions) {
			...
			if (!(self.article.$isTitleHidden === true) && buildOptions.isGridCell !== true) {
				parentSlot.appendChild(uiUtils.createDomElement("div", ["sm-field-title"], self.getTitle()));
			}
		},
		...
		buildFieldValue: function(parentSlot, buildOptions) {
			...
			value = self.formatValue(self.getValue());
			if (this.$isEditMode) {
				self.domInput = parentSlot.appendChild(uiUtils.createDomElement("input", ["sm-field-input", "form-control", "ctrl-evt-blur"], null, {
					"type": "text",
					"value": value
		...
		createFieldValueElement: function(parentSlot, value) {
			return uiUtils.createDomElement("div", ["sm-field-value-read"], value || null, null, parentSlot);
		},
		...
		onBlur: function(domField) {
			var value = domField.value;
			var errors = [];
			if (!this.validateValue(value, errors)) {
