...
var _Klass = utils.defineClass(
	...
	function CtrlFieldBase(controller, article, prototype, options) {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			...
			// apply afterRender options if true
			// set to true in formController.js in order to run applyMetaData() method
			if (buildOptions && buildOptions.afterRender) {
				Base.prototype.afterRender.call(this, buildOptions);
			}
