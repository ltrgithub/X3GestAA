	...
	*/
		...
		*/
		_setImage: function(src) {
			...
			var core = self.$$elmt.find("." + "s-m-field-img")[0];
			...
			// update upload button
			self.$$elmt.find(".s-m-upload-binary-field").text(locale.text("image.label.changeimage"));

			// toggle clearBtn
			self.$$elmt.find(".s-m-clear-binary-field").toggleClass("s-m-clear-binary-hidden", false);
		}
	});
