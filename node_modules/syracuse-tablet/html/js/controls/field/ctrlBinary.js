...
var _Klass = utils.defineClass(
	...
	function(controller, article, prototype, options) {
		...
		_buildEditBinaryField: function(parentSlot, docUrl, empty) {
			...
			clearBtn = uiUtils.createDomElement("a", ["ctrl-evt-click", (empty ? "s-m-clear-binary-hidden" : "")], null, {
				"href": "#"
			}, $$layout.find("header")[0]);
	...
	*/
		...
		*/
		_setImage: function(src) {
			...
			// toggle clearBtn
			self.$$elmt.find(".s-m-img-layout > header > a").toggleClass("s-m-clear-binary-hidden", false);
		}
	});
