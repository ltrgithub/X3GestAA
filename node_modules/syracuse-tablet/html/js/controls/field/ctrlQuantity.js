	...
	function CtrlQuantity(controller, article, prototype, options) {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			...
			if (this.displayUnit) {
				if (this.$isEditMode) {
					var unitVal = controllerDao.getValue(this.unitFieldInfo.unitBindName);
					var unit = unitVal && (unitVal.$symbol || unitVal.$$value);
					if (unit) {
						this.$$elmt.find("input").wrap($('<div class="input-group stylish-input-group">'));
						this.$$elmt.find(".stylish-input-group").append('<span class="input-group-addon">' + unit + '</span>');
					}
				} else {
