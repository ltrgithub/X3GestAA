...
var _Klass = utils.defineClass(
	...
	function CtrlReference(controller, article, prototype, options) {
		...
		buildEditValue: function(parentElmt, value) {
			...
			var barcode = this.article && this.article.$scanBarcode && this.nativeBarcode && !($(parentElmt).hasClass("input-group"));
			if (barcode) {
				this._createBarcodeInput(bsInputGroup);
			}
		},
		...
		_createBarcodeInput: function(parent) {
			...
			if (!this.barcodePicker) {
				...
				this.barcodePicker = uiUtils.createDomElement("a", ["btn", "btn-default", "s-m-meta"], null, null, span);
				uiUtils.createDomElement("span", fontUtils.getIconByName("scanBarcode"), null, null, this.barcodePicker);
				$(this.barcodePicker).click(function() {
