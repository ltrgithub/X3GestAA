...
var _Klass = utils.defineClass(
	...
	function CtrlReference(controller, article, prototype, options) {
		...
		applyAuthoring: function() {
			var self = this;
			Base.prototype.applyAuthoring.call(self);

		}
		/*
	 * Authoring - Set description format
	 * desc:      <desc>
	 *         
	 * title:     <title>
	 ...
	 * -> If both values are equal, skip display of second value
	*/
		_setDescFormat: function() {
			//"desc"
			//"title"
			//"desctitle"
			//"titledesc"
			var self = this;
			var $format = self.getAuthoring("$refDescFormat");
			if ($format) {
		...
		;
		/*
		 * Authoring - Set description position
		 * bottom: <value>
		 *         <desc>
		 *
		 * right:  <value> <desc>
