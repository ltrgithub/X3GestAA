...
var _Klass = utils.defineClass(
	...
	function CtrlImage(controller, article, prototype, options) {
		...
		if (this.nativePenInput) {
			this.nativePenInput = native.getModule("penInput").supports("annotatedImage");
		}
		...
		*/
		...
		_onEditClick: function(evt, dom) {
			...
			var editBtn = this.$$elmt.find(".s-m-img-layout > footer > a[action='$edit']")[0];
			$(editBtn).toggle();
			native.getModule("penInput").getAnnotatedImage({
				title: self.getTitle(),
