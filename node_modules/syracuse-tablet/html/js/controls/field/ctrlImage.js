...
var _Klass = utils.defineClass(
	...
	function CtrlImage(controller, article, prototype, options) {
		...
		this.nativePenAnnotatedImage = native.hasCapability("penAnnotatedImage");
		this.nativeSignatureImage = native.hasCapability("penSignatureImage");
		this.nativeImageCamera = native.hasCapability("camera");
		...
		_isBtnActive: function(btnId) {
			...
			switch (btnId) {
				case "$select":
					...
					break;
				case "$edit":
					isActive = (!isSignature && this.nativePenAnnotatedImage);
					break;
				case "$camera":
					isActive = (!isSignature && this.nativeImageCamera);
					break;
				case "$sign":
					isActive = (isSignature && this.nativeSignatureImage);
					break;
				case "$delete":
					isActive = true;
					break;
	...
	*/
		...
		*/
		...
		_checkScale: function(src) {
			...
			// TODO: Get size settings from authoring (noscale, small, medium, large)
			...
			// TODO: map small,medium,large to pixel sizes and send to wrapper instead of 320x240
