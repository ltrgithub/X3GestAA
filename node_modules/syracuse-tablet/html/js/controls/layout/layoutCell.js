...
var _Klass = utils.defineClass(function LayoutCell(controller, type, article, opts) {
	...
	_setCellColorClass: function() {
		/* default color is defined in css .s-m-cell:not(.s-m-bg)*/
		if (!this.article.$bgColor || this.article.$bgColor === "transparent") return;
		this.$$cell.addClass("s-m-bg s-m-color-" + this.article.$bgColor);
	},
