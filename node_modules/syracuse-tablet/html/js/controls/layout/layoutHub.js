...
var _Klass = utils.defineClass(
	function LayoutHub(controller, type, article, opts) {
		...
		onResize: function() {
			...
			if (viewRect) {
				self._gestureMgr.init(viewRect, self._getScrollDir());
			} else {
				self._gestureMgr.reset();
			}
		},
		_getScrollDir: function() {
			return this.orientation != null && this.orientation === "portrait" ? "v" : "h";
		},
