...
var _Klass = utils.defineClass(function(control, disp, options) {
	...
	_onMeasureClick: function(idx) {
		if (!this._links || !this._links.$drillDown) return false;
		var opt = {
			action: "$drillDown",
			idx: idx,
			controlOriginId: (this.control.controller.state.options.controlOriginId || this.control.id) //Propagate control id 
		};
