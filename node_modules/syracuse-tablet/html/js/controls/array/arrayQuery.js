...
var builderTable = require('syracuse-tablet/html/js/controls/array/builderGridHoriz').Klass;
var builderGrid = require('syracuse-tablet/html/js/controls/array/builderTable').Klass;
...
var _Klass = utils.defineClass(
	function(controller, article, prototype) {
		...
		if (self.controller.isVignette()) {
			this.setBuilder(new builderTable(self));
		} else {
			this.setBuilder(new builderGrid(self));
		}
	}, Base, {
