...
exports.Filters = utils.defineClass(
	function filters(arrayCtrl) {
		...
		_$filtersGet: function() {
			...
			if (!exports.filterSortAllowed(this.control) || prototype.root.isRequest()) {
				return this._$filters;
			}
		...
		//TODO
		$filterGetInfo: function() {
			var $filters = this._$filtersGet();
			if ($filters.length === 0) {
				return null;
			}
			var f = null;
			$filters.some(function(x) {
				if (x.$isDefault === true) {
					f = x;
					return true;
				}
		...
		$filtersAllowed: function() {
			return exports.filterSortAllowed(this.control) && this._$filtersGet().length > 0;
		}
	});
