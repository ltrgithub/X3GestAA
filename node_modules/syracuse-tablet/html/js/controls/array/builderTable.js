...
var _Klass = utils.defineClass(
	function(control, disp, options) {
		...
		_build: function(buildOpts, resizeContext) {
			...
			self.refreshHeaderAndGesture(resizeContext);
			if (resizeContext && resizeContext.sendControllerNotif) {
				// Array is able to trigger a notification after having build the content
				notifications.notifyController(resizeContext.sendControllerNotif, this.control.controller);
			}
		},
		/**
		...
		_createColumnInfo: function(buildOpts) {
			...
			var overflow = (self._columnInfo.length - nonDataCol) != nbCols;
			var c;
