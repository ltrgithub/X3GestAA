...
var _Klass = utils.defineClass(
	function(control, disp, options) {
		...
		if (control.controller.isChild !== true && this.$arrayOptions.showRowDetailLink == null) {
			// False by default - We need to check 'Show row detail link' in authoring to enable
			// For child pages we force by default because authoring is not available
