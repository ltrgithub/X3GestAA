...
var _getFixedSizeInfo = function($$table) {
	...
	// console.log("charWidth", r.charWidth,"cellPadding", r.cellPadding, "iconWidth", r.iconWidth)
	$$body.remove();
	_fixedSzInfo[dev] = r;
	return r;
};
...
var _Klass = utils.defineClass(
	function(control, disp, options) {
		...
		onResize: function(context) {
			if (this._columnInfo && this._columnInfo.length > 0) {
		...
		_calulateWidths: function($$table, arrayData) {
			...
			self._columnInfo.forEach(function(i) {
				...
				if (art && false) {
					console.log(i.$bind, "$widthType", art.$widthType, "$widthVal", art.$widthVal, "fixedWidth", i.fixedWidth);
				}
			});
		},
