	...
	function(control, options) {
		...
		_buildTableFoot: function($$table, arrayData, options) {
			...
			if (self.control.controller.isEditMode()) {
				if (this.control.prototype.isSingleArray() && $$table.find(".s-m-record.readonly").length === arrayData.$resources.length) {
					// No 'add row' button for single arrays in readonly mode
					return;
				}
