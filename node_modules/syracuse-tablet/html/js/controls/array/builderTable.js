...
var _Klass = utils.defineClass(
	function(control) {
		...
		_buildTable: function(arrayData, options) {
			var self = this;
			var root = uiUtils.createDomElement('div', ["s-m-value"], null, null, self.$$elmt);
			self.tabElmt = uiUtils.createDomElement('table', ["table table-hover table-condensed"], null, null, root);
