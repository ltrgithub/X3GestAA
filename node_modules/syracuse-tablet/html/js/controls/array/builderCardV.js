...
var _Klass = utils.defineClass(
	function(control, disp, options) {
		var self = this;
		Base.call(self, control, disp, options);
		...
		multipleCardsBuild: function(arrayData, buildOptions) {
			...
			self.addEmptyCells(self._layoutRoot, $$row, remaining, buildOptions);
		},
		/**
		...
		singleCardUpdate: function(idx, buildOptions) {
			try {
				...
				self.callGenerateHtml(self._layoutRoot, self.$$cardCell, rowData, false, buildOptions, idx);
