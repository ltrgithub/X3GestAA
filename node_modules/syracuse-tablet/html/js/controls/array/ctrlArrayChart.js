...
var _Klass = utils.defineClass(
	function CtrlArrayChart(controller, article, prototype, options) {
		...
		drillDownOpt: function(rowId) {
			var self = this;
			var propertiesQuery = ["ifCube", "level_c", "level_m", "level_p", , "recordsPerPage", "refreshLink", "req_id", "displayLineNum"];
			var opt = {
				rowId: rowId,
			...
			if (self._dao.data) { //get options from data
				propertiesQuery.forEach(function(propertyName) {
					opt[propertyName] = self._dao.data[propertyName];
				});
			}
			return opt;
		},
