	...
	function CtrlArrayChart(controller, article, prototype, options) {
		...
		triggerOpenChartDetail: function(opt) {
			...
			var attrs = {
				...
				"data-origin-id": (opt && opt.controlOriginId) ? opt.controlOriginId : this.id,
		...
		_getChartDetailPageInfo: function(typePage) {
			...
			var article = _checkChartArticle(this.article[chartsUtils.getChartDetailArticlePropertyName(level)], this.$bind);
