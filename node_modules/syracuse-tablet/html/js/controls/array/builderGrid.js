...
var _Klass = utils.defineClass(
	function(control, options) {
		...
		_createColumnInfo: function(options) {
			...
			if (self.control.controller.isEditMode() || self.columnInfo.length != cols.length) {
		...
		_getOpenChildProto: function(rowId) {
			...
			return reqProto.create({
				$type: "tablet/x-icon",
				// Check controller for edit activity - $isEditMode is always false for arrays
				$icon: self.control.controller.isEditMode() ? "editrow" : "detailrow",
				$action: $action
			});
		}
	});
