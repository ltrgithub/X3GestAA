...
var filterHelper = require('syracuse-tablet/html/js/helpers/filterHelper');
	...
	function searchArray(control) {
		...
		getHtml: function() {
			if (this.firstRendering === true) {
				// searchInfio read in page's prefs - We need the page (not available in contructor)
				this.searchInfos = this.control.page.getPageSearch();
				if (this.searchInfos && this.searchInfos["0"]) {
