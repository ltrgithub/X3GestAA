	...
	basicSearch: '\
		<nav class="s-m-search">\
            <div class="input-group stylish-input-group">\
                <input type="text" class="form-control ctrl-evt-input"  placeholder="Search"  value="{{searchValue}}" >\
...
var _Klass = utils.defineClass(
	...
	function(savedContext) {
		...
		getHtml: function() {
			...
			this.$$remove = this.$$search.find('[data-params="removeSearch"]');
			this.$$search.find("input").on('input', jsutils.bindFn(this.onInput, this));
			return this.$$search;
		},
		onInput: function(evt) {
			this.$$remove.css("visibility", ($(evt.target).val() || "").length > 0 ? "visible" : "hidden");
		},
		removeSearch: function(ctrl) {
			var refresh = this.searchValue.length > 0;
