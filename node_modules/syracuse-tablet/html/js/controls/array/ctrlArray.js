...
var FilterSortPanel = require('syracuse-tablet/html/js/controls/page/panels/filterSortPanel').Klass;
	...
	function(controller, article, prototype, options) {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			...
			if (self._displayArray()) {
				self.$$header = $('<header/>');
				self.$$value.before(self.$$header);
				buildOptions.dispFilterSort = buildOptions.dispPagin = self.prototype.isQuery();
		...
		_actFilterSortPanel: function(actionName) {
			var self = this;
			(self.filterSortPanel = self.filterSortPanel || new FilterSortPanel(self.controller, "tablet/x-filtersortpanel", {
				ctrlArray: self
			})).toggle();
			//debugger;
		}
