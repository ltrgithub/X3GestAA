...
var _Klass = utils.defineClass(
	...
	function CtrlArray(controller, article, prototype, options) {
		...
		isArrayField: function() {
			...
			return !this.controller.prototype.isLookup() && !this.controller.prototype.isQuery();
		},
		/**
		...
		readArrayData: function(controllerDao) {
			...
			if (self.prototype.isQuery()) {
				res = controllerDao.getQueryData(self.prototype);
			} else if (self.prototype.isLookup()) {
				res = controllerDao.getLookupData(self.prototype);
			} else {
				res = controllerDao.getArrayData(self.$bind, self.prototype);
			}
