...
-		 * none/tabs/list
		...
		_getSdataUrl: function(opt) {
			if (!opt || !opt.action) return this._getMainPage(this.controller).getOriginalSdataUrl();
			return this.prototype.resolveExpression(this._arrayData.$links[opt.action].$url, this._arrayData.$resources[opt.idx], true);
		},
