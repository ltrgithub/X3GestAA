...
var _Klass = utils.defineClass(
	...
	function CtrlArray(controller, article, prototype, options) {
		...
		// This is not the regular process (see saveCtxGetCtrlValue) but it's needed
		var savedContext = controller.saveCtxGetCtrlValue(this.$bind);
		...
		_openDetailRow: function(rowInfofId, activity) {
			...
			try {
				...
				if (!isRowCreation) {
					...
					notifications.notifyController("synch.sm.select.row", self.controller, self.id, dao.getValue("$uuid"), null, true);
				}
