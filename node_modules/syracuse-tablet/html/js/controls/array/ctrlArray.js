...
-		 * none/tabs/list
		...
		//Get columns state (hidden) set by X3
		getColumsState: function() {
			var stateCols = {}, self = this;
			if (!self._arrayData.$properties) return stateCols;
			Object.keys(self._arrayData.$properties).forEach(function(key) {
				stateCols[key] = self._arrayData.$properties[key].$isHidden;
			});
			return stateCols;
		}
	});
