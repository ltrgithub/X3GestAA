...
var _Klass = utils.defineClass(
	function(control, disp, options) {
		...
		_refreshHeader: function(buildOptions) {
			...
			if (buildOptions.refresh !== true && this._isHeaderVisible($filtersAuth)) {
		...
		_buildArrayHeader: function(arrayData, buildOptions, $filtersAuth) {
			...
			if (this.control.isEmpty !== true && headerOpts.paginEnabled === true && this.$arrayOptions.showPagination === true) {
				this._buildPagin(this._$$stdHeader, arrayData);
				empty = false;
			}
			if (this.control.isEmpty !== true && headerOpts.searchEnabled === true && this.$arrayOptions.showSearch === true) {
