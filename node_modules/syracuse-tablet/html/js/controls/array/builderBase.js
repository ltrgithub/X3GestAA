...
var _Klass = utils.defineClass(
	function(control, disp, options) {
			...
			if (!this.control._displayArray()) {
				...
				if (this.control.isEmpty) {
					...
					if (!this.control.isArrayField()) {
						var $title = this.control.prototype && this.control.prototype.data("$title");
						if ($title) {
							var $$title = $('<div class="s-m-no-data-title"></div>');
							$$title.appendTo(this.control.$$value);
							$$title.text($title);
						}
		...
		insertError: function(html) {
			['<div class="s-m-error">', html, "</div>"].join('').appendTo(this.control.$$elmt);
		},
		/**
