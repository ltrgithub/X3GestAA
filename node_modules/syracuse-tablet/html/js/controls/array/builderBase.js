...
var _Klass = utils.defineClass(
	function(control, type, options) {
		...
		buildPagingLinks: function(arrayData, options) {
			...
			options = options || {};
			var linksBottom = options.bottom ? $(uiUtils.createDomElement('div', ["s-m-array-links"])).appendTo(self.$$elmt) : null;
			var linksTop = options.top ? $(uiUtils.createDomElement('div', ["s-m-array-links"])).prependTo(self.$$elmt) : null;
			if (arrayData.$links) {
