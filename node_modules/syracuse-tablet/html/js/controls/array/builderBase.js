...
var _Klass = utils.defineClass(
	function(control, options) {
		...
		buildPagingLinks: function(arrayData, buildOptions) {
			...
			// if any previous array header, remove it
			if (self.control.$$value.prev()) self.control.$$value.prev().remove();

			// append to dom
			self.control.$$value.before($(arrayHeader));
		},
		/**
