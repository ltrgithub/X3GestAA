...
var _Klass = utils.defineClass(
	function(control, options) {
		...
		selectLastSelectedRow: function(rowId, show) {
			var self = this;
			var selector = 'tbody [data-params="' + rowId + '"]';
		...
		getSelectedRow: function() {
			var selectedRowId;
			var $$r = this.$$elmt.find(".s-m-last-selected");
			if ($$r.length > 0) {
				var selectedRowId = $$r.attr('data-params');
				if (!selectedRowId) {
					$$r = $$r.find('[data-action="' + exports.ACTROWDETAIL + '"]');
					selectedRowId = $$r.attr('data-params');
				}
			}
