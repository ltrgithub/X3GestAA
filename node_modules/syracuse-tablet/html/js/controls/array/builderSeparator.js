...
exports.BuilderSeparator = utils.defineClass(
	function builderSeparator(control) {
		...
		this._fieldsControllers = []
	}, Base, {

		destroy: function() {
			Base.prototype.destroy.call(this);
			if (this._fieldsControllers) {
				this.destroyControllers();
				this._fieldsControllers = null;
			}
		},

		/**
		 * We need one controller per field 
		 * Destroy controllers 
		 */
		destroyControllers: function() {
			if (this._fieldsControllers == null) {
				return;
			}
			this._fieldsControllers.forEach(function(ctrler) {
				ctrler.destroy();
			})
			this._fieldsControllers = []
		},
		...
		buildHtml: function(data, $$parent, refresh) {
			...
			data.forEach(function(dataSet, idx) {
				...
				var controller = new SdataController(dataSet);
