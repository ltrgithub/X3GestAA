...
var theme = require('syracuse-tablet/html/js/controls/ctrlCubeChartTheme').theme;
...
var _Klass = utils.defineClass(function(controller, article, prototype) {
	...
	_getOptions: function(proto) {
		...
		if (options.xAxis[0].title.text !== options.title.text) {
			//options.xAxis[0].title.text = options.title.text + (options.xAxis[0].title.text ? ' / ' + options.xAxis[0].title.text : '');
