...
var _Klass = utils.defineClass(
	...
	function(controller, article, prototype) {
		...
		buildFieldTitle: function(parentSlot, buildOptions) {
			...
			if (this.article.$isTitleHidden !== false && buildOptions && buildOptions.isGridCell !== true) {
		...
		buildFieldValue: function(parentSlot, buildOptions) {
			...
			if (this.$isEditMode) {
				...
				$(self.domInput).focusout(function() {
					self._onFocusOut.call(self, this);
				});
			} else {
		 ...
		 */
		getFormattedValueEdit: function() {
			var value = this.dao.getValue(this.$bind);
			if (!this.formatter) {
				return value || "";
			}
		...
		_onFocus: function(domField) {
			var value = this.getFormattedValueEdit();
			this.setDisplayValue(value);
		},
		_onFocusOut: function(domField) {
