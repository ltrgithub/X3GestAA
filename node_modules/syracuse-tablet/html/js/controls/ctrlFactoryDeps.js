...
var PageDashboardTemplatePanel = require('syracuse-tablet/html/js/controls/page/panels/PageDashboardTemplatePanel').Klass;
...
var DashboardConfigHeader = require('syracuse-tablet/html/js/controls/page/ctrlDashboardConfigHeader').Klass;
var DashboardConfigFooter = require('syracuse-tablet/html/js/controls/page/ctrlDashboardConfigFooter').Klass;
...
exports.init = function() {
	...
	ctrlFactory.setImpl("PageDashboardTemplatePanel", PageDashboardTemplatePanel);
	...
	ctrlFactory.setImpl("DashboardConfigHeader", DashboardConfigHeader);
	ctrlFactory.setImpl("DashboardConfigFooter", DashboardConfigFooter);
};