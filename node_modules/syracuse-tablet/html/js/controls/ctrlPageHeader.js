...
var _Klass = utils.defineClass(
	...
	function(page, prototype, $article) {
		...
		buildHtml: function(parent, controllerDao, buildOptions) {
			...
			this.navListContainer = uiUtils.createDomElement("ul", ["nav", "navbar-nav", "navbar-right"], null, null, navbarCollapse);

			var listItem = uiUtils.createDomElement("li", null, null, null, this.navListContainer);
		...
		ensureLinks: function(parent, dao) {
			...
			if ($links && Object.keys($links).length > 0) {
				...
				var linksBar = uiUtils.createDomElement("div", ["sm-links-bar", "hidden"], null, null, linksBarLayout);
				...
				$.each($links, function(name, value) {
					...
					var item = uiUtils.createDomElement("a", ["sm-links-bar-item"], value.$title || this.getLinkTitle(name), attrs, itemSlot);
				});
				...
				uiUtils.createDomElement("span", ["glyphicon", "glyphicon-align-justify"], null, null, picker);
