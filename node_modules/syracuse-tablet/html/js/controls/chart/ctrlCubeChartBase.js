...
var _Klass = utils.defineClass(function(controller, article, prototype, options) {
	...
	_createChart: function(settings, $$parent) {
		var self = this,
			options = _merge(self._getPref(), self._getOptions(self.$prototype, $$parent));
	...
	_getOptions: function(proto, $$parent) {
		var self = this,
			$cube = this.currentMetaData.$cube,
			...
			enuml,
			$style = this.currentMetaData.$style || $cube.$style || proto.$cube.$style;
		var margin = {
	...
	destroy: function() {
		...
		this.highchartObject && this.highchartObject.destroy();
		this.highchartObject = this._localize = this._meta = this.currentMetaData = null;
	}
});
