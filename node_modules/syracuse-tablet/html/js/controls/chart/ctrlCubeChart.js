...
var _Klass = utils.defineClass(function CtrlCubeChart(controller, article, prototype, options) {
	...
	buildHtml: function($$parent, controllerDao, buildOptions) {
		...
		if (openDetail) {
			this.$$catchEvt = $('<div class="s-m-catchevt" data-control-id="' + this.id + '" data-action="' + globals.ACTCHARTDETAIL + '"></div>').prependTo(this.$$elmt);
		} else {
			this.$$catchEvt = null;
		}
	...
	childPageGetPageInfo: function(typePage, currentPage) {
		...
		if (typePage === "chartdetail") {
			var article = _getArticle("hub", this.$bind);
