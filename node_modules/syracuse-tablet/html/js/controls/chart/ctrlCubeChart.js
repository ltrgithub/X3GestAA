...
var _Klass = utils.defineClass(function CtrlCubeChart(controller, article, prototype, options) {
	...
	buildHtml: function($$parent, controllerDao, buildOptions) {
		...
		var hasData = this.dataset && this.dataset.length > 0;
		if (this.article.$openDetail && !this.isChartDetailPage() && hasData) {
	...
	childPageGetPageInfo: function(typePage, currentPage, $article) {
		var pageInfo = {
			home: false,
			type: typePage,
			cached: false,
		...
		if (typePage === "chartdetail") {
			...
			if (!article) {
				article = _getChartDetailArticle("bothSideToSide", this.$bind, $article || this.article);
			}
