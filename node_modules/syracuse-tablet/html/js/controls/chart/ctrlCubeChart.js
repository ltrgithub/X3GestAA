...
exports.ctrlCubeChartInterface = {
	...
	childPageGetPageInfo: function(typePage) {
		...
		// $chartDetail contains only the authoring of chart and array control - no possibility to modify the layout structure
		var chartArticle = article ? article.$chartArticle : this.article;
		var arrayArticle = article ? article.$arrayArticle : null;
