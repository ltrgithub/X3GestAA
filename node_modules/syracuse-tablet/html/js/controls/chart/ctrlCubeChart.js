...
var _Klass = utils.defineClass(function CtrlCubeChart(controller, article, prototype, options) {
	...
	buildHtml: function($$parent, controllerDao, buildOptions) {
		...
		if (openDetail) {
			$('<span class="s-m-lnk-detail ' + fontUtils.getIconByName("gear") + '" data-control-id="' + this.id + '"data-action="' + globals.ACTCHARTDETAIL + '"></span>').prependTo(this.$$elmt);
		}
