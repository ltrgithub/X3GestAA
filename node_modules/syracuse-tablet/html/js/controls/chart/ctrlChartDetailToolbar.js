...
var _Klass = utils.defineClass(
	...
	function CtrlChartDetailToolbar($type, controller, options) {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			...
			var measureCount = this.controller.getChart().getMeasureCount();
			...
			this.updateDisplay(this.controller.getUserPrefs().display, "toolbar");
			this.updateDisplay(this.controller.getUserPrefs().style, "chartstyle");
		},
		getHeight: function() {
			return this.$$elmt.is(":visible") ? this._height : 0;
		},
		_actToolbar: function(display) {
			this.controller.setDisplay({
				"display": display
			}, true);
			this.updateDisplay(display, "toolbar");
		},
		_actChartstyle: function(chartType) {
			this.controller.setDisplay({
				"style": chartType
			}, true);
			this.updateDisplay(chartType, "chartstyle");
		},
		updateDisplay: function(display, dataAction) {
