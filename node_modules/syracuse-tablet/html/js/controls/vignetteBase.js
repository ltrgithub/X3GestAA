...
var _actionTitleMgr = {
	...
	iconActionAdd: function(vignetteCtrl) {
		...
		iconBarCtrl.$$header.addClass("s-m-has-icon").append($('<icon data-action="' + _actionTitleMgr.action + '" data-control-id="' + vignetteCtrl.id + '" class="s-m-tile-act ' + icon + '" style="float:right"/>'));
