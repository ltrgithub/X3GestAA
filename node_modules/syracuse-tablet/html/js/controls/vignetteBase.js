		...
		_initActionFooter: function(dstPage) {
			...
			try {
				...
				if (!this._actionFooter) {
					mgr = actionManager.create(dstPage, "footer", {
						multiSelectionOnly: true
					});
					if (!mgr.hasLinks()) return;
					this._actionFooter = ctrlFactory.createVignetteFooter("footer", this);
				}
				this.$$actionIcon = tile.iconActionAdd("togglePinVignette", this, fontUtils.getPinVignetteIcon("off"));
