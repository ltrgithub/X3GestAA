...
var _templates = {
	...
	linkPage: '\
		<div draggable="false" href="{{href}}"\
			...
			{{#if data-gadget-id}}data-gadget-id="{{data-gadget-id}}"{{/if}}\
			data-application-name="{{data-application-name}}"\
			{{#if data-sdata-parameters}}data-sdata-parameters="{{data-sdata-parameters}}"{{/if}}\
			class="s-m-link-page">\
				{{#if icon}}\
	...
	function VignetteBase(controller, article, prototype, opts) {
		...
		_initActionDashboard: function(dstPage) {
			...
			if (dstPage.isChild) {
				...
				notifications[this._actionsEnabled ? "subscribe" : "unsubscribe"](this, ["sm.vignette.pinned"]);
			}
		},
		/**
