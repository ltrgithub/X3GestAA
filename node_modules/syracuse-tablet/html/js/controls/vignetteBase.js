	...
	function VignetteBase(controller, article, prototype, opts) {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			if (this._stateStack.length > 0) {
				...
				$$parent.removeAttr("data-empty-tile");
		...
		_getCssIcon: function(sageBaseCss) {
			var icon = this.article && this.article.$icon || this._gadget.data("icon")
			if (icon) {
		...
		_getTitle: function() {
			return this.article && this.article.$title ? this.getArticleText("$title") : this._gadget.data("$title");
		},
