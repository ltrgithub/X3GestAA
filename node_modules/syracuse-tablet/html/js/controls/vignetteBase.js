...
var _templates = {
	...
	',
	linkPage: '<a draggable="false" href="{{href}}" data-nav-target="application" data-nav="{{data-nav}}" data-gadget-id="{{data-gadget-id}}" data-application-name="{{data-application-name}}" data-sdata-parameters="{{data-sdata-parameters}}" class="s-m-link-page">{{title}}</a>',
	rightpanelactions: '\
