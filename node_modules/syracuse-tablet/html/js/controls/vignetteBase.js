...
var _templates = {
	main: '\
		<div id="{{ctrlId}}" class="s-m-control s-m-vignette"> \
			...
			<div class="s-m-iconsbar"> \
				<div class="s-m-waiting"> \
...
var _Klass = utils.defineClass(
	...
	function(controller, article, prototype) {
		...
		refreshPage: function(options) {
			...
			self._currentPage.refresh(options).then(function() {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			...
			self._$$content = self.$$elmt.find(".s-m-content");
			self._$$wait = uiUtils.waitPluginCreate(self.$$elmt.find(".s-m-waiting"), _waitConfig);
		},
		...
		refreshNavBtns: function() {
			self = this;
			if (!self.$$icons) {
				self.$$icons = self.$$elmt.find(".s-m-iconsbar");
