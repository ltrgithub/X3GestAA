...
var _Klass = utils.defineClass(function(controller, article, prototype) {
	...
	//		var context = {};
	//		context.id = this.id;
	//		html.push(this.templates.execSync("tmplVignette", context));
	//		return html;
	//	},
	...
	/**
	 * Loaded by dashboard.afterRender temporarily we generate a link to the
	 * page load_save load the content - TODO connect later
	 */
	load: function() {
		var self = this;
		var state;
