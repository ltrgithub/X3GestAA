...
var _Klass = utils.defineClass(
	...
	function(controller, article, prototype) {
		...
		/**
		 * Search for control id in vignette's page
		 */
		getControl: function(id) {
			return this._page && this._page.getControl ? this._page.getControl(id) : null;
		},
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			...
			self.$$waiting = self.$$elmt.find(".s-m-vignette-waiting");
			self.$$waiting.waiting(_waitConfig);
