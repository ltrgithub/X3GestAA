...
var _Klass = utils.defineClass(
	...
	function(controller, article, prototype) {
		...
		buildHtml: function(controllerDao, buildOptions) {
			...
			var fieldSlot = Base.uiutils.createDomElement("div", ["sm-field-slot"], null, {
				"id": this.id
			});
		...
		buildFieldTitle: function(buildOptions) {
			return Base.uiutils.createDomElement("div", ["sm-field-title"], this.prototype.property(this.article.$bind).$title);
		},
		buildFieldCore: function(controllerDao, buildOptions) {
			var fieldCore = Base.uiutils.createDomElement("div", ["sm-field-core"]);
			var fieldValueSlot = Base.uiutils.createDomElement("div", ["sm-field-value-slot"]);
			var fieldValue = Base.uiutils.createDomElement("div", ["sm-field-value"]);
		...
		buildFieldValue: function(controllerDao, buildOptions) {
			...
			if (this.article.$isEditMode) {
				return Base.uiutils.createDomElement("input", ["sm-field-input", "form-control"], null, {
					"type": "text",
					"value": controllerDao.getDisplayValue(this.article.$bind)
				});
			} else {
				return Base.uiutils.createDomElement("div", ["sm-field-value-read"], controllerDao.getDisplayValue(this.article.$bind));
			}
		}
	});

exports.Klass = _Klass;
exports.Klass.uiutils = Base.uiutils;