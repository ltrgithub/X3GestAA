...
var _Klass = utils.defineClass(
	...
	function(controller, article, prototype) {
		...
		getDefaultDisplayOptions: function() {
			var self = this;
			return {
		...
		buildHtml: function(parent, controllerDao, buildOptions) {
			...
			if (buildOptions && buildOptions.isGridCell !== true) {
		...
		buildFieldValue: function(parentSlot, controllerDao, buildOptions) {
			...
			if (this.$isEditMode) {
				...
				parentSlot.appendChild(uiUtils.createDomElement("div", ["sm-field-value-read"], controllerDao.getDisplayValue(this.article.$bind)));
			}
		}
	}
);
