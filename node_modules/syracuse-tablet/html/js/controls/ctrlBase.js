...
exports.CtrlBase = utils.defineClass(
	function CtrlBase(controller, $type, article, options) {
		...
		tryGetPage: function() {
			...
			if (!jsutils.isInstanceOf(page, "PageBase")) {
				page = page.page;
			}
			return page;
		}
