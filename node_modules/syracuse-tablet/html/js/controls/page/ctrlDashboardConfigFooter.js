...
var _Klass = utils.defineClass(
	function CtrlDashboardConfigFooter($type, controller, options) {
		...
		_build: function(deviceType) {
			...
			var htmlCtx = {};
			htmlCtx.addHiddenTiles = _getHtml("tablet", "action", {
			...
			htmlCtx.addGroup = _getHtml("tablet", "action", {
				action: "addGroup",
			...
			if (this.options.publish) {
				htmlCtx.dashboardShare = _getHtml("tablet", "action", {
			...
			htmlCtx.dashboardList = _getHtml("tablet", "action", {
				action: "dashboardList",
				icon: fontUtils.pageIcon("dashboardList"),
				title: locale.text("welcome.dashboard.list"),
