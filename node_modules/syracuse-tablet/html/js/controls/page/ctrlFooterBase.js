...
var _Klass = utils.defineClass(
	function($type, controller, options) {
		...
		this.enableMultiSelectionOnly = false;
		...
		_build: function(deviceType) {
			...
			this._actionManager = actionManager.create(actionController, "footer", {
				...
				addMultiSelection: actionController.isMultiSelectionEnabled(),
				enableMultiSelectionOnly: this.enableMultiSelectionOnly
			});
		 ...
		 * This method is called each timethe footer is toggled
		 */
