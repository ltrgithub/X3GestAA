	...
	function(controller, options) {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			...
			if (this.$$footer) {
				...
				var actionPanel = this.controller.panelGet(_actionPanelId);
				if (actionPanel && actionPanel.isEnabled()) {
					this._enableActionPanel();
				}
			}
		},
		...
		_actFooterAction: function(id) {
			if (id === _actionPanelId) {
				this.controller.panelAttach("right", id, "toggle");
			}
		},
