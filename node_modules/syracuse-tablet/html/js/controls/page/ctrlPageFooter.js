...
var _Klass = utils.defineClass(
	function(controller, options) {
		...
		_actMultiSelection: function(uuid, $$target) {
			this.multiSelManager.toggle($$target, this.$$elmt.find(".s-m-footer-right"));
		},
		...
		_tabletHtml: function(opts) {
			...
			if (self.actionManager) {
				...
				self.multiSelManager = multiSelectionMgr.create(self);
				self.actionManager = actionManager.create(self.controller, "footer", {
					addCancelEditAction: "footerLink",
					addMultiSelection: self.multiSelManager != null ? "multiSelection" : null
				});
			}
