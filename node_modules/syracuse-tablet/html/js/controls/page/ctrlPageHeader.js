...
var _userPanelId = "userpanel";
var _actionPanelId = "pageactionpanel";
...
var _Klass = utils.defineClass(
	...
	function(controller, options) {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			...
			// Build the header with default deviceClass - To avoid flickering of the page
			// Improvement is done in onMainPageResize
			this._build();
		},
		...
		_build: function(deviceClass) {
			...
			if (deviceType === "smartphone") {
				...
				this.resetPanels();
				this._smphUserpanel = this.controller.panelCreate(_userPanelId);
				this._smphPageactionpanel = this.controller.panelCreate(_actionPanelId);
			} else {
		...
		_actHeaderAction: function(id) {
			if (id === _actionPanelId || id == _userPanelId) {
				var panel = this["_smph" + id.smCapitalize()];
