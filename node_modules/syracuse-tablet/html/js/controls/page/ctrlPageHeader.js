...
var _Klass = utils.defineClass(
	...
	function(controller, $type) {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			...
			$$linksPicker.on("click", function(ee) {

				// get header links list dom or build it
				var $$hLinksList = $(".s-m-header-links-list");
				var isBuilt = $$hLinksList.length > 0;
				...
				if (!isBuilt) {
					...
					$$hLinksList = $(_getHtml("headerLinks", _mainCtx));
					$$hLinksList.css("position", "absolute");
					$("#s-m-app-id").append($$hLinksList);
					$$hLinksList.position({
						my: "right top",
						at: "right bottom",
