					...
					<div class="dropdown">\
						...
						<ul class="dropdown-menu" role="menu" aria-labelledby="{{headerDropdownId}}">\
							...
							{{#if showDevelopment}} \
								...
								<li>\
									<a href="#" data-action="linkClicked" data-params="developmentPage" data-control-id="{{ctrlId}}" class="list-group-item">\
										<span class="' + fontUtils.pageIcon("developmentPage") + '" />\
										<span>{{labelDevelopmentPage}}</span>\
									</a>\
								</li>\
							{{/if}} \
						</ul>\
	...
	function(controller, $type) {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			...
			var _mainCtx = {
				...
				labelDevelopmentPage: locale.text("header.links.development"),
				showDevelopment: globals.isDvlpMode()
			};
			...
			var $$header = $(_getHtml(isTablet ? "main" : "mainMobile", _mainCtx));

			// remove dom for dropdown links if conditions not met
			if (!buildOptions.showAuthoring && !buildOptions.showLinks) {
				$$header.find("ul.dropdown-menu").remove();
			}

			self.setRootElement($$header, $$parent);
