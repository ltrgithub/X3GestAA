...
var _Klass = utils.defineClass(
	...
	function(controller, options) {
		...
		_smartPhoneHtml: function(opts) {
			...
			function getLabelContent(isLabelDom, labelVal, opts) {
				if (isLabelDom) {
			...
			if (this.controller.state.isWelcomePage) {
				labelContent = getLabelContent(false, null, opts);
			} else {
				// app dashboard page --> app title
				if (self.controller.state.isHomeDashboard) {
					labelContent = getLabelContent(true, globals.getApplication().getTitle());
				} else {
					// inside app --> page title
					if (self.controller.prototype.data("$title")) {
						labelContent = getLabelContent(true, self.controller.prototype.data("$title"));
					}
