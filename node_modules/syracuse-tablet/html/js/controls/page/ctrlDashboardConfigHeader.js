...
var _templates = {
	main: '\
			<div class="s-m-header {{deviceType}} s-m-dasboard-config">\
				<div class="s-m-header-links  dashboard-header-switch">\
				{{#each views}}\
				...
				<buttons class="pull-right dashboard-header-btn">\
					<button type="button" class="btn btn-danger" data-action="closeDashboardConfig">\
						<i class="fa fa-close"></i>\
					</button>\
					{{#if personal}}\
					<button type="button"class="btn btn-default" data-action="savePersonnalDashboard">\
