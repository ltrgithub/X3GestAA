...
var _templates = {
	main: '\
			<div class="s-m-header {{deviceType}} s-m-dasboard-config">\
				<div class="s-m-header-links  dashboard-switch">\
				{{#each views}}\
					<a href="#" draggable="false" class="s-m-link" data-action="changeWelcome" data-params="{{$uuid}}">\
					{{#if $selected }}\
						<li class="fa fa-circle"></li>\
					{{else}}\
						<li class="fa fa-circle-thin"></li>\
					{{/if}}\
				</a>\
				{{/each}}\
				</div>\
				<div class="s-m-header-links">\
					...
					{{#if personnalCreate}}\
					<a href="#" draggable="false" class="s-m-link" data-action="savePersonnalDashboard" data-params="create">\
						<i class="fa fa-check"></i>\
					</a>\
					{{/if}}\
					{{#if personnalReplace}}\
					<a href="#" draggable="false" class="s-m-link" data-action="savePersonnalDashboard" data-params="replace">\
						<i class="fa fa-check"></i>\
					</a>\
					{{/if}}\
					{{#if publish}}\
					<a href="#" draggable="false" class="s-m-link" data-action="publishDashboard" data-params="">\
