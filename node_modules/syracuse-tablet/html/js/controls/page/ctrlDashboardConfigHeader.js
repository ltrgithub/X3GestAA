			...
			<div class="s-m-header {{deviceType}} s-m-dasboard-config">\
				...
				<buttons class="pull-right dashboard-header-btn" style="width:{{rightBtnWidth}}px">\
					...
					{{#if dirty}}\
						...
						{{else}}\
							{{#if savePublished}}\
								<button type="button"class="btn btn-default" data-action="publishDashboard">\
									<i class="fa fa-check"></i>\
								</button>\
							{{/if}}\
						{{/if}}\
...
var _Klass = utils.defineClass(
	...
	function ctrlDashboardConfigHeader($type, controller, options) {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			...
			options.rightBtnWidth += ((options.dirty && (options.personal || options.savePublished)) ? this._height : 0);
