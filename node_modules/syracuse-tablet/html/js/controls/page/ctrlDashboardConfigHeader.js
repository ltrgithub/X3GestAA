...
var _Klass = utils.defineClass(
	...
	function ctrlDashboardConfigHeader($type, controller, options) {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			...
			options.description = self.options.currentView[0].$description;
			options.factoryOwner = self.options.currentView[0].$factoryOwner;
			...
			options.displaySaveButton = "none"
				// If user want to replace its own dashboard by a template display by default the save button
