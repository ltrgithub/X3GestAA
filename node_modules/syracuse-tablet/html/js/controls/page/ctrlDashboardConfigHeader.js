...
var _Klass = utils.defineClass(
	...
	function ctrlDashboardConfigHeader($type, controller, options) {
		...
		buildHtml: function($$parent, controllerDao, buildOptions) {
			...
			this._$$parent = this.$$elmt.closest("header");
			...
			options.template = !options.personal;
			options.roleCount = options.roles.length;
		...
		notifDashboardRolesChange: function(roles) {
			$(".s-m-dashboard-header-role-number", this.$$elmt).text(roles.length);
		},
		/**
