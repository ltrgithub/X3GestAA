...
var _Klass = utils.defineClass(
	...
	function SidePanel(controller, $type, panelId, options) {
		...
		// true by default - if true the scroll element should have the class s-m-scroll-elmt
		...
		onMainPageResize: function(info) {
			// Called only if device or orientation changed
		},
		_updateGesture: function() {
			if (this.$$elmt.is(':visible') && this.$$elmt) {
				if (!this._gestureMgr) {
