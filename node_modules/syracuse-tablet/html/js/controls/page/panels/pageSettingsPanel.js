...
var _liveTile = [{
	...
	/* Text color is not supported right now
, {
	id: "textColor",
	size: 10,
	picker: true,
...
var _Klass = utils.defineClass(
	...
	function(controller, $type, panelId, options) {
		...
		_getContext: function() {
			...
			var context = page.getPageSettingsContext();
			var ctx = {
				ctrlId: this.id,
				side: this.side
			};
			...
			if (ctx.vignette && ctx.vignette.liveTile) {
				...
				ctx.vignette.liveTile.items.unshift({
					id: "vignette",
					label: locale.text("liveTile.vignette.label"),
					emptyOptionLabel: locale.text("liveTile.vignette.label.emptychoice"),
					select: true,
					dataAction: "choice"
				});
			}
		...
		_actChoice: function(id) {
			...
			btnCreate.toggle(this.$$elmt.find("#vignette").val());
		},
