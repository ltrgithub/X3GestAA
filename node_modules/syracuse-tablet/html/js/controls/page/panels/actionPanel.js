...
var _Klass = utils.defineClass(
	...
	function(controller, $type, panelId, options) {
		...
		buildPanel: function(context, side) {
			var facetLinks = this._getFactLink();
			if (facetLinks) {
		...
		_getFactLink: function() {
			var lnks = actionManager.getLinks(this.controller, "actionpanelparent", {
				deviceType: globals.getSiteLayout().getDeviceType()
			});
			return lnks && Object.keys(lnks).length > 0 ? lnks : null;
		},
		isEnabled: function() {
			return true;
		},
