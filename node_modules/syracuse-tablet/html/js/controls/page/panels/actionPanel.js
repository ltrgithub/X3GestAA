...
var _Klass = utils.defineClass(
	...
	function(controller, $type, panelId, options) {
		...
		// true by default
		this.enableGesture = this.enableTwoColumns != true && options.enableGesture !== false;
		...
		onMainPageResize: function(info) {
			if (this.enableTwoColumns && (info.deviceChanged || info.orientationChanged)) {
		...
		updateGesture: function() {
			if (this.$$elmt.is(':visible') && this.$$panel) {
				if (!this._gestureMgr) {
					this.$$scrollElmt = this.$$panelContent;
					this.$$scrollElmt.css({
						height: "auto",
						position: "relative"
					});
