	...
	function(controller, $type, panelId, options) {
		...
		notifDraftsChanged: function(count) {
			if (!this.$$elmt) {
				...
				this._doAfterBuildPanel = jsutils.bindFn(this.notifDraftsChanged, this, count);
			} else {
