	...
	function(panel, id, options) {
		...
		doActionApply: function() {
			if (this.currentSelection !== null) {
				...
				if (fav) {
					this.panel.getParentArray().sortInfoSet($.extend(true, [], fav.sort), false);
					this.panel.getParentArray().filterInfoSet($.extend(true, [], fav.filter), true);
				}
			}
		...
		saveFavorites: function() {
			...
			prefs.isDirty = true;
			return this.panel.savePagePrefs();
		}
	});
