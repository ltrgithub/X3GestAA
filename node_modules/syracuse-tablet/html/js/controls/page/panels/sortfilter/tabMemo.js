...
var _Klass = utils.defineClass(
	function(panel, id, options) {
		...
		_onMemoClick: function(idx) {
			this.panel.getParentArray().sortInfoSet($.extend(true, [], this.panel.items[idx].sort), false);
			this.panel.getParentArray().filterInfoSet($.extend(true, [], this.panel.items[idx].filter), true);
			this.panel.close();
		},
		onBlur: function() {
			this._updateValue();
