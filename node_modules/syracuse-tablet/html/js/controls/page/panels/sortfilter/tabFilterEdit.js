	...
	main: '\
		<section id="formtabroot">\
			...
			<div class="btn-group btn-group-justified" role="group">\
				...
				<a type="button" class="btn btn-default" disabled="disabled" data-params="submitFilterEdit">\
...
var FormKlass = utils.defineClass(
	function(proto, dao, gestureMgr, filtersMap) {
				...
				switch (ctrl.$bind) {
					case "FIELDS":
						...
						if ($$target.val() == 0) {
							...
							$("a[data-params='submitFilterEdit']").attr("disabled", "disabled");
							return;
						} else {
							// set button validate enabled
							$("a[data-params='submitFilterEdit']").removeAttr("disabled");
		...
		validateForm: function() {
			var self = this;
			var res = true;
			this.forEachControl(function(bind, ctrl) {
	...
	function(parentTab) {
		...
		*/
		setInitData: function(info, initIdx) {
			...
			var bind = ff.isReference ? ff.prop.$item.$refValue : "VALUE-" + ff.id;
