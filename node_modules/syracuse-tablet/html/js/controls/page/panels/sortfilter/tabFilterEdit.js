...
var _Klass = utils.defineClass(
	function(parentTab) {
		...
		create: function($$container) {
			...
			self._buildProtoJson().then(function(result) {
				// set protoJson value
				protoJson = result.protoJson;

				// set data for application/x-choice fields
				if (result.dataJson && Object.keys(result.dataJson).length > 0) {
