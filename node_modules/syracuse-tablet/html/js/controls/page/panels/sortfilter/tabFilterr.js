	...
	function(panel, id, options) {
		...
		*/
		...
		_openFilterEdit: function(filterIdx) {
			...
			// get filter edit tab
			self.filterEditTab = self.filterEditTab || self.panel.getTabs().form;

			// show filter edit tab content
			self.filterEditTab.triggerActivate();

			// set filter tab init data
			//self.filterEditTab.initData(self._isIndexValid(filterIdx) ? self.filterInfo[filterIdx] : null);
		...
		_onFilterUpdate: function(filterInfo) {
			//TODO
			var self = this;

			self._addFilter(filterInfo);

			self.triggerActivate();
