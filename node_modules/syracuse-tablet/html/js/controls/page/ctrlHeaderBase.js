...
var _Klass = utils.defineClass(
	...
	function CtrlHeaderBase($type, controller, options) {
		...
		getHeaderOptions: function(buildOptions) {
			...
			opts.showAuthoring = (globals.isDesktop() === true && _mustHideDevFeatures() === false) ? opts.showAuthoring : false; // Show full feature authoring only if on PC
		...
		getProtoTitle: function() {
			if (globals.isDvlpMode()) {
				return "Titre super long pour tester le nouvel header adaptatif  et qui devrait normalement ne pas plier lorsque la taille de l'écran diminue";
			}
