...
var _Klass = utils.defineClass(
	...
	function CtrlHeaderBase($type, controller, options) {
		...
		getHeaderOptions: function(buildOptions) {
			...
			opts.showAuthoring = (utils.isDesktop() === true && _mustHideDevFeatures() === false && utils.hasDesignRight()) ? opts.showAuthoring : false; // Show full feature authoring only if on PC
