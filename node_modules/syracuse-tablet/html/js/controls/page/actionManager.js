	...
	function(options) {
		...
		_doLinkAction: function(page, link) {
			...
			var _end = function(success, data) {
				// Just notify - resolve of action is done by caller
				self._notify(page, success, link, data);
				deferred.resolve(success, data);
			};
			try {
				// Validate the data before processing - sm.validate.action.link
				// It's a synchronous call - workaround
				if (page && page.notifValidateActionLink && page.notifValidateActionLink() === false) {
