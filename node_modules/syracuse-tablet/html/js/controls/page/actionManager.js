...
var _displayMessage = function(title, data, cb) {
	...
	if (utils.isError(data)) {
		...
		if (data.responseJSON) data.responseJSON = responseJSON;
...
var _Klass = utils.defineClass(
	...
	function(options) {
		...
		self.options.$links.forEach(function(l, idx) {
			l.css = [];
			// TODO manage $links properties in reply
			if (false && l.$isHidden === true) l.css.push("hidden");
			if (false && l.$isDisabled === true) l.css.push("disabled");
			l.css = l.css.join(' ');
				...
				if (self.getLinks().some(function(l) {
					...
					if (link.$confirm) {
						...
						modal.simpleConfirm(link.$confirm, function(confirmed) {
							if (confirmed) {
								self._doLinkAction(link).then(function(data) {
