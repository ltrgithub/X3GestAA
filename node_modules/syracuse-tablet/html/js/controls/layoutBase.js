...
var _Klass = utils.defineClass(function(controller, type, article) {
	...
	buildHtml: function(parent, controllerDao, buildOptions) {
		// layout container
		var container = uiUtils.createDomElement('div', ["container", "s-m-layout", "s-m-" + this.article.$layoutType], null, {
			"id": this.id
		});
		...
		// #### build layout core ####
		var coreSlot = uiUtils.createDomElement("div", [this.article.$layoutType], null, {
