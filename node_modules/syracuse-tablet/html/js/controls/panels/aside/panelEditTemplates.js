			...
			<section class="panel panel-default create">\
				...
				<div class="panel-body">\
					<table style="width:100%"><tr>\
						<td><span style="padding-right:10px;">{{name}}</span></td>\
						<td>\
	...
	function PanelEditTemplates(controller, $type, article, options) {
		...
		_buildItems: function() {
			...
			_readTemplates(this.page, this._selectedFilter).then(function(totalCount, templates) {
				...
				self._$$filter.val(self._selectedFilter).toggle(self._selectedFilter === "all" || totalCount > templates.length);
				self._$$filter.toggle(templates.length > 0);
