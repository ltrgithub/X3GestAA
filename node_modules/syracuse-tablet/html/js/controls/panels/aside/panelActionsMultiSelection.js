...
var _availableSlots = ["actions", "links", "main", "array", "tools", "home", "unclassified"]
	/**
	 * 
	 */
exports.PanelActionsMultiSelection = utils.defineClass(
	function PanelActionsMultiSelection(controller, type, article, opts) {
		...
		_getItems: function() {
			return this.actionAdapter.getMultiSelectionSidePanelItems()
		},
		_extendContext: function(ctx) {
			ctx.title = locale.text("actions");
			return ctx
		},
		...
		_getItemHtml: function(item) {
			return panelsHtml.getItemHtml("actionPanel", item)
		},
		show: function() {
			if (this.$$elmt) {
