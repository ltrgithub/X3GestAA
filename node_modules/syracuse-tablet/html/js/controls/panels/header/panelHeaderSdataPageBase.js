...
exports.PanelHeaderSdataPageBase = utils.defineClass(
	function PanelHeaderSdataPageBase(controller, type, article, opts) {
		...
		_onPress: function(evt) {
			var self = this;
			this.$$btnBack = $("[data-naction='historyBack']");
			this.$$btnBack.removeAttr("data-naction");
			setTimeout(function() {
				try {
					self.$$btnBack.attr("data-naction", 'historyBack')
				} catch (e) {}
			}, 2000)
			notifications.publish("sm.header.panel.pressed", this);
			return true;
		},
		/**
		 * 
