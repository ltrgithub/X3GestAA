...
exports.TabFilter = utils.defineClass(
	function TabFilter(panel, id, options) {
		...
		this.filterInfo = $.extend(true, [], this.panel.filterInfoGet());
	}, Base, {
		destroy: function() {
		...
		updateFilterList: function(list) {
			...
			this.filterInfo = list || (this.filterInfo) ? this.filterInfo : $.extend(true, [], this.panel.filterInfoGet());
		...
		doActionApply: function() {
			this.panel.filterInfoSet($.extend(true, [], this.filterInfo || this.panel.filterInfoGet()), false);
		},
		...
		doContentAction: function(evt, $$target, dataParams) {
			...
			filterChange && this.panel.unselectMemo(); /*filter change so unselect current memo*/
		},
		/*
