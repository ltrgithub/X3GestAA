	...
	main: '\
			<div class="header">\
				<buttons class="pull-left">\
					<button type="button" class="btn btn-default fa fa-arrow-left" data-control-id="{{ctrlId}}" data-nevent="" data-naction="cancel"/>\
				</buttons>\
				<buttons class="pull-right">\
					<button type="button" class="btn btn-default ' + fontUtils.sortFilterTab("memo") + '" data-control-id="{{ctrlId}}" data-nevent="" data-naction="memo"/>\
					<button type="button" class="btn btn-default ' + fontUtils.sortFilterTab("apply") + '" data-control-id="{{ctrlId}}" data-nevent="" data-naction="apply"/>\
				</buttons>\
