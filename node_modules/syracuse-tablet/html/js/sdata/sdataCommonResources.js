...
var _welcomeDashboardListUrl = "/sdata/syracuse/collaboration/syracuse/welcomeDashboards/$service/availableDashboards";
...
exports.queryWelcomeDashboards = function() {
	try {
		var params = {
			method: "GET",
			url: _welcomeDashboardListUrl + "?user=" + globals.getUserUuid() + "&role=" + globals.getSeletedRoleUuid()
		};
		params.parsedUrl = sdataUtils.parseSDataURL(params.url);
		return sdataHttp.send(params)
			.then(function(result) {
