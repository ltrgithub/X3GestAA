...
var _welcomeDashboardUpdtUrl = "/sdata/syracuse/collaboration/syracuse/welcomeDashboards/$service/updateDashboard";
var _welcomeDashboardUrl = "/sdata/syracuse/collaboration/syracuse/welcomeDashboards/$service/availableDashboard";
var _welcomeDashboardDeleteUrl = "/sdata/syracuse/collaboration/syracuse/welcomeDashboards/$service/deleteDashboard"
var _roleListUrl = "/sdata/syracuse/collaboration/syracuse/welcomeDashboards/$service/listOfRoles";
...
exports.queryWelcomeDashboard = function(uuid) {
	var params;
	return $.smResolve().then(function() {
		params = {
			method: "GET",
			url: _welcomeDashboardUrl + "?user=" + globals.getUserUuid() + "&role=" + globals.getSeletedRoleUuid() + (uuid ? "&uuid=" + uuid : "")
		};
		params.parsedUrl = sdataUtils.parseSDataURL(params.url);
		return sdataHttp.send(params)
	}).then(function(result) {
		...
		return ajax.rejectHttpResult(locale.text("err.load.welcomeDashboards"), result, params.url);
	});
};
...
exports.updateWelcomeDashboard = function(data) {
	try {
		var params;
		return $.smResolve().then(function() {
			params = {
				method: "POST",
				url: _welcomeDashboardUpdtUrl,
				send: data
			};
			params.parsedUrl = sdataUtils.parseSDataURL(params.url);
			return sdataHttp.send(params);
			...
			return ajax.rejectHttpResult(locale.text("dashboard.welcome.updating.error"), result, params.url);
		});
...
exports.deleteWelcomeDashboard = function(uuid) {
	try {
		var params;
		return $.smResolve().then(function() {
			params = {
				method: "GET",
				url: _welcomeDashboardDeleteUrl + "?uuid=" + uuid + "&user=" + globals.getUserUuid() + "&role=" + globals.getSeletedRoleUuid(),
			};
			params.parsedUrl = sdataUtils.parseSDataURL(params.url);
			return sdataHttp.send(params);
		}).then(function(result) {
			...
			return ajax.rejectHttpResult(locale.text("dashboard.welcome.deleting.error"), result, params.url);
		});
