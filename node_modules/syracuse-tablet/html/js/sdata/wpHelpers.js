...
exports.pinPage = function(pageData, article) {
	...
	return _getCurrentWelcomeDashboard()
		.then(function(data) {
			...
			Object.keys(pageData.localization).forEach(function(lang) {
				Object.keys(pageData.localization[lang]).forEach(function(key) {
					data.content.$article.$localization[lang] = data.content.$article.$localization[lang] || {}
					data.content.$article.$localization[lang][key] = pageData.localization[lang][key]
				})
			});
...
function _buildTileGadget_not_used(pageData) {
	return {
		"$type": pageData.$type,
		"$title": pageData.$title,
		"icon": pageData.icon,
		"parameters": pageData.parameters,
		"statName": pageData.statName,
		"action": pageData.action,
		"representation": pageData.representation,
		"facet": pageData.facet,
		"applicationName": pageData.applicationName,
