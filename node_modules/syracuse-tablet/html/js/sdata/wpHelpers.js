...
exports.pinPage = function(pageData) {
	var self = this;
	return _getWelcomeDashboarClient()
		.then(function(data) {
			...
			lastGroup.$items.push(_buildArticle(pageData));
			return data
		}).then(function(data) {
...
function _buildGadget(pageData) {
	if (pageData.$type == "$mobileDashboard") {
...
function _buildRepresentationGadget(pageData) {
	return {
		...
		"applicationName": pageData.clientContext.$mobileApplication,
		"icon": pageData.icon,
	};
}
