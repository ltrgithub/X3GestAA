...
exports.getPrototype = function($url, options) {
		return exports._getPrototype(protoHelpers.getPrototypeUrl($url), options)
	}
	/**
	 ...
	 */
exports.saveDraft = function(draftCtx, draftIdx) {
	if (!draftCtx) {
	...
	return exports._getPrototype(protoHelpers.getPrototypeUrl(draftCtx.draftUrl), {
