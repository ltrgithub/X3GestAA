...
exports.DatasetBase = utils.defineClass(
	...
	null, {
		...
		setDraftsData: function(data) {
			...
			this.applyDelta(datasetUtils.renewAllIds(data), "template");
			// Restores mandatory $clientContext - $clientContext gives stateless mode 
			this.json.$clientContext = $clientContext;
		}
	}
);