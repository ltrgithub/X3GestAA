...
exports.DatasetBase = utils.defineClass(
	...
	null, {
		...
		/**
		 * Process the given operation on data || this.json
		 */
		_processData: function(operation, data) {
			if (!this._dataProcessor) {
				this._dataProcessor = new datasetUtils.DataProcessor;
			}
			return this._dataProcessor.process(operation, data || this.json);
		},
		getTemplateData: function() {
			var op = {
				dataToTemplate: {}
			};
			var data = $.extend(true, {}, this.json);
		...
		setTemplateData: function(data) {
			...
			this._setTmplWalkProto(this.prototype.json, data, this.json);
			this.setDirty();
		},
		/**
		 * Check data according to the prototype
