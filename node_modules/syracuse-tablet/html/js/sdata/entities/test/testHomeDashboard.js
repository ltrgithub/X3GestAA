	...
	"testHomeDashboard": {
		...
		"$article": {
			...
			"$items": [{
				...
				"$layoutType": "hubGroup",
				"$title": "testSTATISTIC SUPERV",
				"$items": [{
					"$layoutType": "tile",
					"$bgColor": "purple",
					"$items": [{
						"$bind": "testSTATISTICDashboard"
					}],
				}]
			}, {
				"$layoutType": "hubGroup",
				"$title": "testAQMPROJECTMDashboard",
				"$items": [{
					"$layoutType": "tile",
					"$bgColor": "green",
					"$items": [{
				...
				"$layoutType": "hubGroup",
				"$title": "testAQMINTIMESMDashboard",
				"$items": [{
					"$layoutType": "tile",
					"$bgColor": "purple",
					"$items": [{
