...
exports.gadgets = {
	"testRecordLinkToDashboard": {
		...
		"entity": "testNavigateToDashboard",
		"action": "$query",
		"representation": "testNavigateToDashboard",
		"facet": "$query"
	},
	"testRecordWithContext": {
		"$type": "$representation",
		"$title": "Click to navigate",
		"entity": "testNavigateToDashboardChild",
		"action": "$query",
		"representation": "testNavigateToDashboardChild",
		"facet": "$query"
	}
};