...
var _testGaugeChart1 = require('syracuse-tablet/html/js/sdata/entities/test/testGaugeChart1');
var _testGaugeChart2 = require('syracuse-tablet/html/js/sdata/entities/test/testGaugeChart2');
var _testGaugeChart3 = require('syracuse-tablet/html/js/sdata/entities/test/testGaugeChart3');
var _testGaugeChart4 = require('syracuse-tablet/html/js/sdata/entities/test/testGaugeChart4');
...
exports.register = function() {
	...
	clientContract.registerEntity(_testGaugeChart1.entity);
	clientContract.registerEntity(_testGaugeChart2.entity);
	clientContract.registerEntity(_testGaugeChart3.entity);
	clientContract.registerEntity(_testGaugeChart4.entity);
