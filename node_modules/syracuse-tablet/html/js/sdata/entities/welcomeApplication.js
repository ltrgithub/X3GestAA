...
var _addLiveTileLink = function(tiles, gagdet) {
	return;
	if (!gadget || !gadget.endpoint || !gadget.applicationName) return;
	titles.push({
		type: "gadget",
		gadget: gadget,
		title: gadget.$title
	...
	return $.smResolve()
		...
		.then(function() {
			...
			if (native.hasCapability("voiceCommands")) {
				native.getModule("voiceCommands").setVoiceBookmarks(titlesOnWelcomePage, "set");
			}
			return dashboard;
		})
		.fail(function(e) {
