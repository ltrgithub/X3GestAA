...
function _buildPage(repr, facet, entity, page) {
	...
	// tag page as unit page
	page.$prototype.$isUnitTest = entity.$isUnitTest === true;
	if (page.$prototype.$isUnitTest && !page.$prototype.$title) {
		page.$prototype.$title = "Unit test " + entity.$entityName;
	}
	if (entity.$prototype) {
