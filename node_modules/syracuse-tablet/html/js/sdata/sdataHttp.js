		...
		ajax(params.method, params.url, params.send, params.headers, params.options)
			.then(function(result) {
				...
				try {
					...
					_rejectError(e, "sdata Ajax JSON parsing Exception");
				}
			}, function(e) {
				_rejectError(e, "sdata Ajax rejected");
			});
	} catch (e) {
		_rejectError(e, "sdata Ajax Javascript Exception");
	}
