					...
					if (result) {
						...
						return self._newDoHttp(op, data)
							.then(function(result) {
								...
								return $.smReject(new Error("Error reading $template"));
							});
					}
				})
				.then(function(result) {
					...
					if (result) {
						...
						return self._readDoHttp(op, data)
							.then(function(result) {
								...
								return $.smReject(new Error("Error reading data"));
							});
					}
				})
				.then(function(result) {
					...
					if (result && result.length > 0) {
						...
						return self._queryDoHttp(op, data)
							.then(function(result) {
								...
								return $.smReject(new Error("Error querying data"));
							});
					}
				})
				.then(function(result) {
		...
		try {
			self._saveDoHttp(op, data)
				.then(function(result) {
					...
					return $.smReject(new Error("Error saving object"));
				})
				.then(function(result) {
					deferred.resolve(result);
				}, function(e) {
