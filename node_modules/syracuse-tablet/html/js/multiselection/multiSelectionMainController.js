		...
		multiSelToggleStatus: function() {
			if (this._panel == null) {
				var panelInfo = {
					...
					topIndex: 0,
					selector: "header",
					$type: "application/x-panel-header-multisel"
				}
				this._panel = this._page.attachedControlsMgr.createAddtionalControl(panelInfo, {});
				this._array = this._page.getQueryArray();
			}
			this.isEnabled = this._page.attachedControlsMgr.toggleControls("headerMultisel", "header");
		...
		_processTogglePanel: function(show) {
			if (this._panelRun == null) {
				var panelInfo = {
					...
					topIndex: 0,
					selector: "header",
					$type: "application/x-panel-header-multisel-run"
				}
				this._panelRun = this._page.attachedControlsMgr.createAddtionalControl(panelInfo, {});
			}
			this._page.attachedControlsMgr.toggleControls("headerMultiselRun", "headerMultisel", show);
