...
var _init = function(rsrc, rsrclang) {
	try {
		...
		modal.init();
		locale.init(rsrc, rsrclang);
		// Create global site
		var site = factory.createSite($("#site"));
		// Goto page
		site.changePage(window.location.hash).then(function(dstPage) {
...
exports.main = function(rsrc, rsrclang) {
