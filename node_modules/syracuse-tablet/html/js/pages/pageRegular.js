...
var _Page = utils.defineClass(
	function($parent, state, prototype, article) {
		...
		notifRowdetailUpdate: function(data, arrayId) {
			if (!data) return;
			var childDao = data.dao;
			if (!childDao) return;
			if (childDao.updateParentRow(data.activity === "create", this.dao)) {
		...
		notifRowdetailDelete: function(data, arrayId) {
			...
			this.getDao().deleteRow(arrayId, data.uuid);
			//	this.getControl(arrayId).
		}
	});
