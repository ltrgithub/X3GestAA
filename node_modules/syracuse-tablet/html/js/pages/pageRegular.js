...
var _Page = utils.defineClass(
	function RegularPage($parent, state, prototype, article, options) {
		...
		$filtersHasAuthoring: function() {
			// We force tabs display for smartphones
			return this._$filters && this._$filters.length > 0 && globals.getSiteLayout().getDeviceType() !== "smartphone";
		}
	});
