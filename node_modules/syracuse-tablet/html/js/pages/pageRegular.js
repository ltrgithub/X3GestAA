		...
		getLinksInitStatus: function() {
			...
			var res = {
				dirtyDao: {
					...
					isDirty: this.dao.isDirty || this._dataLoadedFrom === "draft",
					$uuid: this.dao.data.$uuid
				}
			};
			var ep = globals.getEndpoint();
			var representation = this.dao.data.$representation;
			return globals.getStorage().templateOperation("count", ep, representation).then(function(count) {
				res.editTemplates = {
					count: count,
					getendpoint: ep,
