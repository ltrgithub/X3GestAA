...
var _Page = utils.defineClass(
	function RegularPage($parent, state, prototype, article, options) {
		...
		// Working copy is ùanages if nativeApp because it is used to restore the context on nativeAppClosing/nativeAppResume events
		this.enableWorkingCopy = this.isEditMode() && native.hasCapability("nativeApp");
	}, Base, {
		...
		/**
		 * returns true if back is allowed
		 */
		checkBack: function() {
			// TODO Drafts  - check dao.isDirty
			return true;
		}
	});
