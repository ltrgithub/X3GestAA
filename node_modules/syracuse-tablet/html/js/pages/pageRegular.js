...
var _Page = utils.defineClass(
	function($parent, state, prototype, article) {
		...
		notifActionLink: function(success, link, result, options) {
			...
			if (this.isChild) return this.doChildAction(success, link, result, options);
			try {
		...
		doChildAction: function(success, link, responseJSON, options) {
			alert("doChildAction");
		},
		...
		_doActSave: function(success, link, responseJSON, options) {
			...
			var diags = responseJSON.$diagnoses;
