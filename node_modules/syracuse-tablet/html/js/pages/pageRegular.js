...
var _Page = utils.defineClass(
	function RegularPage($parent, state, prototype, article, options) {
		...
		this._nativeSupportsLiveTile = (state.subtype === "query");
		...
		loadData: function(loadOptions) {
			...
			try {
				...
				if (this.prototype.acceptServerPagination()) {
					...
					dispatchOptions.$authCacheId = this.id;
				}
				dispatcher.dispatch({
					...
					if (!data) {
						...
						data = self.getEmptyDao(self.prototype);
					}
					self.setDao(factory.createDaoSdata(data, self.prototype, {}));
