...
var _Page = utils.defineClass(
	...
	function ChartDetailPage($parent, state, prototype, article, parentPage, options) {
		...
		afterRender: function(buildOpts) {
			 ...
			 */
			if (false && this._$$breadcrumbs) {
				this._$$breadcrumbs.hide();
			}
			if (false && this._$$topToolbar) {
		...
		_setDisplay: function(opt) {
			...
			Base.prototype.authUpdateLayout.call(this, article).then(function() {
				 ...
				 */
				setTimeout(function() {
					if (false && self._$$breadcrumbs) {
						self._$$breadcrumbs.show();
					}
					if (false && self._$$topToolbar) {
		...
		actToolbarSetDisplay: function(opt) {
			if (this._setDisplay(opt)) {
				// Save prefs
				var prefs = this.getUserPrefs();
				prefs.display = this._display;
				prefs.style = this._style;
