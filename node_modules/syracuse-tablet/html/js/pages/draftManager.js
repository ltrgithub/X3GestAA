...
var _DraftMgr = function(page) {
	...
	this.notifDataLoaded = function(refreshed) {
		...
		// We enable only save button by calling publishDirty and keep dao not dirty
		this._page.dao.publishDirty(true, true);
	...
	this.notifSaveFailed = function(result) {
		var self = this;
		if (result && result.responseJSON && result.responseJSON.$noConnectionError === true) {
			/**
