...
exports.DraftsManager = function DraftsManager(page) {
	...
	this.saveInDB = function(comment, offline) {
		...
		draftUrl = jsutils.parseURL();
		draftUrl.protocol = "draft";
		...
		draftUrl = jsutils.urlToString(jsutils);
		var draftContext = {
			"id": uuid,
			"draftUrl": draftUrl,
			...
			"comment": comment || "",
			"dataSet": this._page.getDataset().getTemplateData(this._page.controller),
