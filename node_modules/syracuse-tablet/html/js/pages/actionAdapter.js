...
exports.ActionAdapter = utils.defineClass(
	...
	null, {
		...
		_addPinButton: function(items, status, controller, overrides) {
			...
			this._addDataAction(items, "pinPage", status + "Page", null, "global.action.title." + status, "", controller, overrides);
		},
		_addDesignPageButton: function(items, controller, overrides) {
			this._addDataAction(items, "designPage", "designPage", null, "global.action.title.designPage", "", controller, overrides);
		},
		_addShareButton: function(items, controller, overrides) {
			this._addDataAction(items, "pageShare", "pageShare", null, "global.action.title.pageShare", "", controller, overrides);
		},
		_addSwitchContextButton: function(items, controller, overrides) {
			var cacheContext = controller.getCacheContext();
			this._addDataAction(items, "switchContext", "switchContext", null, cacheContext.$role, "switchContext", controller, overrides);
		},
		...
		_addDraftsListButton: function(items, numDrafts, controller, overrides) {
		...
		_addMyDashboardTemplatesButton: function(items, controller, overrides) {
			this._addDataAction(items, "myDashboardTemplates", "myDashboardTemplates", null, "action.myDashboardTemplates", "myDashboardTemplates", controller, overrides);
		},
		...
		_addGlobalAction: function(action, items, controller, overrides, icon, params) {
			this._addDataAction(items, action, action, params, "global.action.title." + action, icon || action, controller, overrides);
		},
		_addMultiSelectonButton: function(items, controller, overrides) {
			this._addDataAction(items, "multiSelToggle", "multiSelToggle", null, "action.multiselection.toggle", "", controller, overrides);
		},
		_addSortFilterButton: function(items, controller, overrides) {
			this._addDataAction(items, "sortFilter", "sortFilter", null, "action.sortFilter", "", controller, overrides);
		},
		//
		// END: Helpers
		//
