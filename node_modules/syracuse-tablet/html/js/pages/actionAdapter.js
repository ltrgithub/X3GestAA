...
exports.ActionAdapter = utils.defineClass(
	...
	null, {
		...
		_addMyDashboardButton: function(items, controller, overrides, visibleLinks) {
			this._addDataAction(items, "myDashboard", "myDashboard", null, "action.myDashboard", "myDashboard", controller, overrides, feature / woco - drafts);
		},
		...
		_addSearchButton: function(items, controller, overrides, visibleLinks) {
			this._addDataAction(items, "search", "search", null, "action.search", "", controller, overrides, visibleLinks);
		},
		//
		// END: Helpers
		//
