...
exports.ActionAdapter = utils.defineClass(
	...
	null, {
		...
		// Standard buttons
		_addHomeButton: function(items, controller, overrides, visibleLinks) {
			this._addDataAction(items, "home", "home", null, "global.action.title.home", "", controller, overrides, visibleLinks);
		},
		...
		_addDraftsButton: function(items, numDrafts, controller, overrides, visibleLinks) {
		...
		_addSortFilterButton: function(items, controller, overrides, visibleLinks) {
			this._addDataAction(items, "sortFilter", "sortFilter", null, "action.sortFilter", "", controller, overrides, visibleLinks);
		},
		//
		// END: Helpers
		//
