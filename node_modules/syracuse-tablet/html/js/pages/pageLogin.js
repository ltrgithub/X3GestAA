...
var _Page = utils.defineClass(
	...
	function LoginPage($parent, state, options) {
		...
		_actLogin: function() {
			...
			self.waitWheelStart();
			return auth.login(usr, pwd, settings.loginRememberMe()).then(function(userProfile) {
				return initLogin.notifLoggedIn(userProfile, null); //notifications.publish("sm.logged.in", userProfile, null);
