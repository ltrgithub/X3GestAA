...
var _pageTemplate = '\
	<div class="container s-m-loginform">\
		<div class="row">\
...
var _Page = utils.defineClass(
	...
	function($parent, state) {
		...
		onMainPageResize: function(info, orientation) {
			...
			var $$form = this.$$contentElmt.children("div.s-m-loginform");
			var p = uiRect.elmtRect($$form);
			$$form.css({
				top: Math.max(0, Math.round((r.height - p.height) / 2)),
				position: "relative"
			});
		}
	});
