...
var _Page = utils.defineClass(
	function($parent, state, prototype, article, parentPage, options) {
		...
		buildHtmlOption: function() {
			return Base.prototype.buildHtmlOption.call(this).
			then(function(opts) {
		...
		loadData: function() {
			...
			if (ctrl.getArrayData() && ctrl.getArrayData().$resources.length > 0) {
				var data = $.extend(true, {}, ctrl.getArrayData().$resources[0].data);
				dao = new daoSdata.Dao(data, this.prototype, null, "carddesign");
			} else {
