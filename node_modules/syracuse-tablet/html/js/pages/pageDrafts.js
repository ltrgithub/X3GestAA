					...
					<div style="display:table-row;width:100%">\
						<div style="display:table-cell">\
							...
							<div style="clear: both;">\
								<b>{{endpoint}} - {{representation}}</span></b>\
							</div>\
							<div>\
						...
						<div style="clear: both;display:table-cell;width:4em;font-size:1.5em;position:relative;padding-left: 15px;">\
...
var _Page = utils.defineClass(
	function DraftsPage($parent, state, options) {
		...
		_uploadAll: function() {
			var self = this;
			this._upload(this.$$elmt.find(".s-m-draft-item").map(function() {
				return this.id;
			}).get()).the(function() {
				...
				if (count === nbSuccess) {
					globals.getModal().info("Uploading draft succeeds - " + nbSuccess + "/" + count, e);
				} else {
					globals.getModal().warning("Uploading uploading failed - Failed:" + nbFails + "/" + count + " - Success:" + nbSuccess + "/" + count, e);
				}
