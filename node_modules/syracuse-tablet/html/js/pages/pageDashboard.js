...
var _Page = utils.defineClass(
	...
	function DashboardPage($parent, state, prototype, article, options) {
		...
		reload: function(options) {
			this.vignettes = [];
			Base.prototype.reload.call(this, options);
		},
		...
		getPinPageData: function() {
			...
			pageData.$type = self.state.options && self.state.options.isAppHomePage === true ? "$application" : "$dashboard";
		...
		getRestoreContext: function() {
			...
			ctx.sdataParameters = this._sdataParam();
			return ctx;
		},
