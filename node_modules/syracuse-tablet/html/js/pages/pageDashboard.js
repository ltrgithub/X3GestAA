...
var _Page = utils.defineClass(
	...
	function($parent, state, prototype, article) {
		...
		buildHtmlContentBefore: function() {
			var self = this;
			var dom = Base.uiutils.createDomElement("div", ["container", "s-m-dashboard"], null, {
				"id": self.dashboardId
			});

			var title = self.prototype.data("$title");
			if (title) {
				dom.appendChild(Base.uiutils.createDomElement("h3", null, title));
			}
		...
		addControl: function(c) {
			...
			if (c && c.isVignette()) self.vignettes.push(c);
		},
