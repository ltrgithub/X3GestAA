...
var _Page = utils.defineClass(
	...
	function($parent, state, prototype, article) {
		...
		/**
		 * Override page method to scan vignettes
		 * Allows actions in vignette'page
		 */
		getControl: function(id) {
			var self = this;
			var c = Base.prototype.getControl.call(self, id);
			if (c == null && self.vignettes) {
				for (var i = 0; c == null && i < self.vignettes.length; i++) {
					c = self.vignettes[i].getControl(id);
				}
			}
			return c;
		},
