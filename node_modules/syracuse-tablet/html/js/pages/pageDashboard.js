...
var _Page = utils.defineClass(
	...
	function DashboardPage($parent, state, prototype, article) {
		...
		ssafterRender: function(options) {
			var self = this;
			// Empty dashboard
			if (!self.vignettes || self.vignettes.length < 1) {
				self.renderEmptyDashboardMessage();
			...
			// ---->
			// MW: This code was in onMainPageResize which causes a reload of the vignette on every resize. this is causing slow down and html arifacts
			// Put back here despite the comment that was put below.
			/**
