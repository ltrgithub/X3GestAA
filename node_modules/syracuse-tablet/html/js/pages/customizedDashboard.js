...
var _Page = utils.defineClass(
	...
	function CustomizedDashboard($parent, state, prototype, article, options) {
		...
		notifElementDrop: function($$dropElt, $$dragElt, params) {
			if ($$dragElt.hasClass("s-m-tile")) this._tileDrop($$dropElt, $$dragElt, params)
			if ($$dragElt.hasClass(".s-m-hub-group")) this._groupDrop($$dropElt, $$dragElt, params)
		},
		...
		notifElementOut: function($$dropElt, $$dragElt) {
			this.dragManager.hideIndicator();
		},
		notifElementOver: function($$dropElt, $$dragElt) {
			if ($$dragElt.hasClass("s-m-tile")) this._tileOver($$dropElt, $$dragElt)
			if ($$dragElt.hasClass(".s-m-hub-group")) this._groupOver($$dropElt, $$dragElt)
		},
		_tileOver: function($$dropElt, $$dragElt) {
			...
			//console.log(optsMoveTile, targetInfo)
