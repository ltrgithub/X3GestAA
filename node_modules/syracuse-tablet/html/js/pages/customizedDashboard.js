...
var _Page = utils.defineClass(
	...
	function CustomizedDashboard($parent, state, prototype, article, options) {
		...
		_titleChange: function(event, opt) {
			var self = this;
			self._changeHubGroupTitle(opt.layout, opt.title.val());
		},
		...
		enabledConfig: function(options) {
			...
			for (var i = 0; i < $$tiles.length; i++) {
				...
				if (!$$tile.attr("data-empty-tile")) { //not empty
					...
					$$tile.append($('<btn class="cfg remove fa fa-trash-o" data-action="removeEmptyTile" data-params="' + $$tile.attr('data-empty-tile') + '">'));
				}
			}
