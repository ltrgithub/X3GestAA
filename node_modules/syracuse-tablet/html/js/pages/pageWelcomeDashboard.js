			...
			self.$$pageConfigHeader = $(
				'<div class="s-m-page-config-header">\
			  	<div class="pull-right">\
					<div class="s-m-page-config-btn-header accept glyphicon glyphicon-ok" data-action="acceptPageConfig"></div>\
					<div class="s-m-page-config-btn-header cancel glyphicon glyphicon-remove" data-action="cancelPageConfig"></div>\
				</div>\
			</div>');
