...
exports.Page = utils.defineClass(
	...
	null, {
		...
		_getDefaultAttachedControls: function() {
			...
			var attachCtrl = ["header"];
			if (this.controller.showNavigationStackBar()) {
				attachCtrl.push("navigationStackBar");
			}
			return attachCtrl;
		},
		...
		_getAttachedControlInfo: function(name) {
			var defaults = {
				...
				navigationStackBar: {
					selector: "header .s-m-navigation-stackbar",
					$type: "application/x-navigation-stackbar"
				}
			};
		...
		/**
		 * Called by navigator whenever the page will navigate to a url or when the page is going to be closed because of a back action
		 * isBack	:	true/false 
		 * parsedUrl:	parsed page's url - null if back
		 * Resolve with true to continue navigation / false to stay in the current page
		 */
		onGotoUrlAction: function(isBack, parsedUrl) {
