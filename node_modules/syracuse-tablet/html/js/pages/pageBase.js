...
var _html = {
	fullpage: '\
		<section class="s-m-page s-m-full {{device}}" id="{{pageId}}" data-nevent="" data-naction="clickPage" style="display: none" data-page-name="{{pageName}}"> \
			<header></header> \
...
exports.Page = utils.defineClass(
	...
	null, {
			...
			var defaults = {
				smartphone: {
					...
					breadcrumbs: {
						...
						$type: "application/x-panel-breadcrumbs-smartphone"
					},
					actionsPanel: {
		...
		_actClickPage: function() {
			notifications.publish(["sm.page.click"], self);
		}
	});
