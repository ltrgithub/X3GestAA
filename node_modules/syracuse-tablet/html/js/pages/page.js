...
var _Page = utils.defineClass(
	function($parent, state, prototype, article) {
		...
		buildHtmlContent: function() {
			...
			templates.preload(["widgets/layout", "widgets/field", "widgets/vignette"]);
			...
			try {
				...
				contentHtml.push(self.rootLayout.buildHtml(self.dao));
		...
		buildHtmlContentBefore: function(html) {
			var self = this;
			html.push('<h3 class="s-m-page-title">' + globals.getApplication().getTitle() + "</h3>");
		},
		/**
		 * For child classes
		 */
