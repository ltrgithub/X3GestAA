	...
	function Page($$parent, state, prototype, article, options) {
		...
		_setNativeCapabilities: function() {
			...
			Object.keys(_nativeCapabilities).forEach(function(capability) {
				self.nativeCapabilities[capability] = (_nativeCapabilities[capability][self.state.type] && _nativeCapabilities[capability][self.state.type][self.state.subtype]) ? true : false;
			});
		},
