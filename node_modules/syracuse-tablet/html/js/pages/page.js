...
var _Page = utils.defineClass(
	function Page($$parent, state, prototype, article, options) {
		...
		self.state = state;
		self.id = state.uuid;
		// Contains all the controls of the page
		self.controlsMap = {};
		// Contains controls that need to be called after Render
		self.ctrlAfterRenderCalls = [];
		// Contains controls that need to be called after Show
		self.ctrlAfterShowCalls = [];
		// Contains controls that have a context to save in order to retrieve it when page will be load (eg: back navigation)
		self.ctrlSaveCtxCalls = [];
		self.dao = null;
