...
var _templates = {
	...
	fullpageLogin: '\
		<section class="s-m-page s-m-full s-m-login-page" id="{{pageid}}" data-appid="{{appid}}" class="ctrl-event-click" style=""> \
			<header></header> \
			<section class="s-m-main-content"></section> \
			<footer></footer> \
			<div class="s-m-side-panel-dismiss" data-action="sidePanel" data-params="close"></div> \
	...
	function($$parent, state, prototype, article) {
		...
		_initRootElmt: function($$parent) {
			...
			if (self.isVignette()) {
				...
				var tmpl = self.state && self.state.name == "login" ? "fullpageLogin" : "fullpage";
				self.$$elmt = $(_getHtml(tmpl, ctx));
