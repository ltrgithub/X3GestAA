...
var _Page = utils.defineClass(
	function Page($$parent, state, prototype, article, options) {
		...
		buildHtmlOption: function() {
			var self = this;
			return settings.isPinnedPage(self._getPinPageId())
		...
		panelAttach: function(where, panel, action) {
			if (!this.$$dismissPanel || !panel || (where != "right" && where != "left")) return;
		...
		panelCreate: function(panelId, options) {
			var controller = this.isVignette ? globals.getCurrentPage() : this;
			return ctrlFactory.createPanel(controller, panelId, options);
		},
		/**
