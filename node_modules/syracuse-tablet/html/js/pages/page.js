			...
			try {
				...
				if (this._pageControls && updateLayout !== true) {
					if (this.options.header === true) {
						this._pageControls.add("header", ctrlFactory.createPageControl("tablet/x-pageheader", this));
					};
					if (this.options.footer === true) {
						this._pageControls.add("footer", ctrlFactory.createPageControl("tablet/x-pagefooter", this));
					}
				}
