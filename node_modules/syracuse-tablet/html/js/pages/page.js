...
var _Page = utils.defineClass(
	function Page($$parent, state, prototype, article, options) {
		 ...
		 * return	prop = null -> {footerHeader:true/false, multiselection/false, refreshPage: true/false}
		...
		actionGetSettings: function(actName, prop) {
			...
			var res = {};
			var found = $actionsSettings.some(function(setting) {
				if (setting.name === actName) {
					if (setting.options) {
						setting.options.forEach(function(opt) {
							res[opt.id] = opt.checked;
						});
					}
					return true;
				}
			...
			return found ? prop === null ? res : res[prop] : null;
		},
