...
var _Page = utils.defineClass(
	function($$parent, state, prototype, article) {
		...
		activate: function(currentPage, cb) {
			var self = this;
			console.log("PAGE activate - vignette " + self.isVignette());
		...
		waitWheelStart: function(controlId) {
			console.log("page waitWheelStart");
			var self = this;
			if (controlId) {
		...
		waitWheelStop: function(controlId) {
			console.log("page waitWheelStop");
			var self = this;
			if (controlId) {
				var c = self.controlsMap[controlId];
