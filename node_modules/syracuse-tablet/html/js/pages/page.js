...
var PageControls = function(page) {
	...
	this.addFooter = function() {
		this.add("footer", ctrlFactory.createPageControl("tablet/x-pagefooter", this.page));
	};
	this.addHeader = function() {
		var c = this.add("header", ctrlFactory.createPageControl("tablet/x-pageheader", this.page));
		// To avoid flashing in ui - If we don't do that the content is shifted when the header is displayed - TODO improve
		this.page.$$contentElmt.css({
			top: c.getHeight()
		});
	};
		...
		loadStructure: function(updateLayout) {
			...
			try {
				...
				if (this._pageControls && updateLayout !== true) {
					if (this.options.header === true) this._pageControls.addHeader();
					if (this.options.footer === true) this._pageControls.addFooter();
				}
