...
var PanelManager = function(page) {
	...
	this.panelAttach = function(where, panel, action) {
		var controller = this.page.isVignette ? globals.getCurrentPage() : this.page;
		...
		if (!panel.isAttached(where)) {
			var $$parent = controller.$$elmt.children("section.s-m-panel.s-m-" + where);
...
var _Page = utils.defineClass(
	function Page($$parent, state, prototype, article, options) {
		...
		_initRootElmt: function($$parent) {
			...
			// Panel manager - Temporarlilly wi create one even for vignettes
			// !!! TODO create only for main page
			// -> Pb is that main page (current) is not available when we create an array sortFilter panel in a vignette
