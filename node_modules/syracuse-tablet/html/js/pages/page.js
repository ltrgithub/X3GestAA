...
var _Page = utils.defineClass(
	function($$parent, state, prototype, article, options) {
		...
		self.isNew = false;
		// Last selected row - Used to save/restore context - USed by lookup to pass data to parent x-reference control
		self.lastSelectedRowId = null;
	}, null, {
		...
		activate: function(pageToClose, savedContext, cb) {
			...
			self._show(pageToClose, function() {
				if (cb) cb();
				if (savedContext) {
					// console.log(self.id + " savedCtxRestore\n" + JSON.stringify(ctx, null, 2) +  "\n" + (pageToClose ? pageToClose.id : "No pageToClose") )
		...
		contextSave: function(pageToClose) {
			...
			// console.log(self.id + " contextSave\n" + JSON.stringify(self.savedContext, null, 2) +  "\n" + (pageToClose ? pageToClose.id : "No pageToClose") )
		},
		/**
		 ...
		 */
		notifSelectRow: function(rowId, rowDao) {
