...
var entities = [
	...
	require('syracuse-tablet/html/js/demos/clientTestApp/unitTests/entities/entityNativeFields')
];

var modules = {
	unitTestCtrlField: require('syracuse-tablet/html/js/demos/clientTestApp/unitTests/unitTestCtrlField'),
	unitTestNativeFields: require('syracuse-tablet/html/js/demos/clientTestApp/unitTests/unitTestNativeFields')
};
