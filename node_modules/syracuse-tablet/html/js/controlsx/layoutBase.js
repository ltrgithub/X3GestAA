...
var Base = require('syracuse-tablet/html/js/controlsx/structElmt').Klass;
...
var _Klass = utils
	.defineClass(
		...
		Base, {
			...
			/**
			 * called by the parser after all children have been
			 * appended
			 */
			...
			buildHtml: function(controllerDao, buildOptions) {
				...
				for (var ii = 0, jj = this.children.length; ii < jj; ii++) {
					...
					context.coreItem.push({
						...
						coreItemContent: this.children[ii].buildHtml(controllerDao, buildOptions)
					});
				}

				return this.templates.execSync("tmplLayout", context);
			}
		});
