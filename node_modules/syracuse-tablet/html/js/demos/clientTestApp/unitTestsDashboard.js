...
var entities = [
	...
	require('syracuse-tablet/html/js/demos/clientTestApp/unitTests/entities/entityBarcode')
];

var modules = {
	unitTestCtrlField: require('syracuse-tablet/html/js/demos/clientTestApp/unitTests/unitTestCtrlField'),
	unitTestBarcode: require('syracuse-tablet/html/js/demos/clientTestApp/unitTests/unitTestBarcode')
};
