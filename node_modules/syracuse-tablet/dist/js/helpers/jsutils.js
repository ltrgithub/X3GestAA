...
var _getClassName = function(klass) {
	...
	if (klass.$smClasses && klass.$smClasses.length > 0) {
		return klass.$smClasses[0];
	}
	var ctorName = klass && klass.toString();
	ctorName = ctorName.match(/^function\s*([^\s(]+)/);
	return ctorName && ctorName.length > 1 ? ctorName[1] : null;
}
...
exports.getClassName = _getClassName;
exports.stringToDiagnoses = function(e) {
	return {
		$diagnoses: [{
			$message: e
		}]
