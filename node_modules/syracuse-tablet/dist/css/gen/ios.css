...
/* 100% on smartphone for dialog panel with the close box */
.s-m-page.s-m-full.smartphone > aside.s-m-panel.dialogpanel {
  width: 100%;
}
...
.landscape .s-m-over-droptarget.s-m-hub-group {
  margin-left: -10px;
}
.landscape .s-m-over-droptarget.s-m-not-droppable.s-m-hub-group {
  margin-left: 0px;
}
.landscape .s-m-ui-drop {
  top: 0px;
  left: 100%;
  width: 10px;
  height: 100%;
}
.portrait .s-m-over-droptarget.s-m-hub-group {
  margin-top: -10px;
}
.portrait .s-m-over-droptarget.s-m-not-droppable.s-m-hub-group {
  margin-top: 0px;
}
.portrait .s-m-ui-drop {
  top: 100%;
  left: 0px;
  width: 100%;
  height: 10px;
...
.s-m-footer.smartphone .s-m-link {
  display: inline-block;
  min-width: 30px;
  /* Force bootstrap a tag color - black*/
  color: #ffffff;
}
.s-m-footer.smartphone > .s-m-footer-left > .s-m-link {
  display: inline-block;
...
.s-m-footer.smartphone > .s-m-footer-left > .s-m-link:first-child {
  margin-left: 0px;
}
.s-m-footer.smartphone > .s-m-footer-left > .s-m-link > span {
  display: none;
  max-width: 100px;
  overflow: hidden;
  text-overflow: ellipsis;
...
.s-m-footer.smartphone > .s-m-footer-left,
.s-m-footer.smartphone > .s-m-footer-right {
  display: table-cell;
  padding-top: 0px;
  padding-left: 0px;
}
.s-m-footer.smartphone > .s-m-footer-right > .s-m-link {
  float: right;
  padding-right: 15px;
}
.s-m-footer.smartphone a.s-m-link i {
  display: block;
  text-align: center;
  font-size: 1.5em;
  top: 0px;
...
.s-m-footer.smartphone a.s-m-link span {
  display: block;
  text-align: center;
  font-size: 1em;
  vertical-align: bottom;
...
.s-m-img-layout > footer > a[action="$delete"] {
  float: right;
}
/* VIGNETTES */
...
/* When we display a carousel in a tile (query/stats/request) we remove the padding to better fit with the tile*/
.s-m-tile.s-m-carousel .s-m-layout,
.s-m-cell.s-m-carousel .s-m-layout {
  padding: 0px;
}
...
/*    MULTISELECTION                 */
/*************************************/
a.enabled[data-action="multiSelection"] > i {
  color: #ff5800;
}
.btn-group.s-m-ismultisel {
  padding-left: 1.7em;
  float: right;
}
.btn-group.s-m-ismultisel:first-child {
  padding-left: 0px;
}
.s-m-link.s-m-ismultisel > span {
  max-width: 100px;
  text-overflow: ellipsis;
  overflow: hidden;
  white-space: nowrap;
...
.s-m-record.s-m-multi-selected.error {
  background-color: #eeb8a6;
  color: #4d4f53;
  border: none;
}
...
.s-m-array.s-m-card .s-m-record.s-m-multi-selected.success > section.s-m-card {
  background-color: #a0d49f;
  color: #4d4f53;
}
...
.s-m-array.s-m-card .s-m-record.s-m-multi-selected.success > .s-m-card {
  background-color: #a0d49f;
  color: #4d4f53;
}
.s-m-array.s-m-card .s-m-record.s-m-multi-selected.error > .s-m-card {
  background-color: #eeb8a6;
  color: #4d4f53;
}
...
.btn-group.s-m-ismultisel > div > button.btn > span:not(.title) {
  font-family: monospace;
}
.btn-group.s-m-ismultisel > div > button.btn > span.title {
  margin-left: 10px;
  margin-right: 10px;
}
...
.s-m-footer-right > .btn-group.s-m-ismultisel > div > ul.dropdown-menu {
  right: 0px;
}
.s-m-footer-right > .btn-group.s-m-ismultisel > div > ul.dropdown-menu > li > a {
  color: #000000;
  font-weight: bold;
  line-height: 2em;
  width: 100%;
...
.s-m-page.s-m-full.chartdetail > .s-m-topToolbar .btn.s-m-selected {
  background-color: #338432;
  border-color: #296a28;
  color: #ffffff;
}
