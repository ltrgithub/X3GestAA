...
.s-m-control.s-m-chart .s-m-no-data-title,
...
.s-m-control.s-m-chart .s-m-no-data-label,
...
.s-m-control.s-m-chart > div.s-m-catchevt {
  z-index: 100;
  height: 100%;
  width: 100%;
  position: absolute;
...
.s-m-control.s-m-chart > .s-m-lnk-detail {
  position: absolute;
  top: 1px;
  right: 4px;
  z-index: 100;
...
td > section.s-m-card > div.s-m-status {
  top: 0;
  right: 0;
  font-size: 1.3em;
  position: absolute;
...
td > section.s-m-card > div.s-m-status > div.s-m-status-icon {
  padding: 2px 2px 2px 2px;
  float: right;
  display: inline-block;
}
td > section.s-m-card > div.s-m-status-color {
  padding: 5px;
}
...
.s-m-page.s-m-full.chartdetail .s-m-chart > div.s-m-slot {
  height: 100%;
  width: 100%;
  position: absolute;
  top: 0px;
