...
function HttpServer(requestListener, options) {
	...
	var emitter = options.createServer(globals.withFreshContext(function(request, response) {
...
/// * `request.abort()`  
///    aborts the request. 
wrapChainMethods(HttpClientRequest, ["abort", "setTimeout"]);
...
function NetServer(serverOptions, connectionListener, streamOptions) {
	...
	net = net || require("net");
	var emitter = net.createServer(serverOptions, globals.withFreshContext(function(connection) {
