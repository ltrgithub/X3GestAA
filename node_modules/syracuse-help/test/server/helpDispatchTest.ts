...
//testAdmin.modifyCollaborationEndpoint("unit_test");
...
/*	it('init database', function(_) {
		...
		db = testAdmin.newMongoDb("unit_test", server, {});
		db = db.open(_);
		db.dropDatabase(_);
...
*/
	...
	it('Manage proxy', function(_) {
		...
		proxyOK = testAdmin.onlyInfo(body.$diagnoses);
	});

	it('Proxy GET Help index.htm', function(_) {
		if (proxyOK) {
