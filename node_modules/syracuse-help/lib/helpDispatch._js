...
exports.dispatcher = function(config) {
	...
	return function(_, request, response) {
		...
		if (helpConfig.local) {
			...
			var version = helpConfig.version;
			tracer.debug && tracer.debug("Help config version: " + helpConfig.version);
			if (version == null) {
				if (ep) version = require('@sage/syracuse-lib/src/collaboration/helpers').AdminHelper.getProductVersionByEndpoint(ep.dataset(_));
